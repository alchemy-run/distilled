...
export const publishPublishersItems: API.OperationMethod<PublishPublishersItemsRequest, PublishPublishersItemsResponse, PublishPublishersItemsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const cancelSubmissionPublishersItems: API.OperationMethod<CancelSubmissionPublishersItemsRequest, CancelSubmissionPublishersItemsResponse, CancelSubmissionPublishersItemsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const fetchStatusPublishersItems: API.OperationMethod<FetchStatusPublishersItemsRequest, FetchStatusPublishersItemsResponse, FetchStatusPublishersItemsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const setPublishedDeployPercentagePublishersItems: API.OperationMethod<SetPublishedDeployPercentagePublishersItemsRequest, SetPublishedDeployPercentagePublishersItemsResponse, SetPublishedDeployPercentagePublishersItemsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
