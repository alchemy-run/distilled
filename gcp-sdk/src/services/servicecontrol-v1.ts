...
export const ExplicitBuckets: Schema.Schema<ExplicitBuckets> = Schema.suspend(() => Schema.Struct({
  bounds: Schema.optional(Schema.Array(Schema.Number)),
})).annotate({ identifier: "ExplicitBuckets" }) as any as Schema.Schema<ExplicitBuckets>;
...
export const LinearBuckets: Schema.Schema<LinearBuckets> = Schema.suspend(() => Schema.Struct({
  numFiniteBuckets: Schema.optional(Schema.Number),
  width: Schema.optional(Schema.Number),
  offset: Schema.optional(Schema.Number),
})).annotate({ identifier: "LinearBuckets" }) as any as Schema.Schema<LinearBuckets>;
...
export const ReportError: Schema.Schema<ReportError> = Schema.suspend(() => Schema.Struct({
  status: Schema.optional(Status),
...
export const V1LogEntryOperation: Schema.Schema<V1LogEntryOperation> = Schema.suspend(() => Schema.Struct({
  last: Schema.optional(Schema.Boolean),
  producer: Schema.optional(Schema.String),
  id: Schema.optional(Schema.String),
  first: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "V1LogEntryOperation" }) as any as Schema.Schema<V1LogEntryOperation>;
...
export const ExponentialBuckets: Schema.Schema<ExponentialBuckets> = Schema.suspend(() => Schema.Struct({
  scale: Schema.optional(Schema.Number),
  growthFactor: Schema.optional(Schema.Number),
  numFiniteBuckets: Schema.optional(Schema.Number),
})).annotate({ identifier: "ExponentialBuckets" }) as any as Schema.Schema<ExponentialBuckets>;
...
export const MetricValueSet: Schema.Schema<MetricValueSet> = Schema.suspend(() => Schema.Struct({
  metricName: Schema.optional(Schema.String),
  metricValues: Schema.optional(Schema.Array(MetricValue)),
})).annotate({ identifier: "MetricValueSet" }) as any as Schema.Schema<MetricValueSet>;
...
export interface QuotaOperation {
  ...
  quotaMode?: "UNSPECIFIED" | "NORMAL" | "BEST_EFFORT" | "CHECK_ONLY" | "ADJUST_ONLY" | (string & {});
...
export const QuotaOperation: Schema.Schema<QuotaOperation> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "QuotaOperation" }) as any as Schema.Schema<QuotaOperation>;
...
export interface QuotaError {
  ...
  status?: Status;
  /** Error code. */
  code?: "UNSPECIFIED" | "RESOURCE_EXHAUSTED" | "OUT_OF_RANGE" | "BILLING_NOT_ACTIVE" | "PROJECT_DELETED" | "API_KEY_INVALID" | "API_KEY_EXPIRED" | "SPATULA_HEADER_INVALID" | "LOAS_ROLE_INVALID" | "NO_LOAS_PROJECT" | "PROJECT_STATUS_UNAVAILABLE" | "SERVICE_STATUS_UNAVAILABLE" | "BILLING_STATUS_UNAVAILABLE" | "QUOTA_SYSTEM_UNAVAILABLE" | (string & {});
  /** Free-form text that provides details on the cause of the error. */
  description?: string;
}

export const QuotaError: Schema.Schema<QuotaError> = Schema.suspend(() => Schema.Struct({
...
export interface QuotaInfo {
  ...
  quotaExtractionState?: "QUOTA_EXTRACTION_STATE_UNSPECIFIED" | "QUOTA_EXTRACTION_STATE_DARK_LAUNCH" | "QUOTA_EXTRACTION_STATE_TRAFFIC_MIGRATION" | (string & {});
...
export const QuotaInfo: Schema.Schema<QuotaInfo> = Schema.suspend(() => Schema.Struct({
...
export interface ConsumerInfo {
  ...
  type?: "CONSUMER_TYPE_UNSPECIFIED" | "PROJECT" | "FOLDER" | "ORGANIZATION" | "SERVICE_SPECIFIC" | (string & {});
...
export const ConsumerInfo: Schema.Schema<ConsumerInfo> = Schema.suspend(() => Schema.Struct({
  type: Schema.optional(Schema.String),
  projectNumber: Schema.optional(Schema.String),
  consumerNumber: Schema.optional(Schema.String),
})).annotate({ identifier: "ConsumerInfo" }) as any as Schema.Schema<ConsumerInfo>;
...
export const V1LogEntrySourceLocation: Schema.Schema<V1LogEntrySourceLocation> = Schema.suspend(() => Schema.Struct({
  function: Schema.optional(Schema.String),
  line: Schema.optional(Schema.String),
  file: Schema.optional(Schema.String),
})).annotate({ identifier: "V1LogEntrySourceLocation" }) as any as Schema.Schema<V1LogEntrySourceLocation>;
...
export const V1HttpRequest: Schema.Schema<V1HttpRequest> = Schema.suspend(() => Schema.Struct({
  requestUrl: Schema.optional(Schema.String),
  serverIp: Schema.optional(Schema.String),
  referer: Schema.optional(Schema.String),
  latency: Schema.optional(Schema.String),
  ...
  requestSize: Schema.optional(Schema.String),
  requestMethod: Schema.optional(Schema.String),
})).annotate({ identifier: "V1HttpRequest" }) as any as Schema.Schema<V1HttpRequest>;
...
export const V1LogEntry: Schema.Schema<V1LogEntry> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const QuotaProperties: Schema.Schema<QuotaProperties> = Schema.suspend(() => Schema.Struct({
  quotaMode: Schema.optional(Schema.String),
})).annotate({ identifier: "QuotaProperties" }) as any as Schema.Schema<QuotaProperties>;
...
export const AllocateQuotaRequest: Schema.Schema<AllocateQuotaRequest> = Schema.suspend(() => Schema.Struct({
  allocateOperation: Schema.optional(QuotaOperation),
  serviceConfigId: Schema.optional(Schema.String),
})).annotate({ identifier: "AllocateQuotaRequest" }) as any as Schema.Schema<AllocateQuotaRequest>;
...
export const AllocateInfo: Schema.Schema<AllocateInfo> = Schema.suspend(() => Schema.Struct({
  unusedArguments: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "AllocateInfo" }) as any as Schema.Schema<AllocateInfo>;
...
export const AllocateQuotaResponse: Schema.Schema<AllocateQuotaResponse> = Schema.suspend(() => Schema.Struct({
  serviceConfigId: Schema.optional(Schema.String),
  quotaMetrics: Schema.optional(Schema.Array(MetricValueSet)),
  allocateInfo: Schema.optional(AllocateInfo),
  allocateErrors: Schema.optional(Schema.Array(QuotaError)),
  operationId: Schema.optional(Schema.String),
})).annotate({ identifier: "AllocateQuotaResponse" }) as any as Schema.Schema<AllocateQuotaResponse>;
...
export const CheckError: Schema.Schema<CheckError> = Schema.suspend(() => Schema.Struct({
  subject: Schema.optional(Schema.String),
...
export const V1ResourceEvent: Schema.Schema<V1ResourceEvent> = Schema.suspend(() => Schema.Struct({
  type: Schema.optional(Schema.String),
...
})).annotate({ identifier: "V1ResourceEvent" }) as any as Schema.Schema<V1ResourceEvent>;
...
export const CheckInfo: Schema.Schema<CheckInfo> = Schema.suspend(() => Schema.Struct({
...
export const CheckServicesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1/services/{serviceName}:check", hasBody: true }),
  svc,
...
export const checkServices: API.OperationMethod<CheckServicesRequest, CheckServicesResponse, CheckServicesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const AllocateQuotaServicesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1/services/{serviceName}:allocateQuota", hasBody: true }),
  svc,
...
export const allocateQuotaServices: API.OperationMethod<AllocateQuotaServicesRequest, AllocateQuotaServicesResponse, AllocateQuotaServicesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ReportServicesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1/services/{serviceName}:report", hasBody: true }),
  svc,
...
export const reportServices: API.OperationMethod<ReportServicesRequest, ReportServicesResponse, ReportServicesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
