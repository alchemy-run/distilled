...
export const sendProjectsMessages: API.OperationMethod<SendProjectsMessagesRequest, SendProjectsMessagesResponse, SendProjectsMessagesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
