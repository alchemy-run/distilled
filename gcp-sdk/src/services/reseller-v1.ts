...
export const PrimaryAdmin: Schema.Schema<PrimaryAdmin> = Schema.suspend(() =>
  Schema.Struct({
...
export const Seats: Schema.Schema<Seats> = Schema.suspend(() =>
  Schema.Struct({
...
export const RenewalSettings: Schema.Schema<RenewalSettings> = Schema.suspend(
  () =>
    Schema.Struct({
...
export const Subscriptions: Schema.Schema<Subscriptions> = Schema.suspend(() =>
  Schema.Struct({
    kind: Schema.optional(Schema.String),
...
export const GetwatchdetailsResellernotifyRequest = Schema.Struct({}).pipe(
  T.Http({
    method: "GET",
