...
export const insertCustomers: API.OperationMethod<InsertCustomersRequest, InsertCustomersResponse, InsertCustomersError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const getwatchdetailsResellernotify: API.OperationMethod<GetwatchdetailsResellernotifyRequest, GetwatchdetailsResellernotifyResponse, GetwatchdetailsResellernotifyError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const registerResellernotify: API.OperationMethod<RegisterResellernotifyRequest, RegisterResellernotifyResponse, RegisterResellernotifyError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const unregisterResellernotify: API.OperationMethod<UnregisterResellernotifyRequest, UnregisterResellernotifyResponse, UnregisterResellernotifyError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const activateSubscriptions: API.OperationMethod<ActivateSubscriptionsRequest, ActivateSubscriptionsResponse, ActivateSubscriptionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const changePlanSubscriptions: API.OperationMethod<ChangePlanSubscriptionsRequest, ChangePlanSubscriptionsResponse, ChangePlanSubscriptionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const changeRenewalSettingsSubscriptions: API.OperationMethod<ChangeRenewalSettingsSubscriptionsRequest, ChangeRenewalSettingsSubscriptionsResponse, ChangeRenewalSettingsSubscriptionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const changeSeatsSubscriptions: API.OperationMethod<ChangeSeatsSubscriptionsRequest, ChangeSeatsSubscriptionsResponse, ChangeSeatsSubscriptionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const startPaidServiceSubscriptions: API.OperationMethod<StartPaidServiceSubscriptionsRequest, StartPaidServiceSubscriptionsResponse, StartPaidServiceSubscriptionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const suspendSubscriptions: API.OperationMethod<SuspendSubscriptionsRequest, SuspendSubscriptionsResponse, SuspendSubscriptionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
