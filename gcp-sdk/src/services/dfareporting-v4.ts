...
export interface Report {
  ...
  reachCriteria?: { dateRange?: DateRange; metricNames?: Array<string>; dimensions?: Array<SortedDimension>; activities?: Activities; enableAllDimensionCombinations?: boolean; dimensionFilters?: Array<DimensionValue>; customRichMediaEvents?: CustomRichMediaEvents; reachByFrequencyMetricNames?: Array<string> };
  /** The report criteria for a report of type "FLOODLIGHT". */
  floodlightCriteria?: { dateRange?: DateRange; floodlightConfigId?: DimensionValue; metricNames?: Array<string>; dimensions?: Array<SortedDimension>; reportProperties?: { includeAttributedIPConversions?: boolean; includeUnattributedCookieConversions?: boolean; includeUnattributedIPConversions?: boolean }; dimensionFilters?: Array<DimensionValue>; customRichMediaEvents?: Array<DimensionValue> };
  ...
  schedule?: { active?: boolean; repeatsOnWeekDays?: Array<"SUNDAY" | "MONDAY" | "TUESDAY" | "WEDNESDAY" | "THURSDAY" | "FRIDAY" | "SATURDAY" | (string & {})>; runsOnDayOfMonth?: "DAY_OF_MONTH" | "WEEK_OF_MONTH" | (string & {}); startDate?: string; every?: number; timezone?: string; repeats?: string; expirationDate?: string };
  ...
  criteria?: { dimensionFilters?: Array<DimensionValue>; customRichMediaEvents?: CustomRichMediaEvents; dateRange?: DateRange; metricNames?: Array<string>; dimensions?: Array<SortedDimension>; activities?: Activities };
  /** The report criteria for a report of type "PATH_TO_CONVERSION". */
  pathToConversionCriteria?: { activityFilters?: Array<DimensionValue>; customRichMediaEvents?: Array<DimensionValue>; perInteractionDimensions?: Array<SortedDimension>; dateRange?: DateRange; reportProperties?: { clicksLookbackWindow?: number; maximumClickInteractions?: number; includeUnattributedIPConversions?: boolean; impressionsLookbackWindow?: number; pivotOnInteractionPath?: boolean; maximumInteractionGap?: number; maximumImpressionInteractions?: number; includeAttributedIPConversions?: boolean; includeUnattributedCookieConversions?: boolean }; conversionDimensions?: Array<SortedDimension>; floodlightConfigId?: DimensionValue; metricNames?: Array<string>; customFloodlightVariables?: Array<SortedDimension> };
  /** The report criteria for a report of type "CROSS_DIMENSION_REACH". */
  crossDimensionReachCriteria?: { dimension?: "ADVERTISER" | "CAMPAIGN" | "SITE_BY_ADVERTISER" | "SITE_BY_CAMPAIGN" | (string & {}); breakdown?: Array<SortedDimension>; overlapMetricNames?: Array<string>; dateRange?: DateRange; metricNames?: Array<string>; pivoted?: boolean; dimensionFilters?: Array<DimensionValue> };
}

export const Report: Schema.Schema<Report> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  kind: Schema.optional(Schema.String),
  reachCriteria: Schema.optional(Schema.Struct({ dateRange: Schema.optional(DateRange), metricNames: Schema.optional(Schema.Array(Schema.String)), dimensions: Schema.optional(Schema.Array(SortedDimension)), activities: Schema.optional(Activities), enableAllDimensionCombinations: Schema.optional(Schema.Boolean), dimensionFilters: Schema.optional(Schema.Array(DimensionValue)), customRichMediaEvents: Schema.optional(CustomRichMediaEvents), reachByFrequencyMetricNames: Schema.optional(Schema.Array(Schema.String)) })),
  floodlightCriteria: Schema.optional(Schema.Struct({ dateRange: Schema.optional(DateRange), floodlightConfigId: Schema.optional(DimensionValue), metricNames: Schema.optional(Schema.Array(Schema.String)), dimensions: Schema.optional(Schema.Array(SortedDimension)), reportProperties: Schema.optional(Schema.Struct({ includeAttributedIPConversions: Schema.optional(Schema.Boolean), includeUnattributedCookieConversions: Schema.optional(Schema.Boolean), includeUnattributedIPConversions: Schema.optional(Schema.Boolean) })), dimensionFilters: Schema.optional(Schema.Array(DimensionValue)), customRichMediaEvents: Schema.optional(Schema.Array(DimensionValue)) })),
  ...
  schedule: Schema.optional(Schema.Struct({ active: Schema.optional(Schema.Boolean), repeatsOnWeekDays: Schema.optional(Schema.Array(Schema.String)), runsOnDayOfMonth: Schema.optional(Schema.String), startDate: Schema.optional(Schema.String), every: Schema.optional(Schema.Number), timezone: Schema.optional(Schema.String), repeats: Schema.optional(Schema.String), expirationDate: Schema.optional(Schema.String) })),
  ...
  type: Schema.optional(Schema.String),
  criteria: Schema.optional(Schema.Struct({ dimensionFilters: Schema.optional(Schema.Array(DimensionValue)), customRichMediaEvents: Schema.optional(CustomRichMediaEvents), dateRange: Schema.optional(DateRange), metricNames: Schema.optional(Schema.Array(Schema.String)), dimensions: Schema.optional(Schema.Array(SortedDimension)), activities: Schema.optional(Activities) })),
  pathToConversionCriteria: Schema.optional(Schema.Struct({ activityFilters: Schema.optional(Schema.Array(DimensionValue)), customRichMediaEvents: Schema.optional(Schema.Array(DimensionValue)), perInteractionDimensions: Schema.optional(Schema.Array(SortedDimension)), dateRange: Schema.optional(DateRange), reportProperties: Schema.optional(Schema.Struct({ clicksLookbackWindow: Schema.optional(Schema.Number), maximumClickInteractions: Schema.optional(Schema.Number), includeUnattributedIPConversions: Schema.optional(Schema.Boolean), impressionsLookbackWindow: Schema.optional(Schema.Number), pivotOnInteractionPath: Schema.optional(Schema.Boolean), maximumInteractionGap: Schema.optional(Schema.Number), maximumImpressionInteractions: Schema.optional(Schema.Number), includeAttributedIPConversions: Schema.optional(Schema.Boolean), includeUnattributedCookieConversions: Schema.optional(Schema.Boolean) })), conversionDimensions: Schema.optional(Schema.Array(SortedDimension)), floodlightConfigId: Schema.optional(DimensionValue), metricNames: Schema.optional(Schema.Array(Schema.String)), customFloodlightVariables: Schema.optional(Schema.Array(SortedDimension)) })),
  crossDimensionReachCriteria: Schema.optional(Schema.Struct({ dimension: Schema.optional(Schema.String), breakdown: Schema.optional(Schema.Array(SortedDimension)), overlapMetricNames: Schema.optional(Schema.Array(Schema.String)), dateRange: Schema.optional(DateRange), metricNames: Schema.optional(Schema.Array(Schema.String)), pivoted: Schema.optional(Schema.Boolean), dimensionFilters: Schema.optional(Schema.Array(DimensionValue)) })),
...
export const File: Schema.Schema<File> = Schema.suspend(() => Schema.Struct({
  ...
  id: Schema.optional(Schema.String),
  format: Schema.optional(Schema.String),
  urls: Schema.optional(Schema.Struct({ apiUrl: Schema.optional(Schema.String), browserUrl: Schema.optional(Schema.String) })),
...
export const listOrders: API.PaginatedOperationMethod<ListOrdersRequest, ListOrdersResponse, ListOrdersError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const listInventoryItems: API.PaginatedOperationMethod<ListInventoryItemsRequest, ListInventoryItemsResponse, ListInventoryItemsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const getInventoryItems: API.OperationMethod<GetInventoryItemsRequest, GetInventoryItemsResponse, GetInventoryItemsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const patchReports: API.OperationMethod<PatchReportsRequest, PatchReportsResponse, PatchReportsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
