...
export const GoogleCloudVideointelligenceV1beta2_ShotChangeDetectionConfig: Schema.Schema<GoogleCloudVideointelligenceV1beta2_ShotChangeDetectionConfig> = Schema.suspend(() => Schema.Struct({
  model: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudVideointelligenceV1beta2_ShotChangeDetectionConfig" }) as any as Schema.Schema<GoogleCloudVideointelligenceV1beta2_ShotChangeDetectionConfig>;
...
export const GoogleCloudVideointelligenceV1beta2_FaceDetectionConfig: Schema.Schema<GoogleCloudVideointelligenceV1beta2_FaceDetectionConfig> = Schema.suspend(() => Schema.Struct({
  model: Schema.optional(Schema.String),
  includeBoundingBoxes: Schema.optional(Schema.Boolean),
  includeAttributes: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "GoogleCloudVideointelligenceV1beta2_FaceDetectionConfig" }) as any as Schema.Schema<GoogleCloudVideointelligenceV1beta2_FaceDetectionConfig>;
...
export const GoogleCloudVideointelligenceV1beta2_ExplicitContentDetectionConfig: Schema.Schema<GoogleCloudVideointelligenceV1beta2_ExplicitContentDetectionConfig> = Schema.suspend(() => Schema.Struct({
  model: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudVideointelligenceV1beta2_ExplicitContentDetectionConfig" }) as any as Schema.Schema<GoogleCloudVideointelligenceV1beta2_ExplicitContentDetectionConfig>;
...
export const GoogleCloudVideointelligenceV1beta2_PersonDetectionConfig: Schema.Schema<GoogleCloudVideointelligenceV1beta2_PersonDetectionConfig> = Schema.suspend(() => Schema.Struct({
  includeBoundingBoxes: Schema.optional(Schema.Boolean),
  includeAttributes: Schema.optional(Schema.Boolean),
  includePoseLandmarks: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "GoogleCloudVideointelligenceV1beta2_PersonDetectionConfig" }) as any as Schema.Schema<GoogleCloudVideointelligenceV1beta2_PersonDetectionConfig>;
...
export const GoogleCloudVideointelligenceV1beta2_SpeechContext: Schema.Schema<GoogleCloudVideointelligenceV1beta2_SpeechContext> = Schema.suspend(() => Schema.Struct({
  phrases: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "GoogleCloudVideointelligenceV1beta2_SpeechContext" }) as any as Schema.Schema<GoogleCloudVideointelligenceV1beta2_SpeechContext>;
...
export const GoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfig: Schema.Schema<GoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfig> = Schema.suspend(() => Schema.Struct({
  maxAlternatives: Schema.optional(Schema.Number),
  filterProfanity: Schema.optional(Schema.Boolean),
  languageCode: Schema.optional(Schema.String),
  speechContexts: Schema.optional(Schema.Array(GoogleCloudVideointelligenceV1beta2_SpeechContext)),
...
})).annotate({ identifier: "GoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfig" }) as any as Schema.Schema<GoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfig>;
...
export const GoogleCloudVideointelligenceV1beta2_TextDetectionConfig: Schema.Schema<GoogleCloudVideointelligenceV1beta2_TextDetectionConfig> = Schema.suspend(() => Schema.Struct({
  languageHints: Schema.optional(Schema.Array(Schema.String)),
  model: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudVideointelligenceV1beta2_TextDetectionConfig" }) as any as Schema.Schema<GoogleCloudVideointelligenceV1beta2_TextDetectionConfig>;
...
export const GoogleCloudVideointelligenceV1beta2_LabelDetectionConfig: Schema.Schema<GoogleCloudVideointelligenceV1beta2_LabelDetectionConfig> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudVideointelligenceV1beta2_LabelDetectionConfig" }) as any as Schema.Schema<GoogleCloudVideointelligenceV1beta2_LabelDetectionConfig>;
...
export const GoogleCloudVideointelligenceV1beta2_ObjectTrackingConfig: Schema.Schema<GoogleCloudVideointelligenceV1beta2_ObjectTrackingConfig> = Schema.suspend(() => Schema.Struct({
  model: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudVideointelligenceV1beta2_ObjectTrackingConfig" }) as any as Schema.Schema<GoogleCloudVideointelligenceV1beta2_ObjectTrackingConfig>;
...
export const GoogleCloudVideointelligenceV1beta2_VideoContext: Schema.Schema<GoogleCloudVideointelligenceV1beta2_VideoContext> = Schema.suspend(() => Schema.Struct({
  explicitContentDetectionConfig: Schema.optional(GoogleCloudVideointelligenceV1beta2_ExplicitContentDetectionConfig),
  personDetectionConfig: Schema.optional(GoogleCloudVideointelligenceV1beta2_PersonDetectionConfig),
  shotChangeDetectionConfig: Schema.optional(GoogleCloudVideointelligenceV1beta2_ShotChangeDetectionConfig),
  segments: Schema.optional(Schema.Array(GoogleCloudVideointelligenceV1beta2_VideoSegment)),
  speechTranscriptionConfig: Schema.optional(GoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfig),
  textDetectionConfig: Schema.optional(GoogleCloudVideointelligenceV1beta2_TextDetectionConfig),
  faceDetectionConfig: Schema.optional(GoogleCloudVideointelligenceV1beta2_FaceDetectionConfig),
  labelDetectionConfig: Schema.optional(GoogleCloudVideointelligenceV1beta2_LabelDetectionConfig),
  objectTrackingConfig: Schema.optional(GoogleCloudVideointelligenceV1beta2_ObjectTrackingConfig),
})).annotate({ identifier: "GoogleCloudVideointelligenceV1beta2_VideoContext" }) as any as Schema.Schema<GoogleCloudVideointelligenceV1beta2_VideoContext>;
...
export const GoogleCloudVideointelligenceV1beta2_AnnotateVideoRequest: Schema.Schema<GoogleCloudVideointelligenceV1beta2_AnnotateVideoRequest> = Schema.suspend(() => Schema.Struct({
  inputUri: Schema.optional(Schema.String),
  videoContext: Schema.optional(GoogleCloudVideointelligenceV1beta2_VideoContext),
  features: Schema.optional(Schema.Array(Schema.String)),
  locationId: Schema.optional(Schema.String),
  inputContent: Schema.optional(Schema.String),
  outputUri: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudVideointelligenceV1beta2_AnnotateVideoRequest" }) as any as Schema.Schema<GoogleCloudVideointelligenceV1beta2_AnnotateVideoRequest>;
...
export const AnnotateVideosRequest = Schema.Struct({
  body: Schema.optional(GoogleCloudVideointelligenceV1beta2_AnnotateVideoRequest).pipe(T.HttpBody()),
}).pipe(
