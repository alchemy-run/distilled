...
export const queryReports: API.OperationMethod<QueryReportsRequest, QueryReportsResponse, QueryReportsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const insertGroupItems: API.OperationMethod<InsertGroupItemsRequest, InsertGroupItemsResponse, InsertGroupItemsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const deleteGroupItems: API.OperationMethod<DeleteGroupItemsRequest, DeleteGroupItemsResponse, DeleteGroupItemsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listGroupItems: API.OperationMethod<ListGroupItemsRequest, ListGroupItemsResponse_Op, ListGroupItemsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
