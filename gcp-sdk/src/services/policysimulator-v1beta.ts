...
export const GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse: Schema.Schema<GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse> = Schema.suspend(() => Schema.Struct({
  orgPolicyViolationsPreviews: Schema.optional(Schema.Array(GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse" }) as any as Schema.Schema<GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse>;
...
export const GoogleCloudPolicysimulatorV1betaResourceContext: Schema.Schema<GoogleCloudPolicysimulatorV1betaResourceContext> = Schema.suspend(() => Schema.Struct({
  resource: Schema.optional(Schema.String),
  assetType: Schema.optional(Schema.String),
  ancestors: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "GoogleCloudPolicysimulatorV1betaResourceContext" }) as any as Schema.Schema<GoogleCloudPolicysimulatorV1betaResourceContext>;
...
export const GoogleCloudPolicysimulatorV1betaOrgPolicyViolation: Schema.Schema<GoogleCloudPolicysimulatorV1betaOrgPolicyViolation> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  resource: Schema.optional(GoogleCloudPolicysimulatorV1betaResourceContext),
  customConstraint: Schema.optional(GoogleCloudOrgpolicyV2CustomConstraint),
  error: Schema.optional(GoogleRpcStatus),
})).annotate({ identifier: "GoogleCloudPolicysimulatorV1betaOrgPolicyViolation" }) as any as Schema.Schema<GoogleCloudPolicysimulatorV1betaOrgPolicyViolation>;
...
export const GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse: Schema.Schema<GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse> = Schema.suspend(() => Schema.Struct({
  orgPolicyViolations: Schema.optional(Schema.Array(GoogleCloudPolicysimulatorV1betaOrgPolicyViolation)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse" }) as any as Schema.Schema<GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse>;
...
export const GoogleCloudPolicysimulatorV1betaReplayConfig: Schema.Schema<GoogleCloudPolicysimulatorV1betaReplayConfig> = Schema.suspend(() => Schema.Struct({
  policyOverlay: Schema.optional(Schema.Record(Schema.String, GoogleIamV1Policy)),
  logSource: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudPolicysimulatorV1betaReplayConfig" }) as any as Schema.Schema<GoogleCloudPolicysimulatorV1betaReplayConfig>;
...
export const GoogleCloudPolicysimulatorV1betaReplayResultsSummary: Schema.Schema<GoogleCloudPolicysimulatorV1betaReplayResultsSummary> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudPolicysimulatorV1betaReplayResultsSummary" }) as any as Schema.Schema<GoogleCloudPolicysimulatorV1betaReplayResultsSummary>;
...
export const GoogleCloudPolicysimulatorV1betaReplay: Schema.Schema<GoogleCloudPolicysimulatorV1betaReplay> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  state: Schema.optional(Schema.String),
  config: Schema.optional(GoogleCloudPolicysimulatorV1betaReplayConfig),
  resultsSummary: Schema.optional(GoogleCloudPolicysimulatorV1betaReplayResultsSummary),
})).annotate({ identifier: "GoogleCloudPolicysimulatorV1betaReplay" }) as any as Schema.Schema<GoogleCloudPolicysimulatorV1betaReplay>;
...
export const GoogleCloudPolicysimulatorV1betaListReplaysResponse: Schema.Schema<GoogleCloudPolicysimulatorV1betaListReplaysResponse> = Schema.suspend(() => Schema.Struct({
  replays: Schema.optional(Schema.Array(GoogleCloudPolicysimulatorV1betaReplay)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudPolicysimulatorV1betaListReplaysResponse" }) as any as Schema.Schema<GoogleCloudPolicysimulatorV1betaListReplaysResponse>;
...
export const GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembership: Schema.Schema<GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembership> = Schema.suspend(() => Schema.Struct({
  membership: Schema.optional(Schema.String),
  relevance: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembership" }) as any as Schema.Schema<GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembership>;
...
export interface GoogleCloudPolicysimulatorV1betaBindingExplanation {
  ...
  memberships?: Record<string, GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembership>;
...
export const GoogleCloudPolicysimulatorV1betaBindingExplanation: Schema.Schema<GoogleCloudPolicysimulatorV1betaBindingExplanation> = Schema.suspend(() => Schema.Struct({
  access: Schema.optional(Schema.String),
  role: Schema.optional(Schema.String),
  rolePermission: Schema.optional(Schema.String),
  rolePermissionRelevance: Schema.optional(Schema.String),
  memberships: Schema.optional(Schema.Record(Schema.String, GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembership)),
  relevance: Schema.optional(Schema.String),
  condition: Schema.optional(GoogleTypeExpr),
})).annotate({ identifier: "GoogleCloudPolicysimulatorV1betaBindingExplanation" }) as any as Schema.Schema<GoogleCloudPolicysimulatorV1betaBindingExplanation>;
...
export const GoogleCloudPolicysimulatorV1betaExplainedPolicy: Schema.Schema<GoogleCloudPolicysimulatorV1betaExplainedPolicy> = Schema.suspend(() => Schema.Struct({
  access: Schema.optional(Schema.String),
  fullResourceName: Schema.optional(Schema.String),
  policy: Schema.optional(GoogleIamV1Policy),
  bindingExplanations: Schema.optional(Schema.Array(GoogleCloudPolicysimulatorV1betaBindingExplanation)),
  relevance: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudPolicysimulatorV1betaExplainedPolicy" }) as any as Schema.Schema<GoogleCloudPolicysimulatorV1betaExplainedPolicy>;
...
export const GoogleCloudPolicysimulatorV1betaExplainedAccess: Schema.Schema<GoogleCloudPolicysimulatorV1betaExplainedAccess> = Schema.suspend(() => Schema.Struct({
  accessState: Schema.optional(Schema.String),
  policies: Schema.optional(Schema.Array(GoogleCloudPolicysimulatorV1betaExplainedPolicy)),
  errors: Schema.optional(Schema.Array(GoogleRpcStatus)),
})).annotate({ identifier: "GoogleCloudPolicysimulatorV1betaExplainedAccess" }) as any as Schema.Schema<GoogleCloudPolicysimulatorV1betaExplainedAccess>;
...
export const GoogleCloudPolicysimulatorV1betaAccessStateDiff: Schema.Schema<GoogleCloudPolicysimulatorV1betaAccessStateDiff> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudPolicysimulatorV1betaAccessStateDiff" }) as any as Schema.Schema<GoogleCloudPolicysimulatorV1betaAccessStateDiff>;
...
export const GoogleCloudPolicysimulatorV1betaReplayDiff: Schema.Schema<GoogleCloudPolicysimulatorV1betaReplayDiff> = Schema.suspend(() => Schema.Struct({
  accessDiff: Schema.optional(GoogleCloudPolicysimulatorV1betaAccessStateDiff),
})).annotate({ identifier: "GoogleCloudPolicysimulatorV1betaReplayDiff" }) as any as Schema.Schema<GoogleCloudPolicysimulatorV1betaReplayDiff>;
...
export const GoogleCloudPolicysimulatorV1betaAccessTuple: Schema.Schema<GoogleCloudPolicysimulatorV1betaAccessTuple> = Schema.suspend(() => Schema.Struct({
  principal: Schema.optional(Schema.String),
  fullResourceName: Schema.optional(Schema.String),
  permission: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudPolicysimulatorV1betaAccessTuple" }) as any as Schema.Schema<GoogleCloudPolicysimulatorV1betaAccessTuple>;
...
export const GoogleCloudPolicysimulatorV1betaReplayResult: Schema.Schema<GoogleCloudPolicysimulatorV1betaReplayResult> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudPolicysimulatorV1betaReplayResult" }) as any as Schema.Schema<GoogleCloudPolicysimulatorV1betaReplayResult>;
...
export const GoogleCloudPolicysimulatorV1betaListReplayResultsResponse: Schema.Schema<GoogleCloudPolicysimulatorV1betaListReplayResultsResponse> = Schema.suspend(() => Schema.Struct({
  replayResults: Schema.optional(Schema.Array(GoogleCloudPolicysimulatorV1betaReplayResult)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudPolicysimulatorV1betaListReplayResultsResponse" }) as any as Schema.Schema<GoogleCloudPolicysimulatorV1betaListReplayResultsResponse>;
...
export const GetProjectsLocationsOrgPolicyViolationsPreviewsOperationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/projects/{projectsId}/locations/{locationsId}/orgPolicyViolationsPreviews/{orgPolicyViolationsPreviewsId}/operations/{operationsId}" }),
  svc,
...
export const GetProjectsLocationsAccessPolicySimulationsOperationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/projects/{projectsId}/locations/{locationsId}/accessPolicySimulations/{accessPolicySimulationsId}/operations/{operationsId}" }),
  svc,
...
export const ListProjectsLocationsReplaysRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta/projects/{projectsId}/locations/{locationsId}/replays" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsReplaysRequest>;

export type ListProjectsLocationsReplaysResponse = GoogleCloudPolicysimulatorV1betaListReplaysResponse;
export const ListProjectsLocationsReplaysResponse = GoogleCloudPolicysimulatorV1betaListReplaysResponse;
...
export const listProjectsLocationsReplays: API.PaginatedOperationMethod<ListProjectsLocationsReplaysRequest, ListProjectsLocationsReplaysResponse, ListProjectsLocationsReplaysError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsReplaysRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/projects/{projectsId}/locations/{locationsId}/replays/{replaysId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsReplaysRequest>;

export type GetProjectsLocationsReplaysResponse = GoogleCloudPolicysimulatorV1betaReplay;
export const GetProjectsLocationsReplaysResponse = GoogleCloudPolicysimulatorV1betaReplay;

export type GetProjectsLocationsReplaysError = DefaultErrors;

/** Gets the specified Replay. Each `Replay` is available for at least 7 days. */
export const getProjectsLocationsReplays: API.OperationMethod<GetProjectsLocationsReplaysRequest, GetProjectsLocationsReplaysResponse, GetProjectsLocationsReplaysError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsReplaysRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudPolicysimulatorV1betaReplay).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta/projects/{projectsId}/locations/{locationsId}/replays", hasBody: true }),
  svc,
...
export const createProjectsLocationsReplays: API.OperationMethod<CreateProjectsLocationsReplaysRequest, CreateProjectsLocationsReplaysResponse, CreateProjectsLocationsReplaysError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsReplaysOperationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/projects/{projectsId}/locations/{locationsId}/replays/{replaysId}/operations" }),
  svc,
...
export const GetProjectsLocationsReplaysOperationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/projects/{projectsId}/locations/{locationsId}/replays/{replaysId}/operations/{operationsId}" }),
  svc,
...
export const ListProjectsLocationsReplaysResultsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/projects/{projectsId}/locations/{locationsId}/replays/{replaysId}/results" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsReplaysResultsRequest>;

export type ListProjectsLocationsReplaysResultsResponse = GoogleCloudPolicysimulatorV1betaListReplayResultsResponse;
export const ListProjectsLocationsReplaysResultsResponse = GoogleCloudPolicysimulatorV1betaListReplayResultsResponse;

export type ListProjectsLocationsReplaysResultsError = DefaultErrors;

/** Lists the results of running a Replay. */
export const listProjectsLocationsReplaysResults: API.PaginatedOperationMethod<ListProjectsLocationsReplaysResultsRequest, ListProjectsLocationsReplaysResultsResponse, ListProjectsLocationsReplaysResultsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetFoldersLocationsOrgPolicyViolationsPreviewsOperationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/folders/{foldersId}/locations/{locationsId}/orgPolicyViolationsPreviews/{orgPolicyViolationsPreviewsId}/operations/{operationsId}" }),
  svc,
...
export const GetFoldersLocationsAccessPolicySimulationsOperationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/folders/{foldersId}/locations/{locationsId}/accessPolicySimulations/{accessPolicySimulationsId}/operations/{operationsId}" }),
  svc,
...
export const ListFoldersLocationsReplaysRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta/folders/{foldersId}/locations/{locationsId}/replays" }),
  svc,
) as unknown as Schema.Schema<ListFoldersLocationsReplaysRequest>;

export type ListFoldersLocationsReplaysResponse = GoogleCloudPolicysimulatorV1betaListReplaysResponse;
export const ListFoldersLocationsReplaysResponse = GoogleCloudPolicysimulatorV1betaListReplaysResponse;

export type ListFoldersLocationsReplaysError = DefaultErrors;

/** Lists each Replay in a project, folder, or organization. Each `Replay` is available for at least 7 days. */
export const listFoldersLocationsReplays: API.PaginatedOperationMethod<ListFoldersLocationsReplaysRequest, ListFoldersLocationsReplaysResponse, ListFoldersLocationsReplaysError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetFoldersLocationsReplaysRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/folders/{foldersId}/locations/{locationsId}/replays/{replaysId}" }),
  svc,
) as unknown as Schema.Schema<GetFoldersLocationsReplaysRequest>;

export type GetFoldersLocationsReplaysResponse = GoogleCloudPolicysimulatorV1betaReplay;
export const GetFoldersLocationsReplaysResponse = GoogleCloudPolicysimulatorV1betaReplay;

export type GetFoldersLocationsReplaysError = DefaultErrors;

/** Gets the specified Replay. Each `Replay` is available for at least 7 days. */
export const getFoldersLocationsReplays: API.OperationMethod<GetFoldersLocationsReplaysRequest, GetFoldersLocationsReplaysResponse, GetFoldersLocationsReplaysError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateFoldersLocationsReplaysRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta/folders/{foldersId}/locations/{locationsId}/replays", hasBody: true }),
  svc,
...
/** Creates and starts a Replay using the given ReplayConfig. */
export const createFoldersLocationsReplays: API.OperationMethod<CreateFoldersLocationsReplaysRequest, CreateFoldersLocationsReplaysResponse, CreateFoldersLocationsReplaysError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListFoldersLocationsReplaysOperationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/folders/{foldersId}/locations/{locationsId}/replays/{replaysId}/operations" }),
  svc,
...
export const GetFoldersLocationsReplaysOperationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/folders/{foldersId}/locations/{locationsId}/replays/{replaysId}/operations/{operationsId}" }),
  svc,
...
export const ListFoldersLocationsReplaysResultsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/folders/{foldersId}/locations/{locationsId}/replays/{replaysId}/results" }),
  svc,
) as unknown as Schema.Schema<ListFoldersLocationsReplaysResultsRequest>;

export type ListFoldersLocationsReplaysResultsResponse = GoogleCloudPolicysimulatorV1betaListReplayResultsResponse;
export const ListFoldersLocationsReplaysResultsResponse = GoogleCloudPolicysimulatorV1betaListReplayResultsResponse;

export type ListFoldersLocationsReplaysResultsError = DefaultErrors;

/** Lists the results of running a Replay. */
export const listFoldersLocationsReplaysResults: API.PaginatedOperationMethod<ListFoldersLocationsReplaysResultsRequest, ListFoldersLocationsReplaysResultsResponse, ListFoldersLocationsReplaysResultsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetOrganizationsLocationsAccessPolicySimulationsOperationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/organizations/{organizationsId}/locations/{locationsId}/accessPolicySimulations/{accessPolicySimulationsId}/operations/{operationsId}" }),
  svc,
...
export const ListOrganizationsLocationsOrgPolicyViolationsPreviewsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/organizations/{organizationsId}/locations/{locationsId}/orgPolicyViolationsPreviews" }),
  svc,
) as unknown as Schema.Schema<ListOrganizationsLocationsOrgPolicyViolationsPreviewsRequest>;

export type ListOrganizationsLocationsOrgPolicyViolationsPreviewsResponse = GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse;
export const ListOrganizationsLocationsOrgPolicyViolationsPreviewsResponse = GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse;

export type ListOrganizationsLocationsOrgPolicyViolationsPreviewsError = DefaultErrors;
...
export const GetOrganizationsLocationsOrgPolicyViolationsPreviewsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/organizations/{organizationsId}/locations/{locationsId}/orgPolicyViolationsPreviews/{orgPolicyViolationsPreviewsId}" }),
  svc,
) as unknown as Schema.Schema<GetOrganizationsLocationsOrgPolicyViolationsPreviewsRequest>;

export type GetOrganizationsLocationsOrgPolicyViolationsPreviewsResponse = GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview;
export const GetOrganizationsLocationsOrgPolicyViolationsPreviewsResponse = GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview;

export type GetOrganizationsLocationsOrgPolicyViolationsPreviewsError = DefaultErrors;
...
export const GenerateOrganizationsLocationsOrgPolicyViolationsPreviewsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta/organizations/{organizationsId}/locations/{locationsId}/orgPolicyViolationsPreviews:generate", hasBody: true }),
  svc,
) as unknown as Schema.Schema<GenerateOrganizationsLocationsOrgPolicyViolationsPreviewsRequest>;

export type GenerateOrganizationsLocationsOrgPolicyViolationsPreviewsResponse = GoogleLongrunningOperation;
export const GenerateOrganizationsLocationsOrgPolicyViolationsPreviewsResponse = GoogleLongrunningOperation;

export type GenerateOrganizationsLocationsOrgPolicyViolationsPreviewsError = DefaultErrors;
...
export const generateOrganizationsLocationsOrgPolicyViolationsPreviews: API.OperationMethod<GenerateOrganizationsLocationsOrgPolicyViolationsPreviewsRequest, GenerateOrganizationsLocationsOrgPolicyViolationsPreviewsResponse, GenerateOrganizationsLocationsOrgPolicyViolationsPreviewsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateOrganizationsLocationsOrgPolicyViolationsPreviewsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta/organizations/{organizationsId}/locations/{locationsId}/orgPolicyViolationsPreviews", hasBody: true }),
  svc,
...
export type CreateOrganizationsLocationsOrgPolicyViolationsPreviewsError = DefaultErrors;
...
export const GetOrganizationsLocationsOrgPolicyViolationsPreviewsOperationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/organizations/{organizationsId}/locations/{locationsId}/orgPolicyViolationsPreviews/{orgPolicyViolationsPreviewsId}/operations/{operationsId}" }),
  svc,
...
export const ListOrganizationsLocationsOrgPolicyViolationsPreviewsOrgPolicyViolationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/organizations/{organizationsId}/locations/{locationsId}/orgPolicyViolationsPreviews/{orgPolicyViolationsPreviewsId}/orgPolicyViolations" }),
  svc,
) as unknown as Schema.Schema<ListOrganizationsLocationsOrgPolicyViolationsPreviewsOrgPolicyViolationsRequest>;

export type ListOrganizationsLocationsOrgPolicyViolationsPreviewsOrgPolicyViolationsResponse = GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse;
export const ListOrganizationsLocationsOrgPolicyViolationsPreviewsOrgPolicyViolationsResponse = GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse;

export type ListOrganizationsLocationsOrgPolicyViolationsPreviewsOrgPolicyViolationsError = DefaultErrors;
...
export const ListOrganizationsLocationsReplaysRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta/organizations/{organizationsId}/locations/{locationsId}/replays" }),
  svc,
) as unknown as Schema.Schema<ListOrganizationsLocationsReplaysRequest>;

export type ListOrganizationsLocationsReplaysResponse = GoogleCloudPolicysimulatorV1betaListReplaysResponse;
export const ListOrganizationsLocationsReplaysResponse = GoogleCloudPolicysimulatorV1betaListReplaysResponse;

export type ListOrganizationsLocationsReplaysError = DefaultErrors;

/** Lists each Replay in a project, folder, or organization. Each `Replay` is available for at least 7 days. */
export const listOrganizationsLocationsReplays: API.PaginatedOperationMethod<ListOrganizationsLocationsReplaysRequest, ListOrganizationsLocationsReplaysResponse, ListOrganizationsLocationsReplaysError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetOrganizationsLocationsReplaysRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/organizations/{organizationsId}/locations/{locationsId}/replays/{replaysId}" }),
  svc,
) as unknown as Schema.Schema<GetOrganizationsLocationsReplaysRequest>;

export type GetOrganizationsLocationsReplaysResponse = GoogleCloudPolicysimulatorV1betaReplay;
export const GetOrganizationsLocationsReplaysResponse = GoogleCloudPolicysimulatorV1betaReplay;

export type GetOrganizationsLocationsReplaysError = DefaultErrors;

/** Gets the specified Replay. Each `Replay` is available for at least 7 days. */
export const getOrganizationsLocationsReplays: API.OperationMethod<GetOrganizationsLocationsReplaysRequest, GetOrganizationsLocationsReplaysResponse, GetOrganizationsLocationsReplaysError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateOrganizationsLocationsReplaysRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta/organizations/{organizationsId}/locations/{locationsId}/replays", hasBody: true }),
  svc,
...
/** Creates and starts a Replay using the given ReplayConfig. */
export const createOrganizationsLocationsReplays: API.OperationMethod<CreateOrganizationsLocationsReplaysRequest, CreateOrganizationsLocationsReplaysResponse, CreateOrganizationsLocationsReplaysError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListOrganizationsLocationsReplaysOperationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/organizations/{organizationsId}/locations/{locationsId}/replays/{replaysId}/operations" }),
  svc,
...
export const GetOrganizationsLocationsReplaysOperationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/organizations/{organizationsId}/locations/{locationsId}/replays/{replaysId}/operations/{operationsId}" }),
  svc,
...
export const ListOrganizationsLocationsReplaysResultsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/organizations/{organizationsId}/locations/{locationsId}/replays/{replaysId}/results" }),
  svc,
) as unknown as Schema.Schema<ListOrganizationsLocationsReplaysResultsRequest>;

export type ListOrganizationsLocationsReplaysResultsResponse = GoogleCloudPolicysimulatorV1betaListReplayResultsResponse;
export const ListOrganizationsLocationsReplaysResultsResponse = GoogleCloudPolicysimulatorV1betaListReplayResultsResponse;

export type ListOrganizationsLocationsReplaysResultsError = DefaultErrors;

/** Lists the results of running a Replay. */
export const listOrganizationsLocationsReplaysResults: API.PaginatedOperationMethod<ListOrganizationsLocationsReplaysResultsRequest, ListOrganizationsLocationsReplaysResultsResponse, ListOrganizationsLocationsReplaysResultsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
