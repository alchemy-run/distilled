...
/** Creates a new query. */
export const createQueries: API.OperationMethod<CreateQueriesRequest, CreateQueriesResponse, CreateQueriesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const deleteQueries: API.OperationMethod<DeleteQueriesRequest, DeleteQueriesResponse, DeleteQueriesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
/** Retrieves a query. */
export const getQueries: API.OperationMethod<GetQueriesRequest, GetQueriesResponse, GetQueriesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listQueries: API.PaginatedOperationMethod<ListQueriesRequest, ListQueriesResponse_Op, ListQueriesError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const runQueries: API.OperationMethod<RunQueriesRequest, RunQueriesResponse, RunQueriesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listQueriesReports: API.PaginatedOperationMethod<ListQueriesReportsRequest, ListQueriesReportsResponse, ListQueriesReportsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
/** Retrieves a report. */
export const getQueriesReports: API.OperationMethod<GetQueriesReportsRequest, GetQueriesReportsResponse, GetQueriesReportsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
