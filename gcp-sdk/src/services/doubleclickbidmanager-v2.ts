...
export const DataRange: Schema.Schema<DataRange> = Schema.suspend(() =>
  Schema.Struct({
...
export const QueryMetadata: Schema.Schema<QueryMetadata> = Schema.suspend(() =>
  Schema.Struct({
...
export const FilterPair: Schema.Schema<FilterPair> = Schema.suspend(() =>
  Schema.Struct({
...
export const Parameters: Schema.Schema<Parameters> = Schema.suspend(() =>
  Schema.Struct({
    type: Schema.optional(Schema.String),
...
export const QuerySchedule: Schema.Schema<QuerySchedule> = Schema.suspend(() =>
  Schema.Struct({
...
export const ReportKey: Schema.Schema<ReportKey> = Schema.suspend(() =>
  Schema.Struct({
    queryId: Schema.optional(Schema.String),
...
export const ReportStatus: Schema.Schema<ReportStatus> = Schema.suspend(() =>
  Schema.Struct({
...
export const ReportMetadata: Schema.Schema<ReportMetadata> = Schema.suspend(
  () =>
    Schema.Struct({
...
export const DeleteQueriesResponse: Schema.Schema<DeleteQueriesResponse> =
  Schema.Struct({}) as any as Schema.Schema<DeleteQueriesResponse>;
