...
export const GetAccountsNotificationsubscriptionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "notifications/v1beta/accounts/{accountsId}/notificationsubscriptions/{notificationsubscriptionsId}" }),
  svc,
...
export const PatchAccountsNotificationsubscriptionsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "notifications/v1beta/accounts/{accountsId}/notificationsubscriptions/{notificationsubscriptionsId}", hasBody: true }),
  svc,
...
export const DeleteAccountsNotificationsubscriptionsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "notifications/v1beta/accounts/{accountsId}/notificationsubscriptions/{notificationsubscriptionsId}" }),
  svc,
...
export const CreateAccountsNotificationsubscriptionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "notifications/v1beta/accounts/{accountsId}/notificationsubscriptions", hasBody: true }),
  svc,
...
export const ListAccountsNotificationsubscriptionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "notifications/v1beta/accounts/{accountsId}/notificationsubscriptions" }),
  svc,
