...
export const computeInsightsV1: API.OperationMethod<ComputeInsightsV1Request, ComputeInsightsV1Response, ComputeInsightsV1Error, Credentials | HttpClient.HttpClient> = API.make(() => ({
