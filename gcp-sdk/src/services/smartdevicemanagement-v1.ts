...
export const listEnterprisesDevices: API.OperationMethod<ListEnterprisesDevicesRequest, ListEnterprisesDevicesResponse, ListEnterprisesDevicesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const executeCommandEnterprisesDevices: API.OperationMethod<ExecuteCommandEnterprisesDevicesRequest, ExecuteCommandEnterprisesDevicesResponse, ExecuteCommandEnterprisesDevicesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const getEnterprisesStructures: API.OperationMethod<GetEnterprisesStructuresRequest, GetEnterprisesStructuresResponse, GetEnterprisesStructuresError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listEnterprisesStructures: API.OperationMethod<ListEnterprisesStructuresRequest, ListEnterprisesStructuresResponse, ListEnterprisesStructuresError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const getEnterprisesStructuresRooms: API.OperationMethod<GetEnterprisesStructuresRoomsRequest, GetEnterprisesStructuresRoomsResponse, GetEnterprisesStructuresRoomsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listEnterprisesStructuresRooms: API.OperationMethod<ListEnterprisesStructuresRoomsRequest, ListEnterprisesStructuresRoomsResponse, ListEnterprisesStructuresRoomsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
