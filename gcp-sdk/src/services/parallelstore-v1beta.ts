...
export const PatchProjectsLocationsInstancesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1beta/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}", hasBody: true }),
  svc,
...
export const ImportDataProjectsLocationsInstancesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:importData", hasBody: true }),
  svc,
...
export const importDataProjectsLocationsInstances: API.OperationMethod<ImportDataProjectsLocationsInstancesRequest, ImportDataProjectsLocationsInstancesResponse, ImportDataProjectsLocationsInstancesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ExportDataProjectsLocationsInstancesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:exportData", hasBody: true }),
  svc,
...
export const exportDataProjectsLocationsInstances: API.OperationMethod<ExportDataProjectsLocationsInstancesRequest, ExportDataProjectsLocationsInstancesResponse, ExportDataProjectsLocationsInstancesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
