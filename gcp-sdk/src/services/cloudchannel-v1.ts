...
export const checkCloudIdentityAccountsExistAccounts: API.OperationMethod<CheckCloudIdentityAccountsExistAccountsRequest, CheckCloudIdentityAccountsExistAccountsResponse, CheckCloudIdentityAccountsExistAccountsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listSubscribersAccounts: API.PaginatedOperationMethod<ListSubscribersAccountsRequest, ListSubscribersAccountsResponse, ListSubscribersAccountsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const registerAccounts: API.OperationMethod<RegisterAccountsRequest, RegisterAccountsResponse, RegisterAccountsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listTransferableSkusAccounts: API.OperationMethod<ListTransferableSkusAccountsRequest, ListTransferableSkusAccountsResponse, ListTransferableSkusAccountsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listTransferableOffersAccounts: API.OperationMethod<ListTransferableOffersAccountsRequest, ListTransferableOffersAccountsResponse, ListTransferableOffersAccountsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const unregisterAccounts: API.OperationMethod<UnregisterAccountsRequest, UnregisterAccountsResponse, UnregisterAccountsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const fetchReportResultsAccountsReportJobs: API.OperationMethod<FetchReportResultsAccountsReportJobsRequest, FetchReportResultsAccountsReportJobsResponse, FetchReportResultsAccountsReportJobsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listAccountsOffers: API.PaginatedOperationMethod<ListAccountsOffersRequest, ListAccountsOffersResponse, ListAccountsOffersError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const listAccountsReports: API.PaginatedOperationMethod<ListAccountsReportsRequest, ListAccountsReportsResponse, ListAccountsReportsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const runAccountsReports: API.OperationMethod<RunAccountsReportsRequest, RunAccountsReportsResponse, RunAccountsReportsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const createAccountsCustomers: API.OperationMethod<CreateAccountsCustomersRequest, CreateAccountsCustomersResponse, CreateAccountsCustomersError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const transferEntitlementsAccountsCustomers: API.OperationMethod<TransferEntitlementsAccountsCustomersRequest, TransferEntitlementsAccountsCustomersResponse, TransferEntitlementsAccountsCustomersError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const getAccountsCustomers: API.OperationMethod<GetAccountsCustomersRequest, GetAccountsCustomersResponse, GetAccountsCustomersError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listAccountsCustomers: API.PaginatedOperationMethod<ListAccountsCustomersRequest, ListAccountsCustomersResponse, ListAccountsCustomersError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const listPurchasableOffersAccountsCustomers: API.PaginatedOperationMethod<ListPurchasableOffersAccountsCustomersRequest, ListPurchasableOffersAccountsCustomersResponse, ListPurchasableOffersAccountsCustomersError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const transferEntitlementsToGoogleAccountsCustomers: API.OperationMethod<TransferEntitlementsToGoogleAccountsCustomersRequest, TransferEntitlementsToGoogleAccountsCustomersResponse, TransferEntitlementsToGoogleAccountsCustomersError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const queryEligibleBillingAccountsAccountsCustomers: API.OperationMethod<QueryEligibleBillingAccountsAccountsCustomersRequest, QueryEligibleBillingAccountsAccountsCustomersResponse, QueryEligibleBillingAccountsAccountsCustomersError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listPurchasableSkusAccountsCustomers: API.PaginatedOperationMethod<ListPurchasableSkusAccountsCustomersRequest, ListPurchasableSkusAccountsCustomersResponse, ListPurchasableSkusAccountsCustomersError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const deleteAccountsCustomers: API.OperationMethod<DeleteAccountsCustomersRequest, DeleteAccountsCustomersResponse, DeleteAccountsCustomersError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const patchAccountsCustomers: API.OperationMethod<PatchAccountsCustomersRequest, PatchAccountsCustomersResponse, PatchAccountsCustomersError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const provisionCloudIdentityAccountsCustomers: API.OperationMethod<ProvisionCloudIdentityAccountsCustomersRequest, ProvisionCloudIdentityAccountsCustomersResponse, ProvisionCloudIdentityAccountsCustomersError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const importAccountsCustomers: API.OperationMethod<ImportAccountsCustomersRequest, ImportAccountsCustomersResponse, ImportAccountsCustomersError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const getAccountsCustomersEntitlements: API.OperationMethod<GetAccountsCustomersEntitlementsRequest, GetAccountsCustomersEntitlementsResponse, GetAccountsCustomersEntitlementsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export type ChangeRenewalSettingsAccountsCustomersEntitlementsError = DefaultErrors;
...
export const changeRenewalSettingsAccountsCustomersEntitlements: API.OperationMethod<ChangeRenewalSettingsAccountsCustomersEntitlementsRequest, ChangeRenewalSettingsAccountsCustomersEntitlementsResponse, ChangeRenewalSettingsAccountsCustomersEntitlementsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const createAccountsCustomersEntitlements: API.OperationMethod<CreateAccountsCustomersEntitlementsRequest, CreateAccountsCustomersEntitlementsResponse, CreateAccountsCustomersEntitlementsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const changeParametersAccountsCustomersEntitlements: API.OperationMethod<ChangeParametersAccountsCustomersEntitlementsRequest, ChangeParametersAccountsCustomersEntitlementsResponse, ChangeParametersAccountsCustomersEntitlementsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const cancelAccountsCustomersEntitlements: API.OperationMethod<CancelAccountsCustomersEntitlementsRequest, CancelAccountsCustomersEntitlementsResponse, CancelAccountsCustomersEntitlementsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listAccountsCustomersEntitlements: API.PaginatedOperationMethod<ListAccountsCustomersEntitlementsRequest, ListAccountsCustomersEntitlementsResponse, ListAccountsCustomersEntitlementsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const changeOfferAccountsCustomersEntitlements: API.OperationMethod<ChangeOfferAccountsCustomersEntitlementsRequest, ChangeOfferAccountsCustomersEntitlementsResponse, ChangeOfferAccountsCustomersEntitlementsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const suspendAccountsCustomersEntitlements: API.OperationMethod<SuspendAccountsCustomersEntitlementsRequest, SuspendAccountsCustomersEntitlementsResponse, SuspendAccountsCustomersEntitlementsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const activateAccountsCustomersEntitlements: API.OperationMethod<ActivateAccountsCustomersEntitlementsRequest, ActivateAccountsCustomersEntitlementsResponse, ActivateAccountsCustomersEntitlementsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const lookupOfferAccountsCustomersEntitlements: API.OperationMethod<LookupOfferAccountsCustomersEntitlementsRequest, LookupOfferAccountsCustomersEntitlementsResponse, LookupOfferAccountsCustomersEntitlementsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const startPaidServiceAccountsCustomersEntitlements: API.OperationMethod<StartPaidServiceAccountsCustomersEntitlementsRequest, StartPaidServiceAccountsCustomersEntitlementsResponse, StartPaidServiceAccountsCustomersEntitlementsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export type ListEntitlementChangesAccountsCustomersEntitlementsError = DefaultErrors;
...
export const listEntitlementChangesAccountsCustomersEntitlements: API.PaginatedOperationMethod<ListEntitlementChangesAccountsCustomersEntitlementsRequest, ListEntitlementChangesAccountsCustomersEntitlementsResponse, ListEntitlementChangesAccountsCustomersEntitlementsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const listAccountsCustomersCustomerRepricingConfigs: API.PaginatedOperationMethod<ListAccountsCustomersCustomerRepricingConfigsRequest, ListAccountsCustomersCustomerRepricingConfigsResponse, ListAccountsCustomersCustomerRepricingConfigsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const patchAccountsCustomersCustomerRepricingConfigs: API.OperationMethod<PatchAccountsCustomersCustomerRepricingConfigsRequest, PatchAccountsCustomersCustomerRepricingConfigsResponse, PatchAccountsCustomersCustomerRepricingConfigsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const getAccountsCustomersCustomerRepricingConfigs: API.OperationMethod<GetAccountsCustomersCustomerRepricingConfigsRequest, GetAccountsCustomersCustomerRepricingConfigsResponse, GetAccountsCustomersCustomerRepricingConfigsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export type CreateAccountsCustomersCustomerRepricingConfigsError = DefaultErrors;
...
export const createAccountsCustomersCustomerRepricingConfigs: API.OperationMethod<CreateAccountsCustomersCustomerRepricingConfigsRequest, CreateAccountsCustomersCustomerRepricingConfigsResponse, CreateAccountsCustomersCustomerRepricingConfigsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export type DeleteAccountsCustomersCustomerRepricingConfigsError = DefaultErrors;
...
export const deleteAccountsCustomersCustomerRepricingConfigs: API.OperationMethod<DeleteAccountsCustomersCustomerRepricingConfigsRequest, DeleteAccountsCustomersCustomerRepricingConfigsResponse, DeleteAccountsCustomersCustomerRepricingConfigsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const getAccountsChannelPartnerLinks: API.OperationMethod<GetAccountsChannelPartnerLinksRequest, GetAccountsChannelPartnerLinksResponse, GetAccountsChannelPartnerLinksError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const createAccountsChannelPartnerLinks: API.OperationMethod<CreateAccountsChannelPartnerLinksRequest, CreateAccountsChannelPartnerLinksResponse, CreateAccountsChannelPartnerLinksError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listAccountsChannelPartnerLinks: API.PaginatedOperationMethod<ListAccountsChannelPartnerLinksRequest, ListAccountsChannelPartnerLinksResponse, ListAccountsChannelPartnerLinksError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const patchAccountsChannelPartnerLinks: API.OperationMethod<PatchAccountsChannelPartnerLinksRequest, PatchAccountsChannelPartnerLinksResponse, PatchAccountsChannelPartnerLinksError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
/** List Customers. Possible error codes: * PERMISSION_DENIED: The reseller account making the request is different from the reseller account in the API request. * INVALID_ARGUMENT: Required request parameters are missing or invalid. Return value: List of Customers, or an empty list if there are no customers. */
export const listAccountsChannelPartnerLinksCustomers: API.PaginatedOperationMethod<ListAccountsChannelPartnerLinksCustomersRequest, ListAccountsChannelPartnerLinksCustomersResponse, ListAccountsChannelPartnerLinksCustomersError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
/** Updates an existing Customer resource for the reseller or distributor. Possible error codes: * PERMISSION_DENIED: The reseller account making the request is different from the reseller account in the API request. * INVALID_ARGUMENT: Required request parameters are missing or invalid. * NOT_FOUND: No Customer resource found for the name in the request. Return value: The updated Customer resource. */
export const patchAccountsChannelPartnerLinksCustomers: API.OperationMethod<PatchAccountsChannelPartnerLinksCustomersRequest, PatchAccountsChannelPartnerLinksCustomersResponse, PatchAccountsChannelPartnerLinksCustomersError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
/** Creates a new Customer resource under the reseller or distributor account. Possible error codes: * PERMISSION_DENIED: * The reseller account making the request is different from the reseller account in the API request. * You are not authorized to create a customer. See https://support.google.com/channelservices/answer/9759265 * INVALID_ARGUMENT: * Required request parameters are missing or invalid. * Domain field value doesn't match the primary email domain. Return value: The newly created Customer resource. */
export const createAccountsChannelPartnerLinksCustomers: API.OperationMethod<CreateAccountsChannelPartnerLinksCustomersRequest, CreateAccountsChannelPartnerLinksCustomersResponse, CreateAccountsChannelPartnerLinksCustomersError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
/** Deletes the given Customer permanently. Possible error codes: * PERMISSION_DENIED: The account making the request does not own this customer. * INVALID_ARGUMENT: Required request parameters are missing or invalid. * FAILED_PRECONDITION: The customer has existing entitlements. * NOT_FOUND: No Customer resource found for the name in the request. */
export const deleteAccountsChannelPartnerLinksCustomers: API.OperationMethod<DeleteAccountsChannelPartnerLinksCustomersRequest, DeleteAccountsChannelPartnerLinksCustomersResponse, DeleteAccountsChannelPartnerLinksCustomersError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
/** Returns the requested Customer resource. Possible error codes: * PERMISSION_DENIED: The reseller account making the request is different from the reseller account in the API request. * INVALID_ARGUMENT: Required request parameters are missing or invalid. * NOT_FOUND: The customer resource doesn't exist. Usually the result of an invalid name parameter. Return value: The Customer resource. */
export const getAccountsChannelPartnerLinksCustomers: API.OperationMethod<GetAccountsChannelPartnerLinksCustomersRequest, GetAccountsChannelPartnerLinksCustomersResponse, GetAccountsChannelPartnerLinksCustomersError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
/** Imports a Customer from the Cloud Identity associated with the provided Cloud Identity ID or domain before a TransferEntitlements call. If a linked Customer already exists and overwrite_if_exists is true, it will update that Customer's data. Possible error codes: * PERMISSION_DENIED: * The reseller account making the request is different from the reseller account in the API request. * You are not authorized to import the customer. See https://support.google.com/channelservices/answer/9759265 * NOT_FOUND: Cloud Identity doesn't exist or was deleted. * INVALID_ARGUMENT: Required parameters are missing, or the auth_token is expired or invalid. * ALREADY_EXISTS: A customer already exists and has conflicting critical fields. Requires an overwrite. Return value: The Customer. */
export const importAccountsChannelPartnerLinksCustomers: API.OperationMethod<ImportAccountsChannelPartnerLinksCustomersRequest, ImportAccountsChannelPartnerLinksCustomersResponse, ImportAccountsChannelPartnerLinksCustomersError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export type GetAccountsChannelPartnerLinksChannelPartnerRepricingConfigsError = DefaultErrors;
...
export type CreateAccountsChannelPartnerLinksChannelPartnerRepricingConfigsError = DefaultErrors;
...
export type DeleteAccountsChannelPartnerLinksChannelPartnerRepricingConfigsError = DefaultErrors;
...
export const listAccountsChannelPartnerLinksChannelPartnerRepricingConfigs: API.PaginatedOperationMethod<ListAccountsChannelPartnerLinksChannelPartnerRepricingConfigsRequest, ListAccountsChannelPartnerLinksChannelPartnerRepricingConfigsResponse, ListAccountsChannelPartnerLinksChannelPartnerRepricingConfigsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export type PatchAccountsChannelPartnerLinksChannelPartnerRepricingConfigsError = DefaultErrors;
...
export const listAccountsSkuGroups: API.PaginatedOperationMethod<ListAccountsSkuGroupsRequest, ListAccountsSkuGroupsResponse, ListAccountsSkuGroupsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const listAccountsSkuGroupsBillableSkus: API.PaginatedOperationMethod<ListAccountsSkuGroupsBillableSkusRequest, ListAccountsSkuGroupsBillableSkusResponse, ListAccountsSkuGroupsBillableSkusError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
/** Registers a service account with subscriber privileges on the Pub/Sub topic for this Channel Services account or integrator. After you create a subscriber, you get the events through SubscriberEvent Possible error codes: * PERMISSION_DENIED: The reseller account making the request and the provided reseller account are different, or the impersonated user is not a super admin. * INVALID_ARGUMENT: Required request parameters are missing or invalid. * INTERNAL: Any non-user error related to a technical issue in the backend. Contact Cloud Channel support. * UNKNOWN: Any non-user error related to a technical issue in the backend. Contact Cloud Channel support. Return value: The topic name with the registered service email address. */
export const registerSubscriberIntegrators: API.OperationMethod<RegisterSubscriberIntegratorsRequest, RegisterSubscriberIntegratorsResponse, RegisterSubscriberIntegratorsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
/** Unregisters a service account with subscriber privileges on the Pub/Sub topic created for this Channel Services account or integrator. If there are no service accounts left with subscriber privileges, this deletes the topic. You can call ListSubscribers to check for these accounts. Possible error codes: * PERMISSION_DENIED: The reseller account making the request and the provided reseller account are different, or the impersonated user is not a super admin. * INVALID_ARGUMENT: Required request parameters are missing or invalid. * NOT_FOUND: The topic resource doesn't exist. * INTERNAL: Any non-user error related to a technical issue in the backend. Contact Cloud Channel support. * UNKNOWN: Any non-user error related to a technical issue in the backend. Contact Cloud Channel support. Return value: The topic name that unregistered the service email address. Returns a success response if the service email address wasn't registered with the topic. */
export const unregisterSubscriberIntegrators: API.OperationMethod<UnregisterSubscriberIntegratorsRequest, UnregisterSubscriberIntegratorsResponse, UnregisterSubscriberIntegratorsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
/** Lists service accounts with subscriber privileges on the Pub/Sub topic created for this Channel Services account or integrator. Possible error codes: * PERMISSION_DENIED: The reseller account making the request and the provided reseller account are different, or the impersonated user is not a super admin. * INVALID_ARGUMENT: Required request parameters are missing or invalid. * NOT_FOUND: The topic resource doesn't exist. * INTERNAL: Any non-user error related to a technical issue in the backend. Contact Cloud Channel support. * UNKNOWN: Any non-user error related to a technical issue in the backend. Contact Cloud Channel support. Return value: A list of service email addresses. */
export const listSubscribersIntegrators: API.PaginatedOperationMethod<ListSubscribersIntegratorsRequest, ListSubscribersIntegratorsResponse, ListSubscribersIntegratorsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const listProductsSkus: API.PaginatedOperationMethod<ListProductsSkusRequest, ListProductsSkusResponse, ListProductsSkusError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
