...
export const listRecommenders: API.PaginatedOperationMethod<ListRecommendersRequest, ListRecommendersResponse, ListRecommendersError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const listInsightTypes: API.PaginatedOperationMethod<ListInsightTypesRequest, ListInsightTypesResponse, ListInsightTypesError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
