...
export const showFeedCases: API.PaginatedOperationMethod<ShowFeedCasesRequest, ShowFeedCasesResponse, ShowFeedCasesError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const getCasesAttachments: API.OperationMethod<GetCasesAttachmentsRequest, GetCasesAttachmentsResponse, GetCasesAttachmentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const getCasesComments: API.OperationMethod<GetCasesCommentsRequest, GetCasesCommentsResponse, GetCasesCommentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
