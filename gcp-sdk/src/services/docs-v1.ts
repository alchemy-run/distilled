...
export const createDocuments: API.OperationMethod<CreateDocumentsRequest, CreateDocumentsResponse, CreateDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const batchUpdateDocuments: API.OperationMethod<BatchUpdateDocumentsRequest, BatchUpdateDocumentsResponse, BatchUpdateDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
