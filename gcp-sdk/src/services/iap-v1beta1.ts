...
export const setIamPolicyV1beta1: API.OperationMethod<SetIamPolicyV1beta1Request, SetIamPolicyV1beta1Response, SetIamPolicyV1beta1Error, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const getIamPolicyV1beta1: API.OperationMethod<GetIamPolicyV1beta1Request, GetIamPolicyV1beta1Response, GetIamPolicyV1beta1Error, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const testIamPermissionsV1beta1: API.OperationMethod<TestIamPermissionsV1beta1Request, TestIamPermissionsV1beta1Response, TestIamPermissionsV1beta1Error, Credentials | HttpClient.HttpClient> = API.make(() => ({
