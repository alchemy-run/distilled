...
export const GetAccountsConversionSourcesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "conversions/v1beta/accounts/{accountsId}/conversionSources/{conversionSourcesId}" }),
  svc,
...
export const CreateAccountsConversionSourcesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "conversions/v1beta/accounts/{accountsId}/conversionSources", hasBody: true }),
  svc,
...
export const PatchAccountsConversionSourcesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "conversions/v1beta/accounts/{accountsId}/conversionSources/{conversionSourcesId}", hasBody: true }),
  svc,
...
export const DeleteAccountsConversionSourcesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "conversions/v1beta/accounts/{accountsId}/conversionSources/{conversionSourcesId}" }),
  svc,
...
export const UndeleteAccountsConversionSourcesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "conversions/v1beta/accounts/{accountsId}/conversionSources/{conversionSourcesId}:undelete", hasBody: true }),
  svc,
...
export const ListAccountsConversionSourcesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "conversions/v1beta/accounts/{accountsId}/conversionSources" }),
  svc,
