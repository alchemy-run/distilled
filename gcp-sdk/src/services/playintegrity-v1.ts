...
export const decodeIntegrityTokenV1: API.OperationMethod<DecodeIntegrityTokenV1Request, DecodeIntegrityTokenV1Response, DecodeIntegrityTokenV1Error, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const decodePcIntegrityTokenV1: API.OperationMethod<DecodePcIntegrityTokenV1Request, DecodePcIntegrityTokenV1Response, DecodePcIntegrityTokenV1Error, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const writeDeviceRecall: API.OperationMethod<WriteDeviceRecallRequest_Op, WriteDeviceRecallResponse_Op, WriteDeviceRecallError, Credentials | HttpClient.HttpClient> = API.make(() => ({
