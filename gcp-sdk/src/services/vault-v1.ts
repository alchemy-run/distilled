...
export const MatterPermission: Schema.Schema<MatterPermission> = Schema.suspend(
  () =>
    Schema.Struct({
...
export const Matter: Schema.Schema<Matter> = Schema.suspend(() =>
  Schema.Struct({
...
export const AccountInfo: Schema.Schema<AccountInfo> = Schema.suspend(() =>
  Schema.Struct({
...
export const OrgUnitInfo: Schema.Schema<OrgUnitInfo> = Schema.suspend(() =>
  Schema.Struct({
...
export const SharedDriveInfo: Schema.Schema<SharedDriveInfo> = Schema.suspend(
  () =>
    Schema.Struct({
...
export const HangoutsChatInfo: Schema.Schema<HangoutsChatInfo> = Schema.suspend(
  () =>
    Schema.Struct({
...
export const SitesUrlInfo: Schema.Schema<SitesUrlInfo> = Schema.suspend(() =>
  Schema.Struct({
...
export const DriveDocumentIds: Schema.Schema<DriveDocumentIds> = Schema.suspend(
  () =>
    Schema.Struct({
...
export const TeamDriveInfo: Schema.Schema<TeamDriveInfo> = Schema.suspend(() =>
  Schema.Struct({
...
export const MailOptions: Schema.Schema<MailOptions> = Schema.suspend(() =>
  Schema.Struct({
...
export const DriveOptions: Schema.Schema<DriveOptions> = Schema.suspend(() =>
  Schema.Struct({
...
export const VoiceOptions: Schema.Schema<VoiceOptions> = Schema.suspend(() =>
  Schema.Struct({
...
export const CalendarOptions: Schema.Schema<CalendarOptions> = Schema.suspend(
  () =>
    Schema.Struct({
...
export const GeminiOptions: Schema.Schema<GeminiOptions> = Schema.suspend(() =>
  Schema.Struct({}),
).annotate({
...
export const ExportOptions: Schema.Schema<ExportOptions> = Schema.suspend(() =>
  Schema.Struct({
...
export const ExportStats: Schema.Schema<ExportStats> = Schema.suspend(() =>
  Schema.Struct({
...
export const CloudStorageFile: Schema.Schema<CloudStorageFile> = Schema.suspend(
  () =>
    Schema.Struct({
...
export const CloudStorageSink: Schema.Schema<CloudStorageSink> = Schema.suspend(
  () =>
    Schema.Struct({
...
export const Export: Schema.Schema<Export> = Schema.suspend(() =>
  Schema.Struct({
...
export const HeldAccount: Schema.Schema<HeldAccount> = Schema.suspend(() =>
  Schema.Struct({
    accountId: Schema.optional(Schema.String),
...
export const HeldOrgUnit: Schema.Schema<HeldOrgUnit> = Schema.suspend(() =>
  Schema.Struct({
    orgUnitId: Schema.optional(Schema.String),
    holdTime: Schema.optional(Schema.String),
  }),
...
export const HeldDriveQuery: Schema.Schema<HeldDriveQuery> = Schema.suspend(
  () =>
    Schema.Struct({
...
export const HeldMailQuery: Schema.Schema<HeldMailQuery> = Schema.suspend(() =>
  Schema.Struct({
    terms: Schema.optional(Schema.String),
    startTime: Schema.optional(Schema.String),
    endTime: Schema.optional(Schema.String),
...
export const HeldGroupsQuery: Schema.Schema<HeldGroupsQuery> = Schema.suspend(
  () =>
    Schema.Struct({
      terms: Schema.optional(Schema.String),
      startTime: Schema.optional(Schema.String),
...
export const HeldVoiceQuery: Schema.Schema<HeldVoiceQuery> = Schema.suspend(
  () =>
    Schema.Struct({
      coveredData: Schema.optional(Schema.Array(Schema.String)),
    }),
...
export const CorpusQuery: Schema.Schema<CorpusQuery> = Schema.suspend(() =>
  Schema.Struct({
...
export const Hold: Schema.Schema<Hold> = Schema.suspend(() =>
  Schema.Struct({
...
export const AccountCount: Schema.Schema<AccountCount> = Schema.suspend(() =>
  Schema.Struct({
    account: Schema.optional(UserInfo),
...
export const MailCountResult: Schema.Schema<MailCountResult> = Schema.suspend(
  () =>
    Schema.Struct({
