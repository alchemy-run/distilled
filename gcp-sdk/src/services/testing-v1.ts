...
export const createProjectsTestMatrices: API.OperationMethod<CreateProjectsTestMatricesRequest, CreateProjectsTestMatricesResponse, CreateProjectsTestMatricesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const getProjectsTestMatrices: API.OperationMethod<GetProjectsTestMatricesRequest, GetProjectsTestMatricesResponse, GetProjectsTestMatricesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const cancelProjectsTestMatrices: API.OperationMethod<CancelProjectsTestMatricesRequest, CancelProjectsTestMatricesResponse, CancelProjectsTestMatricesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listProjectsDeviceSessions: API.PaginatedOperationMethod<ListProjectsDeviceSessionsRequest, ListProjectsDeviceSessionsResponse, ListProjectsDeviceSessionsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const createProjectsDeviceSessions: API.OperationMethod<CreateProjectsDeviceSessionsRequest, CreateProjectsDeviceSessionsResponse, CreateProjectsDeviceSessionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const getProjectsDeviceSessions: API.OperationMethod<GetProjectsDeviceSessionsRequest, GetProjectsDeviceSessionsResponse, GetProjectsDeviceSessionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const cancelProjectsDeviceSessions: API.OperationMethod<CancelProjectsDeviceSessionsRequest, CancelProjectsDeviceSessionsResponse, CancelProjectsDeviceSessionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const patchProjectsDeviceSessions: API.OperationMethod<PatchProjectsDeviceSessionsRequest, PatchProjectsDeviceSessionsResponse, PatchProjectsDeviceSessionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const getApkDetailsApplicationDetailService: API.OperationMethod<GetApkDetailsApplicationDetailServiceRequest, GetApkDetailsApplicationDetailServiceResponse, GetApkDetailsApplicationDetailServiceError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const getTestEnvironmentCatalog: API.OperationMethod<GetTestEnvironmentCatalogRequest, GetTestEnvironmentCatalogResponse, GetTestEnvironmentCatalogError, Credentials | HttpClient.HttpClient> = API.make(() => ({
