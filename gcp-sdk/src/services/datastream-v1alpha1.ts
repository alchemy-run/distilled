...
export const fetchErrorsProjectsLocationsStreams: API.OperationMethod<FetchErrorsProjectsLocationsStreamsRequest, FetchErrorsProjectsLocationsStreamsResponse, FetchErrorsProjectsLocationsStreamsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
