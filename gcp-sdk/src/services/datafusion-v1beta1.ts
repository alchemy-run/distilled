...
export interface Instance {
  ...
  state?: "STATE_UNSPECIFIED" | "CREATING" | "RUNNING" | "FAILED" | "DELETING" | "UPGRADING" | "RESTARTING" | "UPDATING" | "AUTO_UPDATING" | "AUTO_UPGRADING" | "DISABLED" | "ENABLING" | (string & {});
...
export const RemoveIamPolicyProjectsLocationsRequest = Schema.Struct({
  resource: Schema.String.pipe(T.HttpPath("resource")),
  body: Schema.optional(RemoveIamPolicyRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/{locationsId1}:removeIamPolicy", hasBody: true }),
  svc,
...
export const RemoveIamPolicyProjectsLocationsResponse = RemoveIamPolicyResponse;
...
export const removeIamPolicyProjectsLocations: API.OperationMethod<RemoveIamPolicyProjectsLocationsRequest, RemoveIamPolicyProjectsLocationsResponse, RemoveIamPolicyProjectsLocationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/versions" }),
  svc,
...
export const listProjectsLocationsVersions: API.PaginatedOperationMethod<ListProjectsLocationsVersionsRequest, ListProjectsLocationsVersionsResponse, ListProjectsLocationsVersionsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const RestartProjectsLocationsInstancesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:restart", hasBody: true }),
  svc,
...
export const restartProjectsLocationsInstances: API.OperationMethod<RestartProjectsLocationsInstancesRequest, RestartProjectsLocationsInstancesResponse, RestartProjectsLocationsInstancesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const SetIamPolicyProjectsLocationsInstancesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:setIamPolicy", hasBody: true }),
  svc,
...
export const GetIamPolicyProjectsLocationsInstancesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:getIamPolicy" }),
  svc,
...
export const TestIamPermissionsProjectsLocationsInstancesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:testIamPermissions", hasBody: true }),
  svc,
...
export interface ListProjectsLocationsInstancesNamespacesRequest {
  ...
  view?: "NAMESPACE_VIEW_UNSPECIFIED" | "NAMESPACE_VIEW_BASIC" | "NAMESPACE_VIEW_FULL" | (string & {});
}

export const ListProjectsLocationsInstancesNamespacesRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  view: Schema.optional(Schema.String).pipe(T.HttpQuery("view")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/namespaces" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsInstancesNamespacesRequest>;

export type ListProjectsLocationsInstancesNamespacesResponse = ListNamespacesResponse;
export const ListProjectsLocationsInstancesNamespacesResponse = ListNamespacesResponse;

export type ListProjectsLocationsInstancesNamespacesError = DefaultErrors;

/** List namespaces in a given instance */
export const listProjectsLocationsInstancesNamespaces: API.PaginatedOperationMethod<ListProjectsLocationsInstancesNamespacesRequest, ListProjectsLocationsInstancesNamespacesResponse, ListProjectsLocationsInstancesNamespacesError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const SetIamPolicyProjectsLocationsInstancesNamespacesRequest = Schema.Struct({
  resource: Schema.String.pipe(T.HttpPath("resource")),
  body: Schema.optional(SetIamPolicyRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/namespaces/{namespacesId}:setIamPolicy", hasBody: true }),
  svc,
...
export const SetIamPolicyProjectsLocationsInstancesNamespacesResponse = Policy;

export type SetIamPolicyProjectsLocationsInstancesNamespacesError = DefaultErrors;

/** Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors. */
export const setIamPolicyProjectsLocationsInstancesNamespaces: API.OperationMethod<SetIamPolicyProjectsLocationsInstancesNamespacesRequest, SetIamPolicyProjectsLocationsInstancesNamespacesResponse, SetIamPolicyProjectsLocationsInstancesNamespacesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetIamPolicyProjectsLocationsInstancesNamespacesRequest = Schema.Struct({
  resource: Schema.String.pipe(T.HttpPath("resource")),
  "options.requestedPolicyVersion": Schema.optional(Schema.Number).pipe(T.HttpQuery("options.requestedPolicyVersion")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/namespaces/{namespacesId}:getIamPolicy" }),
  svc,
...
export const GetIamPolicyProjectsLocationsInstancesNamespacesResponse = Policy;

export type GetIamPolicyProjectsLocationsInstancesNamespacesError = DefaultErrors;

/** Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. */
export const getIamPolicyProjectsLocationsInstancesNamespaces: API.OperationMethod<GetIamPolicyProjectsLocationsInstancesNamespacesRequest, GetIamPolicyProjectsLocationsInstancesNamespacesResponse, GetIamPolicyProjectsLocationsInstancesNamespacesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const TestIamPermissionsProjectsLocationsInstancesNamespacesRequest = Schema.Struct({
  resource: Schema.String.pipe(T.HttpPath("resource")),
  body: Schema.optional(TestIamPermissionsRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/namespaces/{namespacesId}:testIamPermissions", hasBody: true }),
  svc,
) as unknown as Schema.Schema<TestIamPermissionsProjectsLocationsInstancesNamespacesRequest>;

export type TestIamPermissionsProjectsLocationsInstancesNamespacesResponse = TestIamPermissionsResponse;
export const TestIamPermissionsProjectsLocationsInstancesNamespacesResponse = TestIamPermissionsResponse;

export type TestIamPermissionsProjectsLocationsInstancesNamespacesError = DefaultErrors;

/** Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a `NOT_FOUND` error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning. */
export const testIamPermissionsProjectsLocationsInstancesNamespaces: API.OperationMethod<TestIamPermissionsProjectsLocationsInstancesNamespacesRequest, TestIamPermissionsProjectsLocationsInstancesNamespacesResponse, TestIamPermissionsProjectsLocationsInstancesNamespacesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsInstancesDnsPeeringsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/dnsPeerings", hasBody: true }),
  svc,
...
export const createProjectsLocationsInstancesDnsPeerings: API.OperationMethod<CreateProjectsLocationsInstancesDnsPeeringsRequest, CreateProjectsLocationsInstancesDnsPeeringsResponse, CreateProjectsLocationsInstancesDnsPeeringsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsInstancesDnsPeeringsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/dnsPeerings/{dnsPeeringsId}" }),
  svc,
...
export const deleteProjectsLocationsInstancesDnsPeerings: API.OperationMethod<DeleteProjectsLocationsInstancesDnsPeeringsRequest, DeleteProjectsLocationsInstancesDnsPeeringsResponse, DeleteProjectsLocationsInstancesDnsPeeringsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsInstancesDnsPeeringsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/dnsPeerings" }),
  svc,
...
export const listProjectsLocationsInstancesDnsPeerings: API.PaginatedOperationMethod<ListProjectsLocationsInstancesDnsPeeringsRequest, ListProjectsLocationsInstancesDnsPeeringsResponse, ListProjectsLocationsInstancesDnsPeeringsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
