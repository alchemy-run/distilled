...
export const ListProjectsLocationsJobsRequest = Schema.Struct({
  ...
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  legacyAppEngineCron: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("legacyAppEngineCron")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/jobs" }),
  svc,
...
export const GetProjectsLocationsJobsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/jobs/{jobsId}" }),
  svc,
...
export const CreateProjectsLocationsJobsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/jobs", hasBody: true }),
  svc,
...
export const PatchProjectsLocationsJobsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/jobs/{jobsId}", hasBody: true }),
  svc,
...
export const DeleteProjectsLocationsJobsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/jobs/{jobsId}" }),
  svc,
...
export const PauseProjectsLocationsJobsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/jobs/{jobsId}:pause", hasBody: true }),
  svc,
...
export const pauseProjectsLocationsJobs: API.OperationMethod<PauseProjectsLocationsJobsRequest, PauseProjectsLocationsJobsResponse, PauseProjectsLocationsJobsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ResumeProjectsLocationsJobsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/jobs/{jobsId}:resume", hasBody: true }),
  svc,
...
export const resumeProjectsLocationsJobs: API.OperationMethod<ResumeProjectsLocationsJobsRequest, ResumeProjectsLocationsJobsResponse, ResumeProjectsLocationsJobsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const RunProjectsLocationsJobsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/jobs/{jobsId}:run", hasBody: true }),
  svc,
