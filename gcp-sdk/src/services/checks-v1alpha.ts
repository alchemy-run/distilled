...
export const getAccountsReposOperations: API.OperationMethod<GetAccountsReposOperationsRequest, GetAccountsReposOperationsResponse, GetAccountsReposOperationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const getAccountsReposScans: API.OperationMethod<GetAccountsReposScansRequest, GetAccountsReposScansResponse, GetAccountsReposScansError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listAccountsReposScans: API.PaginatedOperationMethod<ListAccountsReposScansRequest, ListAccountsReposScansResponse, ListAccountsReposScansError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const generateAccountsReposScans: API.OperationMethod<GenerateAccountsReposScansRequest, GenerateAccountsReposScansResponse, GenerateAccountsReposScansError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
/** Gets an app. */
export const getAccountsApps: API.OperationMethod<GetAccountsAppsRequest, GetAccountsAppsResponse, GetAccountsAppsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const cancelAccountsAppsOperations: API.OperationMethod<CancelAccountsAppsOperationsRequest, CancelAccountsAppsOperationsResponse, CancelAccountsAppsOperationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const waitAccountsAppsOperations: API.OperationMethod<WaitAccountsAppsOperationsRequest, WaitAccountsAppsOperationsResponse, WaitAccountsAppsOperationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listAccountsAppsOperations: API.PaginatedOperationMethod<ListAccountsAppsOperationsRequest, ListAccountsAppsOperationsResponse, ListAccountsAppsOperationsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
/** Gets the latest state of a long-running operation. Clients can use this method to poll the operation result at intervals as recommended by the API service. */
export const getAccountsAppsOperations: API.OperationMethod<GetAccountsAppsOperationsRequest, GetAccountsAppsOperationsResponse, GetAccountsAppsOperationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const deleteAccountsAppsOperations: API.OperationMethod<DeleteAccountsAppsOperationsRequest, DeleteAccountsAppsOperationsResponse, DeleteAccountsAppsOperationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const getAccountsAppsReports: API.OperationMethod<GetAccountsAppsReportsRequest, GetAccountsAppsReportsResponse, GetAccountsAppsReportsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listAccountsAppsReports: API.PaginatedOperationMethod<ListAccountsAppsReportsRequest, ListAccountsAppsReportsResponse, ListAccountsAppsReportsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const classifyContentAisafety: API.OperationMethod<ClassifyContentAisafetyRequest, ClassifyContentAisafetyResponse, ClassifyContentAisafetyError, Credentials | HttpClient.HttpClient> = API.make(() => ({
