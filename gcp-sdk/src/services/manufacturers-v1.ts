...
export const updateAccountsProducts: API.OperationMethod<UpdateAccountsProductsRequest, UpdateAccountsProductsResponse, UpdateAccountsProductsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const deleteAccountsProducts: API.OperationMethod<DeleteAccountsProductsRequest, DeleteAccountsProductsResponse, DeleteAccountsProductsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const patchAccountsLanguagesProductCertifications: API.OperationMethod<PatchAccountsLanguagesProductCertificationsRequest, PatchAccountsLanguagesProductCertificationsResponse, PatchAccountsLanguagesProductCertificationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listAccountsLanguagesProductCertifications: API.PaginatedOperationMethod<ListAccountsLanguagesProductCertificationsRequest, ListAccountsLanguagesProductCertificationsResponse, ListAccountsLanguagesProductCertificationsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const getAccountsLanguagesProductCertifications: API.OperationMethod<GetAccountsLanguagesProductCertificationsRequest, GetAccountsLanguagesProductCertificationsResponse, GetAccountsLanguagesProductCertificationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const deleteAccountsLanguagesProductCertifications: API.OperationMethod<DeleteAccountsLanguagesProductCertificationsRequest, DeleteAccountsLanguagesProductCertificationsResponse, DeleteAccountsLanguagesProductCertificationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
