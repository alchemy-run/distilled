...
export const queryRecordRecords: API.OperationMethod<QueryRecordRecordsRequest, QueryRecordRecordsResponse, QueryRecordRecordsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const queryHistoryRecordRecords: API.OperationMethod<QueryHistoryRecordRecordsRequest, QueryHistoryRecordRecordsResponse, QueryHistoryRecordRecordsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
