...
export const createManagedShortLinks: API.OperationMethod<CreateManagedShortLinksRequest, CreateManagedShortLinksResponse, CreateManagedShortLinksError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const createShortLinks: API.OperationMethod<CreateShortLinksRequest, CreateShortLinksResponse, CreateShortLinksError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const getLinkStatsV1: API.OperationMethod<GetLinkStatsV1Request, GetLinkStatsV1Response, GetLinkStatsV1Error, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const installAttributionV1: API.OperationMethod<InstallAttributionV1Request, InstallAttributionV1Response, InstallAttributionV1Error, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const reopenAttributionV1: API.OperationMethod<ReopenAttributionV1Request, ReopenAttributionV1Response, ReopenAttributionV1Error, Credentials | HttpClient.HttpClient> = API.make(() => ({
