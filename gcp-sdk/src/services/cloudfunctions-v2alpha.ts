...
export const GoogleCloudFunctionsV2alphaStateMessage: Schema.Schema<GoogleCloudFunctionsV2alphaStateMessage> = Schema.suspend(() => Schema.Struct({
  severity: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  message: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudFunctionsV2alphaStateMessage" }) as any as Schema.Schema<GoogleCloudFunctionsV2alphaStateMessage>;
...
export const Cloudfunctions_Function: Schema.Schema<Cloudfunctions_Function> = Schema.suspend(() => Schema.Struct({
  ...
  stateMessages: Schema.optional(Schema.Array(GoogleCloudFunctionsV2alphaStateMessage)),
...
export const GoogleCloudFunctionsV2alphaStage: Schema.Schema<GoogleCloudFunctionsV2alphaStage> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  message: Schema.optional(Schema.String),
  state: Schema.optional(Schema.String),
  ...
  stateMessages: Schema.optional(Schema.Array(GoogleCloudFunctionsV2alphaStateMessage)),
})).annotate({ identifier: "GoogleCloudFunctionsV2alphaStage" }) as any as Schema.Schema<GoogleCloudFunctionsV2alphaStage>;
...
export const GoogleCloudFunctionsV2alphaOperationMetadata: Schema.Schema<GoogleCloudFunctionsV2alphaOperationMetadata> = Schema.suspend(() => Schema.Struct({
  createTime: Schema.optional(Schema.String),
...
})).annotate({ identifier: "GoogleCloudFunctionsV2alphaOperationMetadata" }) as any as Schema.Schema<GoogleCloudFunctionsV2alphaOperationMetadata>;
...
export const GoogleCloudFunctionsV2alphaLocationMetadata: Schema.Schema<GoogleCloudFunctionsV2alphaLocationMetadata> = Schema.suspend(() => Schema.Struct({
  environments: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "GoogleCloudFunctionsV2alphaLocationMetadata" }) as any as Schema.Schema<GoogleCloudFunctionsV2alphaLocationMetadata>;
...
export const GetProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2alpha/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}" }),
  svc,
...
export const ListProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2alpha/projects/{projectsId}/locations/{locationsId}/functions" }),
  svc,
...
export const CreateProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2alpha/projects/{projectsId}/locations/{locationsId}/functions", hasBody: true }),
  svc,
...
export const PatchProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2alpha/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}", hasBody: true }),
  svc,
...
export const SetupFunctionUpgradeConfigProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2alpha/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:setupFunctionUpgradeConfig", hasBody: true }),
  svc,
...
export const AbortFunctionUpgradeProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2alpha/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:abortFunctionUpgrade", hasBody: true }),
  svc,
...
export const RedirectFunctionUpgradeTrafficProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2alpha/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:redirectFunctionUpgradeTraffic", hasBody: true }),
  svc,
...
export const RollbackFunctionUpgradeTrafficProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2alpha/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:rollbackFunctionUpgradeTraffic", hasBody: true }),
  svc,
...
export const CommitFunctionUpgradeProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2alpha/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:commitFunctionUpgrade", hasBody: true }),
  svc,
...
export const CommitFunctionUpgradeAsGen2ProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2alpha/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:commitFunctionUpgradeAsGen2", hasBody: true }),
  svc,
...
export const DeleteProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2alpha/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}" }),
  svc,
...
export const GenerateUploadUrlProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2alpha/projects/{projectsId}/locations/{locationsId}/functions:generateUploadUrl", hasBody: true }),
  svc,
...
export const GenerateDownloadUrlProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2alpha/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:generateDownloadUrl", hasBody: true }),
  svc,
...
export const DetachFunctionProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2alpha/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:detachFunction", hasBody: true }),
  svc,
...
export const SetIamPolicyProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2alpha/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:setIamPolicy", hasBody: true }),
  svc,
...
export const GetIamPolicyProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2alpha/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:getIamPolicy" }),
  svc,
...
export const TestIamPermissionsProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2alpha/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:testIamPermissions", hasBody: true }),
  svc,
...
export const ListProjectsLocationsRuntimesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2alpha/projects/{projectsId}/locations/{locationsId}/runtimes" }),
  svc,
