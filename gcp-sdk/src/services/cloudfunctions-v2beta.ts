...
export const GoogleCloudFunctionsV2betaStateMessage: Schema.Schema<GoogleCloudFunctionsV2betaStateMessage> = Schema.suspend(() => Schema.Struct({
  severity: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  message: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudFunctionsV2betaStateMessage" }) as any as Schema.Schema<GoogleCloudFunctionsV2betaStateMessage>;
...
export const Cloudfunctions_Function: Schema.Schema<Cloudfunctions_Function> = Schema.suspend(() => Schema.Struct({
  ...
  stateMessages: Schema.optional(Schema.Array(GoogleCloudFunctionsV2betaStateMessage)),
...
export const GoogleCloudFunctionsV2betaStage: Schema.Schema<GoogleCloudFunctionsV2betaStage> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  message: Schema.optional(Schema.String),
  state: Schema.optional(Schema.String),
  ...
  stateMessages: Schema.optional(Schema.Array(GoogleCloudFunctionsV2betaStateMessage)),
})).annotate({ identifier: "GoogleCloudFunctionsV2betaStage" }) as any as Schema.Schema<GoogleCloudFunctionsV2betaStage>;
...
export const GoogleCloudFunctionsV2betaOperationMetadata: Schema.Schema<GoogleCloudFunctionsV2betaOperationMetadata> = Schema.suspend(() => Schema.Struct({
  createTime: Schema.optional(Schema.String),
...
})).annotate({ identifier: "GoogleCloudFunctionsV2betaOperationMetadata" }) as any as Schema.Schema<GoogleCloudFunctionsV2betaOperationMetadata>;
...
export const GoogleCloudFunctionsV2betaLocationMetadata: Schema.Schema<GoogleCloudFunctionsV2betaLocationMetadata> = Schema.suspend(() => Schema.Struct({
  environments: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "GoogleCloudFunctionsV2betaLocationMetadata" }) as any as Schema.Schema<GoogleCloudFunctionsV2betaLocationMetadata>;
...
export const SetIamPolicyProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2beta/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:setIamPolicy", hasBody: true }),
  svc,
...
export const GetIamPolicyProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2beta/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:getIamPolicy" }),
  svc,
...
export const TestIamPermissionsProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2beta/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:testIamPermissions", hasBody: true }),
  svc,
...
export const GetProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2beta/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}" }),
  svc,
...
export const ListProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2beta/projects/{projectsId}/locations/{locationsId}/functions" }),
  svc,
...
export const CreateProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2beta/projects/{projectsId}/locations/{locationsId}/functions", hasBody: true }),
  svc,
...
export const PatchProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2beta/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}", hasBody: true }),
  svc,
...
export const SetupFunctionUpgradeConfigProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2beta/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:setupFunctionUpgradeConfig", hasBody: true }),
  svc,
...
export const AbortFunctionUpgradeProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2beta/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:abortFunctionUpgrade", hasBody: true }),
  svc,
...
export const RedirectFunctionUpgradeTrafficProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2beta/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:redirectFunctionUpgradeTraffic", hasBody: true }),
  svc,
...
export const RollbackFunctionUpgradeTrafficProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2beta/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:rollbackFunctionUpgradeTraffic", hasBody: true }),
  svc,
...
export const CommitFunctionUpgradeProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2beta/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:commitFunctionUpgrade", hasBody: true }),
  svc,
...
export const CommitFunctionUpgradeAsGen2ProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2beta/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:commitFunctionUpgradeAsGen2", hasBody: true }),
  svc,
...
export const DeleteProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2beta/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}" }),
  svc,
...
export const GenerateUploadUrlProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2beta/projects/{projectsId}/locations/{locationsId}/functions:generateUploadUrl", hasBody: true }),
  svc,
...
export const GenerateDownloadUrlProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2beta/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:generateDownloadUrl", hasBody: true }),
  svc,
...
export const DetachFunctionProjectsLocationsFunctionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2beta/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:detachFunction", hasBody: true }),
  svc,
...
export const ListProjectsLocationsRuntimesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2beta/projects/{projectsId}/locations/{locationsId}/runtimes" }),
  svc,
