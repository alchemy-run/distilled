...
export const listProjectsTraceSinks: API.PaginatedOperationMethod<ListProjectsTraceSinksRequest, ListProjectsTraceSinksResponse, ListProjectsTraceSinksError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const getProjectsTraceSinks: API.OperationMethod<GetProjectsTraceSinksRequest, GetProjectsTraceSinksResponse, GetProjectsTraceSinksError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const createProjectsTraceSinks: API.OperationMethod<CreateProjectsTraceSinksRequest, CreateProjectsTraceSinksResponse, CreateProjectsTraceSinksError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const patchProjectsTraceSinks: API.OperationMethod<PatchProjectsTraceSinksRequest, PatchProjectsTraceSinksResponse, PatchProjectsTraceSinksError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
/** Deletes a sink. */
export const deleteProjectsTraceSinks: API.OperationMethod<DeleteProjectsTraceSinksRequest, DeleteProjectsTraceSinksResponse, DeleteProjectsTraceSinksError, Credentials | HttpClient.HttpClient> = API.make(() => ({
