...
export const CreateProjectsRequest = Schema.Struct({
  useLegacyStack: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("useLegacyStack")),
...
export const UpdateProjectsRequest = Schema.Struct({
  ...
  T.Http({ method: "PUT", path: "v1beta1/projects/{projectId}", hasBody: true }),
  svc,
...
export const UndeleteProjectsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectId}:undelete", hasBody: true }),
  svc,
...
export const GetAncestryProjectsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectId}:getAncestry", hasBody: true }),
  svc,
...
export const GetIamPolicyProjectsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{resource}:getIamPolicy", hasBody: true }),
  svc,
...
export const SetIamPolicyProjectsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{resource}:setIamPolicy", hasBody: true }),
  svc,
...
export const TestIamPermissionsProjectsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{resource}:testIamPermissions", hasBody: true }),
  svc,
...
export const GetOrganizationsRequest = Schema.Struct({
  ...
  organizationId: Schema.optional(Schema.String).pipe(T.HttpQuery("organizationId")),
}).pipe(
...
export const UpdateOrganizationsRequest = Schema.Struct({
  ...
  T.Http({ method: "PUT", path: "v1beta1/organizations/{organizationsId}", hasBody: true }),
  svc,
...
export const updateOrganizations: API.OperationMethod<UpdateOrganizationsRequest, UpdateOrganizationsResponse, UpdateOrganizationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const SetIamPolicyOrganizationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/organizations/{organizationsId}:setIamPolicy", hasBody: true }),
  svc,
...
export const GetIamPolicyOrganizationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/organizations/{organizationsId}:getIamPolicy", hasBody: true }),
  svc,
...
export const TestIamPermissionsOrganizationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/organizations/{organizationsId}:testIamPermissions", hasBody: true }),
  svc,
