...
export interface NfsExportOptions {
  ...
  securityFlavors?: Array<"SECURITY_FLAVOR_UNSPECIFIED" | "AUTH_SYS" | "KRB5" | "KRB5I" | "KRB5P" | (string & {})>;
...
export const ManagedActiveDirectoryConfig: Schema.Schema<ManagedActiveDirectoryConfig> = Schema.suspend(() => Schema.Struct({
  domain: Schema.optional(Schema.String),
  computer: Schema.optional(Schema.String),
})).annotate({ identifier: "ManagedActiveDirectoryConfig" }) as any as Schema.Schema<ManagedActiveDirectoryConfig>;
...
export interface Instance {
  ...
  state?: "STATE_UNSPECIFIED" | "CREATING" | "READY" | "REPAIRING" | "DELETING" | "ERROR" | "RESTORING" | "SUSPENDED" | "REVERTING" | "SUSPENDING" | "RESUMING" | "PROMOTING" | (string & {});
  ...
  backendType?: "BACKEND_TYPE_UNSPECIFIED" | "COMPUTE_BASED_BACKEND" | "FILESTORE_BACKEND" | (string & {});
}
...
export const Share: Schema.Schema<Share> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const ListSharesResponse: Schema.Schema<ListSharesResponse> = Schema.suspend(() => Schema.Struct({
  shares: Schema.optional(Schema.Array(Share)),
  nextPageToken: Schema.optional(Schema.String),
  unreachable: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "ListSharesResponse" }) as any as Schema.Schema<ListSharesResponse>;
...
export const ListProjectsLocationsInstancesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances" }),
  svc,
...
export const GetProjectsLocationsInstancesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}" }),
  svc,
...
export const CreateProjectsLocationsInstancesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances", hasBody: true }),
  svc,
...
export const PatchProjectsLocationsInstancesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}", hasBody: true }),
  svc,
...
export const patchProjectsLocationsInstances: API.OperationMethod<PatchProjectsLocationsInstancesRequest, PatchProjectsLocationsInstancesResponse, PatchProjectsLocationsInstancesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const RestoreProjectsLocationsInstancesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:restore", hasBody: true }),
  svc,
...
export const restoreProjectsLocationsInstances: API.OperationMethod<RestoreProjectsLocationsInstancesRequest, RestoreProjectsLocationsInstancesResponse, RestoreProjectsLocationsInstancesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const RevertProjectsLocationsInstancesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:revert", hasBody: true }),
  svc,
...
export const revertProjectsLocationsInstances: API.OperationMethod<RevertProjectsLocationsInstancesRequest, RevertProjectsLocationsInstancesResponse, RevertProjectsLocationsInstancesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PromoteReplicaProjectsLocationsInstancesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:promoteReplica", hasBody: true }),
  svc,
...
export const promoteReplicaProjectsLocationsInstances: API.OperationMethod<PromoteReplicaProjectsLocationsInstancesRequest, PromoteReplicaProjectsLocationsInstancesResponse, PromoteReplicaProjectsLocationsInstancesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PauseReplicaProjectsLocationsInstancesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:pauseReplica", hasBody: true }),
  svc,
...
export const pauseReplicaProjectsLocationsInstances: API.OperationMethod<PauseReplicaProjectsLocationsInstancesRequest, PauseReplicaProjectsLocationsInstancesResponse, PauseReplicaProjectsLocationsInstancesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ResumeReplicaProjectsLocationsInstancesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:resumeReplica", hasBody: true }),
  svc,
...
export const resumeReplicaProjectsLocationsInstances: API.OperationMethod<ResumeReplicaProjectsLocationsInstancesRequest, ResumeReplicaProjectsLocationsInstancesResponse, ResumeReplicaProjectsLocationsInstancesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsInstancesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}" }),
  svc,
...
export const ListProjectsLocationsInstancesSnapshotsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/snapshots" }),
  svc,
...
export const listProjectsLocationsInstancesSnapshots: API.PaginatedOperationMethod<ListProjectsLocationsInstancesSnapshotsRequest, ListProjectsLocationsInstancesSnapshotsResponse, ListProjectsLocationsInstancesSnapshotsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsInstancesSnapshotsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/snapshots/{snapshotsId}" }),
  svc,
...
export const getProjectsLocationsInstancesSnapshots: API.OperationMethod<GetProjectsLocationsInstancesSnapshotsRequest, GetProjectsLocationsInstancesSnapshotsResponse, GetProjectsLocationsInstancesSnapshotsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsInstancesSnapshotsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/snapshots", hasBody: true }),
  svc,
...
/** Creates a snapshot. */
export const createProjectsLocationsInstancesSnapshots: API.OperationMethod<CreateProjectsLocationsInstancesSnapshotsRequest, CreateProjectsLocationsInstancesSnapshotsResponse, CreateProjectsLocationsInstancesSnapshotsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsInstancesSnapshotsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/snapshots/{snapshotsId}" }),
  svc,
...
/** Deletes a snapshot. */
export const deleteProjectsLocationsInstancesSnapshots: API.OperationMethod<DeleteProjectsLocationsInstancesSnapshotsRequest, DeleteProjectsLocationsInstancesSnapshotsResponse, DeleteProjectsLocationsInstancesSnapshotsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsInstancesSnapshotsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/snapshots/{snapshotsId}", hasBody: true }),
  svc,
...
export const patchProjectsLocationsInstancesSnapshots: API.OperationMethod<PatchProjectsLocationsInstancesSnapshotsRequest, PatchProjectsLocationsInstancesSnapshotsResponse, PatchProjectsLocationsInstancesSnapshotsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsInstancesSharesRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  orderBy: Schema.optional(Schema.String).pipe(T.HttpQuery("orderBy")),
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/shares" }),
  svc,
...
export const ListProjectsLocationsInstancesSharesResponse = ListSharesResponse;

export type ListProjectsLocationsInstancesSharesError = DefaultErrors;

/** Lists all shares for a specified instance. */
export const listProjectsLocationsInstancesShares: API.PaginatedOperationMethod<ListProjectsLocationsInstancesSharesRequest, ListProjectsLocationsInstancesSharesResponse, ListProjectsLocationsInstancesSharesError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsInstancesSharesRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/shares/{sharesId}" }),
  svc,
...
export const GetProjectsLocationsInstancesSharesResponse = Share;

export type GetProjectsLocationsInstancesSharesError = DefaultErrors;

/** Gets the details of a specific share. */
export const getProjectsLocationsInstancesShares: API.OperationMethod<GetProjectsLocationsInstancesSharesRequest, GetProjectsLocationsInstancesSharesResponse, GetProjectsLocationsInstancesSharesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsInstancesSharesRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  shareId: Schema.optional(Schema.String).pipe(T.HttpQuery("shareId")),
  body: Schema.optional(Share).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/shares", hasBody: true }),
  svc,
...
export const CreateProjectsLocationsInstancesSharesResponse = Operation;

export type CreateProjectsLocationsInstancesSharesError = DefaultErrors;

/** Creates a share. */
export const createProjectsLocationsInstancesShares: API.OperationMethod<CreateProjectsLocationsInstancesSharesRequest, CreateProjectsLocationsInstancesSharesResponse, CreateProjectsLocationsInstancesSharesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsInstancesSharesRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/shares/{sharesId}" }),
  svc,
...
export const DeleteProjectsLocationsInstancesSharesResponse = Operation;

export type DeleteProjectsLocationsInstancesSharesError = DefaultErrors;

/** Deletes a share. */
export const deleteProjectsLocationsInstancesShares: API.OperationMethod<DeleteProjectsLocationsInstancesSharesRequest, DeleteProjectsLocationsInstancesSharesResponse, DeleteProjectsLocationsInstancesSharesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsInstancesSharesRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(Share).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}/shares/{sharesId}", hasBody: true }),
  svc,
...
export const PatchProjectsLocationsInstancesSharesResponse = Operation;

export type PatchProjectsLocationsInstancesSharesError = DefaultErrors;

/** Updates the settings of a specific share. */
export const patchProjectsLocationsInstancesShares: API.OperationMethod<PatchProjectsLocationsInstancesSharesRequest, PatchProjectsLocationsInstancesSharesResponse, PatchProjectsLocationsInstancesSharesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsBackupsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/backups" }),
  svc,
...
export const GetProjectsLocationsBackupsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/backups/{backupsId}" }),
  svc,
...
export const CreateProjectsLocationsBackupsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/backups", hasBody: true }),
  svc,
...
export const DeleteProjectsLocationsBackupsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/backups/{backupsId}" }),
  svc,
...
export const PatchProjectsLocationsBackupsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/backups/{backupsId}", hasBody: true }),
  svc,
