...
export const GoogleCloudDialogflowV2Agent: Schema.Schema<GoogleCloudDialogflowV2Agent> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDialogflowV2Agent" }) as any as Schema.Schema<GoogleCloudDialogflowV2Agent>;
...
export const GoogleCloudDialogflowV2SearchAgentsResponse: Schema.Schema<GoogleCloudDialogflowV2SearchAgentsResponse> = Schema.suspend(() => Schema.Struct({
  agents: Schema.optional(Schema.Array(GoogleCloudDialogflowV2Agent)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2SearchAgentsResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2SearchAgentsResponse>;

export interface GoogleCloudDialogflowV2TrainAgentRequest {
}

export const GoogleCloudDialogflowV2TrainAgentRequest: Schema.Schema<GoogleCloudDialogflowV2TrainAgentRequest> = Schema.suspend(() => Schema.Struct({
})).annotate({ identifier: "GoogleCloudDialogflowV2TrainAgentRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2TrainAgentRequest>;

export interface GoogleCloudDialogflowV2ExportAgentRequest {
  agentUri?: string;
}

export const GoogleCloudDialogflowV2ExportAgentRequest: Schema.Schema<GoogleCloudDialogflowV2ExportAgentRequest> = Schema.suspend(() => Schema.Struct({
  agentUri: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ExportAgentRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2ExportAgentRequest>;
...
export const GoogleCloudDialogflowV2ImportAgentRequest: Schema.Schema<GoogleCloudDialogflowV2ImportAgentRequest> = Schema.suspend(() => Schema.Struct({
  agentUri: Schema.optional(Schema.String),
  agentContent: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ImportAgentRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2ImportAgentRequest>;
...
export const GoogleCloudDialogflowV2RestoreAgentRequest: Schema.Schema<GoogleCloudDialogflowV2RestoreAgentRequest> = Schema.suspend(() => Schema.Struct({
  agentUri: Schema.optional(Schema.String),
  agentContent: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2RestoreAgentRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2RestoreAgentRequest>;
...
export const GoogleCloudDialogflowV2ValidationError: Schema.Schema<GoogleCloudDialogflowV2ValidationError> = Schema.suspend(() => Schema.Struct({
  severity: Schema.optional(Schema.String),
  entries: Schema.optional(Schema.Array(Schema.String)),
  errorMessage: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ValidationError" }) as any as Schema.Schema<GoogleCloudDialogflowV2ValidationError>;

export interface GoogleCloudDialogflowV2ValidationResult {
  validationErrors?: Array<GoogleCloudDialogflowV2ValidationError>;
}

export const GoogleCloudDialogflowV2ValidationResult: Schema.Schema<GoogleCloudDialogflowV2ValidationResult> = Schema.suspend(() => Schema.Struct({
  validationErrors: Schema.optional(Schema.Array(GoogleCloudDialogflowV2ValidationError)),
})).annotate({ identifier: "GoogleCloudDialogflowV2ValidationResult" }) as any as Schema.Schema<GoogleCloudDialogflowV2ValidationResult>;

export interface GoogleCloudDialogflowV2ToolExtensionTool {
  name?: string;
}

export const GoogleCloudDialogflowV2ToolExtensionTool: Schema.Schema<GoogleCloudDialogflowV2ToolExtensionTool> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ToolExtensionTool" }) as any as Schema.Schema<GoogleCloudDialogflowV2ToolExtensionTool>;
...
export const GoogleCloudDialogflowV2ToolFunctionTool: Schema.Schema<GoogleCloudDialogflowV2ToolFunctionTool> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDialogflowV2ToolFunctionTool" }) as any as Schema.Schema<GoogleCloudDialogflowV2ToolFunctionTool>;
...
export const GoogleCloudDialogflowV2ToolConnectorToolActionEntityOperation: Schema.Schema<GoogleCloudDialogflowV2ToolConnectorToolActionEntityOperation> = Schema.suspend(() => Schema.Struct({
  entityId: Schema.optional(Schema.String),
  operation: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ToolConnectorToolActionEntityOperation" }) as any as Schema.Schema<GoogleCloudDialogflowV2ToolConnectorToolActionEntityOperation>;
...
export const GoogleCloudDialogflowV2ToolConnectorToolAction: Schema.Schema<GoogleCloudDialogflowV2ToolConnectorToolAction> = Schema.suspend(() => Schema.Struct({
  connectionActionId: Schema.optional(Schema.String),
  entityOperation: Schema.optional(GoogleCloudDialogflowV2ToolConnectorToolActionEntityOperation),
  inputFields: Schema.optional(Schema.Array(Schema.String)),
  outputFields: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "GoogleCloudDialogflowV2ToolConnectorToolAction" }) as any as Schema.Schema<GoogleCloudDialogflowV2ToolConnectorToolAction>;
...
export const GoogleCloudDialogflowV2ToolConnectorTool: Schema.Schema<GoogleCloudDialogflowV2ToolConnectorTool> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  actions: Schema.optional(Schema.Array(GoogleCloudDialogflowV2ToolConnectorToolAction)),
})).annotate({ identifier: "GoogleCloudDialogflowV2ToolConnectorTool" }) as any as Schema.Schema<GoogleCloudDialogflowV2ToolConnectorTool>;
...
export const GoogleCloudDialogflowV2ToolAuthenticationApiKeyConfig: Schema.Schema<GoogleCloudDialogflowV2ToolAuthenticationApiKeyConfig> = Schema.suspend(() => Schema.Struct({
  keyName: Schema.optional(Schema.String),
  apiKey: Schema.optional(Schema.String),
  secretVersionForApiKey: Schema.optional(Schema.String),
  requestLocation: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ToolAuthenticationApiKeyConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2ToolAuthenticationApiKeyConfig>;
...
export const GoogleCloudDialogflowV2ToolAuthenticationOAuthConfig: Schema.Schema<GoogleCloudDialogflowV2ToolAuthenticationOAuthConfig> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDialogflowV2ToolAuthenticationOAuthConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2ToolAuthenticationOAuthConfig>;
...
export const GoogleCloudDialogflowV2ToolAuthenticationServiceAgentAuthConfig: Schema.Schema<GoogleCloudDialogflowV2ToolAuthenticationServiceAgentAuthConfig> = Schema.suspend(() => Schema.Struct({
  serviceAgentAuth: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ToolAuthenticationServiceAgentAuthConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2ToolAuthenticationServiceAgentAuthConfig>;
...
export const GoogleCloudDialogflowV2ToolAuthenticationBearerTokenConfig: Schema.Schema<GoogleCloudDialogflowV2ToolAuthenticationBearerTokenConfig> = Schema.suspend(() => Schema.Struct({
  token: Schema.optional(Schema.String),
  secretVersionForToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ToolAuthenticationBearerTokenConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2ToolAuthenticationBearerTokenConfig>;
...
export const GoogleCloudDialogflowV2ToolAuthentication: Schema.Schema<GoogleCloudDialogflowV2ToolAuthentication> = Schema.suspend(() => Schema.Struct({
  apiKeyConfig: Schema.optional(GoogleCloudDialogflowV2ToolAuthenticationApiKeyConfig),
  oauthConfig: Schema.optional(GoogleCloudDialogflowV2ToolAuthenticationOAuthConfig),
  serviceAgentAuthConfig: Schema.optional(GoogleCloudDialogflowV2ToolAuthenticationServiceAgentAuthConfig),
  bearerTokenConfig: Schema.optional(GoogleCloudDialogflowV2ToolAuthenticationBearerTokenConfig),
})).annotate({ identifier: "GoogleCloudDialogflowV2ToolAuthentication" }) as any as Schema.Schema<GoogleCloudDialogflowV2ToolAuthentication>;
...
export const GoogleCloudDialogflowV2ToolTLSConfigCACert: Schema.Schema<GoogleCloudDialogflowV2ToolTLSConfigCACert> = Schema.suspend(() => Schema.Struct({
  displayName: Schema.optional(Schema.String),
  cert: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ToolTLSConfigCACert" }) as any as Schema.Schema<GoogleCloudDialogflowV2ToolTLSConfigCACert>;

export interface GoogleCloudDialogflowV2ToolTLSConfig {
  caCerts?: Array<GoogleCloudDialogflowV2ToolTLSConfigCACert>;
}

export const GoogleCloudDialogflowV2ToolTLSConfig: Schema.Schema<GoogleCloudDialogflowV2ToolTLSConfig> = Schema.suspend(() => Schema.Struct({
  caCerts: Schema.optional(Schema.Array(GoogleCloudDialogflowV2ToolTLSConfigCACert)),
})).annotate({ identifier: "GoogleCloudDialogflowV2ToolTLSConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2ToolTLSConfig>;

export interface GoogleCloudDialogflowV2ToolServiceDirectoryConfig {
  service?: string;
}

export const GoogleCloudDialogflowV2ToolServiceDirectoryConfig: Schema.Schema<GoogleCloudDialogflowV2ToolServiceDirectoryConfig> = Schema.suspend(() => Schema.Struct({
  service: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ToolServiceDirectoryConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2ToolServiceDirectoryConfig>;
...
export const GoogleCloudDialogflowV2ToolOpenApiTool: Schema.Schema<GoogleCloudDialogflowV2ToolOpenApiTool> = Schema.suspend(() => Schema.Struct({
  ...
  serviceDirectoryConfig: Schema.optional(GoogleCloudDialogflowV2ToolServiceDirectoryConfig),
})).annotate({ identifier: "GoogleCloudDialogflowV2ToolOpenApiTool" }) as any as Schema.Schema<GoogleCloudDialogflowV2ToolOpenApiTool>;
...
export const GoogleCloudDialogflowV2Tool: Schema.Schema<GoogleCloudDialogflowV2Tool> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
...
})).annotate({ identifier: "GoogleCloudDialogflowV2Tool" }) as any as Schema.Schema<GoogleCloudDialogflowV2Tool>;
...
export const GoogleCloudDialogflowV2ListToolsResponse: Schema.Schema<GoogleCloudDialogflowV2ListToolsResponse> = Schema.suspend(() => Schema.Struct({
  tools: Schema.optional(Schema.Array(GoogleCloudDialogflowV2Tool)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListToolsResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListToolsResponse>;

export interface GoogleCloudDialogflowV2FreeFormContext {
  text?: string;
}

export const GoogleCloudDialogflowV2FreeFormContext: Schema.Schema<GoogleCloudDialogflowV2FreeFormContext> = Schema.suspend(() => Schema.Struct({
  text: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2FreeFormContext" }) as any as Schema.Schema<GoogleCloudDialogflowV2FreeFormContext>;
...
export const GoogleCloudDialogflowV2AgentCoachingContext: Schema.Schema<GoogleCloudDialogflowV2AgentCoachingContext> = Schema.suspend(() => Schema.Struct({
  overarchingGuidance: Schema.optional(Schema.String),
  instructions: Schema.optional(Schema.Array(GoogleCloudDialogflowV2AgentCoachingInstruction)),
  version: Schema.optional(Schema.String),
  outputLanguageCode: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2AgentCoachingContext" }) as any as Schema.Schema<GoogleCloudDialogflowV2AgentCoachingContext>;
...
export const GoogleCloudDialogflowV2SummarizationSection: Schema.Schema<GoogleCloudDialogflowV2SummarizationSection> = Schema.suspend(() => Schema.Struct({
  key: Schema.optional(Schema.String),
  definition: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2SummarizationSection" }) as any as Schema.Schema<GoogleCloudDialogflowV2SummarizationSection>;
...
export const GoogleCloudDialogflowV2MessageEntry: Schema.Schema<GoogleCloudDialogflowV2MessageEntry> = Schema.suspend(() => Schema.Struct({
  role: Schema.optional(Schema.String),
  text: Schema.optional(Schema.String),
  languageCode: Schema.optional(Schema.String),
  createTime: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2MessageEntry" }) as any as Schema.Schema<GoogleCloudDialogflowV2MessageEntry>;

export interface GoogleCloudDialogflowV2ConversationContext {
  messageEntries?: Array<GoogleCloudDialogflowV2MessageEntry>;
}

export const GoogleCloudDialogflowV2ConversationContext: Schema.Schema<GoogleCloudDialogflowV2ConversationContext> = Schema.suspend(() => Schema.Struct({
  messageEntries: Schema.optional(Schema.Array(GoogleCloudDialogflowV2MessageEntry)),
})).annotate({ identifier: "GoogleCloudDialogflowV2ConversationContext" }) as any as Schema.Schema<GoogleCloudDialogflowV2ConversationContext>;
...
export const GoogleCloudDialogflowV2SummarizationSectionList: Schema.Schema<GoogleCloudDialogflowV2SummarizationSectionList> = Schema.suspend(() => Schema.Struct({
  summarizationSections: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SummarizationSection)),
})).annotate({ identifier: "GoogleCloudDialogflowV2SummarizationSectionList" }) as any as Schema.Schema<GoogleCloudDialogflowV2SummarizationSectionList>;
...
export const GoogleCloudDialogflowV2FewShotExample: Schema.Schema<GoogleCloudDialogflowV2FewShotExample> = Schema.suspend(() => Schema.Struct({
  conversationContext: Schema.optional(GoogleCloudDialogflowV2ConversationContext),
  extraInfo: Schema.optional(Schema.Record(Schema.String, Schema.String)),
  summarizationSectionList: Schema.optional(GoogleCloudDialogflowV2SummarizationSectionList),
  output: Schema.optional(GoogleCloudDialogflowV2GeneratorSuggestion),
})).annotate({ identifier: "GoogleCloudDialogflowV2FewShotExample" }) as any as Schema.Schema<GoogleCloudDialogflowV2FewShotExample>;
...
export const GoogleCloudDialogflowV2SummarizationContext: Schema.Schema<GoogleCloudDialogflowV2SummarizationContext> = Schema.suspend(() => Schema.Struct({
  summarizationSections: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SummarizationSection)),
  fewShotExamples: Schema.optional(Schema.Array(GoogleCloudDialogflowV2FewShotExample)),
  version: Schema.optional(Schema.String),
  outputLanguageCode: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2SummarizationContext" }) as any as Schema.Schema<GoogleCloudDialogflowV2SummarizationContext>;
...
export const GoogleCloudDialogflowV2InferenceParameter: Schema.Schema<GoogleCloudDialogflowV2InferenceParameter> = Schema.suspend(() => Schema.Struct({
  maxOutputTokens: Schema.optional(Schema.Number),
  temperature: Schema.optional(Schema.Number),
  topK: Schema.optional(Schema.Number),
  topP: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDialogflowV2InferenceParameter" }) as any as Schema.Schema<GoogleCloudDialogflowV2InferenceParameter>;
...
export const GoogleCloudDialogflowV2SuggestionDedupingConfig: Schema.Schema<GoogleCloudDialogflowV2SuggestionDedupingConfig> = Schema.suspend(() => Schema.Struct({
  enableDeduping: Schema.optional(Schema.Boolean),
  similarityThreshold: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDialogflowV2SuggestionDedupingConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2SuggestionDedupingConfig>;
...
export const GoogleCloudDialogflowV2Generator: Schema.Schema<GoogleCloudDialogflowV2Generator> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
  freeFormContext: Schema.optional(GoogleCloudDialogflowV2FreeFormContext),
  agentCoachingContext: Schema.optional(GoogleCloudDialogflowV2AgentCoachingContext),
  summarizationContext: Schema.optional(GoogleCloudDialogflowV2SummarizationContext),
  inferenceParameter: Schema.optional(GoogleCloudDialogflowV2InferenceParameter),
  triggerEvent: Schema.optional(Schema.String),
  publishedModel: Schema.optional(Schema.String),
  createTime: Schema.optional(Schema.String),
  updateTime: Schema.optional(Schema.String),
  tools: Schema.optional(Schema.Array(Schema.String)),
  suggestionDedupingConfig: Schema.optional(GoogleCloudDialogflowV2SuggestionDedupingConfig),
})).annotate({ identifier: "GoogleCloudDialogflowV2Generator" }) as any as Schema.Schema<GoogleCloudDialogflowV2Generator>;
...
export const GoogleCloudDialogflowV2ListGeneratorsResponse: Schema.Schema<GoogleCloudDialogflowV2ListGeneratorsResponse> = Schema.suspend(() => Schema.Struct({
  generators: Schema.optional(Schema.Array(GoogleCloudDialogflowV2Generator)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListGeneratorsResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListGeneratorsResponse>;
...
export const GoogleCloudDialogflowV2ListContextsResponse: Schema.Schema<GoogleCloudDialogflowV2ListContextsResponse> = Schema.suspend(() => Schema.Struct({
  contexts: Schema.optional(Schema.Array(GoogleCloudDialogflowV2Context)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListContextsResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListContextsResponse>;
...
export const GoogleCloudDialogflowV2ListIntentsResponse: Schema.Schema<GoogleCloudDialogflowV2ListIntentsResponse> = Schema.suspend(() => Schema.Struct({
  intents: Schema.optional(Schema.Array(GoogleCloudDialogflowV2Intent)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListIntentsResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListIntentsResponse>;

export interface GoogleCloudDialogflowV2IntentBatch {
  intents?: Array<GoogleCloudDialogflowV2Intent>;
}

export const GoogleCloudDialogflowV2IntentBatch: Schema.Schema<GoogleCloudDialogflowV2IntentBatch> = Schema.suspend(() => Schema.Struct({
  intents: Schema.optional(Schema.Array(GoogleCloudDialogflowV2Intent)),
})).annotate({ identifier: "GoogleCloudDialogflowV2IntentBatch" }) as any as Schema.Schema<GoogleCloudDialogflowV2IntentBatch>;
...
export const GoogleCloudDialogflowV2BatchUpdateIntentsRequest: Schema.Schema<GoogleCloudDialogflowV2BatchUpdateIntentsRequest> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDialogflowV2BatchUpdateIntentsRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2BatchUpdateIntentsRequest>;

export interface GoogleCloudDialogflowV2BatchDeleteIntentsRequest {
  intents?: Array<GoogleCloudDialogflowV2Intent>;
}

export const GoogleCloudDialogflowV2BatchDeleteIntentsRequest: Schema.Schema<GoogleCloudDialogflowV2BatchDeleteIntentsRequest> = Schema.suspend(() => Schema.Struct({
  intents: Schema.optional(Schema.Array(GoogleCloudDialogflowV2Intent)),
})).annotate({ identifier: "GoogleCloudDialogflowV2BatchDeleteIntentsRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2BatchDeleteIntentsRequest>;
...
export const GoogleCloudDialogflowV2ListEntityTypesResponse: Schema.Schema<GoogleCloudDialogflowV2ListEntityTypesResponse> = Schema.suspend(() => Schema.Struct({
  entityTypes: Schema.optional(Schema.Array(GoogleCloudDialogflowV2EntityType)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListEntityTypesResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListEntityTypesResponse>;

export interface GoogleCloudDialogflowV2EntityTypeBatch {
  entityTypes?: Array<GoogleCloudDialogflowV2EntityType>;
}

export const GoogleCloudDialogflowV2EntityTypeBatch: Schema.Schema<GoogleCloudDialogflowV2EntityTypeBatch> = Schema.suspend(() => Schema.Struct({
  entityTypes: Schema.optional(Schema.Array(GoogleCloudDialogflowV2EntityType)),
})).annotate({ identifier: "GoogleCloudDialogflowV2EntityTypeBatch" }) as any as Schema.Schema<GoogleCloudDialogflowV2EntityTypeBatch>;
...
export const GoogleCloudDialogflowV2BatchUpdateEntityTypesRequest: Schema.Schema<GoogleCloudDialogflowV2BatchUpdateEntityTypesRequest> = Schema.suspend(() => Schema.Struct({
  entityTypeBatchUri: Schema.optional(Schema.String),
  entityTypeBatchInline: Schema.optional(GoogleCloudDialogflowV2EntityTypeBatch),
  languageCode: Schema.optional(Schema.String),
  updateMask: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2BatchUpdateEntityTypesRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2BatchUpdateEntityTypesRequest>;

export interface GoogleCloudDialogflowV2BatchDeleteEntityTypesRequest {
  entityTypeNames?: Array<string>;
}

export const GoogleCloudDialogflowV2BatchDeleteEntityTypesRequest: Schema.Schema<GoogleCloudDialogflowV2BatchDeleteEntityTypesRequest> = Schema.suspend(() => Schema.Struct({
  entityTypeNames: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "GoogleCloudDialogflowV2BatchDeleteEntityTypesRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2BatchDeleteEntityTypesRequest>;
...
export const GoogleCloudDialogflowV2BatchCreateEntitiesRequest: Schema.Schema<GoogleCloudDialogflowV2BatchCreateEntitiesRequest> = Schema.suspend(() => Schema.Struct({
  entities: Schema.optional(Schema.Array(GoogleCloudDialogflowV2EntityTypeEntity)),
  languageCode: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2BatchCreateEntitiesRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2BatchCreateEntitiesRequest>;
...
export const GoogleCloudDialogflowV2BatchUpdateEntitiesRequest: Schema.Schema<GoogleCloudDialogflowV2BatchUpdateEntitiesRequest> = Schema.suspend(() => Schema.Struct({
  entities: Schema.optional(Schema.Array(GoogleCloudDialogflowV2EntityTypeEntity)),
  languageCode: Schema.optional(Schema.String),
  updateMask: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2BatchUpdateEntitiesRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2BatchUpdateEntitiesRequest>;
...
export const GoogleCloudDialogflowV2BatchDeleteEntitiesRequest: Schema.Schema<GoogleCloudDialogflowV2BatchDeleteEntitiesRequest> = Schema.suspend(() => Schema.Struct({
  entityValues: Schema.optional(Schema.Array(Schema.String)),
  languageCode: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2BatchDeleteEntitiesRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2BatchDeleteEntitiesRequest>;
...
export const GoogleCloudDialogflowV2ListSessionEntityTypesResponse: Schema.Schema<GoogleCloudDialogflowV2ListSessionEntityTypesResponse> = Schema.suspend(() => Schema.Struct({
  sessionEntityTypes: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SessionEntityType)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListSessionEntityTypesResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListSessionEntityTypesResponse>;
...
export const GoogleCloudDialogflowV2SentimentAnalysisRequestConfig: Schema.Schema<GoogleCloudDialogflowV2SentimentAnalysisRequestConfig> = Schema.suspend(() => Schema.Struct({
  analyzeQueryTextSentiment: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "GoogleCloudDialogflowV2SentimentAnalysisRequestConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2SentimentAnalysisRequestConfig>;
...
export const GoogleCloudDialogflowV2QueryParameters: Schema.Schema<GoogleCloudDialogflowV2QueryParameters> = Schema.suspend(() => Schema.Struct({
  timeZone: Schema.optional(Schema.String),
  ...
  sessionEntityTypes: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SessionEntityType)),
  payload: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
  sentimentAnalysisRequestConfig: Schema.optional(GoogleCloudDialogflowV2SentimentAnalysisRequestConfig),
  webhookHeaders: Schema.optional(Schema.Record(Schema.String, Schema.String)),
  platform: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2QueryParameters" }) as any as Schema.Schema<GoogleCloudDialogflowV2QueryParameters>;
...
export const GoogleCloudDialogflowV2SpeechContext: Schema.Schema<GoogleCloudDialogflowV2SpeechContext> = Schema.suspend(() => Schema.Struct({
  phrases: Schema.optional(Schema.Array(Schema.String)),
  boost: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDialogflowV2SpeechContext" }) as any as Schema.Schema<GoogleCloudDialogflowV2SpeechContext>;
...
export const GoogleCloudDialogflowV2InputAudioConfig: Schema.Schema<GoogleCloudDialogflowV2InputAudioConfig> = Schema.suspend(() => Schema.Struct({
  ...
  speechContexts: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SpeechContext)),
...
})).annotate({ identifier: "GoogleCloudDialogflowV2InputAudioConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2InputAudioConfig>;
...
export const GoogleCloudDialogflowV2TextInput: Schema.Schema<GoogleCloudDialogflowV2TextInput> = Schema.suspend(() => Schema.Struct({
  text: Schema.optional(Schema.String),
  languageCode: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2TextInput" }) as any as Schema.Schema<GoogleCloudDialogflowV2TextInput>;
...
export const GoogleCloudDialogflowV2QueryInput: Schema.Schema<GoogleCloudDialogflowV2QueryInput> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDialogflowV2QueryInput" }) as any as Schema.Schema<GoogleCloudDialogflowV2QueryInput>;
...
export const GoogleCloudDialogflowV2VoiceSelectionParams: Schema.Schema<GoogleCloudDialogflowV2VoiceSelectionParams> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  ssmlGender: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2VoiceSelectionParams" }) as any as Schema.Schema<GoogleCloudDialogflowV2VoiceSelectionParams>;
...
export const GoogleCloudDialogflowV2CustomPronunciationParams: Schema.Schema<GoogleCloudDialogflowV2CustomPronunciationParams> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDialogflowV2CustomPronunciationParams" }) as any as Schema.Schema<GoogleCloudDialogflowV2CustomPronunciationParams>;
...
export const GoogleCloudDialogflowV2SynthesizeSpeechConfig: Schema.Schema<GoogleCloudDialogflowV2SynthesizeSpeechConfig> = Schema.suspend(() => Schema.Struct({
  ...
  pronunciations: Schema.optional(Schema.Array(GoogleCloudDialogflowV2CustomPronunciationParams)),
})).annotate({ identifier: "GoogleCloudDialogflowV2SynthesizeSpeechConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2SynthesizeSpeechConfig>;
...
export const GoogleCloudDialogflowV2OutputAudioConfig: Schema.Schema<GoogleCloudDialogflowV2OutputAudioConfig> = Schema.suspend(() => Schema.Struct({
  audioEncoding: Schema.optional(Schema.String),
  sampleRateHertz: Schema.optional(Schema.Number),
  synthesizeSpeechConfig: Schema.optional(GoogleCloudDialogflowV2SynthesizeSpeechConfig),
})).annotate({ identifier: "GoogleCloudDialogflowV2OutputAudioConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2OutputAudioConfig>;
...
export const GoogleCloudDialogflowV2DetectIntentRequest: Schema.Schema<GoogleCloudDialogflowV2DetectIntentRequest> = Schema.suspend(() => Schema.Struct({
  ...
  outputAudioConfig: Schema.optional(GoogleCloudDialogflowV2OutputAudioConfig),
  outputAudioConfigMask: Schema.optional(Schema.String),
  inputAudio: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2DetectIntentRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2DetectIntentRequest>;
...
export const GoogleCloudDialogflowV2DetectIntentResponse: Schema.Schema<GoogleCloudDialogflowV2DetectIntentResponse> = Schema.suspend(() => Schema.Struct({
  ...
  outputAudioConfig: Schema.optional(GoogleCloudDialogflowV2OutputAudioConfig),
})).annotate({ identifier: "GoogleCloudDialogflowV2DetectIntentResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2DetectIntentResponse>;
...
export const GoogleCloudDialogflowV2Participant: Schema.Schema<GoogleCloudDialogflowV2Participant> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  role: Schema.optional(Schema.String),
...
})).annotate({ identifier: "GoogleCloudDialogflowV2Participant" }) as any as Schema.Schema<GoogleCloudDialogflowV2Participant>;
...
export const GoogleCloudDialogflowV2ListParticipantsResponse: Schema.Schema<GoogleCloudDialogflowV2ListParticipantsResponse> = Schema.suspend(() => Schema.Struct({
  participants: Schema.optional(Schema.Array(GoogleCloudDialogflowV2Participant)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListParticipantsResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListParticipantsResponse>;
...
export const GoogleCloudDialogflowV2AudioInput: Schema.Schema<GoogleCloudDialogflowV2AudioInput> = Schema.suspend(() => Schema.Struct({
  config: Schema.optional(GoogleCloudDialogflowV2InputAudioConfig),
  audio: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2AudioInput" }) as any as Schema.Schema<GoogleCloudDialogflowV2AudioInput>;
...
export const GoogleCloudDialogflowV2SuggestionInput: Schema.Schema<GoogleCloudDialogflowV2SuggestionInput> = Schema.suspend(() => Schema.Struct({
  answerRecord: Schema.optional(Schema.String),
  parameters: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
  action: Schema.optional(Schema.String),
  sendTime: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2SuggestionInput" }) as any as Schema.Schema<GoogleCloudDialogflowV2SuggestionInput>;

export interface GoogleCloudDialogflowV2AssistQueryParameters {
  documentsMetadataFilters?: Record<string, string>;
}

export const GoogleCloudDialogflowV2AssistQueryParameters: Schema.Schema<GoogleCloudDialogflowV2AssistQueryParameters> = Schema.suspend(() => Schema.Struct({
  documentsMetadataFilters: Schema.optional(Schema.Record(Schema.String, Schema.String)),
})).annotate({ identifier: "GoogleCloudDialogflowV2AssistQueryParameters" }) as any as Schema.Schema<GoogleCloudDialogflowV2AssistQueryParameters>;
...
export const GoogleCloudDialogflowV2AnalyzeContentRequest: Schema.Schema<GoogleCloudDialogflowV2AnalyzeContentRequest> = Schema.suspend(() => Schema.Struct({
  ...
  queryParams: Schema.optional(GoogleCloudDialogflowV2QueryParameters),
  assistQueryParams: Schema.optional(GoogleCloudDialogflowV2AssistQueryParameters),
  cxParameters: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
  requestId: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2AnalyzeContentRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2AnalyzeContentRequest>;
...
export const GoogleCloudDialogflowV2OutputAudio: Schema.Schema<GoogleCloudDialogflowV2OutputAudio> = Schema.suspend(() => Schema.Struct({
  config: Schema.optional(GoogleCloudDialogflowV2OutputAudioConfig),
  audio: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2OutputAudio" }) as any as Schema.Schema<GoogleCloudDialogflowV2OutputAudio>;
...
export const GoogleCloudDialogflowV2AutomatedAgentReply: Schema.Schema<GoogleCloudDialogflowV2AutomatedAgentReply> = Schema.suspend(() => Schema.Struct({
  detectIntentResponse: Schema.optional(GoogleCloudDialogflowV2DetectIntentResponse),
...
})).annotate({ identifier: "GoogleCloudDialogflowV2AutomatedAgentReply" }) as any as Schema.Schema<GoogleCloudDialogflowV2AutomatedAgentReply>;
...
export const GoogleCloudDialogflowV2DtmfParameters: Schema.Schema<GoogleCloudDialogflowV2DtmfParameters> = Schema.suspend(() => Schema.Struct({
  acceptsDtmfInput: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "GoogleCloudDialogflowV2DtmfParameters" }) as any as Schema.Schema<GoogleCloudDialogflowV2DtmfParameters>;
...
export const GoogleCloudDialogflowV2AnalyzeContentResponse: Schema.Schema<GoogleCloudDialogflowV2AnalyzeContentResponse> = Schema.suspend(() => Schema.Struct({
  replyText: Schema.optional(Schema.String),
  replyAudio: Schema.optional(GoogleCloudDialogflowV2OutputAudio),
  automatedAgentReply: Schema.optional(GoogleCloudDialogflowV2AutomatedAgentReply),
  message: Schema.optional(GoogleCloudDialogflowV2Message),
  humanAgentSuggestionResults: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SuggestionResult)),
  endUserSuggestionResults: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SuggestionResult)),
  dtmfParameters: Schema.optional(GoogleCloudDialogflowV2DtmfParameters),
})).annotate({ identifier: "GoogleCloudDialogflowV2AnalyzeContentResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2AnalyzeContentResponse>;
...
export const GoogleCloudDialogflowV2SuggestArticlesRequest: Schema.Schema<GoogleCloudDialogflowV2SuggestArticlesRequest> = Schema.suspend(() => Schema.Struct({
  latestMessage: Schema.optional(Schema.String),
  contextSize: Schema.optional(Schema.Number),
  assistQueryParams: Schema.optional(GoogleCloudDialogflowV2AssistQueryParameters),
})).annotate({ identifier: "GoogleCloudDialogflowV2SuggestArticlesRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2SuggestArticlesRequest>;
...
export const GoogleCloudDialogflowV2SuggestFaqAnswersRequest: Schema.Schema<GoogleCloudDialogflowV2SuggestFaqAnswersRequest> = Schema.suspend(() => Schema.Struct({
  latestMessage: Schema.optional(Schema.String),
  contextSize: Schema.optional(Schema.Number),
  assistQueryParams: Schema.optional(GoogleCloudDialogflowV2AssistQueryParameters),
})).annotate({ identifier: "GoogleCloudDialogflowV2SuggestFaqAnswersRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2SuggestFaqAnswersRequest>;
...
export const GoogleCloudDialogflowV2SuggestSmartRepliesRequest: Schema.Schema<GoogleCloudDialogflowV2SuggestSmartRepliesRequest> = Schema.suspend(() => Schema.Struct({
  currentTextInput: Schema.optional(GoogleCloudDialogflowV2TextInput),
  latestMessage: Schema.optional(Schema.String),
  contextSize: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDialogflowV2SuggestSmartRepliesRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2SuggestSmartRepliesRequest>;
...
export const GoogleCloudDialogflowV2SuggestKnowledgeAssistRequest: Schema.Schema<GoogleCloudDialogflowV2SuggestKnowledgeAssistRequest> = Schema.suspend(() => Schema.Struct({
  latestMessage: Schema.optional(Schema.String),
  contextSize: Schema.optional(Schema.Number),
  previousSuggestedQuery: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2SuggestKnowledgeAssistRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2SuggestKnowledgeAssistRequest>;
...
export const GoogleCloudDialogflowV2AgentAssistantFeedbackSummarizationFeedback: Schema.Schema<GoogleCloudDialogflowV2AgentAssistantFeedbackSummarizationFeedback> = Schema.suspend(() => Schema.Struct({
  startTime: Schema.optional(Schema.String),
...
})).annotate({ identifier: "GoogleCloudDialogflowV2AgentAssistantFeedbackSummarizationFeedback" }) as any as Schema.Schema<GoogleCloudDialogflowV2AgentAssistantFeedbackSummarizationFeedback>;
...
export const GoogleCloudDialogflowV2AgentAssistantFeedbackKnowledgeSearchFeedback: Schema.Schema<GoogleCloudDialogflowV2AgentAssistantFeedbackKnowledgeSearchFeedback> = Schema.suspend(() => Schema.Struct({
  answerCopied: Schema.optional(Schema.Boolean),
  clickedUris: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "GoogleCloudDialogflowV2AgentAssistantFeedbackKnowledgeSearchFeedback" }) as any as Schema.Schema<GoogleCloudDialogflowV2AgentAssistantFeedbackKnowledgeSearchFeedback>;
...
export const GoogleCloudDialogflowV2AgentAssistantFeedbackKnowledgeAssistFeedback: Schema.Schema<GoogleCloudDialogflowV2AgentAssistantFeedbackKnowledgeAssistFeedback> = Schema.suspend(() => Schema.Struct({
  answerCopied: Schema.optional(Schema.Boolean),
  clickedUris: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "GoogleCloudDialogflowV2AgentAssistantFeedbackKnowledgeAssistFeedback" }) as any as Schema.Schema<GoogleCloudDialogflowV2AgentAssistantFeedbackKnowledgeAssistFeedback>;
...
export const GoogleCloudDialogflowV2AgentAssistantFeedback: Schema.Schema<GoogleCloudDialogflowV2AgentAssistantFeedback> = Schema.suspend(() => Schema.Struct({
  ...
  summarizationFeedback: Schema.optional(GoogleCloudDialogflowV2AgentAssistantFeedbackSummarizationFeedback),
  knowledgeSearchFeedback: Schema.optional(GoogleCloudDialogflowV2AgentAssistantFeedbackKnowledgeSearchFeedback),
  knowledgeAssistFeedback: Schema.optional(GoogleCloudDialogflowV2AgentAssistantFeedbackKnowledgeAssistFeedback),
})).annotate({ identifier: "GoogleCloudDialogflowV2AgentAssistantFeedback" }) as any as Schema.Schema<GoogleCloudDialogflowV2AgentAssistantFeedback>;
...
export const GoogleCloudDialogflowV2AnswerFeedback: Schema.Schema<GoogleCloudDialogflowV2AnswerFeedback> = Schema.suspend(() => Schema.Struct({
  correctnessLevel: Schema.optional(Schema.String),
  agentAssistantDetailFeedback: Schema.optional(GoogleCloudDialogflowV2AgentAssistantFeedback),
...
})).annotate({ identifier: "GoogleCloudDialogflowV2AnswerFeedback" }) as any as Schema.Schema<GoogleCloudDialogflowV2AnswerFeedback>;
...
export const GoogleCloudDialogflowV2IntentSuggestion: Schema.Schema<GoogleCloudDialogflowV2IntentSuggestion> = Schema.suspend(() => Schema.Struct({
  displayName: Schema.optional(Schema.String),
  intentV2: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2IntentSuggestion" }) as any as Schema.Schema<GoogleCloudDialogflowV2IntentSuggestion>;
...
export const GoogleCloudDialogflowV2DialogflowAssistAnswer: Schema.Schema<GoogleCloudDialogflowV2DialogflowAssistAnswer> = Schema.suspend(() => Schema.Struct({
  queryResult: Schema.optional(GoogleCloudDialogflowV2QueryResult),
  intentSuggestion: Schema.optional(GoogleCloudDialogflowV2IntentSuggestion),
  answerRecord: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2DialogflowAssistAnswer" }) as any as Schema.Schema<GoogleCloudDialogflowV2DialogflowAssistAnswer>;
...
export const GoogleCloudDialogflowV2AgentAssistantRecord: Schema.Schema<GoogleCloudDialogflowV2AgentAssistantRecord> = Schema.suspend(() => Schema.Struct({
  articleSuggestionAnswer: Schema.optional(GoogleCloudDialogflowV2ArticleAnswer),
  faqAnswer: Schema.optional(GoogleCloudDialogflowV2FaqAnswer),
  dialogflowAssistAnswer: Schema.optional(GoogleCloudDialogflowV2DialogflowAssistAnswer),
  generatorSuggestion: Schema.optional(GoogleCloudDialogflowV2GeneratorSuggestion),
})).annotate({ identifier: "GoogleCloudDialogflowV2AgentAssistantRecord" }) as any as Schema.Schema<GoogleCloudDialogflowV2AgentAssistantRecord>;
...
export const GoogleCloudDialogflowV2AnswerRecord: Schema.Schema<GoogleCloudDialogflowV2AnswerRecord> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  answerFeedback: Schema.optional(GoogleCloudDialogflowV2AnswerFeedback),
  agentAssistantRecord: Schema.optional(GoogleCloudDialogflowV2AgentAssistantRecord),
})).annotate({ identifier: "GoogleCloudDialogflowV2AnswerRecord" }) as any as Schema.Schema<GoogleCloudDialogflowV2AnswerRecord>;
...
export const GoogleCloudDialogflowV2ListAnswerRecordsResponse: Schema.Schema<GoogleCloudDialogflowV2ListAnswerRecordsResponse> = Schema.suspend(() => Schema.Struct({
  answerRecords: Schema.optional(Schema.Array(GoogleCloudDialogflowV2AnswerRecord)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListAnswerRecordsResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListAnswerRecordsResponse>;

export interface GoogleCloudDialogflowV2GcsSources {
  uris?: Array<string>;
}

export const GoogleCloudDialogflowV2GcsSources: Schema.Schema<GoogleCloudDialogflowV2GcsSources> = Schema.suspend(() => Schema.Struct({
  uris: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "GoogleCloudDialogflowV2GcsSources" }) as any as Schema.Schema<GoogleCloudDialogflowV2GcsSources>;

export interface GoogleCloudDialogflowV2InputConfig {
  gcsSource?: GoogleCloudDialogflowV2GcsSources;
}

export const GoogleCloudDialogflowV2InputConfig: Schema.Schema<GoogleCloudDialogflowV2InputConfig> = Schema.suspend(() => Schema.Struct({
  gcsSource: Schema.optional(GoogleCloudDialogflowV2GcsSources),
})).annotate({ identifier: "GoogleCloudDialogflowV2InputConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2InputConfig>;

export interface GoogleCloudDialogflowV2ConversationInfo {
  languageCode?: string;
}

export const GoogleCloudDialogflowV2ConversationInfo: Schema.Schema<GoogleCloudDialogflowV2ConversationInfo> = Schema.suspend(() => Schema.Struct({
  languageCode: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ConversationInfo" }) as any as Schema.Schema<GoogleCloudDialogflowV2ConversationInfo>;
...
export const GoogleCloudDialogflowV2ConversationDataset: Schema.Schema<GoogleCloudDialogflowV2ConversationDataset> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  displayName: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
  createTime: Schema.optional(Schema.String),
  ...
  satisfiesPzi: Schema.optional(Schema.Boolean),
  satisfiesPzs: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "GoogleCloudDialogflowV2ConversationDataset" }) as any as Schema.Schema<GoogleCloudDialogflowV2ConversationDataset>;
...
export const GoogleCloudDialogflowV2ListConversationDatasetsResponse: Schema.Schema<GoogleCloudDialogflowV2ListConversationDatasetsResponse> = Schema.suspend(() => Schema.Struct({
  conversationDatasets: Schema.optional(Schema.Array(GoogleCloudDialogflowV2ConversationDataset)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListConversationDatasetsResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListConversationDatasetsResponse>;

export interface GoogleCloudDialogflowV2ImportConversationDataRequest {
  inputConfig?: GoogleCloudDialogflowV2InputConfig;
}

export const GoogleCloudDialogflowV2ImportConversationDataRequest: Schema.Schema<GoogleCloudDialogflowV2ImportConversationDataRequest> = Schema.suspend(() => Schema.Struct({
  inputConfig: Schema.optional(GoogleCloudDialogflowV2InputConfig),
})).annotate({ identifier: "GoogleCloudDialogflowV2ImportConversationDataRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2ImportConversationDataRequest>;
...
export const GoogleCloudDialogflowV2ListConversationModelsResponse: Schema.Schema<GoogleCloudDialogflowV2ListConversationModelsResponse> = Schema.suspend(() => Schema.Struct({
  conversationModels: Schema.optional(Schema.Array(GoogleCloudDialogflowV2ConversationModel)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListConversationModelsResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListConversationModelsResponse>;

export interface GoogleCloudDialogflowV2DeployConversationModelRequest {
}

export const GoogleCloudDialogflowV2DeployConversationModelRequest: Schema.Schema<GoogleCloudDialogflowV2DeployConversationModelRequest> = Schema.suspend(() => Schema.Struct({
})).annotate({ identifier: "GoogleCloudDialogflowV2DeployConversationModelRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2DeployConversationModelRequest>;

export interface GoogleCloudDialogflowV2UndeployConversationModelRequest {
}

export const GoogleCloudDialogflowV2UndeployConversationModelRequest: Schema.Schema<GoogleCloudDialogflowV2UndeployConversationModelRequest> = Schema.suspend(() => Schema.Struct({
})).annotate({ identifier: "GoogleCloudDialogflowV2UndeployConversationModelRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2UndeployConversationModelRequest>;
...
export const GoogleCloudDialogflowV2EvaluationConfigSmartReplyConfig: Schema.Schema<GoogleCloudDialogflowV2EvaluationConfigSmartReplyConfig> = Schema.suspend(() => Schema.Struct({
  allowlistDocument: Schema.optional(Schema.String),
  maxResultCount: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDialogflowV2EvaluationConfigSmartReplyConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2EvaluationConfigSmartReplyConfig>;
...
export const GoogleCloudDialogflowV2EvaluationConfigSmartComposeConfig: Schema.Schema<GoogleCloudDialogflowV2EvaluationConfigSmartComposeConfig> = Schema.suspend(() => Schema.Struct({
  allowlistDocument: Schema.optional(Schema.String),
  maxResultCount: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDialogflowV2EvaluationConfigSmartComposeConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2EvaluationConfigSmartComposeConfig>;
...
export const GoogleCloudDialogflowV2EvaluationConfig: Schema.Schema<GoogleCloudDialogflowV2EvaluationConfig> = Schema.suspend(() => Schema.Struct({
  datasets: Schema.optional(Schema.Array(GoogleCloudDialogflowV2InputDataset)),
  smartReplyConfig: Schema.optional(GoogleCloudDialogflowV2EvaluationConfigSmartReplyConfig),
  smartComposeConfig: Schema.optional(GoogleCloudDialogflowV2EvaluationConfigSmartComposeConfig),
})).annotate({ identifier: "GoogleCloudDialogflowV2EvaluationConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2EvaluationConfig>;
...
export const GoogleCloudDialogflowV2SmartReplyMetricsTopNMetrics: Schema.Schema<GoogleCloudDialogflowV2SmartReplyMetricsTopNMetrics> = Schema.suspend(() => Schema.Struct({
  n: Schema.optional(Schema.Number),
  recall: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDialogflowV2SmartReplyMetricsTopNMetrics" }) as any as Schema.Schema<GoogleCloudDialogflowV2SmartReplyMetricsTopNMetrics>;
...
export const GoogleCloudDialogflowV2SmartReplyMetrics: Schema.Schema<GoogleCloudDialogflowV2SmartReplyMetrics> = Schema.suspend(() => Schema.Struct({
  allowlistCoverage: Schema.optional(Schema.Number),
  topNMetrics: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SmartReplyMetricsTopNMetrics)),
  conversationCount: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2SmartReplyMetrics" }) as any as Schema.Schema<GoogleCloudDialogflowV2SmartReplyMetrics>;
...
export const GoogleCloudDialogflowV2ConversationModelEvaluation: Schema.Schema<GoogleCloudDialogflowV2ConversationModelEvaluation> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  displayName: Schema.optional(Schema.String),
  evaluationConfig: Schema.optional(GoogleCloudDialogflowV2EvaluationConfig),
  createTime: Schema.optional(Schema.String),
  smartReplyMetrics: Schema.optional(GoogleCloudDialogflowV2SmartReplyMetrics),
  rawHumanEvalTemplateCsv: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ConversationModelEvaluation" }) as any as Schema.Schema<GoogleCloudDialogflowV2ConversationModelEvaluation>;
...
export const GoogleCloudDialogflowV2ListConversationModelEvaluationsResponse: Schema.Schema<GoogleCloudDialogflowV2ListConversationModelEvaluationsResponse> = Schema.suspend(() => Schema.Struct({
  conversationModelEvaluations: Schema.optional(Schema.Array(GoogleCloudDialogflowV2ConversationModelEvaluation)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListConversationModelEvaluationsResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListConversationModelEvaluationsResponse>;
...
export const GoogleCloudDialogflowV2CreateConversationModelEvaluationRequest: Schema.Schema<GoogleCloudDialogflowV2CreateConversationModelEvaluationRequest> = Schema.suspend(() => Schema.Struct({
  conversationModelEvaluation: Schema.optional(GoogleCloudDialogflowV2ConversationModelEvaluation),
})).annotate({ identifier: "GoogleCloudDialogflowV2CreateConversationModelEvaluationRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2CreateConversationModelEvaluationRequest>;
...
export const GoogleCloudDialogflowV2AutomatedAgentConfig: Schema.Schema<GoogleCloudDialogflowV2AutomatedAgentConfig> = Schema.suspend(() => Schema.Struct({
  agent: Schema.optional(Schema.String),
  sessionTtl: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2AutomatedAgentConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2AutomatedAgentConfig>;
...
export const GoogleCloudDialogflowV2NotificationConfig: Schema.Schema<GoogleCloudDialogflowV2NotificationConfig> = Schema.suspend(() => Schema.Struct({
  topic: Schema.optional(Schema.String),
  messageFormat: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2NotificationConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2NotificationConfig>;

export interface GoogleCloudDialogflowV2SuggestionFeature {
  type?: "TYPE_UNSPECIFIED" | "ARTICLE_SUGGESTION" | "FAQ" | "SMART_REPLY" | "CONVERSATION_SUMMARIZATION" | "KNOWLEDGE_SEARCH" | "KNOWLEDGE_ASSIST" | (string & {});
}

export const GoogleCloudDialogflowV2SuggestionFeature: Schema.Schema<GoogleCloudDialogflowV2SuggestionFeature> = Schema.suspend(() => Schema.Struct({
  type: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2SuggestionFeature" }) as any as Schema.Schema<GoogleCloudDialogflowV2SuggestionFeature>;
...
export const GoogleCloudDialogflowV2RaiSettingsRaiCategoryConfig: Schema.Schema<GoogleCloudDialogflowV2RaiSettingsRaiCategoryConfig> = Schema.suspend(() => Schema.Struct({
  category: Schema.optional(Schema.String),
  sensitivityLevel: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2RaiSettingsRaiCategoryConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2RaiSettingsRaiCategoryConfig>;
...
export const GoogleCloudDialogflowV2RaiSettings: Schema.Schema<GoogleCloudDialogflowV2RaiSettings> = Schema.suspend(() => Schema.Struct({
  raiCategoryConfigs: Schema.optional(Schema.Array(GoogleCloudDialogflowV2RaiSettingsRaiCategoryConfig)),
})).annotate({ identifier: "GoogleCloudDialogflowV2RaiSettings" }) as any as Schema.Schema<GoogleCloudDialogflowV2RaiSettings>;
...
export const GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionTriggerSettings: Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionTriggerSettings> = Schema.suspend(() => Schema.Struct({
  noSmalltalk: Schema.optional(Schema.Boolean),
  onlyEndUser: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionTriggerSettings" }) as any as Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionTriggerSettings>;
...
export const GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigKnowledgeBaseQuerySource: Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigKnowledgeBaseQuerySource> = Schema.suspend(() => Schema.Struct({
  knowledgeBases: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigKnowledgeBaseQuerySource" }) as any as Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigKnowledgeBaseQuerySource>;

export interface GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDocumentQuerySource {
  documents?: Array<string>;
}

export const GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDocumentQuerySource: Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDocumentQuerySource> = Schema.suspend(() => Schema.Struct({
  documents: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDocumentQuerySource" }) as any as Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDocumentQuerySource>;
...
export const GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySourceHumanAgentSideConfig: Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySourceHumanAgentSideConfig> = Schema.suspend(() => Schema.Struct({
  agent: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySourceHumanAgentSideConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySourceHumanAgentSideConfig>;
...
export const GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySource: Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySource> = Schema.suspend(() => Schema.Struct({
  agent: Schema.optional(Schema.String),
  humanAgentSideConfig: Schema.optional(GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySourceHumanAgentSideConfig),
})).annotate({ identifier: "GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySource" }) as any as Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySource>;
...
export const GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigContextFilterSettings: Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigContextFilterSettings> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigContextFilterSettings" }) as any as Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigContextFilterSettings>;
...
export const GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigSections: Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigSections> = Schema.suspend(() => Schema.Struct({
  sectionTypes: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigSections" }) as any as Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigSections>;
...
export const GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfig: Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfig> = Schema.suspend(() => Schema.Struct({
  knowledgeBaseQuerySource: Schema.optional(GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigKnowledgeBaseQuerySource),
  documentQuerySource: Schema.optional(GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDocumentQuerySource),
  dialogflowQuerySource: Schema.optional(GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigDialogflowQuerySource),
  maxResults: Schema.optional(Schema.Number),
  confidenceThreshold: Schema.optional(Schema.Number),
  contextFilterSettings: Schema.optional(GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigContextFilterSettings),
  sections: Schema.optional(GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfigSections),
  contextSize: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfig>;
...
export const GoogleCloudDialogflowV2HumanAgentAssistantConfigConversationModelConfig: Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigConversationModelConfig> = Schema.suspend(() => Schema.Struct({
  model: Schema.optional(Schema.String),
  baselineModelVersion: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2HumanAgentAssistantConfigConversationModelConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigConversationModelConfig>;

export interface GoogleCloudDialogflowV2HumanAgentAssistantConfigConversationProcessConfig {
  recentSentencesCount?: number;
}

export const GoogleCloudDialogflowV2HumanAgentAssistantConfigConversationProcessConfig: Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigConversationProcessConfig> = Schema.suspend(() => Schema.Struct({
  recentSentencesCount: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDialogflowV2HumanAgentAssistantConfigConversationProcessConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigConversationProcessConfig>;
...
export const GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfig: Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfig> = Schema.suspend(() => Schema.Struct({
  suggestionFeature: Schema.optional(GoogleCloudDialogflowV2SuggestionFeature),
  ...
  suggestionTriggerSettings: Schema.optional(GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionTriggerSettings),
  queryConfig: Schema.optional(GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionQueryConfig),
  conversationModelConfig: Schema.optional(GoogleCloudDialogflowV2HumanAgentAssistantConfigConversationModelConfig),
  conversationProcessConfig: Schema.optional(GoogleCloudDialogflowV2HumanAgentAssistantConfigConversationProcessConfig),
})).annotate({ identifier: "GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfig>;
...
export const GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionConfig: Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionConfig> = Schema.suspend(() => Schema.Struct({
  featureConfigs: Schema.optional(Schema.Array(GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfig)),
...
})).annotate({ identifier: "GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionConfig>;
...
export const GoogleCloudDialogflowV2HumanAgentAssistantConfigMessageAnalysisConfig: Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigMessageAnalysisConfig> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDialogflowV2HumanAgentAssistantConfigMessageAnalysisConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfigMessageAnalysisConfig>;
...
export const GoogleCloudDialogflowV2HumanAgentAssistantConfig: Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfig> = Schema.suspend(() => Schema.Struct({
  notificationConfig: Schema.optional(GoogleCloudDialogflowV2NotificationConfig),
  humanAgentSuggestionConfig: Schema.optional(GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionConfig),
  endUserSuggestionConfig: Schema.optional(GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionConfig),
  messageAnalysisConfig: Schema.optional(GoogleCloudDialogflowV2HumanAgentAssistantConfigMessageAnalysisConfig),
})).annotate({ identifier: "GoogleCloudDialogflowV2HumanAgentAssistantConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2HumanAgentAssistantConfig>;

export interface GoogleCloudDialogflowV2HumanAgentHandoffConfigLivePersonConfig {
  accountNumber?: string;
}

export const GoogleCloudDialogflowV2HumanAgentHandoffConfigLivePersonConfig: Schema.Schema<GoogleCloudDialogflowV2HumanAgentHandoffConfigLivePersonConfig> = Schema.suspend(() => Schema.Struct({
  accountNumber: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2HumanAgentHandoffConfigLivePersonConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2HumanAgentHandoffConfigLivePersonConfig>;
...
export const GoogleCloudDialogflowV2HumanAgentHandoffConfigSalesforceLiveAgentConfig: Schema.Schema<GoogleCloudDialogflowV2HumanAgentHandoffConfigSalesforceLiveAgentConfig> = Schema.suspend(() => Schema.Struct({
  organizationId: Schema.optional(Schema.String),
  deploymentId: Schema.optional(Schema.String),
  buttonId: Schema.optional(Schema.String),
  endpointDomain: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2HumanAgentHandoffConfigSalesforceLiveAgentConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2HumanAgentHandoffConfigSalesforceLiveAgentConfig>;
...
export const GoogleCloudDialogflowV2HumanAgentHandoffConfig: Schema.Schema<GoogleCloudDialogflowV2HumanAgentHandoffConfig> = Schema.suspend(() => Schema.Struct({
  livePersonConfig: Schema.optional(GoogleCloudDialogflowV2HumanAgentHandoffConfigLivePersonConfig),
  salesforceLiveAgentConfig: Schema.optional(GoogleCloudDialogflowV2HumanAgentHandoffConfigSalesforceLiveAgentConfig),
})).annotate({ identifier: "GoogleCloudDialogflowV2HumanAgentHandoffConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2HumanAgentHandoffConfig>;

export interface GoogleCloudDialogflowV2LoggingConfig {
  enableStackdriverLogging?: boolean;
}

export const GoogleCloudDialogflowV2LoggingConfig: Schema.Schema<GoogleCloudDialogflowV2LoggingConfig> = Schema.suspend(() => Schema.Struct({
  enableStackdriverLogging: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "GoogleCloudDialogflowV2LoggingConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2LoggingConfig>;
...
export const GoogleCloudDialogflowV2SpeechToTextConfig: Schema.Schema<GoogleCloudDialogflowV2SpeechToTextConfig> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDialogflowV2SpeechToTextConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2SpeechToTextConfig>;
...
export const GoogleCloudDialogflowV2ConversationProfile: Schema.Schema<GoogleCloudDialogflowV2ConversationProfile> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  displayName: Schema.optional(Schema.String),
  createTime: Schema.optional(Schema.String),
  updateTime: Schema.optional(Schema.String),
  automatedAgentConfig: Schema.optional(GoogleCloudDialogflowV2AutomatedAgentConfig),
  humanAgentAssistantConfig: Schema.optional(GoogleCloudDialogflowV2HumanAgentAssistantConfig),
  humanAgentHandoffConfig: Schema.optional(GoogleCloudDialogflowV2HumanAgentHandoffConfig),
  notificationConfig: Schema.optional(GoogleCloudDialogflowV2NotificationConfig),
  loggingConfig: Schema.optional(GoogleCloudDialogflowV2LoggingConfig),
  newMessageEventNotificationConfig: Schema.optional(GoogleCloudDialogflowV2NotificationConfig),
  newRecognitionResultNotificationConfig: Schema.optional(GoogleCloudDialogflowV2NotificationConfig),
...
})).annotate({ identifier: "GoogleCloudDialogflowV2ConversationProfile" }) as any as Schema.Schema<GoogleCloudDialogflowV2ConversationProfile>;
...
export const GoogleCloudDialogflowV2ListConversationProfilesResponse: Schema.Schema<GoogleCloudDialogflowV2ListConversationProfilesResponse> = Schema.suspend(() => Schema.Struct({
  conversationProfiles: Schema.optional(Schema.Array(GoogleCloudDialogflowV2ConversationProfile)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListConversationProfilesResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListConversationProfilesResponse>;
...
export const GoogleCloudDialogflowV2SetSuggestionFeatureConfigRequest: Schema.Schema<GoogleCloudDialogflowV2SetSuggestionFeatureConfigRequest> = Schema.suspend(() => Schema.Struct({
  participantRole: Schema.optional(Schema.String),
  suggestionFeatureConfig: Schema.optional(GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionFeatureConfig),
})).annotate({ identifier: "GoogleCloudDialogflowV2SetSuggestionFeatureConfigRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2SetSuggestionFeatureConfigRequest>;
...
export const GoogleCloudDialogflowV2ClearSuggestionFeatureConfigRequest: Schema.Schema<GoogleCloudDialogflowV2ClearSuggestionFeatureConfigRequest> = Schema.suspend(() => Schema.Struct({
  participantRole: Schema.optional(Schema.String),
  suggestionFeatureType: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ClearSuggestionFeatureConfigRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2ClearSuggestionFeatureConfigRequest>;
...
export const GoogleCloudDialogflowV2ConversationPhoneNumber: Schema.Schema<GoogleCloudDialogflowV2ConversationPhoneNumber> = Schema.suspend(() => Schema.Struct({
  countryCode: Schema.optional(Schema.Number),
  phoneNumber: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ConversationPhoneNumber" }) as any as Schema.Schema<GoogleCloudDialogflowV2ConversationPhoneNumber>;
...
export const GoogleCloudDialogflowV2ConversationTelephonyConnectionInfoSipHeader: Schema.Schema<GoogleCloudDialogflowV2ConversationTelephonyConnectionInfoSipHeader> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  value: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ConversationTelephonyConnectionInfoSipHeader" }) as any as Schema.Schema<GoogleCloudDialogflowV2ConversationTelephonyConnectionInfoSipHeader>;
...
export const GoogleCloudDialogflowV2ConversationTelephonyConnectionInfoMimeContent: Schema.Schema<GoogleCloudDialogflowV2ConversationTelephonyConnectionInfoMimeContent> = Schema.suspend(() => Schema.Struct({
  mimeType: Schema.optional(Schema.String),
  content: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ConversationTelephonyConnectionInfoMimeContent" }) as any as Schema.Schema<GoogleCloudDialogflowV2ConversationTelephonyConnectionInfoMimeContent>;
...
export const GoogleCloudDialogflowV2ConversationTelephonyConnectionInfo: Schema.Schema<GoogleCloudDialogflowV2ConversationTelephonyConnectionInfo> = Schema.suspend(() => Schema.Struct({
  dialedNumber: Schema.optional(Schema.String),
  sdp: Schema.optional(Schema.String),
  sipHeaders: Schema.optional(Schema.Array(GoogleCloudDialogflowV2ConversationTelephonyConnectionInfoSipHeader)),
  extraMimeContents: Schema.optional(Schema.Array(GoogleCloudDialogflowV2ConversationTelephonyConnectionInfoMimeContent)),
})).annotate({ identifier: "GoogleCloudDialogflowV2ConversationTelephonyConnectionInfo" }) as any as Schema.Schema<GoogleCloudDialogflowV2ConversationTelephonyConnectionInfo>;
...
export const GoogleCloudDialogflowV2ConversationContextReferenceContextContent: Schema.Schema<GoogleCloudDialogflowV2ConversationContextReferenceContextContent> = Schema.suspend(() => Schema.Struct({
  content: Schema.optional(Schema.String),
  contentFormat: Schema.optional(Schema.String),
  ingestionTime: Schema.optional(Schema.String),
  answerRecord: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ConversationContextReferenceContextContent" }) as any as Schema.Schema<GoogleCloudDialogflowV2ConversationContextReferenceContextContent>;
...
export const GoogleCloudDialogflowV2ConversationContextReference: Schema.Schema<GoogleCloudDialogflowV2ConversationContextReference> = Schema.suspend(() => Schema.Struct({
  contextContents: Schema.optional(Schema.Array(GoogleCloudDialogflowV2ConversationContextReferenceContextContent)),
  updateMode: Schema.optional(Schema.String),
  languageCode: Schema.optional(Schema.String),
  createTime: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ConversationContextReference" }) as any as Schema.Schema<GoogleCloudDialogflowV2ConversationContextReference>;
...
export interface GoogleCloudDialogflowV2Conversation {
  ...
  ingestedContextReferences?: Record<string, GoogleCloudDialogflowV2ConversationContextReference>;
}

export const GoogleCloudDialogflowV2Conversation: Schema.Schema<GoogleCloudDialogflowV2Conversation> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  lifecycleState: Schema.optional(Schema.String),
  conversationProfile: Schema.optional(Schema.String),
  phoneNumber: Schema.optional(GoogleCloudDialogflowV2ConversationPhoneNumber),
  startTime: Schema.optional(Schema.String),
  endTime: Schema.optional(Schema.String),
  conversationStage: Schema.optional(Schema.String),
  telephonyConnectionInfo: Schema.optional(GoogleCloudDialogflowV2ConversationTelephonyConnectionInfo),
  ingestedContextReferences: Schema.optional(Schema.Record(Schema.String, GoogleCloudDialogflowV2ConversationContextReference)),
})).annotate({ identifier: "GoogleCloudDialogflowV2Conversation" }) as any as Schema.Schema<GoogleCloudDialogflowV2Conversation>;
...
export const GoogleCloudDialogflowV2ListConversationsResponse: Schema.Schema<GoogleCloudDialogflowV2ListConversationsResponse> = Schema.suspend(() => Schema.Struct({
  conversations: Schema.optional(Schema.Array(GoogleCloudDialogflowV2Conversation)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListConversationsResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListConversationsResponse>;

export interface GoogleCloudDialogflowV2CompleteConversationRequest {
}

export const GoogleCloudDialogflowV2CompleteConversationRequest: Schema.Schema<GoogleCloudDialogflowV2CompleteConversationRequest> = Schema.suspend(() => Schema.Struct({
})).annotate({ identifier: "GoogleCloudDialogflowV2CompleteConversationRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2CompleteConversationRequest>;

export interface GoogleCloudDialogflowV2IngestContextReferencesRequest {
  contextReferences?: Record<string, GoogleCloudDialogflowV2ConversationContextReference>;
}

export const GoogleCloudDialogflowV2IngestContextReferencesRequest: Schema.Schema<GoogleCloudDialogflowV2IngestContextReferencesRequest> = Schema.suspend(() => Schema.Struct({
  contextReferences: Schema.optional(Schema.Record(Schema.String, GoogleCloudDialogflowV2ConversationContextReference)),
})).annotate({ identifier: "GoogleCloudDialogflowV2IngestContextReferencesRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2IngestContextReferencesRequest>;

export interface GoogleCloudDialogflowV2IngestContextReferencesResponse {
  ingestedContextReferences?: Record<string, GoogleCloudDialogflowV2ConversationContextReference>;
}

export const GoogleCloudDialogflowV2IngestContextReferencesResponse: Schema.Schema<GoogleCloudDialogflowV2IngestContextReferencesResponse> = Schema.suspend(() => Schema.Struct({
  ingestedContextReferences: Schema.optional(Schema.Record(Schema.String, GoogleCloudDialogflowV2ConversationContextReference)),
})).annotate({ identifier: "GoogleCloudDialogflowV2IngestContextReferencesResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2IngestContextReferencesResponse>;
...
export const GoogleCloudDialogflowV2ListMessagesResponse: Schema.Schema<GoogleCloudDialogflowV2ListMessagesResponse> = Schema.suspend(() => Schema.Struct({
  messages: Schema.optional(Schema.Array(GoogleCloudDialogflowV2Message)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListMessagesResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListMessagesResponse>;
...
export const GoogleCloudDialogflowV2SuggestConversationSummaryRequest: Schema.Schema<GoogleCloudDialogflowV2SuggestConversationSummaryRequest> = Schema.suspend(() => Schema.Struct({
  latestMessage: Schema.optional(Schema.String),
  contextSize: Schema.optional(Schema.Number),
  assistQueryParams: Schema.optional(GoogleCloudDialogflowV2AssistQueryParameters),
})).annotate({ identifier: "GoogleCloudDialogflowV2SuggestConversationSummaryRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2SuggestConversationSummaryRequest>;
...
export const GoogleCloudDialogflowV2SuggestConversationSummaryResponseSummarySummarySection: Schema.Schema<GoogleCloudDialogflowV2SuggestConversationSummaryResponseSummarySummarySection> = Schema.suspend(() => Schema.Struct({
  section: Schema.optional(Schema.String),
  summary: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2SuggestConversationSummaryResponseSummarySummarySection" }) as any as Schema.Schema<GoogleCloudDialogflowV2SuggestConversationSummaryResponseSummarySummarySection>;
...
export const GoogleCloudDialogflowV2SuggestConversationSummaryResponseSummary: Schema.Schema<GoogleCloudDialogflowV2SuggestConversationSummaryResponseSummary> = Schema.suspend(() => Schema.Struct({
  text: Schema.optional(Schema.String),
  textSections: Schema.optional(Schema.Record(Schema.String, Schema.String)),
  sortedTextSections: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SuggestConversationSummaryResponseSummarySummarySection)),
  answerRecord: Schema.optional(Schema.String),
  baselineModelVersion: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2SuggestConversationSummaryResponseSummary" }) as any as Schema.Schema<GoogleCloudDialogflowV2SuggestConversationSummaryResponseSummary>;
...
export const GoogleCloudDialogflowV2SuggestConversationSummaryResponse: Schema.Schema<GoogleCloudDialogflowV2SuggestConversationSummaryResponse> = Schema.suspend(() => Schema.Struct({
  summary: Schema.optional(GoogleCloudDialogflowV2SuggestConversationSummaryResponseSummary),
  latestMessage: Schema.optional(Schema.String),
  contextSize: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDialogflowV2SuggestConversationSummaryResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2SuggestConversationSummaryResponse>;

export interface GoogleCloudDialogflowV2GenerateStatelessSummaryRequestMinimalConversation {
  messages?: Array<GoogleCloudDialogflowV2Message>;
}

export const GoogleCloudDialogflowV2GenerateStatelessSummaryRequestMinimalConversation: Schema.Schema<GoogleCloudDialogflowV2GenerateStatelessSummaryRequestMinimalConversation> = Schema.suspend(() => Schema.Struct({
  messages: Schema.optional(Schema.Array(GoogleCloudDialogflowV2Message)),
})).annotate({ identifier: "GoogleCloudDialogflowV2GenerateStatelessSummaryRequestMinimalConversation" }) as any as Schema.Schema<GoogleCloudDialogflowV2GenerateStatelessSummaryRequestMinimalConversation>;
...
export const GoogleCloudDialogflowV2GenerateStatelessSummaryRequest: Schema.Schema<GoogleCloudDialogflowV2GenerateStatelessSummaryRequest> = Schema.suspend(() => Schema.Struct({
  statelessConversation: Schema.optional(GoogleCloudDialogflowV2GenerateStatelessSummaryRequestMinimalConversation),
  conversationProfile: Schema.optional(GoogleCloudDialogflowV2ConversationProfile),
  latestMessage: Schema.optional(Schema.String),
  maxContextSize: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDialogflowV2GenerateStatelessSummaryRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2GenerateStatelessSummaryRequest>;
...
export const GoogleCloudDialogflowV2GenerateStatelessSummaryResponseSummary: Schema.Schema<GoogleCloudDialogflowV2GenerateStatelessSummaryResponseSummary> = Schema.suspend(() => Schema.Struct({
  text: Schema.optional(Schema.String),
  textSections: Schema.optional(Schema.Record(Schema.String, Schema.String)),
  baselineModelVersion: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2GenerateStatelessSummaryResponseSummary" }) as any as Schema.Schema<GoogleCloudDialogflowV2GenerateStatelessSummaryResponseSummary>;
...
export const GoogleCloudDialogflowV2GenerateStatelessSummaryResponse: Schema.Schema<GoogleCloudDialogflowV2GenerateStatelessSummaryResponse> = Schema.suspend(() => Schema.Struct({
  summary: Schema.optional(GoogleCloudDialogflowV2GenerateStatelessSummaryResponseSummary),
  latestMessage: Schema.optional(Schema.String),
  contextSize: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDialogflowV2GenerateStatelessSummaryResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2GenerateStatelessSummaryResponse>;
...
export const GoogleCloudDialogflowV2GenerateStatelessSuggestionRequest: Schema.Schema<GoogleCloudDialogflowV2GenerateStatelessSuggestionRequest> = Schema.suspend(() => Schema.Struct({
  ...
  securitySettings: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2GenerateStatelessSuggestionRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2GenerateStatelessSuggestionRequest>;

export interface GoogleCloudDialogflowV2GenerateStatelessSuggestionResponse {
  generatorSuggestion?: GoogleCloudDialogflowV2GeneratorSuggestion;
}

export const GoogleCloudDialogflowV2GenerateStatelessSuggestionResponse: Schema.Schema<GoogleCloudDialogflowV2GenerateStatelessSuggestionResponse> = Schema.suspend(() => Schema.Struct({
  generatorSuggestion: Schema.optional(GoogleCloudDialogflowV2GeneratorSuggestion),
})).annotate({ identifier: "GoogleCloudDialogflowV2GenerateStatelessSuggestionResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2GenerateStatelessSuggestionResponse>;
...
export const GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpecConditionBoostSpecBoostControlSpecControlPoint: Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpecConditionBoostSpecBoostControlSpecControlPoint> = Schema.suspend(() => Schema.Struct({
  attributeValue: Schema.optional(Schema.String),
  boostAmount: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpecConditionBoostSpecBoostControlSpecControlPoint" }) as any as Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpecConditionBoostSpecBoostControlSpecControlPoint>;
...
export const GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpecConditionBoostSpecBoostControlSpec: Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpecConditionBoostSpecBoostControlSpec> = Schema.suspend(() => Schema.Struct({
  fieldName: Schema.optional(Schema.String),
  attributeType: Schema.optional(Schema.String),
  interpolationType: Schema.optional(Schema.String),
  controlPoints: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpecConditionBoostSpecBoostControlSpecControlPoint)),
})).annotate({ identifier: "GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpecConditionBoostSpecBoostControlSpec" }) as any as Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpecConditionBoostSpecBoostControlSpec>;
...
export const GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpecConditionBoostSpec: Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpecConditionBoostSpec> = Schema.suspend(() => Schema.Struct({
  condition: Schema.optional(Schema.String),
  boost: Schema.optional(Schema.Number),
  boostControlSpec: Schema.optional(GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpecConditionBoostSpecBoostControlSpec),
})).annotate({ identifier: "GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpecConditionBoostSpec" }) as any as Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpecConditionBoostSpec>;
...
export const GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpec: Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpec> = Schema.suspend(() => Schema.Struct({
  conditionBoostSpecs: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpecConditionBoostSpec)),
})).annotate({ identifier: "GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpec" }) as any as Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpec>;
...
export const GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecs: Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecs> = Schema.suspend(() => Schema.Struct({
  dataStores: Schema.optional(Schema.Array(Schema.String)),
  spec: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecsBoostSpec)),
})).annotate({ identifier: "GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecs" }) as any as Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecs>;
...
export const GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigFilterSpecs: Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigFilterSpecs> = Schema.suspend(() => Schema.Struct({
  dataStores: Schema.optional(Schema.Array(Schema.String)),
  filter: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigFilterSpecs" }) as any as Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigFilterSpecs>;
...
export const GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfig: Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfig> = Schema.suspend(() => Schema.Struct({
  boostSpecs: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigBoostSpecs)),
  filterSpecs: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfigFilterSpecs)),
})).annotate({ identifier: "GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfig>;
...
export const GoogleCloudDialogflowV2SearchKnowledgeRequest: Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeRequest> = Schema.suspend(() => Schema.Struct({
  parent: Schema.optional(Schema.String),
  ...
  searchConfig: Schema.optional(GoogleCloudDialogflowV2SearchKnowledgeRequestSearchConfig),
  exactSearch: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "GoogleCloudDialogflowV2SearchKnowledgeRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeRequest>;
...
export const GoogleCloudDialogflowV2SearchKnowledgeAnswerAnswerSource: Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeAnswerAnswerSource> = Schema.suspend(() => Schema.Struct({
  title: Schema.optional(Schema.String),
  uri: Schema.optional(Schema.String),
  snippet: Schema.optional(Schema.String),
  metadata: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
})).annotate({ identifier: "GoogleCloudDialogflowV2SearchKnowledgeAnswerAnswerSource" }) as any as Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeAnswerAnswerSource>;
...
export const GoogleCloudDialogflowV2SearchKnowledgeAnswer: Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeAnswer> = Schema.suspend(() => Schema.Struct({
  answer: Schema.optional(Schema.String),
  answerType: Schema.optional(Schema.String),
  answerSources: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SearchKnowledgeAnswerAnswerSource)),
  answerRecord: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2SearchKnowledgeAnswer" }) as any as Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeAnswer>;
...
export const GoogleCloudDialogflowV2SearchKnowledgeDebugInfoSearchKnowledgeBehavior: Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeDebugInfoSearchKnowledgeBehavior> = Schema.suspend(() => Schema.Struct({
  answerGenerationRewriterOn: Schema.optional(Schema.Boolean),
  endUserMetadataIncluded: Schema.optional(Schema.Boolean),
  thirdPartyConnectorAllowed: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "GoogleCloudDialogflowV2SearchKnowledgeDebugInfoSearchKnowledgeBehavior" }) as any as Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeDebugInfoSearchKnowledgeBehavior>;
...
export const GoogleCloudDialogflowV2SearchKnowledgeDebugInfo: Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeDebugInfo> = Schema.suspend(() => Schema.Struct({
  datastoreResponseReason: Schema.optional(Schema.String),
  searchKnowledgeBehavior: Schema.optional(GoogleCloudDialogflowV2SearchKnowledgeDebugInfoSearchKnowledgeBehavior),
  ingestedContextReferenceDebugInfo: Schema.optional(GoogleCloudDialogflowV2IngestedContextReferenceDebugInfo),
  serviceLatency: Schema.optional(GoogleCloudDialogflowV2ServiceLatency),
})).annotate({ identifier: "GoogleCloudDialogflowV2SearchKnowledgeDebugInfo" }) as any as Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeDebugInfo>;
...
export const GoogleCloudDialogflowV2SearchKnowledgeResponse: Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeResponse> = Schema.suspend(() => Schema.Struct({
  answers: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SearchKnowledgeAnswer)),
  rewrittenQuery: Schema.optional(Schema.String),
  searchKnowledgeDebugInfo: Schema.optional(GoogleCloudDialogflowV2SearchKnowledgeDebugInfo),
})).annotate({ identifier: "GoogleCloudDialogflowV2SearchKnowledgeResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2SearchKnowledgeResponse>;
...
export const GoogleCloudDialogflowV2GenerateSuggestionsRequest: Schema.Schema<GoogleCloudDialogflowV2GenerateSuggestionsRequest> = Schema.suspend(() => Schema.Struct({
  latestMessage: Schema.optional(Schema.String),
  triggerEvents: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "GoogleCloudDialogflowV2GenerateSuggestionsRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2GenerateSuggestionsRequest>;
...
export const GoogleCloudDialogflowV2DocumentReloadStatus: Schema.Schema<GoogleCloudDialogflowV2DocumentReloadStatus> = Schema.suspend(() => Schema.Struct({
  time: Schema.optional(Schema.String),
  status: Schema.optional(GoogleRpcStatus),
})).annotate({ identifier: "GoogleCloudDialogflowV2DocumentReloadStatus" }) as any as Schema.Schema<GoogleCloudDialogflowV2DocumentReloadStatus>;

export interface GoogleCloudDialogflowV2Document {
  name?: string;
  displayName?: string;
  mimeType?: string;
  knowledgeTypes?: Array<"KNOWLEDGE_TYPE_UNSPECIFIED" | "FAQ" | "EXTRACTIVE_QA" | "ARTICLE_SUGGESTION" | "AGENT_FACING_SMART_REPLY" | (string & {})>;
  contentUri?: string;
  rawContent?: string;
...
export const GoogleCloudDialogflowV2Document: Schema.Schema<GoogleCloudDialogflowV2Document> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  displayName: Schema.optional(Schema.String),
  mimeType: Schema.optional(Schema.String),
  ...
  latestReloadStatus: Schema.optional(GoogleCloudDialogflowV2DocumentReloadStatus),
  metadata: Schema.optional(Schema.Record(Schema.String, Schema.String)),
  state: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2Document" }) as any as Schema.Schema<GoogleCloudDialogflowV2Document>;
...
export const GoogleCloudDialogflowV2ListDocumentsResponse: Schema.Schema<GoogleCloudDialogflowV2ListDocumentsResponse> = Schema.suspend(() => Schema.Struct({
  documents: Schema.optional(Schema.Array(GoogleCloudDialogflowV2Document)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListDocumentsResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListDocumentsResponse>;
...
export const GoogleCloudDialogflowV2ImportDocumentTemplate: Schema.Schema<GoogleCloudDialogflowV2ImportDocumentTemplate> = Schema.suspend(() => Schema.Struct({
  mimeType: Schema.optional(Schema.String),
  knowledgeTypes: Schema.optional(Schema.Array(Schema.String)),
  metadata: Schema.optional(Schema.Record(Schema.String, Schema.String)),
})).annotate({ identifier: "GoogleCloudDialogflowV2ImportDocumentTemplate" }) as any as Schema.Schema<GoogleCloudDialogflowV2ImportDocumentTemplate>;
...
export const GoogleCloudDialogflowV2ImportDocumentsRequest: Schema.Schema<GoogleCloudDialogflowV2ImportDocumentsRequest> = Schema.suspend(() => Schema.Struct({
  gcsSource: Schema.optional(GoogleCloudDialogflowV2GcsSources),
  documentTemplate: Schema.optional(GoogleCloudDialogflowV2ImportDocumentTemplate),
  importGcsCustomMetadata: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "GoogleCloudDialogflowV2ImportDocumentsRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2ImportDocumentsRequest>;
...
export const GoogleCloudDialogflowV2ReloadDocumentRequest: Schema.Schema<GoogleCloudDialogflowV2ReloadDocumentRequest> = Schema.suspend(() => Schema.Struct({
  contentUri: Schema.optional(Schema.String),
  importGcsCustomMetadata: Schema.optional(Schema.Boolean),
  smartMessagingPartialUpdate: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "GoogleCloudDialogflowV2ReloadDocumentRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2ReloadDocumentRequest>;
...
export const GoogleCloudDialogflowV2ExportDocumentRequest: Schema.Schema<GoogleCloudDialogflowV2ExportDocumentRequest> = Schema.suspend(() => Schema.Struct({
  gcsDestination: Schema.optional(GoogleCloudDialogflowV2GcsDestination),
  exportFullContent: Schema.optional(Schema.Boolean),
  smartMessagingPartialUpdate: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "GoogleCloudDialogflowV2ExportDocumentRequest" }) as any as Schema.Schema<GoogleCloudDialogflowV2ExportDocumentRequest>;
...
export const GoogleCloudDialogflowV2FulfillmentGenericWebService: Schema.Schema<GoogleCloudDialogflowV2FulfillmentGenericWebService> = Schema.suspend(() => Schema.Struct({
  uri: Schema.optional(Schema.String),
...
})).annotate({ identifier: "GoogleCloudDialogflowV2FulfillmentGenericWebService" }) as any as Schema.Schema<GoogleCloudDialogflowV2FulfillmentGenericWebService>;

export interface GoogleCloudDialogflowV2FulfillmentFeature {
  type?: "TYPE_UNSPECIFIED" | "SMALLTALK" | (string & {});
}

export const GoogleCloudDialogflowV2FulfillmentFeature: Schema.Schema<GoogleCloudDialogflowV2FulfillmentFeature> = Schema.suspend(() => Schema.Struct({
  type: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2FulfillmentFeature" }) as any as Schema.Schema<GoogleCloudDialogflowV2FulfillmentFeature>;
...
export const GoogleCloudDialogflowV2Fulfillment: Schema.Schema<GoogleCloudDialogflowV2Fulfillment> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  displayName: Schema.optional(Schema.String),
  genericWebService: Schema.optional(GoogleCloudDialogflowV2FulfillmentGenericWebService),
  enabled: Schema.optional(Schema.Boolean),
  features: Schema.optional(Schema.Array(GoogleCloudDialogflowV2FulfillmentFeature)),
})).annotate({ identifier: "GoogleCloudDialogflowV2Fulfillment" }) as any as Schema.Schema<GoogleCloudDialogflowV2Fulfillment>;
...
export const GoogleCloudDialogflowV2TextToSpeechSettings: Schema.Schema<GoogleCloudDialogflowV2TextToSpeechSettings> = Schema.suspend(() => Schema.Struct({
  enableTextToSpeech: Schema.optional(Schema.Boolean),
  outputAudioEncoding: Schema.optional(Schema.String),
  sampleRateHertz: Schema.optional(Schema.Number),
  synthesizeSpeechConfigs: Schema.optional(Schema.Record(Schema.String, GoogleCloudDialogflowV2SynthesizeSpeechConfig)),
})).annotate({ identifier: "GoogleCloudDialogflowV2TextToSpeechSettings" }) as any as Schema.Schema<GoogleCloudDialogflowV2TextToSpeechSettings>;
...
export const GoogleCloudDialogflowV2Environment: Schema.Schema<GoogleCloudDialogflowV2Environment> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
  agentVersion: Schema.optional(Schema.String),
  state: Schema.optional(Schema.String),
  updateTime: Schema.optional(Schema.String),
  textToSpeechSettings: Schema.optional(GoogleCloudDialogflowV2TextToSpeechSettings),
  fulfillment: Schema.optional(GoogleCloudDialogflowV2Fulfillment),
})).annotate({ identifier: "GoogleCloudDialogflowV2Environment" }) as any as Schema.Schema<GoogleCloudDialogflowV2Environment>;
...
export const GoogleCloudDialogflowV2ListEnvironmentsResponse: Schema.Schema<GoogleCloudDialogflowV2ListEnvironmentsResponse> = Schema.suspend(() => Schema.Struct({
  environments: Schema.optional(Schema.Array(GoogleCloudDialogflowV2Environment)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListEnvironmentsResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListEnvironmentsResponse>;
...
export const GoogleCloudDialogflowV2EnvironmentHistoryEntry: Schema.Schema<GoogleCloudDialogflowV2EnvironmentHistoryEntry> = Schema.suspend(() => Schema.Struct({
  agentVersion: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
  createTime: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2EnvironmentHistoryEntry" }) as any as Schema.Schema<GoogleCloudDialogflowV2EnvironmentHistoryEntry>;
...
export const GoogleCloudDialogflowV2EnvironmentHistory: Schema.Schema<GoogleCloudDialogflowV2EnvironmentHistory> = Schema.suspend(() => Schema.Struct({
  parent: Schema.optional(Schema.String),
  entries: Schema.optional(Schema.Array(GoogleCloudDialogflowV2EnvironmentHistoryEntry)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2EnvironmentHistory" }) as any as Schema.Schema<GoogleCloudDialogflowV2EnvironmentHistory>;
...
export const GoogleCloudDialogflowV2GeneratorEvaluationConfigAgentAssistInputDataConfig: Schema.Schema<GoogleCloudDialogflowV2GeneratorEvaluationConfigAgentAssistInputDataConfig> = Schema.suspend(() => Schema.Struct({
  startTime: Schema.optional(Schema.String),
  endTime: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2GeneratorEvaluationConfigAgentAssistInputDataConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2GeneratorEvaluationConfigAgentAssistInputDataConfig>;

export interface GoogleCloudDialogflowV2GeneratorEvaluationConfigDatasetInputDataConfig {
  dataset?: string;
}

export const GoogleCloudDialogflowV2GeneratorEvaluationConfigDatasetInputDataConfig: Schema.Schema<GoogleCloudDialogflowV2GeneratorEvaluationConfigDatasetInputDataConfig> = Schema.suspend(() => Schema.Struct({
  dataset: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2GeneratorEvaluationConfigDatasetInputDataConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2GeneratorEvaluationConfigDatasetInputDataConfig>;
...
export const GoogleCloudDialogflowV2GeneratorEvaluationConfigInputDataConfig: Schema.Schema<GoogleCloudDialogflowV2GeneratorEvaluationConfigInputDataConfig> = Schema.suspend(() => Schema.Struct({
  ...
  agentAssistInputDataConfig: Schema.optional(GoogleCloudDialogflowV2GeneratorEvaluationConfigAgentAssistInputDataConfig),
  datasetInputDataConfig: Schema.optional(GoogleCloudDialogflowV2GeneratorEvaluationConfigDatasetInputDataConfig),
})).annotate({ identifier: "GoogleCloudDialogflowV2GeneratorEvaluationConfigInputDataConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2GeneratorEvaluationConfigInputDataConfig>;
...
export const GoogleCloudDialogflowV2GeneratorEvaluationConfigSummarizationConfig: Schema.Schema<GoogleCloudDialogflowV2GeneratorEvaluationConfigSummarizationConfig> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDialogflowV2GeneratorEvaluationConfigSummarizationConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2GeneratorEvaluationConfigSummarizationConfig>;
...
export const GoogleCloudDialogflowV2GeneratorEvaluationConfig: Schema.Schema<GoogleCloudDialogflowV2GeneratorEvaluationConfig> = Schema.suspend(() => Schema.Struct({
  inputDataConfig: Schema.optional(GoogleCloudDialogflowV2GeneratorEvaluationConfigInputDataConfig),
  outputGcsBucketPath: Schema.optional(Schema.String),
  summarizationConfig: Schema.optional(GoogleCloudDialogflowV2GeneratorEvaluationConfigSummarizationConfig),
})).annotate({ identifier: "GoogleCloudDialogflowV2GeneratorEvaluationConfig" }) as any as Schema.Schema<GoogleCloudDialogflowV2GeneratorEvaluationConfig>;
...
export const GoogleCloudDialogflowV2SummarizationEvaluationMetricsAccuracyDecomposition: Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsAccuracyDecomposition> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDialogflowV2SummarizationEvaluationMetricsAccuracyDecomposition" }) as any as Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsAccuracyDecomposition>;
...
export const GoogleCloudDialogflowV2SummarizationEvaluationMetricsAdherenceDecomposition: Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsAdherenceDecomposition> = Schema.suspend(() => Schema.Struct({
  point: Schema.optional(Schema.String),
  adherenceReasoning: Schema.optional(Schema.String),
  isAdherent: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "GoogleCloudDialogflowV2SummarizationEvaluationMetricsAdherenceDecomposition" }) as any as Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsAdherenceDecomposition>;
...
export const GoogleCloudDialogflowV2SummarizationEvaluationMetricsDecomposition: Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsDecomposition> = Schema.suspend(() => Schema.Struct({
  accuracyDecomposition: Schema.optional(GoogleCloudDialogflowV2SummarizationEvaluationMetricsAccuracyDecomposition),
  adherenceDecomposition: Schema.optional(GoogleCloudDialogflowV2SummarizationEvaluationMetricsAdherenceDecomposition),
})).annotate({ identifier: "GoogleCloudDialogflowV2SummarizationEvaluationMetricsDecomposition" }) as any as Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsDecomposition>;
...
export const GoogleCloudDialogflowV2SummarizationEvaluationMetricsAdherenceRubric: Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsAdherenceRubric> = Schema.suspend(() => Schema.Struct({
  question: Schema.optional(Schema.String),
  reasoning: Schema.optional(Schema.String),
  isAddressed: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "GoogleCloudDialogflowV2SummarizationEvaluationMetricsAdherenceRubric" }) as any as Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsAdherenceRubric>;
...
export const GoogleCloudDialogflowV2SummarizationEvaluationMetricsCompletenessRubric: Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsCompletenessRubric> = Schema.suspend(() => Schema.Struct({
  question: Schema.optional(Schema.String),
  isAddressed: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "GoogleCloudDialogflowV2SummarizationEvaluationMetricsCompletenessRubric" }) as any as Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsCompletenessRubric>;
...
export const GoogleCloudDialogflowV2SummarizationEvaluationMetricsEvaluationResult: Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsEvaluationResult> = Schema.suspend(() => Schema.Struct({
  accuracyDecomposition: Schema.optional(GoogleCloudDialogflowV2SummarizationEvaluationMetricsAccuracyDecomposition),
  adherenceRubric: Schema.optional(GoogleCloudDialogflowV2SummarizationEvaluationMetricsAdherenceRubric),
  completenessRubric: Schema.optional(GoogleCloudDialogflowV2SummarizationEvaluationMetricsCompletenessRubric),
})).annotate({ identifier: "GoogleCloudDialogflowV2SummarizationEvaluationMetricsEvaluationResult" }) as any as Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsEvaluationResult>;
...
export const GoogleCloudDialogflowV2SummarizationEvaluationMetricsSummarizationEvaluationResult: Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsSummarizationEvaluationResult> = Schema.suspend(() => Schema.Struct({
  sessionId: Schema.optional(Schema.String),
  metric: Schema.optional(Schema.String),
  section: Schema.optional(Schema.String),
  score: Schema.optional(Schema.Number),
  sectionSummary: Schema.optional(Schema.String),
  decompositions: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SummarizationEvaluationMetricsDecomposition)),
  evaluationResults: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SummarizationEvaluationMetricsEvaluationResult)),
})).annotate({ identifier: "GoogleCloudDialogflowV2SummarizationEvaluationMetricsSummarizationEvaluationResult" }) as any as Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsSummarizationEvaluationResult>;

export interface GoogleCloudDialogflowV2SummarizationEvaluationMetricsOverallScoresByMetric {
  metric?: string;
}

export const GoogleCloudDialogflowV2SummarizationEvaluationMetricsOverallScoresByMetric: Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsOverallScoresByMetric> = Schema.suspend(() => Schema.Struct({
  metric: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2SummarizationEvaluationMetricsOverallScoresByMetric" }) as any as Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsOverallScoresByMetric>;
...
export const GoogleCloudDialogflowV2SummarizationEvaluationMetricsSectionToken: Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsSectionToken> = Schema.suspend(() => Schema.Struct({
  section: Schema.optional(Schema.String),
  tokenCount: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2SummarizationEvaluationMetricsSectionToken" }) as any as Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsSectionToken>;
...
export const GoogleCloudDialogflowV2SummarizationEvaluationMetricsConversationDetailMetricDetailSectionDetail: Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsConversationDetailMetricDetailSectionDetail> = Schema.suspend(() => Schema.Struct({
  section: Schema.optional(Schema.String),
  score: Schema.optional(Schema.Number),
  sectionSummary: Schema.optional(Schema.String),
  evaluationResults: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SummarizationEvaluationMetricsEvaluationResult)),
})).annotate({ identifier: "GoogleCloudDialogflowV2SummarizationEvaluationMetricsConversationDetailMetricDetailSectionDetail" }) as any as Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsConversationDetailMetricDetailSectionDetail>;
...
export const GoogleCloudDialogflowV2SummarizationEvaluationMetricsConversationDetailMetricDetail: Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsConversationDetailMetricDetail> = Schema.suspend(() => Schema.Struct({
  metric: Schema.optional(Schema.String),
  score: Schema.optional(Schema.Number),
  sectionDetails: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SummarizationEvaluationMetricsConversationDetailMetricDetailSectionDetail)),
})).annotate({ identifier: "GoogleCloudDialogflowV2SummarizationEvaluationMetricsConversationDetailMetricDetail" }) as any as Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsConversationDetailMetricDetail>;
...
export const GoogleCloudDialogflowV2SummarizationEvaluationMetricsConversationDetail: Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsConversationDetail> = Schema.suspend(() => Schema.Struct({
  messageEntries: Schema.optional(Schema.Array(GoogleCloudDialogflowV2MessageEntry)),
  summarySections: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SummarySuggestionSummarySection)),
  metricDetails: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SummarizationEvaluationMetricsConversationDetailMetricDetail)),
  sectionTokens: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SummarizationEvaluationMetricsSectionToken)),
})).annotate({ identifier: "GoogleCloudDialogflowV2SummarizationEvaluationMetricsConversationDetail" }) as any as Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetricsConversationDetail>;
...
export const GoogleCloudDialogflowV2SummarizationEvaluationMetrics: Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetrics> = Schema.suspend(() => Schema.Struct({
  summarizationEvaluationResults: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SummarizationEvaluationMetricsSummarizationEvaluationResult)),
  summarizationEvaluationMergedResultsUri: Schema.optional(Schema.String),
  overallMetrics: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SummarizationEvaluationMetricsOverallScoresByMetric)),
  overallSectionTokens: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SummarizationEvaluationMetricsSectionToken)),
  conversationDetails: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SummarizationEvaluationMetricsConversationDetail)),
})).annotate({ identifier: "GoogleCloudDialogflowV2SummarizationEvaluationMetrics" }) as any as Schema.Schema<GoogleCloudDialogflowV2SummarizationEvaluationMetrics>;
...
export const GoogleCloudDialogflowV2EvaluationStatus: Schema.Schema<GoogleCloudDialogflowV2EvaluationStatus> = Schema.suspend(() => Schema.Struct({
  done: Schema.optional(Schema.Boolean),
  pipelineStatus: Schema.optional(GoogleRpcStatus),
})).annotate({ identifier: "GoogleCloudDialogflowV2EvaluationStatus" }) as any as Schema.Schema<GoogleCloudDialogflowV2EvaluationStatus>;
...
export const GoogleCloudDialogflowV2GeneratorEvaluation: Schema.Schema<GoogleCloudDialogflowV2GeneratorEvaluation> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  displayName: Schema.optional(Schema.String),
  generatorEvaluationConfig: Schema.optional(GoogleCloudDialogflowV2GeneratorEvaluationConfig),
  createTime: Schema.optional(Schema.String),
  completeTime: Schema.optional(Schema.String),
  initialGenerator: Schema.optional(GoogleCloudDialogflowV2Generator),
  summarizationMetrics: Schema.optional(GoogleCloudDialogflowV2SummarizationEvaluationMetrics),
  evaluationStatus: Schema.optional(GoogleCloudDialogflowV2EvaluationStatus),
  satisfiesPzs: Schema.optional(Schema.Boolean),
  satisfiesPzi: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "GoogleCloudDialogflowV2GeneratorEvaluation" }) as any as Schema.Schema<GoogleCloudDialogflowV2GeneratorEvaluation>;
...
export const GoogleCloudDialogflowV2ListGeneratorEvaluationsResponse: Schema.Schema<GoogleCloudDialogflowV2ListGeneratorEvaluationsResponse> = Schema.suspend(() => Schema.Struct({
  generatorEvaluations: Schema.optional(Schema.Array(GoogleCloudDialogflowV2GeneratorEvaluation)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListGeneratorEvaluationsResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListGeneratorEvaluationsResponse>;
...
export const GoogleCloudDialogflowV2KnowledgeBase: Schema.Schema<GoogleCloudDialogflowV2KnowledgeBase> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  displayName: Schema.optional(Schema.String),
  languageCode: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2KnowledgeBase" }) as any as Schema.Schema<GoogleCloudDialogflowV2KnowledgeBase>;
...
export const GoogleCloudDialogflowV2ListKnowledgeBasesResponse: Schema.Schema<GoogleCloudDialogflowV2ListKnowledgeBasesResponse> = Schema.suspend(() => Schema.Struct({
  knowledgeBases: Schema.optional(Schema.Array(GoogleCloudDialogflowV2KnowledgeBase)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListKnowledgeBasesResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListKnowledgeBasesResponse>;
...
export const GoogleCloudDialogflowV2ConnectionErrorDetails: Schema.Schema<GoogleCloudDialogflowV2ConnectionErrorDetails> = Schema.suspend(() => Schema.Struct({
  certificateState: Schema.optional(Schema.String),
  errorMessage: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ConnectionErrorDetails" }) as any as Schema.Schema<GoogleCloudDialogflowV2ConnectionErrorDetails>;
...
export const GoogleCloudDialogflowV2Connection: Schema.Schema<GoogleCloudDialogflowV2Connection> = Schema.suspend(() => Schema.Struct({
  connectionId: Schema.optional(Schema.String),
  state: Schema.optional(Schema.String),
  updateTime: Schema.optional(Schema.String),
  errorDetails: Schema.optional(GoogleCloudDialogflowV2ConnectionErrorDetails),
})).annotate({ identifier: "GoogleCloudDialogflowV2Connection" }) as any as Schema.Schema<GoogleCloudDialogflowV2Connection>;
...
export const GoogleCloudDialogflowV2SipTrunk: Schema.Schema<GoogleCloudDialogflowV2SipTrunk> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  expectedHostname: Schema.optional(Schema.Array(Schema.String)),
  connections: Schema.optional(Schema.Array(GoogleCloudDialogflowV2Connection)),
  displayName: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2SipTrunk" }) as any as Schema.Schema<GoogleCloudDialogflowV2SipTrunk>;
...
export const GoogleCloudDialogflowV2ListSipTrunksResponse: Schema.Schema<GoogleCloudDialogflowV2ListSipTrunksResponse> = Schema.suspend(() => Schema.Struct({
  sipTrunks: Schema.optional(Schema.Array(GoogleCloudDialogflowV2SipTrunk)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListSipTrunksResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListSipTrunksResponse>;
...
export const GoogleCloudDialogflowV2Version: Schema.Schema<GoogleCloudDialogflowV2Version> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
  versionNumber: Schema.optional(Schema.Number),
  createTime: Schema.optional(Schema.String),
  status: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2Version" }) as any as Schema.Schema<GoogleCloudDialogflowV2Version>;
...
export const GoogleCloudDialogflowV2ListVersionsResponse: Schema.Schema<GoogleCloudDialogflowV2ListVersionsResponse> = Schema.suspend(() => Schema.Struct({
  versions: Schema.optional(Schema.Array(GoogleCloudDialogflowV2Version)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDialogflowV2ListVersionsResponse" }) as any as Schema.Schema<GoogleCloudDialogflowV2ListVersionsResponse>;
...
export const GetAgentProjectsResponse = GoogleCloudDialogflowV2Agent;

export type GetAgentProjectsError = DefaultErrors;

export const getAgentProjects: API.OperationMethod<GetAgentProjectsRequest, GetAgentProjectsResponse, GetAgentProjectsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const SetAgentProjectsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent", hasBody: true }),
  svc,
) as unknown as Schema.Schema<SetAgentProjectsRequest>;

export type SetAgentProjectsResponse = GoogleCloudDialogflowV2Agent;
export const SetAgentProjectsResponse = GoogleCloudDialogflowV2Agent;

export type SetAgentProjectsError = DefaultErrors;

export const setAgentProjects: API.OperationMethod<SetAgentProjectsRequest, SetAgentProjectsResponse, SetAgentProjectsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const deleteAgentProjects: API.OperationMethod<DeleteAgentProjectsRequest, DeleteAgentProjectsResponse, DeleteAgentProjectsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listProjectsOperations: API.PaginatedOperationMethod<ListProjectsOperationsRequest, ListProjectsOperationsResponse, ListProjectsOperationsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const CancelProjectsOperationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/operations/{operationsId}:cancel", hasBody: true }),
  svc,
...
export const cancelProjectsOperations: API.OperationMethod<CancelProjectsOperationsRequest, CancelProjectsOperationsResponse, CancelProjectsOperationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetAgentProjectsLocationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent" }),
  svc,
...
export const GetAgentProjectsLocationsResponse = GoogleCloudDialogflowV2Agent;

export type GetAgentProjectsLocationsError = DefaultErrors;

export const getAgentProjectsLocations: API.OperationMethod<GetAgentProjectsLocationsRequest, GetAgentProjectsLocationsResponse, GetAgentProjectsLocationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const SetAgentProjectsLocationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent", hasBody: true }),
  svc,
...
export const SetAgentProjectsLocationsResponse = GoogleCloudDialogflowV2Agent;

export type SetAgentProjectsLocationsError = DefaultErrors;

export const setAgentProjectsLocations: API.OperationMethod<SetAgentProjectsLocationsRequest, SetAgentProjectsLocationsResponse, SetAgentProjectsLocationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteAgentProjectsLocationsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/agent" }),
  svc,
...
export const deleteAgentProjectsLocations: API.OperationMethod<DeleteAgentProjectsLocationsRequest, DeleteAgentProjectsLocationsResponse, DeleteAgentProjectsLocationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetEncryptionSpecProjectsLocationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/encryptionSpec" }),
  svc,
) as unknown as Schema.Schema<GetEncryptionSpecProjectsLocationsRequest>;

export type GetEncryptionSpecProjectsLocationsResponse = GoogleCloudDialogflowV2EncryptionSpec;
export const GetEncryptionSpecProjectsLocationsResponse = GoogleCloudDialogflowV2EncryptionSpec;

export type GetEncryptionSpecProjectsLocationsError = DefaultErrors;

export const getEncryptionSpecProjectsLocations: API.OperationMethod<GetEncryptionSpecProjectsLocationsRequest, GetEncryptionSpecProjectsLocationsResponse, GetEncryptionSpecProjectsLocationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const SearchProjectsLocationsAgentRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent:search" }),
  svc,
) as unknown as Schema.Schema<SearchProjectsLocationsAgentRequest>;

export type SearchProjectsLocationsAgentResponse = GoogleCloudDialogflowV2SearchAgentsResponse;
export const SearchProjectsLocationsAgentResponse = GoogleCloudDialogflowV2SearchAgentsResponse;

export type SearchProjectsLocationsAgentError = DefaultErrors;

export const searchProjectsLocationsAgent: API.PaginatedOperationMethod<SearchProjectsLocationsAgentRequest, SearchProjectsLocationsAgentResponse, SearchProjectsLocationsAgentError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const TrainProjectsLocationsAgentRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2TrainAgentRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent:train", hasBody: true }),
  svc,
...
export const trainProjectsLocationsAgent: API.OperationMethod<TrainProjectsLocationsAgentRequest, TrainProjectsLocationsAgentResponse, TrainProjectsLocationsAgentError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ExportProjectsLocationsAgentRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2ExportAgentRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent:export", hasBody: true }),
  svc,
...
export const exportProjectsLocationsAgent: API.OperationMethod<ExportProjectsLocationsAgentRequest, ExportProjectsLocationsAgentResponse, ExportProjectsLocationsAgentError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ImportProjectsLocationsAgentRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2ImportAgentRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent:import", hasBody: true }),
  svc,
...
export const importProjectsLocationsAgent: API.OperationMethod<ImportProjectsLocationsAgentRequest, ImportProjectsLocationsAgentResponse, ImportProjectsLocationsAgentError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const RestoreProjectsLocationsAgentRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2RestoreAgentRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent:restore", hasBody: true }),
  svc,
...
export const restoreProjectsLocationsAgent: API.OperationMethod<RestoreProjectsLocationsAgentRequest, RestoreProjectsLocationsAgentResponse, RestoreProjectsLocationsAgentError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetValidationResultProjectsLocationsAgentRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/validationResult" }),
  svc,
) as unknown as Schema.Schema<GetValidationResultProjectsLocationsAgentRequest>;

export type GetValidationResultProjectsLocationsAgentResponse = GoogleCloudDialogflowV2ValidationResult;
export const GetValidationResultProjectsLocationsAgentResponse = GoogleCloudDialogflowV2ValidationResult;

export type GetValidationResultProjectsLocationsAgentError = DefaultErrors;

export const getValidationResultProjectsLocationsAgent: API.OperationMethod<GetValidationResultProjectsLocationsAgentRequest, GetValidationResultProjectsLocationsAgentResponse, GetValidationResultProjectsLocationsAgentError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetFulfillmentProjectsLocationsAgentRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/fulfillment" }),
  svc,
) as unknown as Schema.Schema<GetFulfillmentProjectsLocationsAgentRequest>;

export type GetFulfillmentProjectsLocationsAgentResponse = GoogleCloudDialogflowV2Fulfillment;
export const GetFulfillmentProjectsLocationsAgentResponse = GoogleCloudDialogflowV2Fulfillment;

export type GetFulfillmentProjectsLocationsAgentError = DefaultErrors;

export const getFulfillmentProjectsLocationsAgent: API.OperationMethod<GetFulfillmentProjectsLocationsAgentRequest, GetFulfillmentProjectsLocationsAgentResponse, GetFulfillmentProjectsLocationsAgentError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateFulfillmentProjectsLocationsAgentRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(GoogleCloudDialogflowV2Fulfillment).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/fulfillment", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateFulfillmentProjectsLocationsAgentRequest>;

export type UpdateFulfillmentProjectsLocationsAgentResponse = GoogleCloudDialogflowV2Fulfillment;
export const UpdateFulfillmentProjectsLocationsAgentResponse = GoogleCloudDialogflowV2Fulfillment;

export type UpdateFulfillmentProjectsLocationsAgentError = DefaultErrors;

export const updateFulfillmentProjectsLocationsAgent: API.OperationMethod<UpdateFulfillmentProjectsLocationsAgentRequest, UpdateFulfillmentProjectsLocationsAgentResponse, UpdateFulfillmentProjectsLocationsAgentError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteContextsProjectsLocationsAgentSessionsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/sessions/{sessionsId}/contexts" }),
  svc,
...
export const deleteContextsProjectsLocationsAgentSessions: API.OperationMethod<DeleteContextsProjectsLocationsAgentSessionsRequest, DeleteContextsProjectsLocationsAgentSessionsResponse, DeleteContextsProjectsLocationsAgentSessionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DetectIntentProjectsLocationsAgentSessionsRequest = Schema.Struct({
  ...
  body: Schema.optional(GoogleCloudDialogflowV2DetectIntentRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/sessions/{sessionsId}:detectIntent", hasBody: true }),
  svc,
) as unknown as Schema.Schema<DetectIntentProjectsLocationsAgentSessionsRequest>;

export type DetectIntentProjectsLocationsAgentSessionsResponse = GoogleCloudDialogflowV2DetectIntentResponse;
export const DetectIntentProjectsLocationsAgentSessionsResponse = GoogleCloudDialogflowV2DetectIntentResponse;

export type DetectIntentProjectsLocationsAgentSessionsError = DefaultErrors;

export const detectIntentProjectsLocationsAgentSessions: API.OperationMethod<DetectIntentProjectsLocationsAgentSessionsRequest, DetectIntentProjectsLocationsAgentSessionsResponse, DetectIntentProjectsLocationsAgentSessionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsAgentSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/sessions/{sessionsId}/contexts" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsAgentSessionsContextsRequest>;

export type ListProjectsLocationsAgentSessionsContextsResponse = GoogleCloudDialogflowV2ListContextsResponse;
export const ListProjectsLocationsAgentSessionsContextsResponse = GoogleCloudDialogflowV2ListContextsResponse;

export type ListProjectsLocationsAgentSessionsContextsError = DefaultErrors;

export const listProjectsLocationsAgentSessionsContexts: API.PaginatedOperationMethod<ListProjectsLocationsAgentSessionsContextsRequest, ListProjectsLocationsAgentSessionsContextsResponse, ListProjectsLocationsAgentSessionsContextsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsAgentSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/sessions/{sessionsId}/contexts/{contextsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsAgentSessionsContextsRequest>;

export type GetProjectsLocationsAgentSessionsContextsResponse = GoogleCloudDialogflowV2Context;
export const GetProjectsLocationsAgentSessionsContextsResponse = GoogleCloudDialogflowV2Context;

export type GetProjectsLocationsAgentSessionsContextsError = DefaultErrors;

export const getProjectsLocationsAgentSessionsContexts: API.OperationMethod<GetProjectsLocationsAgentSessionsContextsRequest, GetProjectsLocationsAgentSessionsContextsResponse, GetProjectsLocationsAgentSessionsContextsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsAgentSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/sessions/{sessionsId}/contexts", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsAgentSessionsContextsRequest>;

export type CreateProjectsLocationsAgentSessionsContextsResponse = GoogleCloudDialogflowV2Context;
export const CreateProjectsLocationsAgentSessionsContextsResponse = GoogleCloudDialogflowV2Context;

export type CreateProjectsLocationsAgentSessionsContextsError = DefaultErrors;

export const createProjectsLocationsAgentSessionsContexts: API.OperationMethod<CreateProjectsLocationsAgentSessionsContextsRequest, CreateProjectsLocationsAgentSessionsContextsResponse, CreateProjectsLocationsAgentSessionsContextsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsAgentSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/sessions/{sessionsId}/contexts/{contextsId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsLocationsAgentSessionsContextsRequest>;

export type PatchProjectsLocationsAgentSessionsContextsResponse = GoogleCloudDialogflowV2Context;
export const PatchProjectsLocationsAgentSessionsContextsResponse = GoogleCloudDialogflowV2Context;

export type PatchProjectsLocationsAgentSessionsContextsError = DefaultErrors;

export const patchProjectsLocationsAgentSessionsContexts: API.OperationMethod<PatchProjectsLocationsAgentSessionsContextsRequest, PatchProjectsLocationsAgentSessionsContextsResponse, PatchProjectsLocationsAgentSessionsContextsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsAgentSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/sessions/{sessionsId}/contexts/{contextsId}" }),
  svc,
...
export const deleteProjectsLocationsAgentSessionsContexts: API.OperationMethod<DeleteProjectsLocationsAgentSessionsContextsRequest, DeleteProjectsLocationsAgentSessionsContextsResponse, DeleteProjectsLocationsAgentSessionsContextsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsAgentSessionsEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/sessions/{sessionsId}/entityTypes" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsAgentSessionsEntityTypesRequest>;

export type ListProjectsLocationsAgentSessionsEntityTypesResponse = GoogleCloudDialogflowV2ListSessionEntityTypesResponse;
export const ListProjectsLocationsAgentSessionsEntityTypesResponse = GoogleCloudDialogflowV2ListSessionEntityTypesResponse;

export type ListProjectsLocationsAgentSessionsEntityTypesError = DefaultErrors;

export const listProjectsLocationsAgentSessionsEntityTypes: API.PaginatedOperationMethod<ListProjectsLocationsAgentSessionsEntityTypesRequest, ListProjectsLocationsAgentSessionsEntityTypesResponse, ListProjectsLocationsAgentSessionsEntityTypesError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsAgentSessionsEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/sessions/{sessionsId}/entityTypes/{entityTypesId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsAgentSessionsEntityTypesRequest>;

export type GetProjectsLocationsAgentSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;
export const GetProjectsLocationsAgentSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;

export type GetProjectsLocationsAgentSessionsEntityTypesError = DefaultErrors;

export const getProjectsLocationsAgentSessionsEntityTypes: API.OperationMethod<GetProjectsLocationsAgentSessionsEntityTypesRequest, GetProjectsLocationsAgentSessionsEntityTypesResponse, GetProjectsLocationsAgentSessionsEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsAgentSessionsEntityTypesRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2SessionEntityType).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/sessions/{sessionsId}/entityTypes", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsAgentSessionsEntityTypesRequest>;

export type CreateProjectsLocationsAgentSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;
export const CreateProjectsLocationsAgentSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;

export type CreateProjectsLocationsAgentSessionsEntityTypesError = DefaultErrors;

export const createProjectsLocationsAgentSessionsEntityTypes: API.OperationMethod<CreateProjectsLocationsAgentSessionsEntityTypesRequest, CreateProjectsLocationsAgentSessionsEntityTypesResponse, CreateProjectsLocationsAgentSessionsEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsAgentSessionsEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/sessions/{sessionsId}/entityTypes/{entityTypesId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsLocationsAgentSessionsEntityTypesRequest>;

export type PatchProjectsLocationsAgentSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;
export const PatchProjectsLocationsAgentSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;

export type PatchProjectsLocationsAgentSessionsEntityTypesError = DefaultErrors;

export const patchProjectsLocationsAgentSessionsEntityTypes: API.OperationMethod<PatchProjectsLocationsAgentSessionsEntityTypesRequest, PatchProjectsLocationsAgentSessionsEntityTypesResponse, PatchProjectsLocationsAgentSessionsEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsAgentSessionsEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/sessions/{sessionsId}/entityTypes/{entityTypesId}" }),
  svc,
...
export type DeleteProjectsLocationsAgentSessionsEntityTypesError = DefaultErrors;

export const deleteProjectsLocationsAgentSessionsEntityTypes: API.OperationMethod<DeleteProjectsLocationsAgentSessionsEntityTypesRequest, DeleteProjectsLocationsAgentSessionsEntityTypesResponse, DeleteProjectsLocationsAgentSessionsEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsAgentIntentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/intents" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsAgentIntentsRequest>;

export type ListProjectsLocationsAgentIntentsResponse = GoogleCloudDialogflowV2ListIntentsResponse;
export const ListProjectsLocationsAgentIntentsResponse = GoogleCloudDialogflowV2ListIntentsResponse;

export type ListProjectsLocationsAgentIntentsError = DefaultErrors;

export const listProjectsLocationsAgentIntents: API.PaginatedOperationMethod<ListProjectsLocationsAgentIntentsRequest, ListProjectsLocationsAgentIntentsResponse, ListProjectsLocationsAgentIntentsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsAgentIntentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/intents/{intentsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsAgentIntentsRequest>;

export type GetProjectsLocationsAgentIntentsResponse = GoogleCloudDialogflowV2Intent;
export const GetProjectsLocationsAgentIntentsResponse = GoogleCloudDialogflowV2Intent;

export type GetProjectsLocationsAgentIntentsError = DefaultErrors;

export const getProjectsLocationsAgentIntents: API.OperationMethod<GetProjectsLocationsAgentIntentsRequest, GetProjectsLocationsAgentIntentsResponse, GetProjectsLocationsAgentIntentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsAgentIntentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/intents", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsAgentIntentsRequest>;

export type CreateProjectsLocationsAgentIntentsResponse = GoogleCloudDialogflowV2Intent;
export const CreateProjectsLocationsAgentIntentsResponse = GoogleCloudDialogflowV2Intent;

export type CreateProjectsLocationsAgentIntentsError = DefaultErrors;

export const createProjectsLocationsAgentIntents: API.OperationMethod<CreateProjectsLocationsAgentIntentsRequest, CreateProjectsLocationsAgentIntentsResponse, CreateProjectsLocationsAgentIntentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsAgentIntentsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/intents/{intentsId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsLocationsAgentIntentsRequest>;

export type PatchProjectsLocationsAgentIntentsResponse = GoogleCloudDialogflowV2Intent;
export const PatchProjectsLocationsAgentIntentsResponse = GoogleCloudDialogflowV2Intent;

export type PatchProjectsLocationsAgentIntentsError = DefaultErrors;

export const patchProjectsLocationsAgentIntents: API.OperationMethod<PatchProjectsLocationsAgentIntentsRequest, PatchProjectsLocationsAgentIntentsResponse, PatchProjectsLocationsAgentIntentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsAgentIntentsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/intents/{intentsId}" }),
  svc,
...
export const deleteProjectsLocationsAgentIntents: API.OperationMethod<DeleteProjectsLocationsAgentIntentsRequest, DeleteProjectsLocationsAgentIntentsResponse, DeleteProjectsLocationsAgentIntentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const BatchUpdateProjectsLocationsAgentIntentsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2BatchUpdateIntentsRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/intents:batchUpdate", hasBody: true }),
  svc,
...
export const batchUpdateProjectsLocationsAgentIntents: API.OperationMethod<BatchUpdateProjectsLocationsAgentIntentsRequest, BatchUpdateProjectsLocationsAgentIntentsResponse, BatchUpdateProjectsLocationsAgentIntentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const BatchDeleteProjectsLocationsAgentIntentsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2BatchDeleteIntentsRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/intents:batchDelete", hasBody: true }),
  svc,
...
export const batchDeleteProjectsLocationsAgentIntents: API.OperationMethod<BatchDeleteProjectsLocationsAgentIntentsRequest, BatchDeleteProjectsLocationsAgentIntentsResponse, BatchDeleteProjectsLocationsAgentIntentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsAgentEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/entityTypes" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsAgentEntityTypesRequest>;

export type ListProjectsLocationsAgentEntityTypesResponse = GoogleCloudDialogflowV2ListEntityTypesResponse;
export const ListProjectsLocationsAgentEntityTypesResponse = GoogleCloudDialogflowV2ListEntityTypesResponse;

export type ListProjectsLocationsAgentEntityTypesError = DefaultErrors;

export const listProjectsLocationsAgentEntityTypes: API.PaginatedOperationMethod<ListProjectsLocationsAgentEntityTypesRequest, ListProjectsLocationsAgentEntityTypesResponse, ListProjectsLocationsAgentEntityTypesError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsAgentEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/entityTypes/{entityTypesId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsAgentEntityTypesRequest>;

export type GetProjectsLocationsAgentEntityTypesResponse = GoogleCloudDialogflowV2EntityType;
export const GetProjectsLocationsAgentEntityTypesResponse = GoogleCloudDialogflowV2EntityType;

export type GetProjectsLocationsAgentEntityTypesError = DefaultErrors;

export const getProjectsLocationsAgentEntityTypes: API.OperationMethod<GetProjectsLocationsAgentEntityTypesRequest, GetProjectsLocationsAgentEntityTypesResponse, GetProjectsLocationsAgentEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsAgentEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/entityTypes", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsAgentEntityTypesRequest>;

export type CreateProjectsLocationsAgentEntityTypesResponse = GoogleCloudDialogflowV2EntityType;
export const CreateProjectsLocationsAgentEntityTypesResponse = GoogleCloudDialogflowV2EntityType;

export type CreateProjectsLocationsAgentEntityTypesError = DefaultErrors;

export const createProjectsLocationsAgentEntityTypes: API.OperationMethod<CreateProjectsLocationsAgentEntityTypesRequest, CreateProjectsLocationsAgentEntityTypesResponse, CreateProjectsLocationsAgentEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsAgentEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/entityTypes/{entityTypesId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsLocationsAgentEntityTypesRequest>;

export type PatchProjectsLocationsAgentEntityTypesResponse = GoogleCloudDialogflowV2EntityType;
export const PatchProjectsLocationsAgentEntityTypesResponse = GoogleCloudDialogflowV2EntityType;

export type PatchProjectsLocationsAgentEntityTypesError = DefaultErrors;

export const patchProjectsLocationsAgentEntityTypes: API.OperationMethod<PatchProjectsLocationsAgentEntityTypesRequest, PatchProjectsLocationsAgentEntityTypesResponse, PatchProjectsLocationsAgentEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsAgentEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/entityTypes/{entityTypesId}" }),
  svc,
...
export const deleteProjectsLocationsAgentEntityTypes: API.OperationMethod<DeleteProjectsLocationsAgentEntityTypesRequest, DeleteProjectsLocationsAgentEntityTypesResponse, DeleteProjectsLocationsAgentEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const BatchUpdateProjectsLocationsAgentEntityTypesRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2BatchUpdateEntityTypesRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/entityTypes:batchUpdate", hasBody: true }),
  svc,
...
export const batchUpdateProjectsLocationsAgentEntityTypes: API.OperationMethod<BatchUpdateProjectsLocationsAgentEntityTypesRequest, BatchUpdateProjectsLocationsAgentEntityTypesResponse, BatchUpdateProjectsLocationsAgentEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const BatchDeleteProjectsLocationsAgentEntityTypesRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2BatchDeleteEntityTypesRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/entityTypes:batchDelete", hasBody: true }),
  svc,
...
export const batchDeleteProjectsLocationsAgentEntityTypes: API.OperationMethod<BatchDeleteProjectsLocationsAgentEntityTypesRequest, BatchDeleteProjectsLocationsAgentEntityTypesResponse, BatchDeleteProjectsLocationsAgentEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const BatchCreateProjectsLocationsAgentEntityTypesEntitiesRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2BatchCreateEntitiesRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/entityTypes/{entityTypesId}/entities:batchCreate", hasBody: true }),
  svc,
...
export type BatchCreateProjectsLocationsAgentEntityTypesEntitiesError = DefaultErrors;

export const batchCreateProjectsLocationsAgentEntityTypesEntities: API.OperationMethod<BatchCreateProjectsLocationsAgentEntityTypesEntitiesRequest, BatchCreateProjectsLocationsAgentEntityTypesEntitiesResponse, BatchCreateProjectsLocationsAgentEntityTypesEntitiesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const BatchUpdateProjectsLocationsAgentEntityTypesEntitiesRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2BatchUpdateEntitiesRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/entityTypes/{entityTypesId}/entities:batchUpdate", hasBody: true }),
  svc,
...
export type BatchUpdateProjectsLocationsAgentEntityTypesEntitiesError = DefaultErrors;

export const batchUpdateProjectsLocationsAgentEntityTypesEntities: API.OperationMethod<BatchUpdateProjectsLocationsAgentEntityTypesEntitiesRequest, BatchUpdateProjectsLocationsAgentEntityTypesEntitiesResponse, BatchUpdateProjectsLocationsAgentEntityTypesEntitiesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const BatchDeleteProjectsLocationsAgentEntityTypesEntitiesRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2BatchDeleteEntitiesRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/entityTypes/{entityTypesId}/entities:batchDelete", hasBody: true }),
  svc,
...
export type BatchDeleteProjectsLocationsAgentEntityTypesEntitiesError = DefaultErrors;
...
export const ListProjectsLocationsAgentEnvironmentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/environments" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsAgentEnvironmentsRequest>;

export type ListProjectsLocationsAgentEnvironmentsResponse = GoogleCloudDialogflowV2ListEnvironmentsResponse;
export const ListProjectsLocationsAgentEnvironmentsResponse = GoogleCloudDialogflowV2ListEnvironmentsResponse;

export type ListProjectsLocationsAgentEnvironmentsError = DefaultErrors;

export const listProjectsLocationsAgentEnvironments: API.PaginatedOperationMethod<ListProjectsLocationsAgentEnvironmentsRequest, ListProjectsLocationsAgentEnvironmentsResponse, ListProjectsLocationsAgentEnvironmentsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsAgentEnvironmentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/environments/{environmentsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsAgentEnvironmentsRequest>;

export type GetProjectsLocationsAgentEnvironmentsResponse = GoogleCloudDialogflowV2Environment;
export const GetProjectsLocationsAgentEnvironmentsResponse = GoogleCloudDialogflowV2Environment;

export type GetProjectsLocationsAgentEnvironmentsError = DefaultErrors;

export const getProjectsLocationsAgentEnvironments: API.OperationMethod<GetProjectsLocationsAgentEnvironmentsRequest, GetProjectsLocationsAgentEnvironmentsResponse, GetProjectsLocationsAgentEnvironmentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsAgentEnvironmentsRequest = Schema.Struct({
  ...
  body: Schema.optional(GoogleCloudDialogflowV2Environment).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/environments", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsAgentEnvironmentsRequest>;

export type CreateProjectsLocationsAgentEnvironmentsResponse = GoogleCloudDialogflowV2Environment;
export const CreateProjectsLocationsAgentEnvironmentsResponse = GoogleCloudDialogflowV2Environment;

export type CreateProjectsLocationsAgentEnvironmentsError = DefaultErrors;

export const createProjectsLocationsAgentEnvironments: API.OperationMethod<CreateProjectsLocationsAgentEnvironmentsRequest, CreateProjectsLocationsAgentEnvironmentsResponse, CreateProjectsLocationsAgentEnvironmentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsAgentEnvironmentsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/environments/{environmentsId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsLocationsAgentEnvironmentsRequest>;

export type PatchProjectsLocationsAgentEnvironmentsResponse = GoogleCloudDialogflowV2Environment;
export const PatchProjectsLocationsAgentEnvironmentsResponse = GoogleCloudDialogflowV2Environment;

export type PatchProjectsLocationsAgentEnvironmentsError = DefaultErrors;

export const patchProjectsLocationsAgentEnvironments: API.OperationMethod<PatchProjectsLocationsAgentEnvironmentsRequest, PatchProjectsLocationsAgentEnvironmentsResponse, PatchProjectsLocationsAgentEnvironmentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsAgentEnvironmentsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/environments/{environmentsId}" }),
  svc,
...
export const deleteProjectsLocationsAgentEnvironments: API.OperationMethod<DeleteProjectsLocationsAgentEnvironmentsRequest, DeleteProjectsLocationsAgentEnvironmentsResponse, DeleteProjectsLocationsAgentEnvironmentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetHistoryProjectsLocationsAgentEnvironmentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/environments/{environmentsId}/history" }),
  svc,
) as unknown as Schema.Schema<GetHistoryProjectsLocationsAgentEnvironmentsRequest>;

export type GetHistoryProjectsLocationsAgentEnvironmentsResponse = GoogleCloudDialogflowV2EnvironmentHistory;
export const GetHistoryProjectsLocationsAgentEnvironmentsResponse = GoogleCloudDialogflowV2EnvironmentHistory;

export type GetHistoryProjectsLocationsAgentEnvironmentsError = DefaultErrors;

export const getHistoryProjectsLocationsAgentEnvironments: API.PaginatedOperationMethod<GetHistoryProjectsLocationsAgentEnvironmentsRequest, GetHistoryProjectsLocationsAgentEnvironmentsResponse, GetHistoryProjectsLocationsAgentEnvironmentsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const DeleteContextsProjectsLocationsAgentEnvironmentsUsersSessionsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/contexts" }),
  svc,
...
export type DeleteContextsProjectsLocationsAgentEnvironmentsUsersSessionsError = DefaultErrors;

export const deleteContextsProjectsLocationsAgentEnvironmentsUsersSessions: API.OperationMethod<DeleteContextsProjectsLocationsAgentEnvironmentsUsersSessionsRequest, DeleteContextsProjectsLocationsAgentEnvironmentsUsersSessionsResponse, DeleteContextsProjectsLocationsAgentEnvironmentsUsersSessionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DetectIntentProjectsLocationsAgentEnvironmentsUsersSessionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}:detectIntent", hasBody: true }),
  svc,
) as unknown as Schema.Schema<DetectIntentProjectsLocationsAgentEnvironmentsUsersSessionsRequest>;

export type DetectIntentProjectsLocationsAgentEnvironmentsUsersSessionsResponse = GoogleCloudDialogflowV2DetectIntentResponse;
export const DetectIntentProjectsLocationsAgentEnvironmentsUsersSessionsResponse = GoogleCloudDialogflowV2DetectIntentResponse;

export type DetectIntentProjectsLocationsAgentEnvironmentsUsersSessionsError = DefaultErrors;
...
export const ListProjectsLocationsAgentEnvironmentsUsersSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/contexts" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsAgentEnvironmentsUsersSessionsContextsRequest>;

export type ListProjectsLocationsAgentEnvironmentsUsersSessionsContextsResponse = GoogleCloudDialogflowV2ListContextsResponse;
export const ListProjectsLocationsAgentEnvironmentsUsersSessionsContextsResponse = GoogleCloudDialogflowV2ListContextsResponse;

export type ListProjectsLocationsAgentEnvironmentsUsersSessionsContextsError = DefaultErrors;
...
export const GetProjectsLocationsAgentEnvironmentsUsersSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/contexts/{contextsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsAgentEnvironmentsUsersSessionsContextsRequest>;

export type GetProjectsLocationsAgentEnvironmentsUsersSessionsContextsResponse = GoogleCloudDialogflowV2Context;
export const GetProjectsLocationsAgentEnvironmentsUsersSessionsContextsResponse = GoogleCloudDialogflowV2Context;

export type GetProjectsLocationsAgentEnvironmentsUsersSessionsContextsError = DefaultErrors;

export const getProjectsLocationsAgentEnvironmentsUsersSessionsContexts: API.OperationMethod<GetProjectsLocationsAgentEnvironmentsUsersSessionsContextsRequest, GetProjectsLocationsAgentEnvironmentsUsersSessionsContextsResponse, GetProjectsLocationsAgentEnvironmentsUsersSessionsContextsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsAgentEnvironmentsUsersSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/contexts", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsAgentEnvironmentsUsersSessionsContextsRequest>;

export type CreateProjectsLocationsAgentEnvironmentsUsersSessionsContextsResponse = GoogleCloudDialogflowV2Context;
export const CreateProjectsLocationsAgentEnvironmentsUsersSessionsContextsResponse = GoogleCloudDialogflowV2Context;

export type CreateProjectsLocationsAgentEnvironmentsUsersSessionsContextsError = DefaultErrors;

export const createProjectsLocationsAgentEnvironmentsUsersSessionsContexts: API.OperationMethod<CreateProjectsLocationsAgentEnvironmentsUsersSessionsContextsRequest, CreateProjectsLocationsAgentEnvironmentsUsersSessionsContextsResponse, CreateProjectsLocationsAgentEnvironmentsUsersSessionsContextsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsAgentEnvironmentsUsersSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/contexts/{contextsId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsLocationsAgentEnvironmentsUsersSessionsContextsRequest>;

export type PatchProjectsLocationsAgentEnvironmentsUsersSessionsContextsResponse = GoogleCloudDialogflowV2Context;
export const PatchProjectsLocationsAgentEnvironmentsUsersSessionsContextsResponse = GoogleCloudDialogflowV2Context;

export type PatchProjectsLocationsAgentEnvironmentsUsersSessionsContextsError = DefaultErrors;
...
export const DeleteProjectsLocationsAgentEnvironmentsUsersSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/contexts/{contextsId}" }),
  svc,
...
export const ListProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/entityTypes" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesRequest>;

export type ListProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesResponse = GoogleCloudDialogflowV2ListSessionEntityTypesResponse;
export const ListProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesResponse = GoogleCloudDialogflowV2ListSessionEntityTypesResponse;

export type ListProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesError = DefaultErrors;

export const listProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypes: API.PaginatedOperationMethod<ListProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesRequest, ListProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesResponse, ListProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/entityTypes/{entityTypesId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesRequest>;

export type GetProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;
export const GetProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;

export type GetProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesError = DefaultErrors;

export const getProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypes: API.OperationMethod<GetProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesRequest, GetProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesResponse, GetProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/entityTypes", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesRequest>;

export type CreateProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;
export const CreateProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;

export type CreateProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesError = DefaultErrors;

export const createProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypes: API.OperationMethod<CreateProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesRequest, CreateProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesResponse, CreateProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/entityTypes/{entityTypesId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesRequest>;

export type PatchProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;
export const PatchProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;

export type PatchProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesError = DefaultErrors;
...
export const DeleteProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/entityTypes/{entityTypesId}" }),
  svc,
...
export type DeleteProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesError = DefaultErrors;

export const deleteProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypes: API.OperationMethod<DeleteProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesRequest, DeleteProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesResponse, DeleteProjectsLocationsAgentEnvironmentsUsersSessionsEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsAgentEnvironmentsIntentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/environments/{environmentsId}/intents" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsAgentEnvironmentsIntentsRequest>;

export type ListProjectsLocationsAgentEnvironmentsIntentsResponse = GoogleCloudDialogflowV2ListIntentsResponse;
export const ListProjectsLocationsAgentEnvironmentsIntentsResponse = GoogleCloudDialogflowV2ListIntentsResponse;

export type ListProjectsLocationsAgentEnvironmentsIntentsError = DefaultErrors;

export const listProjectsLocationsAgentEnvironmentsIntents: API.PaginatedOperationMethod<ListProjectsLocationsAgentEnvironmentsIntentsRequest, ListProjectsLocationsAgentEnvironmentsIntentsResponse, ListProjectsLocationsAgentEnvironmentsIntentsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const ListProjectsLocationsAgentVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/versions" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsAgentVersionsRequest>;

export type ListProjectsLocationsAgentVersionsResponse = GoogleCloudDialogflowV2ListVersionsResponse;
export const ListProjectsLocationsAgentVersionsResponse = GoogleCloudDialogflowV2ListVersionsResponse;

export type ListProjectsLocationsAgentVersionsError = DefaultErrors;

export const listProjectsLocationsAgentVersions: API.PaginatedOperationMethod<ListProjectsLocationsAgentVersionsRequest, ListProjectsLocationsAgentVersionsResponse, ListProjectsLocationsAgentVersionsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsAgentVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/versions/{versionsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsAgentVersionsRequest>;

export type GetProjectsLocationsAgentVersionsResponse = GoogleCloudDialogflowV2Version;
export const GetProjectsLocationsAgentVersionsResponse = GoogleCloudDialogflowV2Version;

export type GetProjectsLocationsAgentVersionsError = DefaultErrors;

export const getProjectsLocationsAgentVersions: API.OperationMethod<GetProjectsLocationsAgentVersionsRequest, GetProjectsLocationsAgentVersionsResponse, GetProjectsLocationsAgentVersionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsAgentVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/versions", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsAgentVersionsRequest>;

export type CreateProjectsLocationsAgentVersionsResponse = GoogleCloudDialogflowV2Version;
export const CreateProjectsLocationsAgentVersionsResponse = GoogleCloudDialogflowV2Version;

export type CreateProjectsLocationsAgentVersionsError = DefaultErrors;

export const createProjectsLocationsAgentVersions: API.OperationMethod<CreateProjectsLocationsAgentVersionsRequest, CreateProjectsLocationsAgentVersionsResponse, CreateProjectsLocationsAgentVersionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsAgentVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/versions/{versionsId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsLocationsAgentVersionsRequest>;

export type PatchProjectsLocationsAgentVersionsResponse = GoogleCloudDialogflowV2Version;
export const PatchProjectsLocationsAgentVersionsResponse = GoogleCloudDialogflowV2Version;

export type PatchProjectsLocationsAgentVersionsError = DefaultErrors;

export const patchProjectsLocationsAgentVersions: API.OperationMethod<PatchProjectsLocationsAgentVersionsRequest, PatchProjectsLocationsAgentVersionsResponse, PatchProjectsLocationsAgentVersionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsAgentVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/agent/versions/{versionsId}" }),
  svc,
...
export const deleteProjectsLocationsAgentVersions: API.OperationMethod<DeleteProjectsLocationsAgentVersionsRequest, DeleteProjectsLocationsAgentVersionsResponse, DeleteProjectsLocationsAgentVersionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsToolsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/tools", hasBody: true }),
  svc,
...
export const CreateProjectsLocationsToolsResponse = GoogleCloudDialogflowV2Tool;

export type CreateProjectsLocationsToolsError = DefaultErrors;

export const createProjectsLocationsTools: API.OperationMethod<CreateProjectsLocationsToolsRequest, CreateProjectsLocationsToolsResponse, CreateProjectsLocationsToolsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetProjectsLocationsToolsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/tools/{toolsId}" }),
  svc,
...
export const GetProjectsLocationsToolsResponse = GoogleCloudDialogflowV2Tool;

export type GetProjectsLocationsToolsError = DefaultErrors;

export const getProjectsLocationsTools: API.OperationMethod<GetProjectsLocationsToolsRequest, GetProjectsLocationsToolsResponse, GetProjectsLocationsToolsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsToolsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/tools" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsToolsRequest>;

export type ListProjectsLocationsToolsResponse = GoogleCloudDialogflowV2ListToolsResponse;
export const ListProjectsLocationsToolsResponse = GoogleCloudDialogflowV2ListToolsResponse;

export type ListProjectsLocationsToolsError = DefaultErrors;

export const listProjectsLocationsTools: API.PaginatedOperationMethod<ListProjectsLocationsToolsRequest, ListProjectsLocationsToolsResponse, ListProjectsLocationsToolsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const DeleteProjectsLocationsToolsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/tools/{toolsId}" }),
  svc,
...
export const deleteProjectsLocationsTools: API.OperationMethod<DeleteProjectsLocationsToolsRequest, DeleteProjectsLocationsToolsResponse, DeleteProjectsLocationsToolsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsToolsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/locations/{locationsId}/tools/{toolsId}", hasBody: true }),
  svc,
...
export const PatchProjectsLocationsToolsResponse = GoogleCloudDialogflowV2Tool;

export type PatchProjectsLocationsToolsError = DefaultErrors;

export const patchProjectsLocationsTools: API.OperationMethod<PatchProjectsLocationsToolsRequest, PatchProjectsLocationsToolsResponse, PatchProjectsLocationsToolsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsGeneratorsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/generators", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsGeneratorsRequest>;

export type CreateProjectsLocationsGeneratorsResponse = GoogleCloudDialogflowV2Generator;
export const CreateProjectsLocationsGeneratorsResponse = GoogleCloudDialogflowV2Generator;

export type CreateProjectsLocationsGeneratorsError = DefaultErrors;

export const createProjectsLocationsGenerators: API.OperationMethod<CreateProjectsLocationsGeneratorsRequest, CreateProjectsLocationsGeneratorsResponse, CreateProjectsLocationsGeneratorsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetProjectsLocationsGeneratorsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/generators/{generatorsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsGeneratorsRequest>;

export type GetProjectsLocationsGeneratorsResponse = GoogleCloudDialogflowV2Generator;
export const GetProjectsLocationsGeneratorsResponse = GoogleCloudDialogflowV2Generator;

export type GetProjectsLocationsGeneratorsError = DefaultErrors;

export const getProjectsLocationsGenerators: API.OperationMethod<GetProjectsLocationsGeneratorsRequest, GetProjectsLocationsGeneratorsResponse, GetProjectsLocationsGeneratorsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsGeneratorsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/generators" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsGeneratorsRequest>;

export type ListProjectsLocationsGeneratorsResponse = GoogleCloudDialogflowV2ListGeneratorsResponse;
export const ListProjectsLocationsGeneratorsResponse = GoogleCloudDialogflowV2ListGeneratorsResponse;

export type ListProjectsLocationsGeneratorsError = DefaultErrors;

export const listProjectsLocationsGenerators: API.PaginatedOperationMethod<ListProjectsLocationsGeneratorsRequest, ListProjectsLocationsGeneratorsResponse, ListProjectsLocationsGeneratorsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const DeleteProjectsLocationsGeneratorsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/generators/{generatorsId}" }),
  svc,
...
export const deleteProjectsLocationsGenerators: API.OperationMethod<DeleteProjectsLocationsGeneratorsRequest, DeleteProjectsLocationsGeneratorsResponse, DeleteProjectsLocationsGeneratorsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsGeneratorsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/locations/{locationsId}/generators/{generatorsId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsLocationsGeneratorsRequest>;

export type PatchProjectsLocationsGeneratorsResponse = GoogleCloudDialogflowV2Generator;
export const PatchProjectsLocationsGeneratorsResponse = GoogleCloudDialogflowV2Generator;

export type PatchProjectsLocationsGeneratorsError = DefaultErrors;

export const patchProjectsLocationsGenerators: API.OperationMethod<PatchProjectsLocationsGeneratorsRequest, PatchProjectsLocationsGeneratorsResponse, PatchProjectsLocationsGeneratorsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsGeneratorsEvaluationsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2GeneratorEvaluation).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/generators/{generatorsId}/evaluations", hasBody: true }),
  svc,
...
export const createProjectsLocationsGeneratorsEvaluations: API.OperationMethod<CreateProjectsLocationsGeneratorsEvaluationsRequest, CreateProjectsLocationsGeneratorsEvaluationsResponse, CreateProjectsLocationsGeneratorsEvaluationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetProjectsLocationsGeneratorsEvaluationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/generators/{generatorsId}/evaluations/{evaluationsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsGeneratorsEvaluationsRequest>;

export type GetProjectsLocationsGeneratorsEvaluationsResponse = GoogleCloudDialogflowV2GeneratorEvaluation;
export const GetProjectsLocationsGeneratorsEvaluationsResponse = GoogleCloudDialogflowV2GeneratorEvaluation;

export type GetProjectsLocationsGeneratorsEvaluationsError = DefaultErrors;

export const getProjectsLocationsGeneratorsEvaluations: API.OperationMethod<GetProjectsLocationsGeneratorsEvaluationsRequest, GetProjectsLocationsGeneratorsEvaluationsResponse, GetProjectsLocationsGeneratorsEvaluationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsGeneratorsEvaluationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/generators/{generatorsId}/evaluations" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsGeneratorsEvaluationsRequest>;

export type ListProjectsLocationsGeneratorsEvaluationsResponse = GoogleCloudDialogflowV2ListGeneratorEvaluationsResponse;
export const ListProjectsLocationsGeneratorsEvaluationsResponse = GoogleCloudDialogflowV2ListGeneratorEvaluationsResponse;

export type ListProjectsLocationsGeneratorsEvaluationsError = DefaultErrors;

export const listProjectsLocationsGeneratorsEvaluations: API.PaginatedOperationMethod<ListProjectsLocationsGeneratorsEvaluationsRequest, ListProjectsLocationsGeneratorsEvaluationsResponse, ListProjectsLocationsGeneratorsEvaluationsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const DeleteProjectsLocationsGeneratorsEvaluationsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/generators/{generatorsId}/evaluations/{evaluationsId}" }),
  svc,
...
export const deleteProjectsLocationsGeneratorsEvaluations: API.OperationMethod<DeleteProjectsLocationsGeneratorsEvaluationsRequest, DeleteProjectsLocationsGeneratorsEvaluationsResponse, DeleteProjectsLocationsGeneratorsEvaluationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsAnswerRecordsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/answerRecords" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsAnswerRecordsRequest>;

export type ListProjectsLocationsAnswerRecordsResponse = GoogleCloudDialogflowV2ListAnswerRecordsResponse;
export const ListProjectsLocationsAnswerRecordsResponse = GoogleCloudDialogflowV2ListAnswerRecordsResponse;

export type ListProjectsLocationsAnswerRecordsError = DefaultErrors;

export const listProjectsLocationsAnswerRecords: API.PaginatedOperationMethod<ListProjectsLocationsAnswerRecordsRequest, ListProjectsLocationsAnswerRecordsResponse, ListProjectsLocationsAnswerRecordsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const PatchProjectsLocationsAnswerRecordsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/locations/{locationsId}/answerRecords/{answerRecordsId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsLocationsAnswerRecordsRequest>;

export type PatchProjectsLocationsAnswerRecordsResponse = GoogleCloudDialogflowV2AnswerRecord;
export const PatchProjectsLocationsAnswerRecordsResponse = GoogleCloudDialogflowV2AnswerRecord;

export type PatchProjectsLocationsAnswerRecordsError = DefaultErrors;

export const patchProjectsLocationsAnswerRecords: API.OperationMethod<PatchProjectsLocationsAnswerRecordsRequest, PatchProjectsLocationsAnswerRecordsResponse, PatchProjectsLocationsAnswerRecordsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsConversationDatasetsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2ConversationDataset).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationDatasets", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsConversationDatasetsRequest>;

export type CreateProjectsLocationsConversationDatasetsResponse = GoogleLongrunningOperation;
export const CreateProjectsLocationsConversationDatasetsResponse = GoogleLongrunningOperation;

export type CreateProjectsLocationsConversationDatasetsError = DefaultErrors;

export const createProjectsLocationsConversationDatasets: API.OperationMethod<CreateProjectsLocationsConversationDatasetsRequest, CreateProjectsLocationsConversationDatasetsResponse, CreateProjectsLocationsConversationDatasetsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetProjectsLocationsConversationDatasetsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationDatasets/{conversationDatasetsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsConversationDatasetsRequest>;

export type GetProjectsLocationsConversationDatasetsResponse = GoogleCloudDialogflowV2ConversationDataset;
export const GetProjectsLocationsConversationDatasetsResponse = GoogleCloudDialogflowV2ConversationDataset;

export type GetProjectsLocationsConversationDatasetsError = DefaultErrors;

export const getProjectsLocationsConversationDatasets: API.OperationMethod<GetProjectsLocationsConversationDatasetsRequest, GetProjectsLocationsConversationDatasetsResponse, GetProjectsLocationsConversationDatasetsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsConversationDatasetsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationDatasets" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsConversationDatasetsRequest>;

export type ListProjectsLocationsConversationDatasetsResponse = GoogleCloudDialogflowV2ListConversationDatasetsResponse;
export const ListProjectsLocationsConversationDatasetsResponse = GoogleCloudDialogflowV2ListConversationDatasetsResponse;

export type ListProjectsLocationsConversationDatasetsError = DefaultErrors;

export const listProjectsLocationsConversationDatasets: API.PaginatedOperationMethod<ListProjectsLocationsConversationDatasetsRequest, ListProjectsLocationsConversationDatasetsResponse, ListProjectsLocationsConversationDatasetsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const DeleteProjectsLocationsConversationDatasetsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationDatasets/{conversationDatasetsId}" }),
  svc,
) as unknown as Schema.Schema<DeleteProjectsLocationsConversationDatasetsRequest>;

export type DeleteProjectsLocationsConversationDatasetsResponse = GoogleLongrunningOperation;
export const DeleteProjectsLocationsConversationDatasetsResponse = GoogleLongrunningOperation;

export type DeleteProjectsLocationsConversationDatasetsError = DefaultErrors;

export const deleteProjectsLocationsConversationDatasets: API.OperationMethod<DeleteProjectsLocationsConversationDatasetsRequest, DeleteProjectsLocationsConversationDatasetsResponse, DeleteProjectsLocationsConversationDatasetsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ImportConversationDataProjectsLocationsConversationDatasetsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudDialogflowV2ImportConversationDataRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationDatasets/{conversationDatasetsId}:importConversationData", hasBody: true }),
  svc,
) as unknown as Schema.Schema<ImportConversationDataProjectsLocationsConversationDatasetsRequest>;

export type ImportConversationDataProjectsLocationsConversationDatasetsResponse = GoogleLongrunningOperation;
export const ImportConversationDataProjectsLocationsConversationDatasetsResponse = GoogleLongrunningOperation;

export type ImportConversationDataProjectsLocationsConversationDatasetsError = DefaultErrors;

export const importConversationDataProjectsLocationsConversationDatasets: API.OperationMethod<ImportConversationDataProjectsLocationsConversationDatasetsRequest, ImportConversationDataProjectsLocationsConversationDatasetsResponse, ImportConversationDataProjectsLocationsConversationDatasetsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsConversationModelsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2ConversationModel).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationModels", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsConversationModelsRequest>;

export type CreateProjectsLocationsConversationModelsResponse = GoogleLongrunningOperation;
export const CreateProjectsLocationsConversationModelsResponse = GoogleLongrunningOperation;

export type CreateProjectsLocationsConversationModelsError = DefaultErrors;

export const createProjectsLocationsConversationModels: API.OperationMethod<CreateProjectsLocationsConversationModelsRequest, CreateProjectsLocationsConversationModelsResponse, CreateProjectsLocationsConversationModelsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetProjectsLocationsConversationModelsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationModels/{conversationModelsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsConversationModelsRequest>;

export type GetProjectsLocationsConversationModelsResponse = GoogleCloudDialogflowV2ConversationModel;
export const GetProjectsLocationsConversationModelsResponse = GoogleCloudDialogflowV2ConversationModel;

export type GetProjectsLocationsConversationModelsError = DefaultErrors;

export const getProjectsLocationsConversationModels: API.OperationMethod<GetProjectsLocationsConversationModelsRequest, GetProjectsLocationsConversationModelsResponse, GetProjectsLocationsConversationModelsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsConversationModelsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationModels" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsConversationModelsRequest>;

export type ListProjectsLocationsConversationModelsResponse = GoogleCloudDialogflowV2ListConversationModelsResponse;
export const ListProjectsLocationsConversationModelsResponse = GoogleCloudDialogflowV2ListConversationModelsResponse;

export type ListProjectsLocationsConversationModelsError = DefaultErrors;

export const listProjectsLocationsConversationModels: API.PaginatedOperationMethod<ListProjectsLocationsConversationModelsRequest, ListProjectsLocationsConversationModelsResponse, ListProjectsLocationsConversationModelsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const DeleteProjectsLocationsConversationModelsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationModels/{conversationModelsId}" }),
  svc,
) as unknown as Schema.Schema<DeleteProjectsLocationsConversationModelsRequest>;

export type DeleteProjectsLocationsConversationModelsResponse = GoogleLongrunningOperation;
export const DeleteProjectsLocationsConversationModelsResponse = GoogleLongrunningOperation;

export type DeleteProjectsLocationsConversationModelsError = DefaultErrors;

export const deleteProjectsLocationsConversationModels: API.OperationMethod<DeleteProjectsLocationsConversationModelsRequest, DeleteProjectsLocationsConversationModelsResponse, DeleteProjectsLocationsConversationModelsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeployProjectsLocationsConversationModelsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudDialogflowV2DeployConversationModelRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationModels/{conversationModelsId}:deploy", hasBody: true }),
  svc,
) as unknown as Schema.Schema<DeployProjectsLocationsConversationModelsRequest>;

export type DeployProjectsLocationsConversationModelsResponse = GoogleLongrunningOperation;
export const DeployProjectsLocationsConversationModelsResponse = GoogleLongrunningOperation;

export type DeployProjectsLocationsConversationModelsError = DefaultErrors;

export const deployProjectsLocationsConversationModels: API.OperationMethod<DeployProjectsLocationsConversationModelsRequest, DeployProjectsLocationsConversationModelsResponse, DeployProjectsLocationsConversationModelsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const UndeployProjectsLocationsConversationModelsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudDialogflowV2UndeployConversationModelRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationModels/{conversationModelsId}:undeploy", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UndeployProjectsLocationsConversationModelsRequest>;

export type UndeployProjectsLocationsConversationModelsResponse = GoogleLongrunningOperation;
export const UndeployProjectsLocationsConversationModelsResponse = GoogleLongrunningOperation;

export type UndeployProjectsLocationsConversationModelsError = DefaultErrors;

export const undeployProjectsLocationsConversationModels: API.OperationMethod<UndeployProjectsLocationsConversationModelsRequest, UndeployProjectsLocationsConversationModelsResponse, UndeployProjectsLocationsConversationModelsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetProjectsLocationsConversationModelsEvaluationsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationModels/{conversationModelsId}/evaluations/{evaluationsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsConversationModelsEvaluationsRequest>;

export type GetProjectsLocationsConversationModelsEvaluationsResponse = GoogleCloudDialogflowV2ConversationModelEvaluation;
export const GetProjectsLocationsConversationModelsEvaluationsResponse = GoogleCloudDialogflowV2ConversationModelEvaluation;

export type GetProjectsLocationsConversationModelsEvaluationsError = DefaultErrors;

export const getProjectsLocationsConversationModelsEvaluations: API.OperationMethod<GetProjectsLocationsConversationModelsEvaluationsRequest, GetProjectsLocationsConversationModelsEvaluationsResponse, GetProjectsLocationsConversationModelsEvaluationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsConversationModelsEvaluationsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationModels/{conversationModelsId}/evaluations" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsConversationModelsEvaluationsRequest>;

export type ListProjectsLocationsConversationModelsEvaluationsResponse = GoogleCloudDialogflowV2ListConversationModelEvaluationsResponse;
export const ListProjectsLocationsConversationModelsEvaluationsResponse = GoogleCloudDialogflowV2ListConversationModelEvaluationsResponse;

export type ListProjectsLocationsConversationModelsEvaluationsError = DefaultErrors;

export const listProjectsLocationsConversationModelsEvaluations: API.PaginatedOperationMethod<ListProjectsLocationsConversationModelsEvaluationsRequest, ListProjectsLocationsConversationModelsEvaluationsResponse, ListProjectsLocationsConversationModelsEvaluationsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const CreateProjectsLocationsConversationModelsEvaluationsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2CreateConversationModelEvaluationRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationModels/{conversationModelsId}/evaluations", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsConversationModelsEvaluationsRequest>;

export type CreateProjectsLocationsConversationModelsEvaluationsResponse = GoogleLongrunningOperation;
export const CreateProjectsLocationsConversationModelsEvaluationsResponse = GoogleLongrunningOperation;

export type CreateProjectsLocationsConversationModelsEvaluationsError = DefaultErrors;

export const createProjectsLocationsConversationModelsEvaluations: API.OperationMethod<CreateProjectsLocationsConversationModelsEvaluationsRequest, CreateProjectsLocationsConversationModelsEvaluationsResponse, CreateProjectsLocationsConversationModelsEvaluationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsConversationProfilesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationProfiles" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsConversationProfilesRequest>;

export type ListProjectsLocationsConversationProfilesResponse = GoogleCloudDialogflowV2ListConversationProfilesResponse;
export const ListProjectsLocationsConversationProfilesResponse = GoogleCloudDialogflowV2ListConversationProfilesResponse;

export type ListProjectsLocationsConversationProfilesError = DefaultErrors;

export const listProjectsLocationsConversationProfiles: API.PaginatedOperationMethod<ListProjectsLocationsConversationProfilesRequest, ListProjectsLocationsConversationProfilesResponse, ListProjectsLocationsConversationProfilesError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsConversationProfilesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationProfiles/{conversationProfilesId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsConversationProfilesRequest>;

export type GetProjectsLocationsConversationProfilesResponse = GoogleCloudDialogflowV2ConversationProfile;
export const GetProjectsLocationsConversationProfilesResponse = GoogleCloudDialogflowV2ConversationProfile;

export type GetProjectsLocationsConversationProfilesError = DefaultErrors;

export const getProjectsLocationsConversationProfiles: API.OperationMethod<GetProjectsLocationsConversationProfilesRequest, GetProjectsLocationsConversationProfilesResponse, GetProjectsLocationsConversationProfilesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsConversationProfilesRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2ConversationProfile).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationProfiles", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsConversationProfilesRequest>;

export type CreateProjectsLocationsConversationProfilesResponse = GoogleCloudDialogflowV2ConversationProfile;
export const CreateProjectsLocationsConversationProfilesResponse = GoogleCloudDialogflowV2ConversationProfile;

export type CreateProjectsLocationsConversationProfilesError = DefaultErrors;

export const createProjectsLocationsConversationProfiles: API.OperationMethod<CreateProjectsLocationsConversationProfilesRequest, CreateProjectsLocationsConversationProfilesResponse, CreateProjectsLocationsConversationProfilesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsConversationProfilesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationProfiles/{conversationProfilesId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsLocationsConversationProfilesRequest>;

export type PatchProjectsLocationsConversationProfilesResponse = GoogleCloudDialogflowV2ConversationProfile;
export const PatchProjectsLocationsConversationProfilesResponse = GoogleCloudDialogflowV2ConversationProfile;

export type PatchProjectsLocationsConversationProfilesError = DefaultErrors;

export const patchProjectsLocationsConversationProfiles: API.OperationMethod<PatchProjectsLocationsConversationProfilesRequest, PatchProjectsLocationsConversationProfilesResponse, PatchProjectsLocationsConversationProfilesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsConversationProfilesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationProfiles/{conversationProfilesId}" }),
  svc,
...
export const deleteProjectsLocationsConversationProfiles: API.OperationMethod<DeleteProjectsLocationsConversationProfilesRequest, DeleteProjectsLocationsConversationProfilesResponse, DeleteProjectsLocationsConversationProfilesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const SetSuggestionFeatureConfigProjectsLocationsConversationProfilesRequest = Schema.Struct({
  ...
  body: Schema.optional(GoogleCloudDialogflowV2SetSuggestionFeatureConfigRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationProfiles/{conversationProfilesId}:setSuggestionFeatureConfig", hasBody: true }),
  svc,
...
export type SetSuggestionFeatureConfigProjectsLocationsConversationProfilesError = DefaultErrors;
...
export const ClearSuggestionFeatureConfigProjectsLocationsConversationProfilesRequest = Schema.Struct({
  conversationProfile: Schema.String.pipe(T.HttpPath("conversationProfile")),
  body: Schema.optional(GoogleCloudDialogflowV2ClearSuggestionFeatureConfigRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversationProfiles/{conversationProfilesId}:clearSuggestionFeatureConfig", hasBody: true }),
  svc,
...
export type ClearSuggestionFeatureConfigProjectsLocationsConversationProfilesError = DefaultErrors;
...
export const CreateProjectsLocationsConversationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversations", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsConversationsRequest>;

export type CreateProjectsLocationsConversationsResponse = GoogleCloudDialogflowV2Conversation;
export const CreateProjectsLocationsConversationsResponse = GoogleCloudDialogflowV2Conversation;

export type CreateProjectsLocationsConversationsError = DefaultErrors;

export const createProjectsLocationsConversations: API.OperationMethod<CreateProjectsLocationsConversationsRequest, CreateProjectsLocationsConversationsResponse, CreateProjectsLocationsConversationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsConversationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/conversations" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsConversationsRequest>;

export type ListProjectsLocationsConversationsResponse = GoogleCloudDialogflowV2ListConversationsResponse;
export const ListProjectsLocationsConversationsResponse = GoogleCloudDialogflowV2ListConversationsResponse;

export type ListProjectsLocationsConversationsError = DefaultErrors;

export const listProjectsLocationsConversations: API.PaginatedOperationMethod<ListProjectsLocationsConversationsRequest, ListProjectsLocationsConversationsResponse, ListProjectsLocationsConversationsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsConversationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/conversations/{conversationsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsConversationsRequest>;

export type GetProjectsLocationsConversationsResponse = GoogleCloudDialogflowV2Conversation;
export const GetProjectsLocationsConversationsResponse = GoogleCloudDialogflowV2Conversation;

export type GetProjectsLocationsConversationsError = DefaultErrors;

export const getProjectsLocationsConversations: API.OperationMethod<GetProjectsLocationsConversationsRequest, GetProjectsLocationsConversationsResponse, GetProjectsLocationsConversationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CompleteProjectsLocationsConversationsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudDialogflowV2CompleteConversationRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversations/{conversationsId}:complete", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CompleteProjectsLocationsConversationsRequest>;

export type CompleteProjectsLocationsConversationsResponse = GoogleCloudDialogflowV2Conversation;
export const CompleteProjectsLocationsConversationsResponse = GoogleCloudDialogflowV2Conversation;

export type CompleteProjectsLocationsConversationsError = DefaultErrors;

export const completeProjectsLocationsConversations: API.OperationMethod<CompleteProjectsLocationsConversationsRequest, CompleteProjectsLocationsConversationsResponse, CompleteProjectsLocationsConversationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const IngestContextReferencesProjectsLocationsConversationsRequest = Schema.Struct({
  ...
  body: Schema.optional(GoogleCloudDialogflowV2IngestContextReferencesRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversations/{conversationsId}:ingestContextReferences", hasBody: true }),
  svc,
) as unknown as Schema.Schema<IngestContextReferencesProjectsLocationsConversationsRequest>;

export type IngestContextReferencesProjectsLocationsConversationsResponse = GoogleCloudDialogflowV2IngestContextReferencesResponse;
export const IngestContextReferencesProjectsLocationsConversationsResponse = GoogleCloudDialogflowV2IngestContextReferencesResponse;

export type IngestContextReferencesProjectsLocationsConversationsError = DefaultErrors;

export const ingestContextReferencesProjectsLocationsConversations: API.OperationMethod<IngestContextReferencesProjectsLocationsConversationsRequest, IngestContextReferencesProjectsLocationsConversationsResponse, IngestContextReferencesProjectsLocationsConversationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsConversationsParticipantsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2Participant).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversations/{conversationsId}/participants", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsConversationsParticipantsRequest>;

export type CreateProjectsLocationsConversationsParticipantsResponse = GoogleCloudDialogflowV2Participant;
export const CreateProjectsLocationsConversationsParticipantsResponse = GoogleCloudDialogflowV2Participant;

export type CreateProjectsLocationsConversationsParticipantsError = DefaultErrors;

export const createProjectsLocationsConversationsParticipants: API.OperationMethod<CreateProjectsLocationsConversationsParticipantsRequest, CreateProjectsLocationsConversationsParticipantsResponse, CreateProjectsLocationsConversationsParticipantsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetProjectsLocationsConversationsParticipantsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/conversations/{conversationsId}/participants/{participantsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsConversationsParticipantsRequest>;

export type GetProjectsLocationsConversationsParticipantsResponse = GoogleCloudDialogflowV2Participant;
export const GetProjectsLocationsConversationsParticipantsResponse = GoogleCloudDialogflowV2Participant;

export type GetProjectsLocationsConversationsParticipantsError = DefaultErrors;

export const getProjectsLocationsConversationsParticipants: API.OperationMethod<GetProjectsLocationsConversationsParticipantsRequest, GetProjectsLocationsConversationsParticipantsResponse, GetProjectsLocationsConversationsParticipantsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsConversationsParticipantsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/conversations/{conversationsId}/participants" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsConversationsParticipantsRequest>;

export type ListProjectsLocationsConversationsParticipantsResponse = GoogleCloudDialogflowV2ListParticipantsResponse;
export const ListProjectsLocationsConversationsParticipantsResponse = GoogleCloudDialogflowV2ListParticipantsResponse;

export type ListProjectsLocationsConversationsParticipantsError = DefaultErrors;

export const listProjectsLocationsConversationsParticipants: API.PaginatedOperationMethod<ListProjectsLocationsConversationsParticipantsRequest, ListProjectsLocationsConversationsParticipantsResponse, ListProjectsLocationsConversationsParticipantsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const PatchProjectsLocationsConversationsParticipantsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/locations/{locationsId}/conversations/{conversationsId}/participants/{participantsId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsLocationsConversationsParticipantsRequest>;

export type PatchProjectsLocationsConversationsParticipantsResponse = GoogleCloudDialogflowV2Participant;
export const PatchProjectsLocationsConversationsParticipantsResponse = GoogleCloudDialogflowV2Participant;

export type PatchProjectsLocationsConversationsParticipantsError = DefaultErrors;

export const patchProjectsLocationsConversationsParticipants: API.OperationMethod<PatchProjectsLocationsConversationsParticipantsRequest, PatchProjectsLocationsConversationsParticipantsResponse, PatchProjectsLocationsConversationsParticipantsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const AnalyzeContentProjectsLocationsConversationsParticipantsRequest = Schema.Struct({
  ...
  body: Schema.optional(GoogleCloudDialogflowV2AnalyzeContentRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversations/{conversationsId}/participants/{participantsId}:analyzeContent", hasBody: true }),
  svc,
) as unknown as Schema.Schema<AnalyzeContentProjectsLocationsConversationsParticipantsRequest>;

export type AnalyzeContentProjectsLocationsConversationsParticipantsResponse = GoogleCloudDialogflowV2AnalyzeContentResponse;
export const AnalyzeContentProjectsLocationsConversationsParticipantsResponse = GoogleCloudDialogflowV2AnalyzeContentResponse;

export type AnalyzeContentProjectsLocationsConversationsParticipantsError = DefaultErrors;
...
export const SuggestArticlesProjectsLocationsConversationsParticipantsSuggestionsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2SuggestArticlesRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversations/{conversationsId}/participants/{participantsId}/suggestions:suggestArticles", hasBody: true }),
  svc,
) as unknown as Schema.Schema<SuggestArticlesProjectsLocationsConversationsParticipantsSuggestionsRequest>;

export type SuggestArticlesProjectsLocationsConversationsParticipantsSuggestionsResponse = GoogleCloudDialogflowV2SuggestArticlesResponse;
export const SuggestArticlesProjectsLocationsConversationsParticipantsSuggestionsResponse = GoogleCloudDialogflowV2SuggestArticlesResponse;

export type SuggestArticlesProjectsLocationsConversationsParticipantsSuggestionsError = DefaultErrors;
...
export const SuggestFaqAnswersProjectsLocationsConversationsParticipantsSuggestionsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2SuggestFaqAnswersRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversations/{conversationsId}/participants/{participantsId}/suggestions:suggestFaqAnswers", hasBody: true }),
  svc,
) as unknown as Schema.Schema<SuggestFaqAnswersProjectsLocationsConversationsParticipantsSuggestionsRequest>;

export type SuggestFaqAnswersProjectsLocationsConversationsParticipantsSuggestionsResponse = GoogleCloudDialogflowV2SuggestFaqAnswersResponse;
export const SuggestFaqAnswersProjectsLocationsConversationsParticipantsSuggestionsResponse = GoogleCloudDialogflowV2SuggestFaqAnswersResponse;

export type SuggestFaqAnswersProjectsLocationsConversationsParticipantsSuggestionsError = DefaultErrors;
...
export const SuggestSmartRepliesProjectsLocationsConversationsParticipantsSuggestionsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2SuggestSmartRepliesRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversations/{conversationsId}/participants/{participantsId}/suggestions:suggestSmartReplies", hasBody: true }),
  svc,
) as unknown as Schema.Schema<SuggestSmartRepliesProjectsLocationsConversationsParticipantsSuggestionsRequest>;

export type SuggestSmartRepliesProjectsLocationsConversationsParticipantsSuggestionsResponse = GoogleCloudDialogflowV2SuggestSmartRepliesResponse;
export const SuggestSmartRepliesProjectsLocationsConversationsParticipantsSuggestionsResponse = GoogleCloudDialogflowV2SuggestSmartRepliesResponse;

export type SuggestSmartRepliesProjectsLocationsConversationsParticipantsSuggestionsError = DefaultErrors;
...
export const SuggestKnowledgeAssistProjectsLocationsConversationsParticipantsSuggestionsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2SuggestKnowledgeAssistRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversations/{conversationsId}/participants/{participantsId}/suggestions:suggestKnowledgeAssist", hasBody: true }),
  svc,
) as unknown as Schema.Schema<SuggestKnowledgeAssistProjectsLocationsConversationsParticipantsSuggestionsRequest>;

export type SuggestKnowledgeAssistProjectsLocationsConversationsParticipantsSuggestionsResponse = GoogleCloudDialogflowV2SuggestKnowledgeAssistResponse;
export const SuggestKnowledgeAssistProjectsLocationsConversationsParticipantsSuggestionsResponse = GoogleCloudDialogflowV2SuggestKnowledgeAssistResponse;

export type SuggestKnowledgeAssistProjectsLocationsConversationsParticipantsSuggestionsError = DefaultErrors;
...
export const ListProjectsLocationsConversationsMessagesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/conversations/{conversationsId}/messages" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsConversationsMessagesRequest>;

export type ListProjectsLocationsConversationsMessagesResponse = GoogleCloudDialogflowV2ListMessagesResponse;
export const ListProjectsLocationsConversationsMessagesResponse = GoogleCloudDialogflowV2ListMessagesResponse;

export type ListProjectsLocationsConversationsMessagesError = DefaultErrors;

export const listProjectsLocationsConversationsMessages: API.PaginatedOperationMethod<ListProjectsLocationsConversationsMessagesRequest, ListProjectsLocationsConversationsMessagesResponse, ListProjectsLocationsConversationsMessagesError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const SuggestConversationSummaryProjectsLocationsConversationsSuggestionsRequest = Schema.Struct({
  conversation: Schema.String.pipe(T.HttpPath("conversation")),
  body: Schema.optional(GoogleCloudDialogflowV2SuggestConversationSummaryRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversations/{conversationsId}/suggestions:suggestConversationSummary", hasBody: true }),
  svc,
) as unknown as Schema.Schema<SuggestConversationSummaryProjectsLocationsConversationsSuggestionsRequest>;

export type SuggestConversationSummaryProjectsLocationsConversationsSuggestionsResponse = GoogleCloudDialogflowV2SuggestConversationSummaryResponse;
export const SuggestConversationSummaryProjectsLocationsConversationsSuggestionsResponse = GoogleCloudDialogflowV2SuggestConversationSummaryResponse;

export type SuggestConversationSummaryProjectsLocationsConversationsSuggestionsError = DefaultErrors;
...
export const SearchKnowledgeProjectsLocationsConversationsSuggestionsRequest = Schema.Struct({
  conversation: Schema.String.pipe(T.HttpPath("conversation")),
  body: Schema.optional(GoogleCloudDialogflowV2SearchKnowledgeRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversations/{conversationsId}/suggestions:searchKnowledge", hasBody: true }),
  svc,
) as unknown as Schema.Schema<SearchKnowledgeProjectsLocationsConversationsSuggestionsRequest>;

export type SearchKnowledgeProjectsLocationsConversationsSuggestionsResponse = GoogleCloudDialogflowV2SearchKnowledgeResponse;
export const SearchKnowledgeProjectsLocationsConversationsSuggestionsResponse = GoogleCloudDialogflowV2SearchKnowledgeResponse;

export type SearchKnowledgeProjectsLocationsConversationsSuggestionsError = DefaultErrors;
...
export const GenerateProjectsLocationsConversationsSuggestionsRequest = Schema.Struct({
  conversation: Schema.String.pipe(T.HttpPath("conversation")),
  body: Schema.optional(GoogleCloudDialogflowV2GenerateSuggestionsRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/conversations/{conversationsId}/suggestions:generate", hasBody: true }),
  svc,
) as unknown as Schema.Schema<GenerateProjectsLocationsConversationsSuggestionsRequest>;

export type GenerateProjectsLocationsConversationsSuggestionsResponse = GoogleCloudDialogflowV2GenerateSuggestionsResponse;
export const GenerateProjectsLocationsConversationsSuggestionsResponse = GoogleCloudDialogflowV2GenerateSuggestionsResponse;

export type GenerateProjectsLocationsConversationsSuggestionsError = DefaultErrors;

export const generateProjectsLocationsConversationsSuggestions: API.OperationMethod<GenerateProjectsLocationsConversationsSuggestionsRequest, GenerateProjectsLocationsConversationsSuggestionsResponse, GenerateProjectsLocationsConversationsSuggestionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GenerateStatelessSummaryProjectsLocationsSuggestionsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2GenerateStatelessSummaryRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/suggestions:generateStatelessSummary", hasBody: true }),
  svc,
) as unknown as Schema.Schema<GenerateStatelessSummaryProjectsLocationsSuggestionsRequest>;

export type GenerateStatelessSummaryProjectsLocationsSuggestionsResponse = GoogleCloudDialogflowV2GenerateStatelessSummaryResponse;
export const GenerateStatelessSummaryProjectsLocationsSuggestionsResponse = GoogleCloudDialogflowV2GenerateStatelessSummaryResponse;

export type GenerateStatelessSummaryProjectsLocationsSuggestionsError = DefaultErrors;

export const generateStatelessSummaryProjectsLocationsSuggestions: API.OperationMethod<GenerateStatelessSummaryProjectsLocationsSuggestionsRequest, GenerateStatelessSummaryProjectsLocationsSuggestionsResponse, GenerateStatelessSummaryProjectsLocationsSuggestionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const SearchKnowledgeProjectsLocationsSuggestionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/suggestions:searchKnowledge", hasBody: true }),
  svc,
) as unknown as Schema.Schema<SearchKnowledgeProjectsLocationsSuggestionsRequest>;

export type SearchKnowledgeProjectsLocationsSuggestionsResponse = GoogleCloudDialogflowV2SearchKnowledgeResponse;
export const SearchKnowledgeProjectsLocationsSuggestionsResponse = GoogleCloudDialogflowV2SearchKnowledgeResponse;

export type SearchKnowledgeProjectsLocationsSuggestionsError = DefaultErrors;

export const searchKnowledgeProjectsLocationsSuggestions: API.OperationMethod<SearchKnowledgeProjectsLocationsSuggestionsRequest, SearchKnowledgeProjectsLocationsSuggestionsResponse, SearchKnowledgeProjectsLocationsSuggestionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GenerateProjectsLocationsStatelessSuggestionRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2GenerateStatelessSuggestionRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/statelessSuggestion:generate", hasBody: true }),
  svc,
) as unknown as Schema.Schema<GenerateProjectsLocationsStatelessSuggestionRequest>;

export type GenerateProjectsLocationsStatelessSuggestionResponse = GoogleCloudDialogflowV2GenerateStatelessSuggestionResponse;
export const GenerateProjectsLocationsStatelessSuggestionResponse = GoogleCloudDialogflowV2GenerateStatelessSuggestionResponse;

export type GenerateProjectsLocationsStatelessSuggestionError = DefaultErrors;

export const generateProjectsLocationsStatelessSuggestion: API.OperationMethod<GenerateProjectsLocationsStatelessSuggestionRequest, GenerateProjectsLocationsStatelessSuggestionResponse, GenerateProjectsLocationsStatelessSuggestionError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const InitializeProjectsLocationsEncryptionSpecRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudDialogflowV2InitializeEncryptionSpecRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/encryptionSpec:initialize", hasBody: true }),
  svc,
...
export const initializeProjectsLocationsEncryptionSpec: API.OperationMethod<InitializeProjectsLocationsEncryptionSpecRequest, InitializeProjectsLocationsEncryptionSpecResponse, InitializeProjectsLocationsEncryptionSpecError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsKnowledgeBasesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/knowledgeBases" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsKnowledgeBasesRequest>;

export type ListProjectsLocationsKnowledgeBasesResponse = GoogleCloudDialogflowV2ListKnowledgeBasesResponse;
export const ListProjectsLocationsKnowledgeBasesResponse = GoogleCloudDialogflowV2ListKnowledgeBasesResponse;

export type ListProjectsLocationsKnowledgeBasesError = DefaultErrors;

export const listProjectsLocationsKnowledgeBases: API.PaginatedOperationMethod<ListProjectsLocationsKnowledgeBasesRequest, ListProjectsLocationsKnowledgeBasesResponse, ListProjectsLocationsKnowledgeBasesError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsKnowledgeBasesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/knowledgeBases/{knowledgeBasesId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsKnowledgeBasesRequest>;

export type GetProjectsLocationsKnowledgeBasesResponse = GoogleCloudDialogflowV2KnowledgeBase;
export const GetProjectsLocationsKnowledgeBasesResponse = GoogleCloudDialogflowV2KnowledgeBase;

export type GetProjectsLocationsKnowledgeBasesError = DefaultErrors;

export const getProjectsLocationsKnowledgeBases: API.OperationMethod<GetProjectsLocationsKnowledgeBasesRequest, GetProjectsLocationsKnowledgeBasesResponse, GetProjectsLocationsKnowledgeBasesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsKnowledgeBasesRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2KnowledgeBase).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/knowledgeBases", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsKnowledgeBasesRequest>;

export type CreateProjectsLocationsKnowledgeBasesResponse = GoogleCloudDialogflowV2KnowledgeBase;
export const CreateProjectsLocationsKnowledgeBasesResponse = GoogleCloudDialogflowV2KnowledgeBase;

export type CreateProjectsLocationsKnowledgeBasesError = DefaultErrors;

export const createProjectsLocationsKnowledgeBases: API.OperationMethod<CreateProjectsLocationsKnowledgeBasesRequest, CreateProjectsLocationsKnowledgeBasesResponse, CreateProjectsLocationsKnowledgeBasesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsKnowledgeBasesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/knowledgeBases/{knowledgeBasesId}" }),
  svc,
...
export const deleteProjectsLocationsKnowledgeBases: API.OperationMethod<DeleteProjectsLocationsKnowledgeBasesRequest, DeleteProjectsLocationsKnowledgeBasesResponse, DeleteProjectsLocationsKnowledgeBasesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsKnowledgeBasesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/locations/{locationsId}/knowledgeBases/{knowledgeBasesId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsLocationsKnowledgeBasesRequest>;

export type PatchProjectsLocationsKnowledgeBasesResponse = GoogleCloudDialogflowV2KnowledgeBase;
export const PatchProjectsLocationsKnowledgeBasesResponse = GoogleCloudDialogflowV2KnowledgeBase;

export type PatchProjectsLocationsKnowledgeBasesError = DefaultErrors;

export const patchProjectsLocationsKnowledgeBases: API.OperationMethod<PatchProjectsLocationsKnowledgeBasesRequest, PatchProjectsLocationsKnowledgeBasesResponse, PatchProjectsLocationsKnowledgeBasesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsKnowledgeBasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/knowledgeBases/{knowledgeBasesId}/documents" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsKnowledgeBasesDocumentsRequest>;

export type ListProjectsLocationsKnowledgeBasesDocumentsResponse = GoogleCloudDialogflowV2ListDocumentsResponse;
export const ListProjectsLocationsKnowledgeBasesDocumentsResponse = GoogleCloudDialogflowV2ListDocumentsResponse;

export type ListProjectsLocationsKnowledgeBasesDocumentsError = DefaultErrors;

export const listProjectsLocationsKnowledgeBasesDocuments: API.PaginatedOperationMethod<ListProjectsLocationsKnowledgeBasesDocumentsRequest, ListProjectsLocationsKnowledgeBasesDocumentsResponse, ListProjectsLocationsKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsKnowledgeBasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/knowledgeBases/{knowledgeBasesId}/documents/{documentsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsKnowledgeBasesDocumentsRequest>;

export type GetProjectsLocationsKnowledgeBasesDocumentsResponse = GoogleCloudDialogflowV2Document;
export const GetProjectsLocationsKnowledgeBasesDocumentsResponse = GoogleCloudDialogflowV2Document;

export type GetProjectsLocationsKnowledgeBasesDocumentsError = DefaultErrors;

export const getProjectsLocationsKnowledgeBasesDocuments: API.OperationMethod<GetProjectsLocationsKnowledgeBasesDocumentsRequest, GetProjectsLocationsKnowledgeBasesDocumentsResponse, GetProjectsLocationsKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsKnowledgeBasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/knowledgeBases/{knowledgeBasesId}/documents", hasBody: true }),
  svc,
...
export const createProjectsLocationsKnowledgeBasesDocuments: API.OperationMethod<CreateProjectsLocationsKnowledgeBasesDocumentsRequest, CreateProjectsLocationsKnowledgeBasesDocumentsResponse, CreateProjectsLocationsKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ImportProjectsLocationsKnowledgeBasesDocumentsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2ImportDocumentsRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/knowledgeBases/{knowledgeBasesId}/documents:import", hasBody: true }),
  svc,
...
export const importProjectsLocationsKnowledgeBasesDocuments: API.OperationMethod<ImportProjectsLocationsKnowledgeBasesDocumentsRequest, ImportProjectsLocationsKnowledgeBasesDocumentsResponse, ImportProjectsLocationsKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsKnowledgeBasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/knowledgeBases/{knowledgeBasesId}/documents/{documentsId}" }),
  svc,
...
export const deleteProjectsLocationsKnowledgeBasesDocuments: API.OperationMethod<DeleteProjectsLocationsKnowledgeBasesDocumentsRequest, DeleteProjectsLocationsKnowledgeBasesDocumentsResponse, DeleteProjectsLocationsKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsKnowledgeBasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/locations/{locationsId}/knowledgeBases/{knowledgeBasesId}/documents/{documentsId}", hasBody: true }),
  svc,
...
export const patchProjectsLocationsKnowledgeBasesDocuments: API.OperationMethod<PatchProjectsLocationsKnowledgeBasesDocumentsRequest, PatchProjectsLocationsKnowledgeBasesDocumentsResponse, PatchProjectsLocationsKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ReloadProjectsLocationsKnowledgeBasesDocumentsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudDialogflowV2ReloadDocumentRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/knowledgeBases/{knowledgeBasesId}/documents/{documentsId}:reload", hasBody: true }),
  svc,
...
export const reloadProjectsLocationsKnowledgeBasesDocuments: API.OperationMethod<ReloadProjectsLocationsKnowledgeBasesDocumentsRequest, ReloadProjectsLocationsKnowledgeBasesDocumentsResponse, ReloadProjectsLocationsKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ExportProjectsLocationsKnowledgeBasesDocumentsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudDialogflowV2ExportDocumentRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/knowledgeBases/{knowledgeBasesId}/documents/{documentsId}:export", hasBody: true }),
  svc,
) as unknown as Schema.Schema<ExportProjectsLocationsKnowledgeBasesDocumentsRequest>;

export type ExportProjectsLocationsKnowledgeBasesDocumentsResponse = GoogleLongrunningOperation;
export const ExportProjectsLocationsKnowledgeBasesDocumentsResponse = GoogleLongrunningOperation;

export type ExportProjectsLocationsKnowledgeBasesDocumentsError = DefaultErrors;

export const exportProjectsLocationsKnowledgeBasesDocuments: API.OperationMethod<ExportProjectsLocationsKnowledgeBasesDocumentsRequest, ExportProjectsLocationsKnowledgeBasesDocumentsResponse, ExportProjectsLocationsKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsSipTrunksRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/locations/{locationsId}/sipTrunks", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsSipTrunksRequest>;

export type CreateProjectsLocationsSipTrunksResponse = GoogleCloudDialogflowV2SipTrunk;
export const CreateProjectsLocationsSipTrunksResponse = GoogleCloudDialogflowV2SipTrunk;

export type CreateProjectsLocationsSipTrunksError = DefaultErrors;

export const createProjectsLocationsSipTrunks: API.OperationMethod<CreateProjectsLocationsSipTrunksRequest, CreateProjectsLocationsSipTrunksResponse, CreateProjectsLocationsSipTrunksError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsSipTrunksRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/locations/{locationsId}/sipTrunks/{sipTrunksId}" }),
  svc,
...
export const deleteProjectsLocationsSipTrunks: API.OperationMethod<DeleteProjectsLocationsSipTrunksRequest, DeleteProjectsLocationsSipTrunksResponse, DeleteProjectsLocationsSipTrunksError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsSipTrunksRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/sipTrunks" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsSipTrunksRequest>;

export type ListProjectsLocationsSipTrunksResponse = GoogleCloudDialogflowV2ListSipTrunksResponse;
export const ListProjectsLocationsSipTrunksResponse = GoogleCloudDialogflowV2ListSipTrunksResponse;

export type ListProjectsLocationsSipTrunksError = DefaultErrors;

export const listProjectsLocationsSipTrunks: API.PaginatedOperationMethod<ListProjectsLocationsSipTrunksRequest, ListProjectsLocationsSipTrunksResponse, ListProjectsLocationsSipTrunksError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsSipTrunksRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/locations/{locationsId}/sipTrunks/{sipTrunksId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsSipTrunksRequest>;

export type GetProjectsLocationsSipTrunksResponse = GoogleCloudDialogflowV2SipTrunk;
export const GetProjectsLocationsSipTrunksResponse = GoogleCloudDialogflowV2SipTrunk;

export type GetProjectsLocationsSipTrunksError = DefaultErrors;

export const getProjectsLocationsSipTrunks: API.OperationMethod<GetProjectsLocationsSipTrunksRequest, GetProjectsLocationsSipTrunksResponse, GetProjectsLocationsSipTrunksError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsSipTrunksRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/locations/{locationsId}/sipTrunks/{sipTrunksId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsLocationsSipTrunksRequest>;

export type PatchProjectsLocationsSipTrunksResponse = GoogleCloudDialogflowV2SipTrunk;
export const PatchProjectsLocationsSipTrunksResponse = GoogleCloudDialogflowV2SipTrunk;

export type PatchProjectsLocationsSipTrunksError = DefaultErrors;

export const patchProjectsLocationsSipTrunks: API.OperationMethod<PatchProjectsLocationsSipTrunksRequest, PatchProjectsLocationsSipTrunksResponse, PatchProjectsLocationsSipTrunksError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export type SearchProjectsAgentResponse = GoogleCloudDialogflowV2SearchAgentsResponse;
export const SearchProjectsAgentResponse = GoogleCloudDialogflowV2SearchAgentsResponse;

export type SearchProjectsAgentError = DefaultErrors;

export const searchProjectsAgent: API.PaginatedOperationMethod<SearchProjectsAgentRequest, SearchProjectsAgentResponse, SearchProjectsAgentError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const TrainProjectsAgentRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent:train", hasBody: true }),
  svc,
...
export const trainProjectsAgent: API.OperationMethod<TrainProjectsAgentRequest, TrainProjectsAgentResponse, TrainProjectsAgentError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ExportProjectsAgentRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent:export", hasBody: true }),
  svc,
...
export const exportProjectsAgent: API.OperationMethod<ExportProjectsAgentRequest, ExportProjectsAgentResponse, ExportProjectsAgentError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ImportProjectsAgentRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent:import", hasBody: true }),
  svc,
...
export const importProjectsAgent: API.OperationMethod<ImportProjectsAgentRequest, ImportProjectsAgentResponse, ImportProjectsAgentError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const RestoreProjectsAgentRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent:restore", hasBody: true }),
  svc,
...
export const restoreProjectsAgent: API.OperationMethod<RestoreProjectsAgentRequest, RestoreProjectsAgentResponse, RestoreProjectsAgentError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetValidationResultProjectsAgentRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/validationResult" }),
  svc,
) as unknown as Schema.Schema<GetValidationResultProjectsAgentRequest>;

export type GetValidationResultProjectsAgentResponse = GoogleCloudDialogflowV2ValidationResult;
export const GetValidationResultProjectsAgentResponse = GoogleCloudDialogflowV2ValidationResult;

export type GetValidationResultProjectsAgentError = DefaultErrors;

export const getValidationResultProjectsAgent: API.OperationMethod<GetValidationResultProjectsAgentRequest, GetValidationResultProjectsAgentResponse, GetValidationResultProjectsAgentError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetFulfillmentProjectsAgentRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/fulfillment" }),
  svc,
) as unknown as Schema.Schema<GetFulfillmentProjectsAgentRequest>;

export type GetFulfillmentProjectsAgentResponse = GoogleCloudDialogflowV2Fulfillment;
export const GetFulfillmentProjectsAgentResponse = GoogleCloudDialogflowV2Fulfillment;

export type GetFulfillmentProjectsAgentError = DefaultErrors;

export const getFulfillmentProjectsAgent: API.OperationMethod<GetFulfillmentProjectsAgentRequest, GetFulfillmentProjectsAgentResponse, GetFulfillmentProjectsAgentError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateFulfillmentProjectsAgentRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/agent/fulfillment", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateFulfillmentProjectsAgentRequest>;

export type UpdateFulfillmentProjectsAgentResponse = GoogleCloudDialogflowV2Fulfillment;
export const UpdateFulfillmentProjectsAgentResponse = GoogleCloudDialogflowV2Fulfillment;

export type UpdateFulfillmentProjectsAgentError = DefaultErrors;

export const updateFulfillmentProjectsAgent: API.OperationMethod<UpdateFulfillmentProjectsAgentRequest, UpdateFulfillmentProjectsAgentResponse, UpdateFulfillmentProjectsAgentError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteContextsProjectsAgentSessionsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/agent/sessions/{sessionsId}/contexts" }),
  svc,
...
export const deleteContextsProjectsAgentSessions: API.OperationMethod<DeleteContextsProjectsAgentSessionsRequest, DeleteContextsProjectsAgentSessionsResponse, DeleteContextsProjectsAgentSessionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DetectIntentProjectsAgentSessionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/sessions/{sessionsId}:detectIntent", hasBody: true }),
  svc,
) as unknown as Schema.Schema<DetectIntentProjectsAgentSessionsRequest>;

export type DetectIntentProjectsAgentSessionsResponse = GoogleCloudDialogflowV2DetectIntentResponse;
export const DetectIntentProjectsAgentSessionsResponse = GoogleCloudDialogflowV2DetectIntentResponse;

export type DetectIntentProjectsAgentSessionsError = DefaultErrors;

export const detectIntentProjectsAgentSessions: API.OperationMethod<DetectIntentProjectsAgentSessionsRequest, DetectIntentProjectsAgentSessionsResponse, DetectIntentProjectsAgentSessionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsAgentSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/sessions/{sessionsId}/contexts" }),
  svc,
) as unknown as Schema.Schema<ListProjectsAgentSessionsContextsRequest>;

export type ListProjectsAgentSessionsContextsResponse = GoogleCloudDialogflowV2ListContextsResponse;
export const ListProjectsAgentSessionsContextsResponse = GoogleCloudDialogflowV2ListContextsResponse;

export type ListProjectsAgentSessionsContextsError = DefaultErrors;

export const listProjectsAgentSessionsContexts: API.PaginatedOperationMethod<ListProjectsAgentSessionsContextsRequest, ListProjectsAgentSessionsContextsResponse, ListProjectsAgentSessionsContextsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsAgentSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/sessions/{sessionsId}/contexts/{contextsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsAgentSessionsContextsRequest>;

export type GetProjectsAgentSessionsContextsResponse = GoogleCloudDialogflowV2Context;
export const GetProjectsAgentSessionsContextsResponse = GoogleCloudDialogflowV2Context;

export type GetProjectsAgentSessionsContextsError = DefaultErrors;

export const getProjectsAgentSessionsContexts: API.OperationMethod<GetProjectsAgentSessionsContextsRequest, GetProjectsAgentSessionsContextsResponse, GetProjectsAgentSessionsContextsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsAgentSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/sessions/{sessionsId}/contexts", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsAgentSessionsContextsRequest>;

export type CreateProjectsAgentSessionsContextsResponse = GoogleCloudDialogflowV2Context;
export const CreateProjectsAgentSessionsContextsResponse = GoogleCloudDialogflowV2Context;

export type CreateProjectsAgentSessionsContextsError = DefaultErrors;

export const createProjectsAgentSessionsContexts: API.OperationMethod<CreateProjectsAgentSessionsContextsRequest, CreateProjectsAgentSessionsContextsResponse, CreateProjectsAgentSessionsContextsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsAgentSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/agent/sessions/{sessionsId}/contexts/{contextsId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsAgentSessionsContextsRequest>;

export type PatchProjectsAgentSessionsContextsResponse = GoogleCloudDialogflowV2Context;
export const PatchProjectsAgentSessionsContextsResponse = GoogleCloudDialogflowV2Context;

export type PatchProjectsAgentSessionsContextsError = DefaultErrors;

export const patchProjectsAgentSessionsContexts: API.OperationMethod<PatchProjectsAgentSessionsContextsRequest, PatchProjectsAgentSessionsContextsResponse, PatchProjectsAgentSessionsContextsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsAgentSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/agent/sessions/{sessionsId}/contexts/{contextsId}" }),
  svc,
...
export const deleteProjectsAgentSessionsContexts: API.OperationMethod<DeleteProjectsAgentSessionsContextsRequest, DeleteProjectsAgentSessionsContextsResponse, DeleteProjectsAgentSessionsContextsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsAgentSessionsEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/sessions/{sessionsId}/entityTypes" }),
  svc,
) as unknown as Schema.Schema<ListProjectsAgentSessionsEntityTypesRequest>;

export type ListProjectsAgentSessionsEntityTypesResponse = GoogleCloudDialogflowV2ListSessionEntityTypesResponse;
export const ListProjectsAgentSessionsEntityTypesResponse = GoogleCloudDialogflowV2ListSessionEntityTypesResponse;

export type ListProjectsAgentSessionsEntityTypesError = DefaultErrors;

export const listProjectsAgentSessionsEntityTypes: API.PaginatedOperationMethod<ListProjectsAgentSessionsEntityTypesRequest, ListProjectsAgentSessionsEntityTypesResponse, ListProjectsAgentSessionsEntityTypesError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsAgentSessionsEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/sessions/{sessionsId}/entityTypes/{entityTypesId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsAgentSessionsEntityTypesRequest>;

export type GetProjectsAgentSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;
export const GetProjectsAgentSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;

export type GetProjectsAgentSessionsEntityTypesError = DefaultErrors;

export const getProjectsAgentSessionsEntityTypes: API.OperationMethod<GetProjectsAgentSessionsEntityTypesRequest, GetProjectsAgentSessionsEntityTypesResponse, GetProjectsAgentSessionsEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsAgentSessionsEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/sessions/{sessionsId}/entityTypes", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsAgentSessionsEntityTypesRequest>;

export type CreateProjectsAgentSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;
export const CreateProjectsAgentSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;

export type CreateProjectsAgentSessionsEntityTypesError = DefaultErrors;

export const createProjectsAgentSessionsEntityTypes: API.OperationMethod<CreateProjectsAgentSessionsEntityTypesRequest, CreateProjectsAgentSessionsEntityTypesResponse, CreateProjectsAgentSessionsEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsAgentSessionsEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/agent/sessions/{sessionsId}/entityTypes/{entityTypesId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsAgentSessionsEntityTypesRequest>;

export type PatchProjectsAgentSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;
export const PatchProjectsAgentSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;

export type PatchProjectsAgentSessionsEntityTypesError = DefaultErrors;

export const patchProjectsAgentSessionsEntityTypes: API.OperationMethod<PatchProjectsAgentSessionsEntityTypesRequest, PatchProjectsAgentSessionsEntityTypesResponse, PatchProjectsAgentSessionsEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsAgentSessionsEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/agent/sessions/{sessionsId}/entityTypes/{entityTypesId}" }),
  svc,
...
export const deleteProjectsAgentSessionsEntityTypes: API.OperationMethod<DeleteProjectsAgentSessionsEntityTypesRequest, DeleteProjectsAgentSessionsEntityTypesResponse, DeleteProjectsAgentSessionsEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export type ListProjectsAgentIntentsResponse = GoogleCloudDialogflowV2ListIntentsResponse;
export const ListProjectsAgentIntentsResponse = GoogleCloudDialogflowV2ListIntentsResponse;

export type ListProjectsAgentIntentsError = DefaultErrors;

export const listProjectsAgentIntents: API.PaginatedOperationMethod<ListProjectsAgentIntentsRequest, ListProjectsAgentIntentsResponse, ListProjectsAgentIntentsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsAgentIntentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/intents/{intentsId}" }),
  svc,
...
export const GetProjectsAgentIntentsResponse = GoogleCloudDialogflowV2Intent;

export type GetProjectsAgentIntentsError = DefaultErrors;

export const getProjectsAgentIntents: API.OperationMethod<GetProjectsAgentIntentsRequest, GetProjectsAgentIntentsResponse, GetProjectsAgentIntentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsAgentIntentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/intents", hasBody: true }),
  svc,
...
export const CreateProjectsAgentIntentsResponse = GoogleCloudDialogflowV2Intent;

export type CreateProjectsAgentIntentsError = DefaultErrors;

export const createProjectsAgentIntents: API.OperationMethod<CreateProjectsAgentIntentsRequest, CreateProjectsAgentIntentsResponse, CreateProjectsAgentIntentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsAgentIntentsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/agent/intents/{intentsId}", hasBody: true }),
  svc,
...
export const PatchProjectsAgentIntentsResponse = GoogleCloudDialogflowV2Intent;

export type PatchProjectsAgentIntentsError = DefaultErrors;

export const patchProjectsAgentIntents: API.OperationMethod<PatchProjectsAgentIntentsRequest, PatchProjectsAgentIntentsResponse, PatchProjectsAgentIntentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsAgentIntentsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/agent/intents/{intentsId}" }),
  svc,
...
export const deleteProjectsAgentIntents: API.OperationMethod<DeleteProjectsAgentIntentsRequest, DeleteProjectsAgentIntentsResponse, DeleteProjectsAgentIntentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const BatchUpdateProjectsAgentIntentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/intents:batchUpdate", hasBody: true }),
  svc,
...
export const batchUpdateProjectsAgentIntents: API.OperationMethod<BatchUpdateProjectsAgentIntentsRequest, BatchUpdateProjectsAgentIntentsResponse, BatchUpdateProjectsAgentIntentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const BatchDeleteProjectsAgentIntentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/intents:batchDelete", hasBody: true }),
  svc,
...
export const batchDeleteProjectsAgentIntents: API.OperationMethod<BatchDeleteProjectsAgentIntentsRequest, BatchDeleteProjectsAgentIntentsResponse, BatchDeleteProjectsAgentIntentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsAgentEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/entityTypes" }),
  svc,
) as unknown as Schema.Schema<ListProjectsAgentEntityTypesRequest>;

export type ListProjectsAgentEntityTypesResponse = GoogleCloudDialogflowV2ListEntityTypesResponse;
export const ListProjectsAgentEntityTypesResponse = GoogleCloudDialogflowV2ListEntityTypesResponse;

export type ListProjectsAgentEntityTypesError = DefaultErrors;

export const listProjectsAgentEntityTypes: API.PaginatedOperationMethod<ListProjectsAgentEntityTypesRequest, ListProjectsAgentEntityTypesResponse, ListProjectsAgentEntityTypesError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsAgentEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/entityTypes/{entityTypesId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsAgentEntityTypesRequest>;

export type GetProjectsAgentEntityTypesResponse = GoogleCloudDialogflowV2EntityType;
export const GetProjectsAgentEntityTypesResponse = GoogleCloudDialogflowV2EntityType;

export type GetProjectsAgentEntityTypesError = DefaultErrors;

export const getProjectsAgentEntityTypes: API.OperationMethod<GetProjectsAgentEntityTypesRequest, GetProjectsAgentEntityTypesResponse, GetProjectsAgentEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsAgentEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/entityTypes", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsAgentEntityTypesRequest>;

export type CreateProjectsAgentEntityTypesResponse = GoogleCloudDialogflowV2EntityType;
export const CreateProjectsAgentEntityTypesResponse = GoogleCloudDialogflowV2EntityType;

export type CreateProjectsAgentEntityTypesError = DefaultErrors;

export const createProjectsAgentEntityTypes: API.OperationMethod<CreateProjectsAgentEntityTypesRequest, CreateProjectsAgentEntityTypesResponse, CreateProjectsAgentEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsAgentEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/agent/entityTypes/{entityTypesId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsAgentEntityTypesRequest>;

export type PatchProjectsAgentEntityTypesResponse = GoogleCloudDialogflowV2EntityType;
export const PatchProjectsAgentEntityTypesResponse = GoogleCloudDialogflowV2EntityType;

export type PatchProjectsAgentEntityTypesError = DefaultErrors;

export const patchProjectsAgentEntityTypes: API.OperationMethod<PatchProjectsAgentEntityTypesRequest, PatchProjectsAgentEntityTypesResponse, PatchProjectsAgentEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsAgentEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/agent/entityTypes/{entityTypesId}" }),
  svc,
...
export const deleteProjectsAgentEntityTypes: API.OperationMethod<DeleteProjectsAgentEntityTypesRequest, DeleteProjectsAgentEntityTypesResponse, DeleteProjectsAgentEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const BatchUpdateProjectsAgentEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/entityTypes:batchUpdate", hasBody: true }),
  svc,
...
export const batchUpdateProjectsAgentEntityTypes: API.OperationMethod<BatchUpdateProjectsAgentEntityTypesRequest, BatchUpdateProjectsAgentEntityTypesResponse, BatchUpdateProjectsAgentEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const BatchDeleteProjectsAgentEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/entityTypes:batchDelete", hasBody: true }),
  svc,
...
export const batchDeleteProjectsAgentEntityTypes: API.OperationMethod<BatchDeleteProjectsAgentEntityTypesRequest, BatchDeleteProjectsAgentEntityTypesResponse, BatchDeleteProjectsAgentEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const BatchCreateProjectsAgentEntityTypesEntitiesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/entityTypes/{entityTypesId}/entities:batchCreate", hasBody: true }),
  svc,
...
export const batchCreateProjectsAgentEntityTypesEntities: API.OperationMethod<BatchCreateProjectsAgentEntityTypesEntitiesRequest, BatchCreateProjectsAgentEntityTypesEntitiesResponse, BatchCreateProjectsAgentEntityTypesEntitiesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const BatchUpdateProjectsAgentEntityTypesEntitiesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/entityTypes/{entityTypesId}/entities:batchUpdate", hasBody: true }),
  svc,
...
export const batchUpdateProjectsAgentEntityTypesEntities: API.OperationMethod<BatchUpdateProjectsAgentEntityTypesEntitiesRequest, BatchUpdateProjectsAgentEntityTypesEntitiesResponse, BatchUpdateProjectsAgentEntityTypesEntitiesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const BatchDeleteProjectsAgentEntityTypesEntitiesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/entityTypes/{entityTypesId}/entities:batchDelete", hasBody: true }),
  svc,
...
export const batchDeleteProjectsAgentEntityTypesEntities: API.OperationMethod<BatchDeleteProjectsAgentEntityTypesEntitiesRequest, BatchDeleteProjectsAgentEntityTypesEntitiesResponse, BatchDeleteProjectsAgentEntityTypesEntitiesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsAgentEnvironmentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/environments" }),
  svc,
) as unknown as Schema.Schema<ListProjectsAgentEnvironmentsRequest>;

export type ListProjectsAgentEnvironmentsResponse = GoogleCloudDialogflowV2ListEnvironmentsResponse;
export const ListProjectsAgentEnvironmentsResponse = GoogleCloudDialogflowV2ListEnvironmentsResponse;

export type ListProjectsAgentEnvironmentsError = DefaultErrors;

export const listProjectsAgentEnvironments: API.PaginatedOperationMethod<ListProjectsAgentEnvironmentsRequest, ListProjectsAgentEnvironmentsResponse, ListProjectsAgentEnvironmentsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsAgentEnvironmentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/environments/{environmentsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsAgentEnvironmentsRequest>;

export type GetProjectsAgentEnvironmentsResponse = GoogleCloudDialogflowV2Environment;
export const GetProjectsAgentEnvironmentsResponse = GoogleCloudDialogflowV2Environment;

export type GetProjectsAgentEnvironmentsError = DefaultErrors;

export const getProjectsAgentEnvironments: API.OperationMethod<GetProjectsAgentEnvironmentsRequest, GetProjectsAgentEnvironmentsResponse, GetProjectsAgentEnvironmentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsAgentEnvironmentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/environments", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsAgentEnvironmentsRequest>;

export type CreateProjectsAgentEnvironmentsResponse = GoogleCloudDialogflowV2Environment;
export const CreateProjectsAgentEnvironmentsResponse = GoogleCloudDialogflowV2Environment;

export type CreateProjectsAgentEnvironmentsError = DefaultErrors;

export const createProjectsAgentEnvironments: API.OperationMethod<CreateProjectsAgentEnvironmentsRequest, CreateProjectsAgentEnvironmentsResponse, CreateProjectsAgentEnvironmentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsAgentEnvironmentsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/agent/environments/{environmentsId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsAgentEnvironmentsRequest>;

export type PatchProjectsAgentEnvironmentsResponse = GoogleCloudDialogflowV2Environment;
export const PatchProjectsAgentEnvironmentsResponse = GoogleCloudDialogflowV2Environment;

export type PatchProjectsAgentEnvironmentsError = DefaultErrors;

export const patchProjectsAgentEnvironments: API.OperationMethod<PatchProjectsAgentEnvironmentsRequest, PatchProjectsAgentEnvironmentsResponse, PatchProjectsAgentEnvironmentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsAgentEnvironmentsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/agent/environments/{environmentsId}" }),
  svc,
...
export const deleteProjectsAgentEnvironments: API.OperationMethod<DeleteProjectsAgentEnvironmentsRequest, DeleteProjectsAgentEnvironmentsResponse, DeleteProjectsAgentEnvironmentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetHistoryProjectsAgentEnvironmentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/environments/{environmentsId}/history" }),
  svc,
) as unknown as Schema.Schema<GetHistoryProjectsAgentEnvironmentsRequest>;

export type GetHistoryProjectsAgentEnvironmentsResponse = GoogleCloudDialogflowV2EnvironmentHistory;
export const GetHistoryProjectsAgentEnvironmentsResponse = GoogleCloudDialogflowV2EnvironmentHistory;

export type GetHistoryProjectsAgentEnvironmentsError = DefaultErrors;

export const getHistoryProjectsAgentEnvironments: API.PaginatedOperationMethod<GetHistoryProjectsAgentEnvironmentsRequest, GetHistoryProjectsAgentEnvironmentsResponse, GetHistoryProjectsAgentEnvironmentsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const DeleteContextsProjectsAgentEnvironmentsUsersSessionsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/contexts" }),
  svc,
...
export type DeleteContextsProjectsAgentEnvironmentsUsersSessionsError = DefaultErrors;
...
export const DetectIntentProjectsAgentEnvironmentsUsersSessionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}:detectIntent", hasBody: true }),
  svc,
) as unknown as Schema.Schema<DetectIntentProjectsAgentEnvironmentsUsersSessionsRequest>;

export type DetectIntentProjectsAgentEnvironmentsUsersSessionsResponse = GoogleCloudDialogflowV2DetectIntentResponse;
export const DetectIntentProjectsAgentEnvironmentsUsersSessionsResponse = GoogleCloudDialogflowV2DetectIntentResponse;

export type DetectIntentProjectsAgentEnvironmentsUsersSessionsError = DefaultErrors;

export const detectIntentProjectsAgentEnvironmentsUsersSessions: API.OperationMethod<DetectIntentProjectsAgentEnvironmentsUsersSessionsRequest, DetectIntentProjectsAgentEnvironmentsUsersSessionsResponse, DetectIntentProjectsAgentEnvironmentsUsersSessionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsAgentEnvironmentsUsersSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/contexts" }),
  svc,
) as unknown as Schema.Schema<ListProjectsAgentEnvironmentsUsersSessionsContextsRequest>;

export type ListProjectsAgentEnvironmentsUsersSessionsContextsResponse = GoogleCloudDialogflowV2ListContextsResponse;
export const ListProjectsAgentEnvironmentsUsersSessionsContextsResponse = GoogleCloudDialogflowV2ListContextsResponse;

export type ListProjectsAgentEnvironmentsUsersSessionsContextsError = DefaultErrors;
...
export const GetProjectsAgentEnvironmentsUsersSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/contexts/{contextsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsAgentEnvironmentsUsersSessionsContextsRequest>;

export type GetProjectsAgentEnvironmentsUsersSessionsContextsResponse = GoogleCloudDialogflowV2Context;
export const GetProjectsAgentEnvironmentsUsersSessionsContextsResponse = GoogleCloudDialogflowV2Context;

export type GetProjectsAgentEnvironmentsUsersSessionsContextsError = DefaultErrors;

export const getProjectsAgentEnvironmentsUsersSessionsContexts: API.OperationMethod<GetProjectsAgentEnvironmentsUsersSessionsContextsRequest, GetProjectsAgentEnvironmentsUsersSessionsContextsResponse, GetProjectsAgentEnvironmentsUsersSessionsContextsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsAgentEnvironmentsUsersSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/contexts", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsAgentEnvironmentsUsersSessionsContextsRequest>;

export type CreateProjectsAgentEnvironmentsUsersSessionsContextsResponse = GoogleCloudDialogflowV2Context;
export const CreateProjectsAgentEnvironmentsUsersSessionsContextsResponse = GoogleCloudDialogflowV2Context;

export type CreateProjectsAgentEnvironmentsUsersSessionsContextsError = DefaultErrors;

export const createProjectsAgentEnvironmentsUsersSessionsContexts: API.OperationMethod<CreateProjectsAgentEnvironmentsUsersSessionsContextsRequest, CreateProjectsAgentEnvironmentsUsersSessionsContextsResponse, CreateProjectsAgentEnvironmentsUsersSessionsContextsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsAgentEnvironmentsUsersSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/contexts/{contextsId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsAgentEnvironmentsUsersSessionsContextsRequest>;

export type PatchProjectsAgentEnvironmentsUsersSessionsContextsResponse = GoogleCloudDialogflowV2Context;
export const PatchProjectsAgentEnvironmentsUsersSessionsContextsResponse = GoogleCloudDialogflowV2Context;

export type PatchProjectsAgentEnvironmentsUsersSessionsContextsError = DefaultErrors;

export const patchProjectsAgentEnvironmentsUsersSessionsContexts: API.OperationMethod<PatchProjectsAgentEnvironmentsUsersSessionsContextsRequest, PatchProjectsAgentEnvironmentsUsersSessionsContextsResponse, PatchProjectsAgentEnvironmentsUsersSessionsContextsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsAgentEnvironmentsUsersSessionsContextsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/contexts/{contextsId}" }),
  svc,
...
export type DeleteProjectsAgentEnvironmentsUsersSessionsContextsError = DefaultErrors;
...
export const ListProjectsAgentEnvironmentsUsersSessionsEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/entityTypes" }),
  svc,
) as unknown as Schema.Schema<ListProjectsAgentEnvironmentsUsersSessionsEntityTypesRequest>;

export type ListProjectsAgentEnvironmentsUsersSessionsEntityTypesResponse = GoogleCloudDialogflowV2ListSessionEntityTypesResponse;
export const ListProjectsAgentEnvironmentsUsersSessionsEntityTypesResponse = GoogleCloudDialogflowV2ListSessionEntityTypesResponse;

export type ListProjectsAgentEnvironmentsUsersSessionsEntityTypesError = DefaultErrors;
...
export const GetProjectsAgentEnvironmentsUsersSessionsEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/entityTypes/{entityTypesId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsAgentEnvironmentsUsersSessionsEntityTypesRequest>;

export type GetProjectsAgentEnvironmentsUsersSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;
export const GetProjectsAgentEnvironmentsUsersSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;

export type GetProjectsAgentEnvironmentsUsersSessionsEntityTypesError = DefaultErrors;
...
export const CreateProjectsAgentEnvironmentsUsersSessionsEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/entityTypes", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsAgentEnvironmentsUsersSessionsEntityTypesRequest>;

export type CreateProjectsAgentEnvironmentsUsersSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;
export const CreateProjectsAgentEnvironmentsUsersSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;

export type CreateProjectsAgentEnvironmentsUsersSessionsEntityTypesError = DefaultErrors;

export const createProjectsAgentEnvironmentsUsersSessionsEntityTypes: API.OperationMethod<CreateProjectsAgentEnvironmentsUsersSessionsEntityTypesRequest, CreateProjectsAgentEnvironmentsUsersSessionsEntityTypesResponse, CreateProjectsAgentEnvironmentsUsersSessionsEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsAgentEnvironmentsUsersSessionsEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/entityTypes/{entityTypesId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsAgentEnvironmentsUsersSessionsEntityTypesRequest>;

export type PatchProjectsAgentEnvironmentsUsersSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;
export const PatchProjectsAgentEnvironmentsUsersSessionsEntityTypesResponse = GoogleCloudDialogflowV2SessionEntityType;

export type PatchProjectsAgentEnvironmentsUsersSessionsEntityTypesError = DefaultErrors;

export const patchProjectsAgentEnvironmentsUsersSessionsEntityTypes: API.OperationMethod<PatchProjectsAgentEnvironmentsUsersSessionsEntityTypesRequest, PatchProjectsAgentEnvironmentsUsersSessionsEntityTypesResponse, PatchProjectsAgentEnvironmentsUsersSessionsEntityTypesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsAgentEnvironmentsUsersSessionsEntityTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/agent/environments/{environmentsId}/users/{usersId}/sessions/{sessionsId}/entityTypes/{entityTypesId}" }),
  svc,
...
export type DeleteProjectsAgentEnvironmentsUsersSessionsEntityTypesError = DefaultErrors;
...
export const ListProjectsAgentEnvironmentsIntentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/environments/{environmentsId}/intents" }),
  svc,
) as unknown as Schema.Schema<ListProjectsAgentEnvironmentsIntentsRequest>;

export type ListProjectsAgentEnvironmentsIntentsResponse = GoogleCloudDialogflowV2ListIntentsResponse;
export const ListProjectsAgentEnvironmentsIntentsResponse = GoogleCloudDialogflowV2ListIntentsResponse;

export type ListProjectsAgentEnvironmentsIntentsError = DefaultErrors;

export const listProjectsAgentEnvironmentsIntents: API.PaginatedOperationMethod<ListProjectsAgentEnvironmentsIntentsRequest, ListProjectsAgentEnvironmentsIntentsResponse, ListProjectsAgentEnvironmentsIntentsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const ListProjectsAgentKnowledgeBasesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/knowledgeBases" }),
  svc,
) as unknown as Schema.Schema<ListProjectsAgentKnowledgeBasesRequest>;

export type ListProjectsAgentKnowledgeBasesResponse = GoogleCloudDialogflowV2ListKnowledgeBasesResponse;
export const ListProjectsAgentKnowledgeBasesResponse = GoogleCloudDialogflowV2ListKnowledgeBasesResponse;

export type ListProjectsAgentKnowledgeBasesError = DefaultErrors;

export const listProjectsAgentKnowledgeBases: API.PaginatedOperationMethod<ListProjectsAgentKnowledgeBasesRequest, ListProjectsAgentKnowledgeBasesResponse, ListProjectsAgentKnowledgeBasesError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsAgentKnowledgeBasesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/knowledgeBases/{knowledgeBasesId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsAgentKnowledgeBasesRequest>;

export type GetProjectsAgentKnowledgeBasesResponse = GoogleCloudDialogflowV2KnowledgeBase;
export const GetProjectsAgentKnowledgeBasesResponse = GoogleCloudDialogflowV2KnowledgeBase;

export type GetProjectsAgentKnowledgeBasesError = DefaultErrors;

export const getProjectsAgentKnowledgeBases: API.OperationMethod<GetProjectsAgentKnowledgeBasesRequest, GetProjectsAgentKnowledgeBasesResponse, GetProjectsAgentKnowledgeBasesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsAgentKnowledgeBasesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/knowledgeBases", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsAgentKnowledgeBasesRequest>;

export type CreateProjectsAgentKnowledgeBasesResponse = GoogleCloudDialogflowV2KnowledgeBase;
export const CreateProjectsAgentKnowledgeBasesResponse = GoogleCloudDialogflowV2KnowledgeBase;

export type CreateProjectsAgentKnowledgeBasesError = DefaultErrors;

export const createProjectsAgentKnowledgeBases: API.OperationMethod<CreateProjectsAgentKnowledgeBasesRequest, CreateProjectsAgentKnowledgeBasesResponse, CreateProjectsAgentKnowledgeBasesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsAgentKnowledgeBasesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/agent/knowledgeBases/{knowledgeBasesId}" }),
  svc,
...
export const deleteProjectsAgentKnowledgeBases: API.OperationMethod<DeleteProjectsAgentKnowledgeBasesRequest, DeleteProjectsAgentKnowledgeBasesResponse, DeleteProjectsAgentKnowledgeBasesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsAgentKnowledgeBasesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/agent/knowledgeBases/{knowledgeBasesId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsAgentKnowledgeBasesRequest>;

export type PatchProjectsAgentKnowledgeBasesResponse = GoogleCloudDialogflowV2KnowledgeBase;
export const PatchProjectsAgentKnowledgeBasesResponse = GoogleCloudDialogflowV2KnowledgeBase;

export type PatchProjectsAgentKnowledgeBasesError = DefaultErrors;

export const patchProjectsAgentKnowledgeBases: API.OperationMethod<PatchProjectsAgentKnowledgeBasesRequest, PatchProjectsAgentKnowledgeBasesResponse, PatchProjectsAgentKnowledgeBasesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsAgentKnowledgeBasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/knowledgeBases/{knowledgeBasesId}/documents" }),
  svc,
) as unknown as Schema.Schema<ListProjectsAgentKnowledgeBasesDocumentsRequest>;

export type ListProjectsAgentKnowledgeBasesDocumentsResponse = GoogleCloudDialogflowV2ListDocumentsResponse;
export const ListProjectsAgentKnowledgeBasesDocumentsResponse = GoogleCloudDialogflowV2ListDocumentsResponse;

export type ListProjectsAgentKnowledgeBasesDocumentsError = DefaultErrors;

export const listProjectsAgentKnowledgeBasesDocuments: API.PaginatedOperationMethod<ListProjectsAgentKnowledgeBasesDocumentsRequest, ListProjectsAgentKnowledgeBasesDocumentsResponse, ListProjectsAgentKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsAgentKnowledgeBasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/knowledgeBases/{knowledgeBasesId}/documents/{documentsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsAgentKnowledgeBasesDocumentsRequest>;

export type GetProjectsAgentKnowledgeBasesDocumentsResponse = GoogleCloudDialogflowV2Document;
export const GetProjectsAgentKnowledgeBasesDocumentsResponse = GoogleCloudDialogflowV2Document;

export type GetProjectsAgentKnowledgeBasesDocumentsError = DefaultErrors;

export const getProjectsAgentKnowledgeBasesDocuments: API.OperationMethod<GetProjectsAgentKnowledgeBasesDocumentsRequest, GetProjectsAgentKnowledgeBasesDocumentsResponse, GetProjectsAgentKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsAgentKnowledgeBasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/knowledgeBases/{knowledgeBasesId}/documents", hasBody: true }),
  svc,
...
export const createProjectsAgentKnowledgeBasesDocuments: API.OperationMethod<CreateProjectsAgentKnowledgeBasesDocumentsRequest, CreateProjectsAgentKnowledgeBasesDocumentsResponse, CreateProjectsAgentKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsAgentKnowledgeBasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/agent/knowledgeBases/{knowledgeBasesId}/documents/{documentsId}" }),
  svc,
...
export const deleteProjectsAgentKnowledgeBasesDocuments: API.OperationMethod<DeleteProjectsAgentKnowledgeBasesDocumentsRequest, DeleteProjectsAgentKnowledgeBasesDocumentsResponse, DeleteProjectsAgentKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsAgentKnowledgeBasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/agent/knowledgeBases/{knowledgeBasesId}/documents/{documentsId}", hasBody: true }),
  svc,
...
export const patchProjectsAgentKnowledgeBasesDocuments: API.OperationMethod<PatchProjectsAgentKnowledgeBasesDocumentsRequest, PatchProjectsAgentKnowledgeBasesDocumentsResponse, PatchProjectsAgentKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ReloadProjectsAgentKnowledgeBasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/knowledgeBases/{knowledgeBasesId}/documents/{documentsId}:reload", hasBody: true }),
  svc,
...
export const reloadProjectsAgentKnowledgeBasesDocuments: API.OperationMethod<ReloadProjectsAgentKnowledgeBasesDocumentsRequest, ReloadProjectsAgentKnowledgeBasesDocumentsResponse, ReloadProjectsAgentKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export type ListProjectsAgentVersionsResponse = GoogleCloudDialogflowV2ListVersionsResponse;
export const ListProjectsAgentVersionsResponse = GoogleCloudDialogflowV2ListVersionsResponse;

export type ListProjectsAgentVersionsError = DefaultErrors;

export const listProjectsAgentVersions: API.PaginatedOperationMethod<ListProjectsAgentVersionsRequest, ListProjectsAgentVersionsResponse, ListProjectsAgentVersionsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsAgentVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/agent/versions/{versionsId}" }),
  svc,
...
export const GetProjectsAgentVersionsResponse = GoogleCloudDialogflowV2Version;

export type GetProjectsAgentVersionsError = DefaultErrors;

export const getProjectsAgentVersions: API.OperationMethod<GetProjectsAgentVersionsRequest, GetProjectsAgentVersionsResponse, GetProjectsAgentVersionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsAgentVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/agent/versions", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsAgentVersionsRequest>;

export type CreateProjectsAgentVersionsResponse = GoogleCloudDialogflowV2Version;
export const CreateProjectsAgentVersionsResponse = GoogleCloudDialogflowV2Version;

export type CreateProjectsAgentVersionsError = DefaultErrors;

export const createProjectsAgentVersions: API.OperationMethod<CreateProjectsAgentVersionsRequest, CreateProjectsAgentVersionsResponse, CreateProjectsAgentVersionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsAgentVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/agent/versions/{versionsId}", hasBody: true }),
  svc,
...
export const PatchProjectsAgentVersionsResponse = GoogleCloudDialogflowV2Version;

export type PatchProjectsAgentVersionsError = DefaultErrors;

export const patchProjectsAgentVersions: API.OperationMethod<PatchProjectsAgentVersionsRequest, PatchProjectsAgentVersionsResponse, PatchProjectsAgentVersionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsAgentVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/agent/versions/{versionsId}" }),
  svc,
...
export const deleteProjectsAgentVersions: API.OperationMethod<DeleteProjectsAgentVersionsRequest, DeleteProjectsAgentVersionsResponse, DeleteProjectsAgentVersionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsGeneratorsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/generators", hasBody: true }),
  svc,
...
export const CreateProjectsGeneratorsResponse = GoogleCloudDialogflowV2Generator;

export type CreateProjectsGeneratorsError = DefaultErrors;

export const createProjectsGenerators: API.OperationMethod<CreateProjectsGeneratorsRequest, CreateProjectsGeneratorsResponse, CreateProjectsGeneratorsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export type ListProjectsGeneratorsResponse = GoogleCloudDialogflowV2ListGeneratorsResponse;
export const ListProjectsGeneratorsResponse = GoogleCloudDialogflowV2ListGeneratorsResponse;

export type ListProjectsGeneratorsError = DefaultErrors;

export const listProjectsGenerators: API.PaginatedOperationMethod<ListProjectsGeneratorsRequest, ListProjectsGeneratorsResponse, ListProjectsGeneratorsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export type ListProjectsAnswerRecordsResponse = GoogleCloudDialogflowV2ListAnswerRecordsResponse;
export const ListProjectsAnswerRecordsResponse = GoogleCloudDialogflowV2ListAnswerRecordsResponse;

export type ListProjectsAnswerRecordsError = DefaultErrors;

export const listProjectsAnswerRecords: API.PaginatedOperationMethod<ListProjectsAnswerRecordsRequest, ListProjectsAnswerRecordsResponse, ListProjectsAnswerRecordsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const PatchProjectsAnswerRecordsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/answerRecords/{answerRecordsId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsAnswerRecordsRequest>;

export type PatchProjectsAnswerRecordsResponse = GoogleCloudDialogflowV2AnswerRecord;
export const PatchProjectsAnswerRecordsResponse = GoogleCloudDialogflowV2AnswerRecord;

export type PatchProjectsAnswerRecordsError = DefaultErrors;

export const patchProjectsAnswerRecords: API.OperationMethod<PatchProjectsAnswerRecordsRequest, PatchProjectsAnswerRecordsResponse, PatchProjectsAnswerRecordsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetProjectsConversationDatasetsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/conversationDatasets/{conversationDatasetsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsConversationDatasetsRequest>;

export type GetProjectsConversationDatasetsResponse = GoogleCloudDialogflowV2ConversationDataset;
export const GetProjectsConversationDatasetsResponse = GoogleCloudDialogflowV2ConversationDataset;

export type GetProjectsConversationDatasetsError = DefaultErrors;

export const getProjectsConversationDatasets: API.OperationMethod<GetProjectsConversationDatasetsRequest, GetProjectsConversationDatasetsResponse, GetProjectsConversationDatasetsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsConversationDatasetsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/conversationDatasets" }),
  svc,
) as unknown as Schema.Schema<ListProjectsConversationDatasetsRequest>;

export type ListProjectsConversationDatasetsResponse = GoogleCloudDialogflowV2ListConversationDatasetsResponse;
export const ListProjectsConversationDatasetsResponse = GoogleCloudDialogflowV2ListConversationDatasetsResponse;

export type ListProjectsConversationDatasetsError = DefaultErrors;

export const listProjectsConversationDatasets: API.PaginatedOperationMethod<ListProjectsConversationDatasetsRequest, ListProjectsConversationDatasetsResponse, ListProjectsConversationDatasetsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const ImportConversationDataProjectsConversationDatasetsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudDialogflowV2ImportConversationDataRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/conversationDatasets/{conversationDatasetsId}:importConversationData", hasBody: true }),
  svc,
) as unknown as Schema.Schema<ImportConversationDataProjectsConversationDatasetsRequest>;

export type ImportConversationDataProjectsConversationDatasetsResponse = GoogleLongrunningOperation;
export const ImportConversationDataProjectsConversationDatasetsResponse = GoogleLongrunningOperation;

export type ImportConversationDataProjectsConversationDatasetsError = DefaultErrors;

export const importConversationDataProjectsConversationDatasets: API.OperationMethod<ImportConversationDataProjectsConversationDatasetsRequest, ImportConversationDataProjectsConversationDatasetsResponse, ImportConversationDataProjectsConversationDatasetsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsConversationModelsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDialogflowV2ConversationModel).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/conversationModels", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsConversationModelsRequest>;

export type CreateProjectsConversationModelsResponse = GoogleLongrunningOperation;
export const CreateProjectsConversationModelsResponse = GoogleLongrunningOperation;

export type CreateProjectsConversationModelsError = DefaultErrors;

export const createProjectsConversationModels: API.OperationMethod<CreateProjectsConversationModelsRequest, CreateProjectsConversationModelsResponse, CreateProjectsConversationModelsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetProjectsConversationModelsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/conversationModels/{conversationModelsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsConversationModelsRequest>;

export type GetProjectsConversationModelsResponse = GoogleCloudDialogflowV2ConversationModel;
export const GetProjectsConversationModelsResponse = GoogleCloudDialogflowV2ConversationModel;

export type GetProjectsConversationModelsError = DefaultErrors;

export const getProjectsConversationModels: API.OperationMethod<GetProjectsConversationModelsRequest, GetProjectsConversationModelsResponse, GetProjectsConversationModelsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsConversationModelsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/conversationModels" }),
  svc,
) as unknown as Schema.Schema<ListProjectsConversationModelsRequest>;

export type ListProjectsConversationModelsResponse = GoogleCloudDialogflowV2ListConversationModelsResponse;
export const ListProjectsConversationModelsResponse = GoogleCloudDialogflowV2ListConversationModelsResponse;

export type ListProjectsConversationModelsError = DefaultErrors;

export const listProjectsConversationModels: API.PaginatedOperationMethod<ListProjectsConversationModelsRequest, ListProjectsConversationModelsResponse, ListProjectsConversationModelsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const DeleteProjectsConversationModelsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/conversationModels/{conversationModelsId}" }),
  svc,
) as unknown as Schema.Schema<DeleteProjectsConversationModelsRequest>;

export type DeleteProjectsConversationModelsResponse = GoogleLongrunningOperation;
export const DeleteProjectsConversationModelsResponse = GoogleLongrunningOperation;

export type DeleteProjectsConversationModelsError = DefaultErrors;

export const deleteProjectsConversationModels: API.OperationMethod<DeleteProjectsConversationModelsRequest, DeleteProjectsConversationModelsResponse, DeleteProjectsConversationModelsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeployProjectsConversationModelsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudDialogflowV2DeployConversationModelRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/conversationModels/{conversationModelsId}:deploy", hasBody: true }),
  svc,
) as unknown as Schema.Schema<DeployProjectsConversationModelsRequest>;

export type DeployProjectsConversationModelsResponse = GoogleLongrunningOperation;
export const DeployProjectsConversationModelsResponse = GoogleLongrunningOperation;

export type DeployProjectsConversationModelsError = DefaultErrors;

export const deployProjectsConversationModels: API.OperationMethod<DeployProjectsConversationModelsRequest, DeployProjectsConversationModelsResponse, DeployProjectsConversationModelsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const UndeployProjectsConversationModelsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudDialogflowV2UndeployConversationModelRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/conversationModels/{conversationModelsId}:undeploy", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UndeployProjectsConversationModelsRequest>;

export type UndeployProjectsConversationModelsResponse = GoogleLongrunningOperation;
export const UndeployProjectsConversationModelsResponse = GoogleLongrunningOperation;

export type UndeployProjectsConversationModelsError = DefaultErrors;

export const undeployProjectsConversationModels: API.OperationMethod<UndeployProjectsConversationModelsRequest, UndeployProjectsConversationModelsResponse, UndeployProjectsConversationModelsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetProjectsConversationModelsEvaluationsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/conversationModels/{conversationModelsId}/evaluations/{evaluationsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsConversationModelsEvaluationsRequest>;

export type GetProjectsConversationModelsEvaluationsResponse = GoogleCloudDialogflowV2ConversationModelEvaluation;
export const GetProjectsConversationModelsEvaluationsResponse = GoogleCloudDialogflowV2ConversationModelEvaluation;

export type GetProjectsConversationModelsEvaluationsError = DefaultErrors;

export const getProjectsConversationModelsEvaluations: API.OperationMethod<GetProjectsConversationModelsEvaluationsRequest, GetProjectsConversationModelsEvaluationsResponse, GetProjectsConversationModelsEvaluationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsConversationModelsEvaluationsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/conversationModels/{conversationModelsId}/evaluations" }),
  svc,
) as unknown as Schema.Schema<ListProjectsConversationModelsEvaluationsRequest>;

export type ListProjectsConversationModelsEvaluationsResponse = GoogleCloudDialogflowV2ListConversationModelEvaluationsResponse;
export const ListProjectsConversationModelsEvaluationsResponse = GoogleCloudDialogflowV2ListConversationModelEvaluationsResponse;

export type ListProjectsConversationModelsEvaluationsError = DefaultErrors;

export const listProjectsConversationModelsEvaluations: API.PaginatedOperationMethod<ListProjectsConversationModelsEvaluationsRequest, ListProjectsConversationModelsEvaluationsResponse, ListProjectsConversationModelsEvaluationsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const ListProjectsConversationProfilesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/conversationProfiles" }),
  svc,
) as unknown as Schema.Schema<ListProjectsConversationProfilesRequest>;

export type ListProjectsConversationProfilesResponse = GoogleCloudDialogflowV2ListConversationProfilesResponse;
export const ListProjectsConversationProfilesResponse = GoogleCloudDialogflowV2ListConversationProfilesResponse;

export type ListProjectsConversationProfilesError = DefaultErrors;

export const listProjectsConversationProfiles: API.PaginatedOperationMethod<ListProjectsConversationProfilesRequest, ListProjectsConversationProfilesResponse, ListProjectsConversationProfilesError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsConversationProfilesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/conversationProfiles/{conversationProfilesId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsConversationProfilesRequest>;

export type GetProjectsConversationProfilesResponse = GoogleCloudDialogflowV2ConversationProfile;
export const GetProjectsConversationProfilesResponse = GoogleCloudDialogflowV2ConversationProfile;

export type GetProjectsConversationProfilesError = DefaultErrors;

export const getProjectsConversationProfiles: API.OperationMethod<GetProjectsConversationProfilesRequest, GetProjectsConversationProfilesResponse, GetProjectsConversationProfilesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsConversationProfilesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/conversationProfiles", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsConversationProfilesRequest>;

export type CreateProjectsConversationProfilesResponse = GoogleCloudDialogflowV2ConversationProfile;
export const CreateProjectsConversationProfilesResponse = GoogleCloudDialogflowV2ConversationProfile;

export type CreateProjectsConversationProfilesError = DefaultErrors;

export const createProjectsConversationProfiles: API.OperationMethod<CreateProjectsConversationProfilesRequest, CreateProjectsConversationProfilesResponse, CreateProjectsConversationProfilesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsConversationProfilesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/conversationProfiles/{conversationProfilesId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsConversationProfilesRequest>;

export type PatchProjectsConversationProfilesResponse = GoogleCloudDialogflowV2ConversationProfile;
export const PatchProjectsConversationProfilesResponse = GoogleCloudDialogflowV2ConversationProfile;

export type PatchProjectsConversationProfilesError = DefaultErrors;

export const patchProjectsConversationProfiles: API.OperationMethod<PatchProjectsConversationProfilesRequest, PatchProjectsConversationProfilesResponse, PatchProjectsConversationProfilesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsConversationProfilesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/conversationProfiles/{conversationProfilesId}" }),
  svc,
...
export const deleteProjectsConversationProfiles: API.OperationMethod<DeleteProjectsConversationProfilesRequest, DeleteProjectsConversationProfilesResponse, DeleteProjectsConversationProfilesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const SetSuggestionFeatureConfigProjectsConversationProfilesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/conversationProfiles/{conversationProfilesId}:setSuggestionFeatureConfig", hasBody: true }),
  svc,
...
export const ClearSuggestionFeatureConfigProjectsConversationProfilesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/conversationProfiles/{conversationProfilesId}:clearSuggestionFeatureConfig", hasBody: true }),
  svc,
...
export type ClearSuggestionFeatureConfigProjectsConversationProfilesError = DefaultErrors;
...
export const CreateProjectsConversationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/conversations", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsConversationsRequest>;

export type CreateProjectsConversationsResponse = GoogleCloudDialogflowV2Conversation;
export const CreateProjectsConversationsResponse = GoogleCloudDialogflowV2Conversation;

export type CreateProjectsConversationsError = DefaultErrors;

export const createProjectsConversations: API.OperationMethod<CreateProjectsConversationsRequest, CreateProjectsConversationsResponse, CreateProjectsConversationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export type ListProjectsConversationsResponse = GoogleCloudDialogflowV2ListConversationsResponse;
export const ListProjectsConversationsResponse = GoogleCloudDialogflowV2ListConversationsResponse;

export type ListProjectsConversationsError = DefaultErrors;

export const listProjectsConversations: API.PaginatedOperationMethod<ListProjectsConversationsRequest, ListProjectsConversationsResponse, ListProjectsConversationsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsConversationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/conversations/{conversationsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsConversationsRequest>;

export type GetProjectsConversationsResponse = GoogleCloudDialogflowV2Conversation;
export const GetProjectsConversationsResponse = GoogleCloudDialogflowV2Conversation;

export type GetProjectsConversationsError = DefaultErrors;

export const getProjectsConversations: API.OperationMethod<GetProjectsConversationsRequest, GetProjectsConversationsResponse, GetProjectsConversationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CompleteProjectsConversationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/conversations/{conversationsId}:complete", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CompleteProjectsConversationsRequest>;

export type CompleteProjectsConversationsResponse = GoogleCloudDialogflowV2Conversation;
export const CompleteProjectsConversationsResponse = GoogleCloudDialogflowV2Conversation;

export type CompleteProjectsConversationsError = DefaultErrors;

export const completeProjectsConversations: API.OperationMethod<CompleteProjectsConversationsRequest, CompleteProjectsConversationsResponse, CompleteProjectsConversationsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsConversationsParticipantsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/conversations/{conversationsId}/participants", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsConversationsParticipantsRequest>;

export type CreateProjectsConversationsParticipantsResponse = GoogleCloudDialogflowV2Participant;
export const CreateProjectsConversationsParticipantsResponse = GoogleCloudDialogflowV2Participant;

export type CreateProjectsConversationsParticipantsError = DefaultErrors;

export const createProjectsConversationsParticipants: API.OperationMethod<CreateProjectsConversationsParticipantsRequest, CreateProjectsConversationsParticipantsResponse, CreateProjectsConversationsParticipantsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetProjectsConversationsParticipantsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/conversations/{conversationsId}/participants/{participantsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsConversationsParticipantsRequest>;

export type GetProjectsConversationsParticipantsResponse = GoogleCloudDialogflowV2Participant;
export const GetProjectsConversationsParticipantsResponse = GoogleCloudDialogflowV2Participant;

export type GetProjectsConversationsParticipantsError = DefaultErrors;

export const getProjectsConversationsParticipants: API.OperationMethod<GetProjectsConversationsParticipantsRequest, GetProjectsConversationsParticipantsResponse, GetProjectsConversationsParticipantsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsConversationsParticipantsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/conversations/{conversationsId}/participants" }),
  svc,
) as unknown as Schema.Schema<ListProjectsConversationsParticipantsRequest>;

export type ListProjectsConversationsParticipantsResponse = GoogleCloudDialogflowV2ListParticipantsResponse;
export const ListProjectsConversationsParticipantsResponse = GoogleCloudDialogflowV2ListParticipantsResponse;

export type ListProjectsConversationsParticipantsError = DefaultErrors;

export const listProjectsConversationsParticipants: API.PaginatedOperationMethod<ListProjectsConversationsParticipantsRequest, ListProjectsConversationsParticipantsResponse, ListProjectsConversationsParticipantsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const PatchProjectsConversationsParticipantsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/conversations/{conversationsId}/participants/{participantsId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsConversationsParticipantsRequest>;

export type PatchProjectsConversationsParticipantsResponse = GoogleCloudDialogflowV2Participant;
export const PatchProjectsConversationsParticipantsResponse = GoogleCloudDialogflowV2Participant;

export type PatchProjectsConversationsParticipantsError = DefaultErrors;

export const patchProjectsConversationsParticipants: API.OperationMethod<PatchProjectsConversationsParticipantsRequest, PatchProjectsConversationsParticipantsResponse, PatchProjectsConversationsParticipantsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const AnalyzeContentProjectsConversationsParticipantsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/conversations/{conversationsId}/participants/{participantsId}:analyzeContent", hasBody: true }),
  svc,
) as unknown as Schema.Schema<AnalyzeContentProjectsConversationsParticipantsRequest>;

export type AnalyzeContentProjectsConversationsParticipantsResponse = GoogleCloudDialogflowV2AnalyzeContentResponse;
export const AnalyzeContentProjectsConversationsParticipantsResponse = GoogleCloudDialogflowV2AnalyzeContentResponse;

export type AnalyzeContentProjectsConversationsParticipantsError = DefaultErrors;

export const analyzeContentProjectsConversationsParticipants: API.OperationMethod<AnalyzeContentProjectsConversationsParticipantsRequest, AnalyzeContentProjectsConversationsParticipantsResponse, AnalyzeContentProjectsConversationsParticipantsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const SuggestArticlesProjectsConversationsParticipantsSuggestionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/conversations/{conversationsId}/participants/{participantsId}/suggestions:suggestArticles", hasBody: true }),
  svc,
) as unknown as Schema.Schema<SuggestArticlesProjectsConversationsParticipantsSuggestionsRequest>;

export type SuggestArticlesProjectsConversationsParticipantsSuggestionsResponse = GoogleCloudDialogflowV2SuggestArticlesResponse;
export const SuggestArticlesProjectsConversationsParticipantsSuggestionsResponse = GoogleCloudDialogflowV2SuggestArticlesResponse;

export type SuggestArticlesProjectsConversationsParticipantsSuggestionsError = DefaultErrors;
...
export const SuggestFaqAnswersProjectsConversationsParticipantsSuggestionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/conversations/{conversationsId}/participants/{participantsId}/suggestions:suggestFaqAnswers", hasBody: true }),
  svc,
) as unknown as Schema.Schema<SuggestFaqAnswersProjectsConversationsParticipantsSuggestionsRequest>;

export type SuggestFaqAnswersProjectsConversationsParticipantsSuggestionsResponse = GoogleCloudDialogflowV2SuggestFaqAnswersResponse;
export const SuggestFaqAnswersProjectsConversationsParticipantsSuggestionsResponse = GoogleCloudDialogflowV2SuggestFaqAnswersResponse;

export type SuggestFaqAnswersProjectsConversationsParticipantsSuggestionsError = DefaultErrors;
...
export const SuggestSmartRepliesProjectsConversationsParticipantsSuggestionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/conversations/{conversationsId}/participants/{participantsId}/suggestions:suggestSmartReplies", hasBody: true }),
  svc,
) as unknown as Schema.Schema<SuggestSmartRepliesProjectsConversationsParticipantsSuggestionsRequest>;

export type SuggestSmartRepliesProjectsConversationsParticipantsSuggestionsResponse = GoogleCloudDialogflowV2SuggestSmartRepliesResponse;
export const SuggestSmartRepliesProjectsConversationsParticipantsSuggestionsResponse = GoogleCloudDialogflowV2SuggestSmartRepliesResponse;

export type SuggestSmartRepliesProjectsConversationsParticipantsSuggestionsError = DefaultErrors;
...
export const SuggestKnowledgeAssistProjectsConversationsParticipantsSuggestionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/conversations/{conversationsId}/participants/{participantsId}/suggestions:suggestKnowledgeAssist", hasBody: true }),
  svc,
) as unknown as Schema.Schema<SuggestKnowledgeAssistProjectsConversationsParticipantsSuggestionsRequest>;

export type SuggestKnowledgeAssistProjectsConversationsParticipantsSuggestionsResponse = GoogleCloudDialogflowV2SuggestKnowledgeAssistResponse;
export const SuggestKnowledgeAssistProjectsConversationsParticipantsSuggestionsResponse = GoogleCloudDialogflowV2SuggestKnowledgeAssistResponse;

export type SuggestKnowledgeAssistProjectsConversationsParticipantsSuggestionsError = DefaultErrors;
...
export const ListProjectsConversationsMessagesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/conversations/{conversationsId}/messages" }),
  svc,
) as unknown as Schema.Schema<ListProjectsConversationsMessagesRequest>;

export type ListProjectsConversationsMessagesResponse = GoogleCloudDialogflowV2ListMessagesResponse;
export const ListProjectsConversationsMessagesResponse = GoogleCloudDialogflowV2ListMessagesResponse;

export type ListProjectsConversationsMessagesError = DefaultErrors;

export const listProjectsConversationsMessages: API.PaginatedOperationMethod<ListProjectsConversationsMessagesRequest, ListProjectsConversationsMessagesResponse, ListProjectsConversationsMessagesError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const SuggestConversationSummaryProjectsConversationsSuggestionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/conversations/{conversationsId}/suggestions:suggestConversationSummary", hasBody: true }),
  svc,
) as unknown as Schema.Schema<SuggestConversationSummaryProjectsConversationsSuggestionsRequest>;

export type SuggestConversationSummaryProjectsConversationsSuggestionsResponse = GoogleCloudDialogflowV2SuggestConversationSummaryResponse;
export const SuggestConversationSummaryProjectsConversationsSuggestionsResponse = GoogleCloudDialogflowV2SuggestConversationSummaryResponse;

export type SuggestConversationSummaryProjectsConversationsSuggestionsError = DefaultErrors;

export const suggestConversationSummaryProjectsConversationsSuggestions: API.OperationMethod<SuggestConversationSummaryProjectsConversationsSuggestionsRequest, SuggestConversationSummaryProjectsConversationsSuggestionsResponse, SuggestConversationSummaryProjectsConversationsSuggestionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const SearchKnowledgeProjectsConversationsSuggestionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/conversations/{conversationsId}/suggestions:searchKnowledge", hasBody: true }),
  svc,
) as unknown as Schema.Schema<SearchKnowledgeProjectsConversationsSuggestionsRequest>;

export type SearchKnowledgeProjectsConversationsSuggestionsResponse = GoogleCloudDialogflowV2SearchKnowledgeResponse;
export const SearchKnowledgeProjectsConversationsSuggestionsResponse = GoogleCloudDialogflowV2SearchKnowledgeResponse;

export type SearchKnowledgeProjectsConversationsSuggestionsError = DefaultErrors;

export const searchKnowledgeProjectsConversationsSuggestions: API.OperationMethod<SearchKnowledgeProjectsConversationsSuggestionsRequest, SearchKnowledgeProjectsConversationsSuggestionsResponse, SearchKnowledgeProjectsConversationsSuggestionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GenerateProjectsConversationsSuggestionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/conversations/{conversationsId}/suggestions:generate", hasBody: true }),
  svc,
) as unknown as Schema.Schema<GenerateProjectsConversationsSuggestionsRequest>;

export type GenerateProjectsConversationsSuggestionsResponse = GoogleCloudDialogflowV2GenerateSuggestionsResponse;
export const GenerateProjectsConversationsSuggestionsResponse = GoogleCloudDialogflowV2GenerateSuggestionsResponse;

export type GenerateProjectsConversationsSuggestionsError = DefaultErrors;

export const generateProjectsConversationsSuggestions: API.OperationMethod<GenerateProjectsConversationsSuggestionsRequest, GenerateProjectsConversationsSuggestionsResponse, GenerateProjectsConversationsSuggestionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GenerateStatelessSummaryProjectsSuggestionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/suggestions:generateStatelessSummary", hasBody: true }),
  svc,
) as unknown as Schema.Schema<GenerateStatelessSummaryProjectsSuggestionsRequest>;

export type GenerateStatelessSummaryProjectsSuggestionsResponse = GoogleCloudDialogflowV2GenerateStatelessSummaryResponse;
export const GenerateStatelessSummaryProjectsSuggestionsResponse = GoogleCloudDialogflowV2GenerateStatelessSummaryResponse;

export type GenerateStatelessSummaryProjectsSuggestionsError = DefaultErrors;

export const generateStatelessSummaryProjectsSuggestions: API.OperationMethod<GenerateStatelessSummaryProjectsSuggestionsRequest, GenerateStatelessSummaryProjectsSuggestionsResponse, GenerateStatelessSummaryProjectsSuggestionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const SearchKnowledgeProjectsSuggestionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/suggestions:searchKnowledge", hasBody: true }),
  svc,
) as unknown as Schema.Schema<SearchKnowledgeProjectsSuggestionsRequest>;

export type SearchKnowledgeProjectsSuggestionsResponse = GoogleCloudDialogflowV2SearchKnowledgeResponse;
export const SearchKnowledgeProjectsSuggestionsResponse = GoogleCloudDialogflowV2SearchKnowledgeResponse;

export type SearchKnowledgeProjectsSuggestionsError = DefaultErrors;

export const searchKnowledgeProjectsSuggestions: API.OperationMethod<SearchKnowledgeProjectsSuggestionsRequest, SearchKnowledgeProjectsSuggestionsResponse, SearchKnowledgeProjectsSuggestionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export type ListProjectsKnowledgeBasesResponse = GoogleCloudDialogflowV2ListKnowledgeBasesResponse;
export const ListProjectsKnowledgeBasesResponse = GoogleCloudDialogflowV2ListKnowledgeBasesResponse;

export type ListProjectsKnowledgeBasesError = DefaultErrors;

export const listProjectsKnowledgeBases: API.PaginatedOperationMethod<ListProjectsKnowledgeBasesRequest, ListProjectsKnowledgeBasesResponse, ListProjectsKnowledgeBasesError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsKnowledgeBasesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/knowledgeBases/{knowledgeBasesId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsKnowledgeBasesRequest>;

export type GetProjectsKnowledgeBasesResponse = GoogleCloudDialogflowV2KnowledgeBase;
export const GetProjectsKnowledgeBasesResponse = GoogleCloudDialogflowV2KnowledgeBase;

export type GetProjectsKnowledgeBasesError = DefaultErrors;

export const getProjectsKnowledgeBases: API.OperationMethod<GetProjectsKnowledgeBasesRequest, GetProjectsKnowledgeBasesResponse, GetProjectsKnowledgeBasesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsKnowledgeBasesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/knowledgeBases", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsKnowledgeBasesRequest>;

export type CreateProjectsKnowledgeBasesResponse = GoogleCloudDialogflowV2KnowledgeBase;
export const CreateProjectsKnowledgeBasesResponse = GoogleCloudDialogflowV2KnowledgeBase;

export type CreateProjectsKnowledgeBasesError = DefaultErrors;

export const createProjectsKnowledgeBases: API.OperationMethod<CreateProjectsKnowledgeBasesRequest, CreateProjectsKnowledgeBasesResponse, CreateProjectsKnowledgeBasesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsKnowledgeBasesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/knowledgeBases/{knowledgeBasesId}" }),
  svc,
...
export const deleteProjectsKnowledgeBases: API.OperationMethod<DeleteProjectsKnowledgeBasesRequest, DeleteProjectsKnowledgeBasesResponse, DeleteProjectsKnowledgeBasesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsKnowledgeBasesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/knowledgeBases/{knowledgeBasesId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsKnowledgeBasesRequest>;

export type PatchProjectsKnowledgeBasesResponse = GoogleCloudDialogflowV2KnowledgeBase;
export const PatchProjectsKnowledgeBasesResponse = GoogleCloudDialogflowV2KnowledgeBase;

export type PatchProjectsKnowledgeBasesError = DefaultErrors;

export const patchProjectsKnowledgeBases: API.OperationMethod<PatchProjectsKnowledgeBasesRequest, PatchProjectsKnowledgeBasesResponse, PatchProjectsKnowledgeBasesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsKnowledgeBasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/knowledgeBases/{knowledgeBasesId}/documents" }),
  svc,
) as unknown as Schema.Schema<ListProjectsKnowledgeBasesDocumentsRequest>;

export type ListProjectsKnowledgeBasesDocumentsResponse = GoogleCloudDialogflowV2ListDocumentsResponse;
export const ListProjectsKnowledgeBasesDocumentsResponse = GoogleCloudDialogflowV2ListDocumentsResponse;

export type ListProjectsKnowledgeBasesDocumentsError = DefaultErrors;

export const listProjectsKnowledgeBasesDocuments: API.PaginatedOperationMethod<ListProjectsKnowledgeBasesDocumentsRequest, ListProjectsKnowledgeBasesDocumentsResponse, ListProjectsKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsKnowledgeBasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2/projects/{projectsId}/knowledgeBases/{knowledgeBasesId}/documents/{documentsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsKnowledgeBasesDocumentsRequest>;

export type GetProjectsKnowledgeBasesDocumentsResponse = GoogleCloudDialogflowV2Document;
export const GetProjectsKnowledgeBasesDocumentsResponse = GoogleCloudDialogflowV2Document;

export type GetProjectsKnowledgeBasesDocumentsError = DefaultErrors;

export const getProjectsKnowledgeBasesDocuments: API.OperationMethod<GetProjectsKnowledgeBasesDocumentsRequest, GetProjectsKnowledgeBasesDocumentsResponse, GetProjectsKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsKnowledgeBasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/knowledgeBases/{knowledgeBasesId}/documents", hasBody: true }),
  svc,
...
export const createProjectsKnowledgeBasesDocuments: API.OperationMethod<CreateProjectsKnowledgeBasesDocumentsRequest, CreateProjectsKnowledgeBasesDocumentsResponse, CreateProjectsKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ImportProjectsKnowledgeBasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/knowledgeBases/{knowledgeBasesId}/documents:import", hasBody: true }),
  svc,
...
export const importProjectsKnowledgeBasesDocuments: API.OperationMethod<ImportProjectsKnowledgeBasesDocumentsRequest, ImportProjectsKnowledgeBasesDocumentsResponse, ImportProjectsKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsKnowledgeBasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2/projects/{projectsId}/knowledgeBases/{knowledgeBasesId}/documents/{documentsId}" }),
  svc,
...
export const deleteProjectsKnowledgeBasesDocuments: API.OperationMethod<DeleteProjectsKnowledgeBasesDocumentsRequest, DeleteProjectsKnowledgeBasesDocumentsResponse, DeleteProjectsKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsKnowledgeBasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2/projects/{projectsId}/knowledgeBases/{knowledgeBasesId}/documents/{documentsId}", hasBody: true }),
  svc,
...
export const patchProjectsKnowledgeBasesDocuments: API.OperationMethod<PatchProjectsKnowledgeBasesDocumentsRequest, PatchProjectsKnowledgeBasesDocumentsResponse, PatchProjectsKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ReloadProjectsKnowledgeBasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/knowledgeBases/{knowledgeBasesId}/documents/{documentsId}:reload", hasBody: true }),
  svc,
...
export const reloadProjectsKnowledgeBasesDocuments: API.OperationMethod<ReloadProjectsKnowledgeBasesDocumentsRequest, ReloadProjectsKnowledgeBasesDocumentsResponse, ReloadProjectsKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ExportProjectsKnowledgeBasesDocumentsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudDialogflowV2ExportDocumentRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/projects/{projectsId}/knowledgeBases/{knowledgeBasesId}/documents/{documentsId}:export", hasBody: true }),
  svc,
) as unknown as Schema.Schema<ExportProjectsKnowledgeBasesDocumentsRequest>;

export type ExportProjectsKnowledgeBasesDocumentsResponse = GoogleLongrunningOperation;
export const ExportProjectsKnowledgeBasesDocumentsResponse = GoogleLongrunningOperation;

export type ExportProjectsKnowledgeBasesDocumentsError = DefaultErrors;

export const exportProjectsKnowledgeBasesDocuments: API.OperationMethod<ExportProjectsKnowledgeBasesDocumentsRequest, ExportProjectsKnowledgeBasesDocumentsResponse, ExportProjectsKnowledgeBasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
