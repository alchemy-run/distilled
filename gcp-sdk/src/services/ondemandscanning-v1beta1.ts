...
export const AnalyzePackagesRequest: Schema.Schema<AnalyzePackagesRequest> = Schema.suspend(() => Schema.Struct({
  resourceUri: Schema.optional(Schema.String),
  packages: Schema.optional(Schema.Array(PackageData)),
})).annotate({ identifier: "AnalyzePackagesRequest" }) as any as Schema.Schema<AnalyzePackagesRequest>;
...
export const ListVulnerabilitiesResponse: Schema.Schema<ListVulnerabilitiesResponse> = Schema.suspend(() => Schema.Struct({
  occurrences: Schema.optional(Schema.Array(Occurrence)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "ListVulnerabilitiesResponse" }) as any as Schema.Schema<ListVulnerabilitiesResponse>;
...
export const WaitProjectsLocationsOperationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/operations/{operationsId}:wait", hasBody: true }),
  svc,
...
export const AnalyzePackagesProjectsLocationsScansRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/scans:analyzePackages", hasBody: true }),
  svc,
...
export const analyzePackagesProjectsLocationsScans: API.OperationMethod<AnalyzePackagesProjectsLocationsScansRequest, AnalyzePackagesProjectsLocationsScansResponse, AnalyzePackagesProjectsLocationsScansError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsScansVulnerabilitiesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/scans/{scansId}/vulnerabilities" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsScansVulnerabilitiesRequest>;

export type ListProjectsLocationsScansVulnerabilitiesResponse = ListVulnerabilitiesResponse;
export const ListProjectsLocationsScansVulnerabilitiesResponse = ListVulnerabilitiesResponse;

export type ListProjectsLocationsScansVulnerabilitiesError = DefaultErrors;

/** Lists vulnerabilities resulting from a successfully completed scan. */
export const listProjectsLocationsScansVulnerabilities: API.PaginatedOperationMethod<ListProjectsLocationsScansVulnerabilitiesRequest, ListProjectsLocationsScansVulnerabilitiesResponse, ListProjectsLocationsScansVulnerabilitiesError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
