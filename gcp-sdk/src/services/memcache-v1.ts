...
export const setTagsProjectsLocationsInstances: API.OperationMethod<SetTagsProjectsLocationsInstancesRequest, SetTagsProjectsLocationsInstancesResponse, SetTagsProjectsLocationsInstancesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const getTagsProjectsLocationsInstances: API.OperationMethod<GetTagsProjectsLocationsInstancesRequest, GetTagsProjectsLocationsInstancesResponse, GetTagsProjectsLocationsInstancesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
