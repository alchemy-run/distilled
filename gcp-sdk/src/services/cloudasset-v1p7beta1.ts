...
export const exportAssetsV1p7beta1: API.OperationMethod<ExportAssetsV1p7beta1Request, ExportAssetsV1p7beta1Response, ExportAssetsV1p7beta1Error, Credentials | HttpClient.HttpClient> = API.make(() => ({
