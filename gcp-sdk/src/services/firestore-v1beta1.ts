...
export interface GoogleFirestoreAdminV1beta1IndexField {
  ...
  fieldPath?: string;
  /** The field's mode. */
  mode?: "MODE_UNSPECIFIED" | "ASCENDING" | "DESCENDING" | "ARRAY_CONTAINS" | (string & {});
}

export const GoogleFirestoreAdminV1beta1IndexField: Schema.Schema<GoogleFirestoreAdminV1beta1IndexField> = Schema.suspend(() => Schema.Struct({
  fieldPath: Schema.optional(Schema.String),
  mode: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleFirestoreAdminV1beta1IndexField" }) as any as Schema.Schema<GoogleFirestoreAdminV1beta1IndexField>;
...
export const GoogleFirestoreAdminV1beta1Index: Schema.Schema<GoogleFirestoreAdminV1beta1Index> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  collectionId: Schema.optional(Schema.String),
  fields: Schema.optional(Schema.Array(GoogleFirestoreAdminV1beta1IndexField)),
  state: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleFirestoreAdminV1beta1Index" }) as any as Schema.Schema<GoogleFirestoreAdminV1beta1Index>;
...
export const GoogleFirestoreAdminV1beta1ListIndexesResponse: Schema.Schema<GoogleFirestoreAdminV1beta1ListIndexesResponse> = Schema.suspend(() => Schema.Struct({
  indexes: Schema.optional(Schema.Array(GoogleFirestoreAdminV1beta1Index)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleFirestoreAdminV1beta1ListIndexesResponse" }) as any as Schema.Schema<GoogleFirestoreAdminV1beta1ListIndexesResponse>;
...
export const GoogleFirestoreAdminV1beta1ExportDocumentsRequest: Schema.Schema<GoogleFirestoreAdminV1beta1ExportDocumentsRequest> = Schema.suspend(() => Schema.Struct({
  collectionIds: Schema.optional(Schema.Array(Schema.String)),
  outputUriPrefix: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleFirestoreAdminV1beta1ExportDocumentsRequest" }) as any as Schema.Schema<GoogleFirestoreAdminV1beta1ExportDocumentsRequest>;
...
export const GoogleFirestoreAdminV1beta1ImportDocumentsRequest: Schema.Schema<GoogleFirestoreAdminV1beta1ImportDocumentsRequest> = Schema.suspend(() => Schema.Struct({
  collectionIds: Schema.optional(Schema.Array(Schema.String)),
  inputUriPrefix: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleFirestoreAdminV1beta1ImportDocumentsRequest" }) as any as Schema.Schema<GoogleFirestoreAdminV1beta1ImportDocumentsRequest>;
...
export const GoogleFirestoreAdminV1beta1Progress: Schema.Schema<GoogleFirestoreAdminV1beta1Progress> = Schema.suspend(() => Schema.Struct({
  workCompleted: Schema.optional(Schema.String),
  workEstimated: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleFirestoreAdminV1beta1Progress" }) as any as Schema.Schema<GoogleFirestoreAdminV1beta1Progress>;
...
export interface GoogleFirestoreAdminV1beta1IndexOperationMetadata {
  ...
  operationType?: "OPERATION_TYPE_UNSPECIFIED" | "CREATING_INDEX" | (string & {});
...
export const GoogleFirestoreAdminV1beta1IndexOperationMetadata: Schema.Schema<GoogleFirestoreAdminV1beta1IndexOperationMetadata> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleFirestoreAdminV1beta1IndexOperationMetadata" }) as any as Schema.Schema<GoogleFirestoreAdminV1beta1IndexOperationMetadata>;

export interface GoogleFirestoreAdminV1beta1LocationMetadata {
}

export const GoogleFirestoreAdminV1beta1LocationMetadata: Schema.Schema<GoogleFirestoreAdminV1beta1LocationMetadata> = Schema.suspend(() => Schema.Struct({
})).annotate({ identifier: "GoogleFirestoreAdminV1beta1LocationMetadata" }) as any as Schema.Schema<GoogleFirestoreAdminV1beta1LocationMetadata>;
...
export interface GoogleFirestoreAdminV1beta1ExportDocumentsMetadata {
  ...
  operationState?: "STATE_UNSPECIFIED" | "INITIALIZING" | "PROCESSING" | "CANCELLING" | "FINALIZING" | "SUCCESSFUL" | "FAILED" | "CANCELLED" | (string & {});
...
export const GoogleFirestoreAdminV1beta1ExportDocumentsMetadata: Schema.Schema<GoogleFirestoreAdminV1beta1ExportDocumentsMetadata> = Schema.suspend(() => Schema.Struct({
  startTime: Schema.optional(Schema.String),
  endTime: Schema.optional(Schema.String),
  ...
  collectionIds: Schema.optional(Schema.Array(Schema.String)),
  outputUriPrefix: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleFirestoreAdminV1beta1ExportDocumentsMetadata" }) as any as Schema.Schema<GoogleFirestoreAdminV1beta1ExportDocumentsMetadata>;
...
export const GoogleFirestoreAdminV1beta1ImportDocumentsMetadata: Schema.Schema<GoogleFirestoreAdminV1beta1ImportDocumentsMetadata> = Schema.suspend(() => Schema.Struct({
  startTime: Schema.optional(Schema.String),
  endTime: Schema.optional(Schema.String),
  operationState: Schema.optional(Schema.String),
  progressDocuments: Schema.optional(GoogleFirestoreAdminV1beta1Progress),
  ...
  collectionIds: Schema.optional(Schema.Array(Schema.String)),
  inputUriPrefix: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleFirestoreAdminV1beta1ImportDocumentsMetadata" }) as any as Schema.Schema<GoogleFirestoreAdminV1beta1ImportDocumentsMetadata>;
...
export const GoogleFirestoreAdminV1beta1ExportDocumentsResponse: Schema.Schema<GoogleFirestoreAdminV1beta1ExportDocumentsResponse> = Schema.suspend(() => Schema.Struct({
  outputUriPrefix: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleFirestoreAdminV1beta1ExportDocumentsResponse" }) as any as Schema.Schema<GoogleFirestoreAdminV1beta1ExportDocumentsResponse>;
...
export const ExportDocumentsProjectsDatabasesRequest = Schema.Struct({
  ...
  body: Schema.optional(GoogleFirestoreAdminV1beta1ExportDocumentsRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/databases/{databasesId}:exportDocuments", hasBody: true }),
  svc,
...
export const ImportDocumentsProjectsDatabasesRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleFirestoreAdminV1beta1ImportDocumentsRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/databases/{databasesId}:importDocuments", hasBody: true }),
  svc,
...
export const CreateProjectsDatabasesIndexesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/indexes", hasBody: true }),
  svc,
...
export const CreateProjectsDatabasesIndexesResponse = GoogleLongrunningOperation;
...
export const createProjectsDatabasesIndexes: API.OperationMethod<CreateProjectsDatabasesIndexesRequest, CreateProjectsDatabasesIndexesResponse, CreateProjectsDatabasesIndexesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsDatabasesIndexesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/indexes" }),
  svc,
) as unknown as Schema.Schema<ListProjectsDatabasesIndexesRequest>;

export type ListProjectsDatabasesIndexesResponse = GoogleFirestoreAdminV1beta1ListIndexesResponse;
export const ListProjectsDatabasesIndexesResponse = GoogleFirestoreAdminV1beta1ListIndexesResponse;

export type ListProjectsDatabasesIndexesError = DefaultErrors;

/** Lists the indexes that match the specified filters. */
export const listProjectsDatabasesIndexes: API.PaginatedOperationMethod<ListProjectsDatabasesIndexesRequest, ListProjectsDatabasesIndexesResponse, ListProjectsDatabasesIndexesError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsDatabasesIndexesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/indexes/{indexesId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsDatabasesIndexesRequest>;

export type GetProjectsDatabasesIndexesResponse = GoogleFirestoreAdminV1beta1Index;
export const GetProjectsDatabasesIndexesResponse = GoogleFirestoreAdminV1beta1Index;

export type GetProjectsDatabasesIndexesError = DefaultErrors;

/** Gets an index. */
export const getProjectsDatabasesIndexes: API.OperationMethod<GetProjectsDatabasesIndexesRequest, GetProjectsDatabasesIndexesResponse, GetProjectsDatabasesIndexesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsDatabasesIndexesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/indexes/{indexesId}" }),
  svc,
...
/** Deletes an index. */
export const deleteProjectsDatabasesIndexes: API.OperationMethod<DeleteProjectsDatabasesIndexesRequest, DeleteProjectsDatabasesIndexesResponse, DeleteProjectsDatabasesIndexesError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const GetProjectsDatabasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/documents/{documentsId}/{documentsId1}" }),
  svc,
...
export const getProjectsDatabasesDocuments: API.OperationMethod<GetProjectsDatabasesDocumentsRequest, GetProjectsDatabasesDocumentsResponse, GetProjectsDatabasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsDatabasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/documents/{documentsId}/{documentsId1}/{collectionId}" }),
  svc,
...
/** Lists documents. */
export const listProjectsDatabasesDocuments: API.PaginatedOperationMethod<ListProjectsDatabasesDocumentsRequest, ListProjectsDatabasesDocumentsResponse, ListProjectsDatabasesDocumentsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const ListDocumentsProjectsDatabasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/documents/{collectionId}" }),
  svc,
...
/** Lists documents. */
export const listDocumentsProjectsDatabasesDocuments: API.PaginatedOperationMethod<ListDocumentsProjectsDatabasesDocumentsRequest, ListDocumentsProjectsDatabasesDocumentsResponse, ListDocumentsProjectsDatabasesDocumentsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const PatchProjectsDatabasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/documents/{documentsId}/{documentsId1}", hasBody: true }),
  svc,
...
export const patchProjectsDatabasesDocuments: API.OperationMethod<PatchProjectsDatabasesDocumentsRequest, PatchProjectsDatabasesDocumentsResponse, PatchProjectsDatabasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsDatabasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/documents/{documentsId}/{documentsId1}" }),
  svc,
...
/** Deletes a document. */
export const deleteProjectsDatabasesDocuments: API.OperationMethod<DeleteProjectsDatabasesDocumentsRequest, DeleteProjectsDatabasesDocumentsResponse, DeleteProjectsDatabasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const BatchGetProjectsDatabasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/documents:batchGet", hasBody: true }),
  svc,
...
export const batchGetProjectsDatabasesDocuments: API.OperationMethod<BatchGetProjectsDatabasesDocumentsRequest, BatchGetProjectsDatabasesDocumentsResponse, BatchGetProjectsDatabasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const BeginTransactionProjectsDatabasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/documents:beginTransaction", hasBody: true }),
  svc,
...
export const beginTransactionProjectsDatabasesDocuments: API.OperationMethod<BeginTransactionProjectsDatabasesDocumentsRequest, BeginTransactionProjectsDatabasesDocumentsResponse, BeginTransactionProjectsDatabasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CommitProjectsDatabasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/documents:commit", hasBody: true }),
  svc,
...
export const commitProjectsDatabasesDocuments: API.OperationMethod<CommitProjectsDatabasesDocumentsRequest, CommitProjectsDatabasesDocumentsResponse, CommitProjectsDatabasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const RollbackProjectsDatabasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/documents:rollback", hasBody: true }),
  svc,
...
export const rollbackProjectsDatabasesDocuments: API.OperationMethod<RollbackProjectsDatabasesDocumentsRequest, RollbackProjectsDatabasesDocumentsResponse, RollbackProjectsDatabasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const RunQueryProjectsDatabasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/documents/{documentsId}/{documentsId1}:runQuery", hasBody: true }),
  svc,
...
/** Runs a query. */
export const runQueryProjectsDatabasesDocuments: API.OperationMethod<RunQueryProjectsDatabasesDocumentsRequest, RunQueryProjectsDatabasesDocumentsResponse, RunQueryProjectsDatabasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ExecutePipelineProjectsDatabasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/documents:executePipeline", hasBody: true }),
  svc,
...
export const executePipelineProjectsDatabasesDocuments: API.OperationMethod<ExecutePipelineProjectsDatabasesDocumentsRequest, ExecutePipelineProjectsDatabasesDocumentsResponse, ExecutePipelineProjectsDatabasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const RunAggregationQueryProjectsDatabasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/documents/{documentsId}/{documentsId1}:runAggregationQuery", hasBody: true }),
  svc,
...
export const runAggregationQueryProjectsDatabasesDocuments: API.OperationMethod<RunAggregationQueryProjectsDatabasesDocumentsRequest, RunAggregationQueryProjectsDatabasesDocumentsResponse, RunAggregationQueryProjectsDatabasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const PartitionQueryProjectsDatabasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/documents/{documentsId}/{documentsId1}:partitionQuery", hasBody: true }),
  svc,
...
export const partitionQueryProjectsDatabasesDocuments: API.OperationMethod<PartitionQueryProjectsDatabasesDocumentsRequest, PartitionQueryProjectsDatabasesDocumentsResponse, PartitionQueryProjectsDatabasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const WriteProjectsDatabasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/documents:write", hasBody: true }),
  svc,
...
export const writeProjectsDatabasesDocuments: API.OperationMethod<WriteProjectsDatabasesDocumentsRequest, WriteProjectsDatabasesDocumentsResponse, WriteProjectsDatabasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListenProjectsDatabasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/documents:listen", hasBody: true }),
  svc,
...
export const listenProjectsDatabasesDocuments: API.OperationMethod<ListenProjectsDatabasesDocumentsRequest, ListenProjectsDatabasesDocumentsResponse, ListenProjectsDatabasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const ListCollectionIdsProjectsDatabasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/documents/{documentsId}/{documentsId1}:listCollectionIds", hasBody: true }),
  svc,
...
export const listCollectionIdsProjectsDatabasesDocuments: API.OperationMethod<ListCollectionIdsProjectsDatabasesDocumentsRequest, ListCollectionIdsProjectsDatabasesDocumentsResponse, ListCollectionIdsProjectsDatabasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const BatchWriteProjectsDatabasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/documents:batchWrite", hasBody: true }),
  svc,
...
export const batchWriteProjectsDatabasesDocuments: API.OperationMethod<BatchWriteProjectsDatabasesDocumentsRequest, BatchWriteProjectsDatabasesDocumentsResponse, BatchWriteProjectsDatabasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateDocumentProjectsDatabasesDocumentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/databases/{databasesId}/documents/{documentsId}/{collectionId}", hasBody: true }),
  svc,
...
export const createDocumentProjectsDatabasesDocuments: API.OperationMethod<CreateDocumentProjectsDatabasesDocumentsRequest, CreateDocumentProjectsDatabasesDocumentsResponse, CreateDocumentProjectsDatabasesDocumentsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
