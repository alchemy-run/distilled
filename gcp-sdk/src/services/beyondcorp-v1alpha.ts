...
export interface GoogleCloudBeyondcorpSaasplatformSubscriptionsV1alphaSubscription {
  ...
  subscriberType?: "SUBSCRIBER_TYPE_UNSPECIFIED" | "ONLINE" | "OFFLINE" | "CEP_TRIAL" | (string & {});
...
export const GoogleCloudBeyondcorpSecuritygatewaysV1alphaLoggingConfig: Schema.Schema<GoogleCloudBeyondcorpSecuritygatewaysV1alphaLoggingConfig> = Schema.suspend(() => Schema.Struct({
})).annotate({ identifier: "GoogleCloudBeyondcorpSecuritygatewaysV1alphaLoggingConfig" }) as any as Schema.Schema<GoogleCloudBeyondcorpSecuritygatewaysV1alphaLoggingConfig>;
...
export const GoogleCloudBeyondcorpSecuritygatewaysV1alphaSecurityGateway: Schema.Schema<GoogleCloudBeyondcorpSecuritygatewaysV1alphaSecurityGateway> = Schema.suspend(() => Schema.Struct({
  ...
  logging: Schema.optional(GoogleCloudBeyondcorpSecuritygatewaysV1alphaLoggingConfig),
...
export const getOrganizationsLocationsInsights: API.OperationMethod<GetOrganizationsLocationsInsightsRequest, GetOrganizationsLocationsInsightsResponse, GetOrganizationsLocationsInsightsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listOrganizationsLocationsInsights: API.PaginatedOperationMethod<ListOrganizationsLocationsInsightsRequest, ListOrganizationsLocationsInsightsResponse, ListOrganizationsLocationsInsightsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export type ConfiguredInsightOrganizationsLocationsInsightsError = DefaultErrors;
...
export const configuredInsightOrganizationsLocationsInsights: API.PaginatedOperationMethod<ConfiguredInsightOrganizationsLocationsInsightsRequest, ConfiguredInsightOrganizationsLocationsInsightsResponse, ConfiguredInsightOrganizationsLocationsInsightsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const listOrganizationsLocationsSubscriptions: API.PaginatedOperationMethod<ListOrganizationsLocationsSubscriptionsRequest, ListOrganizationsLocationsSubscriptionsResponse, ListOrganizationsLocationsSubscriptionsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const createOrganizationsLocationsSubscriptions: API.OperationMethod<CreateOrganizationsLocationsSubscriptionsRequest, CreateOrganizationsLocationsSubscriptionsResponse, CreateOrganizationsLocationsSubscriptionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const getOrganizationsLocationsSubscriptions: API.OperationMethod<GetOrganizationsLocationsSubscriptionsRequest, GetOrganizationsLocationsSubscriptionsResponse, GetOrganizationsLocationsSubscriptionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const restartOrganizationsLocationsSubscriptions: API.OperationMethod<RestartOrganizationsLocationsSubscriptionsRequest, RestartOrganizationsLocationsSubscriptionsResponse, RestartOrganizationsLocationsSubscriptionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const patchOrganizationsLocationsSubscriptions: API.OperationMethod<PatchOrganizationsLocationsSubscriptionsRequest, PatchOrganizationsLocationsSubscriptionsResponse, PatchOrganizationsLocationsSubscriptionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const cancelOrganizationsLocationsSubscriptions: API.OperationMethod<CancelOrganizationsLocationsSubscriptionsRequest, CancelOrganizationsLocationsSubscriptionsResponse, CancelOrganizationsLocationsSubscriptionsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
/** Gets the value for a selected particular insight with default configuration. The default aggregation level is 'DAILY' and no grouping will be applied or default grouping if applicable. The data will be returned for recent 7 days starting the day before. The insight data size will be limited to 50 rows. Use the organization level path for fetching at org level and project level path for fetching the insight value specific to a particular project. Setting the `view` to `BASIC` will only return the metadata for the insight. */
export const getProjectsLocationsInsights: API.OperationMethod<GetProjectsLocationsInsightsRequest, GetProjectsLocationsInsightsResponse, GetProjectsLocationsInsightsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
/** Gets the value for a selected particular insight based on the provided filters. Use the organization level path for fetching at org level and project level path for fetching the insight value specific to a particular project. */
export const configuredInsightProjectsLocationsInsights: API.PaginatedOperationMethod<ConfiguredInsightProjectsLocationsInsightsRequest, ConfiguredInsightProjectsLocationsInsightsResponse, ConfiguredInsightProjectsLocationsInsightsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
/** Lists for all the available insights that could be fetched from the system. Allows to filter using category. Setting the `view` to `BASIC` will let you iterate over the list of insight metadatas. */
export const listProjectsLocationsInsights: API.PaginatedOperationMethod<ListProjectsLocationsInsightsRequest, ListProjectsLocationsInsightsResponse, ListProjectsLocationsInsightsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const getProjectsLocationsConnectors: API.OperationMethod<GetProjectsLocationsConnectorsRequest, GetProjectsLocationsConnectorsResponse, GetProjectsLocationsConnectorsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const patchProjectsLocationsConnectors: API.OperationMethod<PatchProjectsLocationsConnectorsRequest, PatchProjectsLocationsConnectorsResponse, PatchProjectsLocationsConnectorsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export type ResolveInstanceConfigProjectsLocationsConnectorsError = DefaultErrors;

/** Gets instance configuration for a given connector. An internal method called by a connector to get its container config. */
export const resolveInstanceConfigProjectsLocationsConnectors: API.OperationMethod<ResolveInstanceConfigProjectsLocationsConnectorsRequest, ResolveInstanceConfigProjectsLocationsConnectorsResponse, ResolveInstanceConfigProjectsLocationsConnectorsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const listProjectsLocationsConnectors: API.PaginatedOperationMethod<ListProjectsLocationsConnectorsRequest, ListProjectsLocationsConnectorsResponse, ListProjectsLocationsConnectorsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const createProjectsLocationsConnectors: API.OperationMethod<CreateProjectsLocationsConnectorsRequest, CreateProjectsLocationsConnectorsResponse, CreateProjectsLocationsConnectorsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
/** Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. */
export const getIamPolicyProjectsLocationsConnectors: API.OperationMethod<GetIamPolicyProjectsLocationsConnectorsRequest, GetIamPolicyProjectsLocationsConnectorsResponse, GetIamPolicyProjectsLocationsConnectorsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
/** Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors. */
export const setIamPolicyProjectsLocationsConnectors: API.OperationMethod<SetIamPolicyProjectsLocationsConnectorsRequest, SetIamPolicyProjectsLocationsConnectorsResponse, SetIamPolicyProjectsLocationsConnectorsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
/** Report status for a given connector. */
export const reportStatusProjectsLocationsConnectors: API.OperationMethod<ReportStatusProjectsLocationsConnectorsRequest, ReportStatusProjectsLocationsConnectorsResponse, ReportStatusProjectsLocationsConnectorsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const deleteProjectsLocationsConnectors: API.OperationMethod<DeleteProjectsLocationsConnectorsRequest, DeleteProjectsLocationsConnectorsResponse, DeleteProjectsLocationsConnectorsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export type SetIamPolicyProjectsLocationsApplicationDomainsError = DefaultErrors;

/** Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors. */
export const setIamPolicyProjectsLocationsApplicationDomains: API.OperationMethod<SetIamPolicyProjectsLocationsApplicationDomainsRequest, SetIamPolicyProjectsLocationsApplicationDomainsResponse, SetIamPolicyProjectsLocationsApplicationDomainsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export type GetIamPolicyProjectsLocationsApplicationDomainsError = DefaultErrors;

/** Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. */
export const getIamPolicyProjectsLocationsApplicationDomains: API.OperationMethod<GetIamPolicyProjectsLocationsApplicationDomainsRequest, GetIamPolicyProjectsLocationsApplicationDomainsResponse, GetIamPolicyProjectsLocationsApplicationDomainsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export type TestIamPermissionsProjectsLocationsApplicationDomainsError = DefaultErrors;
...
export const resolveProjectsLocationsConnections: API.PaginatedOperationMethod<ResolveProjectsLocationsConnectionsRequest, ResolveProjectsLocationsConnectionsResponse, ResolveProjectsLocationsConnectionsError, Credentials | HttpClient.HttpClient> = API.makePaginated(() => ({
