...
export const computeScope3FlightEmissionsFlights: API.OperationMethod<ComputeScope3FlightEmissionsFlightsRequest, ComputeScope3FlightEmissionsFlightsResponse, ComputeScope3FlightEmissionsFlightsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const computeFlightEmissionsFlights: API.OperationMethod<ComputeFlightEmissionsFlightsRequest, ComputeFlightEmissionsFlightsResponse, ComputeFlightEmissionsFlightsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const computeTypicalFlightEmissionsFlights: API.OperationMethod<ComputeTypicalFlightEmissionsFlightsRequest, ComputeTypicalFlightEmissionsFlightsResponse, ComputeTypicalFlightEmissionsFlightsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
