...
/** Inserts a new item. */
export const insertItems: API.OperationMethod<InsertItemsRequest, InsertItemsResponse, InsertItemsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const getItems: API.OperationMethod<GetItemsRequest, GetItemsResponse, GetItemsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
/** Publishes an item. */
export const publishItems: API.OperationMethod<PublishItemsRequest, PublishItemsResponse, PublishItemsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
...
export const updateItems: API.OperationMethod<UpdateItemsRequest, UpdateItemsResponse, UpdateItemsError, Credentials | HttpClient.HttpClient> = API.make(() => ({
