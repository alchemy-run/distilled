...
}).pipe(T.Http({ method: "GET", path: "/projects/{project_id}/branches/{branch_id}/data-api/{database_name}" }));
export type GetProjectBranchDataAPIInput = typeof GetProjectBranchDataAPIInput.Type;
...
export const GetProjectBranchDataAPIOutput = Schema.Struct({
  ...
  available_schemas: Schema.optional(Schema.NullOr(Schema.Array(Schema.String))),
});
export type GetProjectBranchDataAPIOutput = typeof GetProjectBranchDataAPIOutput.Type;
