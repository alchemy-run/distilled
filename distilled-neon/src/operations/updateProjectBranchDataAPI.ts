...
}).pipe(T.Http({ method: "PATCH", path: "/projects/{project_id}/branches/{branch_id}/data-api/{database_name}" }));
export type UpdateProjectBranchDataAPIInput = typeof UpdateProjectBranchDataAPIInput.Type;

// Output Schema
export const UpdateProjectBranchDataAPIOutput = Schema.Struct({

});
export type UpdateProjectBranchDataAPIOutput = typeof UpdateProjectBranchDataAPIOutput.Type;
