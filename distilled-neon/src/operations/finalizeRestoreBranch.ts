...
}).pipe(T.Http({ method: "POST", path: "/projects/{project_id}/branches/{branch_id}/finalize_restore" }));
...
export type FinalizeRestoreBranchOutput = typeof FinalizeRestoreBranchOutput.Type;
