...
import { TypesenseProtocol, type TypesenseOpError, type TypesenseOpContext } from "../protocol.ts";
...
export const CreateAnalyticsRuleRequestBody = /*@__PURE__*/ S.Unknown.pipe(
  T.UnionCases([["name", "type", "collection", "event_type", "rule_tag", "params"], []]),
);
...
export const CreateAnalyticsRuleResponseBodyCase1ItemCase1 = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const CreateAnalyticsRuleResponseBodyCase1Item = /*@__PURE__*/ S.Unknown.pipe(
  T.UnionCases([["name", "type", "collection", "event_type", "rule_tag", "params"], ["error"]]),
);
...
export const CreateCollectionResponseTokenSeparatorsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateNLSearchModelRequestStopSequencesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateNLSearchModelResponseStopSequencesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const DeleteAnalyticsRuleRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "DELETE", uri: "/analytics/rules/{ruleName}", code: 200 })),
).annotate({
...
export const DeleteAnalyticsRuleResponseParamsMetaFieldsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const DeleteCollectionResponseTokenSeparatorsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const DeleteDocumentsRequestDeleteDocumentsParameters = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    filter_by: S.String,
...
export const DeleteNLSearchModelRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    modelId: S.String.pipe(T.Label()),
  }).pipe(T.Http({ method: "DELETE", uri: "/nl_search_models/{modelId}", code: 200 })),
).annotate({
...
export const ExportDocumentsRequestExportDocumentsParameters = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const GetAllConversationModelsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}).pipe(T.Http({ method: "GET", uri: "/conversations/models", code: 200 })),
).annotate({
...
export const GetAllNLSearchModelsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}).pipe(T.Http({ method: "GET", uri: "/nl_search_models", code: 200 })),
).annotate({
...
export const AnalyticsEventsResponseEventsItemDocIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetAnalyticsStatusRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}).pipe(T.Http({ method: "GET", uri: "/analytics/status", code: 200 })),
).annotate({
...
export const GetCollectionsRequestGetCollectionsParameters = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    exclude_fields: S.optional(S.String),
    limit: S.optional(S.Number),
    offset: S.optional(S.Number),
...
export const GetSynonymSetItemResponseSymbolsToIndexList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ImportDocumentsRequestImportDocumentsParameters = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    batch_size: S.optional(S.Number),
...
export const ImportStemmingDictionaryRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "POST", uri: "/stemming/dictionaries/import", code: 200 })),
).annotate({
...
export const ListStemmingDictionariesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}).pipe(T.Http({ method: "GET", uri: "/stemming/dictionaries", code: 200 })),
).annotate({
...
export const ListStemmingDictionariesResponseDictionariesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const MultiSearchResultItemUnionRequestParamsList = /*@__PURE__*/ S.Array(
  SearchRequestParams,
...
export const UpdateDocumentsRequestUpdateDocumentsParameters = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    filter_by: S.optional(S.String),
  }),
).annotate({
...
export const UpdateNLSearchModelRequestStopSequencesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateNLSearchModelRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    account_id: S.optional(S.String),
    id: S.optional(S.String),
  }).pipe(T.Http({ method: "PUT", uri: "/nl_search_models/{modelId}", code: 200 })),
).annotate({
...
export const UpdateNLSearchModelResponseStopSequencesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpsertAnalyticsRuleRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "PUT", uri: "/analytics/rules/{ruleName}", code: 200 })),
).annotate({
...
export const UpsertAnalyticsRuleResponseParamsMetaFieldsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpsertSynonymSetItemRequestSymbolsToIndexList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpsertSynonymSetItemResponseSymbolsToIndexList = /*@__PURE__*/ S.Array(
  S.String,
...
export const VoteRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}).pipe(T.Http({ method: "POST", uri: "/operations/vote", code: 200 })),
...
export const vote: API.OperationMethod<VoteRequest, SuccessStatus, VoteError, TypesenseOpContext> =
  /*@__PURE__*/ API.make(() => ({
    input: VoteRequest,
    output: SuccessStatus,
    errors: [],
