...
import { InngestProtocol, type InngestOpError, type InngestOpContext } from "../protocol.ts";
...
export type V2ExperimentDetailVariantWeightsList = Array<V2ExperimentVariantWeight>;
...
export type V2ExperimentVariantMetricsMetricsList = Array<V2ExperimentVariantMetric>;
...
export type V2FunctionConfigurationCancellationsList = Array<V2FunctionCancellationConfiguration>;
...
export type V2FunctionConcurrencyScope = "UNSPECIFIED" | "ACCOUNT" | "ENVIRONMENT" | "FUNCTION";
...
export type V2FunctionConfigurationConcurrencyList = Array<V2FunctionConcurrencyConfiguration>;
...
export const ListV2InsightsEventSchemasRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    cursor: S.optional(S.String.pipe(T.Query())),
    limit: S.optional(S.Number.pipe(T.Query())),
  }).pipe(T.Http({ method: "GET", uri: "/insights/events/schemas", code: 200 })),
).annotate({
...
export const ListV2InsightsTablesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}).pipe(T.Http({ method: "GET", uri: "/insights/tables", code: 200 })),
).annotate({
...
export type V2InsightsDiagnosticSeverity = "SEVERITY_UNSPECIFIED" | "ERROR" | "WARNING" | "INFO";
...
export const V2StreamSandboxLogsRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "GET", uri: "/sandboxes/{sandboxId}/logs", code: 200 })),
).annotate({
...
export type CreateV2EnvError = BadRequest | Forbidden | Conflict | InngestOpError;
...
export type CreateV2PartnerAccountError = BadRequest | Forbidden | Conflict | InngestOpError;
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [BadRequest, Forbidden, Conflict, UnprocessableEntity, UnknownInngestError],
  protocol: InngestProtocol,
  retry: Retry.Retry,
}));
...
export type FetchV2AccountEventKeysError = BadRequest | Forbidden | NotFound | InngestOpError;
...
export type FetchV2AccountSigningKeysError = BadRequest | Forbidden | NotFound | InngestOpError;
...
export type FetchV2PartnerAccountsError = BadRequest | Forbidden | InngestOpError;
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [BadRequest, Forbidden, NotFound, Conflict, UnprocessableEntity, UnknownInngestError],
  protocol: InngestProtocol,
  retry: Retry.Retry,
}));
...
export type ListV2InsightsEventSchemasError = BadRequest | Forbidden | InngestOpError;
