...
export type DaytonaConfigurationSshGatewayHostKeyFingerprintsList = Array<string>;
export const DaytonaConfigurationSshGatewayHostKeyFingerprintsList = /*@__PURE__*/ S.Array(
  S.String,
