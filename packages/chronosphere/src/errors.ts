/**
 * Chronosphere-specific error types.
 *
 * Re-exports the common HTTP errors from core and adds the Chronosphere
...
export class ChronosphereParseError extends Schema.TaggedError<ChronosphereParseError>()(
