 ...
 */
export type ForgejoOpError = DefaultErrors | ConfigError | HttpClientError.HttpClientError;
...
export const ForgejoProtocol: Layer.Layer<API.Protocol> = makeRestProtocol<Config>({
