...
export const PostInvoicesInvoiceAttachPaymentInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    payment_record: Schema.optional(Schema.String),
  }).pipe(
    T.Http({
      method: "POST",
...
export type PostInvoicesInvoiceAttachPaymentInput =
  typeof PostInvoicesInvoiceAttachPaymentInput.Type;
...
export type PostInvoicesInvoiceAttachPaymentOutput =
  typeof PostInvoicesInvoiceAttachPaymentOutput.Type;
