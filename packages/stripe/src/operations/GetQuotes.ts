...
export const GetQuotesInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  status: Schema.optional(
    Schema.Literals(["accepted", "canceled", "draft", "open"]),
  ),
  test_clock: Schema.optional(Schema.String),
}).pipe(
  T.Http({ method: "GET", path: "/v1/quotes", contentType: "form-urlencoded" }),
);
...
export type GetQuotesOutput = typeof GetQuotesOutput.Type;
 ...
 * @param customer_account - The ID of the account representing the customer whose quotes you're retrieving.
