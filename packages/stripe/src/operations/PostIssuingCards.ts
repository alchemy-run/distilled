...
// Input Schema
export const PostIssuingCardsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  replacement_for: Schema.optional(Schema.String),
  replacement_reason: Schema.optional(
    Schema.Literals(["damaged", "expired", "lost", "stolen"]),
  ),
  second_line: Schema.optional(Schema.Unknown),
...
export type PostIssuingCardsInput = typeof PostIssuingCardsInput.Type;

// Output Schema
export const PostIssuingCardsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
    brand: Schema.String,
...
export type PostIssuingCardsOutput = typeof PostIssuingCardsOutput.Type;
 ...
 */
export const PostIssuingCards = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: PostIssuingCardsInput,
  outputSchema: PostIssuingCardsOutput,
}));
