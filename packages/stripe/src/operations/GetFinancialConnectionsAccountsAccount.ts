...
export type GetFinancialConnectionsAccountsAccountInput =
  typeof GetFinancialConnectionsAccountsAccountInput.Type;
...
export type GetFinancialConnectionsAccountsAccountOutput =
  typeof GetFinancialConnectionsAccountsAccountOutput.Type;
