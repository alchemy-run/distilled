...
export const PostV2CoreAccountsAccountIdPersonsInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "POST", path: "/v2/core/accounts/{account_id}/persons" }),
  );
export type PostV2CoreAccountsAccountIdPersonsInput =
  typeof PostV2CoreAccountsAccountIdPersonsInput.Type;
...
export type PostV2CoreAccountsAccountIdPersonsOutput =
  typeof PostV2CoreAccountsAccountIdPersonsOutput.Type;
