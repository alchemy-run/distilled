...
export class ContainerApplicationNotFound
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<ContainerApplicationNotFound>()("ContainerApplicationNotFound", {
      code: S.Number,
      message: S.String,
    }),
    [
...
export class DurableObjectCheckError
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<DurableObjectCheckError>()("DurableObjectCheckError", {
      code: S.Number,
      message: S.String,
    }),
    [
...
export const CreateContainerApplicationRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    configuration: ContainerConfiguration,
    durableObjects: S.optional(DurableObjectsRef.pipe(T.Body("durable_objects"))),
...
export const CreateContainerApplicationRolloutRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    targetConfiguration: S.optional(ContainerConfiguration.pipe(T.Body("target_configuration"))),
  }).pipe(
    T.Http({
      method: "POST",
...
export type CreateContainerApplicationRolloutResponse = ContainerApplicationItem;
export const CreateContainerApplicationRolloutResponse = /*@__PURE__*/ S.suspend(() =>
  ContainerApplicationItem.pipe(T.EnvelopePayloadRoot()),
).annotate({
...
export const CreateContainerRegistryCredentialsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    accountId: S.String.pipe(T.Label("account_id")),
...
export type CreateContainerRegistryCredentialsResponse = CreateContainerRegistryCredentialsResult;
export const CreateContainerRegistryCredentialsResponse = /*@__PURE__*/ S.suspend(() =>
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [InvalidRoute, ContainerApplicationNotFound, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));

export type CreateContainerRegistryCredentialsError = InvalidRoute | CloudflareOpError;
