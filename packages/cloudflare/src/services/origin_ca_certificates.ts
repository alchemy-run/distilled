...
export class CertificateAlreadyRevoked
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<CertificateAlreadyRevoked>()("CertificateAlreadyRevoked", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 1014 }],
...
export class CertificateRevocationFailed
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<CertificateRevocationFailed>()("CertificateRevocationFailed", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 1000 }],
...
export class HostnameNotAuthorized
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<HostnameNotAuthorized>()("HostnameNotAuthorized", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 1010 }],
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [HostnameNotAuthorized, Forbidden, CloudflareRateLimited, CloudflareError],
