...
export class SnippetNotFound
  extends /*@__PURE__*/ T.applyErrorMatchers(
    ...
    [{ status: 400, message: { includes: "snippet not found" } }, { status: 404 }],
  ) {}

export class SnippetRulesNotFound
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<SnippetRulesNotFound>()("SnippetRulesNotFound", {
      code: S.Number,
      message: S.String,
    }),
    [{ status: 404 }],
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [SnippetNotFound, SnippetInUse, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [SnippetRulesNotFound, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
