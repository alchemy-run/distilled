...
export class OrganizationNotFound
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<OrganizationNotFound>()("OrganizationNotFound", {
      code: S.Number,
      message: S.String,
    }),
    [{ status: 404 }],
...
export type CreateMemberResponseStatus = "active" | "pending" | "rejected" | "canceled";
...
export const CreateResponseMeta = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    hierarchyTags: S.optional(
      S.NullOr(CreateResponseMetaHierarchyTagsList).pipe(T.Body("hierarchy_tags")),
    ),
...
export const BillingUsageGetResultItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    chargeClass: S.optional(
      S.NullOr(BillingUsageGetResultItemChargeClass).pipe(T.Body("ChargeClass")),
    ),
    contractedCost: S.optional(S.NullOr(S.Number).pipe(T.Body("ContractedCost"))),
    contractedUnitPrice: S.optional(S.NullOr(S.Number).pipe(T.Body("ContractedUnitPrice"))),
    ...
    pricingQuantity: S.optional(S.NullOr(S.Number).pipe(T.Body("PricingQuantity"))),
...
export type GetMemberResponseStatus = "active" | "pending" | "rejected" | "canceled";
...
export const GetOrganizationAccountRequestAccountPubname = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const GetOrganizationAccountRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    direction: S.optional(GetOrganizationAccountRequestDirection.pipe(T.Query())),
    includeTags: S.optional(S.Boolean.pipe(T.Query("include_tags"))),
    includeTotal: S.optional(S.Boolean.pipe(T.Query("include_total"))),
    name: S.optional(GetOrganizationAccountRequestName.pipe(T.DeepQuery("name"))),
    orderBy: S.optional(GetOrganizationAccountRequestOrderBy.pipe(T.Query("order_by"))),
...
export type GetOrganizationAccountResultList = Array<GetOrganizationAccountResultItem>;
...
export const GetOrganizationAccountResponse = /*@__PURE__*/ S.suspend(() =>
  GetOrganizationAccountResultList.pipe(T.EnvelopePayloadRoot(), T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export type LogsAuditListRequestActorTypeNotItem = "cloudflare_admin" | "system" | "user";
...
export type LogsAuditListResultItemActorType = "cloudflare_admin" | "system" | "user";
...
export type ListMembersRequestStatusList = Array<ListMembersRequestStatus | (string & {})>;
...
export type ListMembersResultItemStatus = "active" | "pending" | "rejected" | "canceled";
...
export const ListOrganizationsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    containing: S.optional(ListRequestContaining.pipe(T.DeepQuery("containing"))),
...
export const ListResultItemMeta = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    hierarchyTags: S.optional(
      S.NullOr(ListResultItemMetaHierarchyTagsList).pipe(T.Body("hierarchy_tags")),
    ),
    managedBy: S.optional(S.NullOr(S.String).pipe(T.Body("managed_by"))),
    tenantFlags: S.optional(S.NullOr(CreateResponseMetaTenantFlags).pipe(T.Body("tenant_flags"))),
  }),
...
export type LogsAuditHistoryResultItemActorType = "cloudflare_admin" | "system" | "user";
...
export type LogsAuditHistoryResultItemOrganization = LogsAuditListResultItemOrganization;
export const LogsAuditHistoryResultItemOrganization = LogsAuditListResultItemOrganization;
...
export const UpdateResponseMeta = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    hierarchyTags: S.optional(
      S.NullOr(UpdateResponseMetaHierarchyTagsList).pipe(T.Body("hierarchy_tags")),
    ),
    managedBy: S.optional(S.NullOr(S.String).pipe(T.Body("managed_by"))),
    tenantFlags: S.optional(S.NullOr(CreateResponseMetaTenantFlags).pipe(T.Body("tenant_flags"))),
  }),
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [OrganizationNotFound, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
...
export type GetOrganizationError = OrganizationNotFound | Forbidden | CloudflareOpError;
...
export type GetOrganizationProfileError = OrganizationNotFound | Forbidden | CloudflareOpError;
...
export type PutOrganizationProfileError = OrganizationNotFound | Forbidden | CloudflareOpError;
