...
export class NonexistentAccountPrefix
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<NonexistentAccountPrefix>()("NonexistentAccountPrefix", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 1003 }],
...
export class RegionalHostnameEmpty
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<RegionalHostnameEmpty>()("RegionalHostnameEmpty", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 1000, message: { includes: "not_found" } }],
...
export class RegionalHostnameNotFound
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<RegionalHostnameNotFound>()("RegionalHostnameNotFound", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 1002, message: { includes: "forbidden" } }],
...
export const PrefixesBgpPrefixesCreateResponseBgpSignalOpts = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    enabled: S.optional(S.NullOr(S.Boolean)),
    modifiedAt: S.optional(S.NullOr(S.String).pipe(T.Body("modified_at"))),
  }),
...
export const PrefixesBgpPrefixesCreateResponseOnDemand = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    advertised: S.optional(S.NullOr(S.Boolean)),
    advertisedModifiedAt: S.optional(S.NullOr(S.String).pipe(T.Body("advertised_modified_at"))),
    onDemandEnabled: S.optional(S.NullOr(S.Boolean).pipe(T.Body("on_demand_enabled"))),
...
export const CreatePrefixBgpPrefixResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    bgpSignalOpts: S.optional(
      S.NullOr(PrefixesBgpPrefixesCreateResponseBgpSignalOpts).pipe(T.Body("bgp_signal_opts")),
    ),
    cidr: S.optional(S.NullOr(S.String)),
    createdAt: S.optional(S.NullOr(S.String).pipe(T.Body("created_at"))),
    modifiedAt: S.optional(S.NullOr(S.String).pipe(T.Body("modified_at"))),
    onDemand: S.optional(
      S.NullOr(PrefixesBgpPrefixesCreateResponseOnDemand).pipe(T.Body("on_demand")),
    ),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export const PrefixesServiceBindingsCreateResponseProvisioning = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const PrefixesServiceBindingsGetResponseProvisioning = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const PrefixesServiceBindingsListResultItemProvisioning = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [FeatureNotEnabled, InvalidAccountId, Forbidden, CloudflareRateLimited, CloudflareError],
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [InvalidAccountId, InvalidLoaForm, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [DelegationNotFound, InvalidAccountId, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [AddressMapNotFound, InvalidAccountId, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [LoaDocumentNotFound, InvalidAccountId, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [PrefixNotFound, InvalidAccountId, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
