...
export class HyperdriveOriginUnavailable
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<HyperdriveOriginUnavailable>()("HyperdriveOriginUnavailable", {
      code: S.Number,
      message: S.String,
    }),
    [
...
export class InvalidHyperdriveConfig
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<InvalidHyperdriveConfig>()("InvalidHyperdriveConfig", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 2007 }],
...
export class PrivateHostNotAllowed
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<PrivateHostNotAllowed>()("PrivateHostNotAllowed", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 2009 }],
...
export const ConfigsCreateResponseOriginPublicDatabase = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    database: S.String,
    host: S.String,
    port: S.Number,
...
export const ConfigsCreateResponseOrigin = /*@__PURE__*/ S.Unknown.pipe(
  T.UnionCases([
    ...
    ["accessClientId", "accessClientSecret", "database", "host", "scheme", "user"],
...
export const ConfigsGetResponseOriginDatabaseReachableThroughAWorkersVPC = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      database: S.String,
      scheme: ConfigsGetResponseOriginDatabaseReachableThroughAWorkersVPCScheme,
...
export const ConfigsListResultItemOriginPublicDatabase = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    database: S.String,
    host: S.String,
    port: S.Number,
...
export const ConfigsEditRequestOriginHyperdriveHyperdriveDatabase = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const ConfigsEditRequestOriginHyperdriveInternetOrigin = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    host: S.String,
    port: S.Number,
  }),
...
export const ConfigsEditRequestOriginHyperdriveOverAccessOrigin = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    accessClientId: S.String.pipe(T.Body("access_client_id")),
    accessClientSecret: S.String.pipe(T.Body("access_client_secret")),
    host: S.String,
...
export const ConfigsEditRequestOriginHyperdriveVPCServiceOrigin = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    serviceId: S.String.pipe(T.Body("service_id")),
  }),
).annotate({
...
export const ConfigsEditResponseOriginDatabaseReachableThroughAWorkersVPC = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      database: S.String,
      scheme: ConfigsEditResponseOriginDatabaseReachableThroughAWorkersVPCScheme,
...
export const ConfigsUpdateResponseOriginPublicDatabase = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    database: S.String,
    host: S.String,
    port: S.Number,
