...
export class CustomTrustStoreNotFound
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<CustomTrustStoreNotFound>()("CustomTrustStoreNotFound", {
      code: S.Number,
      message: S.String,
    }),
    [{ status: 404 }],
...
export class PreviousJobInProgress
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<PreviousJobInProgress>()("PreviousJobInProgress", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 1482 }],
...
export const GetTotalTlResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    certificateAuthority: S.optional(
      S.NullOr(TotalTlsGetResponseCertificateAuthority).pipe(T.Body("certificate_authority")),
    ),
...
export const UpdateTotalTlResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    certificateAuthority: S.optional(
      S.NullOr(TotalTlsEditResponseCertificateAuthority).pipe(T.Body("certificate_authority")),
    ),
    enabled: S.optional(S.NullOr(S.Boolean)),
    validityPeriod: S.optional(
...
export const UpdateTotalTlsResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    certificateAuthority: S.optional(
      S.NullOr(UpdateTotalTlsResponseCertificateAuthority).pipe(T.Body("certificate_authority")),
    ),
    enabled: S.optional(S.NullOr(S.Boolean)),
    validityPeriod: S.optional(
