...
export class SendingSubdomainAlreadyExists
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<SendingSubdomainAlreadyExists>()("SendingSubdomainAlreadyExists", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 2040 }],
...
export class SendingSubdomainNotFound
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<SendingSubdomainNotFound>()("SendingSubdomainNotFound", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 2033 }],
...
export type ImportSuppressionRequestItemsList = Array<ImportSuppressionRequestItemsItem>;
...
export type ImportSuppressionResponseItemsList = Array<ImportSuppressionResponseItemsItem>;
...
export type CreateSubdomainError = Forbidden | SendingSubdomainAlreadyExists | CloudflareOpError;
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [Forbidden, SendingSubdomainAlreadyExists, CloudflareRateLimited, CloudflareError],
...
export type DeleteSubdomainError = Forbidden | SendingSubdomainNotFound | CloudflareOpError;
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [Forbidden, SendingSubdomainNotFound, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
...
export type GetSubdomainError = Forbidden | SendingSubdomainNotFound | CloudflareOpError;
