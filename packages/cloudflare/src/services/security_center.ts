...
export const GetInsightContextResponse = /*@__PURE__*/ S.suspend(() =>
  InsightsContextGetResultMap.pipe(T.EnvelopePayloadRoot(), T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export const InsightsSeverityGetRequestIssueClassNeqList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetInsightSeverityForAccountRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    issueClassNeq: S.optional(
      InsightsSeverityGetRequestIssueClassNeqList.pipe(T.Query("issue_class~neq")),
    ),
    issueType: S.optional(InsightsSeverityGetRequestIssueTypeList.pipe(T.Query("issue_type"))),
    issueTypeNeq: S.optional(
      InsightsSeverityGetRequestIssueTypeNeqList.pipe(T.Query("issue_type~neq")),
    ),
...
export const GetInsightSeverityResponse = /*@__PURE__*/ S.suspend(() =>
  InsightsSeverityGetResultList.pipe(T.EnvelopePayloadRoot(), T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export const ListByInsightInsightAuditLogForAccountRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    accountId: S.String.pipe(T.Label("account_id")),
    issueId: S.String.pipe(T.Label("issue_id")),
    ...
    fieldChanged: S.optional(
      InsightsAuditLogsListByInsightRequestFieldChanged.pipe(T.Query("field_changed")),
    ),
...
export const InsightsAuditLogsListByInsightResultItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    fieldChanged: S.optional(
      S.NullOr(InsightsAuditLogsListByInsightResultItemFieldChanged).pipe(T.Body("field_changed")),
    ),
...
export const ListByInsightInsightAuditLogForZoneRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    zoneId: S.String.pipe(T.Label("zone_id")),
    issueId: S.String.pipe(T.Label("issue_id")),
    before: S.optional(S.String.pipe(T.Query())),
...
export const InsightsAuditLogsListResultItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    currentValue: S.optional(S.NullOr(S.String).pipe(T.Body("current_value"))),
    fieldChanged: S.optional(
      S.NullOr(InsightsAuditLogsListResultItemFieldChanged).pipe(T.Body("field_changed")),
    ),
    issueId: S.optional(S.NullOr(S.String).pipe(T.Body("issue_id"))),
    previousValue: S.optional(S.NullOr(S.String).pipe(T.Body("previous_value"))),
    rationale: S.optional(S.NullOr(S.String)),
...
export const InsightsListResponseIssuesItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    issueType: S.optional(
      S.NullOr(InsightsListResponseIssuesItemIssueType).pipe(T.Body("issue_type")),
    ),
...
export const PatchInsightClassificationForAccountRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    accountId: S.String.pipe(T.Label("account_id")),
    issueId: S.String.pipe(T.Label("issue_id")),
...
export const PatchInsightClassificationForAccountResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export const PatchInsightClassificationForZoneResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
