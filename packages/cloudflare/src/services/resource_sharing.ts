...
export class ShareRecipientNotFound
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<ShareRecipientNotFound>()("ShareRecipientNotFound", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 1004 }, { status: 404 }],
...
export class ShareResourceNotFound
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<ShareResourceNotFound>()("ShareResourceNotFound", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 1004 }, { status: 404 }],
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [ShareRecipientNotFound, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [ShareResourceNotFound, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
