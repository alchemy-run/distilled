...
export class UnentitledMitigationAction
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<UnentitledMitigationAction>()("UnentitledMitigationAction", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 11400 }],
...
export const SettingsOperationsBulkEditRequestBodyValue = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    mitigationAction: S.optional(
      SettingsOperationsBulkEditRequestBodyValueMitigationAction.pipe(T.Body("mitigation_action")),
    ),
  }),
).annotate({
...
export const GetSettingResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    validationDefaultMitigationAction: SettingsGetResponseValidationDefaultMitigationAction.pipe(
...
export const PatchSettingResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    validationDefaultMitigationAction: SettingsEditResponseValidationDefaultMitigationAction.pipe(
      T.Body("validation_default_mitigation_action"),
    ),
    validationOverrideMitigationAction: S.optional(
...
export const PutSettingRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    zoneId: S.String.pipe(T.Label("zone_id")),
    validationDefaultMitigationAction: SettingsUpdateRequestValidationDefaultMitigationAction.pipe(
      T.Body("validation_default_mitigation_action"),
    ),
    validationOverrideMitigationAction: S.optional(
...
export const PutSettingResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    validationDefaultMitigationAction: SettingsUpdateResponseValidationDefaultMitigationAction.pipe(
      T.Body("validation_default_mitigation_action"),
    ),
    validationOverrideMitigationAction: S.optional(
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [OperationNotFound, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [UnentitledMitigationAction, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [OperationNotFound, UnentitledMitigationAction, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
