...
export const JobsCreateRequestOutputOptionsFieldNamesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const JobsCreateRequestOutputOptions = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    outputType: S.optional(JobsCreateRequestOutputOptionsOutputType.pipe(T.Body("output_type"))),
    ...
    timestampFormat: S.optional(
      JobsCreateRequestOutputOptionsTimestampFormat.pipe(T.Body("timestamp_format")),
    ),
...
export const CreateJobForAccountRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    maxUploadIntervalSeconds: S.optional(S.Number.pipe(T.Body("max_upload_interval_seconds"))),
...
export const JobsCreateResponseOutputOptionsFieldNamesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const JobsCreateResponseOutputOptions = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    fieldDelimiter: S.optional(S.NullOr(S.String).pipe(T.Body("field_delimiter"))),
    fieldNames: S.optional(
      S.NullOr(JobsCreateResponseOutputOptionsFieldNamesList).pipe(T.Body("field_names")),
    ),
    mergeSubrequests: S.optional(S.NullOr(S.Boolean).pipe(T.Body("merge_subrequests"))),
    outputType: S.optional(
      S.NullOr(JobsCreateResponseOutputOptionsOutputType).pipe(T.Body("output_type")),
    ),
    recordDelimiter: S.optional(S.NullOr(S.String).pipe(T.Body("record_delimiter"))),
    ...
    recordTemplate: S.optional(S.NullOr(S.String).pipe(T.Body("record_template"))),
    sampleRate: S.optional(S.NullOr(S.Number).pipe(T.Body("sample_rate"))),
    timestampFormat: S.optional(
      S.NullOr(JobsCreateResponseOutputOptionsTimestampFormat).pipe(T.Body("timestamp_format")),
    ),
    "cve-2021-44228": S.optional(S.NullOr(S.Boolean).pipe(T.Body("CVE-2021-44228"))),
  }),
).annotate({
...
export const CreateJobResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    logpullOptions: S.optional(S.NullOr(S.String).pipe(T.Body("logpull_options"))),
    maxUploadBytes: S.optional(S.NullOr(S.Number).pipe(T.Body("max_upload_bytes"))),
    maxUploadIntervalSeconds: S.optional(
      S.NullOr(S.Number).pipe(T.Body("max_upload_interval_seconds")),
    ),
    maxUploadRecords: S.optional(S.NullOr(S.Number).pipe(T.Body("max_upload_records"))),
...
export const CreateTransformerResponseAssociatedJobsItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.NullOr(S.Number)),
    name: S.optional(S.NullOr(S.String)),
    objectTag: S.optional(S.NullOr(S.String).pipe(T.Body("object_tag"))),
    objectType: S.optional(
      S.NullOr(CreateTransformerResponseAssociatedJobsItemObjectType).pipe(T.Body("object_type")),
    ),
  }),
).annotate({
...
export const CreateTransformerResponseAssociatedJobsList = /*@__PURE__*/ S.Array(
...
export const CreateTransformerResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    associatedJobs: S.optional(
      S.NullOr(CreateTransformerResponseAssociatedJobsList).pipe(T.Body("associated_jobs")),
    ),
...
export const DestinationExistsValidateForAccountRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    accountId: S.String.pipe(T.Label("account_id")),
    destinationConf: S.String.pipe(T.Body("destination_conf")),
  })
...
export const DatasetsJobsGetResultItemOutputOptionsFieldNamesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const DatasetsJobsGetResultItemOutputOptions = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    fieldDelimiter: S.optional(S.NullOr(S.String).pipe(T.Body("field_delimiter"))),
    fieldNames: S.optional(
      S.NullOr(DatasetsJobsGetResultItemOutputOptionsFieldNamesList).pipe(T.Body("field_names")),
    ),
    mergeSubrequests: S.optional(S.NullOr(S.Boolean).pipe(T.Body("merge_subrequests"))),
    outputType: S.optional(
      S.NullOr(DatasetsJobsGetResultItemOutputOptionsOutputType).pipe(T.Body("output_type")),
    ),
    recordDelimiter: S.optional(S.NullOr(S.String).pipe(T.Body("record_delimiter"))),
    recordPrefix: S.optional(S.NullOr(S.String).pipe(T.Body("record_prefix"))),
    recordSuffix: S.optional(S.NullOr(S.String).pipe(T.Body("record_suffix"))),
...
export const DatasetsJobsGetResultItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    name: S.optional(S.NullOr(S.String)),
    outputOptions: S.optional(
      S.NullOr(DatasetsJobsGetResultItemOutputOptions).pipe(T.Body("output_options")),
    ),
  }),
).annotate({
...
export const JobsGetResponseOutputOptions = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    fieldDelimiter: S.optional(S.NullOr(S.String).pipe(T.Body("field_delimiter"))),
    fieldNames: S.optional(
      S.NullOr(JobsGetResponseOutputOptionsFieldNamesList).pipe(T.Body("field_names")),
    ),
    mergeSubrequests: S.optional(S.NullOr(S.Boolean).pipe(T.Body("merge_subrequests"))),
    outputType: S.optional(
      S.NullOr(JobsGetResponseOutputOptionsOutputType).pipe(T.Body("output_type")),
    ),
    recordDelimiter: S.optional(S.NullOr(S.String).pipe(T.Body("record_delimiter"))),
    recordPrefix: S.optional(S.NullOr(S.String).pipe(T.Body("record_prefix"))),
    recordSuffix: S.optional(S.NullOr(S.String).pipe(T.Body("record_suffix"))),
    ...
    sampleRate: S.optional(S.NullOr(S.Number).pipe(T.Body("sample_rate"))),
    timestampFormat: S.optional(
      S.NullOr(JobsGetResponseOutputOptionsTimestampFormat).pipe(T.Body("timestamp_format")),
    ),
    "cve-2021-44228": S.optional(S.NullOr(S.Boolean).pipe(T.Body("CVE-2021-44228"))),
  }),
).annotate({
...
export const GetTransformerResponseAssociatedJobsItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    objectTag: S.optional(S.NullOr(S.String).pipe(T.Body("object_tag"))),
    objectType: S.optional(
      S.NullOr(GetTransformerResponseAssociatedJobsItemObjectType).pipe(T.Body("object_type")),
    ),
  }),
).annotate({
...
export const GetTransformerResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.NullOr(S.Number)),
    associatedJobs: S.optional(
      S.NullOr(GetTransformerResponseAssociatedJobsList).pipe(T.Body("associated_jobs")),
    ),
    createdAt: S.optional(S.NullOr(S.String).pipe(T.Body("created_at"))),
    dataset: S.optional(S.NullOr(S.String)),
    description: S.optional(S.NullOr(S.String)),
...
export const JobsListResultItemOutputOptionsFieldNamesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const JobsListResultItemOutputOptions = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    fieldDelimiter: S.optional(S.NullOr(S.String).pipe(T.Body("field_delimiter"))),
    fieldNames: S.optional(
      S.NullOr(JobsListResultItemOutputOptionsFieldNamesList).pipe(T.Body("field_names")),
    ),
    mergeSubrequests: S.optional(S.NullOr(S.Boolean).pipe(T.Body("merge_subrequests"))),
    outputType: S.optional(
      S.NullOr(JobsListResultItemOutputOptionsOutputType).pipe(T.Body("output_type")),
    ),
    recordDelimiter: S.optional(S.NullOr(S.String).pipe(T.Body("record_delimiter"))),
    recordPrefix: S.optional(S.NullOr(S.String).pipe(T.Body("record_prefix"))),
    recordSuffix: S.optional(S.NullOr(S.String).pipe(T.Body("record_suffix"))),
    ...
    sampleRate: S.optional(S.NullOr(S.Number).pipe(T.Body("sample_rate"))),
    timestampFormat: S.optional(
      S.NullOr(JobsListResultItemOutputOptionsTimestampFormat).pipe(T.Body("timestamp_format")),
    ),
    "cve-2021-44228": S.optional(S.NullOr(S.Boolean).pipe(T.Body("CVE-2021-44228"))),
  }),
).annotate({
...
export const ListTransformersResultItemAssociatedJobsItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.NullOr(S.Number)),
    name: S.optional(S.NullOr(S.String)),
    objectTag: S.optional(S.NullOr(S.String).pipe(T.Body("object_tag"))),
    objectType: S.optional(
      S.NullOr(ListTransformersResultItemAssociatedJobsItemObjectType).pipe(T.Body("object_type")),
    ),
  }),
).annotate({
...
export const ListTransformersResultItemAssociatedJobsList = /*@__PURE__*/ S.Array(
...
export const ListTransformersResultItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.NullOr(S.Number)),
    associatedJobs: S.optional(
      S.NullOr(ListTransformersResultItemAssociatedJobsList).pipe(T.Body("associated_jobs")),
    ),
    createdAt: S.optional(S.NullOr(S.String).pipe(T.Body("created_at"))),
    dataset: S.optional(S.NullOr(S.String)),
    description: S.optional(S.NullOr(S.String)),
...
export const ListTransformersVersionsResponse = /*@__PURE__*/ S.suspend(() =>
  ListTransformersVersionsResultList.pipe(T.EnvelopePayloadRoot(), T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export const PreviewTransformerResponse = /*@__PURE__*/ S.suspend(() =>
  PreviewTransformerResultList.pipe(T.EnvelopePayloadRoot(), T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export const JobsUpdateRequestOutputOptionsFieldNamesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const JobsUpdateRequestOutputOptions = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    mergeSubrequests: S.optional(S.Boolean.pipe(T.Body("merge_subrequests"))),
    outputType: S.optional(JobsUpdateRequestOutputOptionsOutputType.pipe(T.Body("output_type"))),
    recordDelimiter: S.optional(S.String.pipe(T.Body("record_delimiter"))),
    recordPrefix: S.optional(S.String.pipe(T.Body("record_prefix"))),
    recordSuffix: S.optional(S.String.pipe(T.Body("record_suffix"))),
    recordTemplate: S.optional(S.String.pipe(T.Body("record_template"))),
    sampleRate: S.optional(S.Number.pipe(T.Body("sample_rate"))),
    timestampFormat: S.optional(
      JobsUpdateRequestOutputOptionsTimestampFormat.pipe(T.Body("timestamp_format")),
    ),
    "cve-2021-44228": S.optional(S.Boolean.pipe(T.Body("CVE-2021-44228"))),
  }),
).annotate({
...
export const JobsUpdateResponseOutputOptionsFieldNamesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const JobsUpdateResponseOutputOptions = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    fieldDelimiter: S.optional(S.NullOr(S.String).pipe(T.Body("field_delimiter"))),
    fieldNames: S.optional(
      S.NullOr(JobsUpdateResponseOutputOptionsFieldNamesList).pipe(T.Body("field_names")),
    ),
    mergeSubrequests: S.optional(S.NullOr(S.Boolean).pipe(T.Body("merge_subrequests"))),
    outputType: S.optional(
      S.NullOr(JobsUpdateResponseOutputOptionsOutputType).pipe(T.Body("output_type")),
    ),
    recordDelimiter: S.optional(S.NullOr(S.String).pipe(T.Body("record_delimiter"))),
    recordPrefix: S.optional(S.NullOr(S.String).pipe(T.Body("record_prefix"))),
    recordSuffix: S.optional(S.NullOr(S.String).pipe(T.Body("record_suffix"))),
    ...
    sampleRate: S.optional(S.NullOr(S.Number).pipe(T.Body("sample_rate"))),
    timestampFormat: S.optional(
      S.NullOr(JobsUpdateResponseOutputOptionsTimestampFormat).pipe(T.Body("timestamp_format")),
    ),
    "cve-2021-44228": S.optional(S.NullOr(S.Boolean).pipe(T.Body("CVE-2021-44228"))),
  }),
).annotate({
...
export const UpdateTransformerResponseAssociatedJobsItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.NullOr(S.Number)),
    name: S.optional(S.NullOr(S.String)),
    objectTag: S.optional(S.NullOr(S.String).pipe(T.Body("object_tag"))),
    objectType: S.optional(
      S.NullOr(UpdateTransformerResponseAssociatedJobsItemObjectType).pipe(T.Body("object_type")),
    ),
  }),
).annotate({
...
export const UpdateTransformerResponseAssociatedJobsList = /*@__PURE__*/ S.Array(
...
export const UpdateTransformerResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.NullOr(S.Number)),
    associatedJobs: S.optional(
      S.NullOr(UpdateTransformerResponseAssociatedJobsList).pipe(T.Body("associated_jobs")),
    ),
    createdAt: S.optional(S.NullOr(S.String).pipe(T.Body("created_at"))),
    dataset: S.optional(S.NullOr(S.String)),
    description: S.optional(S.NullOr(S.String)),
