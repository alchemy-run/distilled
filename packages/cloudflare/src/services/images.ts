...
export class ImagesAccessNotEnabled
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<ImagesAccessNotEnabled>()("ImagesAccessNotEnabled", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 5403 }],
...
export class VariantAlreadyExists
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<VariantAlreadyExists>()("VariantAlreadyExists", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 5409 }],
...
export class VariantNameNotAllowed
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<VariantNameNotAllowed>()("VariantNameNotAllowed", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 5400 }],
...
export const V1VariantsListResponseVariantsHeroOptions = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    fit: V1VariantsListResponseVariantsHeroOptionsFit,
    height: S.Number,
    metadata: V1VariantsListResponseVariantsHeroOptionsMetadata,
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [ImagesAccessNotEnabled, ImageNotFound, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [ImagesAccessNotEnabled, KeyNotFound, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
