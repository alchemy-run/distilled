...
export const GetHostnameAssociationRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    mtlsCertificateId: S.optional(S.String.pipe(T.Query("mtls_certificate_id"))),
  })
    .pipe(
      T.Http({
        method: "GET",
...
export const HostnameAssociationsGetResponseHostnamesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetHostnameAssociationResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    hostnames: S.optional(S.NullOr(HostnameAssociationsGetResponseHostnamesList)),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export const HostnameAssociationsUpdateRequestHostnamesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const HostnameAssociationsUpdateResponseHostnamesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const PutHostnameAssociationResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    hostnames: S.optional(S.NullOr(HostnameAssociationsUpdateResponseHostnamesList)),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
