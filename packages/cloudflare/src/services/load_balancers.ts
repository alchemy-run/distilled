...
export class LoadBalancerNotFound
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<LoadBalancerNotFound>()("LoadBalancerNotFound", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 1001 }],
...
export class MonitorGroupNotFound
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<MonitorGroupNotFound>()("MonitorGroupNotFound", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 1001 }],
...
export class MonitorGroupsNotEnabled
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<MonitorGroupsNotEnabled>()("MonitorGroupsNotEnabled", {
      code: S.Number,
      message: S.String,
    }),
...
export class MonitorIntervalOutOfRange
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<MonitorIntervalOutOfRange>()("MonitorIntervalOutOfRange", {
      code: S.Number,
      message: S.String,
    }),
...
export type PoolsBulkEditResultItemHealthSourcesItem = "local" | "regional" | "global";
...
export type PoolsBulkEditResultItemLoadSheddingDefaultPolicy = "random" | "hash";
...
export const PoolsBulkEditResultItemLoadShedding = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultPercent: S.optional(S.NullOr(S.Number).pipe(T.Body("default_percent"))),
    defaultPolicy: S.optional(
      S.NullOr(PoolsBulkEditResultItemLoadSheddingDefaultPolicy).pipe(T.Body("default_policy")),
    ),
    sessionPercent: S.optional(S.NullOr(S.Number).pipe(T.Body("session_percent"))),
    sessionPolicy: S.optional(
      S.NullOr(PoolsBulkEditResultItemLoadSheddingSessionPolicy).pipe(T.Body("session_policy")),
    ),
  }),
).annotate({
...
export const PoolsBulkEditResultItemNotificationFilterOrigin = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const PoolsBulkEditResultItemNotificationFilter = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    origin: S.optional(S.NullOr(PoolsBulkEditResultItemNotificationFilterOrigin)),
    pool: S.optional(S.NullOr(PoolsBulkEditResultItemNotificationFilterOrigin)),
  }),
).annotate({
...
export const PoolsBulkEditResultItemOriginsItemHeaderHostList = /*@__PURE__*/ S.Array(
  S.String,
...
export const PoolsBulkEditResultItemOriginsItemHeader = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    host: S.optional(
      S.NullOr(PoolsBulkEditResultItemOriginsItemHeaderHostList).pipe(T.Body("Host")),
    ),
  }),
).annotate({
...
export type PoolsBulkEditResultItemOriginsList = Array<PoolsBulkEditResultItemOriginsItem>;
...
export const PoolsBulkEditResultItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    checkRegions: S.optional(
      S.NullOr(PoolsBulkEditResultItemCheckRegionsList).pipe(T.Body("check_regions")),
    ),
    ...
    healthSources: S.optional(
      S.NullOr(PoolsBulkEditResultItemHealthSourcesList).pipe(T.Body("health_sources")),
    ),
    latitude: S.optional(S.NullOr(S.Number)),
    loadShedding: S.optional(
      S.NullOr(PoolsBulkEditResultItemLoadShedding).pipe(T.Body("load_shedding")),
    ),
    longitude: S.optional(S.NullOr(S.Number)),
    minimumOrigins: S.optional(S.NullOr(S.Number).pipe(T.Body("minimum_origins"))),
    ...
    notificationEmail: S.optional(S.NullOr(S.String).pipe(T.Body("notification_email"))),
    notificationFilter: S.optional(
      S.NullOr(PoolsBulkEditResultItemNotificationFilter).pipe(T.Body("notification_filter")),
    ),
    originSteering: S.optional(
      S.NullOr(PoolsBulkEditResultItemOriginSteering).pipe(T.Body("origin_steering")),
    ),
...
export const CreateRequestAdaptiveRouting = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    failoverAcrossPools: S.optional(S.Boolean.pipe(T.Body("failover_across_pools"))),
  }),
).annotate({
...
export type CreateRequestLocationStrategyPreferEcs = "always" | "never" | "proximity" | "geo";
...
export const CreateRequestLocationStrategy = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    preferEcs: S.optional(CreateRequestLocationStrategyPreferEcs.pipe(T.Body("prefer_ecs"))),
  }),
).annotate({
...
export const CreateRequestRandomSteering = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    poolWeights: S.optional(CreateRequestRandomSteeringPoolWeightsMap.pipe(T.Body("pool_weights"))),
  }),
).annotate({
...
export type CreateRequestRulesItemOverridesAdaptiveRouting = CreateRequestAdaptiveRouting;
export const CreateRequestRulesItemOverridesAdaptiveRouting = CreateRequestAdaptiveRouting;

export type CreateRequestRulesItemOverridesCountryPoolsValueList = Array<string>;
export const CreateRequestRulesItemOverridesCountryPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export type CreateRequestRulesItemOverridesCountryPoolsMap = {
  [key: string]: CreateRequestRulesItemOverridesCountryPoolsValueList | undefined;
};
export const CreateRequestRulesItemOverridesCountryPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export const CreateRequestRulesItemOverridesDefaultPoolsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<CreateRequestRulesItemOverridesDefaultPoolsList>;

export type CreateRequestRulesItemOverridesLocationStrategyMode = "pop" | "resolver_ip";
...
export type CreateRequestRulesItemOverridesLocationStrategyPreferEcs =
  ...
  | "proximity"
  | "geo";
export const CreateRequestRulesItemOverridesLocationStrategyPreferEcs = S.String;
...
export interface CreateRequestRulesItemOverridesLocationStrategy {
  ...
  /** Whether the EDNS Client Subnet (ECS) GeoIP should be preferred as the authoritative location. */
  preferEcs?: CreateRequestRulesItemOverridesLocationStrategyPreferEcs | (string & {});
}
export const CreateRequestRulesItemOverridesLocationStrategy = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    mode: S.optional(CreateRequestRulesItemOverridesLocationStrategyMode),
    preferEcs: S.optional(
      CreateRequestRulesItemOverridesLocationStrategyPreferEcs.pipe(T.Body("prefer_ecs")),
    ),
  }),
).annotate({
...
export const CreateRequestRulesItemOverridesPopPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateRequestRulesItemOverridesPopPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export const CreateRequestRulesItemOverridesRandomSteeringPoolWeightsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Number,
...
export const CreateRequestRulesItemOverridesRandomSteering = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultWeight: S.optional(S.Number.pipe(T.Body("default_weight"))),
    poolWeights: S.optional(
      CreateRequestRulesItemOverridesRandomSteeringPoolWeightsMap.pipe(T.Body("pool_weights")),
    ),
  }),
).annotate({
...
export const CreateRequestRulesItemOverridesRegionPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export type CreateRequestRulesItemOverridesRegionPoolsMap = {
  [key: string]: CreateRequestRulesItemOverridesRegionPoolsValueList | undefined;
};
export const CreateRequestRulesItemOverridesRegionPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export type CreateRequestRulesItemOverridesSessionAffinityAttributesHeadersList = Array<string>;
...
export type CreateRequestRulesItemOverridesSessionAffinityAttributesSamesite =
  ...
  | "None"
  | "Strict";
export const CreateRequestRulesItemOverridesSessionAffinityAttributesSamesite = S.String;

export type CreateRequestRulesItemOverridesSessionAffinityAttributesSecure =
  | "Auto"
  | "Always"
  | "Never";
export const CreateRequestRulesItemOverridesSessionAffinityAttributesSecure = S.String;
...
export interface CreateRequestRulesItemOverridesSessionAffinityAttributes {
  ...
  samesite?: CreateRequestRulesItemOverridesSessionAffinityAttributesSamesite | (string & {});
  /** Configures the Secure attribute on session affinity cookie. Value "Always" indicates the Secure attribute will be set in the Set-Cookie header, "Never" indicates the Secure attribute will not be set, and "Auto" will set the Secure attribute depending if Always Use HTTPS is enabled. */
  secure?: CreateRequestRulesItemOverridesSessionAffinityAttributesSecure | (string & {});
...
export const CreateRequestRulesItemOverridesSessionAffinityAttributes = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      drainDuration: S.optional(S.Number.pipe(T.Body("drain_duration"))),
      headers: S.optional(CreateRequestRulesItemOverridesSessionAffinityAttributesHeadersList),
      requireAllHeaders: S.optional(S.Boolean.pipe(T.Body("require_all_headers"))),
      samesite: S.optional(CreateRequestRulesItemOverridesSessionAffinityAttributesSamesite),
      secure: S.optional(CreateRequestRulesItemOverridesSessionAffinityAttributesSecure),
...
export interface CreateRequestRulesItemOverrides {
  ...
  sessionAffinity?: CreateRequestRulesItemOverridesSessionAffinity | (string & {});
  ...
  steeringPolicy?: CreateRequestRulesItemOverridesSteeringPolicy | (string & {});
...
export const CreateRequestRulesItemOverrides = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    countryPools: S.optional(
      CreateRequestRulesItemOverridesCountryPoolsMap.pipe(T.Body("country_pools")),
    ),
    defaultPools: S.optional(
      CreateRequestRulesItemOverridesDefaultPoolsList.pipe(T.Body("default_pools")),
    ),
    fallbackPool: S.optional(S.String.pipe(T.Body("fallback_pool"))),
    locationStrategy: S.optional(
      CreateRequestRulesItemOverridesLocationStrategy.pipe(T.Body("location_strategy")),
    ),
    poolDefaultWeight: S.optional(S.Number.pipe(T.Body("pool_default_weight"))),
    poolWeights: S.optional(
      CreateRequestRulesItemOverridesPoolWeightsMap.pipe(T.Body("pool_weights")),
    ),
    pools: S.optional(CreateRequestRulesItemOverridesPoolsList),
    popPools: S.optional(CreateRequestRulesItemOverridesPopPoolsMap.pipe(T.Body("pop_pools"))),
    randomSteering: S.optional(
      CreateRequestRulesItemOverridesRandomSteering.pipe(T.Body("random_steering")),
    ),
    regionPools: S.optional(
      CreateRequestRulesItemOverridesRegionPoolsMap.pipe(T.Body("region_pools")),
    ),
    sessionAffinity: S.optional(
      CreateRequestRulesItemOverridesSessionAffinity.pipe(T.Body("session_affinity")),
    ),
    ...
    sessionAffinityTtl: S.optional(S.Number.pipe(T.Body("session_affinity_ttl"))),
    steeringPolicy: S.optional(
      CreateRequestRulesItemOverridesSteeringPolicy.pipe(T.Body("steering_policy")),
    ),
...
export const CreateRequestRulesItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    fixedResponse: S.optional(CreateRequestRulesItemFixedResponse.pipe(T.Body("fixed_response"))),
...
export type CreateRequestSessionAffinity = "none" | "cookie" | "ip_cookie" | "header";
...
export const CreateRequestSessionAffinityAttributesHeadersList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<CreateRequestSessionAffinityAttributesHeadersList>;

export type CreateRequestSessionAffinityAttributesSamesite = "Auto" | "Lax" | "None" | "Strict";
export const CreateRequestSessionAffinityAttributesSamesite = S.String;

export type CreateRequestSessionAffinityAttributesSecure = "Auto" | "Always" | "Never";
...
export type CreateRequestSessionAffinityAttributesZeroDowntimeFailover =
  ...
  | "temporary"
  | "sticky";
export const CreateRequestSessionAffinityAttributesZeroDowntimeFailover = S.String;
...
export interface CreateRequestSessionAffinityAttributes {
  ...
  /** Configures the zero-downtime failover between origins within a pool when session affinity is enabled. This feature is currently incompatible with Argo, Tiered Cache, and Bandwidth Alliance. The supported values are: - `"none"`: No failover takes place for sessions pinned to the origin (default). - `"temporary"`: Traffic will be sent to another other healthy origin until the originally pinned origin is available; note that this can potentially result in heavy origin flapping. - `"sticky"`: The session affinity cookie is updated and subsequent requests are sent to the new origin. Note: Zero-downtime failover with sticky sessions is currently not supported for session affinity by header. */
  zeroDowntimeFailover?: CreateRequestSessionAffinityAttributesZeroDowntimeFailover | (string & {});
}
...
export const CreateLoadBalancerRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    name: S.String,
    adaptiveRouting: S.optional(CreateRequestAdaptiveRouting.pipe(T.Body("adaptive_routing"))),
    countryPools: S.optional(CreateRequestCountryPoolsMap.pipe(T.Body("country_pools"))),
    description: S.optional(S.String),
    enabled: S.optional(S.Boolean),
    locationStrategy: S.optional(CreateRequestLocationStrategy.pipe(T.Body("location_strategy"))),
    ...
    randomSteering: S.optional(CreateRequestRandomSteering.pipe(T.Body("random_steering"))),
    regionPools: S.optional(CreateRequestRegionPoolsMap.pipe(T.Body("region_pools"))),
    rules: S.optional(CreateRequestRulesList),
    sessionAffinity: S.optional(CreateRequestSessionAffinity.pipe(T.Body("session_affinity"))),
    sessionAffinityAttributes: S.optional(
      CreateRequestSessionAffinityAttributes.pipe(T.Body("session_affinity_attributes")),
    ),
    sessionAffinityTtl: S.optional(S.Number.pipe(T.Body("session_affinity_ttl"))),
...
export const CreateResponseAdaptiveRouting = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    failoverAcrossPools: S.optional(S.NullOr(S.Boolean).pipe(T.Body("failover_across_pools"))),
  }),
).annotate({
...
export type CreateResponseLocationStrategyPreferEcs = "always" | "never" | "proximity" | "geo";
...
export const CreateResponseLocationStrategy = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    preferEcs: S.optional(
      S.NullOr(CreateResponseLocationStrategyPreferEcs).pipe(T.Body("prefer_ecs")),
    ),
  }),
).annotate({
...
export type CreateResponsePoolSetsItemMatchTopologyCountriesList = Array<string>;
export const CreateResponsePoolSetsItemMatchTopologyCountriesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateResponsePoolSetsItemMatchTopologyPopsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateResponsePoolSetsItemMatchTopologyRegionsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateResponsePoolSetsItemMatchTopology = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    countries: S.optional(S.NullOr(CreateResponsePoolSetsItemMatchTopologyCountriesList)),
    pops: S.optional(S.NullOr(CreateResponsePoolSetsItemMatchTopologyPopsList)),
    regions: S.optional(S.NullOr(CreateResponsePoolSetsItemMatchTopologyRegionsList)),
  }),
).annotate({
...
export const CreateResponsePoolSetsItemOverridesPoolWeightsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Number,
...
export const CreateResponsePoolSetsItemOverridesPoolsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateResponsePoolSetsItemOverrides = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    poolDefaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("pool_default_weight"))),
    poolWeights: S.optional(
      S.NullOr(CreateResponsePoolSetsItemOverridesPoolWeightsMap).pipe(T.Body("pool_weights")),
    ),
    pools: S.optional(S.NullOr(CreateResponsePoolSetsItemOverridesPoolsList)),
    steeringPolicy: S.optional(
      S.NullOr(CreateResponsePoolSetsItemOverridesSteeringPolicy).pipe(T.Body("steering_policy")),
    ),
  }),
).annotate({
...
export const CreateResponsePoolSetsItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    fixedResponse: S.optional(
      S.NullOr(CreateResponsePoolSetsItemFixedResponse).pipe(T.Body("fixed_response")),
    ),
...
export const CreateResponseRandomSteering = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("default_weight"))),
    poolWeights: S.optional(
      S.NullOr(CreateResponseRandomSteeringPoolWeightsMap).pipe(T.Body("pool_weights")),
    ),
  }),
).annotate({
...
export type CreateResponseRulesItemFixedResponse = CreateResponsePoolSetsItemFixedResponse;
export const CreateResponseRulesItemFixedResponse = CreateResponsePoolSetsItemFixedResponse;

export type CreateResponseRulesItemOverridesAdaptiveRouting = CreateResponseAdaptiveRouting;
export const CreateResponseRulesItemOverridesAdaptiveRouting = CreateResponseAdaptiveRouting;

export type CreateResponseRulesItemOverridesCountryPoolsValueList = Array<string>;
export const CreateResponseRulesItemOverridesCountryPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export type CreateResponseRulesItemOverridesCountryPoolsMap = {
  [key: string]: CreateResponseRulesItemOverridesCountryPoolsValueList | undefined;
};
export const CreateResponseRulesItemOverridesCountryPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export const CreateResponseRulesItemOverridesDefaultPoolsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<CreateResponseRulesItemOverridesDefaultPoolsList>;

export type CreateResponseRulesItemOverridesLocationStrategyMode = "pop" | "resolver_ip";
...
export type CreateResponseRulesItemOverridesLocationStrategyPreferEcs =
  ...
  | "proximity"
  | "geo";
export const CreateResponseRulesItemOverridesLocationStrategyPreferEcs = S.String;
...
export const CreateResponseRulesItemOverridesLocationStrategy = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    mode: S.optional(S.NullOr(CreateResponseRulesItemOverridesLocationStrategyMode)),
    preferEcs: S.optional(
      S.NullOr(CreateResponseRulesItemOverridesLocationStrategyPreferEcs).pipe(
        T.Body("prefer_ecs"),
      ),
    ),
  }),
...
export const CreateResponseRulesItemOverridesPopPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateResponseRulesItemOverridesPopPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export const CreateResponseRulesItemOverridesRandomSteeringPoolWeightsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Number,
...
export const CreateResponseRulesItemOverridesRandomSteering = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("default_weight"))),
    poolWeights: S.optional(
      S.NullOr(CreateResponseRulesItemOverridesRandomSteeringPoolWeightsMap).pipe(
        T.Body("pool_weights"),
      ),
    ),
  }),
...
export type CreateResponseRulesItemOverridesRegionPoolsValueList = Array<string>;
export const CreateResponseRulesItemOverridesRegionPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export type CreateResponseRulesItemOverridesRegionPoolsMap = {
  [key: string]: CreateResponseRulesItemOverridesRegionPoolsValueList | undefined;
};
export const CreateResponseRulesItemOverridesRegionPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export type CreateResponseRulesItemOverridesSessionAffinityAttributesHeadersList = Array<string>;
...
export type CreateResponseRulesItemOverridesSessionAffinityAttributesSamesite =
  ...
  | "None"
  | "Strict";
export const CreateResponseRulesItemOverridesSessionAffinityAttributesSamesite = S.String;

export type CreateResponseRulesItemOverridesSessionAffinityAttributesSecure =
  | "Auto"
  | "Always"
  | "Never";
export const CreateResponseRulesItemOverridesSessionAffinityAttributesSecure = S.String;
...
export const CreateResponseRulesItemOverridesSessionAffinityAttributes = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      drainDuration: S.optional(S.NullOr(S.Number).pipe(T.Body("drain_duration"))),
      headers: S.optional(
        S.NullOr(CreateResponseRulesItemOverridesSessionAffinityAttributesHeadersList),
      ),
      requireAllHeaders: S.optional(S.NullOr(S.Boolean).pipe(T.Body("require_all_headers"))),
      samesite: S.optional(
        S.NullOr(CreateResponseRulesItemOverridesSessionAffinityAttributesSamesite),
      ),
      secure: S.optional(S.NullOr(CreateResponseRulesItemOverridesSessionAffinityAttributesSecure)),
      zeroDowntimeFailover: S.optional(
        S.NullOr(
...
export const CreateResponseRulesItemOverrides = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    countryPools: S.optional(
      S.NullOr(CreateResponseRulesItemOverridesCountryPoolsMap).pipe(T.Body("country_pools")),
    ),
    defaultPools: S.optional(
      S.NullOr(CreateResponseRulesItemOverridesDefaultPoolsList).pipe(T.Body("default_pools")),
    ),
    fallbackPool: S.optional(S.NullOr(S.String).pipe(T.Body("fallback_pool"))),
    locationStrategy: S.optional(
      S.NullOr(CreateResponseRulesItemOverridesLocationStrategy).pipe(T.Body("location_strategy")),
    ),
    poolDefaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("pool_default_weight"))),
    poolWeights: S.optional(
      S.NullOr(CreateResponseRulesItemOverridesPoolWeightsMap).pipe(T.Body("pool_weights")),
    ),
    pools: S.optional(S.NullOr(CreateResponseRulesItemOverridesPoolsList)),
    popPools: S.optional(
      S.NullOr(CreateResponseRulesItemOverridesPopPoolsMap).pipe(T.Body("pop_pools")),
    ),
    randomSteering: S.optional(
      S.NullOr(CreateResponseRulesItemOverridesRandomSteering).pipe(T.Body("random_steering")),
    ),
    regionPools: S.optional(
      S.NullOr(CreateResponseRulesItemOverridesRegionPoolsMap).pipe(T.Body("region_pools")),
    ),
    sessionAffinity: S.optional(
      S.NullOr(CreateResponseRulesItemOverridesSessionAffinity).pipe(T.Body("session_affinity")),
    ),
    sessionAffinityAttributes: S.optional(
    ...
    sessionAffinityTtl: S.optional(S.NullOr(S.Number).pipe(T.Body("session_affinity_ttl"))),
    steeringPolicy: S.optional(
      S.NullOr(CreateResponseRulesItemOverridesSteeringPolicy).pipe(T.Body("steering_policy")),
    ),
...
export type CreateResponseSessionAffinity = "none" | "cookie" | "ip_cookie" | "header";
...
export const CreateResponseSessionAffinityAttributesHeadersList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<CreateResponseSessionAffinityAttributesHeadersList>;

export type CreateResponseSessionAffinityAttributesSamesite = "Auto" | "Lax" | "None" | "Strict";
export const CreateResponseSessionAffinityAttributesSamesite = S.String;

export type CreateResponseSessionAffinityAttributesSecure = "Auto" | "Always" | "Never";
...
export type CreateResponseSessionAffinityAttributesZeroDowntimeFailover =
  ...
  | "temporary"
  | "sticky";
export const CreateResponseSessionAffinityAttributesZeroDowntimeFailover = S.String;
...
export const CreateResponseSessionAffinityAttributes = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    drainDuration: S.optional(S.NullOr(S.Number).pipe(T.Body("drain_duration"))),
    headers: S.optional(S.NullOr(CreateResponseSessionAffinityAttributesHeadersList)),
    requireAllHeaders: S.optional(S.NullOr(S.Boolean).pipe(T.Body("require_all_headers"))),
    samesite: S.optional(S.NullOr(CreateResponseSessionAffinityAttributesSamesite)),
    secure: S.optional(S.NullOr(CreateResponseSessionAffinityAttributesSecure)),
    zeroDowntimeFailover: S.optional(
      S.NullOr(CreateResponseSessionAffinityAttributesZeroDowntimeFailover).pipe(
        T.Body("zero_downtime_failover"),
      ),
    ),
  }),
...
export const CreateLoadBalancerResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    countryPools: S.optional(S.NullOr(CreateResponseCountryPoolsMap).pipe(T.Body("country_pools"))),
    createdOn: S.optional(S.NullOr(S.String).pipe(T.Body("created_on"))),
    defaultPools: S.optional(
    ...
    fallbackPool: S.optional(S.NullOr(S.String).pipe(T.Body("fallback_pool"))),
    locationStrategy: S.optional(
      S.NullOr(CreateResponseLocationStrategy).pipe(T.Body("location_strategy")),
    ),
    modifiedOn: S.optional(S.NullOr(S.String).pipe(T.Body("modified_on"))),
    name: S.optional(S.NullOr(S.String)),
    networks: S.optional(S.NullOr(CreateResponseNetworksList)),
    poolSets: S.optional(S.NullOr(CreateResponsePoolSetsList).pipe(T.Body("pool_sets"))),
    popPools: S.optional(S.NullOr(CreateResponsePopPoolsMap).pipe(T.Body("pop_pools"))),
    proxied: S.optional(S.NullOr(S.Boolean)),
    randomSteering: S.optional(
      S.NullOr(CreateResponseRandomSteering).pipe(T.Body("random_steering")),
    ),
    regionPools: S.optional(S.NullOr(CreateResponseRegionPoolsMap).pipe(T.Body("region_pools"))),
    rules: S.optional(S.NullOr(CreateResponseRulesList)),
    sessionAffinity: S.optional(
      S.NullOr(CreateResponseSessionAffinity).pipe(T.Body("session_affinity")),
    ),
    sessionAffinityAttributes: S.optional(
      S.NullOr(CreateResponseSessionAffinityAttributes).pipe(T.Body("session_affinity_attributes")),
    ),
    sessionAffinityTtl: S.optional(S.NullOr(S.Number).pipe(T.Body("session_affinity_ttl"))),
    steeringPolicy: S.optional(
...
export const CreateMonitorResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    consecutiveDown: S.optional(S.NullOr(S.Number).pipe(T.Body("consecutive_down"))),
    ...
    expectedCodes: S.optional(S.NullOr(S.String).pipe(T.Body("expected_codes"))),
...
export type MonitorGroupsCreateRequestMembersList = Array<MonitorGroupsCreateRequestMembersItem>;
...
export type MonitorGroupsCreateResponseMembersList = Array<MonitorGroupsCreateResponseMembersItem>;
...
export const MonitorsPreviewsCreateRequestHeaderValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export const PoolsCreateRequestOriginsItemHeaderHostList = /*@__PURE__*/ S.Array(
  S.String,
...
export const PoolsCreateRequestOriginsItemHeader = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    host: S.optional(PoolsCreateRequestOriginsItemHeaderHostList.pipe(T.Body("Host"))),
  }),
).annotate({
...
export type PoolsCreateRequestOriginsList = Array<PoolsCreateRequestOriginsItem>;
...
export const PoolsCreateRequestLoadShedding = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    defaultPolicy: S.optional(
      PoolsCreateRequestLoadSheddingDefaultPolicy.pipe(T.Body("default_policy")),
    ),
    sessionPercent: S.optional(S.Number.pipe(T.Body("session_percent"))),
    sessionPolicy: S.optional(
      PoolsCreateRequestLoadSheddingSessionPolicy.pipe(T.Body("session_policy")),
    ),
  }),
).annotate({
...
export const PoolsCreateRequestNotificationFilterOrigin = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export type PoolsCreateRequestNotificationFilterPool = PoolsCreateRequestNotificationFilterOrigin;
export const PoolsCreateRequestNotificationFilterPool = PoolsCreateRequestNotificationFilterOrigin;
...
export const CreatePoolRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    loadShedding: S.optional(PoolsCreateRequestLoadShedding.pipe(T.Body("load_shedding"))),
...
export type PoolsCreateResponseCheckRegionsList = Array<PoolsCreateResponseCheckRegionsItem>;
...
export type PoolsCreateResponseHealthSourcesItem = "local" | "regional" | "global";
export const PoolsCreateResponseHealthSourcesItem = S.String;

export type PoolsCreateResponseHealthSourcesList = Array<PoolsCreateResponseHealthSourcesItem>;
...
export const PoolsCreateResponseLoadShedding = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultPercent: S.optional(S.NullOr(S.Number).pipe(T.Body("default_percent"))),
    defaultPolicy: S.optional(
      S.NullOr(PoolsCreateResponseLoadSheddingDefaultPolicy).pipe(T.Body("default_policy")),
    ),
    sessionPercent: S.optional(S.NullOr(S.Number).pipe(T.Body("session_percent"))),
    sessionPolicy: S.optional(
      S.NullOr(PoolsCreateResponseLoadSheddingSessionPolicy).pipe(T.Body("session_policy")),
    ),
  }),
).annotate({
...
export type PoolsCreateResponseNotificationFilter = PoolsBulkEditResultItemNotificationFilter;
export const PoolsCreateResponseNotificationFilter = PoolsBulkEditResultItemNotificationFilter;
...
export const PoolsCreateResponseOriginsItemHeaderHostList = /*@__PURE__*/ S.Array(
  S.String,
...
export const PoolsCreateResponseOriginsItemHeader = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    host: S.optional(S.NullOr(PoolsCreateResponseOriginsItemHeaderHostList).pipe(T.Body("Host"))),
  }),
).annotate({
...
export type PoolsCreateResponseOriginsList = Array<PoolsCreateResponseOriginsItem>;
...
export const CreatePoolResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.NullOr(S.String)),
    checkRegions: S.optional(
      S.NullOr(PoolsCreateResponseCheckRegionsList).pipe(T.Body("check_regions")),
    ),
    createdOn: S.optional(S.NullOr(S.String).pipe(T.Body("created_on"))),
    description: S.optional(S.NullOr(S.String)),
    disabledAt: S.optional(S.NullOr(S.String).pipe(T.Body("disabled_at"))),
    enabled: S.optional(S.NullOr(S.Boolean)),
    healthSources: S.optional(
      S.NullOr(PoolsCreateResponseHealthSourcesList).pipe(T.Body("health_sources")),
    ),
    latitude: S.optional(S.NullOr(S.Number)),
    loadShedding: S.optional(
    ...
    originSteering: S.optional(
      S.NullOr(PoolsCreateResponseOriginSteering).pipe(T.Body("origin_steering")),
    ),
...
export type MonitorGroupsDeleteResponseMembersItem = MonitorGroupsCreateResponseMembersItem;
export const MonitorGroupsDeleteResponseMembersItem = MonitorGroupsCreateResponseMembersItem;

export type MonitorGroupsDeleteResponseMembersList = Array<MonitorGroupsCreateResponseMembersItem>;
...
export type GetResponseLocationStrategyPreferEcs = "always" | "never" | "proximity" | "geo";
...
export type GetResponsePoolSetsItemFixedResponse = CreateResponsePoolSetsItemFixedResponse;
export const GetResponsePoolSetsItemFixedResponse = CreateResponsePoolSetsItemFixedResponse;

export type GetResponsePoolSetsItemMatchTopologyCountriesList = Array<string>;
export const GetResponsePoolSetsItemMatchTopologyCountriesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetResponsePoolSetsItemMatchTopologyPopsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetResponsePoolSetsItemMatchTopologyRegionsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetResponsePoolSetsItemMatchTopology = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    countries: S.optional(S.NullOr(GetResponsePoolSetsItemMatchTopologyCountriesList)),
    pops: S.optional(S.NullOr(GetResponsePoolSetsItemMatchTopologyPopsList)),
    regions: S.optional(S.NullOr(GetResponsePoolSetsItemMatchTopologyRegionsList)),
  }),
).annotate({
...
export const GetResponsePoolSetsItemOverrides = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    poolDefaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("pool_default_weight"))),
    poolWeights: S.optional(
      S.NullOr(GetResponsePoolSetsItemOverridesPoolWeightsMap).pipe(T.Body("pool_weights")),
    ),
    pools: S.optional(S.NullOr(GetResponsePoolSetsItemOverridesPoolsList)),
    steeringPolicy: S.optional(
      S.NullOr(GetResponsePoolSetsItemOverridesSteeringPolicy).pipe(T.Body("steering_policy")),
    ),
  }),
).annotate({
...
export const GetResponseRandomSteering = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("default_weight"))),
    poolWeights: S.optional(
      S.NullOr(GetResponseRandomSteeringPoolWeightsMap).pipe(T.Body("pool_weights")),
    ),
  }),
).annotate({
...
export type GetResponseRulesItemFixedResponse = CreateResponsePoolSetsItemFixedResponse;
export const GetResponseRulesItemFixedResponse = CreateResponsePoolSetsItemFixedResponse;

export type GetResponseRulesItemOverridesAdaptiveRouting = CreateResponseAdaptiveRouting;
export const GetResponseRulesItemOverridesAdaptiveRouting = CreateResponseAdaptiveRouting;

export type GetResponseRulesItemOverridesCountryPoolsValueList = Array<string>;
export const GetResponseRulesItemOverridesCountryPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetResponseRulesItemOverridesCountryPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export const GetResponseRulesItemOverridesDefaultPoolsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<GetResponseRulesItemOverridesDefaultPoolsList>;

export type GetResponseRulesItemOverridesLocationStrategyMode = "pop" | "resolver_ip";
...
export const GetResponseRulesItemOverridesLocationStrategy = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    mode: S.optional(S.NullOr(GetResponseRulesItemOverridesLocationStrategyMode)),
    preferEcs: S.optional(
      S.NullOr(GetResponseRulesItemOverridesLocationStrategyPreferEcs).pipe(T.Body("prefer_ecs")),
    ),
  }),
).annotate({
...
export const GetResponseRulesItemOverridesPopPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetResponseRulesItemOverridesRandomSteeringPoolWeightsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Number,
...
export const GetResponseRulesItemOverridesRandomSteering = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("default_weight"))),
    poolWeights: S.optional(
      S.NullOr(GetResponseRulesItemOverridesRandomSteeringPoolWeightsMap).pipe(
        T.Body("pool_weights"),
      ),
    ),
  }),
...
export const GetResponseRulesItemOverridesRegionPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetResponseRulesItemOverridesRegionPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export type GetResponseRulesItemOverridesSessionAffinityAttributesHeadersList = Array<string>;
...
export type GetResponseRulesItemOverridesSessionAffinityAttributesSamesite =
  ...
  | "None"
  | "Strict";
export const GetResponseRulesItemOverridesSessionAffinityAttributesSamesite = S.String;

export type GetResponseRulesItemOverridesSessionAffinityAttributesSecure =
  | "Auto"
  | "Always"
  | "Never";
export const GetResponseRulesItemOverridesSessionAffinityAttributesSecure = S.String;

export type GetResponseRulesItemOverridesSessionAffinityAttributesZeroDowntimeFailover =
  | "none"
  | "temporary"
  | "sticky";
export const GetResponseRulesItemOverridesSessionAffinityAttributesZeroDowntimeFailover = S.String;
...
export const GetResponseRulesItemOverridesSessionAffinityAttributes = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    drainDuration: S.optional(S.NullOr(S.Number).pipe(T.Body("drain_duration"))),
    headers: S.optional(
      S.NullOr(GetResponseRulesItemOverridesSessionAffinityAttributesHeadersList),
    ),
    requireAllHeaders: S.optional(S.NullOr(S.Boolean).pipe(T.Body("require_all_headers"))),
    samesite: S.optional(S.NullOr(GetResponseRulesItemOverridesSessionAffinityAttributesSamesite)),
    secure: S.optional(S.NullOr(GetResponseRulesItemOverridesSessionAffinityAttributesSecure)),
    zeroDowntimeFailover: S.optional(
      S.NullOr(GetResponseRulesItemOverridesSessionAffinityAttributesZeroDowntimeFailover).pipe(
        T.Body("zero_downtime_failover"),
      ),
    ),
  }),
...
export const GetResponseRulesItemOverrides = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    countryPools: S.optional(
      S.NullOr(GetResponseRulesItemOverridesCountryPoolsMap).pipe(T.Body("country_pools")),
    ),
    defaultPools: S.optional(
      S.NullOr(GetResponseRulesItemOverridesDefaultPoolsList).pipe(T.Body("default_pools")),
    ),
    fallbackPool: S.optional(S.NullOr(S.String).pipe(T.Body("fallback_pool"))),
    locationStrategy: S.optional(
      S.NullOr(GetResponseRulesItemOverridesLocationStrategy).pipe(T.Body("location_strategy")),
    ),
    poolDefaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("pool_default_weight"))),
    poolWeights: S.optional(
      S.NullOr(GetResponseRulesItemOverridesPoolWeightsMap).pipe(T.Body("pool_weights")),
    ),
    pools: S.optional(S.NullOr(GetResponseRulesItemOverridesPoolsList)),
    popPools: S.optional(
      S.NullOr(GetResponseRulesItemOverridesPopPoolsMap).pipe(T.Body("pop_pools")),
    ),
    randomSteering: S.optional(
      S.NullOr(GetResponseRulesItemOverridesRandomSteering).pipe(T.Body("random_steering")),
    ),
    regionPools: S.optional(
      S.NullOr(GetResponseRulesItemOverridesRegionPoolsMap).pipe(T.Body("region_pools")),
    ),
    sessionAffinity: S.optional(
      S.NullOr(GetResponseRulesItemOverridesSessionAffinity).pipe(T.Body("session_affinity")),
    ),
    sessionAffinityAttributes: S.optional(
    ...
    sessionAffinityTtl: S.optional(S.NullOr(S.Number).pipe(T.Body("session_affinity_ttl"))),
    steeringPolicy: S.optional(
      S.NullOr(GetResponseRulesItemOverridesSteeringPolicy).pipe(T.Body("steering_policy")),
    ),
    ttl: S.optional(S.NullOr(S.Number)),
  }),
).annotate({
...
export type GetResponseSessionAffinity = "none" | "cookie" | "ip_cookie" | "header";
export const GetResponseSessionAffinity = S.String;

export type GetResponseSessionAffinityAttributesHeadersList = Array<string>;
export const GetResponseSessionAffinityAttributesHeadersList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<GetResponseSessionAffinityAttributesHeadersList>;

export type GetResponseSessionAffinityAttributesSamesite = "Auto" | "Lax" | "None" | "Strict";
export const GetResponseSessionAffinityAttributesSamesite = S.String;

export type GetResponseSessionAffinityAttributesSecure = "Auto" | "Always" | "Never";
...
export type GetResponseSessionAffinityAttributesZeroDowntimeFailover =
  ...
  | "temporary"
  | "sticky";
export const GetResponseSessionAffinityAttributesZeroDowntimeFailover = S.String;
...
export const GetResponseSessionAffinityAttributes = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    drainDuration: S.optional(S.NullOr(S.Number).pipe(T.Body("drain_duration"))),
    headers: S.optional(S.NullOr(GetResponseSessionAffinityAttributesHeadersList)),
    requireAllHeaders: S.optional(S.NullOr(S.Boolean).pipe(T.Body("require_all_headers"))),
    samesite: S.optional(S.NullOr(GetResponseSessionAffinityAttributesSamesite)),
...
export const GetLoadBalancerResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    countryPools: S.optional(S.NullOr(GetResponseCountryPoolsMap).pipe(T.Body("country_pools"))),
    createdOn: S.optional(S.NullOr(S.String).pipe(T.Body("created_on"))),
    defaultPools: S.optional(S.NullOr(GetResponseDefaultPoolsList).pipe(T.Body("default_pools"))),
    description: S.optional(S.NullOr(S.String)),
    enabled: S.optional(S.NullOr(S.Boolean)),
    fallbackPool: S.optional(S.NullOr(S.String).pipe(T.Body("fallback_pool"))),
    locationStrategy: S.optional(
    ...
    poolSets: S.optional(S.NullOr(GetResponsePoolSetsList).pipe(T.Body("pool_sets"))),
    popPools: S.optional(S.NullOr(GetResponsePopPoolsMap).pipe(T.Body("pop_pools"))),
    proxied: S.optional(S.NullOr(S.Boolean)),
    randomSteering: S.optional(S.NullOr(GetResponseRandomSteering).pipe(T.Body("random_steering"))),
    regionPools: S.optional(S.NullOr(GetResponseRegionPoolsMap).pipe(T.Body("region_pools"))),
    rules: S.optional(S.NullOr(GetResponseRulesList)),
    sessionAffinity: S.optional(
      S.NullOr(GetResponseSessionAffinity).pipe(T.Body("session_affinity")),
    ),
    sessionAffinityAttributes: S.optional(
      S.NullOr(GetResponseSessionAffinityAttributes).pipe(T.Body("session_affinity_attributes")),
    ),
    sessionAffinityTtl: S.optional(S.NullOr(S.Number).pipe(T.Body("session_affinity_ttl"))),
    steeringPolicy: S.optional(S.NullOr(GetResponseSteeringPolicy).pipe(T.Body("steering_policy"))),
    ttl: S.optional(S.NullOr(S.Number)),
    zoneName: S.optional(S.NullOr(S.String).pipe(T.Body("zone_name"))),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export type MonitorsGetResponseType = "http" | "https" | "tcp" | "udp_icmp" | "icmp_ping" | "smtp";
...
export type MonitorGroupsGetResponseMembersList = Array<MonitorGroupsCreateResponseMembersItem>;
...
export type MonitorGroupsReferencesGetResultItemReferenceType = "*" | "referral" | "referrer";
...
export const MonitorGroupsReferencesGetResultItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    referenceType: S.optional(
      S.NullOr(MonitorGroupsReferencesGetResultItemReferenceType).pipe(T.Body("reference_type")),
    ),
...
export type MonitorGroupsReferencesGetResultList = Array<MonitorGroupsReferencesGetResultItem>;
...
export type MonitorsReferencesGetResultItemReferenceType = "*" | "referral" | "referrer";
...
export const MonitorsReferencesGetResultItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    referenceType: S.optional(
      S.NullOr(MonitorsReferencesGetResultItemReferenceType).pipe(T.Body("reference_type")),
    ),
    resourceId: S.optional(S.NullOr(S.String).pipe(T.Body("resource_id"))),
    resourceName: S.optional(S.NullOr(S.String).pipe(T.Body("resource_name"))),
    resourceType: S.optional(S.NullOr(S.String).pipe(T.Body("resource_type"))),
...
export type MonitorsReferencesGetResultList = Array<MonitorsReferencesGetResultItem>;
...
export type PoolsGetResponseCheckRegionsList = Array<PoolsGetResponseCheckRegionsItem>;
...
export type PoolsGetResponseHealthSourcesList = Array<PoolsGetResponseHealthSourcesItem>;
...
export const PoolsGetResponseLoadShedding = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultPercent: S.optional(S.NullOr(S.Number).pipe(T.Body("default_percent"))),
    defaultPolicy: S.optional(
      S.NullOr(PoolsGetResponseLoadSheddingDefaultPolicy).pipe(T.Body("default_policy")),
    ),
    sessionPercent: S.optional(S.NullOr(S.Number).pipe(T.Body("session_percent"))),
    sessionPolicy: S.optional(
      S.NullOr(PoolsGetResponseLoadSheddingSessionPolicy).pipe(T.Body("session_policy")),
    ),
  }),
).annotate({
...
export type PoolsGetResponseNotificationFilter = PoolsBulkEditResultItemNotificationFilter;
export const PoolsGetResponseNotificationFilter = PoolsBulkEditResultItemNotificationFilter;
...
export const PoolsGetResponseOriginsItemHeader = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    host: S.optional(S.NullOr(PoolsGetResponseOriginsItemHeaderHostList).pipe(T.Body("Host"))),
  }),
).annotate({
...
export const GetPoolResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    enabled: S.optional(S.NullOr(S.Boolean)),
    healthSources: S.optional(
      S.NullOr(PoolsGetResponseHealthSourcesList).pipe(T.Body("health_sources")),
    ),
    latitude: S.optional(S.NullOr(S.Number)),
    loadShedding: S.optional(S.NullOr(PoolsGetResponseLoadShedding).pipe(T.Body("load_shedding"))),
    longitude: S.optional(S.NullOr(S.Number)),
    minimumOrigins: S.optional(S.NullOr(S.Number).pipe(T.Body("minimum_origins"))),
    modifiedOn: S.optional(S.NullOr(S.String).pipe(T.Body("modified_on"))),
    monitor: S.optional(S.NullOr(S.String)),
...
export const PoolsHealthGetResponsePopHealthOriginsItemIp = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    failureReason: S.optional(S.NullOr(S.String).pipe(T.Body("failure_reason"))),
    healthy: S.optional(S.NullOr(S.Boolean)),
    responseCode: S.optional(S.NullOr(S.Number).pipe(T.Body("response_code"))),
...
export const PoolsHealthGetResponsePopHealthOriginsItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const PoolsReferencesGetResultItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    referenceType: S.optional(
      S.NullOr(PoolsReferencesGetResultItemReferenceType).pipe(T.Body("reference_type")),
    ),
    resourceId: S.optional(S.NullOr(S.String).pipe(T.Body("resource_id"))),
    resourceName: S.optional(S.NullOr(S.String).pipe(T.Body("resource_name"))),
    resourceType: S.optional(S.NullOr(S.String).pipe(T.Body("resource_type"))),
...
export type PreviewsGetResultValueOriginsList = Array<PreviewsGetResultValueOriginsItemMap>;
...
export type ListResultItemLocationStrategyPreferEcs = "always" | "never" | "proximity" | "geo";
...
export const ListResultItemLocationStrategy = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    preferEcs: S.optional(
      S.NullOr(ListResultItemLocationStrategyPreferEcs).pipe(T.Body("prefer_ecs")),
    ),
  }),
).annotate({
...
export type ListResultItemPoolSetsItemFixedResponse = CreateResponsePoolSetsItemFixedResponse;
export const ListResultItemPoolSetsItemFixedResponse = CreateResponsePoolSetsItemFixedResponse;

export type ListResultItemPoolSetsItemMatchTopologyCountriesList = Array<string>;
export const ListResultItemPoolSetsItemMatchTopologyCountriesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ListResultItemPoolSetsItemMatchTopologyPopsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ListResultItemPoolSetsItemMatchTopologyRegionsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ListResultItemPoolSetsItemMatchTopology = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    countries: S.optional(S.NullOr(ListResultItemPoolSetsItemMatchTopologyCountriesList)),
    pops: S.optional(S.NullOr(ListResultItemPoolSetsItemMatchTopologyPopsList)),
    regions: S.optional(S.NullOr(ListResultItemPoolSetsItemMatchTopologyRegionsList)),
  }),
).annotate({
...
export const ListResultItemPoolSetsItemOverridesPoolWeightsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Number,
...
export const ListResultItemPoolSetsItemOverridesPoolsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ListResultItemPoolSetsItemOverrides = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    poolDefaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("pool_default_weight"))),
    poolWeights: S.optional(
      S.NullOr(ListResultItemPoolSetsItemOverridesPoolWeightsMap).pipe(T.Body("pool_weights")),
    ),
    pools: S.optional(S.NullOr(ListResultItemPoolSetsItemOverridesPoolsList)),
    steeringPolicy: S.optional(
      S.NullOr(ListResultItemPoolSetsItemOverridesSteeringPolicy).pipe(T.Body("steering_policy")),
    ),
  }),
).annotate({
...
export const ListResultItemRandomSteering = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("default_weight"))),
    poolWeights: S.optional(
      S.NullOr(ListResultItemRandomSteeringPoolWeightsMap).pipe(T.Body("pool_weights")),
    ),
  }),
).annotate({
...
export type ListResultItemRulesItemFixedResponse = CreateResponsePoolSetsItemFixedResponse;
export const ListResultItemRulesItemFixedResponse = CreateResponsePoolSetsItemFixedResponse;

export type ListResultItemRulesItemOverridesAdaptiveRouting = CreateResponseAdaptiveRouting;
export const ListResultItemRulesItemOverridesAdaptiveRouting = CreateResponseAdaptiveRouting;

export type ListResultItemRulesItemOverridesCountryPoolsValueList = Array<string>;
export const ListResultItemRulesItemOverridesCountryPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export type ListResultItemRulesItemOverridesCountryPoolsMap = {
  [key: string]: ListResultItemRulesItemOverridesCountryPoolsValueList | undefined;
};
export const ListResultItemRulesItemOverridesCountryPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export const ListResultItemRulesItemOverridesDefaultPoolsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<ListResultItemRulesItemOverridesDefaultPoolsList>;

export type ListResultItemRulesItemOverridesLocationStrategyMode = "pop" | "resolver_ip";
...
export type ListResultItemRulesItemOverridesLocationStrategyPreferEcs =
  ...
  | "proximity"
  | "geo";
export const ListResultItemRulesItemOverridesLocationStrategyPreferEcs = S.String;
...
export const ListResultItemRulesItemOverridesLocationStrategy = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    mode: S.optional(S.NullOr(ListResultItemRulesItemOverridesLocationStrategyMode)),
    preferEcs: S.optional(
      S.NullOr(ListResultItemRulesItemOverridesLocationStrategyPreferEcs).pipe(
        T.Body("prefer_ecs"),
      ),
    ),
  }),
...
export const ListResultItemRulesItemOverridesPopPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ListResultItemRulesItemOverridesPopPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export const ListResultItemRulesItemOverridesRandomSteeringPoolWeightsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Number,
...
export const ListResultItemRulesItemOverridesRandomSteering = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("default_weight"))),
    poolWeights: S.optional(
      S.NullOr(ListResultItemRulesItemOverridesRandomSteeringPoolWeightsMap).pipe(
        T.Body("pool_weights"),
      ),
    ),
  }),
...
export type ListResultItemRulesItemOverridesRegionPoolsValueList = Array<string>;
export const ListResultItemRulesItemOverridesRegionPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export type ListResultItemRulesItemOverridesRegionPoolsMap = {
  [key: string]: ListResultItemRulesItemOverridesRegionPoolsValueList | undefined;
};
export const ListResultItemRulesItemOverridesRegionPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export type ListResultItemRulesItemOverridesSessionAffinityAttributesHeadersList = Array<string>;
...
export type ListResultItemRulesItemOverridesSessionAffinityAttributesSamesite =
  ...
  | "None"
  | "Strict";
export const ListResultItemRulesItemOverridesSessionAffinityAttributesSamesite = S.String;

export type ListResultItemRulesItemOverridesSessionAffinityAttributesSecure =
  | "Auto"
  | "Always"
  | "Never";
export const ListResultItemRulesItemOverridesSessionAffinityAttributesSecure = S.String;
...
export const ListResultItemRulesItemOverridesSessionAffinityAttributes = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      drainDuration: S.optional(S.NullOr(S.Number).pipe(T.Body("drain_duration"))),
      headers: S.optional(
        S.NullOr(ListResultItemRulesItemOverridesSessionAffinityAttributesHeadersList),
      ),
      requireAllHeaders: S.optional(S.NullOr(S.Boolean).pipe(T.Body("require_all_headers"))),
      samesite: S.optional(
        S.NullOr(ListResultItemRulesItemOverridesSessionAffinityAttributesSamesite),
      ),
      secure: S.optional(S.NullOr(ListResultItemRulesItemOverridesSessionAffinityAttributesSecure)),
      zeroDowntimeFailover: S.optional(
        S.NullOr(
...
export const ListResultItemRulesItemOverrides = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    countryPools: S.optional(
      S.NullOr(ListResultItemRulesItemOverridesCountryPoolsMap).pipe(T.Body("country_pools")),
    ),
    defaultPools: S.optional(
      S.NullOr(ListResultItemRulesItemOverridesDefaultPoolsList).pipe(T.Body("default_pools")),
    ),
    fallbackPool: S.optional(S.NullOr(S.String).pipe(T.Body("fallback_pool"))),
    locationStrategy: S.optional(
      S.NullOr(ListResultItemRulesItemOverridesLocationStrategy).pipe(T.Body("location_strategy")),
    ),
    poolDefaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("pool_default_weight"))),
    poolWeights: S.optional(
      S.NullOr(ListResultItemRulesItemOverridesPoolWeightsMap).pipe(T.Body("pool_weights")),
    ),
    pools: S.optional(S.NullOr(ListResultItemRulesItemOverridesPoolsList)),
    popPools: S.optional(
      S.NullOr(ListResultItemRulesItemOverridesPopPoolsMap).pipe(T.Body("pop_pools")),
    ),
    randomSteering: S.optional(
      S.NullOr(ListResultItemRulesItemOverridesRandomSteering).pipe(T.Body("random_steering")),
    ),
    regionPools: S.optional(
      S.NullOr(ListResultItemRulesItemOverridesRegionPoolsMap).pipe(T.Body("region_pools")),
    ),
    sessionAffinity: S.optional(
      S.NullOr(ListResultItemRulesItemOverridesSessionAffinity).pipe(T.Body("session_affinity")),
    ),
    sessionAffinityAttributes: S.optional(
    ...
    sessionAffinityTtl: S.optional(S.NullOr(S.Number).pipe(T.Body("session_affinity_ttl"))),
    steeringPolicy: S.optional(
      S.NullOr(ListResultItemRulesItemOverridesSteeringPolicy).pipe(T.Body("steering_policy")),
    ),
    ttl: S.optional(S.NullOr(S.Number)),
  }),
).annotate({
...
export type ListResultItemSessionAffinity = "none" | "cookie" | "ip_cookie" | "header";
...
export const ListResultItemSessionAffinityAttributesHeadersList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<ListResultItemSessionAffinityAttributesHeadersList>;

export type ListResultItemSessionAffinityAttributesSamesite = "Auto" | "Lax" | "None" | "Strict";
export const ListResultItemSessionAffinityAttributesSamesite = S.String;

export type ListResultItemSessionAffinityAttributesSecure = "Auto" | "Always" | "Never";
...
export type ListResultItemSessionAffinityAttributesZeroDowntimeFailover =
  ...
  | "temporary"
  | "sticky";
export const ListResultItemSessionAffinityAttributesZeroDowntimeFailover = S.String;
...
export const ListResultItemSessionAffinityAttributes = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    drainDuration: S.optional(S.NullOr(S.Number).pipe(T.Body("drain_duration"))),
    headers: S.optional(S.NullOr(ListResultItemSessionAffinityAttributesHeadersList)),
    requireAllHeaders: S.optional(S.NullOr(S.Boolean).pipe(T.Body("require_all_headers"))),
    samesite: S.optional(S.NullOr(ListResultItemSessionAffinityAttributesSamesite)),
    secure: S.optional(S.NullOr(ListResultItemSessionAffinityAttributesSecure)),
    zeroDowntimeFailover: S.optional(
      S.NullOr(ListResultItemSessionAffinityAttributesZeroDowntimeFailover).pipe(
        T.Body("zero_downtime_failover"),
      ),
    ),
  }),
...
export const ListResultItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    countryPools: S.optional(S.NullOr(ListResultItemCountryPoolsMap).pipe(T.Body("country_pools"))),
    createdOn: S.optional(S.NullOr(S.String).pipe(T.Body("created_on"))),
    defaultPools: S.optional(
    ...
    fallbackPool: S.optional(S.NullOr(S.String).pipe(T.Body("fallback_pool"))),
    locationStrategy: S.optional(
      S.NullOr(ListResultItemLocationStrategy).pipe(T.Body("location_strategy")),
    ),
    modifiedOn: S.optional(S.NullOr(S.String).pipe(T.Body("modified_on"))),
    name: S.optional(S.NullOr(S.String)),
    networks: S.optional(S.NullOr(ListResultItemNetworksList)),
    poolSets: S.optional(S.NullOr(ListResultItemPoolSetsList).pipe(T.Body("pool_sets"))),
    popPools: S.optional(S.NullOr(ListResultItemPopPoolsMap).pipe(T.Body("pop_pools"))),
    proxied: S.optional(S.NullOr(S.Boolean)),
    randomSteering: S.optional(
      S.NullOr(ListResultItemRandomSteering).pipe(T.Body("random_steering")),
    ),
    regionPools: S.optional(S.NullOr(ListResultItemRegionPoolsMap).pipe(T.Body("region_pools"))),
    rules: S.optional(S.NullOr(ListResultItemRulesList)),
    sessionAffinity: S.optional(
      S.NullOr(ListResultItemSessionAffinity).pipe(T.Body("session_affinity")),
    ),
    sessionAffinityAttributes: S.optional(
      S.NullOr(ListResultItemSessionAffinityAttributes).pipe(T.Body("session_affinity_attributes")),
    ),
    sessionAffinityTtl: S.optional(S.NullOr(S.Number).pipe(T.Body("session_affinity_ttl"))),
    steeringPolicy: S.optional(
...
export type MonitorGroupsListResultItemMembersList = Array<MonitorGroupsCreateResponseMembersItem>;
...
export type PoolsListResultItemCheckRegionsList = Array<PoolsListResultItemCheckRegionsItem>;
...
export type PoolsListResultItemHealthSourcesItem = "local" | "regional" | "global";
export const PoolsListResultItemHealthSourcesItem = S.String;

export type PoolsListResultItemHealthSourcesList = Array<PoolsListResultItemHealthSourcesItem>;
...
export const PoolsListResultItemLoadShedding = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultPercent: S.optional(S.NullOr(S.Number).pipe(T.Body("default_percent"))),
    defaultPolicy: S.optional(
      S.NullOr(PoolsListResultItemLoadSheddingDefaultPolicy).pipe(T.Body("default_policy")),
    ),
    sessionPercent: S.optional(S.NullOr(S.Number).pipe(T.Body("session_percent"))),
    sessionPolicy: S.optional(
      S.NullOr(PoolsListResultItemLoadSheddingSessionPolicy).pipe(T.Body("session_policy")),
    ),
  }),
).annotate({
...
export type PoolsListResultItemNotificationFilter = PoolsBulkEditResultItemNotificationFilter;
export const PoolsListResultItemNotificationFilter = PoolsBulkEditResultItemNotificationFilter;
...
export const PoolsListResultItemOriginsItemHeaderHostList = /*@__PURE__*/ S.Array(
  S.String,
...
export const PoolsListResultItemOriginsItemHeader = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    host: S.optional(S.NullOr(PoolsListResultItemOriginsItemHeaderHostList).pipe(T.Body("Host"))),
  }),
).annotate({
...
export type PoolsListResultItemOriginsList = Array<PoolsListResultItemOriginsItem>;
...
export const PoolsListResultItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.NullOr(S.String)),
    checkRegions: S.optional(
      S.NullOr(PoolsListResultItemCheckRegionsList).pipe(T.Body("check_regions")),
    ),
    createdOn: S.optional(S.NullOr(S.String).pipe(T.Body("created_on"))),
    description: S.optional(S.NullOr(S.String)),
    disabledAt: S.optional(S.NullOr(S.String).pipe(T.Body("disabled_at"))),
    enabled: S.optional(S.NullOr(S.Boolean)),
    healthSources: S.optional(
      S.NullOr(PoolsListResultItemHealthSourcesList).pipe(T.Body("health_sources")),
    ),
    latitude: S.optional(S.NullOr(S.Number)),
    loadShedding: S.optional(
    ...
    originSteering: S.optional(
      S.NullOr(PoolsListResultItemOriginSteering).pipe(T.Body("origin_steering")),
    ),
...
export const SearchesListResponseResourcesItemReferencesList = /*@__PURE__*/ S.Array(
  S.Unknown,
) as any as S.Schema<SearchesListResponseResourcesItemReferencesList>;

export type SearchesListResponseResourcesItemResourceType = "load_balancer" | "monitor" | "pool";
...
export const SearchesListResponseResourcesItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    referenceType: S.optional(
      S.NullOr(SearchesListResponseResourcesItemReferenceType).pipe(T.Body("reference_type")),
    ),
    references: S.optional(S.NullOr(SearchesListResponseResourcesItemReferencesList)),
    resourceId: S.optional(S.NullOr(S.String).pipe(T.Body("resource_id"))),
    resourceName: S.optional(S.NullOr(S.String).pipe(T.Body("resource_name"))),
    resourceType: S.optional(
      S.NullOr(SearchesListResponseResourcesItemResourceType).pipe(T.Body("resource_type")),
    ),
  }),
).annotate({
...
export type SearchesListResponseResourcesList = Array<SearchesListResponseResourcesItem>;
...
export type EditRequestLocationStrategyPreferEcs = "always" | "never" | "proximity" | "geo";
...
export const EditRequestLocationStrategy = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    preferEcs: S.optional(EditRequestLocationStrategyPreferEcs.pipe(T.Body("prefer_ecs"))),
  }),
).annotate({
...
export const EditRequestRandomSteering = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultWeight: S.optional(S.Number.pipe(T.Body("default_weight"))),
    poolWeights: S.optional(EditRequestRandomSteeringPoolWeightsMap.pipe(T.Body("pool_weights"))),
  }),
).annotate({
...
export type EditRequestRulesItemFixedResponse = CreateRequestRulesItemFixedResponse;
export const EditRequestRulesItemFixedResponse = CreateRequestRulesItemFixedResponse;

export type EditRequestRulesItemOverridesAdaptiveRouting = CreateRequestAdaptiveRouting;
export const EditRequestRulesItemOverridesAdaptiveRouting = CreateRequestAdaptiveRouting;

export type EditRequestRulesItemOverridesCountryPoolsValueList = Array<string>;
export const EditRequestRulesItemOverridesCountryPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export const EditRequestRulesItemOverridesCountryPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export const EditRequestRulesItemOverridesDefaultPoolsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<EditRequestRulesItemOverridesDefaultPoolsList>;

export type EditRequestRulesItemOverridesLocationStrategyMode = "pop" | "resolver_ip";
...
export interface EditRequestRulesItemOverridesLocationStrategy {
  ...
  /** Whether the EDNS Client Subnet (ECS) GeoIP should be preferred as the authoritative location. */
  preferEcs?: EditRequestRulesItemOverridesLocationStrategyPreferEcs | (string & {});
}
export const EditRequestRulesItemOverridesLocationStrategy = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    mode: S.optional(EditRequestRulesItemOverridesLocationStrategyMode),
    preferEcs: S.optional(
      EditRequestRulesItemOverridesLocationStrategyPreferEcs.pipe(T.Body("prefer_ecs")),
    ),
  }),
).annotate({
...
export const EditRequestRulesItemOverridesPopPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export const EditRequestRulesItemOverridesRandomSteeringPoolWeightsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Number,
...
export const EditRequestRulesItemOverridesRandomSteering = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultWeight: S.optional(S.Number.pipe(T.Body("default_weight"))),
    poolWeights: S.optional(
      EditRequestRulesItemOverridesRandomSteeringPoolWeightsMap.pipe(T.Body("pool_weights")),
    ),
  }),
).annotate({
...
export const EditRequestRulesItemOverridesRegionPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export const EditRequestRulesItemOverridesRegionPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export type EditRequestRulesItemOverridesSessionAffinityAttributesHeadersList = Array<string>;
...
export type EditRequestRulesItemOverridesSessionAffinityAttributesSamesite =
  ...
  | "None"
  | "Strict";
export const EditRequestRulesItemOverridesSessionAffinityAttributesSamesite = S.String;

export type EditRequestRulesItemOverridesSessionAffinityAttributesSecure =
  | "Auto"
  | "Always"
  | "Never";
export const EditRequestRulesItemOverridesSessionAffinityAttributesSecure = S.String;

export type EditRequestRulesItemOverridesSessionAffinityAttributesZeroDowntimeFailover =
  | "none"
  | "temporary"
  | "sticky";
export const EditRequestRulesItemOverridesSessionAffinityAttributesZeroDowntimeFailover = S.String;
...
export interface EditRequestRulesItemOverridesSessionAffinityAttributes {
  ...
  requireAllHeaders?: boolean;
  /** Configures the SameSite attribute on session affinity cookie. Value "Auto" will be translated to "Lax" or "None" depending if Always Use HTTPS is enabled. Note: when using value "None", the secure attribute can not be set to "Never". */
  samesite?: EditRequestRulesItemOverridesSessionAffinityAttributesSamesite | (string & {});
  /** Configures the Secure attribute on session affinity cookie. Value "Always" indicates the Secure attribute will be set in the Set-Cookie header, "Never" indicates the Secure attribute will not be set, and "Auto" will set the Secure attribute depending if Always Use HTTPS is enabled. */
  secure?: EditRequestRulesItemOverridesSessionAffinityAttributesSecure | (string & {});
  /** Configures the zero-downtime failover between origins within a pool when session affinity is enabled. This feature is currently incompatible with Argo, Tiered Cache, and Bandwidth Alliance. The supported values are: - `"none"`: No failover takes place for sessions pinned to the origin (default). - `"temporary"`: Traffic will be sent to another other healthy origin until the originally pinned origin is available; note that this can potentially result in heavy origin flapping. - `"sticky"`: The session affinity cookie is updated and subsequent requests are sent to the new origin. Note: Zero-downtime failover with sticky sessions is currently not supported for session affinity by header. */
  zeroDowntimeFailover?:
    | EditRequestRulesItemOverridesSessionAffinityAttributesZeroDowntimeFailover
    | (string & {});
}
export const EditRequestRulesItemOverridesSessionAffinityAttributes = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    drainDuration: S.optional(S.Number.pipe(T.Body("drain_duration"))),
    headers: S.optional(EditRequestRulesItemOverridesSessionAffinityAttributesHeadersList),
    requireAllHeaders: S.optional(S.Boolean.pipe(T.Body("require_all_headers"))),
    samesite: S.optional(EditRequestRulesItemOverridesSessionAffinityAttributesSamesite),
...
export interface EditRequestRulesItemOverrides {
  ...
  /** Specifies the type of session affinity the load balancer should use unless specified as `"none"`. The supported types are: - `"cookie"`: On the first request to a proxied load balancer, a cookie is generated, encoding information of which origin the request will be forwarded to. Subsequent requests, by the same client to the same load balancer, will be sent to the origin server the cookie encodes, for the duration of the cookie and as long as the origin server remains healthy. If the cookie has expired or the origin server is unhealthy, then a new origin server is calculated and used. - `"ip_cookie"`: Behaves the same as `"cookie"` except the initial origin selection is stable and based on the client's ip address. - `"header"`: On the first request to a proxied load balancer, a session key based on the configured HTTP headers (see `session_affinity_attributes.headers`) is generated, encoding the request headers used for storing in the load balancer session state which origin the request will be forwarded to. Subsequent requests to the load balancer with the same headers will be sent to the same origin server, for the duration of the session and as long as the origin server remains healthy. If the session has been idle for the duration of `session_affinity_ttl` seconds or the origin server is unhealthy, then a new origin server is calculated and used. See `headers` in `session_affinity_attributes` for additional required configuration. */
  sessionAffinity?: EditRequestRulesItemOverridesSessionAffinity | (string & {});
  /** Configures attributes for session affinity. */
...
export const EditRequestRulesItemOverrides = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    adaptiveRouting: S.optional(CreateRequestAdaptiveRouting.pipe(T.Body("adaptive_routing"))),
    countryPools: S.optional(
      EditRequestRulesItemOverridesCountryPoolsMap.pipe(T.Body("country_pools")),
    ),
    defaultPools: S.optional(
      EditRequestRulesItemOverridesDefaultPoolsList.pipe(T.Body("default_pools")),
    ),
    fallbackPool: S.optional(S.String.pipe(T.Body("fallback_pool"))),
    locationStrategy: S.optional(
      EditRequestRulesItemOverridesLocationStrategy.pipe(T.Body("location_strategy")),
    ),
    poolDefaultWeight: S.optional(S.Number.pipe(T.Body("pool_default_weight"))),
    poolWeights: S.optional(
    ...
    popPools: S.optional(EditRequestRulesItemOverridesPopPoolsMap.pipe(T.Body("pop_pools"))),
    randomSteering: S.optional(
      EditRequestRulesItemOverridesRandomSteering.pipe(T.Body("random_steering")),
    ),
    regionPools: S.optional(
      EditRequestRulesItemOverridesRegionPoolsMap.pipe(T.Body("region_pools")),
    ),
    sessionAffinity: S.optional(
      EditRequestRulesItemOverridesSessionAffinity.pipe(T.Body("session_affinity")),
    ),
    sessionAffinityAttributes: S.optional(
    ...
    sessionAffinityTtl: S.optional(S.Number.pipe(T.Body("session_affinity_ttl"))),
    steeringPolicy: S.optional(
      EditRequestRulesItemOverridesSteeringPolicy.pipe(T.Body("steering_policy")),
    ),
    ttl: S.optional(S.Number),
  }),
).annotate({
...
export type EditRequestSessionAffinity = "none" | "cookie" | "ip_cookie" | "header";
export const EditRequestSessionAffinity = S.String;

export type EditRequestSessionAffinityAttributesHeadersList = Array<string>;
export const EditRequestSessionAffinityAttributesHeadersList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<EditRequestSessionAffinityAttributesHeadersList>;

export type EditRequestSessionAffinityAttributesSamesite = "Auto" | "Lax" | "None" | "Strict";
export const EditRequestSessionAffinityAttributesSamesite = S.String;

export type EditRequestSessionAffinityAttributesSecure = "Auto" | "Always" | "Never";
...
export type EditRequestSessionAffinityAttributesZeroDowntimeFailover =
  ...
  | "temporary"
  | "sticky";
export const EditRequestSessionAffinityAttributesZeroDowntimeFailover = S.String;
...
export interface EditRequestSessionAffinityAttributes {
  ...
  /** Configures the zero-downtime failover between origins within a pool when session affinity is enabled. This feature is currently incompatible with Argo, Tiered Cache, and Bandwidth Alliance. The supported values are: - `"none"`: No failover takes place for sessions pinned to the origin (default). - `"temporary"`: Traffic will be sent to another other healthy origin until the originally pinned origin is available; note that this can potentially result in heavy origin flapping. - `"sticky"`: The session affinity cookie is updated and subsequent requests are sent to the new origin. Note: Zero-downtime failover with sticky sessions is currently not supported for session affinity by header. */
  zeroDowntimeFailover?: EditRequestSessionAffinityAttributesZeroDowntimeFailover | (string & {});
}
...
export const PatchLoadBalancerRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    loadBalancerId: S.String.pipe(T.Label("load_balancer_id")),
    adaptiveRouting: S.optional(CreateRequestAdaptiveRouting.pipe(T.Body("adaptive_routing"))),
    countryPools: S.optional(EditRequestCountryPoolsMap.pipe(T.Body("country_pools"))),
    defaultPools: S.optional(EditRequestDefaultPoolsList.pipe(T.Body("default_pools"))),
    description: S.optional(S.String),
    enabled: S.optional(S.Boolean),
    fallbackPool: S.optional(S.String.pipe(T.Body("fallback_pool"))),
    locationStrategy: S.optional(EditRequestLocationStrategy.pipe(T.Body("location_strategy"))),
    name: S.optional(S.String),
    networks: S.optional(EditRequestNetworksList),
    popPools: S.optional(EditRequestPopPoolsMap.pipe(T.Body("pop_pools"))),
    proxied: S.optional(S.Boolean),
    randomSteering: S.optional(EditRequestRandomSteering.pipe(T.Body("random_steering"))),
    regionPools: S.optional(EditRequestRegionPoolsMap.pipe(T.Body("region_pools"))),
    rules: S.optional(EditRequestRulesList),
    sessionAffinity: S.optional(EditRequestSessionAffinity.pipe(T.Body("session_affinity"))),
    sessionAffinityAttributes: S.optional(
      EditRequestSessionAffinityAttributes.pipe(T.Body("session_affinity_attributes")),
    ),
    sessionAffinityTtl: S.optional(S.Number.pipe(T.Body("session_affinity_ttl"))),
    steeringPolicy: S.optional(EditRequestSteeringPolicy.pipe(T.Body("steering_policy"))),
    ttl: S.optional(S.Number),
  })
    .pipe(
      T.Http({
...
export type EditResponseLocationStrategyPreferEcs = "always" | "never" | "proximity" | "geo";
...
export const EditResponseLocationStrategy = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    preferEcs: S.optional(
      S.NullOr(EditResponseLocationStrategyPreferEcs).pipe(T.Body("prefer_ecs")),
    ),
  }),
).annotate({
...
export type EditResponsePoolSetsItemFixedResponse = CreateResponsePoolSetsItemFixedResponse;
export const EditResponsePoolSetsItemFixedResponse = CreateResponsePoolSetsItemFixedResponse;

export type EditResponsePoolSetsItemMatchTopologyCountriesList = Array<string>;
export const EditResponsePoolSetsItemMatchTopologyCountriesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const EditResponsePoolSetsItemMatchTopologyPopsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const EditResponsePoolSetsItemMatchTopologyRegionsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const EditResponsePoolSetsItemMatchTopology = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    countries: S.optional(S.NullOr(EditResponsePoolSetsItemMatchTopologyCountriesList)),
    pops: S.optional(S.NullOr(EditResponsePoolSetsItemMatchTopologyPopsList)),
    regions: S.optional(S.NullOr(EditResponsePoolSetsItemMatchTopologyRegionsList)),
  }),
).annotate({
...
export const EditResponsePoolSetsItemOverrides = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    poolDefaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("pool_default_weight"))),
    poolWeights: S.optional(
      S.NullOr(EditResponsePoolSetsItemOverridesPoolWeightsMap).pipe(T.Body("pool_weights")),
    ),
    pools: S.optional(S.NullOr(EditResponsePoolSetsItemOverridesPoolsList)),
    steeringPolicy: S.optional(
      S.NullOr(EditResponsePoolSetsItemOverridesSteeringPolicy).pipe(T.Body("steering_policy")),
    ),
  }),
).annotate({
...
export const EditResponseRandomSteering = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("default_weight"))),
    poolWeights: S.optional(
      S.NullOr(EditResponseRandomSteeringPoolWeightsMap).pipe(T.Body("pool_weights")),
    ),
  }),
).annotate({
...
export type EditResponseRulesItemFixedResponse = CreateResponsePoolSetsItemFixedResponse;
export const EditResponseRulesItemFixedResponse = CreateResponsePoolSetsItemFixedResponse;

export type EditResponseRulesItemOverridesAdaptiveRouting = CreateResponseAdaptiveRouting;
export const EditResponseRulesItemOverridesAdaptiveRouting = CreateResponseAdaptiveRouting;

export type EditResponseRulesItemOverridesCountryPoolsValueList = Array<string>;
export const EditResponseRulesItemOverridesCountryPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export type EditResponseRulesItemOverridesCountryPoolsMap = {
  [key: string]: EditResponseRulesItemOverridesCountryPoolsValueList | undefined;
};
export const EditResponseRulesItemOverridesCountryPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export const EditResponseRulesItemOverridesDefaultPoolsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<EditResponseRulesItemOverridesDefaultPoolsList>;

export type EditResponseRulesItemOverridesLocationStrategyMode = "pop" | "resolver_ip";
...
export const EditResponseRulesItemOverridesLocationStrategy = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    mode: S.optional(S.NullOr(EditResponseRulesItemOverridesLocationStrategyMode)),
    preferEcs: S.optional(
      S.NullOr(EditResponseRulesItemOverridesLocationStrategyPreferEcs).pipe(T.Body("prefer_ecs")),
    ),
  }),
).annotate({
...
export const EditResponseRulesItemOverridesPopPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export const EditResponseRulesItemOverridesRandomSteeringPoolWeightsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Number,
...
export const EditResponseRulesItemOverridesRandomSteering = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("default_weight"))),
    poolWeights: S.optional(
      S.NullOr(EditResponseRulesItemOverridesRandomSteeringPoolWeightsMap).pipe(
        T.Body("pool_weights"),
      ),
    ),
  }),
...
export const EditResponseRulesItemOverridesRegionPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export const EditResponseRulesItemOverridesRegionPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export type EditResponseRulesItemOverridesSessionAffinityAttributesHeadersList = Array<string>;
...
export type EditResponseRulesItemOverridesSessionAffinityAttributesSamesite =
  ...
  | "None"
  | "Strict";
export const EditResponseRulesItemOverridesSessionAffinityAttributesSamesite = S.String;

export type EditResponseRulesItemOverridesSessionAffinityAttributesSecure =
  | "Auto"
  | "Always"
  | "Never";
export const EditResponseRulesItemOverridesSessionAffinityAttributesSecure = S.String;

export type EditResponseRulesItemOverridesSessionAffinityAttributesZeroDowntimeFailover =
  | "none"
  | "temporary"
  | "sticky";
export const EditResponseRulesItemOverridesSessionAffinityAttributesZeroDowntimeFailover = S.String;
...
export const EditResponseRulesItemOverridesSessionAffinityAttributes = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    drainDuration: S.optional(S.NullOr(S.Number).pipe(T.Body("drain_duration"))),
    headers: S.optional(
      S.NullOr(EditResponseRulesItemOverridesSessionAffinityAttributesHeadersList),
    ),
    requireAllHeaders: S.optional(S.NullOr(S.Boolean).pipe(T.Body("require_all_headers"))),
    samesite: S.optional(S.NullOr(EditResponseRulesItemOverridesSessionAffinityAttributesSamesite)),
    secure: S.optional(S.NullOr(EditResponseRulesItemOverridesSessionAffinityAttributesSecure)),
    zeroDowntimeFailover: S.optional(
      S.NullOr(EditResponseRulesItemOverridesSessionAffinityAttributesZeroDowntimeFailover).pipe(
        T.Body("zero_downtime_failover"),
      ),
    ),
  }),
...
export const EditResponseRulesItemOverrides = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    countryPools: S.optional(
      S.NullOr(EditResponseRulesItemOverridesCountryPoolsMap).pipe(T.Body("country_pools")),
    ),
    defaultPools: S.optional(
      S.NullOr(EditResponseRulesItemOverridesDefaultPoolsList).pipe(T.Body("default_pools")),
    ),
    fallbackPool: S.optional(S.NullOr(S.String).pipe(T.Body("fallback_pool"))),
    locationStrategy: S.optional(
      S.NullOr(EditResponseRulesItemOverridesLocationStrategy).pipe(T.Body("location_strategy")),
    ),
    poolDefaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("pool_default_weight"))),
    poolWeights: S.optional(
      S.NullOr(EditResponseRulesItemOverridesPoolWeightsMap).pipe(T.Body("pool_weights")),
    ),
    pools: S.optional(S.NullOr(EditResponseRulesItemOverridesPoolsList)),
    popPools: S.optional(
      S.NullOr(EditResponseRulesItemOverridesPopPoolsMap).pipe(T.Body("pop_pools")),
    ),
    randomSteering: S.optional(
      S.NullOr(EditResponseRulesItemOverridesRandomSteering).pipe(T.Body("random_steering")),
    ),
    regionPools: S.optional(
      S.NullOr(EditResponseRulesItemOverridesRegionPoolsMap).pipe(T.Body("region_pools")),
    ),
    sessionAffinity: S.optional(
      S.NullOr(EditResponseRulesItemOverridesSessionAffinity).pipe(T.Body("session_affinity")),
    ),
    sessionAffinityAttributes: S.optional(
    ...
    sessionAffinityTtl: S.optional(S.NullOr(S.Number).pipe(T.Body("session_affinity_ttl"))),
    steeringPolicy: S.optional(
      S.NullOr(EditResponseRulesItemOverridesSteeringPolicy).pipe(T.Body("steering_policy")),
    ),
    ttl: S.optional(S.NullOr(S.Number)),
  }),
).annotate({
...
export type EditResponseSessionAffinity = "none" | "cookie" | "ip_cookie" | "header";
...
export const EditResponseSessionAffinityAttributesHeadersList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<EditResponseSessionAffinityAttributesHeadersList>;

export type EditResponseSessionAffinityAttributesSamesite = "Auto" | "Lax" | "None" | "Strict";
export const EditResponseSessionAffinityAttributesSamesite = S.String;

export type EditResponseSessionAffinityAttributesSecure = "Auto" | "Always" | "Never";
...
export type EditResponseSessionAffinityAttributesZeroDowntimeFailover =
  ...
  | "temporary"
  | "sticky";
export const EditResponseSessionAffinityAttributesZeroDowntimeFailover = S.String;
...
export const EditResponseSessionAffinityAttributes = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    drainDuration: S.optional(S.NullOr(S.Number).pipe(T.Body("drain_duration"))),
    headers: S.optional(S.NullOr(EditResponseSessionAffinityAttributesHeadersList)),
    requireAllHeaders: S.optional(S.NullOr(S.Boolean).pipe(T.Body("require_all_headers"))),
    samesite: S.optional(S.NullOr(EditResponseSessionAffinityAttributesSamesite)),
    secure: S.optional(S.NullOr(EditResponseSessionAffinityAttributesSecure)),
    zeroDowntimeFailover: S.optional(
      S.NullOr(EditResponseSessionAffinityAttributesZeroDowntimeFailover).pipe(
        T.Body("zero_downtime_failover"),
      ),
    ),
  }),
...
export const PatchLoadBalancerResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    countryPools: S.optional(S.NullOr(EditResponseCountryPoolsMap).pipe(T.Body("country_pools"))),
    createdOn: S.optional(S.NullOr(S.String).pipe(T.Body("created_on"))),
    defaultPools: S.optional(S.NullOr(EditResponseDefaultPoolsList).pipe(T.Body("default_pools"))),
    description: S.optional(S.NullOr(S.String)),
    enabled: S.optional(S.NullOr(S.Boolean)),
    fallbackPool: S.optional(S.NullOr(S.String).pipe(T.Body("fallback_pool"))),
    locationStrategy: S.optional(
    ...
    poolSets: S.optional(S.NullOr(EditResponsePoolSetsList).pipe(T.Body("pool_sets"))),
    popPools: S.optional(S.NullOr(EditResponsePopPoolsMap).pipe(T.Body("pop_pools"))),
    proxied: S.optional(S.NullOr(S.Boolean)),
    randomSteering: S.optional(
      S.NullOr(EditResponseRandomSteering).pipe(T.Body("random_steering")),
    ),
    regionPools: S.optional(S.NullOr(EditResponseRegionPoolsMap).pipe(T.Body("region_pools"))),
    rules: S.optional(S.NullOr(EditResponseRulesList)),
    sessionAffinity: S.optional(
      S.NullOr(EditResponseSessionAffinity).pipe(T.Body("session_affinity")),
    ),
    sessionAffinityAttributes: S.optional(
      S.NullOr(EditResponseSessionAffinityAttributes).pipe(T.Body("session_affinity_attributes")),
    ),
    sessionAffinityTtl: S.optional(S.NullOr(S.Number).pipe(T.Body("session_affinity_ttl"))),
    steeringPolicy: S.optional(
...
export type MonitorsEditRequestType = "http" | "https" | "tcp" | "udp_icmp" | "icmp_ping" | "smtp";
...
export type MonitorsEditResponseType = "http" | "https" | "tcp" | "udp_icmp" | "icmp_ping" | "smtp";
...
export type MonitorGroupsEditRequestMembersList = Array<MonitorGroupsCreateRequestMembersItem>;
...
export type MonitorGroupsEditResponseMembersList = Array<MonitorGroupsCreateResponseMembersItem>;
...
export type PoolsEditRequestNotificationFilterOrigin = PoolsCreateRequestNotificationFilterOrigin;
export const PoolsEditRequestNotificationFilterOrigin = PoolsCreateRequestNotificationFilterOrigin;

export type PoolsEditRequestNotificationFilterPool = PoolsCreateRequestNotificationFilterOrigin;
export const PoolsEditRequestNotificationFilterPool = PoolsCreateRequestNotificationFilterOrigin;

export type PoolsEditRequestNotificationFilter = PoolsCreateRequestNotificationFilter;
export const PoolsEditRequestNotificationFilter = PoolsCreateRequestNotificationFilter;
...
export const PoolsEditRequestOriginsItemHeader = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    host: S.optional(PoolsEditRequestOriginsItemHeaderHostList.pipe(T.Body("Host"))),
  }),
).annotate({
...
export const PatchPoolRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    accountId: S.String.pipe(T.Label("account_id")),
    poolId: S.String.pipe(T.Label("pool_id")),
    checkRegions: S.optional(PoolsEditRequestCheckRegionsList.pipe(T.Body("check_regions"))),
    description: S.optional(S.String),
    enabled: S.optional(S.Boolean),
    healthSources: S.optional(PoolsEditRequestHealthSourcesList.pipe(T.Body("health_sources"))),
    latitude: S.optional(S.Number),
    loadShedding: S.optional(PoolsEditRequestLoadShedding.pipe(T.Body("load_shedding"))),
    longitude: S.optional(S.Number),
    minimumOrigins: S.optional(S.Number.pipe(T.Body("minimum_origins"))),
    monitor: S.optional(S.String),
    monitorGroup: S.optional(S.String.pipe(T.Body("monitor_group"))),
    ...
    originSteering: S.optional(PoolsEditRequestOriginSteering.pipe(T.Body("origin_steering"))),
...
export type PoolsEditResponseCheckRegionsList = Array<PoolsEditResponseCheckRegionsItem>;
...
export type PoolsEditResponseHealthSourcesItem = "local" | "regional" | "global";
export const PoolsEditResponseHealthSourcesItem = S.String;

export type PoolsEditResponseHealthSourcesList = Array<PoolsEditResponseHealthSourcesItem>;
...
export const PoolsEditResponseLoadShedding = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultPercent: S.optional(S.NullOr(S.Number).pipe(T.Body("default_percent"))),
    defaultPolicy: S.optional(
      S.NullOr(PoolsEditResponseLoadSheddingDefaultPolicy).pipe(T.Body("default_policy")),
    ),
    sessionPercent: S.optional(S.NullOr(S.Number).pipe(T.Body("session_percent"))),
    sessionPolicy: S.optional(
      S.NullOr(PoolsEditResponseLoadSheddingSessionPolicy).pipe(T.Body("session_policy")),
    ),
  }),
).annotate({
...
export type PoolsEditResponseNotificationFilter = PoolsBulkEditResultItemNotificationFilter;
export const PoolsEditResponseNotificationFilter = PoolsBulkEditResultItemNotificationFilter;
...
export const PoolsEditResponseOriginsItemHeader = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    host: S.optional(S.NullOr(PoolsEditResponseOriginsItemHeaderHostList).pipe(T.Body("Host"))),
  }),
).annotate({
...
export const PatchPoolResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    enabled: S.optional(S.NullOr(S.Boolean)),
    healthSources: S.optional(
      S.NullOr(PoolsEditResponseHealthSourcesList).pipe(T.Body("health_sources")),
    ),
    latitude: S.optional(S.NullOr(S.Number)),
    loadShedding: S.optional(S.NullOr(PoolsEditResponseLoadShedding).pipe(T.Body("load_shedding"))),
    longitude: S.optional(S.NullOr(S.Number)),
    minimumOrigins: S.optional(S.NullOr(S.Number).pipe(T.Body("minimum_origins"))),
    modifiedOn: S.optional(S.NullOr(S.String).pipe(T.Body("modified_on"))),
    monitor: S.optional(S.NullOr(S.String)),
...
export type UpdateRequestLocationStrategyPreferEcs = "always" | "never" | "proximity" | "geo";
...
export const UpdateRequestLocationStrategy = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    preferEcs: S.optional(UpdateRequestLocationStrategyPreferEcs.pipe(T.Body("prefer_ecs"))),
  }),
).annotate({
...
export const UpdateRequestRandomSteering = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultWeight: S.optional(S.Number.pipe(T.Body("default_weight"))),
    poolWeights: S.optional(UpdateRequestRandomSteeringPoolWeightsMap.pipe(T.Body("pool_weights"))),
  }),
).annotate({
...
export type UpdateRequestRulesItemFixedResponse = CreateRequestRulesItemFixedResponse;
export const UpdateRequestRulesItemFixedResponse = CreateRequestRulesItemFixedResponse;

export type UpdateRequestRulesItemOverridesAdaptiveRouting = CreateRequestAdaptiveRouting;
export const UpdateRequestRulesItemOverridesAdaptiveRouting = CreateRequestAdaptiveRouting;

export type UpdateRequestRulesItemOverridesCountryPoolsValueList = Array<string>;
export const UpdateRequestRulesItemOverridesCountryPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export type UpdateRequestRulesItemOverridesCountryPoolsMap = {
  [key: string]: UpdateRequestRulesItemOverridesCountryPoolsValueList | undefined;
};
export const UpdateRequestRulesItemOverridesCountryPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export const UpdateRequestRulesItemOverridesDefaultPoolsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<UpdateRequestRulesItemOverridesDefaultPoolsList>;

export type UpdateRequestRulesItemOverridesLocationStrategyMode = "pop" | "resolver_ip";
...
export type UpdateRequestRulesItemOverridesLocationStrategyPreferEcs =
  ...
  | "proximity"
  | "geo";
export const UpdateRequestRulesItemOverridesLocationStrategyPreferEcs = S.String;
...
export interface UpdateRequestRulesItemOverridesLocationStrategy {
  ...
  /** Whether the EDNS Client Subnet (ECS) GeoIP should be preferred as the authoritative location. */
  preferEcs?: UpdateRequestRulesItemOverridesLocationStrategyPreferEcs | (string & {});
}
export const UpdateRequestRulesItemOverridesLocationStrategy = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    mode: S.optional(UpdateRequestRulesItemOverridesLocationStrategyMode),
    preferEcs: S.optional(
      UpdateRequestRulesItemOverridesLocationStrategyPreferEcs.pipe(T.Body("prefer_ecs")),
    ),
  }),
).annotate({
...
export const UpdateRequestRulesItemOverridesPopPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateRequestRulesItemOverridesPopPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export const UpdateRequestRulesItemOverridesRandomSteeringPoolWeightsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Number,
...
export const UpdateRequestRulesItemOverridesRandomSteering = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultWeight: S.optional(S.Number.pipe(T.Body("default_weight"))),
    poolWeights: S.optional(
      UpdateRequestRulesItemOverridesRandomSteeringPoolWeightsMap.pipe(T.Body("pool_weights")),
    ),
  }),
).annotate({
...
export const UpdateRequestRulesItemOverridesRegionPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export type UpdateRequestRulesItemOverridesRegionPoolsMap = {
  [key: string]: UpdateRequestRulesItemOverridesRegionPoolsValueList | undefined;
};
export const UpdateRequestRulesItemOverridesRegionPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export type UpdateRequestRulesItemOverridesSessionAffinityAttributesHeadersList = Array<string>;
...
export type UpdateRequestRulesItemOverridesSessionAffinityAttributesSamesite =
  ...
  | "None"
  | "Strict";
export const UpdateRequestRulesItemOverridesSessionAffinityAttributesSamesite = S.String;

export type UpdateRequestRulesItemOverridesSessionAffinityAttributesSecure =
  | "Auto"
  | "Always"
  | "Never";
export const UpdateRequestRulesItemOverridesSessionAffinityAttributesSecure = S.String;
...
export interface UpdateRequestRulesItemOverridesSessionAffinityAttributes {
  ...
  requireAllHeaders?: boolean;
  /** Configures the SameSite attribute on session affinity cookie. Value "Auto" will be translated to "Lax" or "None" depending if Always Use HTTPS is enabled. Note: when using value "None", the secure attribute can not be set to "Never". */
  samesite?: UpdateRequestRulesItemOverridesSessionAffinityAttributesSamesite | (string & {});
  /** Configures the Secure attribute on session affinity cookie. Value "Always" indicates the Secure attribute will be set in the Set-Cookie header, "Never" indicates the Secure attribute will not be set, and "Auto" will set the Secure attribute depending if Always Use HTTPS is enabled. */
  secure?: UpdateRequestRulesItemOverridesSessionAffinityAttributesSecure | (string & {});
  /** Configures the zero-downtime failover between origins within a pool when session affinity is enabled. This feature is currently incompatible with Argo, Tiered Cache, and Bandwidth Alliance. The supported values are: - `"none"`: No failover takes place for sessions pinned to the origin (default). - `"temporary"`: Traffic will be sent to another other healthy origin until the originally pinned origin is available; note that this can potentially result in heavy origin flapping. - `"sticky"`: The session affinity cookie is updated and subsequent requests are sent to the new origin. Note: Zero-downtime failover with sticky sessions is currently not supported for session affinity by header. */
  zeroDowntimeFailover?:
    | UpdateRequestRulesItemOverridesSessionAffinityAttributesZeroDowntimeFailover
    | (string & {});
}
export const UpdateRequestRulesItemOverridesSessionAffinityAttributes = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      drainDuration: S.optional(S.Number.pipe(T.Body("drain_duration"))),
      headers: S.optional(UpdateRequestRulesItemOverridesSessionAffinityAttributesHeadersList),
      requireAllHeaders: S.optional(S.Boolean.pipe(T.Body("require_all_headers"))),
      samesite: S.optional(UpdateRequestRulesItemOverridesSessionAffinityAttributesSamesite),
      secure: S.optional(UpdateRequestRulesItemOverridesSessionAffinityAttributesSecure),
      zeroDowntimeFailover: S.optional(
...
export interface UpdateRequestRulesItemOverrides {
  ...
  /** Specifies the type of session affinity the load balancer should use unless specified as `"none"`. The supported types are: - `"cookie"`: On the first request to a proxied load balancer, a cookie is generated, encoding information of which origin the request will be forwarded to. Subsequent requests, by the same client to the same load balancer, will be sent to the origin server the cookie encodes, for the duration of the cookie and as long as the origin server remains healthy. If the cookie has expired or the origin server is unhealthy, then a new origin server is calculated and used. - `"ip_cookie"`: Behaves the same as `"cookie"` except the initial origin selection is stable and based on the client's ip address. - `"header"`: On the first request to a proxied load balancer, a session key based on the configured HTTP headers (see `session_affinity_attributes.headers`) is generated, encoding the request headers used for storing in the load balancer session state which origin the request will be forwarded to. Subsequent requests to the load balancer with the same headers will be sent to the same origin server, for the duration of the session and as long as the origin server remains healthy. If the session has been idle for the duration of `session_affinity_ttl` seconds or the origin server is unhealthy, then a new origin server is calculated and used. See `headers` in `session_affinity_attributes` for additional required configuration. */
  sessionAffinity?: UpdateRequestRulesItemOverridesSessionAffinity | (string & {});
  /** Configures attributes for session affinity. */
  sessionAffinityAttributes?: UpdateRequestRulesItemOverridesSessionAffinityAttributes;
  /** Time, in seconds, until a client's session expires after being created. Once the expiry time has been reached, subsequent requests may get sent to a different origin server. The accepted ranges per `session_affinity` policy are: - `"cookie"` / `"ip_cookie"`: The current default of 23 hours will be used unless explicitly set. The accepted range of values is between [1800, 604800]. - `"header"`: The current default of 1800 seconds will be used unless explicitly set. The accepted range of values is between [30, 3600]. Note: With session affinity by header, sessions only expire after they haven't been used for the number of seconds specified. */
  sessionAffinityTtl?: number;
  /** Steering Policy for this load balancer. */
  steeringPolicy?: UpdateRequestRulesItemOverridesSteeringPolicy | (string & {});
  /** Time to live (TTL) of the DNS entry for the IP address returned by this load balancer. This only applies to gray-clouded (unproxied) load balancers. */
  ttl?: number;
}
export const UpdateRequestRulesItemOverrides = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    adaptiveRouting: S.optional(CreateRequestAdaptiveRouting.pipe(T.Body("adaptive_routing"))),
    countryPools: S.optional(
      UpdateRequestRulesItemOverridesCountryPoolsMap.pipe(T.Body("country_pools")),
    ),
    defaultPools: S.optional(
      UpdateRequestRulesItemOverridesDefaultPoolsList.pipe(T.Body("default_pools")),
    ),
    fallbackPool: S.optional(S.String.pipe(T.Body("fallback_pool"))),
    locationStrategy: S.optional(
      UpdateRequestRulesItemOverridesLocationStrategy.pipe(T.Body("location_strategy")),
    ),
    poolDefaultWeight: S.optional(S.Number.pipe(T.Body("pool_default_weight"))),
    poolWeights: S.optional(
      UpdateRequestRulesItemOverridesPoolWeightsMap.pipe(T.Body("pool_weights")),
    ),
    pools: S.optional(UpdateRequestRulesItemOverridesPoolsList),
    popPools: S.optional(UpdateRequestRulesItemOverridesPopPoolsMap.pipe(T.Body("pop_pools"))),
    randomSteering: S.optional(
      UpdateRequestRulesItemOverridesRandomSteering.pipe(T.Body("random_steering")),
    ),
    regionPools: S.optional(
      UpdateRequestRulesItemOverridesRegionPoolsMap.pipe(T.Body("region_pools")),
    ),
    sessionAffinity: S.optional(
      UpdateRequestRulesItemOverridesSessionAffinity.pipe(T.Body("session_affinity")),
    ),
    sessionAffinityAttributes: S.optional(
    ...
    sessionAffinityTtl: S.optional(S.Number.pipe(T.Body("session_affinity_ttl"))),
    steeringPolicy: S.optional(
      UpdateRequestRulesItemOverridesSteeringPolicy.pipe(T.Body("steering_policy")),
    ),
    ttl: S.optional(S.Number),
  }),
).annotate({
...
export type UpdateRequestSessionAffinity = "none" | "cookie" | "ip_cookie" | "header";
...
export const UpdateRequestSessionAffinityAttributesHeadersList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<UpdateRequestSessionAffinityAttributesHeadersList>;

export type UpdateRequestSessionAffinityAttributesSamesite = "Auto" | "Lax" | "None" | "Strict";
export const UpdateRequestSessionAffinityAttributesSamesite = S.String;

export type UpdateRequestSessionAffinityAttributesSecure = "Auto" | "Always" | "Never";
...
export type UpdateRequestSessionAffinityAttributesZeroDowntimeFailover =
  ...
  | "temporary"
  | "sticky";
export const UpdateRequestSessionAffinityAttributesZeroDowntimeFailover = S.String;
...
export interface UpdateRequestSessionAffinityAttributes {
  ...
  /** Configures the zero-downtime failover between origins within a pool when session affinity is enabled. This feature is currently incompatible with Argo, Tiered Cache, and Bandwidth Alliance. The supported values are: - `"none"`: No failover takes place for sessions pinned to the origin (default). - `"temporary"`: Traffic will be sent to another other healthy origin until the originally pinned origin is available; note that this can potentially result in heavy origin flapping. - `"sticky"`: The session affinity cookie is updated and subsequent requests are sent to the new origin. Note: Zero-downtime failover with sticky sessions is currently not supported for session affinity by header. */
  zeroDowntimeFailover?: UpdateRequestSessionAffinityAttributesZeroDowntimeFailover | (string & {});
}
...
export const UpdateLoadBalancerRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    name: S.String,
    adaptiveRouting: S.optional(CreateRequestAdaptiveRouting.pipe(T.Body("adaptive_routing"))),
    countryPools: S.optional(UpdateRequestCountryPoolsMap.pipe(T.Body("country_pools"))),
    description: S.optional(S.String),
    enabled: S.optional(S.Boolean),
    locationStrategy: S.optional(UpdateRequestLocationStrategy.pipe(T.Body("location_strategy"))),
    networks: S.optional(UpdateRequestNetworksList),
    popPools: S.optional(UpdateRequestPopPoolsMap.pipe(T.Body("pop_pools"))),
    proxied: S.optional(S.Boolean),
    randomSteering: S.optional(UpdateRequestRandomSteering.pipe(T.Body("random_steering"))),
    regionPools: S.optional(UpdateRequestRegionPoolsMap.pipe(T.Body("region_pools"))),
    rules: S.optional(UpdateRequestRulesList),
    sessionAffinity: S.optional(UpdateRequestSessionAffinity.pipe(T.Body("session_affinity"))),
    sessionAffinityAttributes: S.optional(
      UpdateRequestSessionAffinityAttributes.pipe(T.Body("session_affinity_attributes")),
    ),
    sessionAffinityTtl: S.optional(S.Number.pipe(T.Body("session_affinity_ttl"))),
    steeringPolicy: S.optional(UpdateRequestSteeringPolicy.pipe(T.Body("steering_policy"))),
    ttl: S.optional(S.Number),
  })
    .pipe(
      T.Http({
...
export type UpdateResponseLocationStrategyPreferEcs = "always" | "never" | "proximity" | "geo";
...
export const UpdateResponseLocationStrategy = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    preferEcs: S.optional(
      S.NullOr(UpdateResponseLocationStrategyPreferEcs).pipe(T.Body("prefer_ecs")),
    ),
  }),
).annotate({
...
export type UpdateResponsePoolSetsItemFixedResponse = CreateResponsePoolSetsItemFixedResponse;
export const UpdateResponsePoolSetsItemFixedResponse = CreateResponsePoolSetsItemFixedResponse;

export type UpdateResponsePoolSetsItemMatchTopologyCountriesList = Array<string>;
export const UpdateResponsePoolSetsItemMatchTopologyCountriesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateResponsePoolSetsItemMatchTopologyPopsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateResponsePoolSetsItemMatchTopologyRegionsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateResponsePoolSetsItemMatchTopology = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    countries: S.optional(S.NullOr(UpdateResponsePoolSetsItemMatchTopologyCountriesList)),
    pops: S.optional(S.NullOr(UpdateResponsePoolSetsItemMatchTopologyPopsList)),
    regions: S.optional(S.NullOr(UpdateResponsePoolSetsItemMatchTopologyRegionsList)),
  }),
).annotate({
...
export const UpdateResponsePoolSetsItemOverridesPoolWeightsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Number,
...
export const UpdateResponsePoolSetsItemOverridesPoolsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateResponsePoolSetsItemOverrides = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    poolDefaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("pool_default_weight"))),
    poolWeights: S.optional(
      S.NullOr(UpdateResponsePoolSetsItemOverridesPoolWeightsMap).pipe(T.Body("pool_weights")),
    ),
    pools: S.optional(S.NullOr(UpdateResponsePoolSetsItemOverridesPoolsList)),
    steeringPolicy: S.optional(
      S.NullOr(UpdateResponsePoolSetsItemOverridesSteeringPolicy).pipe(T.Body("steering_policy")),
    ),
  }),
).annotate({
...
export const UpdateResponseRandomSteering = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("default_weight"))),
    poolWeights: S.optional(
      S.NullOr(UpdateResponseRandomSteeringPoolWeightsMap).pipe(T.Body("pool_weights")),
    ),
  }),
).annotate({
...
export type UpdateResponseRulesItemFixedResponse = CreateResponsePoolSetsItemFixedResponse;
export const UpdateResponseRulesItemFixedResponse = CreateResponsePoolSetsItemFixedResponse;

export type UpdateResponseRulesItemOverridesAdaptiveRouting = CreateResponseAdaptiveRouting;
export const UpdateResponseRulesItemOverridesAdaptiveRouting = CreateResponseAdaptiveRouting;

export type UpdateResponseRulesItemOverridesCountryPoolsValueList = Array<string>;
export const UpdateResponseRulesItemOverridesCountryPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export type UpdateResponseRulesItemOverridesCountryPoolsMap = {
  [key: string]: UpdateResponseRulesItemOverridesCountryPoolsValueList | undefined;
};
export const UpdateResponseRulesItemOverridesCountryPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export const UpdateResponseRulesItemOverridesDefaultPoolsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<UpdateResponseRulesItemOverridesDefaultPoolsList>;

export type UpdateResponseRulesItemOverridesLocationStrategyMode = "pop" | "resolver_ip";
...
export type UpdateResponseRulesItemOverridesLocationStrategyPreferEcs =
  ...
  | "proximity"
  | "geo";
export const UpdateResponseRulesItemOverridesLocationStrategyPreferEcs = S.String;
...
export const UpdateResponseRulesItemOverridesLocationStrategy = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    mode: S.optional(S.NullOr(UpdateResponseRulesItemOverridesLocationStrategyMode)),
    preferEcs: S.optional(
      S.NullOr(UpdateResponseRulesItemOverridesLocationStrategyPreferEcs).pipe(
        T.Body("prefer_ecs"),
      ),
    ),
  }),
...
export const UpdateResponseRulesItemOverridesPopPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateResponseRulesItemOverridesPopPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export const UpdateResponseRulesItemOverridesRandomSteeringPoolWeightsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Number,
...
export const UpdateResponseRulesItemOverridesRandomSteering = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("default_weight"))),
    poolWeights: S.optional(
      S.NullOr(UpdateResponseRulesItemOverridesRandomSteeringPoolWeightsMap).pipe(
        T.Body("pool_weights"),
      ),
    ),
  }),
...
export type UpdateResponseRulesItemOverridesRegionPoolsValueList = Array<string>;
export const UpdateResponseRulesItemOverridesRegionPoolsValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export type UpdateResponseRulesItemOverridesRegionPoolsMap = {
  [key: string]: UpdateResponseRulesItemOverridesRegionPoolsValueList | undefined;
};
export const UpdateResponseRulesItemOverridesRegionPoolsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export type UpdateResponseRulesItemOverridesSessionAffinityAttributesHeadersList = Array<string>;
...
export type UpdateResponseRulesItemOverridesSessionAffinityAttributesSamesite =
  ...
  | "None"
  | "Strict";
export const UpdateResponseRulesItemOverridesSessionAffinityAttributesSamesite = S.String;

export type UpdateResponseRulesItemOverridesSessionAffinityAttributesSecure =
  | "Auto"
  | "Always"
  | "Never";
export const UpdateResponseRulesItemOverridesSessionAffinityAttributesSecure = S.String;
...
export const UpdateResponseRulesItemOverridesSessionAffinityAttributes = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      drainDuration: S.optional(S.NullOr(S.Number).pipe(T.Body("drain_duration"))),
      headers: S.optional(
        S.NullOr(UpdateResponseRulesItemOverridesSessionAffinityAttributesHeadersList),
      ),
      requireAllHeaders: S.optional(S.NullOr(S.Boolean).pipe(T.Body("require_all_headers"))),
      samesite: S.optional(
        S.NullOr(UpdateResponseRulesItemOverridesSessionAffinityAttributesSamesite),
      ),
      secure: S.optional(S.NullOr(UpdateResponseRulesItemOverridesSessionAffinityAttributesSecure)),
      zeroDowntimeFailover: S.optional(
        S.NullOr(
...
export const UpdateResponseRulesItemOverrides = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    countryPools: S.optional(
      S.NullOr(UpdateResponseRulesItemOverridesCountryPoolsMap).pipe(T.Body("country_pools")),
    ),
    defaultPools: S.optional(
      S.NullOr(UpdateResponseRulesItemOverridesDefaultPoolsList).pipe(T.Body("default_pools")),
    ),
    fallbackPool: S.optional(S.NullOr(S.String).pipe(T.Body("fallback_pool"))),
    locationStrategy: S.optional(
      S.NullOr(UpdateResponseRulesItemOverridesLocationStrategy).pipe(T.Body("location_strategy")),
    ),
    poolDefaultWeight: S.optional(S.NullOr(S.Number).pipe(T.Body("pool_default_weight"))),
    poolWeights: S.optional(
      S.NullOr(UpdateResponseRulesItemOverridesPoolWeightsMap).pipe(T.Body("pool_weights")),
    ),
    pools: S.optional(S.NullOr(UpdateResponseRulesItemOverridesPoolsList)),
    popPools: S.optional(
      S.NullOr(UpdateResponseRulesItemOverridesPopPoolsMap).pipe(T.Body("pop_pools")),
    ),
    randomSteering: S.optional(
      S.NullOr(UpdateResponseRulesItemOverridesRandomSteering).pipe(T.Body("random_steering")),
    ),
    regionPools: S.optional(
      S.NullOr(UpdateResponseRulesItemOverridesRegionPoolsMap).pipe(T.Body("region_pools")),
    ),
    sessionAffinity: S.optional(
      S.NullOr(UpdateResponseRulesItemOverridesSessionAffinity).pipe(T.Body("session_affinity")),
    ),
    sessionAffinityAttributes: S.optional(
    ...
    sessionAffinityTtl: S.optional(S.NullOr(S.Number).pipe(T.Body("session_affinity_ttl"))),
    steeringPolicy: S.optional(
      S.NullOr(UpdateResponseRulesItemOverridesSteeringPolicy).pipe(T.Body("steering_policy")),
    ),
    ttl: S.optional(S.NullOr(S.Number)),
  }),
).annotate({
...
export type UpdateResponseSessionAffinity = "none" | "cookie" | "ip_cookie" | "header";
...
export const UpdateResponseSessionAffinityAttributesHeadersList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<UpdateResponseSessionAffinityAttributesHeadersList>;

export type UpdateResponseSessionAffinityAttributesSamesite = "Auto" | "Lax" | "None" | "Strict";
export const UpdateResponseSessionAffinityAttributesSamesite = S.String;

export type UpdateResponseSessionAffinityAttributesSecure = "Auto" | "Always" | "Never";
...
export type UpdateResponseSessionAffinityAttributesZeroDowntimeFailover =
  ...
  | "temporary"
  | "sticky";
export const UpdateResponseSessionAffinityAttributesZeroDowntimeFailover = S.String;
...
export const UpdateResponseSessionAffinityAttributes = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    drainDuration: S.optional(S.NullOr(S.Number).pipe(T.Body("drain_duration"))),
    headers: S.optional(S.NullOr(UpdateResponseSessionAffinityAttributesHeadersList)),
    requireAllHeaders: S.optional(S.NullOr(S.Boolean).pipe(T.Body("require_all_headers"))),
    samesite: S.optional(S.NullOr(UpdateResponseSessionAffinityAttributesSamesite)),
    secure: S.optional(S.NullOr(UpdateResponseSessionAffinityAttributesSecure)),
    zeroDowntimeFailover: S.optional(
      S.NullOr(UpdateResponseSessionAffinityAttributesZeroDowntimeFailover).pipe(
        T.Body("zero_downtime_failover"),
      ),
    ),
  }),
...
export const UpdateLoadBalancerResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    countryPools: S.optional(S.NullOr(UpdateResponseCountryPoolsMap).pipe(T.Body("country_pools"))),
    createdOn: S.optional(S.NullOr(S.String).pipe(T.Body("created_on"))),
    defaultPools: S.optional(
    ...
    fallbackPool: S.optional(S.NullOr(S.String).pipe(T.Body("fallback_pool"))),
    locationStrategy: S.optional(
      S.NullOr(UpdateResponseLocationStrategy).pipe(T.Body("location_strategy")),
    ),
    modifiedOn: S.optional(S.NullOr(S.String).pipe(T.Body("modified_on"))),
    name: S.optional(S.NullOr(S.String)),
    networks: S.optional(S.NullOr(UpdateResponseNetworksList)),
    poolSets: S.optional(S.NullOr(UpdateResponsePoolSetsList).pipe(T.Body("pool_sets"))),
    popPools: S.optional(S.NullOr(UpdateResponsePopPoolsMap).pipe(T.Body("pop_pools"))),
    proxied: S.optional(S.NullOr(S.Boolean)),
    randomSteering: S.optional(
      S.NullOr(UpdateResponseRandomSteering).pipe(T.Body("random_steering")),
    ),
    regionPools: S.optional(S.NullOr(UpdateResponseRegionPoolsMap).pipe(T.Body("region_pools"))),
    rules: S.optional(S.NullOr(UpdateResponseRulesList)),
    sessionAffinity: S.optional(
      S.NullOr(UpdateResponseSessionAffinity).pipe(T.Body("session_affinity")),
    ),
    sessionAffinityAttributes: S.optional(
      S.NullOr(UpdateResponseSessionAffinityAttributes).pipe(T.Body("session_affinity_attributes")),
    ),
    sessionAffinityTtl: S.optional(S.NullOr(S.Number).pipe(T.Body("session_affinity_ttl"))),
    steeringPolicy: S.optional(
...
export type MonitorGroupsUpdateRequestMembersList = Array<MonitorGroupsCreateRequestMembersItem>;
...
export type MonitorGroupsUpdateResponseMembersItem = MonitorGroupsCreateResponseMembersItem;
export const MonitorGroupsUpdateResponseMembersItem = MonitorGroupsCreateResponseMembersItem;

export type MonitorGroupsUpdateResponseMembersList = Array<MonitorGroupsCreateResponseMembersItem>;
...
export const PoolsUpdateRequestOriginsItemHeaderHostList = /*@__PURE__*/ S.Array(
  S.String,
...
export const PoolsUpdateRequestOriginsItemHeader = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    host: S.optional(PoolsUpdateRequestOriginsItemHeaderHostList.pipe(T.Body("Host"))),
  }),
).annotate({
...
export type PoolsUpdateRequestOriginsList = Array<PoolsUpdateRequestOriginsItem>;
...
export type PoolsUpdateRequestHealthSourcesItem = "local" | "regional" | "global";
...
export const PoolsUpdateRequestLoadShedding = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultPercent: S.optional(S.Number.pipe(T.Body("default_percent"))),
    defaultPolicy: S.optional(
      PoolsUpdateRequestLoadSheddingDefaultPolicy.pipe(T.Body("default_policy")),
    ),
    sessionPercent: S.optional(S.Number.pipe(T.Body("session_percent"))),
    sessionPolicy: S.optional(
      PoolsUpdateRequestLoadSheddingSessionPolicy.pipe(T.Body("session_policy")),
    ),
  }),
).annotate({
...
export type PoolsUpdateRequestNotificationFilterOrigin = PoolsCreateRequestNotificationFilterOrigin;
export const PoolsUpdateRequestNotificationFilterOrigin =
  PoolsCreateRequestNotificationFilterOrigin;

export type PoolsUpdateRequestNotificationFilterPool = PoolsCreateRequestNotificationFilterOrigin;
export const PoolsUpdateRequestNotificationFilterPool = PoolsCreateRequestNotificationFilterOrigin;

export type PoolsUpdateRequestNotificationFilter = PoolsCreateRequestNotificationFilter;
export const PoolsUpdateRequestNotificationFilter = PoolsCreateRequestNotificationFilter;
...
export const UpdatePoolRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    name: S.String,
    origins: PoolsUpdateRequestOriginsList,
    checkRegions: S.optional(PoolsUpdateRequestCheckRegionsList.pipe(T.Body("check_regions"))),
    description: S.optional(S.String),
    enabled: S.optional(S.Boolean),
    healthSources: S.optional(PoolsUpdateRequestHealthSourcesList.pipe(T.Body("health_sources"))),
    latitude: S.optional(S.Number),
    loadShedding: S.optional(PoolsUpdateRequestLoadShedding.pipe(T.Body("load_shedding"))),
    longitude: S.optional(S.Number),
    minimumOrigins: S.optional(S.Number.pipe(T.Body("minimum_origins"))),
    monitor: S.optional(S.String),
    monitorGroup: S.optional(S.String.pipe(T.Body("monitor_group"))),
    ...
    originSteering: S.optional(PoolsUpdateRequestOriginSteering.pipe(T.Body("origin_steering"))),
  })
    .pipe(
      T.Http({
        method: "PUT",
...
export type PoolsUpdateResponseCheckRegionsList = Array<PoolsUpdateResponseCheckRegionsItem>;
...
export type PoolsUpdateResponseHealthSourcesItem = "local" | "regional" | "global";
export const PoolsUpdateResponseHealthSourcesItem = S.String;

export type PoolsUpdateResponseHealthSourcesList = Array<PoolsUpdateResponseHealthSourcesItem>;
...
export const PoolsUpdateResponseLoadShedding = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    defaultPercent: S.optional(S.NullOr(S.Number).pipe(T.Body("default_percent"))),
    defaultPolicy: S.optional(
      S.NullOr(PoolsUpdateResponseLoadSheddingDefaultPolicy).pipe(T.Body("default_policy")),
    ),
    sessionPercent: S.optional(S.NullOr(S.Number).pipe(T.Body("session_percent"))),
    sessionPolicy: S.optional(
      S.NullOr(PoolsUpdateResponseLoadSheddingSessionPolicy).pipe(T.Body("session_policy")),
    ),
  }),
).annotate({
...
export const PoolsUpdateResponseOriginsItemHeaderHostList = /*@__PURE__*/ S.Array(
  S.String,
...
export const PoolsUpdateResponseOriginsItemHeader = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    host: S.optional(S.NullOr(PoolsUpdateResponseOriginsItemHeaderHostList).pipe(T.Body("Host"))),
  }),
).annotate({
...
export type PoolsUpdateResponseOriginsList = Array<PoolsUpdateResponseOriginsItem>;
...
export const UpdatePoolResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.NullOr(S.String)),
    checkRegions: S.optional(
      S.NullOr(PoolsUpdateResponseCheckRegionsList).pipe(T.Body("check_regions")),
    ),
    createdOn: S.optional(S.NullOr(S.String).pipe(T.Body("created_on"))),
    description: S.optional(S.NullOr(S.String)),
    disabledAt: S.optional(S.NullOr(S.String).pipe(T.Body("disabled_at"))),
    enabled: S.optional(S.NullOr(S.Boolean)),
    healthSources: S.optional(
      S.NullOr(PoolsUpdateResponseHealthSourcesList).pipe(T.Body("health_sources")),
    ),
    latitude: S.optional(S.NullOr(S.Number)),
    loadShedding: S.optional(
    ...
    originSteering: S.optional(
      S.NullOr(PoolsUpdateResponseOriginSteering).pipe(T.Body("origin_steering")),
    ),
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [LoadBalancingNotEnabledForZone, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));

export type CreateMonitorError = MonitorIntervalOutOfRange | Forbidden | CloudflareOpError;
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [MonitorIntervalOutOfRange, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));

export type CreateMonitorGroupError = MonitorGroupsNotEnabled | Forbidden | CloudflareOpError;
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [MonitorGroupsNotEnabled, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
...
export type DeleteLoadBalancerError = LoadBalancerNotFound | Forbidden | CloudflareOpError;
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [LoadBalancerNotFound, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));

export type DeleteMonitorError = MonitorNotFound | MonitorInUse | Forbidden | CloudflareOpError;
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [MonitorNotFound, MonitorInUse, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
...
export type DeletePoolError = PoolNotFound | PoolInUse | Forbidden | CloudflareOpError;
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [PoolNotFound, PoolInUse, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));

export type GetLoadBalancerError = LoadBalancerNotFound | Forbidden | CloudflareOpError;
...
export type GetMonitorGroupError = MonitorGroupNotFound | Forbidden | CloudflareOpError;
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [MonitorGroupNotFound, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
...
export type UpdatePoolError = PoolNotFound | PoolAccessFailed | Forbidden | CloudflareOpError;
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [PoolNotFound, PoolAccessFailed, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
