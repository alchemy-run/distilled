...
export class MaximumStoresExceeded
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<MaximumStoresExceeded>()("MaximumStoresExceeded", {
      code: S.Number,
      message: S.String,
    }),
...
export class SecretNameAlreadyExists
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<SecretNameAlreadyExists>()("SecretNameAlreadyExists", {
      code: S.Number,
      message: S.String,
    }),
...
>;
export const StoresSecretsCreateRequestBodyItemScopesList = /*@__PURE__*/ S.Array(
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [InvalidAccountId, MaximumStoresExceeded, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [StoreNotFound, InvalidAccountId, NotFound, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.makePaginated(
  () => ({
    ...
    errors: [StoreNotFound, InvalidAccountId, CloudflareRateLimited, CloudflareError],
    protocol: CloudflarePaginatedProtocol,
    retry: Retry.Retry,
    pagination: {
      mode: "page",
