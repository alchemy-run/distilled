...
export type PutSecurityTxtError = Forbidden | SecurityTxtInvalid | CloudflareOpError;
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [Forbidden, SecurityTxtInvalid, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
