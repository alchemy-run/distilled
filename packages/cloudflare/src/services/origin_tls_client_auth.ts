...
export class CertificateAlreadyDeleted
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<CertificateAlreadyDeleted>()("CertificateAlreadyDeleted", {
      code: S.Number,
      message: S.String,
    }),
...
export class CertificateAlreadyExists
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<CertificateAlreadyExists>()("CertificateAlreadyExists", {
      code: S.Number,
      message: S.String,
    }),
...
export class CertificateNotFound
  extends /*@__PURE__*/ T.applyErrorMatchers(
    ...
    [{ code: 1552, message: { includes: "certificate not found" } }, { status: 404 }],
  ) {}

export class CertificatePendingDeletion
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<CertificatePendingDeletion>()("CertificatePendingDeletion", {
      code: S.Number,
      message: S.String,
    }),
...
export class CertificatePendingDeployment
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<CertificatePendingDeployment>()("CertificatePendingDeployment", {
      code: S.Number,
      message: S.String,
    }),
...
export class HostnameAssociationNotFound
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<HostnameAssociationNotFound>()("HostnameAssociationNotFound", {
      code: S.Number,
      message: S.String,
    }),
    [
...
export class HostnameCertificateIdRequired
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<HostnameCertificateIdRequired>()("HostnameCertificateIdRequired", {
      code: S.Number,
      message: S.String,
    }),
...
export class HostnameCertificateInUse
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<HostnameCertificateInUse>()("HostnameCertificateInUse", {
      code: S.Number,
      message: S.String,
    }),
...
export class HostnameCertificateNotFound
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<HostnameCertificateNotFound>()("HostnameCertificateNotFound", {
      code: S.Number,
      message: S.String,
    }),
...
export class InvalidCertificateId
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<InvalidCertificateId>()("InvalidCertificateId", {
      code: S.Number,
      message: S.String,
    }),
...
export class InvalidHostnameConfig
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<InvalidHostnameConfig>()("InvalidHostnameConfig", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 1415 }],
...
export class ZoneClientCertConflict
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<ZoneClientCertConflict>()("ZoneClientCertConflict", {
      code: S.Number,
      message: S.String,
    }),
    [{ status: 409 }],
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [HostnameAssociationNotFound, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [HostnameCertificateNotFound, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [CertificateNotFound, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
