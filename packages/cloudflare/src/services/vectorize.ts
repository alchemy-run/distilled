...
export class MetadataIndexAlreadyExists
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<MetadataIndexAlreadyExists>()("MetadataIndexAlreadyExists", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 40004 }],
...
export class MetadataIndexInvalidType
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<MetadataIndexInvalidType>()("MetadataIndexInvalidType", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 40026 }],
...
export class MetadataIndexNotFound
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<MetadataIndexNotFound>()("MetadataIndexNotFound", {
      code: S.Number,
      message: S.String,
    }),
    [{ code: 40005 }],
...
export const IndexesCreateRequestConfigIndexDimensionConfiguration = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    dimensions: S.Number,
...
export const IndexesCreateRequestConfigVectorizeIndexPresetConfiguration = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
...
export const InsertIndexRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    unparsableBehavior: S.optional(
      IndexesInsertRequestUnparsableBehavior.pipe(T.Query("unparsable-behavior")),
    ),
...
export const IndexesMetadataIndexListResponseMetadataIndexesItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const IndexesMetadataIndexListResponseMetadataIndexesList = /*@__PURE__*/ S.Array(
...
export const UpsertIndexRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    indexName: S.String.pipe(T.Label("index_name")),
    unparsableBehavior: S.optional(
      IndexesUpsertRequestUnparsableBehavior.pipe(T.Query("unparsable-behavior")),
    ),
    body: S.String.pipe(T.HttpBody()),
  })
    .pipe(
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [NotFound, Gone, MetadataIndexNotFound, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
