...
export class CustomNameserverAlreadyExists
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<CustomNameserverAlreadyExists>()("CustomNameserverAlreadyExists", {
      code: S.Number,
      message: S.String,
    }),
...
export class CustomNameserverNotFound
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<CustomNameserverNotFound>()("CustomNameserverNotFound", {
      code: S.Number,
      message: S.String,
    }),
    [{ status: 404 }],
...
export class CustomNameserversNotEnabled
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<CustomNameserversNotEnabled>()("CustomNameserversNotEnabled", {
      code: S.Number,
      message: S.String,
    }),
...
export const GetResultList = /*@__PURE__*/ S.Array(GetResultItem) as any as S.Schema<GetResultList>;
...
export type GetCustomNameserverError = CustomNameserversNotEnabled | Forbidden | CloudflareOpError;
...
> = /*@__PURE__*/ API.makePaginated(
  () => ({
    ...
    errors: [CustomNameserversNotEnabled, Forbidden, CloudflareRateLimited, CloudflareError],
    protocol: CloudflarePaginatedProtocol,
    retry: Retry.Retry,
    pagination: { mode: "single", items: "result" } as const,
  }),
