...
export class KeylessCertificateNotFound
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<KeylessCertificateNotFound>()("KeylessCertificateNotFound", {
      code: S.Number,
      message: S.String,
    }),
...
export class KeylessSslNotAvailable
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<KeylessSslNotAvailable>()("KeylessSslNotAvailable", {
      code: S.Number,
      message: S.String,
    }),
...
export type CreateKeylessCertificateError = KeylessSslNotAvailable | Forbidden | CloudflareOpError;
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [KeylessSslNotAvailable, Forbidden, CloudflareRateLimited, CloudflareError],
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [KeylessCertificateNotFound, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));

export type GetKeylessCertificateError = KeylessCertificateNotFound | Forbidden | CloudflareOpError;
