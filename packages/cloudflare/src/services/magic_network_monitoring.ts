...
export class DuplicateMnmRuleName
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<DuplicateMnmRuleName>()("DuplicateMnmRuleName", {
      code: S.Number,
      message: S.String,
    }),
...
export class MnmConfigAlreadyExists
  extends /*@__PURE__*/ T.applyErrorMatchers(
    /*@__PURE__*/ S.TaggedError<MnmConfigAlreadyExists>()("MnmConfigAlreadyExists", {
      code: S.Number,
      message: S.String,
    }),
...
export const CreateRuleResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    zscoreSensitivity: S.optional(
      S.NullOr(RulesCreateResponseZscoreSensitivity).pipe(T.Body("zscore_sensitivity")),
    ),
...
export const DeleteRuleResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    zscoreSensitivity: S.optional(
      S.NullOr(RulesDeleteResponseZscoreSensitivity).pipe(T.Body("zscore_sensitivity")),
    ),
    zscoreTarget: S.optional(
...
export const GetRuleResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    zscoreSensitivity: S.optional(
      S.NullOr(RulesGetResponseZscoreSensitivity).pipe(T.Body("zscore_sensitivity")),
    ),
...
export const RulesListResultItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    zscoreSensitivity: S.optional(
      S.NullOr(RulesListResultItemZscoreSensitivity).pipe(T.Body("zscore_sensitivity")),
    ),
    zscoreTarget: S.optional(
...
export const PatchRuleResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    zscoreSensitivity: S.optional(
      S.NullOr(RulesEditResponseZscoreSensitivity).pipe(T.Body("zscore_sensitivity")),
    ),
...
export const UpdateRuleResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    zscoreSensitivity: S.optional(
      S.NullOr(RulesUpdateResponseZscoreSensitivity).pipe(T.Body("zscore_sensitivity")),
    ),
    zscoreTarget: S.optional(
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [MnmConfigNotFound, Forbidden, CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
