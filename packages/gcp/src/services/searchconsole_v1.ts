...
>;
export const SearchAnalyticsQueryRequestDimensionsItemEnumList = /*@__PURE__*/ S.Array(
...
export const getSites: API.OperationMethod<GetSitesRequest, WmxSite, GetSitesError, GcpOpContext> =
  /*@__PURE__*/ API.make(() => ({
