...
export const GetFileReportsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const IdMappingFile = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
  identifier: "IdMappingFile",
}) as any as S.Schema<IdMappingFile>;
