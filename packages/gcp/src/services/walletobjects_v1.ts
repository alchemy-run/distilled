...
export interface PassConstraints {
  ...
  screenshotEligibility?: PassConstraintsScreenshotEligibilityEnum | (string & {});
}
...
export type DiscoverableProgramMerchantSignupInfoSignupSharedDatasItemEnum =
  ...
  | "EMAIL"
  | "PHONE";
export const DiscoverableProgramMerchantSignupInfoSignupSharedDatasItemEnum = S.String;

export type DiscoverableProgramMerchantSignupInfoSignupSharedDatasItemEnumList = Array<
  DiscoverableProgramMerchantSignupInfoSignupSharedDatasItemEnum | (string & {})
>;
...
export const SetPassUpdateNoticeResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const JwtValidateResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export type ValidateJwtError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
