...
export const CheckPackagesPackageRegistrationStatusRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export type CheckPackagesPackageRegistrationStatusError = NotFound | Forbidden | GcpOpError;
