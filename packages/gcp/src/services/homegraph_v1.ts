...
export const ResultMap = /*@__PURE__*/ S.Record(S.String, Result) as any as S.Schema<ResultMap>;
...
export const RequestSyncDevicesResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
