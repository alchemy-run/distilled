...
export const UndeleteFolderRequest = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const getLiens: API.OperationMethod<GetLiensRequest, Lien, GetLiensError, GcpOpContext> =
  /*@__PURE__*/ API.make(() => ({
