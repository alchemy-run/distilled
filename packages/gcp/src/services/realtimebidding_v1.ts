...
>;
export const PretargetingConfigIncludedUserIdTypesItemEnumList = /*@__PURE__*/ S.Array(
...
>;
export const PretargetingConfigIncludedEnvironmentsItemEnumList = /*@__PURE__*/ S.Array(
...
export type SuspendPretargetingConfigRequest = ActivatePretargetingConfigRequest;
export const SuspendPretargetingConfigRequest = ActivatePretargetingConfigRequest;
...
export const getBuyers: API.OperationMethod<GetBuyersRequest, Buyer, GetBuyersError, GcpOpContext> =
  /*@__PURE__*/ API.make(() => ({
