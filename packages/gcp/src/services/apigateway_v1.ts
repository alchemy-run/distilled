...
export const ApigatewayApiConfigGrpcServiceDefinitionList = /*@__PURE__*/ S.Array(
...
export type ApigatewayApiConfigOpenApiDocumentList = Array<ApigatewayApiConfigOpenApiDocument>;
