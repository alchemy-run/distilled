...
export const WriteLogEntriesResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
/** Gets a sink. */
export const getSinks: API.OperationMethod<GetSinksRequest, LogSink, GetSinksError, GcpOpContext> =
  /*@__PURE__*/ API.make(() => ({
