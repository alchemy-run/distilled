...
export const CancelPatchJobRequest = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export type EffectiveGuestPolicySourcedPackageList = Array<EffectiveGuestPolicySourcedPackage>;
