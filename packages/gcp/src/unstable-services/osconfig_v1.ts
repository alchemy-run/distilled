...
>;
export const WindowsUpdateSettingsClassificationsItemEnumList = /*@__PURE__*/ S.Array(
...
export interface ProjectFeatureSettings {
  ...
  patchAndConfigFeatureSet?: ProjectFeatureSettingsPatchAndConfigFeatureSetEnum | (string & {});
}
