...
export const SignSshPublicKeyProjectsLocationsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    parent: S.String.pipe(T.Label()),
    body: S.optional(
      GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyRequest.pipe(T.HttpBody()),
    ),
  }).pipe(
    T.Http({
      method: "POST",
...
export const GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyResponse =
  /*@__PURE__*/ S.suspend(() =>
    ...
    identifier: "GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyResponse",
