...
export const CloseAccountRequest = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const CloseAccountResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const GetAccountsPlatformsChildAccountsSitesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    name: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
...
export const RequestSiteReviewResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export type GetAccountsPlatformsChildAccountsSitesError = NotFound | Forbidden | GcpOpError;
