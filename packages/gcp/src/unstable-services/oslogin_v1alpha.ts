...
export const SignSshPublicKeyProjectsLocationsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    parent: S.String.pipe(T.Label()),
    body: S.optional(
      GoogleCloudOsloginControlplaneRegionalV1alphaSignSshPublicKeyRequest.pipe(T.HttpBody()),
    ),
  }).pipe(
    T.Http({
      method: "POST",
...
export const GoogleCloudOsloginControlplaneRegionalV1alphaSignSshPublicKeyResponse =
  /*@__PURE__*/ S.suspend(() =>
    ...
    identifier: "GoogleCloudOsloginControlplaneRegionalV1alphaSignSshPublicKeyResponse",
