...
export type GetIamPolicyV1beta1Error = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
...
export type SetIamPolicyV1beta1Error = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
