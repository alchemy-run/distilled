...
export type PaginatedProjectSecretAPIKeyListResultsList = Array<ProjectSecretAPIKey>;
export const PaginatedProjectSecretAPIKeyListResultsList = /*@__PURE__*/ S.Array(
  ProjectSecretAPIKey,
...
export const UpdateProjectSecretApiKeysPartialRequestScopesList = /*@__PURE__*/ S.Array(
  S.String,
...
export type CreateProjectSecretApiKeyError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type CreateProjectSecretApiKeysRollError = Forbidden | NotFound | PosthogOpError;
...
export type ListProjectSecretApiKeysError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ProjectSecretApiKeysDestroyError = Forbidden | NotFound | PosthogOpError;
...
export type UpdateProjectSecretApiKeyError = BadRequest | Forbidden | NotFound | PosthogOpError;
