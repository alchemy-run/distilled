...
export const DatasetsDestroyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export type DatasetsListRequestOrderByList = Array<DatasetsListRequestOrderByItem | (string & {})>;
...
export type DatasetsCreateError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type DatasetsListError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type DatasetsPartialUpdateError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type DatasetsUpdateError = BadRequest | Forbidden | NotFound | PosthogOpError;
