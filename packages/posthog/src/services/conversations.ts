...
export type ConversationsTicketsBulkUpdateStatusCreateRequestIdsList = Array<string>;
export const ConversationsTicketsBulkUpdateStatusCreateRequestIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ConversationsTicketsBulkUpdateStatusCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const CreateConversationsTicketsAiFeedbackRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
    message_id: S.String,
...
export const CreateConversationsTicketsAiFeedbackResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export type TicketViewFiltersPriorityList = Array<TicketPriorityEnum | (string & {})>;
...
export type TicketChannelFilterEnum = "widget" | "email" | "slack" | "teams" | "github" | "all";
...
export const TicketTagsList = /*@__PURE__*/ S.Array(S.Unknown) as any as S.Schema<TicketTagsList>;
...
export const GetConversationsTicketsMessagesFullEmailRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
    message_id: S.String.pipe(T.Label()),
...
export type ListConversationsTicketsRequestSla = "at-risk" | "breached" | "on-track";
...
export const ListConversationsTicketsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    channel_detail: S.optional(ListConversationsTicketsRequestChannelDetail.pipe(T.Query())),
    channel_source: S.optional(ListConversationsTicketsRequestChannelSource.pipe(T.Query())),
    ...
    order_by: S.optional(ListConversationsTicketsRequestOrderBy.pipe(T.Query())),
...
export const TicketAssigneeRequest = S.Unknown as any as S.Schema<TicketAssigneeRequest>;
...
export const UpdateConversationsTicketsNotesPartialRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
    message_id: S.String.pipe(T.Label()),
...
/** Ticket priority: low, medium, high, or critical. Pass null to clear it. * `low` - Low * `medium` - Medium * `high` - High * `critical` - Critical */
export type UpdateConversationsTicketsPartialRequestPriority = TicketPriorityEnum | BlankEnum;
...
export const UpdateConversationsTicketsPartialRequestTagsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateConversationsTicketsPartialRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    id: S.String.pipe(T.Label()),
    status: S.optional(TicketStatusEnum),
    priority: S.optional(S.NullOr(UpdateConversationsTicketsPartialRequestPriority)),
    assignee: S.optional(S.NullOr(TicketAssigneeRequest)),
    anonymous_traits: S.optional(S.Unknown),
    ai_resolved: S.optional(S.Boolean),
    escalation_reason: S.optional(S.NullOr(S.String)),
...
export type ConversationsTicketsDestroyError = Forbidden | NotFound | PosthogOpError;
...
export type ConversationsViewsDestroyError = Forbidden | NotFound | PosthogOpError;
...
export type CreateConversationsViewError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetConversationsTicketsMessagesFullEmailError = NotFound | PosthogOpError;
...
export type ListConversationsTicketsError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ListConversationsViewsError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UpdateConversationsTicketError = BadRequest | Forbidden | NotFound | PosthogOpError;
