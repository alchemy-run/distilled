...
export type InputsSchemaItemTemplating = boolean | InputsSchemaItemTemplatingCase1;
export const InputsSchemaItemTemplating = S.Unknown as any as S.Schema<InputsSchemaItemTemplating>;
...
export type HogFunctionTemplateMappingTemplatesList = Array<HogFunctionMappingTemplate>;
...
export const CreateHogFunctionsInvocationRequestClickhouseEventMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const CreateHogFunctionsInvocationRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    clickhouse_event: S.optional(CreateHogFunctionsInvocationRequestClickhouseEventMap),
...
export const GetHogFunctionsIconResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const GetHogFunctionsIcon2Response = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const GetHogFunctionsLogResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export type GetHogFunctionsMaskedSecretResponse = GetHogFunctionsMaskedSecretResponseBodyList;
...
export const GetHogFunctionsMetricsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    after: S.optional(S.String.pipe(T.Query())),
    before: S.optional(S.String.pipe(T.Query())),
    breakdown_by: S.optional(GetHogFunctionsMetricsRequestBreakdownBy.pipe(T.Query())),
    instance_id: S.optional(S.String.pipe(T.Query())),
...
export type GetHogFunctionsMetricsTotalRequestInterval = "hour" | "day" | "week";
...
export const GetHogFunctionsMetricsTotalRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    after: S.optional(S.String.pipe(T.Query())),
    before: S.optional(S.String.pipe(T.Query())),
    breakdown_by: S.optional(GetHogFunctionsMetricsTotalRequestBreakdownBy.pipe(T.Query())),
    instance_id: S.optional(S.String.pipe(T.Query())),
    interval: S.optional(GetHogFunctionsMetricsTotalRequestInterval.pipe(T.Query())),
    kind: S.optional(S.String.pipe(T.Query())),
    name: S.optional(S.String.pipe(T.Query())),
  }).pipe(
    T.Http({
...
export const HogFunctionsDestroyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
  identifier: "HogFunctionsDestroyResponse",
}) as any as S.Schema<HogFunctionsDestroyResponse>;

/** Schema defining the configurable input parameters for this function. */
export type HogFunctionsEnableBackfillsCreateRequestInputsSchemaList = Array<InputsSchemaItem>;
export const HogFunctionsEnableBackfillsCreateRequestInputsSchemaList = /*@__PURE__*/ S.Array(
  InputsSchemaItem,
...
export const HogFunctionsEnableBackfillsCreateRequestInputsMap = /*@__PURE__*/ S.Record(
  S.String,
  InputsItemInput,
) as any as S.Schema<HogFunctionsEnableBackfillsCreateRequestInputsMap>;

/** Event-to-destination field mappings. Only for destination and site_destination types. */
export type HogFunctionsEnableBackfillsCreateRequestMappingsList = Array<MappingsInput>;
export const HogFunctionsEnableBackfillsCreateRequestMappingsList = /*@__PURE__*/ S.Array(
  MappingsInput,
...
export const HogFunctionsEnableBackfillsCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    deleted: S.optional(S.Boolean),
    hog: S.optional(S.String),
    inputs_schema: S.optional(HogFunctionsEnableBackfillsCreateRequestInputsSchemaList),
    inputs: S.optional(HogFunctionsEnableBackfillsCreateRequestInputsMap),
    filters: S.optional(HogFunctionFilters),
    masking: S.optional(S.NullOr(HogFunctionMasking)),
    mappings: S.optional(S.NullOr(HogFunctionsEnableBackfillsCreateRequestMappingsList)),
    icon_url: S.optional(S.NullOr(S.String)),
    template_id: S.optional(S.NullOr(S.String)),
    execution_order: S.optional(S.NullOr(S.Number)),
    _create_in_folder: S.optional(S.String),
...
export const HogFunctionsEnableBackfillsCreateResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export const HogFunctionPublishResponseOutputChangedFieldsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const HogFunctionsRevisionsRestoreCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
    version: S.Number.pipe(T.Label()),
...
export const UpdateHogFunctionsPartialRequestInputsSchemaList = /*@__PURE__*/ S.Array(
  InputsSchemaItem,
...
export const UpdateHogFunctionsPartialRequestMappingsList = /*@__PURE__*/ S.Array(
  MappingsInput,
...
export const UpdateHogFunctionsPartialRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    filters: S.optional(HogFunctionFilters),
    masking: S.optional(S.NullOr(HogFunctionMasking)),
    mappings: S.optional(S.NullOr(UpdateHogFunctionsPartialRequestMappingsList)),
    icon_url: S.optional(S.NullOr(S.String)),
    template_id: S.optional(S.NullOr(S.String)),
    execution_order: S.optional(S.NullOr(S.Number)),
    _create_in_folder: S.optional(S.String),
...
export const UpdateHogFunctionsRearrangePartialRequestOrdersMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Number,
...
export const UpdateHogFunctionsRearrangePartialRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
...
export type UpdateHogFunctionsRearrangePartialResponseBodyList = Array<HogFunctionOutput>;
export const UpdateHogFunctionsRearrangePartialResponseBodyList = /*@__PURE__*/ S.Array(
  HogFunctionOutput,
...
export const UpdateHogFunctionsRearrangePartialResponse = /*@__PURE__*/ S.suspend(() =>
  UpdateHogFunctionsRearrangePartialResponseBodyList.pipe(T.RawResponseRoot()),
).annotate({
  identifier: "UpdateHogFunctionsRearrangePartialResponse",
}) as any as S.Schema<UpdateHogFunctionsRearrangePartialResponse>;

export type CreateHogFunctionError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type CreateHogFunctionsInvocationError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetHogFunctionsLogError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetHogFunctionsMetricsError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetHogFunctionsMetricsTotalError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ListHogFunctionsError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UpdateHogFunctionError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UpdateHogFunctionsPartialError = BadRequest | Forbidden | NotFound | PosthogOpError;
