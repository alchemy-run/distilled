...
export type SandboxEnvironmentNetworkAccessLevelEnum = "trusted" | "full" | "custom";
...
export interface CreateSandboxRequest {
  ...
  network_access_level?: SandboxEnvironmentNetworkAccessLevelEnum | (string & {});
  /** Allowed domains for custom network access. */
...
export const SandboxEnvironmentDTOEnvironmentVariableKeysList = /*@__PURE__*/ S.Array(
  S.String,
...
export const SandboxEnvironmentDTO = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    environment_variable_keys: S.optional(SandboxEnvironmentDTOEnvironmentVariableKeysList),
    private: S.Boolean,
    internal: S.Boolean,
...
export const UpdateSandboxPartialRequestAllowedDomainsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateSandboxPartialRequestRepositoriesList = /*@__PURE__*/ S.Array(
  S.String,
...
export type CreateSandboxError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ListSandboxError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** API for managing sandbox environments that control network access for task runs. */
...
export type UpdateSandboxPartialError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** API for managing sandbox environments that control network access for task runs. */
