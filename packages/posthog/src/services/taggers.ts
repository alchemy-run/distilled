...
export type TaggerConditionPropertiesList = Array<TaggerConditionPropertiesItemMap>;
...
export type ListTaggersRequestOrderByList = Array<ListTaggersRequestOrderByItem | (string & {})>;
