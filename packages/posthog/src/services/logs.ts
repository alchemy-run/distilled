...
export type LogsAlertFiltersSeverityLevelsList = Array<LogSeverityLevel | (string & {})>;
...
export interface CreateLogsAlertRequest {
  ...
  threshold_operator?: LogsAlertConfigurationThresholdOperatorEnum | (string & {});
...
export type LogsAlertConfigurationDestinationTypesList = Array<NotificationDestinationTypeEnum>;
...
export const LogsAlertDestinationResponseHogFunctionIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const LogsAlertDestinationResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    hog_function_ids: S.optional(LogsAlertDestinationResponseHogFunctionIdsList),
  }),
).annotate({
...
export type LogsAnomalyScanResponseBindingConstraintsList = Array<BindingConstraintsEnum>;
export const LogsAnomalyScanResponseBindingConstraintsList = /*@__PURE__*/ S.Array(
...
export type LogsAnomalyBaselineStageEnum = "insufficient" | "cold_start" | "developing" | "mature";
...
export const LogsAnomalyScanIssueAnomalousBucketTimesList = /*@__PURE__*/ S.Array(
  S.String,
...
export type LogsCountBodySeverityLevelsList = Array<SeverityLevelsEnum | (string & {})>;
...
export type LogPropertyFilterTypeEnum = "log" | "log_attribute" | "log_resource_attribute";
...
export type LogsFacetValuesBodySeverityLevelsList = Array<SeverityLevelsEnum | (string & {})>;
...
export type LogsPatternsBodySeverityLevelsList = Array<SeverityLevelsEnum | (string & {})>;
...
export type LogsPatternsResponseSparklineBucketsList = Array<LogsPatternsSparklineBucket>;
...
export type LogPatternDiffEntryClassificationEnum = "new" | "rate_shift" | "gone" | "unchanged";
...
export const CreateLogsRetentionRulesReorderRequestOrderedIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export type PaginatedLogsRetentionRuleListResultsList = Array<LogsRetentionRule>;
...
export const CreateLogsRetentionRulesSuggestNameRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
...
export type LogsExclusionRuleRuleTypeEnum = "severity_sampling" | "path_drop" | "rate_limit";
...
export const CreateLogsSamplingRuleRequestScopeAttributeFiltersItemMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const CreateLogsSamplingRuleRequestScopeAttributeFiltersList = /*@__PURE__*/ S.Array(
...
export const LogsSamplingRule = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    scope_service: S.optional(S.NullOr(S.String)),
    scope_path_pattern: S.optional(S.NullOr(S.String)),
    scope_attribute_filters: S.optional(LogsSamplingRuleScopeAttributeFiltersList),
    config: S.Unknown,
    version: S.Number,
    created_by: S.Number,
    created_at: S.String,
...
export const CreateLogsSamplingRulesReorderRequestOrderedIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
/** Filter by log severity levels. */
export type LogsServicesBodySeverityLevelsList = Array<SeverityLevelsEnum | (string & {})>;
...
export type LogsServicesResponseSparklineList = Array<LogsServicesSparklineBucket>;
...
export const LogsAlertConfigurationDetailStateTimelineList = /*@__PURE__*/ S.Array(
  LogsAlertStateInterval,
...
export const LogsAlertConfigurationDetailDestinationTypesList = /*@__PURE__*/ S.Array(
  NotificationDestinationTypeEnum,
...
export const LogsAlertDestinationConfigHogFunctionIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export type LogsAlertConfigurationDetailDestinationsList = Array<LogsAlertDestinationConfig>;
export const LogsAlertConfigurationDetailDestinationsList = /*@__PURE__*/ S.Array(
...
export const GetLogsValueRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    attribute_type: S.optional(GetLogsValueRequestAttributeType.pipe(T.Query())),
    dateRange: S.optional(DateRange.pipe(T.Query())),
...
export const LogsAlertsDestinationsDeleteCreateRequestHogFunctionIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const LogsAlertsDestinationsDeleteCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
    hog_function_ids: S.optional(LogsAlertsDestinationsDeleteCreateRequestHogFunctionIdsList),
  }).pipe(
    T.Http({
      method: "POST",
...
export const LogsAlertsDestinationsDeleteCreateResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export const LogsMetricRulesDestroyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const UpdateLogsSamplingRuleRequestScopeAttributeFiltersItemMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const UpdateLogsSamplingRuleRequestScopeAttributeFiltersList = /*@__PURE__*/ S.Array(
...
export const UpdateLogsSamplingRuleRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    scope_service: S.optional(S.NullOr(S.String)),
    scope_path_pattern: S.optional(S.NullOr(S.String)),
    scope_attribute_filters: S.optional(UpdateLogsSamplingRuleRequestScopeAttributeFiltersList),
    config: S.Unknown,
  }).pipe(
    T.Http({
      method: "PUT",
...
export const UpdateLogsSamplingRulesPartialRequestScopeAttributeFiltersList = /*@__PURE__*/ S.Array(
...
export type CreateLogsAlertError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type CreateLogsAlertsDestinationError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type CreateLogsAlertsSimulateError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type CreateLogsAnomaliesSeriesBandError = BadRequest | UnprocessableEntity | PosthogOpError;
...
export type CreateLogsCountError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type CreateLogsQueryError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type CreateLogsServiceError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type CreateLogsSparklineError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetLogsAttributeError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetLogsValueError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ListLogsAlertsError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ListLogsAlertsEventsError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UpdateLogsAlertError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UpdateLogsAlertsPartialError = BadRequest | Forbidden | NotFound | PosthogOpError;
