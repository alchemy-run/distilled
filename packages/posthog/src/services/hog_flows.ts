...
export type HogFlowConversionFiltersList = Array<HogFlowConversionFiltersItemMap>;
...
export type HogFunctionFiltersActionsList = Array<HogFunctionFiltersActionsItemMap>;
...
export type HogFunctionFiltersEventsList = Array<HogFunctionFiltersEventsItemMap>;
...
export type HogFunctionFiltersDataWarehouseList = Array<HogFunctionFiltersDataWarehouseItemMap>;
...
export type HogFunctionFiltersPropertiesList = Array<HogFunctionFiltersPropertiesItemMap>;
...
export type HogFlowActionConfigCase1EventsList = Array<HogFlowActionConfigCase1EventsItem>;
...
export type CreateHogFlowRequestVariablesList = Array<CreateHogFlowRequestVariablesItemMap>;
...
export const CreateHogFlowRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    email_sending_rate_limit: S.optional(S.NullOr(HogFlowEmailSendingRateLimit)),
...
export type GetHogFlowsInvocationResultResponse = GetHogFlowsInvocationResultResponseBodyList;
...
export const GetHogFlowsMetricsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    after: S.optional(S.String.pipe(T.Query())),
    before: S.optional(S.String.pipe(T.Query())),
    breakdown_by: S.optional(GetHogFlowsMetricsRequestBreakdownBy.pipe(T.Query())),
    instance_id: S.optional(S.String.pipe(T.Query())),
...
export type GetHogFlowsMetricsGlobalResponse = GetHogFlowsMetricsGlobalResponseBodyList;
...
export const GetHogFlowsMetricsTotalRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    after: S.optional(S.String.pipe(T.Query())),
    before: S.optional(S.String.pipe(T.Query())),
    breakdown_by: S.optional(GetHogFlowsMetricsTotalRequestBreakdownBy.pipe(T.Query())),
    instance_id: S.optional(S.String.pipe(T.Query())),
    interval: S.optional(GetHogFlowsMetricsTotalRequestInterval.pipe(T.Query())),
    kind: S.optional(S.String.pipe(T.Query())),
    name: S.optional(S.String.pipe(T.Query())),
  }).pipe(
    T.Http({
...
export type AwsTenantReputationHealthEnum = "healthy" | "warning" | "critical" | "suspended";
...
export type TeamEmailReputationResponseWorkflowsList = Array<WorkflowEmailSendingRates>;
...
export const TeamEmailReputationResponseIspSharedDomainsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const TeamEmailReputationResponseIspWithheldDomainsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const HogFlowsBulkDeleteCreateRequestVariablesList = /*@__PURE__*/ S.Array(
...
export type HogFlowsInvocationsCancelCreateRequestInvocationIdsList = Array<string>;
export const HogFlowsInvocationsCancelCreateRequestInvocationIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const HogFlowsInvocationsCancelCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
    invocation_ids: S.optional(HogFlowsInvocationsCancelCreateRequestInvocationIdsList),
...
export type HogFlowPublishImpactDeletedStepsList = Array<HogFlowPublishImpactDeletedStep>;
...
export const HogFlowPublishImpactEmptyVariableReferencedByList = /*@__PURE__*/ S.Array(
  S.String,
...
export type HogFlowPublishImpactEmptyVariablesList = Array<HogFlowPublishImpactEmptyVariable>;
...
export const HogFlowPublishImpactScheduleConflictVariablesList = /*@__PURE__*/ S.Array(
  S.String,
...
export type HogFlowPublishImpactScheduleConflictsList = Array<HogFlowPublishImpactScheduleConflict>;
...
export type ListHogFlowsBatchJobsResponse = ListHogFlowsBatchJobsResponseBodyList;
...
export type ListHogFlowsSchedulesResponse = ListHogFlowsSchedulesResponseBodyList;
...
/** Workflow vars (key, type, default). Total <5KB. */
export type UpdateHogFlowRequestVariablesList = Array<UpdateHogFlowRequestVariablesItemMap>;
...
export const UpdateHogFlowsActionsEmailPartialRequestOperationsList = /*@__PURE__*/ S.Array(
  DesignOperation,
...
export const UpdateHogFlowsActionsEmailPartialRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    operations: S.optional(UpdateHogFlowsActionsEmailPartialRequestOperationsList),
...
export const UpdateHogFlowsGraphPartialRequestOperationsList = /*@__PURE__*/ S.Array(
...
export type CreateHogFlowError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type CreateHogFlowsBatchJobError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type CreateHogFlowsInvocationError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type CreateHogFlowsScheduleError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type CreateHogFlowsUserBlastRadiusError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetHogFlowsLogError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetHogFlowsMetricsError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetHogFlowsMetricsTotalError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type HogFlowsBulkDeleteCreateError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type HogFlowsSchedulesDestroyError = Forbidden | NotFound | PosthogOpError;
...
export type ListHogFlowsError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ListHogFlowsSchedulesError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UpdateHogFlowError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UpdateHogFlowsPartialError = BadRequest | Forbidden | NotFound | PosthogOpError;
