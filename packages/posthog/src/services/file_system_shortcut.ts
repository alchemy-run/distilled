...
export const CreateFileSystemShortcutReorderRequestOrderedIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export type PaginatedFileSystemShortcutListResultsList = Array<FileSystemShortcut2>;
...
export type CreateFileSystemShortcutError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type FileSystemShortcutDestroyError = Forbidden | NotFound | PosthogOpError;
...
export type ListFileSystemShortcutError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UpdateFileSystemShortcutError = BadRequest | Forbidden | NotFound | PosthogOpError;
