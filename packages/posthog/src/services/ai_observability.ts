...
export const AiObservabilityInstrumentationChecklistRestoreCreateRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
...
export type InstrumentationCheckStatusEnum = "ok" | "warning" | "pending" | "dismissed";
...
export const CreateAiObservabilityInstrumentationChecklistDismissRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      project_id: S.String.pipe(T.Label()),
      check: AIObservabilityInstrumentationCheckEnum,
...
export const CreateLlmAnalyticsOfflineEvaluationsExperimentItemRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      project_id: S.String.pipe(T.Label()),
...
export const OfflineExperimentItemsResponseResultsItemList = /*@__PURE__*/ S.Array(
  S.Unknown,
...
export const CreateLlmAnalyticsSummarizationBatchCheckRequestTraceIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateLlmAnalyticsSummarizationBatchCheckRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    trace_ids: S.optional(CreateLlmAnalyticsSummarizationBatchCheckRequestTraceIdsList),
    mode: S.optional(DetailModeValueEnum),
    model: S.optional(S.NullOr(S.String)),
  }).pipe(
    T.Http({
...
export const GetAiObservabilityInstrumentationChecklistRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
...
export type ListLlmAnalyticsPersonalSpendRequestBucketMinutes = 5 | 15 | 30 | 60;
...
export interface ListLlmAnalyticsPersonalSpendRequest {
  ...
  bucket_minutes?: ListLlmAnalyticsPersonalSpendRequestBucketMinutes | (number & {});
...
export const ListLlmAnalyticsPersonalSpendRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    bucket_minutes: S.optional(ListLlmAnalyticsPersonalSpendRequestBucketMinutes.pipe(T.Query())),
...
export const PersonalSpendAnalysisResponseByDayModelList = /*@__PURE__*/ S.Array(
...
export type ListLlmAnalyticsPersonalSpendResponseBodyList = Array<PersonalSpendAnalysisResponse>;
export const ListLlmAnalyticsPersonalSpendResponseBodyList = /*@__PURE__*/ S.Array(
  PersonalSpendAnalysisResponse,
) as any as S.Schema<ListLlmAnalyticsPersonalSpendResponseBodyList>;

export type ListLlmAnalyticsPersonalSpendResponse = ListLlmAnalyticsPersonalSpendResponseBodyList;
...
export const UpdateDatasetItemsPartialRequestInputCase1List = /*@__PURE__*/ S.Array(
  S.Unknown,
...
export const UpdateDatasetItemsPartialRequestExpectedOutputCase0Map = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<UpdateDatasetItemsPartialRequestExpectedOutputCase0Map>;

export type UpdateDatasetItemsPartialRequestExpectedOutputCase1List = Array<unknown>;
export const UpdateDatasetItemsPartialRequestExpectedOutputCase1List = /*@__PURE__*/ S.Array(
  S.Unknown,
...
export const UpdateDatasetItemsPartialRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    expected_output: S.optional(S.NullOr(UpdateDatasetItemsPartialRequestExpectedOutput)),
...
export type AiObservabilityInstrumentationChecklistRestoreCreateError = PosthogOpError;
...
export type CreateAiObservabilityInstrumentationChecklistDismissError = PosthogOpError;
...
export type CreateDatasetError = BadRequest | Forbidden | NotFound | Conflict | PosthogOpError;
...
export type CreateDatasetItemError = BadRequest | Forbidden | NotFound | Conflict | PosthogOpError;
...
export type CreateLlmAnalyticsOfflineEvaluationsExperimentItemError = BadRequest | PosthogOpError;
...
export type CreateLlmAnalyticsSummarizationError = BadRequest | Forbidden | PosthogOpError;
...
export type ListDatasetItemsError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ListDatasetsError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ListLlmAnalyticsPersonalSpendError = BadRequest | Forbidden | NotFound | PosthogOpError;
