...
export const CreateUsersCredentialsReviewCompleteRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const CreateUsersCredentialsReviewCompleteResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export const CreateUsersIntegrationsGithubPrepareCallbackRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    uuid: S.String.pipe(T.Label()),
...
export const CreateUsersIntegrationsGithubPrepareCallbackResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export type UserOutputNotificationLocksList = Array<OrganizationNotificationLock>;
...
export const UserOutputToolbarMode = S.Unknown as any as S.Schema<UserOutputToolbarMode>;
...
export type UserOutputScenePersonalisationList = Array<ScenePersonalisationBasic>;
...
export const UserOutputThemeMode = S.Unknown as any as S.Schema<UserOutputThemeMode>;
...
export const UserOutputShortcutPosition = S.Unknown as any as S.Schema<UserOutputShortcutPosition>;
...
export type OnboardingSkippedReasonEnum = "delegated" | "later" | "other" | "provisioned";
...
export const UserOutputActiveRealtimeNotificationTypesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UserOutput = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    onboarding_skipped_reason: S.optional(S.NullOr(OnboardingSkippedReasonEnum)),
    ...
    active_realtime_notification_types: S.optional(UserOutputActiveRealtimeNotificationTypesList),
...
export type CreateUsersRequestEmailVerificationRequestToolbarMode = ToolbarModeEnum | BlankEnum;
...
export type CreateUsersRequestEmailVerificationRequestThemeMode = ThemeModeEnum | BlankEnum;
...
export const CreateUsersRequestEmailVerificationRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    anonymize_data: S.optional(S.NullOr(S.Boolean)),
    allow_impersonation: S.optional(S.NullOr(S.Boolean)),
    toolbar_mode: S.optional(S.NullOr(CreateUsersRequestEmailVerificationRequestToolbarMode)),
    is_staff: S.optional(S.Boolean),
    ...
    events_column_config: S.optional(S.Unknown),
    has_seen_product_intro_for: S.optional(S.Unknown),
    theme_mode: S.optional(S.NullOr(CreateUsersRequestEmailVerificationRequestThemeMode)),
    hedgehog_config: S.optional(S.Unknown),
    allow_sidebar_suggestions: S.optional(S.NullOr(S.Boolean)),
...
export const CreateUsersRequestEmailVerificationResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export const CreateUsersScenePersonalisationRequestNotificationSettingsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<CreateUsersScenePersonalisationRequestNotificationSettingsMap>;

export type CreateUsersScenePersonalisationRequestToolbarMode = ToolbarModeEnum | BlankEnum;
...
export type CreateUsersScenePersonalisationRequestThemeMode = ThemeModeEnum | BlankEnum;
...
export const CreateUsersScenePersonalisationRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    anonymize_data: S.optional(S.NullOr(S.Boolean)),
    allow_impersonation: S.optional(S.NullOr(S.Boolean)),
    toolbar_mode: S.optional(S.NullOr(CreateUsersScenePersonalisationRequestToolbarMode)),
    is_staff: S.optional(S.Boolean),
    set_current_organization: S.optional(S.String),
    set_current_team: S.optional(S.String),
    password: S.optional(S.String.pipe(T.SensitiveValue({}))),
    ...
    events_column_config: S.optional(S.Unknown),
    has_seen_product_intro_for: S.optional(S.Unknown),
    theme_mode: S.optional(S.NullOr(CreateUsersScenePersonalisationRequestThemeMode)),
    hedgehog_config: S.optional(S.Unknown),
    allow_sidebar_suggestions: S.optional(S.NullOr(S.Boolean)),
    shortcut_position: S.optional(S.NullOr(CreateUsersScenePersonalisationRequestShortcutPosition)),
    role_at_organization: S.optional(RoleAtOrganizationEnum),
    passkeys_enabled_for_2fa: S.optional(S.NullOr(S.Boolean)),
    hide_mcp_hints: S.optional(S.Boolean),
    ui_configuration: S.optional(S.Unknown),
...
export type SignalUserAutonomyConfigAutostartPriority = AutonomyPriorityEnum | BlankEnum;
...
/** Minimum report priority that triggers a Slack notification. P0 is highest. Null means notify on every priority. When set, reports without a priority judgment do not notify. * `P0` - P0 * `P1` - P1 * `P2` - P2 * `P3` - P3 * `P4` - P4 */
export type SignalUserAutonomyConfigSlackNotificationMinPriority = AutonomyPriorityEnum | BlankEnum;
...
export const SignalUserAutonomyConfig = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    autostart_priority: S.optional(S.NullOr(SignalUserAutonomyConfigAutostartPriority)),
...
export const CreateUsersTwoFactorBackupCodeRequestNotificationSettingsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<CreateUsersTwoFactorBackupCodeRequestNotificationSettingsMap>;

export type CreateUsersTwoFactorBackupCodeRequestToolbarMode = ToolbarModeEnum | BlankEnum;
...
export type CreateUsersTwoFactorBackupCodeRequestThemeMode = ThemeModeEnum | BlankEnum;
...
export const CreateUsersTwoFactorBackupCodeRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    last_name: S.optional(S.String),
    email: S.optional(S.String),
    notification_settings: S.optional(CreateUsersTwoFactorBackupCodeRequestNotificationSettingsMap),
    anonymize_data: S.optional(S.NullOr(S.Boolean)),
    allow_impersonation: S.optional(S.NullOr(S.Boolean)),
    toolbar_mode: S.optional(S.NullOr(CreateUsersTwoFactorBackupCodeRequestToolbarMode)),
    is_staff: S.optional(S.Boolean),
    set_current_organization: S.optional(S.String),
    set_current_team: S.optional(S.String),
    password: S.optional(S.String.pipe(T.SensitiveValue({}))),
    ...
    events_column_config: S.optional(S.Unknown),
    has_seen_product_intro_for: S.optional(S.Unknown),
    theme_mode: S.optional(S.NullOr(CreateUsersTwoFactorBackupCodeRequestThemeMode)),
    hedgehog_config: S.optional(S.Unknown),
    allow_sidebar_suggestions: S.optional(S.NullOr(S.Boolean)),
    shortcut_position: S.optional(S.NullOr(CreateUsersTwoFactorBackupCodeRequestShortcutPosition)),
    role_at_organization: S.optional(RoleAtOrganizationEnum),
    passkeys_enabled_for_2fa: S.optional(S.NullOr(S.Boolean)),
    hide_mcp_hints: S.optional(S.Boolean),
    ui_configuration: S.optional(S.Unknown),
...
export const CreateUsersValidate2faRequestNotificationSettingsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<CreateUsersValidate2faRequestNotificationSettingsMap>;

export type CreateUsersValidate2faRequestToolbarMode = ToolbarModeEnum | BlankEnum;
...
export type CreateUsersValidate2faRequestShortcutPosition = ShortcutPositionEnum | BlankEnum;
...
export const CreateUsersValidate2faRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    last_name: S.optional(S.String),
    email: S.optional(S.String),
    notification_settings: S.optional(CreateUsersValidate2faRequestNotificationSettingsMap),
    anonymize_data: S.optional(S.NullOr(S.Boolean)),
    allow_impersonation: S.optional(S.NullOr(S.Boolean)),
    toolbar_mode: S.optional(S.NullOr(CreateUsersValidate2faRequestToolbarMode)),
    is_staff: S.optional(S.Boolean),
    set_current_organization: S.optional(S.String),
    set_current_team: S.optional(S.String),
    password: S.optional(S.String.pipe(T.SensitiveValue({}))),
    ...
    hedgehog_config: S.optional(S.Unknown),
    allow_sidebar_suggestions: S.optional(S.NullOr(S.Boolean)),
    shortcut_position: S.optional(S.NullOr(CreateUsersValidate2faRequestShortcutPosition)),
    role_at_organization: S.optional(RoleAtOrganizationEnum),
    passkeys_enabled_for_2fa: S.optional(S.NullOr(S.Boolean)),
    hide_mcp_hints: S.optional(S.Boolean),
    ui_configuration: S.optional(S.Unknown),
...
export const CreateUsersValidate2faResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const GetUsersIntegrationsSlackLinkableWorkspaceRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    uuid: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
...
export const UserSlackLinkableWorkspaceListResponseResultsList = /*@__PURE__*/ S.Array(
...
export const GetUsersStart2faSetupResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const InstallUsersIntegrationsGithubRequestsDestroyRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    uuid: S.String.pipe(T.Label()),
...
export const InstallUsersIntegrationsGithubRequestsDestroyResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export type UserGitHubIntegrationListResponseResultsList = Array<UserGitHubIntegrationItem>;
export const UserGitHubIntegrationListResponseResultsList = /*@__PURE__*/ S.Array(
...
export const PaginatedUserGitHubIntegrationListResponseListResultsList = /*@__PURE__*/ S.Array(
...
export const PaginatedUserGitHubIntegrationListResponseList = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    count: S.Number,
    next: S.optional(S.NullOr(S.String)),
    previous: S.optional(S.NullOr(S.String)),
...
export type ListUsersLoginSessionsResponse = ListUsersLoginSessionsResponseBodyList;
...
export const UpdateUserRequestThemeMode = S.Unknown as any as S.Schema<UpdateUserRequestThemeMode>;

export type UpdateUserRequestShortcutPosition = ShortcutPositionEnum | BlankEnum;
...
export type UpdateUsersHedgehogConfigPartialRequestToolbarMode = ToolbarModeEnum | BlankEnum;
...
export type UpdateUsersHedgehogConfigPartialRequestThemeMode = ThemeModeEnum | BlankEnum;
...
export const UpdateUsersHedgehogConfigPartialRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    anonymize_data: S.optional(S.NullOr(S.Boolean)),
    allow_impersonation: S.optional(S.NullOr(S.Boolean)),
    toolbar_mode: S.optional(S.NullOr(UpdateUsersHedgehogConfigPartialRequestToolbarMode)),
    is_staff: S.optional(S.Boolean),
    set_current_organization: S.optional(S.String),
    set_current_team: S.optional(S.String),
    password: S.optional(S.String.pipe(T.SensitiveValue({}))),
    ...
    events_column_config: S.optional(S.Unknown),
    has_seen_product_intro_for: S.optional(S.Unknown),
    theme_mode: S.optional(S.NullOr(UpdateUsersHedgehogConfigPartialRequestThemeMode)),
    hedgehog_config: S.optional(S.Unknown),
    allow_sidebar_suggestions: S.optional(S.NullOr(S.Boolean)),
    shortcut_position: S.optional(
...
export const UpdateUsersPartialRequestNotificationSettingsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export type UpdateUsersPartialRequestShortcutPosition = ShortcutPositionEnum | BlankEnum;
...
export const UpdateUsersPartialRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    last_name: S.optional(S.String),
    email: S.optional(S.String),
    notification_settings: S.optional(UpdateUsersPartialRequestNotificationSettingsMap),
    anonymize_data: S.optional(S.NullOr(S.Boolean)),
    allow_impersonation: S.optional(S.NullOr(S.Boolean)),
    ...
    hedgehog_config: S.optional(S.Unknown),
    allow_sidebar_suggestions: S.optional(S.NullOr(S.Boolean)),
    shortcut_position: S.optional(S.NullOr(UpdateUsersPartialRequestShortcutPosition)),
    role_at_organization: S.optional(RoleAtOrganizationEnum),
    passkeys_enabled_for_2fa: S.optional(S.NullOr(S.Boolean)),
    hide_mcp_hints: S.optional(S.Boolean),
    ui_configuration: S.optional(S.Unknown),
...
export const UpdateUsersProductIntroSeenPartialRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    uuid: S.String.pipe(T.Label()),
...
export const UpdateUsersProductIntroSeenPartialResponseBodyMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Boolean,
...
export const UpdateUsersProductIntroSeenPartialResponse = /*@__PURE__*/ S.suspend(() =>
...
export type UsersCancelEmailChangeRequestPartialUpdateRequestThemeMode = ThemeModeEnum | BlankEnum;
...
export const UsersCancelEmailChangeRequestPartialUpdateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    events_column_config: S.optional(S.Unknown),
    has_seen_product_intro_for: S.optional(S.Unknown),
    theme_mode: S.optional(S.NullOr(UsersCancelEmailChangeRequestPartialUpdateRequestThemeMode)),
    hedgehog_config: S.optional(S.Unknown),
    allow_sidebar_suggestions: S.optional(S.NullOr(S.Boolean)),
    shortcut_position: S.optional(
      S.NullOr(UsersCancelEmailChangeRequestPartialUpdateRequestShortcutPosition),
    ),
    role_at_organization: S.optional(RoleAtOrganizationEnum),
    passkeys_enabled_for_2fa: S.optional(S.NullOr(S.Boolean)),
    hide_mcp_hints: S.optional(S.Boolean),
...
export const UsersCancelEmailChangeRequestPartialUpdateResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export const UsersIntegrationsGithubInstallRequestsRetrieveRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    uuid: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
...
export type GitHubInstallRequestStatusEnum = "pending" | "approved" | "unidentified";
...
export const GitHubInstallRequestListResponseResultsList = /*@__PURE__*/ S.Array(
...
export const UsersIntegrationsGithubReposRefreshCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    uuid: S.String.pipe(T.Label()),
    installation_id: S.String.pipe(T.Label()),
  }).pipe(
...
export const UsersIntegrationsGithubStartCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    uuid: S.String.pipe(T.Label()),
...
export const UsersLoginSessionsRevokeOthersCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    uuid: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
...
export const UsersTwoFactorDisableCreateRequestNotificationSettingsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<UsersTwoFactorDisableCreateRequestNotificationSettingsMap>;

export type UsersTwoFactorDisableCreateRequestToolbarMode = ToolbarModeEnum | BlankEnum;
...
export type UsersTwoFactorDisableCreateRequestThemeMode = ThemeModeEnum | BlankEnum;
...
export type UsersTwoFactorDisableCreateRequestShortcutPosition = ShortcutPositionEnum | BlankEnum;
...
export const UsersTwoFactorDisableCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    last_name: S.optional(S.String),
    email: S.optional(S.String),
    notification_settings: S.optional(UsersTwoFactorDisableCreateRequestNotificationSettingsMap),
    anonymize_data: S.optional(S.NullOr(S.Boolean)),
    allow_impersonation: S.optional(S.NullOr(S.Boolean)),
    toolbar_mode: S.optional(S.NullOr(UsersTwoFactorDisableCreateRequestToolbarMode)),
    is_staff: S.optional(S.Boolean),
    set_current_organization: S.optional(S.String),
    set_current_team: S.optional(S.String),
    password: S.optional(S.String.pipe(T.SensitiveValue({}))),
    ...
    events_column_config: S.optional(S.Unknown),
    has_seen_product_intro_for: S.optional(S.Unknown),
    theme_mode: S.optional(S.NullOr(UsersTwoFactorDisableCreateRequestThemeMode)),
    hedgehog_config: S.optional(S.Unknown),
    allow_sidebar_suggestions: S.optional(S.NullOr(S.Boolean)),
    shortcut_position: S.optional(S.NullOr(UsersTwoFactorDisableCreateRequestShortcutPosition)),
    role_at_organization: S.optional(RoleAtOrganizationEnum),
    passkeys_enabled_for_2fa: S.optional(S.NullOr(S.Boolean)),
    hide_mcp_hints: S.optional(S.Boolean),
    ui_configuration: S.optional(S.Unknown),
...
export const UsersTwoFactorValidateCreateRequestNotificationSettingsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<UsersTwoFactorValidateCreateRequestNotificationSettingsMap>;

export type UsersTwoFactorValidateCreateRequestToolbarMode = ToolbarModeEnum | BlankEnum;
...
export type UsersTwoFactorValidateCreateRequestThemeMode = ThemeModeEnum | BlankEnum;
...
export type UsersTwoFactorValidateCreateRequestShortcutPosition = ShortcutPositionEnum | BlankEnum;
...
export const UsersTwoFactorValidateCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    last_name: S.optional(S.String),
    email: S.optional(S.String),
    notification_settings: S.optional(UsersTwoFactorValidateCreateRequestNotificationSettingsMap),
    anonymize_data: S.optional(S.NullOr(S.Boolean)),
    allow_impersonation: S.optional(S.NullOr(S.Boolean)),
    toolbar_mode: S.optional(S.NullOr(UsersTwoFactorValidateCreateRequestToolbarMode)),
    is_staff: S.optional(S.Boolean),
    set_current_organization: S.optional(S.String),
    set_current_team: S.optional(S.String),
    password: S.optional(S.String.pipe(T.SensitiveValue({}))),
    ...
    events_column_config: S.optional(S.Unknown),
    has_seen_product_intro_for: S.optional(S.Unknown),
    theme_mode: S.optional(S.NullOr(UsersTwoFactorValidateCreateRequestThemeMode)),
    hedgehog_config: S.optional(S.Unknown),
    allow_sidebar_suggestions: S.optional(S.NullOr(S.Boolean)),
    shortcut_position: S.optional(S.NullOr(UsersTwoFactorValidateCreateRequestShortcutPosition)),
    role_at_organization: S.optional(RoleAtOrganizationEnum),
    passkeys_enabled_for_2fa: S.optional(S.NullOr(S.Boolean)),
    hide_mcp_hints: S.optional(S.Boolean),
    ui_configuration: S.optional(S.Unknown),
...
export const UsersVerifyEmailCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    uuid: S.String,
    code: S.String,
  }).pipe(T.Http({ method: "POST", uri: "/api/users/verify_email/", code: 200 })),
).annotate({
...
export const UsersVerifyEmailCreateResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export type CreateUsersRequestEmailVerificationError = BadRequest | Forbidden | PosthogOpError;
...
export type CreateUsersSignalAutonomyError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type CreateUsersValidate2faError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type SignalUserAutonomyDestroyError = Forbidden | NotFound | PosthogOpError;
/** Per-user signal autonomy config (singleton keyed by user). GET /api/users/<id>/signal_autonomy/ → current config (or 404) POST /api/users/<id>/signal_autonomy/ → create or update DELETE /api/users/<id>/signal_autonomy/ → remove (opt out) */
...
export type UpdateUserError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UpdateUsersPartialError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UsersIntegrationsGithubInstallRequestsRetrieveError = PosthogOpError;
...
export type UsersTwoFactorDisableCreateError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UsersTwoFactorStartSetupRetrieveError = Forbidden | NotFound | PosthogOpError;
...
export type UsersTwoFactorValidateCreateError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UsersVerifyEmailCreateError = BadRequest | Forbidden | PosthogOpError;
