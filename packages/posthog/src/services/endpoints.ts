...
export type CreateEndpointRequestOptionalBreakdownPropertiesList = Array<string>;
export const CreateEndpointRequestOptionalBreakdownPropertiesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateEndpointRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    bucket_overrides: S.optional(S.NullOr(CreateEndpointRequestBucketOverridesMap)),
...
export const EndpointResponseOptionalBreakdownPropertiesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateEndpointsMaterializationPreviewRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    name: S.String.pipe(T.Label()),
    version: S.optional(S.Number),
    bucket_overrides: S.optional(
      S.NullOr(CreateEndpointsMaterializationPreviewRequestBucketOverridesMap),
    ),
  }).pipe(
    T.Http({
      method: "POST",
...
export const CreateEndpointsMaterializationSuggestionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    name: S.String.pipe(T.Label()),
    version: S.optional(S.NullOr(S.Number)),
...
export type SuggestionStatusEnum = "ok" | "cannot_fix" | "invalid" | "model_error";
...
/** Breakdown property names that may be omitted on /run. Omitted ones return data aggregated across all values of that breakdown. */
export type EndpointVersionResponseOptionalBreakdownPropertiesList = Array<string>;
export const EndpointVersionResponseOptionalBreakdownPropertiesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const EndpointVersionResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    last_executed_at: S.optional(S.NullOr(S.String)),
    materialization: S.optional(EndpointMaterialization),
    bucket_overrides: S.optional(S.NullOr(EndpointVersionResponseBucketOverridesMap)),
...
export const GetEndpointsMaterializationConditionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
...
export type PaginatedEndpointVersionResponseListResultsList = Array<EndpointVersionResponse>;
export const PaginatedEndpointVersionResponseListResultsList = /*@__PURE__*/ S.Array(
...
/** Breakdown property names that may be omitted on /run. Omitted ones return data aggregated across all values of that breakdown. Defaults to [] — every breakdown variable is required. */
export type UpdateEndpointRequestOptionalBreakdownPropertiesList = Array<string>;
export const UpdateEndpointRequestOptionalBreakdownPropertiesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateEndpointRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    derived_from_insight: S.optional(S.NullOr(S.String)),
    version: S.optional(S.NullOr(S.Number)),
    bucket_overrides: S.optional(S.NullOr(UpdateEndpointRequestBucketOverridesMap)),
    deleted: S.optional(S.NullOr(S.Boolean)),
...
export const UpdateEndpointsPartialRequestBucketOverridesMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
/** Breakdown property names that may be omitted on /run. Omitted ones return data aggregated across all values of that breakdown. Defaults to [] — every breakdown variable is required. */
export type UpdateEndpointsPartialRequestOptionalBreakdownPropertiesList = Array<string>;
export const UpdateEndpointsPartialRequestOptionalBreakdownPropertiesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateEndpointsPartialRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    derived_from_insight: S.optional(S.NullOr(S.String)),
    version: S.optional(S.NullOr(S.Number)),
    bucket_overrides: S.optional(S.NullOr(UpdateEndpointsPartialRequestBucketOverridesMap)),
    deleted: S.optional(S.NullOr(S.Boolean)),
...
export type CreateEndpointError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type CreateEndpointsRunError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetEndpointsMaterializationStatusError = Forbidden | NotFound | PosthogOpError;
...
export type GetEndpointsOpenapiSpecError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ListEndpointsError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ListEndpointsVersionsError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UpdateEndpointError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UpdateEndpointsPartialError = BadRequest | Forbidden | NotFound | PosthogOpError;
