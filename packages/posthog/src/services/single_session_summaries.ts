...
export type SingleSessionSummariesListRequestOutcome = "failure" | "success" | "unknown";
...
export const SingleSessionSummariesListRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    outcome: S.optional(SingleSessionSummariesListRequestOutcome.pipe(T.Query())),
...
export const SingleSessionSummaryMinimalSessionOutcome = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const SingleSessionSummaryMinimalExtraSummaryContext = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const SingleSessionSummaryMinimal = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    extra_summary_context: S.NullOr(SingleSessionSummaryMinimalExtraSummaryContext),
    created_at: S.String,
...
export const PaginatedSingleSessionSummaryMinimalListResultsList = /*@__PURE__*/ S.Array(
