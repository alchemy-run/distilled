...
export const CancelNotebooksWidgetResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const CreateNotebooksCollabMarkdownSaveResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export type CreateNotebooksSqlV2RunRequestVariablesList = Array<NotebookVariable>;
export const CreateNotebooksSqlV2RunRequestVariablesList = /*@__PURE__*/ S.Array(
  NotebookVariable,
...
export const GetNotebooksActivityResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const NotebookComputeOptionsResponseAllowedCpuCoresList = /*@__PURE__*/ S.Array(
  S.Number,
...
export const NotebookComputeOptionsResponseAllowedMemoryGbList = /*@__PURE__*/ S.Array(
  S.Number,
...
export type NotebookSQLV2FrameColumnsList = Array<NotebookSQLV2FrameColumnsItemList>;
...
export type NotebookSQLV2EnvelopeTypesList = Array<NotebookSQLV2EnvelopeTypesItemList>;
...
export type NotebookSQLV2EnvelopeFirstPageList = Array<NotebookSQLV2EnvelopeFirstPageItemList>;
...
export const NotebooksKernelExecuteCreateRequestVariablesList = /*@__PURE__*/ S.Array(
  NotebookVariable,
...
/** Notebook-level variables, in display order. A SQL cell reads one as a `{name}` placeholder and a Python cell as a global. Names must be unique. */
export type NotebooksKernelStartCreateRequestVariablesList = Array<NotebookVariable>;
export const NotebooksKernelStartCreateRequestVariablesList = /*@__PURE__*/ S.Array(
  NotebookVariable,
...
/** Notebook-level variables, in display order. A SQL cell reads one as a `{name}` placeholder and a Python cell as a global. Names must be unique. */
export type NotebooksKernelStopCreateRequestVariablesList = Array<NotebookVariable>;
export const NotebooksKernelStopCreateRequestVariablesList = /*@__PURE__*/ S.Array(
  NotebookVariable,
...
export type GeneratedWidgetVersionOperationEnum = "initial" | "regenerate" | "improve" | "revert";
...
export type CreateNotebookError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** The API for interacting with Notebooks. This feature is in early access and the API can have breaking changes without announcement. */
...
export type CreateNotebooksCollabSaveError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** The API for interacting with Notebooks. This feature is in early access and the API can have breaking changes without announcement. */
...
export type GetNotebooksAllActivityError = Forbidden | NotFound | PosthogOpError;
/** The API for interacting with Notebooks. This feature is in early access and the API can have breaking changes without announcement. */
...
export type GetNotebooksCollabStreamError = Forbidden | NotFound | PosthogOpError;
/** The API for interacting with Notebooks. This feature is in early access and the API can have breaking changes without announcement. */
...
export type GetNotebooksRecordingCommentError = Forbidden | NotFound | PosthogOpError;
/** The API for interacting with Notebooks. This feature is in early access and the API can have breaking changes without announcement. */
...
export type ListNotebooksError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** The API for interacting with Notebooks. This feature is in early access and the API can have breaking changes without announcement. */
...
export type NotebooksKernelRestartCreateError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** The API for interacting with Notebooks. This feature is in early access and the API can have breaking changes without announcement. */
...
export type NotebooksKernelStartCreateError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** The API for interacting with Notebooks. This feature is in early access and the API can have breaking changes without announcement. */
...
export type NotebooksKernelStopCreateError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** The API for interacting with Notebooks. This feature is in early access and the API can have breaking changes without announcement. */
...
export type NotebooksWidgetFrameError = Forbidden | NotFound | Conflict | PosthogOpError;
/** The API for interacting with Notebooks. This feature is in early access and the API can have breaking changes without announcement. */
...
export type NotebooksWidgetRevertError = BadRequest | NotFound | Conflict | PosthogOpError;
/** The API for interacting with Notebooks. This feature is in early access and the API can have breaking changes without announcement. */
...
export type UpdateNotebookError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** The API for interacting with Notebooks. This feature is in early access and the API can have breaking changes without announcement. */
...
export type UpdateNotebooksPartialError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** The API for interacting with Notebooks. This feature is in early access and the API can have breaking changes without announcement. */
