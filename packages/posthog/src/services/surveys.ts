...
export const SurveyResponseBasedBranchingResponseValuesMap = /*@__PURE__*/ S.Record(
  S.String,
...
export const SurveyBranchingSchema = S.Unknown as any as S.Schema<SurveyBranchingSchema>;
...
export const SurveySingleChoiceQuestionSchemaChoicesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const SurveyMultipleChoiceQuestionSchemaChoicesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const SurveyQuestionInputSchema = S.Unknown as any as S.Schema<SurveyQuestionInputSchema>;
...
export type SurveyEventsConditionSchemaValuesList = Array<SurveyConditionEventValueSchema>;
...
export type SurveyConditionsSchemaDeviceTypesList = Array<DeviceTypesEnum | (string & {})>;
...
export interface SurveyAppearanceSchema {
  ...
  thankYouMessageDescriptionContentType?: DescriptionContentTypeEnum | (string & {});
...
export const SurveyAppearanceSchema = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    thankYouMessageDescriptionContentType: S.optional(DescriptionContentTypeEnum),
...
export const CreateSurveyRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    iteration_start_dates: S.optional(S.NullOr(CreateSurveyRequestIterationStartDatesList)),
...
export type SurveySerializerCreateUpdateOnlyOutputIterationStartDatesList = Array<string | null>;
export const SurveySerializerCreateUpdateOnlyOutputIterationStartDatesList = /*@__PURE__*/ S.Array(
  S.NullOr(S.String),
...
export const SurveySerializerCreateUpdateOnlyOutput = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    response_sampling_start_date: S.optional(S.NullOr(S.String)),
    response_sampling_interval_type: S.optional(
      S.NullOr(SurveySerializerCreateUpdateOnlyOutputResponseSamplingIntervalType),
    ),
    response_sampling_interval: S.optional(S.NullOr(S.Number)),
    response_sampling_limit: S.optional(S.NullOr(S.Number)),
    response_sampling_daily_limits: S.optional(S.Unknown),
...
export type CreateSurveysSummaryHeadlineRequestIterationStartDatesList = Array<string | null>;
export const CreateSurveysSummaryHeadlineRequestIterationStartDatesList = /*@__PURE__*/ S.Array(
  S.NullOr(S.String),
...
export type SurveyResponseSamplingIntervalType = SurveySamplingIntervalTypeEnum | BlankEnum;
...
export const Survey = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    current_iteration_start_date: S.optional(S.NullOr(S.String)),
    response_sampling_start_date: S.optional(S.NullOr(S.String)),
    response_sampling_interval_type: S.optional(S.NullOr(SurveyResponseSamplingIntervalType)),
    response_sampling_interval: S.optional(S.NullOr(S.Number)),
    response_sampling_limit: S.optional(S.NullOr(S.Number)),
    response_sampling_daily_limits: S.optional(S.Unknown),
    enable_partial_responses: S.optional(S.NullOr(S.Boolean)),
...
export const GetSurveysActivityResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const GetSurveysAllActivityResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export type ListSurveysRequestType = "api" | "external_survey" | "popover" | "widget";
...
export type SurveysDuplicateToProjectsCreateRequestIterationStartDatesList = Array<string | null>;
export const SurveysDuplicateToProjectsCreateRequestIterationStartDatesList = /*@__PURE__*/ S.Array(
  S.NullOr(S.String),
...
export const SurveysDuplicateToProjectsCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    iteration_frequency_days: S.optional(S.NullOr(S.Number)),
    iteration_start_dates: S.optional(
      S.NullOr(SurveysDuplicateToProjectsCreateRequestIterationStartDatesList),
    ),
    current_iteration: S.optional(S.NullOr(S.Number)),
    current_iteration_start_date: S.optional(S.NullOr(S.String)),
    response_sampling_start_date: S.optional(S.NullOr(S.String)),
    response_sampling_interval_type: S.optional(
      S.NullOr(SurveysDuplicateToProjectsCreateRequestResponseSamplingIntervalType),
    ),
    response_sampling_interval: S.optional(S.NullOr(S.Number)),
    response_sampling_limit: S.optional(S.NullOr(S.Number)),
    response_sampling_daily_limits: S.optional(S.Unknown),
...
export const SurveysGenerateTranslationsCreateRequestSurveyMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const GenerateSurveyTranslationsResponseTranslationsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export const GeneratedSurveyQuestionTranslationChoicesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GeneratedSurveyQuestionTranslationPatchTranslationsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export const GenerateSurveyTranslationsResponseQuestionsList = /*@__PURE__*/ S.Array(
...
export type GenerateSurveyTranslationsResponseGeneratedFieldPathsList = Array<string>;
export const GenerateSurveyTranslationsResponseGeneratedFieldPathsList = /*@__PURE__*/ S.Array(
  S.String,
...
export type SurveysResponsesArchiveCreateRequestIterationStartDatesList = Array<string | null>;
export const SurveysResponsesArchiveCreateRequestIterationStartDatesList = /*@__PURE__*/ S.Array(
  S.NullOr(S.String),
...
export const SurveysResponsesArchiveCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    response_sampling_start_date: S.optional(S.NullOr(S.String)),
    response_sampling_interval_type: S.optional(
      S.NullOr(SurveysResponsesArchiveCreateRequestResponseSamplingIntervalType),
    ),
    response_sampling_interval: S.optional(S.NullOr(S.Number)),
    response_sampling_limit: S.optional(S.NullOr(S.Number)),
    response_sampling_daily_limits: S.optional(S.Unknown),
...
export type SurveysResponsesUnarchiveCreateRequestIterationStartDatesList = Array<string | null>;
export const SurveysResponsesUnarchiveCreateRequestIterationStartDatesList = /*@__PURE__*/ S.Array(
  S.NullOr(S.String),
...
export const SurveysResponsesUnarchiveCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    response_sampling_start_date: S.optional(S.NullOr(S.String)),
    response_sampling_interval_type: S.optional(
      S.NullOr(SurveysResponsesUnarchiveCreateRequestResponseSamplingIntervalType),
    ),
    response_sampling_interval: S.optional(S.NullOr(S.Number)),
    response_sampling_limit: S.optional(S.NullOr(S.Number)),
    response_sampling_daily_limits: S.optional(S.Unknown),
...
export const UpdateSurveyRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    iteration_count: S.optional(S.NullOr(S.Number)),
    iteration_frequency_days: S.optional(S.NullOr(S.Number)),
    iteration_start_dates: S.optional(S.NullOr(UpdateSurveyRequestIterationStartDatesList)),
    current_iteration: S.optional(S.NullOr(S.Number)),
    current_iteration_start_date: S.optional(S.NullOr(S.String)),
    response_sampling_start_date: S.optional(S.NullOr(S.String)),
    response_sampling_interval_type: S.optional(
...
export type UpdateSurveysPartialRequestIterationStartDatesList = Array<string | null>;
export const UpdateSurveysPartialRequestIterationStartDatesList = /*@__PURE__*/ S.Array(
  S.NullOr(S.String),
...
export const UpdateSurveysPartialRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    iteration_count: S.optional(S.NullOr(S.Number)),
    iteration_frequency_days: S.optional(S.NullOr(S.Number)),
    iteration_start_dates: S.optional(S.NullOr(UpdateSurveysPartialRequestIterationStartDatesList)),
    current_iteration: S.optional(S.NullOr(S.Number)),
    current_iteration_start_date: S.optional(S.NullOr(S.String)),
    response_sampling_start_date: S.optional(S.NullOr(S.String)),
    response_sampling_interval_type: S.optional(
...
export type GetSurveysArchivedResponseUuidError = Forbidden | NotFound | PosthogOpError;
...
export type GetSurveysGlobalStatError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetSurveysResponsesCountError = Forbidden | NotFound | PosthogOpError;
...
export type GetSurveysStatError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type SurveysResponsesArchiveCreateError = BadRequest | Forbidden | NotFound | PosthogOpError;
