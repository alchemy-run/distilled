...
export interface CreateAlertRequest {
  ...
  investigation_inconclusive_action?: InvestigationInconclusiveActionEnum | (string & {});
}
...
export const BreakdownSimulationResultTriggeredIndicesList = /*@__PURE__*/ S.Array(
  S.Number,
...
export const BreakdownSimulationResultTriggeredDatesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const BreakdownSimulationResultSubDetectorScoresItemMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const BreakdownSimulationResultSubDetectorScoresList = /*@__PURE__*/ S.Array(
...
export const BreakdownSimulationResult = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    triggered_indices: S.optional(BreakdownSimulationResultTriggeredIndicesList),
    ...
    sub_detector_scores: S.optional(BreakdownSimulationResultSubDetectorScoresList),
  }),
).annotate({
...
export type AlertSimulateResponseBreakdownResultsList = Array<BreakdownSimulationResult>;
...
export const UpdateAlertsPartialRequestSubscribedUsersList = /*@__PURE__*/ S.Array(
  S.Number,
...
export type CreateAlertError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ListAlertsError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UpdateAlertError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UpdateAlertsPartialError = BadRequest | Forbidden | NotFound | PosthogOpError;
