...
export const CreateVisualReviewReposQuarantineExpireRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
    run_type: S.String.pipe(T.Label()),
...
export const CreateVisualReviewReposQuarantineExpireResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export const CreateVisualReviewRunRequestRemovedIdentifiersList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateVisualReviewRunRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    removed_identifiers: S.optional(CreateVisualReviewRunRequestRemovedIdentifiersList),
...
export type FlakinessStateEnum = "broken" | "unstable" | "at_risk" | "noisy" | "clean";
...
export type PaginatedQuarantinedIdentifierEntryListResultsList = Array<QuarantinedIdentifierEntry>;
export const PaginatedQuarantinedIdentifierEntryListResultsList = /*@__PURE__*/ S.Array(
...
export const ListVisualReviewRunsSnapshotHistoryRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
...
export const ListVisualReviewRunsToleratedHashesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
    identifier: S.String.pipe(T.Query()),
...
export const UpdateVisualReviewReposPartialRequestBaselineFilePathsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.String,
...
export type VisualReviewRunsAddSnapshotsCreateRequestSnapshotsList = Array<SnapshotManifestItem>;
export const VisualReviewRunsAddSnapshotsCreateRequestSnapshotsList = /*@__PURE__*/ S.Array(
  SnapshotManifestItem,
...
export const VisualReviewRunsAddSnapshotsCreateRequestBaselineHashesMap = /*@__PURE__*/ S.Record(
  S.String,
  S.String,
...
export const VisualReviewRunsApproveCreateRequestSnapshotsList = /*@__PURE__*/ S.Array(
...
export type CreateVisualReviewRunError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type CreateVisualReviewRunsCompleteError = Forbidden | NotFound | PosthogOpError;
...
export type CreateVisualReviewRunsRecomputeError = Forbidden | NotFound | PosthogOpError;
...
export type GetVisualReviewRunsCountError = Forbidden | NotFound | PosthogOpError;
...
export type ListVisualReviewReposError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ListVisualReviewRunsError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ListVisualReviewRunsSnapshotsError = BadRequest | Forbidden | NotFound | PosthogOpError;
