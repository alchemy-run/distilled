...
export const CreateExperimentSavedMetricsRequestTagsList = /*@__PURE__*/ S.Array(
  S.Unknown,
...
export type PaginatedExperimentSavedMetricListResultsList = Array<ExperimentSavedMetric>;
export const PaginatedExperimentSavedMetricListResultsList = /*@__PURE__*/ S.Array(
...
export const UpdateExperimentSavedMetricsRequestTagsList = /*@__PURE__*/ S.Array(
  S.Unknown,
...
export const UpdateExperimentSavedMetricsPartialRequestTagsList = /*@__PURE__*/ S.Array(
  S.Unknown,
...
export const UpdateExperimentSavedMetricsPartialRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.Number.pipe(T.Label()),
    name: S.optional(S.String),
...
export type CreateExperimentSavedMetricsError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ExperimentSavedMetricsDestroyError = Forbidden | NotFound | PosthogOpError;
...
export type GetExperimentSavedMetricsError = Forbidden | NotFound | PosthogOpError;
...
export type ListExperimentSavedMetricsError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UpdateExperimentSavedMetricsError = BadRequest | Forbidden | NotFound | PosthogOpError;
