...
export const DatasetItemsDestroyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export type DatasetItemsCreateError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type DatasetItemsListError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type DatasetItemsPartialUpdateError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type DatasetItemsUpdateError = BadRequest | Forbidden | NotFound | PosthogOpError;
