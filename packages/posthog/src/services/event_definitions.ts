...
export const CreateEventDefinitionRequestDefaultColumnsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const EnterpriseEventDefinitionDefaultColumnsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const EnterpriseEventDefinitionMediaPreviewUrlsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const EnterpriseEventDefinition = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    media_preview_urls: S.optional(EnterpriseEventDefinitionMediaPreviewUrlsList),
  }),
).annotate({
...
export type EventDefinitionsBulkUpdateVerifiedCreateRequestIdsList = Array<string>;
export const EventDefinitionsBulkUpdateVerifiedCreateRequestIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const EventDefinitionsBulkUpdateVerifiedCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    ids: EventDefinitionsBulkUpdateVerifiedCreateRequestIdsList,
    verified: S.Boolean,
...
export const EventDefinitionBulkUpdateVerifiedResponseUpdatedList = /*@__PURE__*/ S.Array(
...
export const EventDefinitionBulkUpdateVerifiedResponseSkippedList = /*@__PURE__*/ S.Array(
...
export const EventDefinitionBulkUpdateVerifiedResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    updated: EventDefinitionBulkUpdateVerifiedResponseUpdatedList,
    skipped: EventDefinitionBulkUpdateVerifiedResponseSkippedList,
  }),
...
export const GetEventDefinitionsPrimaryPropertyRequestNamesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetEventDefinitionsPrimaryPropertyRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    names: S.optional(GetEventDefinitionsPrimaryPropertyRequestNamesList.pipe(T.Query())),
  }).pipe(
    T.Http({
      method: "GET",
...
export type PaginatedEnterpriseEventDefinitionListResultsList = Array<EnterpriseEventDefinition>;
export const PaginatedEnterpriseEventDefinitionListResultsList = /*@__PURE__*/ S.Array(
...
export const UpdateEventDefinitionRequestDefaultColumnsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateEventDefinitionsPartialRequestTagsList = /*@__PURE__*/ S.Array(
  S.Unknown,
) as any as S.Schema<UpdateEventDefinitionsPartialRequestTagsList>;

export type UpdateEventDefinitionsPartialRequestDefaultColumnsList = Array<string>;
export const UpdateEventDefinitionsPartialRequestDefaultColumnsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateEventDefinitionsPartialRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    primary_property: S.optional(S.NullOr(S.String)),
    post_to_slack: S.optional(S.Boolean),
    default_columns: S.optional(UpdateEventDefinitionsPartialRequestDefaultColumnsList),
  }).pipe(
    T.Http({
      method: "PATCH",
      uri: "/api/projects/{project_id}/event_definitions/{id}/",
...
export type CreateEventDefinitionError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type EventDefinitionsDestroyError = Forbidden | NotFound | PosthogOpError;
...
export type GetEventDefinitionsByNameError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetEventDefinitionsGolangError = Forbidden | NotFound | PosthogOpError;
...
export type GetEventDefinitionsPythonError = Forbidden | NotFound | PosthogOpError;
...
export type GetEventDefinitionsTypescriptError = Forbidden | NotFound | PosthogOpError;
...
export type UpdateEventDefinitionError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UpdateEventDefinitionsPartialError = BadRequest | Forbidden | NotFound | PosthogOpError;
