...
export const BatchExportsBackfillsCancelCreateResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export const BatchExportsDestroyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export type RedshiftCopyInputsBucketCredentialsCase1 = RedshiftCopyInputsAuthorizationCase2;
export const RedshiftCopyInputsBucketCredentialsCase1 = RedshiftCopyInputsAuthorizationCase2;

/** Credentials used to stage files in the S3 bucket: inline AWS credentials or the id of an aws-s3-kind Integration. */
export type RedshiftCopyInputsBucketCredentials = number | RedshiftCopyInputsAuthorizationCase2;
...
export const FileDownloadBatchExportsCancelCreateResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export const CreateFileDownloadRequest = S.Unknown as any as S.Schema<CreateFileDownloadRequest>;
...
export const FileDownloadBatchExportsDownloadRetrieveRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
  }).pipe(
...
export const FileDownloadBatchExportsDownloadRetrieveResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export const FileDownloadBatchExportsLogsRetrieveRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
...
export const FileDownloadBatchExportsLogsRetrieveResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export type RetrieveBasicOutputStatusEnum = "Starting" | "Running" | "Cancelled";
...
export type FileDownloadBatchExportsRetrieveResponse = RetrieveFileDownloadResponse;
...
export const GetBatchExportsLogResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const GetBatchExportsRunsLogResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const GetBatchExportsTestResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export type PaginatedBatchExportBackfillListResultsList = Array<BatchExportBackfill>;
export const PaginatedBatchExportBackfillListResultsList = /*@__PURE__*/ S.Array(
  BatchExportBackfill,
...
export type BatchExportsRunsCancelCreateError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type BatchExportsRunsRetryCreateError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type BatchExportsUnpauseCreateError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type CreateBatchExportError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type CreateBatchExportsBackfillError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type CreateBatchExportsPauseError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** Pause a BatchExport. */
...
export type CreateBatchExportsRunTestStepError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type FileDownloadBatchExportsCountRowsCreateError = BadRequest | Forbidden | PosthogOpError;
...
export type GetBatchExportsBackfillError = Forbidden | NotFound | PosthogOpError;
...
export type GetBatchExportsLogError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetBatchExportsRunsLogError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ListBatchExportsError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ListBatchExportsBackfillsError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** ViewSet for BatchExportBackfill models. Allows creating and reading backfills, but not updating or deleting them. */
...
export type ListBatchExportsRunsError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UpdateBatchExportError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UpdateBatchExportsPartialError = BadRequest | Forbidden | NotFound | PosthogOpError;
