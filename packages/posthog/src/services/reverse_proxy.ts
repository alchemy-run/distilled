...
export const ProxyRecordsDestroyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export type CreateProxyRecordError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ProxyRecordsRetryCreateError = Forbidden | NotFound | PosthogOpError;
