...
export type UpdateJsSnippetVersionPartialResponse = UpdateJsSnippetVersionPartialResponseBodyMap;
...
export type UpdateJsSnippetVersionPartialError = BadRequest | Forbidden | NotFound | PosthogOpError;
