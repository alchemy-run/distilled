...
export type ReasoningEffortEnum = "low" | "medium" | "high" | "xhigh" | "max" | "ultracode";
...
export const TaskRunPostHogReferenceMetadataSourceMessageIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const TaskRunArtifactMetadata = S.Unknown as any as S.Schema<TaskRunArtifactMetadata>;
...
export const CreateTasksRunsLivingArtifactRequestMetadataMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export type TaskRunLivingArtifactsResponseArtifactsList = Array<TaskRunLivingArtifactResponse>;
export const TaskRunLivingArtifactsResponseArtifactsList = /*@__PURE__*/ S.Array(
...
export type PaginatedTaskThreadMessageDTOListResultsList = Array<TaskThreadMessageDTO>;
export const PaginatedTaskThreadMessageDTOListResultsList = /*@__PURE__*/ S.Array(
...
export const TasksPresenceDestroyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const TaskRunLivingArtifactOpenResponseVersionsItemMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const TaskRunLivingArtifactOpenResponseVersionsList = /*@__PURE__*/ S.Array(
...
export const TasksStagedArtifactsFinalizeUploadCreateRequestArtifactsList = /*@__PURE__*/ S.Array(
...
export const TasksStagedArtifactsFinalizeUploadCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
    artifacts: S.optional(TasksStagedArtifactsFinalizeUploadCreateRequestArtifactsList),
  }).pipe(
    T.Http({
      method: "POST",
...
export type TaskStagedArtifactsFinalizeUploadResponseArtifactsList = Array<TaskRunArtifactResponse>;
export const TaskStagedArtifactsFinalizeUploadResponseArtifactsList = /*@__PURE__*/ S.Array(
  TaskRunArtifactResponse,
...
export const TaskStagedArtifactsFinalizeUploadResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    artifacts: S.optional(TaskStagedArtifactsFinalizeUploadResponseArtifactsList),
  }),
).annotate({
...
export const TasksStagedArtifactsPrepareUploadCreateRequestArtifactsList = /*@__PURE__*/ S.Array(
...
export const TasksStagedArtifactsPrepareUploadCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
    artifacts: S.optional(TasksStagedArtifactsPrepareUploadCreateRequestArtifactsList),
  }).pipe(
    T.Http({
      method: "POST",
...
export const TaskStagedArtifactsPrepareUploadResponseArtifactsList = /*@__PURE__*/ S.Array(
...
export const TaskStagedArtifactsPrepareUploadResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    artifacts: S.optional(TaskStagedArtifactsPrepareUploadResponseArtifactsList),
  }),
).annotate({
...
export const TasksThreadMessagesSendToAgentCreateRequestPayloadMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const TasksThreadMessagesSendToAgentCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    task_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
...
export type CreateTasksRunsLivingArtifactError = BadRequest | NotFound | PosthogOpError;
...
export type EditTasksRunsLivingArtifactError = BadRequest | NotFound | PosthogOpError;
...
export type GetTasksRepositoryReadinessError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetTasksSlackThreadContextError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type TasksRunsLivingArtifactsChartError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type TasksThreadMessagesSendToAgentCreateError = BadRequest | PosthogOpError;
...
export type UpdateTaskError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** API for managing tasks within a project. Tasks represent units of work to be performed by an agent. */
...
export type UpdateTasksPartialError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** API for managing tasks within a project. Tasks represent units of work to be performed by an agent. */
