...
export type PaginatedDataWarehouseExpressionListResultsList = Array<DataWarehouseExpression>;
export const PaginatedDataWarehouseExpressionListResultsList = /*@__PURE__*/ S.Array(
