...
export type PaginatedWarehouseColumnStatisticsListResultsList = Array<WarehouseColumnStatistics2>;
export const PaginatedWarehouseColumnStatisticsListResultsList = /*@__PURE__*/ S.Array(
