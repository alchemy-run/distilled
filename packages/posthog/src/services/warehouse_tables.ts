...
export const CreateWarehouseTablesCheckRequestConfigMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const CreateWarehouseTablesFileRequestOptionsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const ListWarehouseTablesChecksCheckTypesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    table_id: S.String.pipe(T.Label()),
  }).pipe(
...
export type ListWarehouseTablesChecksCheckTypesResponseBodyList = Array<DataQualityCheckType>;
export const ListWarehouseTablesChecksCheckTypesResponseBodyList = /*@__PURE__*/ S.Array(
...
export const ListWarehouseTablesChecksCheckTypesResponse = /*@__PURE__*/ S.suspend(() =>
  ListWarehouseTablesChecksCheckTypesResponseBodyList.pipe(T.RawResponseRoot()),
).annotate({
...
export type ListWarehouseTablesChecksRunsResponseBodyList = Array<DataQualityCheckRun>;
export const ListWarehouseTablesChecksRunsResponseBodyList = /*@__PURE__*/ S.Array(
  DataQualityCheckRun,
) as any as S.Schema<ListWarehouseTablesChecksRunsResponseBodyList>;

export type ListWarehouseTablesChecksRunsResponse = ListWarehouseTablesChecksRunsResponseBodyList;
...
export const ListWarehouseTablesCheckSuiteRunsCheckRunsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    table_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
...
export type ListWarehouseTablesCheckSuiteRunsCheckRunsResponseBodyList = Array<DataQualityCheckRun>;
export const ListWarehouseTablesCheckSuiteRunsCheckRunsResponseBodyList = /*@__PURE__*/ S.Array(
  DataQualityCheckRun,
...
export const ListWarehouseTablesCheckSuiteRunsCheckRunsResponse = /*@__PURE__*/ S.suspend(() =>
  ListWarehouseTablesCheckSuiteRunsCheckRunsResponseBodyList.pipe(T.RawResponseRoot()),
).annotate({
...
export const UpdateWarehouseTablesCheckRequestConfigMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const UpdateWarehouseTablesChecksPartialRequestConfigMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const UpdateWarehouseTablesChecksPartialRequestTagsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateWarehouseTablesChecksPartialRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    table_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
...
export const UpdateWarehouseTablesPartialRequestOptionsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const WarehouseTablesCreateFromUploadCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    upload_id: S.String,
    filename: S.String,
...
export const WarehouseTablesDestroyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const WarehouseTablesRefreshSchemaCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
  }).pipe(
...
export const WarehouseTablesRefreshSchemaCreateResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export const WarehouseTablesUpdateSchemaCreateRequestOptionsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const WarehouseTablesUpdateSchemaCreateResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export type WarehouseTablesUploadFileCreateRequestFileFormat = "csv" | "json" | "parquet";
...
export type CreateWarehouseTableError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type CreateWarehouseTablesFileError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** Create, Read, Update and Delete Warehouse Tables. */
...
export type ListWarehouseTablesError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** Create, Read, Update and Delete Warehouse Tables. */
...
export type UpdateWarehouseTableError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** Create, Read, Update and Delete Warehouse Tables. */
...
export type UpdateWarehouseTablesPartialError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** Create, Read, Update and Delete Warehouse Tables. */
