...
export const UpdateUserHomeSettingsPartialRequestTabsList = /*@__PURE__*/ S.Array(
  PinnedSceneTab,
...
export type UpdateUserHomeSettingsPartialError = BadRequest | Forbidden | NotFound | PosthogOpError;
