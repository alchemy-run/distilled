...
export const CreateSignalsReportPrReviewCommentRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
...
export const CreateSignalsReportPrReviewCommentReactionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
...
export const PullRequestReviewCommentReactionCreateResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    reaction: PullRequestCommentReaction,
  }),
).annotate({
...
export const SignalScoutConfig = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    output_destinations: SignalScoutOutputDestinations,
    structured_output_schema: S.NullOr(SignalScoutConfigStructuredOutputSchemaMap),
    network_access: SignalScoutConfigNetworkAccessEnum,
...
export const CreateSignalsScoutConfigRequestStructuredOutputSchemaMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<CreateSignalsScoutConfigRequestStructuredOutputSchemaMap>;

/** MCP gateway servers (by id) this scout's runs may use, chosen from the connections members shared to the whole team. Selection is per scout: an empty list gives the scout no MCP servers. Applies from the scout's next run. */
export type CreateSignalsScoutConfigRequestMcpGatewayServerIdsList = Array<string>;
export const CreateSignalsScoutConfigRequestMcpGatewayServerIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const EditSignalsScoutReportRequestSuggestedReviewersList = /*@__PURE__*/ S.Array(
  SuggestedReviewer,
...
export const SessionProblemSignalExtra = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    event_history: S.optional(S.NullOr(SessionProblemSignalExtraEventHistoryList)),
  }),
).annotate({
...
export const EndpointBreakdownLimitExceededSignalExtra = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    endpoint_name: S.String,
...
export type SignalsScoutSignalExtraEvidenceList = Array<SignalsScoutEvidenceEntry>;
...
export type AnalyticsAnomalyInvestigationSignalExtraTriggeredDatesList = Array<string>;
export const AnalyticsAnomalyInvestigationSignalExtraTriggeredDatesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const EngineeringAnalyticsCIFlakyCheckSignalExtra = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    repo_owner: S.String,
    repo_name: S.String,
...
export const EngineeringAnalyticsCIBrokenDefaultBranchSignalExtra = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    repo_owner: S.String,
    repo_name: S.String,
    workflow_name: S.String,
...
export const EngineeringAnalyticsCIDurationRegressionSignalExtra = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    repo_owner: S.String,
    repo_name: S.String,
    workflow_name: S.String,
...
export const RetentlyFeedbackSignalExtraFeedbackTopicsList = /*@__PURE__*/ S.Array(
  S.Unknown,
...
export const GoogleSearchConsoleSearchOpportunitySignalExtra = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    page: S.String,
    query: S.String,
    date: S.String,
...
export const ProjectProfileInventoryExternalDataSourcesList = /*@__PURE__*/ S.Array(
...
export type SignalSourceConfigsBucketsDisabledList = Array<SignalSourceConfigEntry>;
...
export const ProjectProfileInventoryRecentDashboardsList = /*@__PURE__*/ S.Array(
...
export type PaginatedSignalReportArtefactListResultsList = Array<SignalReportArtefact>;
export const PaginatedSignalReportArtefactListResultsList = /*@__PURE__*/ S.Array(
...
export type ListSignalsScoutConfigResponse = ListSignalsScoutConfigResponseBodyList;
...
export type ListSignalsScoutMembersResponse = ListSignalsScoutMembersResponseBodyList;
...
export type ListSignalsScoutNotesResponse = ListSignalsScoutNotesResponseBodyList;
...
export type PaginatedSignalSourceConfigListResultsList = Array<SignalSourceConfig>;
...
export const ReviewSignalsReportPrCommentDestroyResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export const ReviewSignalsReportPrCommentReactionDestroyResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export const RunSignalsScoutConfigResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export type SearchSignalsScoutScratchpadResponse = SearchSignalsScoutScratchpadResponseBodyList;
...
export const SignalsReportsBulkStateCreateRequestIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export type SignalReportBulkStateResponseResultsList = Array<SignalReportBulkStateResult>;
...
export const SignalsScoutEmitReportRequestSuggestedReviewersList = /*@__PURE__*/ S.Array(
  SuggestedReviewer,
...
export const RecordStructuredOutputResponseRecordIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export type SignalsScoutRunsEmissionReportsBatchRequestRunIdsList = Array<string>;
export const SignalsScoutRunsEmissionReportsBatchRequestRunIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const SignalsScoutRunsEmissionReportsBatchRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    run_ids: SignalsScoutRunsEmissionReportsBatchRequestRunIdsList,
  }).pipe(
...
export type SignalsScoutRunsEmissionReportsBatchResponseBodyList = Array<ScoutEmissionReportLink>;
export const SignalsScoutRunsEmissionReportsBatchResponseBodyList = /*@__PURE__*/ S.Array(
  ScoutEmissionReportLink,
...
export const SignalsScoutRunsEmissionReportsBatchResponse = /*@__PURE__*/ S.suspend(() =>
  SignalsScoutRunsEmissionReportsBatchResponseBodyList.pipe(T.RawResponseRoot()),
).annotate({
...
export type SignalsScoutRunsEmissionsResponse = SignalsScoutRunsEmissionsResponseBodyList;
...
export const SignalsScoutRunsEmissionsBatchRequestRunIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export type SignalsScoutRunsEmissionsBatchResponseBodyList = Array<SignalScoutEmission>;
export const SignalsScoutRunsEmissionsBatchResponseBodyList = /*@__PURE__*/ S.Array(
  SignalScoutEmission,
) as any as S.Schema<SignalsScoutRunsEmissionsBatchResponseBodyList>;

export type SignalsScoutRunsEmissionsBatchResponse = SignalsScoutRunsEmissionsBatchResponseBodyList;
...
export type SignalsScoutRunsRecentEmissionsResponseBodyList = Array<SignalScoutEmission>;
export const SignalsScoutRunsRecentEmissionsResponseBodyList = /*@__PURE__*/ S.Array(
  SignalScoutEmission,
...
export type SignalsScoutRunsRecentPerScoutResponseBodyList = Array<SignalScoutRunSummary>;
export const SignalsScoutRunsRecentPerScoutResponseBodyList = /*@__PURE__*/ S.Array(
  SignalScoutRunSummary,
) as any as S.Schema<SignalsScoutRunsRecentPerScoutResponseBodyList>;

export type SignalsScoutRunsRecentPerScoutResponse = SignalsScoutRunsRecentPerScoutResponseBodyList;
...
export type SyncSignalsScoutConfigRequestSurface = "roster" | "desktop" | "wizard";
...
export type SyncSignalsScoutConfigResponse = SyncSignalsScoutConfigResponseBodyList;
...
export const UpdateSignalsReportArtefactsPartialRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    report_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
...
export const UpdateSignalsReportPrReviewCommentRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
    comment_id: S.String.pipe(T.Label()),
...
export const UpdateSignalsScoutConfigRequestStructuredOutputSchemaMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
/** MCP gateway servers (by id) this scout's runs may use, chosen from the connections members shared to the whole team. Selection is per scout: an empty list gives the scout no MCP servers. Applies from the scout's next run. */
export type UpdateSignalsScoutConfigRequestMcpGatewayServerIdsList = Array<string>;
export const UpdateSignalsScoutConfigRequestMcpGatewayServerIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateSignalsSourceConfigsPartialRequestConfigMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export type CreateSignalsReportPrReviewCommentReactionError = Forbidden | NotFound | PosthogOpError;
...
export type CreateSignalsSourceConfigError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ListSignalsProcessingError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ListSignalsSourceConfigsError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type PauseSignalsProcessingDestroyError = Forbidden | NotFound | PosthogOpError;
...
export type RefreshSignalsScoutSuggestionError = Forbidden | Conflict | PosthogOpError;
...
export type SignalSignalsScoutEmitError = BadRequest | NotFound | PosthogOpError;
...
export type SignalsScoutRecordOutputError = BadRequest | NotFound | PosthogOpError;
...
export type SignalsSourceConfigsDestroyError = Forbidden | NotFound | PosthogOpError;
...
export type UpdateSignalsProcessingPauseError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** View and control signal processing pipeline state for a team. */
...
export type UpdateSignalsReportArtefactsPartialError = BadRequest | NotFound | PosthogOpError;
...
export type UpdateSignalsReportPrReviewCommentError = Forbidden | NotFound | PosthogOpError;
...
export type UpdateSignalsReportsPartialError = BadRequest | NotFound | PosthogOpError;
...
export type UpdateSignalsSourceConfigError = BadRequest | Forbidden | NotFound | PosthogOpError;
