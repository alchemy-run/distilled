...
export const CreateUserInterviewRequestIntervieweeEmailsList = /*@__PURE__*/ S.Array(
  S.String,
...
>;
export const CreateUserInterviewRequestClassificationsList = /*@__PURE__*/ S.Array(
...
export const CreateUserInterviewRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    interviewee_emails: S.optional(CreateUserInterviewRequestIntervieweeEmailsList),
...
/** Searchable classifications on the response. `abandoned` is auto-derived from the transcript when the interview is recorded; `off-topic` is set manually. Sending `classifications` on an update replaces the whole list — pass the full desired set, not a delta. */
export type UserInterviewOutputClassificationsList = Array<UserInterviewClassificationEnum>;
...
export type PaginatedUserInterviewListOutputResultsList = Array<UserInterviewOutput>;
export const PaginatedUserInterviewListOutputResultsList = /*@__PURE__*/ S.Array(
  UserInterviewOutput,
...
export const UpdateUserInterviewRequestIntervieweeEmailsList = /*@__PURE__*/ S.Array(
  S.String,
...
export type UpdateUserInterviewRequestClassificationsList = Array<
  UserInterviewClassificationEnum | (string & {})
>;
export const UpdateUserInterviewRequestClassificationsList = /*@__PURE__*/ S.Array(
  UserInterviewClassificationEnum,
...
export const UpdateUserInterviewRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
    interviewee_emails: S.optional(UpdateUserInterviewRequestIntervieweeEmailsList),
    summary: S.optional(S.String),
...
export type UpdateUserInterviewsPartialRequestIntervieweeEmailsList = Array<string>;
export const UpdateUserInterviewsPartialRequestIntervieweeEmailsList = /*@__PURE__*/ S.Array(
  S.String,
...
export type UpdateUserInterviewsPartialRequestClassificationsList = Array<
  UserInterviewClassificationEnum | (string & {})
>;
export const UpdateUserInterviewsPartialRequestClassificationsList = /*@__PURE__*/ S.Array(
  UserInterviewClassificationEnum,
...
export const UpdateUserInterviewsPartialRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
    interviewee_emails: S.optional(UpdateUserInterviewsPartialRequestIntervieweeEmailsList),
    summary: S.optional(S.String),
    classifications: S.optional(UpdateUserInterviewsPartialRequestClassificationsList),
    audio: S.optional(S.String),
  }).pipe(
    T.Http({
      method: "PATCH",
...
export const UserInterviewsDestroyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
>;
export const UserInterviewsSearchCreateRequestDocumentTypesList = /*@__PURE__*/ S.Array(
...
export type UserInterviewsSearchCreateRequestClassificationsList = Array<
  UserInterviewClassificationEnum | (string & {})
>;
export const UserInterviewsSearchCreateRequestClassificationsList = /*@__PURE__*/ S.Array(
  UserInterviewClassificationEnum,
...
export const UserInterviewsSearchCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    query: S.String,
    document_types: S.optional(UserInterviewsSearchCreateRequestDocumentTypesList),
    topic_id: S.optional(S.NullOr(S.String)),
    classifications: S.optional(UserInterviewsSearchCreateRequestClassificationsList),
...
export type UserInterviewsSearchCreateResponseBodyList = Array<UserInterviewSearchResult>;
...
export type UserInterviewsSearchCreateResponse = UserInterviewsSearchCreateResponseBodyList;
