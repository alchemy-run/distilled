...
export type PaginatedHogFunctionTemplateListResultsList = Array<HogFunctionTemplate>;
export const PaginatedHogFunctionTemplateListResultsList = /*@__PURE__*/ S.Array(
  HogFunctionTemplate,
...
export type ListHogFunctionTemplatesError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ListPublicHogFunctionTemplatesError = BadRequest | Forbidden | PosthogOpError;
