...
export interface TrendsFilter {
  ...
  detailedResultsAggregationType?: DetailedResultsAggregationType | (string & {}) | null;
...
export interface FunnelsFilter {
  ...
  funnelWindowIntervalUnit?: FunnelConversionWindowTimeUnit | (string & {}) | null;
  /** Goal Lines */
...
export interface PathsV2Filter {
  ...
  conversionWindowIntervalUnit?: FunnelConversionWindowTimeUnit | (string & {}) | null;
...
export type LifecycleFilterToggledLifecyclesList = Array<LifecycleToggle | (string & {})>;
...
export const CreateInsightsViewedResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export type EnsembleDetectorConfigDetectorsList = Array<EnsembleDetectorConfigDetectorsItem>;
...
export type AlertScheduleRestrictionBlockedWindowsList = Array<AlertScheduleRestrictionWindow>;
...
export type InsightBulkDeleteResponseDeletedList = Array<InsightBulkOperationResult>;
...
export type InsightBulkDeleteResponseSkippedList = Array<InsightBulkOperationSkipped>;
...
export type InsightBulkRestoreResponseRestoredList = Array<InsightBulkOperationResult>;
...
export type InsightBulkRestoreResponseSkippedList = Array<InsightBulkOperationSkipped>;
...
export type InsightsBulkSetTestAccountFilterCreateRequestFormat = "csv" | "json";
...
export const InsightsBulkSetTestAccountFilterCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    format: S.optional(InsightsBulkSetTestAccountFilterCreateRequestFormat.pipe(T.Query())),
    enabled: S.Boolean,
  }).pipe(
    T.Http({
      method: "POST",
...
export const InsightsBulkUpdateTagsCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    format: S.optional(InsightsBulkUpdateTagsCreateRequestFormat.pipe(T.Query())),
...
export const InsightsCancelCreateResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const InsightsGenerateMetadataCreateRequestDashboardsList = /*@__PURE__*/ S.Array(
  S.Number,
...
export const InsightsGenerateMetadataCreateRequestTagsList = /*@__PURE__*/ S.Array(
  S.Unknown,
...
export const InsightsGenerateMetadataCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    format: S.optional(InsightsGenerateMetadataCreateRequestFormat.pipe(T.Query())),
    name: S.optional(S.NullOr(S.String)),
    derived_name: S.optional(S.NullOr(S.String)),
    query: S.optional(S.NullOr(InsightQuerySchema)),
    order: S.optional(S.NullOr(S.Number)),
    deleted: S.optional(S.Boolean),
    dashboards: S.optional(InsightsGenerateMetadataCreateRequestDashboardsList),
    description: S.optional(S.NullOr(S.String)),
...
export type PaginatedThresholdWithAlertListResultsList = Array<ThresholdWithAlert>;
...
export type CreateInsightsSharingPasswordError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetInsightsActivityError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetInsightsAllActivityError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetInsightsTrendingError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type InsightsBulkUpdateTagsCreateError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type InsightsDestroyError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type InsightsSharingPasswordsDestroyError = Forbidden | NotFound | PosthogOpError;
...
export type InsightsSharingRefreshCreateError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type ListInsightsThresholdsError = BadRequest | Forbidden | NotFound | PosthogOpError;
