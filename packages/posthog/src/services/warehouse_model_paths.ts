...
export type PaginatedDataWarehouseModelPathListResultsList = Array<DataWarehouseModelPath>;
export const PaginatedDataWarehouseModelPathListResultsList = /*@__PURE__*/ S.Array(
