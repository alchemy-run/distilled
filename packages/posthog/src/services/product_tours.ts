...
export const ProductTourSerializerCreateUpdateOnlyCreationContextEnum = S.String;
...
export interface CreateProductTourRequest {
  ...
  creation_context?: ProductTourSerializerCreateUpdateOnlyCreationContextEnum | (string & {});
}
...
export const ProductTourSerializerCreateUpdateOnlyOutput = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const ProductTour = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    internal_targeting_flag: S.optional(MinimalFeatureFlag),
    linked_flag: S.optional(MinimalFeatureFlag),
    targeting_flag_filters: S.optional(S.NullOr(ProductTourTargetingFlagFiltersMap)),
    content: S.optional(S.Unknown),
...
export const ProductToursDestroyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export type CreateProductTourError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetProductToursDraftStatusError = Forbidden | NotFound | PosthogOpError;
...
export type ListProductToursError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** Create, read, update, and manage product tours and their targeting. */
...
export type ProductToursDiscardDraftDestroyError = Forbidden | NotFound | PosthogOpError;
...
export type ProductToursGenerateCreateError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UpdateProductTourError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** Create, read, update, and manage product tours and their targeting. */
...
export type UpdateProductToursPartialError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** Create, read, update, and manage product tours and their targeting. */
