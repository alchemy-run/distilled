...
export const CreatePersonsBatchByDistinctIdsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    format: S.optional(CreatePersonsBatchByDistinctIdsRequestFormat.pipe(T.Query())),
...
export const CreatePersonsSplitRequestDistinctIdsToSplitList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetPersonsActivityResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const GetPersonsAllActivityResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const PersonPropertiesAtTimeResponseDistinctIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const PersonPropertiesAtTimeResponsePropertiesMap = /*@__PURE__*/ S.Record(
  S.String,
  S.NullOr(S.String),
) as any as S.Schema<PersonPropertiesAtTimeResponsePropertiesMap>;

/** All distinct_ids that were queried for this person */
export type PersonPropertiesAtTimeMetadataDistinctIdsQueriedList = Array<string>;
export const PersonPropertiesAtTimeMetadataDistinctIdsQueriedList = /*@__PURE__*/ S.Array(
  S.String,
...
export const PersonPropertiesAtTimeMetadata = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    distinct_ids_queried: S.optional(PersonPropertiesAtTimeMetadataDistinctIdsQueriedList),
...
export const GetPersonsPropertiesTimelineRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.Number.pipe(T.Label()),
    format: S.optional(GetPersonsPropertiesTimelineRequestFormat.pipe(T.Query())),
  }).pipe(
    T.Http({
      method: "GET",
...
export type ListPersonsDeletionStatusRequestStatus = "all" | "completed" | "pending";
...
export const ListPersonsPushNotificationsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    after: S.optional(S.String.pipe(T.Query())),
    before: S.optional(S.String.pipe(T.Query())),
    format: S.optional(ListPersonsPushNotificationsRequestFormat.pipe(T.Query())),
    limit: S.optional(S.Number.pipe(T.Query())),
    offset: S.optional(S.Number.pipe(T.Query())),
  }).pipe(
    T.Http({
...
export const ListPersonsPushNotificationsResponseBodyList = /*@__PURE__*/ S.Array(
  MessageAsset,
) as any as S.Schema<ListPersonsPushNotificationsResponseBodyList>;

export type ListPersonsPushNotificationsResponse = ListPersonsPushNotificationsResponseBodyList;
...
export const PersonsBulkDeleteCreateRequestDistinctIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const PersonsDeletePropertyCreateRequestUnsetCase1List = /*@__PURE__*/ S.Array(
  S.String,
...
export const PersonsDeletePropertyCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
    format: S.optional(PersonsDeletePropertyCreateRequestFormat.pipe(T.Query())),
    _unset: S.optional(PersonsDeletePropertyCreateRequestUnset.pipe(T.Body("$unset"))),
  }).pipe(
    T.Http({
      method: "POST",
...
export const PersonsResetPersonDistinctIdCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    format: S.optional(PersonsResetPersonDistinctIdCreateRequestFormat.pipe(T.Query())),
    properties: S.optional(S.Unknown),
  }).pipe(
    T.Http({
      method: "POST",
...
export const PersonsResetPersonDistinctIdCreateResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export const PersonsUpdatePropertyCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
    format: S.optional(PersonsUpdatePropertyCreateRequestFormat.pipe(T.Query())),
    key: S.optional(S.String),
...
export type CreatePersonsBatchByUuidError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** This endpoint is meant for reading and deleting persons. To create or update persons, we recommend using the [capture API](https://posthog.com/docs/api/capture), the `$set` and `$unset` [properties](https://posthog.com/docs/product-analytics/user-properties), or one of our SDKs. */
...
export type CreatePersonsSplitError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetPersonsActivityError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** This endpoint is meant for reading and deleting persons. To create or update persons, we recommend using the [capture API](https://posthog.com/docs/api/capture), the `$set` and `$unset` [properties](https://posthog.com/docs/product-analytics/user-properties), or one of our SDKs. */
...
export type GetPersonsAllActivityError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** This endpoint is meant for reading and deleting persons. To create or update persons, we recommend using the [capture API](https://posthog.com/docs/api/capture), the `$set` and `$unset` [properties](https://posthog.com/docs/product-analytics/user-properties), or one of our SDKs. */
...
export type GetPersonsCohortError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** This endpoint is meant for reading and deleting persons. To create or update persons, we recommend using the [capture API](https://posthog.com/docs/api/capture), the `$set` and `$unset` [properties](https://posthog.com/docs/product-analytics/user-properties), or one of our SDKs. */
...
export type GetPersonsPropertiesAtTimeError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type GetPersonsPropertiesTimelineError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** This endpoint is meant for reading and deleting persons. To create or update persons, we recommend using the [capture API](https://posthog.com/docs/api/capture), the `$set` and `$unset` [properties](https://posthog.com/docs/product-analytics/user-properties), or one of our SDKs. */
...
export type GetPersonsValueError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** This endpoint is meant for reading and deleting persons. To create or update persons, we recommend using the [capture API](https://posthog.com/docs/api/capture), the `$set` and `$unset` [properties](https://posthog.com/docs/product-analytics/user-properties), or one of our SDKs. */
...
export type ListPersonsError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** This endpoint is meant for reading and deleting persons. To create or update persons, we recommend using the [capture API](https://posthog.com/docs/api/capture), the `$set` and `$unset` [properties](https://posthog.com/docs/product-analytics/user-properties), or one of our SDKs. */
...
export type ListPersonsDeletionStatusError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type PersonsDeletePropertyCreateError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** This endpoint is meant for reading and deleting persons. To create or update persons, we recommend using the [capture API](https://posthog.com/docs/api/capture), the `$set` and `$unset` [properties](https://posthog.com/docs/product-analytics/user-properties), or one of our SDKs. */
...
export type PersonsUpdatePropertyCreateError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** This endpoint is meant for reading and deleting persons. To create or update persons, we recommend using the [capture API](https://posthog.com/docs/api/capture), the `$set` and `$unset` [properties](https://posthog.com/docs/product-analytics/user-properties), or one of our SDKs. */
...
export type UpdatePersonError = BadRequest | Forbidden | NotFound | PosthogOpError;
...
export type UpdatePersonsPartialError = BadRequest | Forbidden | NotFound | PosthogOpError;
/** This endpoint is meant for reading and deleting persons. To create or update persons, we recommend using the [capture API](https://posthog.com/docs/api/capture), the `$set` and `$unset` [properties](https://posthog.com/docs/product-analytics/user-properties), or one of our SDKs. */
