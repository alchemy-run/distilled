...
export type CanvasPlacementStatusEnum = "pending" | "generating" | "live" | "failed";
...
export type CanvasesLayoutPatchCreateRequestOperationsList = Array<CanvasLayoutPatchOperation>;
export const CanvasesLayoutPatchCreateRequestOperationsList = /*@__PURE__*/ S.Array(
...
export const CanvasesPublishCurrentVersionCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    id: S.String.pipe(T.Label()),
...
export const CanvasCapabilityWideningCaptureEventsAddedList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CanvasCapabilityWideningNetworkOriginsAddedList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CanvasCapabilityWideningStateScopesAddedList = /*@__PURE__*/ S.Array(
  S.String,
...
export type CanvasesLayoutPatchCreateError = BadRequest | Conflict | PosthogOpError;
...
export type CanvasesLayoutPublishCreateError = BadRequest | Conflict | PosthogOpError;
...
export type CanvasesPublishCurrentVersionCreateError = Conflict | PosthogOpError;
...
export type CreateCanvasesRequestAgentError = Forbidden | Conflict | PosthogOpError;
...
export type CreateCanvasesRequestFixError = Forbidden | NotFound | Conflict | PosthogOpError;
