...
The correction and regressions described in this section were subsequently extracted into [Distilled #630](https://github.com/alchemy-run/distilled/pull/630). They are no longer part of the Neon PR; the passing results below describe the earlier combined revision.
