...
/** Trigger type discriminator. */
export type StorageObjectCreatedTriggerCreateRequestType =
  "storage_object_created";
export const StorageObjectCreatedTriggerCreateRequestType = S.Literals([
  "storage_object_created",
]);
...
export const StorageObjectCreatedTriggerType = S.Literals([
  "storage_object_created",
]);
...
export const GetProjectBranchBucketObjectResponse = S.instanceOf(
  Uint8Array,
).pipe(T.BinaryResponse()) as S.Codec<GetProjectBranchBucketObjectResponse>;
...
/** Trigger type discriminator; it does not change the trigger type. */
export type StorageObjectCreatedTriggerUpdateRequestType =
  "storage_object_created";
export const StorageObjectCreatedTriggerUpdateRequestType = S.Literals([
  "storage_object_created",
]);
