...
// AUTO-GENERATED by scripts/generate.ts from .generated-specs (specs/spec-mirror-neon). Do not edit.
import * as S from "@distilled.cloud/core/schema";
import * as Redacted from "effect/Redacted";
import { UnknownNeonError } from "../errors.ts";
import { paginateCursor } from "../pagination.ts";
import { NeonProtocol, type NeonOpError, type NeonOpContext } from "../protocol.ts";
...
}) as any as S.Codec<AcceptProjectTransferRequestRequest>;
...
}) as any as S.Codec<AcceptProjectTransferRequestResponse>;
...
export const AddBranchNeonAuthOauthProviderRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    client_secret: S.optional(
      S.Union([S.String, S.Redacted(S.String, { disallowJsonEncode: true })]).pipe(
        T.SensitiveValue({}),
      ),
    ),
...
}) as any as S.Codec<AddBranchNeonAuthOauthProviderRequest>;
...
}) as any as S.Codec<AddBranchNeonAuthTrustedDomainRequest>;
...
}) as any as S.Codec<AddBranchNeonAuthTrustedDomainResponse>;
...
export const AddProjectJWKSRequestRoleNamesList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<AddProjectJWKSRequestRoleNamesList>;
...
export const JWKSRoleNamesList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<JWKSRoleNamesList>;
...
).annotate({ identifier: "JWKS" }) as any as S.Codec<JWKS>;
...
).annotate({ identifier: "Operation" }) as any as S.Codec<Operation>;
...
export const AddProjectJWKSResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<AddProjectJWKSResponseOperationsList>;
...
}) as any as S.Codec<AssignOrganizationVPCEndpointRequest>;
...
}) as any as S.Codec<AssignOrganizationVPCEndpointResponse>;
...
}) as any as S.Codec<AssignProjectVPCEndpointRequest>;
...
}) as any as S.Codec<AssignProjectVPCEndpointResponse>;
...
}) as any as S.Codec<CountProjectBranchesResponse>;
...
export const ApiKeyCreateResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.Number,
    key: S.Union([S.String, S.Redacted(S.String, { disallowJsonEncode: true })]).pipe(
      T.SensitiveValue({}),
    ),
    name: S.String,
    created_at: S.String,
...
}) as any as S.Codec<CreateBranchNeonAuthNewUserRequest>;
...
}) as any as S.Codec<NeonAuthCreateNewUserResponse>;
...
export type CreateCredentialRequestScopesList = Array<CredentialScope | (string & {})>;
export const CreateCredentialRequestScopesList = /*@__PURE__*/ S.Array(
  CredentialScope,
) as any as S.Codec<CreateCredentialRequestScopesList>;
...
) as any as S.Codec<CreateCredentialResponseScopesList>;
...
export interface CreateCredentialResponse {
  ...
  s3_secret_access_key: string | Redacted.Redacted<string>;
...
export const CreateCredentialResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    name: S.optional(S.String),
    api_token: S.Union([S.String, S.Redacted(S.String, { disallowJsonEncode: true })]).pipe(
      T.SensitiveValue({}),
    ),
    s3_secret_access_key: S.Union([
      S.String,
...
}) as any as S.Codec<NeonAuthCreateIntegrationResponse>;
...
}) as any as S.Codec<CreateNeonAuthProviderSDKKeysRequest>;
...
}) as any as S.Codec<OrganizationInviteCreateRequest>;
...
export const CreateOrganizationInvitationsRequestInvitationsList = /*@__PURE__*/ S.Array(
  OrganizationInviteCreateRequest,
) as any as S.Codec<CreateOrganizationInvitationsRequestInvitationsList>;
...
).annotate({ identifier: "Invitation" }) as any as S.Codec<Invitation>;
...
export const OrganizationInvitationsResponseInvitationsList = /*@__PURE__*/ S.Array(
  Invitation,
) as any as S.Codec<OrganizationInvitationsResponseInvitationsList>;
...
}) as any as S.Codec<OrganizationInvitationsResponse>;
...
).annotate({ identifier: "ProjectQuota" }) as any as S.Codec<ProjectQuota>;
...
export const AllowedIpsIpsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<AllowedIpsIpsList>;
...
).annotate({ identifier: "AllowedIps" }) as any as S.Codec<AllowedIps>;
...
export const MaintenanceWindowWeekdaysList = /*@__PURE__*/ S.Array(
  S.Number,
) as any as S.Codec<MaintenanceWindowWeekdaysList>;
...
export const PreloadLibrariesEnabledLibrariesList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<PreloadLibrariesEnabledLibrariesList>;
...
export const AnnotationValueData = /*@__PURE__*/ S.Record(
  S.String,
  S.String,
) as any as S.Codec<AnnotationValueData>;
...
}) as any as S.Codec<CreateProjectRequestProjectBranch>;
...
export const PgSettingsData = /*@__PURE__*/ S.Record(
  S.String,
  S.String,
) as any as S.Codec<PgSettingsData>;
...
export const PgbouncerSettingsData = /*@__PURE__*/ S.Record(
  S.String,
  S.String,
) as any as S.Codec<PgbouncerSettingsData>;
...
}) as any as S.Codec<CreateProjectRequestProject>;
...
).annotate({ identifier: "Project" }) as any as S.Codec<Project>;
...
export const ConnectionParameters = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    database: S.String,
    password: S.Union([S.String, S.Redacted(S.String, { disallowJsonEncode: true })]).pipe(
      T.SensitiveValue({}),
    ),
    role: S.String,
    host: S.String,
...
export const ConnectionDetails = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    connection_uri: S.Union([S.String, S.Redacted(S.String, { disallowJsonEncode: true })]).pipe(
      T.SensitiveValue({}),
    ),
    connection_parameters: ConnectionParameters,
  }),
...
export const CreateProjectResponseConnectionUrisList = /*@__PURE__*/ S.Array(
  ConnectionDetails,
) as any as S.Codec<CreateProjectResponseConnectionUrisList>;
...
).annotate({ identifier: "Role" }) as any as S.Codec<Role>;
...
export const CreateProjectResponseRolesList = /*@__PURE__*/ S.Array(
  Role,
) as any as S.Codec<CreateProjectResponseRolesList>;
...
).annotate({ identifier: "Database" }) as any as S.Codec<Database>;
...
export const CreateProjectResponseDatabasesList = /*@__PURE__*/ S.Array(
  Database,
) as any as S.Codec<CreateProjectResponseDatabasesList>;
...
export const CreateProjectResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<CreateProjectResponseOperationsList>;
...
) as any as S.Codec<BranchRestrictedActionsList>;
...
).annotate({ identifier: "Branch" }) as any as S.Codec<Branch>;
...
).annotate({ identifier: "Endpoint" }) as any as S.Codec<Endpoint>;
...
export const CreateProjectResponseEndpointsList = /*@__PURE__*/ S.Array(
  Endpoint,
) as any as S.Codec<CreateProjectResponseEndpointsList>;
...
}) as any as S.Codec<BranchCreateRequestEndpointOptions>;
...
export type CreateProjectBranchRequestEndpointsList = Array<BranchCreateRequestEndpointOptions>;
export const CreateProjectBranchRequestEndpointsList = /*@__PURE__*/ S.Array(
  BranchCreateRequestEndpointOptions,
) as any as S.Codec<CreateProjectBranchRequestEndpointsList>;
...
}) as any as S.Codec<CreateProjectBranchRequestBranch>;
...
export const CreateProjectBranchResponseEndpointsList = /*@__PURE__*/ S.Array(
  Endpoint,
) as any as S.Codec<CreateProjectBranchResponseEndpointsList>;
...
export const CreateProjectBranchResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<CreateProjectBranchResponseOperationsList>;
...
export const CreateProjectBranchResponseRolesList = /*@__PURE__*/ S.Array(
  Role,
) as any as S.Codec<CreateProjectBranchResponseRolesList>;
...
export const CreateProjectBranchResponseDatabasesList = /*@__PURE__*/ S.Array(
  Database,
) as any as S.Codec<CreateProjectBranchResponseDatabasesList>;

/** Connection URIs for the compute endpoint, including credentials. */
export type CreateProjectBranchResponseConnectionUrisList = Array<ConnectionDetails>;
export const CreateProjectBranchResponseConnectionUrisList = /*@__PURE__*/ S.Array(
  ConnectionDetails,
) as any as S.Codec<CreateProjectBranchResponseConnectionUrisList>;
...
}) as any as S.Codec<CreateProjectBranchResponse>;

/** Compute endpoints to create together with the branch. If omitted, the branch is created without any compute endpoint. Endpoints can be added to the branch separately after creation. */
export type BranchCreateRequestEndpointsList = Array<BranchCreateRequestEndpointOptions>;
export const BranchCreateRequestEndpointsList = /*@__PURE__*/ S.Array(
  BranchCreateRequestEndpointOptions,
) as any as S.Codec<BranchCreateRequestEndpointsList>;
...
).annotate({ identifier: "MaskingRule" }) as any as S.Codec<MaskingRule>;

/** List of masking rules to apply to the branch. */
export type CreateProjectBranchAnonymizedRequestMaskingRulesList = Array<MaskingRule>;
export const CreateProjectBranchAnonymizedRequestMaskingRulesList = /*@__PURE__*/ S.Array(
  MaskingRule,
) as any as S.Codec<CreateProjectBranchAnonymizedRequestMaskingRulesList>;
...
/** Compute endpoints in the project. Each includes `id`, `branch_id`, `host`, and `type`. */
export type CreateProjectBranchAnonymizedResponseEndpointsList = Array<Endpoint>;
export const CreateProjectBranchAnonymizedResponseEndpointsList = /*@__PURE__*/ S.Array(
  Endpoint,
) as any as S.Codec<CreateProjectBranchAnonymizedResponseEndpointsList>;

export type CreateProjectBranchAnonymizedResponseOperationsList = Array<Operation>;
export const CreateProjectBranchAnonymizedResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<CreateProjectBranchAnonymizedResponseOperationsList>;

/** Roles belonging to the branch. Each role includes fields such as `branch_id`, `name`, `protected`, `created_at`, and `updated_at`. */
export type CreateProjectBranchAnonymizedResponseRolesList = Array<Role>;
export const CreateProjectBranchAnonymizedResponseRolesList = /*@__PURE__*/ S.Array(
  Role,
) as any as S.Codec<CreateProjectBranchAnonymizedResponseRolesList>;

/** Databases on the branch. Each includes `id`, `name`, `owner_name`, and `created_at`. */
export type CreateProjectBranchAnonymizedResponseDatabasesList = Array<Database>;
export const CreateProjectBranchAnonymizedResponseDatabasesList = /*@__PURE__*/ S.Array(
  Database,
) as any as S.Codec<CreateProjectBranchAnonymizedResponseDatabasesList>;

/** Connection URIs for the compute endpoint, including credentials. */
export type CreateProjectBranchAnonymizedResponseConnectionUrisList = Array<ConnectionDetails>;
export const CreateProjectBranchAnonymizedResponseConnectionUrisList = /*@__PURE__*/ S.Array(
  ConnectionDetails,
) as any as S.Codec<CreateProjectBranchAnonymizedResponseConnectionUrisList>;
...
}) as any as S.Codec<CreateProjectBranchAnonymizedResponse>;
...
export type CreateProjectBranchBucketRequestAccessLevel = "private" | "public_read";
...
}) as any as S.Codec<CreateProjectBranchBucketRequest>;
...
).annotate({ identifier: "Bucket" }) as any as S.Codec<Bucket>;
...
).annotate({ identifier: "BucketResponse" }) as any as S.Codec<BucketResponse>;
...
export type CreateProjectBranchDataAPIRequestAuthProvider = "neon_auth" | "external";
...
export const DataAPISettingsDbSchemasList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<DataAPISettingsDbSchemasList>;
...
}) as any as S.Codec<CreateProjectBranchDataAPIRequest>;
...
export const CreateProjectBranchDatabaseRequestDatabase = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    name: S.String,
    owner_name: S.String,
  }),
...
}) as any as S.Codec<CreateProjectBranchDatabaseRequestDatabase>;
...
}) as any as S.Codec<CreateProjectBranchDatabaseRequest>;

export type CreateProjectBranchDatabaseResponseOperationsList = Array<Operation>;
export const CreateProjectBranchDatabaseResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<CreateProjectBranchDatabaseResponseOperationsList>;
...
}) as any as S.Codec<CreateProjectBranchDatabaseResponse>;
...
export interface CreateProjectBranchFunctionDeploymentRequest {
  ...
  zip?: Blob | Uint8Array | ArrayBuffer;
  ...
  environment?: string | Redacted.Redacted<string>;
}
export const CreateProjectBranchFunctionDeploymentRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    branch_id: S.String.pipe(T.Label()),
    slug: S.String.pipe(T.Label()),
    zip: S.optional(
      S.Union([S.instanceOf(Blob), S.instanceOf(Uint8Array), S.instanceOf(ArrayBuffer)]),
    ),
...
}) as any as S.Codec<CreateProjectBranchFunctionDeploymentRequest>;

/** Build lifecycle status of the deployment. */
export type NeonFunctionDeploymentStatus = "pending" | "building" | "completed" | "failed";
...
export const NeonFunctionDeploymentEnvironmentList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<NeonFunctionDeploymentEnvironmentList>;
...
export interface NeonFunctionDeployment {
  ...
  created_at: string;
  /** The NAMES of the deployment's environment variables, sorted. Values are encrypted at rest and are never returned — they are write-only. To change a value, deploy the variable with the new value; to remove a variable, deploy it with an empty value. */
  environment?: NeonFunctionDeploymentEnvironmentList | null;
...
}) as any as S.Codec<NeonFunctionDeploymentResponse>;
...
}) as any as S.Codec<CreateProjectBranchRoleRequestRole>;
...
}) as any as S.Codec<CreateProjectBranchRoleRequest>;

export type CreateProjectBranchRoleResponseOperationsList = Array<Operation>;
export const CreateProjectBranchRoleResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<CreateProjectBranchRoleResponseOperationsList>;
...
}) as any as S.Codec<CreateProjectBranchRoleResponse>;

/** Trigger type discriminator. */
export type ScheduleTriggerCreateRequestType = "schedule";
export const ScheduleTriggerCreateRequestType = S.Literals(["schedule"]);
/** A numeric five-field cron schedule interpreted in UTC. */
export interface FunctionTriggerSchedule {
  /** Numeric five-field cron expression (minute through day-of-week), interpreted in UTC. */
  cron: string;
}
export const FunctionTriggerSchedule = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    cron: S.String,
  }),
).annotate({
...
export interface ScheduleTriggerCreateRequest {
  /** Trigger type discriminator. */
  type: ScheduleTriggerCreateRequestType;
...
export const ScheduleTriggerCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    type: ScheduleTriggerCreateRequestType,
    function_slug: S.String,
    name: S.String,
    function_path: S.optional(S.String),
    schedule: FunctionTriggerSchedule,
    enabled: S.optional(S.Boolean),
  }),
).annotate({
  identifier: "ScheduleTriggerCreateRequest",
}) as any as S.Codec<ScheduleTriggerCreateRequest>;

/** Trigger type discriminator. */
export type StorageObjectCreatedTriggerCreateRequestType = "storage_object_created";
export const StorageObjectCreatedTriggerCreateRequestType = S.Literals(["storage_object_created"]);
/** Matches successful uploads to one exact bucket and, when configured, an object-key prefix. The Function receives a JSON request body with `type` set to `storage_object_created` and a `data` object containing exactly `bucket_name` and `object_key`. */
export interface FunctionTriggerStorageObjectCreated {
  /** The exact object-storage bucket name to watch. */
  bucket_name: string;
  /** Optional object-key prefix of at most 1024 UTF-8 bytes. When omitted, every key in the bucket matches. When present, the full object key must start with these exact bytes; matching is case-sensitive and does not normalize paths or require a path-segment boundary. Match-all responses omit this field rather than returning an empty string. */
  prefix?: string;
}
export const FunctionTriggerStorageObjectCreated = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    bucket_name: S.String,
    prefix: S.optional(S.String),
  }),
).annotate({
  identifier: "FunctionTriggerStorageObjectCreated",
}) as any as S.Codec<FunctionTriggerStorageObjectCreated>;

export interface StorageObjectCreatedTriggerCreateRequest {
  /** Trigger type discriminator. */
  type: StorageObjectCreatedTriggerCreateRequestType;
  /** The branch-local Function slug to invoke. */
  function_slug: string;
  /** Human-readable name, unique among triggers visible on the branch. */
  name: string;
...
export const StorageObjectCreatedTriggerCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    type: StorageObjectCreatedTriggerCreateRequestType,
    function_slug: S.String,
    name: S.String,
  ...
  identifier: "StorageObjectCreatedTriggerCreateRequest",
}) as any as S.Codec<StorageObjectCreatedTriggerCreateRequest>;

/** Trigger creation payload discriminated by `type`. The supported trigger types are `schedule` and `storage_object_created`. */
export type TriggerCreateRequest =
  | ScheduleTriggerCreateRequest
  | StorageObjectCreatedTriggerCreateRequest;
export const TriggerCreateRequest = S.suspend(() =>
  S.Union([ScheduleTriggerCreateRequest, StorageObjectCreatedTriggerCreateRequest]),
) as S.Codec<TriggerCreateRequest>;

export interface CreateProjectBranchTriggerRequest {
  /** The Neon project ID */
  project_id: string;
  /** The Neon branch ID */
  branch_id: string;
...
export const CreateProjectBranchTriggerRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    branch_id: S.String.pipe(T.Label()),
    body: TriggerCreateRequest.pipe(T.HttpBody()),
  }).pipe(
    T.Http({
      method: "POST",
      uri: "/projects/{project_id}/branches/{branch_id}/triggers",
      code: 200,
    }),
  ),
).annotate({
  identifier: "CreateProjectBranchTriggerRequest",
}) as any as S.Codec<CreateProjectBranchTriggerRequest>;

/** Trigger type discriminator. */
export type ScheduleTriggerType = "schedule";
export const ScheduleTriggerType = S.Literals(["schedule"]);
...
export interface ScheduleTrigger {
  ...
  version: number;
  /** Next scheduled occurrence as an RFC 3339 UTC timestamp, or null while disabled or inherited and not explicitly enabled on this branch. */
  next_run_at: string | null;
  /** True when the effective configuration was authored on an ancestor branch. */
  inherited: boolean;
}
export const ScheduleTrigger = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    type: ScheduleTriggerType,
    trigger_id: S.String,
    function_slug: S.String,
    name: S.String,
    function_path: S.String,
    schedule: FunctionTriggerSchedule,
    enabled: S.Boolean,
    version: S.Number,
...
export const StorageObjectCreatedTriggerType = S.Literals(["storage_object_created"]);
/** A branch-effective trigger that invokes a Function after a successful upload matching its exact bucket and optional object-key prefix. */
export interface StorageObjectCreatedTrigger {
  /** Trigger type discriminator. */
  type: StorageObjectCreatedTriggerType;
  trigger_id: string;
...
export const StorageObjectCreatedTrigger = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    type: StorageObjectCreatedTriggerType,
    trigger_id: S.String,
    function_slug: S.String,
  ...
  identifier: "StorageObjectCreatedTrigger",
}) as any as S.Codec<StorageObjectCreatedTrigger>;

/** A branch-effective trigger discriminated by `type`. The supported trigger types are `schedule` and `storage_object_created`. */
export type Trigger = ScheduleTrigger | StorageObjectCreatedTrigger;
export const Trigger = S.suspend(() =>
  S.Union([ScheduleTrigger, StorageObjectCreatedTrigger]),
) as S.Codec<Trigger>;

export interface TriggerResponse {
  trigger: Trigger;
}
export const TriggerResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    trigger: Trigger,
  }),
).annotate({
...
}) as any as S.Codec<CreateProjectEndpointRequestEndpoint>;
...
export const CreateProjectEndpointResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<CreateProjectEndpointResponseOperationsList>;
...
}) as any as S.Codec<CreateProjectEndpointResponse>;
...
}) as any as S.Codec<ProjectTransferRequestResponse>;
...
).annotate({ identifier: "Snapshot" }) as any as S.Codec<Snapshot>;
...
export const CreateSnapshotResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<CreateSnapshotResponseOperationsList>;
...
export interface DeleteBranchNeonAuthOauthProviderRequest {
  ...
  oauth_provider_id: DeleteBranchNeonAuthOauthProviderRequestOauthProviderId | (string & {});
}
...
}) as any as S.Codec<DeleteBranchNeonAuthOauthProviderRequest>;

export interface DeleteBranchNeonAuthOauthProviderResponse {}
export const DeleteBranchNeonAuthOauthProviderResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
  identifier: "DeleteBranchNeonAuthOauthProviderResponse",
}) as any as S.Codec<DeleteBranchNeonAuthOauthProviderResponse>;

export interface NeonAuthDeleteDomainFromRedirectURIWhitelistItem {
  /** URI to remove from the redirect URI whitelist. */
  domain: string;
}
export const NeonAuthDeleteDomainFromRedirectURIWhitelistItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    domain: S.String,
  }),
).annotate({
  identifier: "NeonAuthDeleteDomainFromRedirectURIWhitelistItem",
}) as any as S.Codec<NeonAuthDeleteDomainFromRedirectURIWhitelistItem>;
...
export const DeleteBranchNeonAuthTrustedDomainRequestDomainsList = /*@__PURE__*/ S.Array(
  NeonAuthDeleteDomainFromRedirectURIWhitelistItem,
) as any as S.Codec<DeleteBranchNeonAuthTrustedDomainRequestDomainsList>;
...
}) as any as S.Codec<DeleteBranchNeonAuthTrustedDomainRequest>;

export interface DeleteBranchNeonAuthTrustedDomainResponse {}
export const DeleteBranchNeonAuthTrustedDomainResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
  identifier: "DeleteBranchNeonAuthTrustedDomainResponse",
}) as any as S.Codec<DeleteBranchNeonAuthTrustedDomainResponse>;
...
}) as any as S.Codec<DeleteBranchNeonAuthUserRequest>;
...
}) as any as S.Codec<DeleteBranchNeonAuthUserResponse>;
...
}) as any as S.Codec<DeleteOrganizationSpendingLimitRequest>;
...
}) as any as S.Codec<DeleteOrganizationSpendingLimitResponse>;
...
}) as any as S.Codec<DeleteOrganizationVPCEndpointRequest>;
...
}) as any as S.Codec<DeleteOrganizationVPCEndpointResponse>;
...
export interface DeleteProjectBranchRequest {
  ...
  /** The branch ID */
  branch_id: string;
  /** If true, the branch is permanently deleted immediately without a recovery window. If false (default), the branch can be recovered within 7 days via the recover endpoint. This parameter is part of the Branch Recovery feature, which is in preview and not available to all users. Retained for compatibility with the previously published SDK; the refreshed OpenAPI document omits it. */
  hard_delete?: boolean;
}
...
}) as any as S.Codec<DeleteProjectBranchRequest>;
...
export const DeleteProjectBranchResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<DeleteProjectBranchResponseOperationsList>;
...
}) as any as S.Codec<DeleteProjectBranchResponse>;
...
}) as any as S.Codec<DeleteProjectBranchBucketRequest>;
...
}) as any as S.Codec<DeleteProjectBranchBucketResponse>;
...
}) as any as S.Codec<DeleteProjectBranchBucketObjectRequest>;
...
}) as any as S.Codec<DeleteProjectBranchBucketObjectResponse>;
...
export const DeleteProjectBranchBucketObjectsByPrefixRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    branch_id: S.String.pipe(T.Label()),
    bucket_name: S.String.pipe(T.Label()),
...
}) as any as S.Codec<DeleteProjectBranchBucketObjectsByPrefixRequest>;
...
}) as any as S.Codec<BucketObjectsDeletePrefixResponse>;
...
}) as any as S.Codec<DeleteProjectBranchCustomDomainRequest>;
...
}) as any as S.Codec<DeleteProjectBranchCustomDomainResponse>;
...
}) as any as S.Codec<DeleteProjectBranchDataAPIRequest>;
...
}) as any as S.Codec<DeleteProjectBranchDataAPIResponse>;
...
}) as any as S.Codec<DeleteProjectBranchDatabaseRequest>;

export type DeleteProjectBranchDatabaseResponseOperationsList = Array<Operation>;
export const DeleteProjectBranchDatabaseResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<DeleteProjectBranchDatabaseResponseOperationsList>;
...
}) as any as S.Codec<DeleteProjectBranchDatabaseResponse>;
...
}) as any as S.Codec<DeleteProjectBranchFunctionRequest>;
...
}) as any as S.Codec<DeleteProjectBranchFunctionResponse>;
...
}) as any as S.Codec<DeleteProjectBranchRoleRequest>;

export type DeleteProjectBranchRoleResponseOperationsList = Array<Operation>;
export const DeleteProjectBranchRoleResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<DeleteProjectBranchRoleResponseOperationsList>;
...
}) as any as S.Codec<DeleteProjectBranchRoleResponse>;

export interface DeleteProjectBranchTriggerRequest {
  /** The Neon project ID */
  project_id: string;
  /** The Neon branch ID */
  branch_id: string;
...
export const DeleteProjectBranchTriggerRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    branch_id: S.String.pipe(T.Label()),
    trigger_id: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
      method: "DELETE",
      uri: "/projects/{project_id}/branches/{branch_id}/triggers/{trigger_id}",
      code: 200,
    }),
  ),
).annotate({
  identifier: "DeleteProjectBranchTriggerRequest",
}) as any as S.Codec<DeleteProjectBranchTriggerRequest>;

export interface DeleteProjectBranchTriggerResponse {}
export const DeleteProjectBranchTriggerResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
  identifier: "DeleteProjectBranchTriggerResponse",
}) as any as S.Codec<DeleteProjectBranchTriggerResponse>;
...
}) as any as S.Codec<DeleteProjectEndpointRequest>;

export type DeleteProjectEndpointResponseOperationsList = Array<Operation>;
export const DeleteProjectEndpointResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<DeleteProjectEndpointResponseOperationsList>;
...
}) as any as S.Codec<DeleteProjectEndpointResponse>;
...
}) as any as S.Codec<DeleteProjectVPCEndpointRequest>;
...
}) as any as S.Codec<DeleteProjectVPCEndpointResponse>;
...
}) as any as S.Codec<DeleteSnapshotResponse>;
...
}) as any as S.Codec<DisableNeonAuthResponse>;
...
}) as any as S.Codec<FinalizeRestoreBranchRequest>;
...
export const OperationsResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<OperationsResponseOperationsList>;
...
).annotate({ identifier: "RegionResponse" }) as any as S.Codec<RegionResponse>;
...
export const ActiveRegionsResponseRegionsList = /*@__PURE__*/ S.Array(
  RegionResponse,
) as any as S.Codec<ActiveRegionsResponseRegionsList>;
...
}) as any as S.Codec<GetAnonymizedBranchStatusRequest>;
...
}) as any as S.Codec<AnonymizedBranchStatusResponse>;
...
}) as any as S.Codec<GetAvailablePreloadLibrariesRequest>;
...
) as any as S.Codec<AvailablePreloadLibrariesLibrariesList>;
...
}) as any as S.Codec<AvailablePreloadLibraries>;
...
export const GetConsumptionHistoryPerBranchV2RequestProjectIdsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<GetConsumptionHistoryPerBranchV2RequestProjectIdsList>;

export type GetConsumptionHistoryPerBranchV2RequestBranchIdsList = Array<string>;
export const GetConsumptionHistoryPerBranchV2RequestBranchIdsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<GetConsumptionHistoryPerBranchV2RequestBranchIdsList>;
...
export const ConsumptionHistoryQueryMetrics = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<ConsumptionHistoryQueryMetrics>;
...
export const ConsumptionHistoryPerTimeframeV2MetricsList = /*@__PURE__*/ S.Array(
  ConsumptionMetricValue,
) as any as S.Codec<ConsumptionHistoryPerTimeframeV2MetricsList>;
...
}) as any as S.Codec<ConsumptionHistoryPerTimeframeV2>;

/** Consumption metric records for the billing period. */
export type ConsumptionHistoryPerPeriodV2ConsumptionList = Array<ConsumptionHistoryPerTimeframeV2>;
export const ConsumptionHistoryPerPeriodV2ConsumptionList = /*@__PURE__*/ S.Array(
  ConsumptionHistoryPerTimeframeV2,
) as any as S.Codec<ConsumptionHistoryPerPeriodV2ConsumptionList>;
...
}) as any as S.Codec<ConsumptionHistoryPerPeriodV2>;

/** Consumption history records for the branch, grouped by billing period. */
export type ConsumptionHistoryPerBranchV2PeriodsList = Array<ConsumptionHistoryPerPeriodV2>;
export const ConsumptionHistoryPerBranchV2PeriodsList = /*@__PURE__*/ S.Array(
  ConsumptionHistoryPerPeriodV2,
) as any as S.Codec<ConsumptionHistoryPerBranchV2PeriodsList>;
...
}) as any as S.Codec<ConsumptionHistoryPerBranchV2>;
...
export const GetConsumptionHistoryPerBranchV2ResponseBranchesList = /*@__PURE__*/ S.Array(
  ConsumptionHistoryPerBranchV2,
) as any as S.Codec<GetConsumptionHistoryPerBranchV2ResponseBranchesList>;
...
).annotate({ identifier: "Pagination" }) as any as S.Codec<Pagination>;
...
}) as any as S.Codec<GetConsumptionHistoryPerBranchV2Response>;

export type GetConsumptionHistoryPerProjectRequestProjectIdsList = Array<string>;
export const GetConsumptionHistoryPerProjectRequestProjectIdsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<GetConsumptionHistoryPerProjectRequestProjectIdsList>;
...
}) as any as S.Codec<ConsumptionHistoryPerTimeframe>;

/** Consumption metric records for the billing period. */
export type ConsumptionHistoryPerPeriodConsumptionList = Array<ConsumptionHistoryPerTimeframe>;
export const ConsumptionHistoryPerPeriodConsumptionList = /*@__PURE__*/ S.Array(
  ConsumptionHistoryPerTimeframe,
) as any as S.Codec<ConsumptionHistoryPerPeriodConsumptionList>;
...
}) as any as S.Codec<ConsumptionHistoryPerPeriod>;

/** Consumption periods for the project, each covering a discrete billing interval. */
export type ConsumptionHistoryPerProjectPeriodsList = Array<ConsumptionHistoryPerPeriod>;
export const ConsumptionHistoryPerProjectPeriodsList = /*@__PURE__*/ S.Array(
  ConsumptionHistoryPerPeriod,
) as any as S.Codec<ConsumptionHistoryPerProjectPeriodsList>;
...
}) as any as S.Codec<ConsumptionHistoryPerProject>;
...
export const GetConsumptionHistoryPerProjectResponseProjectsList = /*@__PURE__*/ S.Array(
  ConsumptionHistoryPerProject,
) as any as S.Codec<GetConsumptionHistoryPerProjectResponseProjectsList>;
...
}) as any as S.Codec<GetConsumptionHistoryPerProjectResponse>;

export type GetConsumptionHistoryPerProjectV2RequestProjectIdsList = Array<string>;
export const GetConsumptionHistoryPerProjectV2RequestProjectIdsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<GetConsumptionHistoryPerProjectV2RequestProjectIdsList>;
...
export type ConsumptionHistoryPerProjectV2PeriodsList = Array<ConsumptionHistoryPerPeriodV2>;
export const ConsumptionHistoryPerProjectV2PeriodsList = /*@__PURE__*/ S.Array(
  ConsumptionHistoryPerPeriodV2,
) as any as S.Codec<ConsumptionHistoryPerProjectV2PeriodsList>;
...
}) as any as S.Codec<ConsumptionHistoryPerProjectV2>;
...
export const GetConsumptionHistoryPerProjectV2ResponseProjectsList = /*@__PURE__*/ S.Array(
  ConsumptionHistoryPerProjectV2,
) as any as S.Codec<GetConsumptionHistoryPerProjectV2ResponseProjectsList>;
...
export const GetConsumptionHistoryPerProjectV2Response = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    projects: GetConsumptionHistoryPerProjectV2ResponseProjectsList,
    pagination: S.optional(Pagination),
  }),
...
}) as any as S.Codec<GetConsumptionHistoryPerProjectV2Response>;
...
}) as any as S.Codec<GetCurrentUserInfoRequest>;
...
).annotate({ identifier: "PaymentSource" }) as any as S.Codec<PaymentSource>;
...
).annotate({ identifier: "PlanVersion" }) as any as S.Codec<PlanVersion>;
...
).annotate({ identifier: "PlanDetails" }) as any as S.Codec<PlanDetails>;
...
).annotate({ identifier: "BillingAccount" }) as any as S.Codec<BillingAccount>;
...
) as any as S.Codec<CurrentUserInfoResponseAuthAccountsList>;
...
export const GetCurrentUserOrganizationsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}).pipe(T.Http({ method: "GET", uri: "/users/me/organizations", code: 200 })),
).annotate({
  identifier: "GetCurrentUserOrganizationsRequest",
}) as any as S.Codec<GetCurrentUserOrganizationsRequest>;
...
).annotate({ identifier: "Organization" }) as any as S.Codec<Organization>;
...
export const OrganizationsResponseOrganizationsList = /*@__PURE__*/ S.Array(
  Organization,
) as any as S.Codec<OrganizationsResponseOrganizationsList>;
...
export const MaskingRulesResponseMaskingRulesList = /*@__PURE__*/ S.Array(
  MaskingRule,
) as any as S.Codec<MaskingRulesResponseMaskingRulesList>;
...
}) as any as S.Codec<GetNeonAuthAllowLocalhostRequest>;
...
}) as any as S.Codec<NeonAuthAllowLocalhostResponse>;
...
}) as any as S.Codec<GetNeonAuthEmailAndPasswordConfigRequest>;
...
}) as any as S.Codec<NeonAuthEmailAndPasswordConfig>;
...
export type GetNeonAuthEmailProviderResponse = NeonAuthEmailServerConfigResponse;
...
}) as any as S.Codec<GetNeonAuthEmailProviderResponse>;
...
}) as any as S.Codec<GetNeonAuthPhoneNumberPluginRequest>;
...
}) as any as S.Codec<NeonAuthPhoneNumberConfig>;
...
}) as any as S.Codec<GetNeonAuthPluginConfigsRequest>;
...
}) as any as S.Codec<NeonAuthOrganizationConfig>;
...
) as any as S.Codec<NeonAuthPluginConfigsOauthProvidersList>;
...
}) as any as S.Codec<GetNeonAuthWebhookConfigRequest>;
...
export type NeonAuthWebhookConfigEnabledEventsList = Array<NeonAuthWebhookConfigEnabledEventsItem>;
export const NeonAuthWebhookConfigEnabledEventsList = /*@__PURE__*/ S.Array(
  NeonAuthWebhookConfigEnabledEventsItem,
) as any as S.Codec<NeonAuthWebhookConfigEnabledEventsList>;
...
).annotate({ identifier: "Member" }) as any as S.Codec<Member>;

export type GetOrganizationMembersRequestSortBy = "email" | "role" | "joined_at";
...
).annotate({ identifier: "MemberUserInfo" }) as any as S.Codec<MemberUserInfo>;
...
).annotate({ identifier: "MemberWithUser" }) as any as S.Codec<MemberWithUser>;
...
export const GetOrganizationMembersResponseMembersList = /*@__PURE__*/ S.Array(
  MemberWithUser,
) as any as S.Codec<GetOrganizationMembersResponseMembersList>;
...
}) as any as S.Codec<GetOrganizationMembersResponse>;
...
}) as any as S.Codec<GetOrganizationSpendingLimitRequest>;
...
}) as any as S.Codec<GetOrganizationVPCEndpointDetailsRequest>;
...
export const VPCEndpointDetailsExampleRestrictedProjectsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<VPCEndpointDetailsExampleRestrictedProjectsList>;
...
export type GetProjectAdvisorSecurityIssuesRequestMinSeverity = "INFO" | "WARN" | "ERROR";
...
export interface GetProjectAdvisorSecurityIssuesRequest {
  ...
  min_severity?: GetProjectAdvisorSecurityIssuesRequestMinSeverity | (string & {});
}
...
export const AdvisorIssueCategoriesList = /*@__PURE__*/ S.Array(
  AdvisorCategory,
) as any as S.Codec<AdvisorIssueCategoriesList>;
...
export const AdvisorIssueMetadataMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Codec<AdvisorIssueMetadataMap>;
...
).annotate({ identifier: "AdvisorIssue" }) as any as S.Codec<AdvisorIssue>;

export type GetProjectAdvisorSecurityIssuesResponseIssuesList = Array<AdvisorIssue>;
export const GetProjectAdvisorSecurityIssuesResponseIssuesList = /*@__PURE__*/ S.Array(
  AdvisorIssue,
) as any as S.Codec<GetProjectAdvisorSecurityIssuesResponseIssuesList>;
...
}) as any as S.Codec<GetProjectAdvisorSecurityIssuesResponse>;
...
).annotate({ identifier: "AnnotationData" }) as any as S.Codec<AnnotationData>;
...
}) as any as S.Codec<GetProjectBranchAiGatewayRequest>;
...
}) as any as S.Codec<GetProjectBranchBucketObjectRequest>;

export type GetProjectBranchBucketObjectResponse = Uint8Array;
export const GetProjectBranchBucketObjectResponse = S.instanceOf(Uint8Array).pipe(
  T.BinaryResponse(),
) as S.Codec<GetProjectBranchBucketObjectResponse>;
...
}) as any as S.Codec<GetProjectBranchDataAPIRequest>;
...
export const DataAPIReponseAvailableSchemasList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<DataAPIReponseAvailableSchemasList>;
...
).annotate({ identifier: "DataAPIReponse" }) as any as S.Codec<DataAPIReponse>;
...
}) as any as S.Codec<GetProjectBranchDatabaseRequest>;
...
}) as any as S.Codec<GetProjectBranchFunctionRequest>;
...
export interface NeonFunction {
  ...
  current_deployment?: NeonFunctionDeployment | null;
  ...
  active_deployment?: NeonFunctionDeployment | null;
  created_at: string;
}
export const NeonFunction = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    current_deployment: S.optional(S.NullOr(NeonFunctionDeployment)),
    active_deployment: S.optional(S.NullOr(NeonFunctionDeployment)),
    created_at: S.String,
  }),
).annotate({ identifier: "NeonFunction" }) as any as S.Codec<NeonFunction>;
...
}) as any as S.Codec<GetProjectBranchRoleRequest>;
...
).annotate({ identifier: "RoleResponse" }) as any as S.Codec<RoleResponse>;
...
}) as any as S.Codec<GetProjectBranchRolePasswordRequest>;
...
}) as any as S.Codec<GetProjectBranchSchemaRequest>;
...
}) as any as S.Codec<BranchSchemaJSONTablesItemColumnsItem>;

/** Columns belonging to this table, each describing a column's name and attributes. */
export type BranchSchemaJSONTablesItemColumnsList = Array<BranchSchemaJSONTablesItemColumnsItem>;
export const BranchSchemaJSONTablesItemColumnsList = /*@__PURE__*/ S.Array(
  BranchSchemaJSONTablesItemColumnsItem,
) as any as S.Codec<BranchSchemaJSONTablesItemColumnsList>;

/** Column names participating in this constraint */
export type BranchSchemaJSONTablesItemConstraintsItemColumnsList = Array<string>;
export const BranchSchemaJSONTablesItemConstraintsItemColumnsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<BranchSchemaJSONTablesItemConstraintsItemColumnsList>;

/** Names of the referenced columns */
export type BranchSchemaJSONTablesItemConstraintsItemReferencedTableColumnsList = Array<string>;
export const BranchSchemaJSONTablesItemConstraintsItemReferencedTableColumnsList =
  /*@__PURE__*/ S.Array(
    S.String,
  ) as any as S.Codec<BranchSchemaJSONTablesItemConstraintsItemReferencedTableColumnsList>;
...
export const BranchSchemaJSONTablesItemConstraintsItemReferencedTable = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      schema: S.String,
      table: S.String,
...
}) as any as S.Codec<BranchSchemaJSONTablesItemConstraintsItemReferencedTable>;
...
export const BranchSchemaJSONTablesItemConstraintsItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    type: S.String,
    columns: BranchSchemaJSONTablesItemConstraintsItemColumnsList,
    name: S.optional(S.String),
...
}) as any as S.Codec<BranchSchemaJSONTablesItemConstraintsItem>;
...
) as any as S.Codec<BranchSchemaJSONTablesItemConstraintsList>;
...
}) as any as S.Codec<BranchSchemaJSONTablesItem>;
...
) as any as S.Codec<BranchSchemaJSONTablesList>;
...
}) as any as S.Codec<GetProjectBranchSchemaComparisonRequest>;
...
}) as any as S.Codec<BranchSchemaCompareResponse>;
...
}) as any as S.Codec<GetProjectBranchStorageRequest>;
...
).annotate({ identifier: "BranchStorage" }) as any as S.Codec<BranchStorage>;

export interface GetProjectBranchTriggerRequest {
  /** The Neon project ID */
  project_id: string;
  /** The Neon branch ID */
  branch_id: string;
...
export const GetProjectBranchTriggerRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    branch_id: S.String.pipe(T.Label()),
    trigger_id: S.String.pipe(T.Label()),
  ...
  identifier: "GetProjectBranchTriggerRequest",
}) as any as S.Codec<GetProjectBranchTriggerRequest>;
...
}) as any as S.Codec<GetProjectEndpointRequest>;
...
export const ProjectJWKSResponseJwksList = /*@__PURE__*/ S.Array(
  JWKS,
) as any as S.Codec<ProjectJWKSResponseJwksList>;
...
}) as any as S.Codec<GetProjectOperationRequest>;
...
}) as any as S.Codec<GetSnapshotScheduleRequest>;
...
export const BackupScheduleScheduleList = /*@__PURE__*/ S.Array(
  BackupScheduleItem,
) as any as S.Codec<BackupScheduleScheduleList>;
...
).annotate({ identifier: "BackupSchedule" }) as any as S.Codec<BackupSchedule>;
...
) as any as S.Codec<ListApiKeysResponseBodyList>;
...
}) as any as S.Codec<ListBranchNeonAuthOauthProvidersRequest>;

/** OAuth providers configured for Neon Auth on the project. */
export type ListNeonAuthOauthProvidersResponseProvidersList = Array<NeonAuthOauthProvider>;
export const ListNeonAuthOauthProvidersResponseProvidersList = /*@__PURE__*/ S.Array(
  NeonAuthOauthProvider,
) as any as S.Codec<ListNeonAuthOauthProvidersResponseProvidersList>;
...
}) as any as S.Codec<ListNeonAuthOauthProvidersResponse>;
...
}) as any as S.Codec<ListBranchNeonAuthTrustedDomainsRequest>;
...
}) as any as S.Codec<NeonAuthRedirectURIWhitelistDomain>;
...
export const NeonAuthRedirectURIWhitelistResponseDomainsList = /*@__PURE__*/ S.Array(
  NeonAuthRedirectURIWhitelistDomain,
) as any as S.Codec<NeonAuthRedirectURIWhitelistResponseDomainsList>;
...
}) as any as S.Codec<NeonAuthRedirectURIWhitelistResponse>;
...
export const CredentialMetaScopesList = /*@__PURE__*/ S.Array(
  GrantedCredentialScope,
) as any as S.Codec<CredentialMetaScopesList>;
...
).annotate({ identifier: "CredentialMeta" }) as any as S.Codec<CredentialMeta>;
...
export const ListCredentialsResponseCredentialsList = /*@__PURE__*/ S.Array(
  CredentialMeta,
) as any as S.Codec<ListCredentialsResponseCredentialsList>;
...
}) as any as S.Codec<ListOrganizationVPCEndpointsRequest>;
...
).annotate({ identifier: "VPCEndpoint" }) as any as S.Codec<VPCEndpoint>;
...
export const VPCEndpointsResponseEndpointsList = /*@__PURE__*/ S.Array(
  VPCEndpoint,
) as any as S.Codec<VPCEndpointsResponseEndpointsList>;
...
export const VPCEndpointsWithRegionResponseEndpointsList = /*@__PURE__*/ S.Array(
  VPCEndpointWithRegion,
) as any as S.Codec<VPCEndpointsWithRegionResponseEndpointsList>;
...
}) as any as S.Codec<VPCEndpointsWithRegionResponse>;
...
}) as any as S.Codec<OrgApiKeysListResponseItem>;
...
) as any as S.Codec<ListOrgApiKeysResponseBodyList>;
...
}) as any as S.Codec<ListProjectBranchBucketObjectsRequest>;
...
export const BucketObjectsListResponseFoldersList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<BucketObjectsListResponseFoldersList>;
...
).annotate({ identifier: "BucketObject" }) as any as S.Codec<BucketObject>;
...
export const BucketObjectsListResponseObjectsList = /*@__PURE__*/ S.Array(
  BucketObject,
) as any as S.Codec<BucketObjectsListResponseObjectsList>;
...
}) as any as S.Codec<BucketObjectsListResponse>;
...
}) as any as S.Codec<ListProjectBranchCustomDomainsRequest>;
...
).annotate({ identifier: "CustomDomain" }) as any as S.Codec<CustomDomain>;

export type ListProjectBranchCustomDomainsResponseCustomDomainsList = Array<CustomDomain>;
export const ListProjectBranchCustomDomainsResponseCustomDomainsList = /*@__PURE__*/ S.Array(
  CustomDomain,
) as any as S.Codec<ListProjectBranchCustomDomainsResponseCustomDomainsList>;
...
}) as any as S.Codec<ListProjectBranchCustomDomainsResponse>;
...
export const ListProjectBranchesResponseBranchesList = /*@__PURE__*/ S.Array(
  Branch,
) as any as S.Codec<ListProjectBranchesResponseBranchesList>;
...
export const ListProjectBranchesResponseAnnotationsMap = /*@__PURE__*/ S.Record(
  S.String,
  AnnotationData,
) as any as S.Codec<ListProjectBranchesResponseAnnotationsMap>;
...
}) as any as S.Codec<ListProjectBranchesResponse>;
...
}) as any as S.Codec<ListProjectBranchFunctionsRequest>;

export type ListProjectBranchFunctionsResponseFunctionsList = Array<NeonFunction>;
export const ListProjectBranchFunctionsResponseFunctionsList = /*@__PURE__*/ S.Array(
  NeonFunction,
) as any as S.Codec<ListProjectBranchFunctionsResponseFunctionsList>;
...
}) as any as S.Codec<ListProjectBranchFunctionsResponse>;
...
}) as any as S.Codec<ListProjectBranchLogFieldsRequest>;
...
export const ProjectBranchLogFieldsResponseFieldsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<ProjectBranchLogFieldsResponseFieldsList>;
...
}) as any as S.Codec<ProjectBranchLogFieldsResponse>;
...
}) as any as S.Codec<ListProjectBranchLogFieldValuesRequest>;

export type ProjectBranchLogFieldValuesResponseValuesList = Array<string>;
export const ProjectBranchLogFieldValuesResponseValuesList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<ProjectBranchLogFieldValuesResponseValuesList>;
...
}) as any as S.Codec<ProjectBranchLogFieldValuesResponse>;
...
).annotate({ identifier: "RolesResponse" }) as any as S.Codec<RolesResponse>;

export interface ListProjectBranchTriggersRequest {
  /** The Neon project ID */
  project_id: string;
  /** The Neon branch ID */
  branch_id: string;
}
export const ListProjectBranchTriggersRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    branch_id: S.String.pipe(T.Label()),
  }).pipe(
  ...
  identifier: "ListProjectBranchTriggersRequest",
}) as any as S.Codec<ListProjectBranchTriggersRequest>;

export type TriggersListResponseTriggersList = Array<Trigger>;
export const TriggersListResponseTriggersList = /*@__PURE__*/ S.Array(
  Trigger,
) as any as S.Codec<TriggersListResponseTriggersList>;
...
export const ListProjectMembersRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    cursor: S.optional(S.String.pipe(T.Query())),
    limit: S.optional(S.Number.pipe(T.Query())),
  }).pipe(T.Http({ method: "GET", uri: "/projects/{project_id}/members", code: 200 })),
).annotate({
  identifier: "ListProjectMembersRequest",
}) as any as S.Codec<ListProjectMembersRequest>;
...
).annotate({ identifier: "ProjectMember" }) as any as S.Codec<ProjectMember>;
...
export const ProjectMembersProjectMembersList = /*@__PURE__*/ S.Array(
  ProjectMember,
) as any as S.Codec<ProjectMembersProjectMembersList>;
...
).annotate({ identifier: "ProjectMembers" }) as any as S.Codec<ProjectMembers>;
...
export const ListProjectOperationsResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<ListProjectOperationsResponseOperationsList>;
...
}) as any as S.Codec<ListProjectOperationsResponse>;
...
export const ProjectPermissionsProjectPermissionsList = /*@__PURE__*/ S.Array(
  ProjectPermission,
) as any as S.Codec<ProjectPermissionsProjectPermissionsList>;
...
export const ListProjectsResponseProjectsList = /*@__PURE__*/ S.Array(
  ProjectListItem,
) as any as S.Codec<ListProjectsResponseProjectsList>;
...
export const ListProjectsResponseUnavailableProjectIdsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<ListProjectsResponseUnavailableProjectIdsList>;
...
export const ListProjectsResponseApplicationsValueList = /*@__PURE__*/ S.Array(
  ApplicationType,
) as any as S.Codec<ListProjectsResponseApplicationsValueList>;
...
) as any as S.Codec<ListProjectsResponseApplicationsMap>;
...
export const ListProjectsResponseIntegrationsValueList = /*@__PURE__*/ S.Array(
  ApplicationType,
) as any as S.Codec<ListProjectsResponseIntegrationsValueList>;
...
) as any as S.Codec<ListProjectsResponseIntegrationsMap>;
...
}) as any as S.Codec<ListSharedProjectsRequest>;
...
export const ListSharedProjectsResponseProjectsList = /*@__PURE__*/ S.Array(
  ProjectListItem,
) as any as S.Codec<ListSharedProjectsResponseProjectsList>;

/** A list of project IDs indicating which projects are known to exist, but whose details could not be fetched within the requested (or implicit) time limit */
export type ListSharedProjectsResponseUnavailableProjectIdsList = Array<string>;
export const ListSharedProjectsResponseUnavailableProjectIdsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<ListSharedProjectsResponseUnavailableProjectIdsList>;
...
}) as any as S.Codec<ListSharedProjectsResponse>;
...
export const ListSnapshotsResponseSnapshotsList = /*@__PURE__*/ S.Array(
  Snapshot,
) as any as S.Codec<ListSnapshotsResponseSnapshotsList>;
...
}) as any as S.Codec<PresignProjectBranchBucketObjectRequest>;
...
export const PresignResponseHeadersMap = /*@__PURE__*/ S.Record(
  S.String,
  S.String,
) as any as S.Codec<PresignResponseHeadersMap>;
...
export const PresignResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    url: S.Union([S.String, S.Redacted(S.String, { disallowJsonEncode: true })]).pipe(
      T.SensitiveValue({}),
    ),
    method: S.String,
    headers: PresignResponseHeadersMap,
...
export const ProjectBranchLogRecordAttributesMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Codec<ProjectBranchLogRecordAttributesMap>;
...
) as any as S.Codec<ProjectBranchLogsQueryResponseLogsList>;
...
}) as any as S.Codec<ProjectBranchLogsQueryResponse>;
...
export const RecoverProjectResponseBranchesList = /*@__PURE__*/ S.Array(
  Branch,
) as any as S.Codec<RecoverProjectResponseBranchesList>;
...
}) as any as S.Codec<RegisterProjectBranchCustomDomainRequest>;
...
}) as any as S.Codec<RemoveOrganizationMemberRequest>;
...
}) as any as S.Codec<RemoveOrganizationMemberResponse>;
...
}) as any as S.Codec<RemoveProjectMemberRoleRequest>;
...
}) as any as S.Codec<ProjectMemberRoleResponse>;
...
}) as any as S.Codec<ResetProjectBranchRolePasswordRequest>;

export type ResetProjectBranchRolePasswordResponseOperationsList = Array<Operation>;
export const ResetProjectBranchRolePasswordResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<ResetProjectBranchRolePasswordResponseOperationsList>;
...
}) as any as S.Codec<ResetProjectBranchRolePasswordResponse>;
...
}) as any as S.Codec<RestartProjectEndpointRequest>;

export type RestartProjectEndpointResponseOperationsList = Array<Operation>;
export const RestartProjectEndpointResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<RestartProjectEndpointResponseOperationsList>;
...
}) as any as S.Codec<RestartProjectEndpointResponse>;
...
}) as any as S.Codec<RestoreProjectBranchRequest>;
...
export const RestoreProjectBranchResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<RestoreProjectBranchResponseOperationsList>;
...
}) as any as S.Codec<RestoreProjectBranchResponse>;
...
export const RestoreSnapshotResponseEndpointsList = /*@__PURE__*/ S.Array(
  Endpoint,
) as any as S.Codec<RestoreSnapshotResponseEndpointsList>;
...
export const RestoreSnapshotResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<RestoreSnapshotResponseOperationsList>;
...
}) as any as S.Codec<RevokeCredentialResponse>;
...
}) as any as S.Codec<RevokePermissionFromProjectRequest>;
...
export const RotateCredentialResponseScopesList = /*@__PURE__*/ S.Array(
  GrantedCredentialScope,
) as any as S.Codec<RotateCredentialResponseScopesList>;
...
}) as any as S.Codec<SendNeonAuthEmailProviderTestRequest>;
...
}) as any as S.Codec<SendNeonAuthTestEmailResponse>;
...
}) as any as S.Codec<SetDefaultProjectBranchRequest>;

export type SetDefaultProjectBranchResponseOperationsList = Array<Operation>;
export const SetDefaultProjectBranchResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<SetDefaultProjectBranchResponseOperationsList>;
...
}) as any as S.Codec<SetDefaultProjectBranchResponse>;
...
}) as any as S.Codec<SetOrganizationSpendingLimitRequest>;
...
}) as any as S.Codec<SetProjectMemberRoleRequest>;
...
export const SetSnapshotScheduleRequestScheduleList = /*@__PURE__*/ S.Array(
  BackupScheduleItem,
) as any as S.Codec<SetSnapshotScheduleRequestScheduleList>;
...
}) as any as S.Codec<SetSnapshotScheduleRequest>;
...
}) as any as S.Codec<SetSnapshotScheduleResponse>;
...
}) as any as S.Codec<StartAnonymizationRequest>;
...
}) as any as S.Codec<StartProjectEndpointRequest>;
...
export const StartProjectEndpointResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<StartProjectEndpointResponseOperationsList>;
...
}) as any as S.Codec<StartProjectEndpointResponse>;
...
}) as any as S.Codec<SuspendProjectEndpointRequest>;

export type SuspendProjectEndpointResponseOperationsList = Array<Operation>;
export const SuspendProjectEndpointResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<SuspendProjectEndpointResponseOperationsList>;
...
}) as any as S.Codec<SuspendProjectEndpointResponse>;
...
export const NeonAuthTransferAuthProviderProjectResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    url: S.String,
  }),
).annotate({
  identifier: "NeonAuthTransferAuthProviderProjectResponse",
}) as any as S.Codec<NeonAuthTransferAuthProviderProjectResponse>;
...
export const TransferProjectsFromOrgToOrgRequestProjectIdsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<TransferProjectsFromOrgToOrgRequestProjectIdsList>;
...
}) as any as S.Codec<TransferProjectsFromOrgToOrgRequest>;
...
}) as any as S.Codec<TransferProjectsFromOrgToOrgResponse>;
...
}) as any as S.Codec<UpdateBranchNeonAuthOauthProviderRequest>;
...
export const UpdateMaskingRulesRequestMaskingRulesList = /*@__PURE__*/ S.Array(
  MaskingRule,
) as any as S.Codec<UpdateMaskingRulesRequestMaskingRulesList>;
...
}) as any as S.Codec<UpdateMaskingRulesRequest>;
...
}) as any as S.Codec<UpdateNeonAuthAllowLocalhostRequest>;
...
}) as any as S.Codec<UpdateNeonAuthConfigRequest>;
...
export const UpdateNeonAuthEmailAndPasswordConfigRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    branch_id: S.String.pipe(T.Label()),
    enabled: S.optional(S.Boolean),
...
}) as any as S.Codec<UpdateNeonAuthEmailProviderRequest>;

export type UpdateNeonAuthEmailProviderResponse = NeonAuthEmailServerConfigResponse;
export const UpdateNeonAuthEmailProviderResponse = /*@__PURE__*/ S.suspend(() =>
  NeonAuthEmailServerConfigResponse.pipe(T.RawResponseRoot()),
).annotate({
  identifier: "UpdateNeonAuthEmailProviderResponse",
}) as any as S.Codec<UpdateNeonAuthEmailProviderResponse>;
...
}) as any as S.Codec<UpdateNeonAuthMagicLinkPluginRequest>;

/** Role of the organization's creator. `owner`: full control, including deleting the org and transferring ownership. `admin`: manage members and settings only. */
export type UpdateNeonAuthOrganizationPluginRequestCreatorRole = "admin" | "owner";
...
export interface UpdateNeonAuthOrganizationPluginRequest {
  ...
  membership_limit?: number;
  /** Role of the organization's creator. `owner`: full control, including deleting the org and transferring ownership. `admin`: manage members and settings only. */
  creator_role?: UpdateNeonAuthOrganizationPluginRequestCreatorRole | (string & {});
...
}) as any as S.Codec<UpdateNeonAuthOrganizationPluginRequest>;
...
}) as any as S.Codec<UpdateNeonAuthPhoneNumberPluginRequest>;
...
export const UpdateNeonAuthUserRoleRequestRolesList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Codec<UpdateNeonAuthUserRoleRequestRolesList>;
...
}) as any as S.Codec<UpdateNeonAuthUserRoleRequest>;
...
}) as any as S.Codec<UpdateNeonAuthUserRoleResponse>;
...
>;
export const UpdateNeonAuthWebhookConfigRequestEnabledEventsList = /*@__PURE__*/ S.Array(
  UpdateNeonAuthWebhookConfigRequestEnabledEventsItem,
) as any as S.Codec<UpdateNeonAuthWebhookConfigRequestEnabledEventsList>;
...
}) as any as S.Codec<UpdateNeonAuthWebhookConfigRequest>;
...
}) as any as S.Codec<UpdateOrganizationMemberRequest>;
...
}) as any as S.Codec<UpdateProjectRequestProject>;
...
export const UpdateProjectResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<UpdateProjectResponseOperationsList>;
...
}) as any as S.Codec<UpdateProjectBranchRequestBranch>;
...
}) as any as S.Codec<UpdateProjectBranchRequest>;
...
export const UpdateProjectBranchResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<UpdateProjectBranchResponseOperationsList>;
...
}) as any as S.Codec<UpdateProjectBranchResponse>;
...
}) as any as S.Codec<UpdateProjectBranchDataAPIRequest>;
...
}) as any as S.Codec<UpdateProjectBranchDataAPIResponse>;
...
export const UpdateProjectBranchDatabaseRequestDatabase = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    name: S.optional(S.String),
...
}) as any as S.Codec<UpdateProjectBranchDatabaseRequestDatabase>;
...
}) as any as S.Codec<UpdateProjectBranchDatabaseRequest>;

export type UpdateProjectBranchDatabaseResponseOperationsList = Array<Operation>;
export const UpdateProjectBranchDatabaseResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<UpdateProjectBranchDatabaseResponseOperationsList>;
...
}) as any as S.Codec<UpdateProjectBranchDatabaseResponse>;
...
}) as any as S.Codec<UpdateProjectBranchFunctionRequest>;

/** Trigger type discriminator; it does not change the trigger type. */
export type ScheduleTriggerUpdateRequestType = "schedule";
export const ScheduleTriggerUpdateRequestType = S.Literals(["schedule"]);
export interface ScheduleTriggerUpdateRequest {
  /** Trigger type discriminator; it does not change the trigger type. */
  type: ScheduleTriggerUpdateRequestType;
...
export const ScheduleTriggerUpdateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    type: ScheduleTriggerUpdateRequestType,
    function_slug: S.optional(S.String),
    name: S.optional(S.String),
    function_path: S.optional(S.String),
    schedule: S.optional(FunctionTriggerSchedule),
    enabled: S.optional(S.Boolean),
  }),
).annotate({
  identifier: "ScheduleTriggerUpdateRequest",
}) as any as S.Codec<ScheduleTriggerUpdateRequest>;

/** Trigger type discriminator; it does not change the trigger type. */
export type StorageObjectCreatedTriggerUpdateRequestType = "storage_object_created";
export const StorageObjectCreatedTriggerUpdateRequestType = S.Literals(["storage_object_created"]);
export interface StorageObjectCreatedTriggerUpdateRequest {
  /** Trigger type discriminator; it does not change the trigger type. */
  type: StorageObjectCreatedTriggerUpdateRequestType;
  /** Replacement branch-local Function slug. */
  function_slug?: string;
  name?: string;
  function_path?: string;
...
export const StorageObjectCreatedTriggerUpdateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    type: StorageObjectCreatedTriggerUpdateRequestType,
    function_slug: S.optional(S.String),
    name: S.optional(S.String),
    function_path: S.optional(S.String),
    storage_object_created: S.optional(FunctionTriggerStorageObjectCreated),
    enabled: S.optional(S.Boolean),
  }),
).annotate({
  identifier: "StorageObjectCreatedTriggerUpdateRequest",
}) as any as S.Codec<StorageObjectCreatedTriggerUpdateRequest>;

/** Partial trigger update discriminated by `type`. The supported trigger types are `schedule` and `storage_object_created`. */
export type TriggerUpdateRequest =
  | ScheduleTriggerUpdateRequest
  | StorageObjectCreatedTriggerUpdateRequest;
export const TriggerUpdateRequest = S.suspend(() =>
  S.Union([ScheduleTriggerUpdateRequest, StorageObjectCreatedTriggerUpdateRequest]),
) as S.Codec<TriggerUpdateRequest>;

export interface UpdateProjectBranchTriggerRequest {
  /** The Neon project ID */
  project_id: string;
  /** The Neon branch ID */
  branch_id: string;
...
export const UpdateProjectBranchTriggerRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    branch_id: S.String.pipe(T.Label()),
    trigger_id: S.String.pipe(T.Label()),
    body: TriggerUpdateRequest.pipe(T.HttpBody()),
  }).pipe(
    T.Http({
      method: "PATCH",
      uri: "/projects/{project_id}/branches/{branch_id}/triggers/{trigger_id}",
  ...
  identifier: "UpdateProjectBranchTriggerRequest",
}) as any as S.Codec<UpdateProjectBranchTriggerRequest>;
...
}) as any as S.Codec<UpdateProjectEndpointRequestEndpoint>;
...
}) as any as S.Codec<UpdateProjectEndpointRequest>;

export type UpdateProjectEndpointResponseOperationsList = Array<Operation>;
export const UpdateProjectEndpointResponseOperationsList = /*@__PURE__*/ S.Array(
  Operation,
) as any as S.Codec<UpdateProjectEndpointResponseOperationsList>;
...
}) as any as S.Codec<UpdateProjectEndpointResponse>;
...
}) as any as S.Codec<UpdateSnapshotRequestSnapshot>;
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [BadRequest, NotFound, Conflict, UnprocessableEntity, UnknownNeonError],
  protocol: NeonProtocol,
  retry: Retry.Retry,
}));
...
export type CreateProjectBranchTriggerError = NeonOpError;
/** Create a trigger Creates a trigger for a Function visible on the branch. The required `type` discriminator selects the trigger-specific configuration. The supported types are `schedule` and `storage_object_created`. A schedule trigger uses a numeric five-field cron expression interpreted in UTC. A storage-object-created trigger fires only after a successful upload to one exact bucket and may narrow matches to an object-key prefix. The name must be unique among triggers visible on the branch, including inherited triggers. **Note**: This endpoint is currently in Beta. */
export const createProjectBranchTrigger: API.OperationMethod<
  CreateProjectBranchTriggerRequest,
  TriggerResponse,
  CreateProjectBranchTriggerError,
  NeonOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: CreateProjectBranchTriggerRequest,
...
export type DeleteProjectBranchError = NotFound | UnprocessableEntity | NeonOpError;
...
export type DeleteProjectBranchBucketObjectsByPrefixError = NotFound | NeonOpError;
...
export type DeleteProjectBranchRoleError = NotFound | UnprocessableEntity | NeonOpError;
...
export type DeleteProjectBranchTriggerError = NeonOpError;
/** Delete a trigger Deletes a branch-local trigger or writes a branch-local tombstone for an inherited trigger so it does not reappear. Deletion stops future scheduling or storage-event matching but does not cancel invocations already committed for delivery. The supported trigger types are `schedule` and `storage_object_created`. **Note**: This endpoint is currently in Beta. */
export const deleteProjectBranchTrigger: API.OperationMethod<
  DeleteProjectBranchTriggerRequest,
  DeleteProjectBranchTriggerResponse,
  DeleteProjectBranchTriggerError,
  NeonOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: DeleteProjectBranchTriggerRequest,
  output: DeleteProjectBranchTriggerResponse,
  errors: [UnknownNeonError],
  protocol: NeonProtocol,
  retry: Retry.Retry,
}));
...
export type GetConsumptionHistoryPerBranchV2Error = Forbidden | NotFound | NeonOpError;
...
export type GetConsumptionHistoryPerProjectError = Forbidden | NotFound | NeonOpError;
...
export type GetConsumptionHistoryPerProjectV2Error = Forbidden | NotFound | NeonOpError;
...
export type GetProjectBranchFunctionError = NotFound | NeonOpError;
...
export type GetProjectBranchTriggerError = NotFound | NeonOpError;
/** Get a trigger Returns the trigger visible on the branch. The supported trigger types are `schedule` and `storage_object_created`. **Note**: This endpoint is currently in Beta. */
export const getProjectBranchTrigger: API.OperationMethod<
  GetProjectBranchTriggerRequest,
  TriggerResponse,
  GetProjectBranchTriggerError,
  NeonOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetProjectBranchTriggerRequest,
  output: TriggerResponse,
  errors: [NotFound, UnknownNeonError],
  protocol: NeonProtocol,
  retry: Retry.Retry,
...
export type ListProjectBranchLogFieldValuesError = BadRequest | NotFound | NeonOpError;
...
export type ListProjectBranchTriggersError = NeonOpError;
/** List triggers on the branch Lists the complete project-bounded set of triggers visible on the branch, ordered by `trigger_id`. An inherited trigger keeps its project-wide ID and configuration, and is disabled on the child until explicitly enabled there. The supported trigger types are `schedule` and `storage_object_created`. A storage-object-created trigger watches one exact bucket and fires only after an object upload succeeds. **Note**: This endpoint is currently in Beta. */
export const listProjectBranchTriggers: API.OperationMethod<
  ListProjectBranchTriggersRequest,
  TriggersListResponse,
  ListProjectBranchTriggersError,
  NeonOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: ListProjectBranchTriggersRequest,
...
export type TransferProjectsFromOrgToOrgError = UnprocessableEntity | NeonOpError;
...
export type UpdateProjectBranchTriggerError = NeonOpError;
/** Update a trigger Applies a partial update. The required `type` discriminator must identify the existing trigger kind. The supported types are `schedule` and `storage_object_created`. Editing an inherited trigger creates a child-local shadow with the same `trigger_id`; it remains disabled unless this request explicitly enables it. For a schedule trigger, updating the schedule or enabled state increments `version` and recomputes `next_run_at`. Disabling stops future scheduling but does not cancel occurrences already committed for delivery. For `storage_object_created`, the configuration selects one exact bucket. An omitted object-key prefix matches every key in that bucket; a present prefix is matched byte-for-byte and case-sensitively against the full key, without path normalization or a path-segment boundary. **Note**: This endpoint is currently in Beta. */
export const updateProjectBranchTrigger: API.OperationMethod<
  UpdateProjectBranchTriggerRequest,
  TriggerResponse,
  UpdateProjectBranchTriggerError,
  NeonOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: UpdateProjectBranchTriggerRequest,
  output: TriggerResponse,
  errors: [UnknownNeonError],
  protocol: NeonProtocol,
  retry: Retry.Retry,
