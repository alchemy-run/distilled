...
export const CheckIamAuthorizationRequestResourceURNsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CheckIamAuthorizationRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    actions: CheckIamAuthorizationRequestActionsList,
    resourceURNs: CheckIamAuthorizationRequestResourceURNsList,
  }).pipe(T.Http({ method: "POST", uri: "/iam/authorization/check", code: 200 })),
).annotate({
...
export const IamAuthorizeBatchResponseAuthorizedActionsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const IamAuthorizeBatchResponseUnauthorizedActionsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const IamAuthorizeBatchResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    authorizedActions: S.optional(IamAuthorizeBatchResponseAuthorizedActionsList),
    resourceURN: S.optional(S.String),
    unauthorizedActions: S.optional(IamAuthorizeBatchResponseUnauthorizedActionsList),
  }),
).annotate({
...
export const CheckIamResourceAuthorizationRequestActionsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const IamAuthorizeResponseUnauthorizedActionsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateIamPolicyRequestPermissionsGroupsList = /*@__PURE__*/ S.Array(
...
export const CreateIamResourceTagResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const DeleteIamResourceGroupResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const DeleteIamResourceTagResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const GetIamResourceGroupRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    groupId: S.String.pipe(T.Label()),
    details: S.optional(S.Boolean.pipe(T.Query())),
  }).pipe(T.Http({ method: "GET", uri: "/iam/resourceGroup/{groupId}", code: 200 })),
).annotate({
...
export const ListIamPolicyRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    resourceURN: S.optional(ListIamPolicyRequestResourceURNList.pipe(T.Query())),
    xPaginationCursor: S.optional(S.String.pipe(T.Header("X-Pagination-Cursor"))),
    xPaginationSize: S.optional(S.Number.pipe(T.Header("X-Pagination-Size"))),
...
export const ListIamReferenceActionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    resourceType: S.optional(ListIamReferenceActionRequestResourceTypeList.pipe(T.Query())),
    xPaginationCursor: S.optional(S.String.pipe(T.Header("X-Pagination-Cursor"))),
    xPaginationSize: S.optional(S.Number.pipe(T.Header("X-Pagination-Size"))),
...
export const ListIamReferenceResourceTypeRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    xPaginationCursor: S.optional(S.String.pipe(T.Header("X-Pagination-Cursor"))),
    xPaginationSize: S.optional(S.Number.pipe(T.Header("X-Pagination-Size"))),
  }).pipe(T.Http({ method: "GET", uri: "/iam/reference/resource/type", code: 200 })),
).annotate({
...
export const ListIamReferenceResourceTypeResponseBodyList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ListIamResourceRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    resourceName: S.optional(ListIamResourceRequestResourceNameList.pipe(T.Query())),
    resourceType: S.optional(ListIamResourceRequestResourceTypeList.pipe(T.Query())),
    resourceURN: S.optional(ListIamResourceRequestResourceURNList.pipe(T.Query())),
...
export const PutIamResourceGroupRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    name: S.String,
    resources: PutIamResourceGroupRequestResourcesList,
  }).pipe(T.Http({ method: "PUT", uri: "/iam/resourceGroup/{groupId}", code: 200 })),
).annotate({
