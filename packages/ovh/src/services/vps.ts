...
export const CreateVpsAutomatedBackupRescheduleRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    serviceName: S.String.pipe(T.Label()),
    schedule: S.String,
  }).pipe(
...
export const CreateVpsReinstallRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    templateId: S.Number,
  }).pipe(T.Http({ method: "POST", uri: "/vps/{serviceName}/reinstall", code: 200 })),
).annotate({
...
export const GetVpsSecondaryDnsNameServerAvailableRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    serviceName: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
...
export const ListVpsAutomatedBackupAttachedBackupRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    serviceName: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
...
export const ListVpsAutomatedBackupAttachedBackupResponseBodyList = /*@__PURE__*/ S.Array(
...
export const ListVpsAutomatedBackupAttachedBackupResponse = /*@__PURE__*/ S.suspend(() =>
  ListVpsAutomatedBackupAttachedBackupResponseBodyList.pipe(T.RawResponseRoot()),
).annotate({
...
export const ListVpsAutomatedBackupRestorePointsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    serviceName: S.String.pipe(T.Label()),
...
export const ListVpsAutomatedBackupRestorePointsResponseBodyList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ListVpsAutomatedBackupRestorePointsResponse = /*@__PURE__*/ S.suspend(() =>
  ListVpsAutomatedBackupRestorePointsResponseBodyList.pipe(T.RawResponseRoot()),
).annotate({
...
export const ListVpsBackupftpAuthorizableBlocksRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    serviceName: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
...
export const ListVpsBackupftpAuthorizableBlocksResponseBodyList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ListVpsBackupftpAuthorizableBlocksResponse = /*@__PURE__*/ S.suspend(() =>
  ListVpsBackupftpAuthorizableBlocksResponseBodyList.pipe(T.RawResponseRoot()),
).annotate({
...
export const ComplexTypeUnitAndValuesVpsVpsTimestampValue = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    unit: S.optional(S.String),
...
export const ListVpsDistributionSoftwareResponseBodyList = /*@__PURE__*/ S.Array(
  S.Number,
...
export const ListVpsOrderRuleDatacenterRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "GET", uri: "/vps/order/rule/datacenter", code: 200 })),
).annotate({
...
export const ListVpsOrderRuleOsChoicesRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "GET", uri: "/vps/order/rule/osChoices", code: 200 })),
).annotate({
...
export const PutVpsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
  identifier: "PutVpsResponse",
}) as any as S.Schema<PutVpsResponse>;
...
export const StopVpsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    serviceName: S.String.pipe(T.Label()),
  }).pipe(T.Http({ method: "POST", uri: "/vps/{serviceName}/stop", code: 200 })),
...
export const getVps: API.OperationMethod<GetVpsRequest, VpsVPSWithIAM, GetVpsError, OvhOpContext> =
  /*@__PURE__*/ API.make(() => ({
    input: GetVpsRequest,
...
/** Get this object properties */
export const getVpsIps: API.OperationMethod<GetVpsIpsRequest, VpsIp, GetVpsIpsError, OvhOpContext> =
  /*@__PURE__*/ API.make(() => ({
...
export const putVps: API.OperationMethod<PutVpsRequest, PutVpsResponse, PutVpsError, OvhOpContext> =
  /*@__PURE__*/ API.make(() => ({
    input: PutVpsRequest,
...
export const startVps: API.OperationMethod<StartVpsRequest, VpsTask, StartVpsError, OvhOpContext> =
  /*@__PURE__*/ API.make(() => ({
...
export const stopVps: API.OperationMethod<StopVpsRequest, VpsTask, StopVpsError, OvhOpContext> =
  /*@__PURE__*/ API.make(() => ({
