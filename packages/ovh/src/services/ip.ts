...
export const CreateIpBringYourOwnIpSliceRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "POST", uri: "/ip/{ip}/bringYourOwnIp/slice", code: 200 })),
).annotate({
...
export const CreateIpMigrationTokenRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ip: S.String.pipe(T.Label()),
    customerId: S.String,
  }).pipe(T.Http({ method: "POST", uri: "/ip/{ip}/migrationToken", code: 200 })),
).annotate({
...
export const CreateIpMitigationProfileRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "POST", uri: "/ip/{ip}/mitigationProfiles", code: 200 })),
).annotate({
...
export const CreateIpServiceChangeContactResponseBodyList = /*@__PURE__*/ S.Array(
  S.Number,
...
export const ListIpBringYourOwnIpAggregateResponseBodyList = /*@__PURE__*/ S.Array(
...
export const ListIpBringYourOwnIpSliceRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ip: S.String.pipe(T.Label()),
  }).pipe(T.Http({ method: "GET", uri: "/ip/{ip}/bringYourOwnIp/slice", code: 200 })),
).annotate({
...
export const IpCampusBringYourOwnIpSupportedRirForIpList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ListIpLicenseCloudLinuxRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "GET", uri: "/ip/{ip}/license/cloudLinux", code: 200 })),
).annotate({
...
export const ListIpLicenseDirectadminRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ip: S.String.pipe(T.Label()),
    ipAddress: S.optional(S.String.pipe(T.Query())),
  }).pipe(T.Http({ method: "GET", uri: "/ip/{ip}/license/directadmin", code: 200 })),
).annotate({
...
export const ListIpLicenseSqlserverRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ip: S.String.pipe(T.Label()),
    ipAddress: S.optional(S.String.pipe(T.Query())),
  }).pipe(T.Http({ method: "GET", uri: "/ip/{ip}/license/sqlserver", code: 200 })),
).annotate({
...
export const ListIpLicenseVirtuozzoRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ip: S.String.pipe(T.Label()),
    ipAddress: S.optional(S.String.pipe(T.Query())),
  }).pipe(T.Http({ method: "GET", uri: "/ip/{ip}/license/virtuozzo", code: 200 })),
).annotate({
...
export const ListIpLicenseWindowsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ip: S.String.pipe(T.Label()),
    ipAddress: S.optional(S.String.pipe(T.Query())),
  }).pipe(T.Http({ method: "GET", uri: "/ip/{ip}/license/windows", code: 200 })),
).annotate({
...
export const ListIpLicenseWorklightRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ip: S.String.pipe(T.Label()),
    ipAddress: S.optional(S.String.pipe(T.Query())),
  }).pipe(T.Http({ method: "GET", uri: "/ip/{ip}/license/worklight", code: 200 })),
).annotate({
...
export const ListIpMitigationProfilesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ip: S.String.pipe(T.Label()),
  }).pipe(T.Http({ method: "GET", uri: "/ip/{ip}/mitigationProfiles", code: 200 })),
).annotate({
...
export const PutIpResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
  identifier: "PutIpResponse",
}) as any as S.Schema<PutIpResponse>;
...
export const getIp: API.OperationMethod<GetIpRequest, IpIpWithIAM, GetIpError, OvhOpContext> =
  /*@__PURE__*/ API.make(() => ({
    input: GetIpRequest,
    output: IpIpWithIAM,
    errors: [UnknownOvhError],
...
/** Your OVH IPs */
export const listIp: API.OperationMethod<ListIpRequest, ListIpResponse, ListIpError, OvhOpContext> =
  /*@__PURE__*/ API.make(() => ({
    input: ListIpRequest,
...
export const moveIp: API.OperationMethod<MoveIpRequest, IpIpTask, MoveIpError, OvhOpContext> =
  /*@__PURE__*/ API.make(() => ({
    input: MoveIpRequest,
    output: IpIpTask,
    errors: [UnknownOvhError],
...
export const putIp: API.OperationMethod<PutIpRequest, PutIpResponse, PutIpError, OvhOpContext> =
  /*@__PURE__*/ API.make(() => ({
    input: PutIpRequest,
