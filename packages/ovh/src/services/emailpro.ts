...
export const CreateEmailProAccountChangePasswordRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    service: S.String.pipe(T.Label()),
    email: S.String.pipe(T.Label()),
...
export const CreateEmailProChangeContactResponseBodyList = /*@__PURE__*/ S.Array(
  S.Number,
...
export const CreateEmailProDomainRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "POST", uri: "/email/pro/{service}/domain", code: 200 })),
).annotate({
...
export const DeleteEmailProAccountSendOnBehalfToRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    service: S.String.pipe(T.Label()),
    email: S.String.pipe(T.Label()),
    allowedAccountId: S.Number.pipe(T.Label()),
...
export const ListEmailProAccountRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "GET", uri: "/email/pro/{service}/account", code: 200 })),
).annotate({
...
export const ListEmailProAccountFullAccessResponseBodyList = /*@__PURE__*/ S.Array(
  S.Number,
...
export const ListEmailProAccountSendOnBehalfToResponseBodyList = /*@__PURE__*/ S.Array(
  S.Number,
...
export const ListEmailProAccountSendOnBehalfToResponse = /*@__PURE__*/ S.suspend(() =>
...
export const ListEmailProDomainRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "GET", uri: "/email/pro/{service}/domain", code: 200 })),
).annotate({
...
export const ListEmailProDomainDisclaimerAttributeRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    service: S.String.pipe(T.Label()),
    domainName: S.String.pipe(T.Label()),
  }).pipe(
...
export const ListEmailProDomainDisclaimerAttributeResponseBodyList = /*@__PURE__*/ S.Array(
...
export const ListEmailProDomainDisclaimerAttributeResponse = /*@__PURE__*/ S.suspend(() =>
  ListEmailProDomainDisclaimerAttributeResponseBodyList.pipe(T.RawResponseRoot()),
).annotate({
...
export const ListEmailProDomainDkimSelectorResponseBodyList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ListEmailProExternalContactResponseBodyList = /*@__PURE__*/ S.Array(
  S.String,
...
export const PutEmailProAccountRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    lastName: S.optional(S.NullOr(S.String)),
    login: S.optional(S.String),
    mailingFilter: S.optional(S.NullOr(PutEmailProAccountRequestMailingFilterList)),
    quota: S.optional(S.Number),
    renewPeriod: S.optional(S.NullOr(EmailProRenewPeriodEnum)),
    spamAndVirusConfiguration: S.optional(IamResourceTagFilterInput),
  }).pipe(
...
export const PutEmailProAccountResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
