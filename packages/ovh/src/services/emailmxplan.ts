...
export const CreateEmailMxplanAccountChangePasswordRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    service: S.String.pipe(T.Label()),
    email: S.String.pipe(T.Label()),
...
export const CreateEmailMxplanAccountDiagnosticRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    service: S.String.pipe(T.Label()),
    email: S.String.pipe(T.Label()),
    password: S.String.pipe(T.SensitiveValue({})),
...
export const CreateEmailMxplanAccountFullAccessRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    service: S.String.pipe(T.Label()),
    email: S.String.pipe(T.Label()),
...
export const DeleteEmailMxplanAccountFullAccessRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    service: S.String.pipe(T.Label()),
    email: S.String.pipe(T.Label()),
...
export const DeleteEmailMxplanAccountSendOnBehalfToRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    service: S.String.pipe(T.Label()),
    email: S.String.pipe(T.Label()),
    allowedAccountId: S.Number.pipe(T.Label()),
...
export const GetEmailMxplanAccountSendOnBehalfToRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    service: S.String.pipe(T.Label()),
    email: S.String.pipe(T.Label()),
    allowedAccountId: S.Number.pipe(T.Label()),
...
export const GetEmailMxplanServerRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    service: S.String.pipe(T.Label()),
  }).pipe(T.Http({ method: "GET", uri: "/email/mxplan/{service}/server", code: 200 })),
).annotate({
...
export const ListEmailMxplanAccountAliasResponseBodyList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ListEmailMxplanAccountCapabilitiesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    service: S.String.pipe(T.Label()),
    email: S.String.pipe(T.Label()),
  }).pipe(
...
export const ListEmailMxplanAccountFullAccessResponseBodyList = /*@__PURE__*/ S.Array(
  S.Number,
...
export const ListEmailMxplanAccountSendAsResponseBodyList = /*@__PURE__*/ S.Array(
  S.Number,
...
export const ListEmailMxplanAccountSendOnBehalfToRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    service: S.String.pipe(T.Label()),
    email: S.String.pipe(T.Label()),
  }).pipe(
...
export const ListEmailMxplanAccountSendOnBehalfToResponseBodyList = /*@__PURE__*/ S.Array(
  S.Number,
...
export const ListEmailMxplanAccountSendOnBehalfToResponse = /*@__PURE__*/ S.suspend(() =>
  ListEmailMxplanAccountSendOnBehalfToResponseBodyList.pipe(T.RawResponseRoot()),
).annotate({
...
export const ListEmailMxplanDomainRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "GET", uri: "/email/mxplan/{service}/domain", code: 200 })),
).annotate({
...
export const ListEmailMxplanDomainDisclaimerAttributeRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    service: S.String.pipe(T.Label()),
    domainName: S.String.pipe(T.Label()),
  }).pipe(
...
export const ListEmailMxplanDomainDisclaimerAttributeResponseBodyList = /*@__PURE__*/ S.Array(
...
export const ListEmailMxplanDomainDisclaimerAttributeResponse = /*@__PURE__*/ S.suspend(() =>
  ListEmailMxplanDomainDisclaimerAttributeResponseBodyList.pipe(T.RawResponseRoot()),
).annotate({
...
export const ListEmailMxplanExternalContactResponseBodyList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ListEmailMxplanTaskRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    service: S.String.pipe(T.Label()),
  }).pipe(T.Http({ method: "GET", uri: "/email/mxplan/{service}/task", code: 200 })),
).annotate({
...
>;
export const PutEmailMxplanAccountRequestMailingFilterList = /*@__PURE__*/ S.Array(
  EmailProMailingFilterEnum,
...
export const PutEmailMxplanAccountRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    lastName: S.optional(S.NullOr(S.String)),
    login: S.optional(S.String),
    mailingFilter: S.optional(S.NullOr(PutEmailMxplanAccountRequestMailingFilterList)),
    quota: S.optional(S.Number),
    renewPeriod: S.optional(S.NullOr(EmailProRenewPeriodEnum)),
    spamAndVirusConfiguration: S.optional(EmailProSpamAndVirusConfiguration),
  }).pipe(
...
export const PutEmailMxplanAccountResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const PutEmailMxplanDomainResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const UpdateEmailMxplanFlagsOnAllAccountsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    service: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
...
export const UpdateEmailMxplanFlagsOnAllAccountsResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
