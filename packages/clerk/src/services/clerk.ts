...
import { ClerkProtocol, type ClerkOpError, type ClerkOpContext } from "../protocol.ts";
...
export type AdjustOrganizationBillingCreditBalanceRequestAction = "increase" | "decrease";
...
export const AdjustOrganizationBillingCreditBalanceRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
/** Whether to increase or decrease the credit balance. */
export type AdjustUserBillingCreditBalanceRequestAction = "increase" | "decrease";
...
export const ApplyBillingSubscriptionItemDiscountRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export type CommerceDiscountRedemptionResponseObject = "commerce_discount_redemption";
export const CommerceDiscountRedemptionResponseObject = S.String;

/** How the discount was applied to the subscription item. */
export type CommerceDiscountRedemptionResponseSource = "promotion" | "manual" | "promo_code";
export const CommerceDiscountRedemptionResponseSource = S.String;

/** The snapshotted discount effect. */
export type CommerceDiscountRedemptionResponseEffect = "percentage" | "fixed_amount";
export const CommerceDiscountRedemptionResponseEffect = S.String;

/** Current status of the discount redemption. */
export type CommerceDiscountRedemptionResponseStatus = "active" | "exhausted" | "removed";
...
export const AssignPermissionToOrganizationRoleRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export type VerificationOtpStatus = "unverified" | "verified" | "failed" | "expired";
export const VerificationOtpStatus = S.String;

export type VerificationOtpStrategy = "phone_code" | "email_code" | "reset_password_email_code";
...
export type VerificationEmailLinkStatus = "unverified" | "verified" | "failed" | "expired";
...
export type EmailAddressVerification =
  ...
  | VerificationScim;
export const EmailAddressVerification = S.Unknown as any as S.Schema<EmailAddressVerification>;
...
export const PhoneNumberVerification = S.Unknown as any as S.Schema<PhoneNumberVerification>;
...
export type VerificationWeb3Status = "unverified" | "verified" | "failed" | "expired";
...
export const UserPasskeysList = /*@__PURE__*/ S.Array(Passkey) as any as S.Schema<UserPasskeysList>;
...
export const ExternalAccountWithVerificationPublicMetadataMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const SAMLAccountVerification = S.Unknown as any as S.Schema<SAMLAccountVerification>;
...
export type CommercePaymentMethodResponsePaymentType = "card" | "link" | "payer-credits";
...
export const CommerceSubscriptionItemNextPaymentResponsePerUnitTotalsList = /*@__PURE__*/ S.Array(
  CommercePerUnitTotal,
) as any as S.Schema<CommerceSubscriptionItemNextPaymentResponsePerUnitTotalsList>;

export type CommerceTotalsResponsePerUnitTotalsList = Array<CommercePerUnitTotal>;
...
export const CommerceSubscriptionItemNextPaymentResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    amount: S.optional(S.NullOr(CommerceMoneyResponse)),
    date: S.optional(S.NullOr(S.Number)),
    per_unit_totals: S.optional(CommerceSubscriptionItemNextPaymentResponsePerUnitTotalsList),
...
export type CommerceSubscriptionItemSeatsResponseTiersList = Array<CommercePerUnitTotalTier2>;
export const CommerceSubscriptionItemSeatsResponseTiersList = /*@__PURE__*/ S.Array(
...
export const CommerceSubscriptionItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    next_payment: S.optional(S.NullOr(CommerceSubscriptionItemNextPaymentResponse)),
    payer_id: S.String,
...
export const ChangeProductionInstanceDomainRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "POST", uri: "/instance/change_domain", code: 200 })),
).annotate({
...
export const CreateAdminPortalLinkTokenRequestScopesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateAdminPortalLinkTokenRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "POST", uri: "/admin_portal_link_tokens", code: 200 })),
).annotate({
  identifier: "CreateAdminPortalLinkTokenRequest",
}) as any as S.Schema<CreateAdminPortalLinkTokenRequest>;

export type CreateAdminPortalLinkTokenResponseObject = "admin_portal_link_token";
...
export const CreateAdminPortalLinkTokenResponseScopesList = /*@__PURE__*/ S.Array(
  S.String,
...
export type AllowlistIdentifierIdentifierType = "email_address" | "phone_number" | "web3_wallet";
...
export interface CreateBillingPriceRequest {
  ...
  description?: string;
  /** Which billing periods this price supports. Inferred from amounts if omitted. */
  supported_billing_periods?: CreateBillingPriceRequestSupportedBillingPeriods | (string & {});
}
export const CreateBillingPriceRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    supported_billing_periods: S.optional(CreateBillingPriceRequestSupportedBillingPeriods),
...
export type BillingPriceResponseSupportedBillingPeriods = "month" | "annual" | "both";
...
/** The payment method type. */
export type CommercePaymentSourceResponsePaymentMethod = "card" | "apple_pay" | "google_pay";
...
export const CommerceSubscriptionItem2 = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    amount: S.optional(S.NullOr(CommerceMoneyResponse)),
    next_invoice: S.optional(S.NullOr(CommerceSubscriptionItemNextPaymentResponse)),
    next_payment: S.optional(S.NullOr(CommerceSubscriptionItemNextPaymentResponse)),
    payer_id: S.String,
...
export type CommercePriceTransitionDetailsEffectiveMode = "immediate" | "end_of_period";
...
export type CommercePriceTransitionDetailsPreviousSubscriptionItemStatus =
  ...
  | "ended"
  | "abandoned";
export const CommercePriceTransitionDetailsPreviousSubscriptionItemStatus = S.String;
...
export type BlocklistIdentifierIdentifierType = "email_address" | "phone_number" | "web3_wallet";
...
export const CreateBulkInvitationsRequestBodyItemPublicMetadataMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export type CreateBulkInvitationsRequestBodyItemTemplateSlug = "invitation" | "waitlist_invitation";
...
export interface CreateBulkInvitationsRequestBodyItem {
  ...
  /** The slug of the email template to use for the invitation email. */
  template_slug?: CreateBulkInvitationsRequestBodyItemTemplateSlug | (string & {});
}
export const CreateBulkInvitationsRequestBodyItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    email_address: S.String,
    public_metadata: S.optional(S.NullOr(CreateBulkInvitationsRequestBodyItemPublicMetadataMap)),
    ...
    template_slug: S.optional(CreateBulkInvitationsRequestBodyItemTemplateSlug),
  }),
).annotate({
  identifier: "CreateBulkInvitationsRequestBodyItem",
}) as any as S.Schema<CreateBulkInvitationsRequestBodyItem>;

export type CreateBulkInvitationsRequestBodyList = Array<CreateBulkInvitationsRequestBodyItem>;
...
export type CreateBulkInvitationsResponse = CreateBulkInvitationsResponseBodyList;
...
export const CreateBulkWaitlistEntriesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    body: S.optional(CreateBulkWaitlistEntriesRequestBodyList.pipe(T.HttpBody())),
...
export type WaitlistEntryStatus = "pending" | "invited" | "rejected" | "completed";
...
export type CreateBulkWaitlistEntriesResponse = CreateBulkWaitlistEntriesResponseBodyList;
...
export const CreateDirectoryRequestGroupRoleMappingsItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const CreateDirectoryRequestGroupRoleMappingsList = /*@__PURE__*/ S.Array(
...
export type DirectoryCustomAttributesList = Array<DirectoryCustomAttributesItem>;
...
export const CreateEnterpriseConnectionRequestDomainsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateEnterpriseConnectionRequestSamlAttributeMapping = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    user_id: S.optional(S.NullOr(S.String)),
...
export const CreateEnterpriseConnectionRequestSamlLoginHint = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const CreateEnterpriseConnectionRequestSaml = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    login_hint: S.optional(S.NullOr(CreateEnterpriseConnectionRequestSamlLoginHint)),
  }),
).annotate({
...
export const CreateEnterpriseConnectionRequestCustomAttributesItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    name: S.String,
    key: S.String,
    sso_path: S.optional(S.String),
...
export const CreateEnterpriseConnectionRequestCustomAttributesList = /*@__PURE__*/ S.Array(
...
export const CreateEnterpriseConnectionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    custom_attributes: S.optional(CreateEnterpriseConnectionRequestCustomAttributesList),
  }).pipe(T.Http({ method: "POST", uri: "/enterprise_connections", code: 200 })),
).annotate({
...
export const EnterpriseConnectionSamlConnectionLoginHint = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    mode: EnterpriseConnectionSamlConnectionLoginHintMode,
    source: S.optional(S.String),
  }),
...
/** The slug of the email template to use for the invitation email. */
export type CreateInvitationRequestTemplateSlug = "invitation" | "waitlist_invitation";
...
export type CreateMachineResponseScopedMachinesList = Array<MachineWithoutScopedMachines>;
...
export const CreateMachineScopeRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "POST", uri: "/machines/{machine_id}/scopes", code: 200 })),
).annotate({
...
export const CreateOAuthApplicationRequestRedirectUrisList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateOAuthApplicationRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    name: S.String,
    redirect_uris: S.optional(S.NullOr(CreateOAuthApplicationRequestRedirectUrisList)),
...
export const CreateOAuthApplicationResponseRedirectUrisList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateOrganizationRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    name: S.String,
    created_by: S.optional(S.NullOr(S.String)),
    private_metadata: S.optional(S.NullOr(CreateOrganizationRequestPrivateMetadataMap)),
    public_metadata: S.optional(S.NullOr(CreateOrganizationRequestPublicMetadataMap)),
...
export const OrganizationInvitationPublicOrganizationData = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.String,
    name: S.String,
    slug: S.String,
...
export const OrganizationDomain = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    public_organization_data: S.optional(S.NullOr(OrganizationInvitationPublicOrganizationData)),
    created_at: S.Number,
    updated_at: S.Number,
  }),
).annotate({
...
export const CreateOrganizationInvitationRequestPublicMetadataMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const CreateOrganizationInvitationRequestPrivateMetadataMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const CreateOrganizationInvitationRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    role: S.String,
    public_metadata: S.optional(S.NullOr(CreateOrganizationInvitationRequestPublicMetadataMap)),
    private_metadata: S.optional(S.NullOr(CreateOrganizationInvitationRequestPrivateMetadataMap)),
    redirect_url: S.optional(S.NullOr(S.String)),
    expires_in_days: S.optional(S.NullOr(S.Number)),
    notify: S.optional(S.NullOr(S.Boolean)),
  }).pipe(
...
export const CreateOrganizationInvitationBulkRequestBodyItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    email_address: S.String,
    inviter_user_id: S.optional(S.NullOr(S.String)),
    role: S.String,
    public_metadata: S.optional(
      S.NullOr(CreateOrganizationInvitationBulkRequestBodyItemPublicMetadataMap),
    ),
    private_metadata: S.optional(
      S.NullOr(CreateOrganizationInvitationBulkRequestBodyItemPrivateMetadataMap),
    ),
    redirect_url: S.optional(S.NullOr(S.String)),
    expires_in_days: S.optional(S.NullOr(S.Number)),
    notify: S.optional(S.NullOr(S.Boolean)),
...
export const CreateOrganizationInvitationBulkRequestBodyList = /*@__PURE__*/ S.Array(
...
export const CreateOrganizationMembershipRequestPublicMetadataMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const CreateOrganizationMembershipRequestPrivateMetadataMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const CreateOrganizationPermissionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    key: S.String,
    description: S.optional(S.String),
  }).pipe(T.Http({ method: "POST", uri: "/organization_permissions", code: 200 })),
).annotate({
...
export const CreateOrganizationRoleRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    key: S.String,
    description: S.optional(S.NullOr(S.String)),
    permissions: S.optional(S.NullOr(CreateOrganizationRoleRequestPermissionsList)),
...
export const CreateSCIMDirectoryRequestGroupRoleMappingsItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    scim_group_id: S.String,
    scim_group_display_name: S.optional(S.String),
    role_id: S.String,
...
export const CreateSCIMDirectoryRequestGroupRoleMappingsList = /*@__PURE__*/ S.Array(
...
export const CreateSCIMDirectoryRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    name: S.optional(S.String),
    provider: S.String,
    group_role_mappings: S.optional(CreateSCIMDirectoryRequestGroupRoleMappingsList),
...
export type SCIMDirectoryCustomAttributesList = Array<SCIMDirectoryCustomAttributesItem>;
...
export const CreateSessionTokenRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "POST", uri: "/sessions/{session_id}/tokens", code: 200 })),
).annotate({
...
export const CreateTestingTokenRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}).pipe(T.Http({ method: "POST", uri: "/testing_tokens", code: 200 })),
).annotate({
...
export type CreateUserRequestEmailAddressIdentificationStatusItem = "verified" | "reserved";
...
>;
export const CreateUserRequestEmailAddressIdentificationStatusList = /*@__PURE__*/ S.Array(
...
export type CreateUserRequestPhoneNumberIdentificationStatusItem = "verified" | "reserved";
...
>;
export const CreateUserRequestPhoneNumberIdentificationStatusList = /*@__PURE__*/ S.Array(
...
export type DeleteDirectoryGroupRoleMappingResponseObject = "directory_group_role_mapping";
...
/** String representing the object's type. */
export type DeleteSCIMGroupRoleMappingResponseObject = "scim_group_role_mapping";
...
export const ExtendBillingSubscriptionItemFreeTrialRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscription_item_id: S.String.pipe(T.Label()),
    extend_to: S.String,
  }).pipe(
...
export const GenerateSvixAuthURLRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}).pipe(T.Http({ method: "POST", uri: "/webhooks/svix_url", code: 200 })),
).annotate({
...
export const GetBillingStatementPaymentAttemptsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    statementID: S.String.pipe(T.Label()),
    paginated: S.optional(S.Boolean.pipe(T.Query())),
    limit: S.optional(S.Number.pipe(T.Query())),
...
export type PaginatedBillingPaymentAttemptResponseDataList = Array<BillingPaymentAttempt>;
export const PaginatedBillingPaymentAttemptResponseDataList = /*@__PURE__*/ S.Array(
  BillingPaymentAttempt,
...
export const GetCommerceSubscriptionItemListRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    limit: S.optional(S.Number.pipe(T.Query())),
    offset: S.optional(S.Number.pipe(T.Query())),
    status: S.optional(GetCommerceSubscriptionItemListRequestStatus.pipe(T.Query())),
    payer_type: S.optional(GetCommerceSubscriptionItemListRequestPayerType.pipe(T.Query())),
    plan_id: S.optional(S.String.pipe(T.Query())),
    include_free: S.optional(S.Boolean.pipe(T.Query())),
    query: S.optional(S.String.pipe(T.Query())),
  }).pipe(T.Http({ method: "GET", uri: "/billing/subscription_items", code: 200 })),
).annotate({
...
export type PaginatedCommerceSubscriptionItemResponseDataList = Array<CommerceSubscriptionItem>;
export const PaginatedCommerceSubscriptionItemResponseDataList = /*@__PURE__*/ S.Array(
...
export const PaginatedCommerceSubscriptionItemResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    data: PaginatedCommerceSubscriptionItemResponseDataList,
    total_count: S.Number,
  }),
...
export const GetInstanceCommunicationRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}).pipe(T.Http({ method: "GET", uri: "/instance/communication", code: 200 })),
).annotate({
...
export const InstanceCommunicationBlockedCountryCodesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const OrganizationSettingsDomainsEnrollmentModesList = /*@__PURE__*/ S.Array(
...
export const GetInstanceProtectRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}).pipe(T.Http({ method: "GET", uri: "/instance/protect", code: 200 })),
).annotate({
...
export const JWKSKeysList = /*@__PURE__*/ S.Array(JWKSKeysItem) as any as S.Schema<JWKSKeysList>;
...
export const GetM2MTokensResponseM2mTokensItemScopesList = /*@__PURE__*/ S.Array(
  S.String,
...
export type GetM2MTokensResponseM2mTokensList = Array<GetM2MTokensResponseM2mTokensItem>;
...
/** Array of machines this machine has access to. */
export type GetMachineResponseScopedMachinesList = Array<MachineWithoutScopedMachines>;
...
export const GetOrganizationBillingCreditBalanceRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    organization_id: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
...
export const GetOrganizationBillingSubscriptionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    organization_id: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
...
export type CommerceSubscriptionSubscriptionItemsList = Array<CommerceSubscriptionItem>;
...
/** Per-unit total breakdown (for example, seats) for the next payment. */
export type CommerceSubscriptionNextPaymentPerUnitTotalsList = Array<CommercePerUnitTotal2>;
export const CommerceSubscriptionNextPaymentPerUnitTotalsList = /*@__PURE__*/ S.Array(
  CommercePerUnitTotal2,
...
export const CommerceSubscriptionNextPayment = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    date: S.Number,
    amount: CommerceMoneyResponse,
    per_unit_totals: S.optional(CommerceSubscriptionNextPaymentPerUnitTotalsList),
    totals: S.optional(S.NullOr(CommerceTotalsResponse2)),
  }),
).annotate({
...
export const GetUserListRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    email_address: S.optional(GetUserListRequestEmailAddressList.pipe(T.Query())),
    ...
    organization_id: S.optional(GetUserListRequestOrganizationIdList.pipe(T.Query())),
    query: S.optional(S.String.pipe(T.Query())),
    ...
    provider_user_id: S.optional(GetUserListRequestProviderUserIdList.pipe(T.Query())),
    limit: S.optional(S.Number.pipe(T.Query())),
    offset: S.optional(S.Number.pipe(T.Query())),
...
export const GetUsersCountRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    email_address: S.optional(GetUsersCountRequestEmailAddressList.pipe(T.Query())),
    phone_number: S.optional(GetUsersCountRequestPhoneNumberList.pipe(T.Query())),
    ...
    organization_id: S.optional(GetUsersCountRequestOrganizationIdList.pipe(T.Query())),
    query: S.optional(S.String.pipe(T.Query())),
    email_address_query: S.optional(S.String.pipe(T.Query())),
    phone_number_query: S.optional(S.String.pipe(T.Query())),
    username_query: S.optional(S.String.pipe(T.Query())),
...
export const InstanceGetOrganizationMembershipsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    order_by: S.optional(S.String.pipe(T.Query())),
    limit: S.optional(S.Number.pipe(T.Query())),
    offset: S.optional(S.Number.pipe(T.Query())),
  }).pipe(T.Http({ method: "GET", uri: "/organization_memberships", code: 200 })),
).annotate({
...
>;
export const ListAllOrganizationDomainsRequestEnrollmentModeList = /*@__PURE__*/ S.Array(
...
export const ListAllOrganizationDomainsRequestDomainsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ListAllOrganizationDomainsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    query: S.optional(S.String.pipe(T.Query())),
    domains: S.optional(ListAllOrganizationDomainsRequestDomainsList.pipe(T.Query())),
    order_by: S.optional(S.String.pipe(T.Query())),
    offset: S.optional(S.Number.pipe(T.Query())),
    limit: S.optional(S.Number.pipe(T.Query())),
...
export type ListAllowlistIdentifiersResponseBodyList = Array<AllowlistIdentifier>;
...
export type ListAllowlistIdentifiersResponse = ListAllowlistIdentifiersResponseBodyList;
...
export const ListBlocklistIdentifiersRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}).pipe(T.Http({ method: "GET", uri: "/blocklist_identifiers", code: 200 })),
).annotate({
...
>;
export const ListEnterpriseConnectionTestRunsRequestStatusList = /*@__PURE__*/ S.Array(
...
export const ListEnterpriseConnectionTestRunsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    enterprise_connection_id: S.String.pipe(T.Label()),
    status: S.optional(ListEnterpriseConnectionTestRunsRequestStatusList.pipe(T.Query())),
    limit: S.optional(S.Number.pipe(T.Query())),
    offset: S.optional(S.Number.pipe(T.Query())),
  }).pipe(
    T.Http({
...
export const EnterpriseConnectionTestRunParsedUserInfo = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export type EnterpriseConnectionTestRunLogsList = Array<EnterpriseConnectionTestRunLogsItem>;
...
export const EnterpriseConnectionTestRun = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    status: EnterpriseConnectionTestRunStatus,
    connection_type: EnterpriseConnectionTestRunConnectionType,
    parsed_user_info: S.optional(S.NullOr(EnterpriseConnectionTestRunParsedUserInfo)),
...
export type EnterpriseConnectionTestRunsDataList = Array<EnterpriseConnectionTestRun>;
...
export const ListInstanceOrganizationInvitationsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    order_by: S.optional(S.String.pipe(T.Query())),
    status: S.optional(ListInstanceOrganizationInvitationsRequestStatus.pipe(T.Query())),
    query: S.optional(S.String.pipe(T.Query())),
    limit: S.optional(S.Number.pipe(T.Query())),
    offset: S.optional(S.Number.pipe(T.Query())),
  }).pipe(T.Http({ method: "GET", uri: "/organization_invitations", code: 200 })),
).annotate({
  identifier: "ListInstanceOrganizationInvitationsRequest",
}) as any as S.Schema<ListInstanceOrganizationInvitationsRequest>;

/** String representing the object's type. Objects of the same type share the same value. */
export type OrganizationInvitationWithPublicOrganizationDataObject = "organization_invitation";
...
export const OrganizationInvitationWithPublicOrganizationData = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    object: OrganizationInvitationWithPublicOrganizationDataObject,
    id: S.String,
    email_address: S.String,
    ...
    created_at: S.Number,
    updated_at: S.Number,
    public_organization_data: S.optional(OrganizationInvitationPublicOrganizationData),
  }),
).annotate({
...
export const OrganizationInvitationsWithPublicOrganizationDataDataList = /*@__PURE__*/ S.Array(
...
export const OrganizationInvitationsWithPublicOrganizationData = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    data: OrganizationInvitationsWithPublicOrganizationDataDataList,
    total_count: S.Number,
  }),
...
export type ListInvitationsRequestStatus = "pending" | "accepted" | "revoked" | "expired";
...
export const ListOrganizationInvitationsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    organization_id: S.String.pipe(T.Label()),
    status: S.optional(ListOrganizationInvitationsRequestStatus.pipe(T.Query())),
...
export const ListOrganizationMembershipsRequestUserIdList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ListOrganizationMembershipsRequestEmailAddressList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ListOrganizationMembershipsRequestPhoneNumberList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ListOrganizationMembershipsRequestUsernameList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ListOrganizationMembershipsRequestWeb3WalletList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ListOrganizationMembershipsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    organization_id: S.String.pipe(T.Label()),
    order_by: S.optional(S.String.pipe(T.Query())),
    user_id: S.optional(ListOrganizationMembershipsRequestUserIdList.pipe(T.Query())),
    email_address: S.optional(ListOrganizationMembershipsRequestEmailAddressList.pipe(T.Query())),
    phone_number: S.optional(ListOrganizationMembershipsRequestPhoneNumberList.pipe(T.Query())),
    username: S.optional(ListOrganizationMembershipsRequestUsernameList.pipe(T.Query())),
    web3_wallet: S.optional(ListOrganizationMembershipsRequestWeb3WalletList.pipe(T.Query())),
    role: S.optional(ListOrganizationMembershipsRequestRoleList.pipe(T.Query())),
    query: S.optional(S.String.pipe(T.Query())),
    email_address_query: S.optional(S.String.pipe(T.Query())),
    phone_number_query: S.optional(S.String.pipe(T.Query())),
    username_query: S.optional(S.String.pipe(T.Query())),
...
export const ListOrganizationPermissionsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    limit: S.optional(S.Number.pipe(T.Query())),
    offset: S.optional(S.Number.pipe(T.Query())),
  }).pipe(T.Http({ method: "GET", uri: "/organization_permissions", code: 200 })),
).annotate({
...
export const RolesDataList = /*@__PURE__*/ S.Array(Role) as any as S.Schema<RolesDataList>;
...
export const ListOrganizationsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    organization_id: S.optional(ListOrganizationsRequestOrganizationIdList.pipe(T.Query())),
    order_by: S.optional(S.String.pipe(T.Query())),
    limit: S.optional(S.Number.pipe(T.Query())),
    offset: S.optional(S.Number.pipe(T.Query())),
...
export const MergeOrganizationMetadataRequestPublicMetadataMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const MergeOrganizationMetadataRequestPrivateMetadataMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const RemoveBillingSubscriptionItemDiscountRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscription_item_id: S.String.pipe(T.Label()),
...
export const RemovePermissionFromOrganizationRoleRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    organization_role_id: S.String.pipe(T.Label()),
    permission_id: S.String.pipe(T.Label()),
  }).pipe(
...
export const ReplaceDirectoryGroupRoleMappingsRequestMappingsItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    directory_group_id: S.optional(S.String),
    scim_group_id: S.optional(S.String),
    role_id: S.String,
...
export const ReplaceDirectoryGroupRoleMappingsRequestMappingsList = /*@__PURE__*/ S.Array(
...
export const ReplaceDirectoryGroupRoleMappingsResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    data: DirectoryGroupRoleMappings,
    total_count: S.Number,
  }),
...
export const ReplaceOrganizationMetadataRequestPublicMetadataMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const ReplaceOrganizationMetadataRequestPrivateMetadataMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const ReplaceSCIMGroupRoleMappingsRequestMappingsItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    scim_group_id: S.String,
    role_id: S.String,
  }),
...
export const ReplaceSCIMGroupRoleMappingsRequestMappingsList = /*@__PURE__*/ S.Array(
...
export interface ReplaceUserEmailAddressRequest {
  ...
  email_address: string;
  /** Controls the status of the replacement email address. Defaults to `verified`. Set to `reserved` to create it reserved (unverified but usable for sign-in and locked so no other user can claim it), or to `unverified` to create it neither usable for sign-in nor locked. **Warning:** `unverified` can lock the user out of their account. An unverified email address cannot be used to sign in, so if the user has no other verified or reserved identifier, they will be unable to authenticate and unable to verify this address. Prefer `reserved` unless you specifically need the address left unclaimed — for example so that another user can also hold it until one of them verifies it. */
  identification_status?: ReplaceUserEmailAddressRequestIdentificationStatus | (string & {});
...
export const ReplaceUserEmailAddressRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    user_id: S.String.pipe(T.Label()),
    email_address: S.String,
    identification_status: S.optional(ReplaceUserEmailAddressRequestIdentificationStatus),
    notify_primary_email_address_changed: S.optional(S.NullOr(S.Boolean)),
  }).pipe(T.Http({ method: "PUT", uri: "/users/{user_id}/email_address", code: 200 })),
).annotate({
...
export const ReplaceUserMetadataRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "PUT", uri: "/users/{user_id}/metadata", code: 200 })),
).annotate({
...
export interface ReplaceUserPhoneNumberRequest {
  ...
  phone_number: string;
  /** Controls the status of the replacement phone number. Defaults to `verified`. Set to `reserved` to create it reserved (unverified but usable for sign-in and locked so no other user can claim it), or to `unverified` to create it neither usable for sign-in nor locked. **Warning:** `unverified` can lock the user out of their account. An unverified phone number cannot be used to sign in, so if the user has no other verified or reserved identifier, they will be unable to authenticate and unable to verify this number. Prefer `reserved` unless you specifically need the number left unclaimed — for example so that another user can also hold it until one of them verifies it. */
  identification_status?: ReplaceUserPhoneNumberRequestIdentificationStatus | (string & {});
}
export const ReplaceUserPhoneNumberRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    user_id: S.String.pipe(T.Label()),
    phone_number: S.String,
    identification_status: S.optional(ReplaceUserPhoneNumberRequestIdentificationStatus),
  }).pipe(T.Http({ method: "PUT", uri: "/users/{user_id}/phone_number", code: 200 })),
).annotate({
...
export type RevokeAdminPortalLinkTokenResponseObject = "admin_portal_link_token";
...
export const RevokeAdminPortalLinkTokenResponseScopesList = /*@__PURE__*/ S.Array(
  S.String,
...
export type RevokeInvitationResponseStatus = "pending" | "accepted" | "revoked" | "expired";
...
export type RotateOAuthApplicationSecretResponseRedirectUrisList = Array<string>;
export const RotateOAuthApplicationSecretResponseRedirectUrisList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateEnterpriseConnectionRequestSamlLoginHint = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const UpdateEnterpriseConnectionRequestSaml = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    allow_idp_initiated: S.optional(S.NullOr(S.Boolean)),
    force_authn: S.optional(S.NullOr(S.Boolean)),
    login_hint: S.optional(S.NullOr(UpdateEnterpriseConnectionRequestSamlLoginHint)),
  }),
).annotate({
...
export type UpdateEnterpriseConnectionRequestOidc = CreateEnterpriseConnectionRequestOidc;
export const UpdateEnterpriseConnectionRequestOidc = CreateEnterpriseConnectionRequestOidc;
...
export type UpdateEnterpriseConnectionRequestCustomAttributesList =
  Array<CreateEnterpriseConnectionRequestCustomAttributesItem>;
export const UpdateEnterpriseConnectionRequestCustomAttributesList = /*@__PURE__*/ S.Array(
  CreateEnterpriseConnectionRequestCustomAttributesItem,
...
export const UpdateEnterpriseConnectionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    oidc: S.optional(S.NullOr(CreateEnterpriseConnectionRequestOidc)),
    custom_attributes: S.optional(S.NullOr(UpdateEnterpriseConnectionRequestCustomAttributesList)),
  }).pipe(
    T.Http({
      method: "PATCH",
      uri: "/enterprise_connections/{enterprise_connection_id}",
...
export type UpdateInstanceRequestPreferredSignInStrategyWhenPasswordRequired =
  ...
  | "otp"
  | "";
export const UpdateInstanceRequestPreferredSignInStrategyWhenPasswordRequired = S.String;
...
export type UpdateInstanceCommunicationRequestBlockedCountryCodesList = Array<string>;
export const UpdateInstanceCommunicationRequestBlockedCountryCodesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateInstanceCommunicationRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "PATCH", uri: "/instance/communication", code: 200 })),
).annotate({
...
export interface UpdateInstanceOAuthApplicationSettingsRequest {
  ...
  /** When true, new unknown CIMD clients are rejected. Previously auto-connected and pre-registered clients remain admitted; deleting a client makes it unknown again. */
  client_id_metadata_documents_only_allow_pre_registered_clients?: boolean | null;
  /** When true, recorded implicitly allowed CIMD clients are rejected on future client lookups. Explicitly allowed clients remain accepted. This does not revoke previously issued access tokens. */
  client_id_metadata_documents_block_implicitly_allowed_clients?: boolean | null;
}
export const UpdateInstanceOAuthApplicationSettingsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export type UpdateInstanceOrganizationSettingsRequestDomainsEnrollmentModesList = Array<string>;
...
export const UpdateInstanceOrganizationSettingsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const UpdateInstanceRestrictionsRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "PATCH", uri: "/instance/restrictions", code: 200 })),
).annotate({
...
/** Array of machines this machine has access to. */
export type UpdateMachineResponseScopedMachinesList = Array<MachineWithoutScopedMachines>;
...
export const UpdateOAuthApplicationRequestRedirectUrisList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateOAuthApplicationRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    oauth_application_id: S.String.pipe(T.Label()),
    name: S.optional(S.NullOr(S.String)),
    redirect_uris: S.optional(S.NullOr(UpdateOAuthApplicationRequestRedirectUrisList)),
    callback_url: S.optional(S.NullOr(S.String)),
    scopes: S.optional(S.NullOr(S.String)),
    consent_screen_enabled: S.optional(S.NullOr(S.Boolean)),
    pkce_required: S.optional(S.NullOr(S.Boolean)),
...
export const UpdateOrganizationMembershipMetadataRequestPublicMetadataMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const UpdateOrganizationMembershipMetadataRequestPrivateMetadataMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const UpdateOrganizationMembershipMetadataRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    organization_id: S.String.pipe(T.Label()),
    user_id: S.String.pipe(T.Label()),
    public_metadata: S.optional(UpdateOrganizationMembershipMetadataRequestPublicMetadataMap),
    private_metadata: S.optional(UpdateOrganizationMembershipMetadataRequestPrivateMetadataMap),
  }).pipe(
    T.Http({
      method: "PATCH",
...
export const UpdateUserMetadataRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "PATCH", uri: "/users/{user_id}/metadata", code: 200 })),
).annotate({
...
export const UploadOrganizationLogoResponsePublicMetadataMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export const UploadOrganizationLogoResponsePrivateMetadataMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
...
export type VerifyOAuthAccessTokenResponseBodyCase0Object = "clerk_idp_oauth_access_token";
...
export const VerifyOAuthAccessTokenResponseBodyCase0ScopesList = /*@__PURE__*/ S.Array(
  S.String,
...
export type AttemptEmailAddressVerificationError = BadRequest | Forbidden | NotFound | ClerkOpError;
...
export const banUser: API.OperationMethod<BanUserRequest, User, BanUserError, ClerkOpContext> =
  /*@__PURE__*/ API.make(() => ({
...
export type CreateAdminPortalLinkTokenError = BadRequest | Forbidden | Conflict | ClerkOpError;
...
export type CreateAgentTaskError = BadRequest | NotFound | UnprocessableEntity | ClerkOpError;
...
export type CreateAllowlistIdentifierError = BadRequest | UnprocessableEntity | ClerkOpError;
...
export type CreateBillingPriceError = BadRequest | NotFound | UnprocessableEntity | ClerkOpError;
...
export type CreateBlocklistIdentifierError = BadRequest | UnprocessableEntity | ClerkOpError;
...
export type CreateBulkInvitationsError = BadRequest | UnprocessableEntity | ClerkOpError;
...
export type CreateBulkWaitlistEntriesError = BadRequest | UnprocessableEntity | ClerkOpError;
...
export type CreateDirectoryError = BadRequest | Forbidden | UnprocessableEntity | ClerkOpError;
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  errors: [Forbidden, NotFound, Conflict, UnprocessableEntity, UnknownClerkError],
  protocol: ClerkProtocol,
  retry: Retry.Retry,
}));

export type CreateEnterpriseConnectionTestRunError = Forbidden | NotFound | ClerkOpError;
...
export type CreateInvitationError = BadRequest | UnprocessableEntity | ClerkOpError;
...
export type CreateJWTTemplateError = BadRequest | UnprocessableEntity | ClerkOpError;
...
export type CreateMachineError = BadRequest | Forbidden | UnprocessableEntity | ClerkOpError;
...
export type CreateOrganizationError = BadRequest | Forbidden | UnprocessableEntity | ClerkOpError;
...
export type CreateRedirectURLError = BadRequest | UnprocessableEntity | ClerkOpError;
...
export type CreateSCIMDirectoryError = BadRequest | Forbidden | UnprocessableEntity | ClerkOpError;
/** Create a directory Create a new directory for the instance. */
...
export type CreateSessionError = BadRequest | NotFound | UnprocessableEntity | ClerkOpError;
...
export type CreateSignInTokenError = Forbidden | NotFound | UnprocessableEntity | ClerkOpError;
...
export type CreateUserError = BadRequest | Forbidden | UnprocessableEntity | ClerkOpError;
...
export type CreateWaitlistEntryError = BadRequest | UnprocessableEntity | ClerkOpError;
...
export type DeleteEmailAddressError = BadRequest | Forbidden | NotFound | Conflict | ClerkOpError;
...
export type DeleteEnterpriseConnectionError = Forbidden | NotFound | ClerkOpError;
...
export type DeleteExternalAccountError = BadRequest | Forbidden | NotFound | ClerkOpError;
...
export type DeleteOrganizationDomainError = BadRequest | Forbidden | NotFound | ClerkOpError;
...
export type DeleteOrganizationMembershipError = NotFound | UnprocessableEntity | ClerkOpError;
...
export type DeleteOrganizationPermissionError = Forbidden | NotFound | ClerkOpError;
...
export type DeleteOrganizationRoleError = Forbidden | NotFound | UnprocessableEntity | ClerkOpError;
...
export type DeletePhoneNumberError = BadRequest | Forbidden | NotFound | ClerkOpError;
...
export type DeleteUserWeb3WalletError = BadRequest | Forbidden | NotFound | ClerkOpError;
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: DeletedObject,
  errors: [BadRequest, NotFound, Conflict, UnprocessableEntity, UnknownClerkError],
  protocol: ClerkProtocol,
  retry: Retry.Retry,
}));
...
export type GetBillingPriceListError = BadRequest | NotFound | UnprocessableEntity | ClerkOpError;
...
export type GetBillingStatementError = BadRequest | NotFound | UnprocessableEntity | ClerkOpError;
...
export type GetBillingStatementListError = BadRequest | UnprocessableEntity | ClerkOpError;
...
export type GetCommercePlanListError = BadRequest | UnprocessableEntity | ClerkOpError;
...
export type GetCommerceSubscriptionItemListError = BadRequest | UnprocessableEntity | ClerkOpError;
...
export type GetEmailAddressError = BadRequest | Forbidden | NotFound | ClerkOpError;
...
export type GetInstanceOrganizationSettingsError = NotFound | UnprocessableEntity | ClerkOpError;
...
export const getJWKS: API.OperationMethod<GetJWKSRequest, JWKS, GetJWKSError, ClerkOpContext> =
  /*@__PURE__*/ API.make(() => ({
...
export type GetM2MTokensError = BadRequest | Forbidden | NotFound | ClerkOpError;
...
export type GetMachineSecretKeyError = BadRequest | Forbidden | NotFound | ClerkOpError;
...
export type GetOAuthAccessTokenError = BadRequest | NotFound | UnprocessableEntity | ClerkOpError;
...
export type GetOrganizationInvitationError = BadRequest | Forbidden | NotFound | ClerkOpError;
...
export type GetPhoneNumberError = BadRequest | Forbidden | NotFound | ClerkOpError;
...
export type GetSessionListError = BadRequest | UnprocessableEntity | ClerkOpError;
...
export const getUser: API.OperationMethod<GetUserRequest, User, GetUserError, ClerkOpContext> =
  /*@__PURE__*/ API.make(() => ({
...
export type ListAllOrganizationDomainsError = Forbidden | UnprocessableEntity | ClerkOpError;
...
export type ListDirectoryGroupRoleMappingsError = Forbidden | NotFound | ClerkOpError;
...
export type ListEnterpriseConnectionsError = Forbidden | UnprocessableEntity | ClerkOpError;
...
export type ListMachinesError = BadRequest | Forbidden | UnprocessableEntity | ClerkOpError;
...
export type ListOrganizationMembershipsError = UnprocessableEntity | ClerkOpError;
...
export type ListOrganizationPermissionsError = UnprocessableEntity | ClerkOpError;
...
export type ListOrganizationsError = BadRequest | Forbidden | UnprocessableEntity | ClerkOpError;
...
export type ListRoleSetsError = BadRequest | Forbidden | UnprocessableEntity | ClerkOpError;
...
export type ListSCIMGroupRoleMappingsError = Forbidden | NotFound | ClerkOpError;
...
export const lockUser: API.OperationMethod<LockUserRequest, User, LockUserError, ClerkOpContext> =
  /*@__PURE__*/ API.make(() => ({
...
export type PrepareEmailAddressVerificationError = BadRequest | Forbidden | NotFound | ClerkOpError;
...
export type PreparePhoneNumberVerificationError = BadRequest | Forbidden | NotFound | ClerkOpError;
...
export type RemoveUserPasswordError = BadRequest | Forbidden | NotFound | ClerkOpError;
...
export type ReplaceUserMetadataError = BadRequest | NotFound | UnprocessableEntity | ClerkOpError;
...
export type RevokeAdminPortalLinkTokenError = BadRequest | Forbidden | NotFound | ClerkOpError;
...
export type RevokeOrganizationInvitationError = BadRequest | Forbidden | NotFound | ClerkOpError;
...
export type RotateOAuthApplicationSecretError = Forbidden | NotFound | ClerkOpError;
...
export type UpdateEmailAddressError = BadRequest | Forbidden | NotFound | Conflict | ClerkOpError;
...
export type UpdateInstanceCommunicationError = UnprocessableEntity | ClerkOpError;
...
export type UpdateInstanceOAuthApplicationSettingsError = UnprocessableEntity | ClerkOpError;
...
export type UpdateInstanceRestrictionsError = UnprocessableEntity | ClerkOpError;
...
export type UpdateJWTTemplateError = BadRequest | UnprocessableEntity | ClerkOpError;
...
export type UpdateOrganizationMembershipError = NotFound | UnprocessableEntity | ClerkOpError;
...
export type UpdatePhoneNumberError = BadRequest | Forbidden | NotFound | ClerkOpError;
...
export type UpdateUserError = BadRequest | NotFound | Conflict | UnprocessableEntity | ClerkOpError;
...
export type UpdateUserMetadataError = BadRequest | NotFound | UnprocessableEntity | ClerkOpError;
...
export type UploadOAuthApplicationLogoError = BadRequest | Forbidden | NotFound | ClerkOpError;
...
export type UploadOrganizationLogoError = BadRequest | Forbidden | NotFound | ClerkOpError;
...
export type UsersGetOrganizationInvitationsError = BadRequest | Forbidden | NotFound | ClerkOpError;
...
export type VerifyDomainProxyError = BadRequest | UnprocessableEntity | ClerkOpError;
...
export type VerifyOrganizationDomainOwnershipError = Forbidden | NotFound | ClerkOpError;
...
export type VerifyPasswordError = BadRequest | NotFound | UnprocessableEntity | ClerkOpError;
...
export type VerifyTOTPError = BadRequest | NotFound | UnprocessableEntity | ClerkOpError;
