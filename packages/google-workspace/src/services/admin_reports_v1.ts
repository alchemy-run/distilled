...
export const ActivityEventsItemSensitiveParametersItemList = /*@__PURE__*/ S.Array(
...
export type GetCustomerUsageReportsError = NotFound | Forbidden | GoogleWorkspaceOpError;
...
export type GetEntityUsageReportsError = NotFound | Forbidden | GoogleWorkspaceOpError;
...
export type GetUserUsageReportError = NotFound | Forbidden | GoogleWorkspaceOpError;
