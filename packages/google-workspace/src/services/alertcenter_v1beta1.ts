...
export type GetMetadataAlertsError = NotFound | Forbidden | GoogleWorkspaceOpError;
...
export type GetSettingsV1beta1Error = NotFound | Forbidden | GoogleWorkspaceOpError;
