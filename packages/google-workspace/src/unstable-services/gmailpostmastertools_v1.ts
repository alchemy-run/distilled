...
export type GetDomainsTrafficStatsError = NotFound | Forbidden | GoogleWorkspaceOpError;
...
export type ListDomainsTrafficStatsError = NotFound | Forbidden | GoogleWorkspaceOpError;
