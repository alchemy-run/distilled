...
/** Included quantity properties */
export type MeterIncludedQuantityPropertiesList_2 = Array<IncludedQuantityProperty_2>;
...
export const Meter_2 = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    type: S.optional(S.String),
    includedQuantityProperties: S.optional(MeterIncludedQuantityPropertiesList_2),
  }),
...
/** Term description parameters */
export type TermTermDescriptionParametersList_2 = Array<TermDescriptionParameter_2>;
...
export const TermActionsList = /*@__PURE__*/ S.Array(S.String) as any as S.Schema<TermActionsList>;
...
export const SubscriptionStatusConstraintsRequireAnyOfList = /*@__PURE__*/ S.Array(
  S.String,
...
export type PlanDetailsPurchaseDurationDiscountsList = Array<PurchaseDurationDiscount_2>;
...
export type PrerequisitesSeatConstraintsList = Array<MinMaxPercentageSeatsConstraint>;
...
export const PlanDetails = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    purchaseDurationDiscounts: S.optional(PlanDetailsPurchaseDurationDiscountsList),
...
export type GetSkusByBillingAccountResponseProductAttributesList = Array<Attribute_2>;
export const GetSkusByBillingAccountResponseProductAttributesList = /*@__PURE__*/ S.Array(
  Attribute_2,
) as any as S.Schema<GetSkusByBillingAccountResponseProductAttributesList>;

/** The SKU attributes. */
export type GetSkusByBillingAccountResponseSkuAttributesList = Array<Attribute_2>;
export const GetSkusByBillingAccountResponseSkuAttributesList = /*@__PURE__*/ S.Array(
  Attribute_2,
...
export const GetSkusByBillingAccountResponseOfferingPropertiesList = /*@__PURE__*/ S.Array(
...
export const SkuAlternateIdsApplicableFuturePriceConcessionList = /*@__PURE__*/ S.Array(
  S.String,
...
export type ProductAlternateIdsApplicableFuturePriceConcessionList = Array<string>;
export const ProductAlternateIdsApplicableFuturePriceConcessionList = /*@__PURE__*/ S.Array(
  S.String,
...
export const SkuAlternateIds = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    applicableFuturePriceConcession: S.optional(SkuAlternateIdsApplicableFuturePriceConcessionList),
...
export const GetSkusByBillingAccountResponseCategoryIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetSkusByBillingAccountResponsePricingAudiencesList = /*@__PURE__*/ S.Array(
  S.String,
...
/** Included quantity properties */
export type MeterIncludedQuantityPropertiesList_3 = Array<IncludedQuantityProperty_2>;
...
export const Meter_3 = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    price: S.optional(Price_2),
    type: S.optional(S.String),
    includedQuantityProperties: S.optional(MeterIncludedQuantityPropertiesList_3),
  }),
...
/** Term description parameters */
export type TermTermDescriptionParametersList_3 = Array<TermDescriptionParameter_2>;
...
export type GetSkusByBillingAccountResponseAvailabilitiesList = Array<Availability_2>;
export const GetSkusByBillingAccountResponseAvailabilitiesList = /*@__PURE__*/ S.Array(
  Availability_2,
...
export const GetSkusByBillingAccountResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    productSubType: S.optional(S.String),
    summary: S.optional(S.String),
    productAttributes: S.optional(GetSkusByBillingAccountResponseProductAttributesList),
    skuName: S.String,
    skuId: S.String,
    skuType: S.String,
    language: S.String,
    ...
    offeringProperties: S.optional(GetSkusByBillingAccountResponseOfferingPropertiesList),
    alternateIds: S.optional(SkuAlternateIds),
    offeringType: S.optional(S.String),
    categoryIds: S.optional(GetSkusByBillingAccountResponseCategoryIdsList),
    pricingAudiences: S.optional(GetSkusByBillingAccountResponsePricingAudiencesList),
    availabilities: S.optional(GetSkusByBillingAccountResponseAvailabilitiesList),
  }),
).annotate({
...
/** The product attributes. */
export type GetSkusByBillingProfileResponseProductAttributesList = Array<Attribute_2>;
export const GetSkusByBillingProfileResponseProductAttributesList = /*@__PURE__*/ S.Array(
  Attribute_2,
) as any as S.Schema<GetSkusByBillingProfileResponseProductAttributesList>;

/** The SKU attributes. */
export type GetSkusByBillingProfileResponseSkuAttributesList = Array<Attribute_2>;
export const GetSkusByBillingProfileResponseSkuAttributesList = /*@__PURE__*/ S.Array(
  Attribute_2,
) as any as S.Schema<GetSkusByBillingProfileResponseSkuAttributesList>;

/** Offering properties such as: product code (UPN), term id, meter type, offering id. */
export type GetSkusByBillingProfileResponseOfferingPropertiesList = Array<OfferingProperties_2>;
export const GetSkusByBillingProfileResponseOfferingPropertiesList = /*@__PURE__*/ S.Array(
  OfferingProperties_2,
...
export const GetSkusByBillingProfileResponseCategoryIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetSkusByBillingProfileResponsePricingAudiencesList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<GetSkusByBillingProfileResponsePricingAudiencesList>;

/** Availabilities for this SKU. */
export type GetSkusByBillingProfileResponseAvailabilitiesList = Array<Availability_2>;
export const GetSkusByBillingProfileResponseAvailabilitiesList = /*@__PURE__*/ S.Array(
  Availability_2,
...
export const GetSkusByBillingProfileResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    productSubType: S.optional(S.String),
    summary: S.optional(S.String),
    productAttributes: S.optional(GetSkusByBillingProfileResponseProductAttributesList),
    skuName: S.String,
    skuId: S.String,
    skuType: S.String,
    language: S.String,
    ...
    skuProperties: S.optional(SkuProperties_2),
    offeringProperties: S.optional(GetSkusByBillingProfileResponseOfferingPropertiesList),
    alternateIds: S.optional(SkuAlternateIds),
    offeringType: S.optional(S.String),
    categoryIds: S.optional(GetSkusByBillingProfileResponseCategoryIdsList),
    pricingAudiences: S.optional(GetSkusByBillingProfileResponsePricingAudiencesList),
    availabilities: S.optional(GetSkusByBillingProfileResponseAvailabilitiesList),
  }),
).annotate({
...
export type Store = "Appsource" | "AMP" | "Ibiza" | "Cosell" | "DakotaDownstream";
...
export const Meter = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    type: S.optional(S.NullOr(S.String)),
    includedQuantityProperties: S.optional(S.NullOr(MeterIncludedQuantityPropertiesList)),
  }),
...
export const Term = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    termDescriptionParameters: S.optional(S.NullOr(TermTermDescriptionParametersList)),
    termId: S.optional(S.NullOr(S.String)),
    termUnits: S.optional(S.NullOr(S.String)),
...
/** Plan availabilities */
export type AvailabilityEntityPlanAvailabilitiesList = Array<AvailabilityEntity>;
...
export const PlanUpnsList = /*@__PURE__*/ S.Array(TermUpn) as any as S.Schema<PlanUpnsList>;
...
export const Plan = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    purchaseDurationDiscounts: S.optional(S.NullOr(PlanPurchaseDurationDiscountsList)),
...
export const DefinitionTemplatesDeploymentTemplateFileUrisMap = /*@__PURE__*/ S.Record(
  S.String,
  S.String,
...
export const DefinitionTemplatesDeploymentFragmentFileUrisMap = /*@__PURE__*/ S.Record(
  S.String,
  S.String,
...
export const CatalogItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    offerId: S.String,
    legacyId: S.String,
    determinedStorefronts: S.optional(S.NullOr(CatalogItemDeterminedStorefrontsList)),
    standardContractAmendmentsRevisionId: S.optional(S.String),
    ...
    cloudIndustryCategories: S.optional(S.NullOr(CatalogItemCloudIndustryCategoriesList)),
    ...
    marketPricingDetails: S.optional(S.NullOr(CatalogItemMarketPricingDetailsList)),
    ...
    additionalProperties: S.optional(S.NullOr(CatalogItemAdditionalPropertiesMap)),
    restrictedAudience: S.optional(S.NullOr(RestrictedAudience)),
    ...
    pbiServicePrincipalIds: S.optional(S.NullOr(CatalogItemPbiServicePrincipalIdsList)),
    ...
    autoRunLaunchEvents: S.optional(S.NullOr(CatalogItemAutoRunLaunchEventsList)),
...
export const ApiKeysValueList = /*@__PURE__*/ S.Array(ApiKey) as any as S.Schema<ApiKeysValueList>;
...
export const ListSkusByBillingAccountRequestLocationsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ListSkusByBillingAccountRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    language: S.optional(S.String.pipe(T.Query())),
    locations: S.optional(ListSkusByBillingAccountRequestLocationsList.pipe(T.Query())),
    _filter: S.optional(S.String.pipe(T.Query("$filter"))),
    _select: S.optional(S.String.pipe(T.Query("$select"))),
    _expand: S.optional(S.String.pipe(T.Query("$expand"))),
    _orderBy: S.optional(S.String.pipe(T.Query("$orderBy"))),
...
export const ListSkusByBillingProfileRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    service: S.String.pipe(T.Query()),
    language: S.optional(S.String.pipe(T.Query())),
    locations: S.optional(ListSkusByBillingProfileRequestLocationsList.pipe(T.Query())),
    _filter: S.optional(S.String.pipe(T.Query("$filter"))),
    _select: S.optional(S.String.pipe(T.Query("$select"))),
    _expand: S.optional(S.String.pipe(T.Query("$expand"))),
    _orderBy: S.optional(S.String.pipe(T.Query("$orderBy"))),
...
export type SearchPostArmRequestPricingTypesList = Array<PricingType | (string & {})>;
...
export type PrivateStoreAllow = "AllowedByAdmin" | "AllowedByDefault" | "NonAllowed";
...
>;
export const SearchPostArmRequestPrivateStoreAllowancesList = /*@__PURE__*/ S.Array(
  PrivateStoreAllow,
...
export const SearchPostArmRequestAppSourceIndustriesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const SearchPostArmRequestAppSourceCategoriesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const SearchPostArmRequestAzurePortalCategoriesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const SearchPostArmRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    privateStoreAllowances: S.optional(SearchPostArmRequestPrivateStoreAllowancesList),
    appSourceIndustries: S.optional(SearchPostArmRequestAppSourceIndustriesList),
    operatingSystems: S.optional(SearchPostArmRequestOperatingSystemsList),
    appSourceCategories: S.optional(SearchPostArmRequestAppSourceCategoriesList),
    ...
    azurePortalCategories: S.optional(SearchPostArmRequestAzurePortalCategoriesList),
