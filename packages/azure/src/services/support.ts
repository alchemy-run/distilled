...
export const CheckCommunicationNameAvailabilityRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const CheckCommunicationsNoSubscriptionNameAvailabilityRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      supportTicketName: S.String.pipe(T.Label()),
      name: S.String,
...
export const CheckSupportTicketNameAvailabilityRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    name: S.String,
    type: Type,
...
export const CheckSupportTicketsNoSubscriptionNameAvailabilityRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      name: S.String,
      type: Type,
...
export const CreateCommunicationsNoSubscriptionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    supportTicketName: S.String.pipe(T.Label()),
    communicationName: S.String.pipe(T.Label()),
    properties: CommunicationDetailsPropertiesInput,
...
export const CreateCommunicationsNoSubscriptionResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.String),
    name: S.optional(S.String),
    type: S.optional(S.String),
...
export const CreateFileWorkspacesNoSubscriptionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    fileWorkspaceName: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
...
export const CreateFileWorkspacesNoSubscriptionResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.String),
    name: S.optional(S.String),
    type: S.optional(S.String),
...
export const ContactProfile = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    additionalEmailAddresses: S.optional(ContactProfileAdditionalEmailAddressesList),
...
export const ServiceLevelAgreementInput = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const SupportTicketDetailsPropertiesInputSecondaryConsentList = /*@__PURE__*/ S.Array(
  SecondaryConsent,
...
export const SupportTicketDetailsPropertiesInput = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    secondaryConsent: S.optional(SupportTicketDetailsPropertiesInputSecondaryConsentList),
  }),
).annotate({
...
/** This property indicates secondary consents for the support ticket */
export type SupportTicketDetailsPropertiesSecondaryConsentList = Array<SecondaryConsent>;
export const SupportTicketDetailsPropertiesSecondaryConsentList = /*@__PURE__*/ S.Array(
  SecondaryConsent,
...
export const SupportTicketDetailsProperties = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    technicalTicketDetails: S.optional(TechnicalTicketDetails),
    quotaTicketDetails: S.optional(QuotaTicketDetails),
    secondaryConsent: S.optional(SupportTicketDetailsPropertiesSecondaryConsentList),
  }),
).annotate({
...
export const CreateSupportTicketsNoSubscriptionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    supportTicketName: S.String.pipe(T.Label()),
    properties: SupportTicketDetailsPropertiesInput,
  }).pipe(
...
export const CreateSupportTicketsNoSubscriptionResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.String),
    name: S.optional(S.String),
    type: S.optional(S.String),
...
export const ChatTranscriptDetailsPropertiesMessagesList = /*@__PURE__*/ S.Array(
  MessageProperties,
...
export const ProblemClassificationPropertiesSecondaryConsentEnabledList = /*@__PURE__*/ S.Array(
...
export const ProblemClassificationProperties = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    secondaryConsentEnabled: S.optional(ProblemClassificationPropertiesSecondaryConsentEnabledList),
  }),
).annotate({
...
export const UpdateContactProfileAdditionalEmailAddressesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateContactProfile = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    additionalEmailAddresses: S.optional(UpdateContactProfileAdditionalEmailAddressesList),
    phoneNumber: S.optional(S.String),
...
export const UpdateSupportTicketRequestSecondaryConsentList = /*@__PURE__*/ S.Array(
  SecondaryConsent,
...
export const UpdateSupportTicketRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    secondaryConsent: S.optional(UpdateSupportTicketRequestSecondaryConsentList),
  }).pipe(
    T.Http({
      method: "PATCH",
      uri: "/subscriptions/{subscriptionId}/providers/Microsoft.Support/supportTickets/{supportTicketName}",
...
/** This property indicates secondary consents for the support ticket */
export type UpdateSupportTicketsNoSubscriptionRequestSecondaryConsentList = Array<SecondaryConsent>;
export const UpdateSupportTicketsNoSubscriptionRequestSecondaryConsentList = /*@__PURE__*/ S.Array(
  SecondaryConsent,
...
export const UpdateSupportTicketsNoSubscriptionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    supportTicketName: S.String.pipe(T.Label()),
    severity: S.optional(SeverityLevel),
    status: S.optional(Status),
    contactDetails: S.optional(UpdateContactProfile),
    advancedDiagnosticConsent: S.optional(Consent),
    secondaryConsent: S.optional(UpdateSupportTicketsNoSubscriptionRequestSecondaryConsentList),
  }).pipe(
    T.Http({
      method: "PATCH",
      uri: "/providers/Microsoft.Support/supportTickets/{supportTicketName}",
...
export const UpdateSupportTicketsNoSubscriptionResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.String),
    name: S.optional(S.String),
    type: S.optional(S.String),
...
export type CheckCommunicationsNoSubscriptionNameAvailabilityError = AzureOpError;
/** Check the availability of a resource name. This API should be used to check the uniqueness of the name for adding a new communication to the support ticket. */
...
export type CheckSupportTicketsNoSubscriptionNameAvailabilityError = AzureOpError;
/** Check the availability of a resource name. This API should be used to check the uniqueness of the name for support ticket creation for the selected subscription. */
