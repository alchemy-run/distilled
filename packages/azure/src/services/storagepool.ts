...
export const DiskPoolCreatePropertiesAvailabilityZonesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const DiskPoolCreatePropertiesAdditionalCapabilitiesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const DiskPoolCreateProperties = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    availabilityZones: S.optional(DiskPoolCreatePropertiesAvailabilityZonesList),
...
export const DiskPoolPropertiesAdditionalCapabilitiesList = /*@__PURE__*/ S.Array(
  S.String,
...
export type SystemMetadataLastModifiedByType = "User" | "Application" | "ManagedIdentity" | "Key";
...
export const DiskPoolsDeallocateResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const IscsiTargetCreatePropertiesInputStaticAclsList = /*@__PURE__*/ S.Array(
  Acl,
...
export const ListDiskPoolOutboundNetworkDependenciesEndpointsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    diskPoolName: S.String.pipe(T.Label()),
...
export type OutboundEnvironmentEndpointListValueList = Array<OutboundEnvironmentEndpoint>;
...
export type ResourceSkuZoneDetailsCapabilitiesList = Array<ResourceSkuCapability>;
...
export const IscsiTargetUpdatePropertiesInputStaticAclsList = /*@__PURE__*/ S.Array(
  Acl,
...
export type ListDiskPoolOutboundNetworkDependenciesEndpointsError = AzureOpError;
