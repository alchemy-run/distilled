...
export type BackupRestoreOperationStatus = "InProgress" | "Succeeded" | "Failed" | "Cancelled";
...
/** The error additional info. */
export type BackupResultPropertiesErrorAdditionalInfoList = Array<ErrorAdditionalInfo>;
export const BackupResultPropertiesErrorAdditionalInfoList = /*@__PURE__*/ S.Array(
  ErrorAdditionalInfo,
...
export const CloudHsmClustersCreateOrUpdateRequestIdentity = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export type ActivationState = "NotDefined" | "NotActivated" | "Active" | "Failed" | "Unknown";
...
export const CloudHsmClusterPropertiesPrivateEndpointConnectionsList = /*@__PURE__*/ S.Array(
...
export const CloudHsmClusterProperties = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    privateEndpointConnections: S.optional(CloudHsmClusterPropertiesPrivateEndpointConnectionsList),
...
export const CloudHsmClustersCreateOrUpdateResponseIdentity = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    principalId: S.optional(S.String),
...
export const CloudHsmClustersValidateRestorePropertiesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    cloudHsmClusterName: S.String.pipe(T.Label()),
...
/** The error details. */
export type BackupRestoreBaseResultPropertiesErrorDetailsList = Array<ErrorDetail>;
export const BackupRestoreBaseResultPropertiesErrorDetailsList = /*@__PURE__*/ S.Array(
  ErrorDetail,
) as any as S.Schema<BackupRestoreBaseResultPropertiesErrorDetailsList>;

/** The error additional info. */
export type BackupRestoreBaseResultPropertiesErrorAdditionalInfoList = Array<ErrorAdditionalInfo>;
export const BackupRestoreBaseResultPropertiesErrorAdditionalInfoList = /*@__PURE__*/ S.Array(
  ErrorAdditionalInfo,
...
export const BackupRestoreBaseResultPropertiesError = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    additionalInfo: S.optional(BackupRestoreBaseResultPropertiesErrorAdditionalInfoList),
  }),
).annotate({
...
export const CreateCloudHsmClusterPrivateEndpointConnectionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    cloudHsmClusterName: S.String.pipe(T.Label()),
...
export const CreateCloudHsmClusterPrivateEndpointConnectionResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.String),
    name: S.optional(S.String),
    type: S.optional(S.String),
...
export const DedicatedHsmCreateOrUpdateResponseZonesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const DeleteCloudHsmClusterResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const DeleteCloudHsmClusterPrivateEndpointConnectionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    cloudHsmClusterName: S.String.pipe(T.Label()),
...
export const DeleteCloudHsmClusterPrivateEndpointConnectionResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export const DeleteDedicatedHsmResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const GetCloudHsmClusterResponseIdentityUserAssignedIdentitiesMap = /*@__PURE__*/ S.Record(
  S.String,
  S.NullOr(UserAssignedIdentity),
...
export const GetCloudHsmClusterResponseIdentity = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    tenantId: S.optional(S.String),
    type: ManagedServiceIdentityType,
    userAssignedIdentities: S.optional(GetCloudHsmClusterResponseIdentityUserAssignedIdentitiesMap),
  }),
).annotate({
...
export const GetCloudHsmClusterPrivateEndpointConnectionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    cloudHsmClusterName: S.String.pipe(T.Label()),
...
export const GetCloudHsmClusterPrivateEndpointConnectionResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.String),
    name: S.optional(S.String),
    type: S.optional(S.String),
...
export const ListCloudHsmClusterByResourceGroupRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
...
export const CloudHsmClusterIdentityUserAssignedIdentitiesMap = /*@__PURE__*/ S.Record(
  S.String,
  S.NullOr(UserAssignedIdentity),
...
export const ListCloudHsmClusterPrivateLinkResourceByCloudHsmClusterRequest =
  /*@__PURE__*/ S.suspend(() =>
    ...
    identifier: "ListCloudHsmClusterPrivateLinkResourceByCloudHsmClusterRequest",
...
export const ListCloudHsmClusterPrivateLinkResourceByCloudHsmClusterResponse =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      value: S.optional(ListCloudHsmClusterPrivateLinkResourceByCloudHsmClusterResponseValueList),
      nextLink: S.optional(S.String),
    }),
  ).annotate({
    identifier: "ListCloudHsmClusterPrivateLinkResourceByCloudHsmClusterResponse",
...
export const ListDedicatedHsmOutboundNetworkDependenciesEndpointsRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      subscriptionId: S.String.pipe(T.Label()),
      resourceGroupName: S.String.pipe(T.Label()),
...
export const ListPrivateEndpointConnectionByCloudHsmClusterRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    cloudHsmClusterName: S.String.pipe(T.Label()),
...
export const UpdateCloudHsmClusterRequestIdentityUserAssignedIdentitiesMap = /*@__PURE__*/ S.Record(
  S.String,
  S.NullOr(UserAssignedIdentityInput),
...
export const ValidateCloudHsmClusterBackupPropertiesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    cloudHsmClusterName: S.String.pipe(T.Label()),
...
export type ListCloudHsmClusterPrivateLinkResourceByCloudHsmClusterError = AzureOpError;
...
export type ListDedicatedHsmOutboundNetworkDependenciesEndpointsError = AzureOpError;
