...
export type EncryptionKeyDetailsKekType = "MicrosoftManaged" | "CustomerManaged";
...
export const GetJob: API.OperationMethod<GetJobRequest, JobResponse, GetJobError, AzureOpContext> =
  /*@__PURE__*/ API.make(() => ({
    input: GetJobRequest,
    output: JobResponse,
    errors: [UnknownAzureError],
