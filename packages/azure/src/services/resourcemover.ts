...
export const CommitMoveCollectionRequestMoveResourcesList = /*@__PURE__*/ S.Array(
  S.String,
...
/** The additional info. */
export type OperationStatusErrorAdditionalInfoList = Array<OperationErrorAdditionalInfo>;
...
export const MoveResourcePropertiesInputDependsOnOverridesList = /*@__PURE__*/ S.Array(
...
export const MoveResourcePropertiesInput = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    dependsOnOverrides: S.optional(MoveResourcePropertiesInputDependsOnOverridesList),
  }),
).annotate({
...
/** Gets or sets the move resource dependencies overrides. */
export type MoveResourcePropertiesDependsOnOverridesList = Array<MoveResourceDependencyOverride>;
export const MoveResourcePropertiesDependsOnOverridesList = /*@__PURE__*/ S.Array(
  MoveResourceDependencyOverride,
...
export const MoveResourceProperties = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    dependsOnOverrides: S.optional(MoveResourcePropertiesDependsOnOverridesList),
...
export type GetUnresolvedDependencyRequestDependencyLevel = "Direct" | "Descendant";
...
export interface GetUnresolvedDependencyRequest {
  ...
  dependencyLevel?: GetUnresolvedDependencyRequestDependencyLevel | (string & {});
...
export const GetUnresolvedDependencyRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    resourceGroupName: S.String.pipe(T.Label()),
    moveCollectionName: S.String.pipe(T.Label()),
    dependencyLevel: S.optional(GetUnresolvedDependencyRequestDependencyLevel.pipe(T.Query())),
...
export const RequiredForResourcesCollectionSourceIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const MoveCollectionsBulkRemoveRequestMoveResourcesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const MoveCollectionsBulkRemoveRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    moveCollectionName: S.String.pipe(T.Label()),
    validateOnly: S.optional(S.Boolean),
    moveResources: S.optional(MoveCollectionsBulkRemoveRequestMoveResourcesList),
    moveResourceInputType: S.optional(MoveResourceInputType),
  }).pipe(
    T.Http({
      method: "POST",
...
export const MoveCollectionsDiscardRequestMoveResourcesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const MoveCollectionsInitiateMoveRequestMoveResourcesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const MoveCollectionsListMoveCollectionsByResourceGroupRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      subscriptionId: S.String.pipe(T.Label()),
      resourceGroupName: S.String.pipe(T.Label()),
...
export const MoveCollectionsListMoveCollectionsBySubscriptionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
...
export const MoveCollectionsPrepareRequestMoveResourcesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const MoveCollectionsResolveDependenciesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    moveCollectionName: S.String.pipe(T.Label()),
...
export type MoveCollectionsListMoveCollectionsByResourceGroupError = AzureOpError;
...
export type MoveCollectionsListMoveCollectionsBySubscriptionError = AzureOpError;
