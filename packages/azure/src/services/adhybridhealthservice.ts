...
export const AddAddsServiceRequestCustomNotificationEmailsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const AddAddsServiceRequestNotificationEmailsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const AddAddsServiceRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    customNotificationEmails: S.optional(AddAddsServiceRequestCustomNotificationEmailsList),
...
export const ServicePropertiesCustomNotificationEmailsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ServiceProperties = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    additionalInformation: S.optional(S.String),
    createdDate: S.optional(S.String),
    customNotificationEmails: S.optional(ServicePropertiesCustomNotificationEmailsList),
    disabled: S.optional(S.Boolean),
    displayName: S.optional(S.String),
    health: S.optional(S.String),
    lastDisabled: S.optional(S.String),
...
export type AddAddsServicesServiceMemberRequestServerReportedMonitoringLevel =
  ...
  | "Full"
  | "Off";
export const AddAddsServicesServiceMemberRequestServerReportedMonitoringLevel = S.String;
...
/** The monitoring level reported by the server. */
export type ServiceMemberServerReportedMonitoringLevel = "Partial" | "Full" | "Off";
...
export const ServiceMember = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    resolvedAlerts: S.optional(S.Number),
    role: S.optional(S.String),
    serverReportedMonitoringLevel: S.optional(ServiceMemberServerReportedMonitoringLevel),
    status: S.optional(S.String),
  }),
...
export const AddAddsServicesUserPreferenceRequestMetricNamesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const AddAddsServicesUserPreferenceRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    metricNames: S.optional(AddAddsServicesUserPreferenceRequestMetricNamesList),
  }).pipe(
    T.Http({
      method: "POST",
...
export const AddServiceRequestCustomNotificationEmailsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const AddServiceRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    additionalInformation: S.optional(S.String),
    createdDate: S.optional(S.String),
    customNotificationEmails: S.optional(AddServiceRequestCustomNotificationEmailsList),
    disabled: S.optional(S.Boolean),
    displayName: S.optional(S.String),
    health: S.optional(S.String),
    lastDisabled: S.optional(S.String),
...
/** The monitoring level reported by the server. */
export type AddServiceMemberRequestServerReportedMonitoringLevel = "Partial" | "Full" | "Off";
...
export const AddServiceMemberRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    resolvedAlerts: S.optional(S.Number),
    role: S.optional(S.String),
    serverReportedMonitoringLevel: S.optional(AddServiceMemberRequestServerReportedMonitoringLevel),
    status: S.optional(S.String),
  }).pipe(
    T.Http({
      method: "POST",
...
export const DeleteServiceMemberResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const GetAddsServiceMetricMetadataForGroupRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    serviceName: S.String.pipe(T.Label()),
    metricName: S.String.pipe(T.Label()),
...
export const GetServiceMemberServiceConfigurationRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    serviceName: S.String.pipe(T.Label()),
    serviceMemberId: S.String.pipe(T.Label()),
  }).pipe(
...
export interface ListAdDomainServiceMembersRequest {
  ...
  nextPartitionKey: ListAdDomainServiceMembersRequestNextPartitionKey | (string & {});
...
export const ListAdDomainServiceMembersRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    nextPartitionKey: ListAdDomainServiceMembersRequestNextPartitionKey.pipe(T.Query()),
...
export const AddsServiceMemberMonitoringConfigurationsComputedList = /*@__PURE__*/ S.Array(
  Item,
) as any as S.Schema<AddsServiceMemberMonitoringConfigurationsComputedList>;

/** The customized monitoring configuration of the server which determines what activities are monitored by Azure Active Directory Connect Health. */
export type AddsServiceMemberMonitoringConfigurationsCustomizedList = Array<Item>;
export const AddsServiceMemberMonitoringConfigurationsCustomizedList = /*@__PURE__*/ S.Array(
  Item,
...
/** The monitoring level reported by the server. */
export type AddsServiceMemberServerReportedMonitoringLevel = "Partial" | "Full" | "Off";
...
export const MetricsValueList = /*@__PURE__*/ S.Array(Item) as any as S.Schema<MetricsValueList>;
...
export type ReplicationSummaryInboundNeighborCollectionList = Array<InboundReplicationNeighbor>;
export const ReplicationSummaryInboundNeighborCollectionList = /*@__PURE__*/ S.Array(
...
export interface ListAddsServiceReplicationSummaryRequest {
  ...
  query: string;
  /** The next partition key to query for. */
  nextPartitionKey: ListAddsServiceReplicationSummaryRequestNextPartitionKey | (string & {});
  /** The next row key to query for. */
  nextRowKey: ListAddsServiceReplicationSummaryRequestNextRowKey | (string & {});
  /** The take count , which specifies the number of elements that can be returned from a sequence. */
  takeCount?: number;
}
export const ListAddsServiceReplicationSummaryRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    nextPartitionKey: ListAddsServiceReplicationSummaryRequestNextPartitionKey.pipe(T.Query()),
    nextRowKey: ListAddsServiceReplicationSummaryRequestNextRowKey.pipe(T.Query()),
    takeCount: S.optional(S.Number.pipe(T.Query())),
  }).pipe(
    T.Http({
      method: "GET",
...
export const AlertsValueList = /*@__PURE__*/ S.Array(Alert) as any as S.Schema<AlertsValueList>;
...
export const ListConfigurationAddsConfigurationsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    serviceName: S.String.pipe(T.Label()),
...
/** The health status for the domain controller. */
export type DimensionHealth = "Healthy" | "Warning" | "Error" | "NotMonitored" | "Missing";
...
export const ListServiceMemberGlobalConfigurationRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    serviceName: S.String.pipe(T.Label()),
    serviceMemberId: S.String.pipe(T.Label()),
  }).pipe(
...
export const ListServiceMonitoringConfigurationsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    serviceName: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
...
export const ItemsValueList = /*@__PURE__*/ S.Array(Item) as any as S.Schema<ItemsValueList>;
...
export const ServicesListAllRiskyIpDownloadReportRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    serviceName: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
...
export const ServicesListCurrentRiskyIpDownloadReportRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    serviceName: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
...
/** The list of additional emails that are configured to receive notifications about the service. */
export type UpdateAddsServiceRequestCustomNotificationEmailsList = Array<string>;
export const UpdateAddsServiceRequestCustomNotificationEmailsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateAddsServiceRequestNotificationEmailsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateAddsServiceRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    additionalInformation: S.optional(S.String),
    createdDate: S.optional(S.String),
    customNotificationEmails: S.optional(UpdateAddsServiceRequestCustomNotificationEmailsList),
    disabled: S.optional(S.Boolean),
    displayName: S.optional(S.String),
    health: S.optional(S.String),
    lastDisabled: S.optional(S.String),
    ...
    notificationEmailEnabledForGlobalAdmins: S.optional(S.Boolean),
    notificationEmailsEnabledForGlobalAdmins: S.optional(S.Boolean),
    notificationEmails: S.optional(UpdateAddsServiceRequestNotificationEmailsList),
    originalDisabledState: S.optional(S.Boolean),
    resolvedAlerts: S.optional(S.Number),
    serviceId: S.optional(S.String),
    signature: S.optional(S.String),
...
export const UpdateConfigurationRequestGlobalAdminsEmailList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateConfigurationRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    disabled: S.optional(S.Boolean),
    disabledReason: S.optional(S.Number),
    globalAdminsEmail: S.optional(UpdateConfigurationRequestGlobalAdminsEmailList),
    initialDomain: S.optional(S.String),
    lastDisabled: S.optional(S.String),
    lastVerified: S.optional(S.String),
    onboardingAllowed: S.optional(S.Boolean),
...
export const UpdateServiceRequestCustomNotificationEmailsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateServiceRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    additionalInformation: S.optional(S.String),
    createdDate: S.optional(S.String),
    customNotificationEmails: S.optional(UpdateServiceRequestCustomNotificationEmailsList),
    disabled: S.optional(S.Boolean),
    displayName: S.optional(S.String),
    health: S.optional(S.String),
    lastDisabled: S.optional(S.String),
...
export const UpdateServiceMonitoringConfigurationRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    serviceName: S.String.pipe(T.Label()),
    key: S.optional(S.String),
    value: S.optional(S.String),
...
export const UpdateServiceMonitoringConfigurationResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
