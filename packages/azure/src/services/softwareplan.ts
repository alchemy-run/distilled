...
export const DeleteHybridUseBenefitResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const RegisterSoftwarePlanResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
