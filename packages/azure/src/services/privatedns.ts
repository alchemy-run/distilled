...
export const PrivateZonePropertiesInput = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const VirtualNetworkLinksCreateOrUpdateResponseTagsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.String,
