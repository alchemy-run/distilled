...
export const CreateOuContainerResponseSystemData = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    lastModifiedByType: S.optional(CreateOuContainerResponseSystemDataLastModifiedByType),
...
export const DeleteDomainServiceResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const DomainServicePropertiesInputReplicaSetsList = /*@__PURE__*/ S.Array(
  ReplicaSetInput,
...
export type DomainSecuritySettingsSyncKerberosPasswords = "Enabled" | "Disabled";
...
export type DomainSecuritySettingsKerberosRc4Encryption = "Enabled" | "Disabled";
...
export interface DomainSecuritySettings {
  ...
  /** A flag to determine whether or not SyncKerberosPasswords is enabled or disabled. */
  syncKerberosPasswords?: DomainSecuritySettingsSyncKerberosPasswords | (string & {});
  /** A flag to determine whether or not SyncOnPremPasswords is enabled or disabled. */
  syncOnPremPasswords?: DomainSecuritySettingsSyncOnPremPasswords | (string & {});
  /** A flag to determine whether or not KerberosRc4Encryption is enabled or disabled. */
  kerberosRc4Encryption?: DomainSecuritySettingsKerberosRc4Encryption | (string & {});
  /** A flag to determine whether or not KerberosArmoring is enabled or disabled. */
...
export const DomainSecuritySettings = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    syncKerberosPasswords: S.optional(DomainSecuritySettingsSyncKerberosPasswords),
    syncOnPremPasswords: S.optional(DomainSecuritySettingsSyncOnPremPasswords),
    kerberosRc4Encryption: S.optional(DomainSecuritySettingsKerberosRc4Encryption),
...
export const NotificationSettingsAdditionalRecipientsList = /*@__PURE__*/ S.Array(
  S.String,
...
export type ConfigDiagnosticsValidatorResultIssueDescriptionParamsList = Array<string>;
export const ConfigDiagnosticsValidatorResultIssueDescriptionParamsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ConfigDiagnosticsValidatorResultIssue = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.String),
    descriptionParams: S.optional(ConfigDiagnosticsValidatorResultIssueDescriptionParamsList),
  }),
).annotate({
...
export type ConfigDiagnosticsValidatorResultsList = Array<ConfigDiagnosticsValidatorResult>;
...
export type DomainServicesCreateOrUpdateResponseSystemDataCreatedByType =
  ...
  | "ManagedIdentity"
  | "Key";
export const DomainServicesCreateOrUpdateResponseSystemDataCreatedByType = S.String;
...
export type DomainServicesCreateOrUpdateResponseSystemDataLastModifiedByType =
  ...
  | "ManagedIdentity"
  | "Key";
export const DomainServicesCreateOrUpdateResponseSystemDataLastModifiedByType = S.String;
...
export const DomainServicesCreateOrUpdateResponseSystemData = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    createdBy: S.optional(S.String),
    createdByType: S.optional(DomainServicesCreateOrUpdateResponseSystemDataCreatedByType),
    createdAt: S.optional(S.String),
    lastModifiedBy: S.optional(S.String),
...
export const ReplicaSet = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    subnetId: S.optional(S.String),
    domainControllerIpAddress: S.optional(ReplicaSetDomainControllerIpAddressList),
...
export const GetDomainServiceResponseSystemData = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    createdAt: S.optional(S.String),
    lastModifiedBy: S.optional(S.String),
    lastModifiedByType: S.optional(GetDomainServiceResponseSystemDataLastModifiedByType),
    lastModifiedAt: S.optional(S.String),
  }),
).annotate({
...
export const GetOuContainerResponseSystemData = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    createdAt: S.optional(S.String),
    lastModifiedBy: S.optional(S.String),
    lastModifiedByType: S.optional(GetOuContainerResponseSystemDataLastModifiedByType),
    lastModifiedAt: S.optional(S.String),
  }),
).annotate({
...
/** The type of identity that created the resource. */
export type OuContainerSystemDataCreatedByType = "User" | "Application" | "ManagedIdentity" | "Key";
...
export const UpdateDomainServiceResponseSystemData = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    createdBy: S.optional(S.String),
    createdByType: S.optional(UpdateDomainServiceResponseSystemDataCreatedByType),
    createdAt: S.optional(S.String),
    lastModifiedBy: S.optional(S.String),
    lastModifiedByType: S.optional(UpdateDomainServiceResponseSystemDataLastModifiedByType),
    lastModifiedAt: S.optional(S.String),
  }),
).annotate({
...
export const UpdateOuContainerResponseSystemData = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    createdAt: S.optional(S.String),
    lastModifiedBy: S.optional(S.String),
    lastModifiedByType: S.optional(UpdateOuContainerResponseSystemDataLastModifiedByType),
    lastModifiedAt: S.optional(S.String),
  }),
).annotate({
