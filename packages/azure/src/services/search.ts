...
export interface PrivateEndpointConnectionProperties {
  ...
  groupId?: string;
  /** The provisioning state of the private link service connection. Valid values are Updating, Deleting, Failed, Succeeded, Incomplete, or Canceled. */
  provisioningState?: PrivateLinkServiceConnectionProvisioningState | (string & {});
}
export const PrivateEndpointConnectionProperties = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    provisioningState: S.optional(PrivateLinkServiceConnectionProvisioningState),
  }),
).annotate({
...
export const SearchServicePropertiesDataExfiltrationProtectionsList = /*@__PURE__*/ S.Array(
...
export const SearchServicePropertiesPrivateEndpointConnectionsList = /*@__PURE__*/ S.Array(
...
export interface SharedPrivateLinkResourceProperties {
  ...
  /** The provisioning state of the shared private link resource. Valid values are Updating, Deleting, Failed, Succeeded or Incomplete. */
  provisioningState?: SharedPrivateLinkResourceProvisioningState | (string & {});
}
...
export const SearchServicePropertiesSharedPrivateLinkResourcesList = /*@__PURE__*/ S.Array(
...
export const SearchServiceProperties = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    dataExfiltrationProtections: S.optional(SearchServicePropertiesDataExfiltrationProtectionsList),
    ...
    privateEndpointConnections: S.optional(SearchServicePropertiesPrivateEndpointConnectionsList),
    sharedPrivateLinkResources: S.optional(SearchServicePropertiesSharedPrivateLinkResourcesList),
...
export const ListNetworkSecurityPerimeterConfigurationByServiceRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      subscriptionId: S.String.pipe(T.Label()),
      resourceGroupName: S.String.pipe(T.Label()),
...
export type OperationListResultValueItemOrigin = "user" | "system" | "user,system";
...
export const ListSharedPrivateLinkResourceByServiceRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    searchServiceName: S.String.pipe(T.Label()),
...
export type SharedPrivateLinkResourceListResultValueList = Array<SharedPrivateLinkResource>;
export const SharedPrivateLinkResourceListResultValueList = /*@__PURE__*/ S.Array(
  SharedPrivateLinkResource,
...
>;
export const SearchServicePropertiesInputDataExfiltrationProtectionsList = /*@__PURE__*/ S.Array(
  SearchDataExfiltrationProtection,
...
export interface SearchServicePropertiesInput {
  ...
  /** This value can be set to 'Enabled' to avoid breaking changes on existing customer resources and templates. If set to 'Disabled', traffic over public interface is not allowed, and private endpoint connections would be the exclusive access method. */
  publicNetworkAccess?: SearchServicePropertiesInputPublicNetworkAccess | (string & {});
  /** Network specific rules that determine how the Azure AI Search service may be reached. */
  networkRuleSet?: NetworkRuleSet;
  /** A list of data exfiltration scenarios that are explicitly disallowed for the search service. Currently, the only supported value is 'All' to disable all possible data export scenarios with more fine grained controls planned for the future. */
...
export const SearchServicePropertiesInput = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    computeType: S.optional(ComputeType),
    publicNetworkAccess: S.optional(SearchServicePropertiesInputPublicNetworkAccess),
    networkRuleSet: S.optional(NetworkRuleSet),
...
export const SharedPrivateLinkResourcesCreateOrUpdateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    searchServiceName: S.String.pipe(T.Label()),
...
export const SharedPrivateLinkResourcesCreateOrUpdateResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.String),
    name: S.optional(S.String),
    type: S.optional(S.String),
...
export type ListNetworkSecurityPerimeterConfigurationByServiceError = AzureOpError;
