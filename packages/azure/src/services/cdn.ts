...
export const AbortProfilesMigrationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export type AFDProfilesUpgradeRequestWafMappingListList = Array<ProfileChangeSkuWafMapping>;
export const AFDProfilesUpgradeRequestWafMappingListList = /*@__PURE__*/ S.Array(
...
export const AFDProfilesUpgradeResponseIdentityUserAssignedIdentitiesMap = /*@__PURE__*/ S.Record(
  S.String,
...
export const AFDProfilesUpgradeResponseIdentity = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    type: ManagedServiceIdentityType,
    userAssignedIdentities: S.optional(AFDProfilesUpgradeResponseIdentityUserAssignedIdentitiesMap),
  }),
).annotate({
...
export interface CheckAFDProfileEndpointNameAvailabilityRequest {
  ...
  /** Indicates the endpoint name reuse scope. The default value is TenantReuse. */
  autoGeneratedDomainNameLabelScope?: AutoGeneratedDomainNameLabelScope | (string & {});
}
export const CheckAFDProfileEndpointNameAvailabilityRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    profileName: S.String.pipe(T.Label()),
...
export const CheckAFDProfileHostNameAvailabilityRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    profileName: S.String.pipe(T.Label()),
...
export const CheckNameAvailabilityWithSubscriptionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    name: S.String,
    type: ResourceType,
...
export type AfdCipherSuiteSetType = "Customized" | "TLS10_2019" | "TLS12_2022" | "TLS12_2023";
...
export type AFDDomainHttpsCustomizedCipherSuiteSetCipherSuiteSetForTls12List = Array<
...
export type AfdCustomizedCipherSuiteForTls13 = "TLS_AES_128_GCM_SHA256" | "TLS_AES_256_GCM_SHA384";
...
export type AFDDomainHttpsCustomizedCipherSuiteSetCipherSuiteSetForTls13List = Array<
...
export type AFDDomainHttpsParametersServerTlsGroupsList = Array<AfdServerTlsGroup | (string & {})>;
export const AFDDomainHttpsParametersServerTlsGroupsList = /*@__PURE__*/ S.Array(
  AfdServerTlsGroup,
...
export const AFDDomainHttpsParameters = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    customizedCipherSuiteSet: S.optional(AFDDomainHttpsCustomizedCipherSuiteSet),
...
export type AFDOriginPropertiesInputCustomCertificateSubjectsList = Array<string>;
export const AFDOriginPropertiesInputCustomCertificateSubjectsList = /*@__PURE__*/ S.Array(
  S.String,
...
export interface AFDOriginPropertiesInput {
  ...
  certificateNameCheckValidationMode?: CertificateNameCheckValidationMode | (string & {});
  /** The list of custom certificate subjects to validate against. Only applicable when certificateNameCheckValidationMode is 'CustomCertificateSubject'. Must contain 1 or 2 entries. */
...
export const AFDOriginPropertiesCustomCertificateSubjectsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const AFDOriginProperties = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    enforceCertificateNameCheck: S.optional(S.Boolean),
    certificateNameCheckValidationMode: S.optional(CertificateNameCheckValidationMode),
    customCertificateSubjects: S.optional(AFDOriginPropertiesCustomCertificateSubjectsList),
    provisioningState: S.optional(AfdProvisioningState),
    deploymentStatus: S.optional(DeploymentStatus),
  }),
).annotate({
...
export type OriginAuthenticationTokenDestinationHeader = "Authorization" | "X-Azure-Authorization";
...
export interface OriginAuthenticationProperties {
  ...
  tokenDestinationHeader?: OriginAuthenticationTokenDestinationHeader | (string & {});
}
export const OriginAuthenticationProperties = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    tokenDestinationHeader: S.optional(OriginAuthenticationTokenDestinationHeader),
  }),
).annotate({
...
export const CustomDomainProperties = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    customHttpsProvisioningSubstate: S.optional(CustomHttpsProvisioningSubstate),
...
export const EndpointPropertiesInputContentTypesToCompressList = /*@__PURE__*/ S.Array(
  S.String,
...
export type EndpointPropertiesUpdateParametersDeliveryPolicyRulesList = Array<DeliveryRule>;
export const EndpointPropertiesUpdateParametersDeliveryPolicyRulesList = /*@__PURE__*/ S.Array(
  DeliveryRule,
...
export const EndpointPropertiesUpdateParametersDeliveryPolicy = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export type EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLink = ResourceReference;
export const EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLink = ResourceReference;
...
export type DeepCreatedOriginGroupPropertiesOriginsList = Array<ResourceReference>;
export const DeepCreatedOriginGroupPropertiesOriginsList = /*@__PURE__*/ S.Array(
  ResourceReference,
...
export const ResponseBasedOriginErrorDetectionParametersHttpErrorRangesList = /*@__PURE__*/ S.Array(
...
export interface ResponseBasedOriginErrorDetectionParameters {
  /** Type of response errors for real user requests for which origin will be deemed unhealthy */
  responseBasedDetectedErrorTypes?: ResponseBasedDetectedErrorTypes | (string & {});
...
export const ResponseBasedOriginErrorDetectionParameters = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    responseBasedDetectedErrorTypes: S.optional(ResponseBasedDetectedErrorTypes),
    responseBasedFailoverThresholdPercentage: S.optional(S.Number),
    httpErrorRanges: S.optional(ResponseBasedOriginErrorDetectionParametersHttpErrorRangesList),
  }),
).annotate({
...
export interface EndpointPropertiesInput {
  ...
  /** Defines how CDN caches requests that include query strings. You can ignore any query strings when caching, bypass caching to prevent requests that contain query strings from being cached, or cache every request with a unique URL. */
  queryStringCachingBehavior?: EndpointPropertiesInputQueryStringCachingBehavior | (string & {});
...
export const EndpointPropertiesInput = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    contentTypesToCompress: S.optional(EndpointPropertiesInputContentTypesToCompressList),
    originHostHeader: S.optional(S.String),
    isCompressionEnabled: S.optional(S.Boolean),
    isHttpAllowed: S.optional(S.Boolean),
    isHttpsAllowed: S.optional(S.Boolean),
    queryStringCachingBehavior: S.optional(EndpointPropertiesInputQueryStringCachingBehavior),
    ...
    deliveryPolicy: S.optional(EndpointPropertiesUpdateParametersDeliveryPolicy),
...
export const EndpointPropertiesContentTypesToCompressList = /*@__PURE__*/ S.Array(
  S.String,
...
export const EndpointProperties = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    originPath: S.optional(S.String),
    contentTypesToCompress: S.optional(EndpointPropertiesContentTypesToCompressList),
    originHostHeader: S.optional(S.String),
    isCompressionEnabled: S.optional(S.Boolean),
    isHttpAllowed: S.optional(S.Boolean),
    isHttpsAllowed: S.optional(S.Boolean),
    queryStringCachingBehavior: S.optional(EndpointPropertiesQueryStringCachingBehavior),
    optimizationType: S.optional(OptimizationType),
    probePath: S.optional(S.String),
...
export type OriginProvisioningState = "Succeeded" | "Failed" | "Updating" | "Deleting" | "Creating";
...
export const CreateProfileRequestIdentityUserAssignedIdentitiesMap = /*@__PURE__*/ S.Record(
  S.String,
...
export const CreateProfileRequestIdentity = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    type: ManagedServiceIdentityType,
    userAssignedIdentities: S.optional(CreateProfileRequestIdentityUserAssignedIdentitiesMap),
  }),
).annotate({
...
export const CreateProfileResponseIdentityUserAssignedIdentitiesMap = /*@__PURE__*/ S.Record(
  S.String,
  S.NullOr(UserAssignedIdentity),
...
export const CreateProfileResponseIdentity = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    tenantId: S.optional(S.String),
    type: ManagedServiceIdentityType,
    userAssignedIdentities: S.optional(CreateProfileResponseIdentityUserAssignedIdentitiesMap),
  }),
).annotate({
...
export const CompressionSettingsContentTypesToCompressList = /*@__PURE__*/ S.Array(
  S.String,
...
export type RoutePropertiesInputForwardingProtocol = "HttpOnly" | "HttpsOnly" | "MatchRequest";
...
/** Domains referenced by this endpoint. */
export type RoutePropertiesCustomDomainsList = Array<ActivatedResourceReference>;
...
/** Protocol this rule will use when forwarding traffic to backends. */
export type RoutePropertiesForwardingProtocol = "HttpOnly" | "HttpsOnly" | "MatchRequest";
...
export interface RulePropertiesInput {
  ...
  /** If this rule is a match should the rules engine continue running the remaining rules or stop. If not present, defaults to Continue. */
  matchProcessingBehavior?: RulePropertiesInputMatchProcessingBehavior | (string & {});
}
...
/** If this rule is a match should the rules engine continue running the remaining rules or stop. If not present, defaults to Continue. */
export type BatchRulePropertiesInputMatchProcessingBehavior = "Continue" | "Stop";
...
export interface BatchRulePropertiesInput {
  ...
  /** If this rule is a match should the rules engine continue running the remaining rules or stop. If not present, defaults to Continue. */
  matchProcessingBehavior?: BatchRulePropertiesInputMatchProcessingBehavior | (string & {});
}
...
export const DeleteAFDCustomDomainResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const DeleteAFDOriginGroupResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const EndpointsLoadContentRequestContentPathsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const EndpointsLoadContentResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const GetLogAnalyticsLogAnalyticsLocationsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    profileName: S.String.pipe(T.Label()),
...
export type ContinentsResponseContinentsList = Array<ContinentsResponseContinentsItem>;
...
export type ContinentsResponseCountryOrRegionsList = Array<ContinentsResponseCountryOrRegionsItem>;
...
>;
export const GetLogAnalyticsLogAnalyticsMetricsRequestMetricsList = /*@__PURE__*/ S.Array(
...
export type GetLogAnalyticsLogAnalyticsMetricsRequestGranularity = "PT5M" | "PT1H" | "P1D";
...
>;
export const GetLogAnalyticsLogAnalyticsMetricsRequestGroupByList = /*@__PURE__*/ S.Array(
...
export type GetLogAnalyticsLogAnalyticsMetricsRequestContinentsList = Array<string>;
export const GetLogAnalyticsLogAnalyticsMetricsRequestContinentsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<GetLogAnalyticsLogAnalyticsMetricsRequestContinentsList>;

export type GetLogAnalyticsLogAnalyticsMetricsRequestCountryOrRegionsList = Array<string>;
export const GetLogAnalyticsLogAnalyticsMetricsRequestCountryOrRegionsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<GetLogAnalyticsLogAnalyticsMetricsRequestCountryOrRegionsList>;

export type GetLogAnalyticsLogAnalyticsMetricsRequestCustomDomainsList = Array<string>;
export const GetLogAnalyticsLogAnalyticsMetricsRequestCustomDomainsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<GetLogAnalyticsLogAnalyticsMetricsRequestCustomDomainsList>;

export type GetLogAnalyticsLogAnalyticsMetricsRequestProtocolsList = Array<string>;
export const GetLogAnalyticsLogAnalyticsMetricsRequestProtocolsList = /*@__PURE__*/ S.Array(
  S.String,
...
export interface GetLogAnalyticsLogAnalyticsMetricsRequest {
  ...
  dateTimeEnd: string;
  granularity: GetLogAnalyticsLogAnalyticsMetricsRequestGranularity | (string & {});
...
export const GetLogAnalyticsLogAnalyticsMetricsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    profileName: S.String.pipe(T.Label()),
    metrics: GetLogAnalyticsLogAnalyticsMetricsRequestMetricsList.pipe(T.Query()),
    dateTimeBegin: S.String.pipe(T.Query()),
    dateTimeEnd: S.String.pipe(T.Query()),
    granularity: GetLogAnalyticsLogAnalyticsMetricsRequestGranularity.pipe(T.Query()),
    groupBy: S.optional(GetLogAnalyticsLogAnalyticsMetricsRequestGroupByList.pipe(T.Query())),
    continents: S.optional(GetLogAnalyticsLogAnalyticsMetricsRequestContinentsList.pipe(T.Query())),
    countryOrRegions: S.optional(
      GetLogAnalyticsLogAnalyticsMetricsRequestCountryOrRegionsList.pipe(T.Query()),
    ),
    customDomains: GetLogAnalyticsLogAnalyticsMetricsRequestCustomDomainsList.pipe(T.Query()),
    protocols: GetLogAnalyticsLogAnalyticsMetricsRequestProtocolsList.pipe(T.Query()),
  }).pipe(
    T.Http({
      method: "GET",
...
export type MetricsSeriesUnit = "count" | "bytes" | "bitsPerSecond" | "milliSeconds";
...
export type MetricsResponseSeriesItemGroupsList = Array<MetricsResponseSeriesPropertiesItemsItem>;
...
export const Components1Gs0LlpSchemasMetricsresponsePropertiesSeriesItemsPropertiesDataItems =
  /*@__PURE__*/ S.suspend(() =>
    ...
    identifier: "Components1Gs0LlpSchemasMetricsresponsePropertiesSeriesItemsPropertiesDataItems",
...
>;
export const GetLogAnalyticsLogAnalyticsRankingsRequestRankingsList = /*@__PURE__*/ S.Array(
...
>;
export const GetLogAnalyticsLogAnalyticsRankingsRequestMetricsList = /*@__PURE__*/ S.Array(
...
export type GetLogAnalyticsLogAnalyticsRankingsRequestCustomDomainsList = Array<string>;
export const GetLogAnalyticsLogAnalyticsRankingsRequestCustomDomainsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetLogAnalyticsLogAnalyticsRankingsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    profileName: S.String.pipe(T.Label()),
    rankings: GetLogAnalyticsLogAnalyticsRankingsRequestRankingsList.pipe(T.Query()),
    metrics: GetLogAnalyticsLogAnalyticsRankingsRequestMetricsList.pipe(T.Query()),
    maxRanking: S.Number.pipe(T.Query()),
    dateTimeBegin: S.String.pipe(T.Query()),
    dateTimeEnd: S.String.pipe(T.Query()),
    customDomains: S.optional(
      GetLogAnalyticsLogAnalyticsRankingsRequestCustomDomainsList.pipe(T.Query()),
    ),
  }).pipe(
    T.Http({
      method: "GET",
...
export const RankingsResponseTablesPropertiesItemsMetricsItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    metric: S.optional(S.String),
    value: S.optional(S.Number),
...
export const RankingsResponseTablesPropertiesItemsItemMetricsList = /*@__PURE__*/ S.Array(
...
export const RankingsResponseTablesPropertiesItemsItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    name: S.optional(S.String),
...
export type RankingsResponseTablesItemDataList = Array<RankingsResponseTablesPropertiesItemsItem>;
...
export const GetLogAnalyticsLogAnalyticsResourcesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    profileName: S.String.pipe(T.Label()),
...
export const ResourcesResponseEndpointsPropertiesItemsItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.String),
    name: S.optional(S.String),
...
export const ResourcesResponseEndpointsItemCustomDomainsList = /*@__PURE__*/ S.Array(
...
export type ResourcesResponseEndpointsList = Array<ResourcesResponseEndpointsItem>;
export const ResourcesResponseEndpointsList = /*@__PURE__*/ S.Array(
  ResourcesResponseEndpointsItem,
) as any as S.Schema<ResourcesResponseEndpointsList>;

export type ResourcesResponseCustomDomainsItem = ResourcesResponseEndpointsPropertiesItemsItem;
export const ResourcesResponseCustomDomainsItem = ResourcesResponseEndpointsPropertiesItemsItem;
...
>;
export const GetLogAnalyticsWafLogAnalyticsMetricsRequestMetricsList = /*@__PURE__*/ S.Array(
...
export type GetLogAnalyticsWafLogAnalyticsMetricsRequestGranularity = "PT5M" | "PT1H" | "P1D";
...
>;
export const GetLogAnalyticsWafLogAnalyticsMetricsRequestActionsList = /*@__PURE__*/ S.Array(
...
>;
export const GetLogAnalyticsWafLogAnalyticsMetricsRequestGroupByList = /*@__PURE__*/ S.Array(
...
export type GetLogAnalyticsWafLogAnalyticsMetricsRequestRuleTypesItem =
  ...
  | "custom"
  | "bot";
export const GetLogAnalyticsWafLogAnalyticsMetricsRequestRuleTypesItem = S.String;
...
>;
export const GetLogAnalyticsWafLogAnalyticsMetricsRequestRuleTypesList = /*@__PURE__*/ S.Array(
...
export interface GetLogAnalyticsWafLogAnalyticsMetricsRequest {
  ...
  dateTimeBegin: string;
  dateTimeEnd: string;
  granularity: GetLogAnalyticsWafLogAnalyticsMetricsRequestGranularity | (string & {});
...
export const GetLogAnalyticsWafLogAnalyticsMetricsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    profileName: S.String.pipe(T.Label()),
    metrics: GetLogAnalyticsWafLogAnalyticsMetricsRequestMetricsList.pipe(T.Query()),
    dateTimeBegin: S.String.pipe(T.Query()),
    dateTimeEnd: S.String.pipe(T.Query()),
    granularity: GetLogAnalyticsWafLogAnalyticsMetricsRequestGranularity.pipe(T.Query()),
    actions: S.optional(GetLogAnalyticsWafLogAnalyticsMetricsRequestActionsList.pipe(T.Query())),
    groupBy: S.optional(GetLogAnalyticsWafLogAnalyticsMetricsRequestGroupByList.pipe(T.Query())),
    ruleTypes: S.optional(
      GetLogAnalyticsWafLogAnalyticsMetricsRequestRuleTypesList.pipe(T.Query()),
    ),
  }).pipe(
    T.Http({
      method: "GET",
...
export type WafMetricsResponseSeriesPropertiesItemsItem = MetricsResponseSeriesPropertiesItemsItem;
export const WafMetricsResponseSeriesPropertiesItemsItem = MetricsResponseSeriesPropertiesItemsItem;
...
>;
export const GetLogAnalyticsWafLogAnalyticsRankingsRequestMetricsList = /*@__PURE__*/ S.Array(
...
export type GetLogAnalyticsWafLogAnalyticsRankingsRequestRankingsItem =
  ...
  | "countryOrRegion"
  | "ruleType";
export const GetLogAnalyticsWafLogAnalyticsRankingsRequestRankingsItem = S.String;
...
>;
export const GetLogAnalyticsWafLogAnalyticsRankingsRequestRankingsList = /*@__PURE__*/ S.Array(
...
export type GetLogAnalyticsWafLogAnalyticsRankingsRequestActionsItem =
  ...
  | "log"
  | "redirect";
export const GetLogAnalyticsWafLogAnalyticsRankingsRequestActionsItem = S.String;
...
>;
export const GetLogAnalyticsWafLogAnalyticsRankingsRequestActionsList = /*@__PURE__*/ S.Array(
...
export type GetLogAnalyticsWafLogAnalyticsRankingsRequestRuleTypesItem =
  ...
  | "custom"
  | "bot";
export const GetLogAnalyticsWafLogAnalyticsRankingsRequestRuleTypesItem = S.String;
...
>;
export const GetLogAnalyticsWafLogAnalyticsRankingsRequestRuleTypesList = /*@__PURE__*/ S.Array(
...
export const GetLogAnalyticsWafLogAnalyticsRankingsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    profileName: S.String.pipe(T.Label()),
    metrics: GetLogAnalyticsWafLogAnalyticsRankingsRequestMetricsList.pipe(T.Query()),
    dateTimeBegin: S.String.pipe(T.Query()),
    dateTimeEnd: S.String.pipe(T.Query()),
    maxRanking: S.Number.pipe(T.Query()),
    rankings: GetLogAnalyticsWafLogAnalyticsRankingsRequestRankingsList.pipe(T.Query()),
    actions: S.optional(GetLogAnalyticsWafLogAnalyticsRankingsRequestActionsList.pipe(T.Query())),
    ruleTypes: S.optional(
      GetLogAnalyticsWafLogAnalyticsRankingsRequestRuleTypesList.pipe(T.Query()),
    ),
  }).pipe(
    T.Http({
      method: "GET",
...
export type PolicySettingsDefaultCustomBlockResponseStatusCode = 200 | 403 | 405 | 406 | 429;
...
export type CdnWebApplicationFirewallPolicyPropertiesEndpointLinksList = Array<CdnEndpoint>;
export const CdnWebApplicationFirewallPolicyPropertiesEndpointLinksList = /*@__PURE__*/ S.Array(
  CdnEndpoint,
...
export const CdnWebApplicationFirewallPolicyProperties = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    endpointLinks: S.optional(CdnWebApplicationFirewallPolicyPropertiesEndpointLinksList),
    extendedProperties: S.optional(CdnWebApplicationFirewallPolicyPropertiesExtendedPropertiesMap),
...
export const GetProfileResponseIdentityUserAssignedIdentitiesMap = /*@__PURE__*/ S.Record(
  S.String,
  S.NullOr(UserAssignedIdentity),
...
export const GetProfileResponseIdentity = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    tenantId: S.optional(S.String),
    type: ManagedServiceIdentityType,
    userAssignedIdentities: S.optional(GetProfileResponseIdentityUserAssignedIdentitiesMap),
  }),
).annotate({
...
export type ManagedRuleSetDefinitionPropertiesRuleGroupsList = Array<ManagedRuleGroupDefinition>;
export const ManagedRuleSetDefinitionPropertiesRuleGroupsList = /*@__PURE__*/ S.Array(
...
export const MetricSpecificationSupportedTimeGrainTypesList = /*@__PURE__*/ S.Array(
  S.String,
...
export type CdnWebApplicationFirewallPolicyListValueList = Array<CdnWebApplicationFirewallPolicy>;
export const CdnWebApplicationFirewallPolicyListValueList = /*@__PURE__*/ S.Array(
...
export const ListProfileSupportedOptimizationTypesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    profileName: S.String.pipe(T.Label()),
...
export type CanMigrateDefaultSku = "Standard_AzureFrontDoor" | "Premium_AzureFrontDoor";
...
export const CdnWebApplicationFirewallPolicyPropertiesInput = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    policySettings: S.optional(PolicySettings),
    rateLimitRules: S.optional(RateLimitRuleList),
    customRules: S.optional(CustomRuleList),
...
export const ProfilesCdnMigrateToAfdRequestMigrationEndpointMappingsList = /*@__PURE__*/ S.Array(
...
export const PurgeAFDEndpointContentRequestContentPathsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const PurgeEndpointContentRequestContentPathsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const PurgeEndpointContentResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const RefreshAFDCustomDomainValidationTokenRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    subscriptionId: S.String.pipe(T.Label()),
    resourceGroupName: S.String.pipe(T.Label()),
    profileName: S.String.pipe(T.Label()),
...
export const RefreshAFDCustomDomainValidationTokenResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export const AFDEndpointPropertiesUpdateParametersInput = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    enabledState: S.optional(EnabledState),
    enforceMtls: S.optional(EnforceMtlsEnabledState),
  }),
...
/** The list of custom certificate subjects to validate against. Only applicable when certificateNameCheckValidationMode is 'CustomCertificateSubject'. Must contain 1 or 2 entries. */
export type AFDOriginUpdatePropertiesParametersInputCustomCertificateSubjectsList = Array<string>;
...
export const AFDOriginGroupUpdatePropertiesParametersInput = AFDOriginGroupPropertiesInput;
...
/** List of content types on which compression applies. The value should be a valid MIME type. */
export type EndpointPropertiesUpdateParametersContentTypesToCompressList = Array<string>;
export const EndpointPropertiesUpdateParametersContentTypesToCompressList = /*@__PURE__*/ S.Array(
  S.String,
...
export type EndpointPropertiesUpdateParametersQueryStringCachingBehavior =
  ...
  | "UseQueryString"
  | "NotSet";
export const EndpointPropertiesUpdateParametersQueryStringCachingBehavior = S.String;

/** List of rules defining the user's geo access within a CDN endpoint. Each geo filter defines an access rule to a specified path or content, e.g. block APAC for path /pictures/ */
export type EndpointPropertiesUpdateParametersGeoFiltersList = Array<GeoFilter>;
export const EndpointPropertiesUpdateParametersGeoFiltersList = /*@__PURE__*/ S.Array(
  GeoFilter,
) as any as S.Schema<EndpointPropertiesUpdateParametersGeoFiltersList>;

/** List of keys used to validate the signed URL hashes. */
export type EndpointPropertiesUpdateParametersUrlSigningKeysList = Array<UrlSigningKey>;
export const EndpointPropertiesUpdateParametersUrlSigningKeysList = /*@__PURE__*/ S.Array(
  UrlSigningKey,
...
export const EndpointPropertiesUpdateParameters = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    defaultOriginGroup: S.optional(ResourceReference),
    urlSigningKeys: S.optional(EndpointPropertiesUpdateParametersUrlSigningKeysList),
    deliveryPolicy: S.optional(EndpointPropertiesUpdateParametersDeliveryPolicy),
    webApplicationFirewallPolicyLink: S.optional(ResourceReference),
  }),
).annotate({
...
export const OriginGroupUpdatePropertiesParametersOriginsList = /*@__PURE__*/ S.Array(
  ResourceReference,
...
export const UpdateProfileRequestIdentityUserAssignedIdentitiesMap = /*@__PURE__*/ S.Record(
  S.String,
  S.NullOr(UserAssignedIdentityInput),
...
export const UpdateProfileRequestIdentity = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    type: ManagedServiceIdentityType,
    userAssignedIdentities: S.optional(UpdateProfileRequestIdentityUserAssignedIdentitiesMap),
  }),
).annotate({
...
export const UpdateProfileResponseIdentityUserAssignedIdentitiesMap = /*@__PURE__*/ S.Record(
  S.String,
  S.NullOr(UserAssignedIdentity),
...
export const UpdateProfileResponseIdentity = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    tenantId: S.optional(S.String),
    type: ManagedServiceIdentityType,
    userAssignedIdentities: S.optional(UpdateProfileResponseIdentityUserAssignedIdentitiesMap),
  }),
).annotate({
...
export const RouteUpdatePropertiesParametersInputCustomDomainsList = /*@__PURE__*/ S.Array(
  ResourceReference,
) as any as S.Schema<RouteUpdatePropertiesParametersInputCustomDomainsList>;

/** rule sets referenced by this endpoint. */
export type RouteUpdatePropertiesParametersInputRuleSetsList = Array<ResourceReference>;
export const RouteUpdatePropertiesParametersInputRuleSetsList = /*@__PURE__*/ S.Array(
  ResourceReference,
...
export type RouteUpdatePropertiesParametersInputSupportedProtocolsList = Array<
  AFDEndpointProtocols | (string & {})
>;
export const RouteUpdatePropertiesParametersInputSupportedProtocolsList = /*@__PURE__*/ S.Array(
  AFDEndpointProtocols,
) as any as S.Schema<RouteUpdatePropertiesParametersInputSupportedProtocolsList>;

/** The route patterns of the rule. */
export type RouteUpdatePropertiesParametersInputPatternsToMatchList = Array<string>;
export const RouteUpdatePropertiesParametersInputPatternsToMatchList = /*@__PURE__*/ S.Array(
  S.String,
...
/** whether this route will be linked to the default endpoint domain. */
export type RouteUpdatePropertiesParametersInputLinkToDefaultDomain = "Enabled" | "Disabled";
export const RouteUpdatePropertiesParametersInputLinkToDefaultDomain = S.String;

/** Whether to automatically redirect HTTP traffic to HTTPS traffic. Note that this is a easy way to set up this rule and it will be the first rule that gets executed. */
export type RouteUpdatePropertiesParametersInputHttpsRedirect = "Enabled" | "Disabled";
...
export interface RouteUpdatePropertiesParametersInput {
  ...
  cacheConfiguration?: AfdRouteCacheConfiguration;
  /** Protocol this rule will use when forwarding traffic to backends. */
  forwardingProtocol?: RouteUpdatePropertiesParametersInputForwardingProtocol | (string & {});
  /** whether this route will be linked to the default endpoint domain. */
  linkToDefaultDomain?: RouteUpdatePropertiesParametersInputLinkToDefaultDomain | (string & {});
  /** Whether to automatically redirect HTTP traffic to HTTPS traffic. Note that this is a easy way to set up this rule and it will be the first rule that gets executed. */
  httpsRedirect?: RouteUpdatePropertiesParametersInputHttpsRedirect | (string & {});
  /** Whether to enable use of this rule. Permitted values are 'Enabled' or 'Disabled' */
  enabledState?: EnabledState | (string & {});
}
export const RouteUpdatePropertiesParametersInput = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    customDomains: S.optional(RouteUpdatePropertiesParametersInputCustomDomainsList),
    originGroup: S.optional(ResourceReference),
    originPath: S.optional(S.String),
    ruleSets: S.optional(RouteUpdatePropertiesParametersInputRuleSetsList),
    supportedProtocols: S.optional(RouteUpdatePropertiesParametersInputSupportedProtocolsList),
    patternsToMatch: S.optional(RouteUpdatePropertiesParametersInputPatternsToMatchList),
    cacheConfiguration: S.optional(AfdRouteCacheConfiguration),
    forwardingProtocol: S.optional(RouteUpdatePropertiesParametersInputForwardingProtocol),
    linkToDefaultDomain: S.optional(RouteUpdatePropertiesParametersInputLinkToDefaultDomain),
    httpsRedirect: S.optional(RouteUpdatePropertiesParametersInputHttpsRedirect),
    enabledState: S.optional(EnabledState),
  }),
).annotate({
...
export const RuleUpdatePropertiesParametersInputConditionsList = /*@__PURE__*/ S.Array(
  DeliveryRuleCondition,
) as any as S.Schema<RuleUpdatePropertiesParametersInputConditionsList>;

/** A list of actions that are executed when all the conditions of a rule are satisfied. */
export type RuleUpdatePropertiesParametersInputActionsList = Array<DeliveryRuleAction>;
export const RuleUpdatePropertiesParametersInputActionsList = /*@__PURE__*/ S.Array(
  DeliveryRuleAction,
) as any as S.Schema<RuleUpdatePropertiesParametersInputActionsList>;

/** If this rule is a match should the rules engine continue running the remaining rules or stop. If not present, defaults to Continue. */
export type RuleUpdatePropertiesParametersInputMatchProcessingBehavior = "Continue" | "Stop";
export const RuleUpdatePropertiesParametersInputMatchProcessingBehavior = S.String;
...
export const RuleUpdatePropertiesParametersInput = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    matchProcessingBehavior: S.optional(RuleUpdatePropertiesParametersInputMatchProcessingBehavior),
  }),
).annotate({
