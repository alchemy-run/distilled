...
export type GeoCatalogPropertiesInputAutoGeneratedDomainNameLabelScope =
  ...
  | "SubscriptionReuse"
  | "ResourceGroupReuse";
export const GeoCatalogPropertiesInputAutoGeneratedDomainNameLabelScope = S.String;
...
export const DeleteGeoCatalogResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const UpdateGeoCatalogResponseIdentity = CreateGeoCatalogResponseIdentity;
