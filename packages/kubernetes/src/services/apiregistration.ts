...
export const IoK8sKubeAggregatorPkgApisApiregistrationV1ServiceReference = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      name: S.optional(S.String),
      namespace: S.optional(S.String),
...
export const IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceSpec = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      ...
      service: S.optional(IoK8sKubeAggregatorPkgApisApiregistrationV1ServiceReference),
...
export const IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceCondition =
  /*@__PURE__*/ S.suspend(() =>
    ...
    identifier: "IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceCondition",
...
export const IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceStatus = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
...
export const IoK8sKubeAggregatorPkgApisApiregistrationV1APIService = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    apiVersion: S.optional(S.String),
    kind: S.optional(S.String),
    metadata: S.optional(IoK8sApimachineryPkgApisMetaV1ObjectMeta),
...
export const DeleteApiregistrationV1CollectionAPIServiceRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    pretty: S.optional(S.String.pipe(T.Query())),
...
export const GetApiregistrationAPIGroupRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}).pipe(T.Http({ method: "GET", uri: "/apis/apiregistration.k8s.io/", code: 200 })),
).annotate({
...
export const IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceList = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      apiVersion: S.optional(S.String),
      items: IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceListItemsList,
...
export const PatchApiregistrationV1APIServiceStatusRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    name: S.String.pipe(T.Label()),
    pretty: S.optional(S.String.pipe(T.Query())),
    dryRun: S.optional(S.String.pipe(T.Query())),
...
export const ReadApiregistrationV1APIServiceStatusRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    name: S.String.pipe(T.Label()),
    pretty: S.optional(S.String.pipe(T.Query())),
  }).pipe(
...
export const ReplaceApiregistrationV1APIServiceRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    name: S.String.pipe(T.Label()),
    pretty: S.optional(S.String.pipe(T.Query())),
    dryRun: S.optional(S.String.pipe(T.Query())),
...
export const ReplaceApiregistrationV1APIServiceStatusRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    name: S.String.pipe(T.Label()),
    pretty: S.optional(S.String.pipe(T.Query())),
    dryRun: S.optional(S.String.pipe(T.Query())),
...
export const WatchApiregistrationV1APIServiceListRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    allowWatchBookmarks: S.optional(S.Boolean.pipe(T.Query())),
    continue: S.optional(S.String.pipe(T.Query())),
    fieldSelector: S.optional(S.String.pipe(T.Query())),
...
export type DeleteApiregistrationV1APIServiceError = NotFound | Conflict | KubernetesOpError;
...
export type DeleteApiregistrationV1CollectionAPIServiceError = KubernetesOpError;
...
export type ReadApiregistrationV1APIServiceStatusError = NotFound | KubernetesOpError;
