...
export const DeleteNodeV1CollectionRuntimeClassRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    pretty: S.optional(S.String.pipe(T.Query())),
...
export const GetNodeV1APIResourcesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}).pipe(T.Http({ method: "GET", uri: "/apis/node.k8s.io/v1/", code: 200 })),
).annotate({
...
export type IoK8sApiNodeV1RuntimeClassListItemsList = Array<IoK8sApiNodeV1RuntimeClass>;
...
export type CreateNodeV1RuntimeClassError = Conflict | UnprocessableEntity | KubernetesOpError;
...
export type DeleteNodeV1RuntimeClassError = NotFound | Conflict | KubernetesOpError;
