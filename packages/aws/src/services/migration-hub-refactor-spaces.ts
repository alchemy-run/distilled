...
export const AdditionalDetails = /*@__PURE__*/ S.Record(S.String, S.String.pipe(S.optional));
...
export const PathResourceToId = /*@__PURE__*/ S.Record(S.String, S.String.pipe(S.optional));
