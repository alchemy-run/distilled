...
export const ListEmojiResponseCategoriesItemEmojiNamesList = /*@__PURE__*/ S.Array(
  S.String,
...
export type ListEmojiResponseCategoriesList = Array<ListEmojiResponseCategoriesItem>;
