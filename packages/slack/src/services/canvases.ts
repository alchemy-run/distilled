...
export const DeleteAccessResponseFailedToUpdateChannelIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const DeleteAccessResponseFailedToUpdateUserIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const LookupSectionResponseSectionsItemChildSectionIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const LookupSectionResponseSectionsItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.String,
    child_section_ids: S.optional(LookupSectionResponseSectionsItemChildSectionIdsList),
  }),
).annotate({
...
export type LookupSectionResponseSectionsList = Array<LookupSectionResponseSectionsItem>;
...
export const SetAccessResponseFailedToUpdateChannelIdsList = /*@__PURE__*/ S.Array(
  S.String,
