...
export type OauthAccessResponseInstallerUser = OauthAccessResponseAuthorizingUser;
export const OauthAccessResponseInstallerUser = OauthAccessResponseAuthorizingUser;
