...
export const VolumeRecoveryPointManagementInputRecoveryPointLabelsMap =
  /*@__PURE__*/ S.Record(
    S.String,
    S.String,
...
export const VolumeRecoveryPointManagementInput = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    kind: S.String,
    recoveryPointLabels: S.optional(
      VolumeRecoveryPointManagementInputRecoveryPointLabelsMap,
    ),
    snapshotRetentionPolicy: SnapshotRetentionPolicy,
...
export const CreateSnapshotsResultCreatedSnapshotIDsList =
  /*@__PURE__*/ S.Array(
    S.String,
...
export type VolumeExecutionOutputStepStatus =
  | "PENDING"
  | "RUNNING"
  | "FAILED"
  | "SUCCESSFUL";
...
export const DeleteVolumeAutomationResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export type CreateVolumeAutomationError =
  | BadRequest
  | Forbidden
  | NotFound
  | StackitOpError;
...
export type CreateVolumeExecutionError =
  | BadRequest
  | Forbidden
  | NotFound
  | StackitOpError;
...
export type DeleteVolumeAutomationError =
  | BadRequest
  | Forbidden
  | NotFound
  | StackitOpError;
...
export type GetVolumeAutomationError =
  | BadRequest
  | Forbidden
  | NotFound
  | StackitOpError;
...
export type GetVolumeExecutionError =
  | BadRequest
  | Forbidden
  | NotFound
  | StackitOpError;
...
export type GetVolumeTemplateError =
  | BadRequest
  | Forbidden
  | NotFound
  | StackitOpError;
...
export type ListVolumeAutomationsError =
  | BadRequest
  | Forbidden
  | NotFound
  | StackitOpError;
...
export type ListVolumeExecutionsError =
  | BadRequest
  | Forbidden
  | NotFound
  | StackitOpError;
...
export type ListVolumeTemplatesError =
  | BadRequest
  | Forbidden
  | NotFound
  | StackitOpError;
...
export type PartialUpdateVolumeAutomationError =
  | BadRequest
  | Forbidden
  | NotFound
  | StackitOpError;
