...
export const DeleteApproleSecretIdResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export type CreateApproleError = BadRequest | NotFound | Conflict | StackitOpError;
...
export const getACL: API.OperationMethod<GetACLRequest, ACL, GetACLError, StackitOpContext> =
  /*@__PURE__*/ API.make(() => ({
    input: GetACLRequest,
    output: ACL,
    errors: [BadRequest, NotFound, UnknownStackitError],
...
export const getUser: API.OperationMethod<GetUserRequest, User, GetUserError, StackitOpContext> =
  /*@__PURE__*/ API.make(() => ({
