...
export const ModelSkusList = /*@__PURE__*/ S.Array(
  SKU,
) as any as S.Schema<ModelSkusList>;

export type ModelTagsList = Array<string>;
export const ModelTagsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<ModelTagsList>;
