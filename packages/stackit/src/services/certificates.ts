...
export const UsageItemsList = /*@__PURE__*/ S.Array(UsageItem) as any as S.Schema<UsageItemsList>;
...
export type GetCertificateError = BadRequest | Forbidden | NotFound | StackitOpError;
