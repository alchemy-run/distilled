...
export const DeleteFolderLabelsResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export const DeleteProjectLabelsResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}),
).annotate({
...
export const ParentList = /*@__PURE__*/ S.Array(
  ParentListItem,
) as any as S.Schema<ParentList>;
...
export const ListFoldersRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    containerIds: S.optional(
      ListFoldersRequestContainerIdsList.pipe(T.Query()),
    ),
    member: S.optional(S.String.pipe(T.Query())),
    limit: S.optional(S.Number.pipe(T.Query())),
    offset: S.optional(S.Number.pipe(T.Query())),
    creation_time_start: S.optional(
      S.String.pipe(T.Query("creation-time-start")),
    ),
  }).pipe(
    T.Http({
      method: "GET",
...
export const ListOrganizationsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    containerIds: S.optional(
      ListOrganizationsRequestContainerIdsList.pipe(T.Query()),
    ),
    member: S.optional(S.String.pipe(T.Query())),
    limit: S.optional(S.Number.pipe(T.Query())),
    offset: S.optional(S.Number.pipe(T.Query())),
...
export type ListOrganizationsResponseItemsList =
  Array<ListOrganizationsResponseItemsItem>;
...
export const ListProjectsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    containerParentId: S.optional(S.String.pipe(T.Query())),
    containerIds: S.optional(
      ListProjectsRequestContainerIdsList.pipe(T.Query()),
    ),
    member: S.optional(S.String.pipe(T.Query())),
    offset: S.optional(S.Number.pipe(T.Query())),
    limit: S.optional(S.Number.pipe(T.Query())),
...
export type PartialUpdateFolderError =
  | Forbidden
  | NotFound
  | Conflict
  | StackitOpError;
...
export type PartialUpdateOrganizationError =
  | NotFound
  | Conflict
  | StackitOpError;
...
export type PartialUpdateProjectError =
  | Forbidden
  | NotFound
  | Conflict
  | StackitOpError;
