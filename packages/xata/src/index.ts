/**
 * @distilled.cloud/xata — Xata SDK for Effect.
 *
 ...
 *
 * const orgs = yield* Xata.Services.xata.getOrganizationsList({});
 * ```
 */
export * from "./credentials.ts";
export * from "./errors.ts";
export * as T from "./traits.ts";
export { XataProtocol, type XataOpError, type XataOpContext } from "./protocol.ts";
...
export * from "./services/xata.ts";
export { BadRequest, Conflict, Forbidden, NotFound } from "./services/xata.ts";
