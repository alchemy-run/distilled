...
export const DeleteEdgeConfigSchemaResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const DeleteEdgeConfigTokensResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export type GetEdgeConfigBackupResponseBodyCase0BackupItemsMap = {
  [key: string]: GetEdgeConfigBackupResponseBodyCase0BackupItemsValue | undefined;
};
export const GetEdgeConfigBackupResponseBodyCase0BackupItemsMap = /*@__PURE__*/ S.Record(
  S.String,
...
export const GetEdgeConfigBackupResponseBodyCase1BackupItemsMap = /*@__PURE__*/ S.Record(
  S.String,
  GetEdgeConfigBackupResponseBodyCase0BackupItemsValue,
...
export type PatchEdgeConfigItemsRequestItemsItemCase1Operation = "update" | "upsert";
...
export const PatchEdgeConfigItemsRequestItemsItemCase1 = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export type PatchEdgeConfigItemsRequestItemsItemCase2Operation = "update" | "upsert";
...
export const PatchEdgeConfigItemsRequestItemsItemCase2 = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export type PatchEdgeConfigItemsRequestItemsList = Array<PatchEdgeConfigItemsRequestItemsItem>;
...
export type DeleteEdgeConfigError = BadRequest | Forbidden | NotFound | Conflict | VercelOpError;
...
export type GetEdgeConfigError = BadRequest | Forbidden | NotFound | VercelOpError;
...
export type GetEdgeConfigBackupError = BadRequest | Forbidden | NotFound | VercelOpError;
...
export type GetEdgeConfigBackupsError = BadRequest | Forbidden | NotFound | VercelOpError;
...
export type GetEdgeConfigItemError = BadRequest | Forbidden | NotFound | VercelOpError;
...
export type GetEdgeConfigItemsError = BadRequest | Forbidden | NotFound | VercelOpError;
...
export type GetEdgeConfigSchemaError = BadRequest | Forbidden | NotFound | VercelOpError;
...
export type GetEdgeConfigTokenError = BadRequest | Forbidden | NotFound | VercelOpError;
...
export type GetEdgeConfigTokensError = BadRequest | Forbidden | NotFound | VercelOpError;
