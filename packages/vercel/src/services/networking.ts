...
export const CreateNetworkRequestAwsAvailabilityZoneIdsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateNetworkRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    awsAvailabilityZoneIds: S.optional(CreateNetworkRequestAwsAvailabilityZoneIdsList),
    cidr: S.String,
    name: S.String,
    region: S.String,
