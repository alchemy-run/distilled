...
export const ClaimDomainOwnershipRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "POST", uri: "/v9/domains/{domain}/claim", code: 200 })),
).annotate({
...
export const ClaimDomainOwnershipResponseDomainNameserversList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ClaimDomainOwnershipResponseDomainIntendedNameserversList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ClaimDomainOwnershipResponseDomainCustomNameserversList = /*@__PURE__*/ S.Array(
  S.String,
...
export const ClaimDomainOwnershipResponseDomainCreator = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    username: S.String,
    email: S.String,
...
export const ClaimDomainOwnershipResponseDomain = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    nameservers: ClaimDomainOwnershipResponseDomainNameserversList,
    intendedNameservers: ClaimDomainOwnershipResponseDomainIntendedNameserversList,
    customNameservers: S.optional(ClaimDomainOwnershipResponseDomainCustomNameserversList),
    creator: ClaimDomainOwnershipResponseDomainCreator,
    echMode: ClaimDomainOwnershipResponseDomainEchMode,
    name: S.String,
...
export const CreateOrTransferDomainResponseDomainNameserversList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateOrTransferDomainResponseDomainIntendedNameserversList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateOrTransferDomainResponseDomainCustomNameserversList = /*@__PURE__*/ S.Array(
  S.String,
...
export const CreateOrTransferDomainResponseDomain = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    nameservers: CreateOrTransferDomainResponseDomainNameserversList,
    intendedNameservers: CreateOrTransferDomainResponseDomainIntendedNameserversList,
    customNameservers: S.optional(CreateOrTransferDomainResponseDomainCustomNameserversList),
    creator: ClaimDomainOwnershipResponseDomainCreator,
    echMode: CreateOrTransferDomainResponseDomainEchMode,
    name: S.String,
    teamId: S.NullOr(S.String),
...
export const GetDomainResponseDomainIntendedNameserversList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetDomainResponseDomainCustomNameserversList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetDomainResponseDomainCreator = ClaimDomainOwnershipResponseDomainCreator;
...
export const GetDomainConfigRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    teamId: S.optional(S.String.pipe(T.Query())),
    slug: S.optional(S.String.pipe(T.Query())),
  }).pipe(T.Http({ method: "GET", uri: "/v6/domains/{domain}/config", code: 200 })),
).annotate({
...
export const GetDomainConfigResponseAcceptedChallengesList = /*@__PURE__*/ S.Array(
...
export const GetDomainConfigResponseRecommendedIPv4ItemValueList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetDomainConfigResponseRecommendedIPv4Item = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    rank: S.Number,
    value: GetDomainConfigResponseRecommendedIPv4ItemValueList,
  }),
...
export const GetDomainConfigResponseRecommendedCNAMEItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    rank: S.Number,
    value: S.String,
  }),
...
export const GetDomainConfigResponseRecommendedCNAMEList = /*@__PURE__*/ S.Array(
...
export type GetDomainProjectDomainsResponseProjectDomainsItemRedirectStatusCode =
  ...
  | 307
  | 308;
export const GetDomainProjectDomainsResponseProjectDomainsItemRedirectStatusCode = S.Number;
...
export const GetDomainProjectDomainsResponseProjectDomainsItemVerificationItem =
  /*@__PURE__*/ S.suspend(() =>
    ...
    identifier: "GetDomainProjectDomainsResponseProjectDomainsItemVerificationItem",
...
export const GetDomainProjectDomainsResponseProjectDomainsItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    name: S.String,
    apexName: S.String,
    projectId: S.String,
    ...
    redirectStatusCode: S.optional(
      S.NullOr(GetDomainProjectDomainsResponseProjectDomainsItemRedirectStatusCode),
    ),
    ...
    verified: S.Boolean,
    verification: S.optional(GetDomainProjectDomainsResponseProjectDomainsItemVerificationList),
  }),
).annotate({
...
export const GetDomainProjectDomainsResponseProjectDomainsList = /*@__PURE__*/ S.Array(
...
export const GetDomainsResponseDomainsItemNameserversList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetDomainsResponseDomainsItemIntendedNameserversList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetDomainsResponseDomainsItemCustomNameserversList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetDomainsResponseDomainsItemCreator = ClaimDomainOwnershipResponseDomainCreator;
...
export const GetDomainsResponseDomainsItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    nameservers: GetDomainsResponseDomainsItemNameserversList,
    intendedNameservers: GetDomainsResponseDomainsItemIntendedNameserversList,
    customNameservers: S.optional(GetDomainsResponseDomainsItemCustomNameserversList),
    creator: ClaimDomainOwnershipResponseDomainCreator,
    echMode: GetDomainsResponseDomainsItemEchMode,
    name: S.String,
    teamId: S.NullOr(S.String),
...
export const UpdateDomainRequestBodyCase0CustomNameserversList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateDomainRequestBodyCase0 = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    renew: S.optional(S.Boolean),
    customNameservers: S.optional(UpdateDomainRequestBodyCase0CustomNameserversList),
...
export const UpdateDomainRequestBody = S.Unknown as any as S.Schema<UpdateDomainRequestBody>;
...
export const UpdateDomainResponseBodyCase2CustomNameserversList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateDomainResponseBodyCase2 = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    renew: S.optional(S.Boolean),
    customNameservers: S.optional(UpdateDomainResponseBodyCase2CustomNameserversList),
    zone: S.optional(S.Boolean),
    echMode: UpdateDomainResponseBodyCase2EchMode,
  }),
).annotate({
...
export const UpdateDomainResponseBody = S.Unknown as any as S.Schema<UpdateDomainResponseBody>;
