...
export type AiGatewayVirtualModelConfigSelector = "cost" | "priority" | "tps" | "ttft";
...
export type ListAiGatewayVirtualModelConfigsError = BadRequest | Forbidden | VercelOpError;
