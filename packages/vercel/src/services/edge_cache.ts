...
export const DangerouslyDeleteBySrcImagesRequestSrcImagesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const DangerouslyDeleteByTagsRequestTagsCase0List = /*@__PURE__*/ S.Array(
  S.String,
...
export const InvalidateBySrcImagesResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export type InvalidateByTagsRequestTags = InvalidateByTagsRequestTagsCase0List | string;
...
export type DangerouslyDeleteByTagsError = BadRequest | Forbidden | NotFound | VercelOpError;
...
export type InvalidateByTagsError = BadRequest | Forbidden | NotFound | VercelOpError;
