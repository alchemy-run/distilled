...
export type DeleteAiGatewayRuleError = BadRequest | Forbidden | NotFound | VercelOpError;
...
export type UpdateAiGatewayRuleError = BadRequest | Forbidden | NotFound | VercelOpError;
