...
import { Gone, PaymentRequired, UnknownVercelError, type DefaultErrors } from "./errors.ts";
...
export const VercelProtocol: Layer.Layer<API.Protocol> = makeRestProtocol<Config>({
