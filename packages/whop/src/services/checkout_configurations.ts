...
export const CreateCheckoutConfigurationRequestPaymentMethodConfiguration = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      disabled: S.optional(
        CreateCheckoutConfigurationRequestPaymentMethodConfigurationDisabledList,
      ),
      enabled: S.optional(CreateCheckoutConfigurationRequestPaymentMethodConfigurationEnabledList),
...
export const CreateCheckoutConfigurationRequestPlanPaymentMethodConfiguration =
  /*@__PURE__*/ S.suspend(() =>
    ...
    identifier: "CreateCheckoutConfigurationRequestPlanPaymentMethodConfiguration",
  }) as any as S.Schema<CreateCheckoutConfigurationRequestPlanPaymentMethodConfiguration>;

/** Billing model for the plan. */
export type CreateCheckoutConfigurationRequestPlanPlanType = "renewal" | "one_time";
...
export interface CreateCheckoutConfigurationRequestPlan {
  ...
  /** Billing model for the plan. */
  plan_type?: CreateCheckoutConfigurationRequestPlanPlanType | (string & {}) | null;
  /** Product ID the inline plan should belong to, prefixed `prod_`. */
  product_id?: string | null;
  /** Sales method for the plan. */
  release_method?: CreateCheckoutConfigurationRequestPlanReleaseMethod | (string & {}) | null;
  ...
  /** Whether the plan is visible to customers or hidden from public view. */
  visibility?: CreateCheckoutConfigurationRequestPlanVisibility | (string & {}) | null;
}
export const CreateCheckoutConfigurationRequestPlan = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    payment_method_configuration: S.optional(
      S.NullOr(CreateCheckoutConfigurationRequestPlanPaymentMethodConfiguration),
    ),
    plan_type: S.optional(S.NullOr(CreateCheckoutConfigurationRequestPlanPlanType)),
    product_id: S.optional(S.NullOr(S.String)),
    release_method: S.optional(S.NullOr(CreateCheckoutConfigurationRequestPlanReleaseMethod)),
    renewal_price: S.optional(S.NullOr(S.Number)),
    stock: S.optional(S.NullOr(S.Number)),
    three_ds_level: S.optional(S.NullOr(CreateCheckoutConfigurationRequestPlanThreeDsLevel)),
    ...
    visibility: S.optional(S.NullOr(CreateCheckoutConfigurationRequestPlanVisibility)),
  }),
).annotate({
...
export const CreateCheckoutConfigurationRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    three_ds_level: S.optional(S.NullOr(CreateCheckoutConfigurationRequestThreeDsLevel)),
    idempotency_key: S.optional(S.String.pipe(T.Header("Idempotency-Key"))),
  }).pipe(T.Http({ method: "POST", uri: "/checkout_configurations", code: 200 })),
).annotate({
...
export const CreateCheckoutConfigurationResponseEffectivePaymentMethodConfiguration =
  /*@__PURE__*/ S.suspend(() =>
    ...
    identifier: "CreateCheckoutConfigurationResponseEffectivePaymentMethodConfiguration",
...
export const CreateCheckoutConfigurationResponsePaymentMethodConfiguration =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      enabled: S.optional(CreateCheckoutConfigurationResponsePaymentMethodConfigurationEnabledList),
      include_platform_defaults: S.optional(S.Boolean),
    }),
  ).annotate({
...
/** Billing model for the plan. */
export type CreateCheckoutConfigurationResponsePlanPlanType = "renewal" | "one_time";
...
export const CreateCheckoutConfigurationResponsePlan = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    three_ds_level: S.NullOr(CreateCheckoutConfigurationResponsePlanThreeDsLevel),
...
export const CreateCheckoutConfigurationResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    effective_payment_method_configuration: S.optional(
      S.NullOr(CreateCheckoutConfigurationResponseEffectivePaymentMethodConfiguration),
    ),
    id: S.String,
    metadata: S.optional(S.NullOr(S.Unknown)),
    mode: CreateCheckoutConfigurationResponseMode,
    ...
    redirect_url: S.optional(S.NullOr(S.String)),
    three_ds_level: S.optional(S.NullOr(CreateCheckoutConfigurationResponseThreeDsLevel)),
    updated_at: S.String,
  }),
).annotate({
...
export const GetCheckoutConfigurationRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.String.pipe(T.Label()),
  }).pipe(T.Http({ method: "GET", uri: "/checkout_configurations/{id}", code: 200 })),
).annotate({
...
export const GetCheckoutConfigurationResponseEffectivePaymentMethodConfiguration =
  /*@__PURE__*/ S.suspend(() =>
    ...
    identifier: "GetCheckoutConfigurationResponseEffectivePaymentMethodConfiguration",
...
/** Payment methods explicitly disabled for checkout. */
export type GetCheckoutConfigurationResponsePaymentMethodConfigurationDisabledList = Array<string>;
...
/** Payment methods explicitly enabled for checkout. */
export type GetCheckoutConfigurationResponsePaymentMethodConfigurationEnabledList = Array<string>;
...
export const GetCheckoutConfigurationResponsePaymentMethodConfiguration = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      disabled: S.optional(GetCheckoutConfigurationResponsePaymentMethodConfigurationDisabledList),
      enabled: S.optional(GetCheckoutConfigurationResponsePaymentMethodConfigurationEnabledList),
      include_platform_defaults: S.optional(S.Boolean),
    }),
).annotate({
...
/** Billing model for the plan. */
export type GetCheckoutConfigurationResponsePlanPlanType = "renewal" | "one_time";
...
export const GetCheckoutConfigurationResponsePlan = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    release_method: GetCheckoutConfigurationResponsePlanReleaseMethod,
    renewal_price: S.Number,
    three_ds_level: S.NullOr(GetCheckoutConfigurationResponsePlanThreeDsLevel),
    trial_period_days: S.NullOr(S.Number),
    visibility: GetCheckoutConfigurationResponsePlanVisibility,
  }),
).annotate({
...
export const GetCheckoutConfigurationResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    currency: S.optional(S.NullOr(S.String)),
    effective_payment_method_configuration: S.optional(
      S.NullOr(GetCheckoutConfigurationResponseEffectivePaymentMethodConfiguration),
    ),
    id: S.String,
    metadata: S.optional(S.NullOr(S.Unknown)),
    mode: GetCheckoutConfigurationResponseMode,
    ...
    purchase_url: S.optional(S.NullOr(S.String)),
    redirect_url: S.optional(S.NullOr(S.String)),
    three_ds_level: S.optional(S.NullOr(GetCheckoutConfigurationResponseThreeDsLevel)),
    updated_at: S.String,
  }),
).annotate({
...
export const ListCheckoutConfigurationsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    direction: S.optional(ListCheckoutConfigurationsRequestDirection.pipe(T.Query())),
    first: S.optional(S.Number.pipe(T.Query())),
    after: S.optional(S.String.pipe(T.Query())),
  }).pipe(T.Http({ method: "GET", uri: "/checkout_configurations", code: 200 })),
).annotate({
...
export const ListCheckoutConfigurationsResponseDataItemEffectivePaymentMethodConfiguration =
  /*@__PURE__*/ S.suspend(() =>
    ...
    identifier: "ListCheckoutConfigurationsResponseDataItemEffectivePaymentMethodConfiguration",
  }) as any as S.Schema<ListCheckoutConfigurationsResponseDataItemEffectivePaymentMethodConfiguration>;

/** Controls whether checkout charges the buyer immediately or saves payment details for later. */
export type ListCheckoutConfigurationsResponseDataItemMode = "payment" | "setup";
...
export const ListCheckoutConfigurationsResponseDataItemPaymentMethodConfiguration =
  /*@__PURE__*/ S.suspend(() =>
    ...
    identifier: "ListCheckoutConfigurationsResponseDataItemPaymentMethodConfiguration",
  }) as any as S.Schema<ListCheckoutConfigurationsResponseDataItemPaymentMethodConfiguration>;

/** Billing model for the plan. */
export type ListCheckoutConfigurationsResponseDataItemPlanPlanType = "renewal" | "one_time";
...
export type ListCheckoutConfigurationsResponseDataItemPlanVisibility =
  ...
  | "archived"
  | "quick_link";
export const ListCheckoutConfigurationsResponseDataItemPlanVisibility = S.String;
...
export const ListCheckoutConfigurationsResponseDataItemPlan = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    adaptive_pricing_enabled: S.Boolean,
    billing_period: S.NullOr(S.Number),
    currency: S.String,
    ...
    release_method: ListCheckoutConfigurationsResponseDataItemPlanReleaseMethod,
    renewal_price: S.Number,
    three_ds_level: S.NullOr(ListCheckoutConfigurationsResponseDataItemPlanThreeDsLevel),
    trial_period_days: S.NullOr(S.Number),
    visibility: ListCheckoutConfigurationsResponseDataItemPlanVisibility,
  }),
).annotate({
...
export const ListCheckoutConfigurationsResponseDataItem = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    account_id: S.String,
    affiliate_code: S.optional(S.NullOr(S.String)),
    created_at: S.String,
    currency: S.optional(S.NullOr(S.String)),
    effective_payment_method_configuration: S.optional(
      S.NullOr(ListCheckoutConfigurationsResponseDataItemEffectivePaymentMethodConfiguration),
    ),
    id: S.String,
    metadata: S.optional(S.NullOr(S.Unknown)),
    mode: ListCheckoutConfigurationsResponseDataItemMode,
    payment_method_configuration: S.optional(
      S.NullOr(ListCheckoutConfigurationsResponseDataItemPaymentMethodConfiguration),
    ),
    plan: S.optional(S.NullOr(ListCheckoutConfigurationsResponseDataItemPlan)),
    purchase_url: S.optional(S.NullOr(S.String)),
    redirect_url: S.optional(S.NullOr(S.String)),
    three_ds_level: S.optional(S.NullOr(ListCheckoutConfigurationsResponseDataItemThreeDsLevel)),
    updated_at: S.String,
  }),
).annotate({
...
export const ListCheckoutConfigurationsResponsePageInfo = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
