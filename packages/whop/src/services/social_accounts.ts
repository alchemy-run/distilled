...
export const DeleteSocialAccountRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "DELETE", uri: "/social_accounts/{id}", code: 200 })),
).annotate({
...
export const ListSocialAccountPostsRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "GET", uri: "/social_accounts/{id}/posts", code: 200 })),
).annotate({
...
export type SocialAccountPostRestrictionsList = Array<SocialAccountPostRestrictionsItem>;
...
export type DeleteSocialAccountError = BadRequest | Forbidden | NotFound | Conflict | WhopOpError;
...
export type ListSocialAccountLeadFormsError = BadRequest | NotFound | WhopOpError;
