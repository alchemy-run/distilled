...
export const CreateSetupIntentRequestBodyCase0 = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    metadata: S.optional(S.NullOr(CreateSetupIntentRequestBodyCase0MetadataMap)),
...
export const CreateSetupIntentRequestBodyCase1 = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    currency: S.optional(S.NullOr(Currencies)),
    email: S.optional(S.NullOr(S.String)),
    metadata: S.optional(S.NullOr(CreateSetupIntentRequestBodyCase1MetadataMap)),
...
export const CreateSetupIntentResponseCheckoutConfiguration = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.String,
  }),
).annotate({
...
export const CreateSetupIntentResponsePaymentMethodCard = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const CreateSetupIntentResponsePaymentMethodMailingAddress = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const CreateSetupIntentResponsePaymentMethod = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    created_at: S.String,
    id: S.String,
    mailing_address: S.NullOr(CreateSetupIntentResponsePaymentMethodMailingAddress),
    payment_method_type: PaymentMethodTypes,
  }),
).annotate({
...
export type SetupIntentStatuses = "processing" | "succeeded" | "canceled" | "requires_action";
...
export const CreateSetupIntentResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    checkout_configuration: S.NullOr(CreateSetupIntentResponseCheckoutConfiguration),
...
export const SetupIntentCheckoutConfiguration = CreateSetupIntentResponseCheckoutConfiguration;
...
/** The card data associated with the payment method, if its a debit or credit card. */
export type SetupIntentPaymentMethodCard = CreateSetupIntentResponsePaymentMethodCard;
export const SetupIntentPaymentMethodCard = CreateSetupIntentResponsePaymentMethodCard;
...
export type PaymentNextActionRedirectRenderList = Array<PaymentNextActionRedirectRenderItem>;
...
export const PaymentInstructions = S.Unknown as any as S.Schema<PaymentInstructions>;

/** Where this step can be presented: `inline` inside your own page, `full_page` as a top-level navigation. Pick whichever listed mode suits your surface. */
export type PaymentNextActionDisplayInstructionsRenderItem = "inline" | "full_page";
...
export const PaymentNextActionDisplayInstructionsRenderList = /*@__PURE__*/ S.Array(
...
/** Where this step can be presented: `inline` inside your own page, `full_page` as a top-level navigation. Pick whichever listed mode suits your surface. */
export type PaymentNextActionAwaitConfirmationRenderItem = "inline" | "full_page";
...
export const PaymentNextActionAwaitConfirmationRenderList = /*@__PURE__*/ S.Array(
...
export const PaymentNextAction = S.Unknown as any as S.Schema<PaymentNextAction>;
...
export type SetupStatusStatus = "processing" | "succeeded" | "canceled" | "requires_action";
...
export const SetupIntentListItemMemberUser = CreateSetupIntentResponseMemberUser;
...
/** The card data associated with the payment method, if its a debit or credit card. */
export type SetupIntentListItemPaymentMethodCard = CreateSetupIntentResponsePaymentMethodCard;
export const SetupIntentListItemPaymentMethodCard = CreateSetupIntentResponsePaymentMethodCard;
...
/** The saved payment method created by this setup intent. Null if the setup has not completed successfully. */
export type SetupIntentListItemPaymentMethod = CreateSetupIntentResponsePaymentMethod;
export const SetupIntentListItemPaymentMethod = CreateSetupIntentResponsePaymentMethod;
...
export type UpdateReturnUrlSetupIntentError = BadRequest | Forbidden | WhopOpError;
