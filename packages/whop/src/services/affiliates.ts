...
export const CreateOverrideAffiliateRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "POST", uri: "/affiliates/{id}/overrides", code: 200 })),
).annotate({
...
export const ListOverridesAffiliateRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "GET", uri: "/affiliates/{id}/overrides", code: 200 })),
).annotate({
...
/** A list of nodes. */
export type ListOverridesAffiliateResponseDataList = Array<ListOverridesAffiliateResponseDataItem>;
...
export const UnarchiveAffiliateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.String.pipe(T.Label()),
  }).pipe(T.Http({ method: "POST", uri: "/affiliates/{id}/unarchive", code: 200 })),
).annotate({
