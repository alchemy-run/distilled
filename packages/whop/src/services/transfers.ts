...
export const CreateTransferResponseBodyCase0CreatedByUser = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.String,
...
export const CreateTransferResponseBodyCase0DestinationCase0 = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.String,
...
export const CreateTransferResponseBodyCase0DestinationCase1 = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.String,
    name: S.optional(S.NullOr(S.String)),
    typename: CreateTransferResponseBodyCase0DestinationCase1Typename,
...
export const CreateTransferResponseBodyCase0OriginCase0 = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.String,
    route: S.optional(S.NullOr(S.String)),
    title: S.optional(S.NullOr(S.String)),
...
export const CreateTransferResponseBodyCase0OriginCase1 = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.String,
    name: S.optional(S.NullOr(S.String)),
    typename: CreateTransferResponseBodyCase0OriginCase1Typename,
...
export const CreateTransferResponseBodyCase1Destination = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    account_id: S.String,
    address: S.String,
  }),
...
export type CreateTransferResponseBodyCase1Source = CreateTransferResponseBodyCase1Destination;
export const CreateTransferResponseBodyCase1Source = CreateTransferResponseBodyCase1Destination;
...
export const CreateTransferResponseBody = S.Unknown as any as S.Schema<CreateTransferResponseBody>;
...
export const GetTransferResponseCreatedByUser = CreateTransferResponseBodyCase0CreatedByUser;
...
export const ListTransferRecipientsResponseDataItemCase0 = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.String,
...
export const ListTransferRecipientsResponseDataItemCase1 = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.String,
...
export type ListTransferRecipientsResponseDataList = Array<ListTransferRecipientsResponseDataItem>;
...
export type ListTransferRecipientsResponsePageInfo = ListTransferResponsePageInfo;
export const ListTransferRecipientsResponsePageInfo = ListTransferResponsePageInfo;
...
export type CreateTransferError = BadRequest | Forbidden | Conflict | WhopOpError;
...
export type ListTransferRecipientsError = BadRequest | Forbidden | NotFound | WhopOpError;
