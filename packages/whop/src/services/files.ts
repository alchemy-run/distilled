...
export type CompleteFileRequestMultipartPartsList = Array<CompleteFileRequestMultipartPartsItem>;
...
export const getFile: API.OperationMethod<GetFileRequest, File, GetFileError, WhopOpContext> =
  /*@__PURE__*/ API.make(() => ({
