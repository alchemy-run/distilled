...
export interface UpdateForumRequest {
  ...
  email_notification_preference?: ForumEmailNotificationPreferences | (string & {}) | null;
...
export const UpdateForumRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    email_notification_preference: S.optional(S.NullOr(ForumEmailNotificationPreferences)),
...
export const getForum: API.OperationMethod<GetForumRequest, Forum, GetForumError, WhopOpContext> =
  /*@__PURE__*/ API.make(() => ({
...
export type ListForumError = BadRequest | Forbidden | NotFound | UnprocessableEntity | WhopOpError;
