 ...
 * the schema generics.
 */
export type TursoOpError = DefaultErrors | ConfigError | HttpClientError.HttpClientError;
...
export const TursoProtocol: Layer.Layer<API.Protocol> = makeRestProtocol<Config>({
