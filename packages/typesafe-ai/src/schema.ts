/**
 * QUESTIONS — the combinators a judgment is written with, the schema
 * they compile into TypeSafe's question map, and the decode back into
 * the schema's own types. Asking lives next door, in `query.ts`.
 *
