...
export const ActivateSubscriptionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const CancelSubscriptionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export interface PaymentPreferences {
  ...
  setup_fee?: Money;
  /** The action to take on the subscription if the initial payment for the setup fails. */
  setup_fee_failure_action?: PaymentPreferencesSetupFeeFailureAction | (string & {});
...
/** The action to take on the subscription if the initial payment for the setup fails. */
export type PaymentPreferencesOverrideSetupFeeFailureAction = "CONTINUE" | "CANCEL";
...
export interface PaymentPreferencesOverride {
  ...
  setup_fee?: Money;
  /** The action to take on the subscription if the initial payment for the setup fails. */
  setup_fee_failure_action?: PaymentPreferencesOverrideSetupFeeFailureAction | (string & {});
  /** The maximum number of payment failures before a subscription is suspended. For example, if `payment_failure_threshold` is `2`, the subscription automatically updates to the `SUSPEND` state if two consecutive payments fail. */
  payment_failure_threshold?: number;
}
export const PaymentPreferencesOverride = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    auto_bill_outstanding: S.optional(S.Boolean),
    setup_fee: S.optional(Money),
    setup_fee_failure_action: S.optional(PaymentPreferencesOverrideSetupFeeFailureAction),
    payment_failure_threshold: S.optional(S.Number),
  }),
).annotate({
...
export const CreateSubscriptionRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "POST", uri: "/v1/billing/subscriptions", code: 200 })),
).annotate({
...
export const CardBrandList = /*@__PURE__*/ S.Array(CardBrand) as any as S.Schema<CardBrandList>;
...
/** The portable international postal address. Maps to [AddressValidationMetadata](https://github.com/googlei18n/libaddressinput/wiki/AddressValidationMetadata) and HTML 5.1 [Autofilling form controls: the autocomplete attribute](https://www.w3.org/TR/html51/sec-forms.html#autofilling-form-controls-the-autocomplete-attribute). */
export type CardResponseWithBillingAddressBillingAddress = ShippingDetailAddress;
export const CardResponseWithBillingAddressBillingAddress = ShippingDetailAddress;
...
export const PlanList = /*@__PURE__*/ S.Array(Plan) as any as S.Schema<PlanList>;
...
export const PatchRequest = /*@__PURE__*/ S.Array(Patch) as any as S.Schema<PatchRequest>;
...
export type UpdatePricingSchemeRequestListInput = Array<UpdatePricingSchemeRequestInput>;
...
export type SubscriptionsReviseRequestApplicationContextShippingPreference =
  ...
  | "NO_SHIPPING"
  | "SET_PROVIDED_ADDRESS";
export const SubscriptionsReviseRequestApplicationContextShippingPreference = S.String;
...
export const SubscriptionsReviseRequestApplicationContext = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    brand_name: S.optional(S.String),
    locale: S.optional(S.String),
    shipping_preference: S.optional(SubscriptionsReviseRequestApplicationContextShippingPreference),
    payment_method: S.optional(ApplicationContextPaymentMethod),
    return_url: S.String,
    cancel_url: S.String,
  }),
...
/** An array of request-related [HATEOAS links](/docs/api/reference/api-responses/#hateoas-links). */
export type SubscriptionReviseResponseDefinitionsLinkDescriptionList = Array<LinkDescription>;
export const SubscriptionReviseResponseDefinitionsLinkDescriptionList = /*@__PURE__*/ S.Array(
  LinkDescription,
...
export const SuspendSubscriptionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
  identifier: "SuspendSubscriptionResponse",
}) as any as S.Schema<SuspendSubscriptionResponse>;

export type ActivatePlanError = Forbidden | NotFound | UnprocessableEntity | PaypalOpError;
...
export type CreatePlanError = BadRequest | Forbidden | UnprocessableEntity | PaypalOpError;
...
export type CreateSubscriptionError = BadRequest | Forbidden | UnprocessableEntity | PaypalOpError;
...
export type DeactivatePlanError = Forbidden | NotFound | UnprocessableEntity | PaypalOpError;
...
export const getPlan: API.OperationMethod<GetPlanRequest, Plan, GetPlanError, PaypalOpContext> =
  /*@__PURE__*/ API.make(() => ({
...
export type SubscriptionsTransactionsError = BadRequest | Forbidden | NotFound | PaypalOpError;
