...
import { ModrinthProtocol, type ModrinthOpError, type ModrinthOpContext } from "../protocol.ts";
...
export const CheckProjectValidityRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id_slug: S.String.pipe(T.Label()),
  }).pipe(T.Http({ method: "GET", uri: "/project/{id_slug}/check", code: 200 })),
).annotate({
...
export type CreatableProjectClientSide = "required" | "optional" | "unsupported";
export const CreatableProjectClientSide = S.String;

/** Deprecated - use `environment` instead. */
export type CreatableProjectServerSide = "required" | "optional" | "unsupported";
...
export type VersionDependencyDependencyType = "required" | "optional" | "incompatible" | "embedded";
...
export type EditableVersionRequestedStatus = "listed" | "archived" | "draft" | "unlisted";
...
/** The requested status when submitting for review or scheduling the project for release. Approved status refers to "Public" visibility. */
export type ProjectRequestedStatus = "approved" | "archived" | "unlisted" | "private" | "draft";
...
/** Deprecated - use `environment` instead. */
export type ProjectClientSide = "required" | "optional" | "unsupported" | "unknown";
export const ProjectClientSide = S.String;

/** Deprecated - use `environment` instead. */
export type ProjectServerSide = "required" | "optional" | "unsupported" | "unknown";
...
export type CreatableVersionRequestedStatus = "listed" | "archived" | "draft" | "unlisted";
...
export type CreateVersionResponseRequestedStatus = "listed" | "archived" | "draft" | "unlisted";
...
export const CreateVersionResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    requested_status: S.optional(S.NullOr(CreateVersionResponseRequestedStatus)),
    id: S.String,
    project_id: S.String,
    author_id: S.String,
...
export const DeleteFileFromHashResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const DeleteGalleryImageRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "DELETE", uri: "/project/{id_slug}/gallery", code: 200 })),
).annotate({
...
export const DeleteNotificationsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const DeleteThreadMessageResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const GetFollowedProjectsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id_username: S.String.pipe(T.Label()),
  }).pipe(T.Http({ method: "GET", uri: "/user/{id_username}/follows", code: 200 })),
).annotate({
...
export const GetLatestVersionFromHashRequestGameVersionsList = /*@__PURE__*/ S.Array(
  S.String,
...
/** A list of specific versions of projects that this version depends on */
export type GetLatestVersionFromHashResponseDependenciesList = Array<VersionDependency>;
export const GetLatestVersionFromHashResponseDependenciesList = /*@__PURE__*/ S.Array(
  VersionDependency,
...
export const GetLatestVersionFromHashResponseGameVersionsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<GetLatestVersionFromHashResponseGameVersionsList>;

/** The release channel for this version */
export type GetLatestVersionFromHashResponseVersionType = "release" | "beta" | "alpha";
...
export const GetLatestVersionFromHashResponseLoadersList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetLatestVersionFromHashResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    requested_status: S.optional(S.NullOr(GetLatestVersionFromHashResponseRequestedStatus)),
    id: S.String,
    project_id: S.String,
    author_id: S.String,
    date_published: S.String,
...
export const GetLatestVersionsFromHashesRequestHashesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetLatestVersionsFromHashesRequestLoadersList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetLatestVersionsFromHashesRequestGameVersionsList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetProjectTeamMembersRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id_slug: S.String.pipe(T.Label()),
  }).pipe(T.Http({ method: "GET", uri: "/project/{id_slug}/members", code: 200 })),
).annotate({
...
export type GetProjectTeamMembersResponse = GetProjectTeamMembersResponseBodyList;
...
export const GetProjectVersionsRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "GET", uri: "/project/{id_slug}/version", code: 200 })),
).annotate({
...
/** The type of message */
export type ThreadMessageBodyType = "status_change" | "text" | "thread_closure" | "deleted";
...
export const ThreadMembersList = /*@__PURE__*/ S.Array(User) as any as S.Schema<ThreadMembersList>;
...
export const GetUserFromAuthResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    role: GetUserFromAuthResponseRole,
    badges: S.optional(S.Number),
    auth_providers: S.optional(S.NullOr(GetUserFromAuthResponseAuthProvidersList)),
    email_verified: S.optional(S.NullOr(S.Boolean)),
    has_password: S.optional(S.NullOr(S.Boolean)),
    has_totp: S.optional(S.NullOr(S.Boolean)),
    github_id: S.optional(S.NullOr(S.Number)),
...
export type GetVersionResponseRequestedStatus = "listed" | "archived" | "draft" | "unlisted";
...
/** A list of specific versions of projects that this version depends on */
export type GetVersionFromIdOrNumberResponseDependenciesList = Array<VersionDependency>;
export const GetVersionFromIdOrNumberResponseDependenciesList = /*@__PURE__*/ S.Array(
  VersionDependency,
...
export const GetVersionFromIdOrNumberResponseGameVersionsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<GetVersionFromIdOrNumberResponseGameVersionsList>;

/** The release channel for this version */
export type GetVersionFromIdOrNumberResponseVersionType = "release" | "beta" | "alpha";
...
export const GetVersionFromIdOrNumberResponseLoadersList = /*@__PURE__*/ S.Array(
  S.String,
...
export const GetVersionFromIdOrNumberResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    requested_status: S.optional(S.NullOr(GetVersionFromIdOrNumberResponseRequestedStatus)),
    id: S.String,
    project_id: S.String,
    author_id: S.String,
    date_published: S.String,
...
export const ListDonationPlatformRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}).pipe(T.Http({ method: "GET", uri: "/tag/donation_platform", code: 200 })),
).annotate({
...
export const ModifyGalleryImageRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    description: S.optional(S.String.pipe(T.Query())),
    ordering: S.optional(S.Number.pipe(T.Query())),
  }).pipe(T.Http({ method: "PATCH", uri: "/project/{id_slug}/gallery", code: 200 })),
).annotate({
...
export const ModifyGalleryImageResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const ModifyProjectRequestAdditionalCategoriesList = /*@__PURE__*/ S.Array(
  S.String,
...
/** Deprecated - use `environment` instead. */
export type ModifyProjectRequestClientSide = "required" | "optional" | "unsupported";
export const ModifyProjectRequestClientSide = S.String;

/** Deprecated - use `environment` instead. */
export type ModifyProjectRequestServerSide = "required" | "optional" | "unsupported";
...
export const ModifyProjectRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    additional_categories: S.optional(ModifyProjectRequestAdditionalCategoriesList),
...
export type ModifyVersionRequestRequestedStatus = "listed" | "archived" | "draft" | "unlisted";
...
export type ProjectResultAllProjectTypesList = Array<ProjectResultAllProjectTypesItem>;
...
export type ProjectResultClientSide = "required" | "optional" | "unsupported" | "unknown";
export const ProjectResultClientSide = S.String;

/** Deprecated - use `environment` instead. The server side support of the project */
export type ProjectResultServerSide = "required" | "optional" | "unsupported" | "unknown";
...
/** The type of message */
export type SendThreadMessageRequestType = "status_change" | "text" | "thread_closure" | "deleted";
...
export const TransferTeamOwnershipResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const UpdateProjectsRequestAdditionalCategoriesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateProjectsRequestAddAdditionalCategoriesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const UpdateProjectsRequestRemoveAdditionalCategoriesList = /*@__PURE__*/ S.Array(
  S.String,
...
export type UpdateProjectsRequestAddDonationUrlsList = Array<ProjectDonationURL>;
...
export type UpdateProjectsRequestRemoveDonationUrlsList = Array<ProjectDonationURL>;
export const UpdateProjectsRequestRemoveDonationUrlsList = /*@__PURE__*/ S.Array(
  ProjectDonationURL,
...
export const UpdateProjectsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    additional_categories: S.optional(UpdateProjectsRequestAdditionalCategoriesList),
    add_additional_categories: S.optional(UpdateProjectsRequestAddAdditionalCategoriesList),
    remove_additional_categories: S.optional(UpdateProjectsRequestRemoveAdditionalCategoriesList),
    ...
    remove_donation_urls: S.optional(UpdateProjectsRequestRemoveDonationUrlsList),
    issues_url: S.optional(S.NullOr(S.String)),
    source_url: S.optional(S.NullOr(S.String)),
    wiki_url: S.optional(S.NullOr(S.String)),
    discord_url: S.optional(S.NullOr(S.String)),
...
export type VersionFromHashResponseRequestedStatus = "listed" | "archived" | "draft" | "unlisted";
...
export const VersionFromHashResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    requested_status: S.optional(S.NullOr(VersionFromHashResponseRequestedStatus)),
    id: S.String,
    project_id: S.String,
    author_id: S.String,
    date_published: S.String,
...
export type GetLatestVersionFromHashError = BadRequest | NotFound | ModrinthOpError;
