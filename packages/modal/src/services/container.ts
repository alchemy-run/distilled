...
export const ContainerCheckpointResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const ContainerExecPutInputResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const ContainerReloadVolumesResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
...
export const ExecContainerFilesystemRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    fileWriteReplaceBytesRequest: S.optional(ContainerFileWriteReplaceBytesRequest),
