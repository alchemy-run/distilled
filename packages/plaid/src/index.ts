/**
 * @distilled.cloud/plaid — Plaid SDK for Effect.
 *
 ...
 *
 * const institutions = yield* Plaid.Services.plaid.institutionsGet({});
 * ```
 */
export * from "./credentials.ts";
export * from "./errors.ts";
export * as T from "./traits.ts";
export { PlaidProtocol, type PlaidOpError, type PlaidOpContext } from "./protocol.ts";
...
export * from "./services/plaid.ts";
export { BadRequest } from "./services/plaid.ts";
