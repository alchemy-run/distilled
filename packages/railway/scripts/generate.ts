...
const operationAliases = Object.fromEntries(operationNames.map((name) => [toVerbNoun(name), name]));
...
console.log(`GraphQL: generated ${operationNames.length} selective operations → src/graphql.ts`);
