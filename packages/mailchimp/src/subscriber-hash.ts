 ...
 *
 * Pure TypeScript because Web Crypto has no MD5, and this has to run in a
 * Cloudflare Worker without `node:crypto`.
 */
...
/** Lowercase hex MD5 of the UTF-8 bytes of `input`. */
...
/** The `subscriber_hash` path segment for `email`. */
