/**
 * @distilled.cloud/squarespace — Squarespace Commerce SDK for Effect.
 *
 ...
 *
 * const products = yield* Squarespace.Services.squarespace.getProducts({});
 * ```
 */
...
export * from "./services/squarespace.ts";
export { BadRequest, Conflict, Forbidden, NotFound } from "./services/squarespace.ts";
