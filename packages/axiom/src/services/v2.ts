...
import { AxiomProtocol, type AxiomOpError, type AxiomOpContext } from "../protocol.ts";
...
export const StatisticChartShowChart = S.Unknown as any as S.Schema<StatisticChartShowChart>;

export type StatisticChartChartHeight = string | number;
export const StatisticChartChartHeight = S.Unknown as any as S.Schema<StatisticChartChartHeight>;
...
export const SmartFilterOptions = S.Unknown as any as S.Schema<SmartFilterOptions>;
...
export const SmartFilterConfig = S.Unknown as any as S.Schema<SmartFilterConfig>;
...
export const DashboardResourceVersion = S.Unknown as any as S.Schema<DashboardResourceVersion>;
...
>;
export const RoleDatasetCapabilitiesValueStarredQueriesList = /*@__PURE__*/ S.Array(
...
>;
export const RoleDatasetCapabilitiesValueVirtualFieldsList = /*@__PURE__*/ S.Array(
...
export const MapFields = /*@__PURE__*/ S.Array(S.String) as any as S.Schema<MapFields>;
...
export const RegenerateAPITokenRequest = /*@__PURE__*/ S.suspend(() =>
  ...
  }).pipe(T.Http({ method: "POST", uri: "/v2/tokens/{id}/regenerate", code: 200 })),
).annotate({
...
export const createOrg: API.OperationMethod<CreateOrgRequest, Org, CreateOrgError, AxiomOpContext> =
  /*@__PURE__*/ API.make(() => ({
...
export const getOrg: API.OperationMethod<GetOrgRequest, Org, GetOrgError, AxiomOpContext> =
  /*@__PURE__*/ API.make(() => ({
    input: GetOrgRequest,
    output: Org,
    errors: [NotFound, UnknownAxiomError],
...
/** Get user by ID */
export const getUser: API.OperationMethod<GetUserRequest, User, GetUserError, AxiomOpContext> =
  /*@__PURE__*/ API.make(() => ({
...
export const getView: API.OperationMethod<GetViewRequest, View, GetViewError, AxiomOpContext> =
  /*@__PURE__*/ API.make(() => ({
...
export const updateOrg: API.OperationMethod<UpdateOrgRequest, Org, UpdateOrgError, AxiomOpContext> =
  /*@__PURE__*/ API.make(() => ({
