...
export type CreateTreeRequestTreeItemMode = "100644" | "100755" | "040000" | "160000" | "120000";
...
export type CreateCommitError = NotFound | Conflict | UnprocessableEntity | GithubOpError;
...
export type CreateTreeError = Forbidden | NotFound | Conflict | UnprocessableEntity | GithubOpError;
...
export type GetBlobError = Forbidden | NotFound | Conflict | UnprocessableEntity | GithubOpError;
...
export const getBlob: API.OperationMethod<GetBlobRequest, Blob, GetBlobError, GithubOpContext> =
  /*@__PURE__*/ API.make(() => ({
...
export const getRef: API.OperationMethod<GetRefRequest, GitRef, GetRefError, GithubOpContext> =
  /*@__PURE__*/ API.make(() => ({
    input: GetRefRequest,
    output: GitRef,
    errors: [NotFound, Conflict],
...
export const getTag: API.OperationMethod<GetTagRequest, GitTag, GetTagError, GithubOpContext> =
  /*@__PURE__*/ API.make(() => ({
    input: GetTagRequest,
    output: GitTag,
    errors: [NotFound, Conflict],
...
export type GetTreeError = NotFound | Conflict | UnprocessableEntity | GithubOpError;
...
export const getTree: API.OperationMethod<GetTreeRequest, GitTree, GetTreeError, GithubOpContext> =
  /*@__PURE__*/ API.make(() => ({
