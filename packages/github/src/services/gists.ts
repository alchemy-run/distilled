...
export const CreateRequestPublic = S.Unknown as any as S.Schema<CreateRequestPublic>;
...
export const StarResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
  identifier: "StarResponse",
}) as any as S.Schema<StarResponse>;
...
export const UnstarRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    gist_id: S.String.pipe(T.Label()),
  }).pipe(T.Http({ method: "DELETE", uri: "/gists/{gist_id}/star", code: 200 })),
).annotate({ identifier: "UnstarRequest" }) as any as S.Schema<UnstarRequest>;

export interface UnstarResponse {}
export const UnstarResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
  identifier: "UnstarResponse",
}) as any as S.Schema<UnstarResponse>;
...
export type CreateError = Forbidden | NotFound | UnprocessableEntity | GithubOpError;
...
export const create: API.OperationMethod<CreateRequest, GistSimple, CreateError, GithubOpContext> =
  /*@__PURE__*/ API.make(() => ({
    input: CreateRequest,
    output: GistSimple,
...
export type ForkError = Forbidden | NotFound | UnprocessableEntity | GithubOpError;
/** Fork a gist */
export const fork: API.OperationMethod<ForkRequest, BaseGist, ForkError, GithubOpContext> =
  /*@__PURE__*/ API.make(() => ({
    input: ForkRequest,
    output: BaseGist,
    errors: [Forbidden, NotFound, UnprocessableEntity],
...
export const get: API.OperationMethod<GetRequest, GistSimple, GetError, GithubOpContext> =
  /*@__PURE__*/ API.make(() => ({
    input: GetRequest,
    output: GistSimple,
    errors: [Forbidden, NotFound],
...
export type GetRevisionError = Forbidden | NotFound | UnprocessableEntity | GithubOpError;
...
export const star: API.OperationMethod<StarRequest, StarResponse, StarError, GithubOpContext> =
  /*@__PURE__*/ API.make(() => ({
    input: StarRequest,
    output: StarResponse,
    errors: [Forbidden, NotFound],
...
export const update: API.OperationMethod<UpdateRequest, GistSimple, UpdateError, GithubOpContext> =
  /*@__PURE__*/ API.make(() => ({
    input: UpdateRequest,
    output: GistSimple,
