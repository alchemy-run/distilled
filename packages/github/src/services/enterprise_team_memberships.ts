...
export const RemoveResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
  identifier: "RemoveResponse",
}) as any as S.Schema<RemoveResponse>;

export type AddError = GithubOpError;
/** Add team member Add a team member to an enterprise team. */
export const add: API.OperationMethod<AddRequest, SimpleUser, AddError, GithubOpContext> =
  /*@__PURE__*/ API.make(() => ({
    input: AddRequest,
    output: SimpleUser,
    errors: [],
...
export const get: API.OperationMethod<GetRequest, SimpleUser, GetError, GithubOpContext> =
  /*@__PURE__*/ API.make(() => ({
    input: GetRequest,
    output: SimpleUser,
    errors: [],
