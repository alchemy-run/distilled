...
// Input Schema
export const MachinesListVersionsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  app_name: Schema.String.pipe(T.PathParam()),
  machine_id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/apps/{app_name}/machines/{machine_id}/versions" }));
export type MachinesListVersionsInput = typeof MachinesListVersionsInput.Type;

// Output Schema
export const MachinesListVersionsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Array(Schema.Struct({
  user_config: Schema.optional(Schema.Struct({
