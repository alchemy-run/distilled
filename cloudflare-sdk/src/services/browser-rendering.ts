...
export interface CreateContentRequest {
  ...
  cookies?: ({ name: string; value: string; domain?: string; expires?: number; httpOnly?: boolean; partitionKey?: string; path?: string; priority?: "Low" | "Medium" | "High"; sameParty?: boolean; sameSite?: "Strict" | "Lax" | "None"; secure?: boolean; sourcePort?: number; sourceScheme?: "Unset" | "NonSecure" | "Secure"; url?: string })[];
  /** Body param: */
  emulateMediaType?: string;
  /** Body param: Check [options](https://pptr.dev/api/puppeteer.gotooptions). */
  gotoOptions?: { referer?: string; referrerPolicy?: string; timeout?: number; waitUntil?: "load" | "domcontentloaded" | "networkidle0" | "networkidle2" | ("load" | "domcontentloaded" | "networkidle0" | "networkidle2")[] };
  ...
  viewport?: { height: number; width: number; deviceScaleFactor?: number; hasTouch?: boolean; isLandscape?: boolean; isMobile?: boolean };
...
export const CreateContentRequest = Schema.Struct({
  ...
  allowResourceTypes: Schema.optional(Schema.Array(Schema.Literals(["document", "stylesheet", "image", "media", "font", "script", "texttrack", "xhr", "fetch", "prefetch", "eventsource", "websocket", "manifest", "signedexchange", "ping", "cspviolationreport", "preflight", "other"]))),
  ...
  sourceScheme: Schema.optional(Schema.Literals(["Unset", "NonSecure", "Secure"])),
  url: Schema.optional(Schema.String)
}))),
  ...
  waitUntil: Schema.optional(Schema.Union([Schema.Literal("load"), Schema.Literal("domcontentloaded"), Schema.Literal("networkidle0"), Schema.Literal("networkidle2"), Schema.Array(Schema.Literals(["load", "domcontentloaded", "networkidle0", "networkidle2"]))]))
})),
  rejectRequestPattern: Schema.optional(Schema.Array(Schema.String)),
  rejectResourceTypes: Schema.optional(Schema.Array(Schema.Literals(["document", "stylesheet", "image", "media", "font", "script", "texttrack", "xhr", "fetch", "prefetch", "eventsource", "websocket", "manifest", "signedexchange", "ping", "cspviolationreport", "preflight", "other"]))),
  ...
  .pipe(T.Http({ method: "POST", path: "/accounts/{account_id}/browser-rendering/content" })) as unknown as Schema.Schema<CreateContentRequest>;

export type CreateContentResponse = string;

export const CreateContentResponse = Schema.String as unknown as Schema.Schema<CreateContentResponse>;
...
export const CreateJsonRequest = Schema.Struct({
  ...
  customAi: Schema.optional(Schema.Array(Schema.Struct({
  ...
  type: Schema.String,
  jsonSchema: Schema.optional(Schema.Union([Schema.Struct({}), Schema.Null]))
  ...
  .pipe(Schema.encodeKeys({ html: "html", actionTimeout: "actionTimeout", addScriptTag: "addScriptTag", addStyleTag: "addStyleTag", allowRequestPattern: "allowRequestPattern", allowResourceTypes: "allowResourceTypes", authenticate: "authenticate", bestAttempt: "bestAttempt", cookies: "cookies", customAi: "custom_ai", emulateMediaType: "emulateMediaType", gotoOptions: "gotoOptions", prompt: "prompt", rejectRequestPattern: "rejectRequestPattern", rejectResourceTypes: "rejectResourceTypes", responseFormat: "response_format", setExtraHTTPHeaders: "setExtraHTTPHeaders", setJavaScriptEnabled: "setJavaScriptEnabled", userAgent: "userAgent", viewport: "viewport", waitForSelector: "waitForSelector", waitForTimeout: "waitForTimeout" }), T.Http({ method: "POST", path: "/accounts/{account_id}/browser-rendering/json" })) as unknown as Schema.Schema<CreateJsonRequest>;
...
export const CreateLinkRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/accounts/{account_id}/browser-rendering/links" })) as unknown as Schema.Schema<CreateLinkRequest>;

export type CreateLinkResponse = string[];

export const CreateLinkResponse = Schema.Array(Schema.String) as unknown as Schema.Schema<CreateLinkResponse>;
...
export const CreateMarkdownRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/accounts/{account_id}/browser-rendering/markdown" })) as unknown as Schema.Schema<CreateMarkdownRequest>;

export type CreateMarkdownResponse = string;

export const CreateMarkdownResponse = Schema.String as unknown as Schema.Schema<CreateMarkdownResponse>;
...
export interface CreatePdfRequest {
  ...
  pdfOptions?: { displayHeaderFooter?: boolean; footerTemplate?: string; format?: "letter" | "legal" | "tabloid" | "ledger" | "a0" | "a1" | "a2" | "a3" | "a4" | "a5" | "a6"; headerTemplate?: string; height?: string | number; landscape?: boolean; margin?: { bottom?: string | number; left?: string | number; right?: string | number; top?: string | number }; omitBackground?: boolean; outline?: boolean; pageRanges?: string; preferCSSPageSize?: boolean; printBackground?: boolean; scale?: number; tagged?: boolean; timeout?: number; width?: string | number };
  /** Body param: Block undesired requests that match the provided regex patterns, eg. '/^.\ \.(css)'. */
  rejectRequestPattern?: string[];
  /** Body param: Block undesired requests that match the provided resource types, eg. 'image' or 'script'. */
  rejectResourceTypes?: ("document" | "stylesheet" | "image" | "media" | "font" | "script" | "texttrack" | "xhr" | "fetch" | "prefetch" | "eventsource" | "websocket" | "manifest" | "signedexchange" | "ping" | "cspviolationreport" | "preflight" | "other")[];
...
export const CreatePdfRequest = Schema.Struct({
  ...
  format: Schema.optional(Schema.Literals(["letter", "legal", "tabloid", "ledger", "a0", "a1", "a2", "a3", "a4", "a5", "a6"])),
  ...
  .pipe(T.Http({ method: "POST", path: "/accounts/{account_id}/browser-rendering/pdf" })) as unknown as Schema.Schema<CreatePdfRequest>;
...
export const CreateScrapeRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/accounts/{account_id}/browser-rendering/scrape" })) as unknown as Schema.Schema<CreateScrapeRequest>;

export type CreateScrapeResponse = { results: { attributes: { name: string; value: string }[]; height: number; html: string; left: number; text: string; top: number; width: number }; selector: string }[];

export const CreateScrapeResponse = Schema.Array(Schema.Struct({
...
export interface CreateScreenshotRequest {
  ...
  screenshotOptions?: { captureBeyondViewport?: boolean; clip?: { height: number; width: number; x: number; y: number; scale?: number }; encoding?: "binary" | "base64"; fromSurface?: boolean; fullPage?: boolean; omitBackground?: boolean; optimizeForSpeed?: boolean; quality?: number; type?: "png" | "jpeg" | "webp" };
  /** Body param: */
  scrollPage?: boolean;
  /** Body param: */
  selector?: string;
...
export const CreateScreenshotRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/accounts/{account_id}/browser-rendering/screenshot" })) as unknown as Schema.Schema<CreateScreenshotRequest>;
...
export type CreateScreenshotError =
  | DefaultErrors;
...
export interface CreateSnapshotRequest {
  ...
  rejectResourceTypes?: ("document" | "stylesheet" | "image" | "media" | "font" | "script" | "texttrack" | "xhr" | "fetch" | "prefetch" | "eventsource" | "websocket" | "manifest" | "signedexchange" | "ping" | "cspviolationreport" | "preflight" | "other")[];
  /** Body param: */
  screenshotOptions?: { captureBeyondViewport?: boolean; clip?: { height: number; width: number; x: number; y: number; scale?: number }; fromSurface?: boolean; fullPage?: boolean; omitBackground?: boolean; optimizeForSpeed?: boolean; quality?: number; type?: "png" | "jpeg" | "webp" };
  /** Body param: */
  setExtraHTTPHeaders?: Record<string, unknown>;
  /** Body param: */
  setJavaScriptEnabled?: boolean;
...
export const CreateSnapshotRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/accounts/{account_id}/browser-rendering/snapshot" })) as unknown as Schema.Schema<CreateSnapshotRequest>;
