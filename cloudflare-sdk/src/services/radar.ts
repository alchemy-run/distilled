...
export const UserAgentAiBotSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/ai/bots/summary/user_agent" })) as unknown as Schema.Schema<UserAgentAiBotSummaryRequest>;

export interface UserAgentAiBotSummaryResponse {
  /** Metadata for the results. */
  meta: { confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
...
export const UserAgentAiBotSummaryResponse = Schema.Struct({
  ...
  confidenceInfo: Schema.Struct({
    annotations: Schema.Array(Schema.Struct({
      dataSource: Schema.Literals(["ALL", "AI_BOTS", "AI_GATEWAY", "BGP", "BOTS", "CONNECTION_ANOMALY", "CT", "DNS", "DNS_MAGNITUDE", "DNS_AS112", "DOS", "EMAIL_ROUTING", "EMAIL_SECURITY", "FW", "FW_PG", "HTTP", "HTTP_CONTROL", "HTTP_CRAWLER_REFERER", "HTTP_ORIGINS", "IQI", "LEAKED_CREDENTIALS", "NET", "ROBOTS_TXT", "SPEED", "WORKERS_AI"]),
      description: Schema.String,
      endDate: Schema.String,
      eventType: Schema.Literals(["EVENT", "GENERAL", "OUTAGE", "PARTIAL_PROJECTION", "PIPELINE", "TRAFFIC_ANOMALY"]),
  ...
  normalization: Schema.Literals(["PERCENTAGE", "MIN0_MAX", "MIN_MAX", "RAW_VALUES", "PERCENTAGE_CHANGE", "ROLLING_AVERAGE", "OVERLAPPED_PERCENTAGE", "RATIO"]),
...
export type UserAgentAiBotSummaryError =
  | DefaultErrors;
...
export const UserAgentAiTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/ai/bots/timeseries_groups/user_agent" })) as unknown as Schema.Schema<UserAgentAiTimeseriesGroupRequest>;

export interface UserAgentAiTimeseriesGroupResponse {
  /** Metadata for the results. */
  meta: { aggInterval: "FIFTEEN_MINUTES" | "ONE_HOUR" | "ONE_DAY" | "ONE_WEEK" | "ONE_MONTH"; confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  serie_0: { timestamps: string[] };
}

export const UserAgentAiTimeseriesGroupResponse = Schema.Struct({
  meta: Schema.Struct({
  aggInterval: Schema.Literals(["FIFTEEN_MINUTES", "ONE_HOUR", "ONE_DAY", "ONE_WEEK", "ONE_MONTH"]),
  confidenceInfo: Schema.Struct({
    annotations: Schema.Array(Schema.Struct({
      dataSource: Schema.Literals(["ALL", "AI_BOTS", "AI_GATEWAY", "BGP", "BOTS", "CONNECTION_ANOMALY", "CT", "DNS", "DNS_MAGNITUDE", "DNS_AS112", "DOS", "EMAIL_ROUTING", "EMAIL_SECURITY", "FW", "FW_PG", "HTTP", "HTTP_CONTROL", "HTTP_CRAWLER_REFERER", "HTTP_ORIGINS", "IQI", "LEAKED_CREDENTIALS", "NET", "ROBOTS_TXT", "SPEED", "WORKERS_AI"]),
      description: Schema.String,
...
export type UserAgentAiTimeseriesGroupError =
  | DefaultErrors;
...
export const TimeseriesAiBotRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/ai/bots/timeseries" })) as unknown as Schema.Schema<TimeseriesAiBotRequest>;
...
export type TimeseriesAiBotError =
  | DefaultErrors;
...
export const ModelAiInferenceSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/ai/inference/summary/model" })) as unknown as Schema.Schema<ModelAiInferenceSummaryRequest>;
...
export type ModelAiInferenceSummaryError =
  | DefaultErrors;
...
export const TaskAiInferenceSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/ai/inference/summary/task" })) as unknown as Schema.Schema<TaskAiInferenceSummaryRequest>;
...
export type TaskAiInferenceSummaryError =
  | DefaultErrors;
...
export const ModelAiInferenceTimeseriesGroupSummaryRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/ai/inference/timeseries_groups/model" })) as unknown as Schema.Schema<ModelAiInferenceTimeseriesGroupSummaryRequest>;
...
export type ModelAiInferenceTimeseriesGroupSummaryError =
  | DefaultErrors;
...
export const TaskAiInferenceTimeseriesGroupSummaryRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/ai/inference/timeseries_groups/task" })) as unknown as Schema.Schema<TaskAiInferenceTimeseriesGroupSummaryRequest>;
...
export type TaskAiInferenceTimeseriesGroupSummaryError =
  | DefaultErrors;
...
export const SummaryAiTimeseriesGroupRequest = Schema.Struct({
  dimension: Schema.Literals(["USER_AGENT", "CRAWL_PURPOSE", "INDUSTRY", "VERTICAL"]).pipe(T.HttpPath("dimension"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/ai/bots/summary/{dimension}" })) as unknown as Schema.Schema<SummaryAiTimeseriesGroupRequest>;
...
export type SummaryAiTimeseriesGroupError =
  | DefaultErrors;
...
export const TimeseriesAiTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/ai/bots/timeseries" })) as unknown as Schema.Schema<TimeseriesAiTimeseriesGroupRequest>;
...
export type TimeseriesAiTimeseriesGroupError =
  | DefaultErrors;
...
export const CreateAiToMarkdownRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/accounts/{account_id}/ai/tomarkdown" })) as unknown as Schema.Schema<CreateAiToMarkdownRequest>;

export type CreateAiToMarkdownResponse = { data: string; format: string; mimeType: string; name: string; tokens: string }[];

export const CreateAiToMarkdownResponse = Schema.Array(Schema.Struct({
  data: Schema.String,
...
export type CreateAiToMarkdownError =
  | DefaultErrors;
...
export const ListAnnotationsRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/annotations" })) as unknown as Schema.Schema<ListAnnotationsRequest>;

export interface ListAnnotationsResponse {
  annotations: { id: string; asns: number[]; asnsDetails: { asn: string; name: string; locations?: { code: string; name: string } }[]; dataSource: string; eventType: string; locations: string[]; locationsDetails: { code: string; name: string }[]; origins: string[]; originsDetails: { name: string; origin: string }[]; outage: { outageCause: string; outageType: string }; startDate: string; description?: string; endDate?: string; linkedUrl?: string; scope?: string }[];
}
...
export const ListAnnotationsResponse = Schema.Struct({
  ...
  originsDetails: Schema.Array(Schema.Struct({
    name: Schema.String,
...
export const GetAnnotationOutageRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/annotations/outages" })) as unknown as Schema.Schema<GetAnnotationOutageRequest>;
...
export type GetAnnotationOutageError =
  | DefaultErrors;
...
export const LocationsAnnotationOutageRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/annotations/outages/locations" })) as unknown as Schema.Schema<LocationsAnnotationOutageRequest>;
...
export type LocationsAnnotationOutageError =
  | DefaultErrors;
...
export const MatchingAnswerDnsSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/summary/matching_answer" })) as unknown as Schema.Schema<MatchingAnswerDnsSummaryRequest>;
...
export type MatchingAnswerDnsSummaryError =
  | DefaultErrors;
...
export const MatchingAnswerDnsTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/timeseries_groups/matching_answer" })) as unknown as Schema.Schema<MatchingAnswerDnsTimeseriesGroupRequest>;
...
export type MatchingAnswerDnsTimeseriesGroupError =
  | DefaultErrors;
...
export const TimeseriesAs112Request = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/as112/timeseries" })) as unknown as Schema.Schema<TimeseriesAs112Request>;
...
export type TimeseriesAs112Error =
  | DefaultErrors;
...
export const DnssecAs112SummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/as112/summary/dnssec" })) as unknown as Schema.Schema<DnssecAs112SummaryRequest>;
...
}).pipe(Schema.encodeKeys({ nOT_SUPPORTED: "NOT_SUPPORTED", sUPPORTED: "SUPPORTED" }))
}) as unknown as Schema.Schema<DnssecAs112SummaryResponse>;

export type DnssecAs112SummaryError =
  | DefaultErrors;
...
export const EdnsAs112SummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/as112/summary/edns" })) as unknown as Schema.Schema<EdnsAs112SummaryRequest>;
...
export type EdnsAs112SummaryError =
  | DefaultErrors;
...
export const ProtocolAs112SummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/as112/summary/protocol" })) as unknown as Schema.Schema<ProtocolAs112SummaryRequest>;
...
export type ProtocolAs112SummaryError =
  | DefaultErrors;
...
export const DnssecAs112TimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/as112/timeseries_groups/dnssec" })) as unknown as Schema.Schema<DnssecAs112TimeseriesGroupRequest>;
...
export type DnssecAs112TimeseriesGroupError =
  | DefaultErrors;
...
export const EdnsAs112TimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/as112/timeseries_groups/edns" })) as unknown as Schema.Schema<EdnsAs112TimeseriesGroupRequest>;
...
export type EdnsAs112TimeseriesGroupError =
  | DefaultErrors;
...
export const ProtocolAs112TimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/as112/timeseries_groups/protocol" })) as unknown as Schema.Schema<ProtocolAs112TimeseriesGroupRequest>;
...
export type ProtocolAs112TimeseriesGroupError =
  | DefaultErrors;
...
export const DnssecAs112TopRequest = Schema.Struct({
  dnssec: Schema.Literals(["SUPPORTED", "NOT_SUPPORTED"]).pipe(T.HttpPath("dnssec"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/as112/top/locations/dnssec/{dnssec}" })) as unknown as Schema.Schema<DnssecAs112TopRequest>;

export interface DnssecAs112TopResponse {
  /** Metadata for the results. */
  meta: { confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number } | null; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  top_0: { clientCountryAlpha2: string; clientCountryName: string; value: string }[];
}

export const DnssecAs112TopResponse = Schema.Struct({
  meta: Schema.Struct({
  confidenceInfo: Schema.Union([Schema.Struct({
    annotations: Schema.Array(Schema.Struct({
      dataSource: Schema.Literals(["ALL", "AI_BOTS", "AI_GATEWAY", "BGP", "BOTS", "CONNECTION_ANOMALY", "CT", "DNS", "DNS_MAGNITUDE", "DNS_AS112", "DOS", "EMAIL_ROUTING", "EMAIL_SECURITY", "FW", "FW_PG", "HTTP", "HTTP_CONTROL", "HTTP_CRAWLER_REFERER", "HTTP_ORIGINS", "IQI", "LEAKED_CREDENTIALS", "NET", "ROBOTS_TXT", "SPEED", "WORKERS_AI"]),
      description: Schema.String,
      endDate: Schema.String,
...
export type DnssecAs112TopError =
  | DefaultErrors;
...
export const EdnsAs112TopRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/as112/top/locations/edns/{edns}" })) as unknown as Schema.Schema<EdnsAs112TopRequest>;
...
export const LocationsAs112TopRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/as112/top/locations" })) as unknown as Schema.Schema<LocationsAs112TopRequest>;
...
export type LocationsAs112TopError =
  | DefaultErrors;
...
export const TimeseriesAttackLayer3Request = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/timeseries" })) as unknown as Schema.Schema<TimeseriesAttackLayer3Request>;
...
export type TimeseriesAttackLayer3Error =
  | DefaultErrors;
...
export const BitrateAttackLayer3SummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/summary/bitrate" })) as unknown as Schema.Schema<BitrateAttackLayer3SummaryRequest>;

export interface BitrateAttackLayer3SummaryResponse {
  /** Metadata for the results. */
  meta: { confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  summary_0: { _1_GBPS_TO_10_GBPS: string; _10_GBPS_TO_100_GBPS: string; _500_MBPS_TO_1_GBPS: string; oVER_100_GBPS: string; uNDER_500_MBPS: string };
}
...
}).pipe(Schema.encodeKeys({ _1_GBPS_TO_10_GBPS: "_1_GBPS_TO_10_GBPS", _10_GBPS_TO_100_GBPS: "_10_GBPS_TO_100_GBPS", _500_MBPS_TO_1_GBPS: "_500_MBPS_TO_1_GBPS", oVER_100_GBPS: "OVER_100_GBPS", uNDER_500_MBPS: "UNDER_500_MBPS" }))
}) as unknown as Schema.Schema<BitrateAttackLayer3SummaryResponse>;

export type BitrateAttackLayer3SummaryError =
  | DefaultErrors;
...
export const DurationAttackLayer3SummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/summary/duration" })) as unknown as Schema.Schema<DurationAttackLayer3SummaryRequest>;

export interface DurationAttackLayer3SummaryResponse {
  /** Metadata for the results. */
  meta: { confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  summary_0: { _1_HOUR_TO_3_HOURS: string; _10_MINS_TO_20_MINS: string; _20_MINS_TO_40_MINS: string; _40_MINS_TO_1_HOUR: string; oVER_3_HOURS: string; uNDER_10_MINS: string };
}
...
}).pipe(Schema.encodeKeys({ _1_HOUR_TO_3_HOURS: "_1_HOUR_TO_3_HOURS", _10_MINS_TO_20_MINS: "_10_MINS_TO_20_MINS", _20_MINS_TO_40_MINS: "_20_MINS_TO_40_MINS", _40_MINS_TO_1_HOUR: "_40_MINS_TO_1_HOUR", oVER_3_HOURS: "OVER_3_HOURS", uNDER_10_MINS: "UNDER_10_MINS" }))
}) as unknown as Schema.Schema<DurationAttackLayer3SummaryResponse>;

export type DurationAttackLayer3SummaryError =
  | DefaultErrors;
...
export const IndustryAttackLayer3SummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/summary/industry" })) as unknown as Schema.Schema<IndustryAttackLayer3SummaryRequest>;
...
export type IndustryAttackLayer3SummaryError =
  | DefaultErrors;
...
export const ProtocolAttackLayer3SummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/summary/protocol" })) as unknown as Schema.Schema<ProtocolAttackLayer3SummaryRequest>;
...
export type ProtocolAttackLayer3SummaryError =
  | DefaultErrors;
...
export const VectorAttackLayer3SummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/summary/vector" })) as unknown as Schema.Schema<VectorAttackLayer3SummaryRequest>;
...
export type VectorAttackLayer3SummaryError =
  | DefaultErrors;
...
export const VerticalAttackLayer3SummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/summary/vertical" })) as unknown as Schema.Schema<VerticalAttackLayer3SummaryRequest>;
...
export type VerticalAttackLayer3SummaryError =
  | DefaultErrors;
...
export const BitrateAttackLayer3TimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/timeseries_groups/bitrate" })) as unknown as Schema.Schema<BitrateAttackLayer3TimeseriesGroupRequest>;

export interface BitrateAttackLayer3TimeseriesGroupResponse {
  /** Metadata for the results. */
  meta: { aggInterval: "FIFTEEN_MINUTES" | "ONE_HOUR" | "ONE_DAY" | "ONE_WEEK" | "ONE_MONTH"; confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  serie_0: { _1_GBPS_TO_10_GBPS: string[]; _10_GBPS_TO_100_GBPS: string[]; _500_MBPS_TO_1_GBPS: string[]; oVER_100_GBPS: string[]; timestamps: string[]; uNDER_500_MBPS: string[] };
}
...
}).pipe(Schema.encodeKeys({ _1_GBPS_TO_10_GBPS: "_1_GBPS_TO_10_GBPS", _10_GBPS_TO_100_GBPS: "_10_GBPS_TO_100_GBPS", _500_MBPS_TO_1_GBPS: "_500_MBPS_TO_1_GBPS", oVER_100_GBPS: "OVER_100_GBPS", timestamps: "timestamps", uNDER_500_MBPS: "UNDER_500_MBPS" }))
}) as unknown as Schema.Schema<BitrateAttackLayer3TimeseriesGroupResponse>;

export type BitrateAttackLayer3TimeseriesGroupError =
  | DefaultErrors;
...
export const DurationAttackLayer3TimeseriesGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/timeseries_groups/duration" })) as unknown as Schema.Schema<DurationAttackLayer3TimeseriesGroupRequest>;

export interface DurationAttackLayer3TimeseriesGroupResponse {
  /** Metadata for the results. */
  meta: { aggInterval: "FIFTEEN_MINUTES" | "ONE_HOUR" | "ONE_DAY" | "ONE_WEEK" | "ONE_MONTH"; confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  serie_0: { _1_HOUR_TO_3_HOURS: string[]; _10_MINS_TO_20_MINS: string[]; _20_MINS_TO_40_MINS: string[]; _40_MINS_TO_1_HOUR: string[]; oVER_3_HOURS: string[]; timestamps: string[]; uNDER_10_MINS: string[] };
}
...
}).pipe(Schema.encodeKeys({ _1_HOUR_TO_3_HOURS: "_1_HOUR_TO_3_HOURS", _10_MINS_TO_20_MINS: "_10_MINS_TO_20_MINS", _20_MINS_TO_40_MINS: "_20_MINS_TO_40_MINS", _40_MINS_TO_1_HOUR: "_40_MINS_TO_1_HOUR", oVER_3_HOURS: "OVER_3_HOURS", timestamps: "timestamps", uNDER_10_MINS: "UNDER_10_MINS" }))
}) as unknown as Schema.Schema<DurationAttackLayer3TimeseriesGroupResponse>;

export type DurationAttackLayer3TimeseriesGroupError =
  | DefaultErrors;
...
export const IndustryAttackLayer3TimeseriesGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/timeseries_groups/industry" })) as unknown as Schema.Schema<IndustryAttackLayer3TimeseriesGroupRequest>;
...
export type IndustryAttackLayer3TimeseriesGroupError =
  | DefaultErrors;
...
export const ProtocolAttackLayer3TimeseriesGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/timeseries_groups/protocol" })) as unknown as Schema.Schema<ProtocolAttackLayer3TimeseriesGroupRequest>;
...
export const ProtocolAttackLayer3TimeseriesGroupResponse = Schema.Struct({
  ...
  timestamps: Schema.Array(Schema.String),
  uDP: Schema.Array(Schema.String)
}).pipe(Schema.encodeKeys({ gRE: "GRE", iCMP: "ICMP", tCP: "TCP", timestamps: "timestamps", uDP: "UDP" }))
}) as unknown as Schema.Schema<ProtocolAttackLayer3TimeseriesGroupResponse>;

export type ProtocolAttackLayer3TimeseriesGroupError =
  | DefaultErrors;
...
export const VectorAttackLayer3TimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/timeseries_groups/vector" })) as unknown as Schema.Schema<VectorAttackLayer3TimeseriesGroupRequest>;
...
export type VectorAttackLayer3TimeseriesGroupError =
  | DefaultErrors;
...
export const VerticalAttackLayer3TimeseriesGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/timeseries_groups/vertical" })) as unknown as Schema.Schema<VerticalAttackLayer3TimeseriesGroupRequest>;
...
export type VerticalAttackLayer3TimeseriesGroupError =
  | DefaultErrors;
...
export const AttacksAttackLayer3TopRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/top/attacks" })) as unknown as Schema.Schema<AttacksAttackLayer3TopRequest>;
...
export type AttacksAttackLayer3TopError =
  | DefaultErrors;
...
export const IndustryAttackLayer3TopRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/top/industry" })) as unknown as Schema.Schema<IndustryAttackLayer3TopRequest>;
...
export type IndustryAttackLayer3TopError =
  | DefaultErrors;
...
export const VerticalAttackLayer3TopRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/top/vertical" })) as unknown as Schema.Schema<VerticalAttackLayer3TopRequest>;
...
export type VerticalAttackLayer3TopError =
  | DefaultErrors;
...
export const OriginAttackLayer3TopLocationRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/top/locations/origin" })) as unknown as Schema.Schema<OriginAttackLayer3TopLocationRequest>;
...
export type OriginAttackLayer3TopLocationError =
  | DefaultErrors;
...
export const TargetAttackLayer3TopLocationRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/top/locations/target" })) as unknown as Schema.Schema<TargetAttackLayer3TopLocationRequest>;
...
export type TargetAttackLayer3TopLocationError =
  | DefaultErrors;
...
export const TimeseriesAttackLayer7Request = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/timeseries" })) as unknown as Schema.Schema<TimeseriesAttackLayer7Request>;
...
export type TimeseriesAttackLayer7Error =
  | DefaultErrors;
...
export const IndustryAttackLayer7SummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/summary/industry" })) as unknown as Schema.Schema<IndustryAttackLayer7SummaryRequest>;
...
export type IndustryAttackLayer7SummaryError =
  | DefaultErrors;
...
export const VerticalAttackLayer7SummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/summary/vertical" })) as unknown as Schema.Schema<VerticalAttackLayer7SummaryRequest>;
...
export type VerticalAttackLayer7SummaryError =
  | DefaultErrors;
...
export const IndustryAttackLayer7TimeseriesGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/timeseries_groups/industry" })) as unknown as Schema.Schema<IndustryAttackLayer7TimeseriesGroupRequest>;
...
export type IndustryAttackLayer7TimeseriesGroupError =
  | DefaultErrors;
...
export const VerticalAttackLayer7TimeseriesGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/timeseries_groups/vertical" })) as unknown as Schema.Schema<VerticalAttackLayer7TimeseriesGroupRequest>;
...
export type VerticalAttackLayer7TimeseriesGroupError =
  | DefaultErrors;
...
export const AttacksAttackLayer7TopRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/top/attacks" })) as unknown as Schema.Schema<AttacksAttackLayer7TopRequest>;

export interface AttacksAttackLayer7TopResponse {
  /** Metadata for the results. */
  meta: { confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number } | null; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  top_0: { originCountryAlpha2: string; originCountryName: string; targetCountryAlpha2: string; targetCountryName: string; value: string }[];
}
...
export type AttacksAttackLayer7TopError =
  | DefaultErrors;
...
export const IndustryAttackLayer7TopRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/top/industry" })) as unknown as Schema.Schema<IndustryAttackLayer7TopRequest>;
...
export type IndustryAttackLayer7TopError =
  | DefaultErrors;
...
export const VerticalAttackLayer7TopRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/top/vertical" })) as unknown as Schema.Schema<VerticalAttackLayer7TopRequest>;
...
export type VerticalAttackLayer7TopError =
  | DefaultErrors;
...
export const OriginAttackLayer7TopAsRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/top/ases/origin" })) as unknown as Schema.Schema<OriginAttackLayer7TopAsRequest>;
...
export type OriginAttackLayer7TopAsError =
  | DefaultErrors;
...
export const OriginAttackLayer7TopLocationRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/top/locations/origin" })) as unknown as Schema.Schema<OriginAttackLayer7TopLocationRequest>;
...
export type OriginAttackLayer7TopLocationError =
  | DefaultErrors;
...
export const TargetAttackLayer7TopLocationRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/top/locations/target" })) as unknown as Schema.Schema<TargetAttackLayer7TopLocationRequest>;
...
export type TargetAttackLayer7TopLocationError =
  | DefaultErrors;
...
export const DnssecAwareDnsSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/summary/dnssec_aware" })) as unknown as Schema.Schema<DnssecAwareDnsSummaryRequest>;
...
export type DnssecAwareDnsSummaryError =
  | DefaultErrors;
...
export const DnssecAwareDnsTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/timeseries_groups/dnssec_aware" })) as unknown as Schema.Schema<DnssecAwareDnsTimeseriesGroupRequest>;
...
export type DnssecAwareDnsTimeseriesGroupError =
  | DefaultErrors;
...
export const TimeseriesBgpRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/bgp/timeseries" })) as unknown as Schema.Schema<TimeseriesBgpRequest>;

export interface TimeseriesBgpResponse {
  meta: { aggInterval: "15m" | "1h" | "1d" | "1w"; confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string };
  serie_0: { timestamps: string[]; values: string[] };
}
...
export type TimeseriesBgpError =
  | DefaultErrors;
...
export const ListBgpHijackEventsRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/bgp/hijacks/events" })) as unknown as Schema.Schema<ListBgpHijackEventsRequest>;

export type ListBgpHijackEventsResponse = { asnInfo: { asn: number; countryCode: string; orgName: string }[]; events: { id: number; confidenceScore: number; duration: number; eventType: number; hijackMsgsCount: number; hijackerAsn: number; hijackerCountry: string; isStale: boolean; maxHijackTs: string; maxMsgTs: string; minHijackTs: string; onGoingCount: number; peerAsns: number[]; peerIpCount: number; prefixes: string[]; tags: { name: string; score: number }[]; victimAsns: number[]; victimCountries: string[] }[]; totalMonitors: number }[];

export const ListBgpHijackEventsResponse = Schema.Array(Schema.Struct({
  asnInfo: Schema.Array(Schema.Struct({
    asn: Schema.Number,
    countryCode: Schema.String,
    orgName: Schema.String
  }).pipe(Schema.encodeKeys({ asn: "asn", countryCode: "country_code", orgName: "org_name" }))),
  ...
  }).pipe(Schema.encodeKeys({ id: "id", confidenceScore: "confidence_score", duration: "duration", eventType: "event_type", hijackMsgsCount: "hijack_msgs_count", hijackerAsn: "hijacker_asn", hijackerCountry: "hijacker_country", isStale: "is_stale", maxHijackTs: "max_hijack_ts", maxMsgTs: "max_msg_ts", minHijackTs: "min_hijack_ts", onGoingCount: "on_going_count", peerAsns: "peer_asns", peerIpCount: "peer_ip_count", prefixes: "prefixes", tags: "tags", victimAsns: "victim_asns", victimCountries: "victim_countries" }))),
  totalMonitors: Schema.Number
}).pipe(Schema.encodeKeys({ asnInfo: "asn_info", events: "events", totalMonitors: "total_monitors" }))) as unknown as Schema.Schema<ListBgpHijackEventsResponse>;

export type ListBgpHijackEventsError =
  | DefaultErrors;
...
export const TimeseriesBgpIpRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/bgp/ips/timeseries" })) as unknown as Schema.Schema<TimeseriesBgpIpRequest>;

export interface TimeseriesBgpIpResponse {
  /** Metadata for the results. */
  meta: { aggInterval: "FIFTEEN_MINUTES" | "ONE_HOUR" | "ONE_DAY" | "ONE_WEEK" | "ONE_MONTH"; confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[]; delay?: { asnData: { delaySecs: number; delayStr: string; healthy: boolean; latest: { entriesCount: number; path: string; timestamp: number } }; countryData: { delaySecs: number; delayStr: string; healthy: boolean; latest: { count: number; timestamp: number } }; healthy: boolean; nowTs: number } };
...
export const TimeseriesBgpIpResponse = Schema.Struct({
  ...
  delay: Schema.optional(Schema.Struct({
    asnData: Schema.Struct({
      ...
      }).pipe(Schema.encodeKeys({ entriesCount: "entries_count", path: "path", timestamp: "timestamp" }))
    }),
    ...
    healthy: Schema.Boolean,
    nowTs: Schema.Number
  }).pipe(Schema.encodeKeys({ asnData: "asn_data", countryData: "country_data", healthy: "healthy", nowTs: "nowTs" })))
}),
  serie_0: Schema.Struct({
...
export type TimeseriesBgpIpError =
  | DefaultErrors;
...
export const ListBgpLeakEventsRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/bgp/leaks/events" })) as unknown as Schema.Schema<ListBgpLeakEventsRequest>;

export type ListBgpLeakEventsResponse = { asnInfo: { asn: number; countryCode: string; orgName: string }[]; events: { id: number; countries: string[]; detectedTs: string; finished: boolean; leakAsn: number; leakCount: number; leakSeg: number[]; leakType: number; maxTs: string; minTs: string; originCount: number; peerCount: number; prefixCount: number }[] }[];

export const ListBgpLeakEventsResponse = Schema.Array(Schema.Struct({
  asnInfo: Schema.Array(Schema.Struct({
    asn: Schema.Number,
    countryCode: Schema.String,
    orgName: Schema.String
  ...
  }).pipe(Schema.encodeKeys({ id: "id", countries: "countries", detectedTs: "detected_ts", finished: "finished", leakAsn: "leak_asn", leakCount: "leak_count", leakSeg: "leak_seg", leakType: "leak_type", maxTs: "max_ts", minTs: "min_ts", originCount: "origin_count", peerCount: "peer_count", prefixCount: "prefix_count" })))
}).pipe(Schema.encodeKeys({ asnInfo: "asn_info", events: "events" }))) as unknown as Schema.Schema<ListBgpLeakEventsResponse>;

export type ListBgpLeakEventsError =
  | DefaultErrors;
...
export const AsesBgpRouteRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/bgp/routes/ases" })) as unknown as Schema.Schema<AsesBgpRouteRequest>;

export interface AsesBgpRouteResponse {
  asns: { asn: number; coneSize: number; country: string; ipv4Count: number; ipv6Count: string; name: string; pfxsCount: number; rpkiInvalid: number; rpkiUnknown: number; rpkiValid: number }[];
...
export const MoasBgpRouteRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/bgp/routes/moas" })) as unknown as Schema.Schema<MoasBgpRouteRequest>;

export interface MoasBgpRouteResponse {
  meta: { dataTime: string; queryTime: string; totalPeers: number };
  moas: { origins: { origin: number; peerCount: number; rpkiValidation: string }[]; prefix: string }[];
}
...
export const MoasBgpRouteResponse = Schema.Struct({
  ...
  queryTime: Schema.String,
  totalPeers: Schema.Number
}).pipe(Schema.encodeKeys({ dataTime: "data_time", queryTime: "query_time", totalPeers: "total_peers" })),
  moas: Schema.Array(Schema.Struct({
  origins: Schema.Array(Schema.Struct({
    origin: Schema.Number,
    peerCount: Schema.Number,
    rpkiValidation: Schema.String
  }).pipe(Schema.encodeKeys({ origin: "origin", peerCount: "peer_count", rpkiValidation: "rpki_validation" }))),
  prefix: Schema.String
}))
}) as unknown as Schema.Schema<MoasBgpRouteResponse>;

export type MoasBgpRouteError =
  | DefaultErrors;
...
export const Pfx2asBgpRouteRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/bgp/routes/pfx2as" })) as unknown as Schema.Schema<Pfx2asBgpRouteRequest>;
...
export const Pfx2asBgpRouteResponse = Schema.Struct({
  ...
  prefixOrigins: Schema.Array(Schema.Struct({
  origin: Schema.Number,
  peerCount: Schema.Number,
  prefix: Schema.String,
  rpkiValidation: Schema.String
}).pipe(Schema.encodeKeys({ origin: "origin", peerCount: "peer_count", prefix: "prefix", rpkiValidation: "rpki_validation" })))
}).pipe(Schema.encodeKeys({ meta: "meta", prefixOrigins: "prefix_origins" })) as unknown as Schema.Schema<Pfx2asBgpRouteResponse>;

export type Pfx2asBgpRouteError =
  | DefaultErrors;
...
export const RealtimeBgpRouteRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/bgp/routes/realtime" })) as unknown as Schema.Schema<RealtimeBgpRouteRequest>;

export interface RealtimeBgpRouteResponse {
  meta: { asnInfo: { asName: string; asn: number; countryCode: string; orgId: string; orgName: string }[]; collectors: { collector: string; latestRealtimeTs: string; latestRibTs: string; latestUpdatesTs: string; peersCount: number; peersV4Count: number; peersV6Count: number }[]; dataTime: string; prefixOrigins: { origin: number; prefix: string; rpkiValidation: string; totalPeers: number; totalVisible: number; visibility: number }[]; queryTime: string };
  routes: { asPath: number[]; collector: string; communities: string[]; prefix: string; timestamp: string }[];
}
...
export const RealtimeBgpRouteResponse = Schema.Struct({
  ...
  asnInfo: Schema.Array(Schema.Struct({
    ...
    orgId: Schema.String,
    orgName: Schema.String
  }).pipe(Schema.encodeKeys({ asName: "as_name", asn: "asn", countryCode: "country_code", orgId: "org_id", orgName: "org_name" }))),
  collectors: Schema.Array(Schema.Struct({
  ...
  }).pipe(Schema.encodeKeys({ collector: "collector", latestRealtimeTs: "latest_realtime_ts", latestRibTs: "latest_rib_ts", latestUpdatesTs: "latest_updates_ts", peersCount: "peers_count", peersV4Count: "peers_v4_count", peersV6Count: "peers_v6_count" }))),
  dataTime: Schema.String,
  prefixOrigins: Schema.Array(Schema.Struct({
    origin: Schema.Number,
    prefix: Schema.String,
  ...
  }).pipe(Schema.encodeKeys({ origin: "origin", prefix: "prefix", rpkiValidation: "rpki_validation", totalPeers: "total_peers", totalVisible: "total_visible", visibility: "visibility" }))),
  queryTime: Schema.String
}).pipe(Schema.encodeKeys({ asnInfo: "asn_info", collectors: "collectors", dataTime: "data_time", prefixOrigins: "prefix_origins", queryTime: "query_time" })),
...
}).pipe(Schema.encodeKeys({ asPath: "as_path", collector: "collector", communities: "communities", prefix: "prefix", timestamp: "timestamp" })))
}) as unknown as Schema.Schema<RealtimeBgpRouteResponse>;

export type RealtimeBgpRouteError =
  | DefaultErrors;
...
export const StatsBgpRouteRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/bgp/routes/stats" })) as unknown as Schema.Schema<StatsBgpRouteRequest>;

export interface StatsBgpRouteResponse {
  meta: { dataTime: string; queryTime: string; totalPeers: number };
  stats: { distinctOrigins: number; distinctOriginsIpv4: number; distinctOriginsIpv6: number; distinctPrefixes: number; distinctPrefixesIpv4: number; distinctPrefixesIpv6: number; routesInvalid: number; routesInvalidIpv4: number; routesInvalidIpv6: number; routesTotal: number; routesTotalIpv4: number; routesTotalIpv6: number; routesUnknown: number; routesUnknownIpv4: number; routesUnknownIpv6: number; routesValid: number; routesValidIpv4: number; routesValidIpv6: number };
}
...
}).pipe(Schema.encodeKeys({ distinctOrigins: "distinct_origins", distinctOriginsIpv4: "distinct_origins_ipv4", distinctOriginsIpv6: "distinct_origins_ipv6", distinctPrefixes: "distinct_prefixes", distinctPrefixesIpv4: "distinct_prefixes_ipv4", distinctPrefixesIpv6: "distinct_prefixes_ipv6", routesInvalid: "routes_invalid", routesInvalidIpv4: "routes_invalid_ipv4", routesInvalidIpv6: "routes_invalid_ipv6", routesTotal: "routes_total", routesTotalIpv4: "routes_total_ipv4", routesTotalIpv6: "routes_total_ipv6", routesUnknown: "routes_unknown", routesUnknownIpv4: "routes_unknown_ipv4", routesUnknownIpv6: "routes_unknown_ipv6", routesValid: "routes_valid", routesValidIpv4: "routes_valid_ipv4", routesValidIpv6: "routes_valid_ipv6" }))
}) as unknown as Schema.Schema<StatsBgpRouteResponse>;

export type StatsBgpRouteError =
  | DefaultErrors;
...
export const PrefixesBgpTopRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/bgp/top/prefixes" })) as unknown as Schema.Schema<PrefixesBgpTopRequest>;
...
export type PrefixesBgpTopError =
  | DefaultErrors;
...
export const GetBgpTopAsRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/bgp/top/ases" })) as unknown as Schema.Schema<GetBgpTopAsRequest>;
...
export const PrefixesBgpTopAsRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/bgp/top/ases/prefixes" })) as unknown as Schema.Schema<PrefixesBgpTopAsRequest>;
...
export const PrefixesBgpTopAsResponse = Schema.Struct({
  ...
  name: Schema.String,
  pfxsCount: Schema.Number
}).pipe(Schema.encodeKeys({ asn: "asn", country: "country", name: "name", pfxsCount: "pfxs_count" }))),
  meta: Schema.Struct({
  dataTime: Schema.String,
  queryTime: Schema.String,
  totalPeers: Schema.Number
...
export type PrefixesBgpTopAsError =
  | DefaultErrors;
...
export const GetBotRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/bots/{botSlug}" })) as unknown as Schema.Schema<GetBotRequest>;

export interface GetBotResponse {
  bot: { category: string; description: string; kind: string; name: string; operator: string; operatorUrl: string; slug: string; userAgentPatterns: string[]; userAgents: string[] };
}
...
export const ListBotsRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/bots" })) as unknown as Schema.Schema<ListBotsRequest>;

export interface ListBotsResponse {
  bots: { category: string; description: string; kind: string; name: string; operator: string; slug: string; userAgentPatterns: string[] }[];
}

export const ListBotsResponse = Schema.Struct({
  bots: Schema.Array(Schema.Struct({
  category: Schema.String,
  description: Schema.String,
  kind: Schema.String,
  name: Schema.String,
...
export const SummaryBotRequest = Schema.Struct({
  dimension: Schema.Literals(["BOT", "BOT_KIND", "BOT_OPERATOR", "BOT_CATEGORY"]).pipe(T.HttpPath("dimension"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/bots/summary/{dimension}" })) as unknown as Schema.Schema<SummaryBotRequest>;
...
export const TimeseriesBotRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/bots/timeseries" })) as unknown as Schema.Schema<TimeseriesBotRequest>;
...
export type TimeseriesBotError =
  | DefaultErrors;
...
export const SummaryBotWebCrawlerRequest = Schema.Struct({
  dimension: Schema.Literals(["CLIENT_TYPE", "USER_AGENT", "REFERER", "CRAWL_REFER_RATIO", "VERTICAL", "INDUSTRY"]).pipe(T.HttpPath("dimension"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/bots/crawlers/summary/{dimension}" })) as unknown as Schema.Schema<SummaryBotWebCrawlerRequest>;
...
export type SummaryBotWebCrawlerError =
  | DefaultErrors;
...
export const DomainCategoriesRobotsTxtTopRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/robots_txt/top/domain_categories" })) as unknown as Schema.Schema<DomainCategoriesRobotsTxtTopRequest>;
...
export type DomainCategoriesRobotsTxtTopError =
  | DefaultErrors;
...
export const ThreatCategoryEmailSecuritySummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/summary/threat_category" })) as unknown as Schema.Schema<ThreatCategoryEmailSecuritySummaryRequest>;

export interface ThreatCategoryEmailSecuritySummaryResponse {
  /** Metadata for the results. */
  meta: { confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  summary_0: { brandImpersonation: string; credentialHarvester: string; identityDeception: string; link: string };
}
...
export const ThreatCategoryEmailSecuritySummaryResponse = Schema.Struct({
  ...
  link: Schema.String
}).pipe(Schema.encodeKeys({ brandImpersonation: "BrandImpersonation", credentialHarvester: "CredentialHarvester", identityDeception: "IdentityDeception", link: "Link" }))
}) as unknown as Schema.Schema<ThreatCategoryEmailSecuritySummaryResponse>;

export type ThreatCategoryEmailSecuritySummaryError =
  | DefaultErrors;
...
export const ThreatCategoryEmailSecurityTimeseriesGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/timeseries_groups/threat_category" })) as unknown as Schema.Schema<ThreatCategoryEmailSecurityTimeseriesGroupRequest>;

export interface ThreatCategoryEmailSecurityTimeseriesGroupResponse {
  /** Metadata for the results. */
  meta: { aggInterval: "FIFTEEN_MINUTES" | "ONE_HOUR" | "ONE_DAY" | "ONE_WEEK" | "ONE_MONTH"; confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  serie_0: { brandImpersonation: string[]; credentialHarvester: string[]; identityDeception: string[]; link: string[] };
}
...
export type ThreatCategoryEmailSecurityTimeseriesGroupError =
  | DefaultErrors;
...
export const BotClassHttpSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/summary/bot_class" })) as unknown as Schema.Schema<BotClassHttpSummaryRequest>;
...
export type BotClassHttpSummaryError =
  | DefaultErrors;
...
export const BotClassHttpTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/timeseries_groups/bot_class" })) as unknown as Schema.Schema<BotClassHttpTimeseriesGroupRequest>;
...
export type BotClassHttpTimeseriesGroupError =
  | DefaultErrors;
...
export const BotClassLeakedCredentialSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/leaked_credential_checks/summary/bot_class" })) as unknown as Schema.Schema<BotClassLeakedCredentialSummaryRequest>;
...
export type BotClassLeakedCredentialSummaryError =
  | DefaultErrors;
...
export const BotClassLeakedCredentialTimeseriesGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/leaked_credential_checks/timeseries_groups/bot_class" })) as unknown as Schema.Schema<BotClassLeakedCredentialTimeseriesGroupRequest>;
...
export type BotClassLeakedCredentialTimeseriesGroupError =
  | DefaultErrors;
...
export const ResponseCodeDnsSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/summary/response_code" })) as unknown as Schema.Schema<ResponseCodeDnsSummaryRequest>;
...
export type ResponseCodeDnsSummaryError =
  | DefaultErrors;
...
export const ResponseCodeDnsTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/timeseries_groups/response_code" })) as unknown as Schema.Schema<ResponseCodeDnsTimeseriesGroupRequest>;
...
export type ResponseCodeDnsTimeseriesGroupError =
  | DefaultErrors;
...
export const ResponseCodesAs112SummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/as112/summary/response_codes" })) as unknown as Schema.Schema<ResponseCodesAs112SummaryRequest>;
...
export type ResponseCodesAs112SummaryError =
  | DefaultErrors;
...
export const ResponseCodesAs112TimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/as112/timeseries_groups/response_codes" })) as unknown as Schema.Schema<ResponseCodesAs112TimeseriesGroupRequest>;
...
export type ResponseCodesAs112TimeseriesGroupError =
  | DefaultErrors;
...
export const SummaryCtRequest = Schema.Struct({
  dimension: Schema.Literals(["CA", "CA_OWNER", "DURATION", "ENTRY_TYPE", "EXPIRATION_STATUS", "HAS_IPS", "HAS_WILDCARDS", "LOG", "LOG_API", "LOG_OPERATOR", "PUBLIC_KEY_ALGORITHM", "SIGNATURE_ALGORITHM", "TLD", "VALIDATION_LEVEL"]).pipe(T.HttpPath("dimension"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/ct/summary/{dimension}" })) as unknown as Schema.Schema<SummaryCtRequest>;

export interface SummaryCtResponse {
  /** Metadata for the results. */
  meta: { confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  summary_0: Record<string, unknown> | { rfc6962: string; static: string } | { gt_121d: string; gt_16dLte_31d: string; gt_31dLte_91d: string; gt_3dLte_16d: string; gt_91dLte_121d: string; lte_3d: string } | { cERTIFICATE: string; pRECERTIFICATE: string } | { eXPIRED: string; vALID: string } | { nEGATIVE: string; pOSITIVE: string } | { dSA: string; eCDSA: string; rSA: string } | { domain: string; extended: string; organization: string; unknown: string };
}
...
export const SummaryCtResponse = Schema.Struct({
  ...
  summary_0: Schema.Union([Schema.Struct({}), Schema.Struct({
...
}).pipe(Schema.encodeKeys({ gt_121d: "gt_121d", gt_16dLte_31d: "gt_16d_lte_31d", gt_31dLte_91d: "gt_31d_lte_91d", gt_3dLte_16d: "gt_3d_lte_16d", gt_91dLte_121d: "gt_91d_lte_121d", lte_3d: "lte_3d" })), Schema.Struct({
  cERTIFICATE: Schema.String,
  pRECERTIFICATE: Schema.String
}).pipe(Schema.encodeKeys({ cERTIFICATE: "CERTIFICATE", pRECERTIFICATE: "PRECERTIFICATE" })), Schema.Struct({
  eXPIRED: Schema.String,
  vALID: Schema.String
}).pipe(Schema.encodeKeys({ eXPIRED: "EXPIRED", vALID: "VALID" })), Schema.Struct({
  nEGATIVE: Schema.String,
  pOSITIVE: Schema.String
}).pipe(Schema.encodeKeys({ nEGATIVE: "NEGATIVE", pOSITIVE: "POSITIVE" })), Schema.Struct({
  dSA: Schema.String,
  eCDSA: Schema.String,
  rSA: Schema.String
}).pipe(Schema.encodeKeys({ dSA: "DSA", eCDSA: "ECDSA", rSA: "RSA" })), Schema.Struct({
...
export const TimeseriesCtRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/ct/timeseries" })) as unknown as Schema.Schema<TimeseriesCtRequest>;
...
export const GetCtAuthorityRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/ct/authorities/{caSlug}" })) as unknown as Schema.Schema<GetCtAuthorityRequest>;

export interface GetCtAuthorityResponse {
  certificateAuthority: { appleStatus: "INCLUDED" | "NOT_YET_INCLUDED" | "NOT_INCLUDED" | "NOT_BEFORE" | "REMOVED" | "DISABLED" | "BLOCKED"; authorityKeyIdentifier: string; certificateRecordType: "ROOT_CERTIFICATE" | "INTERMEDIATE_CERTIFICATE"; chromeStatus: "INCLUDED" | "NOT_YET_INCLUDED" | "NOT_INCLUDED" | "NOT_BEFORE" | "REMOVED" | "DISABLED" | "BLOCKED"; country: string; countryName: string; microsoftStatus: "INCLUDED" | "NOT_YET_INCLUDED" | "NOT_INCLUDED" | "NOT_BEFORE" | "REMOVED" | "DISABLED" | "BLOCKED"; mozillaStatus: "INCLUDED" | "NOT_YET_INCLUDED" | "NOT_INCLUDED" | "NOT_BEFORE" | "REMOVED" | "DISABLED" | "BLOCKED"; name: string; owner: string; parentName: string; parentSha256Fingerprint: string; related: ({ certificateRecordType: "ROOT_CERTIFICATE" | "INTERMEDIATE_CERTIFICATE"; name: string; revocationStatus: "NOT_REVOKED" | "REVOKED" | "PARENT_CERT_REVOKED"; sha256Fingerprint: string })[]; revocationStatus: "NOT_REVOKED" | "REVOKED" | "PARENT_CERT_REVOKED"; sha256Fingerprint: string; subjectKeyIdentifier: string; validFrom: string; validTo: string };
}

export const GetCtAuthorityResponse = Schema.Struct({
  certificateAuthority: Schema.Struct({
  appleStatus: Schema.Literals(["INCLUDED", "NOT_YET_INCLUDED", "NOT_INCLUDED", "NOT_BEFORE", "REMOVED", "DISABLED", "BLOCKED"]),
  authorityKeyIdentifier: Schema.String,
  certificateRecordType: Schema.Literals(["ROOT_CERTIFICATE", "INTERMEDIATE_CERTIFICATE"]),
  chromeStatus: Schema.Literals(["INCLUDED", "NOT_YET_INCLUDED", "NOT_INCLUDED", "NOT_BEFORE", "REMOVED", "DISABLED", "BLOCKED"]),
  country: Schema.String,
  countryName: Schema.String,
  microsoftStatus: Schema.Literals(["INCLUDED", "NOT_YET_INCLUDED", "NOT_INCLUDED", "NOT_BEFORE", "REMOVED", "DISABLED", "BLOCKED"]),
  mozillaStatus: Schema.Literals(["INCLUDED", "NOT_YET_INCLUDED", "NOT_INCLUDED", "NOT_BEFORE", "REMOVED", "DISABLED", "BLOCKED"]),
  name: Schema.String,
  owner: Schema.String,
  ...
  related: Schema.Array(Schema.Struct({
    certificateRecordType: Schema.Literals(["ROOT_CERTIFICATE", "INTERMEDIATE_CERTIFICATE"]),
    name: Schema.String,
    revocationStatus: Schema.Literals(["NOT_REVOKED", "REVOKED", "PARENT_CERT_REVOKED"]),
...
export type GetCtAuthorityError =
  | DefaultErrors;
...
export const ListCtAuthoritiesRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/ct/authorities" })) as unknown as Schema.Schema<ListCtAuthoritiesRequest>;

export interface ListCtAuthoritiesResponse {
  certificateAuthorities: ({ certificateRecordType: "ROOT_CERTIFICATE" | "INTERMEDIATE_CERTIFICATE"; country: string; countryName: string; name: string; owner: string; parentName: string; parentSha256Fingerprint: string; revocationStatus: "NOT_REVOKED" | "REVOKED" | "PARENT_CERT_REVOKED"; sha256Fingerprint: string })[];
}

export const ListCtAuthoritiesResponse = Schema.Struct({
  certificateAuthorities: Schema.Array(Schema.Struct({
  certificateRecordType: Schema.Literals(["ROOT_CERTIFICATE", "INTERMEDIATE_CERTIFICATE"]),
  country: Schema.String,
  countryName: Schema.String,
  name: Schema.String,
...
export type ListCtAuthoritiesError =
  | DefaultErrors;
...
export const GetCtLogRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/ct/logs/{logSlug}" })) as unknown as Schema.Schema<GetCtLogRequest>;

export interface GetCtLogResponse {
  certificateLog: { api: "RFC6962" | "STATIC"; avgThroughput: number; description: string; endExclusive: string; lastUpdate: string; operator: string; performance: { endpoints: ({ endpoint: "add-chain (new)" | "add-chain (old)" | "add-pre-chain (new)" | "add-pre-chain (old)" | "get-entries" | "get-roots" | "get-sth"; responseTime: number; uptime: number })[]; responseTime: number; uptime: number } | null; related: ({ description: string; endExclusive: string; slug: string; startInclusive: string; state: "USABLE" | "PENDING" | "QUALIFIED" | "READ_ONLY" | "RETIRED" | "REJECTED" })[]; slug: string; startInclusive: string; state: "USABLE" | "PENDING" | "QUALIFIED" | "READ_ONLY" | "RETIRED" | "REJECTED"; stateTimestamp: string; submittableCertCount: string | null; submittedCertCount: string | null; url: string };
}
...
export const GetCtLogResponse = Schema.Struct({
  ...
  operator: Schema.String,
  performance: Schema.Union([Schema.Struct({
    endpoints: Schema.Array(Schema.Struct({
      endpoint: Schema.Literals(["add-chain (new)", "add-chain (old)", "add-pre-chain (new)", "add-pre-chain (old)", "get-entries", "get-roots", "get-sth"]),
  ...
  related: Schema.Array(Schema.Struct({
    ...
    state: Schema.Literals(["USABLE", "PENDING", "QUALIFIED", "READ_ONLY", "RETIRED", "REJECTED"])
  })),
  slug: Schema.String,
  startInclusive: Schema.String,
  state: Schema.Literals(["USABLE", "PENDING", "QUALIFIED", "READ_ONLY", "RETIRED", "REJECTED"]),
...
export const ListCtLogsRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/ct/logs" })) as unknown as Schema.Schema<ListCtLogsRequest>;

export interface ListCtLogsResponse {
  certificateLogs: ({ api: "RFC6962" | "STATIC"; description: string; endExclusive: string; operator: string; slug: string; startInclusive: string; state: "USABLE" | "PENDING" | "QUALIFIED" | "READ_ONLY" | "RETIRED" | "REJECTED"; stateTimestamp: string; url: string })[];
}

export const ListCtLogsResponse = Schema.Struct({
  certificateLogs: Schema.Array(Schema.Struct({
  api: Schema.Literals(["RFC6962", "STATIC"]),
  description: Schema.String,
  endExclusive: Schema.String,
  operator: Schema.String,
...
export const GetDatasetRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/datasets/{alias}" })) as unknown as Schema.Schema<GetDatasetRequest>;
...
export const ListDatasetsRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/datasets" })) as unknown as Schema.Schema<ListDatasetsRequest>;

export interface ListDatasetsResponse {
  datasets: { id: number; description: string; meta: unknown; tags: string[]; title: string; type: string }[];
}
...
export const DownloadDatasetRequest = Schema.Struct({
  format: Schema.optional(Schema.Literals(["JSON", "CSV"])).pipe(T.HttpQuery("format")),
  datasetId: Schema.Number
})
  .pipe(T.Http({ method: "POST", path: "/radar/datasets/download" })) as unknown as Schema.Schema<DownloadDatasetRequest>;
...
export type DownloadDatasetError =
  | DefaultErrors;
...
export const TimeseriesDnsRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/timeseries" })) as unknown as Schema.Schema<TimeseriesDnsRequest>;
...
export type TimeseriesDnsError =
  | DefaultErrors;
...
export const DnssecDnsSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/summary/dnssec" })) as unknown as Schema.Schema<DnssecDnsSummaryRequest>;
...
}).pipe(Schema.encodeKeys({ iNSECURE: "INSECURE", iNVALID: "INVALID", oTHER: "OTHER", sECURE: "SECURE" }))
}) as unknown as Schema.Schema<DnssecDnsSummaryResponse>;

export type DnssecDnsSummaryError =
  | DefaultErrors;
...
export const ProtocolDnsSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/summary/protocol" })) as unknown as Schema.Schema<ProtocolDnsSummaryRequest>;
...
export type ProtocolDnsSummaryError =
  | DefaultErrors;
...
export const DnssecDnsTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/timeseries_groups/dnssec" })) as unknown as Schema.Schema<DnssecDnsTimeseriesGroupRequest>;
...
export type DnssecDnsTimeseriesGroupError =
  | DefaultErrors;
...
export const ProtocolDnsTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/timeseries_groups/protocol" })) as unknown as Schema.Schema<ProtocolDnsTimeseriesGroupRequest>;
...
export type ProtocolDnsTimeseriesGroupError =
  | DefaultErrors;
...
export const AsesDnsTopRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/top/ases" })) as unknown as Schema.Schema<AsesDnsTopRequest>;
...
export const LocationsDnsTopRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/top/locations" })) as unknown as Schema.Schema<LocationsDnsTopRequest>;
...
export type LocationsDnsTopError =
  | DefaultErrors;
...
export const DnssecE2EDnsSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/summary/dnssec_e2e" })) as unknown as Schema.Schema<DnssecE2EDnsSummaryRequest>;
...
export type DnssecE2EDnsSummaryError =
  | DefaultErrors;
...
export const DnssecE2EDnsTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/timeseries_groups/dnssec_e2e" })) as unknown as Schema.Schema<DnssecE2EDnsTimeseriesGroupRequest>;
...
export type DnssecE2EDnsTimeseriesGroupError =
  | DefaultErrors;
...
export const ArcEmailRoutingSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/routing/summary/arc" })) as unknown as Schema.Schema<ArcEmailRoutingSummaryRequest>;
...
export type ArcEmailRoutingSummaryError =
  | DefaultErrors;
...
export const DkimEmailRoutingSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/routing/summary/dkim" })) as unknown as Schema.Schema<DkimEmailRoutingSummaryRequest>;
...
export type DkimEmailRoutingSummaryError =
  | DefaultErrors;
...
export const DmarcEmailRoutingSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/routing/summary/dmarc" })) as unknown as Schema.Schema<DmarcEmailRoutingSummaryRequest>;
...
export type DmarcEmailRoutingSummaryError =
  | DefaultErrors;
...
export const EncryptedEmailRoutingSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/routing/summary/encrypted" })) as unknown as Schema.Schema<EncryptedEmailRoutingSummaryRequest>;
...
}).pipe(Schema.encodeKeys({ eNCRYPTED: "ENCRYPTED", nOT_ENCRYPTED: "NOT_ENCRYPTED" }))
}) as unknown as Schema.Schema<EncryptedEmailRoutingSummaryResponse>;

export type EncryptedEmailRoutingSummaryError =
  | DefaultErrors;
...
export const SpfEmailRoutingSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/routing/summary/spf" })) as unknown as Schema.Schema<SpfEmailRoutingSummaryRequest>;
...
export type SpfEmailRoutingSummaryError =
  | DefaultErrors;
...
export const ArcEmailRoutingTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/routing/timeseries_groups/arc" })) as unknown as Schema.Schema<ArcEmailRoutingTimeseriesGroupRequest>;
...
export type ArcEmailRoutingTimeseriesGroupError =
  | DefaultErrors;
...
export const DkimEmailRoutingTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/routing/timeseries_groups/dkim" })) as unknown as Schema.Schema<DkimEmailRoutingTimeseriesGroupRequest>;
...
export type DkimEmailRoutingTimeseriesGroupError =
  | DefaultErrors;
...
export const DmarcEmailRoutingTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/routing/timeseries_groups/dmarc" })) as unknown as Schema.Schema<DmarcEmailRoutingTimeseriesGroupRequest>;
...
export type DmarcEmailRoutingTimeseriesGroupError =
  | DefaultErrors;
...
export const EncryptedEmailRoutingTimeseriesGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/email/routing/timeseries_groups/encrypted" })) as unknown as Schema.Schema<EncryptedEmailRoutingTimeseriesGroupRequest>;
...
export type EncryptedEmailRoutingTimeseriesGroupError =
  | DefaultErrors;
...
export const SpfEmailRoutingTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/routing/timeseries_groups/spf" })) as unknown as Schema.Schema<SpfEmailRoutingTimeseriesGroupRequest>;
...
export type SpfEmailRoutingTimeseriesGroupError =
  | DefaultErrors;
...
export const ArcEmailSecuritySummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/summary/arc" })) as unknown as Schema.Schema<ArcEmailSecuritySummaryRequest>;
...
export type ArcEmailSecuritySummaryError =
  | DefaultErrors;
...
export const DkimEmailSecuritySummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/summary/dkim" })) as unknown as Schema.Schema<DkimEmailSecuritySummaryRequest>;
...
export type DkimEmailSecuritySummaryError =
  | DefaultErrors;
...
export const DmarcEmailSecuritySummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/summary/dmarc" })) as unknown as Schema.Schema<DmarcEmailSecuritySummaryRequest>;
...
export type DmarcEmailSecuritySummaryError =
  | DefaultErrors;
...
export const MaliciousEmailSecuritySummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/summary/malicious" })) as unknown as Schema.Schema<MaliciousEmailSecuritySummaryRequest>;
...
}).pipe(Schema.encodeKeys({ mALICIOUS: "MALICIOUS", nOT_MALICIOUS: "NOT_MALICIOUS" }))
}) as unknown as Schema.Schema<MaliciousEmailSecuritySummaryResponse>;

export type MaliciousEmailSecuritySummaryError =
  | DefaultErrors;
...
export const SpamEmailSecuritySummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/summary/spam" })) as unknown as Schema.Schema<SpamEmailSecuritySummaryRequest>;
...
export type SpamEmailSecuritySummaryError =
  | DefaultErrors;
...
export const SpfEmailSecuritySummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/summary/spf" })) as unknown as Schema.Schema<SpfEmailSecuritySummaryRequest>;
...
export type SpfEmailSecuritySummaryError =
  | DefaultErrors;
...
export const SpoofEmailSecuritySummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/summary/spoof" })) as unknown as Schema.Schema<SpoofEmailSecuritySummaryRequest>;
...
export type SpoofEmailSecuritySummaryError =
  | DefaultErrors;
...
export const ArcEmailSecurityTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/timeseries_groups/arc" })) as unknown as Schema.Schema<ArcEmailSecurityTimeseriesGroupRequest>;
...
export type ArcEmailSecurityTimeseriesGroupError =
  | DefaultErrors;
...
export const DkimEmailSecurityTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/timeseries_groups/dkim" })) as unknown as Schema.Schema<DkimEmailSecurityTimeseriesGroupRequest>;
...
export type DkimEmailSecurityTimeseriesGroupError =
  | DefaultErrors;
...
export const DmarcEmailSecurityTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/timeseries_groups/dmarc" })) as unknown as Schema.Schema<DmarcEmailSecurityTimeseriesGroupRequest>;
...
export type DmarcEmailSecurityTimeseriesGroupError =
  | DefaultErrors;
...
export const MaliciousEmailSecurityTimeseriesGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/timeseries_groups/malicious" })) as unknown as Schema.Schema<MaliciousEmailSecurityTimeseriesGroupRequest>;
...
export type MaliciousEmailSecurityTimeseriesGroupError =
  | DefaultErrors;
...
export const SpamEmailSecurityTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/timeseries_groups/spam" })) as unknown as Schema.Schema<SpamEmailSecurityTimeseriesGroupRequest>;
...
export type SpamEmailSecurityTimeseriesGroupError =
  | DefaultErrors;
...
export const SpfEmailSecurityTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/timeseries_groups/spf" })) as unknown as Schema.Schema<SpfEmailSecurityTimeseriesGroupRequest>;
...
export type SpfEmailSecurityTimeseriesGroupError =
  | DefaultErrors;
...
export const SpoofEmailSecurityTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/timeseries_groups/spoof" })) as unknown as Schema.Schema<SpoofEmailSecurityTimeseriesGroupRequest>;
...
export type SpoofEmailSecurityTimeseriesGroupError =
  | DefaultErrors;
...
export const GetEmailSecurityTopTldRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/top/tlds" })) as unknown as Schema.Schema<GetEmailSecurityTopTldRequest>;
...
export type GetEmailSecurityTopTldError =
  | DefaultErrors;
...
export const GetEmailSecurityTopTldMaliciousRequest = Schema.Struct({
  malicious: Schema.Literals(["MALICIOUS", "NOT_MALICIOUS"]).pipe(T.HttpPath("malicious"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/top/tlds/malicious/{malicious}" })) as unknown as Schema.Schema<GetEmailSecurityTopTldMaliciousRequest>;
...
export type GetEmailSecurityTopTldMaliciousError =
  | DefaultErrors;
...
export const GetEmailSecurityTopTldSpamRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/top/tlds/spam/{spam}" })) as unknown as Schema.Schema<GetEmailSecurityTopTldSpamRequest>;
...
export type GetEmailSecurityTopTldSpamError =
  | DefaultErrors;
...
export const GetEmailSecurityTopTldSpoofRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/top/tlds/spoof/{spoof}" })) as unknown as Schema.Schema<GetEmailSecurityTopTldSpoofRequest>;
...
export type GetEmailSecurityTopTldSpoofError =
  | DefaultErrors;
...
export const GetEntityRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/entities/ip" })) as unknown as Schema.Schema<GetEntityRequest>;

export interface GetEntityResponse {
  ip: { asn: string; asnLocation: string; asnName: string; asnOrgName: string; ip: string; ipVersion: string; location: string; locationName: string };
}
...
export const GetEntityAsnRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/entities/asns/{asn}" })) as unknown as Schema.Schema<GetEntityAsnRequest>;

export interface GetEntityAsnResponse {
  asn: { asn: number; confidenceLevel: number; country: string; countryName: string; estimatedUsers: { locations: { locationAlpha2: string; locationName: string; estimatedUsers?: number }[]; estimatedUsers?: number }; name: string; orgName: string; related: { asn: number; name: string; aka?: string; estimatedUsers?: number }[]; source: string; website: string; aka?: string };
}
...
export const ListEntityAsnsRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/entities/asns" })) as unknown as Schema.Schema<ListEntityAsnsRequest>;

export interface ListEntityAsnsResponse {
  asns: { asn: number; country: string; countryName: string; name: string; aka?: string; orgName?: string; website?: string }[];
}
...
export type ListEntityAsnsError =
  | DefaultErrors;
...
export const IpEntityAsnRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/entities/asns/ip" })) as unknown as Schema.Schema<IpEntityAsnRequest>;

export interface IpEntityAsnResponse {
  asn: { asn: number; country: string; countryName: string; estimatedUsers: { locations: { locationAlpha2: string; locationName: string; estimatedUsers?: number }[]; estimatedUsers?: number }; name: string; orgName: string; related: { asn: number; name: string; aka?: string; estimatedUsers?: number }[]; source: string; website: string; aka?: string };
}
...
export const RelEntityAsnRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/entities/asns/{asn}/rel" })) as unknown as Schema.Schema<RelEntityAsnRequest>;

export interface RelEntityAsnResponse {
  meta: { dataTime: string; queryTime: string; totalPeers: number };
  rels: { asn1: number; asn1Country: string; asn1Name: string; asn2: number; asn2Country: string; asn2Name: string; rel: string }[];
}
...
export const RelEntityAsnResponse = Schema.Struct({
  ...
  rels: Schema.Array(Schema.Struct({
  asn1: Schema.Number,
  ...
  rel: Schema.String
}).pipe(Schema.encodeKeys({ asn1: "asn1", asn1Country: "asn1_country", asn1Name: "asn1_name", asn2: "asn2", asn2Country: "asn2_country", asn2Name: "asn2_name", rel: "rel" })))
}) as unknown as Schema.Schema<RelEntityAsnResponse>;

export type RelEntityAsnError =
  | DefaultErrors;
...
export const GetEntityLocationRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/entities/locations/{location}" })) as unknown as Schema.Schema<GetEntityLocationRequest>;

export interface GetEntityLocationResponse {
  location: { alpha2: string; confidenceLevel: number; latitude: string; longitude: string; name: string; region: string; subregion: string };
}
...
export type GetEntityLocationError =
  | DefaultErrors;
...
export const ListEntityLocationsRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/entities/locations" })) as unknown as Schema.Schema<ListEntityLocationsRequest>;
...
export type ListEntityLocationsError =
  | DefaultErrors;
...
export const BrowserFamilyHttpTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/timeseries_groups/browser_family" })) as unknown as Schema.Schema<BrowserFamilyHttpTimeseriesGroupRequest>;
...
export type BrowserFamilyHttpTimeseriesGroupError =
  | DefaultErrors;
...
export const BrowserFamilyHttpTopRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/browser_family" })) as unknown as Schema.Schema<BrowserFamilyHttpTopRequest>;
...
export type BrowserFamilyHttpTopError =
  | DefaultErrors;
...
export const GetGeolocationRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/geolocations/{geoId}" })) as unknown as Schema.Schema<GetGeolocationRequest>;

export interface GetGeolocationResponse {
  geolocation: { geoId: string; latitude: string; longitude: string; name: string; parent: { geoId: string; latitude: string; longitude: string; name: string; parent: { geoId: string; latitude: string; longitude: string; name: string; type: "CONTINENT" | "COUNTRY" | "ADM1" }; type: "CONTINENT" | "COUNTRY" | "ADM1" }; type: "CONTINENT" | "COUNTRY" | "ADM1" };
}
...
export const ListGeolocationsRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/geolocations" })) as unknown as Schema.Schema<ListGeolocationsRequest>;

export interface ListGeolocationsResponse {
  geolocations: ({ geoId: string; latitude: string; longitude: string; name: string; parent: { geoId: string; latitude: string; longitude: string; name: string; parent: { geoId: string; latitude: string; longitude: string; name: string; type: "CONTINENT" | "COUNTRY" | "ADM1" }; type: "CONTINENT" | "COUNTRY" | "ADM1" }; type: "CONTINENT" | "COUNTRY" | "ADM1" })[];
}

export const ListGeolocationsResponse = Schema.Struct({
  geolocations: Schema.Array(Schema.Struct({
  geoId: Schema.String,
  latitude: Schema.String,
  longitude: Schema.String,
  name: Schema.String,
...
export const TimeseriesGroupsAiBotRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/ai/bots/timeseries_groups/{dimension}" })) as unknown as Schema.Schema<TimeseriesGroupsAiBotRequest>;
...
export type TimeseriesGroupsAiBotError =
  | DefaultErrors;
...
export const TimeseriesGroupsAiTimeseriesGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/ai/bots/timeseries_groups/{dimension}" })) as unknown as Schema.Schema<TimeseriesGroupsAiTimeseriesGroupRequest>;
...
export type TimeseriesGroupsAiTimeseriesGroupError =
  | DefaultErrors;
...
export const TimeseriesGroupsBotRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/bots/timeseries_groups/{dimension}" })) as unknown as Schema.Schema<TimeseriesGroupsBotRequest>;
...
export type TimeseriesGroupsBotError =
  | DefaultErrors;
...
export const TimeseriesGroupsBotWebCrawlerRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/bots/crawlers/timeseries_groups/{dimension}" })) as unknown as Schema.Schema<TimeseriesGroupsBotWebCrawlerRequest>;
...
export type TimeseriesGroupsBotWebCrawlerError =
  | DefaultErrors;
...
export const TimeseriesGroupsCtRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/ct/timeseries_groups/{dimension}" })) as unknown as Schema.Schema<TimeseriesGroupsCtRequest>;

export interface TimeseriesGroupsCtResponse {
  /** Metadata for the results. */
  meta: { aggInterval: "FIFTEEN_MINUTES" | "ONE_HOUR" | "ONE_DAY" | "ONE_WEEK" | "ONE_MONTH"; confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  serie_0: { timestamps: string[] } | { rfc6962: string[]; static: string[] } | { gt_121d: string[]; gt_16dLte_31d: string[]; gt_31dLte_91d: string[]; gt_3dLte_16d: string[]; gt_91dLte_121d: string[]; lte_3d: string[] } | { cERTIFICATE: string[]; pRECERTIFICATE: string[] } | { eXPIRED: string[]; vALID: string[] } | { nEGATIVE: string[]; pOSITIVE: string[] } | { dSA: string[]; eCDSA: string[]; rSA: string[] } | { domain: string[]; extended: string[]; organization: string[]; unknown: string[] };
}
...
export const TimeseriesGroupsCtResponse = Schema.Struct({
  ...
  serie_0: Schema.Union([Schema.Struct({
  timestamps: Schema.Array(Schema.String)
}), Schema.Struct({
...
export type TimeseriesGroupsCtError =
  | DefaultErrors;
...
export const TimeseriesGroupsNetflowRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/netflows/timeseries_groups/{dimension}" })) as unknown as Schema.Schema<TimeseriesGroupsNetflowRequest>;
...
export type TimeseriesGroupsNetflowError =
  | DefaultErrors;
...
export const TimeseriesGroupsQualityIqiRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/quality/iqi/timeseries_groups" })) as unknown as Schema.Schema<TimeseriesGroupsQualityIqiRequest>;
...
export type TimeseriesGroupsQualityIqiError =
  | DefaultErrors;
...
export const TimeseriesGroupsRankingRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/ranking/timeseries_groups" })) as unknown as Schema.Schema<TimeseriesGroupsRankingRequest>;
...
export type TimeseriesGroupsRankingError =
  | DefaultErrors;
...
export const TimeseriesGroupsRankingInternetServiceRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/ranking/internet_services/timeseries_groups" })) as unknown as Schema.Schema<TimeseriesGroupsRankingInternetServiceRequest>;
...
export type TimeseriesGroupsRankingInternetServiceError =
  | DefaultErrors;
...
export const TimeseriesGroupsTcpResetsTimeoutRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/tcp_resets_timeouts/timeseries_groups" })) as unknown as Schema.Schema<TimeseriesGroupsTcpResetsTimeoutRequest>;

export interface TimeseriesGroupsTcpResetsTimeoutResponse {
  /** Metadata for the results. */
  meta: { aggInterval: "FIFTEEN_MINUTES" | "ONE_HOUR" | "ONE_DAY" | "ONE_WEEK" | "ONE_MONTH"; confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  serie_0: { laterInFlow: string[]; noMatch: string[]; postAck: string[]; postPsh: string[]; postSyn: string[]; timestamps: string[] };
}
...
export const TimeseriesGroupsTcpResetsTimeoutResponse = Schema.Struct({
  ...
  timestamps: Schema.Array(Schema.String)
}).pipe(Schema.encodeKeys({ laterInFlow: "later_in_flow", noMatch: "no_match", postAck: "post_ack", postPsh: "post_psh", postSyn: "post_syn", timestamps: "timestamps" }))
}) as unknown as Schema.Schema<TimeseriesGroupsTcpResetsTimeoutResponse>;

export type TimeseriesGroupsTcpResetsTimeoutError =
  | DefaultErrors;
...
export const TimeseriesGroupsV2AiInferenceRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/ai/inference/timeseries_groups/{dimension}" })) as unknown as Schema.Schema<TimeseriesGroupsV2AiInferenceRequest>;
...
export type TimeseriesGroupsV2AiInferenceError =
  | DefaultErrors;
...
export const TimeseriesGroupsV2As112Request = Schema.Struct({
  dimension: Schema.Literals(["DNSSEC", "EDNS", "IP_VERSION", "PROTOCOL", "QUERY_TYPE", "RESPONSE_CODE"]).pipe(T.HttpPath("dimension"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/as112/timeseries_groups/{dimension}" })) as unknown as Schema.Schema<TimeseriesGroupsV2As112Request>;
...
export type TimeseriesGroupsV2As112Error =
  | DefaultErrors;
...
export const TimeseriesGroupsV2AttackLayer3Request = Schema.Struct({
  dimension: Schema.Literals(["PROTOCOL", "IP_VERSION", "VECTOR", "DURATION", "BITRATE", "VERTICAL", "INDUSTRY"]).pipe(T.HttpPath("dimension"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/timeseries_groups/{dimension}" })) as unknown as Schema.Schema<TimeseriesGroupsV2AttackLayer3Request>;
...
export type TimeseriesGroupsV2AttackLayer3Error =
  | DefaultErrors;
...
export const TimeseriesGroupsV2AttackLayer7Request = Schema.Struct({
  dimension: Schema.Literals(["HTTP_METHOD", "HTTP_VERSION", "IP_VERSION", "MANAGED_RULES", "MITIGATION_PRODUCT", "VERTICAL", "INDUSTRY"]).pipe(T.HttpPath("dimension"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/timeseries_groups/{dimension}" })) as unknown as Schema.Schema<TimeseriesGroupsV2AttackLayer7Request>;
...
export type TimeseriesGroupsV2AttackLayer7Error =
  | DefaultErrors;
...
export interface TimeseriesGroupsV2DnsRequest {
  dimension: "IP_VERSION" | "CACHE_HIT" | "DNSSEC" | "DNSSEC_AWARE" | "DNSSEC_E2E" | "MATCHING_ANSWER" | "PROTOCOL" | "QUERY_TYPE" | "RESPONSE_CODE" | "RESPONSE_TTL" | "TLD";
}

export const TimeseriesGroupsV2DnsRequest = Schema.Struct({
  dimension: Schema.Literals(["IP_VERSION", "CACHE_HIT", "DNSSEC", "DNSSEC_AWARE", "DNSSEC_E2E", "MATCHING_ANSWER", "PROTOCOL", "QUERY_TYPE", "RESPONSE_CODE", "RESPONSE_TTL", "TLD"]).pipe(T.HttpPath("dimension"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/timeseries_groups/{dimension}" })) as unknown as Schema.Schema<TimeseriesGroupsV2DnsRequest>;
...
export type TimeseriesGroupsV2DnsError =
  | DefaultErrors;
...
export const TimeseriesGroupsV2EmailRoutingRequest = Schema.Struct({
  dimension: Schema.Literals(["IP_VERSION", "ENCRYPTED", "ARC", "DKIM", "DMARC", "SPF"]).pipe(T.HttpPath("dimension"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/routing/timeseries_groups/{dimension}" })) as unknown as Schema.Schema<TimeseriesGroupsV2EmailRoutingRequest>;
...
export type TimeseriesGroupsV2EmailRoutingError =
  | DefaultErrors;
...
export const TimeseriesGroupsV2EmailSecurityRequest = Schema.Struct({
  dimension: Schema.Literals(["SPAM", "MALICIOUS", "SPOOF", "THREAT_CATEGORY", "ARC", "DKIM", "DMARC", "SPF", "TLS_VERSION"]).pipe(T.HttpPath("dimension"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/timeseries_groups/{dimension}" })) as unknown as Schema.Schema<TimeseriesGroupsV2EmailSecurityRequest>;
...
export type TimeseriesGroupsV2EmailSecurityError =
  | DefaultErrors;
...
export interface TimeseriesGroupsV2HttpRequest {
  dimension: "ADM1" | "BOT_CLASS" | "BROWSER" | "BROWSER_FAMILY" | "DEVICE_TYPE" | "HTTP_PROTOCOL" | "HTTP_VERSION" | "IP_VERSION" | "OS" | "POST_QUANTUM" | "TLS_VERSION";
}

export const TimeseriesGroupsV2HttpRequest = Schema.Struct({
  dimension: Schema.Literals(["ADM1", "BOT_CLASS", "BROWSER", "BROWSER_FAMILY", "DEVICE_TYPE", "HTTP_PROTOCOL", "HTTP_VERSION", "IP_VERSION", "OS", "POST_QUANTUM", "TLS_VERSION"]).pipe(T.HttpPath("dimension"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/timeseries_groups/{dimension}" })) as unknown as Schema.Schema<TimeseriesGroupsV2HttpRequest>;
...
export type TimeseriesGroupsV2HttpError =
  | DefaultErrors;
...
export const TimeseriesGroupsV2LeakedCredentialRequest = Schema.Struct({
  dimension: Schema.Literals(["COMPROMISED", "BOT_CLASS"]).pipe(T.HttpPath("dimension"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/leaked_credential_checks/timeseries_groups/{dimension}" })) as unknown as Schema.Schema<TimeseriesGroupsV2LeakedCredentialRequest>;
...
export type TimeseriesGroupsV2LeakedCredentialError =
  | DefaultErrors;
...
export const CacheHitDnsSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/summary/cache_hit" })) as unknown as Schema.Schema<CacheHitDnsSummaryRequest>;
...
export type CacheHitDnsSummaryError =
  | DefaultErrors;
...
export const CacheHitDnsTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/timeseries_groups/cache_hit" })) as unknown as Schema.Schema<CacheHitDnsTimeseriesGroupRequest>;
...
export type CacheHitDnsTimeseriesGroupError =
  | DefaultErrors;
...
export const TimeseriesHttpRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/timeseries" })) as unknown as Schema.Schema<TimeseriesHttpRequest>;
...
export type TimeseriesHttpError =
  | DefaultErrors;
...
export const GetHttpAsRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/ases" })) as unknown as Schema.Schema<GetHttpAsRequest>;
...
export const GetHttpAsBotClassRequest = Schema.Struct({
  botClass: Schema.Literals(["LIKELY_AUTOMATED", "LIKELY_HUMAN"]).pipe(T.HttpPath("botClass"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/ases/bot_class/{botClass}" })) as unknown as Schema.Schema<GetHttpAsBotClassRequest>;
...
export type GetHttpAsBotClassError =
  | DefaultErrors;
...
export const GetHttpAsBrowserFamilyRequest = Schema.Struct({
  browserFamily: Schema.Literals(["CHROME", "EDGE", "FIREFOX", "SAFARI"]).pipe(T.HttpPath("browserFamily"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/ases/browser_family/{browserFamily}" })) as unknown as Schema.Schema<GetHttpAsBrowserFamilyRequest>;
...
export type GetHttpAsBrowserFamilyError =
  | DefaultErrors;
...
export const GetHttpAsDeviceTypeRequest = Schema.Struct({
  deviceType: Schema.Literals(["DESKTOP", "MOBILE", "OTHER"]).pipe(T.HttpPath("deviceType"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/ases/device_type/{deviceType}" })) as unknown as Schema.Schema<GetHttpAsDeviceTypeRequest>;
...
export type GetHttpAsDeviceTypeError =
  | DefaultErrors;
...
export const GetHttpAsHttpMethodRequest = Schema.Struct({
  httpVersion: Schema.Literals(["HTTPv1", "HTTPv2", "HTTPv3"]).pipe(T.HttpPath("httpVersion"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/ases/http_version/{httpVersion}" })) as unknown as Schema.Schema<GetHttpAsHttpMethodRequest>;
...
export type GetHttpAsHttpMethodError =
  | DefaultErrors;
...
export const GetHttpAsHttpProtocolRequest = Schema.Struct({
  httpProtocol: Schema.Literals(["HTTP", "HTTPS"]).pipe(T.HttpPath("httpProtocol"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/ases/http_protocol/{httpProtocol}" })) as unknown as Schema.Schema<GetHttpAsHttpProtocolRequest>;
...
export type GetHttpAsHttpProtocolError =
  | DefaultErrors;
...
export const GetHttpAsIpVersionRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/ases/ip_version/{ipVersion}" })) as unknown as Schema.Schema<GetHttpAsIpVersionRequest>;
...
export type GetHttpAsIpVersionError =
  | DefaultErrors;
...
export const GetHttpAsOsRequest = Schema.Struct({
  os: Schema.Literals(["WINDOWS", "MACOSX", "IOS", "ANDROID", "CHROMEOS", "LINUX", "SMART_TV"]).pipe(T.HttpPath("os"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/ases/os/{os}" })) as unknown as Schema.Schema<GetHttpAsOsRequest>;
...
export const GetHttpAsTlsVersionRequest = Schema.Struct({
  tlsVersion: Schema.Literals(["TLSv1_0", "TLSv1_1", "TLSv1_2", "TLSv1_3", "TLSvQUIC"]).pipe(T.HttpPath("tlsVersion"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/ases/tls_version/{tlsVersion}" })) as unknown as Schema.Schema<GetHttpAsTlsVersionRequest>;
...
export type GetHttpAsTlsVersionError =
  | DefaultErrors;
...
export const GetHttpLocationRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/locations" })) as unknown as Schema.Schema<GetHttpLocationRequest>;
...
export type GetHttpLocationError =
  | DefaultErrors;
...
export const GetHttpLocationBotClassRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/locations/bot_class/{botClass}" })) as unknown as Schema.Schema<GetHttpLocationBotClassRequest>;
...
export type GetHttpLocationBotClassError =
  | DefaultErrors;
...
export const GetHttpLocationBrowserFamilyRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/locations/browser_family/{browserFamily}" })) as unknown as Schema.Schema<GetHttpLocationBrowserFamilyRequest>;
...
export type GetHttpLocationBrowserFamilyError =
  | DefaultErrors;
...
export const GetHttpLocationDeviceTypeRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/locations/device_type/{deviceType}" })) as unknown as Schema.Schema<GetHttpLocationDeviceTypeRequest>;
...
export type GetHttpLocationDeviceTypeError =
  | DefaultErrors;
...
export const GetHttpLocationHttpMethodRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/locations/http_version/{httpVersion}" })) as unknown as Schema.Schema<GetHttpLocationHttpMethodRequest>;
...
export type GetHttpLocationHttpMethodError =
  | DefaultErrors;
...
export const GetHttpLocationHttpProtocolRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/locations/http_protocol/{httpProtocol}" })) as unknown as Schema.Schema<GetHttpLocationHttpProtocolRequest>;
...
export type GetHttpLocationHttpProtocolError =
  | DefaultErrors;
...
export const GetHttpLocationIpVersionRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/locations/ip_version/{ipVersion}" })) as unknown as Schema.Schema<GetHttpLocationIpVersionRequest>;
...
export type GetHttpLocationIpVersionError =
  | DefaultErrors;
...
export const GetHttpLocationOsRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/locations/os/{os}" })) as unknown as Schema.Schema<GetHttpLocationOsRequest>;
...
export type GetHttpLocationOsError =
  | DefaultErrors;
...
export const GetHttpLocationTlsVersionRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/locations/tls_version/{tlsVersion}" })) as unknown as Schema.Schema<GetHttpLocationTlsVersionRequest>;
...
export type GetHttpLocationTlsVersionError =
  | DefaultErrors;
...
export const OsHttpSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/summary/os" })) as unknown as Schema.Schema<OsHttpSummaryRequest>;
...
export type OsHttpSummaryError =
  | DefaultErrors;
...
export const BrowserHttpTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/timeseries_groups/browser" })) as unknown as Schema.Schema<BrowserHttpTimeseriesGroupRequest>;
...
export type BrowserHttpTimeseriesGroupError =
  | DefaultErrors;
...
export const OsHttpTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/timeseries_groups/os" })) as unknown as Schema.Schema<OsHttpTimeseriesGroupRequest>;
...
export type OsHttpTimeseriesGroupError =
  | DefaultErrors;
...
export const BrowserHttpTopRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/top/browser" })) as unknown as Schema.Schema<BrowserHttpTopRequest>;
...
export type BrowserHttpTopError =
  | DefaultErrors;
...
export const CompromisedLeakedCredentialSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/leaked_credential_checks/summary/compromised" })) as unknown as Schema.Schema<CompromisedLeakedCredentialSummaryRequest>;
...
export type CompromisedLeakedCredentialSummaryError =
  | DefaultErrors;
...
export const CompromisedLeakedCredentialTimeseriesGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/leaked_credential_checks/timeseries_groups/compromised" })) as unknown as Schema.Schema<CompromisedLeakedCredentialTimeseriesGroupRequest>;
...
export const CompromisedLeakedCredentialTimeseriesGroupResponse = Schema.Struct({
  ...
  timestamps: Schema.Array(Schema.String)
}).pipe(Schema.encodeKeys({ cLEAN: "CLEAN", cOMPROMISED: "COMPROMISED", timestamps: "timestamps" }))
}) as unknown as Schema.Schema<CompromisedLeakedCredentialTimeseriesGroupResponse>;

export type CompromisedLeakedCredentialTimeseriesGroupError =
  | DefaultErrors;
...
export const HttpMethodAttackLayer7SummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/summary/http_method" })) as unknown as Schema.Schema<HttpMethodAttackLayer7SummaryRequest>;
...
export type HttpMethodAttackLayer7SummaryError =
  | DefaultErrors;
...
export const HttpMethodAttackLayer7TimeseriesGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/timeseries_groups/http_method" })) as unknown as Schema.Schema<HttpMethodAttackLayer7TimeseriesGroupRequest>;
...
export type HttpMethodAttackLayer7TimeseriesGroupError =
  | DefaultErrors;
...
export const SummaryNetflowRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/netflows/summary" })) as unknown as Schema.Schema<SummaryNetflowRequest>;
...
export type SummaryNetflowError =
  | DefaultErrors;
...
export const TimeseriesNetflowRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/netflows/timeseries" })) as unknown as Schema.Schema<TimeseriesNetflowRequest>;
...
export type TimeseriesNetflowError =
  | DefaultErrors;
...
export const AsesNetflowTopRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/netflows/top/ases" })) as unknown as Schema.Schema<AsesNetflowTopRequest>;
...
export type AsesNetflowTopError =
  | DefaultErrors;
...
export const LocationsNetflowTopRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/netflows/top/locations" })) as unknown as Schema.Schema<LocationsNetflowTopRequest>;
...
export type LocationsNetflowTopError =
  | DefaultErrors;
...
export const MitigationProductAttackLayer7SummaryRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/summary/mitigation_product" })) as unknown as Schema.Schema<MitigationProductAttackLayer7SummaryRequest>;
...
export type MitigationProductAttackLayer7SummaryError =
  | DefaultErrors;
...
export const MitigationProductAttackLayer7TimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/timeseries_groups/mitigation_product" })) as unknown as Schema.Schema<MitigationProductAttackLayer7TimeseriesGroupRequest>;
...
export const HttpProtocolHttpSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/summary/http_protocol" })) as unknown as Schema.Schema<HttpProtocolHttpSummaryRequest>;
...
export type HttpProtocolHttpSummaryError =
  | DefaultErrors;
...
export const HttpProtocolHttpTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/timeseries_groups/http_protocol" })) as unknown as Schema.Schema<HttpProtocolHttpTimeseriesGroupRequest>;
...
export type HttpProtocolHttpTimeseriesGroupError =
  | DefaultErrors;
...
export const SummaryQualityIqiRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/quality/iqi/summary" })) as unknown as Schema.Schema<SummaryQualityIqiRequest>;
...
export type SummaryQualityIqiError =
  | DefaultErrors;
...
export const HistogramQualitySpeedRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/quality/speed/histogram" })) as unknown as Schema.Schema<HistogramQualitySpeedRequest>;
...
export interface HistogramQualitySpeedResponse {
  ...
  /** Metadata for the results. */
  meta: { bucketSize: number; confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; totalTests: number[]; units: { name: string; value: string }[] };
}
...
export type HistogramQualitySpeedError =
  | DefaultErrors;
...
export const SummaryQualitySpeedRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/quality/speed/summary" })) as unknown as Schema.Schema<SummaryQualitySpeedRequest>;

export interface SummaryQualitySpeedResponse {
  /** Metadata for the results. */
  meta: { confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  summary_0: { bandwidthDownload: string; bandwidthUpload: string; jitterIdle: string; jitterLoaded: string; latencyIdle: string; latencyLoaded: string; packetLoss: string };
}
...
export type SummaryQualitySpeedError =
  | DefaultErrors;
...
export const AsesQualitySpeedTopRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/quality/speed/top/ases" })) as unknown as Schema.Schema<AsesQualitySpeedTopRequest>;

export interface AsesQualitySpeedTopResponse {
  /** Metadata for the results. */
  meta: { confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number } | null; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  top_0: { bandwidthDownload: string; bandwidthUpload: string; clientASN: number; clientASName: string; jitterIdle: string; jitterLoaded: string; latencyIdle: string; latencyLoaded: string; numTests: number; rankPower: number }[];
}
...
export type AsesQualitySpeedTopError =
  | DefaultErrors;
...
export const LocationsQualitySpeedTopRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/quality/speed/top/locations" })) as unknown as Schema.Schema<LocationsQualitySpeedTopRequest>;

export interface LocationsQualitySpeedTopResponse {
  /** Metadata for the results. */
  meta: { confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number } | null; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  top_0: { bandwidthDownload: string; bandwidthUpload: string; clientCountryAlpha2: string; clientCountryName: string; jitterIdle: string; jitterLoaded: string; latencyIdle: string; latencyLoaded: string; numTests: number; rankPower: number }[];
}
...
export type LocationsQualitySpeedTopError =
  | DefaultErrors;
...
export const PostQuantumHttpSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/summary/post_quantum" })) as unknown as Schema.Schema<PostQuantumHttpSummaryRequest>;
...
export type PostQuantumHttpSummaryError =
  | DefaultErrors;
...
export const PostQuantumHttpTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/timeseries_groups/post_quantum" })) as unknown as Schema.Schema<PostQuantumHttpTimeseriesGroupRequest>;
...
export const PostQuantumHttpTimeseriesGroupResponse = Schema.Struct({
  ...
  sUPPORTED: Schema.Array(Schema.String),
  timestamps: Schema.Array(Schema.String)
}).pipe(Schema.encodeKeys({ nOT_SUPPORTED: "NOT_SUPPORTED", sUPPORTED: "SUPPORTED", timestamps: "timestamps" }))
}) as unknown as Schema.Schema<PostQuantumHttpTimeseriesGroupResponse>;

export type PostQuantumHttpTimeseriesGroupError =
  | DefaultErrors;
...
export const TopRankingRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/ranking/top" })) as unknown as Schema.Schema<TopRankingRequest>;

export interface TopRankingResponse {
  meta: { confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number } | null; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  top_0: { categories: { id: number; name: string; superCategoryId: number }[]; domain: string; rank: number; pctRankChange?: number }[];
}
...
export const GetRankingDomainRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/ranking/domain/{domain}" })) as unknown as Schema.Schema<GetRankingDomainRequest>;

export interface GetRankingDomainResponse {
  details_0: { categories: { id: number; name: string; superCategoryId: number }[]; bucket?: string; rank?: number; topLocations?: { locationCode: string; locationName: string; rank: number }[] };
  meta: { dateRange: { endTime: string; startTime: string }[] };
}
...
export const GetRankingDomainResponse = Schema.Struct({
  ...
  topLocations: Schema.optional(Schema.Array(Schema.Struct({
    locationCode: Schema.String,
    locationName: Schema.String,
    rank: Schema.Number
  })))
}).pipe(Schema.encodeKeys({ categories: "categories", bucket: "bucket", rank: "rank", topLocations: "top_locations" })),
  meta: Schema.Struct({
  dateRange: Schema.Array(Schema.Struct({
    endTime: Schema.String,
    startTime: Schema.String
...
export type GetRankingDomainError =
  | DefaultErrors;
...
export const CategoriesRankingInternetServiceRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/ranking/internet_services/categories" })) as unknown as Schema.Schema<CategoriesRankingInternetServiceRequest>;
...
export type CategoriesRankingInternetServiceError =
  | DefaultErrors;
...
export const TopRankingInternetServiceRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/ranking/internet_services/top" })) as unknown as Schema.Schema<TopRankingInternetServiceRequest>;
...
export type TopRankingInternetServiceError =
  | DefaultErrors;
...
export const DirectiveRobotsTxtTopUserAgentRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/robots_txt/top/user_agents/directive" })) as unknown as Schema.Schema<DirectiveRobotsTxtTopUserAgentRequest>;
...
export type DirectiveRobotsTxtTopUserAgentError =
  | DefaultErrors;
...
export const ManagedRulesAttackLayer7SummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/summary/managed_rules" })) as unknown as Schema.Schema<ManagedRulesAttackLayer7SummaryRequest>;
...
export type ManagedRulesAttackLayer7SummaryError =
  | DefaultErrors;
...
export const ManagedRulesAttackLayer7TimeseriesGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/timeseries_groups/managed_rules" })) as unknown as Schema.Schema<ManagedRulesAttackLayer7TimeseriesGroupRequest>;
...
export type ManagedRulesAttackLayer7TimeseriesGroupError =
  | DefaultErrors;
...
export interface GlobalSearchRequest {
  ...
  exclude?: ("ADM1S" | "ASNS" | "BOTS" | "CERTIFICATE_AUTHORITIES" | "CERTIFICATE_LOGS" | "ORIGINS" | "ORIGIN_REGIONS" | "INDUSTRIES" | "LOCATIONS" | "NOTEBOOKS" | "TLDS" | "VERTICALS")[];
  /** Format in which results will be returned. */
  format?: "JSON" | "CSV";
  /** Search types included in results. */
  include?: ("ADM1S" | "ASNS" | "BOTS" | "CERTIFICATE_AUTHORITIES" | "CERTIFICATE_LOGS" | "ORIGINS" | "ORIGIN_REGIONS" | "INDUSTRIES" | "LOCATIONS" | "NOTEBOOKS" | "TLDS" | "VERTICALS")[];
...
export const GlobalSearchRequest = Schema.Struct({
  query: Schema.String,
  exclude: Schema.optional(Schema.Array(Schema.Literals(["ADM1S", "ASNS", "BOTS", "CERTIFICATE_AUTHORITIES", "CERTIFICATE_LOGS", "ORIGINS", "ORIGIN_REGIONS", "INDUSTRIES", "LOCATIONS", "NOTEBOOKS", "TLDS", "VERTICALS"]))),
  format: Schema.optional(Schema.Literals(["JSON", "CSV"])),
  include: Schema.optional(Schema.Array(Schema.Literals(["ADM1S", "ASNS", "BOTS", "CERTIFICATE_AUTHORITIES", "CERTIFICATE_LOGS", "ORIGINS", "ORIGIN_REGIONS", "INDUSTRIES", "LOCATIONS", "NOTEBOOKS", "TLDS", "VERTICALS"]))),
  limit: Schema.optional(Schema.Number),
  limitPerGroup: Schema.optional(Schema.Number)
})
  .pipe(T.Http({ method: "GET", path: "/radar/search/global" })) as unknown as Schema.Schema<GlobalSearchRequest>;
...
export const GlobalSearchResponse = Schema.Struct({
  search: Schema.Array(Schema.Struct({
  code: Schema.String,
  name: Schema.String,
  type: Schema.String
}))
...
export const AsSetEntityAsnRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/entities/asns/{asn}/as_set" })) as unknown as Schema.Schema<AsSetEntityAsnRequest>;

export interface AsSetEntityAsnResponse {
  asSets: { asMembersCount: number; asSetMembersCount: number; asSetUpstreamsCount: number; asnConeSize: number; irrSources: string[]; name: string; hierarchicalAsn?: number; inferredAsn?: number; peeringdbAsn?: number }[];
...
}).pipe(Schema.encodeKeys({ asMembersCount: "as_members_count", asSetMembersCount: "as_set_members_count", asSetUpstreamsCount: "as_set_upstreams_count", asnConeSize: "asn_cone_size", irrSources: "irr_sources", name: "name", hierarchicalAsn: "hierarchical_asn", inferredAsn: "inferred_asn", peeringdbAsn: "peeringdb_asn" }))),
  paths: Schema.Array(Schema.Array(Schema.String))
}).pipe(Schema.encodeKeys({ asSets: "as_sets", paths: "paths" })) as unknown as Schema.Schema<AsSetEntityAsnResponse>;

export type AsSetEntityAsnError =
  | DefaultErrors;
...
export const SummaryTcpResetsTimeoutRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/tcp_resets_timeouts/summary" })) as unknown as Schema.Schema<SummaryTcpResetsTimeoutRequest>;

export interface SummaryTcpResetsTimeoutResponse {
  /** Metadata for the results. */
  meta: { confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  summary_0: { laterInFlow: string; noMatch: string; postAck: string; postPsh: string; postSyn: string };
}
...
}).pipe(Schema.encodeKeys({ laterInFlow: "later_in_flow", noMatch: "no_match", postAck: "post_ack", postPsh: "post_psh", postSyn: "post_syn" }))
}) as unknown as Schema.Schema<SummaryTcpResetsTimeoutResponse>;

export type SummaryTcpResetsTimeoutError =
  | DefaultErrors;
...
export const GetTrafficAnomalyRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/traffic_anomalies" })) as unknown as Schema.Schema<GetTrafficAnomalyRequest>;

export interface GetTrafficAnomalyResponse {
  trafficAnomalies: { startDate: string; status: string; type: string; uuid: string; asnDetails?: { asn: string; name: string; locations?: { code: string; name: string } }; endDate?: string; locationDetails?: { code: string; name: string }; originDetails?: { name: string; origin: string }; visibleInDataSources?: string[] }[];
}
...
export type GetTrafficAnomalyError =
  | DefaultErrors;
...
export const GetTrafficAnomalyLocationRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/traffic_anomalies/locations" })) as unknown as Schema.Schema<GetTrafficAnomalyLocationRequest>;
...
export type GetTrafficAnomalyLocationError =
  | DefaultErrors;
...
export const ResponseTTLDnsSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/summary/response_ttl" })) as unknown as Schema.Schema<ResponseTTLDnsSummaryRequest>;

export interface ResponseTTLDnsSummaryResponse {
  /** Metadata for the results. */
  meta: { confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  summary_0: { gt_15mLte_1h: string; gt_1dLte_1w: string; gt_1hLte_1d: string; gt_1mLte_5m: string; gt_1w: string; gt_5mLte_15m: string; lte_1m: string };
}
...
}).pipe(Schema.encodeKeys({ gt_15mLte_1h: "gt_15m_lte_1h", gt_1dLte_1w: "gt_1d_lte_1w", gt_1hLte_1d: "gt_1h_lte_1d", gt_1mLte_5m: "gt_1m_lte_5m", gt_1w: "gt_1w", gt_5mLte_15m: "gt_5m_lte_15m", lte_1m: "lte_1m" }))
}) as unknown as Schema.Schema<ResponseTTLDnsSummaryResponse>;

export type ResponseTTLDnsSummaryError =
  | DefaultErrors;
...
export const ResponseTTLDnsTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/timeseries_groups/response_ttl" })) as unknown as Schema.Schema<ResponseTTLDnsTimeseriesGroupRequest>;

export interface ResponseTTLDnsTimeseriesGroupResponse {
  /** Metadata for the results. */
  meta: { aggInterval: "FIFTEEN_MINUTES" | "ONE_HOUR" | "ONE_DAY" | "ONE_WEEK" | "ONE_MONTH"; confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  serie_0: { gt_15mLte_1h: string[]; gt_1dLte_1w: string[]; gt_1hLte_1d: string[]; gt_1mLte_5m: string[]; gt_1w: string[]; gt_5mLte_15m: string[]; lte_1m: string[] };
}
...
export type ResponseTTLDnsTimeseriesGroupError =
  | DefaultErrors;
...
export const QueryTypeAs112SummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/as112/summary/query_type" })) as unknown as Schema.Schema<QueryTypeAs112SummaryRequest>;
...
export type QueryTypeAs112SummaryError =
  | DefaultErrors;
...
export const QueryTypeAs112TimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/as112/timeseries_groups/query_type" })) as unknown as Schema.Schema<QueryTypeAs112TimeseriesGroupRequest>;
...
export type QueryTypeAs112TimeseriesGroupError =
  | DefaultErrors;
...
export const QueryTypeDnsSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/summary/query_type" })) as unknown as Schema.Schema<QueryTypeDnsSummaryRequest>;
...
export type QueryTypeDnsSummaryError =
  | DefaultErrors;
...
export const QueryTypeDnsTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/timeseries_groups/query_type" })) as unknown as Schema.Schema<QueryTypeDnsTimeseriesGroupRequest>;
...
export type QueryTypeDnsTimeseriesGroupError =
  | DefaultErrors;
...
export const DeviceTypeHttpSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/summary/device_type" })) as unknown as Schema.Schema<DeviceTypeHttpSummaryRequest>;
...
export type DeviceTypeHttpSummaryError =
  | DefaultErrors;
...
export const DeviceTypeHttpTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/timeseries_groups/device_type" })) as unknown as Schema.Schema<DeviceTypeHttpTimeseriesGroupRequest>;
...
export type DeviceTypeHttpTimeseriesGroupError =
  | DefaultErrors;
...
export const SummaryV2AiBotRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/ai/bots/summary/{dimension}" })) as unknown as Schema.Schema<SummaryV2AiBotRequest>;
...
export type SummaryV2AiBotError =
  | DefaultErrors;
...
export const SummaryV2AiInferenceRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/ai/inference/summary/{dimension}" })) as unknown as Schema.Schema<SummaryV2AiInferenceRequest>;
...
export type SummaryV2AiInferenceError =
  | DefaultErrors;
...
export const SummaryV2As112Request = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/as112/summary/{dimension}" })) as unknown as Schema.Schema<SummaryV2As112Request>;
...
export type SummaryV2As112Error =
  | DefaultErrors;
...
export const SummaryV2AttackLayer3Request = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/summary/{dimension}" })) as unknown as Schema.Schema<SummaryV2AttackLayer3Request>;
...
export type SummaryV2AttackLayer3Error =
  | DefaultErrors;
...
export const SummaryV2AttackLayer7Request = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/summary/{dimension}" })) as unknown as Schema.Schema<SummaryV2AttackLayer7Request>;
...
export type SummaryV2AttackLayer7Error =
  | DefaultErrors;
...
export interface SummaryV2DnsRequest {
  dimension: "IP_VERSION" | "CACHE_HIT" | "DNSSEC" | "DNSSEC_AWARE" | "DNSSEC_E2E" | "MATCHING_ANSWER" | "PROTOCOL" | "QUERY_TYPE" | "RESPONSE_CODE" | "RESPONSE_TTL" | "TLD" | "TLD_DNS_MAGNITUDE";
}

export const SummaryV2DnsRequest = Schema.Struct({
  dimension: Schema.Literals(["IP_VERSION", "CACHE_HIT", "DNSSEC", "DNSSEC_AWARE", "DNSSEC_E2E", "MATCHING_ANSWER", "PROTOCOL", "QUERY_TYPE", "RESPONSE_CODE", "RESPONSE_TTL", "TLD", "TLD_DNS_MAGNITUDE"]).pipe(T.HttpPath("dimension"))
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/summary/{dimension}" })) as unknown as Schema.Schema<SummaryV2DnsRequest>;
...
export const SummaryV2EmailRoutingRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/email/routing/summary/{dimension}" })) as unknown as Schema.Schema<SummaryV2EmailRoutingRequest>;
...
export type SummaryV2EmailRoutingError =
  | DefaultErrors;
...
export const SummaryV2EmailSecurityRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/summary/{dimension}" })) as unknown as Schema.Schema<SummaryV2EmailSecurityRequest>;
...
export type SummaryV2EmailSecurityError =
  | DefaultErrors;
...
export const SummaryV2HttpRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/http/summary/{dimension}" })) as unknown as Schema.Schema<SummaryV2HttpRequest>;
...
export type SummaryV2HttpError =
  | DefaultErrors;
...
export const SummaryV2LeakedCredentialRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/leaked_credential_checks/summary/{dimension}" })) as unknown as Schema.Schema<SummaryV2LeakedCredentialRequest>;
...
export type SummaryV2LeakedCredentialError =
  | DefaultErrors;
...
export const SummaryV2NetflowRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/netflows/summary/{dimension}" })) as unknown as Schema.Schema<SummaryV2NetflowRequest>;
...
export type SummaryV2NetflowError =
  | DefaultErrors;
...
export const BotsVerifiedBotTopRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/verified_bots/top/bots" })) as unknown as Schema.Schema<BotsVerifiedBotTopRequest>;
...
export type BotsVerifiedBotTopError =
  | DefaultErrors;
...
export const CategoriesVerifiedBotTopRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/verified_bots/top/categories" })) as unknown as Schema.Schema<CategoriesVerifiedBotTopRequest>;
...
export type CategoriesVerifiedBotTopError =
  | DefaultErrors;
...
export const IpVersionAs112SummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/as112/summary/ip_version" })) as unknown as Schema.Schema<IpVersionAs112SummaryRequest>;
...
export type IpVersionAs112SummaryError =
  | DefaultErrors;
...
export const IpVersionAs112TimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/as112/timeseries_groups/ip_version" })) as unknown as Schema.Schema<IpVersionAs112TimeseriesGroupRequest>;
...
export type IpVersionAs112TimeseriesGroupError =
  | DefaultErrors;
...
export const IpVersionAs112TopRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/as112/top/locations/ip_version/{ipVersion}" })) as unknown as Schema.Schema<IpVersionAs112TopRequest>;
...
export type IpVersionAs112TopError =
  | DefaultErrors;
...
export const IpVersionAttackLayer3SummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/summary/ip_version" })) as unknown as Schema.Schema<IpVersionAttackLayer3SummaryRequest>;
...
export type IpVersionAttackLayer3SummaryError =
  | DefaultErrors;
...
export const IpVersionAttackLayer3TimeseriesGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer3/timeseries_groups/ip_version" })) as unknown as Schema.Schema<IpVersionAttackLayer3TimeseriesGroupRequest>;
...
export const IpVersionAttackLayer3TimeseriesGroupResponse = Schema.Struct({
  ...
  iPv6: Schema.Array(Schema.String),
  timestamps: Schema.Array(Schema.String)
}).pipe(Schema.encodeKeys({ iPv4: "IPv4", iPv6: "IPv6", timestamps: "timestamps" }))
}) as unknown as Schema.Schema<IpVersionAttackLayer3TimeseriesGroupResponse>;

export type IpVersionAttackLayer3TimeseriesGroupError =
  | DefaultErrors;
...
export const HttpVersionAttackLayer7SummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/summary/http_version" })) as unknown as Schema.Schema<HttpVersionAttackLayer7SummaryRequest>;
...
export type HttpVersionAttackLayer7SummaryError =
  | DefaultErrors;
...
export const IpVersionAttackLayer7SummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/summary/ip_version" })) as unknown as Schema.Schema<IpVersionAttackLayer7SummaryRequest>;
...
export type IpVersionAttackLayer7SummaryError =
  | DefaultErrors;
...
export const HttpVersionAttackLayer7TimeseriesGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/timeseries_groups/http_version" })) as unknown as Schema.Schema<HttpVersionAttackLayer7TimeseriesGroupRequest>;
...
export type HttpVersionAttackLayer7TimeseriesGroupError =
  | DefaultErrors;
...
export const IpVersionAttackLayer7TimeseriesGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/attacks/layer7/timeseries_groups/ip_version" })) as unknown as Schema.Schema<IpVersionAttackLayer7TimeseriesGroupRequest>;
...
export type IpVersionAttackLayer7TimeseriesGroupError =
  | DefaultErrors;
...
export const IpVersionDnsSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/summary/ip_version" })) as unknown as Schema.Schema<IpVersionDnsSummaryRequest>;
...
export type IpVersionDnsSummaryError =
  | DefaultErrors;
...
export const IpVersionDnsTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/dns/timeseries_groups/ip_version" })) as unknown as Schema.Schema<IpVersionDnsTimeseriesGroupRequest>;
...
export type IpVersionDnsTimeseriesGroupError =
  | DefaultErrors;
...
export const IpVersionEmailRoutingSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/routing/summary/ip_version" })) as unknown as Schema.Schema<IpVersionEmailRoutingSummaryRequest>;
...
export type IpVersionEmailRoutingSummaryError =
  | DefaultErrors;
...
export const IpVersionEmailRoutingTimeseriesGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/email/routing/timeseries_groups/ip_version" })) as unknown as Schema.Schema<IpVersionEmailRoutingTimeseriesGroupRequest>;
...
export type IpVersionEmailRoutingTimeseriesGroupError =
  | DefaultErrors;
...
export const TlsVersionEmailSecuritySummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/summary/tls_version" })) as unknown as Schema.Schema<TlsVersionEmailSecuritySummaryRequest>;
...
export type TlsVersionEmailSecuritySummaryError =
  | DefaultErrors;
...
export const TlsVersionEmailSecurityTimeseriesGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/radar/email/security/timeseries_groups/tls_version" })) as unknown as Schema.Schema<TlsVersionEmailSecurityTimeseriesGroupRequest>;
...
export type TlsVersionEmailSecurityTimeseriesGroupError =
  | DefaultErrors;
...
export const HttpVersionHttpSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/summary/http_version" })) as unknown as Schema.Schema<HttpVersionHttpSummaryRequest>;
...
export type HttpVersionHttpSummaryError =
  | DefaultErrors;
...
export const IpVersionHttpSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/summary/ip_version" })) as unknown as Schema.Schema<IpVersionHttpSummaryRequest>;
...
export type IpVersionHttpSummaryError =
  | DefaultErrors;
...
export const TlsVersionHttpSummaryRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/summary/tls_version" })) as unknown as Schema.Schema<TlsVersionHttpSummaryRequest>;

export interface TlsVersionHttpSummaryResponse {
  /** Metadata for the results. */
  meta: { confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  summary_0: { 'TLS 1.0': string; 'TLS 1.1': string; 'TLS 1.2': string; 'TLS 1.3': string; 'TLS QUIC': string };
}
...
export type TlsVersionHttpSummaryError =
  | DefaultErrors;
...
export const HttpVersionHttpTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/timeseries_groups/http_version" })) as unknown as Schema.Schema<HttpVersionHttpTimeseriesGroupRequest>;
...
export type HttpVersionHttpTimeseriesGroupError =
  | DefaultErrors;
...
export const IpVersionHttpTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/timeseries_groups/ip_version" })) as unknown as Schema.Schema<IpVersionHttpTimeseriesGroupRequest>;
...
export type IpVersionHttpTimeseriesGroupError =
  | DefaultErrors;
...
export const TlsVersionHttpTimeseriesGroupRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/radar/http/timeseries_groups/tls_version" })) as unknown as Schema.Schema<TlsVersionHttpTimeseriesGroupRequest>;

export interface TlsVersionHttpTimeseriesGroupResponse {
  /** Metadata for the results. */
  meta: { aggInterval: "FIFTEEN_MINUTES" | "ONE_HOUR" | "ONE_DAY" | "ONE_WEEK" | "ONE_MONTH"; confidenceInfo: { annotations: ({ dataSource: "ALL" | "AI_BOTS" | "AI_GATEWAY" | "BGP" | "BOTS" | "CONNECTION_ANOMALY" | "CT" | "DNS" | "DNS_MAGNITUDE" | "DNS_AS112" | "DOS" | "EMAIL_ROUTING" | "EMAIL_SECURITY" | "FW" | "FW_PG" | "HTTP" | "HTTP_CONTROL" | "HTTP_CRAWLER_REFERER" | "HTTP_ORIGINS" | "IQI" | "LEAKED_CREDENTIALS" | "NET" | "ROBOTS_TXT" | "SPEED" | "WORKERS_AI"; description: string; endDate: string; eventType: "EVENT" | "GENERAL" | "OUTAGE" | "PARTIAL_PROJECTION" | "PIPELINE" | "TRAFFIC_ANOMALY"; isInstantaneous: boolean; linkedUrl: string; startDate: string })[]; level: number }; dateRange: { endTime: string; startTime: string }[]; lastUpdated: string; normalization: "PERCENTAGE" | "MIN0_MAX" | "MIN_MAX" | "RAW_VALUES" | "PERCENTAGE_CHANGE" | "ROLLING_AVERAGE" | "OVERLAPPED_PERCENTAGE" | "RATIO"; units: { name: string; value: string }[] };
  serie_0: { timestamps: string[]; 'TLS 1.0': string[]; 'TLS 1.1': string[]; 'TLS 1.2': string[]; 'TLS 1.3': string[]; 'TLS QUIC': string[] };
}
...
export type TlsVersionHttpTimeseriesGroupError =
  | DefaultErrors;
