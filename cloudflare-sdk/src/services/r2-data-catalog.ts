...
export const CreateCredentialRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/accounts/{account_id}/r2-catalog/{bucketName}/credential" })) as unknown as Schema.Schema<CreateCredentialRequest>;

export type CreateCredentialResponse = unknown;

export const CreateCredentialResponse = Schema.Unknown as unknown as Schema.Schema<CreateCredentialResponse>;
...
export const GetMaintenanceConfigRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/accounts/{account_id}/r2-catalog/{bucketName}/maintenance-configs" })) as unknown as Schema.Schema<GetMaintenanceConfigRequest>;

export interface GetMaintenanceConfigResponse {
  /** Shows the credential configuration status. */
  credentialStatus: "present" | "absent";
  /** Configures maintenance for the catalog. */
  maintenanceConfig: { compaction?: { state: "enabled" | "disabled"; targetSizeMb: "64" | "128" | "256" | "512" }; snapshotExpiration?: { maxSnapshotAge: string; minSnapshotsToKeep: number; state: "enabled" | "disabled" } };
}
...
export const GetMaintenanceConfigResponse = Schema.Struct({
  ...
  }).pipe(Schema.encodeKeys({ state: "state", targetSizeMb: "target_size_mb" }))),
  snapshotExpiration: Schema.optional(Schema.Struct({
    maxSnapshotAge: Schema.String,
    minSnapshotsToKeep: Schema.Number,
    state: Schema.Literals(["enabled", "disabled"])
  }).pipe(Schema.encodeKeys({ maxSnapshotAge: "max_snapshot_age", minSnapshotsToKeep: "min_snapshots_to_keep", state: "state" })))
}).pipe(Schema.encodeKeys({ compaction: "compaction", snapshotExpiration: "snapshot_expiration" }))
}).pipe(Schema.encodeKeys({ credentialStatus: "credential_status", maintenanceConfig: "maintenance_config" })) as unknown as Schema.Schema<GetMaintenanceConfigResponse>;
...
export interface UpdateMaintenanceConfigRequest {
  ...
  compaction?: { state?: "enabled" | "disabled"; targetSizeMb?: "64" | "128" | "256" | "512" };
  /** Body param: Updates snapshot expiration configuration (all fields optional). */
  snapshotExpiration?: { maxSnapshotAge?: string; minSnapshotsToKeep?: number; state?: "enabled" | "disabled" };
}
...
export const UpdateMaintenanceConfigRequest = Schema.Struct({
  ...
  targetSizeMb: Schema.optional(Schema.Literals(["64", "128", "256", "512"]))
}).pipe(Schema.encodeKeys({ state: "state", targetSizeMb: "target_size_mb" }))),
  snapshotExpiration: Schema.optional(Schema.Struct({
  ...
  .pipe(Schema.encodeKeys({ compaction: "compaction", snapshotExpiration: "snapshot_expiration" }), T.Http({ method: "POST", path: "/accounts/{account_id}/r2-catalog/{bucketName}/maintenance-configs" })) as unknown as Schema.Schema<UpdateMaintenanceConfigRequest>;
...
}).pipe(Schema.encodeKeys({ compaction: "compaction", snapshotExpiration: "snapshot_expiration" })) as unknown as Schema.Schema<UpdateMaintenanceConfigResponse>;
...
export const ListNamespacesRequest = Schema.Struct({
  ...
  returnDetails: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("return_details")),
  returnUuids: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("return_uuids"))
})
  .pipe(T.Http({ method: "GET", path: "/accounts/{account_id}/r2-catalog/{bucketName}/namespaces" })) as unknown as Schema.Schema<ListNamespacesRequest>;
...
export interface ListNamespacesResponse {
  ...
  details?: ({ namespace: string[]; namespaceUuid: string; createdAt?: string | null; updatedAt?: string | null })[] | null;
...
export const ListNamespacesResponse = Schema.Struct({
  ...
  details: Schema.optional(Schema.Union([Schema.Array(Schema.Struct({
  namespace: Schema.Array(Schema.String),
  namespaceUuid: Schema.String,
  createdAt: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
  updatedAt: Schema.optional(Schema.Union([Schema.String, Schema.Null]))
}).pipe(Schema.encodeKeys({ namespace: "namespace", namespaceUuid: "namespace_uuid", createdAt: "created_at", updatedAt: "updated_at" }))), Schema.Null])),
  namespaceUuids: Schema.optional(Schema.Union([Schema.Array(Schema.String), Schema.Null])),
  nextPageToken: Schema.optional(Schema.Union([Schema.String, Schema.Null]))
}).pipe(Schema.encodeKeys({ namespaces: "namespaces", details: "details", namespaceUuids: "namespace_uuids", nextPageToken: "next_page_token" })) as unknown as Schema.Schema<ListNamespacesResponse>;
...
export const ListNamespaceTablesRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/accounts/{account_id}/r2-catalog/{bucketName}/namespaces/{namespace}/tables" })) as unknown as Schema.Schema<ListNamespaceTablesRequest>;
...
export interface ListNamespaceTablesResponse {
  ...
  details?: ({ identifier: { name: string; namespace: string[] }; tableUuid: string; createdAt?: string | null; location?: string | null; metadataLocation?: string | null; updatedAt?: string | null })[] | null;
  /** Use this opaque token to fetch the next page of results. A null or absent value indicates the last page. */
  nextPageToken?: string | null;
...
export const ListNamespaceTablesResponse = Schema.Struct({
  ...
  metadataLocation: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
  updatedAt: Schema.optional(Schema.Union([Schema.String, Schema.Null]))
}).pipe(Schema.encodeKeys({ identifier: "identifier", tableUuid: "table_uuid", createdAt: "created_at", location: "location", metadataLocation: "metadata_location", updatedAt: "updated_at" }))), Schema.Null])),
  nextPageToken: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
  tableUuids: Schema.optional(Schema.Union([Schema.Array(Schema.String), Schema.Null]))
}).pipe(Schema.encodeKeys({ identifiers: "identifiers", details: "details", nextPageToken: "next_page_token", tableUuids: "table_uuids" })) as unknown as Schema.Schema<ListNamespaceTablesResponse>;
...
export const GetNamespaceTableMaintenanceConfigRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/accounts/{account_id}/r2-catalog/{bucketName}/namespaces/{namespace}/tables/{tableName}/maintenance-configs" })) as unknown as Schema.Schema<GetNamespaceTableMaintenanceConfigRequest>;
...
}).pipe(Schema.encodeKeys({ maintenanceConfig: "maintenance_config" })) as unknown as Schema.Schema<GetNamespaceTableMaintenanceConfigResponse>;
...
export const UpdateNamespaceTableMaintenanceConfigRequest = Schema.Struct({
  ...
  .pipe(Schema.encodeKeys({ compaction: "compaction", snapshotExpiration: "snapshot_expiration" }), T.Http({ method: "POST", path: "/accounts/{account_id}/r2-catalog/{bucketName}/namespaces/{namespace}/tables/{tableName}/maintenance-configs" })) as unknown as Schema.Schema<UpdateNamespaceTableMaintenanceConfigRequest>;
...
}).pipe(Schema.encodeKeys({ compaction: "compaction", snapshotExpiration: "snapshot_expiration" })) as unknown as Schema.Schema<UpdateNamespaceTableMaintenanceConfigResponse>;
...
export const GetR2DataCatalogRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/accounts/{account_id}/r2-catalog/{bucketName}" })) as unknown as Schema.Schema<GetR2DataCatalogRequest>;
...
export interface GetR2DataCatalogResponse {
  ...
  /** Configures maintenance for the catalog. */
  maintenanceConfig?: { compaction?: { state: "enabled" | "disabled"; targetSizeMb: "64" | "128" | "256" | "512" }; snapshotExpiration?: { maxSnapshotAge: string; minSnapshotsToKeep: number; state: "enabled" | "disabled" } } | null;
}
...
export const GetR2DataCatalogResponse = Schema.Struct({
  ...
  credentialStatus: Schema.optional(Schema.Union([Schema.Literal("present"), Schema.Literal("absent"), Schema.Null])),
  maintenanceConfig: Schema.optional(Schema.Union([Schema.Struct({
  compaction: Schema.optional(Schema.Struct({
    state: Schema.Literals(["enabled", "disabled"]),
    targetSizeMb: Schema.Literals(["64", "128", "256", "512"])
  }).pipe(Schema.encodeKeys({ state: "state", targetSizeMb: "target_size_mb" }))),
...
}).pipe(Schema.encodeKeys({ compaction: "compaction", snapshotExpiration: "snapshot_expiration" })), Schema.Null]))
}).pipe(Schema.encodeKeys({ id: "id", bucket: "bucket", name: "name", status: "status", credentialStatus: "credential_status", maintenanceConfig: "maintenance_config" })) as unknown as Schema.Schema<GetR2DataCatalogResponse>;
...
export const ListR2DataCatalogsRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/accounts/{account_id}/r2-catalog" })) as unknown as Schema.Schema<ListR2DataCatalogsRequest>;

export interface ListR2DataCatalogsResponse {
  /** Lists catalogs in the account. */
  warehouses: ({ id: string; bucket: string; name: string; status: "active" | "inactive"; credentialStatus?: "present" | "absent" | null; maintenanceConfig?: { compaction?: { state: "enabled" | "disabled"; targetSizeMb: "64" | "128" | "256" | "512" }; snapshotExpiration?: { maxSnapshotAge: string; minSnapshotsToKeep: number; state: "enabled" | "disabled" } } | null })[];
}
...
}).pipe(Schema.encodeKeys({ id: "id", bucket: "bucket", name: "name", status: "status", credentialStatus: "credential_status", maintenanceConfig: "maintenance_config" })))
}) as unknown as Schema.Schema<ListR2DataCatalogsResponse>;

export type ListR2DataCatalogsError =
  | DefaultErrors
  | InvalidRoute;
...
export const EnableR2DataCatalogRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/accounts/{account_id}/r2-catalog/{bucketName}/enable" })) as unknown as Schema.Schema<EnableR2DataCatalogRequest>;
...
export const DisableR2DataCatalogRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/accounts/{account_id}/r2-catalog/{bucketName}/disable" })) as unknown as Schema.Schema<DisableR2DataCatalogRequest>;

export type DisableR2DataCatalogResponse = unknown;

export const DisableR2DataCatalogResponse = Schema.Unknown as unknown as Schema.Schema<DisableR2DataCatalogResponse>;
