...
T.applyErrorMatchers(InvalidWebhookId, [{"code":0,"message":{"includes":"invalid Webhook ID"}}]);
...
T.applyErrorMatchers(WebhookNotFound, [{"code":0,"message":{"includes":"Webhook not found"}}]);

export class WebhookTestFailed extends Schema.TaggedErrorClass<WebhookTestFailed>()(
  "WebhookTestFailed",
  { code: Schema.Number, message: Schema.String },
) {}
T.applyErrorMatchers(WebhookTestFailed, [{"code":0,"message":{"includes":"Webhook test failed"}}]);
...
export const ListAvailableAlertsRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/accounts/{account_id}/alerting/v3/available_alerts" })) as unknown as Schema.Schema<ListAvailableAlertsRequest>;

export type ListAvailableAlertsResponse = Record<string, unknown>;

export const ListAvailableAlertsResponse = Schema.Struct({}) as unknown as Schema.Schema<ListAvailableAlertsResponse>;

export type ListAvailableAlertsError =
  | DefaultErrors
  | InvalidRoute;
...
export const GetDestinationEligibleRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/accounts/{account_id}/alerting/v3/destinations/eligible" })) as unknown as Schema.Schema<GetDestinationEligibleRequest>;

export type GetDestinationEligibleResponse = Record<string, unknown>;

export const GetDestinationEligibleResponse = Schema.Struct({}) as unknown as Schema.Schema<GetDestinationEligibleResponse>;

export type GetDestinationEligibleError =
  | DefaultErrors
  | InvalidRoute;
...
export const GetDestinationPagerdutyRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/accounts/{account_id}/alerting/v3/destinations/pagerduty" })) as unknown as Schema.Schema<GetDestinationPagerdutyRequest>;

export type GetDestinationPagerdutyResponse = { id?: string; name?: string }[];

export const GetDestinationPagerdutyResponse = Schema.Array(Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String)
})) as unknown as Schema.Schema<GetDestinationPagerdutyResponse>;

export type GetDestinationPagerdutyError =
  | DefaultErrors;
...
export const CreateDestinationPagerdutyRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/accounts/{account_id}/alerting/v3/destinations/pagerduty/connect" })) as unknown as Schema.Schema<CreateDestinationPagerdutyRequest>;
...
export type CreateDestinationPagerdutyError =
  | DefaultErrors
  | InvalidRoute;
...
export const DeleteDestinationPagerdutyRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "DELETE", path: "/accounts/{account_id}/alerting/v3/destinations/pagerduty" })) as unknown as Schema.Schema<DeleteDestinationPagerdutyRequest>;
...
export type DeleteDestinationPagerdutyError =
  | DefaultErrors
  | InvalidRoute;
...
export const LinkDestinationPagerdutyRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/accounts/{account_id}/alerting/v3/destinations/pagerduty/connect/{tokenId}" })) as unknown as Schema.Schema<LinkDestinationPagerdutyRequest>;
...
export type LinkDestinationPagerdutyError =
  | DefaultErrors
  | InvalidRoute;
...
export const GetDestinationWebhookRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/accounts/{account_id}/alerting/v3/destinations/webhooks/{webhookId}" })) as unknown as Schema.Schema<GetDestinationWebhookRequest>;
...
export const GetDestinationWebhookResponse = Schema.Struct({
  ...
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.Literals(["datadog", "discord", "feishu", "gchat", "generic", "opsgenie", "slack", "splunk"])),
  url: Schema.optional(Schema.String)
}).pipe(Schema.encodeKeys({ id: "id", createdAt: "created_at", lastFailure: "last_failure", lastSuccess: "last_success", name: "name", type: "type", url: "url" })) as unknown as Schema.Schema<GetDestinationWebhookResponse>;
...
export const ListDestinationWebhooksRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/accounts/{account_id}/alerting/v3/destinations/webhooks" })) as unknown as Schema.Schema<ListDestinationWebhooksRequest>;

export type ListDestinationWebhooksResponse = ({ id?: string; createdAt?: string; lastFailure?: string; lastSuccess?: string; name?: string; type?: "datadog" | "discord" | "feishu" | "gchat" | "generic" | "opsgenie" | "slack" | "splunk"; url?: string })[];

export const ListDestinationWebhooksResponse = Schema.Array(Schema.Struct({
  id: Schema.optional(Schema.String),
  createdAt: Schema.optional(Schema.String),
  lastFailure: Schema.optional(Schema.String),
  lastSuccess: Schema.optional(Schema.String),
  ...
  type: Schema.optional(Schema.Literals(["datadog", "discord", "feishu", "gchat", "generic", "opsgenie", "slack", "splunk"])),
  url: Schema.optional(Schema.String)
}).pipe(Schema.encodeKeys({ id: "id", createdAt: "created_at", lastFailure: "last_failure", lastSuccess: "last_success", name: "name", type: "type", url: "url" }))) as unknown as Schema.Schema<ListDestinationWebhooksResponse>;

export type ListDestinationWebhooksError =
  | DefaultErrors;
...
export const CreateDestinationWebhookRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/accounts/{account_id}/alerting/v3/destinations/webhooks" })) as unknown as Schema.Schema<CreateDestinationWebhookRequest>;
...
export const UpdateDestinationWebhookRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "PUT", path: "/accounts/{account_id}/alerting/v3/destinations/webhooks/{webhookId}" })) as unknown as Schema.Schema<UpdateDestinationWebhookRequest>;
...
export const DeleteDestinationWebhookRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "DELETE", path: "/accounts/{account_id}/alerting/v3/destinations/webhooks/{webhookId}" })) as unknown as Schema.Schema<DeleteDestinationWebhookRequest>;
...
export const ListHistoriesRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/accounts/{account_id}/alerting/v3/history" })) as unknown as Schema.Schema<ListHistoriesRequest>;

export type ListHistoriesResponse = ({ id?: string; alertBody?: string; alertType?: string; description?: string; mechanism?: string; mechanismType?: "email" | "pagerduty" | "webhook"; name?: string; policyId?: string; sent?: string })[];

export const ListHistoriesResponse = Schema.Array(Schema.Struct({
  id: Schema.optional(Schema.String),
  ...
  mechanismType: Schema.optional(Schema.Literals(["email", "pagerduty", "webhook"])),
  name: Schema.optional(Schema.String),
  policyId: Schema.optional(Schema.String),
  sent: Schema.optional(Schema.String)
}).pipe(Schema.encodeKeys({ id: "id", alertBody: "alert_body", alertType: "alert_type", description: "description", mechanism: "mechanism", mechanismType: "mechanism_type", name: "name", policyId: "policy_id", sent: "sent" }))) as unknown as Schema.Schema<ListHistoriesResponse>;

export type ListHistoriesError =
  | DefaultErrors;
...
export const GetPolicyRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/accounts/{account_id}/alerting/v3/policies/{policyId}" })) as unknown as Schema.Schema<GetPolicyRequest>;
...
export interface GetPolicyResponse {
  ...
  filters?: { actions?: string[]; affectedAsns?: string[]; affectedComponents?: string[]; affectedLocations?: string[]; airportCode?: string[]; alertTriggerPreferences?: string[]; alertTriggerPreferencesValue?: string[]; enabled?: string[]; environment?: string[]; event?: string[]; eventSource?: string[]; eventType?: string[]; groupBy?: string[]; healthCheckId?: string[]; incidentImpact?: ("INCIDENT_IMPACT_NONE" | "INCIDENT_IMPACT_MINOR" | "INCIDENT_IMPACT_MAJOR" | "INCIDENT_IMPACT_CRITICAL")[]; inputId?: string[]; insightClass?: string[]; limit?: string[]; logoTag?: string[]; megabitsPerSecond?: string[]; newHealth?: string[]; newStatus?: string[]; packetsPerSecond?: string[]; poolId?: string[]; popNames?: string[]; product?: string[]; projectId?: string[]; protocol?: string[]; queryTag?: string[]; requestsPerSecond?: string[]; selectors?: string[]; services?: string[]; slo?: string[]; status?: string[]; targetHostname?: string[]; targetIp?: string[]; targetZoneName?: string[]; trafficExclusions?: "security_events"[]; tunnelId?: string[]; tunnelName?: string[]; type?: string[]; where?: string[]; zones?: string[] };
  /** List of IDs that will be used when dispatching a notification. IDs for email type will be the email address. */
  mechanisms?: { email?: { id?: string }[]; pagerduty?: { id?: string }[]; webhooks?: { id?: string }[] };
  modified?: string;
  /** Name of the policy. */
  name?: string;
}
...
export const GetPolicyResponse = Schema.Struct({
  ...
  alertType: Schema.optional(Schema.Literals(["abuse_report_alert", "access_custom_certificate_expiration_type", "advanced_ddos_attack_l4_alert", "advanced_ddos_attack_l7_alert", "advanced_http_alert_error", "bgp_hijack_notification", "billing_usage_alert", "block_notification_block_removed", "block_notification_new_block", "block_notification_review_rejected", "bot_traffic_basic_alert", "brand_protection_alert", "brand_protection_digest", "clickhouse_alert_fw_anomaly", "clickhouse_alert_fw_ent_anomaly", "cloudforce_one_request_notification", "custom_analytics", "custom_bot_detection_alert", "custom_ssl_certificate_event_type", "dedicated_ssl_certificate_event_type", "device_connectivity_anomaly_alert", "dos_attack_l4", "dos_attack_l7", "expiring_service_token_alert", "failing_logpush_job_disabled_alert", "fbm_auto_advertisement", "fbm_dosd_attack", "fbm_volumetric_attack", "health_check_status_notification", "hostname_aop_custom_certificate_expiration_type", "http_alert_edge_error", "http_alert_origin_error", "image_notification", "image_resizing_notification", "incident_alert", "load_balancing_health_alert", "load_balancing_pool_enablement_alert", "logo_match_alert", "magic_tunnel_health_check_event", "magic_wan_tunnel_health", "maintenance_event_notification", "mtls_certificate_store_certificate_expiration_type", "pages_event_alert", "radar_notification", "real_origin_monitoring", "scriptmonitor_alert_new_code_change_detections", "scriptmonitor_alert_new_hosts", "scriptmonitor_alert_new_malicious_hosts", "scriptmonitor_alert_new_malicious_scripts", "scriptmonitor_alert_new_malicious_url", "scriptmonitor_alert_new_max_length_resource_url", "scriptmonitor_alert_new_resources", "secondary_dns_all_primaries_failing", "secondary_dns_primaries_failing", "secondary_dns_warning", "secondary_dns_zone_successfully_updated", "secondary_dns_zone_validation_warning", "security_insights_alert", "sentinel_alert", "stream_live_notifications", "synthetic_test_latency_alert", "synthetic_test_low_availability_alert", "traffic_anomalies_alert", "tunnel_health_event", "tunnel_update_event", "universal_ssl_event_type", "web_analytics_metrics_update", "zone_aop_custom_certificate_expiration_type"])),
  ...
  incidentImpact: Schema.optional(Schema.Array(Schema.Literals(["INCIDENT_IMPACT_NONE", "INCIDENT_IMPACT_MINOR", "INCIDENT_IMPACT_MAJOR", "INCIDENT_IMPACT_CRITICAL"]))),
...
}).pipe(Schema.encodeKeys({ actions: "actions", affectedAsns: "affected_asns", affectedComponents: "affected_components", affectedLocations: "affected_locations", airportCode: "airport_code", alertTriggerPreferences: "alert_trigger_preferences", alertTriggerPreferencesValue: "alert_trigger_preferences_value", enabled: "enabled", environment: "environment", event: "event", eventSource: "event_source", eventType: "event_type", groupBy: "group_by", healthCheckId: "health_check_id", incidentImpact: "incident_impact", inputId: "input_id", insightClass: "insight_class", limit: "limit", logoTag: "logo_tag", megabitsPerSecond: "megabits_per_second", newHealth: "new_health", newStatus: "new_status", packetsPerSecond: "packets_per_second", poolId: "pool_id", popNames: "pop_names", product: "product", projectId: "project_id", protocol: "protocol", queryTag: "query_tag", requestsPerSecond: "requests_per_second", selectors: "selectors", services: "services", slo: "slo", status: "status", targetHostname: "target_hostname", targetIp: "target_ip", targetZoneName: "target_zone_name", trafficExclusions: "traffic_exclusions", tunnelId: "tunnel_id", tunnelName: "tunnel_name", type: "type", where: "where", zones: "zones" }))),
  ...
  name: Schema.optional(Schema.String)
}).pipe(Schema.encodeKeys({ id: "id", alertInterval: "alert_interval", alertType: "alert_type", created: "created", description: "description", enabled: "enabled", filters: "filters", mechanisms: "mechanisms", modified: "modified", name: "name" })) as unknown as Schema.Schema<GetPolicyResponse>;
...
export const ListPoliciesRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/accounts/{account_id}/alerting/v3/policies" })) as unknown as Schema.Schema<ListPoliciesRequest>;

export type ListPoliciesResponse = ({ id?: string; alertInterval?: string; alertType?: "abuse_report_alert" | "access_custom_certificate_expiration_type" | "advanced_ddos_attack_l4_alert" | "advanced_ddos_attack_l7_alert" | "advanced_http_alert_error" | "bgp_hijack_notification" | "billing_usage_alert" | "block_notification_block_removed" | "block_notification_new_block" | "block_notification_review_rejected" | "bot_traffic_basic_alert" | "brand_protection_alert" | "brand_protection_digest" | "clickhouse_alert_fw_anomaly" | "clickhouse_alert_fw_ent_anomaly" | "cloudforce_one_request_notification" | "custom_analytics" | "custom_bot_detection_alert" | "custom_ssl_certificate_event_type" | "dedicated_ssl_certificate_event_type" | "device_connectivity_anomaly_alert" | "dos_attack_l4" | "dos_attack_l7" | "expiring_service_token_alert" | "failing_logpush_job_disabled_alert" | "fbm_auto_advertisement" | "fbm_dosd_attack" | "fbm_volumetric_attack" | "health_check_status_notification" | "hostname_aop_custom_certificate_expiration_type" | "http_alert_edge_error" | "http_alert_origin_error" | "image_notification" | "image_resizing_notification" | "incident_alert" | "load_balancing_health_alert" | "load_balancing_pool_enablement_alert" | "logo_match_alert" | "magic_tunnel_health_check_event" | "magic_wan_tunnel_health" | "maintenance_event_notification" | "mtls_certificate_store_certificate_expiration_type" | "pages_event_alert" | "radar_notification" | "real_origin_monitoring" | "scriptmonitor_alert_new_code_change_detections" | "scriptmonitor_alert_new_hosts" | "scriptmonitor_alert_new_malicious_hosts" | "scriptmonitor_alert_new_malicious_scripts" | "scriptmonitor_alert_new_malicious_url" | "scriptmonitor_alert_new_max_length_resource_url" | "scriptmonitor_alert_new_resources" | "secondary_dns_all_primaries_failing" | "secondary_dns_primaries_failing" | "secondary_dns_warning" | "secondary_dns_zone_successfully_updated" | "secondary_dns_zone_validation_warning" | "security_insights_alert" | "sentinel_alert" | "stream_live_notifications" | "synthetic_test_latency_alert" | "synthetic_test_low_availability_alert" | "traffic_anomalies_alert" | "tunnel_health_event" | "tunnel_update_event" | "universal_ssl_event_type" | "web_analytics_metrics_update" | "zone_aop_custom_certificate_expiration_type"; created?: string; description?: string; enabled?: boolean; filters?: { actions?: string[]; affectedAsns?: string[]; affectedComponents?: string[]; affectedLocations?: string[]; airportCode?: string[]; alertTriggerPreferences?: string[]; alertTriggerPreferencesValue?: string[]; enabled?: string[]; environment?: string[]; event?: string[]; eventSource?: string[]; eventType?: string[]; groupBy?: string[]; healthCheckId?: string[]; incidentImpact?: ("INCIDENT_IMPACT_NONE" | "INCIDENT_IMPACT_MINOR" | "INCIDENT_IMPACT_MAJOR" | "INCIDENT_IMPACT_CRITICAL")[]; inputId?: string[]; insightClass?: string[]; limit?: string[]; logoTag?: string[]; megabitsPerSecond?: string[]; newHealth?: string[]; newStatus?: string[]; packetsPerSecond?: string[]; poolId?: string[]; popNames?: string[]; product?: string[]; projectId?: string[]; protocol?: string[]; queryTag?: string[]; requestsPerSecond?: string[]; selectors?: string[]; services?: string[]; slo?: string[]; status?: string[]; targetHostname?: string[]; targetIp?: string[]; targetZoneName?: string[]; trafficExclusions?: "security_events"[]; tunnelId?: string[]; tunnelName?: string[]; type?: string[]; where?: string[]; zones?: string[] }; mechanisms?: { email?: { id?: string }[]; pagerduty?: { id?: string }[]; webhooks?: { id?: string }[] }; modified?: string; name?: string })[];

export const ListPoliciesResponse = Schema.Array(Schema.Struct({
  id: Schema.optional(Schema.String),
  alertInterval: Schema.optional(Schema.String),
  alertType: Schema.optional(Schema.Literals(["abuse_report_alert", "access_custom_certificate_expiration_type", "advanced_ddos_attack_l4_alert", "advanced_ddos_attack_l7_alert", "advanced_http_alert_error", "bgp_hijack_notification", "billing_usage_alert", "block_notification_block_removed", "block_notification_new_block", "block_notification_review_rejected", "bot_traffic_basic_alert", "brand_protection_alert", "brand_protection_digest", "clickhouse_alert_fw_anomaly", "clickhouse_alert_fw_ent_anomaly", "cloudforce_one_request_notification", "custom_analytics", "custom_bot_detection_alert", "custom_ssl_certificate_event_type", "dedicated_ssl_certificate_event_type", "device_connectivity_anomaly_alert", "dos_attack_l4", "dos_attack_l7", "expiring_service_token_alert", "failing_logpush_job_disabled_alert", "fbm_auto_advertisement", "fbm_dosd_attack", "fbm_volumetric_attack", "health_check_status_notification", "hostname_aop_custom_certificate_expiration_type", "http_alert_edge_error", "http_alert_origin_error", "image_notification", "image_resizing_notification", "incident_alert", "load_balancing_health_alert", "load_balancing_pool_enablement_alert", "logo_match_alert", "magic_tunnel_health_check_event", "magic_wan_tunnel_health", "maintenance_event_notification", "mtls_certificate_store_certificate_expiration_type", "pages_event_alert", "radar_notification", "real_origin_monitoring", "scriptmonitor_alert_new_code_change_detections", "scriptmonitor_alert_new_hosts", "scriptmonitor_alert_new_malicious_hosts", "scriptmonitor_alert_new_malicious_scripts", "scriptmonitor_alert_new_malicious_url", "scriptmonitor_alert_new_max_length_resource_url", "scriptmonitor_alert_new_resources", "secondary_dns_all_primaries_failing", "secondary_dns_primaries_failing", "secondary_dns_warning", "secondary_dns_zone_successfully_updated", "secondary_dns_zone_validation_warning", "security_insights_alert", "sentinel_alert", "stream_live_notifications", "synthetic_test_latency_alert", "synthetic_test_low_availability_alert", "traffic_anomalies_alert", "tunnel_health_event", "tunnel_update_event", "universal_ssl_event_type", "web_analytics_metrics_update", "zone_aop_custom_certificate_expiration_type"])),
  created: Schema.optional(Schema.String),
  ...
  modified: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String)
}).pipe(Schema.encodeKeys({ id: "id", alertInterval: "alert_interval", alertType: "alert_type", created: "created", description: "description", enabled: "enabled", filters: "filters", mechanisms: "mechanisms", modified: "modified", name: "name" }))) as unknown as Schema.Schema<ListPoliciesResponse>;
...
export const CreatePolicyRequest = Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("account_id")),
  alertType: Schema.Literals(["abuse_report_alert", "access_custom_certificate_expiration_type", "advanced_ddos_attack_l4_alert", "advanced_ddos_attack_l7_alert", "advanced_http_alert_error", "bgp_hijack_notification", "billing_usage_alert", "block_notification_block_removed", "block_notification_new_block", "block_notification_review_rejected", "bot_traffic_basic_alert", "brand_protection_alert", "brand_protection_digest", "clickhouse_alert_fw_anomaly", "clickhouse_alert_fw_ent_anomaly", "cloudforce_one_request_notification", "custom_analytics", "custom_bot_detection_alert", "custom_ssl_certificate_event_type", "dedicated_ssl_certificate_event_type", "device_connectivity_anomaly_alert", "dos_attack_l4", "dos_attack_l7", "expiring_service_token_alert", "failing_logpush_job_disabled_alert", "fbm_auto_advertisement", "fbm_dosd_attack", "fbm_volumetric_attack", "health_check_status_notification", "hostname_aop_custom_certificate_expiration_type", "http_alert_edge_error", "http_alert_origin_error", "image_notification", "image_resizing_notification", "incident_alert", "load_balancing_health_alert", "load_balancing_pool_enablement_alert", "logo_match_alert", "magic_tunnel_health_check_event", "magic_wan_tunnel_health", "maintenance_event_notification", "mtls_certificate_store_certificate_expiration_type", "pages_event_alert", "radar_notification", "real_origin_monitoring", "scriptmonitor_alert_new_code_change_detections", "scriptmonitor_alert_new_hosts", "scriptmonitor_alert_new_malicious_hosts", "scriptmonitor_alert_new_malicious_scripts", "scriptmonitor_alert_new_malicious_url", "scriptmonitor_alert_new_max_length_resource_url", "scriptmonitor_alert_new_resources", "secondary_dns_all_primaries_failing", "secondary_dns_primaries_failing", "secondary_dns_warning", "secondary_dns_zone_successfully_updated", "secondary_dns_zone_validation_warning", "security_insights_alert", "sentinel_alert", "stream_live_notifications", "synthetic_test_latency_alert", "synthetic_test_low_availability_alert", "traffic_anomalies_alert", "tunnel_health_event", "tunnel_update_event", "universal_ssl_event_type", "web_analytics_metrics_update", "zone_aop_custom_certificate_expiration_type"]),
  ...
  .pipe(Schema.encodeKeys({ alertType: "alert_type", enabled: "enabled", mechanisms: "mechanisms", name: "name", alertInterval: "alert_interval", description: "description", filters: "filters" }), T.Http({ method: "POST", path: "/accounts/{account_id}/alerting/v3/policies" })) as unknown as Schema.Schema<CreatePolicyRequest>;
...
export const UpdatePolicyRequest = Schema.Struct({
  ...
  .pipe(Schema.encodeKeys({ alertInterval: "alert_interval", alertType: "alert_type", description: "description", enabled: "enabled", filters: "filters", mechanisms: "mechanisms", name: "name" }), T.Http({ method: "PUT", path: "/accounts/{account_id}/alerting/v3/policies/{policyId}" })) as unknown as Schema.Schema<UpdatePolicyRequest>;
...
export const DeletePolicyRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "DELETE", path: "/accounts/{account_id}/alerting/v3/policies/{policyId}" })) as unknown as Schema.Schema<DeletePolicyRequest>;
...
}).pipe(Schema.encodeKeys({ errors: "errors", messages: "messages", success: "success", resultInfo: "result_info" })) as unknown as Schema.Schema<DeletePolicyResponse>;
...
export const GetSilenceRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/accounts/{account_id}/alerting/v3/silences/{silenceId}" })) as unknown as Schema.Schema<GetSilenceRequest>;
...
}).pipe(Schema.encodeKeys({ id: "id", createdAt: "created_at", endTime: "end_time", policyId: "policy_id", startTime: "start_time", updatedAt: "updated_at" })) as unknown as Schema.Schema<GetSilenceResponse>;
...
export const ListSilencesRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/accounts/{account_id}/alerting/v3/silences" })) as unknown as Schema.Schema<ListSilencesRequest>;

export type ListSilencesResponse = { id?: string; createdAt?: string; endTime?: string; policyId?: string; startTime?: string; updatedAt?: string }[];

export const ListSilencesResponse = Schema.Array(Schema.Struct({
  id: Schema.optional(Schema.String),
  createdAt: Schema.optional(Schema.String),
  endTime: Schema.optional(Schema.String),
  policyId: Schema.optional(Schema.String),
  startTime: Schema.optional(Schema.String),
  updatedAt: Schema.optional(Schema.String)
}).pipe(Schema.encodeKeys({ id: "id", createdAt: "created_at", endTime: "end_time", policyId: "policy_id", startTime: "start_time", updatedAt: "updated_at" }))) as unknown as Schema.Schema<ListSilencesResponse>;

export type ListSilencesError =
  | DefaultErrors;
...
export const CreateSilenceRequest = Schema.Struct({
  ...
  policyId: Schema.optional(Schema.String),
  startTime: Schema.optional(Schema.String)
}).pipe(Schema.encodeKeys({ endTime: "end_time", policyId: "policy_id", startTime: "start_time" }))).pipe(T.HttpBody())
})
  .pipe(T.Http({ method: "POST", path: "/accounts/{account_id}/alerting/v3/silences" })) as unknown as Schema.Schema<CreateSilenceRequest>;
...
export const UpdateSilenceRequest = Schema.Struct({
  ...
  endTime: Schema.optional(Schema.String),
  startTime: Schema.optional(Schema.String)
}).pipe(Schema.encodeKeys({ id: "id", endTime: "end_time", startTime: "start_time" }))).pipe(T.HttpBody())
})
  .pipe(T.Http({ method: "PUT", path: "/accounts/{account_id}/alerting/v3/silences" })) as unknown as Schema.Schema<UpdateSilenceRequest>;

export type UpdateSilenceResponse = { id?: string; createdAt?: string; endTime?: string; policyId?: string; startTime?: string; updatedAt?: string }[];

export const UpdateSilenceResponse = Schema.Array(Schema.Struct({
  id: Schema.optional(Schema.String),
  createdAt: Schema.optional(Schema.String),
  endTime: Schema.optional(Schema.String),
  policyId: Schema.optional(Schema.String),
  startTime: Schema.optional(Schema.String),
  updatedAt: Schema.optional(Schema.String)
}).pipe(Schema.encodeKeys({ id: "id", createdAt: "created_at", endTime: "end_time", policyId: "policy_id", startTime: "start_time", updatedAt: "updated_at" }))) as unknown as Schema.Schema<UpdateSilenceResponse>;
...
export const DeleteSilenceRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "DELETE", path: "/accounts/{account_id}/alerting/v3/silences/{silenceId}" })) as unknown as Schema.Schema<DeleteSilenceRequest>;
