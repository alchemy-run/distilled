...
}).pipe(Schema.encodeKeys({ defaultUsageModel: "default_usage_model", greenCompute: "green_compute" })) as unknown as Schema.Schema<GetAccountSettingResponse>;
...
export const PutAccountSettingResponse = Schema.Struct({
  defaultUsageModel: Schema.optional(Schema.String),
  greenCompute: Schema.optional(Schema.Boolean)
}).pipe(Schema.encodeKeys({ defaultUsageModel: "default_usage_model", greenCompute: "green_compute" })) as unknown as Schema.Schema<PutAccountSettingResponse>;
...
export const ListBetaWorkersResponse = Schema.Array(Schema.Struct({
  id: Schema.String,
  name: Schema.String
...
export interface GetBetaWorkerVersionResponse {
  ...
  annotations?: { "workers/message"?: string; "workers/tag"?: string; "workers/triggeredBy"?: string };
...
}).pipe(Schema.encodeKeys({ "workers/message": ""workers/message"", "workers/tag": ""workers/tag"", "workers/triggeredBy": ""workers/triggered_by"" }))),
...
export type ListBetaWorkerVersionsResponse = ({ id: string; createdOn: string; number: number; annotations?: { "workers/message"?: string; "workers/tag"?: string; "workers/triggeredBy"?: string }; assets?: { config?: { htmlHandling?: "auto-trailing-slash" | "force-trailing-slash" | "drop-trailing-slash" | "none"; notFoundHandling?: "none" | "404-page" | "single-page-application"; runWorkerFirst?: string[] | boolean }; jwt?: string }; bindings?: ({ name: string; type: "ai" } | { dataset: string; name: string; type: "analytics_engine" } | { name: string; type: "assets" } | { name: string; type: "browser" } | { id: string; name: string; type: "d1" } | { name: string; part: string; type: "data_blob" } | { name: string; namespace: string; type: "dispatch_namespace"; outbound?: { params?: string[]; worker?: { environment?: string; service?: string } } } | { name: string; type: "durable_object_namespace"; className?: string; environment?: string; namespaceId?: string; scriptName?: string } | { id: string; name: string; type: "hyperdrive" } | { name: string; type: "inherit"; oldName?: string; versionId?: string } | { name: string; type: "images" } | { json: string; name: string; type: "json" } | { name: string; namespaceId: string; type: "kv_namespace" } | { certificateId: string; name: string; type: "mtls_certificate" } | { name: string; text: string; type: "plain_text" } | { name: string; pipeline: string; type: "pipelines" } | { name: string; queueName: string; type: "queue" } | { bucketName: string; name: string; type: "r2_bucket"; jurisdiction?: "eu" | "fedramp" } | { name: string; type: "secret_text" } | { name: string; type: "send_email"; allowedDestinationAddresses?: string[]; allowedSenderAddresses?: string[]; destinationAddress?: string } | { name: string; service: string; type: "service"; environment?: string } | { name: string; part: string; type: "text_blob" } | { indexName: string; name: string; type: "vectorize" } | { name: string; type: "version_metadata" } | { name: string; secretName: string; storeId: string; type: "secrets_store_secret" } | { algorithm: unknown; format: "raw" | "pkcs8" | "spki" | "jwk"; name: string; type: "secret_key"; usages: ("encrypt" | "decrypt" | "sign" | "verify" | "deriveKey" | "deriveBits" | "wrapKey" | "unwrapKey")[] } | { name: string; type: "workflow"; workflowName: string; className?: string; scriptName?: string } | { name: string; part: string; type: "wasm_module" })[]; compatibilityDate?: string; compatibilityFlags?: string[]; limits?: { cpuMs: number }; mainModule?: string; migrations?: unknown; modules?: { contentBase64: string; contentType: string; name: string }[]; placement?: { mode?: "smart" }; source?: string; startupTimeMs?: number; usageModel?: "standard" | "bundled" | "unbound" })[];

export const ListBetaWorkerVersionsResponse = Schema.Array(Schema.Struct({
  id: Schema.String,
  createdOn: Schema.String,
  number: Schema.Number,
  annotations: Schema.optional(Schema.Struct({
  ...
  startupTimeMs: Schema.optional(Schema.Number),
  usageModel: Schema.optional(Schema.Literals(["standard", "bundled", "unbound"]))
}).pipe(Schema.encodeKeys({ id: "id", createdOn: "created_on", number: "number", annotations: "annotations", assets: "assets", bindings: "bindings", compatibilityDate: "compatibility_date", compatibilityFlags: "compatibility_flags", limits: "limits", mainModule: "main_module", migrations: "migrations", modules: "modules", placement: "placement", source: "source", startupTimeMs: "startup_time_ms", usageModel: "usage_model" }))) as unknown as Schema.Schema<ListBetaWorkerVersionsResponse>;
...
export interface CreateBetaWorkerVersionRequest {
  ...
  bindings?: ({ name: string; type: "ai" } | { dataset: string; name: string; type: "analytics_engine" } | { name: string; type: "assets" } | { name: string; type: "browser" } | { id: string; name: string; type: "d1" } | { name: string; part: string; type: "data_blob" } | { name: string; namespace: string; type: "dispatch_namespace"; outbound?: { params?: string[]; worker?: { environment?: string; service?: string } } } | { name: string; type: "durable_object_namespace"; className?: string; environment?: string; namespaceId?: string; scriptName?: string } | { id: string; name: string; type: "hyperdrive" } | { name: string; type: "inherit"; oldName?: string; versionId?: string } | { name: string; type: "images" } | { json: string; name: string; type: "json" } | { name: string; namespaceId: string; type: "kv_namespace" } | { certificateId: string; name: string; type: "mtls_certificate" } | { name: string; text: string; type: "plain_text" } | { name: string; pipeline: string; type: "pipelines" } | { name: string; queueName: string; type: "queue" } | { bucketName: string; name: string; type: "r2_bucket"; jurisdiction?: "eu" | "fedramp" } | { name: string; text: string; type: "secret_text" } | { name: string; type: "send_email"; allowedDestinationAddresses?: string[]; allowedSenderAddresses?: string[]; destinationAddress?: string } | { name: string; service: string; type: "service"; environment?: string } | { name: string; part: string; type: "text_blob" } | { indexName: string; name: string; type: "vectorize" } | { name: string; type: "version_metadata" } | { name: string; secretName: string; storeId: string; type: "secrets_store_secret" } | { algorithm: unknown; format: "raw" | "pkcs8" | "spki" | "jwk"; name: string; type: "secret_key"; usages: ("encrypt" | "decrypt" | "sign" | "verify" | "deriveKey" | "deriveBits" | "wrapKey" | "unwrapKey")[]; keyBase64?: string; keyJwk?: unknown } | { name: string; type: "workflow"; workflowName: string; className?: string; scriptName?: string } | { name: string; part: string; type: "wasm_module" })[];
...
export const CreateBetaWorkerVersionRequest = Schema.Struct({
  ...
  mainModule: Schema.optional(Schema.String),
  migrations: Schema.optional(Schema.Union([Schema.Unknown, Schema.Struct({
...
}).pipe(Schema.encodeKeys({ id: "id", environment: "environment", hostname: "hostname", service: "service", zoneId: "zone_id", zoneName: "zone_name" })) as unknown as Schema.Schema<GetDomainResponse>;
...
export type ListDomainsResponse = { id?: string; environment?: string; hostname?: string; service?: string; zoneId?: string; zoneName?: string }[];

export const ListDomainsResponse = Schema.Array(Schema.Struct({
  id: Schema.optional(Schema.String),
  environment: Schema.optional(Schema.String),
  hostname: Schema.optional(Schema.String),
  service: Schema.optional(Schema.String),
  zoneId: Schema.optional(Schema.String),
  zoneName: Schema.optional(Schema.String)
}).pipe(Schema.encodeKeys({ id: "id", environment: "environment", hostname: "hostname", service: "service", zoneId: "zone_id", zoneName: "zone_name" }))) as unknown as Schema.Schema<ListDomainsResponse>;
...
export const PutDomainResponse = Schema.Struct({
  ...
  zoneId: Schema.optional(Schema.String),
  zoneName: Schema.optional(Schema.String)
}).pipe(Schema.encodeKeys({ id: "id", environment: "environment", hostname: "hostname", service: "service", zoneId: "zone_id", zoneName: "zone_name" })) as unknown as Schema.Schema<PutDomainResponse>;
...
export const DeleteDomainResponse = Schema.Unknown as unknown as Schema.Schema<DeleteDomainResponse>;
...
export type KeysObservabilityTelemetryResponse = ({ key: string; lastSeenAt: number; type: "string" | "boolean" | "number" })[];

export const KeysObservabilityTelemetryResponse = Schema.Array(Schema.Struct({
  key: Schema.String,
...
export interface QueryObservabilityTelemetryResponse {
  ...
  run: { id: string; accountId: string; dry: boolean; environmentId: string; granularity: number; query: { id: string; created: string; description: string | null; environmentId: string; generated: boolean | null; name: string | null; parameters: { calculations?: ({ operator: "uniq" | "count" | "max" | "min" | "sum" | "avg" | "median" | "p001" | "p01" | "p05" | "p10" | "p25" | "p75" | "p90" | "p95" | "p99" | "p999" | "stddev" | "variance" | "COUNT_DISTINCT" | "COUNT" | "MAX" | "MIN" | "SUM" | "AVG" | "MEDIAN" | "P001" | "P01" | "P05" | "P10" | "P25" | "P75" | "P90" | "P95" | "P99" | "P999" | "STDDEV" | "VARIANCE"; alias?: string; key?: string; keyType?: "string" | "number" | "boolean" })[]; datasets?: string[]; filterCombination?: "and" | "or" | "AND" | "OR"; filters?: ({ key: string; operation: "includes" | "not_includes" | "starts_with" | "regex" | "exists" | "is_null" | "in" | "not_in" | "eq" | "neq" | "gt" | "gte" | "lt" | "lte" | "=" | "!=" | ">" | ">=" | "<" | "<=" | "INCLUDES" | "DOES_NOT_INCLUDE" | "MATCH_REGEX" | "EXISTS" | "DOES_NOT_EXIST" | "IN" | "NOT_IN" | "STARTS_WITH"; type: "string" | "number" | "boolean"; value?: string | number | boolean })[]; groupBys?: ({ type: "string" | "number" | "boolean"; value: string })[]; havings?: ({ key: string; operation: "eq" | "neq" | "gt" | "gte" | "lt" | "lte"; value: number })[]; limit?: number; needle?: { value: string | number | boolean; isRegex?: boolean; matchCase?: boolean }; orderBy?: { value: string; order?: "asc" | "desc" } }; updated: string; userId: string; workspaceId: string }; status: "STARTED" | "COMPLETED"; timeframe: { from: number; to: number }; userId: string; workspaceId: string; created?: string; statistics?: { bytesRead: number; elapsed: number; rowsRead: number; abrLevel?: number }; updated?: string };
  ...
  statistics: { bytesRead: number; elapsed: number; rowsRead: number; abrLevel?: number };
  calculations?: ({ aggregates: ({ count: number; interval: number; sampleInterval: number; value: number; groups?: ({ key: string; value: string | number | boolean })[] })[]; calculation: string; series: ({ data: ({ count: number; interval: number; sampleInterval: number; value: number; groups?: ({ key: string; value: string | number | boolean })[] })[]; time: string })[]; alias?: string })[];
  compare?: ({ aggregates: ({ count: number; interval: number; sampleInterval: number; value: number; groups?: ({ key: string; value: string | number | boolean })[] })[]; calculation: string; series: ({ data: ({ count: number; interval: number; sampleInterval: number; value: number; groups?: ({ key: string; value: string | number | boolean })[] })[]; time: string })[]; alias?: string })[];
  events?: { count?: number; events?: ({ $metadata: { id: string; account?: string; cloudService?: string; coldStart?: number; cost?: number; duration?: number; endTime?: number; error?: string; errorTemplate?: string; fingerprint?: string; level?: string; message?: string; messageTemplate?: string; metricName?: string; origin?: string; parentSpanId?: string; provider?: string; region?: string; requestId?: string; service?: string; spanId?: string; spanName?: string; stackId?: string; startTime?: number; statusCode?: number; traceDuration?: number; traceId?: string; transactionName?: string; trigger?: string; type?: string; url?: string }; dataset: string; source: unknown; timestamp: number; $containers?: unknown; $workers?: { eventType: "fetch" | "scheduled" | "alarm" | "cron" | "queue" | "email" | "tail" | "rpc" | "websocket" | "unknown"; requestId: string; scriptName: string; durableObjectId?: string; entrypoint?: string; event?: Record<string, unknown>; executionModel?: "durableObject" | "stateless"; outcome?: string; scriptVersion?: { id?: string; message?: string; tag?: string }; truncated?: boolean } | { cpuTimeMs: number; eventType: "fetch" | "scheduled" | "alarm" | "cron" | "queue" | "email" | "tail" | "rpc" | "websocket" | "unknown"; outcome: string; requestId: string; scriptName: string; wallTimeMs: number; diagnosticsChannelEvents?: { channel: string; message: string; timestamp: number }[]; dispatchNamespace?: string; durableObjectId?: string; entrypoint?: string; event?: Record<string, unknown>; executionModel?: "durableObject" | "stateless"; scriptVersion?: { id?: string; message?: string; tag?: string }; truncated?: boolean } })[]; fields?: { key: string; type: string }[]; series?: ({ data: ({ count: number; interval: number; sampleInterval: number; value?: number; groups?: ({ key: string; value: string | number | boolean })[] })[]; time: string })[] };
  invocations?: Record<string, unknown>;
  patterns?: ({ count: number; pattern: string; series: ({ data: { count: number; interval: number; sampleInterval: number; value: number; groups?: ({ key: string; value: string | number | boolean })[] }; time: string })[]; service: string })[];
  traces?: { rootSpanName: string; rootTransactionName: string; service: string[]; spans: number; traceDurationMs: number; traceEndMs: number; traceId: string; traceStartMs: number; errors?: string[] }[];
}
...
export const QueryObservabilityTelemetryResponse = Schema.Struct({
  ...
  events: Schema.optional(Schema.Array(Schema.Struct({
    ...
    $workers: Schema.optional(Schema.Union([Schema.Struct({
      ...
      executionModel: Schema.optional(Schema.Literals(["durableObject", "stateless"])),
...
export type ValuesObservabilityTelemetryResponse = ({ dataset: string; key: string; type: "string" | "boolean" | "number"; value: string | number | boolean })[];

export const ValuesObservabilityTelemetryResponse = Schema.Array(Schema.Struct({
  dataset: Schema.String,
  key: Schema.String,
  type: Schema.Literals(["string", "boolean", "number"]),
  value: Schema.Union([Schema.String, Schema.Number, Schema.Boolean])
...
export type ListRoutesResponse = { id: string; pattern: string; script?: string }[];

export const ListRoutesResponse = Schema.Array(Schema.Struct({
  id: Schema.String,
  pattern: Schema.String,
  script: Schema.optional(Schema.String)
...
export type ListScriptsResponse = ({ id?: string; compatibilityDate?: string; compatibilityFlags?: string[]; createdOn?: string; etag?: string; handlers?: string[]; hasAssets?: boolean; hasModules?: boolean; lastDeployedFrom?: string; logpush?: boolean; migrationTag?: string; modifiedOn?: string; namedHandlers?: { handlers?: string[]; name?: string }[]; observability?: { enabled: boolean; headSamplingRate?: number | null; logs?: { enabled: boolean; invocationLogs: boolean; destinations?: string[]; headSamplingRate?: number | null; persist?: boolean } | null }; placement?: { mode: "smart"; lastAnalyzedAt?: string; status?: "SUCCESS" | "UNSUPPORTED_APPLICATION" | "INSUFFICIENT_INVOCATIONS" } | { region: string; lastAnalyzedAt?: string; status?: "SUCCESS" | "UNSUPPORTED_APPLICATION" | "INSUFFICIENT_INVOCATIONS" } | { hostname: string; lastAnalyzedAt?: string; status?: "SUCCESS" | "UNSUPPORTED_APPLICATION" | "INSUFFICIENT_INVOCATIONS" } | { host: string; lastAnalyzedAt?: string; status?: "SUCCESS" | "UNSUPPORTED_APPLICATION" | "INSUFFICIENT_INVOCATIONS" }; placementMode?: "smart"; placementStatus?: "SUCCESS" | "UNSUPPORTED_APPLICATION" | "INSUFFICIENT_INVOCATIONS"; routes?: { id: string; pattern: string; script?: string }[] | null; tag?: string; tags?: string[] | null; tailConsumers?: unknown[] | null; usageModel?: "standard" | "bundled" | "unbound" })[];

export const ListScriptsResponse = Schema.Array(Schema.Struct({
  id: Schema.optional(Schema.String),
  compatibilityDate: Schema.optional(Schema.String),
  compatibilityFlags: Schema.optional(Schema.Array(Schema.String)),
  ...
  namedHandlers: Schema.optional(Schema.Array(Schema.Struct({
    handlers: Schema.optional(Schema.Array(Schema.String)),
  ...
  placement: Schema.optional(Schema.Union([Schema.Struct({
    ...
    status: Schema.optional(Schema.Literals(["SUCCESS", "UNSUPPORTED_APPLICATION", "INSUFFICIENT_INVOCATIONS"]))
    ...
    lastAnalyzedAt: Schema.optional(Schema.String),
    status: Schema.optional(Schema.Literals(["SUCCESS", "UNSUPPORTED_APPLICATION", "INSUFFICIENT_INVOCATIONS"]))
  }).pipe(Schema.encodeKeys({ host: "host", lastAnalyzedAt: "last_analyzed_at", status: "status" }))])),
  placementMode: Schema.optional(Schema.Literal("smart")),
  placementStatus: Schema.optional(Schema.Literals(["SUCCESS", "UNSUPPORTED_APPLICATION", "INSUFFICIENT_INVOCATIONS"])),
  ...
  usageModel: Schema.optional(Schema.Literals(["standard", "bundled", "unbound"]))
}).pipe(Schema.encodeKeys({ id: "id", compatibilityDate: "compatibility_date", compatibilityFlags: "compatibility_flags", createdOn: "created_on", etag: "etag", handlers: "handlers", hasAssets: "has_assets", hasModules: "has_modules", lastDeployedFrom: "last_deployed_from", logpush: "logpush", migrationTag: "migration_tag", modifiedOn: "modified_on", namedHandlers: "named_handlers", observability: "observability", placement: "placement", placementMode: "placement_mode", placementStatus: "placement_status", routes: "routes", tag: "tag", tags: "tags", tailConsumers: "tail_consumers", usageModel: "usage_model" }))) as unknown as Schema.Schema<ListScriptsResponse>;
...
export interface PutScriptRequest {
  ...
  metadata: { assets?: { config?: { headers?: string; redirects?: string; htmlHandling?: "auto-trailing-slash" | "force-trailing-slash" | "drop-trailing-slash" | "none"; notFoundHandling?: "none" | "404-page" | "single-page-application"; runWorkerFirst?: string[] | boolean; serveDirectly?: boolean }; jwt?: string }; bindings?: ({ name: string; type: "ai" } | { dataset: string; name: string; type: "analytics_engine" } | { name: string; type: "assets" } | { name: string; type: "browser" } | { id: string; name: string; type: "d1" } | { name: string; part: string; type: "data_blob" } | { name: string; namespace: string; type: "dispatch_namespace"; outbound?: { params?: string[]; worker?: { environment?: string; service?: string } } } | { name: string; type: "durable_object_namespace"; className?: string; environment?: string; namespaceId?: string; scriptName?: string } | { id: string; name: string; type: "hyperdrive" } | { name: string; type: "inherit"; oldName?: string; versionId?: string } | { name: string; type: "images" } | { json: string; name: string; type: "json" } | { name: string; namespaceId: string; type: "kv_namespace" } | { certificateId: string; name: string; type: "mtls_certificate" } | { name: string; text: string; type: "plain_text" } | { name: string; pipeline: string; type: "pipelines" } | { name: string; queueName: string; type: "queue" } | { bucketName: string; name: string; type: "r2_bucket"; jurisdiction?: "eu" | "fedramp" } | { name: string; text: string; type: "secret_text" } | { name: string; type: "send_email"; allowedDestinationAddresses?: string[]; allowedSenderAddresses?: string[]; destinationAddress?: string } | { name: string; service: string; type: "service"; environment?: string } | { name: string; part: string; type: "text_blob" } | { indexName: string; name: string; type: "vectorize" } | { name: string; type: "version_metadata" } | { name: string; secretName: string; storeId: string; type: "secrets_store_secret" } | { algorithm: unknown; format: "raw" | "pkcs8" | "spki" | "jwk"; name: string; type: "secret_key"; usages: ("encrypt" | "decrypt" | "sign" | "verify" | "deriveKey" | "deriveBits" | "wrapKey" | "unwrapKey")[]; keyBase64?: string; keyJwk?: unknown } | { name: string; type: "workflow"; workflowName: string; className?: string; scriptName?: string } | { name: string; part: string; type: "wasm_module" })[]; bodyPart?: string; compatibilityDate?: string; compatibilityFlags?: string[]; keepAssets?: boolean; keepBindings?: string[]; limits?: { cpuMs?: number }; logpush?: boolean; mainModule?: string; migrations?: unknown | { newTag?: string; oldTag?: string; steps?: unknown[] }; observability?: { enabled: boolean; headSamplingRate?: number | null; logs?: { enabled: boolean; invocationLogs: boolean; destinations?: string[]; headSamplingRate?: number | null; persist?: boolean } | null }; placement?: { mode: "smart" } | { region: string } | { hostname: string } | { host: string }; tags?: string[]; tailConsumers?: unknown[] | null; usageModel?: "standard" | "bundled" | "unbound" };
...
export const PutScriptRequest = Schema.Struct({
  ...
  tailConsumers: Schema.optional(Schema.Union([Schema.Array(Schema.Unknown), Schema.Null])),
  usageModel: Schema.optional(Schema.Literals(["standard", "bundled", "unbound"]))
}).pipe(Schema.encodeKeys({ assets: "assets", bindings: "bindings", bodyPart: "body_part", compatibilityDate: "compatibility_date", compatibilityFlags: "compatibility_flags", keepAssets: "keep_assets", keepBindings: "keep_bindings", limits: "limits", logpush: "logpush", mainModule: "main_module", migrations: "migrations", observability: "observability", placement: "placement", tags: "tags", tailConsumers: "tail_consumers", usageModel: "usage_model" })),
...
export interface PutScriptResponse {
  ...
  observability?: { enabled: boolean; headSamplingRate?: number | null; logs?: { enabled: boolean; invocationLogs: boolean; destinations?: string[]; headSamplingRate?: number | null; persist?: boolean } | null };
  ...
  placement?: { mode: "smart"; lastAnalyzedAt?: string; status?: "SUCCESS" | "UNSUPPORTED_APPLICATION" | "INSUFFICIENT_INVOCATIONS" } | { region: string; lastAnalyzedAt?: string; status?: "SUCCESS" | "UNSUPPORTED_APPLICATION" | "INSUFFICIENT_INVOCATIONS" } | { hostname: string; lastAnalyzedAt?: string; status?: "SUCCESS" | "UNSUPPORTED_APPLICATION" | "INSUFFICIENT_INVOCATIONS" } | { host: string; lastAnalyzedAt?: string; status?: "SUCCESS" | "UNSUPPORTED_APPLICATION" | "INSUFFICIENT_INVOCATIONS" };
  /** @deprecated */
  placementMode?: "smart";
  /** @deprecated */
...
export const PutScriptResponse = Schema.Struct({
  ...
  tailConsumers: Schema.optional(Schema.Union([Schema.Array(Schema.Unknown), Schema.Null])),
  usageModel: Schema.optional(Schema.Literals(["standard", "bundled", "unbound"]))
}).pipe(Schema.encodeKeys({ startupTimeMs: "startup_time_ms", id: "id", compatibilityDate: "compatibility_date", compatibilityFlags: "compatibility_flags", createdOn: "created_on", entryPoint: "entry_point", etag: "etag", handlers: "handlers", hasAssets: "has_assets", hasModules: "has_modules", lastDeployedFrom: "last_deployed_from", logpush: "logpush", migrationTag: "migration_tag", modifiedOn: "modified_on", namedHandlers: "named_handlers", observability: "observability", placement: "placement", placementMode: "placement_mode", placementStatus: "placement_status", tag: "tag", tags: "tags", tailConsumers: "tail_consumers", usageModel: "usage_model" })) as unknown as Schema.Schema<PutScriptResponse>;
...
export const DeleteScriptResponse = Schema.Unknown as unknown as Schema.Schema<DeleteScriptResponse>;
...
export type SearchScriptResponse = { createdOn: string; modifiedOn: string; scriptName: string; scriptTag?: string; environmentIsDefault?: boolean; environmentName?: string; serviceName?: string }[];

export const SearchScriptResponse = Schema.Array(Schema.Struct({
  createdOn: Schema.String,
...
}).pipe(Schema.encodeKeys({ createdOn: "created_on", modifiedOn: "modified_on", scriptName: "script_name", scriptTag: "script_tag", environmentIsDefault: "environment_is_default", environmentName: "environment_name", serviceName: "service_name" }))) as unknown as Schema.Schema<SearchScriptResponse>;
...
export const GetScriptContentResponse = Schema.Unknown as unknown as Schema.Schema<GetScriptContentResponse>;
...
export const PutScriptContentResponse = Schema.Unknown as unknown as Schema.Schema<PutScriptContentResponse>;
...
export const GetScriptDeploymentResponse = Schema.Struct({
  ...
  "workers/message": Schema.optional(Schema.String),
  "workers/triggeredBy": Schema.optional(Schema.String)
}).pipe(Schema.encodeKeys({ "workers/message": ""workers/message"", "workers/triggeredBy": ""workers/triggered_by"" }))),
  authorEmail: Schema.optional(Schema.String)
}).pipe(Schema.encodeKeys({ id: "id", createdOn: "created_on", source: "source", strategy: "strategy", versions: "versions", annotations: "annotations", authorEmail: "author_email" })) as unknown as Schema.Schema<GetScriptDeploymentResponse>;
...
export interface ListScriptDeploymentsResponse {
  deployments: { id: string; createdOn: string; source: string; strategy: "percentage"; versions: { percentage: number; versionId: string }[]; annotations?: { "workers/message"?: string; "workers/triggeredBy"?: string }; authorEmail?: string }[];
}
...
export const CreateScriptDeploymentResponse = Schema.Struct({
  ...
  versions: Schema.optional(Schema.Array(Schema.Struct({
  percentage: Schema.Number,
  versionId: Schema.String
}).pipe(Schema.encodeKeys({ percentage: "percentage", versionId: "version_id" })))),
  annotations: Schema.optional(Schema.Struct({
  ...
  authorEmail: Schema.optional(Schema.String)
}).pipe(Schema.encodeKeys({ id: "id", createdOn: "created_on", source: "source", strategy: "strategy", versions: "versions", annotations: "annotations", authorEmail: "author_email" })) as unknown as Schema.Schema<CreateScriptDeploymentResponse>;
...
export const GetScriptScriptAndVersionSettingResponse = Schema.Struct({
  ...
  tailConsumers: Schema.optional(Schema.Union([Schema.Array(Schema.Unknown), Schema.Null])),
  usageModel: Schema.optional(Schema.Literals(["standard", "bundled", "unbound"]))
}).pipe(Schema.encodeKeys({ bindings: "bindings", compatibilityDate: "compatibility_date", compatibilityFlags: "compatibility_flags", limits: "limits", logpush: "logpush", observability: "observability", placement: "placement", tags: "tags", tailConsumers: "tail_consumers", usageModel: "usage_model" })) as unknown as Schema.Schema<GetScriptScriptAndVersionSettingResponse>;
...
export interface PatchScriptScriptAndVersionSettingRequest {
  ...
  accountId: string;
  /** Body param: */
  settings?: { bindings?: ({ name: string; type: "ai" } | { dataset: string; name: string; type: "analytics_engine" } | { name: string; type: "assets" } | { name: string; type: "browser" } | { id: string; name: string; type: "d1" } | { name: string; part: string; type: "data_blob" } | { name: string; namespace: string; type: "dispatch_namespace"; outbound?: { params?: string[]; worker?: { environment?: string; service?: string } } } | { name: string; type: "durable_object_namespace"; className?: string; environment?: string; namespaceId?: string; scriptName?: string } | { id: string; name: string; type: "hyperdrive" } | { name: string; type: "inherit"; oldName?: string; versionId?: string } | { name: string; type: "images" } | { json: string; name: string; type: "json" } | { name: string; namespaceId: string; type: "kv_namespace" } | { certificateId: string; name: string; type: "mtls_certificate" } | { name: string; text: string; type: "plain_text" } | { name: string; pipeline: string; type: "pipelines" } | { name: string; queueName: string; type: "queue" } | { bucketName: string; name: string; type: "r2_bucket"; jurisdiction?: "eu" | "fedramp" } | { name: string; text: string; type: "secret_text" } | { name: string; type: "send_email"; allowedDestinationAddresses?: string[]; allowedSenderAddresses?: string[]; destinationAddress?: string } | { name: string; service: string; type: "service"; environment?: string } | { name: string; part: string; type: "text_blob" } | { indexName: string; name: string; type: "vectorize" } | { name: string; type: "version_metadata" } | { name: string; secretName: string; storeId: string; type: "secrets_store_secret" } | { algorithm: unknown; format: "raw" | "pkcs8" | "spki" | "jwk"; name: string; type: "secret_key"; usages: ("encrypt" | "decrypt" | "sign" | "verify" | "deriveKey" | "deriveBits" | "wrapKey" | "unwrapKey")[]; keyBase64?: string; keyJwk?: unknown } | { name: string; type: "workflow"; workflowName: string; className?: string; scriptName?: string } | { name: string; part: string; type: "wasm_module" })[]; compatibilityDate?: string; compatibilityFlags?: string[]; limits?: { cpuMs?: number }; logpush?: boolean; migrations?: unknown | { newTag?: string; oldTag?: string; steps?: unknown[] }; observability?: { enabled: boolean; headSamplingRate?: number | null; logs?: { enabled: boolean; invocationLogs: boolean; destinations?: string[]; headSamplingRate?: number | null; persist?: boolean } | null }; placement?: { mode: "smart" } | { region: string } | { hostname: string } | { host: string }; tags?: string[] | null; tailConsumers?: unknown[] | null; usageModel?: "standard" | "bundled" | "unbound" };
}
...
export const GetScriptSecretResponse = Schema.Union([Schema.Struct({
  name: Schema.String,
  type: Schema.Literal("secret_text")
}), Schema.Struct({
  algorithm: Schema.Unknown,
...
export type ListScriptSecretsResponse = ({ name: string; type: "secret_text" } | { algorithm: unknown; format: "raw" | "pkcs8" | "spki" | "jwk"; name: string; type: "secret_key"; usages: ("encrypt" | "decrypt" | "sign" | "verify" | "deriveKey" | "deriveBits" | "wrapKey" | "unwrapKey")[] })[];

export const ListScriptSecretsResponse = Schema.Array(Schema.Union([Schema.Struct({
  name: Schema.String,
  type: Schema.Literal("secret_text")
}), Schema.Struct({
  algorithm: Schema.Unknown,
...
export const PutScriptSecretResponse = Schema.Union([Schema.Struct({
  name: Schema.String,
  type: Schema.Literal("secret_text")
}), Schema.Struct({
  algorithm: Schema.Unknown,
...
export const DeleteScriptSecretResponse = Schema.Unknown as unknown as Schema.Schema<DeleteScriptSecretResponse>;
...
export const GetScriptSettingResponse = Schema.Unknown as unknown as Schema.Schema<GetScriptSettingResponse>;
...
export const PatchScriptSettingResponse = Schema.Unknown as unknown as Schema.Schema<PatchScriptSettingResponse>;
...
}).pipe(Schema.encodeKeys({ enabled: "enabled", previewsEnabled: "previews_enabled" })) as unknown as Schema.Schema<GetScriptSubdomainResponse>;
...
export const CreateScriptSubdomainResponse = Schema.Struct({
  enabled: Schema.Boolean,
  previewsEnabled: Schema.Boolean
}).pipe(Schema.encodeKeys({ enabled: "enabled", previewsEnabled: "previews_enabled" })) as unknown as Schema.Schema<CreateScriptSubdomainResponse>;
...
export const DeleteScriptSubdomainResponse = Schema.Struct({
  enabled: Schema.Boolean,
  previewsEnabled: Schema.Boolean
}).pipe(Schema.encodeKeys({ enabled: "enabled", previewsEnabled: "previews_enabled" })) as unknown as Schema.Schema<DeleteScriptSubdomainResponse>;
...
export const GetScriptTailResponse = Schema.Struct({
  ...
  url: Schema.String
}).pipe(Schema.encodeKeys({ id: "id", expiresAt: "expires_at", url: "url" })) as unknown as Schema.Schema<GetScriptTailResponse>;
...
export const CreateScriptTailResponse = Schema.Struct({
  ...
  expiresAt: Schema.String,
  url: Schema.String
}).pipe(Schema.encodeKeys({ id: "id", expiresAt: "expires_at", url: "url" })) as unknown as Schema.Schema<CreateScriptTailResponse>;
...
export interface GetScriptVersionResponse {
  resources: { bindings?: ({ name: string; type: "ai" } | { dataset: string; name: string; type: "analytics_engine" } | { name: string; type: "assets" } | { name: string; type: "browser" } | { id: string; name: string; type: "d1" } | { name: string; part: string; type: "data_blob" } | { name: string; namespace: string; type: "dispatch_namespace"; outbound?: { params?: string[]; worker?: { environment?: string; service?: string } } } | { name: string; type: "durable_object_namespace"; className?: string; environment?: string; namespaceId?: string; scriptName?: string } | { id: string; name: string; type: "hyperdrive" } | { name: string; type: "inherit"; oldName?: string; versionId?: string } | { name: string; type: "images" } | { json: string; name: string; type: "json" } | { name: string; namespaceId: string; type: "kv_namespace" } | { certificateId: string; name: string; type: "mtls_certificate" } | { name: string; text: string; type: "plain_text" } | { name: string; pipeline: string; type: "pipelines" } | { name: string; queueName: string; type: "queue" } | { bucketName: string; name: string; type: "r2_bucket"; jurisdiction?: "eu" | "fedramp" } | { name: string; type: "secret_text" } | { name: string; type: "send_email"; allowedDestinationAddresses?: string[]; allowedSenderAddresses?: string[]; destinationAddress?: string } | { name: string; service: string; type: "service"; environment?: string } | { name: string; part: string; type: "text_blob" } | { indexName: string; name: string; type: "vectorize" } | { name: string; type: "version_metadata" } | { name: string; secretName: string; storeId: string; type: "secrets_store_secret" } | { algorithm: unknown; format: "raw" | "pkcs8" | "spki" | "jwk"; name: string; type: "secret_key"; usages: ("encrypt" | "decrypt" | "sign" | "verify" | "deriveKey" | "deriveBits" | "wrapKey" | "unwrapKey")[] } | { name: string; type: "workflow"; workflowName: string; className?: string; scriptName?: string } | { name: string; part: string; type: "wasm_module" })[]; script?: { etag?: string; handlers?: string[]; lastDeployedFrom?: string; namedHandlers?: { handlers?: string[]; name?: string }[] }; scriptRuntime?: { compatibilityDate?: string; compatibilityFlags?: string[]; limits?: { cpuMs?: number }; migrationTag?: string; usageModel?: "bundled" | "unbound" | "standard" } };
  /** Unique identifier for the version. */
  id?: string;
  metadata?: { authorEmail?: string; authorId?: string; createdOn?: string; hasPreview?: boolean; modifiedOn?: string; source?: "unknown" | "api" | "wrangler" | "terraform" | "dash" | "dash_template" | "integration" | "quick_editor" | "playground" | "workersci" };
...
export const GetScriptVersionResponse = Schema.Struct({
  ...
  }).pipe(Schema.encodeKeys({ etag: "etag", handlers: "handlers", lastDeployedFrom: "last_deployed_from", namedHandlers: "named_handlers" }))),
  scriptRuntime: Schema.optional(Schema.Struct({
    compatibilityDate: Schema.optional(Schema.String),
    compatibilityFlags: Schema.optional(Schema.Array(Schema.String)),
    limits: Schema.optional(Schema.Struct({
      cpuMs: Schema.optional(Schema.Number)
  ...
  }).pipe(Schema.encodeKeys({ compatibilityDate: "compatibility_date", compatibilityFlags: "compatibility_flags", limits: "limits", migrationTag: "migration_tag", usageModel: "usage_model" })))
  ...
  modifiedOn: Schema.optional(Schema.String),
  source: Schema.optional(Schema.Literals(["unknown", "api", "wrangler", "terraform", "dash", "dash_template", "integration", "quick_editor", "playground", "workersci"]))
}).pipe(Schema.encodeKeys({ authorEmail: "author_email", authorId: "author_id", createdOn: "created_on", hasPreview: "hasPreview", modifiedOn: "modified_on", source: "source" }))),
...
export type ListScriptVersionsResponse = ({ id?: string; metadata?: { authorEmail?: string; authorId?: string; createdOn?: string; hasPreview?: boolean; modifiedOn?: string; source?: "unknown" | "api" | "wrangler" | "terraform" | "dash" | "dash_template" | "integration" | "quick_editor" | "playground" | "workersci" }; number?: number })[];

export const ListScriptVersionsResponse = Schema.Array(Schema.Struct({
  id: Schema.optional(Schema.String),
  metadata: Schema.optional(Schema.Struct({
    authorEmail: Schema.optional(Schema.String),
    authorId: Schema.optional(Schema.String),
...
export interface CreateScriptVersionRequest {
  ...
  accountId: string;
  /** Body param: JSON-encoded metadata about the uploaded parts and Worker configuration. */
  metadata: { mainModule: string; annotations?: { "workers/alias"?: string; "workers/message"?: string; "workers/tag"?: string }; bindings?: ({ name: string; type: "ai" } | { dataset: string; name: string; type: "analytics_engine" } | { name: string; type: "assets" } | { name: string; type: "browser" } | { id: string; name: string; type: "d1" } | { name: string; part: string; type: "data_blob" } | { name: string; namespace: string; type: "dispatch_namespace"; outbound?: { params?: string[]; worker?: { environment?: string; service?: string } } } | { name: string; type: "durable_object_namespace"; className?: string; environment?: string; namespaceId?: string; scriptName?: string } | { id: string; name: string; type: "hyperdrive" } | { name: string; type: "inherit"; oldName?: string; versionId?: string } | { name: string; type: "images" } | { json: string; name: string; type: "json" } | { name: string; namespaceId: string; type: "kv_namespace" } | { certificateId: string; name: string; type: "mtls_certificate" } | { name: string; text: string; type: "plain_text" } | { name: string; pipeline: string; type: "pipelines" } | { name: string; queueName: string; type: "queue" } | { bucketName: string; name: string; type: "r2_bucket"; jurisdiction?: "eu" | "fedramp" } | { name: string; text: string; type: "secret_text" } | { name: string; type: "send_email"; allowedDestinationAddresses?: string[]; allowedSenderAddresses?: string[]; destinationAddress?: string } | { name: string; service: string; type: "service"; environment?: string } | { name: string; part: string; type: "text_blob" } | { indexName: string; name: string; type: "vectorize" } | { name: string; type: "version_metadata" } | { name: string; secretName: string; storeId: string; type: "secrets_store_secret" } | { algorithm: unknown; format: "raw" | "pkcs8" | "spki" | "jwk"; name: string; type: "secret_key"; usages: ("encrypt" | "decrypt" | "sign" | "verify" | "deriveKey" | "deriveBits" | "wrapKey" | "unwrapKey")[]; keyBase64?: string; keyJwk?: unknown } | { name: string; type: "workflow"; workflowName: string; className?: string; scriptName?: string } | { name: string; part: string; type: "wasm_module" })[]; compatibilityDate?: string; compatibilityFlags?: string[]; keepBindings?: string[]; usageModel?: "standard" | "bundled" | "unbound" };
  /** Body param: An array of modules (often JavaScript files) comprising a Worker script. At least one module must be present and referenced in the metadata as `main_module` or `body_part` by filename.<br/ */
  files?: (File | Blob)[];
}
...
export const CreateScriptVersionResponse = Schema.Struct({
  ...
  number: Schema.optional(Schema.Number),
  startupTimeMs: Schema.optional(Schema.Number)
}).pipe(Schema.encodeKeys({ resources: "resources", id: "id", metadata: "metadata", number: "number", startupTimeMs: "startup_time_ms" })) as unknown as Schema.Schema<CreateScriptVersionResponse>;
...
export const DeleteSubdomainResponse = Schema.Unknown as unknown as Schema.Schema<DeleteSubdomainResponse>;
