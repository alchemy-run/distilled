...
export const GetHostnameRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/web3/hostnames/{identifier}" })) as unknown as Schema.Schema<GetHostnameRequest>;
...
export const GetHostnameResponse = Schema.Struct({
  ...
  status: Schema.optional(Schema.Literals(["active", "pending", "deleting", "error"])),
  target: Schema.optional(Schema.Literals(["ethereum", "ipfs", "ipfs_universal_path"]))
}).pipe(Schema.encodeKeys({ id: "id", createdOn: "created_on", description: "description", dnslink: "dnslink", modifiedOn: "modified_on", name: "name", status: "status", target: "target" })) as unknown as Schema.Schema<GetHostnameResponse>;
...
export const ListHostnamesRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/web3/hostnames" })) as unknown as Schema.Schema<ListHostnamesRequest>;

export type ListHostnamesResponse = ({ id?: string; createdOn?: string; description?: string; dnslink?: string; modifiedOn?: string; name?: string; status?: "active" | "pending" | "deleting" | "error"; target?: "ethereum" | "ipfs" | "ipfs_universal_path" })[];

export const ListHostnamesResponse = Schema.Array(Schema.Struct({
  id: Schema.optional(Schema.String),
  createdOn: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
  dnslink: Schema.optional(Schema.String),
  ...
  status: Schema.optional(Schema.Literals(["active", "pending", "deleting", "error"])),
  target: Schema.optional(Schema.Literals(["ethereum", "ipfs", "ipfs_universal_path"]))
}).pipe(Schema.encodeKeys({ id: "id", createdOn: "created_on", description: "description", dnslink: "dnslink", modifiedOn: "modified_on", name: "name", status: "status", target: "target" }))) as unknown as Schema.Schema<ListHostnamesResponse>;

export type ListHostnamesError =
  | DefaultErrors;
...
export const CreateHostnameRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/zones/{zone_id}/web3/hostnames" })) as unknown as Schema.Schema<CreateHostnameRequest>;
...
export const CreateHostnameResponse = Schema.Struct({
  ...
  status: Schema.optional(Schema.Literals(["active", "pending", "deleting", "error"])),
  target: Schema.optional(Schema.Literals(["ethereum", "ipfs", "ipfs_universal_path"]))
}).pipe(Schema.encodeKeys({ id: "id", createdOn: "created_on", description: "description", dnslink: "dnslink", modifiedOn: "modified_on", name: "name", status: "status", target: "target" })) as unknown as Schema.Schema<CreateHostnameResponse>;
...
export const PatchHostnameRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "PATCH", path: "/zones/{zone_id}/web3/hostnames/{identifier}" })) as unknown as Schema.Schema<PatchHostnameRequest>;
...
export const PatchHostnameResponse = Schema.Struct({
  ...
  status: Schema.optional(Schema.Literals(["active", "pending", "deleting", "error"])),
  target: Schema.optional(Schema.Literals(["ethereum", "ipfs", "ipfs_universal_path"]))
}).pipe(Schema.encodeKeys({ id: "id", createdOn: "created_on", description: "description", dnslink: "dnslink", modifiedOn: "modified_on", name: "name", status: "status", target: "target" })) as unknown as Schema.Schema<PatchHostnameResponse>;
...
export const DeleteHostnameRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "DELETE", path: "/zones/{zone_id}/web3/hostnames/{identifier}" })) as unknown as Schema.Schema<DeleteHostnameRequest>;
...
export const GetHostnameIpfsUniversalPathContentListRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/web3/hostnames/{identifier}/ipfs_universal_path/content_list" })) as unknown as Schema.Schema<GetHostnameIpfsUniversalPathContentListRequest>;
...
export const PutHostnameIpfsUniversalPathContentListRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "PUT", path: "/zones/{zone_id}/web3/hostnames/{identifier}/ipfs_universal_path/content_list" })) as unknown as Schema.Schema<PutHostnameIpfsUniversalPathContentListRequest>;
...
export const GetHostnameIpfsUniversalPathContentListEntryRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/web3/hostnames/{identifier}/ipfs_universal_path/content_list/entries/{contentListEntryIdentifier}" })) as unknown as Schema.Schema<GetHostnameIpfsUniversalPathContentListEntryRequest>;
...
export const GetHostnameIpfsUniversalPathContentListEntryResponse = Schema.Struct({
  ...
  modifiedOn: Schema.optional(Schema.String),
  type: Schema.optional(Schema.Literals(["cid", "content_path"]))
}).pipe(Schema.encodeKeys({ id: "id", content: "content", createdOn: "created_on", description: "description", modifiedOn: "modified_on", type: "type" })) as unknown as Schema.Schema<GetHostnameIpfsUniversalPathContentListEntryResponse>;
...
export const ListHostnameIpfsUniversalPathContentListEntriesRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/web3/hostnames/{identifier}/ipfs_universal_path/content_list/entries" })) as unknown as Schema.Schema<ListHostnameIpfsUniversalPathContentListEntriesRequest>;

export interface ListHostnameIpfsUniversalPathContentListEntriesResponse {
  /** Provides content list entries. */
  entries?: ({ id?: string; content?: string; createdOn?: string; description?: string; modifiedOn?: string; type?: "cid" | "content_path" })[];
}

export const ListHostnameIpfsUniversalPathContentListEntriesResponse = Schema.Struct({
  ...
  modifiedOn: Schema.optional(Schema.String),
  type: Schema.optional(Schema.Literals(["cid", "content_path"]))
}).pipe(Schema.encodeKeys({ id: "id", content: "content", createdOn: "created_on", description: "description", modifiedOn: "modified_on", type: "type" }))))
...
export const CreateHostnameIpfsUniversalPathContentListEntryRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/zones/{zone_id}/web3/hostnames/{identifier}/ipfs_universal_path/content_list/entries" })) as unknown as Schema.Schema<CreateHostnameIpfsUniversalPathContentListEntryRequest>;
...
export const CreateHostnameIpfsUniversalPathContentListEntryResponse = Schema.Struct({
  ...
  modifiedOn: Schema.optional(Schema.String),
  type: Schema.optional(Schema.Literals(["cid", "content_path"]))
}).pipe(Schema.encodeKeys({ id: "id", content: "content", createdOn: "created_on", description: "description", modifiedOn: "modified_on", type: "type" })) as unknown as Schema.Schema<CreateHostnameIpfsUniversalPathContentListEntryResponse>;
...
export const UpdateHostnameIpfsUniversalPathContentListEntryRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "PUT", path: "/zones/{zone_id}/web3/hostnames/{identifier}/ipfs_universal_path/content_list/entries/{contentListEntryIdentifier}" })) as unknown as Schema.Schema<UpdateHostnameIpfsUniversalPathContentListEntryRequest>;
...
export const UpdateHostnameIpfsUniversalPathContentListEntryResponse = Schema.Struct({
  ...
  modifiedOn: Schema.optional(Schema.String),
  type: Schema.optional(Schema.Literals(["cid", "content_path"]))
}).pipe(Schema.encodeKeys({ id: "id", content: "content", createdOn: "created_on", description: "description", modifiedOn: "modified_on", type: "type" })) as unknown as Schema.Schema<UpdateHostnameIpfsUniversalPathContentListEntryResponse>;
...
export const DeleteHostnameIpfsUniversalPathContentListEntryRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "DELETE", path: "/zones/{zone_id}/web3/hostnames/{identifier}/ipfs_universal_path/content_list/entries/{contentListEntryIdentifier}" })) as unknown as Schema.Schema<DeleteHostnameIpfsUniversalPathContentListEntryRequest>;
...
export const DeleteHostnameIpfsUniversalPathContentListEntryResponse = Schema.Struct({
  id: Schema.String
