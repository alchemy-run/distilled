...
export const GetAccessRuleRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/{accountOrZone}/{accountOrZoneId}/firewall/access_rules/rules/{ruleId}" })) as unknown as Schema.Schema<GetAccessRuleRequest>;
...
export interface GetAccessRuleResponse {
  ...
  configuration: { target?: "ip"; value?: string } | { target?: "ip6"; value?: string } | { target?: "ip_range"; value?: string } | { target?: "asn"; value?: string } | { target?: "country"; value?: string };
...
export const GetAccessRuleResponse = Schema.Struct({
  id: Schema.String,
  allowedModes: Schema.Array(Schema.Literals(["block", "challenge", "whitelist", "js_challenge", "managed_challenge"])),
  ...
  mode: Schema.Literals(["block", "challenge", "whitelist", "js_challenge", "managed_challenge"]),
...
}).pipe(Schema.encodeKeys({ id: "id", allowedModes: "allowed_modes", configuration: "configuration", mode: "mode", createdOn: "created_on", modifiedOn: "modified_on", notes: "notes", scope: "scope" })) as unknown as Schema.Schema<GetAccessRuleResponse>;

export type GetAccessRuleError =
  | DefaultErrors;
...
export const ListAccessRulesRequest = Schema.Struct({
})
  .pipe(T.Http({ method: "GET", path: "/{accountOrZone}/{accountOrZoneId}/firewall/access_rules/rules" })) as unknown as Schema.Schema<ListAccessRulesRequest>;

export type ListAccessRulesResponse = ({ id: string; allowedModes: ("block" | "challenge" | "whitelist" | "js_challenge" | "managed_challenge")[]; configuration: { target?: "ip"; value?: string } | { target?: "ip6"; value?: string } | { target?: "ip_range"; value?: string } | { target?: "asn"; value?: string } | { target?: "country"; value?: string }; mode: "block" | "challenge" | "whitelist" | "js_challenge" | "managed_challenge"; createdOn?: string; modifiedOn?: string; notes?: string; scope?: { id?: string; email?: string; type?: "user" | "organization" } })[];

export const ListAccessRulesResponse = Schema.Array(Schema.Struct({
  id: Schema.String,
  allowedModes: Schema.Array(Schema.Literals(["block", "challenge", "whitelist", "js_challenge", "managed_challenge"])),
  configuration: Schema.Union([Schema.Struct({
    target: Schema.optional(Schema.Literal("ip")),
...
}).pipe(Schema.encodeKeys({ id: "id", allowedModes: "allowed_modes", configuration: "configuration", mode: "mode", createdOn: "created_on", modifiedOn: "modified_on", notes: "notes", scope: "scope" }))) as unknown as Schema.Schema<ListAccessRulesResponse>;

export type ListAccessRulesError =
  | DefaultErrors;
...
export const CreateAccessRuleRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/{accountOrZone}/{accountOrZoneId}/firewall/access_rules/rules" })) as unknown as Schema.Schema<CreateAccessRuleRequest>;
...
}).pipe(Schema.encodeKeys({ id: "id", allowedModes: "allowed_modes", configuration: "configuration", mode: "mode", createdOn: "created_on", modifiedOn: "modified_on", notes: "notes", scope: "scope" })) as unknown as Schema.Schema<CreateAccessRuleResponse>;
...
export const PatchAccessRuleRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "PATCH", path: "/{accountOrZone}/{accountOrZoneId}/firewall/access_rules/rules/{ruleId}" })) as unknown as Schema.Schema<PatchAccessRuleRequest>;
...
}).pipe(Schema.encodeKeys({ id: "id", allowedModes: "allowed_modes", configuration: "configuration", mode: "mode", createdOn: "created_on", modifiedOn: "modified_on", notes: "notes", scope: "scope" })) as unknown as Schema.Schema<PatchAccessRuleResponse>;
...
export const DeleteAccessRuleRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "DELETE", path: "/{accountOrZone}/{accountOrZoneId}/firewall/access_rules/rules/{ruleId}" })) as unknown as Schema.Schema<DeleteAccessRuleRequest>;
...
export const GetLockdownRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/firewall/lockdowns/{lockDownsId}" })) as unknown as Schema.Schema<GetLockdownRequest>;
...
}).pipe(Schema.encodeKeys({ id: "id", configurations: "configurations", createdOn: "created_on", description: "description", modifiedOn: "modified_on", paused: "paused", urls: "urls" })) as unknown as Schema.Schema<GetLockdownResponse>;

export type GetLockdownError =
  | DefaultErrors;
...
export const ListLockdownsRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/firewall/lockdowns" })) as unknown as Schema.Schema<ListLockdownsRequest>;

export type ListLockdownsResponse = { id: string; configurations: unknown; createdOn: string; description: string; modifiedOn: string; paused: boolean; urls: string[] }[];

export const ListLockdownsResponse = Schema.Array(Schema.Struct({
  id: Schema.String,
  configurations: Schema.Unknown,
  createdOn: Schema.String,
  description: Schema.String,
  ...
  paused: Schema.Boolean,
  urls: Schema.Array(Schema.String)
}).pipe(Schema.encodeKeys({ id: "id", configurations: "configurations", createdOn: "created_on", description: "description", modifiedOn: "modified_on", paused: "paused", urls: "urls" }))) as unknown as Schema.Schema<ListLockdownsResponse>;

export type ListLockdownsError =
  | DefaultErrors;
...
export const CreateLockdownRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/zones/{zone_id}/firewall/lockdowns" })) as unknown as Schema.Schema<CreateLockdownRequest>;
...
export const CreateLockdownResponse = Schema.Struct({
  ...
  paused: Schema.Boolean,
  urls: Schema.Array(Schema.String)
}).pipe(Schema.encodeKeys({ id: "id", configurations: "configurations", createdOn: "created_on", description: "description", modifiedOn: "modified_on", paused: "paused", urls: "urls" })) as unknown as Schema.Schema<CreateLockdownResponse>;
...
export const UpdateLockdownRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "PUT", path: "/zones/{zone_id}/firewall/lockdowns/{lockDownsId}" })) as unknown as Schema.Schema<UpdateLockdownRequest>;
...
export const UpdateLockdownResponse = Schema.Struct({
  ...
  paused: Schema.Boolean,
  urls: Schema.Array(Schema.String)
}).pipe(Schema.encodeKeys({ id: "id", configurations: "configurations", createdOn: "created_on", description: "description", modifiedOn: "modified_on", paused: "paused", urls: "urls" })) as unknown as Schema.Schema<UpdateLockdownResponse>;
...
export const DeleteLockdownRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "DELETE", path: "/zones/{zone_id}/firewall/lockdowns/{lockDownsId}" })) as unknown as Schema.Schema<DeleteLockdownRequest>;
...
export const BulkPutRulesRequest = Schema.Struct({
  zoneId: Schema.String.pipe(T.HttpPath("zone_id")),
  body: Schema.Unknown.pipe(T.HttpBody())
})
  .pipe(T.Http({ method: "PUT", path: "/zones/{zone_id}/firewall/rules" })) as unknown as Schema.Schema<BulkPutRulesRequest>;

export type BulkPutRulesResponse = ({ id?: string; action?: "block" | "challenge" | "js_challenge" | "managed_challenge" | "allow" | "log" | "bypass"; description?: string; filter?: unknown | { id: string; deleted: boolean }; paused?: boolean; priority?: number; products?: ("zoneLockdown" | "uaBlock" | "bic" | "hot" | "securityLevel" | "rateLimit" | "waf")[]; ref?: string })[];

export const BulkPutRulesResponse = Schema.Array(Schema.Struct({
  id: Schema.optional(Schema.String),
  action: Schema.optional(Schema.Literals(["block", "challenge", "js_challenge", "managed_challenge", "allow", "log", "bypass"])),
  description: Schema.optional(Schema.String),
  filter: Schema.optional(Schema.Union([Schema.Unknown, Schema.Struct({
    id: Schema.String,
    deleted: Schema.Boolean
  })])),
  paused: Schema.optional(Schema.Boolean),
  priority: Schema.optional(Schema.Number),
  products: Schema.optional(Schema.Array(Schema.Literals(["zoneLockdown", "uaBlock", "bic", "hot", "securityLevel", "rateLimit", "waf"]))),
  ref: Schema.optional(Schema.String)
})) as unknown as Schema.Schema<BulkPutRulesResponse>;

export type BulkPutRulesError =
  | DefaultErrors;
...
export const GetRuleRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/firewall/rules/{ruleId}" })) as unknown as Schema.Schema<GetRuleRequest>;
...
export const ListRulesRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/firewall/rules" })) as unknown as Schema.Schema<ListRulesRequest>;

export type ListRulesResponse = ({ id?: string; action?: "block" | "challenge" | "js_challenge" | "managed_challenge" | "allow" | "log" | "bypass"; description?: string; filter?: unknown | { id: string; deleted: boolean }; paused?: boolean; priority?: number; products?: ("zoneLockdown" | "uaBlock" | "bic" | "hot" | "securityLevel" | "rateLimit" | "waf")[]; ref?: string })[];
...
export interface CreateRuleRequest {
  ...
  action: { mode?: "simulate" | "ban" | "challenge" | "js_challenge" | "managed_challenge"; response?: { body?: string; contentType?: string }; timeout?: number };
  /** Body param: */
  filter: unknown;
}
...
export const CreateRuleRequest = Schema.Struct({
  ...
  mode: Schema.optional(Schema.Literals(["simulate", "ban", "challenge", "js_challenge", "managed_challenge"])),
  ...
  .pipe(T.Http({ method: "POST", path: "/zones/{zone_id}/firewall/rules" })) as unknown as Schema.Schema<CreateRuleRequest>;

export type CreateRuleResponse = ({ id?: string; action?: "block" | "challenge" | "js_challenge" | "managed_challenge" | "allow" | "log" | "bypass"; description?: string; filter?: unknown | { id: string; deleted: boolean }; paused?: boolean; priority?: number; products?: ("zoneLockdown" | "uaBlock" | "bic" | "hot" | "securityLevel" | "rateLimit" | "waf")[]; ref?: string })[];
...
export const UpdateRuleRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "PUT", path: "/zones/{zone_id}/firewall/rules/{ruleId}" })) as unknown as Schema.Schema<UpdateRuleRequest>;
...
export const PatchRuleRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "PATCH", path: "/zones/{zone_id}/firewall/rules/{ruleId}" })) as unknown as Schema.Schema<PatchRuleRequest>;

export type PatchRuleResponse = ({ id?: string; action?: "block" | "challenge" | "js_challenge" | "managed_challenge" | "allow" | "log" | "bypass"; description?: string; filter?: unknown | { id: string; deleted: boolean }; paused?: boolean; priority?: number; products?: ("zoneLockdown" | "uaBlock" | "bic" | "hot" | "securityLevel" | "rateLimit" | "waf")[]; ref?: string })[];
...
export const DeleteRuleRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "DELETE", path: "/zones/{zone_id}/firewall/rules/{ruleId}" })) as unknown as Schema.Schema<DeleteRuleRequest>;
...
export const BulkPatchRulesRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "PATCH", path: "/zones/{zone_id}/firewall/rules" })) as unknown as Schema.Schema<BulkPatchRulesRequest>;

export type BulkPatchRulesResponse = ({ id?: string; action?: "block" | "challenge" | "js_challenge" | "managed_challenge" | "allow" | "log" | "bypass"; description?: string; filter?: unknown | { id: string; deleted: boolean }; paused?: boolean; priority?: number; products?: ("zoneLockdown" | "uaBlock" | "bic" | "hot" | "securityLevel" | "rateLimit" | "waf")[]; ref?: string })[];

export const BulkPatchRulesResponse = Schema.Array(Schema.Struct({
  id: Schema.optional(Schema.String),
  action: Schema.optional(Schema.Literals(["block", "challenge", "js_challenge", "managed_challenge", "allow", "log", "bypass"])),
  description: Schema.optional(Schema.String),
  filter: Schema.optional(Schema.Union([Schema.Unknown, Schema.Struct({
...
export type BulkPatchRulesError =
  | DefaultErrors;
...
export const BulkDeleteRulesRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "DELETE", path: "/zones/{zone_id}/firewall/rules" })) as unknown as Schema.Schema<BulkDeleteRulesRequest>;

export type BulkDeleteRulesResponse = ({ id?: string; action?: "block" | "challenge" | "js_challenge" | "managed_challenge" | "allow" | "log" | "bypass"; description?: string; filter?: unknown | { id: string; deleted: boolean }; paused?: boolean; priority?: number; products?: ("zoneLockdown" | "uaBlock" | "bic" | "hot" | "securityLevel" | "rateLimit" | "waf")[]; ref?: string })[];

export const BulkDeleteRulesResponse = Schema.Array(Schema.Struct({
  id: Schema.optional(Schema.String),
  action: Schema.optional(Schema.Literals(["block", "challenge", "js_challenge", "managed_challenge", "allow", "log", "bypass"])),
  description: Schema.optional(Schema.String),
  filter: Schema.optional(Schema.Union([Schema.Unknown, Schema.Struct({
...
export type BulkDeleteRulesError =
  | DefaultErrors;
...
export const GetUaRuleRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/firewall/ua_rules/{uaRuleId}" })) as unknown as Schema.Schema<GetUaRuleRequest>;
...
export const GetUaRuleResponse = Schema.Struct({
  ...
  description: Schema.optional(Schema.String),
  mode: Schema.optional(Schema.Literals(["block", "challenge", "js_challenge", "managed_challenge"])),
  paused: Schema.optional(Schema.Boolean)
}) as unknown as Schema.Schema<GetUaRuleResponse>;

export type GetUaRuleError =
  | DefaultErrors;
...
export const ListUaRulesRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/firewall/ua_rules" })) as unknown as Schema.Schema<ListUaRulesRequest>;

export type ListUaRulesResponse = ({ id?: string; configuration?: { target?: string; value?: string }; description?: string; mode?: "block" | "challenge" | "js_challenge" | "managed_challenge"; paused?: boolean })[];

export const ListUaRulesResponse = Schema.Array(Schema.Struct({
  id: Schema.optional(Schema.String),
  configuration: Schema.optional(Schema.Struct({
    target: Schema.optional(Schema.String),
    value: Schema.optional(Schema.String)
...
export const CreateUaRuleRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/zones/{zone_id}/firewall/ua_rules" })) as unknown as Schema.Schema<CreateUaRuleRequest>;
...
export const UpdateUaRuleRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "PUT", path: "/zones/{zone_id}/firewall/ua_rules/{uaRuleId}" })) as unknown as Schema.Schema<UpdateUaRuleRequest>;
...
export const DeleteUaRuleRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "DELETE", path: "/zones/{zone_id}/firewall/ua_rules/{uaRuleId}" })) as unknown as Schema.Schema<DeleteUaRuleRequest>;
...
export const GetWafOverrideRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/firewall/waf/overrides/{overridesId}" })) as unknown as Schema.Schema<GetWafOverrideRequest>;
...
export interface GetWafOverrideResponse {
  ...
  rewriteAction?: { block?: "challenge" | "block" | "simulate" | "disable" | "default"; challenge?: "challenge" | "block" | "simulate" | "disable" | "default"; default?: "challenge" | "block" | "simulate" | "disable" | "default"; disable?: "challenge" | "block" | "simulate" | "disable" | "default"; simulate?: "challenge" | "block" | "simulate" | "disable" | "default" };
...
export const GetWafOverrideResponse = Schema.Struct({
  ...
  paused: Schema.optional(Schema.Boolean),
  priority: Schema.optional(Schema.Number),
  rewriteAction: Schema.optional(Schema.Struct({
  block: Schema.optional(Schema.Literals(["challenge", "block", "simulate", "disable", "default"])),
  challenge: Schema.optional(Schema.Literals(["challenge", "block", "simulate", "disable", "default"])),
  default: Schema.optional(Schema.Literals(["challenge", "block", "simulate", "disable", "default"])),
  disable: Schema.optional(Schema.Literals(["challenge", "block", "simulate", "disable", "default"])),
  simulate: Schema.optional(Schema.Literals(["challenge", "block", "simulate", "disable", "default"]))
})),
  rules: Schema.optional(Schema.Unknown),
  urls: Schema.optional(Schema.Array(Schema.String))
}).pipe(Schema.encodeKeys({ id: "id", description: "description", groups: "groups", paused: "paused", priority: "priority", rewriteAction: "rewrite_action", rules: "rules", urls: "urls" })) as unknown as Schema.Schema<GetWafOverrideResponse>;

export type GetWafOverrideError =
  | DefaultErrors;
...
export const ListWafOverridesRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/firewall/waf/overrides" })) as unknown as Schema.Schema<ListWafOverridesRequest>;

export type ListWafOverridesResponse = ({ id?: string; description?: string | null; groups?: Record<string, unknown>; paused?: boolean; priority?: number; rewriteAction?: { block?: "challenge" | "block" | "simulate" | "disable" | "default"; challenge?: "challenge" | "block" | "simulate" | "disable" | "default"; default?: "challenge" | "block" | "simulate" | "disable" | "default"; disable?: "challenge" | "block" | "simulate" | "disable" | "default"; simulate?: "challenge" | "block" | "simulate" | "disable" | "default" }; rules?: unknown; urls?: string[] })[];

export const ListWafOverridesResponse = Schema.Array(Schema.Struct({
  id: Schema.optional(Schema.String),
  description: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
  groups: Schema.optional(Schema.Struct({})),
  paused: Schema.optional(Schema.Boolean),
  ...
  rules: Schema.optional(Schema.Unknown),
  urls: Schema.optional(Schema.Array(Schema.String))
}).pipe(Schema.encodeKeys({ id: "id", description: "description", groups: "groups", paused: "paused", priority: "priority", rewriteAction: "rewrite_action", rules: "rules", urls: "urls" }))) as unknown as Schema.Schema<ListWafOverridesResponse>;

export type ListWafOverridesError =
  | DefaultErrors;
...
export const CreateWafOverrideRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "POST", path: "/zones/{zone_id}/firewall/waf/overrides" })) as unknown as Schema.Schema<CreateWafOverrideRequest>;
...
export const CreateWafOverrideResponse = Schema.Struct({
  ...
  rules: Schema.optional(Schema.Unknown),
  urls: Schema.optional(Schema.Array(Schema.String))
}).pipe(Schema.encodeKeys({ id: "id", description: "description", groups: "groups", paused: "paused", priority: "priority", rewriteAction: "rewrite_action", rules: "rules", urls: "urls" })) as unknown as Schema.Schema<CreateWafOverrideResponse>;

export type CreateWafOverrideError =
  | DefaultErrors;
...
export const UpdateWafOverrideRequest = Schema.Struct({
  ...
  .pipe(Schema.encodeKeys({ id: "id", rewriteAction: "rewrite_action", rules: "rules", urls: "urls" }), T.Http({ method: "PUT", path: "/zones/{zone_id}/firewall/waf/overrides/{overridesId}" })) as unknown as Schema.Schema<UpdateWafOverrideRequest>;
...
export const UpdateWafOverrideResponse = Schema.Struct({
  ...
  rules: Schema.optional(Schema.Unknown),
  urls: Schema.optional(Schema.Array(Schema.String))
}).pipe(Schema.encodeKeys({ id: "id", description: "description", groups: "groups", paused: "paused", priority: "priority", rewriteAction: "rewrite_action", rules: "rules", urls: "urls" })) as unknown as Schema.Schema<UpdateWafOverrideResponse>;

export type UpdateWafOverrideError =
  | DefaultErrors;
...
export const DeleteWafOverrideRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "DELETE", path: "/zones/{zone_id}/firewall/waf/overrides/{overridesId}" })) as unknown as Schema.Schema<DeleteWafOverrideRequest>;
...
export type DeleteWafOverrideError =
  | DefaultErrors;
...
export const GetWafPackageRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/firewall/waf/packages/{packageId}" })) as unknown as Schema.Schema<GetWafPackageRequest>;

export type GetWafPackageResponse = { errors: unknown[]; messages: unknown[]; result: string | null; success: true } | { result?: unknown };

export const GetWafPackageResponse = Schema.Union([Schema.Struct({
...
export type GetWafPackageError =
  | DefaultErrors;
...
export const ListWafPackagesRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/firewall/waf/packages" })) as unknown as Schema.Schema<ListWafPackagesRequest>;

export type ListWafPackagesResponse = unknown[];

export const ListWafPackagesResponse = Schema.Array(Schema.Unknown) as unknown as Schema.Schema<ListWafPackagesResponse>;

export type ListWafPackagesError =
  | DefaultErrors;
...
export const GetWafPackageGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/firewall/waf/packages/{packageId}/groups/{groupId}" })) as unknown as Schema.Schema<GetWafPackageGroupRequest>;

export type GetWafPackageGroupResponse = string | null;

export const GetWafPackageGroupResponse = Schema.Union([Schema.String, Schema.Null]) as unknown as Schema.Schema<GetWafPackageGroupResponse>;

export type GetWafPackageGroupError =
  | DefaultErrors;
...
export const ListWafPackageGroupsRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/firewall/waf/packages/{packageId}/groups" })) as unknown as Schema.Schema<ListWafPackageGroupsRequest>;

export type ListWafPackageGroupsResponse = ({ id: string; description: string | null; mode: "on" | "off"; name: string; rulesCount: number; allowedModes?: ("on" | "off")[]; modifiedRulesCount?: number; packageId?: string })[];

export const ListWafPackageGroupsResponse = Schema.Array(Schema.Struct({
  id: Schema.String,
...
}).pipe(Schema.encodeKeys({ id: "id", description: "description", mode: "mode", name: "name", rulesCount: "rules_count", allowedModes: "allowed_modes", modifiedRulesCount: "modified_rules_count", packageId: "package_id" }))) as unknown as Schema.Schema<ListWafPackageGroupsResponse>;

export type ListWafPackageGroupsError =
  | DefaultErrors;
...
export const PatchWafPackageGroupRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "PATCH", path: "/zones/{zone_id}/firewall/waf/packages/{packageId}/groups/{groupId}" })) as unknown as Schema.Schema<PatchWafPackageGroupRequest>;

export type PatchWafPackageGroupResponse = string | null;

export const PatchWafPackageGroupResponse = Schema.Union([Schema.String, Schema.Null]) as unknown as Schema.Schema<PatchWafPackageGroupResponse>;

export type PatchWafPackageGroupError =
  | DefaultErrors;
...
export const GetWafPackageRuleRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/firewall/waf/packages/{packageId}/rules/{ruleId}" })) as unknown as Schema.Schema<GetWafPackageRuleRequest>;

export type GetWafPackageRuleResponse = string | null;

export const GetWafPackageRuleResponse = Schema.Union([Schema.String, Schema.Null]) as unknown as Schema.Schema<GetWafPackageRuleResponse>;

export type GetWafPackageRuleError =
  | DefaultErrors;
...
export const ListWafPackageRulesRequest = Schema.Struct({
  ...
  .pipe(T.Http({ method: "GET", path: "/zones/{zone_id}/firewall/waf/packages/{packageId}/rules" })) as unknown as Schema.Schema<ListWafPackageRulesRequest>;

export type ListWafPackageRulesResponse = ({ id: string; allowedModes: ("on" | "off")[]; description: string; group: unknown; mode: "on" | "off"; packageId: string; priority: string } | { id: string; allowedModes: ("default" | "disable" | "simulate" | "block" | "challenge")[]; defaultMode: "disable" | "simulate" | "block" | "challenge"; description: string; group: unknown; mode: "default" | "disable" | "simulate" | "block" | "challenge"; packageId: string; priority: string })[];

export const ListWafPackageRulesResponse = Schema.Array(Schema.Union([Schema.Struct({
  id: Schema.String,
...
}).pipe(Schema.encodeKeys({ id: "id", allowedModes: "allowed_modes", description: "description", group: "group", mode: "mode", packageId: "package_id", priority: "priority" })), Schema.Struct({
  id: Schema.String,
  allowedModes: Schema.Array(Schema.Literals(["default", "disable", "simulate", "block", "challenge"])),
  defaultMode: Schema.Literals(["disable", "simulate", "block", "challenge"]),
  description: Schema.String,
  group: Schema.Unknown,
  mode: Schema.Literals(["default", "disable", "simulate", "block", "challenge"]),
  packageId: Schema.String,
  priority: Schema.String
}).pipe(Schema.encodeKeys({ id: "id", allowedModes: "allowed_modes", defaultMode: "default_mode", description: "description", group: "group", mode: "mode", packageId: "package_id", priority: "priority" }))])) as unknown as Schema.Schema<ListWafPackageRulesResponse>;

export type ListWafPackageRulesError =
  | DefaultErrors;
...
export const PatchWafPackageRuleRequest = Schema.Struct({
  ...
  ruleId: Schema.String.pipe(T.HttpPath("ruleId")),
  zoneId: Schema.String.pipe(T.HttpPath("zone_id")),
  mode: Schema.optional(Schema.Literals(["default", "disable", "simulate", "block", "challenge", "on", "off"]))
})
  .pipe(T.Http({ method: "PATCH", path: "/zones/{zone_id}/firewall/waf/packages/{packageId}/rules/{ruleId}" })) as unknown as Schema.Schema<PatchWafPackageRuleRequest>;

export type PatchWafPackageRuleResponse = { id: string; allowedModes: ("on" | "off")[]; description: string; group: unknown; mode: "on" | "off"; packageId: string; priority: string } | { id: string; allowedModes: ("default" | "disable" | "simulate" | "block" | "challenge")[]; defaultMode: "disable" | "simulate" | "block" | "challenge"; description: string; group: unknown; mode: "default" | "disable" | "simulate" | "block" | "challenge"; packageId: string; priority: string };

export const PatchWafPackageRuleResponse = Schema.Union([Schema.Struct({
  id: Schema.String,
  allowedModes: Schema.Array(Schema.Literals(["on", "off"])),
  description: Schema.String,
  group: Schema.Unknown,
  ...
  packageId: Schema.String,
  priority: Schema.String
}).pipe(Schema.encodeKeys({ id: "id", allowedModes: "allowed_modes", defaultMode: "default_mode", description: "description", group: "group", mode: "mode", packageId: "package_id", priority: "priority" }))]) as unknown as Schema.Schema<PatchWafPackageRuleResponse>;

export type PatchWafPackageRuleError =
  | DefaultErrors;
