...
/**
 * Provides a custom retry policy to all Prisma Postgres API calls in the effect.
 *
 * @example
 * ```ts
 * import { Retry } from "distilled-prisma-postgres"
 * import * as Schedule from "effect/Schedule"
 *
 * // Static policy
 * myEffect.pipe(
...
/**
 * Creates the default retry policy used by distilled-prisma-postgres.
 *
 * This policy:
