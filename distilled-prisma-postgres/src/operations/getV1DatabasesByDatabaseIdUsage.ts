...
// Input Schema
export const GetV1DatabasesByDatabaseIdUsageInput = Schema.Struct({
...
// Output Schema
export const GetV1DatabasesByDatabaseIdUsageOutput = Schema.Struct({
  ...
  metrics: Schema.Struct({
    operations: Schema.Struct({
      used: Schema.Number,
      unit: Schema.Literal("ops"),
    }),
    storage: Schema.Struct({
      used: Schema.Number,
      unit: Schema.Literal("GiB"),
    }),
  }),
