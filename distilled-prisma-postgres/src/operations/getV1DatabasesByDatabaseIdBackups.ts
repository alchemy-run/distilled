...
// Input Schema
export const GetV1DatabasesByDatabaseIdBackupsInput = Schema.Struct({
...
// Output Schema
export const GetV1DatabasesByDatabaseIdBackupsOutput = Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
      id: Schema.String,
      ...
      type: Schema.optional(Schema.Literal("backup")),
    }),
  ),
  meta: Schema.Struct({
