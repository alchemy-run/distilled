...
// Input Schema
export const GetV1WorkspacesByWorkspaceIdIntegrationsInput = Schema.Struct({
  workspaceId: Schema.String.pipe(T.PathParam()),
  cursor: Schema.optional(Schema.String),
  limit: Schema.optional(Schema.Number),
}).pipe(
  T.Http({ method: "GET", path: "/v1/workspaces/{workspaceId}/integrations" }),
);
export type GetV1WorkspacesByWorkspaceIdIntegrationsInput =
  typeof GetV1WorkspacesByWorkspaceIdIntegrationsInput.Type;

// Output Schema
export const GetV1WorkspacesByWorkspaceIdIntegrationsOutput = Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
      id: Schema.String,
      url: Schema.String,
