 ...
 */
const annotationMetaSymbol = Symbol.for("prisma-postgres/annotation-meta");
...
export const httpSymbol = Symbol.for("prisma-postgres/http");
...
export const pathParamSymbol = Symbol.for("prisma-postgres/path-param");
...
export const queryParamSymbol = Symbol.for("prisma-postgres/query-param");
...
export const apiErrorCodeSymbol = Symbol.for("prisma-postgres/ApiErrorCode");
