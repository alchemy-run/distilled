/**
 * Global error types for Prisma Postgres API operations.
 *
...
/**
 * Base error for general Prisma Postgres errors.
 */
export class PrismaPostgresError extends Schema.TaggedErrorClass<PrismaPostgresError>()(
  "PrismaPostgresError",
  {
...
// ============================================================================
// API Errors - mapped from Prisma Postgres API error responses
// ============================================================================
 ...
 * The requested resource (project, database, connection, etc.) doesn't exist.
 */
 ...
 * An unexpected error occurred on the Prisma Postgres server.
 * Marked as retryable.
 */
 ...
 * The Prisma Postgres service is temporarily unavailable.
 * Marked as retryable.
 */
...
/**
 * All known Prisma Postgres API error classes.
 */
