#!/usr/bin/env bun
/**
 * Mirrors the Turso API spec into ../specs/.
 *
 * Only the 1 file the distilled turso generator actually reads
...
const REPO = "tursodatabase/turso-docs";
...
const FILES: SpecFile[] = [{ path: "api-reference/openapi.json", output: "openapi.json" }];
