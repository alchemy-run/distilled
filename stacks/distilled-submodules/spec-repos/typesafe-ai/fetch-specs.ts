#!/usr/bin/env bun
/**
 * Fetches the TypeSafe AI OpenAPI spec to ../specs/.
 *
 * TypeSafe publishes ONE OpenAPI 3.1 document at a stable URL — the same
 * file its docs site is generated from. There is no git repo and no
...
const OPENAPI_SPEC_URL = "https://api.typesafe.ai/openapi.json";
...
async function main() {
  ...
  const response = await fetch(OPENAPI_SPEC_URL, {
    headers: {
      ...
      "user-agent": "distilled.cloud-typesafe-ai-spec-mirror",
    },
  });
