#!/usr/bin/env bun
/**
 * Mirrors the Kubernetes API spec into ../specs/.
 *
 * Only the 1 file the distilled kubernetes generator actually reads
...
const FILES: SpecFile[] = [{ path: "api/openapi-spec/swagger.json", output: "swagger.json" }];
