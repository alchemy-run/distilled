#!/usr/bin/env bun
/**
 * Mirrors the Coinbase API spec into ../specs/.
 *
 * Only the 1 file the distilled coinbase generator actually reads
...
const FILES: SpecFile[] = [{ path: "openapi.yaml", output: "openapi.yaml" }];
