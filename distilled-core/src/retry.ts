...
import { isThrottlingError, isTransientError } from "./category.ts";
...
/**
 * Context tag for configuring retry behavior of API calls.
 */
export class Retry extends ServiceMap.Service<Retry, Policy>()("Retry") {}

/**
 * Provides a custom retry policy to all API calls in the effect.
 *
 * @example
 * ```ts
 * import { Retry } from "distilled-core"
 * import * as Schedule from "effect/Schedule"
 *
 * // Static policy
 * myEffect.pipe(
