...
const svc = T.AwsApiService({ sdkId: "Marketplace Metering", serviceShapeName: "AWSMPMeteringService" });
...
export interface UsageAllocation { AllocatedUsageQuantity: number; Tags?: Tag[] }
export const UsageAllocation = S.suspend(() => S.Struct({AllocatedUsageQuantity: S.Number, Tags: S.optional(TagList)})).annotate({ identifier: "UsageAllocation" }) as any as S.Schema<UsageAllocation>;
export type UsageAllocations = UsageAllocation[];
export const UsageAllocations = S.Array(UsageAllocation);
export interface UsageRecord { Timestamp: Date; CustomerIdentifier?: string; Dimension: string; Quantity?: number; UsageAllocations?: UsageAllocation[]; CustomerAWSAccountId?: string; LicenseArn?: string }
export const UsageRecord = S.suspend(() => S.Struct({Timestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds")), CustomerIdentifier: S.optional(S.String), Dimension: S.String, Quantity: S.optional(S.Number), UsageAllocations: S.optional(UsageAllocations), CustomerAWSAccountId: S.optional(S.String), LicenseArn: S.optional(S.String)})).annotate({ identifier: "UsageRecord" }) as any as S.Schema<UsageRecord>;
export type UsageRecordList = UsageRecord[];
export const UsageRecordList = S.Array(UsageRecord);
export interface BatchMeterUsageRequest { UsageRecords: UsageRecord[]; ProductCode?: string }
export const BatchMeterUsageRequest = S.suspend(() => S.Struct({UsageRecords: UsageRecordList, ProductCode: S.optional(S.String)}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "BatchMeterUsageRequest" }) as any as S.Schema<BatchMeterUsageRequest>;
...
export interface UsageRecordResult { UsageRecord?: UsageRecord; MeteringRecordId?: string; Status?: UsageRecordResultStatus }
export const UsageRecordResult = S.suspend(() => S.Struct({UsageRecord: S.optional(UsageRecord), MeteringRecordId: S.optional(S.String), Status: S.optional(UsageRecordResultStatus)})).annotate({ identifier: "UsageRecordResult" }) as any as S.Schema<UsageRecordResult>;
export type UsageRecordResultList = UsageRecordResult[];
export const UsageRecordResultList = S.Array(UsageRecordResult);
export interface BatchMeterUsageResult { Results?: UsageRecordResult[]; UnprocessedRecords?: UsageRecord[] }
export const BatchMeterUsageResult = S.suspend(() => S.Struct({Results: S.optional(UsageRecordResultList), UnprocessedRecords: S.optional(UsageRecordList)})).annotate({ identifier: "BatchMeterUsageResult" }) as any as S.Schema<BatchMeterUsageResult>;
export interface MeterUsageRequest { ProductCode: string; Timestamp: Date; UsageDimension: string; UsageQuantity?: number; DryRun?: boolean; UsageAllocations?: UsageAllocation[]; ClientToken?: string }
export const MeterUsageRequest = S.suspend(() => S.Struct({ProductCode: S.String, Timestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds")), UsageDimension: S.String, UsageQuantity: S.optional(S.Number), DryRun: S.optional(S.Boolean), UsageAllocations: S.optional(UsageAllocations), ClientToken: S.optional(S.String).pipe(T.IdempotencyToken())}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "MeterUsageRequest" }) as any as S.Schema<MeterUsageRequest>;
export interface MeterUsageResult { MeteringRecordId?: string }
export const MeterUsageResult = S.suspend(() => S.Struct({MeteringRecordId: S.optional(S.String)})).annotate({ identifier: "MeterUsageResult" }) as any as S.Schema<MeterUsageResult>;
export interface RegisterUsageRequest { ProductCode: string; PublicKeyVersion: number; Nonce?: string }
export const RegisterUsageRequest = S.suspend(() => S.Struct({ProductCode: S.String, PublicKeyVersion: S.Number, Nonce: S.optional(S.String)}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "RegisterUsageRequest" }) as any as S.Schema<RegisterUsageRequest>;
export interface RegisterUsageResult { PublicKeyRotationTimestamp?: Date; Signature?: string }
export const RegisterUsageResult = S.suspend(() => S.Struct({PublicKeyRotationTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Signature: S.optional(S.String)})).annotate({ identifier: "RegisterUsageResult" }) as any as S.Schema<RegisterUsageResult>;
export interface ResolveCustomerRequest { RegistrationToken: string }
export const ResolveCustomerRequest = S.suspend(() => S.Struct({RegistrationToken: S.String}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "ResolveCustomerRequest" }) as any as S.Schema<ResolveCustomerRequest>;
export interface ResolveCustomerResult { CustomerIdentifier?: string; ProductCode?: string; CustomerAWSAccountId?: string; LicenseArn?: string }
export const ResolveCustomerResult = S.suspend(() => S.Struct({CustomerIdentifier: S.optional(S.String), ProductCode: S.optional(S.String), CustomerAWSAccountId: S.optional(S.String), LicenseArn: S.optional(S.String)})).annotate({ identifier: "ResolveCustomerResult" }) as any as S.Schema<ResolveCustomerResult>;

//# Errors
export class DisabledApiException extends S.TaggedErrorClass<DisabledApiException>()("DisabledApiException", {message: S.optional(S.String)}) {}
...
export class InvalidCustomerIdentifierException extends S.TaggedErrorClass<InvalidCustomerIdentifierException>()("InvalidCustomerIdentifierException", {message: S.optional(S.String)}) {}
export class InvalidLicenseException extends S.TaggedErrorClass<InvalidLicenseException>()("InvalidLicenseException", {message: S.optional(S.String)}) {}
export class InvalidProductCodeException extends S.TaggedErrorClass<InvalidProductCodeException>()("InvalidProductCodeException", {message: S.optional(S.String)}) {}
...
export class InvalidUsageAllocationsException extends S.TaggedErrorClass<InvalidUsageAllocationsException>()("InvalidUsageAllocationsException", {message: S.optional(S.String)}) {}
export class InvalidUsageDimensionException extends S.TaggedErrorClass<InvalidUsageDimensionException>()("InvalidUsageDimensionException", {message: S.optional(S.String)}) {}
...
export class TimestampOutOfBoundsException extends S.TaggedErrorClass<TimestampOutOfBoundsException>()("TimestampOutOfBoundsException", {message: S.optional(S.String)}) {}
export class CustomerNotEntitledException extends S.TaggedErrorClass<CustomerNotEntitledException>()("CustomerNotEntitledException", {message: S.optional(S.String)}) {}
export class DuplicateRequestException extends S.TaggedErrorClass<DuplicateRequestException>()("DuplicateRequestException", {message: S.optional(S.String)}) {}
export class IdempotencyConflictException extends S.TaggedErrorClass<IdempotencyConflictException>()("IdempotencyConflictException", {message: S.optional(S.String)}).pipe(C.withConflictError) {}
export class InvalidEndpointRegionException extends S.TaggedErrorClass<InvalidEndpointRegionException>()("InvalidEndpointRegionException", {message: S.optional(S.String)}) {}
export class InvalidPublicKeyVersionException extends S.TaggedErrorClass<InvalidPublicKeyVersionException>()("InvalidPublicKeyVersionException", {message: S.optional(S.String)}) {}
export class InvalidRegionException extends S.TaggedErrorClass<InvalidRegionException>()("InvalidRegionException", {message: S.optional(S.String)}) {}
export class PlatformNotSupportedException extends S.TaggedErrorClass<PlatformNotSupportedException>()("PlatformNotSupportedException", {message: S.optional(S.String)}) {}
export class ExpiredTokenException extends S.TaggedErrorClass<ExpiredTokenException>()("ExpiredTokenException", {message: S.optional(S.String)}) {}
 ...
 * Guide.
 */
export const batchMeterUsage: API.OperationMethod<BatchMeterUsageRequest, BatchMeterUsageResult, BatchMeterUsageError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchMeterUsageRequest, output: BatchMeterUsageResult, errors: [DisabledApiException, InternalServiceErrorException, InvalidCustomerIdentifierException, InvalidLicenseException, InvalidProductCodeException, InvalidTagException, InvalidUsageAllocationsException, InvalidUsageDimensionException, ThrottlingException, TimestampOutOfBoundsException] }));
 ...
 */
export const meterUsage: API.OperationMethod<MeterUsageRequest, MeterUsageResult, MeterUsageError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: MeterUsageRequest, output: MeterUsageResult, errors: [CustomerNotEntitledException, DuplicateRequestException, IdempotencyConflictException, InternalServiceErrorException, InvalidEndpointRegionException, InvalidProductCodeException, InvalidTagException, InvalidUsageAllocationsException, InvalidUsageDimensionException, ThrottlingException, TimestampOutOfBoundsException] }));
 ...
 */
export const registerUsage: API.OperationMethod<RegisterUsageRequest, RegisterUsageResult, RegisterUsageError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RegisterUsageRequest, output: RegisterUsageResult, errors: [CustomerNotEntitledException, DisabledApiException, InternalServiceErrorException, InvalidProductCodeException, InvalidPublicKeyVersionException, InvalidRegionException, PlatformNotSupportedException, ThrottlingException] }));
 ...
 */
export const resolveCustomer: API.OperationMethod<ResolveCustomerRequest, ResolveCustomerResult, ResolveCustomerError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ResolveCustomerRequest, output: ResolveCustomerResult, errors: [DisabledApiException, ExpiredTokenException, InternalServiceErrorException, InvalidTokenException, ThrottlingException] }));
