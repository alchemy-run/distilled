...
const rules = T.EndpointResolver((p, _) => {
  ...
  const _p0 = () => ({"authSchemes": [{"name": "sigv4", "signingName": "sts", "signingRegion": "us-east-1"}]});
  {
    const PartitionResult = _.partition(Region);
    if ((UseGlobalEndpoint === true) && !((Endpoint != null)) && (Region != null) && PartitionResult != null && PartitionResult !== false && (UseFIPS === false) && (UseDualStack === false)) {
      ...
      return e(`https://sts.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}`, {"authSchemes": [{"name": "sigv4", "signingName": "sts", "signingRegion": `${Region}`}]}, {});
    }
  }
  if ((Endpoint != null)) {
    if ((UseFIPS === true)) {
...
//# Schemas
export interface PolicyDescriptorType { arn?: string }
export const PolicyDescriptorType = S.suspend(() => S.Struct({arn: S.optional(S.String)})).annotate({ identifier: "PolicyDescriptorType" }) as any as S.Schema<PolicyDescriptorType>;
...
export interface ProvidedContext { ProviderArn?: string; ContextAssertion?: string }
export const ProvidedContext = S.suspend(() => S.Struct({ProviderArn: S.optional(S.String), ContextAssertion: S.optional(S.String)})).annotate({ identifier: "ProvidedContext" }) as any as S.Schema<ProvidedContext>;
export type ProvidedContextsListType = ProvidedContext[];
export const ProvidedContextsListType = S.Array(ProvidedContext);
export interface AssumeRoleRequest { RoleArn: string; RoleSessionName: string; PolicyArns?: PolicyDescriptorType[]; Policy?: string; DurationSeconds?: number; Tags?: Tag[]; TransitiveTagKeys?: string[]; ExternalId?: string; SerialNumber?: string; TokenCode?: string; SourceIdentity?: string; ProvidedContexts?: ProvidedContext[] }
export const AssumeRoleRequest = S.suspend(() => S.Struct({RoleArn: S.String, RoleSessionName: S.String, PolicyArns: S.optional(PolicyDescriptorListType), Policy: S.optional(S.String), DurationSeconds: S.optional(S.Number), Tags: S.optional(TagListType), TransitiveTagKeys: S.optional(TagKeyListType), ExternalId: S.optional(S.String), SerialNumber: S.optional(S.String), TokenCode: S.optional(S.String), SourceIdentity: S.optional(S.String), ProvidedContexts: S.optional(ProvidedContextsListType)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "AssumeRoleRequest" }) as any as S.Schema<AssumeRoleRequest>;
export interface Credentials { AccessKeyId: string; SecretAccessKey: string | redacted.Redacted<string>; SessionToken: string; Expiration: Date }
export const Credentials = S.suspend(() => S.Struct({AccessKeyId: S.String, SecretAccessKey: SensitiveString, SessionToken: S.String, Expiration: T.DateFromString.pipe(T.TimestampFormat("date-time"))})).annotate({ identifier: "Credentials" }) as any as S.Schema<Credentials>;
export interface AssumedRoleUser { AssumedRoleId: string; Arn: string }
export const AssumedRoleUser = S.suspend(() => S.Struct({AssumedRoleId: S.String, Arn: S.String})).annotate({ identifier: "AssumedRoleUser" }) as any as S.Schema<AssumedRoleUser>;
export interface AssumeRoleResponse { Credentials?: Credentials; AssumedRoleUser?: AssumedRoleUser; PackedPolicySize?: number; SourceIdentity?: string }
export const AssumeRoleResponse = S.suspend(() => S.Struct({Credentials: S.optional(Credentials), AssumedRoleUser: S.optional(AssumedRoleUser), PackedPolicySize: S.optional(S.Number), SourceIdentity: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "AssumeRoleResponse" }) as any as S.Schema<AssumeRoleResponse>;
export interface AssumeRoleWithSAMLRequest { RoleArn: string; PrincipalArn: string; SAMLAssertion: string | redacted.Redacted<string>; PolicyArns?: PolicyDescriptorType[]; Policy?: string; DurationSeconds?: number }
export const AssumeRoleWithSAMLRequest = S.suspend(() => S.Struct({RoleArn: S.String, PrincipalArn: S.String, SAMLAssertion: SensitiveString, PolicyArns: S.optional(PolicyDescriptorListType), Policy: S.optional(S.String), DurationSeconds: S.optional(S.Number)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "AssumeRoleWithSAMLRequest" }) as any as S.Schema<AssumeRoleWithSAMLRequest>;
export interface AssumeRoleWithSAMLResponse { Credentials?: Credentials; AssumedRoleUser?: AssumedRoleUser; PackedPolicySize?: number; Subject?: string; SubjectType?: string; Issuer?: string; Audience?: string; NameQualifier?: string; SourceIdentity?: string }
export const AssumeRoleWithSAMLResponse = S.suspend(() => S.Struct({Credentials: S.optional(Credentials), AssumedRoleUser: S.optional(AssumedRoleUser), PackedPolicySize: S.optional(S.Number), Subject: S.optional(S.String), SubjectType: S.optional(S.String), Issuer: S.optional(S.String), Audience: S.optional(S.String), NameQualifier: S.optional(S.String), SourceIdentity: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "AssumeRoleWithSAMLResponse" }) as any as S.Schema<AssumeRoleWithSAMLResponse>;
export interface AssumeRoleWithWebIdentityRequest { RoleArn: string; RoleSessionName: string; WebIdentityToken: string | redacted.Redacted<string>; ProviderId?: string; PolicyArns?: PolicyDescriptorType[]; Policy?: string; DurationSeconds?: number }
...
export interface AssumeRoleWithWebIdentityResponse { Credentials?: Credentials; SubjectFromWebIdentityToken?: string; AssumedRoleUser?: AssumedRoleUser; PackedPolicySize?: number; Provider?: string; Audience?: string; SourceIdentity?: string }
export const AssumeRoleWithWebIdentityResponse = S.suspend(() => S.Struct({Credentials: S.optional(Credentials), SubjectFromWebIdentityToken: S.optional(S.String), AssumedRoleUser: S.optional(AssumedRoleUser), PackedPolicySize: S.optional(S.Number), Provider: S.optional(S.String), Audience: S.optional(S.String), SourceIdentity: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "AssumeRoleWithWebIdentityResponse" }) as any as S.Schema<AssumeRoleWithWebIdentityResponse>;
export interface AssumeRootRequest { TargetPrincipal: string; TaskPolicyArn: PolicyDescriptorType; DurationSeconds?: number }
export const AssumeRootRequest = S.suspend(() => S.Struct({TargetPrincipal: S.String, TaskPolicyArn: PolicyDescriptorType, DurationSeconds: S.optional(S.Number)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "AssumeRootRequest" }) as any as S.Schema<AssumeRootRequest>;
export interface AssumeRootResponse { Credentials?: Credentials; SourceIdentity?: string }
export const AssumeRootResponse = S.suspend(() => S.Struct({Credentials: S.optional(Credentials), SourceIdentity: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "AssumeRootResponse" }) as any as S.Schema<AssumeRootResponse>;
export interface DecodeAuthorizationMessageRequest { EncodedMessage: string }
export const DecodeAuthorizationMessageRequest = S.suspend(() => S.Struct({EncodedMessage: S.String}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "DecodeAuthorizationMessageRequest" }) as any as S.Schema<DecodeAuthorizationMessageRequest>;
export interface DecodeAuthorizationMessageResponse { DecodedMessage?: string }
export const DecodeAuthorizationMessageResponse = S.suspend(() => S.Struct({DecodedMessage: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "DecodeAuthorizationMessageResponse" }) as any as S.Schema<DecodeAuthorizationMessageResponse>;
export interface GetAccessKeyInfoRequest { AccessKeyId: string }
export const GetAccessKeyInfoRequest = S.suspend(() => S.Struct({AccessKeyId: S.String}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetAccessKeyInfoRequest" }) as any as S.Schema<GetAccessKeyInfoRequest>;
export interface GetAccessKeyInfoResponse { Account?: string }
export const GetAccessKeyInfoResponse = S.suspend(() => S.Struct({Account: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "GetAccessKeyInfoResponse" }) as any as S.Schema<GetAccessKeyInfoResponse>;
export interface GetCallerIdentityRequest {  }
export const GetCallerIdentityRequest = S.suspend(() => S.Struct({}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetCallerIdentityRequest" }) as any as S.Schema<GetCallerIdentityRequest>;
export interface GetCallerIdentityResponse { UserId?: string; Account?: string; Arn?: string }
export const GetCallerIdentityResponse = S.suspend(() => S.Struct({UserId: S.optional(S.String), Account: S.optional(S.String), Arn: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "GetCallerIdentityResponse" }) as any as S.Schema<GetCallerIdentityResponse>;
export interface GetDelegatedAccessTokenRequest { TradeInToken: string | redacted.Redacted<string> }
export const GetDelegatedAccessTokenRequest = S.suspend(() => S.Struct({TradeInToken: SensitiveString}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetDelegatedAccessTokenRequest" }) as any as S.Schema<GetDelegatedAccessTokenRequest>;
export interface GetDelegatedAccessTokenResponse { Credentials?: Credentials; PackedPolicySize?: number; AssumedPrincipal?: string }
export const GetDelegatedAccessTokenResponse = S.suspend(() => S.Struct({Credentials: S.optional(Credentials), PackedPolicySize: S.optional(S.Number), AssumedPrincipal: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "GetDelegatedAccessTokenResponse" }) as any as S.Schema<GetDelegatedAccessTokenResponse>;
export interface GetFederationTokenRequest { Name: string; Policy?: string; PolicyArns?: PolicyDescriptorType[]; DurationSeconds?: number; Tags?: Tag[] }
export const GetFederationTokenRequest = S.suspend(() => S.Struct({Name: S.String, Policy: S.optional(S.String), PolicyArns: S.optional(PolicyDescriptorListType), DurationSeconds: S.optional(S.Number), Tags: S.optional(TagListType)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetFederationTokenRequest" }) as any as S.Schema<GetFederationTokenRequest>;
export interface FederatedUser { FederatedUserId: string; Arn: string }
export const FederatedUser = S.suspend(() => S.Struct({FederatedUserId: S.String, Arn: S.String})).annotate({ identifier: "FederatedUser" }) as any as S.Schema<FederatedUser>;
export interface GetFederationTokenResponse { Credentials?: Credentials; FederatedUser?: FederatedUser; PackedPolicySize?: number }
export const GetFederationTokenResponse = S.suspend(() => S.Struct({Credentials: S.optional(Credentials), FederatedUser: S.optional(FederatedUser), PackedPolicySize: S.optional(S.Number)}).pipe(ns)).annotate({ identifier: "GetFederationTokenResponse" }) as any as S.Schema<GetFederationTokenResponse>;
export interface GetSessionTokenRequest { DurationSeconds?: number; SerialNumber?: string; TokenCode?: string }
export const GetSessionTokenRequest = S.suspend(() => S.Struct({DurationSeconds: S.optional(S.Number), SerialNumber: S.optional(S.String), TokenCode: S.optional(S.String)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetSessionTokenRequest" }) as any as S.Schema<GetSessionTokenRequest>;
export interface GetSessionTokenResponse { Credentials?: Credentials }
export const GetSessionTokenResponse = S.suspend(() => S.Struct({Credentials: S.optional(Credentials)}).pipe(ns)).annotate({ identifier: "GetSessionTokenResponse" }) as any as S.Schema<GetSessionTokenResponse>;
export type WebIdentityTokenAudienceListType = string[];
export const WebIdentityTokenAudienceListType = S.Array(S.String);
export interface GetWebIdentityTokenRequest { Audience: string[]; DurationSeconds?: number; SigningAlgorithm: string; Tags?: Tag[] }
export const GetWebIdentityTokenRequest = S.suspend(() => S.Struct({Audience: WebIdentityTokenAudienceListType, DurationSeconds: S.optional(S.Number), SigningAlgorithm: S.String, Tags: S.optional(TagListType)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetWebIdentityTokenRequest" }) as any as S.Schema<GetWebIdentityTokenRequest>;
export interface GetWebIdentityTokenResponse { WebIdentityToken?: string | redacted.Redacted<string>; Expiration?: Date }
export const GetWebIdentityTokenResponse = S.suspend(() => S.Struct({WebIdentityToken: S.optional(SensitiveString), Expiration: S.optional(T.DateFromString.pipe(T.TimestampFormat("date-time")))}).pipe(ns)).annotate({ identifier: "GetWebIdentityTokenResponse" }) as any as S.Schema<GetWebIdentityTokenResponse>;

//# Errors
export class ExpiredTokenException extends S.TaggedErrorClass<ExpiredTokenException>()("ExpiredTokenException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "ExpiredTokenException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
...
export class PackedPolicyTooLargeException extends S.TaggedErrorClass<PackedPolicyTooLargeException>()("PackedPolicyTooLargeException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "PackedPolicyTooLarge", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class RegionDisabledException extends S.TaggedErrorClass<RegionDisabledException>()("RegionDisabledException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "RegionDisabledException", httpResponseCode: 403 })).pipe(C.withAuthError) {}
export class IDPRejectedClaimException extends S.TaggedErrorClass<IDPRejectedClaimException>()("IDPRejectedClaimException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "IDPRejectedClaim", httpResponseCode: 403 })).pipe(C.withAuthError) {}
export class InvalidIdentityTokenException extends S.TaggedErrorClass<InvalidIdentityTokenException>()("InvalidIdentityTokenException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidIdentityToken", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class IDPCommunicationErrorException extends S.TaggedErrorClass<IDPCommunicationErrorException>()("IDPCommunicationErrorException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "IDPCommunicationError", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class InvalidAuthorizationMessageException extends S.TaggedErrorClass<InvalidAuthorizationMessageException>()("InvalidAuthorizationMessageException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidAuthorizationMessageException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class ExpiredTradeInTokenException extends S.TaggedErrorClass<ExpiredTradeInTokenException>()("ExpiredTradeInTokenException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "ExpiredTradeInTokenException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class JWTPayloadSizeExceededException extends S.TaggedErrorClass<JWTPayloadSizeExceededException>()("JWTPayloadSizeExceededException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "JWTPayloadSizeExceededException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class OutboundWebIdentityFederationDisabledException extends S.TaggedErrorClass<OutboundWebIdentityFederationDisabledException>()("OutboundWebIdentityFederationDisabledException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "OutboundWebIdentityFederationDisabledException", httpResponseCode: 403 })).pipe(C.withAuthError) {}
export class SessionDurationEscalationException extends S.TaggedErrorClass<SessionDurationEscalationException>()("SessionDurationEscalationException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "SessionDurationEscalationException", httpResponseCode: 403 })).pipe(C.withAuthError) {}
 ...
 * produces.
 */
export const assumeRole: API.OperationMethod<AssumeRoleRequest, AssumeRoleResponse, AssumeRoleError, Creds | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssumeRoleRequest, output: AssumeRoleResponse, errors: [ExpiredTokenException, MalformedPolicyDocumentException, PackedPolicyTooLargeException, RegionDisabledException] }));
 ...
 * *IAM User Guide*.
 */
export const assumeRoleWithSAML: API.OperationMethod<AssumeRoleWithSAMLRequest, AssumeRoleWithSAMLResponse, AssumeRoleWithSAMLError, Creds | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssumeRoleWithSAMLRequest, output: AssumeRoleWithSAMLResponse, errors: [ExpiredTokenException, IDPRejectedClaimException, InvalidIdentityTokenException, MalformedPolicyDocumentException, PackedPolicyTooLargeException, RegionDisabledException] }));
 ...
 */
export const assumeRoleWithWebIdentity: API.OperationMethod<AssumeRoleWithWebIdentityRequest, AssumeRoleWithWebIdentityResponse, AssumeRoleWithWebIdentityError, Creds | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssumeRoleWithWebIdentityRequest, output: AssumeRoleWithWebIdentityResponse, errors: [ExpiredTokenException, IDPCommunicationErrorException, IDPRejectedClaimException, InvalidIdentityTokenException, MalformedPolicyDocumentException, PackedPolicyTooLargeException, RegionDisabledException] }));
 ...
 */
export const assumeRoot: API.OperationMethod<AssumeRootRequest, AssumeRootResponse, AssumeRootError, Creds | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssumeRootRequest, output: AssumeRootResponse, errors: [ExpiredTokenException, RegionDisabledException] }));
 ...
 */
export const decodeAuthorizationMessage: API.OperationMethod<DecodeAuthorizationMessageRequest, DecodeAuthorizationMessageResponse, DecodeAuthorizationMessageError, Creds | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DecodeAuthorizationMessageRequest, output: DecodeAuthorizationMessageResponse, errors: [InvalidAuthorizationMessageException] }));
export type GetAccessKeyInfoError =
  | CommonErrors;
/**
 ...
 */
export const getAccessKeyInfo: API.OperationMethod<GetAccessKeyInfoRequest, GetAccessKeyInfoResponse, GetAccessKeyInfoError, Creds | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAccessKeyInfoRequest, output: GetAccessKeyInfoResponse, errors: [] }));
export type GetCallerIdentityError =
  | CommonErrors;
/**
 ...
 * *IAM User Guide*.
 */
export const getCallerIdentity: API.OperationMethod<GetCallerIdentityRequest, GetCallerIdentityResponse, GetCallerIdentityError, Creds | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetCallerIdentityRequest, output: GetCallerIdentityResponse, errors: [] }));
 ...
 * resources.
 */
export const getDelegatedAccessToken: API.OperationMethod<GetDelegatedAccessTokenRequest, GetDelegatedAccessTokenResponse, GetDelegatedAccessTokenError, Creds | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetDelegatedAccessTokenRequest, output: GetDelegatedAccessTokenResponse, errors: [ExpiredTradeInTokenException, PackedPolicyTooLargeException, RegionDisabledException] }));
 ...
 */
export const getFederationToken: API.OperationMethod<GetFederationTokenRequest, GetFederationTokenResponse, GetFederationTokenError, Creds | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetFederationTokenRequest, output: GetFederationTokenResponse, errors: [MalformedPolicyDocumentException, PackedPolicyTooLargeException, RegionDisabledException] }));
export type GetSessionTokenError =
  | RegionDisabledException
  | CommonErrors;
/**
 ...
 * *IAM User Guide*.
 */
export const getSessionToken: API.OperationMethod<GetSessionTokenRequest, GetSessionTokenResponse, GetSessionTokenError, Creds | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetSessionTokenRequest, output: GetSessionTokenResponse, errors: [RegionDisabledException] }));
 ...
 */
export const getWebIdentityToken: API.OperationMethod<GetWebIdentityTokenRequest, GetWebIdentityTokenResponse, GetWebIdentityTokenError, Creds | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetWebIdentityTokenRequest, output: GetWebIdentityTokenResponse, errors: [JWTPayloadSizeExceededException, OutboundWebIdentityFederationDisabledException, SessionDurationEscalationException] }));
