...
//# Schemas
export interface CancelKeyDeletionRequest { KeyId: string }
export const CancelKeyDeletionRequest = S.suspend(() => S.Struct({KeyId: S.String}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "CancelKeyDeletionRequest" }) as any as S.Schema<CancelKeyDeletionRequest>;
export interface CancelKeyDeletionResponse { KeyId?: string }
export const CancelKeyDeletionResponse = S.suspend(() => S.Struct({KeyId: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "CancelKeyDeletionResponse" }) as any as S.Schema<CancelKeyDeletionResponse>;
export interface ConnectCustomKeyStoreRequest { CustomKeyStoreId: string }
export const ConnectCustomKeyStoreRequest = S.suspend(() => S.Struct({CustomKeyStoreId: S.String}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "ConnectCustomKeyStoreRequest" }) as any as S.Schema<ConnectCustomKeyStoreRequest>;
export interface ConnectCustomKeyStoreResponse {  }
export const ConnectCustomKeyStoreResponse = S.suspend(() => S.Struct({}).pipe(ns)).annotate({ identifier: "ConnectCustomKeyStoreResponse" }) as any as S.Schema<ConnectCustomKeyStoreResponse>;
export interface CreateAliasRequest { AliasName: string; TargetKeyId: string }
export const CreateAliasRequest = S.suspend(() => S.Struct({AliasName: S.String, TargetKeyId: S.String}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "CreateAliasRequest" }) as any as S.Schema<CreateAliasRequest>;
export interface CreateAliasResponse {}
export const CreateAliasResponse = S.suspend(() => S.Struct({}).pipe(ns)).annotate({ identifier: "CreateAliasResponse" }) as any as S.Schema<CreateAliasResponse>;
export type CustomKeyStoreType =
  | "AWS_CLOUDHSM"
  | "EXTERNAL_KEY_STORE"
  | (string & {});
export const CustomKeyStoreType = S.String;
export interface XksProxyAuthenticationCredentialType { AccessKeyId: string | redacted.Redacted<string>; RawSecretAccessKey: string | redacted.Redacted<string> }
export const XksProxyAuthenticationCredentialType = S.suspend(() => S.Struct({AccessKeyId: SensitiveString, RawSecretAccessKey: SensitiveString})).annotate({ identifier: "XksProxyAuthenticationCredentialType" }) as any as S.Schema<XksProxyAuthenticationCredentialType>;
export type XksProxyConnectivityType =
  | "PUBLIC_ENDPOINT"
  | "VPC_ENDPOINT_SERVICE"
  | (string & {});
export const XksProxyConnectivityType = S.String;
export interface CreateCustomKeyStoreRequest { CustomKeyStoreName: string; CloudHsmClusterId?: string; TrustAnchorCertificate?: string; KeyStorePassword?: string | redacted.Redacted<string>; CustomKeyStoreType?: CustomKeyStoreType; XksProxyUriEndpoint?: string; XksProxyUriPath?: string; XksProxyVpcEndpointServiceName?: string; XksProxyVpcEndpointServiceOwner?: string; XksProxyAuthenticationCredential?: XksProxyAuthenticationCredentialType; XksProxyConnectivity?: XksProxyConnectivityType }
export const CreateCustomKeyStoreRequest = S.suspend(() => S.Struct({CustomKeyStoreName: S.String, CloudHsmClusterId: S.optional(S.String), TrustAnchorCertificate: S.optional(S.String), KeyStorePassword: S.optional(SensitiveString), CustomKeyStoreType: S.optional(CustomKeyStoreType), XksProxyUriEndpoint: S.optional(S.String), XksProxyUriPath: S.optional(S.String), XksProxyVpcEndpointServiceName: S.optional(S.String), XksProxyVpcEndpointServiceOwner: S.optional(S.String), XksProxyAuthenticationCredential: S.optional(XksProxyAuthenticationCredentialType), XksProxyConnectivity: S.optional(XksProxyConnectivityType)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "CreateCustomKeyStoreRequest" }) as any as S.Schema<CreateCustomKeyStoreRequest>;
export interface CreateCustomKeyStoreResponse { CustomKeyStoreId?: string }
export const CreateCustomKeyStoreResponse = S.suspend(() => S.Struct({CustomKeyStoreId: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "CreateCustomKeyStoreResponse" }) as any as S.Schema<CreateCustomKeyStoreResponse>;
...
export const EncryptionContextType = S.Record(S.String, S.String.pipe(S.optional));
export interface GrantConstraints { EncryptionContextSubset?: { [key: string]: string | undefined }; EncryptionContextEquals?: { [key: string]: string | undefined } }
export const GrantConstraints = S.suspend(() => S.Struct({EncryptionContextSubset: S.optional(EncryptionContextType), EncryptionContextEquals: S.optional(EncryptionContextType)})).annotate({ identifier: "GrantConstraints" }) as any as S.Schema<GrantConstraints>;
export type GrantTokenList = string[];
export const GrantTokenList = S.Array(S.String);
export interface CreateGrantRequest { KeyId: string; GranteePrincipal: string; RetiringPrincipal?: string; Operations: GrantOperation[]; Constraints?: GrantConstraints; GrantTokens?: string[]; Name?: string; DryRun?: boolean }
export const CreateGrantRequest = S.suspend(() => S.Struct({KeyId: S.String, GranteePrincipal: S.String, RetiringPrincipal: S.optional(S.String), Operations: GrantOperationList, Constraints: S.optional(GrantConstraints), GrantTokens: S.optional(GrantTokenList), Name: S.optional(S.String), DryRun: S.optional(S.Boolean)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "CreateGrantRequest" }) as any as S.Schema<CreateGrantRequest>;
export interface CreateGrantResponse { GrantToken?: string; GrantId?: string }
export const CreateGrantResponse = S.suspend(() => S.Struct({GrantToken: S.optional(S.String), GrantId: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "CreateGrantResponse" }) as any as S.Schema<CreateGrantResponse>;
...
export interface Tag { TagKey: string; TagValue: string }
export const Tag = S.suspend(() => S.Struct({TagKey: S.String, TagValue: S.String})).annotate({ identifier: "Tag" }) as any as S.Schema<Tag>;
export type TagList = Tag[];
export const TagList = S.Array(Tag);
export interface CreateKeyRequest { Policy?: string; Description?: string; KeyUsage?: KeyUsageType; CustomerMasterKeySpec?: CustomerMasterKeySpec; KeySpec?: KeySpec; Origin?: OriginType; CustomKeyStoreId?: string; BypassPolicyLockoutSafetyCheck?: boolean; Tags?: Tag[]; MultiRegion?: boolean; XksKeyId?: string }
export const CreateKeyRequest = S.suspend(() => S.Struct({Policy: S.optional(S.String), Description: S.optional(S.String), KeyUsage: S.optional(KeyUsageType), CustomerMasterKeySpec: S.optional(CustomerMasterKeySpec), KeySpec: S.optional(KeySpec), Origin: S.optional(OriginType), CustomKeyStoreId: S.optional(S.String), BypassPolicyLockoutSafetyCheck: S.optional(S.Boolean), Tags: S.optional(TagList), MultiRegion: S.optional(S.Boolean), XksKeyId: S.optional(S.String)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "CreateKeyRequest" }) as any as S.Schema<CreateKeyRequest>;
...
export interface MultiRegionKey { Arn?: string; Region?: string }
export const MultiRegionKey = S.suspend(() => S.Struct({Arn: S.optional(S.String), Region: S.optional(S.String)})).annotate({ identifier: "MultiRegionKey" }) as any as S.Schema<MultiRegionKey>;
export type MultiRegionKeyList = MultiRegionKey[];
export const MultiRegionKeyList = S.Array(MultiRegionKey);
export interface MultiRegionConfiguration { MultiRegionKeyType?: MultiRegionKeyType; PrimaryKey?: MultiRegionKey; ReplicaKeys?: MultiRegionKey[] }
export const MultiRegionConfiguration = S.suspend(() => S.Struct({MultiRegionKeyType: S.optional(MultiRegionKeyType), PrimaryKey: S.optional(MultiRegionKey), ReplicaKeys: S.optional(MultiRegionKeyList)})).annotate({ identifier: "MultiRegionConfiguration" }) as any as S.Schema<MultiRegionConfiguration>;
...
export interface XksKeyConfigurationType { Id?: string }
export const XksKeyConfigurationType = S.suspend(() => S.Struct({Id: S.optional(S.String)})).annotate({ identifier: "XksKeyConfigurationType" }) as any as S.Schema<XksKeyConfigurationType>;
export interface KeyMetadata { AWSAccountId?: string; KeyId: string; Arn?: string; CreationDate?: Date; Enabled?: boolean; Description?: string; KeyUsage?: KeyUsageType; KeyState?: KeyState; DeletionDate?: Date; ValidTo?: Date; Origin?: OriginType; CustomKeyStoreId?: string; CloudHsmClusterId?: string; ExpirationModel?: ExpirationModelType; KeyManager?: KeyManagerType; CustomerMasterKeySpec?: CustomerMasterKeySpec; KeySpec?: KeySpec; EncryptionAlgorithms?: EncryptionAlgorithmSpec[]; SigningAlgorithms?: SigningAlgorithmSpec[]; KeyAgreementAlgorithms?: KeyAgreementAlgorithmSpec[]; MultiRegion?: boolean; MultiRegionConfiguration?: MultiRegionConfiguration; PendingDeletionWindowInDays?: number; MacAlgorithms?: MacAlgorithmSpec[]; XksKeyConfiguration?: XksKeyConfigurationType; CurrentKeyMaterialId?: string }
export const KeyMetadata = S.suspend(() => S.Struct({AWSAccountId: S.optional(S.String), KeyId: S.String, Arn: S.optional(S.String), CreationDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Enabled: S.optional(S.Boolean), Description: S.optional(S.String), KeyUsage: S.optional(KeyUsageType), KeyState: S.optional(KeyState), DeletionDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ValidTo: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Origin: S.optional(OriginType), CustomKeyStoreId: S.optional(S.String), CloudHsmClusterId: S.optional(S.String), ExpirationModel: S.optional(ExpirationModelType), KeyManager: S.optional(KeyManagerType), CustomerMasterKeySpec: S.optional(CustomerMasterKeySpec), KeySpec: S.optional(KeySpec), EncryptionAlgorithms: S.optional(EncryptionAlgorithmSpecList), SigningAlgorithms: S.optional(SigningAlgorithmSpecList), KeyAgreementAlgorithms: S.optional(KeyAgreementAlgorithmSpecList), MultiRegion: S.optional(S.Boolean), MultiRegionConfiguration: S.optional(MultiRegionConfiguration), PendingDeletionWindowInDays: S.optional(S.Number), MacAlgorithms: S.optional(MacAlgorithmSpecList), XksKeyConfiguration: S.optional(XksKeyConfigurationType), CurrentKeyMaterialId: S.optional(S.String)})).annotate({ identifier: "KeyMetadata" }) as any as S.Schema<KeyMetadata>;
export interface CreateKeyResponse { KeyMetadata?: KeyMetadata }
export const CreateKeyResponse = S.suspend(() => S.Struct({KeyMetadata: S.optional(KeyMetadata)}).pipe(ns)).annotate({ identifier: "CreateKeyResponse" }) as any as S.Schema<CreateKeyResponse>;
export type KeyEncryptionMechanism =
  | "RSAES_OAEP_SHA_256"
  | (string & {});
export const KeyEncryptionMechanism = S.String;
export interface RecipientInfo { KeyEncryptionAlgorithm?: KeyEncryptionMechanism; AttestationDocument?: Uint8Array }
export const RecipientInfo = S.suspend(() => S.Struct({KeyEncryptionAlgorithm: S.optional(KeyEncryptionMechanism), AttestationDocument: S.optional(T.Blob)})).annotate({ identifier: "RecipientInfo" }) as any as S.Schema<RecipientInfo>;
...
export interface DecryptRequest { CiphertextBlob?: Uint8Array; EncryptionContext?: { [key: string]: string | undefined }; GrantTokens?: string[]; KeyId?: string; EncryptionAlgorithm?: EncryptionAlgorithmSpec; Recipient?: RecipientInfo; DryRun?: boolean; DryRunModifiers?: DryRunModifierType[] }
export const DecryptRequest = S.suspend(() => S.Struct({CiphertextBlob: S.optional(T.Blob), EncryptionContext: S.optional(EncryptionContextType), GrantTokens: S.optional(GrantTokenList), KeyId: S.optional(S.String), EncryptionAlgorithm: S.optional(EncryptionAlgorithmSpec), Recipient: S.optional(RecipientInfo), DryRun: S.optional(S.Boolean), DryRunModifiers: S.optional(DryRunModifierList)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "DecryptRequest" }) as any as S.Schema<DecryptRequest>;
export interface DecryptResponse { KeyId?: string; Plaintext?: Uint8Array | redacted.Redacted<Uint8Array>; EncryptionAlgorithm?: EncryptionAlgorithmSpec; CiphertextForRecipient?: Uint8Array; KeyMaterialId?: string }
export const DecryptResponse = S.suspend(() => S.Struct({KeyId: S.optional(S.String), Plaintext: S.optional(SensitiveBlob), EncryptionAlgorithm: S.optional(EncryptionAlgorithmSpec), CiphertextForRecipient: S.optional(T.Blob), KeyMaterialId: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "DecryptResponse" }) as any as S.Schema<DecryptResponse>;
export interface DeleteAliasRequest { AliasName: string }
export const DeleteAliasRequest = S.suspend(() => S.Struct({AliasName: S.String}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "DeleteAliasRequest" }) as any as S.Schema<DeleteAliasRequest>;
...
export interface DeleteCustomKeyStoreRequest { CustomKeyStoreId: string }
export const DeleteCustomKeyStoreRequest = S.suspend(() => S.Struct({CustomKeyStoreId: S.String}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "DeleteCustomKeyStoreRequest" }) as any as S.Schema<DeleteCustomKeyStoreRequest>;
export interface DeleteCustomKeyStoreResponse {  }
export const DeleteCustomKeyStoreResponse = S.suspend(() => S.Struct({}).pipe(ns)).annotate({ identifier: "DeleteCustomKeyStoreResponse" }) as any as S.Schema<DeleteCustomKeyStoreResponse>;
export interface DeleteImportedKeyMaterialRequest { KeyId: string; KeyMaterialId?: string }
export const DeleteImportedKeyMaterialRequest = S.suspend(() => S.Struct({KeyId: S.String, KeyMaterialId: S.optional(S.String)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "DeleteImportedKeyMaterialRequest" }) as any as S.Schema<DeleteImportedKeyMaterialRequest>;
export interface DeleteImportedKeyMaterialResponse { KeyId?: string; KeyMaterialId?: string }
export const DeleteImportedKeyMaterialResponse = S.suspend(() => S.Struct({KeyId: S.optional(S.String), KeyMaterialId: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "DeleteImportedKeyMaterialResponse" }) as any as S.Schema<DeleteImportedKeyMaterialResponse>;
export interface DeriveSharedSecretRequest { KeyId: string; KeyAgreementAlgorithm: KeyAgreementAlgorithmSpec; PublicKey: Uint8Array; GrantTokens?: string[]; DryRun?: boolean; Recipient?: RecipientInfo }
export const DeriveSharedSecretRequest = S.suspend(() => S.Struct({KeyId: S.String, KeyAgreementAlgorithm: KeyAgreementAlgorithmSpec, PublicKey: T.Blob, GrantTokens: S.optional(GrantTokenList), DryRun: S.optional(S.Boolean), Recipient: S.optional(RecipientInfo)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "DeriveSharedSecretRequest" }) as any as S.Schema<DeriveSharedSecretRequest>;
export interface DeriveSharedSecretResponse { KeyId?: string; SharedSecret?: Uint8Array | redacted.Redacted<Uint8Array>; CiphertextForRecipient?: Uint8Array; KeyAgreementAlgorithm?: KeyAgreementAlgorithmSpec; KeyOrigin?: OriginType }
export const DeriveSharedSecretResponse = S.suspend(() => S.Struct({KeyId: S.optional(S.String), SharedSecret: S.optional(SensitiveBlob), CiphertextForRecipient: S.optional(T.Blob), KeyAgreementAlgorithm: S.optional(KeyAgreementAlgorithmSpec), KeyOrigin: S.optional(OriginType)}).pipe(ns)).annotate({ identifier: "DeriveSharedSecretResponse" }) as any as S.Schema<DeriveSharedSecretResponse>;
export interface DescribeCustomKeyStoresRequest { CustomKeyStoreId?: string; CustomKeyStoreName?: string; Limit?: number; Marker?: string }
export const DescribeCustomKeyStoresRequest = S.suspend(() => S.Struct({CustomKeyStoreId: S.optional(S.String), CustomKeyStoreName: S.optional(S.String), Limit: S.optional(S.Number), Marker: S.optional(S.String)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "DescribeCustomKeyStoresRequest" }) as any as S.Schema<DescribeCustomKeyStoresRequest>;
...
export interface XksProxyConfigurationType { Connectivity?: XksProxyConnectivityType; AccessKeyId?: string | redacted.Redacted<string>; UriEndpoint?: string; UriPath?: string; VpcEndpointServiceName?: string; VpcEndpointServiceOwner?: string }
export const XksProxyConfigurationType = S.suspend(() => S.Struct({Connectivity: S.optional(XksProxyConnectivityType), AccessKeyId: S.optional(SensitiveString), UriEndpoint: S.optional(S.String), UriPath: S.optional(S.String), VpcEndpointServiceName: S.optional(S.String), VpcEndpointServiceOwner: S.optional(S.String)})).annotate({ identifier: "XksProxyConfigurationType" }) as any as S.Schema<XksProxyConfigurationType>;
export interface CustomKeyStoresListEntry { CustomKeyStoreId?: string; CustomKeyStoreName?: string; CloudHsmClusterId?: string; TrustAnchorCertificate?: string; ConnectionState?: ConnectionStateType; ConnectionErrorCode?: ConnectionErrorCodeType; CreationDate?: Date; CustomKeyStoreType?: CustomKeyStoreType; XksProxyConfiguration?: XksProxyConfigurationType }
export const CustomKeyStoresListEntry = S.suspend(() => S.Struct({CustomKeyStoreId: S.optional(S.String), CustomKeyStoreName: S.optional(S.String), CloudHsmClusterId: S.optional(S.String), TrustAnchorCertificate: S.optional(S.String), ConnectionState: S.optional(ConnectionStateType), ConnectionErrorCode: S.optional(ConnectionErrorCodeType), CreationDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), CustomKeyStoreType: S.optional(CustomKeyStoreType), XksProxyConfiguration: S.optional(XksProxyConfigurationType)})).annotate({ identifier: "CustomKeyStoresListEntry" }) as any as S.Schema<CustomKeyStoresListEntry>;
...
export interface DescribeCustomKeyStoresResponse { CustomKeyStores?: CustomKeyStoresListEntry[]; NextMarker?: string; Truncated?: boolean }
export const DescribeCustomKeyStoresResponse = S.suspend(() => S.Struct({CustomKeyStores: S.optional(CustomKeyStoresList), NextMarker: S.optional(S.String), Truncated: S.optional(S.Boolean)}).pipe(ns)).annotate({ identifier: "DescribeCustomKeyStoresResponse" }) as any as S.Schema<DescribeCustomKeyStoresResponse>;
export interface DescribeKeyRequest { KeyId: string; GrantTokens?: string[] }
export const DescribeKeyRequest = S.suspend(() => S.Struct({KeyId: S.String, GrantTokens: S.optional(GrantTokenList)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "DescribeKeyRequest" }) as any as S.Schema<DescribeKeyRequest>;
export interface DescribeKeyResponse { KeyMetadata?: KeyMetadata }
export const DescribeKeyResponse = S.suspend(() => S.Struct({KeyMetadata: S.optional(KeyMetadata)}).pipe(ns)).annotate({ identifier: "DescribeKeyResponse" }) as any as S.Schema<DescribeKeyResponse>;
export interface DisableKeyRequest { KeyId: string }
export const DisableKeyRequest = S.suspend(() => S.Struct({KeyId: S.String}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "DisableKeyRequest" }) as any as S.Schema<DisableKeyRequest>;
export interface DisableKeyResponse {}
export const DisableKeyResponse = S.suspend(() => S.Struct({}).pipe(ns)).annotate({ identifier: "DisableKeyResponse" }) as any as S.Schema<DisableKeyResponse>;
export interface DisableKeyRotationRequest { KeyId: string }
export const DisableKeyRotationRequest = S.suspend(() => S.Struct({KeyId: S.String}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "DisableKeyRotationRequest" }) as any as S.Schema<DisableKeyRotationRequest>;
export interface DisableKeyRotationResponse {}
export const DisableKeyRotationResponse = S.suspend(() => S.Struct({}).pipe(ns)).annotate({ identifier: "DisableKeyRotationResponse" }) as any as S.Schema<DisableKeyRotationResponse>;
export interface DisconnectCustomKeyStoreRequest { CustomKeyStoreId: string }
export const DisconnectCustomKeyStoreRequest = S.suspend(() => S.Struct({CustomKeyStoreId: S.String}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "DisconnectCustomKeyStoreRequest" }) as any as S.Schema<DisconnectCustomKeyStoreRequest>;
export interface DisconnectCustomKeyStoreResponse {  }
export const DisconnectCustomKeyStoreResponse = S.suspend(() => S.Struct({}).pipe(ns)).annotate({ identifier: "DisconnectCustomKeyStoreResponse" }) as any as S.Schema<DisconnectCustomKeyStoreResponse>;
export interface EnableKeyRequest { KeyId: string }
export const EnableKeyRequest = S.suspend(() => S.Struct({KeyId: S.String}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "EnableKeyRequest" }) as any as S.Schema<EnableKeyRequest>;
export interface EnableKeyResponse {}
export const EnableKeyResponse = S.suspend(() => S.Struct({}).pipe(ns)).annotate({ identifier: "EnableKeyResponse" }) as any as S.Schema<EnableKeyResponse>;
export interface EnableKeyRotationRequest { KeyId: string; RotationPeriodInDays?: number }
export const EnableKeyRotationRequest = S.suspend(() => S.Struct({KeyId: S.String, RotationPeriodInDays: S.optional(S.Number)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "EnableKeyRotationRequest" }) as any as S.Schema<EnableKeyRotationRequest>;
export interface EnableKeyRotationResponse {}
export const EnableKeyRotationResponse = S.suspend(() => S.Struct({}).pipe(ns)).annotate({ identifier: "EnableKeyRotationResponse" }) as any as S.Schema<EnableKeyRotationResponse>;
export interface EncryptRequest { KeyId: string; Plaintext: Uint8Array | redacted.Redacted<Uint8Array>; EncryptionContext?: { [key: string]: string | undefined }; GrantTokens?: string[]; EncryptionAlgorithm?: EncryptionAlgorithmSpec; DryRun?: boolean }
export const EncryptRequest = S.suspend(() => S.Struct({KeyId: S.String, Plaintext: SensitiveBlob, EncryptionContext: S.optional(EncryptionContextType), GrantTokens: S.optional(GrantTokenList), EncryptionAlgorithm: S.optional(EncryptionAlgorithmSpec), DryRun: S.optional(S.Boolean)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "EncryptRequest" }) as any as S.Schema<EncryptRequest>;
export interface EncryptResponse { CiphertextBlob?: Uint8Array; KeyId?: string; EncryptionAlgorithm?: EncryptionAlgorithmSpec }
export const EncryptResponse = S.suspend(() => S.Struct({CiphertextBlob: S.optional(T.Blob), KeyId: S.optional(S.String), EncryptionAlgorithm: S.optional(EncryptionAlgorithmSpec)}).pipe(ns)).annotate({ identifier: "EncryptResponse" }) as any as S.Schema<EncryptResponse>;
export type DataKeySpec =
  | "AES_256"
  | "AES_128"
  | (string & {});
export const DataKeySpec = S.String;
export interface GenerateDataKeyRequest { KeyId: string; EncryptionContext?: { [key: string]: string | undefined }; NumberOfBytes?: number; KeySpec?: DataKeySpec; GrantTokens?: string[]; Recipient?: RecipientInfo; DryRun?: boolean }
export const GenerateDataKeyRequest = S.suspend(() => S.Struct({KeyId: S.String, EncryptionContext: S.optional(EncryptionContextType), NumberOfBytes: S.optional(S.Number), KeySpec: S.optional(DataKeySpec), GrantTokens: S.optional(GrantTokenList), Recipient: S.optional(RecipientInfo), DryRun: S.optional(S.Boolean)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GenerateDataKeyRequest" }) as any as S.Schema<GenerateDataKeyRequest>;
export interface GenerateDataKeyResponse { CiphertextBlob?: Uint8Array; Plaintext?: Uint8Array | redacted.Redacted<Uint8Array>; KeyId?: string; CiphertextForRecipient?: Uint8Array; KeyMaterialId?: string }
export const GenerateDataKeyResponse = S.suspend(() => S.Struct({CiphertextBlob: S.optional(T.Blob), Plaintext: S.optional(SensitiveBlob), KeyId: S.optional(S.String), CiphertextForRecipient: S.optional(T.Blob), KeyMaterialId: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "GenerateDataKeyResponse" }) as any as S.Schema<GenerateDataKeyResponse>;
...
export interface GenerateDataKeyPairRequest { EncryptionContext?: { [key: string]: string | undefined }; KeyId: string; KeyPairSpec: DataKeyPairSpec; GrantTokens?: string[]; Recipient?: RecipientInfo; DryRun?: boolean }
export const GenerateDataKeyPairRequest = S.suspend(() => S.Struct({EncryptionContext: S.optional(EncryptionContextType), KeyId: S.String, KeyPairSpec: DataKeyPairSpec, GrantTokens: S.optional(GrantTokenList), Recipient: S.optional(RecipientInfo), DryRun: S.optional(S.Boolean)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GenerateDataKeyPairRequest" }) as any as S.Schema<GenerateDataKeyPairRequest>;
export interface GenerateDataKeyPairResponse { PrivateKeyCiphertextBlob?: Uint8Array; PrivateKeyPlaintext?: Uint8Array | redacted.Redacted<Uint8Array>; PublicKey?: Uint8Array; KeyId?: string; KeyPairSpec?: DataKeyPairSpec; CiphertextForRecipient?: Uint8Array; KeyMaterialId?: string }
export const GenerateDataKeyPairResponse = S.suspend(() => S.Struct({PrivateKeyCiphertextBlob: S.optional(T.Blob), PrivateKeyPlaintext: S.optional(SensitiveBlob), PublicKey: S.optional(T.Blob), KeyId: S.optional(S.String), KeyPairSpec: S.optional(DataKeyPairSpec), CiphertextForRecipient: S.optional(T.Blob), KeyMaterialId: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "GenerateDataKeyPairResponse" }) as any as S.Schema<GenerateDataKeyPairResponse>;
export interface GenerateDataKeyPairWithoutPlaintextRequest { EncryptionContext?: { [key: string]: string | undefined }; KeyId: string; KeyPairSpec: DataKeyPairSpec; GrantTokens?: string[]; DryRun?: boolean }
export const GenerateDataKeyPairWithoutPlaintextRequest = S.suspend(() => S.Struct({EncryptionContext: S.optional(EncryptionContextType), KeyId: S.String, KeyPairSpec: DataKeyPairSpec, GrantTokens: S.optional(GrantTokenList), DryRun: S.optional(S.Boolean)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GenerateDataKeyPairWithoutPlaintextRequest" }) as any as S.Schema<GenerateDataKeyPairWithoutPlaintextRequest>;
export interface GenerateDataKeyPairWithoutPlaintextResponse { PrivateKeyCiphertextBlob?: Uint8Array; PublicKey?: Uint8Array; KeyId?: string; KeyPairSpec?: DataKeyPairSpec; KeyMaterialId?: string }
export const GenerateDataKeyPairWithoutPlaintextResponse = S.suspend(() => S.Struct({PrivateKeyCiphertextBlob: S.optional(T.Blob), PublicKey: S.optional(T.Blob), KeyId: S.optional(S.String), KeyPairSpec: S.optional(DataKeyPairSpec), KeyMaterialId: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "GenerateDataKeyPairWithoutPlaintextResponse" }) as any as S.Schema<GenerateDataKeyPairWithoutPlaintextResponse>;
export interface GenerateDataKeyWithoutPlaintextRequest { KeyId: string; EncryptionContext?: { [key: string]: string | undefined }; KeySpec?: DataKeySpec; NumberOfBytes?: number; GrantTokens?: string[]; DryRun?: boolean }
export const GenerateDataKeyWithoutPlaintextRequest = S.suspend(() => S.Struct({KeyId: S.String, EncryptionContext: S.optional(EncryptionContextType), KeySpec: S.optional(DataKeySpec), NumberOfBytes: S.optional(S.Number), GrantTokens: S.optional(GrantTokenList), DryRun: S.optional(S.Boolean)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GenerateDataKeyWithoutPlaintextRequest" }) as any as S.Schema<GenerateDataKeyWithoutPlaintextRequest>;
export interface GenerateDataKeyWithoutPlaintextResponse { CiphertextBlob?: Uint8Array; KeyId?: string; KeyMaterialId?: string }
export const GenerateDataKeyWithoutPlaintextResponse = S.suspend(() => S.Struct({CiphertextBlob: S.optional(T.Blob), KeyId: S.optional(S.String), KeyMaterialId: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "GenerateDataKeyWithoutPlaintextResponse" }) as any as S.Schema<GenerateDataKeyWithoutPlaintextResponse>;
export interface GenerateMacRequest { Message: Uint8Array | redacted.Redacted<Uint8Array>; KeyId: string; MacAlgorithm: MacAlgorithmSpec; GrantTokens?: string[]; DryRun?: boolean }
export const GenerateMacRequest = S.suspend(() => S.Struct({Message: SensitiveBlob, KeyId: S.String, MacAlgorithm: MacAlgorithmSpec, GrantTokens: S.optional(GrantTokenList), DryRun: S.optional(S.Boolean)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GenerateMacRequest" }) as any as S.Schema<GenerateMacRequest>;
export interface GenerateMacResponse { Mac?: Uint8Array; MacAlgorithm?: MacAlgorithmSpec; KeyId?: string }
export const GenerateMacResponse = S.suspend(() => S.Struct({Mac: S.optional(T.Blob), MacAlgorithm: S.optional(MacAlgorithmSpec), KeyId: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "GenerateMacResponse" }) as any as S.Schema<GenerateMacResponse>;
export interface GenerateRandomRequest { NumberOfBytes?: number; CustomKeyStoreId?: string; Recipient?: RecipientInfo }
export const GenerateRandomRequest = S.suspend(() => S.Struct({NumberOfBytes: S.optional(S.Number), CustomKeyStoreId: S.optional(S.String), Recipient: S.optional(RecipientInfo)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GenerateRandomRequest" }) as any as S.Schema<GenerateRandomRequest>;
export interface GenerateRandomResponse { Plaintext?: Uint8Array | redacted.Redacted<Uint8Array>; CiphertextForRecipient?: Uint8Array }
export const GenerateRandomResponse = S.suspend(() => S.Struct({Plaintext: S.optional(SensitiveBlob), CiphertextForRecipient: S.optional(T.Blob)}).pipe(ns)).annotate({ identifier: "GenerateRandomResponse" }) as any as S.Schema<GenerateRandomResponse>;
export interface GetKeyPolicyRequest { KeyId: string; PolicyName?: string }
export const GetKeyPolicyRequest = S.suspend(() => S.Struct({KeyId: S.String, PolicyName: S.optional(S.String)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetKeyPolicyRequest" }) as any as S.Schema<GetKeyPolicyRequest>;
export interface GetKeyPolicyResponse { Policy?: string; PolicyName?: string }
export const GetKeyPolicyResponse = S.suspend(() => S.Struct({Policy: S.optional(S.String), PolicyName: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "GetKeyPolicyResponse" }) as any as S.Schema<GetKeyPolicyResponse>;
export interface GetKeyRotationStatusRequest { KeyId: string }
export const GetKeyRotationStatusRequest = S.suspend(() => S.Struct({KeyId: S.String}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetKeyRotationStatusRequest" }) as any as S.Schema<GetKeyRotationStatusRequest>;
export interface GetKeyRotationStatusResponse { KeyRotationEnabled?: boolean; KeyId?: string; RotationPeriodInDays?: number; NextRotationDate?: Date; OnDemandRotationStartDate?: Date }
export const GetKeyRotationStatusResponse = S.suspend(() => S.Struct({KeyRotationEnabled: S.optional(S.Boolean), KeyId: S.optional(S.String), RotationPeriodInDays: S.optional(S.Number), NextRotationDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), OnDemandRotationStartDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}).pipe(ns)).annotate({ identifier: "GetKeyRotationStatusResponse" }) as any as S.Schema<GetKeyRotationStatusResponse>;
...
export interface GetParametersForImportRequest { KeyId: string; WrappingAlgorithm: AlgorithmSpec; WrappingKeySpec: WrappingKeySpec }
export const GetParametersForImportRequest = S.suspend(() => S.Struct({KeyId: S.String, WrappingAlgorithm: AlgorithmSpec, WrappingKeySpec: WrappingKeySpec}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetParametersForImportRequest" }) as any as S.Schema<GetParametersForImportRequest>;
export interface GetParametersForImportResponse { KeyId?: string; ImportToken?: Uint8Array; PublicKey?: Uint8Array | redacted.Redacted<Uint8Array>; ParametersValidTo?: Date }
export const GetParametersForImportResponse = S.suspend(() => S.Struct({KeyId: S.optional(S.String), ImportToken: S.optional(T.Blob), PublicKey: S.optional(SensitiveBlob), ParametersValidTo: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}).pipe(ns)).annotate({ identifier: "GetParametersForImportResponse" }) as any as S.Schema<GetParametersForImportResponse>;
export interface GetPublicKeyRequest { KeyId: string; GrantTokens?: string[] }
export const GetPublicKeyRequest = S.suspend(() => S.Struct({KeyId: S.String, GrantTokens: S.optional(GrantTokenList)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetPublicKeyRequest" }) as any as S.Schema<GetPublicKeyRequest>;
export interface GetPublicKeyResponse { KeyId?: string; PublicKey?: Uint8Array; CustomerMasterKeySpec?: CustomerMasterKeySpec; KeySpec?: KeySpec; KeyUsage?: KeyUsageType; EncryptionAlgorithms?: EncryptionAlgorithmSpec[]; SigningAlgorithms?: SigningAlgorithmSpec[]; KeyAgreementAlgorithms?: KeyAgreementAlgorithmSpec[] }
export const GetPublicKeyResponse = S.suspend(() => S.Struct({KeyId: S.optional(S.String), PublicKey: S.optional(T.Blob), CustomerMasterKeySpec: S.optional(CustomerMasterKeySpec), KeySpec: S.optional(KeySpec), KeyUsage: S.optional(KeyUsageType), EncryptionAlgorithms: S.optional(EncryptionAlgorithmSpecList), SigningAlgorithms: S.optional(SigningAlgorithmSpecList), KeyAgreementAlgorithms: S.optional(KeyAgreementAlgorithmSpecList)}).pipe(ns)).annotate({ identifier: "GetPublicKeyResponse" }) as any as S.Schema<GetPublicKeyResponse>;
export type ImportType =
  | "NEW_KEY_MATERIAL"
  | "EXISTING_KEY_MATERIAL"
  | (string & {});
export const ImportType = S.String;
export interface ImportKeyMaterialRequest { KeyId: string; ImportToken: Uint8Array; EncryptedKeyMaterial: Uint8Array; ValidTo?: Date; ExpirationModel?: ExpirationModelType; ImportType?: ImportType; KeyMaterialDescription?: string; KeyMaterialId?: string }
export const ImportKeyMaterialRequest = S.suspend(() => S.Struct({KeyId: S.String, ImportToken: T.Blob, EncryptedKeyMaterial: T.Blob, ValidTo: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ExpirationModel: S.optional(ExpirationModelType), ImportType: S.optional(ImportType), KeyMaterialDescription: S.optional(S.String), KeyMaterialId: S.optional(S.String)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "ImportKeyMaterialRequest" }) as any as S.Schema<ImportKeyMaterialRequest>;
export interface ImportKeyMaterialResponse { KeyId?: string; KeyMaterialId?: string }
export const ImportKeyMaterialResponse = S.suspend(() => S.Struct({KeyId: S.optional(S.String), KeyMaterialId: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "ImportKeyMaterialResponse" }) as any as S.Schema<ImportKeyMaterialResponse>;
export interface ListAliasesRequest { KeyId?: string; Limit?: number; Marker?: string }
export const ListAliasesRequest = S.suspend(() => S.Struct({KeyId: S.optional(S.String), Limit: S.optional(S.Number), Marker: S.optional(S.String)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "ListAliasesRequest" }) as any as S.Schema<ListAliasesRequest>;
export interface AliasListEntry { AliasName?: string; AliasArn?: string; TargetKeyId?: string; CreationDate?: Date; LastUpdatedDate?: Date }
export const AliasListEntry = S.suspend(() => S.Struct({AliasName: S.optional(S.String), AliasArn: S.optional(S.String), TargetKeyId: S.optional(S.String), CreationDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastUpdatedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))})).annotate({ identifier: "AliasListEntry" }) as any as S.Schema<AliasListEntry>;
export type AliasList = AliasListEntry[];
export const AliasList = S.Array(AliasListEntry);
export interface ListAliasesResponse { Aliases?: AliasListEntry[]; NextMarker?: string; Truncated?: boolean }
export const ListAliasesResponse = S.suspend(() => S.Struct({Aliases: S.optional(AliasList), NextMarker: S.optional(S.String), Truncated: S.optional(S.Boolean)}).pipe(ns)).annotate({ identifier: "ListAliasesResponse" }) as any as S.Schema<ListAliasesResponse>;
export interface ListGrantsRequest { Limit?: number; Marker?: string; KeyId: string; GrantId?: string; GranteePrincipal?: string }
export const ListGrantsRequest = S.suspend(() => S.Struct({Limit: S.optional(S.Number), Marker: S.optional(S.String), KeyId: S.String, GrantId: S.optional(S.String), GranteePrincipal: S.optional(S.String)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "ListGrantsRequest" }) as any as S.Schema<ListGrantsRequest>;
export interface GrantListEntry { KeyId?: string; GrantId?: string; Name?: string; CreationDate?: Date; GranteePrincipal?: string; RetiringPrincipal?: string; IssuingAccount?: string; Operations?: GrantOperation[]; Constraints?: GrantConstraints }
export const GrantListEntry = S.suspend(() => S.Struct({KeyId: S.optional(S.String), GrantId: S.optional(S.String), Name: S.optional(S.String), CreationDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), GranteePrincipal: S.optional(S.String), RetiringPrincipal: S.optional(S.String), IssuingAccount: S.optional(S.String), Operations: S.optional(GrantOperationList), Constraints: S.optional(GrantConstraints)})).annotate({ identifier: "GrantListEntry" }) as any as S.Schema<GrantListEntry>;
export type GrantList = GrantListEntry[];
export const GrantList = S.Array(GrantListEntry);
export interface ListGrantsResponse { Grants?: GrantListEntry[]; NextMarker?: string; Truncated?: boolean }
export const ListGrantsResponse = S.suspend(() => S.Struct({Grants: S.optional(GrantList), NextMarker: S.optional(S.String), Truncated: S.optional(S.Boolean)}).pipe(ns)).annotate({ identifier: "ListGrantsResponse" }) as any as S.Schema<ListGrantsResponse>;
export interface ListKeyPoliciesRequest { KeyId: string; Limit?: number; Marker?: string }
export const ListKeyPoliciesRequest = S.suspend(() => S.Struct({KeyId: S.String, Limit: S.optional(S.Number), Marker: S.optional(S.String)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "ListKeyPoliciesRequest" }) as any as S.Schema<ListKeyPoliciesRequest>;
export type PolicyNameList = string[];
export const PolicyNameList = S.Array(S.String);
export interface ListKeyPoliciesResponse { PolicyNames?: string[]; NextMarker?: string; Truncated?: boolean }
export const ListKeyPoliciesResponse = S.suspend(() => S.Struct({PolicyNames: S.optional(PolicyNameList), NextMarker: S.optional(S.String), Truncated: S.optional(S.Boolean)}).pipe(ns)).annotate({ identifier: "ListKeyPoliciesResponse" }) as any as S.Schema<ListKeyPoliciesResponse>;
export type IncludeKeyMaterial =
  | "ALL_KEY_MATERIAL"
  | "ROTATIONS_ONLY"
  | (string & {});
export const IncludeKeyMaterial = S.String;
export interface ListKeyRotationsRequest { KeyId: string; IncludeKeyMaterial?: IncludeKeyMaterial; Limit?: number; Marker?: string }
export const ListKeyRotationsRequest = S.suspend(() => S.Struct({KeyId: S.String, IncludeKeyMaterial: S.optional(IncludeKeyMaterial), Limit: S.optional(S.Number), Marker: S.optional(S.String)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "ListKeyRotationsRequest" }) as any as S.Schema<ListKeyRotationsRequest>;
...
export interface RotationsListEntry { KeyId?: string; KeyMaterialId?: string; KeyMaterialDescription?: string; ImportState?: ImportState; KeyMaterialState?: KeyMaterialState; ExpirationModel?: ExpirationModelType; ValidTo?: Date; RotationDate?: Date; RotationType?: RotationType }
export const RotationsListEntry = S.suspend(() => S.Struct({KeyId: S.optional(S.String), KeyMaterialId: S.optional(S.String), KeyMaterialDescription: S.optional(S.String), ImportState: S.optional(ImportState), KeyMaterialState: S.optional(KeyMaterialState), ExpirationModel: S.optional(ExpirationModelType), ValidTo: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), RotationDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), RotationType: S.optional(RotationType)})).annotate({ identifier: "RotationsListEntry" }) as any as S.Schema<RotationsListEntry>;
export type RotationsList = RotationsListEntry[];
export const RotationsList = S.Array(RotationsListEntry);
export interface ListKeyRotationsResponse { Rotations?: RotationsListEntry[]; NextMarker?: string; Truncated?: boolean }
export const ListKeyRotationsResponse = S.suspend(() => S.Struct({Rotations: S.optional(RotationsList), NextMarker: S.optional(S.String), Truncated: S.optional(S.Boolean)}).pipe(ns)).annotate({ identifier: "ListKeyRotationsResponse" }) as any as S.Schema<ListKeyRotationsResponse>;
export interface ListKeysRequest { Limit?: number; Marker?: string }
export const ListKeysRequest = S.suspend(() => S.Struct({Limit: S.optional(S.Number), Marker: S.optional(S.String)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "ListKeysRequest" }) as any as S.Schema<ListKeysRequest>;
export interface KeyListEntry { KeyId?: string; KeyArn?: string }
export const KeyListEntry = S.suspend(() => S.Struct({KeyId: S.optional(S.String), KeyArn: S.optional(S.String)})).annotate({ identifier: "KeyListEntry" }) as any as S.Schema<KeyListEntry>;
export type KeyList = KeyListEntry[];
export const KeyList = S.Array(KeyListEntry);
export interface ListKeysResponse { Keys?: KeyListEntry[]; NextMarker?: string; Truncated?: boolean }
export const ListKeysResponse = S.suspend(() => S.Struct({Keys: S.optional(KeyList), NextMarker: S.optional(S.String), Truncated: S.optional(S.Boolean)}).pipe(ns)).annotate({ identifier: "ListKeysResponse" }) as any as S.Schema<ListKeysResponse>;
export interface ListResourceTagsRequest { KeyId: string; Limit?: number; Marker?: string }
export const ListResourceTagsRequest = S.suspend(() => S.Struct({KeyId: S.String, Limit: S.optional(S.Number), Marker: S.optional(S.String)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "ListResourceTagsRequest" }) as any as S.Schema<ListResourceTagsRequest>;
export interface ListResourceTagsResponse { Tags?: Tag[]; NextMarker?: string; Truncated?: boolean }
export const ListResourceTagsResponse = S.suspend(() => S.Struct({Tags: S.optional(TagList), NextMarker: S.optional(S.String), Truncated: S.optional(S.Boolean)}).pipe(ns)).annotate({ identifier: "ListResourceTagsResponse" }) as any as S.Schema<ListResourceTagsResponse>;
export interface ListRetirableGrantsRequest { Limit?: number; Marker?: string; RetiringPrincipal: string }
export const ListRetirableGrantsRequest = S.suspend(() => S.Struct({Limit: S.optional(S.Number), Marker: S.optional(S.String), RetiringPrincipal: S.String}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "ListRetirableGrantsRequest" }) as any as S.Schema<ListRetirableGrantsRequest>;
export interface PutKeyPolicyRequest { KeyId: string; PolicyName?: string; Policy: string; BypassPolicyLockoutSafetyCheck?: boolean }
export const PutKeyPolicyRequest = S.suspend(() => S.Struct({KeyId: S.String, PolicyName: S.optional(S.String), Policy: S.String, BypassPolicyLockoutSafetyCheck: S.optional(S.Boolean)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "PutKeyPolicyRequest" }) as any as S.Schema<PutKeyPolicyRequest>;
export interface PutKeyPolicyResponse {}
export const PutKeyPolicyResponse = S.suspend(() => S.Struct({}).pipe(ns)).annotate({ identifier: "PutKeyPolicyResponse" }) as any as S.Schema<PutKeyPolicyResponse>;
export interface ReEncryptRequest { CiphertextBlob?: Uint8Array; SourceEncryptionContext?: { [key: string]: string | undefined }; SourceKeyId?: string; DestinationKeyId: string; DestinationEncryptionContext?: { [key: string]: string | undefined }; SourceEncryptionAlgorithm?: EncryptionAlgorithmSpec; DestinationEncryptionAlgorithm?: EncryptionAlgorithmSpec; GrantTokens?: string[]; DryRun?: boolean; DryRunModifiers?: DryRunModifierType[] }
export const ReEncryptRequest = S.suspend(() => S.Struct({CiphertextBlob: S.optional(T.Blob), SourceEncryptionContext: S.optional(EncryptionContextType), SourceKeyId: S.optional(S.String), DestinationKeyId: S.String, DestinationEncryptionContext: S.optional(EncryptionContextType), SourceEncryptionAlgorithm: S.optional(EncryptionAlgorithmSpec), DestinationEncryptionAlgorithm: S.optional(EncryptionAlgorithmSpec), GrantTokens: S.optional(GrantTokenList), DryRun: S.optional(S.Boolean), DryRunModifiers: S.optional(DryRunModifierList)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "ReEncryptRequest" }) as any as S.Schema<ReEncryptRequest>;
export interface ReEncryptResponse { CiphertextBlob?: Uint8Array; SourceKeyId?: string; KeyId?: string; SourceEncryptionAlgorithm?: EncryptionAlgorithmSpec; DestinationEncryptionAlgorithm?: EncryptionAlgorithmSpec; SourceKeyMaterialId?: string; DestinationKeyMaterialId?: string }
export const ReEncryptResponse = S.suspend(() => S.Struct({CiphertextBlob: S.optional(T.Blob), SourceKeyId: S.optional(S.String), KeyId: S.optional(S.String), SourceEncryptionAlgorithm: S.optional(EncryptionAlgorithmSpec), DestinationEncryptionAlgorithm: S.optional(EncryptionAlgorithmSpec), SourceKeyMaterialId: S.optional(S.String), DestinationKeyMaterialId: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "ReEncryptResponse" }) as any as S.Schema<ReEncryptResponse>;
export interface ReplicateKeyRequest { KeyId: string; ReplicaRegion: string; Policy?: string; BypassPolicyLockoutSafetyCheck?: boolean; Description?: string; Tags?: Tag[] }
export const ReplicateKeyRequest = S.suspend(() => S.Struct({KeyId: S.String, ReplicaRegion: S.String, Policy: S.optional(S.String), BypassPolicyLockoutSafetyCheck: S.optional(S.Boolean), Description: S.optional(S.String), Tags: S.optional(TagList)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "ReplicateKeyRequest" }) as any as S.Schema<ReplicateKeyRequest>;
export interface ReplicateKeyResponse { ReplicaKeyMetadata?: KeyMetadata; ReplicaPolicy?: string; ReplicaTags?: Tag[] }
export const ReplicateKeyResponse = S.suspend(() => S.Struct({ReplicaKeyMetadata: S.optional(KeyMetadata), ReplicaPolicy: S.optional(S.String), ReplicaTags: S.optional(TagList)}).pipe(ns)).annotate({ identifier: "ReplicateKeyResponse" }) as any as S.Schema<ReplicateKeyResponse>;
export interface RetireGrantRequest { GrantToken?: string; KeyId?: string; GrantId?: string; DryRun?: boolean }
export const RetireGrantRequest = S.suspend(() => S.Struct({GrantToken: S.optional(S.String), KeyId: S.optional(S.String), GrantId: S.optional(S.String), DryRun: S.optional(S.Boolean)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "RetireGrantRequest" }) as any as S.Schema<RetireGrantRequest>;
export interface RetireGrantResponse {}
export const RetireGrantResponse = S.suspend(() => S.Struct({}).pipe(ns)).annotate({ identifier: "RetireGrantResponse" }) as any as S.Schema<RetireGrantResponse>;
export interface RevokeGrantRequest { KeyId: string; GrantId: string; DryRun?: boolean }
export const RevokeGrantRequest = S.suspend(() => S.Struct({KeyId: S.String, GrantId: S.String, DryRun: S.optional(S.Boolean)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "RevokeGrantRequest" }) as any as S.Schema<RevokeGrantRequest>;
export interface RevokeGrantResponse {}
export const RevokeGrantResponse = S.suspend(() => S.Struct({}).pipe(ns)).annotate({ identifier: "RevokeGrantResponse" }) as any as S.Schema<RevokeGrantResponse>;
export interface RotateKeyOnDemandRequest { KeyId: string }
export const RotateKeyOnDemandRequest = S.suspend(() => S.Struct({KeyId: S.String}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "RotateKeyOnDemandRequest" }) as any as S.Schema<RotateKeyOnDemandRequest>;
export interface RotateKeyOnDemandResponse { KeyId?: string }
export const RotateKeyOnDemandResponse = S.suspend(() => S.Struct({KeyId: S.optional(S.String)}).pipe(ns)).annotate({ identifier: "RotateKeyOnDemandResponse" }) as any as S.Schema<RotateKeyOnDemandResponse>;
export interface ScheduleKeyDeletionRequest { KeyId: string; PendingWindowInDays?: number }
export const ScheduleKeyDeletionRequest = S.suspend(() => S.Struct({KeyId: S.String, PendingWindowInDays: S.optional(S.Number)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "ScheduleKeyDeletionRequest" }) as any as S.Schema<ScheduleKeyDeletionRequest>;
export interface ScheduleKeyDeletionResponse { KeyId?: string; DeletionDate?: Date; KeyState?: KeyState; PendingWindowInDays?: number }
export const ScheduleKeyDeletionResponse = S.suspend(() => S.Struct({KeyId: S.optional(S.String), DeletionDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), KeyState: S.optional(KeyState), PendingWindowInDays: S.optional(S.Number)}).pipe(ns)).annotate({ identifier: "ScheduleKeyDeletionResponse" }) as any as S.Schema<ScheduleKeyDeletionResponse>;
...
export interface SignRequest { KeyId: string; Message: Uint8Array | redacted.Redacted<Uint8Array>; MessageType?: MessageType; GrantTokens?: string[]; SigningAlgorithm: SigningAlgorithmSpec; DryRun?: boolean }
export const SignRequest = S.suspend(() => S.Struct({KeyId: S.String, Message: SensitiveBlob, MessageType: S.optional(MessageType), GrantTokens: S.optional(GrantTokenList), SigningAlgorithm: SigningAlgorithmSpec, DryRun: S.optional(S.Boolean)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "SignRequest" }) as any as S.Schema<SignRequest>;
export interface SignResponse { KeyId?: string; Signature?: Uint8Array; SigningAlgorithm?: SigningAlgorithmSpec }
export const SignResponse = S.suspend(() => S.Struct({KeyId: S.optional(S.String), Signature: S.optional(T.Blob), SigningAlgorithm: S.optional(SigningAlgorithmSpec)}).pipe(ns)).annotate({ identifier: "SignResponse" }) as any as S.Schema<SignResponse>;
export interface TagResourceRequest { KeyId: string; Tags: Tag[] }
export const TagResourceRequest = S.suspend(() => S.Struct({KeyId: S.String, Tags: TagList}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "TagResourceRequest" }) as any as S.Schema<TagResourceRequest>;
...
export interface UntagResourceRequest { KeyId: string; TagKeys: string[] }
export const UntagResourceRequest = S.suspend(() => S.Struct({KeyId: S.String, TagKeys: TagKeyList}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "UntagResourceRequest" }) as any as S.Schema<UntagResourceRequest>;
...
export interface UpdateAliasRequest { AliasName: string; TargetKeyId: string }
export const UpdateAliasRequest = S.suspend(() => S.Struct({AliasName: S.String, TargetKeyId: S.String}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "UpdateAliasRequest" }) as any as S.Schema<UpdateAliasRequest>;
export interface UpdateAliasResponse {}
export const UpdateAliasResponse = S.suspend(() => S.Struct({}).pipe(ns)).annotate({ identifier: "UpdateAliasResponse" }) as any as S.Schema<UpdateAliasResponse>;
export interface UpdateCustomKeyStoreRequest { CustomKeyStoreId: string; NewCustomKeyStoreName?: string; KeyStorePassword?: string | redacted.Redacted<string>; CloudHsmClusterId?: string; XksProxyUriEndpoint?: string; XksProxyUriPath?: string; XksProxyVpcEndpointServiceName?: string; XksProxyVpcEndpointServiceOwner?: string; XksProxyAuthenticationCredential?: XksProxyAuthenticationCredentialType; XksProxyConnectivity?: XksProxyConnectivityType }
export const UpdateCustomKeyStoreRequest = S.suspend(() => S.Struct({CustomKeyStoreId: S.String, NewCustomKeyStoreName: S.optional(S.String), KeyStorePassword: S.optional(SensitiveString), CloudHsmClusterId: S.optional(S.String), XksProxyUriEndpoint: S.optional(S.String), XksProxyUriPath: S.optional(S.String), XksProxyVpcEndpointServiceName: S.optional(S.String), XksProxyVpcEndpointServiceOwner: S.optional(S.String), XksProxyAuthenticationCredential: S.optional(XksProxyAuthenticationCredentialType), XksProxyConnectivity: S.optional(XksProxyConnectivityType)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "UpdateCustomKeyStoreRequest" }) as any as S.Schema<UpdateCustomKeyStoreRequest>;
export interface UpdateCustomKeyStoreResponse {  }
export const UpdateCustomKeyStoreResponse = S.suspend(() => S.Struct({}).pipe(ns)).annotate({ identifier: "UpdateCustomKeyStoreResponse" }) as any as S.Schema<UpdateCustomKeyStoreResponse>;
export interface UpdateKeyDescriptionRequest { KeyId: string; Description: string }
export const UpdateKeyDescriptionRequest = S.suspend(() => S.Struct({KeyId: S.String, Description: S.String}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "UpdateKeyDescriptionRequest" }) as any as S.Schema<UpdateKeyDescriptionRequest>;
export interface UpdateKeyDescriptionResponse {}
export const UpdateKeyDescriptionResponse = S.suspend(() => S.Struct({}).pipe(ns)).annotate({ identifier: "UpdateKeyDescriptionResponse" }) as any as S.Schema<UpdateKeyDescriptionResponse>;
export interface UpdatePrimaryRegionRequest { KeyId: string; PrimaryRegion: string }
export const UpdatePrimaryRegionRequest = S.suspend(() => S.Struct({KeyId: S.String, PrimaryRegion: S.String}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "UpdatePrimaryRegionRequest" }) as any as S.Schema<UpdatePrimaryRegionRequest>;
export interface UpdatePrimaryRegionResponse {}
export const UpdatePrimaryRegionResponse = S.suspend(() => S.Struct({}).pipe(ns)).annotate({ identifier: "UpdatePrimaryRegionResponse" }) as any as S.Schema<UpdatePrimaryRegionResponse>;
export interface VerifyRequest { KeyId: string; Message: Uint8Array | redacted.Redacted<Uint8Array>; MessageType?: MessageType; Signature: Uint8Array; SigningAlgorithm: SigningAlgorithmSpec; GrantTokens?: string[]; DryRun?: boolean }
export const VerifyRequest = S.suspend(() => S.Struct({KeyId: S.String, Message: SensitiveBlob, MessageType: S.optional(MessageType), Signature: T.Blob, SigningAlgorithm: SigningAlgorithmSpec, GrantTokens: S.optional(GrantTokenList), DryRun: S.optional(S.Boolean)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "VerifyRequest" }) as any as S.Schema<VerifyRequest>;
export interface VerifyResponse { KeyId?: string; SignatureValid?: boolean; SigningAlgorithm?: SigningAlgorithmSpec }
export const VerifyResponse = S.suspend(() => S.Struct({KeyId: S.optional(S.String), SignatureValid: S.optional(S.Boolean), SigningAlgorithm: S.optional(SigningAlgorithmSpec)}).pipe(ns)).annotate({ identifier: "VerifyResponse" }) as any as S.Schema<VerifyResponse>;
export interface VerifyMacRequest { Message: Uint8Array | redacted.Redacted<Uint8Array>; KeyId: string; MacAlgorithm: MacAlgorithmSpec; Mac: Uint8Array; GrantTokens?: string[]; DryRun?: boolean }
export const VerifyMacRequest = S.suspend(() => S.Struct({Message: SensitiveBlob, KeyId: S.String, MacAlgorithm: MacAlgorithmSpec, Mac: T.Blob, GrantTokens: S.optional(GrantTokenList), DryRun: S.optional(S.Boolean)}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "VerifyMacRequest" }) as any as S.Schema<VerifyMacRequest>;
export interface VerifyMacResponse { KeyId?: string; MacValid?: boolean; MacAlgorithm?: MacAlgorithmSpec }
export const VerifyMacResponse = S.suspend(() => S.Struct({KeyId: S.optional(S.String), MacValid: S.optional(S.Boolean), MacAlgorithm: S.optional(MacAlgorithmSpec)}).pipe(ns)).annotate({ identifier: "VerifyMacResponse" }) as any as S.Schema<VerifyMacResponse>;

//# Errors
export class DependencyTimeoutException extends S.TaggedErrorClass<DependencyTimeoutException>()("DependencyTimeoutException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "DependencyTimeout", httpResponseCode: 503 })).pipe(C.withServerError) {}
export class InvalidArnException extends S.TaggedErrorClass<InvalidArnException>()("InvalidArnException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidArn", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class KMSInternalException extends S.TaggedErrorClass<KMSInternalException>()("KMSInternalException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "KMSInternal", httpResponseCode: 500 })).pipe(C.withServerError) {}
export class KMSInvalidStateException extends S.TaggedErrorClass<KMSInvalidStateException>()("KMSInvalidStateException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "KMSInvalidStateException", httpResponseCode: 409 })).pipe(C.withConflictError) {}
export class NotFoundException extends S.TaggedErrorClass<NotFoundException>()("NotFoundException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "NotFound", httpResponseCode: 404 })).pipe(C.withBadRequestError) {}
export class CloudHsmClusterInvalidConfigurationException extends S.TaggedErrorClass<CloudHsmClusterInvalidConfigurationException>()("CloudHsmClusterInvalidConfigurationException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "CloudHsmClusterInvalidConfigurationException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class CloudHsmClusterNotActiveException extends S.TaggedErrorClass<CloudHsmClusterNotActiveException>()("CloudHsmClusterNotActiveException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "CloudHsmClusterNotActiveException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class CustomKeyStoreInvalidStateException extends S.TaggedErrorClass<CustomKeyStoreInvalidStateException>()("CustomKeyStoreInvalidStateException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "CustomKeyStoreInvalidStateException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class CustomKeyStoreNotFoundException extends S.TaggedErrorClass<CustomKeyStoreNotFoundException>()("CustomKeyStoreNotFoundException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "CustomKeyStoreNotFoundException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class AlreadyExistsException extends S.TaggedErrorClass<AlreadyExistsException>()("AlreadyExistsException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "AlreadyExists", httpResponseCode: 409 })).pipe(C.withConflictError, C.withAlreadyExistsError) {}
export class InvalidAliasNameException extends S.TaggedErrorClass<InvalidAliasNameException>()("InvalidAliasNameException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidAliasName", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
...
export class CloudHsmClusterInUseException extends S.TaggedErrorClass<CloudHsmClusterInUseException>()("CloudHsmClusterInUseException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "CloudHsmClusterInUseException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class CloudHsmClusterNotFoundException extends S.TaggedErrorClass<CloudHsmClusterNotFoundException>()("CloudHsmClusterNotFoundException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "CloudHsmClusterNotFoundException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class CustomKeyStoreNameInUseException extends S.TaggedErrorClass<CustomKeyStoreNameInUseException>()("CustomKeyStoreNameInUseException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "CustomKeyStoreNameInUseException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class IncorrectTrustAnchorException extends S.TaggedErrorClass<IncorrectTrustAnchorException>()("IncorrectTrustAnchorException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "IncorrectTrustAnchorException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class XksProxyIncorrectAuthenticationCredentialException extends S.TaggedErrorClass<XksProxyIncorrectAuthenticationCredentialException>()("XksProxyIncorrectAuthenticationCredentialException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksProxyIncorrectAuthenticationCredentialException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class XksProxyInvalidConfigurationException extends S.TaggedErrorClass<XksProxyInvalidConfigurationException>()("XksProxyInvalidConfigurationException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksProxyInvalidConfigurationException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class XksProxyInvalidResponseException extends S.TaggedErrorClass<XksProxyInvalidResponseException>()("XksProxyInvalidResponseException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksProxyInvalidResponseException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class XksProxyUriEndpointInUseException extends S.TaggedErrorClass<XksProxyUriEndpointInUseException>()("XksProxyUriEndpointInUseException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksProxyUriEndpointInUseException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class XksProxyUriInUseException extends S.TaggedErrorClass<XksProxyUriInUseException>()("XksProxyUriInUseException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksProxyUriInUseException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class XksProxyUriUnreachableException extends S.TaggedErrorClass<XksProxyUriUnreachableException>()("XksProxyUriUnreachableException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksProxyUriUnreachableException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class XksProxyVpcEndpointServiceInUseException extends S.TaggedErrorClass<XksProxyVpcEndpointServiceInUseException>()("XksProxyVpcEndpointServiceInUseException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksProxyVpcEndpointServiceInUseException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class XksProxyVpcEndpointServiceInvalidConfigurationException extends S.TaggedErrorClass<XksProxyVpcEndpointServiceInvalidConfigurationException>()("XksProxyVpcEndpointServiceInvalidConfigurationException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksProxyVpcEndpointServiceInvalidConfigurationException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class XksProxyVpcEndpointServiceNotFoundException extends S.TaggedErrorClass<XksProxyVpcEndpointServiceNotFoundException>()("XksProxyVpcEndpointServiceNotFoundException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksProxyVpcEndpointServiceNotFoundException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class DisabledException extends S.TaggedErrorClass<DisabledException>()("DisabledException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "Disabled", httpResponseCode: 409 })).pipe(C.withConflictError) {}
export class DryRunOperationException extends S.TaggedErrorClass<DryRunOperationException>()("DryRunOperationException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "DryRunOperation", httpResponseCode: 412 })) {}
export class InvalidGrantTokenException extends S.TaggedErrorClass<InvalidGrantTokenException>()("InvalidGrantTokenException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidGrantToken", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
...
export class TagException extends S.TaggedErrorClass<TagException>()("TagException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "TagException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
...
export class XksKeyAlreadyInUseException extends S.TaggedErrorClass<XksKeyAlreadyInUseException>()("XksKeyAlreadyInUseException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksKeyAlreadyInUse", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class XksKeyInvalidConfigurationException extends S.TaggedErrorClass<XksKeyInvalidConfigurationException>()("XksKeyInvalidConfigurationException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksKeyInvalidConfiguration", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class XksKeyNotFoundException extends S.TaggedErrorClass<XksKeyNotFoundException>()("XksKeyNotFoundException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksKeyNotFoundException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class IncorrectKeyException extends S.TaggedErrorClass<IncorrectKeyException>()("IncorrectKeyException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "IncorrectKeyException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class InvalidCiphertextException extends S.TaggedErrorClass<InvalidCiphertextException>()("InvalidCiphertextException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidCiphertext", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class InvalidKeyUsageException extends S.TaggedErrorClass<InvalidKeyUsageException>()("InvalidKeyUsageException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidKeyUsage", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class KeyUnavailableException extends S.TaggedErrorClass<KeyUnavailableException>()("KeyUnavailableException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "KeyUnavailable", httpResponseCode: 500 })).pipe(C.withServerError) {}
export class CustomKeyStoreHasCMKsException extends S.TaggedErrorClass<CustomKeyStoreHasCMKsException>()("CustomKeyStoreHasCMKsException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "CustomKeyStoreHasCMKsException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class InvalidMarkerException extends S.TaggedErrorClass<InvalidMarkerException>()("InvalidMarkerException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidMarker", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class ExpiredImportTokenException extends S.TaggedErrorClass<ExpiredImportTokenException>()("ExpiredImportTokenException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "ExpiredImportTokenException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class IncorrectKeyMaterialException extends S.TaggedErrorClass<IncorrectKeyMaterialException>()("IncorrectKeyMaterialException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "IncorrectKeyMaterialException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class InvalidImportTokenException extends S.TaggedErrorClass<InvalidImportTokenException>()("InvalidImportTokenException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidImportTokenException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class InvalidGrantIdException extends S.TaggedErrorClass<InvalidGrantIdException>()("InvalidGrantIdException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidGrantId", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
...
export class CloudHsmClusterNotRelatedException extends S.TaggedErrorClass<CloudHsmClusterNotRelatedException>()("CloudHsmClusterNotRelatedException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "CloudHsmClusterNotRelatedException", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class KMSInvalidSignatureException extends S.TaggedErrorClass<KMSInvalidSignatureException>()("KMSInvalidSignatureException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "KMSInvalidSignature", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
export class KMSInvalidMacException extends S.TaggedErrorClass<KMSInvalidMacException>()("KMSInvalidMacException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "KMSInvalidMac", httpResponseCode: 400 })).pipe(C.withBadRequestError) {}
 ...
 */
export const cancelKeyDeletion: API.OperationMethod<CancelKeyDeletionRequest, CancelKeyDeletionResponse, CancelKeyDeletionError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CancelKeyDeletionRequest, output: CancelKeyDeletionResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const connectCustomKeyStore: API.OperationMethod<ConnectCustomKeyStoreRequest, ConnectCustomKeyStoreResponse, ConnectCustomKeyStoreError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ConnectCustomKeyStoreRequest, output: ConnectCustomKeyStoreResponse, errors: [CloudHsmClusterInvalidConfigurationException, CloudHsmClusterNotActiveException, CustomKeyStoreInvalidStateException, CustomKeyStoreNotFoundException, KMSInternalException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const createAlias: API.OperationMethod<CreateAliasRequest, CreateAliasResponse, CreateAliasError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateAliasRequest, output: CreateAliasResponse, errors: [AlreadyExistsException, DependencyTimeoutException, InvalidAliasNameException, KMSInternalException, KMSInvalidStateException, LimitExceededException, NotFoundException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const deleteCustomKeyStore: API.OperationMethod<DeleteCustomKeyStoreRequest, DeleteCustomKeyStoreResponse, DeleteCustomKeyStoreError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteCustomKeyStoreRequest, output: DeleteCustomKeyStoreResponse, errors: [CustomKeyStoreHasCMKsException, CustomKeyStoreInvalidStateException, CustomKeyStoreNotFoundException, KMSInternalException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const deleteImportedKeyMaterial: API.OperationMethod<DeleteImportedKeyMaterialRequest, DeleteImportedKeyMaterialResponse, DeleteImportedKeyMaterialError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteImportedKeyMaterialRequest, output: DeleteImportedKeyMaterialResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const deriveSharedSecret: API.OperationMethod<DeriveSharedSecretRequest, DeriveSharedSecretResponse, DeriveSharedSecretError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeriveSharedSecretRequest, output: DeriveSharedSecretResponse, errors: [DependencyTimeoutException, DisabledException, DryRunOperationException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const describeCustomKeyStores: API.OperationMethod<DescribeCustomKeyStoresRequest, DescribeCustomKeyStoresResponse, DescribeCustomKeyStoresError, Credentials | Region | HttpClient.HttpClient> & {
  pages: (input: DescribeCustomKeyStoresRequest) => stream.Stream<DescribeCustomKeyStoresResponse, DescribeCustomKeyStoresError, Credentials | Region | HttpClient.HttpClient>;
  items: (input: DescribeCustomKeyStoresRequest) => stream.Stream<CustomKeyStoresListEntry, DescribeCustomKeyStoresError, Credentials | Region | HttpClient.HttpClient>;
} = /*@__PURE__*/ /*#__PURE__*/ API.makePaginated(() => ({ input: DescribeCustomKeyStoresRequest, output: DescribeCustomKeyStoresResponse, errors: [CustomKeyStoreNotFoundException, InvalidMarkerException, KMSInternalException], pagination: {"inputToken":"Marker","outputToken":"NextMarker","items":"CustomKeyStores","pageSize":"Limit"} as const }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const describeKey: API.OperationMethod<DescribeKeyRequest, DescribeKeyResponse, DescribeKeyError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeKeyRequest, output: DescribeKeyResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, NotFoundException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const disableKey: API.OperationMethod<DisableKeyRequest, DisableKeyResponse, DisableKeyError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisableKeyRequest, output: DisableKeyResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const disableKeyRotation: API.OperationMethod<DisableKeyRotationRequest, DisableKeyRotationResponse, DisableKeyRotationError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisableKeyRotationRequest, output: DisableKeyRotationResponse, errors: [DependencyTimeoutException, DisabledException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const disconnectCustomKeyStore: API.OperationMethod<DisconnectCustomKeyStoreRequest, DisconnectCustomKeyStoreResponse, DisconnectCustomKeyStoreError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisconnectCustomKeyStoreRequest, output: DisconnectCustomKeyStoreResponse, errors: [CustomKeyStoreInvalidStateException, CustomKeyStoreNotFoundException, KMSInternalException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const enableKey: API.OperationMethod<EnableKeyRequest, EnableKeyResponse, EnableKeyError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: EnableKeyRequest, output: EnableKeyResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, LimitExceededException, NotFoundException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const enableKeyRotation: API.OperationMethod<EnableKeyRotationRequest, EnableKeyRotationResponse, EnableKeyRotationError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: EnableKeyRotationRequest, output: EnableKeyRotationResponse, errors: [DependencyTimeoutException, DisabledException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const encrypt: API.OperationMethod<EncryptRequest, EncryptResponse, EncryptError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: EncryptRequest, output: EncryptResponse, errors: [DependencyTimeoutException, DisabledException, DryRunOperationException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const generateDataKey: API.OperationMethod<GenerateDataKeyRequest, GenerateDataKeyResponse, GenerateDataKeyError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GenerateDataKeyRequest, output: GenerateDataKeyResponse, errors: [DependencyTimeoutException, DisabledException, DryRunOperationException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const generateDataKeyWithoutPlaintext: API.OperationMethod<GenerateDataKeyWithoutPlaintextRequest, GenerateDataKeyWithoutPlaintextResponse, GenerateDataKeyWithoutPlaintextError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GenerateDataKeyWithoutPlaintextRequest, output: GenerateDataKeyWithoutPlaintextResponse, errors: [DependencyTimeoutException, DisabledException, DryRunOperationException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const generateMac: API.OperationMethod<GenerateMacRequest, GenerateMacResponse, GenerateMacError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GenerateMacRequest, output: GenerateMacResponse, errors: [DisabledException, DryRunOperationException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const generateRandom: API.OperationMethod<GenerateRandomRequest, GenerateRandomResponse, GenerateRandomError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GenerateRandomRequest, output: GenerateRandomResponse, errors: [CustomKeyStoreInvalidStateException, CustomKeyStoreNotFoundException, DependencyTimeoutException, KMSInternalException, UnsupportedOperationException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const getKeyPolicy: API.OperationMethod<GetKeyPolicyRequest, GetKeyPolicyResponse, GetKeyPolicyError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetKeyPolicyRequest, output: GetKeyPolicyResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const getKeyRotationStatus: API.OperationMethod<GetKeyRotationStatusRequest, GetKeyRotationStatusResponse, GetKeyRotationStatusError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetKeyRotationStatusRequest, output: GetKeyRotationStatusResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const getParametersForImport: API.OperationMethod<GetParametersForImportRequest, GetParametersForImportResponse, GetParametersForImportError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetParametersForImportRequest, output: GetParametersForImportResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const getPublicKey: API.OperationMethod<GetPublicKeyRequest, GetPublicKeyResponse, GetPublicKeyError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetPublicKeyRequest, output: GetPublicKeyResponse, errors: [DependencyTimeoutException, DisabledException, InvalidArnException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const importKeyMaterial: API.OperationMethod<ImportKeyMaterialRequest, ImportKeyMaterialResponse, ImportKeyMaterialError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ImportKeyMaterialRequest, output: ImportKeyMaterialResponse, errors: [DependencyTimeoutException, ExpiredImportTokenException, IncorrectKeyMaterialException, InvalidArnException, InvalidCiphertextException, InvalidImportTokenException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException] }));
...
export const listAliases: API.OperationMethod<ListAliasesRequest, ListAliasesResponse, ListAliasesError, Credentials | Region | HttpClient.HttpClient> & {
  ...
  items: (input: ListAliasesRequest) => stream.Stream<AliasListEntry, ListAliasesError, Credentials | Region | HttpClient.HttpClient>;
} = /*@__PURE__*/ /*#__PURE__*/ API.makePaginated(() => ({ input: ListAliasesRequest, output: ListAliasesResponse, errors: [DependencyTimeoutException, InvalidArnException, InvalidMarkerException, KMSInternalException, NotFoundException], pagination: {"inputToken":"Marker","outputToken":"NextMarker","items":"Aliases","pageSize":"Limit"} as const }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const listGrants: API.OperationMethod<ListGrantsRequest, ListGrantsResponse, ListGrantsError, Credentials | Region | HttpClient.HttpClient> & {
  pages: (input: ListGrantsRequest) => stream.Stream<ListGrantsResponse, ListGrantsError, Credentials | Region | HttpClient.HttpClient>;
  items: (input: ListGrantsRequest) => stream.Stream<GrantListEntry, ListGrantsError, Credentials | Region | HttpClient.HttpClient>;
} = /*@__PURE__*/ /*#__PURE__*/ API.makePaginated(() => ({ input: ListGrantsRequest, output: ListGrantsResponse, errors: [DependencyTimeoutException, InvalidArnException, InvalidGrantIdException, InvalidMarkerException, KMSInternalException, KMSInvalidStateException, NotFoundException], pagination: {"inputToken":"Marker","outputToken":"NextMarker","items":"Grants","pageSize":"Limit"} as const }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const listKeyPolicies: API.OperationMethod<ListKeyPoliciesRequest, ListKeyPoliciesResponse, ListKeyPoliciesError, Credentials | Region | HttpClient.HttpClient> & {
  pages: (input: ListKeyPoliciesRequest) => stream.Stream<ListKeyPoliciesResponse, ListKeyPoliciesError, Credentials | Region | HttpClient.HttpClient>;
  items: (input: ListKeyPoliciesRequest) => stream.Stream<PolicyNameType, ListKeyPoliciesError, Credentials | Region | HttpClient.HttpClient>;
} = /*@__PURE__*/ /*#__PURE__*/ API.makePaginated(() => ({ input: ListKeyPoliciesRequest, output: ListKeyPoliciesResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException], pagination: {"inputToken":"Marker","outputToken":"NextMarker","items":"PolicyNames","pageSize":"Limit"} as const }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const listKeyRotations: API.OperationMethod<ListKeyRotationsRequest, ListKeyRotationsResponse, ListKeyRotationsError, Credentials | Region | HttpClient.HttpClient> & {
  pages: (input: ListKeyRotationsRequest) => stream.Stream<ListKeyRotationsResponse, ListKeyRotationsError, Credentials | Region | HttpClient.HttpClient>;
  items: (input: ListKeyRotationsRequest) => stream.Stream<RotationsListEntry, ListKeyRotationsError, Credentials | Region | HttpClient.HttpClient>;
} = /*@__PURE__*/ /*#__PURE__*/ API.makePaginated(() => ({ input: ListKeyRotationsRequest, output: ListKeyRotationsResponse, errors: [InvalidArnException, InvalidMarkerException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException], pagination: {"inputToken":"Marker","outputToken":"NextMarker","items":"Rotations","pageSize":"Limit"} as const }));
...
export const listKeys: API.OperationMethod<ListKeysRequest, ListKeysResponse, ListKeysError, Credentials | Region | HttpClient.HttpClient> & {
  ...
  items: (input: ListKeysRequest) => stream.Stream<KeyListEntry, ListKeysError, Credentials | Region | HttpClient.HttpClient>;
} = /*@__PURE__*/ /*#__PURE__*/ API.makePaginated(() => ({ input: ListKeysRequest, output: ListKeysResponse, errors: [DependencyTimeoutException, InvalidMarkerException, KMSInternalException], pagination: {"inputToken":"Marker","outputToken":"NextMarker","items":"Keys","pageSize":"Limit"} as const }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const listResourceTags: API.OperationMethod<ListResourceTagsRequest, ListResourceTagsResponse, ListResourceTagsError, Credentials | Region | HttpClient.HttpClient> & {
  pages: (input: ListResourceTagsRequest) => stream.Stream<ListResourceTagsResponse, ListResourceTagsError, Credentials | Region | HttpClient.HttpClient>;
  items: (input: ListResourceTagsRequest) => stream.Stream<Tag, ListResourceTagsError, Credentials | Region | HttpClient.HttpClient>;
} = /*@__PURE__*/ /*#__PURE__*/ API.makePaginated(() => ({ input: ListResourceTagsRequest, output: ListResourceTagsResponse, errors: [InvalidArnException, InvalidMarkerException, KMSInternalException, NotFoundException], pagination: {"inputToken":"Marker","outputToken":"NextMarker","items":"Tags","pageSize":"Limit"} as const }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const listRetirableGrants: API.OperationMethod<ListRetirableGrantsRequest, ListGrantsResponse, ListRetirableGrantsError, Credentials | Region | HttpClient.HttpClient> & {
  pages: (input: ListRetirableGrantsRequest) => stream.Stream<ListGrantsResponse, ListRetirableGrantsError, Credentials | Region | HttpClient.HttpClient>;
  items: (input: ListRetirableGrantsRequest) => stream.Stream<GrantListEntry, ListRetirableGrantsError, Credentials | Region | HttpClient.HttpClient>;
} = /*@__PURE__*/ /*#__PURE__*/ API.makePaginated(() => ({ input: ListRetirableGrantsRequest, output: ListGrantsResponse, errors: [DependencyTimeoutException, InvalidArnException, InvalidMarkerException, KMSInternalException, NotFoundException], pagination: {"inputToken":"Marker","outputToken":"NextMarker","items":"Grants","pageSize":"Limit"} as const }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const putKeyPolicy: API.OperationMethod<PutKeyPolicyRequest, PutKeyPolicyResponse, PutKeyPolicyError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutKeyPolicyRequest, output: PutKeyPolicyResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, LimitExceededException, MalformedPolicyDocumentException, NotFoundException, UnsupportedOperationException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const reEncrypt: API.OperationMethod<ReEncryptRequest, ReEncryptResponse, ReEncryptError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ReEncryptRequest, output: ReEncryptResponse, errors: [DependencyTimeoutException, DisabledException, DryRunOperationException, IncorrectKeyException, InvalidCiphertextException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const replicateKey: API.OperationMethod<ReplicateKeyRequest, ReplicateKeyResponse, ReplicateKeyError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ReplicateKeyRequest, output: ReplicateKeyResponse, errors: [AlreadyExistsException, DisabledException, InvalidArnException, KMSInternalException, KMSInvalidStateException, LimitExceededException, MalformedPolicyDocumentException, NotFoundException, TagException, UnsupportedOperationException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const retireGrant: API.OperationMethod<RetireGrantRequest, RetireGrantResponse, RetireGrantError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RetireGrantRequest, output: RetireGrantResponse, errors: [DependencyTimeoutException, DryRunOperationException, InvalidArnException, InvalidGrantIdException, InvalidGrantTokenException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const revokeGrant: API.OperationMethod<RevokeGrantRequest, RevokeGrantResponse, RevokeGrantError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RevokeGrantRequest, output: RevokeGrantResponse, errors: [DependencyTimeoutException, DryRunOperationException, InvalidArnException, InvalidGrantIdException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const rotateKeyOnDemand: API.OperationMethod<RotateKeyOnDemandRequest, RotateKeyOnDemandResponse, RotateKeyOnDemandError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RotateKeyOnDemandRequest, output: RotateKeyOnDemandResponse, errors: [ConflictException, DependencyTimeoutException, DisabledException, InvalidArnException, KMSInternalException, KMSInvalidStateException, LimitExceededException, NotFoundException, UnsupportedOperationException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const scheduleKeyDeletion: API.OperationMethod<ScheduleKeyDeletionRequest, ScheduleKeyDeletionResponse, ScheduleKeyDeletionError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ScheduleKeyDeletionRequest, output: ScheduleKeyDeletionResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const sign: API.OperationMethod<SignRequest, SignResponse, SignError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SignRequest, output: SignResponse, errors: [DependencyTimeoutException, DisabledException, DryRunOperationException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const tagResource: API.OperationMethod<TagResourceRequest, TagResourceResponse, TagResourceError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResponse, errors: [InvalidArnException, KMSInternalException, KMSInvalidStateException, LimitExceededException, NotFoundException, TagException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const untagResource: API.OperationMethod<UntagResourceRequest, UntagResourceResponse, UntagResourceError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceRequest, output: UntagResourceResponse, errors: [InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException, TagException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const updateAlias: API.OperationMethod<UpdateAliasRequest, UpdateAliasResponse, UpdateAliasError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateAliasRequest, output: UpdateAliasResponse, errors: [DependencyTimeoutException, KMSInternalException, KMSInvalidStateException, LimitExceededException, NotFoundException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const updateKeyDescription: API.OperationMethod<UpdateKeyDescriptionRequest, UpdateKeyDescriptionResponse, UpdateKeyDescriptionError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateKeyDescriptionRequest, output: UpdateKeyDescriptionResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const updatePrimaryRegion: API.OperationMethod<UpdatePrimaryRegionRequest, UpdatePrimaryRegionResponse, UpdatePrimaryRegionError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdatePrimaryRegionRequest, output: UpdatePrimaryRegionResponse, errors: [DisabledException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const verify: API.OperationMethod<VerifyRequest, VerifyResponse, VerifyError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: VerifyRequest, output: VerifyResponse, errors: [DependencyTimeoutException, DisabledException, DryRunOperationException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidSignatureException, KMSInvalidStateException, NotFoundException] }));
 ...
 * For more information, see KMS eventual consistency.
 */
export const verifyMac: API.OperationMethod<VerifyMacRequest, VerifyMacResponse, VerifyMacError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: VerifyMacRequest, output: VerifyMacResponse, errors: [DisabledException, DryRunOperationException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidMacException, KMSInvalidStateException, NotFoundException] }));
