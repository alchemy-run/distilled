...
export const RelationPattern = S.suspend(() =>
  S.Struct({
    relationType: RelationType,
    relationDirection: RelationDirection,
...
export const EntityPattern = S.suspend(() =>
  S.Struct({
    entityType: GraphEntityType,
    identifier: S.String,
...
export const MatchClause = S.Union([
...
export const AdditionalAttributes = S.suspend(() =>
...
export const QueryGraphInput = S.suspend(() =>
  S.Struct({
    domainIdentifier: S.String.pipe(T.HttpLabel("domainIdentifier")),
    match: MatchClauses,
    maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")),
...
export const LineageNodeItem = S.suspend(() =>
  S.Struct({
    domainId: S.String,
    name: S.optional(S.String),
    description: S.optional(S.String),
...
export const QueryGraphOutput = S.suspend(() =>
  S.Struct({
