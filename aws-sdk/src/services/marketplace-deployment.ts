...
const svc = T.AwsApiService({ sdkId: "Marketplace Deployment", serviceShapeName: "AWSMPDeploymentParametersService" });
...
export interface DeploymentParameterInput { name: string; secretString: string | redacted.Redacted<string> }
export const DeploymentParameterInput = S.suspend(() => S.Struct({name: S.String, secretString: SensitiveString})).annotate({ identifier: "DeploymentParameterInput" }) as any as S.Schema<DeploymentParameterInput>;
export type TagsMap = { [key: string]: string | undefined };
export const TagsMap = S.Record(S.String, S.String.pipe(S.optional));
export interface PutDeploymentParameterRequest { catalog: string; productId: string; agreementId: string; deploymentParameter: DeploymentParameterInput; tags?: { [key: string]: string | undefined }; expirationDate?: Date; clientToken?: string }
export const PutDeploymentParameterRequest = S.suspend(() => S.Struct({catalog: S.String.pipe(T.HttpLabel("catalog")), productId: S.String.pipe(T.HttpLabel("productId")), agreementId: S.String, deploymentParameter: DeploymentParameterInput, tags: S.optional(TagsMap), expirationDate: S.optional(T.DateFromString.pipe(T.TimestampFormat("date-time"))), clientToken: S.optional(S.String).pipe(T.IdempotencyToken())}).pipe(T.all(T.Http({ method: "POST", uri: "/catalogs/{catalog}/products/{productId}/deployment-parameters" }), svc, auth, proto, ver, rules))).annotate({ identifier: "PutDeploymentParameterRequest" }) as any as S.Schema<PutDeploymentParameterRequest>;
export interface PutDeploymentParameterResponse { resourceArn: string; agreementId: string; deploymentParameterId: string; tags?: { [key: string]: string | undefined } }
export const PutDeploymentParameterResponse = S.suspend(() => S.Struct({resourceArn: S.String, agreementId: S.String, deploymentParameterId: S.String, tags: S.optional(TagsMap)})).annotate({ identifier: "PutDeploymentParameterResponse" }) as any as S.Schema<PutDeploymentParameterResponse>;
...
export class ValidationException extends S.TaggedErrorClass<ValidationException>()("ValidationException", {message: S.String, fieldName: S.String}).pipe(C.withBadRequestError) {}
 ...
 */
export const putDeploymentParameter: API.OperationMethod<PutDeploymentParameterRequest, PutDeploymentParameterResponse, PutDeploymentParameterError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutDeploymentParameterRequest, output: PutDeploymentParameterResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
