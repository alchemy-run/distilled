...
const svc = T.AwsApiService({ sdkId: "Kinesis Video Archived Media", serviceShapeName: "AWSAcuityReader" });
...
export interface ClipTimestampRange { StartTimestamp: Date; EndTimestamp: Date }
export const ClipTimestampRange = S.suspend(() => S.Struct({StartTimestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds")), EndTimestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds"))})).annotate({ identifier: "ClipTimestampRange" }) as any as S.Schema<ClipTimestampRange>;
export interface ClipFragmentSelector { FragmentSelectorType: ClipFragmentSelectorType; TimestampRange: ClipTimestampRange }
export const ClipFragmentSelector = S.suspend(() => S.Struct({FragmentSelectorType: ClipFragmentSelectorType, TimestampRange: ClipTimestampRange})).annotate({ identifier: "ClipFragmentSelector" }) as any as S.Schema<ClipFragmentSelector>;
export interface GetClipInput { StreamName?: string; StreamARN?: string; ClipFragmentSelector: ClipFragmentSelector }
export const GetClipInput = S.suspend(() => S.Struct({StreamName: S.optional(S.String), StreamARN: S.optional(S.String), ClipFragmentSelector: ClipFragmentSelector}).pipe(T.all(T.Http({ method: "POST", uri: "/getClip" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetClipInput" }) as any as S.Schema<GetClipInput>;
export interface GetClipOutput { ContentType?: string; Payload?: T.StreamingOutputBody }
export const GetClipOutput = S.suspend(() => S.Struct({ContentType: S.optional(S.String).pipe(T.HttpHeader("Content-Type")), Payload: S.optional(T.StreamingOutput).pipe(T.HttpPayload())})).annotate({ identifier: "GetClipOutput" }) as any as S.Schema<GetClipOutput>;
...
export interface DASHTimestampRange { StartTimestamp?: Date; EndTimestamp?: Date }
export const DASHTimestampRange = S.suspend(() => S.Struct({StartTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), EndTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))})).annotate({ identifier: "DASHTimestampRange" }) as any as S.Schema<DASHTimestampRange>;
export interface DASHFragmentSelector { FragmentSelectorType?: DASHFragmentSelectorType; TimestampRange?: DASHTimestampRange }
export const DASHFragmentSelector = S.suspend(() => S.Struct({FragmentSelectorType: S.optional(DASHFragmentSelectorType), TimestampRange: S.optional(DASHTimestampRange)})).annotate({ identifier: "DASHFragmentSelector" }) as any as S.Schema<DASHFragmentSelector>;
export interface GetDASHStreamingSessionURLInput { StreamName?: string; StreamARN?: string; PlaybackMode?: DASHPlaybackMode; DisplayFragmentTimestamp?: DASHDisplayFragmentTimestamp; DisplayFragmentNumber?: DASHDisplayFragmentNumber; DASHFragmentSelector?: DASHFragmentSelector; Expires?: number; MaxManifestFragmentResults?: number }
export const GetDASHStreamingSessionURLInput = S.suspend(() => S.Struct({StreamName: S.optional(S.String), StreamARN: S.optional(S.String), PlaybackMode: S.optional(DASHPlaybackMode), DisplayFragmentTimestamp: S.optional(DASHDisplayFragmentTimestamp), DisplayFragmentNumber: S.optional(DASHDisplayFragmentNumber), DASHFragmentSelector: S.optional(DASHFragmentSelector), Expires: S.optional(S.Number), MaxManifestFragmentResults: S.optional(S.Number)}).pipe(T.all(T.Http({ method: "POST", uri: "/getDASHStreamingSessionURL" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetDASHStreamingSessionURLInput" }) as any as S.Schema<GetDASHStreamingSessionURLInput>;
export interface GetDASHStreamingSessionURLOutput { DASHStreamingSessionURL?: string }
export const GetDASHStreamingSessionURLOutput = S.suspend(() => S.Struct({DASHStreamingSessionURL: S.optional(S.String)})).annotate({ identifier: "GetDASHStreamingSessionURLOutput" }) as any as S.Schema<GetDASHStreamingSessionURLOutput>;
...
export interface HLSTimestampRange { StartTimestamp?: Date; EndTimestamp?: Date }
export const HLSTimestampRange = S.suspend(() => S.Struct({StartTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), EndTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))})).annotate({ identifier: "HLSTimestampRange" }) as any as S.Schema<HLSTimestampRange>;
export interface HLSFragmentSelector { FragmentSelectorType?: HLSFragmentSelectorType; TimestampRange?: HLSTimestampRange }
export const HLSFragmentSelector = S.suspend(() => S.Struct({FragmentSelectorType: S.optional(HLSFragmentSelectorType), TimestampRange: S.optional(HLSTimestampRange)})).annotate({ identifier: "HLSFragmentSelector" }) as any as S.Schema<HLSFragmentSelector>;
...
export interface GetHLSStreamingSessionURLInput { StreamName?: string; StreamARN?: string; PlaybackMode?: HLSPlaybackMode; HLSFragmentSelector?: HLSFragmentSelector; ContainerFormat?: ContainerFormat; DiscontinuityMode?: HLSDiscontinuityMode; DisplayFragmentTimestamp?: HLSDisplayFragmentTimestamp; Expires?: number; MaxMediaPlaylistFragmentResults?: number }
export const GetHLSStreamingSessionURLInput = S.suspend(() => S.Struct({StreamName: S.optional(S.String), StreamARN: S.optional(S.String), PlaybackMode: S.optional(HLSPlaybackMode), HLSFragmentSelector: S.optional(HLSFragmentSelector), ContainerFormat: S.optional(ContainerFormat), DiscontinuityMode: S.optional(HLSDiscontinuityMode), DisplayFragmentTimestamp: S.optional(HLSDisplayFragmentTimestamp), Expires: S.optional(S.Number), MaxMediaPlaylistFragmentResults: S.optional(S.Number)}).pipe(T.all(T.Http({ method: "POST", uri: "/getHLSStreamingSessionURL" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetHLSStreamingSessionURLInput" }) as any as S.Schema<GetHLSStreamingSessionURLInput>;
export interface GetHLSStreamingSessionURLOutput { HLSStreamingSessionURL?: string }
export const GetHLSStreamingSessionURLOutput = S.suspend(() => S.Struct({HLSStreamingSessionURL: S.optional(S.String)})).annotate({ identifier: "GetHLSStreamingSessionURLOutput" }) as any as S.Schema<GetHLSStreamingSessionURLOutput>;
...
export interface GetImagesInput { StreamName?: string; StreamARN?: string; ImageSelectorType: ImageSelectorType; StartTimestamp: Date; EndTimestamp: Date; SamplingInterval?: number; Format: Format; FormatConfig?: { [key: string]: string | undefined }; WidthPixels?: number; HeightPixels?: number; MaxResults?: number; NextToken?: string }
export const GetImagesInput = S.suspend(() => S.Struct({StreamName: S.optional(S.String), StreamARN: S.optional(S.String), ImageSelectorType: ImageSelectorType, StartTimestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds")), EndTimestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds")), SamplingInterval: S.optional(S.Number), Format: Format, FormatConfig: S.optional(FormatConfig), WidthPixels: S.optional(S.Number), HeightPixels: S.optional(S.Number), MaxResults: S.optional(S.Number), NextToken: S.optional(S.String)}).pipe(T.all(T.Http({ method: "POST", uri: "/getImages" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetImagesInput" }) as any as S.Schema<GetImagesInput>;
export type ImageError =
  | "NO_MEDIA"
  | "MEDIA_ERROR"
  | (string & {});
export const ImageError = S.String;
export interface Image { TimeStamp?: Date; Error?: ImageError; ImageContent?: string }
export const Image = S.suspend(() => S.Struct({TimeStamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Error: S.optional(ImageError), ImageContent: S.optional(S.String)})).annotate({ identifier: "Image" }) as any as S.Schema<Image>;
export type Images = Image[];
export const Images = S.Array(Image);
export interface GetImagesOutput { Images?: Image[]; NextToken?: string }
export const GetImagesOutput = S.suspend(() => S.Struct({Images: S.optional(Images), NextToken: S.optional(S.String)})).annotate({ identifier: "GetImagesOutput" }) as any as S.Schema<GetImagesOutput>;
export type FragmentNumberList = string[];
export const FragmentNumberList = S.Array(S.String);
export interface GetMediaForFragmentListInput { StreamName?: string; StreamARN?: string; Fragments: string[] }
export const GetMediaForFragmentListInput = S.suspend(() => S.Struct({StreamName: S.optional(S.String), StreamARN: S.optional(S.String), Fragments: FragmentNumberList}).pipe(T.all(T.Http({ method: "POST", uri: "/getMediaForFragmentList" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetMediaForFragmentListInput" }) as any as S.Schema<GetMediaForFragmentListInput>;
export interface GetMediaForFragmentListOutput { ContentType?: string; Payload?: T.StreamingOutputBody }
export const GetMediaForFragmentListOutput = S.suspend(() => S.Struct({ContentType: S.optional(S.String).pipe(T.HttpHeader("Content-Type")), Payload: S.optional(T.StreamingOutput).pipe(T.HttpPayload())})).annotate({ identifier: "GetMediaForFragmentListOutput" }) as any as S.Schema<GetMediaForFragmentListOutput>;
...
export interface ListFragmentsInput { StreamName?: string; StreamARN?: string; MaxResults?: number; NextToken?: string; FragmentSelector?: FragmentSelector }
export const ListFragmentsInput = S.suspend(() => S.Struct({StreamName: S.optional(S.String), StreamARN: S.optional(S.String), MaxResults: S.optional(S.Number), NextToken: S.optional(S.String), FragmentSelector: S.optional(FragmentSelector)}).pipe(T.all(T.Http({ method: "POST", uri: "/listFragments" }), svc, auth, proto, ver, rules))).annotate({ identifier: "ListFragmentsInput" }) as any as S.Schema<ListFragmentsInput>;
export interface Fragment { FragmentNumber?: string; FragmentSizeInBytes?: number; ProducerTimestamp?: Date; ServerTimestamp?: Date; FragmentLengthInMilliseconds?: number }
export const Fragment = S.suspend(() => S.Struct({FragmentNumber: S.optional(S.String), FragmentSizeInBytes: S.optional(S.Number), ProducerTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ServerTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), FragmentLengthInMilliseconds: S.optional(S.Number)})).annotate({ identifier: "Fragment" }) as any as S.Schema<Fragment>;
export type FragmentList = Fragment[];
export const FragmentList = S.Array(Fragment);
export interface ListFragmentsOutput { Fragments?: Fragment[]; NextToken?: string }
export const ListFragmentsOutput = S.suspend(() => S.Struct({Fragments: S.optional(FragmentList), NextToken: S.optional(S.String)})).annotate({ identifier: "ListFragmentsOutput" }) as any as S.Schema<ListFragmentsOutput>;
...
export class InvalidCodecPrivateDataException extends S.TaggedErrorClass<InvalidCodecPrivateDataException>()("InvalidCodecPrivateDataException", {Message: S.optional(S.String)}).pipe(C.withBadRequestError) {}
export class InvalidMediaFrameException extends S.TaggedErrorClass<InvalidMediaFrameException>()("InvalidMediaFrameException", {Message: S.optional(S.String)}).pipe(C.withBadRequestError) {}
export class MissingCodecPrivateDataException extends S.TaggedErrorClass<MissingCodecPrivateDataException>()("MissingCodecPrivateDataException", {Message: S.optional(S.String)}).pipe(C.withBadRequestError) {}
...
export class UnsupportedStreamMediaTypeException extends S.TaggedErrorClass<UnsupportedStreamMediaTypeException>()("UnsupportedStreamMediaTypeException", {Message: S.optional(S.String)}).pipe(C.withBadRequestError) {}
 ...
 */
export const getClip: API.OperationMethod<GetClipInput, GetClipOutput, GetClipError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetClipInput, output: GetClipOutput, errors: [ClientLimitExceededException, InvalidArgumentException, InvalidCodecPrivateDataException, InvalidMediaFrameException, MissingCodecPrivateDataException, NoDataRetentionException, NotAuthorizedException, ResourceNotFoundException, UnsupportedStreamMediaTypeException] }));
 ...
 */
export const getDASHStreamingSessionURL: API.OperationMethod<GetDASHStreamingSessionURLInput, GetDASHStreamingSessionURLOutput, GetDASHStreamingSessionURLError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetDASHStreamingSessionURLInput, output: GetDASHStreamingSessionURLOutput, errors: [ClientLimitExceededException, InvalidArgumentException, InvalidCodecPrivateDataException, MissingCodecPrivateDataException, NoDataRetentionException, NotAuthorizedException, ResourceNotFoundException, UnsupportedStreamMediaTypeException] }));
 ...
 * the bottom of this topic, as well as Common Errors.
 */
export const getHLSStreamingSessionURL: API.OperationMethod<GetHLSStreamingSessionURLInput, GetHLSStreamingSessionURLOutput, GetHLSStreamingSessionURLError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetHLSStreamingSessionURLInput, output: GetHLSStreamingSessionURLOutput, errors: [ClientLimitExceededException, InvalidArgumentException, InvalidCodecPrivateDataException, MissingCodecPrivateDataException, NoDataRetentionException, NotAuthorizedException, ResourceNotFoundException, UnsupportedStreamMediaTypeException] }));
 ...
 */
export const getImages: API.OperationMethod<GetImagesInput, GetImagesOutput, GetImagesError, Credentials | Region | HttpClient.HttpClient> & {
  pages: (input: GetImagesInput) => stream.Stream<GetImagesOutput, GetImagesError, Credentials | Region | HttpClient.HttpClient>;
  items: (input: GetImagesInput) => stream.Stream<Image, GetImagesError, Credentials | Region | HttpClient.HttpClient>;
} = /*@__PURE__*/ /*#__PURE__*/ API.makePaginated(() => ({ input: GetImagesInput, output: GetImagesOutput, errors: [ClientLimitExceededException, InvalidArgumentException, NoDataRetentionException, NotAuthorizedException, ResourceNotFoundException], pagination: {"inputToken":"NextToken","outputToken":"NextToken","items":"Images","pageSize":"MaxResults"} as const }));
 ...
 * the bottom of this topic, as well as Common Errors.
 */
export const getMediaForFragmentList: API.OperationMethod<GetMediaForFragmentListInput, GetMediaForFragmentListOutput, GetMediaForFragmentListError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetMediaForFragmentListInput, output: GetMediaForFragmentListOutput, errors: [ClientLimitExceededException, InvalidArgumentException, NotAuthorizedException, ResourceNotFoundException] }));
 ...
 * the bottom of this topic, as well as Common Errors.
 */
export const listFragments: API.OperationMethod<ListFragmentsInput, ListFragmentsOutput, ListFragmentsError, Credentials | Region | HttpClient.HttpClient> & {
  pages: (input: ListFragmentsInput) => stream.Stream<ListFragmentsOutput, ListFragmentsError, Credentials | Region | HttpClient.HttpClient>;
  items: (input: ListFragmentsInput) => stream.Stream<Fragment, ListFragmentsError, Credentials | Region | HttpClient.HttpClient>;
} = /*@__PURE__*/ /*#__PURE__*/ API.makePaginated(() => ({ input: ListFragmentsInput, output: ListFragmentsOutput, errors: [ClientLimitExceededException, InvalidArgumentException, NotAuthorizedException, ResourceNotFoundException], pagination: {"inputToken":"NextToken","outputToken":"NextToken","items":"Fragments","pageSize":"MaxResults"} as const }));
