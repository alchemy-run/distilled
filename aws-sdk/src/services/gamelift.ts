...
export const PlayerGatewayConfiguration = S.suspend(() =>
  S.Struct({
...
export const GetPlayerConnectionDetailsInput = S.suspend(() =>
  S.Struct({
    GameSessionId: S.optional(S.String),
    PlayerIds: S.optional(PlayerIdList),
  }).pipe(
...
export const PlayerConnectionEndpoint = S.suspend(() =>
  S.Struct({
    IpAddress: S.optional(SensitiveString),
    Port: S.optional(S.Number),
  }),
...
export const PlayerConnectionDetail = S.suspend(() =>
  S.Struct({
    PlayerId: S.optional(SensitiveString),
...
export const GetPlayerConnectionDetailsOutput = S.suspend(() =>
  S.Struct({
    GameSessionId: S.optional(S.String),
