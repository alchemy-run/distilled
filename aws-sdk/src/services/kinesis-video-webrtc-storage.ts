...
//# Schemas
export interface JoinStorageSessionInput { channelArn: string }
export const JoinStorageSessionInput = S.suspend(() => S.Struct({channelArn: S.String}).pipe(T.all(T.Http({ method: "POST", uri: "/joinStorageSession" }), svc, auth, proto, ver, rules))).annotate({ identifier: "JoinStorageSessionInput" }) as any as S.Schema<JoinStorageSessionInput>;
export interface JoinStorageSessionResponse {}
export const JoinStorageSessionResponse = S.suspend(() => S.Struct({})).annotate({ identifier: "JoinStorageSessionResponse" }) as any as S.Schema<JoinStorageSessionResponse>;
export interface JoinStorageSessionAsViewerInput { channelArn: string; clientId: string }
export const JoinStorageSessionAsViewerInput = S.suspend(() => S.Struct({channelArn: S.String, clientId: S.String}).pipe(T.all(T.Http({ method: "POST", uri: "/joinStorageSessionAsViewer" }), svc, auth, proto, ver, rules))).annotate({ identifier: "JoinStorageSessionAsViewerInput" }) as any as S.Schema<JoinStorageSessionAsViewerInput>;
export interface JoinStorageSessionAsViewerResponse {}
export const JoinStorageSessionAsViewerResponse = S.suspend(() => S.Struct({})).annotate({ identifier: "JoinStorageSessionAsViewerResponse" }) as any as S.Schema<JoinStorageSessionAsViewerResponse>;
 ...
 */
export const joinStorageSession: API.OperationMethod<JoinStorageSessionInput, JoinStorageSessionResponse, JoinStorageSessionError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: JoinStorageSessionInput, output: JoinStorageSessionResponse, errors: [AccessDeniedException, ClientLimitExceededException, InvalidArgumentException, ResourceNotFoundException] }));
 ...
 */
export const joinStorageSessionAsViewer: API.OperationMethod<JoinStorageSessionAsViewerInput, JoinStorageSessionAsViewerResponse, JoinStorageSessionAsViewerError, Credentials | Region | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: JoinStorageSessionAsViewerInput, output: JoinStorageSessionAsViewerResponse, errors: [AccessDeniedException, ClientLimitExceededException, InvalidArgumentException, ResourceNotFoundException] }));
