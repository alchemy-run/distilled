...
export type ListAccountsLimitsError = CommonErrors;

/** Lists the limits of an account. */
export const listAccountsLimits: API.PaginatedOperationMethod<ListAccountsLimitsRequest, ListAccountsLimitsResponse, ListAccountsLimitsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export type GetAccountsLimitsError = CommonErrors;

/** Retrieves an account limit. */
export const getAccountsLimits: API.OperationMethod<GetAccountsLimitsRequest, GetAccountsLimitsResponse, GetAccountsLimitsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
