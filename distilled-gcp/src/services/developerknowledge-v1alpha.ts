...
export type SearchDocumentChunksDocumentsError = CommonErrors;
...
export const searchDocumentChunksDocuments: API.PaginatedOperationMethod<SearchDocumentChunksDocumentsRequest, SearchDocumentChunksDocumentsResponse, SearchDocumentChunksDocumentsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export type BatchGetDocumentsError = CommonErrors;

/** Retrieves multiple documents, each with its full Markdown content. */
export const batchGetDocuments: API.OperationMethod<BatchGetDocumentsRequest, BatchGetDocumentsResponse_Op, BatchGetDocumentsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
