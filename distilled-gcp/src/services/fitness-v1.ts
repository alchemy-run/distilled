...
export const getUsersDataSourcesDatasets: API.PaginatedOperationMethod<GetUsersDataSourcesDatasetsRequest, GetUsersDataSourcesDatasetsResponse, GetUsersDataSourcesDatasetsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const listUsersDataSourcesDataPointChanges: API.PaginatedOperationMethod<ListUsersDataSourcesDataPointChangesRequest, ListUsersDataSourcesDataPointChangesResponse, ListUsersDataSourcesDataPointChangesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const listUsersSessions: API.PaginatedOperationMethod<ListUsersSessionsRequest, ListUsersSessionsResponse, ListUsersSessionsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
