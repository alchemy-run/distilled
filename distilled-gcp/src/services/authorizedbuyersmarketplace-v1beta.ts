...
export const DeactivateCuratorsCuratedPackagesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta/curators/{curatorsId}/curatedPackages/{curatedPackagesId}:deactivate", hasBody: true }),
  svc,
...
export const PatchCuratorsCuratedPackagesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1beta/curators/{curatorsId}/curatedPackages/{curatedPackagesId}", hasBody: true }),
  svc,
...
export const GetCuratorsCuratedPackagesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/curators/{curatorsId}/curatedPackages/{curatedPackagesId}" }),
  svc,
...
export const ActivateCuratorsCuratedPackagesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta/curators/{curatorsId}/curatedPackages/{curatedPackagesId}:activate", hasBody: true }),
  svc,
...
export const ListCuratorsCuratedPackagesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/curators/{curatorsId}/curatedPackages" }),
  svc,
...
export const CreateCuratorsCuratedPackagesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta/curators/{curatorsId}/curatedPackages", hasBody: true }),
  svc,
...
export const PatchCuratorsDataSegmentsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1beta/curators/{curatorsId}/dataSegments/{dataSegmentsId}", hasBody: true }),
  svc,
...
export type PatchCuratorsDataSegmentsError = CommonErrors;

/** Updates a data segment. */
export const patchCuratorsDataSegments: API.OperationMethod<PatchCuratorsDataSegmentsRequest, PatchCuratorsDataSegmentsResponse, PatchCuratorsDataSegmentsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const DeactivateCuratorsDataSegmentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta/curators/{curatorsId}/dataSegments/{dataSegmentsId}:deactivate", hasBody: true }),
  svc,
...
export type DeactivateCuratorsDataSegmentsError = CommonErrors;

/** Deactivates a data segment. */
export const deactivateCuratorsDataSegments: API.OperationMethod<DeactivateCuratorsDataSegmentsRequest, DeactivateCuratorsDataSegmentsResponse, DeactivateCuratorsDataSegmentsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetCuratorsDataSegmentsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta/curators/{curatorsId}/dataSegments/{dataSegmentsId}" }),
  svc,
...
export type GetCuratorsDataSegmentsError = CommonErrors;

/** Gets a data segment given its name. */
export const getCuratorsDataSegments: API.OperationMethod<GetCuratorsDataSegmentsRequest, GetCuratorsDataSegmentsResponse, GetCuratorsDataSegmentsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ActivateCuratorsDataSegmentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta/curators/{curatorsId}/dataSegments/{dataSegmentsId}:activate", hasBody: true }),
  svc,
...
export type ActivateCuratorsDataSegmentsError = CommonErrors;

/** Activates a data segment. */
export const activateCuratorsDataSegments: API.OperationMethod<ActivateCuratorsDataSegmentsRequest, ActivateCuratorsDataSegmentsResponse, ActivateCuratorsDataSegmentsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type ListCuratorsDataSegmentsError = CommonErrors;

/** List the data segments owned by a curator. */
export const listCuratorsDataSegments: API.PaginatedOperationMethod<ListCuratorsDataSegmentsRequest, ListCuratorsDataSegmentsResponse, ListCuratorsDataSegmentsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const CreateCuratorsDataSegmentsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta/curators/{curatorsId}/dataSegments", hasBody: true }),
  svc,
...
export type CreateCuratorsDataSegmentsError = CommonErrors;
...
export const createCuratorsDataSegments: API.OperationMethod<CreateCuratorsDataSegmentsRequest, CreateCuratorsDataSegmentsResponse, CreateCuratorsDataSegmentsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
