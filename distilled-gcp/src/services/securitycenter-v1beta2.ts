...
export const SecurityCenterSettings: Schema.Schema<SecurityCenterSettings> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "SecurityCenterSettings" }) as any as Schema.Schema<SecurityCenterSettings>;
...
export interface Details {
  ...
  type?: "TYPE_UNSPECIFIED" | "STANDARD" | "TRIAL" | "ALPHA" | "DEMO" | "PAY_AS_YOU_GO" | (string & {});
}
...
export interface Subscription {
  ...
  tier?: "TIER_UNSPECIFIED" | "STANDARD" | "PREMIUM" | "ENTERPRISE" | "ENTERPRISE_MC" | (string & {});
...
export interface Config {
  ...
  moduleEnablementState?: "ENABLEMENT_STATE_UNSPECIFIED" | "INHERITED" | "ENABLED" | "DISABLED" | (string & {});
...
export interface ContainerThreatDetectionSettings {
  ...
  serviceEnablementState?: "ENABLEMENT_STATE_UNSPECIFIED" | "INHERITED" | "ENABLED" | "DISABLED" | (string & {});
...
export const ContainerThreatDetectionSettings: Schema.Schema<ContainerThreatDetectionSettings> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
...
})).annotate({ identifier: "ContainerThreatDetectionSettings" }) as any as Schema.Schema<ContainerThreatDetectionSettings>;
...
export const EventThreatDetectionSettings: Schema.Schema<EventThreatDetectionSettings> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  serviceEnablementState: Schema.optional(Schema.String),
  modules: Schema.optional(Schema.Record(Schema.String, Config)),
  updateTime: Schema.optional(Schema.String),
})).annotate({ identifier: "EventThreatDetectionSettings" }) as any as Schema.Schema<EventThreatDetectionSettings>;
...
export const SecurityHealthAnalyticsSettings: Schema.Schema<SecurityHealthAnalyticsSettings> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  serviceEnablementState: Schema.optional(Schema.String),
  modules: Schema.optional(Schema.Record(Schema.String, Config)),
  serviceAccount: Schema.optional(Schema.String),
  updateTime: Schema.optional(Schema.String),
})).annotate({ identifier: "SecurityHealthAnalyticsSettings" }) as any as Schema.Schema<SecurityHealthAnalyticsSettings>;
...
export const VirtualMachineThreatDetectionSettings: Schema.Schema<VirtualMachineThreatDetectionSettings> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  serviceEnablementState: Schema.optional(Schema.String),
  modules: Schema.optional(Schema.Record(Schema.String, Config)),
  serviceAccount: Schema.optional(Schema.String),
  updateTime: Schema.optional(Schema.String),
})).annotate({ identifier: "VirtualMachineThreatDetectionSettings" }) as any as Schema.Schema<VirtualMachineThreatDetectionSettings>;
...
export const RapidVulnerabilityDetectionSettings: Schema.Schema<RapidVulnerabilityDetectionSettings> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  serviceEnablementState: Schema.optional(Schema.String),
  modules: Schema.optional(Schema.Record(Schema.String, Config)),
  updateTime: Schema.optional(Schema.String),
})).annotate({ identifier: "RapidVulnerabilityDetectionSettings" }) as any as Schema.Schema<RapidVulnerabilityDetectionSettings>;
...
export const WebSecurityScannerSettings: Schema.Schema<WebSecurityScannerSettings> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  serviceEnablementState: Schema.optional(Schema.String),
  modules: Schema.optional(Schema.Record(Schema.String, Config)),
  updateTime: Schema.optional(Schema.String),
})).annotate({ identifier: "WebSecurityScannerSettings" }) as any as Schema.Schema<WebSecurityScannerSettings>;
...
export const GetSecurityCenterSettingsOrganizationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta2/organizations/{organizationsId}/securityCenterSettings" }),
  svc,
) as unknown as Schema.Schema<GetSecurityCenterSettingsOrganizationsRequest>;

export type GetSecurityCenterSettingsOrganizationsResponse = SecurityCenterSettings;
export const GetSecurityCenterSettingsOrganizationsResponse = SecurityCenterSettings;

export type GetSecurityCenterSettingsOrganizationsError = CommonErrors;

/** Get the SecurityCenterSettings resource. */
export const getSecurityCenterSettingsOrganizations: API.OperationMethod<GetSecurityCenterSettingsOrganizationsRequest, GetSecurityCenterSettingsOrganizationsResponse, GetSecurityCenterSettingsOrganizationsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetSubscriptionOrganizationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta2/organizations/{organizationsId}/subscription" }),
  svc,
...
export type GetSubscriptionOrganizationsError = CommonErrors;

/** Get the Subscription resource. */
export const getSubscriptionOrganizations: API.OperationMethod<GetSubscriptionOrganizationsRequest, GetSubscriptionOrganizationsResponse, GetSubscriptionOrganizationsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetContainerThreatDetectionSettingsOrganizationsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/organizations/{organizationsId}/containerThreatDetectionSettings" }),
  svc,
) as unknown as Schema.Schema<GetContainerThreatDetectionSettingsOrganizationsRequest>;

export type GetContainerThreatDetectionSettingsOrganizationsResponse = ContainerThreatDetectionSettings;
export const GetContainerThreatDetectionSettingsOrganizationsResponse = ContainerThreatDetectionSettings;

export type GetContainerThreatDetectionSettingsOrganizationsError = CommonErrors;

/** Get the ContainerThreatDetectionSettings resource. In the returned settings response, a missing field only indicates that it was not explicitly set, so no assumption should be made about these fields. In other words, GetContainerThreatDetectionSettings does not calculate the effective service settings for the resource, which accounts for inherited settings and defaults. Instead, use CalculateContainerThreatDetectionSettings for this purpose. */
export const getContainerThreatDetectionSettingsOrganizations: API.OperationMethod<GetContainerThreatDetectionSettingsOrganizationsRequest, GetContainerThreatDetectionSettingsOrganizationsResponse, GetContainerThreatDetectionSettingsOrganizationsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateContainerThreatDetectionSettingsOrganizationsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(ContainerThreatDetectionSettings).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1beta2/organizations/{organizationsId}/containerThreatDetectionSettings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateContainerThreatDetectionSettingsOrganizationsRequest>;

export type UpdateContainerThreatDetectionSettingsOrganizationsResponse = ContainerThreatDetectionSettings;
export const UpdateContainerThreatDetectionSettingsOrganizationsResponse = ContainerThreatDetectionSettings;

export type UpdateContainerThreatDetectionSettingsOrganizationsError = CommonErrors;

/** Update the ContainerThreatDetectionSettings resource. */
export const updateContainerThreatDetectionSettingsOrganizations: API.OperationMethod<UpdateContainerThreatDetectionSettingsOrganizationsRequest, UpdateContainerThreatDetectionSettingsOrganizationsResponse, UpdateContainerThreatDetectionSettingsOrganizationsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetEventThreatDetectionSettingsOrganizationsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/organizations/{organizationsId}/eventThreatDetectionSettings" }),
  svc,
) as unknown as Schema.Schema<GetEventThreatDetectionSettingsOrganizationsRequest>;

export type GetEventThreatDetectionSettingsOrganizationsResponse = EventThreatDetectionSettings;
export const GetEventThreatDetectionSettingsOrganizationsResponse = EventThreatDetectionSettings;

export type GetEventThreatDetectionSettingsOrganizationsError = CommonErrors;
...
export const getEventThreatDetectionSettingsOrganizations: API.OperationMethod<GetEventThreatDetectionSettingsOrganizationsRequest, GetEventThreatDetectionSettingsOrganizationsResponse, GetEventThreatDetectionSettingsOrganizationsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateEventThreatDetectionSettingsOrganizationsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(EventThreatDetectionSettings).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1beta2/organizations/{organizationsId}/eventThreatDetectionSettings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateEventThreatDetectionSettingsOrganizationsRequest>;

export type UpdateEventThreatDetectionSettingsOrganizationsResponse = EventThreatDetectionSettings;
export const UpdateEventThreatDetectionSettingsOrganizationsResponse = EventThreatDetectionSettings;

export type UpdateEventThreatDetectionSettingsOrganizationsError = CommonErrors;

/** Update the EventThreatDetectionSettings resource. */
export const updateEventThreatDetectionSettingsOrganizations: API.OperationMethod<UpdateEventThreatDetectionSettingsOrganizationsRequest, UpdateEventThreatDetectionSettingsOrganizationsResponse, UpdateEventThreatDetectionSettingsOrganizationsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetSecurityHealthAnalyticsSettingsOrganizationsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/organizations/{organizationsId}/securityHealthAnalyticsSettings" }),
  svc,
) as unknown as Schema.Schema<GetSecurityHealthAnalyticsSettingsOrganizationsRequest>;

export type GetSecurityHealthAnalyticsSettingsOrganizationsResponse = SecurityHealthAnalyticsSettings;
export const GetSecurityHealthAnalyticsSettingsOrganizationsResponse = SecurityHealthAnalyticsSettings;

export type GetSecurityHealthAnalyticsSettingsOrganizationsError = CommonErrors;
...
export const getSecurityHealthAnalyticsSettingsOrganizations: API.OperationMethod<GetSecurityHealthAnalyticsSettingsOrganizationsRequest, GetSecurityHealthAnalyticsSettingsOrganizationsResponse, GetSecurityHealthAnalyticsSettingsOrganizationsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateSecurityHealthAnalyticsSettingsOrganizationsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(SecurityHealthAnalyticsSettings).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1beta2/organizations/{organizationsId}/securityHealthAnalyticsSettings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateSecurityHealthAnalyticsSettingsOrganizationsRequest>;

export type UpdateSecurityHealthAnalyticsSettingsOrganizationsResponse = SecurityHealthAnalyticsSettings;
export const UpdateSecurityHealthAnalyticsSettingsOrganizationsResponse = SecurityHealthAnalyticsSettings;

export type UpdateSecurityHealthAnalyticsSettingsOrganizationsError = CommonErrors;

/** Update the SecurityHealthAnalyticsSettings resource. */
export const updateSecurityHealthAnalyticsSettingsOrganizations: API.OperationMethod<UpdateSecurityHealthAnalyticsSettingsOrganizationsRequest, UpdateSecurityHealthAnalyticsSettingsOrganizationsResponse, UpdateSecurityHealthAnalyticsSettingsOrganizationsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetVirtualMachineThreatDetectionSettingsOrganizationsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/organizations/{organizationsId}/virtualMachineThreatDetectionSettings" }),
  svc,
) as unknown as Schema.Schema<GetVirtualMachineThreatDetectionSettingsOrganizationsRequest>;

export type GetVirtualMachineThreatDetectionSettingsOrganizationsResponse = VirtualMachineThreatDetectionSettings;
export const GetVirtualMachineThreatDetectionSettingsOrganizationsResponse = VirtualMachineThreatDetectionSettings;

export type GetVirtualMachineThreatDetectionSettingsOrganizationsError = CommonErrors;
...
export const getVirtualMachineThreatDetectionSettingsOrganizations: API.OperationMethod<GetVirtualMachineThreatDetectionSettingsOrganizationsRequest, GetVirtualMachineThreatDetectionSettingsOrganizationsResponse, GetVirtualMachineThreatDetectionSettingsOrganizationsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateVirtualMachineThreatDetectionSettingsOrganizationsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(VirtualMachineThreatDetectionSettings).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1beta2/organizations/{organizationsId}/virtualMachineThreatDetectionSettings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateVirtualMachineThreatDetectionSettingsOrganizationsRequest>;

export type UpdateVirtualMachineThreatDetectionSettingsOrganizationsResponse = VirtualMachineThreatDetectionSettings;
export const UpdateVirtualMachineThreatDetectionSettingsOrganizationsResponse = VirtualMachineThreatDetectionSettings;

export type UpdateVirtualMachineThreatDetectionSettingsOrganizationsError = CommonErrors;

/** Update the VirtualMachineThreatDetectionSettings resource. */
export const updateVirtualMachineThreatDetectionSettingsOrganizations: API.OperationMethod<UpdateVirtualMachineThreatDetectionSettingsOrganizationsRequest, UpdateVirtualMachineThreatDetectionSettingsOrganizationsResponse, UpdateVirtualMachineThreatDetectionSettingsOrganizationsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetRapidVulnerabilityDetectionSettingsOrganizationsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/organizations/{organizationsId}/rapidVulnerabilityDetectionSettings" }),
  svc,
) as unknown as Schema.Schema<GetRapidVulnerabilityDetectionSettingsOrganizationsRequest>;

export type GetRapidVulnerabilityDetectionSettingsOrganizationsResponse = RapidVulnerabilityDetectionSettings;
export const GetRapidVulnerabilityDetectionSettingsOrganizationsResponse = RapidVulnerabilityDetectionSettings;

export type GetRapidVulnerabilityDetectionSettingsOrganizationsError = CommonErrors;
...
export const getRapidVulnerabilityDetectionSettingsOrganizations: API.OperationMethod<GetRapidVulnerabilityDetectionSettingsOrganizationsRequest, GetRapidVulnerabilityDetectionSettingsOrganizationsResponse, GetRapidVulnerabilityDetectionSettingsOrganizationsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateRapidVulnerabilityDetectionSettingsOrganizationsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(RapidVulnerabilityDetectionSettings).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1beta2/organizations/{organizationsId}/rapidVulnerabilityDetectionSettings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateRapidVulnerabilityDetectionSettingsOrganizationsRequest>;

export type UpdateRapidVulnerabilityDetectionSettingsOrganizationsResponse = RapidVulnerabilityDetectionSettings;
export const UpdateRapidVulnerabilityDetectionSettingsOrganizationsResponse = RapidVulnerabilityDetectionSettings;

export type UpdateRapidVulnerabilityDetectionSettingsOrganizationsError = CommonErrors;

/** Update the RapidVulnerabilityDetectionSettings resource. */
export const updateRapidVulnerabilityDetectionSettingsOrganizations: API.OperationMethod<UpdateRapidVulnerabilityDetectionSettingsOrganizationsRequest, UpdateRapidVulnerabilityDetectionSettingsOrganizationsResponse, UpdateRapidVulnerabilityDetectionSettingsOrganizationsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetWebSecurityScannerSettingsOrganizationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta2/organizations/{organizationsId}/webSecurityScannerSettings" }),
  svc,
) as unknown as Schema.Schema<GetWebSecurityScannerSettingsOrganizationsRequest>;

export type GetWebSecurityScannerSettingsOrganizationsResponse = WebSecurityScannerSettings;
export const GetWebSecurityScannerSettingsOrganizationsResponse = WebSecurityScannerSettings;

export type GetWebSecurityScannerSettingsOrganizationsError = CommonErrors;
...
export const getWebSecurityScannerSettingsOrganizations: API.OperationMethod<GetWebSecurityScannerSettingsOrganizationsRequest, GetWebSecurityScannerSettingsOrganizationsResponse, GetWebSecurityScannerSettingsOrganizationsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateWebSecurityScannerSettingsOrganizationsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(WebSecurityScannerSettings).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1beta2/organizations/{organizationsId}/webSecurityScannerSettings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateWebSecurityScannerSettingsOrganizationsRequest>;

export type UpdateWebSecurityScannerSettingsOrganizationsResponse = WebSecurityScannerSettings;
export const UpdateWebSecurityScannerSettingsOrganizationsResponse = WebSecurityScannerSettings;

export type UpdateWebSecurityScannerSettingsOrganizationsError = CommonErrors;

/** Update the WebSecurityScannerSettings resource. */
export const updateWebSecurityScannerSettingsOrganizations: API.OperationMethod<UpdateWebSecurityScannerSettingsOrganizationsRequest, UpdateWebSecurityScannerSettingsOrganizationsResponse, UpdateWebSecurityScannerSettingsOrganizationsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CalculateOrganizationsContainerThreatDetectionSettingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  showEligibleModulesOnly: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("showEligibleModulesOnly")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/organizations/{organizationsId}/containerThreatDetectionSettings:calculate" }),
  svc,
) as unknown as Schema.Schema<CalculateOrganizationsContainerThreatDetectionSettingsRequest>;

export type CalculateOrganizationsContainerThreatDetectionSettingsResponse = ContainerThreatDetectionSettings;
export const CalculateOrganizationsContainerThreatDetectionSettingsResponse = ContainerThreatDetectionSettings;

export type CalculateOrganizationsContainerThreatDetectionSettingsError = CommonErrors;
...
export const calculateOrganizationsContainerThreatDetectionSettings: API.OperationMethod<CalculateOrganizationsContainerThreatDetectionSettingsRequest, CalculateOrganizationsContainerThreatDetectionSettingsResponse, CalculateOrganizationsContainerThreatDetectionSettingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CalculateOrganizationsEventThreatDetectionSettingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  showEligibleModulesOnly: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("showEligibleModulesOnly")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/organizations/{organizationsId}/eventThreatDetectionSettings:calculate" }),
  svc,
) as unknown as Schema.Schema<CalculateOrganizationsEventThreatDetectionSettingsRequest>;

export type CalculateOrganizationsEventThreatDetectionSettingsResponse = EventThreatDetectionSettings;
export const CalculateOrganizationsEventThreatDetectionSettingsResponse = EventThreatDetectionSettings;

export type CalculateOrganizationsEventThreatDetectionSettingsError = CommonErrors;
...
export const calculateOrganizationsEventThreatDetectionSettings: API.OperationMethod<CalculateOrganizationsEventThreatDetectionSettingsRequest, CalculateOrganizationsEventThreatDetectionSettingsResponse, CalculateOrganizationsEventThreatDetectionSettingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CalculateOrganizationsSecurityHealthAnalyticsSettingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  showEligibleModulesOnly: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("showEligibleModulesOnly")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/organizations/{organizationsId}/securityHealthAnalyticsSettings:calculate" }),
  svc,
) as unknown as Schema.Schema<CalculateOrganizationsSecurityHealthAnalyticsSettingsRequest>;

export type CalculateOrganizationsSecurityHealthAnalyticsSettingsResponse = SecurityHealthAnalyticsSettings;
export const CalculateOrganizationsSecurityHealthAnalyticsSettingsResponse = SecurityHealthAnalyticsSettings;

export type CalculateOrganizationsSecurityHealthAnalyticsSettingsError = CommonErrors;
...
export const calculateOrganizationsSecurityHealthAnalyticsSettings: API.OperationMethod<CalculateOrganizationsSecurityHealthAnalyticsSettingsRequest, CalculateOrganizationsSecurityHealthAnalyticsSettingsResponse, CalculateOrganizationsSecurityHealthAnalyticsSettingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CalculateOrganizationsVirtualMachineThreatDetectionSettingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  showEligibleModulesOnly: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("showEligibleModulesOnly")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/organizations/{organizationsId}/virtualMachineThreatDetectionSettings:calculate" }),
  svc,
) as unknown as Schema.Schema<CalculateOrganizationsVirtualMachineThreatDetectionSettingsRequest>;

export type CalculateOrganizationsVirtualMachineThreatDetectionSettingsResponse = VirtualMachineThreatDetectionSettings;
export const CalculateOrganizationsVirtualMachineThreatDetectionSettingsResponse = VirtualMachineThreatDetectionSettings;

export type CalculateOrganizationsVirtualMachineThreatDetectionSettingsError = CommonErrors;
...
export const calculateOrganizationsVirtualMachineThreatDetectionSettings: API.OperationMethod<CalculateOrganizationsVirtualMachineThreatDetectionSettingsRequest, CalculateOrganizationsVirtualMachineThreatDetectionSettingsResponse, CalculateOrganizationsVirtualMachineThreatDetectionSettingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CalculateOrganizationsRapidVulnerabilityDetectionSettingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/organizations/{organizationsId}/rapidVulnerabilityDetectionSettings:calculate" }),
  svc,
) as unknown as Schema.Schema<CalculateOrganizationsRapidVulnerabilityDetectionSettingsRequest>;

export type CalculateOrganizationsRapidVulnerabilityDetectionSettingsResponse = RapidVulnerabilityDetectionSettings;
export const CalculateOrganizationsRapidVulnerabilityDetectionSettingsResponse = RapidVulnerabilityDetectionSettings;

export type CalculateOrganizationsRapidVulnerabilityDetectionSettingsError = CommonErrors;
...
export const calculateOrganizationsRapidVulnerabilityDetectionSettings: API.OperationMethod<CalculateOrganizationsRapidVulnerabilityDetectionSettingsRequest, CalculateOrganizationsRapidVulnerabilityDetectionSettingsResponse, CalculateOrganizationsRapidVulnerabilityDetectionSettingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CalculateOrganizationsWebSecurityScannerSettingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  showEligibleModulesOnly: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("showEligibleModulesOnly")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/organizations/{organizationsId}/webSecurityScannerSettings:calculate" }),
  svc,
) as unknown as Schema.Schema<CalculateOrganizationsWebSecurityScannerSettingsRequest>;

export type CalculateOrganizationsWebSecurityScannerSettingsResponse = WebSecurityScannerSettings;
export const CalculateOrganizationsWebSecurityScannerSettingsResponse = WebSecurityScannerSettings;

export type CalculateOrganizationsWebSecurityScannerSettingsError = CommonErrors;
...
export const calculateOrganizationsWebSecurityScannerSettings: API.OperationMethod<CalculateOrganizationsWebSecurityScannerSettingsRequest, CalculateOrganizationsWebSecurityScannerSettingsResponse, CalculateOrganizationsWebSecurityScannerSettingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetSecurityCenterSettingsFoldersRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta2/folders/{foldersId}/securityCenterSettings" }),
  svc,
...
export type GetSecurityCenterSettingsFoldersError = CommonErrors;

/** Get the SecurityCenterSettings resource. */
export const getSecurityCenterSettingsFolders: API.OperationMethod<GetSecurityCenterSettingsFoldersRequest, GetSecurityCenterSettingsFoldersResponse, GetSecurityCenterSettingsFoldersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetContainerThreatDetectionSettingsFoldersRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta2/folders/{foldersId}/containerThreatDetectionSettings" }),
  svc,
) as unknown as Schema.Schema<GetContainerThreatDetectionSettingsFoldersRequest>;

export type GetContainerThreatDetectionSettingsFoldersResponse = ContainerThreatDetectionSettings;
export const GetContainerThreatDetectionSettingsFoldersResponse = ContainerThreatDetectionSettings;

export type GetContainerThreatDetectionSettingsFoldersError = CommonErrors;

/** Get the ContainerThreatDetectionSettings resource. In the returned settings response, a missing field only indicates that it was not explicitly set, so no assumption should be made about these fields. In other words, GetContainerThreatDetectionSettings does not calculate the effective service settings for the resource, which accounts for inherited settings and defaults. Instead, use CalculateContainerThreatDetectionSettings for this purpose. */
export const getContainerThreatDetectionSettingsFolders: API.OperationMethod<GetContainerThreatDetectionSettingsFoldersRequest, GetContainerThreatDetectionSettingsFoldersResponse, GetContainerThreatDetectionSettingsFoldersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateContainerThreatDetectionSettingsFoldersRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(ContainerThreatDetectionSettings).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1beta2/folders/{foldersId}/containerThreatDetectionSettings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateContainerThreatDetectionSettingsFoldersRequest>;

export type UpdateContainerThreatDetectionSettingsFoldersResponse = ContainerThreatDetectionSettings;
export const UpdateContainerThreatDetectionSettingsFoldersResponse = ContainerThreatDetectionSettings;

export type UpdateContainerThreatDetectionSettingsFoldersError = CommonErrors;

/** Update the ContainerThreatDetectionSettings resource. */
export const updateContainerThreatDetectionSettingsFolders: API.OperationMethod<UpdateContainerThreatDetectionSettingsFoldersRequest, UpdateContainerThreatDetectionSettingsFoldersResponse, UpdateContainerThreatDetectionSettingsFoldersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetEventThreatDetectionSettingsFoldersRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta2/folders/{foldersId}/eventThreatDetectionSettings" }),
  svc,
) as unknown as Schema.Schema<GetEventThreatDetectionSettingsFoldersRequest>;

export type GetEventThreatDetectionSettingsFoldersResponse = EventThreatDetectionSettings;
export const GetEventThreatDetectionSettingsFoldersResponse = EventThreatDetectionSettings;

export type GetEventThreatDetectionSettingsFoldersError = CommonErrors;

/** Get the EventThreatDetectionSettings resource. In the returned settings response, a missing field only indicates that it was not explicitly set, so no assumption should be made about these fields. In other words, GetEventThreatDetectionSettings does not calculate the effective service settings for the resource, which accounts for inherited settings and defaults. Instead, use CalculateEventThreatDetectionSettings for this purpose. */
export const getEventThreatDetectionSettingsFolders: API.OperationMethod<GetEventThreatDetectionSettingsFoldersRequest, GetEventThreatDetectionSettingsFoldersResponse, GetEventThreatDetectionSettingsFoldersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateEventThreatDetectionSettingsFoldersRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1beta2/folders/{foldersId}/eventThreatDetectionSettings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateEventThreatDetectionSettingsFoldersRequest>;

export type UpdateEventThreatDetectionSettingsFoldersResponse = EventThreatDetectionSettings;
export const UpdateEventThreatDetectionSettingsFoldersResponse = EventThreatDetectionSettings;

export type UpdateEventThreatDetectionSettingsFoldersError = CommonErrors;

/** Update the EventThreatDetectionSettings resource. */
export const updateEventThreatDetectionSettingsFolders: API.OperationMethod<UpdateEventThreatDetectionSettingsFoldersRequest, UpdateEventThreatDetectionSettingsFoldersResponse, UpdateEventThreatDetectionSettingsFoldersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetSecurityHealthAnalyticsSettingsFoldersRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta2/folders/{foldersId}/securityHealthAnalyticsSettings" }),
  svc,
) as unknown as Schema.Schema<GetSecurityHealthAnalyticsSettingsFoldersRequest>;

export type GetSecurityHealthAnalyticsSettingsFoldersResponse = SecurityHealthAnalyticsSettings;
export const GetSecurityHealthAnalyticsSettingsFoldersResponse = SecurityHealthAnalyticsSettings;

export type GetSecurityHealthAnalyticsSettingsFoldersError = CommonErrors;

/** Get the SecurityHealthAnalyticsSettings resource. In the returned settings response, a missing field only indicates that it was not explicitly set, so no assumption should be made about these fields. In other words, GetSecurityHealthAnalyticsSettings does not calculate the effective service settings for the resource, which accounts for inherited settings and defaults. Instead, use CalculateSecurityHealthAnalyticsSettings for this purpose. */
export const getSecurityHealthAnalyticsSettingsFolders: API.OperationMethod<GetSecurityHealthAnalyticsSettingsFoldersRequest, GetSecurityHealthAnalyticsSettingsFoldersResponse, GetSecurityHealthAnalyticsSettingsFoldersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateSecurityHealthAnalyticsSettingsFoldersRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(SecurityHealthAnalyticsSettings).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1beta2/folders/{foldersId}/securityHealthAnalyticsSettings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateSecurityHealthAnalyticsSettingsFoldersRequest>;

export type UpdateSecurityHealthAnalyticsSettingsFoldersResponse = SecurityHealthAnalyticsSettings;
export const UpdateSecurityHealthAnalyticsSettingsFoldersResponse = SecurityHealthAnalyticsSettings;

export type UpdateSecurityHealthAnalyticsSettingsFoldersError = CommonErrors;

/** Update the SecurityHealthAnalyticsSettings resource. */
export const updateSecurityHealthAnalyticsSettingsFolders: API.OperationMethod<UpdateSecurityHealthAnalyticsSettingsFoldersRequest, UpdateSecurityHealthAnalyticsSettingsFoldersResponse, UpdateSecurityHealthAnalyticsSettingsFoldersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetVirtualMachineThreatDetectionSettingsFoldersRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/folders/{foldersId}/virtualMachineThreatDetectionSettings" }),
  svc,
) as unknown as Schema.Schema<GetVirtualMachineThreatDetectionSettingsFoldersRequest>;

export type GetVirtualMachineThreatDetectionSettingsFoldersResponse = VirtualMachineThreatDetectionSettings;
export const GetVirtualMachineThreatDetectionSettingsFoldersResponse = VirtualMachineThreatDetectionSettings;

export type GetVirtualMachineThreatDetectionSettingsFoldersError = CommonErrors;

/** Get the VirtualMachineThreatDetectionSettings resource. In the returned settings response, a missing field only indicates that it was not explicitly set, so no assumption should be made about these fields. In other words, GetVirtualMachineThreatDetectionSettings does not calculate the effective service settings for the resource, which accounts for inherited settings and defaults. Instead, use CalculateVirtualMachineThreatDetectionSettings for this purpose. */
export const getVirtualMachineThreatDetectionSettingsFolders: API.OperationMethod<GetVirtualMachineThreatDetectionSettingsFoldersRequest, GetVirtualMachineThreatDetectionSettingsFoldersResponse, GetVirtualMachineThreatDetectionSettingsFoldersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateVirtualMachineThreatDetectionSettingsFoldersRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(VirtualMachineThreatDetectionSettings).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1beta2/folders/{foldersId}/virtualMachineThreatDetectionSettings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateVirtualMachineThreatDetectionSettingsFoldersRequest>;

export type UpdateVirtualMachineThreatDetectionSettingsFoldersResponse = VirtualMachineThreatDetectionSettings;
export const UpdateVirtualMachineThreatDetectionSettingsFoldersResponse = VirtualMachineThreatDetectionSettings;

export type UpdateVirtualMachineThreatDetectionSettingsFoldersError = CommonErrors;

/** Update the VirtualMachineThreatDetectionSettings resource. */
export const updateVirtualMachineThreatDetectionSettingsFolders: API.OperationMethod<UpdateVirtualMachineThreatDetectionSettingsFoldersRequest, UpdateVirtualMachineThreatDetectionSettingsFoldersResponse, UpdateVirtualMachineThreatDetectionSettingsFoldersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetRapidVulnerabilityDetectionSettingsFoldersRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/folders/{foldersId}/rapidVulnerabilityDetectionSettings" }),
  svc,
) as unknown as Schema.Schema<GetRapidVulnerabilityDetectionSettingsFoldersRequest>;

export type GetRapidVulnerabilityDetectionSettingsFoldersResponse = RapidVulnerabilityDetectionSettings;
export const GetRapidVulnerabilityDetectionSettingsFoldersResponse = RapidVulnerabilityDetectionSettings;

export type GetRapidVulnerabilityDetectionSettingsFoldersError = CommonErrors;

/** Get the RapidVulnerabilityDetectionSettings resource. In the returned settings response, a missing field only indicates that it was not explicitly set, so no assumption should be made about these fields. In other words, GetRapidVulnerabilityDetectionSettings does not calculate the effective service settings for the resource, which accounts for inherited settings and defaults. Instead, use CalculateRapidVulnerabilityDetectionSettings for this purpose. */
export const getRapidVulnerabilityDetectionSettingsFolders: API.OperationMethod<GetRapidVulnerabilityDetectionSettingsFoldersRequest, GetRapidVulnerabilityDetectionSettingsFoldersResponse, GetRapidVulnerabilityDetectionSettingsFoldersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateRapidVulnerabilityDetectionSettingsFoldersRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(RapidVulnerabilityDetectionSettings).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1beta2/folders/{foldersId}/rapidVulnerabilityDetectionSettings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateRapidVulnerabilityDetectionSettingsFoldersRequest>;

export type UpdateRapidVulnerabilityDetectionSettingsFoldersResponse = RapidVulnerabilityDetectionSettings;
export const UpdateRapidVulnerabilityDetectionSettingsFoldersResponse = RapidVulnerabilityDetectionSettings;

export type UpdateRapidVulnerabilityDetectionSettingsFoldersError = CommonErrors;

/** Update the RapidVulnerabilityDetectionSettings resource. */
export const updateRapidVulnerabilityDetectionSettingsFolders: API.OperationMethod<UpdateRapidVulnerabilityDetectionSettingsFoldersRequest, UpdateRapidVulnerabilityDetectionSettingsFoldersResponse, UpdateRapidVulnerabilityDetectionSettingsFoldersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetWebSecurityScannerSettingsFoldersRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta2/folders/{foldersId}/webSecurityScannerSettings" }),
  svc,
) as unknown as Schema.Schema<GetWebSecurityScannerSettingsFoldersRequest>;

export type GetWebSecurityScannerSettingsFoldersResponse = WebSecurityScannerSettings;
export const GetWebSecurityScannerSettingsFoldersResponse = WebSecurityScannerSettings;

export type GetWebSecurityScannerSettingsFoldersError = CommonErrors;

/** Get the WebSecurityScannerSettings resource. In the returned settings response, a missing field only indicates that it was not explicitly set, so no assumption should be made about these fields. In other words, GetWebSecurityScannerSettings does not calculate the effective service settings for the resource, which accounts for inherited settings and defaults. Instead, use CalculateWebSecurityScannerSettings for this purpose. */
export const getWebSecurityScannerSettingsFolders: API.OperationMethod<GetWebSecurityScannerSettingsFoldersRequest, GetWebSecurityScannerSettingsFoldersResponse, GetWebSecurityScannerSettingsFoldersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateWebSecurityScannerSettingsFoldersRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1beta2/folders/{foldersId}/webSecurityScannerSettings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateWebSecurityScannerSettingsFoldersRequest>;

export type UpdateWebSecurityScannerSettingsFoldersResponse = WebSecurityScannerSettings;
export const UpdateWebSecurityScannerSettingsFoldersResponse = WebSecurityScannerSettings;

export type UpdateWebSecurityScannerSettingsFoldersError = CommonErrors;

/** Update the WebSecurityScannerSettings resource. */
export const updateWebSecurityScannerSettingsFolders: API.OperationMethod<UpdateWebSecurityScannerSettingsFoldersRequest, UpdateWebSecurityScannerSettingsFoldersResponse, UpdateWebSecurityScannerSettingsFoldersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CalculateFoldersContainerThreatDetectionSettingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  showEligibleModulesOnly: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("showEligibleModulesOnly")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/folders/{foldersId}/containerThreatDetectionSettings:calculate" }),
  svc,
) as unknown as Schema.Schema<CalculateFoldersContainerThreatDetectionSettingsRequest>;

export type CalculateFoldersContainerThreatDetectionSettingsResponse = ContainerThreatDetectionSettings;
export const CalculateFoldersContainerThreatDetectionSettingsResponse = ContainerThreatDetectionSettings;

export type CalculateFoldersContainerThreatDetectionSettingsError = CommonErrors;

/** Calculates the effective ContainerThreatDetectionSettings based on its level in the resource hierarchy and its settings. Settings provided closer to the target resource take precedence over those further away (e.g. folder will override organization level settings). The default SCC setting for the detector service defaults can be overridden at organization, folder and project levels. No assumptions should be made about the SCC defaults as it is considered an internal implementation detail. */
export const calculateFoldersContainerThreatDetectionSettings: API.OperationMethod<CalculateFoldersContainerThreatDetectionSettingsRequest, CalculateFoldersContainerThreatDetectionSettingsResponse, CalculateFoldersContainerThreatDetectionSettingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CalculateFoldersEventThreatDetectionSettingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  showEligibleModulesOnly: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("showEligibleModulesOnly")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/folders/{foldersId}/eventThreatDetectionSettings:calculate" }),
  svc,
) as unknown as Schema.Schema<CalculateFoldersEventThreatDetectionSettingsRequest>;

export type CalculateFoldersEventThreatDetectionSettingsResponse = EventThreatDetectionSettings;
export const CalculateFoldersEventThreatDetectionSettingsResponse = EventThreatDetectionSettings;

export type CalculateFoldersEventThreatDetectionSettingsError = CommonErrors;

/** Calculates the effective EventThreatDetectionSettings based on its level in the resource hierarchy and its settings. Settings provided closer to the target resource take precedence over those further away (e.g. folder will override organization level settings). The default SCC setting for the detector service defaults can be overridden at organization, folder and project levels. No assumptions should be made about the SCC defaults as it is considered an internal implementation detail. */
export const calculateFoldersEventThreatDetectionSettings: API.OperationMethod<CalculateFoldersEventThreatDetectionSettingsRequest, CalculateFoldersEventThreatDetectionSettingsResponse, CalculateFoldersEventThreatDetectionSettingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CalculateFoldersSecurityHealthAnalyticsSettingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  showEligibleModulesOnly: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("showEligibleModulesOnly")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/folders/{foldersId}/securityHealthAnalyticsSettings:calculate" }),
  svc,
) as unknown as Schema.Schema<CalculateFoldersSecurityHealthAnalyticsSettingsRequest>;

export type CalculateFoldersSecurityHealthAnalyticsSettingsResponse = SecurityHealthAnalyticsSettings;
export const CalculateFoldersSecurityHealthAnalyticsSettingsResponse = SecurityHealthAnalyticsSettings;

export type CalculateFoldersSecurityHealthAnalyticsSettingsError = CommonErrors;

/** Calculates the effective SecurityHealthAnalyticsSettings based on its level in the resource hierarchy and its settings. Settings provided closer to the target resource take precedence over those further away (e.g. folder will override organization level settings). The default SCC setting for the detector service defaults can be overridden at organization, folder and project levels. No assumptions should be made about the SCC defaults as it is considered an internal implementation detail. */
export const calculateFoldersSecurityHealthAnalyticsSettings: API.OperationMethod<CalculateFoldersSecurityHealthAnalyticsSettingsRequest, CalculateFoldersSecurityHealthAnalyticsSettingsResponse, CalculateFoldersSecurityHealthAnalyticsSettingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CalculateFoldersVirtualMachineThreatDetectionSettingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  showEligibleModulesOnly: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("showEligibleModulesOnly")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/folders/{foldersId}/virtualMachineThreatDetectionSettings:calculate" }),
  svc,
) as unknown as Schema.Schema<CalculateFoldersVirtualMachineThreatDetectionSettingsRequest>;

export type CalculateFoldersVirtualMachineThreatDetectionSettingsResponse = VirtualMachineThreatDetectionSettings;
export const CalculateFoldersVirtualMachineThreatDetectionSettingsResponse = VirtualMachineThreatDetectionSettings;

export type CalculateFoldersVirtualMachineThreatDetectionSettingsError = CommonErrors;

/** Calculates the effective VirtualMachineThreatDetectionSettings based on its level in the resource hierarchy and its settings. Settings provided closer to the target resource take precedence over those further away (e.g. folder will override organization level settings). The default SCC setting for the detector service defaults can be overridden at organization, folder and project levels. No assumptions should be made about the SCC defaults as it is considered an internal implementation detail. */
export const calculateFoldersVirtualMachineThreatDetectionSettings: API.OperationMethod<CalculateFoldersVirtualMachineThreatDetectionSettingsRequest, CalculateFoldersVirtualMachineThreatDetectionSettingsResponse, CalculateFoldersVirtualMachineThreatDetectionSettingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CalculateFoldersRapidVulnerabilityDetectionSettingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/folders/{foldersId}/rapidVulnerabilityDetectionSettings:calculate" }),
  svc,
) as unknown as Schema.Schema<CalculateFoldersRapidVulnerabilityDetectionSettingsRequest>;

export type CalculateFoldersRapidVulnerabilityDetectionSettingsResponse = RapidVulnerabilityDetectionSettings;
export const CalculateFoldersRapidVulnerabilityDetectionSettingsResponse = RapidVulnerabilityDetectionSettings;

export type CalculateFoldersRapidVulnerabilityDetectionSettingsError = CommonErrors;

/** Calculates the effective RapidVulnerabilityDetectionSettings based on its level in the resource hierarchy and its settings. Settings provided closer to the target resource take precedence over those further away (e.g. folder will override organization level settings). The default SCC setting for the detector service defaults can be overridden at organization, folder and project levels. No assumptions should be made about the SCC defaults as it is considered an internal implementation detail. */
export const calculateFoldersRapidVulnerabilityDetectionSettings: API.OperationMethod<CalculateFoldersRapidVulnerabilityDetectionSettingsRequest, CalculateFoldersRapidVulnerabilityDetectionSettingsResponse, CalculateFoldersRapidVulnerabilityDetectionSettingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CalculateFoldersWebSecurityScannerSettingsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta2/folders/{foldersId}/webSecurityScannerSettings:calculate" }),
  svc,
) as unknown as Schema.Schema<CalculateFoldersWebSecurityScannerSettingsRequest>;

export type CalculateFoldersWebSecurityScannerSettingsResponse = WebSecurityScannerSettings;
export const CalculateFoldersWebSecurityScannerSettingsResponse = WebSecurityScannerSettings;

export type CalculateFoldersWebSecurityScannerSettingsError = CommonErrors;

/** Calculates the effective WebSecurityScannerSettings based on its level in the resource hierarchy and its settings. Settings provided closer to the target resource take precedence over those further away (e.g. folder will override organization level settings). The default SCC setting for the detector service defaults can be overridden at organization, folder and project levels. No assumptions should be made about the SCC defaults as it is considered an internal implementation detail. */
export const calculateFoldersWebSecurityScannerSettings: API.OperationMethod<CalculateFoldersWebSecurityScannerSettingsRequest, CalculateFoldersWebSecurityScannerSettingsResponse, CalculateFoldersWebSecurityScannerSettingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetSecurityCenterSettingsProjectsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta2/projects/{projectsId}/securityCenterSettings" }),
  svc,
...
export type GetSecurityCenterSettingsProjectsError = CommonErrors;

/** Get the SecurityCenterSettings resource. */
export const getSecurityCenterSettingsProjects: API.OperationMethod<GetSecurityCenterSettingsProjectsRequest, GetSecurityCenterSettingsProjectsResponse, GetSecurityCenterSettingsProjectsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetContainerThreatDetectionSettingsProjectsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta2/projects/{projectsId}/containerThreatDetectionSettings" }),
  svc,
) as unknown as Schema.Schema<GetContainerThreatDetectionSettingsProjectsRequest>;

export type GetContainerThreatDetectionSettingsProjectsResponse = ContainerThreatDetectionSettings;
export const GetContainerThreatDetectionSettingsProjectsResponse = ContainerThreatDetectionSettings;

export type GetContainerThreatDetectionSettingsProjectsError = CommonErrors;

/** Get the ContainerThreatDetectionSettings resource. In the returned settings response, a missing field only indicates that it was not explicitly set, so no assumption should be made about these fields. In other words, GetContainerThreatDetectionSettings does not calculate the effective service settings for the resource, which accounts for inherited settings and defaults. Instead, use CalculateContainerThreatDetectionSettings for this purpose. */
export const getContainerThreatDetectionSettingsProjects: API.OperationMethod<GetContainerThreatDetectionSettingsProjectsRequest, GetContainerThreatDetectionSettingsProjectsResponse, GetContainerThreatDetectionSettingsProjectsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateContainerThreatDetectionSettingsProjectsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(ContainerThreatDetectionSettings).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1beta2/projects/{projectsId}/containerThreatDetectionSettings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateContainerThreatDetectionSettingsProjectsRequest>;

export type UpdateContainerThreatDetectionSettingsProjectsResponse = ContainerThreatDetectionSettings;
export const UpdateContainerThreatDetectionSettingsProjectsResponse = ContainerThreatDetectionSettings;

export type UpdateContainerThreatDetectionSettingsProjectsError = CommonErrors;

/** Update the ContainerThreatDetectionSettings resource. */
export const updateContainerThreatDetectionSettingsProjects: API.OperationMethod<UpdateContainerThreatDetectionSettingsProjectsRequest, UpdateContainerThreatDetectionSettingsProjectsResponse, UpdateContainerThreatDetectionSettingsProjectsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetEventThreatDetectionSettingsProjectsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta2/projects/{projectsId}/eventThreatDetectionSettings" }),
  svc,
) as unknown as Schema.Schema<GetEventThreatDetectionSettingsProjectsRequest>;

export type GetEventThreatDetectionSettingsProjectsResponse = EventThreatDetectionSettings;
export const GetEventThreatDetectionSettingsProjectsResponse = EventThreatDetectionSettings;

export type GetEventThreatDetectionSettingsProjectsError = CommonErrors;

/** Get the EventThreatDetectionSettings resource. In the returned settings response, a missing field only indicates that it was not explicitly set, so no assumption should be made about these fields. In other words, GetEventThreatDetectionSettings does not calculate the effective service settings for the resource, which accounts for inherited settings and defaults. Instead, use CalculateEventThreatDetectionSettings for this purpose. */
export const getEventThreatDetectionSettingsProjects: API.OperationMethod<GetEventThreatDetectionSettingsProjectsRequest, GetEventThreatDetectionSettingsProjectsResponse, GetEventThreatDetectionSettingsProjectsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateEventThreatDetectionSettingsProjectsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1beta2/projects/{projectsId}/eventThreatDetectionSettings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateEventThreatDetectionSettingsProjectsRequest>;

export type UpdateEventThreatDetectionSettingsProjectsResponse = EventThreatDetectionSettings;
export const UpdateEventThreatDetectionSettingsProjectsResponse = EventThreatDetectionSettings;

export type UpdateEventThreatDetectionSettingsProjectsError = CommonErrors;

/** Update the EventThreatDetectionSettings resource. */
export const updateEventThreatDetectionSettingsProjects: API.OperationMethod<UpdateEventThreatDetectionSettingsProjectsRequest, UpdateEventThreatDetectionSettingsProjectsResponse, UpdateEventThreatDetectionSettingsProjectsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetSecurityHealthAnalyticsSettingsProjectsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta2/projects/{projectsId}/securityHealthAnalyticsSettings" }),
  svc,
) as unknown as Schema.Schema<GetSecurityHealthAnalyticsSettingsProjectsRequest>;

export type GetSecurityHealthAnalyticsSettingsProjectsResponse = SecurityHealthAnalyticsSettings;
export const GetSecurityHealthAnalyticsSettingsProjectsResponse = SecurityHealthAnalyticsSettings;

export type GetSecurityHealthAnalyticsSettingsProjectsError = CommonErrors;

/** Get the SecurityHealthAnalyticsSettings resource. In the returned settings response, a missing field only indicates that it was not explicitly set, so no assumption should be made about these fields. In other words, GetSecurityHealthAnalyticsSettings does not calculate the effective service settings for the resource, which accounts for inherited settings and defaults. Instead, use CalculateSecurityHealthAnalyticsSettings for this purpose. */
export const getSecurityHealthAnalyticsSettingsProjects: API.OperationMethod<GetSecurityHealthAnalyticsSettingsProjectsRequest, GetSecurityHealthAnalyticsSettingsProjectsResponse, GetSecurityHealthAnalyticsSettingsProjectsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateSecurityHealthAnalyticsSettingsProjectsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(SecurityHealthAnalyticsSettings).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1beta2/projects/{projectsId}/securityHealthAnalyticsSettings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateSecurityHealthAnalyticsSettingsProjectsRequest>;

export type UpdateSecurityHealthAnalyticsSettingsProjectsResponse = SecurityHealthAnalyticsSettings;
export const UpdateSecurityHealthAnalyticsSettingsProjectsResponse = SecurityHealthAnalyticsSettings;

export type UpdateSecurityHealthAnalyticsSettingsProjectsError = CommonErrors;

/** Update the SecurityHealthAnalyticsSettings resource. */
export const updateSecurityHealthAnalyticsSettingsProjects: API.OperationMethod<UpdateSecurityHealthAnalyticsSettingsProjectsRequest, UpdateSecurityHealthAnalyticsSettingsProjectsResponse, UpdateSecurityHealthAnalyticsSettingsProjectsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetVirtualMachineThreatDetectionSettingsProjectsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/projects/{projectsId}/virtualMachineThreatDetectionSettings" }),
  svc,
) as unknown as Schema.Schema<GetVirtualMachineThreatDetectionSettingsProjectsRequest>;

export type GetVirtualMachineThreatDetectionSettingsProjectsResponse = VirtualMachineThreatDetectionSettings;
export const GetVirtualMachineThreatDetectionSettingsProjectsResponse = VirtualMachineThreatDetectionSettings;

export type GetVirtualMachineThreatDetectionSettingsProjectsError = CommonErrors;

/** Get the VirtualMachineThreatDetectionSettings resource. In the returned settings response, a missing field only indicates that it was not explicitly set, so no assumption should be made about these fields. In other words, GetVirtualMachineThreatDetectionSettings does not calculate the effective service settings for the resource, which accounts for inherited settings and defaults. Instead, use CalculateVirtualMachineThreatDetectionSettings for this purpose. */
export const getVirtualMachineThreatDetectionSettingsProjects: API.OperationMethod<GetVirtualMachineThreatDetectionSettingsProjectsRequest, GetVirtualMachineThreatDetectionSettingsProjectsResponse, GetVirtualMachineThreatDetectionSettingsProjectsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateVirtualMachineThreatDetectionSettingsProjectsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(VirtualMachineThreatDetectionSettings).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1beta2/projects/{projectsId}/virtualMachineThreatDetectionSettings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateVirtualMachineThreatDetectionSettingsProjectsRequest>;

export type UpdateVirtualMachineThreatDetectionSettingsProjectsResponse = VirtualMachineThreatDetectionSettings;
export const UpdateVirtualMachineThreatDetectionSettingsProjectsResponse = VirtualMachineThreatDetectionSettings;

export type UpdateVirtualMachineThreatDetectionSettingsProjectsError = CommonErrors;

/** Update the VirtualMachineThreatDetectionSettings resource. */
export const updateVirtualMachineThreatDetectionSettingsProjects: API.OperationMethod<UpdateVirtualMachineThreatDetectionSettingsProjectsRequest, UpdateVirtualMachineThreatDetectionSettingsProjectsResponse, UpdateVirtualMachineThreatDetectionSettingsProjectsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetRapidVulnerabilityDetectionSettingsProjectsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/projects/{projectsId}/rapidVulnerabilityDetectionSettings" }),
  svc,
) as unknown as Schema.Schema<GetRapidVulnerabilityDetectionSettingsProjectsRequest>;

export type GetRapidVulnerabilityDetectionSettingsProjectsResponse = RapidVulnerabilityDetectionSettings;
export const GetRapidVulnerabilityDetectionSettingsProjectsResponse = RapidVulnerabilityDetectionSettings;

export type GetRapidVulnerabilityDetectionSettingsProjectsError = CommonErrors;

/** Get the RapidVulnerabilityDetectionSettings resource. In the returned settings response, a missing field only indicates that it was not explicitly set, so no assumption should be made about these fields. In other words, GetRapidVulnerabilityDetectionSettings does not calculate the effective service settings for the resource, which accounts for inherited settings and defaults. Instead, use CalculateRapidVulnerabilityDetectionSettings for this purpose. */
export const getRapidVulnerabilityDetectionSettingsProjects: API.OperationMethod<GetRapidVulnerabilityDetectionSettingsProjectsRequest, GetRapidVulnerabilityDetectionSettingsProjectsResponse, GetRapidVulnerabilityDetectionSettingsProjectsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateRapidVulnerabilityDetectionSettingsProjectsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(RapidVulnerabilityDetectionSettings).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1beta2/projects/{projectsId}/rapidVulnerabilityDetectionSettings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateRapidVulnerabilityDetectionSettingsProjectsRequest>;

export type UpdateRapidVulnerabilityDetectionSettingsProjectsResponse = RapidVulnerabilityDetectionSettings;
export const UpdateRapidVulnerabilityDetectionSettingsProjectsResponse = RapidVulnerabilityDetectionSettings;

export type UpdateRapidVulnerabilityDetectionSettingsProjectsError = CommonErrors;

/** Update the RapidVulnerabilityDetectionSettings resource. */
export const updateRapidVulnerabilityDetectionSettingsProjects: API.OperationMethod<UpdateRapidVulnerabilityDetectionSettingsProjectsRequest, UpdateRapidVulnerabilityDetectionSettingsProjectsResponse, UpdateRapidVulnerabilityDetectionSettingsProjectsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetWebSecurityScannerSettingsProjectsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta2/projects/{projectsId}/webSecurityScannerSettings" }),
  svc,
) as unknown as Schema.Schema<GetWebSecurityScannerSettingsProjectsRequest>;

export type GetWebSecurityScannerSettingsProjectsResponse = WebSecurityScannerSettings;
export const GetWebSecurityScannerSettingsProjectsResponse = WebSecurityScannerSettings;

export type GetWebSecurityScannerSettingsProjectsError = CommonErrors;

/** Get the WebSecurityScannerSettings resource. In the returned settings response, a missing field only indicates that it was not explicitly set, so no assumption should be made about these fields. In other words, GetWebSecurityScannerSettings does not calculate the effective service settings for the resource, which accounts for inherited settings and defaults. Instead, use CalculateWebSecurityScannerSettings for this purpose. */
export const getWebSecurityScannerSettingsProjects: API.OperationMethod<GetWebSecurityScannerSettingsProjectsRequest, GetWebSecurityScannerSettingsProjectsResponse, GetWebSecurityScannerSettingsProjectsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateWebSecurityScannerSettingsProjectsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1beta2/projects/{projectsId}/webSecurityScannerSettings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateWebSecurityScannerSettingsProjectsRequest>;

export type UpdateWebSecurityScannerSettingsProjectsResponse = WebSecurityScannerSettings;
export const UpdateWebSecurityScannerSettingsProjectsResponse = WebSecurityScannerSettings;

export type UpdateWebSecurityScannerSettingsProjectsError = CommonErrors;

/** Update the WebSecurityScannerSettings resource. */
export const updateWebSecurityScannerSettingsProjects: API.OperationMethod<UpdateWebSecurityScannerSettingsProjectsRequest, UpdateWebSecurityScannerSettingsProjectsResponse, UpdateWebSecurityScannerSettingsProjectsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetContainerThreatDetectionSettingsProjectsLocationsClustersRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}/containerThreatDetectionSettings" }),
  svc,
) as unknown as Schema.Schema<GetContainerThreatDetectionSettingsProjectsLocationsClustersRequest>;

export type GetContainerThreatDetectionSettingsProjectsLocationsClustersResponse = ContainerThreatDetectionSettings;
export const GetContainerThreatDetectionSettingsProjectsLocationsClustersResponse = ContainerThreatDetectionSettings;

export type GetContainerThreatDetectionSettingsProjectsLocationsClustersError = CommonErrors;

/** Get the ContainerThreatDetectionSettings resource. In the returned settings response, a missing field only indicates that it was not explicitly set, so no assumption should be made about these fields. In other words, GetContainerThreatDetectionSettings does not calculate the effective service settings for the resource, which accounts for inherited settings and defaults. Instead, use CalculateContainerThreatDetectionSettings for this purpose. */
export const getContainerThreatDetectionSettingsProjectsLocationsClusters: API.OperationMethod<GetContainerThreatDetectionSettingsProjectsLocationsClustersRequest, GetContainerThreatDetectionSettingsProjectsLocationsClustersResponse, GetContainerThreatDetectionSettingsProjectsLocationsClustersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateContainerThreatDetectionSettingsProjectsLocationsClustersRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(ContainerThreatDetectionSettings).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1beta2/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}/containerThreatDetectionSettings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateContainerThreatDetectionSettingsProjectsLocationsClustersRequest>;

export type UpdateContainerThreatDetectionSettingsProjectsLocationsClustersResponse = ContainerThreatDetectionSettings;
export const UpdateContainerThreatDetectionSettingsProjectsLocationsClustersResponse = ContainerThreatDetectionSettings;

export type UpdateContainerThreatDetectionSettingsProjectsLocationsClustersError = CommonErrors;

/** Update the ContainerThreatDetectionSettings resource. */
export const updateContainerThreatDetectionSettingsProjectsLocationsClusters: API.OperationMethod<UpdateContainerThreatDetectionSettingsProjectsLocationsClustersRequest, UpdateContainerThreatDetectionSettingsProjectsLocationsClustersResponse, UpdateContainerThreatDetectionSettingsProjectsLocationsClustersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
  input: UpdateContainerThreatDetectionSettingsProjectsLocationsClustersRequest,
  output: UpdateContainerThreatDetectionSettingsProjectsLocationsClustersResponse,
  errors: [],
}));
...
export const CalculateProjectsLocationsClustersContainerThreatDetectionSettingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  showEligibleModulesOnly: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("showEligibleModulesOnly")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}/containerThreatDetectionSettings:calculate" }),
  svc,
) as unknown as Schema.Schema<CalculateProjectsLocationsClustersContainerThreatDetectionSettingsRequest>;

export type CalculateProjectsLocationsClustersContainerThreatDetectionSettingsResponse = ContainerThreatDetectionSettings;
export const CalculateProjectsLocationsClustersContainerThreatDetectionSettingsResponse = ContainerThreatDetectionSettings;

export type CalculateProjectsLocationsClustersContainerThreatDetectionSettingsError = CommonErrors;

/** Calculates the effective ContainerThreatDetectionSettings based on its level in the resource hierarchy and its settings. Settings provided closer to the target resource take precedence over those further away (e.g. folder will override organization level settings). The default SCC setting for the detector service defaults can be overridden at organization, folder and project levels. No assumptions should be made about the SCC defaults as it is considered an internal implementation detail. */
export const calculateProjectsLocationsClustersContainerThreatDetectionSettings: API.OperationMethod<CalculateProjectsLocationsClustersContainerThreatDetectionSettingsRequest, CalculateProjectsLocationsClustersContainerThreatDetectionSettingsResponse, CalculateProjectsLocationsClustersContainerThreatDetectionSettingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
  input: CalculateProjectsLocationsClustersContainerThreatDetectionSettingsRequest,
  output: CalculateProjectsLocationsClustersContainerThreatDetectionSettingsResponse,
  errors: [],
}));
...
export const CalculateProjectsContainerThreatDetectionSettingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  showEligibleModulesOnly: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("showEligibleModulesOnly")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/projects/{projectsId}/containerThreatDetectionSettings:calculate" }),
  svc,
) as unknown as Schema.Schema<CalculateProjectsContainerThreatDetectionSettingsRequest>;

export type CalculateProjectsContainerThreatDetectionSettingsResponse = ContainerThreatDetectionSettings;
export const CalculateProjectsContainerThreatDetectionSettingsResponse = ContainerThreatDetectionSettings;

export type CalculateProjectsContainerThreatDetectionSettingsError = CommonErrors;

/** Calculates the effective ContainerThreatDetectionSettings based on its level in the resource hierarchy and its settings. Settings provided closer to the target resource take precedence over those further away (e.g. folder will override organization level settings). The default SCC setting for the detector service defaults can be overridden at organization, folder and project levels. No assumptions should be made about the SCC defaults as it is considered an internal implementation detail. */
export const calculateProjectsContainerThreatDetectionSettings: API.OperationMethod<CalculateProjectsContainerThreatDetectionSettingsRequest, CalculateProjectsContainerThreatDetectionSettingsResponse, CalculateProjectsContainerThreatDetectionSettingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CalculateProjectsEventThreatDetectionSettingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  showEligibleModulesOnly: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("showEligibleModulesOnly")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/projects/{projectsId}/eventThreatDetectionSettings:calculate" }),
  svc,
) as unknown as Schema.Schema<CalculateProjectsEventThreatDetectionSettingsRequest>;

export type CalculateProjectsEventThreatDetectionSettingsResponse = EventThreatDetectionSettings;
export const CalculateProjectsEventThreatDetectionSettingsResponse = EventThreatDetectionSettings;

export type CalculateProjectsEventThreatDetectionSettingsError = CommonErrors;

/** Calculates the effective EventThreatDetectionSettings based on its level in the resource hierarchy and its settings. Settings provided closer to the target resource take precedence over those further away (e.g. folder will override organization level settings). The default SCC setting for the detector service defaults can be overridden at organization, folder and project levels. No assumptions should be made about the SCC defaults as it is considered an internal implementation detail. */
export const calculateProjectsEventThreatDetectionSettings: API.OperationMethod<CalculateProjectsEventThreatDetectionSettingsRequest, CalculateProjectsEventThreatDetectionSettingsResponse, CalculateProjectsEventThreatDetectionSettingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CalculateProjectsSecurityHealthAnalyticsSettingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  showEligibleModulesOnly: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("showEligibleModulesOnly")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/projects/{projectsId}/securityHealthAnalyticsSettings:calculate" }),
  svc,
) as unknown as Schema.Schema<CalculateProjectsSecurityHealthAnalyticsSettingsRequest>;

export type CalculateProjectsSecurityHealthAnalyticsSettingsResponse = SecurityHealthAnalyticsSettings;
export const CalculateProjectsSecurityHealthAnalyticsSettingsResponse = SecurityHealthAnalyticsSettings;

export type CalculateProjectsSecurityHealthAnalyticsSettingsError = CommonErrors;

/** Calculates the effective SecurityHealthAnalyticsSettings based on its level in the resource hierarchy and its settings. Settings provided closer to the target resource take precedence over those further away (e.g. folder will override organization level settings). The default SCC setting for the detector service defaults can be overridden at organization, folder and project levels. No assumptions should be made about the SCC defaults as it is considered an internal implementation detail. */
export const calculateProjectsSecurityHealthAnalyticsSettings: API.OperationMethod<CalculateProjectsSecurityHealthAnalyticsSettingsRequest, CalculateProjectsSecurityHealthAnalyticsSettingsResponse, CalculateProjectsSecurityHealthAnalyticsSettingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CalculateProjectsVirtualMachineThreatDetectionSettingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  showEligibleModulesOnly: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("showEligibleModulesOnly")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/projects/{projectsId}/virtualMachineThreatDetectionSettings:calculate" }),
  svc,
) as unknown as Schema.Schema<CalculateProjectsVirtualMachineThreatDetectionSettingsRequest>;

export type CalculateProjectsVirtualMachineThreatDetectionSettingsResponse = VirtualMachineThreatDetectionSettings;
export const CalculateProjectsVirtualMachineThreatDetectionSettingsResponse = VirtualMachineThreatDetectionSettings;

export type CalculateProjectsVirtualMachineThreatDetectionSettingsError = CommonErrors;

/** Calculates the effective VirtualMachineThreatDetectionSettings based on its level in the resource hierarchy and its settings. Settings provided closer to the target resource take precedence over those further away (e.g. folder will override organization level settings). The default SCC setting for the detector service defaults can be overridden at organization, folder and project levels. No assumptions should be made about the SCC defaults as it is considered an internal implementation detail. */
export const calculateProjectsVirtualMachineThreatDetectionSettings: API.OperationMethod<CalculateProjectsVirtualMachineThreatDetectionSettingsRequest, CalculateProjectsVirtualMachineThreatDetectionSettingsResponse, CalculateProjectsVirtualMachineThreatDetectionSettingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CalculateProjectsRapidVulnerabilityDetectionSettingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta2/projects/{projectsId}/rapidVulnerabilityDetectionSettings:calculate" }),
  svc,
) as unknown as Schema.Schema<CalculateProjectsRapidVulnerabilityDetectionSettingsRequest>;

export type CalculateProjectsRapidVulnerabilityDetectionSettingsResponse = RapidVulnerabilityDetectionSettings;
export const CalculateProjectsRapidVulnerabilityDetectionSettingsResponse = RapidVulnerabilityDetectionSettings;

export type CalculateProjectsRapidVulnerabilityDetectionSettingsError = CommonErrors;

/** Calculates the effective RapidVulnerabilityDetectionSettings based on its level in the resource hierarchy and its settings. Settings provided closer to the target resource take precedence over those further away (e.g. folder will override organization level settings). The default SCC setting for the detector service defaults can be overridden at organization, folder and project levels. No assumptions should be made about the SCC defaults as it is considered an internal implementation detail. */
export const calculateProjectsRapidVulnerabilityDetectionSettings: API.OperationMethod<CalculateProjectsRapidVulnerabilityDetectionSettingsRequest, CalculateProjectsRapidVulnerabilityDetectionSettingsResponse, CalculateProjectsRapidVulnerabilityDetectionSettingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CalculateProjectsWebSecurityScannerSettingsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta2/projects/{projectsId}/webSecurityScannerSettings:calculate" }),
  svc,
) as unknown as Schema.Schema<CalculateProjectsWebSecurityScannerSettingsRequest>;

export type CalculateProjectsWebSecurityScannerSettingsResponse = WebSecurityScannerSettings;
export const CalculateProjectsWebSecurityScannerSettingsResponse = WebSecurityScannerSettings;

export type CalculateProjectsWebSecurityScannerSettingsError = CommonErrors;

/** Calculates the effective WebSecurityScannerSettings based on its level in the resource hierarchy and its settings. Settings provided closer to the target resource take precedence over those further away (e.g. folder will override organization level settings). The default SCC setting for the detector service defaults can be overridden at organization, folder and project levels. No assumptions should be made about the SCC defaults as it is considered an internal implementation detail. */
export const calculateProjectsWebSecurityScannerSettings: API.OperationMethod<CalculateProjectsWebSecurityScannerSettingsRequest, CalculateProjectsWebSecurityScannerSettingsResponse, CalculateProjectsWebSecurityScannerSettingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
