...
export interface Operation {
  ...
  error?: { errors?: Array<{ errorDetails?: Array<{ localizedMessage?: LocalizedMessage; quotaInfo?: QuotaExceededInfo; errorInfo?: ErrorInfo; help?: Help }>; code?: string; message?: string; location?: string; debugInfo?: DebugInfo; arguments?: Array<string> }> };
...
export const Operation: Schema.Schema<Operation> = Schema.suspend(() => Schema.Struct({
  ...
  error: Schema.optional(Schema.Struct({ errors: Schema.optional(Schema.Array(Schema.Struct({ errorDetails: Schema.optional(Schema.Array(Schema.Struct({ localizedMessage: Schema.optional(LocalizedMessage), quotaInfo: Schema.optional(QuotaExceededInfo), errorInfo: Schema.optional(ErrorInfo), help: Schema.optional(Help) }))), code: Schema.optional(Schema.String), message: Schema.optional(Schema.String), location: Schema.optional(Schema.String), debugInfo: Schema.optional(DebugInfo), arguments: Schema.optional(Schema.Array(Schema.String)) }))) })),
  description: Schema.optional(Schema.String),
...
export interface ResourceUpdate {
  ...
  warnings?: Array<{ data?: Array<{ key?: string; value?: string }>; code?: "DEPRECATED_RESOURCE_USED" | "NO_RESULTS_ON_PAGE" | "UNREACHABLE" | "NEXT_HOP_ADDRESS_NOT_ASSIGNED" | "NEXT_HOP_INSTANCE_NOT_FOUND" | "NEXT_HOP_INSTANCE_NOT_ON_NETWORK" | "NEXT_HOP_CANNOT_IP_FORWARD" | "NEXT_HOP_NOT_RUNNING" | "INJECTED_KERNELS_DEPRECATED" | "REQUIRED_TOS_AGREEMENT" | "DISK_SIZE_LARGER_THAN_IMAGE_SIZE" | "RESOURCE_NOT_DELETED" | "SINGLE_INSTANCE_PROPERTY_TEMPLATE" | "NOT_CRITICAL_ERROR" | "CLEANUP_FAILED" | "FIELD_VALUE_OVERRIDEN" | "RESOURCE_IN_USE_BY_OTHER_RESOURCE_WARNING" | "NETWORK_ENDPOINT_NOT_DETACHED" | "PAGE_MISSING_RESULTS" | "SSL_POLICY_ENABLED_FEATURES_NOT_FETCHED" | "RESOURCE_NOT_FOUND_WARNING" | "MISSING_TYPE_DEPENDENCY" | "EXTERNAL_API_WARNING" | "SCHEMA_VALIDATION_IGNORED" | "UNDECLARED_PROPERTIES" | "EXPERIMENTAL_TYPE_USED" | "DEPRECATED_TYPE_USED" | "PARTIAL_SUCCESS" | "LARGE_DEPLOYMENT_WARNING" | "NEXT_HOP_INSTANCE_HAS_NO_IPV6_INTERFACE" | "INVALID_HEALTH_CHECK_FOR_DYNAMIC_WIEGHTED_LB" | "LIST_OVERHEAD_QUOTA_EXCEED" | "QUOTA_INFO_UNAVAILABLE" | "RESOURCE_USES_GLOBAL_DNS" | "RATE_LIMIT_EXCEEDED" | "UPCOMING_MAINTENANCES_UNAVAILABLE" | "RESERVED_ENTRY_136" | "RESERVED_ENTRY_139" | "RESERVED_ENTRY_141" | "RESERVED_ENTRY_142" | "RESERVED_ENTRY_143" | (string & {}); message?: string }>;
  /** Output only. If errors are generated during update of the resource, this field will be populated. */
  error?: { errors?: Array<{ arguments?: Array<string>; location?: string; debugInfo?: DebugInfo; errorDetails?: Array<{ quotaInfo?: QuotaExceededInfo; errorInfo?: ErrorInfo; localizedMessage?: LocalizedMessage; help?: Help }>; code?: string; message?: string }> };
...
export const ResourceUpdate: Schema.Schema<ResourceUpdate> = Schema.suspend(() => Schema.Struct({
  ...
  warnings: Schema.optional(Schema.Array(Schema.Struct({ data: Schema.optional(Schema.Array(Schema.Struct({ key: Schema.optional(Schema.String), value: Schema.optional(Schema.String) }))), code: Schema.optional(Schema.String), message: Schema.optional(Schema.String) }))),
  error: Schema.optional(Schema.Struct({ errors: Schema.optional(Schema.Array(Schema.Struct({ arguments: Schema.optional(Schema.Array(Schema.String)), location: Schema.optional(Schema.String), debugInfo: Schema.optional(DebugInfo), errorDetails: Schema.optional(Schema.Array(Schema.Struct({ quotaInfo: Schema.optional(QuotaExceededInfo), errorInfo: Schema.optional(ErrorInfo), localizedMessage: Schema.optional(LocalizedMessage), help: Schema.optional(Help) }))), code: Schema.optional(Schema.String), message: Schema.optional(Schema.String) }))) })),
...
export interface Resource {
  ...
  accessControl?: ResourceAccessControl;
  /** Output only. If warning messages are generated during processing of this resource, this field will be populated. */
  warnings?: Array<{ message?: string; data?: Array<{ value?: string; key?: string }>; code?: "DEPRECATED_RESOURCE_USED" | "NO_RESULTS_ON_PAGE" | "UNREACHABLE" | "NEXT_HOP_ADDRESS_NOT_ASSIGNED" | "NEXT_HOP_INSTANCE_NOT_FOUND" | "NEXT_HOP_INSTANCE_NOT_ON_NETWORK" | "NEXT_HOP_CANNOT_IP_FORWARD" | "NEXT_HOP_NOT_RUNNING" | "INJECTED_KERNELS_DEPRECATED" | "REQUIRED_TOS_AGREEMENT" | "DISK_SIZE_LARGER_THAN_IMAGE_SIZE" | "RESOURCE_NOT_DELETED" | "SINGLE_INSTANCE_PROPERTY_TEMPLATE" | "NOT_CRITICAL_ERROR" | "CLEANUP_FAILED" | "FIELD_VALUE_OVERRIDEN" | "RESOURCE_IN_USE_BY_OTHER_RESOURCE_WARNING" | "NETWORK_ENDPOINT_NOT_DETACHED" | "PAGE_MISSING_RESULTS" | "SSL_POLICY_ENABLED_FEATURES_NOT_FETCHED" | "RESOURCE_NOT_FOUND_WARNING" | "MISSING_TYPE_DEPENDENCY" | "EXTERNAL_API_WARNING" | "SCHEMA_VALIDATION_IGNORED" | "UNDECLARED_PROPERTIES" | "EXPERIMENTAL_TYPE_USED" | "DEPRECATED_TYPE_USED" | "PARTIAL_SUCCESS" | "LARGE_DEPLOYMENT_WARNING" | "NEXT_HOP_INSTANCE_HAS_NO_IPV6_INTERFACE" | "INVALID_HEALTH_CHECK_FOR_DYNAMIC_WIEGHTED_LB" | "LIST_OVERHEAD_QUOTA_EXCEED" | "QUOTA_INFO_UNAVAILABLE" | "RESOURCE_USES_GLOBAL_DNS" | "RATE_LIMIT_EXCEEDED" | "UPCOMING_MAINTENANCES_UNAVAILABLE" | "RESERVED_ENTRY_136" | "RESERVED_ENTRY_139" | "RESERVED_ENTRY_141" | "RESERVED_ENTRY_142" | "RESERVED_ENTRY_143" | (string & {}) }>;
...
export const Resource: Schema.Schema<Resource> = Schema.suspend(() => Schema.Struct({
  ...
  insertTime: Schema.optional(Schema.String),
  accessControl: Schema.optional(ResourceAccessControl),
  warnings: Schema.optional(Schema.Array(Schema.Struct({ message: Schema.optional(Schema.String), data: Schema.optional(Schema.Array(Schema.Struct({ value: Schema.optional(Schema.String), key: Schema.optional(Schema.String) }))), code: Schema.optional(Schema.String) }))),
  name: Schema.optional(Schema.String),
...
export type PatchTypeProvidersError = CommonErrors;

/** Patches a type provider. */
export const patchTypeProviders: API.OperationMethod<PatchTypeProvidersRequest, PatchTypeProvidersResponse, PatchTypeProvidersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type GetTypeProvidersError = CommonErrors;

/** Gets information about a specific type provider. */
export const getTypeProviders: API.OperationMethod<GetTypeProvidersRequest, GetTypeProvidersResponse, GetTypeProvidersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type DeleteTypeProvidersError = CommonErrors;

/** Deletes a type provider. */
export const deleteTypeProviders: API.OperationMethod<DeleteTypeProvidersRequest, DeleteTypeProvidersResponse, DeleteTypeProvidersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type ListTypesTypeProvidersError = CommonErrors;

/** Lists all the type info for a TypeProvider. */
export const listTypesTypeProviders: API.PaginatedOperationMethod<ListTypesTypeProvidersRequest, ListTypesTypeProvidersResponse, ListTypesTypeProvidersError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export type ListTypeProvidersError = CommonErrors;

/** Lists all resource type providers for Deployment Manager. */
export const listTypeProviders: API.PaginatedOperationMethod<ListTypeProvidersRequest, ListTypeProvidersResponse, ListTypeProvidersError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export type GetTypeTypeProvidersError = CommonErrors;

/** Gets a type info for a type provided by a TypeProvider. */
export const getTypeTypeProviders: API.OperationMethod<GetTypeTypeProvidersRequest, GetTypeTypeProvidersResponse, GetTypeTypeProvidersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type UpdateTypeProvidersError = CommonErrors;

/** Updates a type provider. */
export const updateTypeProviders: API.OperationMethod<UpdateTypeProvidersRequest, UpdateTypeProvidersResponse, UpdateTypeProvidersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type InsertTypeProvidersError = CommonErrors;

/** Creates a type provider. */
export const insertTypeProviders: API.OperationMethod<InsertTypeProvidersRequest, InsertTypeProvidersResponse, InsertTypeProvidersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type DeleteCompositeTypesError = CommonErrors;

/** Deletes a composite type. */
export const deleteCompositeTypes: API.OperationMethod<DeleteCompositeTypesRequest, DeleteCompositeTypesResponse, DeleteCompositeTypesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type GetCompositeTypesError = CommonErrors;

/** Gets information about a specific composite type. */
export const getCompositeTypes: API.OperationMethod<GetCompositeTypesRequest, GetCompositeTypesResponse, GetCompositeTypesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type ListCompositeTypesError = CommonErrors;

/** Lists all composite types for Deployment Manager. */
export const listCompositeTypes: API.PaginatedOperationMethod<ListCompositeTypesRequest, ListCompositeTypesResponse, ListCompositeTypesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export type InsertCompositeTypesError = CommonErrors;

/** Creates a composite type. */
export const insertCompositeTypes: API.OperationMethod<InsertCompositeTypesRequest, InsertCompositeTypesResponse, InsertCompositeTypesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type UpdateCompositeTypesError = CommonErrors;

/** Updates a composite type. */
export const updateCompositeTypes: API.OperationMethod<UpdateCompositeTypesRequest, UpdateCompositeTypesResponse, UpdateCompositeTypesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type PatchCompositeTypesError = CommonErrors;

/** Patches a composite type. */
export const patchCompositeTypes: API.OperationMethod<PatchCompositeTypesRequest, PatchCompositeTypesResponse, PatchCompositeTypesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
