...
export type ApplySoftwareUpdateProjectsLocationsInstancesError = CommonErrors;

/** Updates software on the selected nodes of the Instance. */
export const applySoftwareUpdateProjectsLocationsInstances: API.OperationMethod<ApplySoftwareUpdateProjectsLocationsInstancesRequest, ApplySoftwareUpdateProjectsLocationsInstancesResponse, ApplySoftwareUpdateProjectsLocationsInstancesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
