...
export type PatchTracesProjectsError = CommonErrors;
...
export const patchTracesProjects: API.OperationMethod<PatchTracesProjectsRequest, PatchTracesProjectsResponse, PatchTracesProjectsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type ListProjectsTracesError = CommonErrors;

/** Returns a list of traces that match the specified filter conditions. */
export const listProjectsTraces: API.PaginatedOperationMethod<ListProjectsTracesRequest, ListProjectsTracesResponse, ListProjectsTracesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export type GetProjectsTracesError = CommonErrors;

/** Gets a single trace by its ID. */
export const getProjectsTraces: API.OperationMethod<GetProjectsTracesRequest, GetProjectsTracesResponse, GetProjectsTracesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
