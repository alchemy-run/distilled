...
export const SearchAllResourcesResponse_Op = SearchAllResourcesResponse;

export type SearchAllResourcesError = CommonErrors;
...
export const searchAllResources: API.PaginatedOperationMethod<SearchAllResourcesRequest, SearchAllResourcesResponse_Op, SearchAllResourcesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const SearchAllIamPoliciesRequest = Schema.Struct({
  scope: Schema.String.pipe(T.HttpPath("scope")),
  query: Schema.optional(Schema.String).pipe(T.HttpQuery("query")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
...
export const SearchAllIamPoliciesResponse_Op = SearchAllIamPoliciesResponse;

export type SearchAllIamPoliciesError = CommonErrors;
...
export const searchAllIamPolicies: API.PaginatedOperationMethod<SearchAllIamPoliciesRequest, SearchAllIamPoliciesResponse_Op, SearchAllIamPoliciesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
