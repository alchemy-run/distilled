...
export type GetProjectsLocationsInstanceOSPoliciesCompliancesError = CommonErrors;

/** Get OS policies compliance data for the specified Compute Engine VM instance. */
export const getProjectsLocationsInstanceOSPoliciesCompliances: API.OperationMethod<GetProjectsLocationsInstanceOSPoliciesCompliancesRequest, GetProjectsLocationsInstanceOSPoliciesCompliancesResponse, GetProjectsLocationsInstanceOSPoliciesCompliancesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
