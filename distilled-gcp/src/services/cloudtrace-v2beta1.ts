...
export const TraceSink: Schema.Schema<TraceSink> = Schema.suspend(() => Schema.Struct({
...
export const ListTraceSinksResponse: Schema.Schema<ListTraceSinksResponse> = Schema.suspend(() => Schema.Struct({
  sinks: Schema.optional(Schema.Array(TraceSink)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "ListTraceSinksResponse" }) as any as Schema.Schema<ListTraceSinksResponse>;
...
export type ListProjectsTraceSinksError = CommonErrors;

/** List all sinks for the parent resource (GCP project). */
export const listProjectsTraceSinks: API.PaginatedOperationMethod<ListProjectsTraceSinksRequest, ListProjectsTraceSinksResponse, ListProjectsTraceSinksError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsTraceSinksRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2beta1/projects/{projectsId}/traceSinks/{traceSinksId}" }),
  svc,
...
export type GetProjectsTraceSinksError = CommonErrors;

/** Get a trace sink by name under the parent resource (GCP project). */
export const getProjectsTraceSinks: API.OperationMethod<GetProjectsTraceSinksRequest, GetProjectsTraceSinksResponse, GetProjectsTraceSinksError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsTraceSinksRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2beta1/projects/{projectsId}/traceSinks", hasBody: true }),
  svc,
...
export type CreateProjectsTraceSinksError = CommonErrors;
...
export const createProjectsTraceSinks: API.OperationMethod<CreateProjectsTraceSinksRequest, CreateProjectsTraceSinksResponse, CreateProjectsTraceSinksError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsTraceSinksRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v2beta1/projects/{projectsId}/traceSinks/{traceSinksId}", hasBody: true }),
  svc,
...
export type PatchProjectsTraceSinksError = CommonErrors;
...
export const patchProjectsTraceSinks: API.OperationMethod<PatchProjectsTraceSinksRequest, PatchProjectsTraceSinksResponse, PatchProjectsTraceSinksError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsTraceSinksRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2beta1/projects/{projectsId}/traceSinks/{traceSinksId}" }),
  svc,
...
export type DeleteProjectsTraceSinksError = CommonErrors;

/** Deletes a sink. */
export const deleteProjectsTraceSinks: API.OperationMethod<DeleteProjectsTraceSinksRequest, DeleteProjectsTraceSinksResponse, DeleteProjectsTraceSinksError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
