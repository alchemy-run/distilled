...
export type UpdateConnectionsServicesError = CommonErrors;
...
export const updateConnectionsServices: API.OperationMethod<UpdateConnectionsServicesRequest, UpdateConnectionsServicesResponse, UpdateConnectionsServicesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
