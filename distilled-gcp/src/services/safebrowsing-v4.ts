...
export type FindThreatMatchesError = CommonErrors;

/** Finds the threat entries that match the Safe Browsing lists. */
export const findThreatMatches: API.OperationMethod<FindThreatMatchesRequest, FindThreatMatchesResponse, FindThreatMatchesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type FetchThreatListUpdatesError = CommonErrors;

/** Fetches the most recent threat list updates. A client can request updates for multiple lists at once. */
export const fetchThreatListUpdates: API.OperationMethod<FetchThreatListUpdatesRequest, FetchThreatListUpdatesResponse, FetchThreatListUpdatesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type GetEncodedUpdatesError = CommonErrors;

export const getEncodedUpdates: API.OperationMethod<GetEncodedUpdatesRequest, GetEncodedUpdatesResponse, GetEncodedUpdatesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type FindFullHashesError = CommonErrors;

/** Finds the full hashes that match the requested hash prefixes. */
export const findFullHashes: API.OperationMethod<FindFullHashesRequest, FindFullHashesResponse, FindFullHashesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type GetEncodedFullHashesError = CommonErrors;

export const getEncodedFullHashes: API.OperationMethod<GetEncodedFullHashesRequest, GetEncodedFullHashesResponse, GetEncodedFullHashesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type CreateThreatHitsError = CommonErrors;

/** Reports a Safe Browsing threat list hit to Google. Only projects with TRUSTED_REPORTER visibility can use this method. */
export const createThreatHits: API.OperationMethod<CreateThreatHitsRequest, CreateThreatHitsResponse, CreateThreatHitsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type ListThreatListsError = CommonErrors;

/** Lists the Safe Browsing threat lists available for download. */
export const listThreatLists: API.OperationMethod<ListThreatListsRequest, ListThreatListsResponse, ListThreatListsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
