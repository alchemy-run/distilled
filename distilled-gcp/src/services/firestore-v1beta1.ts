...
export type CreateProjectsDatabasesIndexesError = CommonErrors;

/** Creates the specified index. A newly created index's initial state is `CREATING`. On completion of the returned google.longrunning.Operation, the state will be `READY`. If the index already exists, the call will return an `ALREADY_EXISTS` status. During creation, the process could result in an error, in which case the index will move to the `ERROR` state. The process can be recovered by fixing the data that caused the error, removing the index with delete, then re-creating the index with create. Indexes with a single field cannot be created. */
export const createProjectsDatabasesIndexes: API.OperationMethod<CreateProjectsDatabasesIndexesRequest, CreateProjectsDatabasesIndexesResponse, CreateProjectsDatabasesIndexesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type ListProjectsDatabasesIndexesError = CommonErrors;

/** Lists the indexes that match the specified filters. */
export const listProjectsDatabasesIndexes: API.PaginatedOperationMethod<ListProjectsDatabasesIndexesRequest, ListProjectsDatabasesIndexesResponse, ListProjectsDatabasesIndexesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export type GetProjectsDatabasesIndexesError = CommonErrors;

/** Gets an index. */
export const getProjectsDatabasesIndexes: API.OperationMethod<GetProjectsDatabasesIndexesRequest, GetProjectsDatabasesIndexesResponse, GetProjectsDatabasesIndexesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type DeleteProjectsDatabasesIndexesError = CommonErrors;

/** Deletes an index. */
export const deleteProjectsDatabasesIndexes: API.OperationMethod<DeleteProjectsDatabasesIndexesRequest, DeleteProjectsDatabasesIndexesResponse, DeleteProjectsDatabasesIndexesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
