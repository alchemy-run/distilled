...
export type UpdateCredentialProjectsLocationsConnectionsError = CommonErrors;

/** Sets the credential for the specified connection. */
export const updateCredentialProjectsLocationsConnections: API.OperationMethod<UpdateCredentialProjectsLocationsConnectionsRequest, UpdateCredentialProjectsLocationsConnectionsResponse, UpdateCredentialProjectsLocationsConnectionsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
