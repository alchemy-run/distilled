...
export interface Operation {
  ...
  error?: { errors?: Array<{ code?: string; debugInfo?: DebugInfo; arguments?: Array<string>; message?: string; errorDetails?: Array<{ errorInfo?: ErrorInfo; help?: Help; localizedMessage?: LocalizedMessage; quotaInfo?: QuotaExceededInfo }>; location?: string }> };
...
export const Operation: Schema.Schema<Operation> = Schema.suspend(() => Schema.Struct({
  ...
  error: Schema.optional(Schema.Struct({ errors: Schema.optional(Schema.Array(Schema.Struct({ code: Schema.optional(Schema.String), debugInfo: Schema.optional(DebugInfo), arguments: Schema.optional(Schema.Array(Schema.String)), message: Schema.optional(Schema.String), errorDetails: Schema.optional(Schema.Array(Schema.Struct({ errorInfo: Schema.optional(ErrorInfo), help: Schema.optional(Help), localizedMessage: Schema.optional(LocalizedMessage), quotaInfo: Schema.optional(QuotaExceededInfo) }))), location: Schema.optional(Schema.String) }))) })),
  status: Schema.optional(Schema.String),
...
export interface ResourceUpdate {
  ...
  error?: { errors?: Array<{ errorDetails?: Array<{ quotaInfo?: QuotaExceededInfo; errorInfo?: ErrorInfo; help?: Help; localizedMessage?: LocalizedMessage }>; code?: string; debugInfo?: DebugInfo; arguments?: Array<string>; message?: string; location?: string }> };
}
...
export const ResourceUpdate: Schema.Schema<ResourceUpdate> = Schema.suspend(() => Schema.Struct({
  ...
  error: Schema.optional(Schema.Struct({ errors: Schema.optional(Schema.Array(Schema.Struct({ errorDetails: Schema.optional(Schema.Array(Schema.Struct({ quotaInfo: Schema.optional(QuotaExceededInfo), errorInfo: Schema.optional(ErrorInfo), help: Schema.optional(Help), localizedMessage: Schema.optional(LocalizedMessage) }))), code: Schema.optional(Schema.String), debugInfo: Schema.optional(DebugInfo), arguments: Schema.optional(Schema.Array(Schema.String)), message: Schema.optional(Schema.String), location: Schema.optional(Schema.String) }))) })),
...
export type GetTypesError = CommonErrors;

/** Gets information about a specific type. */
export const getTypes: API.OperationMethod<GetTypesRequest, GetTypesResponse, GetTypesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
