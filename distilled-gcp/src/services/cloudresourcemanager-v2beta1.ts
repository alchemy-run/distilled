...
export const searchFolders: API.OperationMethod<SearchFoldersRequest_Op, SearchFoldersResponse_Op, SearchFoldersError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
