...
export const searchAppsProjects: API.PaginatedOperationMethod<SearchAppsProjectsRequest, SearchAppsProjectsResponse, SearchAppsProjectsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const listProjectsWebApps: API.PaginatedOperationMethod<ListProjectsWebAppsRequest, ListProjectsWebAppsResponse, ListProjectsWebAppsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const listProjectsAndroidApps: API.PaginatedOperationMethod<ListProjectsAndroidAppsRequest, ListProjectsAndroidAppsResponse, ListProjectsAndroidAppsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const listProjectsAvailableLocations: API.PaginatedOperationMethod<ListProjectsAvailableLocationsRequest, ListProjectsAvailableLocationsResponse, ListProjectsAvailableLocationsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const listProjectsIosApps: API.PaginatedOperationMethod<ListProjectsIosAppsRequest, ListProjectsIosAppsResponse, ListProjectsIosAppsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const listAvailableProjects: API.PaginatedOperationMethod<ListAvailableProjectsRequest, ListAvailableProjectsResponse_Op, ListAvailableProjectsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
