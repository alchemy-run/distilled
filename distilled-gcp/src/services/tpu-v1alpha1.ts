...
export interface Node {
  ...
  health?: "HEALTH_UNSPECIFIED" | "HEALTHY" | "DEPRECATED_UNHEALTHY" | "TIMEOUT" | "UNHEALTHY_TENSORFLOW" | "UNHEALTHY_MAINTENANCE" | (string & {});
...
export const ReimageNodeRequest: Schema.Schema<ReimageNodeRequest> = Schema.suspend(() => Schema.Struct({
  tensorflowVersion: Schema.optional(Schema.String),
})).annotate({ identifier: "ReimageNodeRequest" }) as any as Schema.Schema<ReimageNodeRequest>;
...
export const TensorFlowVersion: Schema.Schema<TensorFlowVersion> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  version: Schema.optional(Schema.String),
})).annotate({ identifier: "TensorFlowVersion" }) as any as Schema.Schema<TensorFlowVersion>;
...
export const ListTensorFlowVersionsResponse: Schema.Schema<ListTensorFlowVersionsResponse> = Schema.suspend(() => Schema.Struct({
  tensorflowVersions: Schema.optional(Schema.Array(TensorFlowVersion)),
  nextPageToken: Schema.optional(Schema.String),
  unreachable: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "ListTensorFlowVersionsResponse" }) as any as Schema.Schema<ListTensorFlowVersionsResponse>;
...
export const ListProjectsLocationsNodesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha1/projects/{projectsId}/locations/{locationsId}/nodes" }),
  svc,
...
/** Lists nodes. */
export const listProjectsLocationsNodes: API.PaginatedOperationMethod<ListProjectsLocationsNodesRequest, ListProjectsLocationsNodesResponse, ListProjectsLocationsNodesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsNodesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha1/projects/{projectsId}/locations/{locationsId}/nodes/{nodesId}" }),
  svc,
...
export const CreateProjectsLocationsNodesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1alpha1/projects/{projectsId}/locations/{locationsId}/nodes", hasBody: true }),
  svc,
...
export const DeleteProjectsLocationsNodesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1alpha1/projects/{projectsId}/locations/{locationsId}/nodes/{nodesId}" }),
  svc,
...
export const ReimageProjectsLocationsNodesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1alpha1/projects/{projectsId}/locations/{locationsId}/nodes/{nodesId}:reimage", hasBody: true }),
  svc,
...
export type ReimageProjectsLocationsNodesError = CommonErrors;

/** Reimages a node's OS. */
export const reimageProjectsLocationsNodes: API.OperationMethod<ReimageProjectsLocationsNodesRequest, ReimageProjectsLocationsNodesResponse, ReimageProjectsLocationsNodesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const StopProjectsLocationsNodesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1alpha1/projects/{projectsId}/locations/{locationsId}/nodes/{nodesId}:stop", hasBody: true }),
  svc,
...
export const StartProjectsLocationsNodesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1alpha1/projects/{projectsId}/locations/{locationsId}/nodes/{nodesId}:start", hasBody: true }),
  svc,
...
export const ListProjectsLocationsTensorflowVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha1/projects/{projectsId}/locations/{locationsId}/tensorflowVersions" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsTensorflowVersionsRequest>;

export type ListProjectsLocationsTensorflowVersionsResponse = ListTensorFlowVersionsResponse;
export const ListProjectsLocationsTensorflowVersionsResponse = ListTensorFlowVersionsResponse;

export type ListProjectsLocationsTensorflowVersionsError = CommonErrors;

/** Lists TensorFlow versions supported by this API. */
export const listProjectsLocationsTensorflowVersions: API.PaginatedOperationMethod<ListProjectsLocationsTensorflowVersionsRequest, ListProjectsLocationsTensorflowVersionsResponse, ListProjectsLocationsTensorflowVersionsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsTensorflowVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha1/projects/{projectsId}/locations/{locationsId}/tensorflowVersions/{tensorflowVersionsId}" }),
  svc,
...
export type GetProjectsLocationsTensorflowVersionsError = CommonErrors;

/** Gets TensorFlow Version. */
export const getProjectsLocationsTensorflowVersions: API.OperationMethod<GetProjectsLocationsTensorflowVersionsRequest, GetProjectsLocationsTensorflowVersionsResponse, GetProjectsLocationsTensorflowVersionsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsAcceleratorTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha1/projects/{projectsId}/locations/{locationsId}/acceleratorTypes" }),
  svc,
...
export const listProjectsLocationsAcceleratorTypes: API.PaginatedOperationMethod<ListProjectsLocationsAcceleratorTypesRequest, ListProjectsLocationsAcceleratorTypesResponse, ListProjectsLocationsAcceleratorTypesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsAcceleratorTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha1/projects/{projectsId}/locations/{locationsId}/acceleratorTypes/{acceleratorTypesId}" }),
  svc,
