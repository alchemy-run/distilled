...
export type ListProjectsLocationsReplaysError = CommonErrors;

/** Lists each Replay in a project, folder, or organization. Each `Replay` is available for at least 7 days. */
export const listProjectsLocationsReplays: API.PaginatedOperationMethod<ListProjectsLocationsReplaysRequest, ListProjectsLocationsReplaysResponse, ListProjectsLocationsReplaysError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export type ListFoldersLocationsReplaysError = CommonErrors;

/** Lists each Replay in a project, folder, or organization. Each `Replay` is available for at least 7 days. */
export const listFoldersLocationsReplays: API.PaginatedOperationMethod<ListFoldersLocationsReplaysRequest, ListFoldersLocationsReplaysResponse, ListFoldersLocationsReplaysError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export type GenerateOrganizationsLocationsOrgPolicyViolationsPreviewsError = CommonErrors;
...
export type ListOrganizationsLocationsReplaysError = CommonErrors;

/** Lists each Replay in a project, folder, or organization. Each `Replay` is available for at least 7 days. */
export const listOrganizationsLocationsReplays: API.PaginatedOperationMethod<ListOrganizationsLocationsReplaysRequest, ListOrganizationsLocationsReplaysResponse, ListOrganizationsLocationsReplaysError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
