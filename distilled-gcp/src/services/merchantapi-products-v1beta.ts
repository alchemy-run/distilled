...
export const Tax: Schema.Schema<Tax> = Schema.suspend(() => Schema.Struct({
...
export const GetAccountsProductsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "products/v1beta/accounts/{accountsId}/products/{productsId}" }),
  svc,
...
export const ListAccountsProductsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "products/v1beta/accounts/{accountsId}/products" }),
  svc,
...
export const InsertAccountsProductInputsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "products/v1beta/accounts/{accountsId}/productInputs:insert", hasBody: true }),
  svc,
...
export type InsertAccountsProductInputsError = CommonErrors;
...
export const insertAccountsProductInputs: API.OperationMethod<InsertAccountsProductInputsRequest, InsertAccountsProductInputsResponse, InsertAccountsProductInputsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchAccountsProductInputsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "products/v1beta/accounts/{accountsId}/productInputs/{productInputsId}", hasBody: true }),
  svc,
...
export type PatchAccountsProductInputsError = CommonErrors;
...
export const patchAccountsProductInputs: API.OperationMethod<PatchAccountsProductInputsRequest, PatchAccountsProductInputsResponse, PatchAccountsProductInputsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteAccountsProductInputsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "products/v1beta/accounts/{accountsId}/productInputs/{productInputsId}" }),
  svc,
...
export type DeleteAccountsProductInputsError = CommonErrors;
...
export const deleteAccountsProductInputs: API.OperationMethod<DeleteAccountsProductInputsRequest, DeleteAccountsProductInputsResponse, DeleteAccountsProductInputsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
