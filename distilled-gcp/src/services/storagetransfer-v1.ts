...
/** Lists agent pools. */
export const listProjectsAgentPools: API.PaginatedOperationMethod<ListProjectsAgentPoolsRequest, ListProjectsAgentPoolsResponse, ListProjectsAgentPoolsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
/** Lists transfer jobs. */
export const listTransferJobs: API.PaginatedOperationMethod<ListTransferJobsRequest, ListTransferJobsResponse_Op, ListTransferJobsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const listTransferOperations: API.PaginatedOperationMethod<ListTransferOperationsRequest, ListTransferOperationsResponse, ListTransferOperationsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
