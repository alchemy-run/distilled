...
export const SetIamPolicyV1beta1Request = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/{v1beta1Id}:setIamPolicy", hasBody: true }),
  svc,
...
export type SetIamPolicyV1beta1Error = CommonErrors;

/** Sets the access control policy for an Identity-Aware Proxy protected resource. Replaces any existing policy. More information about managing access via IAP can be found at: https://cloud.google.com/iap/docs/managing-access#managing_access_via_the_api */
export const setIamPolicyV1beta1: API.OperationMethod<SetIamPolicyV1beta1Request, SetIamPolicyV1beta1Response, SetIamPolicyV1beta1Error, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetIamPolicyV1beta1Request = Schema.Struct({
  resource: Schema.String.pipe(T.HttpPath("resource")),
  body: Schema.optional(GetIamPolicyRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta1/{v1beta1Id}:getIamPolicy", hasBody: true }),
  svc,
) as unknown as Schema.Schema<GetIamPolicyV1beta1Request>;

export type GetIamPolicyV1beta1Response = Policy;
export const GetIamPolicyV1beta1Response = Policy;

export type GetIamPolicyV1beta1Error = CommonErrors;

/** Gets the access control policy for an Identity-Aware Proxy protected resource. More information about managing access via IAP can be found at: https://cloud.google.com/iap/docs/managing-access#managing_access_via_the_api */
export const getIamPolicyV1beta1: API.OperationMethod<GetIamPolicyV1beta1Request, GetIamPolicyV1beta1Response, GetIamPolicyV1beta1Error, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const TestIamPermissionsV1beta1Request = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/{v1beta1Id}:testIamPermissions", hasBody: true }),
  svc,
...
export type TestIamPermissionsV1beta1Error = CommonErrors;
...
export const testIamPermissionsV1beta1: API.OperationMethod<TestIamPermissionsV1beta1Request, TestIamPermissionsV1beta1Response, TestIamPermissionsV1beta1Error, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
