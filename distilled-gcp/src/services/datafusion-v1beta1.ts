...
export type RemoveIamPolicyProjectsLocationsError = CommonErrors;

/** Remove IAM policy that is currently set on the given resource. */
export const removeIamPolicyProjectsLocations: API.OperationMethod<RemoveIamPolicyProjectsLocationsRequest, RemoveIamPolicyProjectsLocationsResponse, RemoveIamPolicyProjectsLocationsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type ListProjectsLocationsInstancesNamespacesError = CommonErrors;

/** List namespaces in a given instance */
export const listProjectsLocationsInstancesNamespaces: API.PaginatedOperationMethod<ListProjectsLocationsInstancesNamespacesRequest, ListProjectsLocationsInstancesNamespacesResponse, ListProjectsLocationsInstancesNamespacesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export type SetIamPolicyProjectsLocationsInstancesNamespacesError = CommonErrors;

/** Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors. */
export const setIamPolicyProjectsLocationsInstancesNamespaces: API.OperationMethod<SetIamPolicyProjectsLocationsInstancesNamespacesRequest, SetIamPolicyProjectsLocationsInstancesNamespacesResponse, SetIamPolicyProjectsLocationsInstancesNamespacesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type GetIamPolicyProjectsLocationsInstancesNamespacesError = CommonErrors;

/** Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. */
export const getIamPolicyProjectsLocationsInstancesNamespaces: API.OperationMethod<GetIamPolicyProjectsLocationsInstancesNamespacesRequest, GetIamPolicyProjectsLocationsInstancesNamespacesResponse, GetIamPolicyProjectsLocationsInstancesNamespacesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type TestIamPermissionsProjectsLocationsInstancesNamespacesError = CommonErrors;

/** Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a `NOT_FOUND` error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning. */
export const testIamPermissionsProjectsLocationsInstancesNamespaces: API.OperationMethod<TestIamPermissionsProjectsLocationsInstancesNamespacesRequest, TestIamPermissionsProjectsLocationsInstancesNamespacesResponse, TestIamPermissionsProjectsLocationsInstancesNamespacesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
