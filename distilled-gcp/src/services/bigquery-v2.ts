...
export interface QueryParameterType {
  ...
  structTypes?: Array<{ type?: QueryParameterType; name?: string; description?: string }>;
...
export const QueryParameterType: Schema.Schema<QueryParameterType> = Schema.suspend(() => Schema.Struct({
  ...
  timestampPrecision: Schema.optional(Schema.String),
  structTypes: Schema.optional(Schema.Array(Schema.Struct({ type: Schema.optional(QueryParameterType), name: Schema.optional(Schema.String), description: Schema.optional(Schema.String) }))),
  type: Schema.optional(Schema.String),
...
export interface RangePartitioning {
  ...
  range?: { end?: string; start?: string; interval?: string };
...
export const RangePartitioning: Schema.Schema<RangePartitioning> = Schema.suspend(() => Schema.Struct({
  range: Schema.optional(Schema.Struct({ end: Schema.optional(Schema.String), start: Schema.optional(Schema.String), interval: Schema.optional(Schema.String) })),
  field: Schema.optional(Schema.String),
...
export interface TableList {
  ...
  tables?: Array<{ labels?: Record<string, string>; expirationTime?: string; creationTime?: string; rangePartitioning?: RangePartitioning; timePartitioning?: TimePartitioning; view?: { privacyPolicy?: PrivacyPolicy; useLegacySql?: boolean }; type?: string; id?: string; clustering?: Clustering; friendlyName?: string; tableReference?: TableReference; requirePartitionFilter?: boolean; kind?: string }>;
...
export const TableList: Schema.Schema<TableList> = Schema.suspend(() => Schema.Struct({
  etag: Schema.optional(Schema.String),
  kind: Schema.optional(Schema.String),
  tables: Schema.optional(Schema.Array(Schema.Struct({ labels: Schema.optional(Schema.Record(Schema.String, Schema.String)), expirationTime: Schema.optional(Schema.String), creationTime: Schema.optional(Schema.String), rangePartitioning: Schema.optional(RangePartitioning), timePartitioning: Schema.optional(TimePartitioning), view: Schema.optional(Schema.Struct({ privacyPolicy: Schema.optional(PrivacyPolicy), useLegacySql: Schema.optional(Schema.Boolean) })), type: Schema.optional(Schema.String), id: Schema.optional(Schema.String), clustering: Schema.optional(Clustering), friendlyName: Schema.optional(Schema.String), tableReference: Schema.optional(TableReference), requirePartitionFilter: Schema.optional(Schema.Boolean), kind: Schema.optional(Schema.String) }))),
...
export interface DatasetList {
  ...
  datasets?: Array<{ datasetReference?: DatasetReference; externalDatasetReference?: ExternalDatasetReference; location?: string; labels?: Record<string, string>; id?: string; kind?: string; friendlyName?: string }>;
...
export const DatasetList: Schema.Schema<DatasetList> = Schema.suspend(() => Schema.Struct({
  nextPageToken: Schema.optional(Schema.String),
  etag: Schema.optional(Schema.String),
  datasets: Schema.optional(Schema.Array(Schema.Struct({ datasetReference: Schema.optional(DatasetReference), externalDatasetReference: Schema.optional(ExternalDatasetReference), location: Schema.optional(Schema.String), labels: Schema.optional(Schema.Record(Schema.String, Schema.String)), id: Schema.optional(Schema.String), kind: Schema.optional(Schema.String), friendlyName: Schema.optional(Schema.String) }))),
...
export interface JobList {
  ...
  jobs?: Array<{ state?: string; kind?: string; status?: JobStatus; statistics?: JobStatistics; principal_subject?: string; configuration?: JobConfiguration; user_email?: string; errorResult?: ErrorProto; jobReference?: JobReference; id?: string }>;
  /** A hash of this page of results. */
  etag?: string;
  /** A token to request the next page of results. */
  nextPageToken?: string;
...
export const JobList: Schema.Schema<JobList> = Schema.suspend(() => Schema.Struct({
  unreachable: Schema.optional(Schema.Array(Schema.String)),
  jobs: Schema.optional(Schema.Array(Schema.Struct({ state: Schema.optional(Schema.String), kind: Schema.optional(Schema.String), status: Schema.optional(JobStatus), statistics: Schema.optional(JobStatistics), principal_subject: Schema.optional(Schema.String), configuration: Schema.optional(JobConfiguration), user_email: Schema.optional(Schema.String), errorResult: Schema.optional(ErrorProto), jobReference: Schema.optional(JobReference), id: Schema.optional(Schema.String) }))),
  etag: Schema.optional(Schema.String),
  nextPageToken: Schema.optional(Schema.String),
  kind: Schema.optional(Schema.String),
...
export interface BqmlTrainingRun {
  ...
  startTime?: string;
  /** Deprecated. */
  trainingOptions?: { earlyStop?: boolean; maxIteration?: string; l2Reg?: number; warmStart?: boolean; lineSearchInitLearnRate?: number; minRelProgress?: number; learnRateStrategy?: string; l1Reg?: number; learnRate?: number };
  /** Deprecated. */
...
export const BqmlTrainingRun: Schema.Schema<BqmlTrainingRun> = Schema.suspend(() => Schema.Struct({
  state: Schema.optional(Schema.String),
  startTime: Schema.optional(Schema.String),
  trainingOptions: Schema.optional(Schema.Struct({ earlyStop: Schema.optional(Schema.Boolean), maxIteration: Schema.optional(Schema.String), l2Reg: Schema.optional(Schema.Number), warmStart: Schema.optional(Schema.Boolean), lineSearchInitLearnRate: Schema.optional(Schema.Number), minRelProgress: Schema.optional(Schema.Number), learnRateStrategy: Schema.optional(Schema.String), l1Reg: Schema.optional(Schema.Number), learnRate: Schema.optional(Schema.Number) })),
...
export interface ProjectList {
  ...
  projects?: Array<{ kind?: string; friendlyName?: string; numericId?: string; projectReference?: ProjectReference; id?: string }>;
  /** The resource type of the response. */
  kind?: string;
...
export const ProjectList: Schema.Schema<ProjectList> = Schema.suspend(() => Schema.Struct({
  projects: Schema.optional(Schema.Array(Schema.Struct({ kind: Schema.optional(Schema.String), friendlyName: Schema.optional(Schema.String), numericId: Schema.optional(Schema.String), projectReference: Schema.optional(ProjectReference), id: Schema.optional(Schema.String) }))),
  kind: Schema.optional(Schema.String),
  nextPageToken: Schema.optional(Schema.String),
  etag: Schema.optional(Schema.String),
  totalItems: Schema.optional(Schema.Number),
...
export interface TableConstraints {
  ...
  foreignKeys?: Array<{ referencedTable?: { projectId?: string; datasetId?: string; tableId?: string }; columnReferences?: Array<{ referencedColumn?: string; referencingColumn?: string }>; name?: string }>;
...
export const TableConstraints: Schema.Schema<TableConstraints> = Schema.suspend(() => Schema.Struct({
  foreignKeys: Schema.optional(Schema.Array(Schema.Struct({ referencedTable: Schema.optional(Schema.Struct({ projectId: Schema.optional(Schema.String), datasetId: Schema.optional(Schema.String), tableId: Schema.optional(Schema.String) })), columnReferences: Schema.optional(Schema.Array(Schema.Struct({ referencedColumn: Schema.optional(Schema.String), referencingColumn: Schema.optional(Schema.String) }))), name: Schema.optional(Schema.String) }))),
...
export interface Dataset {
  ...
  access?: Array<{ routine?: RoutineReference; userByEmail?: string; specialGroup?: string; view?: TableReference; domain?: string; groupByEmail?: string; dataset?: DatasetAccessEntry; role?: string; iamMember?: string; condition?: Expr }>;
...
export const Dataset: Schema.Schema<Dataset> = Schema.suspend(() => Schema.Struct({
  ...
  access: Schema.optional(Schema.Array(Schema.Struct({ routine: Schema.optional(RoutineReference), userByEmail: Schema.optional(Schema.String), specialGroup: Schema.optional(Schema.String), view: Schema.optional(TableReference), domain: Schema.optional(Schema.String), groupByEmail: Schema.optional(Schema.String), dataset: Schema.optional(DatasetAccessEntry), role: Schema.optional(Schema.String), iamMember: Schema.optional(Schema.String), condition: Schema.optional(Expr) }))),
