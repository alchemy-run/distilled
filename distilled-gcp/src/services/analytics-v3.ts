...
export interface EntityUserLink {
  ...
  entity?: { profileRef?: ProfileRef; webPropertyRef?: WebPropertyRef; accountRef?: AccountRef };
  /** Entity user link ID */
  id?: string;
  /** User reference. */
  userRef?: UserRef;
...
export const EntityUserLink: Schema.Schema<EntityUserLink> = Schema.suspend(() => Schema.Struct({
  ...
  entity: Schema.optional(Schema.Struct({ profileRef: Schema.optional(ProfileRef), webPropertyRef: Schema.optional(WebPropertyRef), accountRef: Schema.optional(AccountRef) })),
  id: Schema.optional(Schema.String),
...
export interface Filter {
  ...
  advancedDetails?: { fieldBIndex?: number; outputToField?: string; fieldBRequired?: boolean; fieldARequired?: boolean; outputConstructor?: string; caseSensitive?: boolean; outputToFieldIndex?: number; overrideOutputField?: boolean; fieldA?: string; extractA?: string; fieldAIndex?: number; fieldB?: string; extractB?: string };
}
...
export const Filter: Schema.Schema<Filter> = Schema.suspend(() => Schema.Struct({
  ...
  uppercaseDetails: Schema.optional(Schema.Struct({ fieldIndex: Schema.optional(Schema.Number), field: Schema.optional(Schema.String) })),
  accountId: Schema.optional(Schema.String),
  includeDetails: Schema.optional(FilterExpression),
  created: Schema.optional(Schema.String),
  lowercaseDetails: Schema.optional(Schema.Struct({ fieldIndex: Schema.optional(Schema.Number), field: Schema.optional(Schema.String) })),
  updated: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  advancedDetails: Schema.optional(Schema.Struct({ fieldBIndex: Schema.optional(Schema.Number), outputToField: Schema.optional(Schema.String), fieldBRequired: Schema.optional(Schema.Boolean), fieldARequired: Schema.optional(Schema.Boolean), outputConstructor: Schema.optional(Schema.String), caseSensitive: Schema.optional(Schema.Boolean), outputToFieldIndex: Schema.optional(Schema.Number), overrideOutputField: Schema.optional(Schema.Boolean), fieldA: Schema.optional(Schema.String), extractA: Schema.optional(Schema.String), fieldAIndex: Schema.optional(Schema.Number), fieldB: Schema.optional(Schema.String), extractB: Schema.optional(Schema.String) })),
})).annotate({ identifier: "Filter" }) as any as Schema.Schema<Filter>;

export interface GaData {
  /** Information for the view (profile), for which the Analytics data was requested. */
  profileInfo?: { profileId?: string; webPropertyId?: string; profileName?: string; accountId?: string; tableId?: string; internalWebPropertyId?: string };
  ...
  query?: { segment?: string; "end-date"?: string; metrics?: Array<string>; filters?: string; "max-results"?: number; sort?: Array<string>; ids?: string; dimensions?: string; samplingLevel?: string; "start-index"?: number; "start-date"?: string };
  ...
  previousLink?: string;
  dataTable?: { rows?: Array<{ c?: Array<{ v?: string }> }>; cols?: Array<{ id?: string; label?: string; type?: string }> };
...
export const GaData: Schema.Schema<GaData> = Schema.suspend(() => Schema.Struct({
  profileInfo: Schema.optional(Schema.Struct({ profileId: Schema.optional(Schema.String), webPropertyId: Schema.optional(Schema.String), profileName: Schema.optional(Schema.String), accountId: Schema.optional(Schema.String), tableId: Schema.optional(Schema.String), internalWebPropertyId: Schema.optional(Schema.String) })),
  totalResults: Schema.optional(Schema.Number),
  itemsPerPage: Schema.optional(Schema.Number),
  nextLink: Schema.optional(Schema.String),
  query: Schema.optional(Schema.Struct({ segment: Schema.optional(Schema.String), "end-date": Schema.optional(Schema.String), metrics: Schema.optional(Schema.Array(Schema.String)), filters: Schema.optional(Schema.String), "max-results": Schema.optional(Schema.Number), sort: Schema.optional(Schema.Array(Schema.String)), ids: Schema.optional(Schema.String), dimensions: Schema.optional(Schema.String), samplingLevel: Schema.optional(Schema.String), "start-index": Schema.optional(Schema.Number), "start-date": Schema.optional(Schema.String) })),
  containsSampledData: Schema.optional(Schema.Boolean),
  rows: Schema.optional(Schema.Array(Schema.Array(Schema.String))),
  previousLink: Schema.optional(Schema.String),
  dataTable: Schema.optional(Schema.Struct({ rows: Schema.optional(Schema.Array(Schema.Struct({ c: Schema.optional(Schema.Array(Schema.Struct({ v: Schema.optional(Schema.String) }))) }))), cols: Schema.optional(Schema.Array(Schema.Struct({ id: Schema.optional(Schema.String), label: Schema.optional(Schema.String), type: Schema.optional(Schema.String) }))) })),
...
export interface Goal {
  ...
  eventDetails?: { eventConditions?: Array<{ matchType?: string; expression?: string; type?: string; comparisonValue?: string; comparisonType?: string }>; useEventValue?: boolean };
  /** Goal name. */
  name?: string;
  ...
  urlDestinationDetails?: { firstStepRequired?: boolean; caseSensitive?: boolean; steps?: Array<{ name?: string; url?: string; number?: number }>; matchType?: string; url?: string };
  /** Determines whether this goal is active. */
  active?: boolean;
  /** Details for the goal of the type VISIT_TIME_ON_SITE. */
  visitTimeOnSiteDetails?: { comparisonValue?: string; comparisonType?: string };
...
export const Goal: Schema.Schema<Goal> = Schema.suspend(() => Schema.Struct({
  ...
  eventDetails: Schema.optional(Schema.Struct({ eventConditions: Schema.optional(Schema.Array(Schema.Struct({ matchType: Schema.optional(Schema.String), expression: Schema.optional(Schema.String), type: Schema.optional(Schema.String), comparisonValue: Schema.optional(Schema.String), comparisonType: Schema.optional(Schema.String) }))), useEventValue: Schema.optional(Schema.Boolean) })),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  updated: Schema.optional(Schema.String),
  created: Schema.optional(Schema.String),
  urlDestinationDetails: Schema.optional(Schema.Struct({ firstStepRequired: Schema.optional(Schema.Boolean), caseSensitive: Schema.optional(Schema.Boolean), steps: Schema.optional(Schema.Array(Schema.Struct({ name: Schema.optional(Schema.String), url: Schema.optional(Schema.String), number: Schema.optional(Schema.Number) }))), matchType: Schema.optional(Schema.String), url: Schema.optional(Schema.String) })),
  active: Schema.optional(Schema.Boolean),
  visitTimeOnSiteDetails: Schema.optional(Schema.Struct({ comparisonValue: Schema.optional(Schema.String), comparisonType: Schema.optional(Schema.String) })),
  internalWebPropertyId: Schema.optional(Schema.String),
  accountId: Schema.optional(Schema.String),
  kind: Schema.optional(Schema.String),
  selfLink: Schema.optional(Schema.String),
...
export interface RemarketingAudience {
  ...
  stateBasedAudienceDefinition?: { includeConditions?: IncludeConditions; excludeConditions?: { exclusionDuration?: string; segment?: string } };
...
export const RemarketingAudience: Schema.Schema<RemarketingAudience> = Schema.suspend(() => Schema.Struct({
  ...
  accountId: Schema.optional(Schema.String),
  stateBasedAudienceDefinition: Schema.optional(Schema.Struct({ includeConditions: Schema.optional(IncludeConditions), excludeConditions: Schema.optional(Schema.Struct({ exclusionDuration: Schema.optional(Schema.String), segment: Schema.optional(Schema.String) })) })),
  internalWebPropertyId: Schema.optional(Schema.String),
  created: Schema.optional(Schema.String),
...
export interface RealtimeData {
  ...
  query?: { "max-results"?: number; sort?: Array<string>; dimensions?: string; ids?: string; filters?: string; metrics?: Array<string> };
  /** Link to this page. */
  selfLink?: string;
  /** Unique ID for this data response. */
  id?: string;
  /** Column headers that list dimension names followed by the metric names. The order of dimensions and metrics is same as specified in the request. */
  columnHeaders?: Array<{ columnType?: string; name?: string; dataType?: string }>;
  /** Total values for the requested metrics over all the results, not just the results returned in this response. The order of the metric totals is same as the metric order specified in the request. */
  totalsForAllResults?: Record<string, string>;
  /** The total number of rows for the query, regardless of the number of rows in the response. */
  totalResults?: number;
  ...
  profileInfo?: { accountId?: string; tableId?: string; internalWebPropertyId?: string; profileId?: string; webPropertyId?: string; profileName?: string };
}

export const RealtimeData: Schema.Schema<RealtimeData> = Schema.suspend(() => Schema.Struct({
  kind: Schema.optional(Schema.String),
  query: Schema.optional(Schema.Struct({ "max-results": Schema.optional(Schema.Number), sort: Schema.optional(Schema.Array(Schema.String)), dimensions: Schema.optional(Schema.String), ids: Schema.optional(Schema.String), filters: Schema.optional(Schema.String), metrics: Schema.optional(Schema.Array(Schema.String)) })),
  selfLink: Schema.optional(Schema.String),
  id: Schema.optional(Schema.String),
  columnHeaders: Schema.optional(Schema.Array(Schema.Struct({ columnType: Schema.optional(Schema.String), name: Schema.optional(Schema.String), dataType: Schema.optional(Schema.String) }))),
  totalsForAllResults: Schema.optional(Schema.Record(Schema.String, Schema.String)),
  totalResults: Schema.optional(Schema.Number),
  rows: Schema.optional(Schema.Array(Schema.Array(Schema.String))),
  profileInfo: Schema.optional(Schema.Struct({ accountId: Schema.optional(Schema.String), tableId: Schema.optional(Schema.String), internalWebPropertyId: Schema.optional(Schema.String), profileId: Schema.optional(Schema.String), webPropertyId: Schema.optional(Schema.String), profileName: Schema.optional(Schema.String) })),
...
export interface McfData {
  ...
  containsSampledData?: boolean;
  /** Analytics data request query parameters. */
  query?: { filters?: string; "end-date"?: string; metrics?: Array<string>; segment?: string; sort?: Array<string>; "max-results"?: number; samplingLevel?: string; "start-index"?: number; dimensions?: string; ids?: string; "start-date"?: string };
  /** The maximum number of rows the response can contain, regardless of the actual number of rows returned. Its value ranges from 1 to 10,000 with a value of 1000 by default, or otherwise specified by the max-results query parameter. */
  itemsPerPage?: number;
  /** Link to next page for this Analytics data query. */
  nextLink?: string;
  ...
  totalResults?: number;
  /** Information for the view (profile), for which the Analytics data was requested. */
  profileInfo?: { webPropertyId?: string; profileId?: string; profileName?: string; internalWebPropertyId?: string; accountId?: string; tableId?: string };
}
...
export const McfData: Schema.Schema<McfData> = Schema.suspend(() => Schema.Struct({
  ...
  sampleSpace: Schema.optional(Schema.String),
  id: Schema.optional(Schema.String),
  columnHeaders: Schema.optional(Schema.Array(Schema.Struct({ name: Schema.optional(Schema.String), dataType: Schema.optional(Schema.String), columnType: Schema.optional(Schema.String) }))),
  totalsForAllResults: Schema.optional(Schema.Record(Schema.String, Schema.String)),
  sampleSize: Schema.optional(Schema.String),
  ...
  previousLink: Schema.optional(Schema.String),
  containsSampledData: Schema.optional(Schema.Boolean),
  query: Schema.optional(Schema.Struct({ filters: Schema.optional(Schema.String), "end-date": Schema.optional(Schema.String), metrics: Schema.optional(Schema.Array(Schema.String)), segment: Schema.optional(Schema.String), sort: Schema.optional(Schema.Array(Schema.String)), "max-results": Schema.optional(Schema.Number), samplingLevel: Schema.optional(Schema.String), "start-index": Schema.optional(Schema.Number), dimensions: Schema.optional(Schema.String), ids: Schema.optional(Schema.String), "start-date": Schema.optional(Schema.String) })),
  itemsPerPage: Schema.optional(Schema.Number),
  nextLink: Schema.optional(Schema.String),
  totalResults: Schema.optional(Schema.Number),
  profileInfo: Schema.optional(Schema.Struct({ webPropertyId: Schema.optional(Schema.String), profileId: Schema.optional(Schema.String), profileName: Schema.optional(Schema.String), internalWebPropertyId: Schema.optional(Schema.String), accountId: Schema.optional(Schema.String), tableId: Schema.optional(Schema.String) })),
...
export interface Experiment {
  ...
  variations?: Array<{ name?: string; weight?: number; won?: boolean; url?: string; status?: string }>;
...
export const Experiment: Schema.Schema<Experiment> = Schema.suspend(() => Schema.Struct({
  ...
  variations: Schema.optional(Schema.Array(Schema.Struct({ name: Schema.optional(Schema.String), weight: Schema.optional(Schema.Number), won: Schema.optional(Schema.Boolean), url: Schema.optional(Schema.String), status: Schema.optional(Schema.String) }))),
  internalWebPropertyId: Schema.optional(Schema.String),
  parentLink: Schema.optional(Schema.Struct({ type: Schema.optional(Schema.String), href: Schema.optional(Schema.String) })),
  webPropertyId: Schema.optional(Schema.String),
