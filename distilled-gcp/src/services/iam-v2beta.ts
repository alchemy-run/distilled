...
export const GoogleIamV2betaDenyRule: Schema.Schema<GoogleIamV2betaDenyRule> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleIamV2betaDenyRule" }) as any as Schema.Schema<GoogleIamV2betaDenyRule>;
...
export const GoogleIamV2betaPolicyRule: Schema.Schema<GoogleIamV2betaPolicyRule> = Schema.suspend(() => Schema.Struct({
  denyRule: Schema.optional(GoogleIamV2betaDenyRule),
  description: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleIamV2betaPolicyRule" }) as any as Schema.Schema<GoogleIamV2betaPolicyRule>;
...
export const GoogleIamV2betaPolicy: Schema.Schema<GoogleIamV2betaPolicy> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
...
})).annotate({ identifier: "GoogleIamV2betaPolicy" }) as any as Schema.Schema<GoogleIamV2betaPolicy>;
...
export const GoogleIamV2betaListPoliciesResponse: Schema.Schema<GoogleIamV2betaListPoliciesResponse> = Schema.suspend(() => Schema.Struct({
  policies: Schema.optional(Schema.Array(GoogleIamV2betaPolicy)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleIamV2betaListPoliciesResponse" }) as any as Schema.Schema<GoogleIamV2betaListPoliciesResponse>;
...
export const GoogleIamV2betaPolicyOperationMetadata: Schema.Schema<GoogleIamV2betaPolicyOperationMetadata> = Schema.suspend(() => Schema.Struct({
  createTime: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleIamV2betaPolicyOperationMetadata" }) as any as Schema.Schema<GoogleIamV2betaPolicyOperationMetadata>;
...
export const ListPoliciesPoliciesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2beta/policies/{policiesId}/{policiesId1}" }),
  svc,
...
export const ListPoliciesPoliciesResponse = GoogleIamV2betaListPoliciesResponse;
...
export const GetPoliciesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2beta/policies/{policiesId}/{policiesId1}/{policiesId2}" }),
  svc,
) as unknown as Schema.Schema<GetPoliciesRequest>;

export type GetPoliciesResponse = GoogleIamV2betaPolicy;
export const GetPoliciesResponse = GoogleIamV2betaPolicy;
...
export const CreatePolicyPoliciesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v2beta/policies/{policiesId}/{policiesId1}", hasBody: true }),
  svc,
...
export const UpdatePoliciesRequest = Schema.Struct({
  ...
  T.Http({ method: "PUT", path: "v2beta/policies/{policiesId}/{policiesId1}/{policiesId2}", hasBody: true }),
  svc,
...
export const DeletePoliciesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v2beta/policies/{policiesId}/{policiesId1}/{policiesId2}" }),
  svc,
...
export const GetPoliciesOperationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v2beta/policies/{policiesId}/{policiesId1}/{policiesId2}/operations/{operationsId}" }),
  svc,
