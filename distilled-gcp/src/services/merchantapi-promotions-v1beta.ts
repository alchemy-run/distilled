...
export const InsertAccountsPromotionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "promotions/v1beta/accounts/{accountsId}/promotions:insert", hasBody: true }),
  svc,
...
export type InsertAccountsPromotionsError = CommonErrors;
...
export const insertAccountsPromotions: API.OperationMethod<InsertAccountsPromotionsRequest, InsertAccountsPromotionsResponse, InsertAccountsPromotionsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetAccountsPromotionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "promotions/v1beta/accounts/{accountsId}/promotions/{promotionsId}" }),
  svc,
...
export type GetAccountsPromotionsError = CommonErrors;
...
export const getAccountsPromotions: API.OperationMethod<GetAccountsPromotionsRequest, GetAccountsPromotionsResponse, GetAccountsPromotionsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ListAccountsPromotionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "promotions/v1beta/accounts/{accountsId}/promotions" }),
  svc,
...
export type ListAccountsPromotionsError = CommonErrors;
...
export const listAccountsPromotions: API.PaginatedOperationMethod<ListAccountsPromotionsRequest, ListAccountsPromotionsResponse, ListAccountsPromotionsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
