...
export const Task: Schema.Schema<Task> = Schema.suspend(() => Schema.Struct({
  ...
  links: Schema.optional(Schema.Array(Schema.Struct({ link: Schema.optional(Schema.String), type: Schema.optional(Schema.String), description: Schema.optional(Schema.String) }))),
