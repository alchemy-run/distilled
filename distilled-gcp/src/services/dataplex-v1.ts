...
export type PatchProjectsLocationsEntryGroupsEntryLinksError = CommonErrors;

/** Updates an Entry Link. */
export const patchProjectsLocationsEntryGroupsEntryLinks: API.OperationMethod<PatchProjectsLocationsEntryGroupsEntryLinksRequest, PatchProjectsLocationsEntryGroupsEntryLinksResponse, PatchProjectsLocationsEntryGroupsEntryLinksError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
