...
export const InsertAccountsLfpInventoriesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "lfp/v1/accounts/{accountsId}/lfpInventories:insert", hasBody: true }),
  svc,
...
export type InsertAccountsLfpInventoriesError = CommonErrors;
...
export const insertAccountsLfpInventories: API.OperationMethod<InsertAccountsLfpInventoriesRequest, InsertAccountsLfpInventoriesResponse, InsertAccountsLfpInventoriesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetAccountsLfpMerchantStatesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "lfp/v1/accounts/{accountsId}/lfpMerchantStates/{lfpMerchantStatesId}" }),
  svc,
...
export type GetAccountsLfpMerchantStatesError = CommonErrors;

/** Gets the LFP state of a merchant */
export const getAccountsLfpMerchantStates: API.OperationMethod<GetAccountsLfpMerchantStatesRequest, GetAccountsLfpMerchantStatesResponse, GetAccountsLfpMerchantStatesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const InsertAccountsLfpSalesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "lfp/v1/accounts/{accountsId}/lfpSales:insert", hasBody: true }),
  svc,
...
export type InsertAccountsLfpSalesError = CommonErrors;

/** Inserts a `LfpSale` for the given merchant. */
export const insertAccountsLfpSales: API.OperationMethod<InsertAccountsLfpSalesRequest, InsertAccountsLfpSalesResponse, InsertAccountsLfpSalesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const InsertAccountsLfpStoresRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "lfp/v1/accounts/{accountsId}/lfpStores:insert", hasBody: true }),
  svc,
...
export type InsertAccountsLfpStoresError = CommonErrors;

/** Inserts a store for the target merchant. If the store with the same store code already exists, it will be replaced. */
export const insertAccountsLfpStores: API.OperationMethod<InsertAccountsLfpStoresRequest, InsertAccountsLfpStoresResponse, InsertAccountsLfpStoresError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type ListAccountsLfpStoresError = CommonErrors;

/** Lists the stores of the target merchant, specified by the filter in `ListLfpStoresRequest`. */
export const listAccountsLfpStores: API.PaginatedOperationMethod<ListAccountsLfpStoresRequest, ListAccountsLfpStoresResponse, ListAccountsLfpStoresError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetAccountsLfpStoresRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "lfp/v1/accounts/{accountsId}/lfpStores/{lfpStoresId}" }),
  svc,
...
export type GetAccountsLfpStoresError = CommonErrors;

/** Retrieves information about a store. */
export const getAccountsLfpStores: API.OperationMethod<GetAccountsLfpStoresRequest, GetAccountsLfpStoresResponse, GetAccountsLfpStoresError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteAccountsLfpStoresRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "lfp/v1/accounts/{accountsId}/lfpStores/{lfpStoresId}" }),
  svc,
...
export type DeleteAccountsLfpStoresError = CommonErrors;

/** Deletes a store for a target merchant. */
export const deleteAccountsLfpStores: API.OperationMethod<DeleteAccountsLfpStoresRequest, DeleteAccountsLfpStoresResponse, DeleteAccountsLfpStoresError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
