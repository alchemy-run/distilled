...
export interface Subscription {
  ...
  plan?: { planName?: string; isCommitmentPlan?: boolean; commitmentInterval?: { startTime?: string; endTime?: string } };
  /** Read-only transfer related information for the subscription. For more information, see retrieve transferable subscriptions for a customer. */
  transferInfo?: { currentLegacySkuId?: string; minimumTransferableSeats?: number; transferabilityExpirationTime?: string };
...
export const Subscription: Schema.Schema<Subscription> = Schema.suspend(() => Schema.Struct({
  ...
  trialSettings: Schema.optional(Schema.Struct({ trialEndTime: Schema.optional(Schema.String), isInTrial: Schema.optional(Schema.Boolean) })),
  seats: Schema.optional(Seats),
  creationTime: Schema.optional(Schema.String),
  plan: Schema.optional(Schema.Struct({ planName: Schema.optional(Schema.String), isCommitmentPlan: Schema.optional(Schema.Boolean), commitmentInterval: Schema.optional(Schema.Struct({ startTime: Schema.optional(Schema.String), endTime: Schema.optional(Schema.String) })) })),
  transferInfo: Schema.optional(Schema.Struct({ currentLegacySkuId: Schema.optional(Schema.String), minimumTransferableSeats: Schema.optional(Schema.Number), transferabilityExpirationTime: Schema.optional(Schema.String) })),
