...
export interface Operation {
  ...
  error?: { errors?: Array<{ code?: string; message?: string; location?: string; errorDetails?: Array<{ quotaInfo?: QuotaExceededInfo; localizedMessage?: LocalizedMessage; help?: Help; errorInfo?: ErrorInfo }>; arguments?: Array<string>; debugInfo?: DebugInfo }> };
...
export const Operation: Schema.Schema<Operation> = Schema.suspend(() => Schema.Struct({
  ...
  error: Schema.optional(Schema.Struct({ errors: Schema.optional(Schema.Array(Schema.Struct({ code: Schema.optional(Schema.String), message: Schema.optional(Schema.String), location: Schema.optional(Schema.String), errorDetails: Schema.optional(Schema.Array(Schema.Struct({ quotaInfo: Schema.optional(QuotaExceededInfo), localizedMessage: Schema.optional(LocalizedMessage), help: Schema.optional(Help), errorInfo: Schema.optional(ErrorInfo) }))), arguments: Schema.optional(Schema.Array(Schema.String)), debugInfo: Schema.optional(DebugInfo) }))) })),
...
export interface ResourceUpdate {
  ...
  error?: { errors?: Array<{ debugInfo?: DebugInfo; arguments?: Array<string>; errorDetails?: Array<{ help?: Help; localizedMessage?: LocalizedMessage; errorInfo?: ErrorInfo; quotaInfo?: QuotaExceededInfo }>; location?: string; code?: string; message?: string }> };
...
export const ResourceUpdate: Schema.Schema<ResourceUpdate> = Schema.suspend(() => Schema.Struct({
  ...
  error: Schema.optional(Schema.Struct({ errors: Schema.optional(Schema.Array(Schema.Struct({ debugInfo: Schema.optional(DebugInfo), arguments: Schema.optional(Schema.Array(Schema.String)), errorDetails: Schema.optional(Schema.Array(Schema.Struct({ help: Schema.optional(Help), localizedMessage: Schema.optional(LocalizedMessage), errorInfo: Schema.optional(ErrorInfo), quotaInfo: Schema.optional(QuotaExceededInfo) }))), location: Schema.optional(Schema.String), code: Schema.optional(Schema.String), message: Schema.optional(Schema.String) }))) })),
...
export interface Resource {
  ...
  manifest?: string;
  /** Output only. If warning messages are generated during processing of this resource, this field will be populated. */
  warnings?: Array<{ code?: "DEPRECATED_RESOURCE_USED" | "NO_RESULTS_ON_PAGE" | "UNREACHABLE" | "NEXT_HOP_ADDRESS_NOT_ASSIGNED" | "NEXT_HOP_INSTANCE_NOT_FOUND" | "NEXT_HOP_INSTANCE_NOT_ON_NETWORK" | "NEXT_HOP_CANNOT_IP_FORWARD" | "NEXT_HOP_NOT_RUNNING" | "INJECTED_KERNELS_DEPRECATED" | "REQUIRED_TOS_AGREEMENT" | "DISK_SIZE_LARGER_THAN_IMAGE_SIZE" | "RESOURCE_NOT_DELETED" | "SINGLE_INSTANCE_PROPERTY_TEMPLATE" | "NOT_CRITICAL_ERROR" | "CLEANUP_FAILED" | "FIELD_VALUE_OVERRIDEN" | "RESOURCE_IN_USE_BY_OTHER_RESOURCE_WARNING" | "NETWORK_ENDPOINT_NOT_DETACHED" | "PAGE_MISSING_RESULTS" | "SSL_POLICY_ENABLED_FEATURES_NOT_FETCHED" | "RESOURCE_NOT_FOUND_WARNING" | "MISSING_TYPE_DEPENDENCY" | "EXTERNAL_API_WARNING" | "SCHEMA_VALIDATION_IGNORED" | "UNDECLARED_PROPERTIES" | "EXPERIMENTAL_TYPE_USED" | "DEPRECATED_TYPE_USED" | "PARTIAL_SUCCESS" | "LARGE_DEPLOYMENT_WARNING" | "NEXT_HOP_INSTANCE_HAS_NO_IPV6_INTERFACE" | "INVALID_HEALTH_CHECK_FOR_DYNAMIC_WIEGHTED_LB" | "LIST_OVERHEAD_QUOTA_EXCEED" | "QUOTA_INFO_UNAVAILABLE" | "RESOURCE_USES_GLOBAL_DNS" | "RATE_LIMIT_EXCEEDED" | "UPCOMING_MAINTENANCES_UNAVAILABLE" | "RESERVED_ENTRY_136" | "RESERVED_ENTRY_139" | "RESERVED_ENTRY_141" | "RESERVED_ENTRY_142" | "RESERVED_ENTRY_143" | (string & {}); message?: string; data?: Array<{ value?: string; key?: string }> }>;
...
export const Resource: Schema.Schema<Resource> = Schema.suspend(() => Schema.Struct({
  ...
  accessControl: Schema.optional(ResourceAccessControl),
  manifest: Schema.optional(Schema.String),
  warnings: Schema.optional(Schema.Array(Schema.Struct({ code: Schema.optional(Schema.String), message: Schema.optional(Schema.String), data: Schema.optional(Schema.Array(Schema.Struct({ value: Schema.optional(Schema.String), key: Schema.optional(Schema.String) }))) }))),
