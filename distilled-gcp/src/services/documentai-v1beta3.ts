...
export const GoogleCloudDocumentaiV1beta3DocumentTextAnchorTextSegment: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentTextAnchorTextSegment> = Schema.suspend(() => Schema.Struct({
  startIndex: Schema.optional(Schema.String),
  endIndex: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentTextAnchorTextSegment" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentTextAnchorTextSegment>;
...
export const GoogleCloudDocumentaiV1beta3DocumentTextAnchor: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentTextAnchor> = Schema.suspend(() => Schema.Struct({
  textSegments: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentTextAnchorTextSegment)),
  content: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentTextAnchor" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentTextAnchor>;
...
export const GoogleCloudDocumentaiV1beta3DocumentStyleFontSize: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentStyleFontSize> = Schema.suspend(() => Schema.Struct({
  size: Schema.optional(Schema.Number),
  unit: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentStyleFontSize" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentStyleFontSize>;
...
export const GoogleCloudDocumentaiV1beta3DocumentStyle: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentStyle> = Schema.suspend(() => Schema.Struct({
  ...
  fontSize: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentStyleFontSize),
  fontFamily: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentStyle" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentStyle>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageImage: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageImage> = Schema.suspend(() => Schema.Struct({
  content: Schema.optional(Schema.String),
  mimeType: Schema.optional(Schema.String),
  width: Schema.optional(Schema.Number),
  height: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageImage" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageImage>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageMatrix: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageMatrix> = Schema.suspend(() => Schema.Struct({
  rows: Schema.optional(Schema.Number),
  cols: Schema.optional(Schema.Number),
  type: Schema.optional(Schema.Number),
  data: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageMatrix" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageMatrix>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageDimension: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageDimension> = Schema.suspend(() => Schema.Struct({
  width: Schema.optional(Schema.Number),
  height: Schema.optional(Schema.Number),
  unit: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageDimension" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageDimension>;
...
export const GoogleCloudDocumentaiV1beta3Vertex: Schema.Schema<GoogleCloudDocumentaiV1beta3Vertex> = Schema.suspend(() => Schema.Struct({
  x: Schema.optional(Schema.Number),
  y: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3Vertex" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3Vertex>;
...
export const GoogleCloudDocumentaiV1beta3NormalizedVertex: Schema.Schema<GoogleCloudDocumentaiV1beta3NormalizedVertex> = Schema.suspend(() => Schema.Struct({
  x: Schema.optional(Schema.Number),
  y: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3NormalizedVertex" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3NormalizedVertex>;
...
export const GoogleCloudDocumentaiV1beta3BoundingPoly: Schema.Schema<GoogleCloudDocumentaiV1beta3BoundingPoly> = Schema.suspend(() => Schema.Struct({
  vertices: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3Vertex)),
  normalizedVertices: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3NormalizedVertex)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3BoundingPoly" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3BoundingPoly>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageLayout: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageLayout> = Schema.suspend(() => Schema.Struct({
  textAnchor: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentTextAnchor),
  confidence: Schema.optional(Schema.Number),
  boundingPoly: Schema.optional(GoogleCloudDocumentaiV1beta3BoundingPoly),
  orientation: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageLayout" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageLayout>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage> = Schema.suspend(() => Schema.Struct({
  languageCode: Schema.optional(Schema.String),
  confidence: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage>;
...
export const GoogleCloudDocumentaiV1beta3DocumentProvenanceParent: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentProvenanceParent> = Schema.suspend(() => Schema.Struct({
  revision: Schema.optional(Schema.Number),
  index: Schema.optional(Schema.Number),
  id: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentProvenanceParent" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentProvenanceParent>;
...
export const GoogleCloudDocumentaiV1beta3DocumentProvenance: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentProvenance> = Schema.suspend(() => Schema.Struct({
  revision: Schema.optional(Schema.Number),
  id: Schema.optional(Schema.Number),
  parents: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentProvenanceParent)),
  type: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentProvenance" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentProvenance>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageBlock: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageBlock> = Schema.suspend(() => Schema.Struct({
  layout: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentPageLayout),
  detectedLanguages: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage)),
  provenance: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentProvenance),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageBlock" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageBlock>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageParagraph: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageParagraph> = Schema.suspend(() => Schema.Struct({
  layout: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentPageLayout),
  detectedLanguages: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage)),
  provenance: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentProvenance),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageParagraph" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageParagraph>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageLine: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageLine> = Schema.suspend(() => Schema.Struct({
  layout: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentPageLayout),
  detectedLanguages: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage)),
  provenance: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentProvenance),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageLine" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageLine>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageTokenDetectedBreak: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageTokenDetectedBreak> = Schema.suspend(() => Schema.Struct({
  type: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageTokenDetectedBreak" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageTokenDetectedBreak>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageTokenStyleInfo: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageTokenStyleInfo> = Schema.suspend(() => Schema.Struct({
  ...
  backgroundColor: Schema.optional(GoogleTypeColor),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageTokenStyleInfo" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageTokenStyleInfo>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageToken: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageToken> = Schema.suspend(() => Schema.Struct({
  layout: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentPageLayout),
  detectedBreak: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentPageTokenDetectedBreak),
  detectedLanguages: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage)),
  provenance: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentProvenance),
  styleInfo: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentPageTokenStyleInfo),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageToken" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageToken>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageVisualElement: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageVisualElement> = Schema.suspend(() => Schema.Struct({
  layout: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentPageLayout),
  type: Schema.optional(Schema.String),
  detectedLanguages: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageVisualElement" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageVisualElement>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageTableTableCell: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageTableTableCell> = Schema.suspend(() => Schema.Struct({
  layout: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentPageLayout),
  rowSpan: Schema.optional(Schema.Number),
  colSpan: Schema.optional(Schema.Number),
  detectedLanguages: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageTableTableCell" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageTableTableCell>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageTableTableRow: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageTableTableRow> = Schema.suspend(() => Schema.Struct({
  cells: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageTableTableCell)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageTableTableRow" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageTableTableRow>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageTable: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageTable> = Schema.suspend(() => Schema.Struct({
  layout: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentPageLayout),
  headerRows: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageTableTableRow)),
  bodyRows: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageTableTableRow)),
  detectedLanguages: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage)),
  provenance: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentProvenance),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageTable" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageTable>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageFormField: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageFormField> = Schema.suspend(() => Schema.Struct({
  ...
  nameDetectedLanguages: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage)),
  valueDetectedLanguages: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage)),
  valueType: Schema.optional(Schema.String),
  correctedKeyText: Schema.optional(Schema.String),
  correctedValueText: Schema.optional(Schema.String),
  provenance: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentProvenance),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageFormField" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageFormField>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageSymbol: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageSymbol> = Schema.suspend(() => Schema.Struct({
  layout: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentPageLayout),
  detectedLanguages: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageSymbol" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageSymbol>;
...
export const GoogleCloudDocumentaiV1beta3Barcode: Schema.Schema<GoogleCloudDocumentaiV1beta3Barcode> = Schema.suspend(() => Schema.Struct({
  format: Schema.optional(Schema.String),
  valueFormat: Schema.optional(Schema.String),
  rawValue: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3Barcode" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3Barcode>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageDetectedBarcode: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageDetectedBarcode> = Schema.suspend(() => Schema.Struct({
  layout: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentPageLayout),
  barcode: Schema.optional(GoogleCloudDocumentaiV1beta3Barcode),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageDetectedBarcode" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageDetectedBarcode>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageImageQualityScoresDetectedDefect: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageImageQualityScoresDetectedDefect> = Schema.suspend(() => Schema.Struct({
  type: Schema.optional(Schema.String),
  confidence: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageImageQualityScoresDetectedDefect" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageImageQualityScoresDetectedDefect>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageImageQualityScores: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageImageQualityScores> = Schema.suspend(() => Schema.Struct({
  qualityScore: Schema.optional(Schema.Number),
  detectedDefects: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageImageQualityScoresDetectedDefect)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageImageQualityScores" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageImageQualityScores>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPage: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPage> = Schema.suspend(() => Schema.Struct({
  pageNumber: Schema.optional(Schema.Number),
  image: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentPageImage),
  transforms: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageMatrix)),
  dimension: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentPageDimension),
  layout: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentPageLayout),
  detectedLanguages: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage)),
  blocks: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageBlock)),
  paragraphs: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageParagraph)),
  lines: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageLine)),
  tokens: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageToken)),
  visualElements: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageVisualElement)),
  tables: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageTable)),
  formFields: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageFormField)),
  symbols: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageSymbol)),
  detectedBarcodes: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageDetectedBarcode)),
  imageQualityScores: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentPageImageQualityScores),
  provenance: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentProvenance),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPage" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPage>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageAnchorPageRef: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageAnchorPageRef> = Schema.suspend(() => Schema.Struct({
  page: Schema.optional(Schema.String),
  layoutType: Schema.optional(Schema.String),
  layoutId: Schema.optional(Schema.String),
  boundingPoly: Schema.optional(GoogleCloudDocumentaiV1beta3BoundingPoly),
  confidence: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageAnchorPageRef" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageAnchorPageRef>;
...
export const GoogleCloudDocumentaiV1beta3DocumentPageAnchor: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageAnchor> = Schema.suspend(() => Schema.Struct({
  pageRefs: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPageAnchorPageRef)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentPageAnchor" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentPageAnchor>;
...
export const GoogleCloudDocumentaiV1beta3DocumentEntityNormalizedValue: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentEntityNormalizedValue> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentEntityNormalizedValue" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentEntityNormalizedValue>;
...
export const GoogleCloudDocumentaiV1beta3DocumentEntity: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentEntity> = Schema.suspend(() => Schema.Struct({
  textAnchor: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentTextAnchor),
  type: Schema.optional(Schema.String),
  mentionText: Schema.optional(Schema.String),
  mentionId: Schema.optional(Schema.String),
  confidence: Schema.optional(Schema.Number),
  pageAnchor: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentPageAnchor),
  id: Schema.optional(Schema.String),
  normalizedValue: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentEntityNormalizedValue),
  properties: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentEntity)),
  provenance: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentProvenance),
  redacted: Schema.optional(Schema.Boolean),
  method: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentEntity" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentEntity>;
...
export const GoogleCloudDocumentaiV1beta3DocumentEntityRelation: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentEntityRelation> = Schema.suspend(() => Schema.Struct({
  subjectId: Schema.optional(Schema.String),
  objectId: Schema.optional(Schema.String),
  relation: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentEntityRelation" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentEntityRelation>;
...
export const GoogleCloudDocumentaiV1beta3DocumentTextChange: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentTextChange> = Schema.suspend(() => Schema.Struct({
  textAnchor: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentTextAnchor),
  changedText: Schema.optional(Schema.String),
  provenance: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentProvenance)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentTextChange" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentTextChange>;
...
export const GoogleCloudDocumentaiV1beta3DocumentShardInfo: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentShardInfo> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentShardInfo" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentShardInfo>;
...
export const GoogleCloudDocumentaiV1beta3DocumentRevisionHumanReview: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentRevisionHumanReview> = Schema.suspend(() => Schema.Struct({
  state: Schema.optional(Schema.String),
  stateMessage: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentRevisionHumanReview" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentRevisionHumanReview>;
...
export const GoogleCloudDocumentaiV1beta3DocumentRevision: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentRevision> = Schema.suspend(() => Schema.Struct({
  ...
  humanReview: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentRevisionHumanReview),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentRevision" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentRevision>;
...
export const GoogleCloudDocumentaiV1beta3DocumentAnnotations: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentAnnotations> = Schema.suspend(() => Schema.Struct({
  description: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentAnnotations" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentAnnotations>;
...
export const GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTextBlock: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTextBlock> = Schema.suspend(() => Schema.Struct({
  text: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  blocks: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlock)),
  annotations: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentAnnotations),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTextBlock" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTextBlock>;
...
export const GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTableCell: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTableCell> = Schema.suspend(() => Schema.Struct({
  blocks: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlock)),
  rowSpan: Schema.optional(Schema.Number),
  colSpan: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTableCell" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTableCell>;
...
export const GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTableRow: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTableRow> = Schema.suspend(() => Schema.Struct({
  cells: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTableCell)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTableRow" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTableRow>;
...
export const GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTableBlock: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTableBlock> = Schema.suspend(() => Schema.Struct({
  headerRows: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTableRow)),
  bodyRows: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTableRow)),
  caption: Schema.optional(Schema.String),
  annotations: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentAnnotations),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTableBlock" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTableBlock>;
...
export const GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutListEntry: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutListEntry> = Schema.suspend(() => Schema.Struct({
  blocks: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlock)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutListEntry" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutListEntry>;
...
export const GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutListBlock: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutListBlock> = Schema.suspend(() => Schema.Struct({
  listEntries: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutListEntry)),
  type: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutListBlock" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutListBlock>;
...
export const GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutImageBlock: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutImageBlock> = Schema.suspend(() => Schema.Struct({
  ...
  annotations: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentAnnotations),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutImageBlock" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutImageBlock>;
...
export const GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutPageSpan: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutPageSpan> = Schema.suspend(() => Schema.Struct({
  pageStart: Schema.optional(Schema.Number),
  pageEnd: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutPageSpan" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutPageSpan>;
...
export const GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlock: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlock> = Schema.suspend(() => Schema.Struct({
  textBlock: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTextBlock),
  tableBlock: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutTableBlock),
  listBlock: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutListBlock),
  imageBlock: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutImageBlock),
  blockId: Schema.optional(Schema.String),
  pageSpan: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlockLayoutPageSpan),
  boundingBox: Schema.optional(GoogleCloudDocumentaiV1beta3BoundingPoly),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlock" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlock>;
...
export const GoogleCloudDocumentaiV1beta3DocumentDocumentLayout: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayout> = Schema.suspend(() => Schema.Struct({
  blocks: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentDocumentLayoutDocumentLayoutBlock)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentDocumentLayout" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentDocumentLayout>;
...
export const GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkPageSpan: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkPageSpan> = Schema.suspend(() => Schema.Struct({
  pageStart: Schema.optional(Schema.Number),
  pageEnd: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkPageSpan" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkPageSpan>;
...
export const GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkPageHeader: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkPageHeader> = Schema.suspend(() => Schema.Struct({
  text: Schema.optional(Schema.String),
  pageSpan: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkPageSpan),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkPageHeader" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkPageHeader>;
...
export const GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkPageFooter: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkPageFooter> = Schema.suspend(() => Schema.Struct({
  text: Schema.optional(Schema.String),
  pageSpan: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkPageSpan),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkPageFooter" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkPageFooter>;
...
export const GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkImageChunkField: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkImageChunkField> = Schema.suspend(() => Schema.Struct({
  blobAssetId: Schema.optional(Schema.String),
  gcsUri: Schema.optional(Schema.String),
  dataUri: Schema.optional(Schema.String),
  annotations: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentAnnotations),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkImageChunkField" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkImageChunkField>;
...
export const GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkTableChunkField: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkTableChunkField> = Schema.suspend(() => Schema.Struct({
  annotations: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentAnnotations),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkTableChunkField" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkTableChunkField>;
...
export const GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkField: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkField> = Schema.suspend(() => Schema.Struct({
  imageChunkField: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkImageChunkField),
  tableChunkField: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkTableChunkField),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkField" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkField>;
...
export const GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunk: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunk> = Schema.suspend(() => Schema.Struct({
  chunkId: Schema.optional(Schema.String),
  sourceBlockIds: Schema.optional(Schema.Array(Schema.String)),
  content: Schema.optional(Schema.String),
  pageSpan: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkPageSpan),
  pageHeaders: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkPageHeader)),
  pageFooters: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkPageFooter)),
  chunkFields: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunkChunkField)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunk" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunk>;
...
export const GoogleCloudDocumentaiV1beta3DocumentChunkedDocument: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentChunkedDocument> = Schema.suspend(() => Schema.Struct({
  chunks: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentChunkedDocumentChunk)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentChunkedDocument" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentChunkedDocument>;
...
export const GoogleCloudDocumentaiV1beta3DocumentBlobAsset: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentBlobAsset> = Schema.suspend(() => Schema.Struct({
  assetId: Schema.optional(Schema.String),
  content: Schema.optional(Schema.String),
  mimeType: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentBlobAsset" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentBlobAsset>;
...
export const GoogleCloudDocumentaiV1beta3DocumentEntityValidationOutputValidationResult: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentEntityValidationOutputValidationResult> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentEntityValidationOutputValidationResult" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentEntityValidationOutputValidationResult>;
...
export const GoogleCloudDocumentaiV1beta3DocumentEntityValidationOutput: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentEntityValidationOutput> = Schema.suspend(() => Schema.Struct({
  validationResults: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentEntityValidationOutputValidationResult)),
  passAllRules: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentEntityValidationOutput" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentEntityValidationOutput>;
...
export const GoogleCloudDocumentaiV1beta3DocumentEntitiesRevision: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentEntitiesRevision> = Schema.suspend(() => Schema.Struct({
  revisionId: Schema.optional(Schema.String),
  entities: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentEntity)),
  entityValidationOutput: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentEntityValidationOutput),
  provenance: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentProvenance),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentEntitiesRevision" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentEntitiesRevision>;
...
export const GoogleCloudDocumentaiV1beta3Document: Schema.Schema<GoogleCloudDocumentaiV1beta3Document> = Schema.suspend(() => Schema.Struct({
  uri: Schema.optional(Schema.String),
  content: Schema.optional(Schema.String),
  docid: Schema.optional(Schema.String),
  mimeType: Schema.optional(Schema.String),
  text: Schema.optional(Schema.String),
  textStyles: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentStyle)),
  pages: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentPage)),
  entities: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentEntity)),
  entityRelations: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentEntityRelation)),
  textChanges: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentTextChange)),
  shardInfo: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentShardInfo),
  error: Schema.optional(GoogleRpcStatus),
  revisions: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentRevision)),
  documentLayout: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentDocumentLayout),
  chunkedDocument: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentChunkedDocument),
  blobAssets: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentBlobAsset)),
  entityValidationOutput: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentEntityValidationOutput),
  entitiesRevisions: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentEntitiesRevision)),
  entitiesRevisionId: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3Document" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3Document>;
...
export const GoogleCloudDocumentaiV1beta3RawDocument: Schema.Schema<GoogleCloudDocumentaiV1beta3RawDocument> = Schema.suspend(() => Schema.Struct({
  content: Schema.optional(Schema.String),
  mimeType: Schema.optional(Schema.String),
  displayName: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3RawDocument" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3RawDocument>;
...
export const GoogleCloudDocumentaiV1beta3GcsDocument: Schema.Schema<GoogleCloudDocumentaiV1beta3GcsDocument> = Schema.suspend(() => Schema.Struct({
  gcsUri: Schema.optional(Schema.String),
  mimeType: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3GcsDocument" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3GcsDocument>;
...
export const GoogleCloudDocumentaiV1beta3ProcessOptionsIndividualPageSelector: Schema.Schema<GoogleCloudDocumentaiV1beta3ProcessOptionsIndividualPageSelector> = Schema.suspend(() => Schema.Struct({
  pages: Schema.optional(Schema.Array(Schema.Number)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ProcessOptionsIndividualPageSelector" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ProcessOptionsIndividualPageSelector>;
...
export const GoogleCloudDocumentaiV1beta3OcrConfigHints: Schema.Schema<GoogleCloudDocumentaiV1beta3OcrConfigHints> = Schema.suspend(() => Schema.Struct({
  languageHints: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3OcrConfigHints" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3OcrConfigHints>;
...
export const GoogleCloudDocumentaiV1beta3OcrConfigPremiumFeatures: Schema.Schema<GoogleCloudDocumentaiV1beta3OcrConfigPremiumFeatures> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3OcrConfigPremiumFeatures" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3OcrConfigPremiumFeatures>;
...
export const GoogleCloudDocumentaiV1beta3OcrConfig: Schema.Schema<GoogleCloudDocumentaiV1beta3OcrConfig> = Schema.suspend(() => Schema.Struct({
  ...
  premiumFeatures: Schema.optional(GoogleCloudDocumentaiV1beta3OcrConfigPremiumFeatures),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3OcrConfig" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3OcrConfig>;
...
export const GoogleCloudDocumentaiV1beta3ProcessOptionsLayoutConfigChunkingConfig: Schema.Schema<GoogleCloudDocumentaiV1beta3ProcessOptionsLayoutConfigChunkingConfig> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ProcessOptionsLayoutConfigChunkingConfig" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ProcessOptionsLayoutConfigChunkingConfig>;
...
export const GoogleCloudDocumentaiV1beta3ProcessOptionsLayoutConfig: Schema.Schema<GoogleCloudDocumentaiV1beta3ProcessOptionsLayoutConfig> = Schema.suspend(() => Schema.Struct({
  chunkingConfig: Schema.optional(GoogleCloudDocumentaiV1beta3ProcessOptionsLayoutConfigChunkingConfig),
...
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ProcessOptionsLayoutConfig" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ProcessOptionsLayoutConfig>;
...
export const GoogleCloudDocumentaiV1beta3ProcessOptions: Schema.Schema<GoogleCloudDocumentaiV1beta3ProcessOptions> = Schema.suspend(() => Schema.Struct({
  individualPageSelector: Schema.optional(GoogleCloudDocumentaiV1beta3ProcessOptionsIndividualPageSelector),
  ...
  layoutConfig: Schema.optional(GoogleCloudDocumentaiV1beta3ProcessOptionsLayoutConfig),
  schemaOverride: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentSchema),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ProcessOptions" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ProcessOptions>;
...
export const GoogleCloudDocumentaiV1beta3ProcessRequest: Schema.Schema<GoogleCloudDocumentaiV1beta3ProcessRequest> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ProcessRequest" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ProcessRequest>;
...
export const GoogleCloudDocumentaiV1beta3ProcessResponse: Schema.Schema<GoogleCloudDocumentaiV1beta3ProcessResponse> = Schema.suspend(() => Schema.Struct({
  document: Schema.optional(GoogleCloudDocumentaiV1beta3Document),
  humanReviewOperation: Schema.optional(Schema.String),
  humanReviewStatus: Schema.optional(GoogleCloudDocumentaiV1beta3HumanReviewStatus),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ProcessResponse" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ProcessResponse>;
...
export const GoogleCloudDocumentaiV1beta3BatchProcessRequestBatchInputConfig: Schema.Schema<GoogleCloudDocumentaiV1beta3BatchProcessRequestBatchInputConfig> = Schema.suspend(() => Schema.Struct({
  gcsSource: Schema.optional(Schema.String),
  mimeType: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3BatchProcessRequestBatchInputConfig" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3BatchProcessRequestBatchInputConfig>;
...
export const GoogleCloudDocumentaiV1beta3BatchProcessRequestBatchOutputConfig: Schema.Schema<GoogleCloudDocumentaiV1beta3BatchProcessRequestBatchOutputConfig> = Schema.suspend(() => Schema.Struct({
  gcsDestination: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3BatchProcessRequestBatchOutputConfig" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3BatchProcessRequestBatchOutputConfig>;
...
export const GoogleCloudDocumentaiV1beta3GcsDocuments: Schema.Schema<GoogleCloudDocumentaiV1beta3GcsDocuments> = Schema.suspend(() => Schema.Struct({
  documents: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3GcsDocument)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3GcsDocuments" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3GcsDocuments>;
...
export const GoogleCloudDocumentaiV1beta3BatchDocumentsInputConfig: Schema.Schema<GoogleCloudDocumentaiV1beta3BatchDocumentsInputConfig> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3BatchDocumentsInputConfig" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3BatchDocumentsInputConfig>;
...
export const GoogleCloudDocumentaiV1beta3DocumentOutputConfigGcsOutputConfigShardingConfig: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentOutputConfigGcsOutputConfigShardingConfig> = Schema.suspend(() => Schema.Struct({
  pagesPerShard: Schema.optional(Schema.Number),
  pagesOverlap: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentOutputConfigGcsOutputConfigShardingConfig" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentOutputConfigGcsOutputConfigShardingConfig>;
...
export const GoogleCloudDocumentaiV1beta3DocumentOutputConfigGcsOutputConfig: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentOutputConfigGcsOutputConfig> = Schema.suspend(() => Schema.Struct({
  gcsUri: Schema.optional(Schema.String),
  fieldMask: Schema.optional(Schema.String),
  shardingConfig: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentOutputConfigGcsOutputConfigShardingConfig),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentOutputConfigGcsOutputConfig" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentOutputConfigGcsOutputConfig>;
...
export const GoogleCloudDocumentaiV1beta3DocumentOutputConfig: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentOutputConfig> = Schema.suspend(() => Schema.Struct({
  gcsOutputConfig: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentOutputConfigGcsOutputConfig),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentOutputConfig" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentOutputConfig>;
...
export const GoogleCloudDocumentaiV1beta3BatchProcessRequest: Schema.Schema<GoogleCloudDocumentaiV1beta3BatchProcessRequest> = Schema.suspend(() => Schema.Struct({
  inputConfigs: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3BatchProcessRequestBatchInputConfig)),
  outputConfig: Schema.optional(GoogleCloudDocumentaiV1beta3BatchProcessRequestBatchOutputConfig),
  inputDocuments: Schema.optional(GoogleCloudDocumentaiV1beta3BatchDocumentsInputConfig),
  documentOutputConfig: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentOutputConfig),
  skipHumanReview: Schema.optional(Schema.Boolean),
  processOptions: Schema.optional(GoogleCloudDocumentaiV1beta3ProcessOptions),
  labels: Schema.optional(Schema.Record(Schema.String, Schema.String)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3BatchProcessRequest" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3BatchProcessRequest>;
...
export const GoogleCloudDocumentaiV1beta3ProcessorTypeLocationInfo: Schema.Schema<GoogleCloudDocumentaiV1beta3ProcessorTypeLocationInfo> = Schema.suspend(() => Schema.Struct({
  locationId: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ProcessorTypeLocationInfo" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ProcessorTypeLocationInfo>;
...
export const GoogleCloudDocumentaiV1beta3ProcessorType: Schema.Schema<GoogleCloudDocumentaiV1beta3ProcessorType> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  category: Schema.optional(Schema.String),
  availableLocations: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3ProcessorTypeLocationInfo)),
...
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ProcessorType" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ProcessorType>;
...
export const GoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse: Schema.Schema<GoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse> = Schema.suspend(() => Schema.Struct({
  processorTypes: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3ProcessorType)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse>;
...
export const GoogleCloudDocumentaiV1beta3ListProcessorTypesResponse: Schema.Schema<GoogleCloudDocumentaiV1beta3ListProcessorTypesResponse> = Schema.suspend(() => Schema.Struct({
  processorTypes: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3ProcessorType)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ListProcessorTypesResponse" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ListProcessorTypesResponse>;
...
export const GoogleCloudDocumentaiV1beta3ListProcessorsResponse: Schema.Schema<GoogleCloudDocumentaiV1beta3ListProcessorsResponse> = Schema.suspend(() => Schema.Struct({
  processors: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3Processor)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ListProcessorsResponse" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ListProcessorsResponse>;
...
export const GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestCustomDocumentExtractionOptions: Schema.Schema<GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestCustomDocumentExtractionOptions> = Schema.suspend(() => Schema.Struct({
  trainingMethod: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestCustomDocumentExtractionOptions" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestCustomDocumentExtractionOptions>;
...
export const GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestFoundationModelTuningOptions: Schema.Schema<GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestFoundationModelTuningOptions> = Schema.suspend(() => Schema.Struct({
  trainSteps: Schema.optional(Schema.Number),
  learningRateMultiplier: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestFoundationModelTuningOptions" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestFoundationModelTuningOptions>;
...
export const GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestInputData: Schema.Schema<GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestInputData> = Schema.suspend(() => Schema.Struct({
  trainingDocuments: Schema.optional(GoogleCloudDocumentaiV1beta3BatchDocumentsInputConfig),
  testDocuments: Schema.optional(GoogleCloudDocumentaiV1beta3BatchDocumentsInputConfig),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestInputData" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestInputData>;
...
export const GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequest: Schema.Schema<GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequest> = Schema.suspend(() => Schema.Struct({
  customDocumentExtractionOptions: Schema.optional(GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestCustomDocumentExtractionOptions),
  foundationModelTuningOptions: Schema.optional(GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestFoundationModelTuningOptions),
  processorVersion: Schema.optional(GoogleCloudDocumentaiV1beta3ProcessorVersion),
  documentSchema: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentSchema),
  inputData: Schema.optional(GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestInputData),
  baseProcessorVersion: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequest" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequest>;
...
export const GoogleCloudDocumentaiV1beta3ListProcessorVersionsResponse: Schema.Schema<GoogleCloudDocumentaiV1beta3ListProcessorVersionsResponse> = Schema.suspend(() => Schema.Struct({
  processorVersions: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3ProcessorVersion)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ListProcessorVersionsResponse" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ListProcessorVersionsResponse>;

export interface GoogleCloudDocumentaiV1beta3DeployProcessorVersionRequest {
}

export const GoogleCloudDocumentaiV1beta3DeployProcessorVersionRequest: Schema.Schema<GoogleCloudDocumentaiV1beta3DeployProcessorVersionRequest> = Schema.suspend(() => Schema.Struct({
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DeployProcessorVersionRequest" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DeployProcessorVersionRequest>;

export interface GoogleCloudDocumentaiV1beta3UndeployProcessorVersionRequest {
}

export const GoogleCloudDocumentaiV1beta3UndeployProcessorVersionRequest: Schema.Schema<GoogleCloudDocumentaiV1beta3UndeployProcessorVersionRequest> = Schema.suspend(() => Schema.Struct({
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3UndeployProcessorVersionRequest" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3UndeployProcessorVersionRequest>;

export interface GoogleCloudDocumentaiV1beta3EnableProcessorRequest {
}

export const GoogleCloudDocumentaiV1beta3EnableProcessorRequest: Schema.Schema<GoogleCloudDocumentaiV1beta3EnableProcessorRequest> = Schema.suspend(() => Schema.Struct({
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3EnableProcessorRequest" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3EnableProcessorRequest>;

export interface GoogleCloudDocumentaiV1beta3DisableProcessorRequest {
}

export const GoogleCloudDocumentaiV1beta3DisableProcessorRequest: Schema.Schema<GoogleCloudDocumentaiV1beta3DisableProcessorRequest> = Schema.suspend(() => Schema.Struct({
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DisableProcessorRequest" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DisableProcessorRequest>;
...
export const GoogleCloudDocumentaiV1beta3SetDefaultProcessorVersionRequest: Schema.Schema<GoogleCloudDocumentaiV1beta3SetDefaultProcessorVersionRequest> = Schema.suspend(() => Schema.Struct({
  defaultProcessorVersion: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3SetDefaultProcessorVersionRequest" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3SetDefaultProcessorVersionRequest>;
...
export const GoogleCloudDocumentaiV1beta3ReviewDocumentRequest: Schema.Schema<GoogleCloudDocumentaiV1beta3ReviewDocumentRequest> = Schema.suspend(() => Schema.Struct({
  inlineDocument: Schema.optional(GoogleCloudDocumentaiV1beta3Document),
  document: Schema.optional(GoogleCloudDocumentaiV1beta3Document),
  enableSchemaValidation: Schema.optional(Schema.Boolean),
  priority: Schema.optional(Schema.String),
  documentSchema: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentSchema),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ReviewDocumentRequest" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ReviewDocumentRequest>;
...
export const GoogleCloudDocumentaiV1beta3EvaluateProcessorVersionRequest: Schema.Schema<GoogleCloudDocumentaiV1beta3EvaluateProcessorVersionRequest> = Schema.suspend(() => Schema.Struct({
  evaluationDocuments: Schema.optional(GoogleCloudDocumentaiV1beta3BatchDocumentsInputConfig),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3EvaluateProcessorVersionRequest" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3EvaluateProcessorVersionRequest>;
...
export const GoogleCloudDocumentaiV1beta3EvaluationCounters: Schema.Schema<GoogleCloudDocumentaiV1beta3EvaluationCounters> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3EvaluationCounters" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3EvaluationCounters>;
...
export const GoogleCloudDocumentaiV1beta3EvaluationConfidenceLevelMetrics: Schema.Schema<GoogleCloudDocumentaiV1beta3EvaluationConfidenceLevelMetrics> = Schema.suspend(() => Schema.Struct({
  confidenceLevel: Schema.optional(Schema.Number),
  metrics: Schema.optional(GoogleCloudDocumentaiV1beta3EvaluationMetrics),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3EvaluationConfidenceLevelMetrics" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3EvaluationConfidenceLevelMetrics>;
...
export const GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetrics: Schema.Schema<GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetrics> = Schema.suspend(() => Schema.Struct({
  confidenceLevelMetrics: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3EvaluationConfidenceLevelMetrics)),
  confidenceLevelMetricsExact: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3EvaluationConfidenceLevelMetrics)),
...
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetrics" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetrics>;
...
export const GoogleCloudDocumentaiV1beta3EvaluationEvaluationRevision: Schema.Schema<GoogleCloudDocumentaiV1beta3EvaluationEvaluationRevision> = Schema.suspend(() => Schema.Struct({
  revisionId: Schema.optional(Schema.String),
  documentCounters: Schema.optional(GoogleCloudDocumentaiV1beta3EvaluationCounters),
  allEntitiesMetrics: Schema.optional(GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetrics),
  entityMetrics: Schema.optional(Schema.Record(Schema.String, GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetrics)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3EvaluationEvaluationRevision" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3EvaluationEvaluationRevision>;
...
export const GoogleCloudDocumentaiV1beta3Evaluation: Schema.Schema<GoogleCloudDocumentaiV1beta3Evaluation> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  createTime: Schema.optional(Schema.String),
  documentCounters: Schema.optional(GoogleCloudDocumentaiV1beta3EvaluationCounters),
  allEntitiesMetrics: Schema.optional(GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetrics),
  ...
  kmsKeyName: Schema.optional(Schema.String),
  kmsKeyVersionName: Schema.optional(Schema.String),
  revisions: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3EvaluationEvaluationRevision)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3Evaluation" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3Evaluation>;
...
export const GoogleCloudDocumentaiV1beta3ListEvaluationsResponse: Schema.Schema<GoogleCloudDocumentaiV1beta3ListEvaluationsResponse> = Schema.suspend(() => Schema.Struct({
  evaluations: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3Evaluation)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ListEvaluationsResponse" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ListEvaluationsResponse>;
...
export const GoogleCloudDocumentaiV1beta3ImportProcessorVersionRequestExternalProcessorVersionSource: Schema.Schema<GoogleCloudDocumentaiV1beta3ImportProcessorVersionRequestExternalProcessorVersionSource> = Schema.suspend(() => Schema.Struct({
  processorVersion: Schema.optional(Schema.String),
  serviceEndpoint: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ImportProcessorVersionRequestExternalProcessorVersionSource" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ImportProcessorVersionRequestExternalProcessorVersionSource>;
...
export const GoogleCloudDocumentaiV1beta3ImportProcessorVersionRequest: Schema.Schema<GoogleCloudDocumentaiV1beta3ImportProcessorVersionRequest> = Schema.suspend(() => Schema.Struct({
  processorVersionSource: Schema.optional(Schema.String),
  externalProcessorVersionSource: Schema.optional(GoogleCloudDocumentaiV1beta3ImportProcessorVersionRequestExternalProcessorVersionSource),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ImportProcessorVersionRequest" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ImportProcessorVersionRequest>;
...
export const GoogleCloudDocumentaiV1beta3ImportDocumentsRequestBatchDocumentsImportConfigAutoSplitConfig: Schema.Schema<GoogleCloudDocumentaiV1beta3ImportDocumentsRequestBatchDocumentsImportConfigAutoSplitConfig> = Schema.suspend(() => Schema.Struct({
  trainingSplitRatio: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ImportDocumentsRequestBatchDocumentsImportConfigAutoSplitConfig" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ImportDocumentsRequestBatchDocumentsImportConfigAutoSplitConfig>;
...
export interface GoogleCloudDocumentaiV1beta3ImportDocumentsRequestBatchDocumentsImportConfig {
  ...
  datasetSplit?: "DATASET_SPLIT_TYPE_UNSPECIFIED" | "DATASET_SPLIT_TRAIN" | "DATASET_SPLIT_TEST" | "DATASET_SPLIT_UNASSIGNED" | (string & {});
...
export const GoogleCloudDocumentaiV1beta3ImportDocumentsRequestBatchDocumentsImportConfig: Schema.Schema<GoogleCloudDocumentaiV1beta3ImportDocumentsRequestBatchDocumentsImportConfig> = Schema.suspend(() => Schema.Struct({
  datasetSplit: Schema.optional(Schema.String),
  autoSplitConfig: Schema.optional(GoogleCloudDocumentaiV1beta3ImportDocumentsRequestBatchDocumentsImportConfigAutoSplitConfig),
  batchInputConfig: Schema.optional(GoogleCloudDocumentaiV1beta3BatchDocumentsInputConfig),
  documentType: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ImportDocumentsRequestBatchDocumentsImportConfig" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ImportDocumentsRequestBatchDocumentsImportConfig>;
...
export const GoogleCloudDocumentaiV1beta3ImportDocumentsRequest: Schema.Schema<GoogleCloudDocumentaiV1beta3ImportDocumentsRequest> = Schema.suspend(() => Schema.Struct({
  batchDocumentsImportConfigs: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3ImportDocumentsRequestBatchDocumentsImportConfig)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ImportDocumentsRequest" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ImportDocumentsRequest>;

export interface GoogleCloudDocumentaiV1beta3GetDocumentResponse {
  document?: GoogleCloudDocumentaiV1beta3Document;
}

export const GoogleCloudDocumentaiV1beta3GetDocumentResponse: Schema.Schema<GoogleCloudDocumentaiV1beta3GetDocumentResponse> = Schema.suspend(() => Schema.Struct({
  document: Schema.optional(GoogleCloudDocumentaiV1beta3Document),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3GetDocumentResponse" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3GetDocumentResponse>;
...
export const GoogleCloudDocumentaiV1beta3ListDocumentsRequest: Schema.Schema<GoogleCloudDocumentaiV1beta3ListDocumentsRequest> = Schema.suspend(() => Schema.Struct({
  pageSize: Schema.optional(Schema.Number),
  pageToken: Schema.optional(Schema.String),
  filter: Schema.optional(Schema.String),
  returnTotalSize: Schema.optional(Schema.Boolean),
  skip: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ListDocumentsRequest" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ListDocumentsRequest>;
...
export interface GoogleCloudDocumentaiV1beta3DocumentMetadata {
  ...
  datasetType?: "DATASET_SPLIT_TYPE_UNSPECIFIED" | "DATASET_SPLIT_TRAIN" | "DATASET_SPLIT_TEST" | "DATASET_SPLIT_UNASSIGNED" | (string & {});
  /** Labeling state of the document. */
  labelingState?: "DOCUMENT_LABELING_STATE_UNSPECIFIED" | "DOCUMENT_LABELED" | "DOCUMENT_UNLABELED" | "DOCUMENT_AUTO_LABELED" | (string & {});
  /** The display name of the document. */
  displayName?: string;
}

export const GoogleCloudDocumentaiV1beta3DocumentMetadata: Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentMetadata> = Schema.suspend(() => Schema.Struct({
  ...
  displayName: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DocumentMetadata" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DocumentMetadata>;
...
export const GoogleCloudDocumentaiV1beta3ListDocumentsResponse: Schema.Schema<GoogleCloudDocumentaiV1beta3ListDocumentsResponse> = Schema.suspend(() => Schema.Struct({
  documentMetadata: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentMetadata)),
  nextPageToken: Schema.optional(Schema.String),
  totalSize: Schema.optional(Schema.Number),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ListDocumentsResponse" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ListDocumentsResponse>;
...
export const GoogleCloudDocumentaiV1beta3BatchDatasetDocumentsIndividualDocumentIds: Schema.Schema<GoogleCloudDocumentaiV1beta3BatchDatasetDocumentsIndividualDocumentIds> = Schema.suspend(() => Schema.Struct({
  documentIds: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3DocumentId)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3BatchDatasetDocumentsIndividualDocumentIds" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3BatchDatasetDocumentsIndividualDocumentIds>;
...
export const GoogleCloudDocumentaiV1beta3BatchDatasetDocuments: Schema.Schema<GoogleCloudDocumentaiV1beta3BatchDatasetDocuments> = Schema.suspend(() => Schema.Struct({
  individualDocumentIds: Schema.optional(GoogleCloudDocumentaiV1beta3BatchDatasetDocumentsIndividualDocumentIds),
  filter: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3BatchDatasetDocuments" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3BatchDatasetDocuments>;
...
export const GoogleCloudDocumentaiV1beta3BatchDeleteDocumentsRequest: Schema.Schema<GoogleCloudDocumentaiV1beta3BatchDeleteDocumentsRequest> = Schema.suspend(() => Schema.Struct({
  datasetDocuments: Schema.optional(GoogleCloudDocumentaiV1beta3BatchDatasetDocuments),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3BatchDeleteDocumentsRequest" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3BatchDeleteDocumentsRequest>;
...
export const GoogleCloudDocumentaiV1beta3DatasetSchema: Schema.Schema<GoogleCloudDocumentaiV1beta3DatasetSchema> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  documentSchema: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentSchema),
  satisfiesPzs: Schema.optional(Schema.Boolean),
  satisfiesPzi: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3DatasetSchema" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3DatasetSchema>;
...
export const GoogleCloudDocumentaiV1beta3NextSchema: Schema.Schema<GoogleCloudDocumentaiV1beta3NextSchema> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  displayName: Schema.optional(Schema.String),
  labels: Schema.optional(Schema.Record(Schema.String, Schema.String)),
  createTime: Schema.optional(Schema.String),
  updateTime: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3NextSchema" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3NextSchema>;
...
export const GoogleCloudDocumentaiV1beta3ListSchemasResponse: Schema.Schema<GoogleCloudDocumentaiV1beta3ListSchemasResponse> = Schema.suspend(() => Schema.Struct({
  schemas: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3NextSchema)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ListSchemasResponse" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ListSchemasResponse>;
...
export const GoogleCloudDocumentaiV1beta3SchemaVersion: Schema.Schema<GoogleCloudDocumentaiV1beta3SchemaVersion> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  displayName: Schema.optional(Schema.String),
  labels: Schema.optional(Schema.Record(Schema.String, Schema.String)),
  createTime: Schema.optional(Schema.String),
  schema: Schema.optional(GoogleCloudDocumentaiV1beta3DocumentSchema),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3SchemaVersion" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3SchemaVersion>;
...
export const GoogleCloudDocumentaiV1beta3Documents: Schema.Schema<GoogleCloudDocumentaiV1beta3Documents> = Schema.suspend(() => Schema.Struct({
  documents: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3Document)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3Documents" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3Documents>;
...
export const GoogleCloudDocumentaiV1beta3RawDocuments: Schema.Schema<GoogleCloudDocumentaiV1beta3RawDocuments> = Schema.suspend(() => Schema.Struct({
  documents: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3RawDocument)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3RawDocuments" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3RawDocuments>;
...
export const GoogleCloudDocumentaiV1beta3SchemaGenerationIteration: Schema.Schema<GoogleCloudDocumentaiV1beta3SchemaGenerationIteration> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3SchemaGenerationIteration" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3SchemaGenerationIteration>;
...
export const GoogleCloudDocumentaiV1beta3SchemaGenerationHistory: Schema.Schema<GoogleCloudDocumentaiV1beta3SchemaGenerationHistory> = Schema.suspend(() => Schema.Struct({
  iterations: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3SchemaGenerationIteration)),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3SchemaGenerationHistory" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3SchemaGenerationHistory>;
...
export const GoogleCloudDocumentaiV1beta3GenerateSchemaVersionRequestGenerateSchemaVersionParams: Schema.Schema<GoogleCloudDocumentaiV1beta3GenerateSchemaVersionRequestGenerateSchemaVersionParams> = Schema.suspend(() => Schema.Struct({
  prompt: Schema.optional(Schema.String),
  history: Schema.optional(GoogleCloudDocumentaiV1beta3SchemaGenerationHistory),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3GenerateSchemaVersionRequestGenerateSchemaVersionParams" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3GenerateSchemaVersionRequestGenerateSchemaVersionParams>;
...
export const GoogleCloudDocumentaiV1beta3GenerateSchemaVersionRequest: Schema.Schema<GoogleCloudDocumentaiV1beta3GenerateSchemaVersionRequest> = Schema.suspend(() => Schema.Struct({
  ...
  generateSchemaVersionParams: Schema.optional(GoogleCloudDocumentaiV1beta3GenerateSchemaVersionRequestGenerateSchemaVersionParams),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3GenerateSchemaVersionRequest" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3GenerateSchemaVersionRequest>;
...
export const GoogleCloudDocumentaiV1beta3GenerateSchemaVersionResponse: Schema.Schema<GoogleCloudDocumentaiV1beta3GenerateSchemaVersionResponse> = Schema.suspend(() => Schema.Struct({
  schemaVersion: Schema.optional(GoogleCloudDocumentaiV1beta3SchemaVersion),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3GenerateSchemaVersionResponse" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3GenerateSchemaVersionResponse>;
...
export const GoogleCloudDocumentaiV1beta3ListSchemaVersionsResponse: Schema.Schema<GoogleCloudDocumentaiV1beta3ListSchemaVersionsResponse> = Schema.suspend(() => Schema.Struct({
  schemaVersions: Schema.optional(Schema.Array(GoogleCloudDocumentaiV1beta3SchemaVersion)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudDocumentaiV1beta3ListSchemaVersionsResponse" }) as any as Schema.Schema<GoogleCloudDocumentaiV1beta3ListSchemaVersionsResponse>;
...
export const FetchProcessorTypesProjectsLocationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta3/projects/{projectsId}/locations/{locationsId}:fetchProcessorTypes" }),
  svc,
) as unknown as Schema.Schema<FetchProcessorTypesProjectsLocationsRequest>;

export type FetchProcessorTypesProjectsLocationsResponse = GoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse;
export const FetchProcessorTypesProjectsLocationsResponse = GoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse;
...
export const GetProjectsLocationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta3/projects/{projectsId}/locations/{locationsId}" }),
  svc,
...
export const ListProjectsLocationsOperationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/operations" }),
  svc,
...
export const GetProjectsLocationsOperationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/operations/{operationsId}" }),
  svc,
...
export const CancelProjectsLocationsOperationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/operations/{operationsId}:cancel", hasBody: true }),
  svc,
...
export const ProcessProjectsLocationsProcessorsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudDocumentaiV1beta3ProcessRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}:process", hasBody: true }),
  svc,
) as unknown as Schema.Schema<ProcessProjectsLocationsProcessorsRequest>;

export type ProcessProjectsLocationsProcessorsResponse = GoogleCloudDocumentaiV1beta3ProcessResponse;
export const ProcessProjectsLocationsProcessorsResponse = GoogleCloudDocumentaiV1beta3ProcessResponse;
...
export const BatchProcessProjectsLocationsProcessorsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudDocumentaiV1beta3BatchProcessRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}:batchProcess", hasBody: true }),
  svc,
...
export const ListProjectsLocationsProcessorsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsProcessorsRequest>;

export type ListProjectsLocationsProcessorsResponse = GoogleCloudDocumentaiV1beta3ListProcessorsResponse;
export const ListProjectsLocationsProcessorsResponse = GoogleCloudDocumentaiV1beta3ListProcessorsResponse;
...
export const GetProjectsLocationsProcessorsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsProcessorsRequest>;

export type GetProjectsLocationsProcessorsResponse = GoogleCloudDocumentaiV1beta3Processor;
export const GetProjectsLocationsProcessorsResponse = GoogleCloudDocumentaiV1beta3Processor;
...
export const CreateProjectsLocationsProcessorsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDocumentaiV1beta3Processor).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsProcessorsRequest>;

export type CreateProjectsLocationsProcessorsResponse = GoogleCloudDocumentaiV1beta3Processor;
export const CreateProjectsLocationsProcessorsResponse = GoogleCloudDocumentaiV1beta3Processor;
...
export const DeleteProjectsLocationsProcessorsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}" }),
  svc,
...
export const EnableProjectsLocationsProcessorsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudDocumentaiV1beta3EnableProcessorRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}:enable", hasBody: true }),
  svc,
...
export const DisableProjectsLocationsProcessorsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudDocumentaiV1beta3DisableProcessorRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}:disable", hasBody: true }),
  svc,
...
export const SetDefaultProcessorVersionProjectsLocationsProcessorsRequest = Schema.Struct({
  ...
  body: Schema.optional(GoogleCloudDocumentaiV1beta3SetDefaultProcessorVersionRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}:setDefaultProcessorVersion", hasBody: true }),
  svc,
...
export const UpdateDatasetProjectsLocationsProcessorsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/dataset", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateDatasetProjectsLocationsProcessorsRequest>;

export type UpdateDatasetProjectsLocationsProcessorsResponse = GoogleLongrunningOperation;
export const UpdateDatasetProjectsLocationsProcessorsResponse = GoogleLongrunningOperation;

export type UpdateDatasetProjectsLocationsProcessorsError = CommonErrors;
...
export const updateDatasetProjectsLocationsProcessors: API.OperationMethod<UpdateDatasetProjectsLocationsProcessorsRequest, UpdateDatasetProjectsLocationsProcessorsResponse, UpdateDatasetProjectsLocationsProcessorsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ProcessProjectsLocationsProcessorsProcessorVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/processorVersions/{processorVersionsId}:process", hasBody: true }),
  svc,
) as unknown as Schema.Schema<ProcessProjectsLocationsProcessorsProcessorVersionsRequest>;

export type ProcessProjectsLocationsProcessorsProcessorVersionsResponse = GoogleCloudDocumentaiV1beta3ProcessResponse;
export const ProcessProjectsLocationsProcessorsProcessorVersionsResponse = GoogleCloudDocumentaiV1beta3ProcessResponse;
...
export const BatchProcessProjectsLocationsProcessorsProcessorVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/processorVersions/{processorVersionsId}:batchProcess", hasBody: true }),
  svc,
...
export const TrainProjectsLocationsProcessorsProcessorVersionsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/processorVersions:train", hasBody: true }),
  svc,
...
export const GetProjectsLocationsProcessorsProcessorVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/processorVersions/{processorVersionsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsProcessorsProcessorVersionsRequest>;

export type GetProjectsLocationsProcessorsProcessorVersionsResponse = GoogleCloudDocumentaiV1beta3ProcessorVersion;
export const GetProjectsLocationsProcessorsProcessorVersionsResponse = GoogleCloudDocumentaiV1beta3ProcessorVersion;
...
export const ListProjectsLocationsProcessorsProcessorVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/processorVersions" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsProcessorsProcessorVersionsRequest>;

export type ListProjectsLocationsProcessorsProcessorVersionsResponse = GoogleCloudDocumentaiV1beta3ListProcessorVersionsResponse;
export const ListProjectsLocationsProcessorsProcessorVersionsResponse = GoogleCloudDocumentaiV1beta3ListProcessorVersionsResponse;
...
export const DeleteProjectsLocationsProcessorsProcessorVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/processorVersions/{processorVersionsId}" }),
  svc,
...
export const DeployProjectsLocationsProcessorsProcessorVersionsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudDocumentaiV1beta3DeployProcessorVersionRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/processorVersions/{processorVersionsId}:deploy", hasBody: true }),
  svc,
...
export const UndeployProjectsLocationsProcessorsProcessorVersionsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudDocumentaiV1beta3UndeployProcessorVersionRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/processorVersions/{processorVersionsId}:undeploy", hasBody: true }),
  svc,
...
export const EvaluateProcessorVersionProjectsLocationsProcessorsProcessorVersionsRequest = Schema.Struct({
  ...
  body: Schema.optional(GoogleCloudDocumentaiV1beta3EvaluateProcessorVersionRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/processorVersions/{processorVersionsId}:evaluateProcessorVersion", hasBody: true }),
  svc,
...
export const ImportProcessorVersionProjectsLocationsProcessorsProcessorVersionsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDocumentaiV1beta3ImportProcessorVersionRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/processorVersions:importProcessorVersion", hasBody: true }),
  svc,
) as unknown as Schema.Schema<ImportProcessorVersionProjectsLocationsProcessorsProcessorVersionsRequest>;

export type ImportProcessorVersionProjectsLocationsProcessorsProcessorVersionsResponse = GoogleLongrunningOperation;
export const ImportProcessorVersionProjectsLocationsProcessorsProcessorVersionsResponse = GoogleLongrunningOperation;

export type ImportProcessorVersionProjectsLocationsProcessorsProcessorVersionsError = CommonErrors;

/** Imports a processor version from source processor version. */
export const importProcessorVersionProjectsLocationsProcessorsProcessorVersions: API.OperationMethod<ImportProcessorVersionProjectsLocationsProcessorsProcessorVersionsRequest, ImportProcessorVersionProjectsLocationsProcessorsProcessorVersionsResponse, ImportProcessorVersionProjectsLocationsProcessorsProcessorVersionsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
  input: ImportProcessorVersionProjectsLocationsProcessorsProcessorVersionsRequest,
  output: ImportProcessorVersionProjectsLocationsProcessorsProcessorVersionsResponse,
  errors: [],
}));
...
export const GetProjectsLocationsProcessorsProcessorVersionsEvaluationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/processorVersions/{processorVersionsId}/evaluations/{evaluationsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsProcessorsProcessorVersionsEvaluationsRequest>;

export type GetProjectsLocationsProcessorsProcessorVersionsEvaluationsResponse = GoogleCloudDocumentaiV1beta3Evaluation;
export const GetProjectsLocationsProcessorsProcessorVersionsEvaluationsResponse = GoogleCloudDocumentaiV1beta3Evaluation;
...
export const ListProjectsLocationsProcessorsProcessorVersionsEvaluationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/processorVersions/{processorVersionsId}/evaluations" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsProcessorsProcessorVersionsEvaluationsRequest>;

export type ListProjectsLocationsProcessorsProcessorVersionsEvaluationsResponse = GoogleCloudDocumentaiV1beta3ListEvaluationsResponse;
export const ListProjectsLocationsProcessorsProcessorVersionsEvaluationsResponse = GoogleCloudDocumentaiV1beta3ListEvaluationsResponse;
...
export const ReviewDocumentProjectsLocationsProcessorsHumanReviewConfigRequest = Schema.Struct({
  ...
  body: Schema.optional(GoogleCloudDocumentaiV1beta3ReviewDocumentRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/humanReviewConfig:reviewDocument", hasBody: true }),
  svc,
...
export const ImportDocumentsProjectsLocationsProcessorsDatasetRequest = Schema.Struct({
  dataset: Schema.String.pipe(T.HttpPath("dataset")),
  body: Schema.optional(GoogleCloudDocumentaiV1beta3ImportDocumentsRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/dataset:importDocuments", hasBody: true }),
  svc,
) as unknown as Schema.Schema<ImportDocumentsProjectsLocationsProcessorsDatasetRequest>;

export type ImportDocumentsProjectsLocationsProcessorsDatasetResponse = GoogleLongrunningOperation;
export const ImportDocumentsProjectsLocationsProcessorsDatasetResponse = GoogleLongrunningOperation;

export type ImportDocumentsProjectsLocationsProcessorsDatasetError = CommonErrors;

/** Import documents into a dataset. */
export const importDocumentsProjectsLocationsProcessorsDataset: API.OperationMethod<ImportDocumentsProjectsLocationsProcessorsDatasetRequest, ImportDocumentsProjectsLocationsProcessorsDatasetResponse, ImportDocumentsProjectsLocationsProcessorsDatasetError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export interface GetDocumentProjectsLocationsProcessorsDatasetRequest {
  ...
  /** Reads the revision by the predefined case. */
  "documentId.revisionRef.revisionCase"?: "REVISION_CASE_UNSPECIFIED" | "LATEST_HUMAN_REVIEW" | "LATEST_TIMESTAMP" | "BASE_OCR_REVISION" | (string & {});
  /** Reads the revision given by the id. */
...
export const GetDocumentProjectsLocationsProcessorsDatasetRequest = Schema.Struct({
  dataset: Schema.String.pipe(T.HttpPath("dataset")),
  "documentId.gcsManagedDocId.gcsUri": Schema.optional(Schema.String).pipe(T.HttpQuery("documentId.gcsManagedDocId.gcsUri")),
  "documentId.gcsManagedDocId.cwDocId": Schema.optional(Schema.String).pipe(T.HttpQuery("documentId.gcsManagedDocId.cwDocId")),
  "documentId.unmanagedDocId.docId": Schema.optional(Schema.String).pipe(T.HttpQuery("documentId.unmanagedDocId.docId")),
  "documentId.revisionRef.revisionCase": Schema.optional(Schema.String).pipe(T.HttpQuery("documentId.revisionRef.revisionCase")),
  "documentId.revisionRef.revisionId": Schema.optional(Schema.String).pipe(T.HttpQuery("documentId.revisionRef.revisionId")),
  "documentId.revisionRef.latestProcessorVersion": Schema.optional(Schema.String).pipe(T.HttpQuery("documentId.revisionRef.latestProcessorVersion")),
  readMask: Schema.optional(Schema.String).pipe(T.HttpQuery("readMask")),
  "pageRange.start": Schema.optional(Schema.Number).pipe(T.HttpQuery("pageRange.start")),
  "pageRange.end": Schema.optional(Schema.Number).pipe(T.HttpQuery("pageRange.end")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/dataset:getDocument" }),
  svc,
) as unknown as Schema.Schema<GetDocumentProjectsLocationsProcessorsDatasetRequest>;

export type GetDocumentProjectsLocationsProcessorsDatasetResponse = GoogleCloudDocumentaiV1beta3GetDocumentResponse;
export const GetDocumentProjectsLocationsProcessorsDatasetResponse = GoogleCloudDocumentaiV1beta3GetDocumentResponse;

export type GetDocumentProjectsLocationsProcessorsDatasetError = CommonErrors;

/** Returns relevant fields present in the requested document. */
export const getDocumentProjectsLocationsProcessorsDataset: API.OperationMethod<GetDocumentProjectsLocationsProcessorsDatasetRequest, GetDocumentProjectsLocationsProcessorsDatasetResponse, GetDocumentProjectsLocationsProcessorsDatasetError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ListDocumentsProjectsLocationsProcessorsDatasetRequest = Schema.Struct({
  dataset: Schema.String.pipe(T.HttpPath("dataset")),
  body: Schema.optional(GoogleCloudDocumentaiV1beta3ListDocumentsRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/dataset:listDocuments", hasBody: true }),
  svc,
) as unknown as Schema.Schema<ListDocumentsProjectsLocationsProcessorsDatasetRequest>;

export type ListDocumentsProjectsLocationsProcessorsDatasetResponse = GoogleCloudDocumentaiV1beta3ListDocumentsResponse;
export const ListDocumentsProjectsLocationsProcessorsDatasetResponse = GoogleCloudDocumentaiV1beta3ListDocumentsResponse;

export type ListDocumentsProjectsLocationsProcessorsDatasetError = CommonErrors;

/** Returns a list of documents present in the dataset. */
export const listDocumentsProjectsLocationsProcessorsDataset: API.OperationMethod<ListDocumentsProjectsLocationsProcessorsDatasetRequest, ListDocumentsProjectsLocationsProcessorsDatasetResponse, ListDocumentsProjectsLocationsProcessorsDatasetError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const BatchDeleteDocumentsProjectsLocationsProcessorsDatasetRequest = Schema.Struct({
  dataset: Schema.String.pipe(T.HttpPath("dataset")),
  body: Schema.optional(GoogleCloudDocumentaiV1beta3BatchDeleteDocumentsRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/dataset:batchDeleteDocuments", hasBody: true }),
  svc,
) as unknown as Schema.Schema<BatchDeleteDocumentsProjectsLocationsProcessorsDatasetRequest>;

export type BatchDeleteDocumentsProjectsLocationsProcessorsDatasetResponse = GoogleLongrunningOperation;
export const BatchDeleteDocumentsProjectsLocationsProcessorsDatasetResponse = GoogleLongrunningOperation;

export type BatchDeleteDocumentsProjectsLocationsProcessorsDatasetError = CommonErrors;

/** Deletes a set of documents. */
export const batchDeleteDocumentsProjectsLocationsProcessorsDataset: API.OperationMethod<BatchDeleteDocumentsProjectsLocationsProcessorsDatasetRequest, BatchDeleteDocumentsProjectsLocationsProcessorsDatasetResponse, BatchDeleteDocumentsProjectsLocationsProcessorsDatasetError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetDatasetSchemaProjectsLocationsProcessorsDatasetRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  visibleFieldsOnly: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("visibleFieldsOnly")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/dataset/datasetSchema" }),
  svc,
) as unknown as Schema.Schema<GetDatasetSchemaProjectsLocationsProcessorsDatasetRequest>;

export type GetDatasetSchemaProjectsLocationsProcessorsDatasetResponse = GoogleCloudDocumentaiV1beta3DatasetSchema;
export const GetDatasetSchemaProjectsLocationsProcessorsDatasetResponse = GoogleCloudDocumentaiV1beta3DatasetSchema;

export type GetDatasetSchemaProjectsLocationsProcessorsDatasetError = CommonErrors;

/** Gets the `DatasetSchema` of a `Dataset`. */
export const getDatasetSchemaProjectsLocationsProcessorsDataset: API.OperationMethod<GetDatasetSchemaProjectsLocationsProcessorsDatasetRequest, GetDatasetSchemaProjectsLocationsProcessorsDatasetResponse, GetDatasetSchemaProjectsLocationsProcessorsDatasetError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const UpdateDatasetSchemaProjectsLocationsProcessorsDatasetRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(GoogleCloudDocumentaiV1beta3DatasetSchema).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processors/{processorsId}/dataset/datasetSchema", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateDatasetSchemaProjectsLocationsProcessorsDatasetRequest>;

export type UpdateDatasetSchemaProjectsLocationsProcessorsDatasetResponse = GoogleCloudDocumentaiV1beta3DatasetSchema;
export const UpdateDatasetSchemaProjectsLocationsProcessorsDatasetResponse = GoogleCloudDocumentaiV1beta3DatasetSchema;

export type UpdateDatasetSchemaProjectsLocationsProcessorsDatasetError = CommonErrors;

/** Updates a `DatasetSchema`. */
export const updateDatasetSchemaProjectsLocationsProcessorsDataset: API.OperationMethod<UpdateDatasetSchemaProjectsLocationsProcessorsDatasetRequest, UpdateDatasetSchemaProjectsLocationsProcessorsDatasetResponse, UpdateDatasetSchemaProjectsLocationsProcessorsDatasetError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsProcessorTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processorTypes" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsProcessorTypesRequest>;

export type ListProjectsLocationsProcessorTypesResponse = GoogleCloudDocumentaiV1beta3ListProcessorTypesResponse;
export const ListProjectsLocationsProcessorTypesResponse = GoogleCloudDocumentaiV1beta3ListProcessorTypesResponse;
...
export const GetProjectsLocationsProcessorTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/processorTypes/{processorTypesId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsProcessorTypesRequest>;

export type GetProjectsLocationsProcessorTypesResponse = GoogleCloudDocumentaiV1beta3ProcessorType;
export const GetProjectsLocationsProcessorTypesResponse = GoogleCloudDocumentaiV1beta3ProcessorType;
...
export const CreateProjectsLocationsSchemasRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDocumentaiV1beta3NextSchema).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/schemas", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsSchemasRequest>;

export type CreateProjectsLocationsSchemasResponse = GoogleCloudDocumentaiV1beta3NextSchema;
export const CreateProjectsLocationsSchemasResponse = GoogleCloudDocumentaiV1beta3NextSchema;
...
export const PatchProjectsLocationsSchemasRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/schemas/{schemasId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsLocationsSchemasRequest>;

export type PatchProjectsLocationsSchemasResponse = GoogleCloudDocumentaiV1beta3NextSchema;
export const PatchProjectsLocationsSchemasResponse = GoogleCloudDocumentaiV1beta3NextSchema;
...
export const DeleteProjectsLocationsSchemasRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/schemas/{schemasId}" }),
  svc,
...
export const ListProjectsLocationsSchemasRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/schemas" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsSchemasRequest>;

export type ListProjectsLocationsSchemasResponse = GoogleCloudDocumentaiV1beta3ListSchemasResponse;
export const ListProjectsLocationsSchemasResponse = GoogleCloudDocumentaiV1beta3ListSchemasResponse;
...
export const GetProjectsLocationsSchemasRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/schemas/{schemasId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsSchemasRequest>;

export type GetProjectsLocationsSchemasResponse = GoogleCloudDocumentaiV1beta3NextSchema;
export const GetProjectsLocationsSchemasResponse = GoogleCloudDocumentaiV1beta3NextSchema;
...
export const CreateProjectsLocationsSchemasSchemaVersionsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDocumentaiV1beta3SchemaVersion).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/schemas/{schemasId}/schemaVersions", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsSchemasSchemaVersionsRequest>;

export type CreateProjectsLocationsSchemasSchemaVersionsResponse = GoogleCloudDocumentaiV1beta3SchemaVersion;
export const CreateProjectsLocationsSchemasSchemaVersionsResponse = GoogleCloudDocumentaiV1beta3SchemaVersion;
...
export const PatchProjectsLocationsSchemasSchemaVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/schemas/{schemasId}/schemaVersions/{schemaVersionsId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsLocationsSchemasSchemaVersionsRequest>;

export type PatchProjectsLocationsSchemasSchemaVersionsResponse = GoogleCloudDocumentaiV1beta3SchemaVersion;
export const PatchProjectsLocationsSchemasSchemaVersionsResponse = GoogleCloudDocumentaiV1beta3SchemaVersion;
...
export const GenerateProjectsLocationsSchemasSchemaVersionsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudDocumentaiV1beta3GenerateSchemaVersionRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/schemas/{schemasId}/schemaVersions:generate", hasBody: true }),
  svc,
) as unknown as Schema.Schema<GenerateProjectsLocationsSchemasSchemaVersionsRequest>;

export type GenerateProjectsLocationsSchemasSchemaVersionsResponse = GoogleCloudDocumentaiV1beta3GenerateSchemaVersionResponse;
export const GenerateProjectsLocationsSchemasSchemaVersionsResponse = GoogleCloudDocumentaiV1beta3GenerateSchemaVersionResponse;
...
export const DeleteProjectsLocationsSchemasSchemaVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/schemas/{schemasId}/schemaVersions/{schemaVersionsId}" }),
  svc,
...
export const ListProjectsLocationsSchemasSchemaVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/schemas/{schemasId}/schemaVersions" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsSchemasSchemaVersionsRequest>;

export type ListProjectsLocationsSchemasSchemaVersionsResponse = GoogleCloudDocumentaiV1beta3ListSchemaVersionsResponse;
export const ListProjectsLocationsSchemasSchemaVersionsResponse = GoogleCloudDocumentaiV1beta3ListSchemaVersionsResponse;
...
export const GetProjectsLocationsSchemasSchemaVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta3/projects/{projectsId}/locations/{locationsId}/schemas/{schemasId}/schemaVersions/{schemaVersionsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsSchemasSchemaVersionsRequest>;

export type GetProjectsLocationsSchemasSchemaVersionsResponse = GoogleCloudDocumentaiV1beta3SchemaVersion;
export const GetProjectsLocationsSchemasSchemaVersionsResponse = GoogleCloudDocumentaiV1beta3SchemaVersion;
