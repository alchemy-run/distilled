...
export const ListAdminClusterMembershipsResponse: Schema.Schema<ListAdminClusterMembershipsResponse> = Schema.suspend(() => Schema.Struct({
  adminClusterMemberships: Schema.optional(Schema.Array(Membership)),
  nextPageToken: Schema.optional(Schema.String),
  unreachable: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "ListAdminClusterMembershipsResponse" }) as any as Schema.Schema<ListAdminClusterMembershipsResponse>;
...
export const ListBoundMembershipsResponse: Schema.Schema<ListBoundMembershipsResponse> = Schema.suspend(() => Schema.Struct({
  memberships: Schema.optional(Schema.Array(Membership)),
  unreachable: Schema.optional(Schema.Array(Schema.String)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "ListBoundMembershipsResponse" }) as any as Schema.Schema<ListBoundMembershipsResponse>;
...
export const FeatureResourceState: Schema.Schema<FeatureResourceState> = Schema.suspend(() => Schema.Struct({
  state: Schema.optional(Schema.String),
})).annotate({ identifier: "FeatureResourceState" }) as any as Schema.Schema<FeatureResourceState>;

export interface MultiClusterIngressFeatureSpec {
  /** Fully-qualified Membership name which hosts the MultiClusterIngress CRD. Example: `projects/foo-proj/locations/global/memberships/bar` */
  configMembership?: string;
  /** Deprecated: This field will be ignored and should not be set. Customer's billing structure. */
  billing?: "BILLING_UNSPECIFIED" | "PAY_AS_YOU_GO" | "ANTHOS_LICENSE" | (string & {});
}

export const MultiClusterIngressFeatureSpec: Schema.Schema<MultiClusterIngressFeatureSpec> = Schema.suspend(() => Schema.Struct({
  configMembership: Schema.optional(Schema.String),
  billing: Schema.optional(Schema.String),
})).annotate({ identifier: "MultiClusterIngressFeatureSpec" }) as any as Schema.Schema<MultiClusterIngressFeatureSpec>;
...
export const CloudAuditLoggingFeatureSpec: Schema.Schema<CloudAuditLoggingFeatureSpec> = Schema.suspend(() => Schema.Struct({
  allowlistedServiceAccounts: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "CloudAuditLoggingFeatureSpec" }) as any as Schema.Schema<CloudAuditLoggingFeatureSpec>;
...
export const MembershipSpec: Schema.Schema<MembershipSpec> = Schema.suspend(() => Schema.Struct({
  certificateManagement: Schema.optional(Schema.String),
})).annotate({ identifier: "MembershipSpec" }) as any as Schema.Schema<MembershipSpec>;

export interface FeatureSpec {
  /** Immutable. Specifies CA configuration. */
  provisionGoogleCa?: "GOOGLE_CA_PROVISIONING_UNSPECIFIED" | "DISABLED" | "ENABLED" | "ENABLED_WITH_MANAGED_CA" | "ENABLED_WITH_DEFAULT_CA" | (string & {});
...
export const AppDevExperienceFeatureSpec: Schema.Schema<AppDevExperienceFeatureSpec> = Schema.suspend(() => Schema.Struct({
})).annotate({ identifier: "AppDevExperienceFeatureSpec" }) as any as Schema.Schema<AppDevExperienceFeatureSpec>;
...
export const RBACRoleBindingActuationFeatureSpec: Schema.Schema<RBACRoleBindingActuationFeatureSpec> = Schema.suspend(() => Schema.Struct({
  allowedCustomRoles: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "RBACRoleBindingActuationFeatureSpec" }) as any as Schema.Schema<RBACRoleBindingActuationFeatureSpec>;
...
export const FleetObservabilityRoutingConfig: Schema.Schema<FleetObservabilityRoutingConfig> = Schema.suspend(() => Schema.Struct({
  mode: Schema.optional(Schema.String),
})).annotate({ identifier: "FleetObservabilityRoutingConfig" }) as any as Schema.Schema<FleetObservabilityRoutingConfig>;
...
export const FleetObservabilityLoggingConfig: Schema.Schema<FleetObservabilityLoggingConfig> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "FleetObservabilityLoggingConfig" }) as any as Schema.Schema<FleetObservabilityLoggingConfig>;
...
export const FleetObservabilityFeatureSpec: Schema.Schema<FleetObservabilityFeatureSpec> = Schema.suspend(() => Schema.Struct({
  loggingConfig: Schema.optional(FleetObservabilityLoggingConfig),
})).annotate({ identifier: "FleetObservabilityFeatureSpec" }) as any as Schema.Schema<FleetObservabilityFeatureSpec>;

export interface NamespaceActuationFeatureSpec {
  /** actuation_mode controls the behavior of the controller */
  actuationMode?: "ACTUATION_MODE_UNSPECIFIED" | "ACTUATION_MODE_CREATE_AND_DELETE_IF_CREATED" | "ACTUATION_MODE_ADD_AND_REMOVE_FLEET_LABELS" | (string & {});
}

export const NamespaceActuationFeatureSpec: Schema.Schema<NamespaceActuationFeatureSpec> = Schema.suspend(() => Schema.Struct({
  actuationMode: Schema.optional(Schema.String),
})).annotate({ identifier: "NamespaceActuationFeatureSpec" }) as any as Schema.Schema<NamespaceActuationFeatureSpec>;
...
export const ClusterUpgradePostConditions: Schema.Schema<ClusterUpgradePostConditions> = Schema.suspend(() => Schema.Struct({
  soaking: Schema.optional(Schema.String),
})).annotate({ identifier: "ClusterUpgradePostConditions" }) as any as Schema.Schema<ClusterUpgradePostConditions>;
...
export const ClusterUpgradeGKEUpgradeOverride: Schema.Schema<ClusterUpgradeGKEUpgradeOverride> = Schema.suspend(() => Schema.Struct({
  upgrade: Schema.optional(ClusterUpgradeGKEUpgrade),
  postConditions: Schema.optional(ClusterUpgradePostConditions),
})).annotate({ identifier: "ClusterUpgradeGKEUpgradeOverride" }) as any as Schema.Schema<ClusterUpgradeGKEUpgradeOverride>;
...
export interface ClusterUpgradeFleetSpec {
  ...
  upgradeEngine?: "UPGRADE_ENGINE_UNSPECIFIED" | "SEQUENCING_V1" | "SEQUENCING_V2" | (string & {});
}

export const ClusterUpgradeFleetSpec: Schema.Schema<ClusterUpgradeFleetSpec> = Schema.suspend(() => Schema.Struct({
  upstreamFleets: Schema.optional(Schema.Array(Schema.String)),
  postConditions: Schema.optional(ClusterUpgradePostConditions),
  gkeUpgradeOverrides: Schema.optional(Schema.Array(ClusterUpgradeGKEUpgradeOverride)),
  upgradeEngine: Schema.optional(Schema.String),
})).annotate({ identifier: "ClusterUpgradeFleetSpec" }) as any as Schema.Schema<ClusterUpgradeFleetSpec>;
...
export const DataplaneV2FeatureSpec: Schema.Schema<DataplaneV2FeatureSpec> = Schema.suspend(() => Schema.Struct({
  enableEncryption: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "DataplaneV2FeatureSpec" }) as any as Schema.Schema<DataplaneV2FeatureSpec>;
...
export const WorkloadIdentityFeatureSpec: Schema.Schema<WorkloadIdentityFeatureSpec> = Schema.suspend(() => Schema.Struct({
  scopeTenancyPool: Schema.optional(Schema.String),
})).annotate({ identifier: "WorkloadIdentityFeatureSpec" }) as any as Schema.Schema<WorkloadIdentityFeatureSpec>;
...
export const CommonFeatureSpec: Schema.Schema<CommonFeatureSpec> = Schema.suspend(() => Schema.Struct({
  ...
  rbacrolebindingactuation: Schema.optional(RBACRoleBindingActuationFeatureSpec),
...
})).annotate({ identifier: "CommonFeatureSpec" }) as any as Schema.Schema<CommonFeatureSpec>;
...
export const ConfigManagementMembershipSpec: Schema.Schema<ConfigManagementMembershipSpec> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "ConfigManagementMembershipSpec" }) as any as Schema.Schema<ConfigManagementMembershipSpec>;
...
export const CloudBuildMembershipSpec: Schema.Schema<CloudBuildMembershipSpec> = Schema.suspend(() => Schema.Struct({
  version: Schema.optional(Schema.String),
  securityPolicy: Schema.optional(Schema.String),
})).annotate({ identifier: "CloudBuildMembershipSpec" }) as any as Schema.Schema<CloudBuildMembershipSpec>;
...
export const IdentityServiceMembershipSpec: Schema.Schema<IdentityServiceMembershipSpec> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "IdentityServiceMembershipSpec" }) as any as Schema.Schema<IdentityServiceMembershipSpec>;
...
export const ServiceMeshMembershipSpec: Schema.Schema<ServiceMeshMembershipSpec> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "ServiceMeshMembershipSpec" }) as any as Schema.Schema<ServiceMeshMembershipSpec>;
...
export const PolicyControllerMembershipSpec: Schema.Schema<PolicyControllerMembershipSpec> = Schema.suspend(() => Schema.Struct({
  policyControllerHubConfig: Schema.optional(PolicyControllerHubConfig),
  version: Schema.optional(Schema.String),
})).annotate({ identifier: "PolicyControllerMembershipSpec" }) as any as Schema.Schema<PolicyControllerMembershipSpec>;

export interface FleetObservabilityMembershipSpec {
}

export const FleetObservabilityMembershipSpec: Schema.Schema<FleetObservabilityMembershipSpec> = Schema.suspend(() => Schema.Struct({
})).annotate({ identifier: "FleetObservabilityMembershipSpec" }) as any as Schema.Schema<FleetObservabilityMembershipSpec>;

export interface NamespaceActuationMembershipSpec {
}

export const NamespaceActuationMembershipSpec: Schema.Schema<NamespaceActuationMembershipSpec> = Schema.suspend(() => Schema.Struct({
})).annotate({ identifier: "NamespaceActuationMembershipSpec" }) as any as Schema.Schema<NamespaceActuationMembershipSpec>;
...
export const MembershipFeatureSpec: Schema.Schema<MembershipFeatureSpec> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "MembershipFeatureSpec" }) as any as Schema.Schema<MembershipFeatureSpec>;
...
export const ServiceMeshFeatureCondition: Schema.Schema<ServiceMeshFeatureCondition> = Schema.suspend(() => Schema.Struct({
  code: Schema.optional(Schema.String),
  documentationLink: Schema.optional(Schema.String),
  details: Schema.optional(Schema.String),
  severity: Schema.optional(Schema.String),
})).annotate({ identifier: "ServiceMeshFeatureCondition" }) as any as Schema.Schema<ServiceMeshFeatureCondition>;
...
export const ServiceMeshFeatureState: Schema.Schema<ServiceMeshFeatureState> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "ServiceMeshFeatureState" }) as any as Schema.Schema<ServiceMeshFeatureState>;
...
export const AppDevExperienceFeatureState: Schema.Schema<AppDevExperienceFeatureState> = Schema.suspend(() => Schema.Struct({
  networkingInstallSucceeded: Schema.optional(Status),
})).annotate({ identifier: "AppDevExperienceFeatureState" }) as any as Schema.Schema<AppDevExperienceFeatureState>;

export interface RBACRoleBindingActuationFeatureState {
}

export const RBACRoleBindingActuationFeatureState: Schema.Schema<RBACRoleBindingActuationFeatureState> = Schema.suspend(() => Schema.Struct({
})).annotate({ identifier: "RBACRoleBindingActuationFeatureState" }) as any as Schema.Schema<RBACRoleBindingActuationFeatureState>;
...
export const FleetObservabilityFeatureError: Schema.Schema<FleetObservabilityFeatureError> = Schema.suspend(() => Schema.Struct({
  code: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
})).annotate({ identifier: "FleetObservabilityFeatureError" }) as any as Schema.Schema<FleetObservabilityFeatureError>;
...
export const FleetObservabilityFleetObservabilityBaseFeatureState: Schema.Schema<FleetObservabilityFleetObservabilityBaseFeatureState> = Schema.suspend(() => Schema.Struct({
  code: Schema.optional(Schema.String),
  errors: Schema.optional(Schema.Array(FleetObservabilityFeatureError)),
})).annotate({ identifier: "FleetObservabilityFleetObservabilityBaseFeatureState" }) as any as Schema.Schema<FleetObservabilityFleetObservabilityBaseFeatureState>;
...
export const FleetObservabilityFleetObservabilityLoggingState: Schema.Schema<FleetObservabilityFleetObservabilityLoggingState> = Schema.suspend(() => Schema.Struct({
  defaultLog: Schema.optional(FleetObservabilityFleetObservabilityBaseFeatureState),
  scopeLog: Schema.optional(FleetObservabilityFleetObservabilityBaseFeatureState),
})).annotate({ identifier: "FleetObservabilityFleetObservabilityLoggingState" }) as any as Schema.Schema<FleetObservabilityFleetObservabilityLoggingState>;
...
export const FleetObservabilityFleetObservabilityMonitoringState: Schema.Schema<FleetObservabilityFleetObservabilityMonitoringState> = Schema.suspend(() => Schema.Struct({
  state: Schema.optional(FleetObservabilityFleetObservabilityBaseFeatureState),
})).annotate({ identifier: "FleetObservabilityFleetObservabilityMonitoringState" }) as any as Schema.Schema<FleetObservabilityFleetObservabilityMonitoringState>;
...
export const FleetObservabilityFeatureState: Schema.Schema<FleetObservabilityFeatureState> = Schema.suspend(() => Schema.Struct({
  logging: Schema.optional(FleetObservabilityFleetObservabilityLoggingState),
  monitoring: Schema.optional(FleetObservabilityFleetObservabilityMonitoringState),
})).annotate({ identifier: "FleetObservabilityFeatureState" }) as any as Schema.Schema<FleetObservabilityFeatureState>;

export interface NamespaceActuationFeatureState {
}

export const NamespaceActuationFeatureState: Schema.Schema<NamespaceActuationFeatureState> = Schema.suspend(() => Schema.Struct({
})).annotate({ identifier: "NamespaceActuationFeatureState" }) as any as Schema.Schema<NamespaceActuationFeatureState>;
...
export const ClusterUpgradeGKEUpgradeState: Schema.Schema<ClusterUpgradeGKEUpgradeState> = Schema.suspend(() => Schema.Struct({
  upgrade: Schema.optional(ClusterUpgradeGKEUpgrade),
  status: Schema.optional(ClusterUpgradeUpgradeStatus),
  stats: Schema.optional(Schema.Record(Schema.String, Schema.String)),
})).annotate({ identifier: "ClusterUpgradeGKEUpgradeState" }) as any as Schema.Schema<ClusterUpgradeGKEUpgradeState>;
...
export const ClusterUpgradeGKEUpgradeFeatureCondition: Schema.Schema<ClusterUpgradeGKEUpgradeFeatureCondition> = Schema.suspend(() => Schema.Struct({
  type: Schema.optional(Schema.String),
  status: Schema.optional(Schema.String),
  reason: Schema.optional(Schema.String),
  updateTime: Schema.optional(Schema.String),
})).annotate({ identifier: "ClusterUpgradeGKEUpgradeFeatureCondition" }) as any as Schema.Schema<ClusterUpgradeGKEUpgradeFeatureCondition>;
...
export const ClusterUpgradeGKEUpgradeFeatureState: Schema.Schema<ClusterUpgradeGKEUpgradeFeatureState> = Schema.suspend(() => Schema.Struct({
  upgradeState: Schema.optional(Schema.Array(ClusterUpgradeGKEUpgradeState)),
  conditions: Schema.optional(Schema.Array(ClusterUpgradeGKEUpgradeFeatureCondition)),
})).annotate({ identifier: "ClusterUpgradeGKEUpgradeFeatureState" }) as any as Schema.Schema<ClusterUpgradeGKEUpgradeFeatureState>;
...
export const ClusterUpgradeFleetState: Schema.Schema<ClusterUpgradeFleetState> = Schema.suspend(() => Schema.Struct({
  downstreamFleets: Schema.optional(Schema.Array(Schema.String)),
  ignored: Schema.optional(Schema.Record(Schema.String, ClusterUpgradeIgnoredMembership)),
  gkeState: Schema.optional(ClusterUpgradeGKEUpgradeFeatureState),
})).annotate({ identifier: "ClusterUpgradeFleetState" }) as any as Schema.Schema<ClusterUpgradeFleetState>;

export interface WorkloadIdentityNamespaceStateDetail {
  /** The state of the IAM namespace. */
  code?: "NAMESPACE_STATE_UNSPECIFIED" | "NAMESPACE_STATE_OK" | "NAMESPACE_STATE_ERROR" | (string & {});
  /** A human-readable description of the current state or returned error. */
  description?: string;
}

export const WorkloadIdentityNamespaceStateDetail: Schema.Schema<WorkloadIdentityNamespaceStateDetail> = Schema.suspend(() => Schema.Struct({
  code: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
})).annotate({ identifier: "WorkloadIdentityNamespaceStateDetail" }) as any as Schema.Schema<WorkloadIdentityNamespaceStateDetail>;

export interface WorkloadIdentityWorkloadIdentityPoolStateDetail {
  /** The state of the Workload Identity Pool. */
  code?: "WORKLOAD_IDENTITY_POOL_STATE_UNSPECIFIED" | "WORKLOAD_IDENTITY_POOL_STATE_OK" | "WORKLOAD_IDENTITY_POOL_STATE_ERROR" | (string & {});
  /** A human-readable description of the current state or returned error. */
  description?: string;
}

export const WorkloadIdentityWorkloadIdentityPoolStateDetail: Schema.Schema<WorkloadIdentityWorkloadIdentityPoolStateDetail> = Schema.suspend(() => Schema.Struct({
  code: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
})).annotate({ identifier: "WorkloadIdentityWorkloadIdentityPoolStateDetail" }) as any as Schema.Schema<WorkloadIdentityWorkloadIdentityPoolStateDetail>;
...
export interface WorkloadIdentityFeatureState {
  ...
  namespaceStates?: Record<string, "NAMESPACE_STATE_UNSPECIFIED" | "NAMESPACE_STATE_OK" | "NAMESPACE_STATE_ERROR" | (string & {})>;
  ...
  workloadIdentityPoolStateDetails?: Record<string, WorkloadIdentityWorkloadIdentityPoolStateDetail>;
}

export const WorkloadIdentityFeatureState: Schema.Schema<WorkloadIdentityFeatureState> = Schema.suspend(() => Schema.Struct({
  workloadIdentityPool: Schema.optional(Schema.String),
  scopeTenancyWorkloadIdentityPool: Schema.optional(Schema.String),
  namespaceStates: Schema.optional(Schema.Record(Schema.String, Schema.String)),
  namespaceStateDetails: Schema.optional(Schema.Record(Schema.String, WorkloadIdentityNamespaceStateDetail)),
  workloadIdentityPoolStateDetails: Schema.optional(Schema.Record(Schema.String, WorkloadIdentityWorkloadIdentityPoolStateDetail)),
})).annotate({ identifier: "WorkloadIdentityFeatureState" }) as any as Schema.Schema<WorkloadIdentityFeatureState>;
...
export const CommonFeatureState: Schema.Schema<CommonFeatureState> = Schema.suspend(() => Schema.Struct({
  servicemesh: Schema.optional(ServiceMeshFeatureState),
  appdevexperience: Schema.optional(AppDevExperienceFeatureState),
  rbacrolebindingactuation: Schema.optional(RBACRoleBindingActuationFeatureState),
...
})).annotate({ identifier: "CommonFeatureState" }) as any as Schema.Schema<CommonFeatureState>;
...
export const ServiceMeshMembershipState: Schema.Schema<ServiceMeshMembershipState> = Schema.suspend(() => Schema.Struct({
  analysisMessages: Schema.optional(Schema.Array(ServiceMeshAnalysisMessage)),
...
})).annotate({ identifier: "ServiceMeshMembershipState" }) as any as Schema.Schema<ServiceMeshMembershipState>;
...
export const MeteringMembershipState: Schema.Schema<MeteringMembershipState> = Schema.suspend(() => Schema.Struct({
  lastMeasurementTime: Schema.optional(Schema.String),
  preciseLastMeasuredClusterVcpuCapacity: Schema.optional(Schema.Number),
})).annotate({ identifier: "MeteringMembershipState" }) as any as Schema.Schema<MeteringMembershipState>;
...
export const ConfigManagementMembershipState: Schema.Schema<ConfigManagementMembershipState> = Schema.suspend(() => Schema.Struct({
  ...
  kubernetesApiServerVersion: Schema.optional(Schema.String),
})).annotate({ identifier: "ConfigManagementMembershipState" }) as any as Schema.Schema<ConfigManagementMembershipState>;
...
export const IdentityServiceMembershipState: Schema.Schema<IdentityServiceMembershipState> = Schema.suspend(() => Schema.Struct({
  installedVersion: Schema.optional(Schema.String),
  state: Schema.optional(Schema.String),
  failureReason: Schema.optional(Schema.String),
  memberConfig: Schema.optional(IdentityServiceMembershipSpec),
})).annotate({ identifier: "IdentityServiceMembershipState" }) as any as Schema.Schema<IdentityServiceMembershipState>;
...
export const PolicyControllerMembershipState: Schema.Schema<PolicyControllerMembershipState> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "PolicyControllerMembershipState" }) as any as Schema.Schema<PolicyControllerMembershipState>;
...
export const ClusterUpgradeMembershipState: Schema.Schema<ClusterUpgradeMembershipState> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "ClusterUpgradeMembershipState" }) as any as Schema.Schema<ClusterUpgradeMembershipState>;

export interface FleetObservabilityMembershipState {
}

export const FleetObservabilityMembershipState: Schema.Schema<FleetObservabilityMembershipState> = Schema.suspend(() => Schema.Struct({
})).annotate({ identifier: "FleetObservabilityMembershipState" }) as any as Schema.Schema<FleetObservabilityMembershipState>;

export interface NamespaceActuationMembershipState {
}

export const NamespaceActuationMembershipState: Schema.Schema<NamespaceActuationMembershipState> = Schema.suspend(() => Schema.Struct({
})).annotate({ identifier: "NamespaceActuationMembershipState" }) as any as Schema.Schema<NamespaceActuationMembershipState>;
...
export const WorkloadIdentityMembershipState: Schema.Schema<WorkloadIdentityMembershipState> = Schema.suspend(() => Schema.Struct({
  description: Schema.optional(Schema.String),
  identityProviderStateDetails: Schema.optional(Schema.Record(Schema.String, WorkloadIdentityIdentityProviderStateDetail)),
})).annotate({ identifier: "WorkloadIdentityMembershipState" }) as any as Schema.Schema<WorkloadIdentityMembershipState>;
...
export const MembershipFeatureState: Schema.Schema<MembershipFeatureState> = Schema.suspend(() => Schema.Struct({
  ...
  state: Schema.optional(FeatureState),
})).annotate({ identifier: "MembershipFeatureState" }) as any as Schema.Schema<MembershipFeatureState>;
...
export const CommonFleetDefaultMemberConfigSpec: Schema.Schema<CommonFleetDefaultMemberConfigSpec> = Schema.suspend(() => Schema.Struct({
  mesh: Schema.optional(ServiceMeshMembershipSpec),
  configmanagement: Schema.optional(ConfigManagementMembershipSpec),
  identityservice: Schema.optional(IdentityServiceMembershipSpec),
  policycontroller: Schema.optional(PolicyControllerMembershipSpec),
})).annotate({ identifier: "CommonFleetDefaultMemberConfigSpec" }) as any as Schema.Schema<CommonFleetDefaultMemberConfigSpec>;
...
export const ClusterUpgradeScopeSpec: Schema.Schema<ClusterUpgradeScopeSpec> = Schema.suspend(() => Schema.Struct({
  upstreamScopes: Schema.optional(Schema.Array(Schema.String)),
  postConditions: Schema.optional(ClusterUpgradePostConditions),
  gkeUpgradeOverrides: Schema.optional(Schema.Array(ClusterUpgradeGKEUpgradeOverride)),
})).annotate({ identifier: "ClusterUpgradeScopeSpec" }) as any as Schema.Schema<ClusterUpgradeScopeSpec>;
...
export const ScopeFeatureSpec: Schema.Schema<ScopeFeatureSpec> = Schema.suspend(() => Schema.Struct({
  clusterupgrade: Schema.optional(ClusterUpgradeScopeSpec),
})).annotate({ identifier: "ScopeFeatureSpec" }) as any as Schema.Schema<ScopeFeatureSpec>;
...
export const ClusterUpgradeScopeState: Schema.Schema<ClusterUpgradeScopeState> = Schema.suspend(() => Schema.Struct({
  downstreamScopes: Schema.optional(Schema.Array(Schema.String)),
  ignored: Schema.optional(Schema.Record(Schema.String, ClusterUpgradeIgnoredMembership)),
  gkeState: Schema.optional(ClusterUpgradeGKEUpgradeFeatureState),
})).annotate({ identifier: "ClusterUpgradeScopeState" }) as any as Schema.Schema<ClusterUpgradeScopeState>;
...
export const ScopeFeatureState: Schema.Schema<ScopeFeatureState> = Schema.suspend(() => Schema.Struct({
  clusterupgrade: Schema.optional(ClusterUpgradeScopeState),
  state: Schema.optional(FeatureState),
})).annotate({ identifier: "ScopeFeatureState" }) as any as Schema.Schema<ScopeFeatureState>;
...
export const Feature: Schema.Schema<Feature> = Schema.suspend(() => Schema.Struct({
  ...
  membershipSpecs: Schema.optional(Schema.Record(Schema.String, MembershipFeatureSpec)),
  state: Schema.optional(CommonFeatureState),
  membershipStates: Schema.optional(Schema.Record(Schema.String, MembershipFeatureState)),
  createTime: Schema.optional(Schema.String),
  updateTime: Schema.optional(Schema.String),
  deleteTime: Schema.optional(Schema.String),
...
export const ListFeaturesResponse: Schema.Schema<ListFeaturesResponse> = Schema.suspend(() => Schema.Struct({
  resources: Schema.optional(Schema.Array(Feature)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "ListFeaturesResponse" }) as any as Schema.Schema<ListFeaturesResponse>;
...
export interface FleetLifecycleState {
  ...
  code?: "CODE_UNSPECIFIED" | "CREATING" | "READY" | "DELETING" | "UPDATING" | (string & {});
}

export const FleetLifecycleState: Schema.Schema<FleetLifecycleState> = Schema.suspend(() => Schema.Struct({
  code: Schema.optional(Schema.String),
})).annotate({ identifier: "FleetLifecycleState" }) as any as Schema.Schema<FleetLifecycleState>;
...
export interface BinaryAuthorizationConfig {
  ...
  evaluationMode?: "EVALUATION_MODE_UNSPECIFIED" | "DISABLED" | "POLICY_BINDINGS" | (string & {});
  /** Optional. Binauthz policies that apply to this cluster. */
  policyBindings?: Array<PolicyBinding>;
}

export const BinaryAuthorizationConfig: Schema.Schema<BinaryAuthorizationConfig> = Schema.suspend(() => Schema.Struct({
  evaluationMode: Schema.optional(Schema.String),
  policyBindings: Schema.optional(Schema.Array(PolicyBinding)),
})).annotate({ identifier: "BinaryAuthorizationConfig" }) as any as Schema.Schema<BinaryAuthorizationConfig>;
...
export const DefaultClusterConfig: Schema.Schema<DefaultClusterConfig> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "DefaultClusterConfig" }) as any as Schema.Schema<DefaultClusterConfig>;
...
export const ListFleetsResponse: Schema.Schema<ListFleetsResponse> = Schema.suspend(() => Schema.Struct({
  fleets: Schema.optional(Schema.Array(Fleet)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "ListFleetsResponse" }) as any as Schema.Schema<ListFleetsResponse>;

export interface VersionUpgrade {
  /** Optional. Type of version upgrade specifies which component should be upgraded. */
  type?: "TYPE_UNSPECIFIED" | "TYPE_CONTROL_PLANE" | "TYPE_NODE_POOL" | (string & {});
  /** Optional. Desired version of the component. */
  desiredVersion?: string;
}

export const VersionUpgrade: Schema.Schema<VersionUpgrade> = Schema.suspend(() => Schema.Struct({
  type: Schema.optional(Schema.String),
  desiredVersion: Schema.optional(Schema.String),
})).annotate({ identifier: "VersionUpgrade" }) as any as Schema.Schema<VersionUpgrade>;

export interface RolloutStage {
  /** Output only. The wave number to which this status applies. */
  stageNumber?: number;
  /** Output only. The state of the wave. */
  state?: "STATE_UNSPECIFIED" | "PENDING" | "RUNNING" | "SOAKING" | "COMPLETED" | "FORCED_SOAKING" | (string & {});
...
export const RolloutStage: Schema.Schema<RolloutStage> = Schema.suspend(() => Schema.Struct({
  stageNumber: Schema.optional(Schema.Number),
  state: Schema.optional(Schema.String),
  startTime: Schema.optional(Schema.String),
  endTime: Schema.optional(Schema.String),
  soakDuration: Schema.optional(Schema.String),
})).annotate({ identifier: "RolloutStage" }) as any as Schema.Schema<RolloutStage>;
...
export interface RolloutTarget {
  ...
  state?: "STATE_UNSPECIFIED" | "PENDING" | "RUNNING" | "FAILED" | "SUCCEEDED" | "PAUSED" | "REMOVED" | "INELIGIBLE" | (string & {});
...
export const RolloutTarget: Schema.Schema<RolloutTarget> = Schema.suspend(() => Schema.Struct({
  cluster: Schema.optional(Schema.String),
  nodePool: Schema.optional(Schema.String),
  state: Schema.optional(Schema.String),
  reason: Schema.optional(Schema.String),
  operation: Schema.optional(Schema.String),
})).annotate({ identifier: "RolloutTarget" }) as any as Schema.Schema<RolloutTarget>;
...
export const RolloutMembershipState: Schema.Schema<RolloutMembershipState> = Schema.suspend(() => Schema.Struct({
  stageAssignment: Schema.optional(Schema.Number),
  targets: Schema.optional(Schema.Array(RolloutTarget)),
  lastUpdateTime: Schema.optional(Schema.String),
})).annotate({ identifier: "RolloutMembershipState" }) as any as Schema.Schema<RolloutMembershipState>;
...
export interface Rollout {
  ...
  state?: "STATE_UNSPECIFIED" | "RUNNING" | "PAUSED" | "CANCELLED" | "COMPLETED" | (string & {});
...
export const Rollout: Schema.Schema<Rollout> = Schema.suspend(() => Schema.Struct({
  ...
  membershipStates: Schema.optional(Schema.Record(Schema.String, RolloutMembershipState)),
...
export interface RolloutSequenceState {
  ...
  lifecycleState?: "LIFECYCLE_STATE_UNSPECIFIED" | "LIFECYCLE_STATE_ACTIVE" | "LIFECYCLE_STATE_WARNING" | "LIFECYCLE_STATE_ERROR" | (string & {});
  /** Output only. StateReason represents the reason for the Rollout Sequence state. */
  stateReasons?: Array<"STATE_REASON_UNSPECIFIED" | "FLEET_FEATURE_DELETED_ERROR" | "FLEET_DELETED_ERROR" | "EMPTY_STAGE_WARNING" | "MIXED_RELEASE_CHANNELS_WARNING" | "INTERNAL_ERROR" | (string & {})>;
}

export const RolloutSequenceState: Schema.Schema<RolloutSequenceState> = Schema.suspend(() => Schema.Struct({
  lifecycleState: Schema.optional(Schema.String),
  stateReasons: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "RolloutSequenceState" }) as any as Schema.Schema<RolloutSequenceState>;
...
export const RolloutSequence: Schema.Schema<RolloutSequence> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  displayName: Schema.optional(Schema.String),
  uid: Schema.optional(Schema.String),
  etag: Schema.optional(Schema.String),
...
})).annotate({ identifier: "RolloutSequence" }) as any as Schema.Schema<RolloutSequence>;
...
export const ListRolloutSequencesResponse: Schema.Schema<ListRolloutSequencesResponse> = Schema.suspend(() => Schema.Struct({
  rolloutSequences: Schema.optional(Schema.Array(RolloutSequence)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "ListRolloutSequencesResponse" }) as any as Schema.Schema<ListRolloutSequencesResponse>;
...
export const NamespaceLifecycleState: Schema.Schema<NamespaceLifecycleState> = Schema.suspend(() => Schema.Struct({
  code: Schema.optional(Schema.String),
})).annotate({ identifier: "NamespaceLifecycleState" }) as any as Schema.Schema<NamespaceLifecycleState>;
...
export const ListScopeNamespacesResponse: Schema.Schema<ListScopeNamespacesResponse> = Schema.suspend(() => Schema.Struct({
  scopeNamespaces: Schema.optional(Schema.Array(Namespace)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "ListScopeNamespacesResponse" }) as any as Schema.Schema<ListScopeNamespacesResponse>;
...
export const RBACRoleBindingLifecycleState: Schema.Schema<RBACRoleBindingLifecycleState> = Schema.suspend(() => Schema.Struct({
  code: Schema.optional(Schema.String),
})).annotate({ identifier: "RBACRoleBindingLifecycleState" }) as any as Schema.Schema<RBACRoleBindingLifecycleState>;

export interface Role {
  /** predefined_role is the Kubernetes default role to use */
  predefinedRole?: "UNKNOWN" | "ADMIN" | "EDIT" | "VIEW" | "ANTHOS_SUPPORT" | (string & {});
...
export const RBACRoleBinding: Schema.Schema<RBACRoleBinding> = Schema.suspend(() => Schema.Struct({
  ...
  labels: Schema.optional(Schema.Record(Schema.String, Schema.String)),
})).annotate({ identifier: "RBACRoleBinding" }) as any as Schema.Schema<RBACRoleBinding>;
...
export const ListScopeRBACRoleBindingsResponse: Schema.Schema<ListScopeRBACRoleBindingsResponse> = Schema.suspend(() => Schema.Struct({
  rbacrolebindings: Schema.optional(Schema.Array(RBACRoleBinding)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "ListScopeRBACRoleBindingsResponse" }) as any as Schema.Schema<ListScopeRBACRoleBindingsResponse>;
...
export const ScopeLifecycleState: Schema.Schema<ScopeLifecycleState> = Schema.suspend(() => Schema.Struct({
  code: Schema.optional(Schema.String),
})).annotate({ identifier: "ScopeLifecycleState" }) as any as Schema.Schema<ScopeLifecycleState>;
...
export const ListScopesResponse: Schema.Schema<ListScopesResponse> = Schema.suspend(() => Schema.Struct({
  scopes: Schema.optional(Schema.Array(Scope)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "ListScopesResponse" }) as any as Schema.Schema<ListScopesResponse>;
...
export const ListPermittedScopesResponse: Schema.Schema<ListPermittedScopesResponse> = Schema.suspend(() => Schema.Struct({
  scopes: Schema.optional(Schema.Array(Scope)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "ListPermittedScopesResponse" }) as any as Schema.Schema<ListPermittedScopesResponse>;
...
export const MembershipBindingLifecycleState: Schema.Schema<MembershipBindingLifecycleState> = Schema.suspend(() => Schema.Struct({
  code: Schema.optional(Schema.String),
})).annotate({ identifier: "MembershipBindingLifecycleState" }) as any as Schema.Schema<MembershipBindingLifecycleState>;
...
export const MembershipBinding: Schema.Schema<MembershipBinding> = Schema.suspend(() => Schema.Struct({
  scope: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  uid: Schema.optional(Schema.String),
  createTime: Schema.optional(Schema.String),
  ...
  labels: Schema.optional(Schema.Record(Schema.String, Schema.String)),
})).annotate({ identifier: "MembershipBinding" }) as any as Schema.Schema<MembershipBinding>;
...
export const ListMembershipBindingsResponse: Schema.Schema<ListMembershipBindingsResponse> = Schema.suspend(() => Schema.Struct({
  membershipBindings: Schema.optional(Schema.Array(MembershipBinding)),
  nextPageToken: Schema.optional(Schema.String),
  unreachable: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "ListMembershipBindingsResponse" }) as any as Schema.Schema<ListMembershipBindingsResponse>;
...
export const ListMembershipRBACRoleBindingsResponse: Schema.Schema<ListMembershipRBACRoleBindingsResponse> = Schema.suspend(() => Schema.Struct({
  rbacrolebindings: Schema.optional(Schema.Array(RBACRoleBinding)),
  nextPageToken: Schema.optional(Schema.String),
  unreachable: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "ListMembershipRBACRoleBindingsResponse" }) as any as Schema.Schema<ListMembershipRBACRoleBindingsResponse>;
...
export const GenerateMembershipRBACRoleBindingYAMLResponse: Schema.Schema<GenerateMembershipRBACRoleBindingYAMLResponse> = Schema.suspend(() => Schema.Struct({
  roleBindingsYaml: Schema.optional(Schema.String),
})).annotate({ identifier: "GenerateMembershipRBACRoleBindingYAMLResponse" }) as any as Schema.Schema<GenerateMembershipRBACRoleBindingYAMLResponse>;
...
export const ValidateCreateMembershipRequest: Schema.Schema<ValidateCreateMembershipRequest> = Schema.suspend(() => Schema.Struct({
  membershipId: Schema.optional(Schema.String),
  membership: Schema.optional(Membership),
})).annotate({ identifier: "ValidateCreateMembershipRequest" }) as any as Schema.Schema<ValidateCreateMembershipRequest>;

export interface ValidationResult {
  /** Validator type to validate membership with. */
  validator?: "VALIDATOR_TYPE_UNSPECIFIED" | "MEMBERSHIP_ID" | "CROSS_PROJECT_PERMISSION" | "FLEET_ALLOWED_FOR_PROJECT_GUARDRAIL" | (string & {});
...
export const ValidateCreateMembershipResponse: Schema.Schema<ValidateCreateMembershipResponse> = Schema.suspend(() => Schema.Struct({
  validationResults: Schema.optional(Schema.Array(ValidationResult)),
})).annotate({ identifier: "ValidateCreateMembershipResponse" }) as any as Schema.Schema<ValidateCreateMembershipResponse>;
...
export const ListProjectsLocationsMembershipsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships" }),
  svc,
...
export type ListProjectsLocationsMembershipsError = CommonErrors;

/** Lists Memberships in a given project and location. */
export const listProjectsLocationsMemberships: API.PaginatedOperationMethod<ListProjectsLocationsMembershipsRequest, ListProjectsLocationsMembershipsResponse, ListProjectsLocationsMembershipsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const ListAdminProjectsLocationsMembershipsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships:listAdmin" }),
  svc,
) as unknown as Schema.Schema<ListAdminProjectsLocationsMembershipsRequest>;

export type ListAdminProjectsLocationsMembershipsResponse = ListAdminClusterMembershipsResponse;
export const ListAdminProjectsLocationsMembershipsResponse = ListAdminClusterMembershipsResponse;

export type ListAdminProjectsLocationsMembershipsError = CommonErrors;

/** Lists Memberships of admin clusters in a given project and location. **This method is only used internally**. */
export const listAdminProjectsLocationsMemberships: API.PaginatedOperationMethod<ListAdminProjectsLocationsMembershipsRequest, ListAdminProjectsLocationsMembershipsResponse, ListAdminProjectsLocationsMembershipsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsMembershipsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}" }),
  svc,
...
export type GetProjectsLocationsMembershipsError = CommonErrors;

/** Gets the details of a Membership. */
export const getProjectsLocationsMemberships: API.OperationMethod<GetProjectsLocationsMembershipsRequest, GetProjectsLocationsMembershipsResponse, GetProjectsLocationsMembershipsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsMembershipsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships", hasBody: true }),
  svc,
...
export type CreateProjectsLocationsMembershipsError = CommonErrors;

/** Creates a new Membership. **This is currently only supported for GKE clusters on Google Cloud**. To register other clusters, follow the instructions at https://cloud.google.com/anthos/multicluster-management/connect/registering-a-cluster. */
export const createProjectsLocationsMemberships: API.OperationMethod<CreateProjectsLocationsMembershipsRequest, CreateProjectsLocationsMembershipsResponse, CreateProjectsLocationsMembershipsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsMembershipsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}" }),
  svc,
...
export type DeleteProjectsLocationsMembershipsError = CommonErrors;

/** Removes a Membership. **This is currently only supported for GKE clusters on Google Cloud**. To unregister other clusters, follow the instructions at https://cloud.google.com/anthos/multicluster-management/connect/unregistering-a-cluster. */
export const deleteProjectsLocationsMemberships: API.OperationMethod<DeleteProjectsLocationsMembershipsRequest, DeleteProjectsLocationsMembershipsResponse, DeleteProjectsLocationsMembershipsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsMembershipsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}", hasBody: true }),
  svc,
...
export type PatchProjectsLocationsMembershipsError = CommonErrors;

/** Updates an existing Membership. */
export const patchProjectsLocationsMemberships: API.OperationMethod<PatchProjectsLocationsMembershipsRequest, PatchProjectsLocationsMembershipsResponse, PatchProjectsLocationsMembershipsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GenerateConnectManifestProjectsLocationsMembershipsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}:generateConnectManifest" }),
  svc,
...
export type GenerateConnectManifestProjectsLocationsMembershipsError = CommonErrors;

/** Generates the manifest for deployment of the GKE connect agent. **This method is used internally by Google-provided libraries.** Most clients should not need to call this method directly. */
export const generateConnectManifestProjectsLocationsMemberships: API.OperationMethod<GenerateConnectManifestProjectsLocationsMembershipsRequest, GenerateConnectManifestProjectsLocationsMembershipsResponse, GenerateConnectManifestProjectsLocationsMembershipsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ValidateCreateProjectsLocationsMembershipsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(ValidateCreateMembershipRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships:validateCreate", hasBody: true }),
  svc,
) as unknown as Schema.Schema<ValidateCreateProjectsLocationsMembershipsRequest>;

export type ValidateCreateProjectsLocationsMembershipsResponse = ValidateCreateMembershipResponse;
export const ValidateCreateProjectsLocationsMembershipsResponse = ValidateCreateMembershipResponse;

export type ValidateCreateProjectsLocationsMembershipsError = CommonErrors;
...
export const validateCreateProjectsLocationsMemberships: API.OperationMethod<ValidateCreateProjectsLocationsMembershipsRequest, ValidateCreateProjectsLocationsMembershipsResponse, ValidateCreateProjectsLocationsMembershipsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ValidateExclusivityProjectsLocationsMembershipsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships:validateExclusivity" }),
  svc,
...
export type ValidateExclusivityProjectsLocationsMembershipsError = CommonErrors;
...
export const validateExclusivityProjectsLocationsMemberships: API.OperationMethod<ValidateExclusivityProjectsLocationsMembershipsRequest, ValidateExclusivityProjectsLocationsMembershipsResponse, ValidateExclusivityProjectsLocationsMembershipsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GenerateExclusivityManifestProjectsLocationsMembershipsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}:generateExclusivityManifest" }),
  svc,
...
export type GenerateExclusivityManifestProjectsLocationsMembershipsError = CommonErrors;
...
export const SetIamPolicyProjectsLocationsMembershipsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}:setIamPolicy", hasBody: true }),
  svc,
...
export type SetIamPolicyProjectsLocationsMembershipsError = CommonErrors;

/** Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors. */
export const setIamPolicyProjectsLocationsMemberships: API.OperationMethod<SetIamPolicyProjectsLocationsMembershipsRequest, SetIamPolicyProjectsLocationsMembershipsResponse, SetIamPolicyProjectsLocationsMembershipsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetIamPolicyProjectsLocationsMembershipsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}:getIamPolicy" }),
  svc,
...
export type GetIamPolicyProjectsLocationsMembershipsError = CommonErrors;

/** Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. */
export const getIamPolicyProjectsLocationsMemberships: API.OperationMethod<GetIamPolicyProjectsLocationsMembershipsRequest, GetIamPolicyProjectsLocationsMembershipsResponse, GetIamPolicyProjectsLocationsMembershipsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const TestIamPermissionsProjectsLocationsMembershipsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}:testIamPermissions", hasBody: true }),
  svc,
...
export type TestIamPermissionsProjectsLocationsMembershipsError = CommonErrors;

/** Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a `NOT_FOUND` error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning. */
export const testIamPermissionsProjectsLocationsMemberships: API.OperationMethod<TestIamPermissionsProjectsLocationsMembershipsRequest, TestIamPermissionsProjectsLocationsMembershipsResponse, TestIamPermissionsProjectsLocationsMembershipsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetProjectsLocationsMembershipsBindingsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}/bindings/{bindingsId}" }),
  svc,
...
export const GetProjectsLocationsMembershipsBindingsResponse = MembershipBinding;

export type GetProjectsLocationsMembershipsBindingsError = CommonErrors;

/** Returns the details of a MembershipBinding. */
export const getProjectsLocationsMembershipsBindings: API.OperationMethod<GetProjectsLocationsMembershipsBindingsRequest, GetProjectsLocationsMembershipsBindingsResponse, GetProjectsLocationsMembershipsBindingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsMembershipsBindingsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  membershipBindingId: Schema.optional(Schema.String).pipe(T.HttpQuery("membershipBindingId")),
  body: Schema.optional(MembershipBinding).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}/bindings", hasBody: true }),
  svc,
...
export type CreateProjectsLocationsMembershipsBindingsError = CommonErrors;

/** Creates a MembershipBinding. */
export const createProjectsLocationsMembershipsBindings: API.OperationMethod<CreateProjectsLocationsMembershipsBindingsRequest, CreateProjectsLocationsMembershipsBindingsResponse, CreateProjectsLocationsMembershipsBindingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsMembershipsBindingsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}/bindings/{bindingsId}", hasBody: true }),
  svc,
...
export type PatchProjectsLocationsMembershipsBindingsError = CommonErrors;

/** Updates a MembershipBinding. */
export const patchProjectsLocationsMembershipsBindings: API.OperationMethod<PatchProjectsLocationsMembershipsBindingsRequest, PatchProjectsLocationsMembershipsBindingsResponse, PatchProjectsLocationsMembershipsBindingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsMembershipsBindingsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}/bindings/{bindingsId}" }),
  svc,
...
export type DeleteProjectsLocationsMembershipsBindingsError = CommonErrors;

/** Deletes a MembershipBinding. */
export const deleteProjectsLocationsMembershipsBindings: API.OperationMethod<DeleteProjectsLocationsMembershipsBindingsRequest, DeleteProjectsLocationsMembershipsBindingsResponse, DeleteProjectsLocationsMembershipsBindingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsMembershipsBindingsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}/bindings" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsMembershipsBindingsRequest>;

export type ListProjectsLocationsMembershipsBindingsResponse = ListMembershipBindingsResponse;
export const ListProjectsLocationsMembershipsBindingsResponse = ListMembershipBindingsResponse;

export type ListProjectsLocationsMembershipsBindingsError = CommonErrors;

/** Lists MembershipBindings. */
export const listProjectsLocationsMembershipsBindings: API.PaginatedOperationMethod<ListProjectsLocationsMembershipsBindingsRequest, ListProjectsLocationsMembershipsBindingsResponse, ListProjectsLocationsMembershipsBindingsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsMembershipsRbacrolebindingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}/rbacrolebindings/{rbacrolebindingsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsMembershipsRbacrolebindingsRequest>;

export type GetProjectsLocationsMembershipsRbacrolebindingsResponse = RBACRoleBinding;
export const GetProjectsLocationsMembershipsRbacrolebindingsResponse = RBACRoleBinding;

export type GetProjectsLocationsMembershipsRbacrolebindingsError = CommonErrors;

/** Returns the details of a Membership RBACRoleBinding. */
export const getProjectsLocationsMembershipsRbacrolebindings: API.OperationMethod<GetProjectsLocationsMembershipsRbacrolebindingsRequest, GetProjectsLocationsMembershipsRbacrolebindingsResponse, GetProjectsLocationsMembershipsRbacrolebindingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsMembershipsRbacrolebindingsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  rbacrolebindingId: Schema.optional(Schema.String).pipe(T.HttpQuery("rbacrolebindingId")),
  body: Schema.optional(RBACRoleBinding).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}/rbacrolebindings", hasBody: true }),
  svc,
) as unknown as Schema.Schema<CreateProjectsLocationsMembershipsRbacrolebindingsRequest>;

export type CreateProjectsLocationsMembershipsRbacrolebindingsResponse = Operation;
export const CreateProjectsLocationsMembershipsRbacrolebindingsResponse = Operation;

export type CreateProjectsLocationsMembershipsRbacrolebindingsError = CommonErrors;

/** Creates a Membership RBACRoleBinding. */
export const createProjectsLocationsMembershipsRbacrolebindings: API.OperationMethod<CreateProjectsLocationsMembershipsRbacrolebindingsRequest, CreateProjectsLocationsMembershipsRbacrolebindingsResponse, CreateProjectsLocationsMembershipsRbacrolebindingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsMembershipsRbacrolebindingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(RBACRoleBinding).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}/rbacrolebindings/{rbacrolebindingsId}", hasBody: true }),
  svc,
) as unknown as Schema.Schema<PatchProjectsLocationsMembershipsRbacrolebindingsRequest>;

export type PatchProjectsLocationsMembershipsRbacrolebindingsResponse = Operation;
export const PatchProjectsLocationsMembershipsRbacrolebindingsResponse = Operation;

export type PatchProjectsLocationsMembershipsRbacrolebindingsError = CommonErrors;

/** Updates a Membership RBACRoleBinding. */
export const patchProjectsLocationsMembershipsRbacrolebindings: API.OperationMethod<PatchProjectsLocationsMembershipsRbacrolebindingsRequest, PatchProjectsLocationsMembershipsRbacrolebindingsResponse, PatchProjectsLocationsMembershipsRbacrolebindingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsMembershipsRbacrolebindingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}/rbacrolebindings/{rbacrolebindingsId}" }),
  svc,
) as unknown as Schema.Schema<DeleteProjectsLocationsMembershipsRbacrolebindingsRequest>;

export type DeleteProjectsLocationsMembershipsRbacrolebindingsResponse = Operation;
export const DeleteProjectsLocationsMembershipsRbacrolebindingsResponse = Operation;

export type DeleteProjectsLocationsMembershipsRbacrolebindingsError = CommonErrors;

/** Deletes a Membership RBACRoleBinding. */
export const deleteProjectsLocationsMembershipsRbacrolebindings: API.OperationMethod<DeleteProjectsLocationsMembershipsRbacrolebindingsRequest, DeleteProjectsLocationsMembershipsRbacrolebindingsResponse, DeleteProjectsLocationsMembershipsRbacrolebindingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsMembershipsRbacrolebindingsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}/rbacrolebindings" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsMembershipsRbacrolebindingsRequest>;

export type ListProjectsLocationsMembershipsRbacrolebindingsResponse = ListMembershipRBACRoleBindingsResponse;
export const ListProjectsLocationsMembershipsRbacrolebindingsResponse = ListMembershipRBACRoleBindingsResponse;

export type ListProjectsLocationsMembershipsRbacrolebindingsError = CommonErrors;

/** Lists all Membership RBACRoleBindings. */
export const listProjectsLocationsMembershipsRbacrolebindings: API.PaginatedOperationMethod<ListProjectsLocationsMembershipsRbacrolebindingsRequest, ListProjectsLocationsMembershipsRbacrolebindingsResponse, ListProjectsLocationsMembershipsRbacrolebindingsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GenerateMembershipRBACRoleBindingYAMLProjectsLocationsMembershipsRbacrolebindingsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  rbacrolebindingId: Schema.optional(Schema.String).pipe(T.HttpQuery("rbacrolebindingId")),
  body: Schema.optional(RBACRoleBinding).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}/rbacrolebindings:generateMembershipRBACRoleBindingYAML", hasBody: true }),
  svc,
) as unknown as Schema.Schema<GenerateMembershipRBACRoleBindingYAMLProjectsLocationsMembershipsRbacrolebindingsRequest>;

export type GenerateMembershipRBACRoleBindingYAMLProjectsLocationsMembershipsRbacrolebindingsResponse = GenerateMembershipRBACRoleBindingYAMLResponse;
export const GenerateMembershipRBACRoleBindingYAMLProjectsLocationsMembershipsRbacrolebindingsResponse = GenerateMembershipRBACRoleBindingYAMLResponse;

export type GenerateMembershipRBACRoleBindingYAMLProjectsLocationsMembershipsRbacrolebindingsError = CommonErrors;

/** Generates a YAML of the RBAC policies for the specified RoleBinding and its associated impersonation resources. */
export const generateMembershipRBACRoleBindingYAMLProjectsLocationsMembershipsRbacrolebindings: API.OperationMethod<GenerateMembershipRBACRoleBindingYAMLProjectsLocationsMembershipsRbacrolebindingsRequest, GenerateMembershipRBACRoleBindingYAMLProjectsLocationsMembershipsRbacrolebindingsResponse, GenerateMembershipRBACRoleBindingYAMLProjectsLocationsMembershipsRbacrolebindingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
  input: GenerateMembershipRBACRoleBindingYAMLProjectsLocationsMembershipsRbacrolebindingsRequest,
  output: GenerateMembershipRBACRoleBindingYAMLProjectsLocationsMembershipsRbacrolebindingsResponse,
  errors: [],
}));
...
export const ListMembershipsProjectsLocationsScopesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes/{scopesId}:listMemberships" }),
  svc,
) as unknown as Schema.Schema<ListMembershipsProjectsLocationsScopesRequest>;

export type ListMembershipsProjectsLocationsScopesResponse = ListBoundMembershipsResponse;
export const ListMembershipsProjectsLocationsScopesResponse = ListBoundMembershipsResponse;

export type ListMembershipsProjectsLocationsScopesError = CommonErrors;

/** Lists Memberships bound to a Scope. The response includes relevant Memberships from all regions. */
export const listMembershipsProjectsLocationsScopes: API.PaginatedOperationMethod<ListMembershipsProjectsLocationsScopesRequest, ListMembershipsProjectsLocationsScopesResponse, ListMembershipsProjectsLocationsScopesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsScopesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes/{scopesId}" }),
  svc,
...
export const CreateProjectsLocationsScopesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes", hasBody: true }),
  svc,
...
export type CreateProjectsLocationsScopesError = CommonErrors;

/** Creates a Scope. */
export const createProjectsLocationsScopes: API.OperationMethod<CreateProjectsLocationsScopesRequest, CreateProjectsLocationsScopesResponse, CreateProjectsLocationsScopesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsScopesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes/{scopesId}", hasBody: true }),
  svc,
...
export const DeleteProjectsLocationsScopesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes/{scopesId}" }),
  svc,
...
export type DeleteProjectsLocationsScopesError = CommonErrors;

/** Deletes a Scope. */
export const deleteProjectsLocationsScopes: API.OperationMethod<DeleteProjectsLocationsScopesRequest, DeleteProjectsLocationsScopesResponse, DeleteProjectsLocationsScopesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsScopesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes" }),
  svc,
...
export type ListProjectsLocationsScopesError = CommonErrors;

/** Lists Scopes. */
export const listProjectsLocationsScopes: API.PaginatedOperationMethod<ListProjectsLocationsScopesRequest, ListProjectsLocationsScopesResponse, ListProjectsLocationsScopesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const ListPermittedProjectsLocationsScopesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes:listPermitted" }),
  svc,
) as unknown as Schema.Schema<ListPermittedProjectsLocationsScopesRequest>;

export type ListPermittedProjectsLocationsScopesResponse = ListPermittedScopesResponse;
export const ListPermittedProjectsLocationsScopesResponse = ListPermittedScopesResponse;

export type ListPermittedProjectsLocationsScopesError = CommonErrors;

/** Lists permitted Scopes. */
export const listPermittedProjectsLocationsScopes: API.PaginatedOperationMethod<ListPermittedProjectsLocationsScopesRequest, ListPermittedProjectsLocationsScopesResponse, ListPermittedProjectsLocationsScopesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const SetIamPolicyProjectsLocationsScopesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes/{scopesId}:setIamPolicy", hasBody: true }),
  svc,
...
export type SetIamPolicyProjectsLocationsScopesError = CommonErrors;

/** Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors. */
export const setIamPolicyProjectsLocationsScopes: API.OperationMethod<SetIamPolicyProjectsLocationsScopesRequest, SetIamPolicyProjectsLocationsScopesResponse, SetIamPolicyProjectsLocationsScopesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetIamPolicyProjectsLocationsScopesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes/{scopesId}:getIamPolicy" }),
  svc,
...
export type GetIamPolicyProjectsLocationsScopesError = CommonErrors;

/** Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. */
export const getIamPolicyProjectsLocationsScopes: API.OperationMethod<GetIamPolicyProjectsLocationsScopesRequest, GetIamPolicyProjectsLocationsScopesResponse, GetIamPolicyProjectsLocationsScopesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const TestIamPermissionsProjectsLocationsScopesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes/{scopesId}:testIamPermissions", hasBody: true }),
  svc,
) as unknown as Schema.Schema<TestIamPermissionsProjectsLocationsScopesRequest>;

export type TestIamPermissionsProjectsLocationsScopesResponse = TestIamPermissionsResponse;
export const TestIamPermissionsProjectsLocationsScopesResponse = TestIamPermissionsResponse;

export type TestIamPermissionsProjectsLocationsScopesError = CommonErrors;

/** Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a `NOT_FOUND` error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning. */
export const testIamPermissionsProjectsLocationsScopes: API.OperationMethod<TestIamPermissionsProjectsLocationsScopesRequest, TestIamPermissionsProjectsLocationsScopesResponse, TestIamPermissionsProjectsLocationsScopesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetProjectsLocationsScopesNamespacesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes/{scopesId}/namespaces/{namespacesId}" }),
  svc,
...
export type GetProjectsLocationsScopesNamespacesError = CommonErrors;

/** Returns the details of a fleet namespace. */
export const getProjectsLocationsScopesNamespaces: API.OperationMethod<GetProjectsLocationsScopesNamespacesRequest, GetProjectsLocationsScopesNamespacesResponse, GetProjectsLocationsScopesNamespacesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsScopesNamespacesRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  scopeNamespaceId: Schema.optional(Schema.String).pipe(T.HttpQuery("scopeNamespaceId")),
  body: Schema.optional(Namespace).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes/{scopesId}/namespaces", hasBody: true }),
  svc,
...
export type CreateProjectsLocationsScopesNamespacesError = CommonErrors;

/** Creates a fleet namespace. */
export const createProjectsLocationsScopesNamespaces: API.OperationMethod<CreateProjectsLocationsScopesNamespacesRequest, CreateProjectsLocationsScopesNamespacesResponse, CreateProjectsLocationsScopesNamespacesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsScopesNamespacesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes/{scopesId}/namespaces/{namespacesId}", hasBody: true }),
  svc,
...
export type PatchProjectsLocationsScopesNamespacesError = CommonErrors;

/** Updates a fleet namespace. */
export const patchProjectsLocationsScopesNamespaces: API.OperationMethod<PatchProjectsLocationsScopesNamespacesRequest, PatchProjectsLocationsScopesNamespacesResponse, PatchProjectsLocationsScopesNamespacesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsScopesNamespacesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes/{scopesId}/namespaces/{namespacesId}" }),
  svc,
...
export type DeleteProjectsLocationsScopesNamespacesError = CommonErrors;

/** Deletes a fleet namespace. */
export const deleteProjectsLocationsScopesNamespaces: API.OperationMethod<DeleteProjectsLocationsScopesNamespacesRequest, DeleteProjectsLocationsScopesNamespacesResponse, DeleteProjectsLocationsScopesNamespacesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsScopesNamespacesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes/{scopesId}/namespaces" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsScopesNamespacesRequest>;

export type ListProjectsLocationsScopesNamespacesResponse = ListScopeNamespacesResponse;
export const ListProjectsLocationsScopesNamespacesResponse = ListScopeNamespacesResponse;

export type ListProjectsLocationsScopesNamespacesError = CommonErrors;

/** Lists fleet namespaces. */
export const listProjectsLocationsScopesNamespaces: API.PaginatedOperationMethod<ListProjectsLocationsScopesNamespacesRequest, ListProjectsLocationsScopesNamespacesResponse, ListProjectsLocationsScopesNamespacesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsScopesRbacrolebindingsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes/{scopesId}/rbacrolebindings/{rbacrolebindingsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsScopesRbacrolebindingsRequest>;

export type GetProjectsLocationsScopesRbacrolebindingsResponse = RBACRoleBinding;
export const GetProjectsLocationsScopesRbacrolebindingsResponse = RBACRoleBinding;

export type GetProjectsLocationsScopesRbacrolebindingsError = CommonErrors;

/** Returns the details of a Scope RBACRoleBinding. */
export const getProjectsLocationsScopesRbacrolebindings: API.OperationMethod<GetProjectsLocationsScopesRbacrolebindingsRequest, GetProjectsLocationsScopesRbacrolebindingsResponse, GetProjectsLocationsScopesRbacrolebindingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsScopesRbacrolebindingsRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  rbacrolebindingId: Schema.optional(Schema.String).pipe(T.HttpQuery("rbacrolebindingId")),
  body: Schema.optional(RBACRoleBinding).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes/{scopesId}/rbacrolebindings", hasBody: true }),
  svc,
...
export type CreateProjectsLocationsScopesRbacrolebindingsError = CommonErrors;

/** Creates a Scope RBACRoleBinding. */
export const createProjectsLocationsScopesRbacrolebindings: API.OperationMethod<CreateProjectsLocationsScopesRbacrolebindingsRequest, CreateProjectsLocationsScopesRbacrolebindingsResponse, CreateProjectsLocationsScopesRbacrolebindingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsScopesRbacrolebindingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(RBACRoleBinding).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes/{scopesId}/rbacrolebindings/{rbacrolebindingsId}", hasBody: true }),
  svc,
...
export type PatchProjectsLocationsScopesRbacrolebindingsError = CommonErrors;

/** Updates a Scope RBACRoleBinding. */
export const patchProjectsLocationsScopesRbacrolebindings: API.OperationMethod<PatchProjectsLocationsScopesRbacrolebindingsRequest, PatchProjectsLocationsScopesRbacrolebindingsResponse, PatchProjectsLocationsScopesRbacrolebindingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsScopesRbacrolebindingsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes/{scopesId}/rbacrolebindings/{rbacrolebindingsId}" }),
  svc,
...
export type DeleteProjectsLocationsScopesRbacrolebindingsError = CommonErrors;

/** Deletes a Scope RBACRoleBinding. */
export const deleteProjectsLocationsScopesRbacrolebindings: API.OperationMethod<DeleteProjectsLocationsScopesRbacrolebindingsRequest, DeleteProjectsLocationsScopesRbacrolebindingsResponse, DeleteProjectsLocationsScopesRbacrolebindingsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsScopesRbacrolebindingsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/scopes/{scopesId}/rbacrolebindings" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsScopesRbacrolebindingsRequest>;

export type ListProjectsLocationsScopesRbacrolebindingsResponse = ListScopeRBACRoleBindingsResponse;
export const ListProjectsLocationsScopesRbacrolebindingsResponse = ListScopeRBACRoleBindingsResponse;

export type ListProjectsLocationsScopesRbacrolebindingsError = CommonErrors;

/** Lists all Scope RBACRoleBindings. */
export const listProjectsLocationsScopesRbacrolebindings: API.PaginatedOperationMethod<ListProjectsLocationsScopesRbacrolebindingsRequest, ListProjectsLocationsScopesRbacrolebindingsResponse, ListProjectsLocationsScopesRbacrolebindingsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const ListProjectsLocationsFeaturesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/features" }),
  svc,
...
export type ListProjectsLocationsFeaturesError = CommonErrors;

/** Lists Features in a given project and location. */
export const listProjectsLocationsFeatures: API.PaginatedOperationMethod<ListProjectsLocationsFeaturesRequest, ListProjectsLocationsFeaturesResponse, ListProjectsLocationsFeaturesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsFeaturesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/features/{featuresId}" }),
  svc,
...
export type GetProjectsLocationsFeaturesError = CommonErrors;

/** Gets details of a single Feature. */
export const getProjectsLocationsFeatures: API.OperationMethod<GetProjectsLocationsFeaturesRequest, GetProjectsLocationsFeaturesResponse, GetProjectsLocationsFeaturesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsFeaturesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/features", hasBody: true }),
  svc,
...
export type CreateProjectsLocationsFeaturesError = CommonErrors;

/** Adds a new Feature. */
export const createProjectsLocationsFeatures: API.OperationMethod<CreateProjectsLocationsFeaturesRequest, CreateProjectsLocationsFeaturesResponse, CreateProjectsLocationsFeaturesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsFeaturesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/features/{featuresId}" }),
  svc,
...
export type DeleteProjectsLocationsFeaturesError = CommonErrors;

/** Removes a Feature. */
export const deleteProjectsLocationsFeatures: API.OperationMethod<DeleteProjectsLocationsFeaturesRequest, DeleteProjectsLocationsFeaturesResponse, DeleteProjectsLocationsFeaturesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsFeaturesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/features/{featuresId}", hasBody: true }),
  svc,
...
export type PatchProjectsLocationsFeaturesError = CommonErrors;

/** Updates an existing Feature. */
export const patchProjectsLocationsFeatures: API.OperationMethod<PatchProjectsLocationsFeaturesRequest, PatchProjectsLocationsFeaturesResponse, PatchProjectsLocationsFeaturesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const SetIamPolicyProjectsLocationsFeaturesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/features/{featuresId}:setIamPolicy", hasBody: true }),
  svc,
...
export type SetIamPolicyProjectsLocationsFeaturesError = CommonErrors;

/** Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors. */
export const setIamPolicyProjectsLocationsFeatures: API.OperationMethod<SetIamPolicyProjectsLocationsFeaturesRequest, SetIamPolicyProjectsLocationsFeaturesResponse, SetIamPolicyProjectsLocationsFeaturesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetIamPolicyProjectsLocationsFeaturesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/features/{featuresId}:getIamPolicy" }),
  svc,
...
export type GetIamPolicyProjectsLocationsFeaturesError = CommonErrors;

/** Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. */
export const getIamPolicyProjectsLocationsFeatures: API.OperationMethod<GetIamPolicyProjectsLocationsFeaturesRequest, GetIamPolicyProjectsLocationsFeaturesResponse, GetIamPolicyProjectsLocationsFeaturesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const TestIamPermissionsProjectsLocationsFeaturesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/features/{featuresId}:testIamPermissions", hasBody: true }),
  svc,
) as unknown as Schema.Schema<TestIamPermissionsProjectsLocationsFeaturesRequest>;

export type TestIamPermissionsProjectsLocationsFeaturesResponse = TestIamPermissionsResponse;
export const TestIamPermissionsProjectsLocationsFeaturesResponse = TestIamPermissionsResponse;

export type TestIamPermissionsProjectsLocationsFeaturesError = CommonErrors;

/** Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a `NOT_FOUND` error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning. */
export const testIamPermissionsProjectsLocationsFeatures: API.OperationMethod<TestIamPermissionsProjectsLocationsFeaturesRequest, TestIamPermissionsProjectsLocationsFeaturesResponse, TestIamPermissionsProjectsLocationsFeaturesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const CreateProjectsLocationsFleetsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/fleets", hasBody: true }),
  svc,
...
export type CreateProjectsLocationsFleetsError = CommonErrors;

/** Creates a fleet. */
export const createProjectsLocationsFleets: API.OperationMethod<CreateProjectsLocationsFleetsRequest, CreateProjectsLocationsFleetsResponse, CreateProjectsLocationsFleetsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetProjectsLocationsFleetsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/fleets/{fleetsId}" }),
  svc,
...
export type GetProjectsLocationsFleetsError = CommonErrors;

/** Returns the details of a fleet. */
export const getProjectsLocationsFleets: API.OperationMethod<GetProjectsLocationsFleetsRequest, GetProjectsLocationsFleetsResponse, GetProjectsLocationsFleetsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsLocationsFleetsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/fleets/{fleetsId}", hasBody: true }),
  svc,
...
export type PatchProjectsLocationsFleetsError = CommonErrors;

/** Updates a fleet. */
export const patchProjectsLocationsFleets: API.OperationMethod<PatchProjectsLocationsFleetsRequest, PatchProjectsLocationsFleetsResponse, PatchProjectsLocationsFleetsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsFleetsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/fleets/{fleetsId}" }),
  svc,
...
export type DeleteProjectsLocationsFleetsError = CommonErrors;

/** Removes a Fleet. There must be no memberships remaining in the Fleet. */
export const deleteProjectsLocationsFleets: API.OperationMethod<DeleteProjectsLocationsFleetsRequest, DeleteProjectsLocationsFleetsResponse, DeleteProjectsLocationsFleetsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsFleetsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/fleets" }),
  svc,
...
export type ListProjectsLocationsFleetsError = CommonErrors;

/** Returns all fleets within an organization or a project that the caller has access to. */
export const listProjectsLocationsFleets: API.PaginatedOperationMethod<ListProjectsLocationsFleetsRequest, ListProjectsLocationsFleetsResponse, ListProjectsLocationsFleetsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsRolloutsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/rollouts/{rolloutsId}" }),
  svc,
...
export const ListProjectsLocationsRolloutsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/rollouts" }),
  svc,
...
export const CreateProjectsLocationsRolloutSequencesRequest = Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  rolloutSequenceId: Schema.optional(Schema.String).pipe(T.HttpQuery("rolloutSequenceId")),
  body: Schema.optional(RolloutSequence).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/rolloutSequences", hasBody: true }),
  svc,
...
export type CreateProjectsLocationsRolloutSequencesError = CommonErrors;

/** Create a new rollout sequence resource. */
export const createProjectsLocationsRolloutSequences: API.OperationMethod<CreateProjectsLocationsRolloutSequencesRequest, CreateProjectsLocationsRolloutSequencesResponse, CreateProjectsLocationsRolloutSequencesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetProjectsLocationsRolloutSequencesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/rolloutSequences/{rolloutSequencesId}" }),
  svc,
...
export type GetProjectsLocationsRolloutSequencesError = CommonErrors;

/** Retrieve a single rollout sequence. */
export const getProjectsLocationsRolloutSequences: API.OperationMethod<GetProjectsLocationsRolloutSequencesRequest, GetProjectsLocationsRolloutSequencesResponse, GetProjectsLocationsRolloutSequencesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationsRolloutSequencesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/rolloutSequences" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsRolloutSequencesRequest>;

export type ListProjectsLocationsRolloutSequencesResponse = ListRolloutSequencesResponse;
export const ListProjectsLocationsRolloutSequencesResponse = ListRolloutSequencesResponse;

export type ListProjectsLocationsRolloutSequencesError = CommonErrors;

/** Retrieve the list of all rollout sequences. */
export const listProjectsLocationsRolloutSequences: API.PaginatedOperationMethod<ListProjectsLocationsRolloutSequencesRequest, ListProjectsLocationsRolloutSequencesResponse, ListProjectsLocationsRolloutSequencesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const PatchProjectsLocationsRolloutSequencesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/rolloutSequences/{rolloutSequencesId}", hasBody: true }),
  svc,
...
export type PatchProjectsLocationsRolloutSequencesError = CommonErrors;

/** Update a rollout sequence. */
export const patchProjectsLocationsRolloutSequences: API.OperationMethod<PatchProjectsLocationsRolloutSequencesRequest, PatchProjectsLocationsRolloutSequencesResponse, PatchProjectsLocationsRolloutSequencesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsLocationsRolloutSequencesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1alpha/projects/{projectsId}/locations/{locationsId}/rolloutSequences/{rolloutSequencesId}" }),
  svc,
...
export type DeleteProjectsLocationsRolloutSequencesError = CommonErrors;

/** Remove a RolloutSequence. */
export const deleteProjectsLocationsRolloutSequences: API.OperationMethod<DeleteProjectsLocationsRolloutSequencesRequest, DeleteProjectsLocationsRolloutSequencesResponse, DeleteProjectsLocationsRolloutSequencesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ListOrganizationsLocationsFleetsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1alpha/organizations/{organizationsId}/locations/{locationsId}/fleets" }),
  svc,
...
export type ListOrganizationsLocationsFleetsError = CommonErrors;

/** Returns all fleets within an organization or a project that the caller has access to. */
export const listOrganizationsLocationsFleets: API.PaginatedOperationMethod<ListOrganizationsLocationsFleetsRequest, ListOrganizationsLocationsFleetsResponse, ListOrganizationsLocationsFleetsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
