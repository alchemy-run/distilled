...
export const listDetections: API.OperationMethod<ListDetectionsRequest, ListDetectionsResponse, ListDetectionsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type DetectDetectionsError = CommonErrors;

/** Detects the language of text within a request. */
export const detectDetections: API.OperationMethod<DetectDetectionsRequest, DetectDetectionsResponse, DetectDetectionsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type ListTranslationsError = CommonErrors;

/** Translates input text, returning translated text. */
export const listTranslations: API.OperationMethod<ListTranslationsRequest, ListTranslationsResponse, ListTranslationsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type TranslateTranslationsError = CommonErrors;

/** Translates input text, returning translated text. */
export const translateTranslations: API.OperationMethod<TranslateTranslationsRequest, TranslateTranslationsResponse, TranslateTranslationsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
