...
export const listProjectsTenantsJobs: API.PaginatedOperationMethod<ListProjectsTenantsJobsRequest, ListProjectsTenantsJobsResponse, ListProjectsTenantsJobsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const listProjectsTenantsCompanies: API.PaginatedOperationMethod<ListProjectsTenantsCompaniesRequest, ListProjectsTenantsCompaniesResponse, ListProjectsTenantsCompaniesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
