...
export const CreativeAssetSelection: Schema.Schema<CreativeAssetSelection> = Schema.suspend(() => Schema.Struct({
  rules: Schema.optional(Schema.Array(Rule)),
  defaultAssetId: Schema.optional(Schema.String),
})).annotate({ identifier: "CreativeAssetSelection" }) as any as Schema.Schema<CreativeAssetSelection>;
...
export interface Project {
  ...
  audienceAgeGroup?: "PLANNING_AUDIENCE_AGE_18_24" | "PLANNING_AUDIENCE_AGE_25_34" | "PLANNING_AUDIENCE_AGE_35_44" | "PLANNING_AUDIENCE_AGE_45_54" | "PLANNING_AUDIENCE_AGE_55_64" | "PLANNING_AUDIENCE_AGE_65_OR_MORE" | "PLANNING_AUDIENCE_AGE_UNKNOWN" | (string & {});
  ...
  audienceGender?: "PLANNING_AUDIENCE_GENDER_MALE" | "PLANNING_AUDIENCE_GENDER_FEMALE" | (string & {});
}
...
export const ProjectsListResponse: Schema.Schema<ProjectsListResponse> = Schema.suspend(() => Schema.Struct({
  projects: Schema.optional(Schema.Array(Project)),
  kind: Schema.optional(Schema.String),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "ProjectsListResponse" }) as any as Schema.Schema<ProjectsListResponse>;
...
export interface AdSlot {
  ...
  paymentSourceType?: "PLANNING_PAYMENT_SOURCE_TYPE_AGENCY_PAID" | "PLANNING_PAYMENT_SOURCE_TYPE_PUBLISHER_PAID" | (string & {});
...
export const AdSlot: Schema.Schema<AdSlot> = Schema.suspend(() => Schema.Struct({
...
export interface Report {
  ...
  type?: "STANDARD" | "REACH" | "PATH_TO_CONVERSION" | "CROSS_DIMENSION_REACH" | "FLOODLIGHT" | "CROSS_MEDIA_REACH" | (string & {});
  ...
  floodlightCriteria?: { dateRange?: DateRange; floodlightConfigId?: DimensionValue; metricNames?: Array<string>; reportProperties?: { includeUnattributedIPConversions?: boolean; includeUnattributedCookieConversions?: boolean; includeAttributedIPConversions?: boolean }; dimensionFilters?: Array<DimensionValue>; dimensions?: Array<SortedDimension>; customRichMediaEvents?: Array<DimensionValue> };
  /** Optional. The report criteria for a report of type "CROSS_MEDIA_REACH". */
  crossMediaReachCriteria?: { dimensions?: Array<SortedDimension>; dimensionFilters?: Array<DimensionValue>; dateRange?: DateRange; metricNames?: Array<string> };
  /** The report criteria for a report of type "CROSS_DIMENSION_REACH". */
  crossDimensionReachCriteria?: { dateRange?: DateRange; dimension?: "ADVERTISER" | "CAMPAIGN" | "SITE_BY_ADVERTISER" | "SITE_BY_CAMPAIGN" | (string & {}); metricNames?: Array<string>; overlapMetricNames?: Array<string>; dimensionFilters?: Array<DimensionValue>; breakdown?: Array<SortedDimension>; pivoted?: boolean };
  /** The account ID to which this report belongs. */
  accountId?: string;
  /** The report's email delivery settings. */
  delivery?: { message?: string; recipients?: Array<Recipient>; emailOwnerDeliveryType?: "LINK" | "ATTACHMENT" | (string & {}); emailOwner?: boolean };
  /** The user profile id of the owner of this report. */
  ownerProfileId?: string;
  /** The eTag of this response for caching purposes. */
  etag?: string;
  /** The report criteria for a report of type "PATH_TO_CONVERSION". */
  pathToConversionCriteria?: { floodlightConfigId?: DimensionValue; activityFilters?: Array<DimensionValue>; customRichMediaEvents?: Array<DimensionValue>; dateRange?: DateRange; customFloodlightVariables?: Array<SortedDimension>; metricNames?: Array<string>; reportProperties?: { includeUnattributedIPConversions?: boolean; pivotOnInteractionPath?: boolean; maximumImpressionInteractions?: number; maximumClickInteractions?: number; clicksLookbackWindow?: number; maximumInteractionGap?: number; impressionsLookbackWindow?: number; includeAttributedIPConversions?: boolean; includeUnattributedCookieConversions?: boolean }; conversionDimensions?: Array<SortedDimension>; perInteractionDimensions?: Array<SortedDimension> };
  /** The report criteria for a report of type "REACH". */
  reachCriteria?: { customRichMediaEvents?: CustomRichMediaEvents; dimensions?: Array<SortedDimension>; dimensionFilters?: Array<DimensionValue>; activities?: Activities; reachByFrequencyMetricNames?: Array<string>; metricNames?: Array<string>; enableAllDimensionCombinations?: boolean; dateRange?: DateRange };
  /** The filename used when generating report files for this report. */
  fileName?: string;
  /** The report's schedule. Can only be set if the report's 'dateRange' is a relative date range and the relative date range is not "TODAY". */
  schedule?: { every?: number; expirationDate?: string; repeats?: string; timezone?: string; runsOnDayOfMonth?: "DAY_OF_MONTH" | "WEEK_OF_MONTH" | (string & {}); active?: boolean; startDate?: string; repeatsOnWeekDays?: Array<"SUNDAY" | "MONDAY" | "TUESDAY" | "WEDNESDAY" | "THURSDAY" | "FRIDAY" | "SATURDAY" | (string & {})> };
  /** The output format of the report. If not specified, default format is "CSV". Note that the actual format in the completed report file might differ if for instance the report's size exceeds the format's capabilities. "CSV" will then be the fallback format. */
  format?: "CSV" | "EXCEL" | (string & {});
  /** The subaccount ID to which this report belongs if applicable. */
  subAccountId?: string;
  /** The report criteria for a report of type "STANDARD". */
  criteria?: { metricNames?: Array<string>; activities?: Activities; dimensions?: Array<SortedDimension>; dimensionFilters?: Array<DimensionValue>; customRichMediaEvents?: CustomRichMediaEvents; dateRange?: DateRange };
}
...
export const Report: Schema.Schema<Report> = Schema.suspend(() => Schema.Struct({
  ...
  name: Schema.optional(Schema.String),
  id: Schema.optional(Schema.String),
  floodlightCriteria: Schema.optional(Schema.Struct({ dateRange: Schema.optional(DateRange), floodlightConfigId: Schema.optional(DimensionValue), metricNames: Schema.optional(Schema.Array(Schema.String)), reportProperties: Schema.optional(Schema.Struct({ includeUnattributedIPConversions: Schema.optional(Schema.Boolean), includeUnattributedCookieConversions: Schema.optional(Schema.Boolean), includeAttributedIPConversions: Schema.optional(Schema.Boolean) })), dimensionFilters: Schema.optional(Schema.Array(DimensionValue)), dimensions: Schema.optional(Schema.Array(SortedDimension)), customRichMediaEvents: Schema.optional(Schema.Array(DimensionValue)) })),
  crossMediaReachCriteria: Schema.optional(Schema.Struct({ dimensions: Schema.optional(Schema.Array(SortedDimension)), dimensionFilters: Schema.optional(Schema.Array(DimensionValue)), dateRange: Schema.optional(DateRange), metricNames: Schema.optional(Schema.Array(Schema.String)) })),
  crossDimensionReachCriteria: Schema.optional(Schema.Struct({ dateRange: Schema.optional(DateRange), dimension: Schema.optional(Schema.String), metricNames: Schema.optional(Schema.Array(Schema.String)), overlapMetricNames: Schema.optional(Schema.Array(Schema.String)), dimensionFilters: Schema.optional(Schema.Array(DimensionValue)), breakdown: Schema.optional(Schema.Array(SortedDimension)), pivoted: Schema.optional(Schema.Boolean) })),
  accountId: Schema.optional(Schema.String),
  delivery: Schema.optional(Schema.Struct({ message: Schema.optional(Schema.String), recipients: Schema.optional(Schema.Array(Recipient)), emailOwnerDeliveryType: Schema.optional(Schema.String), emailOwner: Schema.optional(Schema.Boolean) })),
  ownerProfileId: Schema.optional(Schema.String),
  etag: Schema.optional(Schema.String),
  pathToConversionCriteria: Schema.optional(Schema.Struct({ floodlightConfigId: Schema.optional(DimensionValue), activityFilters: Schema.optional(Schema.Array(DimensionValue)), customRichMediaEvents: Schema.optional(Schema.Array(DimensionValue)), dateRange: Schema.optional(DateRange), customFloodlightVariables: Schema.optional(Schema.Array(SortedDimension)), metricNames: Schema.optional(Schema.Array(Schema.String)), reportProperties: Schema.optional(Schema.Struct({ includeUnattributedIPConversions: Schema.optional(Schema.Boolean), pivotOnInteractionPath: Schema.optional(Schema.Boolean), maximumImpressionInteractions: Schema.optional(Schema.Number), maximumClickInteractions: Schema.optional(Schema.Number), clicksLookbackWindow: Schema.optional(Schema.Number), maximumInteractionGap: Schema.optional(Schema.Number), impressionsLookbackWindow: Schema.optional(Schema.Number), includeAttributedIPConversions: Schema.optional(Schema.Boolean), includeUnattributedCookieConversions: Schema.optional(Schema.Boolean) })), conversionDimensions: Schema.optional(Schema.Array(SortedDimension)), perInteractionDimensions: Schema.optional(Schema.Array(SortedDimension)) })),
  reachCriteria: Schema.optional(Schema.Struct({ customRichMediaEvents: Schema.optional(CustomRichMediaEvents), dimensions: Schema.optional(Schema.Array(SortedDimension)), dimensionFilters: Schema.optional(Schema.Array(DimensionValue)), activities: Schema.optional(Activities), reachByFrequencyMetricNames: Schema.optional(Schema.Array(Schema.String)), metricNames: Schema.optional(Schema.Array(Schema.String)), enableAllDimensionCombinations: Schema.optional(Schema.Boolean), dateRange: Schema.optional(DateRange) })),
  fileName: Schema.optional(Schema.String),
  schedule: Schema.optional(Schema.Struct({ every: Schema.optional(Schema.Number), expirationDate: Schema.optional(Schema.String), repeats: Schema.optional(Schema.String), timezone: Schema.optional(Schema.String), runsOnDayOfMonth: Schema.optional(Schema.String), active: Schema.optional(Schema.Boolean), startDate: Schema.optional(Schema.String), repeatsOnWeekDays: Schema.optional(Schema.Array(Schema.String)) })),
  format: Schema.optional(Schema.String),
  subAccountId: Schema.optional(Schema.String),
  criteria: Schema.optional(Schema.Struct({ metricNames: Schema.optional(Schema.Array(Schema.String)), activities: Schema.optional(Activities), dimensions: Schema.optional(Schema.Array(SortedDimension)), dimensionFilters: Schema.optional(Schema.Array(DimensionValue)), customRichMediaEvents: Schema.optional(CustomRichMediaEvents), dateRange: Schema.optional(DateRange) })),
...
export const Flight: Schema.Schema<Flight> = Schema.suspend(() => Schema.Struct({
  startDate: Schema.optional(Schema.String),
  endDate: Schema.optional(Schema.String),
...
export interface Pricing {
  ...
  capCostType?: "PLANNING_PLACEMENT_CAP_COST_TYPE_NONE" | "PLANNING_PLACEMENT_CAP_COST_TYPE_MONTHLY" | "PLANNING_PLACEMENT_CAP_COST_TYPE_CUMULATIVE" | (string & {});
  startDate?: string;
  ...
  groupType?: "PLANNING_PLACEMENT_GROUP_TYPE_PACKAGE" | "PLANNING_PLACEMENT_GROUP_TYPE_ROADBLOCK" | (string & {});
  /** Pricing type of this inventory item. */
  pricingType?: "PLANNING_PLACEMENT_PRICING_TYPE_IMPRESSIONS" | "PLANNING_PLACEMENT_PRICING_TYPE_CPM" | "PLANNING_PLACEMENT_PRICING_TYPE_CLICKS" | "PLANNING_PLACEMENT_PRICING_TYPE_CPC" | "PLANNING_PLACEMENT_PRICING_TYPE_CPA" | "PLANNING_PLACEMENT_PRICING_TYPE_FLAT_RATE_IMPRESSIONS" | "PLANNING_PLACEMENT_PRICING_TYPE_FLAT_RATE_CLICKS" | "PLANNING_PLACEMENT_PRICING_TYPE_CPM_ACTIVEVIEW" | (string & {});
...
export const Pricing: Schema.Schema<Pricing> = Schema.suspend(() => Schema.Struct({
  endDate: Schema.optional(Schema.String),
...
export interface InventoryItem {
  ...
  type?: "PLANNING_PLACEMENT_TYPE_REGULAR" | "PLANNING_PLACEMENT_TYPE_CREDIT" | (string & {});
...
export interface OrderContact {
  ...
  contactType?: "PLANNING_ORDER_CONTACT_BUYER_CONTACT" | "PLANNING_ORDER_CONTACT_BUYER_BILLING_CONTACT" | "PLANNING_ORDER_CONTACT_SELLER_CONTACT" | (string & {});
...
export const OrderContact: Schema.Schema<OrderContact> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "OrderContact" }) as any as Schema.Schema<OrderContact>;
...
export const OrdersListResponse: Schema.Schema<OrdersListResponse> = Schema.suspend(() => Schema.Struct({
  kind: Schema.optional(Schema.String),
  nextPageToken: Schema.optional(Schema.String),
  orders: Schema.optional(Schema.Array(Order)),
})).annotate({ identifier: "OrdersListResponse" }) as any as Schema.Schema<OrdersListResponse>;
...
export const InventoryItemsListResponse: Schema.Schema<InventoryItemsListResponse> = Schema.suspend(() => Schema.Struct({
  kind: Schema.optional(Schema.String),
  nextPageToken: Schema.optional(Schema.String),
  inventoryItems: Schema.optional(Schema.Array(InventoryItem)),
})).annotate({ identifier: "InventoryItemsListResponse" }) as any as Schema.Schema<InventoryItemsListResponse>;
...
export const GetInventoryItemsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "userprofiles/{userprofilesId}/projects/{projectId}/inventoryItems/{inventoryItemsId}" }),
  svc,
...
export type GetInventoryItemsError = CommonErrors;

/** Gets one inventory item by ID. */
export const getInventoryItems: API.OperationMethod<GetInventoryItemsRequest, GetInventoryItemsResponse, GetInventoryItemsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ListInventoryItemsRequest = Schema.Struct({
  ...
  sortField: Schema.optional(Schema.String).pipe(T.HttpQuery("sortField")),
  ids: Schema.optional(Schema.Array(Schema.String)).pipe(T.HttpQuery("ids")),
  orderId: Schema.optional(Schema.Array(Schema.String)).pipe(T.HttpQuery("orderId")),
  siteId: Schema.optional(Schema.Array(Schema.String)).pipe(T.HttpQuery("siteId")),
  sortOrder: Schema.optional(Schema.String).pipe(T.HttpQuery("sortOrder")),
  profileId: Schema.String.pipe(T.HttpPath("profileId")),
  type: Schema.optional(Schema.String).pipe(T.HttpQuery("type")),
  maxResults: Schema.optional(Schema.Number).pipe(T.HttpQuery("maxResults")),
}).pipe(
  T.Http({ method: "GET", path: "userprofiles/{userprofilesId}/projects/{projectId}/inventoryItems" }),
  svc,
...
export type ListInventoryItemsError = CommonErrors;

/** Retrieves a list of inventory items, possibly filtered. This method supports paging. */
export const listInventoryItems: API.PaginatedOperationMethod<ListInventoryItemsRequest, ListInventoryItemsResponse, ListInventoryItemsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const ListOrdersRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "userprofiles/{userprofilesId}/projects/{projectId}/orders" }),
  svc,
...
export type ListOrdersError = CommonErrors;

/** Retrieves a list of orders, possibly filtered. This method supports paging. */
export const listOrders: API.PaginatedOperationMethod<ListOrdersRequest, ListOrdersResponse, ListOrdersError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetOrdersRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "userprofiles/{userprofilesId}/projects/{projectId}/orders/{ordersId}" }),
  svc,
...
export const GetProjectsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "userprofiles/{userprofilesId}/projects/{projectsId}" }),
  svc,
...
export const PatchReportsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "userprofiles/{profileId}/reports/{reportId}", hasBody: true }),
  svc,
...
export type PatchReportsError = CommonErrors;

/** Updates an existing report. This method supports patch semantics. */
export const patchReports: API.OperationMethod<PatchReportsRequest, PatchReportsResponse, PatchReportsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
