...
export type ListProjectsLocationsInstancesSharesError = CommonErrors;

/** Lists all shares for a specified instance. */
export const listProjectsLocationsInstancesShares: API.PaginatedOperationMethod<ListProjectsLocationsInstancesSharesRequest, ListProjectsLocationsInstancesSharesResponse, ListProjectsLocationsInstancesSharesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export type GetProjectsLocationsInstancesSharesError = CommonErrors;

/** Gets the details of a specific share. */
export const getProjectsLocationsInstancesShares: API.OperationMethod<GetProjectsLocationsInstancesSharesRequest, GetProjectsLocationsInstancesSharesResponse, GetProjectsLocationsInstancesSharesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type CreateProjectsLocationsInstancesSharesError = CommonErrors;

/** Creates a share. */
export const createProjectsLocationsInstancesShares: API.OperationMethod<CreateProjectsLocationsInstancesSharesRequest, CreateProjectsLocationsInstancesSharesResponse, CreateProjectsLocationsInstancesSharesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type DeleteProjectsLocationsInstancesSharesError = CommonErrors;

/** Deletes a share. */
export const deleteProjectsLocationsInstancesShares: API.OperationMethod<DeleteProjectsLocationsInstancesSharesRequest, DeleteProjectsLocationsInstancesSharesResponse, DeleteProjectsLocationsInstancesSharesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type PatchProjectsLocationsInstancesSharesError = CommonErrors;

/** Updates the settings of a specific share. */
export const patchProjectsLocationsInstancesShares: API.OperationMethod<PatchProjectsLocationsInstancesSharesRequest, PatchProjectsLocationsInstancesSharesResponse, PatchProjectsLocationsInstancesSharesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
