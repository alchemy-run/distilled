...
export const GoogleCloudRecommenderV1beta1InsightStateInfo: Schema.Schema<GoogleCloudRecommenderV1beta1InsightStateInfo> = Schema.suspend(() => Schema.Struct({
  state: Schema.optional(Schema.String),
  stateMetadata: Schema.optional(Schema.Record(Schema.String, Schema.String)),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1InsightStateInfo" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1InsightStateInfo>;
...
export const GoogleCloudRecommenderV1beta1InsightRecommendationReference: Schema.Schema<GoogleCloudRecommenderV1beta1InsightRecommendationReference> = Schema.suspend(() => Schema.Struct({
  recommendation: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1InsightRecommendationReference" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1InsightRecommendationReference>;
...
export const GoogleCloudRecommenderV1beta1Insight: Schema.Schema<GoogleCloudRecommenderV1beta1Insight> = Schema.suspend(() => Schema.Struct({
  ...
  associatedRecommendations: Schema.optional(Schema.Array(GoogleCloudRecommenderV1beta1InsightRecommendationReference)),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1Insight" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1Insight>;
...
export const GoogleCloudRecommenderV1beta1ListInsightsResponse: Schema.Schema<GoogleCloudRecommenderV1beta1ListInsightsResponse> = Schema.suspend(() => Schema.Struct({
  insights: Schema.optional(Schema.Array(GoogleCloudRecommenderV1beta1Insight)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1ListInsightsResponse" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1ListInsightsResponse>;
...
export const GoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest: Schema.Schema<GoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest> = Schema.suspend(() => Schema.Struct({
  stateMetadata: Schema.optional(Schema.Record(Schema.String, Schema.String)),
  etag: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest>;
...
export interface GoogleCloudRecommenderV1beta1CostProjection {
  ...
  pricingType?: "PRICING_TYPE_UNSPECIFIED" | "LIST_PRICE" | "CUSTOM_PRICE" | (string & {});
}

export const GoogleCloudRecommenderV1beta1CostProjection: Schema.Schema<GoogleCloudRecommenderV1beta1CostProjection> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1CostProjection" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1CostProjection>;
...
export const GoogleCloudRecommenderV1beta1SecurityProjection: Schema.Schema<GoogleCloudRecommenderV1beta1SecurityProjection> = Schema.suspend(() => Schema.Struct({
  details: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1SecurityProjection" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1SecurityProjection>;
...
export const GoogleCloudRecommenderV1beta1SustainabilityProjection: Schema.Schema<GoogleCloudRecommenderV1beta1SustainabilityProjection> = Schema.suspend(() => Schema.Struct({
  kgCO2e: Schema.optional(Schema.Number),
  duration: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1SustainabilityProjection" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1SustainabilityProjection>;
...
export const GoogleCloudRecommenderV1beta1ReliabilityProjection: Schema.Schema<GoogleCloudRecommenderV1beta1ReliabilityProjection> = Schema.suspend(() => Schema.Struct({
  risks: Schema.optional(Schema.Array(Schema.String)),
  details: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1ReliabilityProjection" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1ReliabilityProjection>;
...
export const GoogleCloudRecommenderV1beta1Impact: Schema.Schema<GoogleCloudRecommenderV1beta1Impact> = Schema.suspend(() => Schema.Struct({
  category: Schema.optional(Schema.String),
  costProjection: Schema.optional(GoogleCloudRecommenderV1beta1CostProjection),
  securityProjection: Schema.optional(GoogleCloudRecommenderV1beta1SecurityProjection),
  sustainabilityProjection: Schema.optional(GoogleCloudRecommenderV1beta1SustainabilityProjection),
  reliabilityProjection: Schema.optional(GoogleCloudRecommenderV1beta1ReliabilityProjection),
  service: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1Impact" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1Impact>;
...
export const GoogleCloudRecommenderV1beta1ValueMatcher: Schema.Schema<GoogleCloudRecommenderV1beta1ValueMatcher> = Schema.suspend(() => Schema.Struct({
  matchesPattern: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1ValueMatcher" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1ValueMatcher>;
...
export const GoogleCloudRecommenderV1beta1Operation: Schema.Schema<GoogleCloudRecommenderV1beta1Operation> = Schema.suspend(() => Schema.Struct({
  ...
  pathValueMatchers: Schema.optional(Schema.Record(Schema.String, GoogleCloudRecommenderV1beta1ValueMatcher)),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1Operation" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1Operation>;
...
export const GoogleCloudRecommenderV1beta1OperationGroup: Schema.Schema<GoogleCloudRecommenderV1beta1OperationGroup> = Schema.suspend(() => Schema.Struct({
  operations: Schema.optional(Schema.Array(GoogleCloudRecommenderV1beta1Operation)),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1OperationGroup" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1OperationGroup>;
...
export const GoogleCloudRecommenderV1beta1RecommendationContent: Schema.Schema<GoogleCloudRecommenderV1beta1RecommendationContent> = Schema.suspend(() => Schema.Struct({
  operationGroups: Schema.optional(Schema.Array(GoogleCloudRecommenderV1beta1OperationGroup)),
  overview: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1RecommendationContent" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1RecommendationContent>;
...
export const GoogleCloudRecommenderV1beta1RecommendationStateInfo: Schema.Schema<GoogleCloudRecommenderV1beta1RecommendationStateInfo> = Schema.suspend(() => Schema.Struct({
  state: Schema.optional(Schema.String),
  stateMetadata: Schema.optional(Schema.Record(Schema.String, Schema.String)),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1RecommendationStateInfo" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1RecommendationStateInfo>;
...
export const GoogleCloudRecommenderV1beta1RecommendationInsightReference: Schema.Schema<GoogleCloudRecommenderV1beta1RecommendationInsightReference> = Schema.suspend(() => Schema.Struct({
  insight: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1RecommendationInsightReference" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1RecommendationInsightReference>;
...
export const GoogleCloudRecommenderV1beta1Recommendation: Schema.Schema<GoogleCloudRecommenderV1beta1Recommendation> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
  recommenderSubtype: Schema.optional(Schema.String),
  lastRefreshTime: Schema.optional(Schema.String),
  primaryImpact: Schema.optional(GoogleCloudRecommenderV1beta1Impact),
  additionalImpact: Schema.optional(Schema.Array(GoogleCloudRecommenderV1beta1Impact)),
  priority: Schema.optional(Schema.String),
  content: Schema.optional(GoogleCloudRecommenderV1beta1RecommendationContent),
  stateInfo: Schema.optional(GoogleCloudRecommenderV1beta1RecommendationStateInfo),
  etag: Schema.optional(Schema.String),
  associatedInsights: Schema.optional(Schema.Array(GoogleCloudRecommenderV1beta1RecommendationInsightReference)),
  xorGroupId: Schema.optional(Schema.String),
  targetResources: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1Recommendation" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1Recommendation>;
...
export const GoogleCloudRecommenderV1beta1ListRecommendationsResponse: Schema.Schema<GoogleCloudRecommenderV1beta1ListRecommendationsResponse> = Schema.suspend(() => Schema.Struct({
  recommendations: Schema.optional(Schema.Array(GoogleCloudRecommenderV1beta1Recommendation)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1ListRecommendationsResponse" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1ListRecommendationsResponse>;
...
export const GoogleCloudRecommenderV1beta1MarkRecommendationDismissedRequest: Schema.Schema<GoogleCloudRecommenderV1beta1MarkRecommendationDismissedRequest> = Schema.suspend(() => Schema.Struct({
  etag: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1MarkRecommendationDismissedRequest" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1MarkRecommendationDismissedRequest>;
...
export const GoogleCloudRecommenderV1beta1MarkRecommendationClaimedRequest: Schema.Schema<GoogleCloudRecommenderV1beta1MarkRecommendationClaimedRequest> = Schema.suspend(() => Schema.Struct({
  stateMetadata: Schema.optional(Schema.Record(Schema.String, Schema.String)),
  etag: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1MarkRecommendationClaimedRequest" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1MarkRecommendationClaimedRequest>;
...
export const GoogleCloudRecommenderV1beta1MarkRecommendationSucceededRequest: Schema.Schema<GoogleCloudRecommenderV1beta1MarkRecommendationSucceededRequest> = Schema.suspend(() => Schema.Struct({
  stateMetadata: Schema.optional(Schema.Record(Schema.String, Schema.String)),
  etag: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1MarkRecommendationSucceededRequest" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1MarkRecommendationSucceededRequest>;
...
export const GoogleCloudRecommenderV1beta1MarkRecommendationFailedRequest: Schema.Schema<GoogleCloudRecommenderV1beta1MarkRecommendationFailedRequest> = Schema.suspend(() => Schema.Struct({
  stateMetadata: Schema.optional(Schema.Record(Schema.String, Schema.String)),
  etag: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1MarkRecommendationFailedRequest" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1MarkRecommendationFailedRequest>;
...
export const GoogleCloudRecommenderV1beta1RecommenderGenerationConfig: Schema.Schema<GoogleCloudRecommenderV1beta1RecommenderGenerationConfig> = Schema.suspend(() => Schema.Struct({
  params: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1RecommenderGenerationConfig" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1RecommenderGenerationConfig>;
...
export const GoogleCloudRecommenderV1beta1RecommenderConfig: Schema.Schema<GoogleCloudRecommenderV1beta1RecommenderConfig> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  recommenderGenerationConfig: Schema.optional(GoogleCloudRecommenderV1beta1RecommenderGenerationConfig),
  etag: Schema.optional(Schema.String),
  updateTime: Schema.optional(Schema.String),
  revisionId: Schema.optional(Schema.String),
  annotations: Schema.optional(Schema.Record(Schema.String, Schema.String)),
  displayName: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1RecommenderConfig" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1RecommenderConfig>;
...
export const GoogleCloudRecommenderV1beta1InsightTypeGenerationConfig: Schema.Schema<GoogleCloudRecommenderV1beta1InsightTypeGenerationConfig> = Schema.suspend(() => Schema.Struct({
  params: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1InsightTypeGenerationConfig" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1InsightTypeGenerationConfig>;
...
export const GoogleCloudRecommenderV1beta1InsightTypeConfig: Schema.Schema<GoogleCloudRecommenderV1beta1InsightTypeConfig> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  insightTypeGenerationConfig: Schema.optional(GoogleCloudRecommenderV1beta1InsightTypeGenerationConfig),
  etag: Schema.optional(Schema.String),
  updateTime: Schema.optional(Schema.String),
  revisionId: Schema.optional(Schema.String),
  annotations: Schema.optional(Schema.Record(Schema.String, Schema.String)),
  displayName: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1InsightTypeConfig" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1InsightTypeConfig>;
...
export const GoogleCloudRecommenderV1beta1RecommenderType: Schema.Schema<GoogleCloudRecommenderV1beta1RecommenderType> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1RecommenderType" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1RecommenderType>;
...
export const GoogleCloudRecommenderV1beta1ListRecommendersResponse: Schema.Schema<GoogleCloudRecommenderV1beta1ListRecommendersResponse> = Schema.suspend(() => Schema.Struct({
  recommenders: Schema.optional(Schema.Array(GoogleCloudRecommenderV1beta1RecommenderType)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1ListRecommendersResponse" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1ListRecommendersResponse>;
...
export const GoogleCloudRecommenderV1beta1InsightType: Schema.Schema<GoogleCloudRecommenderV1beta1InsightType> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1InsightType" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1InsightType>;
...
export const GoogleCloudRecommenderV1beta1ListInsightTypesResponse: Schema.Schema<GoogleCloudRecommenderV1beta1ListInsightTypesResponse> = Schema.suspend(() => Schema.Struct({
  insightTypes: Schema.optional(Schema.Array(GoogleCloudRecommenderV1beta1InsightType)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "GoogleCloudRecommenderV1beta1ListInsightTypesResponse" }) as any as Schema.Schema<GoogleCloudRecommenderV1beta1ListInsightTypesResponse>;
...
export const GetConfigProjectsLocationsRecommendersRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/recommenders/{recommendersId}/config" }),
  svc,
) as unknown as Schema.Schema<GetConfigProjectsLocationsRecommendersRequest>;

export type GetConfigProjectsLocationsRecommendersResponse = GoogleCloudRecommenderV1beta1RecommenderConfig;
export const GetConfigProjectsLocationsRecommendersResponse = GoogleCloudRecommenderV1beta1RecommenderConfig;
...
export const UpdateConfigProjectsLocationsRecommendersRequest = Schema.Struct({
  ...
  body: Schema.optional(GoogleCloudRecommenderV1beta1RecommenderConfig).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/recommenders/{recommendersId}/config", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateConfigProjectsLocationsRecommendersRequest>;

export type UpdateConfigProjectsLocationsRecommendersResponse = GoogleCloudRecommenderV1beta1RecommenderConfig;
export const UpdateConfigProjectsLocationsRecommendersResponse = GoogleCloudRecommenderV1beta1RecommenderConfig;
...
export const ListProjectsLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsRecommendersRecommendationsRequest>;

export type ListProjectsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1ListRecommendationsResponse;
export const ListProjectsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1ListRecommendationsResponse;

export type ListProjectsLocationsRecommendersRecommendationsError = CommonErrors;

/** Lists recommendations for the specified Cloud Resource. Requires the recommender.*.list IAM permission for the specified recommender. */
export const listProjectsLocationsRecommendersRecommendations: API.PaginatedOperationMethod<ListProjectsLocationsRecommendersRecommendationsRequest, ListProjectsLocationsRecommendersRecommendationsResponse, ListProjectsLocationsRecommendersRecommendationsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsRecommendersRecommendationsRequest>;

export type GetProjectsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const GetProjectsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const MarkDismissedProjectsLocationsRecommendersRecommendationsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudRecommenderV1beta1MarkRecommendationDismissedRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}:markDismissed", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkDismissedProjectsLocationsRecommendersRecommendationsRequest>;

export type MarkDismissedProjectsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const MarkDismissedProjectsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const MarkClaimedProjectsLocationsRecommendersRecommendationsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudRecommenderV1beta1MarkRecommendationClaimedRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}:markClaimed", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkClaimedProjectsLocationsRecommendersRecommendationsRequest>;

export type MarkClaimedProjectsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const MarkClaimedProjectsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const MarkSucceededProjectsLocationsRecommendersRecommendationsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudRecommenderV1beta1MarkRecommendationSucceededRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}:markSucceeded", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkSucceededProjectsLocationsRecommendersRecommendationsRequest>;

export type MarkSucceededProjectsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const MarkSucceededProjectsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const MarkFailedProjectsLocationsRecommendersRecommendationsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudRecommenderV1beta1MarkRecommendationFailedRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}:markFailed", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkFailedProjectsLocationsRecommendersRecommendationsRequest>;

export type MarkFailedProjectsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const MarkFailedProjectsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const GetConfigProjectsLocationsInsightTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/insightTypes/{insightTypesId}/config" }),
  svc,
) as unknown as Schema.Schema<GetConfigProjectsLocationsInsightTypesRequest>;

export type GetConfigProjectsLocationsInsightTypesResponse = GoogleCloudRecommenderV1beta1InsightTypeConfig;
export const GetConfigProjectsLocationsInsightTypesResponse = GoogleCloudRecommenderV1beta1InsightTypeConfig;
...
export const UpdateConfigProjectsLocationsInsightTypesRequest = Schema.Struct({
  ...
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  validateOnly: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("validateOnly")),
  body: Schema.optional(GoogleCloudRecommenderV1beta1InsightTypeConfig).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "PATCH", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/insightTypes/{insightTypesId}/config", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateConfigProjectsLocationsInsightTypesRequest>;

export type UpdateConfigProjectsLocationsInsightTypesResponse = GoogleCloudRecommenderV1beta1InsightTypeConfig;
export const UpdateConfigProjectsLocationsInsightTypesResponse = GoogleCloudRecommenderV1beta1InsightTypeConfig;
...
export const ListProjectsLocationsInsightTypesInsightsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/insightTypes/{insightTypesId}/insights" }),
  svc,
) as unknown as Schema.Schema<ListProjectsLocationsInsightTypesInsightsRequest>;

export type ListProjectsLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1ListInsightsResponse;
export const ListProjectsLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1ListInsightsResponse;

export type ListProjectsLocationsInsightTypesInsightsError = CommonErrors;

/** Lists insights for the specified Cloud Resource. Requires the recommender.*.list IAM permission for the specified insight type. */
export const listProjectsLocationsInsightTypesInsights: API.PaginatedOperationMethod<ListProjectsLocationsInsightTypesInsightsRequest, ListProjectsLocationsInsightTypesInsightsResponse, ListProjectsLocationsInsightTypesInsightsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsLocationsInsightTypesInsightsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/insightTypes/{insightTypesId}/insights/{insightsId}" }),
  svc,
) as unknown as Schema.Schema<GetProjectsLocationsInsightTypesInsightsRequest>;

export type GetProjectsLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1Insight;
export const GetProjectsLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1Insight;
...
export const MarkAcceptedProjectsLocationsInsightTypesInsightsRequest = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta1/projects/{projectsId}/locations/{locationsId}/insightTypes/{insightTypesId}/insights/{insightsId}:markAccepted", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkAcceptedProjectsLocationsInsightTypesInsightsRequest>;

export type MarkAcceptedProjectsLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1Insight;
export const MarkAcceptedProjectsLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1Insight;
...
export const ListBillingAccountsLocationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/billingAccounts/{billingAccountsId}/locations" }),
  svc,
) as unknown as Schema.Schema<ListBillingAccountsLocationsRequest>;

export type ListBillingAccountsLocationsResponse = GoogleCloudLocationListLocationsResponse;
export const ListBillingAccountsLocationsResponse = GoogleCloudLocationListLocationsResponse;
...
export const GetConfigBillingAccountsLocationsRecommendersRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/billingAccounts/{billingAccountsId}/locations/{locationsId}/recommenders/{recommendersId}/config" }),
  svc,
) as unknown as Schema.Schema<GetConfigBillingAccountsLocationsRecommendersRequest>;

export type GetConfigBillingAccountsLocationsRecommendersResponse = GoogleCloudRecommenderV1beta1RecommenderConfig;
export const GetConfigBillingAccountsLocationsRecommendersResponse = GoogleCloudRecommenderV1beta1RecommenderConfig;
...
export const UpdateConfigBillingAccountsLocationsRecommendersRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1beta1/billingAccounts/{billingAccountsId}/locations/{locationsId}/recommenders/{recommendersId}/config", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateConfigBillingAccountsLocationsRecommendersRequest>;

export type UpdateConfigBillingAccountsLocationsRecommendersResponse = GoogleCloudRecommenderV1beta1RecommenderConfig;
export const UpdateConfigBillingAccountsLocationsRecommendersResponse = GoogleCloudRecommenderV1beta1RecommenderConfig;
...
export const ListBillingAccountsLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/billingAccounts/{billingAccountsId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations" }),
  svc,
) as unknown as Schema.Schema<ListBillingAccountsLocationsRecommendersRecommendationsRequest>;

export type ListBillingAccountsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1ListRecommendationsResponse;
export const ListBillingAccountsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1ListRecommendationsResponse;

export type ListBillingAccountsLocationsRecommendersRecommendationsError = CommonErrors;

/** Lists recommendations for the specified Cloud Resource. Requires the recommender.*.list IAM permission for the specified recommender. */
export const listBillingAccountsLocationsRecommendersRecommendations: API.PaginatedOperationMethod<ListBillingAccountsLocationsRecommendersRecommendationsRequest, ListBillingAccountsLocationsRecommendersRecommendationsResponse, ListBillingAccountsLocationsRecommendersRecommendationsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetBillingAccountsLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/billingAccounts/{billingAccountsId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}" }),
  svc,
) as unknown as Schema.Schema<GetBillingAccountsLocationsRecommendersRecommendationsRequest>;

export type GetBillingAccountsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const GetBillingAccountsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const MarkDismissedBillingAccountsLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/billingAccounts/{billingAccountsId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}:markDismissed", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkDismissedBillingAccountsLocationsRecommendersRecommendationsRequest>;

export type MarkDismissedBillingAccountsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const MarkDismissedBillingAccountsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const MarkClaimedBillingAccountsLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/billingAccounts/{billingAccountsId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}:markClaimed", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkClaimedBillingAccountsLocationsRecommendersRecommendationsRequest>;

export type MarkClaimedBillingAccountsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const MarkClaimedBillingAccountsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const MarkSucceededBillingAccountsLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/billingAccounts/{billingAccountsId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}:markSucceeded", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkSucceededBillingAccountsLocationsRecommendersRecommendationsRequest>;

export type MarkSucceededBillingAccountsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const MarkSucceededBillingAccountsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const MarkFailedBillingAccountsLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/billingAccounts/{billingAccountsId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}:markFailed", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkFailedBillingAccountsLocationsRecommendersRecommendationsRequest>;

export type MarkFailedBillingAccountsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const MarkFailedBillingAccountsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const GetConfigBillingAccountsLocationsInsightTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/billingAccounts/{billingAccountsId}/locations/{locationsId}/insightTypes/{insightTypesId}/config" }),
  svc,
) as unknown as Schema.Schema<GetConfigBillingAccountsLocationsInsightTypesRequest>;

export type GetConfigBillingAccountsLocationsInsightTypesResponse = GoogleCloudRecommenderV1beta1InsightTypeConfig;
export const GetConfigBillingAccountsLocationsInsightTypesResponse = GoogleCloudRecommenderV1beta1InsightTypeConfig;
...
export const UpdateConfigBillingAccountsLocationsInsightTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1beta1/billingAccounts/{billingAccountsId}/locations/{locationsId}/insightTypes/{insightTypesId}/config", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateConfigBillingAccountsLocationsInsightTypesRequest>;

export type UpdateConfigBillingAccountsLocationsInsightTypesResponse = GoogleCloudRecommenderV1beta1InsightTypeConfig;
export const UpdateConfigBillingAccountsLocationsInsightTypesResponse = GoogleCloudRecommenderV1beta1InsightTypeConfig;
...
export const ListBillingAccountsLocationsInsightTypesInsightsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/billingAccounts/{billingAccountsId}/locations/{locationsId}/insightTypes/{insightTypesId}/insights" }),
  svc,
) as unknown as Schema.Schema<ListBillingAccountsLocationsInsightTypesInsightsRequest>;

export type ListBillingAccountsLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1ListInsightsResponse;
export const ListBillingAccountsLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1ListInsightsResponse;
...
export const GetBillingAccountsLocationsInsightTypesInsightsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/billingAccounts/{billingAccountsId}/locations/{locationsId}/insightTypes/{insightTypesId}/insights/{insightsId}" }),
  svc,
) as unknown as Schema.Schema<GetBillingAccountsLocationsInsightTypesInsightsRequest>;

export type GetBillingAccountsLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1Insight;
export const GetBillingAccountsLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1Insight;
...
export const MarkAcceptedBillingAccountsLocationsInsightTypesInsightsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/billingAccounts/{billingAccountsId}/locations/{locationsId}/insightTypes/{insightTypesId}/insights/{insightsId}:markAccepted", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkAcceptedBillingAccountsLocationsInsightTypesInsightsRequest>;

export type MarkAcceptedBillingAccountsLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1Insight;
export const MarkAcceptedBillingAccountsLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1Insight;
...
export type ListFoldersLocationsResponse = GoogleCloudLocationListLocationsResponse;
export const ListFoldersLocationsResponse = GoogleCloudLocationListLocationsResponse;
...
export const ListFoldersLocationsInsightTypesInsightsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/folders/{foldersId}/locations/{locationsId}/insightTypes/{insightTypesId}/insights" }),
  svc,
) as unknown as Schema.Schema<ListFoldersLocationsInsightTypesInsightsRequest>;

export type ListFoldersLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1ListInsightsResponse;
export const ListFoldersLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1ListInsightsResponse;

export type ListFoldersLocationsInsightTypesInsightsError = CommonErrors;

/** Lists insights for the specified Cloud Resource. Requires the recommender.*.list IAM permission for the specified insight type. */
export const listFoldersLocationsInsightTypesInsights: API.PaginatedOperationMethod<ListFoldersLocationsInsightTypesInsightsRequest, ListFoldersLocationsInsightTypesInsightsResponse, ListFoldersLocationsInsightTypesInsightsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetFoldersLocationsInsightTypesInsightsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/folders/{foldersId}/locations/{locationsId}/insightTypes/{insightTypesId}/insights/{insightsId}" }),
  svc,
) as unknown as Schema.Schema<GetFoldersLocationsInsightTypesInsightsRequest>;

export type GetFoldersLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1Insight;
export const GetFoldersLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1Insight;
...
export const MarkAcceptedFoldersLocationsInsightTypesInsightsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/folders/{foldersId}/locations/{locationsId}/insightTypes/{insightTypesId}/insights/{insightsId}:markAccepted", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkAcceptedFoldersLocationsInsightTypesInsightsRequest>;

export type MarkAcceptedFoldersLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1Insight;
export const MarkAcceptedFoldersLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1Insight;
...
export const ListFoldersLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/folders/{foldersId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations" }),
  svc,
) as unknown as Schema.Schema<ListFoldersLocationsRecommendersRecommendationsRequest>;

export type ListFoldersLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1ListRecommendationsResponse;
export const ListFoldersLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1ListRecommendationsResponse;

export type ListFoldersLocationsRecommendersRecommendationsError = CommonErrors;

/** Lists recommendations for the specified Cloud Resource. Requires the recommender.*.list IAM permission for the specified recommender. */
export const listFoldersLocationsRecommendersRecommendations: API.PaginatedOperationMethod<ListFoldersLocationsRecommendersRecommendationsRequest, ListFoldersLocationsRecommendersRecommendationsResponse, ListFoldersLocationsRecommendersRecommendationsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetFoldersLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/folders/{foldersId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}" }),
  svc,
) as unknown as Schema.Schema<GetFoldersLocationsRecommendersRecommendationsRequest>;

export type GetFoldersLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const GetFoldersLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const MarkDismissedFoldersLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/folders/{foldersId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}:markDismissed", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkDismissedFoldersLocationsRecommendersRecommendationsRequest>;

export type MarkDismissedFoldersLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const MarkDismissedFoldersLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const MarkClaimedFoldersLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/folders/{foldersId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}:markClaimed", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkClaimedFoldersLocationsRecommendersRecommendationsRequest>;

export type MarkClaimedFoldersLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const MarkClaimedFoldersLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const MarkSucceededFoldersLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/folders/{foldersId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}:markSucceeded", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkSucceededFoldersLocationsRecommendersRecommendationsRequest>;

export type MarkSucceededFoldersLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const MarkSucceededFoldersLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const MarkFailedFoldersLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/folders/{foldersId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}:markFailed", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkFailedFoldersLocationsRecommendersRecommendationsRequest>;

export type MarkFailedFoldersLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const MarkFailedFoldersLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const ListOrganizationsLocationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/organizations/{organizationsId}/locations" }),
  svc,
) as unknown as Schema.Schema<ListOrganizationsLocationsRequest>;

export type ListOrganizationsLocationsResponse = GoogleCloudLocationListLocationsResponse;
export const ListOrganizationsLocationsResponse = GoogleCloudLocationListLocationsResponse;
...
export const GetConfigOrganizationsLocationsRecommendersRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/organizations/{organizationsId}/locations/{locationsId}/recommenders/{recommendersId}/config" }),
  svc,
) as unknown as Schema.Schema<GetConfigOrganizationsLocationsRecommendersRequest>;

export type GetConfigOrganizationsLocationsRecommendersResponse = GoogleCloudRecommenderV1beta1RecommenderConfig;
export const GetConfigOrganizationsLocationsRecommendersResponse = GoogleCloudRecommenderV1beta1RecommenderConfig;
...
export const UpdateConfigOrganizationsLocationsRecommendersRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1beta1/organizations/{organizationsId}/locations/{locationsId}/recommenders/{recommendersId}/config", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateConfigOrganizationsLocationsRecommendersRequest>;

export type UpdateConfigOrganizationsLocationsRecommendersResponse = GoogleCloudRecommenderV1beta1RecommenderConfig;
export const UpdateConfigOrganizationsLocationsRecommendersResponse = GoogleCloudRecommenderV1beta1RecommenderConfig;
...
export const ListOrganizationsLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/organizations/{organizationsId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations" }),
  svc,
) as unknown as Schema.Schema<ListOrganizationsLocationsRecommendersRecommendationsRequest>;

export type ListOrganizationsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1ListRecommendationsResponse;
export const ListOrganizationsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1ListRecommendationsResponse;
...
export const GetOrganizationsLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/organizations/{organizationsId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}" }),
  svc,
) as unknown as Schema.Schema<GetOrganizationsLocationsRecommendersRecommendationsRequest>;

export type GetOrganizationsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const GetOrganizationsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const MarkDismissedOrganizationsLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/organizations/{organizationsId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}:markDismissed", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkDismissedOrganizationsLocationsRecommendersRecommendationsRequest>;

export type MarkDismissedOrganizationsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const MarkDismissedOrganizationsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const MarkClaimedOrganizationsLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/organizations/{organizationsId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}:markClaimed", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkClaimedOrganizationsLocationsRecommendersRecommendationsRequest>;

export type MarkClaimedOrganizationsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const MarkClaimedOrganizationsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const MarkSucceededOrganizationsLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/organizations/{organizationsId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}:markSucceeded", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkSucceededOrganizationsLocationsRecommendersRecommendationsRequest>;

export type MarkSucceededOrganizationsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const MarkSucceededOrganizationsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const MarkFailedOrganizationsLocationsRecommendersRecommendationsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/organizations/{organizationsId}/locations/{locationsId}/recommenders/{recommendersId}/recommendations/{recommendationsId}:markFailed", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkFailedOrganizationsLocationsRecommendersRecommendationsRequest>;

export type MarkFailedOrganizationsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
export const MarkFailedOrganizationsLocationsRecommendersRecommendationsResponse = GoogleCloudRecommenderV1beta1Recommendation;
...
export const GetConfigOrganizationsLocationsInsightTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/organizations/{organizationsId}/locations/{locationsId}/insightTypes/{insightTypesId}/config" }),
  svc,
) as unknown as Schema.Schema<GetConfigOrganizationsLocationsInsightTypesRequest>;

export type GetConfigOrganizationsLocationsInsightTypesResponse = GoogleCloudRecommenderV1beta1InsightTypeConfig;
export const GetConfigOrganizationsLocationsInsightTypesResponse = GoogleCloudRecommenderV1beta1InsightTypeConfig;
...
export const UpdateConfigOrganizationsLocationsInsightTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1beta1/organizations/{organizationsId}/locations/{locationsId}/insightTypes/{insightTypesId}/config", hasBody: true }),
  svc,
) as unknown as Schema.Schema<UpdateConfigOrganizationsLocationsInsightTypesRequest>;

export type UpdateConfigOrganizationsLocationsInsightTypesResponse = GoogleCloudRecommenderV1beta1InsightTypeConfig;
export const UpdateConfigOrganizationsLocationsInsightTypesResponse = GoogleCloudRecommenderV1beta1InsightTypeConfig;
...
export const ListOrganizationsLocationsInsightTypesInsightsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/organizations/{organizationsId}/locations/{locationsId}/insightTypes/{insightTypesId}/insights" }),
  svc,
) as unknown as Schema.Schema<ListOrganizationsLocationsInsightTypesInsightsRequest>;

export type ListOrganizationsLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1ListInsightsResponse;
export const ListOrganizationsLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1ListInsightsResponse;

export type ListOrganizationsLocationsInsightTypesInsightsError = CommonErrors;

/** Lists insights for the specified Cloud Resource. Requires the recommender.*.list IAM permission for the specified insight type. */
export const listOrganizationsLocationsInsightTypesInsights: API.PaginatedOperationMethod<ListOrganizationsLocationsInsightTypesInsightsRequest, ListOrganizationsLocationsInsightTypesInsightsResponse, ListOrganizationsLocationsInsightTypesInsightsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetOrganizationsLocationsInsightTypesInsightsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1beta1/organizations/{organizationsId}/locations/{locationsId}/insightTypes/{insightTypesId}/insights/{insightsId}" }),
  svc,
) as unknown as Schema.Schema<GetOrganizationsLocationsInsightTypesInsightsRequest>;

export type GetOrganizationsLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1Insight;
export const GetOrganizationsLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1Insight;
...
export const MarkAcceptedOrganizationsLocationsInsightTypesInsightsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/organizations/{organizationsId}/locations/{locationsId}/insightTypes/{insightTypesId}/insights/{insightsId}:markAccepted", hasBody: true }),
  svc,
) as unknown as Schema.Schema<MarkAcceptedOrganizationsLocationsInsightTypesInsightsRequest>;

export type MarkAcceptedOrganizationsLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1Insight;
export const MarkAcceptedOrganizationsLocationsInsightTypesInsightsResponse = GoogleCloudRecommenderV1beta1Insight;
...
export type ListRecommendersResponse = GoogleCloudRecommenderV1beta1ListRecommendersResponse;
export const ListRecommendersResponse = GoogleCloudRecommenderV1beta1ListRecommendersResponse;

export type ListRecommendersError = CommonErrors;

/** Lists all available Recommenders. No IAM permissions are required. */
export const listRecommenders: API.PaginatedOperationMethod<ListRecommendersRequest, ListRecommendersResponse, ListRecommendersError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export type ListInsightTypesResponse = GoogleCloudRecommenderV1beta1ListInsightTypesResponse;
export const ListInsightTypesResponse = GoogleCloudRecommenderV1beta1ListInsightTypesResponse;

export type ListInsightTypesError = CommonErrors;

/** Lists available InsightTypes. No IAM permissions are required. */
export const listInsightTypes: API.PaginatedOperationMethod<ListInsightTypesRequest, ListInsightTypesResponse, ListInsightTypesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
