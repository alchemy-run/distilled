...
export type RenameProjectsLocationsDataPoliciesError = CommonErrors;

/** Renames the id (display name) of the specified data policy. */
export const renameProjectsLocationsDataPolicies: API.OperationMethod<RenameProjectsLocationsDataPoliciesRequest, RenameProjectsLocationsDataPoliciesResponse, RenameProjectsLocationsDataPoliciesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
