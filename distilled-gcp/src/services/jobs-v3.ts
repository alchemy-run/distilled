...
export interface CommuteFilter {
  ...
  commuteMethod?: "COMMUTE_METHOD_UNSPECIFIED" | "DRIVING" | "TRANSIT" | (string & {});
}
...
export const PatchProjectsCompaniesRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v3/projects/{projectsId}/companies/{companiesId}", hasBody: true }),
  svc,
...
export const GetProjectsCompaniesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v3/projects/{projectsId}/companies/{companiesId}" }),
  svc,
...
export const CreateProjectsCompaniesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v3/projects/{projectsId}/companies", hasBody: true }),
  svc,
...
export const DeleteProjectsCompaniesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v3/projects/{projectsId}/companies/{companiesId}" }),
  svc,
...
export const CreateProjectsClientEventsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v3/projects/{projectsId}/clientEvents", hasBody: true }),
  svc,
...
export const BatchDeleteProjectsJobsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v3/projects/{projectsId}/jobs:batchDelete", hasBody: true }),
  svc,
...
export const DeleteProjectsJobsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v3/projects/{projectsId}/jobs/{jobsId}" }),
  svc,
...
export const CreateProjectsJobsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v3/projects/{projectsId}/jobs", hasBody: true }),
  svc,
...
export const PatchProjectsJobsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v3/projects/{projectsId}/jobs/{jobsId}", hasBody: true }),
  svc,
...
export const SearchProjectsJobsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v3/projects/{projectsId}/jobs:search", hasBody: true }),
  svc,
...
export const SearchForAlertProjectsJobsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v3/projects/{projectsId}/jobs:searchForAlert", hasBody: true }),
  svc,
