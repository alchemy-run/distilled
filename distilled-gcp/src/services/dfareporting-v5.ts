...
export interface Report {
  ...
  reachCriteria?: { dimensionFilters?: Array<DimensionValue>; customRichMediaEvents?: CustomRichMediaEvents; dimensions?: Array<SortedDimension>; metricNames?: Array<string>; activities?: Activities; reachByFrequencyMetricNames?: Array<string>; dateRange?: DateRange };
  /** The user profile id of the owner of this report. */
  ownerProfileId?: string;
  /** Optional. The report criteria for a report of type "CROSS_MEDIA_REACH". */
  crossMediaReachCriteria?: { dateRange?: DateRange; dimensionFilters?: Array<DimensionValue>; dimensions?: Array<SortedDimension>; metricNames?: Array<string> };
  /** The subaccount ID to which this report belongs if applicable. */
  subAccountId?: string;
  /** The report criteria for a report of type "PATH_TO_CONVERSION". */
  pathToConversionCriteria?: { conversionDimensions?: Array<SortedDimension>; reportProperties?: { includeAttributedIPConversions?: boolean; includeUnattributedIPConversions?: boolean; clicksLookbackWindow?: number; maximumClickInteractions?: number; pivotOnInteractionPath?: boolean; impressionsLookbackWindow?: number; includeUnattributedCookieConversions?: boolean; maximumInteractionGap?: number; maximumImpressionInteractions?: number }; customRichMediaEvents?: Array<DimensionValue>; metricNames?: Array<string>; customFloodlightVariables?: Array<SortedDimension>; activityFilters?: Array<DimensionValue>; perInteractionDimensions?: Array<SortedDimension>; dateRange?: DateRange; floodlightConfigId?: DimensionValue };
  /** The unique ID identifying this report resource. */
  id?: string;
  /** The type of the report. */
  type?: "STANDARD" | "REACH" | "PATH_TO_CONVERSION" | "FLOODLIGHT" | "CROSS_MEDIA_REACH" | (string & {});
  /** The report's schedule. Can only be set if the report's 'dateRange' is a relative date range and the relative date range is not "TODAY". */
  schedule?: { every?: number; active?: boolean; repeatsOnWeekDays?: Array<"SUNDAY" | "MONDAY" | "TUESDAY" | "WEDNESDAY" | "THURSDAY" | "FRIDAY" | "SATURDAY" | (string & {})>; startDate?: string; expirationDate?: string; timezone?: string; runsOnDayOfMonth?: "DAY_OF_MONTH" | "WEEK_OF_MONTH" | (string & {}); repeats?: string };
  /** The eTag of this response for caching purposes. */
  etag?: string;
  /** The timestamp (in milliseconds since epoch) of when this report was last modified. */
  lastModifiedTime?: string;
  /** The report criteria for a report of type "FLOODLIGHT". */
  floodlightCriteria?: { reportProperties?: { includeAttributedIPConversions?: boolean; includeUnattributedIPConversions?: boolean; includeUnattributedCookieConversions?: boolean }; dateRange?: DateRange; floodlightConfigId?: DimensionValue; dimensionFilters?: Array<DimensionValue>; customRichMediaEvents?: Array<DimensionValue>; dimensions?: Array<SortedDimension>; metricNames?: Array<string> };
  /** The report criteria for a report of type "STANDARD". */
  criteria?: { dateRange?: DateRange; dimensionFilters?: Array<DimensionValue>; customRichMediaEvents?: CustomRichMediaEvents; dimensions?: Array<SortedDimension>; metricNames?: Array<string>; activities?: Activities };
  /** The report's email delivery settings. */
  delivery?: { emailOwnerDeliveryType?: "LINK" | "ATTACHMENT" | (string & {}); message?: string; emailOwner?: boolean; recipients?: Array<Recipient> };
...
export const Report: Schema.Schema<Report> = Schema.suspend(() => Schema.Struct({
  ...
  kind: Schema.optional(Schema.String),
  reachCriteria: Schema.optional(Schema.Struct({ dimensionFilters: Schema.optional(Schema.Array(DimensionValue)), customRichMediaEvents: Schema.optional(CustomRichMediaEvents), dimensions: Schema.optional(Schema.Array(SortedDimension)), metricNames: Schema.optional(Schema.Array(Schema.String)), activities: Schema.optional(Activities), reachByFrequencyMetricNames: Schema.optional(Schema.Array(Schema.String)), dateRange: Schema.optional(DateRange) })),
  ownerProfileId: Schema.optional(Schema.String),
  crossMediaReachCriteria: Schema.optional(Schema.Struct({ dateRange: Schema.optional(DateRange), dimensionFilters: Schema.optional(Schema.Array(DimensionValue)), dimensions: Schema.optional(Schema.Array(SortedDimension)), metricNames: Schema.optional(Schema.Array(Schema.String)) })),
  subAccountId: Schema.optional(Schema.String),
  pathToConversionCriteria: Schema.optional(Schema.Struct({ conversionDimensions: Schema.optional(Schema.Array(SortedDimension)), reportProperties: Schema.optional(Schema.Struct({ includeAttributedIPConversions: Schema.optional(Schema.Boolean), includeUnattributedIPConversions: Schema.optional(Schema.Boolean), clicksLookbackWindow: Schema.optional(Schema.Number), maximumClickInteractions: Schema.optional(Schema.Number), pivotOnInteractionPath: Schema.optional(Schema.Boolean), impressionsLookbackWindow: Schema.optional(Schema.Number), includeUnattributedCookieConversions: Schema.optional(Schema.Boolean), maximumInteractionGap: Schema.optional(Schema.Number), maximumImpressionInteractions: Schema.optional(Schema.Number) })), customRichMediaEvents: Schema.optional(Schema.Array(DimensionValue)), metricNames: Schema.optional(Schema.Array(Schema.String)), customFloodlightVariables: Schema.optional(Schema.Array(SortedDimension)), activityFilters: Schema.optional(Schema.Array(DimensionValue)), perInteractionDimensions: Schema.optional(Schema.Array(SortedDimension)), dateRange: Schema.optional(DateRange), floodlightConfigId: Schema.optional(DimensionValue) })),
  id: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  schedule: Schema.optional(Schema.Struct({ every: Schema.optional(Schema.Number), active: Schema.optional(Schema.Boolean), repeatsOnWeekDays: Schema.optional(Schema.Array(Schema.String)), startDate: Schema.optional(Schema.String), expirationDate: Schema.optional(Schema.String), timezone: Schema.optional(Schema.String), runsOnDayOfMonth: Schema.optional(Schema.String), repeats: Schema.optional(Schema.String) })),
  etag: Schema.optional(Schema.String),
  lastModifiedTime: Schema.optional(Schema.String),
  floodlightCriteria: Schema.optional(Schema.Struct({ reportProperties: Schema.optional(Schema.Struct({ includeAttributedIPConversions: Schema.optional(Schema.Boolean), includeUnattributedIPConversions: Schema.optional(Schema.Boolean), includeUnattributedCookieConversions: Schema.optional(Schema.Boolean) })), dateRange: Schema.optional(DateRange), floodlightConfigId: Schema.optional(DimensionValue), dimensionFilters: Schema.optional(Schema.Array(DimensionValue)), customRichMediaEvents: Schema.optional(Schema.Array(DimensionValue)), dimensions: Schema.optional(Schema.Array(SortedDimension)), metricNames: Schema.optional(Schema.Array(Schema.String)) })),
  criteria: Schema.optional(Schema.Struct({ dateRange: Schema.optional(DateRange), dimensionFilters: Schema.optional(Schema.Array(DimensionValue)), customRichMediaEvents: Schema.optional(CustomRichMediaEvents), dimensions: Schema.optional(Schema.Array(SortedDimension)), metricNames: Schema.optional(Schema.Array(Schema.String)), activities: Schema.optional(Activities) })),
  delivery: Schema.optional(Schema.Struct({ emailOwnerDeliveryType: Schema.optional(Schema.String), message: Schema.optional(Schema.String), emailOwner: Schema.optional(Schema.Boolean), recipients: Schema.optional(Schema.Array(Recipient)) })),
  name: Schema.optional(Schema.String),
  accountId: Schema.optional(Schema.String),
  fileName: Schema.optional(Schema.String),
