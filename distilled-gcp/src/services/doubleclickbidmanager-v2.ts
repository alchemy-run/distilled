...
export const listQueries: API.PaginatedOperationMethod<ListQueriesRequest, ListQueriesResponse_Op, ListQueriesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const listQueriesReports: API.PaginatedOperationMethod<ListQueriesReportsRequest, ListQueriesReportsResponse, ListQueriesReportsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
