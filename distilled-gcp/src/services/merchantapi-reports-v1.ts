...
export const SearchAccountsReportsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "reports/v1/accounts/{accountsId}/reports:search", hasBody: true }),
  svc,
...
export type SearchAccountsReportsError = CommonErrors;
...
export const searchAccountsReports: API.OperationMethod<SearchAccountsReportsRequest, SearchAccountsReportsResponse, SearchAccountsReportsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
