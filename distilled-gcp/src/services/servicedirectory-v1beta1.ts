...
export type GetIamPolicyProjectsLocationsNamespacesWorkloadsError = CommonErrors;

/** Gets the IAM Policy for a resource */
export const getIamPolicyProjectsLocationsNamespacesWorkloads: API.OperationMethod<GetIamPolicyProjectsLocationsNamespacesWorkloadsRequest, GetIamPolicyProjectsLocationsNamespacesWorkloadsResponse, GetIamPolicyProjectsLocationsNamespacesWorkloadsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type SetIamPolicyProjectsLocationsNamespacesWorkloadsError = CommonErrors;

/** Sets the IAM Policy for a resource */
export const setIamPolicyProjectsLocationsNamespacesWorkloads: API.OperationMethod<SetIamPolicyProjectsLocationsNamespacesWorkloadsRequest, SetIamPolicyProjectsLocationsNamespacesWorkloadsResponse, SetIamPolicyProjectsLocationsNamespacesWorkloadsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type TestIamPermissionsProjectsLocationsNamespacesWorkloadsError = CommonErrors;

/** Tests IAM permissions for a resource (namespace, service or service workload only). */
export const testIamPermissionsProjectsLocationsNamespacesWorkloads: API.OperationMethod<TestIamPermissionsProjectsLocationsNamespacesWorkloadsRequest, TestIamPermissionsProjectsLocationsNamespacesWorkloadsResponse, TestIamPermissionsProjectsLocationsNamespacesWorkloadsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
