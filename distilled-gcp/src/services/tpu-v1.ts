...
export const ListProjectsLocationsNodesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1/projects/{projectsId}/locations/{locationsId}/nodes" }),
  svc,
...
export const GetProjectsLocationsNodesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1/projects/{projectsId}/locations/{locationsId}/nodes/{nodesId}" }),
  svc,
...
export const CreateProjectsLocationsNodesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1/projects/{projectsId}/locations/{locationsId}/nodes", hasBody: true }),
  svc,
...
export const DeleteProjectsLocationsNodesRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1/projects/{projectsId}/locations/{locationsId}/nodes/{nodesId}" }),
  svc,
...
export const ReimageProjectsLocationsNodesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1/projects/{projectsId}/locations/{locationsId}/nodes/{nodesId}:reimage", hasBody: true }),
  svc,
...
export const StopProjectsLocationsNodesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1/projects/{projectsId}/locations/{locationsId}/nodes/{nodesId}:stop", hasBody: true }),
  svc,
...
export const StartProjectsLocationsNodesRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1/projects/{projectsId}/locations/{locationsId}/nodes/{nodesId}:start", hasBody: true }),
  svc,
...
export const ListProjectsLocationsTensorflowVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1/projects/{projectsId}/locations/{locationsId}/tensorflowVersions" }),
  svc,
...
export const GetProjectsLocationsTensorflowVersionsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1/projects/{projectsId}/locations/{locationsId}/tensorflowVersions/{tensorflowVersionsId}" }),
  svc,
...
export const ListProjectsLocationsAcceleratorTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1/projects/{projectsId}/locations/{locationsId}/acceleratorTypes" }),
  svc,
...
export const GetProjectsLocationsAcceleratorTypesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1/projects/{projectsId}/locations/{locationsId}/acceleratorTypes/{acceleratorTypesId}" }),
  svc,
