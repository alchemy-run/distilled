...
export type PerformMaintenanceProjectsLocationsNodesError = CommonErrors;

/** Perform manual maintenance on a node. */
export const performMaintenanceProjectsLocationsNodes: API.OperationMethod<PerformMaintenanceProjectsLocationsNodesRequest, PerformMaintenanceProjectsLocationsNodesResponse, PerformMaintenanceProjectsLocationsNodesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type SimulateMaintenanceEventProjectsLocationsNodesError = CommonErrors;

/** Simulates a maintenance event. */
export const simulateMaintenanceEventProjectsLocationsNodes: API.OperationMethod<SimulateMaintenanceEventProjectsLocationsNodesRequest, SimulateMaintenanceEventProjectsLocationsNodesResponse, SimulateMaintenanceEventProjectsLocationsNodesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const listProjectsLocationsQueuedResources: API.PaginatedOperationMethod<ListProjectsLocationsQueuedResourcesRequest, ListProjectsLocationsQueuedResourcesResponse, ListProjectsLocationsQueuedResourcesError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export type PerformMaintenanceQueuedResourceProjectsLocationsQueuedResourcesError = CommonErrors;
...
export type GetMaintenanceInfoProjectsLocationsQueuedResourcesError = CommonErrors;

/** Gets the maintenance info for a queued resource. */
export const getMaintenanceInfoProjectsLocationsQueuedResources: API.OperationMethod<GetMaintenanceInfoProjectsLocationsQueuedResourcesRequest, GetMaintenanceInfoProjectsLocationsQueuedResourcesResponse, GetMaintenanceInfoProjectsLocationsQueuedResourcesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const listProjectsLocationsRuntimeVersions: API.PaginatedOperationMethod<ListProjectsLocationsRuntimeVersionsRequest, ListProjectsLocationsRuntimeVersionsResponse, ListProjectsLocationsRuntimeVersionsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
