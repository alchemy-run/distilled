...
export interface EventWorkingLocationProperties {
  ...
  officeLocation?: { floorId?: string; floorSectionId?: string; label?: string; deskId?: string; buildingId?: string };
...
export const EventWorkingLocationProperties: Schema.Schema<EventWorkingLocationProperties> = Schema.suspend(() => Schema.Struct({
  officeLocation: Schema.optional(Schema.Struct({ floorId: Schema.optional(Schema.String), floorSectionId: Schema.optional(Schema.String), label: Schema.optional(Schema.String), deskId: Schema.optional(Schema.String), buildingId: Schema.optional(Schema.String) })),
...
export interface Event {
  ...
  organizer?: { displayName?: string; id?: string; email?: string; self?: boolean };
  ...
  gadget?: { width?: number; height?: number; type?: string; link?: string; display?: string; preferences?: Record<string, string>; title?: string; iconLink?: string };
  ...
  creator?: { displayName?: string; id?: string; email?: string; self?: boolean };
...
export const Event: Schema.Schema<Event> = Schema.suspend(() => Schema.Struct({
  ...
  organizer: Schema.optional(Schema.Struct({ displayName: Schema.optional(Schema.String), id: Schema.optional(Schema.String), email: Schema.optional(Schema.String), self: Schema.optional(Schema.Boolean) })),
  ...
  gadget: Schema.optional(Schema.Struct({ width: Schema.optional(Schema.Number), height: Schema.optional(Schema.Number), type: Schema.optional(Schema.String), link: Schema.optional(Schema.String), display: Schema.optional(Schema.String), preferences: Schema.optional(Schema.Record(Schema.String, Schema.String)), title: Schema.optional(Schema.String), iconLink: Schema.optional(Schema.String) })),
  iCalUID: Schema.optional(Schema.String),
  updated: Schema.optional(Schema.String),
  creator: Schema.optional(Schema.Struct({ displayName: Schema.optional(Schema.String), id: Schema.optional(Schema.String), email: Schema.optional(Schema.String), self: Schema.optional(Schema.Boolean) })),
