...
export interface PickTimeSeriesFilter {
  ...
  rankingMethod?: "METHOD_UNSPECIFIED" | "METHOD_MEAN" | "METHOD_MAX" | "METHOD_MIN" | "METHOD_SUM" | "METHOD_LATEST" | (string & {});
...
export const PickTimeSeriesFilter: Schema.Schema<PickTimeSeriesFilter> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "PickTimeSeriesFilter" }) as any as Schema.Schema<PickTimeSeriesFilter>;

export interface StatisticalTimeSeriesFilter {
  /** rankingMethod is applied to a set of time series, and then the produced value for each individual time series is used to compare a given time series to others. These are methods that cannot be applied stream-by-stream, but rather require the full context of a request to evaluate time series. */
  rankingMethod?: "METHOD_UNSPECIFIED" | "METHOD_CLUSTER_OUTLIER" | (string & {});
  /** How many time series to output. */
  numTimeSeries?: number;
}

export const StatisticalTimeSeriesFilter: Schema.Schema<StatisticalTimeSeriesFilter> = Schema.suspend(() => Schema.Struct({
  rankingMethod: Schema.optional(Schema.String),
  numTimeSeries: Schema.optional(Schema.Number),
})).annotate({ identifier: "StatisticalTimeSeriesFilter" }) as any as Schema.Schema<StatisticalTimeSeriesFilter>;
...
export const TimeSeriesFilter: Schema.Schema<TimeSeriesFilter> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "TimeSeriesFilter" }) as any as Schema.Schema<TimeSeriesFilter>;
...
export const RatioPart: Schema.Schema<RatioPart> = Schema.suspend(() => Schema.Struct({
  filter: Schema.optional(Schema.String),
  aggregation: Schema.optional(Aggregation),
...
export const TimeSeriesFilterRatio: Schema.Schema<TimeSeriesFilterRatio> = Schema.suspend(() => Schema.Struct({
  numerator: Schema.optional(RatioPart),
  denominator: Schema.optional(RatioPart),
  secondaryAggregation: Schema.optional(Aggregation),
  pickTimeSeriesFilter: Schema.optional(PickTimeSeriesFilter),
  statisticalTimeSeriesFilter: Schema.optional(StatisticalTimeSeriesFilter),
})).annotate({ identifier: "TimeSeriesFilterRatio" }) as any as Schema.Schema<TimeSeriesFilterRatio>;
...
export const TimeSeriesQuery: Schema.Schema<TimeSeriesQuery> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "TimeSeriesQuery" }) as any as Schema.Schema<TimeSeriesQuery>;
...
export interface Dimension {
  ...
  sortOrder?: "SORT_ORDER_UNSPECIFIED" | "SORT_ORDER_NONE" | "SORT_ORDER_ASCENDING" | "SORT_ORDER_DESCENDING" | (string & {});
...
export const AggregationFunction: Schema.Schema<AggregationFunction> = Schema.suspend(() => Schema.Struct({
  type: Schema.optional(Schema.String),
  parameters: Schema.optional(Schema.Array(Parameter)),
})).annotate({ identifier: "AggregationFunction" }) as any as Schema.Schema<AggregationFunction>;
...
export const Measure: Schema.Schema<Measure> = Schema.suspend(() => Schema.Struct({
  column: Schema.optional(Schema.String),
...
export interface ColumnSortingOptions {
  ...
  direction?: "SORT_ORDER_UNSPECIFIED" | "SORT_ORDER_NONE" | "SORT_ORDER_ASCENDING" | "SORT_ORDER_DESCENDING" | (string & {});
}

export const ColumnSortingOptions: Schema.Schema<ColumnSortingOptions> = Schema.suspend(() => Schema.Struct({
  column: Schema.optional(Schema.String),
  direction: Schema.optional(Schema.String),
})).annotate({ identifier: "ColumnSortingOptions" }) as any as Schema.Schema<ColumnSortingOptions>;

export interface DataSet {
  /** Required. Fields for querying time series data from the Stackdriver metrics API. */
  timeSeriesQuery?: TimeSeriesQuery;
  /** How this data should be plotted on the chart. */
  plotType?: "PLOT_TYPE_UNSPECIFIED" | "LINE" | "STACKED_AREA" | "STACKED_BAR" | "HEATMAP" | (string & {});
...
export const Threshold: Schema.Schema<Threshold> = Schema.suspend(() => Schema.Struct({
...
export const ChartOptions: Schema.Schema<ChartOptions> = Schema.suspend(() => Schema.Struct({
  mode: Schema.optional(Schema.String),
  displayHorizontal: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "ChartOptions" }) as any as Schema.Schema<ChartOptions>;
...
export const XyChart: Schema.Schema<XyChart> = Schema.suspend(() => Schema.Struct({
...
export const GaugeView: Schema.Schema<GaugeView> = Schema.suspend(() => Schema.Struct({
...
export interface SparkChartView {
  ...
  sparkChartType?: "SPARK_CHART_TYPE_UNSPECIFIED" | "SPARK_LINE" | "SPARK_BAR" | (string & {});
  /** The lower bound on data point frequency in the chart implemented by specifying the minimum alignment period to use in a time series query. For example, if the data is published once every 10 minutes it would not make sense to fetch and align data at one minute intervals. This field is optional and exists only as a hint. */
  minAlignmentPeriod?: string;
}

export const SparkChartView: Schema.Schema<SparkChartView> = Schema.suspend(() => Schema.Struct({
  sparkChartType: Schema.optional(Schema.String),
  minAlignmentPeriod: Schema.optional(Schema.String),
})).annotate({ identifier: "SparkChartView" }) as any as Schema.Schema<SparkChartView>;
...
export const Scorecard: Schema.Schema<Scorecard> = Schema.suspend(() => Schema.Struct({
  timeSeriesQuery: Schema.optional(TimeSeriesQuery),
...
export interface TextStyle {
  ...
  horizontalAlignment?: "HORIZONTAL_ALIGNMENT_UNSPECIFIED" | "H_LEFT" | "H_CENTER" | "H_RIGHT" | (string & {});
  /** The vertical alignment of both the title and content */
  verticalAlignment?: "VERTICAL_ALIGNMENT_UNSPECIFIED" | "V_TOP" | "V_CENTER" | "V_BOTTOM" | (string & {});
  /** The amount of padding around the widget */
  padding?: "PADDING_SIZE_UNSPECIFIED" | "P_EXTRA_SMALL" | "P_SMALL" | "P_MEDIUM" | "P_LARGE" | "P_EXTRA_LARGE" | (string & {});
  /** Font sizes for both the title and content. The title will still be larger relative to the content. */
  fontSize?: "FONT_SIZE_UNSPECIFIED" | "FS_EXTRA_SMALL" | "FS_SMALL" | "FS_MEDIUM" | "FS_LARGE" | "FS_EXTRA_LARGE" | (string & {});
  /** The pointer location for this widget (also sometimes called a "tail") */
  pointerLocation?: "POINTER_LOCATION_UNSPECIFIED" | "PL_TOP" | "PL_RIGHT" | "PL_BOTTOM" | "PL_LEFT" | "PL_TOP_LEFT" | "PL_TOP_RIGHT" | "PL_RIGHT_TOP" | "PL_RIGHT_BOTTOM" | "PL_BOTTOM_RIGHT" | "PL_BOTTOM_LEFT" | "PL_LEFT_BOTTOM" | "PL_LEFT_TOP" | (string & {});
}
...
export const AlertChart: Schema.Schema<AlertChart> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const TableDisplayOptions: Schema.Schema<TableDisplayOptions> = Schema.suspend(() => Schema.Struct({
  shownColumns: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "TableDisplayOptions" }) as any as Schema.Schema<TableDisplayOptions>;
...
export const TableDataSet: Schema.Schema<TableDataSet> = Schema.suspend(() => Schema.Struct({
  timeSeriesQuery: Schema.optional(TimeSeriesQuery),
  tableTemplate: Schema.optional(Schema.String),
  minAlignmentPeriod: Schema.optional(Schema.String),
  tableDisplayOptions: Schema.optional(TableDisplayOptions),
})).annotate({ identifier: "TableDataSet" }) as any as Schema.Schema<TableDataSet>;
...
export interface ColumnSettings {
  ...
  alignment?: "CELL_ALIGNMENT_UNSPECIFIED" | "LEFT" | "CENTER" | "RIGHT" | (string & {});
...
export const ColumnSettings: Schema.Schema<ColumnSettings> = Schema.suspend(() => Schema.Struct({
  column: Schema.optional(Schema.String),
  visible: Schema.optional(Schema.Boolean),
  alignment: Schema.optional(Schema.String),
  displayName: Schema.optional(Schema.String),
  thresholds: Schema.optional(Schema.Array(Threshold)),
})).annotate({ identifier: "ColumnSettings" }) as any as Schema.Schema<ColumnSettings>;

export interface TimeSeriesTable {
  /** Required. The data displayed in this table. */
  dataSets?: Array<TableDataSet>;
  /** Optional. Store rendering strategy */
  metricVisualization?: "METRIC_VISUALIZATION_UNSPECIFIED" | "NUMBER" | "BAR" | (string & {});
  /** Optional. The list of the persistent column settings for the table. */
  columnSettings?: Array<ColumnSettings>;
}

export const TimeSeriesTable: Schema.Schema<TimeSeriesTable> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "TimeSeriesTable" }) as any as Schema.Schema<TimeSeriesTable>;
...
export const CollapsibleGroup: Schema.Schema<CollapsibleGroup> = Schema.suspend(() => Schema.Struct({
  collapsed: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "CollapsibleGroup" }) as any as Schema.Schema<CollapsibleGroup>;
...
export const LogsPanel: Schema.Schema<LogsPanel> = Schema.suspend(() => Schema.Struct({
  filter: Schema.optional(Schema.String),
...
export const IncidentList: Schema.Schema<IncidentList> = Schema.suspend(() => Schema.Struct({
  monitoredResources: Schema.optional(Schema.Array(MonitoredResource)),
  policyNames: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "IncidentList" }) as any as Schema.Schema<IncidentList>;
...
export const PieChartDataSet: Schema.Schema<PieChartDataSet> = Schema.suspend(() => Schema.Struct({
  timeSeriesQuery: Schema.optional(TimeSeriesQuery),
  sliceNameTemplate: Schema.optional(Schema.String),
  minAlignmentPeriod: Schema.optional(Schema.String),
  dimensions: Schema.optional(Schema.Array(Dimension)),
  measures: Schema.optional(Schema.Array(Measure)),
})).annotate({ identifier: "PieChartDataSet" }) as any as Schema.Schema<PieChartDataSet>;
...
export const PieChart: Schema.Schema<PieChart> = Schema.suspend(() => Schema.Struct({
...
export const TreemapDataSet: Schema.Schema<TreemapDataSet> = Schema.suspend(() => Schema.Struct({
  timeSeriesQuery: Schema.optional(TimeSeriesQuery),
  measures: Schema.optional(Schema.Array(Measure)),
  breakdowns: Schema.optional(Schema.Array(Breakdown)),
})).annotate({ identifier: "TreemapDataSet" }) as any as Schema.Schema<TreemapDataSet>;
...
export const Treemap: Schema.Schema<Treemap> = Schema.suspend(() => Schema.Struct({
...
export const ErrorReportingPanel: Schema.Schema<ErrorReportingPanel> = Schema.suspend(() => Schema.Struct({
  projectNames: Schema.optional(Schema.Array(Schema.String)),
  services: Schema.optional(Schema.Array(Schema.String)),
  versions: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "ErrorReportingPanel" }) as any as Schema.Schema<ErrorReportingPanel>;
...
export const SectionHeader: Schema.Schema<SectionHeader> = Schema.suspend(() => Schema.Struct({
  subtitle: Schema.optional(Schema.String),
  dividerBelow: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "SectionHeader" }) as any as Schema.Schema<SectionHeader>;
...
export const SingleViewGroup: Schema.Schema<SingleViewGroup> = Schema.suspend(() => Schema.Struct({
  displayType: Schema.optional(Schema.String),
})).annotate({ identifier: "SingleViewGroup" }) as any as Schema.Schema<SingleViewGroup>;
...
export const FilterControl: Schema.Schema<FilterControl> = Schema.suspend(() => Schema.Struct({
  templateVariable: Schema.optional(Schema.String),
})).annotate({ identifier: "FilterControl" }) as any as Schema.Schema<FilterControl>;
...
export const TemplateVariableCondition: Schema.Schema<TemplateVariableCondition> = Schema.suspend(() => Schema.Struct({
  templateVariable: Schema.optional(Schema.String),
  templateVariableValue: Schema.optional(Schema.String),
  comparator: Schema.optional(Schema.String),
})).annotate({ identifier: "TemplateVariableCondition" }) as any as Schema.Schema<TemplateVariableCondition>;
...
export const VisibilityCondition: Schema.Schema<VisibilityCondition> = Schema.suspend(() => Schema.Struct({
  templateVariableCondition: Schema.optional(TemplateVariableCondition),
})).annotate({ identifier: "VisibilityCondition" }) as any as Schema.Schema<VisibilityCondition>;
...
export const Widget: Schema.Schema<Widget> = Schema.suspend(() => Schema.Struct({
...
export const GridLayout: Schema.Schema<GridLayout> = Schema.suspend(() => Schema.Struct({
...
export const Tile: Schema.Schema<Tile> = Schema.suspend(() => Schema.Struct({
...
export const MosaicLayout: Schema.Schema<MosaicLayout> = Schema.suspend(() => Schema.Struct({
  columns: Schema.optional(Schema.Number),
  tiles: Schema.optional(Schema.Array(Tile)),
})).annotate({ identifier: "MosaicLayout" }) as any as Schema.Schema<MosaicLayout>;
...
export const RowLayout: Schema.Schema<RowLayout> = Schema.suspend(() => Schema.Struct({
...
export const ColumnLayout: Schema.Schema<ColumnLayout> = Schema.suspend(() => Schema.Struct({
  columns: Schema.optional(Schema.Array(Column)),
})).annotate({ identifier: "ColumnLayout" }) as any as Schema.Schema<ColumnLayout>;
...
export const StringArray: Schema.Schema<StringArray> = Schema.suspend(() => Schema.Struct({
...
export interface DashboardFilter {
  ...
  valueType?: "VALUE_TYPE_UNSPECIFIED" | "STRING" | "STRING_ARRAY" | (string & {});
  ...
  filterType?: "FILTER_TYPE_UNSPECIFIED" | "RESOURCE_LABEL" | "METRIC_LABEL" | "USER_METADATA_LABEL" | "SYSTEM_METADATA_LABEL" | "GROUP" | "VALUE_ONLY" | (string & {});
...
export const DashboardFilter: Schema.Schema<DashboardFilter> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "DashboardFilter" }) as any as Schema.Schema<DashboardFilter>;

export interface EventAnnotation {
  /** Solely for UI display. Should not be used programmatically. */
  displayName?: string;
  /** The type of event to display. */
  eventType?: "EVENT_TYPE_UNSPECIFIED" | "GKE_WORKLOAD_DEPLOYMENT" | "GKE_POD_CRASH" | "GKE_POD_UNSCHEDULABLE" | "GKE_CONTAINER_CREATION_FAILED" | "GKE_CLUSTER_CREATE_DELETE" | "GKE_CLUSTER_UPDATE" | "GKE_NODE_POOL_UPDATE" | "GKE_CLUSTER_AUTOSCALER" | "GKE_POD_AUTOSCALER" | "VM_TERMINATION" | "VM_GUEST_OS_ERROR" | "VM_START_FAILED" | "MIG_UPDATE" | "MIG_AUTOSCALER" | "CLOUD_RUN_DEPLOYMENT" | "CLOUD_SQL_FAILOVER" | "CLOUD_SQL_START_STOP" | "CLOUD_SQL_STORAGE" | "UPTIME_CHECK_FAILURE" | "CLOUD_ALERTING_ALERT" | "SERVICE_HEALTH_INCIDENT" | "SAP_BACKINT" | "SAP_AVAILABILITY" | "SAP_OPERATIONS" | (string & {});
...
export const EventAnnotation: Schema.Schema<EventAnnotation> = Schema.suspend(() => Schema.Struct({
  displayName: Schema.optional(Schema.String),
  eventType: Schema.optional(Schema.String),
  filter: Schema.optional(Schema.String),
  enabled: Schema.optional(Schema.Boolean),
  resourceNames: Schema.optional(Schema.Array(Schema.String)),
})).annotate({ identifier: "EventAnnotation" }) as any as Schema.Schema<EventAnnotation>;
...
export const DashboardAnnotations: Schema.Schema<DashboardAnnotations> = Schema.suspend(() => Schema.Struct({
...
})).annotate({ identifier: "DashboardAnnotations" }) as any as Schema.Schema<DashboardAnnotations>;
...
export const Dashboard: Schema.Schema<Dashboard> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  displayName: Schema.optional(Schema.String),
...
export const ListDashboardsResponse: Schema.Schema<ListDashboardsResponse> = Schema.suspend(() => Schema.Struct({
  dashboards: Schema.optional(Schema.Array(Dashboard)),
  nextPageToken: Schema.optional(Schema.String),
})).annotate({ identifier: "ListDashboardsResponse" }) as any as Schema.Schema<ListDashboardsResponse>;
...
export const MonitoredProject: Schema.Schema<MonitoredProject> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  createTime: Schema.optional(Schema.String),
  isTombstoned: Schema.optional(Schema.Boolean),
})).annotate({ identifier: "MonitoredProject" }) as any as Schema.Schema<MonitoredProject>;
...
export const MetricsScope: Schema.Schema<MetricsScope> = Schema.suspend(() => Schema.Struct({
  name: Schema.optional(Schema.String),
  createTime: Schema.optional(Schema.String),
  updateTime: Schema.optional(Schema.String),
  monitoredProjects: Schema.optional(Schema.Array(MonitoredProject)),
})).annotate({ identifier: "MetricsScope" }) as any as Schema.Schema<MetricsScope>;
...
export const ListMetricsScopesByMonitoredProjectResponse: Schema.Schema<ListMetricsScopesByMonitoredProjectResponse> = Schema.suspend(() => Schema.Struct({
  metricsScopes: Schema.optional(Schema.Array(MetricsScope)),
})).annotate({ identifier: "ListMetricsScopesByMonitoredProjectResponse" }) as any as Schema.Schema<ListMetricsScopesByMonitoredProjectResponse>;
...
export const QueryInstantRequest: Schema.Schema<QueryInstantRequest> = Schema.suspend(() => Schema.Struct({
  query: Schema.optional(Schema.String),
  time: Schema.optional(Schema.String),
  timeout: Schema.optional(Schema.String),
})).annotate({ identifier: "QueryInstantRequest" }) as any as Schema.Schema<QueryInstantRequest>;
...
export const QueryRangeRequest: Schema.Schema<QueryRangeRequest> = Schema.suspend(() => Schema.Struct({
  query: Schema.optional(Schema.String),
  start: Schema.optional(Schema.String),
  end: Schema.optional(Schema.String),
  step: Schema.optional(Schema.String),
  timeout: Schema.optional(Schema.String),
})).annotate({ identifier: "QueryRangeRequest" }) as any as Schema.Schema<QueryRangeRequest>;
...
export const QueryLabelsRequest: Schema.Schema<QueryLabelsRequest> = Schema.suspend(() => Schema.Struct({
  start: Schema.optional(Schema.String),
  end: Schema.optional(Schema.String),
  match: Schema.optional(Schema.String),
})).annotate({ identifier: "QueryLabelsRequest" }) as any as Schema.Schema<QueryLabelsRequest>;
...
export const QuerySeriesRequest: Schema.Schema<QuerySeriesRequest> = Schema.suspend(() => Schema.Struct({
  start: Schema.optional(Schema.String),
  end: Schema.optional(Schema.String),
})).annotate({ identifier: "QuerySeriesRequest" }) as any as Schema.Schema<QuerySeriesRequest>;
...
export const QueryExemplarsRequest: Schema.Schema<QueryExemplarsRequest> = Schema.suspend(() => Schema.Struct({
  query: Schema.optional(Schema.String),
  start: Schema.optional(Schema.String),
  end: Schema.optional(Schema.String),
})).annotate({ identifier: "QueryExemplarsRequest" }) as any as Schema.Schema<QueryExemplarsRequest>;
...
export const CreateProjectsDashboardsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1/projects/{projectsId}/dashboards", hasBody: true }),
  svc,
...
export type CreateProjectsDashboardsError = CommonErrors;

/** Creates a new custom dashboard. For examples on how you can use this API to create dashboards, see Managing dashboards by API (https://cloud.google.com/monitoring/dashboards/api-dashboard). This method requires the monitoring.dashboards.create permission on the specified project. For more information about permissions, see Cloud Identity and Access Management (https://cloud.google.com/iam). */
export const createProjectsDashboards: API.OperationMethod<CreateProjectsDashboardsRequest, CreateProjectsDashboardsResponse, CreateProjectsDashboardsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export type ListProjectsDashboardsError = CommonErrors;
...
export const listProjectsDashboards: API.PaginatedOperationMethod<ListProjectsDashboardsRequest, ListProjectsDashboardsResponse, ListProjectsDashboardsError, GCPAuth | HttpClient.HttpClient> = API.makePaginated(() => ({
...
export const GetProjectsDashboardsRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1/projects/{projectsId}/dashboards/{dashboardsId}" }),
  svc,
...
export type GetProjectsDashboardsError = CommonErrors;

/** Fetches a specific dashboard.This method requires the monitoring.dashboards.get permission on the specified dashboard. For more information, see Cloud Identity and Access Management (https://cloud.google.com/iam). */
export const getProjectsDashboards: API.OperationMethod<GetProjectsDashboardsRequest, GetProjectsDashboardsResponse, GetProjectsDashboardsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteProjectsDashboardsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1/projects/{projectsId}/dashboards/{dashboardsId}" }),
  svc,
...
export type DeleteProjectsDashboardsError = CommonErrors;
...
export const deleteProjectsDashboards: API.OperationMethod<DeleteProjectsDashboardsRequest, DeleteProjectsDashboardsResponse, DeleteProjectsDashboardsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const PatchProjectsDashboardsRequest = Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "v1/projects/{projectsId}/dashboards/{dashboardsId}", hasBody: true }),
  svc,
...
export type PatchProjectsDashboardsError = CommonErrors;
...
export const patchProjectsDashboards: API.OperationMethod<PatchProjectsDashboardsRequest, PatchProjectsDashboardsResponse, PatchProjectsDashboardsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const QueryProjectsLocationPrometheusApiV1Request = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1/projects/{projectsId}/location/{location}/prometheus/api/v1/query", hasBody: true }),
  svc,
...
export type QueryProjectsLocationPrometheusApiV1Error = CommonErrors;

/** Evaluate a PromQL query at a single point in time. */
export const queryProjectsLocationPrometheusApiV1: API.OperationMethod<QueryProjectsLocationPrometheusApiV1Request, QueryProjectsLocationPrometheusApiV1Response, QueryProjectsLocationPrometheusApiV1Error, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const Query_rangeProjectsLocationPrometheusApiV1Request = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1/projects/{projectsId}/location/{location}/prometheus/api/v1/query_range", hasBody: true }),
  svc,
...
export type Query_rangeProjectsLocationPrometheusApiV1Error = CommonErrors;

/** Evaluate a PromQL query with start, end time range. */
export const query_rangeProjectsLocationPrometheusApiV1: API.OperationMethod<Query_rangeProjectsLocationPrometheusApiV1Request, Query_rangeProjectsLocationPrometheusApiV1Response, Query_rangeProjectsLocationPrometheusApiV1Error, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const LabelsProjectsLocationPrometheusApiV1Request = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1/projects/{projectsId}/location/{location}/prometheus/api/v1/labels", hasBody: true }),
  svc,
...
export type LabelsProjectsLocationPrometheusApiV1Error = CommonErrors;

/** Lists labels for metrics. */
export const labelsProjectsLocationPrometheusApiV1: API.OperationMethod<LabelsProjectsLocationPrometheusApiV1Request, LabelsProjectsLocationPrometheusApiV1Response, LabelsProjectsLocationPrometheusApiV1Error, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const SeriesProjectsLocationPrometheusApiV1Request = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1/projects/{projectsId}/location/{location}/prometheus/api/v1/series", hasBody: true }),
  svc,
...
export type SeriesProjectsLocationPrometheusApiV1Error = CommonErrors;

/** Lists metadata for metrics. */
export const seriesProjectsLocationPrometheusApiV1: API.OperationMethod<SeriesProjectsLocationPrometheusApiV1Request, SeriesProjectsLocationPrometheusApiV1Response, SeriesProjectsLocationPrometheusApiV1Error, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const Query_exemplarsProjectsLocationPrometheusApiV1Request = Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  location: Schema.String.pipe(T.HttpPath("location")),
  body: Schema.optional(QueryExemplarsRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1/projects/{projectsId}/location/{location}/prometheus/api/v1/query_exemplars", hasBody: true }),
  svc,
...
export type Query_exemplarsProjectsLocationPrometheusApiV1Error = CommonErrors;

/** Lists exemplars relevant to a given PromQL query, */
export const query_exemplarsProjectsLocationPrometheusApiV1: API.OperationMethod<Query_exemplarsProjectsLocationPrometheusApiV1Request, Query_exemplarsProjectsLocationPrometheusApiV1Response, Query_exemplarsProjectsLocationPrometheusApiV1Error, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ValuesProjectsLocationPrometheusApiV1LabelRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1/projects/{projectsId}/location/{location}/prometheus/api/v1/label/{label}/values" }),
  svc,
...
export type ValuesProjectsLocationPrometheusApiV1LabelError = CommonErrors;

/** Lists possible values for a given label name. */
export const valuesProjectsLocationPrometheusApiV1Label: API.OperationMethod<ValuesProjectsLocationPrometheusApiV1LabelRequest, ValuesProjectsLocationPrometheusApiV1LabelResponse, ValuesProjectsLocationPrometheusApiV1LabelError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ListProjectsLocationPrometheusApiV1MetadataRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1/projects/{projectsId}/location/{location}/prometheus/api/v1/metadata" }),
  svc,
...
export type ListProjectsLocationPrometheusApiV1MetadataError = CommonErrors;

/** Lists metadata for metrics. */
export const listProjectsLocationPrometheusApiV1Metadata: API.OperationMethod<ListProjectsLocationPrometheusApiV1MetadataRequest, ListProjectsLocationPrometheusApiV1MetadataResponse, ListProjectsLocationPrometheusApiV1MetadataError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const GetLocationsGlobalMetricsScopesRequest = Schema.Struct({
  ...
  T.Http({ method: "GET", path: "v1/locations/global/metricsScopes/{metricsScopesId}" }),
  svc,
...
export type GetLocationsGlobalMetricsScopesError = CommonErrors;

/** Returns a specific Metrics Scope, including the list of projects monitored by the specified Metrics Scope. */
export const getLocationsGlobalMetricsScopes: API.OperationMethod<GetLocationsGlobalMetricsScopesRequest, GetLocationsGlobalMetricsScopesResponse, GetLocationsGlobalMetricsScopesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const ListMetricsScopesByMonitoredProjectLocationsGlobalMetricsScopesRequest = Schema.Struct({
  monitoredResourceContainer: Schema.optional(Schema.String).pipe(T.HttpQuery("monitoredResourceContainer")),
}).pipe(
  T.Http({ method: "GET", path: "v1/locations/global/metricsScopes:listMetricsScopesByMonitoredProject" }),
  svc,
) as unknown as Schema.Schema<ListMetricsScopesByMonitoredProjectLocationsGlobalMetricsScopesRequest>;

export type ListMetricsScopesByMonitoredProjectLocationsGlobalMetricsScopesResponse = ListMetricsScopesByMonitoredProjectResponse;
export const ListMetricsScopesByMonitoredProjectLocationsGlobalMetricsScopesResponse = ListMetricsScopesByMonitoredProjectResponse;

export type ListMetricsScopesByMonitoredProjectLocationsGlobalMetricsScopesError = CommonErrors;

/** Returns a list of every Metrics Scope that a specific MonitoredProject has been added to. The metrics scope representing the specified monitored project will always be the first entry in the response. */
export const listMetricsScopesByMonitoredProjectLocationsGlobalMetricsScopes: API.OperationMethod<ListMetricsScopesByMonitoredProjectLocationsGlobalMetricsScopesRequest, ListMetricsScopesByMonitoredProjectLocationsGlobalMetricsScopesResponse, ListMetricsScopesByMonitoredProjectLocationsGlobalMetricsScopesError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
  input: ListMetricsScopesByMonitoredProjectLocationsGlobalMetricsScopesRequest,
  output: ListMetricsScopesByMonitoredProjectLocationsGlobalMetricsScopesResponse,
  errors: [],
}));
...
export const CreateLocationsGlobalMetricsScopesProjectsRequest = Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1/locations/global/metricsScopes/{metricsScopesId}/projects", hasBody: true }),
  svc,
...
export type CreateLocationsGlobalMetricsScopesProjectsError = CommonErrors;

/** Adds a MonitoredProject with the given project ID to the specified Metrics Scope. */
export const createLocationsGlobalMetricsScopesProjects: API.OperationMethod<CreateLocationsGlobalMetricsScopesProjectsRequest, CreateLocationsGlobalMetricsScopesProjectsResponse, CreateLocationsGlobalMetricsScopesProjectsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
...
export const DeleteLocationsGlobalMetricsScopesProjectsRequest = Schema.Struct({
  ...
  T.Http({ method: "DELETE", path: "v1/locations/global/metricsScopes/{metricsScopesId}/projects/{projectsId}" }),
  svc,
...
export type DeleteLocationsGlobalMetricsScopesProjectsError = CommonErrors;

/** Deletes a MonitoredProject from the specified Metrics Scope. */
export const deleteLocationsGlobalMetricsScopesProjects: API.OperationMethod<DeleteLocationsGlobalMetricsScopesProjectsRequest, DeleteLocationsGlobalMetricsScopesProjectsResponse, DeleteLocationsGlobalMetricsScopesProjectsError, GCPAuth | HttpClient.HttpClient> = API.make(() => ({
